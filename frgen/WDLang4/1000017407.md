...
- La rubrique peut être manipulée comme n'importe quelle rubrique du schéma des données.
...
`<Résultat> = HDécritIndexFullText(<Table> , <Index full-text>)`
---
...
Nom de la table HFSQL (décrit avec la fonction [HDécritTable](../WDLang4/3044206.md)).
...
<a name="comment_decrire_index_fulltext_par_programmation_ELTPARAGRAPHE000066"></a>
...
2. Décrire les caractéristiques de la table, de ses rubriques, de ses liaisons et de ses index full-text grâce aux propriétés HFSQL.
...
5. Fixer la description de la table (fonction [HDécritTable](../WDLang4/3044206.md)) et des liaisons (fonction [HDécritLiaison](../WDLang4/3044191.md)).
...
<a name="liste_des_proprietes_hfsql_utilisables_pour_decrire_index_fulltext_par_programmation_ELTPARAGRAPHE000102"></a>Les propriétés suivantes sont disponibles en lecture et écriture.
