...
<a name="comment_bloquer_une_table_les_enregistrements_une_requete_ELTPARAGRAPHE000072"></a>Pour bloquer une table (ou les enregistrements d'une requête) :
...
### Accès Natif ORACLE
<a name="acces_natif_oracle_ELTPARAGRAPHE000097"></a>Il est possible de paramétrer le comportement de la fonction **SQLBloque** lorsque l'enregistrement est bloqué (attente infinie, compte-rendu de blocage immédiat, ...). Ce paramétrage est réalisé dans les options du programme WDORAINS.
<a name="NOTE0_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) 

### Accès Natif MySQL
<a name="acces_natif_mysql_ELTPARAGRAPHE000109"></a>Les fonctions **SQLBloque** et [SQLTransaction](../WDLang4/3072029.md) permettent de gérer les blocages et les transactions uniquement sur les tables MySQL de type "InnoDB".
...
[SQLTransaction (Fonction)](../WDLang4/3072029.md)
