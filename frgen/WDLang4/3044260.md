...
Convertit une valeur numérique en une chaîne binaire pour effectuer une recherche sur une clé numérique. Permet de composer une clé composée d'une ou de plusieurs rubriques numériques.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=HConvertX%20-%20HC%20N%B0001.gif)


Pour les tables utilisant le "Mode 7" pour la gestion des espaces dans les rubriques texte, il est nécessaire d'utiliser la fonction [HConstruitValClé](../WDLang4/3044258.md) pour réaliser des parcours sur les clés composées. Pour plus de détails, consultez [Clés composées](../WDLang4/3044178.md).
...
<a name="les_differentes_syntaxes_fonction_des_valeurs_convertir_ELTPARAGRAPHE000057"></a>
...
<a name="utilisation_fonction_docparampagetitleshort_methode_conservee_pour_compatibilite_avec_windev_55_ELTPARAGRAPHE000097"></a>

Pour construire la valeur d'une clé composée sans utiliser la fonction [HConstruitValClé](../WDLang4/3044258.md), il est nécessaire de:
