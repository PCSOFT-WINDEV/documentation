...
NomFichier est une Source de Données = HErreurInfo(HErrTable)
...
|   |   |
| --- | --- |
| *hEnrFichier* | État de l'enregistrement dans la table. |
| *hEnrLu* | Etat de l'enregistrement original (lu avant l'exécution de la fonction [&lt;Source&gt;.Modifie](../WDLang4/1000025038.md)). |
| *hEnrUtilisateur* | Etat de l'enregistrement en cours au moment de l'appel à la fonction [&lt;Source&gt;.Modifie](../WDLang4/1000025038.md). |
...
<a name="conflit_modification_etat_enregistrement_ELTPARAGRAPHE000232"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Pour plus de détails sur la gestion automatique des erreurs HFSQL, consultez [Gestion assistée des erreurs HFSQL](../WDLang4/3044188.md).
...
[HErreurEtatModification (Fonction)](../WDLang4/3044103.md)
