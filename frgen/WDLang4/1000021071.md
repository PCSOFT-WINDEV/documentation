...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Ce mode de réplication ne permet pas d'effectuer une réplication entre une base de données SQLite et une base de données HFSQL. 
...
- Le schéma des données doit être partagé entre l'application WINDEV et WINDEV Mobile (Android ou iOS). 
...
- IMPORTANT: La date et l'heure doivent être identiques sur le serveur et les terminaux Android/iOS. Les dates internes (celles utilisées par la réplication dans les tables HFSQL) sont en UTC. 
...
<a name="definition_replication_ELTPARAGRAPHE000069"></a>
...
<a name="programmation_replication_ELTPARAGRAPHE000088"></a>
...
**Remarque**: N'oubliez pas dans le code du projet Android (ou iOS) de paramétrer la connexion à la base locale (table HFSQL Classic sur l'appareil mobile). 
