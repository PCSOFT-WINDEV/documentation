...
- Plusieurs triggers serveur peuvent être associés à une même table.
...
## Création des triggers serveur sous le schéma des données
<a name="creation_des_triggers_serveur_sous_schema_des_donnees_ELTTEXTE000303"></a>


### Préalable
<a name="prealable_ELTPARAGRAPHE000083"></a>

Pour créer un trigger serveur: 

- sous le volet "Schéma des données", dans le groupe "Création", déroulez "Nouveau" et sélectionnez "Trigger". 

- sélectionnez l'option "Nouveau trigger" du menu contextuel du volet ancrable "Schéma des données".

- affichez l'onglet "Triggers HF" de la fenêtre de description de la table et cliquez sur le bouton "Créer un nouveau trigger".
...
- dans l'onglet "Général": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Triggers_Serveur%20-%20HC%20N%B0002.gif&type=thumb)
...
- dans l'onglet "Général": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Triggers_Serveur%20-%20HC%20N%B0003.gif&type=thumb)


	- les tables associées au trigger.
...
- dans le volet du schéma des données.

- directement dans le graphe du schéma des données: si un trigger serveur est associé à une table, une icône spécifique apparaît: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Triggers_Serveur%20-%20HC%20N%B0001.gif).
...
<a name="prise_compte_des_triggers_serveur_ELTPARAGRAPHE000129"></a>

Les triggers serveur créés dans le schéma des données sont créés sur le serveur:

- lors de la création des tables (fonction [HCrée](../WDLang4/3044255.md) ou [HCréeSiInexistant](../WDLang4/3044254.md)).
...
- si nécessaire lors de la modification automatique des tables.
...
<a name="procedure_stockee_liee_trigger_ELTPARAGRAPHE000156"></a>
...
Le mot-clé [MonFichier](../Motscles/1511019.md) permet de connaître et de manipuler dans le code de la procédure stockée le nom de la table sur laquelle le trigger a été déclenché.
...
En effet, lorsqu'une procédure stockée est lancée par exemple depuis le Centre de Contrôle HFSQL, il n'y a pas de schéma des données en cours: les données HFSQL Client/Serveur ne sont pas immédiatement accessibles. 
...
<a name="tester_une_procedure_stockee_appelee_par_trigger_ELTPARAGRAPHE000180"></a>
...
<a name="manipulation_des_triggers_serveur_par_programmation_ELTTEXTE000414"></a>


### Les fonctions du WLangage
<a name="les_fonctions_wlangage_ELTPARAGRAPHE000225"></a>Plusieurs fonctions permettent de manipuler les triggers serveur:
