...
***En anglais : &lt;Connection variable&gt;.ModifyDatabaseRights***
...
**Remarque**: il est possible de connaître les droits d'un groupe ou d'un utilisateur sur une base de données HFSQL Client/Serveur grâce à la fonction [&lt;Variable Connexion&gt;.InfoDroitBaseDeDonnées](../WDLang4/1000022666.md). 
...
| *hDroitDésanonymisation* | Droit de désanonymiser les rubriques anonymisées présentes dans les tables de la base de données. |
...
| *hDroitInterditAccèsBaseDeDonnées* | Droit d'interdire ou non l'accès à une base de données (fonctions [&lt;Variable Connexion&gt;.InterditAccèsBaseDeDonnées](../WDLang4/1000022690.md) et [&lt;Variable Connexion&gt;.FinInterditAccèsBaseDeDonnées](../WDLang4/1000022661.md)). |
...
<a name="quand_estce_que_modification_droit_est_realisee_ELTPARAGRAPHE000396"></a>
...
[&lt;Variable Connexion&gt;.InfoDroitBaseDeDonnées (Fonction)](../WDLang4/1000022666.md)
