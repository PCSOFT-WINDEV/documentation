...
- Pour connaître la géométrie correspondant à l'intersection, utilisez la fonction [GéométrieIntersection](../WDLang4/1410090153.md). 

- La fonction **GéométrieIntersecte** ne renvoyant pas la géométrie résultat, elle est beaucoup plus rapide que la fonction [GéométrieIntersection](../WDLang4/1410090153.md). 
...
<a name="parcours_des_donnees_spatiales_utilisation_des_index_spatiaux_ELTPARAGRAPHE000356"></a>

Il est possible d'effectuer un parcours sur une table avec un filtre concernant des données spatiales. Par exemple, le filtre utilisé peut être basé sur le résultat de la fonction **GéométrieIntersecte**.
...
[&lt;Variable PolygoneGéo&gt;.Intersecte (Fonction)](../WDLang4/1410090577.md)
