...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le fetch partiel est automatiquement réalisé par le framework JAVA.
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003072017&name=sqlpremier_fonction">Voir des exemples supplémentaires</a>
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)  Ce paramètre est ignoré. En effet, le Fetch partiel est réalisé automatiquement par le framework Java. 
...
<a name="chargement_requete_memoire_ELTPARAGRAPHE000099"></a>Si la fonction **SQLPremier** est appelée immédiatement après la fonction [SQLExec](../WDLang4/3072007.md), le résultat de la requête est chargé en mémoire. Deux méthodes sont possibles :
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le Fetch partiel est automatiquement réalisé par le framework Java. La variable **SQL.RecupEnCours** n'est jamais initialisée et renvoie toujours <u><u><u><u>Faux</u></u></u></u>.
...
### Fetch Partiel
<a name="fetch_partiel_ELTPARAGRAPHE000134"></a>Si la méthode de récupération du résultat de la requête par Fetch Partiel est utilisée (consultez l'exemple de cette fonction) :
...
[SQLDernier (Fonction)](../WDLang4/3072009.md)

[SQLSuivant (Fonction)](../WDLang4/3072030.md)

[SQLPositionne (Fonction)](../WDLang4/3072024.md)
