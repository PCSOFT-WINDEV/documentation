...
- travailler sur différentes tables physiques ayant une même description logique. 

- avoir plusieurs "pointeurs" sur la même table pour faire des parcours imbriqués. 


Par exemple, pour une table: 

- la description de la table est effectuée dans le schéma des données. 

- une variable de type **Alias** permet de créer l'alias de la table.
...
// Il se comporte comme la table "Commande" décrite dans le schéma des données.
// -------------------
...
<a name="suppression_alias_ELTPARAGRAPHE000038"></a>
...
<a name="table_physique_associee_alias_ELTPARAGRAPHE000045"></a>
...
Pour associer l'alias à une table physique de nom différent, il suffit d'utiliser la fonction [HChangeNom](../WDLang4/3044141.md). Si nécessaire: 

- la fonction [HChangeConnexion](../WDLang4/3044150.md) permet de redéfinir la connexion liée à la table. 

- la fonction [HChangeRep](../WDLang4/3044168.md) permet de redéfinir le répertoire de la table.
...
<a name="avantages_par_rapport_fonction_haliaswdlang43044176md_ELTPARAGRAPHE000072"></a>
...
### Alias et requêtes
<a name="alias_requetes_ELTPARAGRAPHE000091"></a>
...
<a name="manipuler_fichier_alias_ses_rubriques_ELTPARAGRAPHE000111"></a>
...
[Alias sur les tables : fonction HAlias](../WDLang4/3044180.md)
