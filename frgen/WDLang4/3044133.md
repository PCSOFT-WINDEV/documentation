...
![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/us/HFCS.png) Les tables HFSQL Client/Serveur peuvent être réindexées de manière asynchrone grâce à la fonction [HRéindexeAsynchrone](../WDLang4/1410091053.md). 
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003044133&name=hreindexe_fonction">Voir des exemples supplémentaires</a>
...
![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/us/HF55.png) Ce paramètre n'est pas utilisable.
...
<a name="conditions_utilisation_ELTPARAGRAPHE000232"></a>
...
<a name="reindexation_automatique_ELTPARAGRAPHE000253"></a>
...
<a name="reindexation_chaud_ELTPARAGRAPHE000305"></a>
...
<a name="calcul_des_statistiques_ELTPARAGRAPHE000333"></a>

Le calcul des statistiques permet d'optimiser les requêtes et les filtres sur la table. Ce calcul prend en compte uniquement les enregistrements actifs. Ce calcul peut également être obtenu par la fonction [HStatCalcule](../WDLang4/3044134.md).
...
<a name="repertoire_des_fichiers_temporaires_ELTPARAGRAPHE000347"></a>
...
<a name="gestion_des_alphabets_non_latins_ELTPARAGRAPHE000375"></a>
...
2. Ré-indexez la table avec la fonction **HRéindexe**. Utilisez la constante *hChangeAlphabet* pour prendre en compte l'alphabet spécifié avec la fonction [ChangeAlphabet](../WDLang1/3054001.md).
...
<a name="droits_acces_table_ELTPARAGRAPHE000400"></a>
...
<a name="cas_particulier_tables_corrompues_apres_reboot_erreur_fatale_poste_ELTPARAGRAPHE000411"></a>
...
<a name="versions_precedentes_ELTPARAGRAPHE000427"></a>
