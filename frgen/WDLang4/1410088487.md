...
`<Résultat> = HExporteChaîneJSON(<Table> [, <Rubriques à exporter>] [, <Options> [, <Jauge>]])`
---
...
<a name="exporter_contenu_une_requete_ELTPARAGRAPHE000201"></a>

Pour exporter le contenu d'une requête, il est nécessaire d'initialiser la requête (fonction [HExécuteRequête](../WDLang4/3044080.md)) avant d'utiliser la fonction **HExporteChaîneJSON**.
<a name="1000021964_NOTE0_2"></a>


### Exporter un seul enregistrement
<a name="exporter_seul_enregistrement_ELTPARAGRAPHE000215"></a>
...
### Rubriques tableau
<a name="rubriques_tableau_ELTPARAGRAPHE000227"></a>Si une des rubriques exportées est une rubrique de type Tableau, chaque élément de la rubrique tableau est exportée dans un nouveau niveau:
...
[JSON (Type de variable)](../WDLang4/1000023611.md)

[Fonctions de gestion HFSQL](../WDLang4/3044156.md)

[&lt;Source&gt;.ExporteChaîneJSON (Fonction)](../WDLang4/1410088491.md)
