...
![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/us/HF55.png) Ce paramètre n'est pas pris en compte. La sécurité est activée pour tous les fichiers de données de l'analyse en cours.
...
<a name="fonctions_docparampagetitleshort_hforceecriture_ELTPARAGRAPHE000097"></a>Les fonctions **HSécurité** et [HForceEcriture](../WDLang4/3044004.md) permettent toutes les deux de forcer l'écriture physique sur le disque.
