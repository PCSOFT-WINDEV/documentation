...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003044159&name=hcreevue_fonction">Voir des exemples supplémentaires</a>
...
`<Résultat> = HCréeVue(<Vue à créer> , <Table> [, <Rubriques> [, <Rubriques de tri> [, <Condition de sélection>]]] [, <Mode de création> [, <Taille d'une page>]])`
---
...
Nom de la table manipulée. Cette table peut correspondre à une table décrite dans le schéma des données ou décrite par programmation (fonction [HDécritTable](../WDLang4/3044206.md)). Il est également possible d'utiliser une [source de données](../WDLang4/1514053.md).
...
<a name="condition_selection_ELTPARAGRAPHE000171"></a>
...
<a name="creer_une_vue_sur_une_table_filtree_ELTPARAGRAPHE000277"></a>

La fonction **HCréeVue** tient compte du filtre posé sur la table source de la vue.
...
<a name="versions_precedentes_ELTPARAGRAPHE000290"></a>
...
[HTrieVue (Fonction)](../WDLang4/3044114.md)

[HVueVersTable (Fonction)](../WDLang4/3044021.md)
...
[&lt;Source&gt;.CréeVue (Fonction)](../WDLang4/1000024209.md)
