...
Importe un fichier Texte dans une table au format HFSQL Classic ou Client/Serveur (table décrite sous l'éditeur de schémas des données, ou déclarée par les fonctions [HDéclare](../WDLang4/3044203.md), [HDéclareExterne](../WDLang4/3044204.md) ou [HDécritTable](../WDLang4/3044206.md)).
...
// sNomJoueur et dDateNaissance sont 2 rubriques de la table Joueur de type chaîne et Date
...
`<Résultat> = HImporteTexte(<Table> , <Chemin complet du fichier texte> , <Liste des rubriques> , <Séparateurs> [, <Options> [, <Jauge>]])`
---
...
| *hImpIgnoreRubriqueVide* | Si une ou plusieurs rubriques ne sont pas renseignées dans le fichier texte, les lignes correspondantes sont quand même importées.<br>Les rubriques manquantes contiennent:<br><br>- soit la valeur par défaut des rubriques si la constante *hValDéfaut* est spécifiée.<br><br>- soit la valeur des rubriques dans l'enregistrement en cours avant l'appel de la fonction **HImporteTexte**.<br><br><br> |
...
| *hValDéfaut* | Pour les rubriques non importées, les valeurs de l'enregistrement en cours sont réinitialisées:<br><br>- soit avec leur valeur par défaut si la constante *hValDéfaut* est spécifiée.<br><br>- soit avec la valeur des rubriques correspondantes dans l'enregistrement en cours avant l'appel de la fonction **HImporteTexte** si la constante *hValDéfaut* n'est pas spécifiée.<br><br><br> |
...
## Remarques
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/us/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/us/HFCS.png)![Procédures stockées](https://doc.pcsoft.fr/ext/images/us/PS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/us/HF55.png) 

### Importation d'une rubrique de type mémo texte
<a name="importation_une_rubrique_type_memo_texte_ELTPARAGRAPHE000217"></a>
...
<a name="NOTE0_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/us/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/us/HFCS.png)![Procédures stockées](https://doc.pcsoft.fr/ext/images/us/PS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/us/HF55.png) 

### Importation d'une rubrique de type mémo binaire
<a name="importation_une_rubrique_type_memo_binaire_ELTPARAGRAPHE000233"></a>
...
<a name="importation_une_rubrique_indicee_ELTPARAGRAPHE000277"></a>
...
<a name="importation_une_rubrique_type_heure_ELTPARAGRAPHE000290"></a>

La fonction **HImporteTexte** enregistre des heures non valides si les heures à importer ne sont pas dans un des formats disponibles dans le schéma des données.
...
<a name="versions_precedentes_ELTPARAGRAPHE000308"></a>
