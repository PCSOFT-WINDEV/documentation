...
- La fonction **SourceVersPage** n'effectue aucune lecture de la table. C'est la valeur de l'enregistrement chargé en mémoire qui est utilisée pour initialiser les champs. Il faut donc qu'un enregistrement soit au préalable chargé en mémoire (fonctions [HLit](../WDLang4/3044047.md), [HLitRecherche](../WDLang4/3044050.md), [HLitPremier](../WDLang4/3044051.md), ...).
...
Nom de la page où les champs doivent être initialisés avec les valeurs de l'enregistrement en cours dans la table.
...
<a name="liaison_avec_une_rubrique_types_liaisons_ELTPARAGRAPHE000107"></a>
...
[&lt;Page&gt;.DepuisSource (Fonction)](../WDLang4/1000021393.md)
