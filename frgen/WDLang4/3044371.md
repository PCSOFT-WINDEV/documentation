...
- directement dans l'éditeur de schémas des données.

- par programmation grâce à la variable [H.CréationLangueUnicode](../WDLang4/3044382.md). Cette variable doit être utilisée avant la création des tables (fonction [HCrée](../WDLang4/3044255.md) ou [HCréeSiInexistant](../WDLang4/3044254.md)).
...
### Créer une rubrique de type Unicode dans le schéma des données
<a name="creer_une_rubrique_type_unicode_dans_schema_des_donnees_ELTPARAGRAPHE000039"></a>

Lors de la création de la rubrique sous l'éditeur de schémas des données (voir [Manipulations de rubriques](../Editeurs/2011009.md) pour plus de détails), il suffit d'indiquer le sous-type voulu pour la rubrique. Une rubrique de type Texte peut être :
...
Lors de la sélection d'un type Unicode (chaîne ou mémo texte), l'éditeur de schémas des données permet de saisir les caractéristiques de la langue qui sera saisie dans cette rubrique.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Unicode_HFSQL%20-%20HC%20N%B0001.gif)
...
### Passer de l'Unicode à ANSI et inversement sous l'éditeur de schémas des données
<a name="passer_unicode_ansi_inversement_sous_editeur_schemas_des_donnees_ELTPARAGRAPHE000081"></a>
...
## A savoir
<a name="savoir_ELTTEXTE000223"></a>


### Champs liés aux rubriques
<a name="champs_lies_aux_rubriques_ELTPARAGRAPHE000094"></a>
...
<a name="programmation_wlangage_ELTPARAGRAPHE000108"></a>

La programmation en WLangage des fichiers contenant des rubriques Unicode est identique à celle des fichiers contenant des rubriques ANSI. Les options de langue définies dans l'éditeur de schémas des données sont prises en compte lors des parcours indexés et lors des tris pour définir l'ordre des enregistrements.
...
<a name="recherche_avec_fonction_hlitrecherche_ELTPARAGRAPHE000120"></a>
...
[Éditeur de schémas des données: les différents types de rubriques](../WDLang4/2011026.md)

[Gestion de l'Unicode dans les chaînes de caractères](../WDLang4/3024038.md)
