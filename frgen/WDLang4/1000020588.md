...
<a name="mettre_place_replication_serveurs_hfsql_ELTTEXTE000195"></a>
...
## Pré-requis
<a name="prerequis_ELTTEXTE000219"></a>
...
**1. Au niveau du schéma des données de l'application**
Dans le schéma des données, les tables prises en compte dans la réplication de serveurs HFSQL doivent posséder:
...
- Un fichier ne peut pas être copié s'il est répliqué: la fonction [HCopieTable](../WDLang4/3044282.md) ne doit pas être utilisée. 
...
<a name="questions_frequentes_sur_replication_serveurs_hfsql_ELTTEXTE000298"></a>
...
<a name="lors_mise_place_une_replication_entre_des_serveurs_hfsql_pourquoi_les_identifiants_automatiques_doiventils_etre_sur_8_octets_ELTPARAGRAPHE000067"></a>
...
<a name="pourquoi_les_valeurs_des_identifiants_automatiques_ajoutes_apres_mise_place_replication_serveurs_sontelles_aussi_elevees_ELTPARAGRAPHE000076"></a>
...
<a name="quelle_est_configuration_reseau_necessaire_pour_mettre_place_une_replication_serveurs_ELTPARAGRAPHE000085"></a>
...
### J'ai modifié la structure des fichiers dans le schéma des données (ajouts, modifications ou suppressions de rubriques). Comment appliquer les modifications sur des fichiers qui se trouvent sur des serveurs HFSQL avec une réplication de serveurs?
<a name="jai_modifie_structure_des_fichiers_dans_schema_des_donnees_ajouts_modifications_suppressions_rubriques_comment_appliquer_les_modifications_sur_des_fichiers_qui_trouvent_sur_des_serveurs_hfsql_avec_une_replication_serveurs_ELTPARAGRAPHE000093"></a>
...
- depuis l'éditeur de schémas des données,
...
<a name="replication_serveurs_estce_que_les_transactions_sont_gerees_sur_les_serveurs_hfsql_ELTPARAGRAPHE000104"></a>
...
<a name="replication_serveurs_quelle_est_securisation_propre_replication_serveurs_ELTPARAGRAPHE000113"></a>
...
<a name="replication_serveurs_comment_sont_executes_les_triggers_serveur_ELTPARAGRAPHE000118"></a>

Un trigger serveur associé à la mise à jour d'une table est exécuté uniquement sur le serveur HFSQL pour lequel la fonction qui déclenche le trigger est appelée. 
