...
***En anglais : &lt;Connection variable&gt;.InfoItemRights***
...
sDroit = MaConnexion.InfoDroitRubrique("Dupont", hDroitDésanonymisation, "MaBase", "MaTable.fic", "MaRubrique")
SELON sDroit
	CAS hAutorisé
	...
	CAS hInterdit
...
`<Résultat> = <Connexion>.InfoDroitRubrique(<Utilisateur/Groupe> , <Droits> , <Base de données> , <Table> , <Rubrique> [, <Mode d'affichage>])`
---
...
## Remarques
Pour modifier les droits sur une rubrique pour un utilisateur ou un groupe, utilisez la fonction [&lt;Variable Connexion&gt;.ModifieDroitRubrique](../WDLang4/1410090544.md).
...
[&lt;Variable Connexion&gt;.ModifieDroitServeur (Fonction)](../WDLang4/1000022710.md)
