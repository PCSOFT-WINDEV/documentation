...
<a name="principe_replication_universelle_assistee_automatique_ELTTEXTE000295"></a>
...
<a name="les_etapes_mise_place_une_replication_universelle_assistee_automatique_sont_les_suivantes_ELTPARAGRAPHE000037"></a>
...
<a name="adaptation_application_necessaire_ELTTEXTE000325"></a>
Il est possible de mettre en place la réplication universelle assistée sur des applications utilisant des tables aux formats HFSQL Classic, HFSQL Client/Serveur, OLE DB, ou encore manipulées par des Connecteurs Natifs (également appelés Accès Natifs).

**Les tables dans le schéma des données sont au format HFSQL Classic**: aucune modification ne doit être réalisée. Le paramétrage des fichiers maître peut être réalisé:
...
**Les tables dans le schéma des données utilisent une connexion** (HFSQL Client/Serveur, Connecteurs Natifs, tables OLE DB, ...): il est nécessaire de ***définir la connexion au serveur maître dans le schéma des données et d'associer les tables à cette connexion***.
...
**Attention: Quel que soit le format des tables, pour utiliser la réplication universelle assistée automatique**, IL NE FAUT PAS modifier les informations d'accès aux tables par programmation. IL NE FAUT PAS UTILISER:
...
<a name="utilisation_bases_donnees_non_hfsql_ELTPARAGRAPHE000102"></a>
...
<a name="preparation_des_fichiers_necessaires_replication_universelle_assistee_ELTTEXTE000355"></a>
La préparation des fichiers nécessaires à la réplication universelle assistée automatique est réalisée sur le poste de développement:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Preparation_replic.gif)
...
<a name="utilisation_replication_ELTTEXTE000379"></a>


### Réplication universelle assistée directe
<a name="replication_universelle_assistee_directe_ELTPARAGRAPHE000164"></a>

Le principe de la réplication assistée directe est le suivant:
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=replication_directe.gif)
...
<a name="replication_universelle_assistee_par_serveur_replication_ELTPARAGRAPHE000185"></a>
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=replication_serveur.gif)
...
<a name="mode_nomademode_connecte_ELTPARAGRAPHE000204"></a>
...
**Lorsque l'application est en mode nomade configuré par ReplicAdmin**, l'application utilise toujours les tables locales. Aucun mécanisme automatique n'est mis en place. Pour utiliser la base maître, il faut se synchroniser et utiliser ReplicAdmin pour passer en mode connecté.
