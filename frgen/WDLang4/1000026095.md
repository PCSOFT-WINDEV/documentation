...
<a name="texte_requete_sql_ELTPARAGRAPHE000267"></a>
...
<a name="executer_une_requete_sql_parametree_ELTPARAGRAPHE000278"></a>
...
<a name="injection_sql_comment_sen_premunir_ELTPARAGRAPHE000325"></a>
...
### Jointures
<a name="jointures_ELTPARAGRAPHE000349"></a>
...
<a name="NOTE0_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) 

### Pourquoi utiliser la constante hRequêteSansCorrection?
<a name="pourquoi_utiliser_constante_hrequetesanscorrection_ELTPARAGRAPHE000362"></a>
...
| --- | --- |
| Détermination automatique de la connexion associée aux tables présentes dans la requête. | La connexion à utiliser doit être précisée dans la fonction **HExécuteRequêteSQLAsynchrone**. |
...
<a name="condition_sur_une_cle_composee_dans_une_requete_sql_ELTPARAGRAPHE000415"></a>
