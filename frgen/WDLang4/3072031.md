...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le fetch partiel est automatiquement réalisé par le framework JAVA.![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) La fonction **SQLTable** ne fonctionne pas si la requête contient des mémos binaires. Il est nécessaire de traiter séparément les mémos binaires (par exemple les enregistrer avec [fSauveTexte](../WDLang1/3036046.md)).
<a name="Exemple1"></a>
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le nom de la requête doit obligatoirement être entre guillemets.
...
<a name="caracteristiques_champ_table_par_programmation_ELTPARAGRAPHE000104"></a>Le nombre de colonnes du champ Table par programmation doit être suffisant pour accueillir toutes les colonnes du résultat de la requête.
<a name="NOTE0_2"></a>


### Fermeture d'une requête
<a name="fermeture_une_requete_ELTPARAGRAPHE000111"></a>Une requête est fermée automatiquement :
...
<a name="utilisation_fetch_partiel_ELTPARAGRAPHE000126"></a>La récupération en cours s'arrête dès que la fonction [SQLFerme](../WDLang4/3072015.md) est appelée ou dès que la fenêtre contenant le champ Table est fermée.
...
<a name="les_differents_types_requetes_ELTPARAGRAPHE000140"></a>La fonction **SQLTable** permet d'associer à un champ Table par programmation les requêtes créées avec la fonction [SQLExec](../WDLang4/3072007.md).
...
<a name="gestion_unicode_ELTPARAGRAPHE000177"></a>La gestion de l'Unicode peut être définie au niveau de la configuration de projet (onglet "Unicode" de la fenêtre de description de la configuration) : 
