...
Une variable de type **Description de Rubrique** permet de décrire par programmation une ou plusieurs rubriques d'une table. La description de chaque rubrique est validée par la fonction [HDécritRubrique](../WDLang4/3044233.md).

Après cette validation:

- Cette rubrique pourra être manipulée comme n'importe quelle rubrique décrite dans le schéma des données.

- La variable de type "Description de Rubrique" est réinitialisée et pourra être utilisée pour décrire par programmation une autre rubrique de table.
...
// Validation de la description de la table UneTable
...
```
...
<a name="proprietes_specifiques_description_rubriques_par_programmation_ELTPARAGRAPHE000078"></a>
...
| [LargeurMaxVignette](../Proprietes/2512112.md) | Définir la largeur maximale d'une vignette d'une rubrique. |
...
| [PersistanceRubriqueCalculée](../Proprietes/1000021858.md) | Définir si la valeur d'une rubrique calculée (de type Formule) est mémorisée dans la table. |
...
<a name="comment_decrire_des_tables_par_programmation_ELTPARAGRAPHE000353"></a>
...
<a name="manipulation_des_rubriques_une_table_decrit_par_programmation_ELTPARAGRAPHE000395"></a>
...
Pour que les noms de la table décrit par programmation et de ses rubriques soient reconnus par le compilateur, il est nécessaire de déclarer le nom de la table en tant que [source de données](../WDLang4/1514053.md). Ce table et ses rubriques pourront alors être manipulés par leur nom sous l'éditeur de code.
...
### Journalisation
<a name="journalisation_ELTPARAGRAPHE000421"></a>
