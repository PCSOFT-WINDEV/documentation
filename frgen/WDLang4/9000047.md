...
## Présentation
<a name="presentation_ELTTEXTE000308"></a>
...
- réplication directe, <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=replication_directe_prog.gif)


- réplication par serveur avec réplica immédiat ou périodique. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=replication_serveur_prog.gif)
...
<a name="base_donnees_hfsql_classic_mise_place_replication_par_programmation_ELTTEXTE000332"></a>
...
### Etape 1: Programmation de l'accès aux tables HFSQL Classic en local
<a name="etape_1_programmation_acces_aux_tables_hfsql_classic_local_ELTPARAGRAPHE000027"></a>
...
Il est donc nécessaire de modifier l'application pour qu'elle puisse accéder aux tables locales. Il est nécessaire de programmer:
...
<a name="etape_2_description_replication_ELTPARAGRAPHE000050"></a>
...
<a name="etape_3_programmation_replication_ELTPARAGRAPHE000068"></a>
...
<a name="NOTE3_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/us/HF.png)![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png) 

### Etape 4: Déploiement de l'application
<a name="etape_4_deploiement_application_ELTPARAGRAPHE000101"></a>
...
**Réplication assistée directe (sans serveur de réplication)**: Il est nécessaire d'intégrer le fichier .WER aux fichiers installés par l'application. Le fichier .WER doit contenir toutes les caractéristiques des chemins aux tables maître utilisées par l'application. Il n'est pas possible d'inclure le fichier .WER dans la bibliothèque (fichier WDL).

Si lors de la création du fichier .WER, la localisation des tables de la base maître n'est pas connue, il est nécessaire de l'indiquer pour chaque poste client installé. Cette opération peut être réalisée:
...
<a name="base_donnees_hfsql_clientserveur_mise_place_replication_par_programmation_ELTTEXTE000374"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/us/HFCS.png)![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) 

### Etape 1: Programmation de l'accès aux fichiers en local
<a name="etape_1_programmation_acces_aux_fichiers_local_ELTPARAGRAPHE000140"></a>
...
- **Définition de connexions au niveau du schéma des données**: Les connexions doivent être décrites au niveau du schéma des données. Chaque fichier est associé à une connexion.
...
**Mise en place**: Si votre application utilise des tables nécessitant une connexion ou plusieurs connexions (HFSQL Client/Serveur, accès natifs, tables OLE DB, ...): il est conseillé de réaliser les manipulations suivantes:

- sous l'éditeur de schémas des données: si vos fichiers ne sont pas associés à des connexions, créez autant de connexions de test que nécessaire. Par exemple, si vous utilisez des données HFSQL Client/Serveur et des données Oracle, vous définissez deux connexions de test dans le schéma des données.

- dans votre code, modifiez les connexions associées aux tables: il suffit de modifier les paramètres des connexions de test pour manipuler des tables HFSQL Classic locales. Par exemple, le code suivant permet de définir une connexion locale sur des tables HFSQL:
...
<a name="etape_1_bis_utilisation_base_donnees_non_hfsql_ELTPARAGRAPHE000167"></a>
...
### Etape 2: Description de la réplication
<a name="etape_2_description_replication_ELTPARAGRAPHE000176"></a>

La description de la réplication est réalisée grâce à ReplicEdit. Cet outil permet de:

- définir les fichiers pris en compte par la réplication, les filtres pris en compte lors de la mise à jour des données. Pour plus de détails, consultez [Créer une réplication avec ReplicEdit](../ReplicEdit/3526501.md).

- paramétrer la localisation des fichiers maîtres. Il suffit de redéfinir les connexions du schéma des données. La liste des connexions est donnée par l'option "Réplication .. Description des connexions" de ReplicEdit. Pour plus de détails, consultez [Options de réplication définies dans ReplicEdit](../ReplicEdit/3526502.md).
...
<a name="NOTE4_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/us/HFCS.png)![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) 

### Etape 3: Programmation de la réplication
<a name="etape_3_programmation_replication_ELTPARAGRAPHE000196"></a>
...
### Etape 4: Déploiement de l'application
<a name="etape_4_deploiement_application_ELTPARAGRAPHE000229"></a>
...
[Réplication universelle assistée](../WDLang4/9000045.md)

[Réplication universelle assistée: spécificités](../WDLang4/9000048.md)

[ReplicEdit: Editeur de réplication](../WDLang4/3526500.md)

[Réplication des données mobiles (Android ou iOS)](../WDLang4/1000021071.md)
