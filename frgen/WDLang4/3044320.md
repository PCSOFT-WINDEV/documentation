...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003044320&name=hinfodroitbasededonnees_fonction">Voir des exemples supplémentaires</a>
...
| *hDroitCréationFichier* | Droit de créer une table (avec la fonction [HCrée](../WDLang4/3044255.md)). |
