...
La fonction **HLitSuivant** permet de se positionner dans la table lors d'une boucle de parcours. Cette fonction peut être exécutée uniquement: 

- à la suite d'une fonction amorçant un parcours (par exemple [HLitPremier (Fonction)](../WDLang4/3044051.md) ou [HRecherchePremier (Fonction)](../WDLang4/3044125.md)),

- après un appel à la fonction [HChangeClé (Fonction)](../WDLang4/3044151.md).
...
`<Résultat> = HLitSuivant([<Table> [, <Rubrique de parcours>] [, <Options>]])`
---
...
Nom de la table, de la vue ou de la requête manipulée. Si ce paramètre correspond à une chaîne vide (""), la fonction **HLitSuivant** manipule la dernière table utilisée par la dernière fonction de gestion HFSQL (fonction commençant par la lettre H).

**`<Rubrique de parcours> : (Chaîne de caractères optionnelle)`**

Nom de la rubrique utilisée pour parcourir la table, la vue ou la requête. Si ce nom n'est pas spécifié, la fonction **HLitSuivant** va utiliser:
...
<a name="lecture_selon_une_rubrique_cle_non_ELTPARAGRAPHE000254"></a>

Si la rubrique utilisée est une clé, la fonction **HLitSuivant** lit l'enregistrement pour lequel la valeur de la clé est la plus grande. L'ordre de tri pris en compte est l'ordre de tri spécifié dans le schéma des données pour cette clé. 
...
Si la rubrique n'est pas une clé, la fonction **HLitSuivant** lit l'enregistrement actif suivant. En cas de parcours de la table, les enregistrements seront triés selon leur numéro d'enregistrement. 
...
### Mémos
<a name="memos_ELTPARAGRAPHE000289"></a>
...
<a name="parcours_des_enregistrements_correspondant_une_condition_ELTPARAGRAPHE000306"></a>
...
<a name="modification_valeur_cle_parcours_ELTPARAGRAPHE000358"></a>
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000379"></a>
...
### Divers
<a name="divers_ELTPARAGRAPHE000394"></a>
