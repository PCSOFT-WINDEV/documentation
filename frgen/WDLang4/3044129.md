...
En général, la fonction **HRechercheDernier** permet de se positionner dans la table pour effectuer une boucle de parcours parmi les enregistrements correspondant à une condition.
...
`<Résultat> = HRechercheDernier(<Table> , <Rubrique clé> , <Valeur recherchée> [, <Options>])`
---
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Accès par JDBC: Ce paramètre est ignoré.![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) Si le provider OLE DB ou le Connecteur Natif utilisé ne gère pas les blocages, les options de blocage seront sans effet.![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png) Le mode de blocage spécifié avec la fonction **HRechercheDernier** restera effectif lors des appels aux fonctions [HPrécédent](../WDLang4/3044112.md) et [HSuivant](../WDLang4/3044027.md).
...
<a name="recherche_generiquerecherche_identique_ELTPARAGRAPHE000270"></a>
...
<a name="recherche_sur_une_cle_composee_ELTPARAGRAPHE000371"></a>
...
<a name="recherche_sur_une_rubrique_tableau_ELTPARAGRAPHE000402"></a>
...
### Recherche et filtre
<a name="recherche_filtre_ELTPARAGRAPHE000411"></a>
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000428"></a>
