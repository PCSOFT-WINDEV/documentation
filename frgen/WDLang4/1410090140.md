...
Permet de savoir si une géométrie A couvre une géométrie B. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FormeCouvre.gif)
Remarques : 
...
<a name="parcours_des_donnees_spatiales_utilisation_des_index_spatiaux_ELTPARAGRAPHE000342"></a>

Il est possible d'effectuer un parcours sur une table avec un filtre concernant des données spatiales. Par exemple, le filtre utilisé peut être basé sur le résultat de la fonction **GéométrieCouvre**.
