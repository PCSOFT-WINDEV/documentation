...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Les transactions peuvent être utilisées uniquement avec des tables HFSQL Client/Serveur.
...
### Principe des transactions sur des tables HFSQL Client/Serveur et HFSQL Classic
<a name="principe_des_transactions_sur_des_tables_hfsql_clientserveur_hfsql_classic_ELTPARAGRAPHE000029"></a>
...
- lors du redémarrage du serveur. Attention: la transaction n'est pas annulée si la transaction porte sur un fichier avec mot de passe sécurisé. La transaction sera annulée à la prochaine ouverture de la table.
...
## Gestion avancée
<a name="gestion_avancee_ELTTEXTE000267"></a>


### Fichiers créés par une transaction
<a name="fichiers_crees_par_une_transaction_ELTPARAGRAPHE000068"></a>

Lors de la mise en place des transactions, plusieurs types de tables HFSQL sont créés:
...
- **le journal des valeurs**: Table associée à chaque table prise en compte par la transaction. Ce fichier s'appelle &lt;NomFichier&gt;.TRX. Ce fichier contient pour chaque opération réalisée dans la transaction:
...
<a name="identifiant_poste_realisant_transaction_ELTPARAGRAPHE000112"></a>
...
<a name="erreurs_specifiques_gestion_des_transactions_mode_hfsql_clientserveur_ELTPARAGRAPHE000138"></a>
