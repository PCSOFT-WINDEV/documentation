...
<a name="fonctions_sqlcol_sqllitcol_differents_types_parcours_ELTPARAGRAPHE000074"></a>Les fonctions **SQLCol** et [SQLLitCol](../WDLang4/3072019.md) sont équivalentes lors d'un accès OLE DB ou HFSQL. Il faut cependant respecter le type de parcours associé à chacune de ces fonctions :
...
<a name="ligne_cours_requete_ELTPARAGRAPHE000103"></a>Pour se positionner sur une ligne de la requête, utilisez une des fonctions suivantes : [SQLPremier](../WDLang4/3072017.md), [SQLSuivant](../WDLang4/3072030.md), [SQLPrécédent](../WDLang4/3072022.md), [SQLDernier](../WDLang4/3072009.md) ou [SQLPositionne](../WDLang4/3072024.md).
<a name="NOTE0_3"></a>
...
<a name="requete_sans_resultat_ELTPARAGRAPHE000126"></a>La fonction **SQLCol** ne doit pas être appelée si la requête n'a pas renvoyé de résultat : il faut tester la variable *SQL.EnDehors* après s'être positionné dans le résultat de la requête et avant d'appeler la fonction **SQLCol**.
...
<a name="utilisation_tabulations_dans_les_rubriques_ELTPARAGRAPHE000143"></a>Les fonctions SQL permettent d'insérer des tabulations dans les rubriques des fichiers. La gestion des tabulations dépend du mode d'accès utilisé.
...
<a name="NOTE0_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png)![ODBC](https://doc.pcsoft.fr/ext/images/us/ODBC.png) 

### Récupération de rubriques de type Float sur Oracle (via ODBC)
<a name="recuperation_rubriques_type_float_sur_oracle_via_odbc_ELTPARAGRAPHE000206"></a>Par défaut, le séparateur décimal utilisé pour les rubriques de type Float sur Oracle est le point. Or le driver ODBC renvoie la valeur avec en utilisant la virgule comme séparateur décimal. Lors de l'affectation de la valeur dans un champ de type numérique, les décimales sont perdues.
...
<a name="gestion_des_espaces_fin_des_rubriques_texte_ELTPARAGRAPHE000220"></a>La gestion des espaces à la fin des rubriques récupérées dépend du mode d'accès utilisé : 
