...
<a name="reconnexion_serveur_ELTPARAGRAPHE000065"></a>
...
- L'application a bloqué toute une table.

- L'application a effectué un blocage en "lecture/écriture" sur une table.

- L'application a effectué un blocage en "écriture" sur une table et une autre application a modifié cet enregistrement pendant la période où l'application n'était pas connectée.
