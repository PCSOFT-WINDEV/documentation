...
<a name="mettre_place_replication_universelle_ELTTEXTE000382"></a>


### Fonctionnement de la réplication
<a name="fonctionnement_replication_ELTPARAGRAPHE000052"></a>
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Replication_universelle.gif)

<a name="NOTE2_2"></a>


### Structure de la base de données
<a name="structure_base_donnees_ELTPARAGRAPHE000059"></a>
...
| [HRplGestionTable](../WDLang4/1000017215.md) | Définit les options utilisées pour la réplication universelle d'un fichier. |
...
<a name="etape_1_mise_place_sur_site_maitre_ELTPARAGRAPHE000098"></a>
...
3. **Création des tables de l'application** (optionnel)
	Si les tables n'existent pas, vous pouvez créer les tables vides (fonction [HCrée](../WDLang4/3044255.md)). Ces données seront manipulées par les utilisateurs du site maître.
...
<a name="etape_2_preparation_des_donnees_site_abonne_ELTPARAGRAPHE000135"></a>
...
<a name="etape_3_mise_place_sur_site_abonne_ELTPARAGRAPHE000181"></a>
...
2. Le site abonné doit créer sa base de données vierge (fonction [HCrée](../WDLang4/3044255.md)) avant la première synchronisation:
...
<a name="etape_4_synchronisation_initiale_des_sites_maitre_abonnes_ELTPARAGRAPHE000201"></a>
...
2. **Intégration du réplica transportable dans la base abonnée**: 
	...
	```wl
	sReplicaTransportable = gsRépertoireMaître + RPL.Table
...
- Tous les fichiers d'une base de données ne doivent pas obligatoirement être répliqués. Répliquez uniquement les tables nécessaires. 
...
<a name="etape_5_synchronisations_quotidiennes_ELTPARAGRAPHE000234"></a>
...
## Remarques
<a name="remarques_ELTTEXTE000442"></a>


- **Vérifiez les fichiers répliqués. Tous les fichiers d'une base de données ne doivent pas obligatoirement être répliqués. Répliquez uniquement les tables nécessaires.**
...
## Limitations
<a name="limitations_ELTTEXTE000466"></a>
