...
POUR TOUT ConfigRéplication DE listeRS
	...
	SI PAS RSIgnoreErreur(ConnexionHFAbonné, ConfigRéplication) ALORS
		Trace(HErreurInfo())
	SINON
		Trace("OK")
	FIN
...
`<Résultat> = RSIgnoreErreur(<Connexion> , <Réplication>)`
---
...
Dans ce cas, l'utilisation de la fonction **RSIgnoreErreur** sur le serveur abonné permet d'ignorer le fichier journal corrompu et de passer au journal suivant. 
