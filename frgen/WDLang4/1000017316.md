...
<a name="mode_isolation_read_uncommitted_ELTTEXTE000338"></a>
...
<a name="exemple_cas_une_gestion_stock_ELTPARAGRAPHE000053"></a>

Considérons une table PRODUIT avec un article Art01 dont la quantité en stock est de 10.
...
<a name="exemple_cas_une_modification_client_ELTPARAGRAPHE000077"></a>
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Isolation_ReadUncommitted.gif)
...
<a name="mettre_place_mode_isolation_read_uncommitted_ELTPARAGRAPHE000087"></a>

Pour mettre en place le mode d'isolation READ UNCOMMITTED, il faut: 

- Utiliser des tables HFSQL en mode Client/Serveur. 
...
<a name="mode_isolation_read_committed_ELTTEXTE000380"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000116"></a>
...
### Exemple: Cas d'une gestion de stock
<a name="exemple_cas_une_gestion_stock_ELTPARAGRAPHE000125"></a>
...
### Exemple: Cas d'une modification d'un client
<a name="exemple_cas_une_modification_client_ELTPARAGRAPHE000149"></a>
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Isolation_ReadCommitted.gif)
...
<a name="mettre_place_mode_isolation_read_committed_ELTPARAGRAPHE000159"></a>
...
<a name="mode_isolation_repeatable_read_ELTTEXTE000422"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000188"></a>
...
### Exemple: Cas d'une gestion de stock
<a name="exemple_cas_une_gestion_stock_ELTPARAGRAPHE000199"></a>
...
### Exemple: Cas d'une modification d'un client
<a name="exemple_cas_une_modification_client_ELTPARAGRAPHE000227"></a>
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Isolation_RepeatableRead.gif)
...
<a name="mettre_place_mode_isolation_repeatable_read_ELTPARAGRAPHE000238"></a>
...
- Activer le mode REPEATABLE READ dans chaque table du schéma des données en transaction. Cette option est disponible dans l'onglet "Détail" de la fenêtre de description de la table. Une modification automatique des tables est nécessaire pour prendre en compte ce paramètre. Attention: si cette option est activée, la table est incompatible avec les versions 18 et antérieures.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RepeatableReadSupport%E9%20-%20HC%20N%B0001.gif)
...
**Astuce**: Pour savoir si le mode REPEATABLE READ est activé sur une table, utilisez la propriété [RepeatableReadSupporté](../Proprietes/1000020959.md). 
...
[HTransactionIsolation (Fonction)](../WDLang4/1000020926.md)
