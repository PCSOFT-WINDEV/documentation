...
## Serveur Manta
<a name="serveur_manta_ELTTEXTE000301"></a>
...
- du service **Manta**. 
	...
	Remarque: En cas de défaillance, le service est automatiquement redémarré.Sous WINDEV:

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ClientServeur_XManta03.gif)
Sous WEBDEV:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_ClientServeur_XManta03.gif)
...
<a name="est_installe_serveur_manta_ELTTEXTE000325"></a>


### Comment installer HFSQL Client/Serveur?
<a name="comment_installer_hfsql_clientserveur_ELTPARAGRAPHE000031"></a>
...
<a name="installation_sous_linux_ELTPARAGRAPHE000054"></a>
...
<a name="installation_via_systeme_integre_debian_ELTPARAGRAPHE000099"></a>Pour utiliser ce mode d'installation:
...
<a name="installation_via_systeme_integre_redhat_derive_ELTPARAGRAPHE000118"></a>Pour utiliser ce mode d'installation, veuillez effectuer les actions suivantes:
...
<a name="installation_via_docker_ELTPARAGRAPHE000129"></a>Pour utiliser ce mode d'installation, utilisez l'adresse suivante:
...
- soit sur le poste de développement:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ClientServeur_XManta02.gif)


- soit sur le poste serveur: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ClientServeur_XManta.gif)
...
<a name="centre_controle_hfsql_outil_administration_serveur_distance_ELTTEXTE000379"></a>
...
- visualiser les connexions en cours sur une base de données ou sur une table.
...
| **4** | **Répertoire DonnéesApplicationA**<br>Ce répertoire contient l'ensemble des tables utilisées par "ApplicationA". Le nom de ce répertoire est défini lors de la [création de la connexion utilisée par l'application](../WDLang4/3044301.md). |
...
| **6** | **Tables de DonnéesApplicationA**<br>Ensemble des tables utilisées par "ApplicationA".<br>Comme présenté dans le point 7, ces tables peuvent être également présentes dans plusieurs sous-répertoires.<br>**Remarque**: Une même application peut utiliser des tables provenant de plusieurs bases de données. |
| **7** | **Tables de DonnéesApplicationB**<br>Ensemble des tables utilisées par "ApplicationB", présentes dans plusieurs sous-répertoires.<br>**Remarque**: Une même application peut utiliser des tables provenant de plusieurs bases de données. |
...
<a name="desinstallation_des_services_serveur_ELTTEXTE000427"></a>


### Vous pouvez désinstaller les services d'un serveur
<a name="vous_pouvez_desinstaller_les_services_serveur_ELTPARAGRAPHE000251"></a>
