...
Si ce paramètre est égal à une chaîne vide (""), la gestion automatique sera désactivée. Dans le cas d'une déconnexion, la connexion est fermée par le serveur. Une erreur sera alors affichée lors du prochain accès à une table.
...
<a name="personnalisation_affichage_des_messages_ELTPARAGRAPHE000111"></a>
