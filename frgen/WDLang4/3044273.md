...
Le pilote est disponible en lecture et en écriture. Une application écrite dans un langage tiers peut lire et écrire dans des tables HFSQL.  
...
### Installation
<a name="installation_ELTPARAGRAPHE000020"></a>
...
## Configuration
<a name="configuration_ELTTEXTE000149"></a>


### Pour utiliser le driver ODBC sur HFSQL, configurez le driver ODBC:
<a name="pour_utiliser_driver_odbc_sur_hfsql_configurez_driver_odbc_ELTPARAGRAPHE000031"></a>
...
8. Sélectionnez le fichier WDD correspondant au schéma des données grâce au bouton "Parcourir".

9. Dans la liste des schémas des données, sélectionnez le schéma des données voulu puis sélectionnez le répertoire des tables correspondant (bouton "Parcourir"). Toutes les tables HFSQL correspondant au schéma des données sélectionné sont regroupées dans ce répertoire.
...
<a name="utiliser_driver_odbc_sur_hfsql_depuis_votre_programme_java_ELTPARAGRAPHE000053"></a>
...
## Problèmes connus
<a name="problemes_connus_ELTTEXTE000197"></a>
