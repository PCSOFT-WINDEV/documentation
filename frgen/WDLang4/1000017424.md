...
L'avantage d'un serveur spare est la mise en oeuvre simplissime de l'infrastructure. Par rapport à une réplication, il n'est pas nécessaire que la table (la table) dispose de rubrique de type Identifiant automatique sur 8 octets.
...
<a name="mettre_place_replication_spare_ELTTEXTE000151"></a>
...
<a name="fonctionnalites_specifiques_ELTTEXTE000175"></a>
...
- Gestion de l'intégrité et mot de passe sécurisé: Pour que la gestion de l'intégrité sur des tables avec mots de passe soit prise en compte par la réplication, il est nécessaire que toutes les tables intervenant dans la contrainte d'intégrité aient le même mot de passe. Dans le cas contraire, la réplication ne sera pas effectuée. 
...
## Questions / réponses
<a name="questions_reponses_ELTTEXTE000199"></a>
