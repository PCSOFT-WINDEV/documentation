...
<a name="creer_une_cle_composee_ELTTEXTE000433"></a>
La création d'une clé composée est réalisée directement sous l'éditeur de schémas des données.

Pour créer une clé composée dans la description d'une table:

1. Affichez la description des rubriques de la table: 
...
2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Manipulations_rubriques%20-%20HC%20N%B0001%207.gif). Un écran permettant de construire la clé composée apparaît.

3. Dans le tableau de gauche, la liste des rubriques existantes dans la table apparaît. Double-cliquez sur les rubriques devant participer à la clé composée. Ces rubriques apparaissent dans le tableau de droite.
...
6. Validez. La clé composée apparaît dans la liste des rubriques de la table.
...
<a name="cle_composee_liaison_ELTPARAGRAPHE000071"></a>

Il est possible d'utiliser des clés composées dans des liaisons entre tables. Lors de la description du schéma des données, la clé composée présente dans la table liée apparaît alors non plus comme une clé composée mais comme une ***clé binaire***. Il ne sera pas possible d'accéder aux différentes composantes de la clé composée dans la table reliée.
...
<a name="valeur_une_cle_composee_ELTTEXTE000463"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000085"></a>
...
<a name="ajout_enregistrement_contenant_une_cle_composee_ELTPARAGRAPHE000092"></a>
...
### Ajout d'un enregistrement contenant une clé composée dans une table reliée
<a name="ajout_enregistrement_contenant_une_cle_composee_dans_une_table_reliee_ELTPARAGRAPHE000099"></a>

Lors de l'ajout d'un enregistrement contenant une clé composée dans une table reliée, il est nécessaire de construire la valeur de la clé. En effet, dans la table reliée, la clé composée n'est pas considérée comme une clé composée, mais comme une clé binaire. Il est donc nécessaire de lui affecter une valeur.

Cette valeur peut être affectée:

- soit directement. Par exemple, un enregistrement a été ajouté dans la table Client. Pour ajouter la valeur de la clé dans la table reliée, il suffit de réaliser une affectation directe: 
...
<a name="construire_valeur_une_cle_composee_pour_realiser_une_recherche_filtre_ELTPARAGRAPHE000116"></a>
...
**Exemple**: Recherche de tous les enregistrements de la table Client dont le nom et le prénom sont compris entre "AA","Barnabé" et "Philomène" et "Tartuffe".
...
**Exemple**: Recherche de tous les enregistrements de la table Taches dont les tâches sont comprises entre le 15/03/2011 00h00 et le 25/03/2011 00h00.
...
Il est possible de construire la valeur d'une clé composée avec la fonction [HConstruitValClé](../WDLang4/3044258.md). Il suffit de préciser dans cette fonction, la table concernée, le nom de la clé et les valeurs des composantes.

Par exemple, pour construire la valeur de la clé composée "NOMDATE" correspondant à "NOMCLIENT+DATE_ENTREE" de la table Client, il suffit d'utiliser la ligne de code:
...
<a name="proprietes_wlangage_permettant_manipuler_les_cles_composees_ELTPARAGRAPHE000188"></a>Les principales propriétés permettant de manipuler les clés composées par programmation sont les suivantes:
...
<a name="utiliser_une_cle_composee_pour_realiser_des_recherches_identique_ELTTEXTE000538"></a>


### Recherche à l'identique avec HLitRecherchePremier
<a name="recherche_identique_avec_hlitrecherchepremier_ELTPARAGRAPHE000198"></a>
...
<a name="recherche_identique_hlitrecherche_ELTPARAGRAPHE000221"></a>
...
<a name="utiliser_une_cle_composee_pour_realiser_des_recherches_generiques_ELTTEXTE000568"></a>


### Recherche générique avec HLitRecherchePremier
<a name="recherche_generique_avec_hlitrecherchepremier_ELTPARAGRAPHE000246"></a>
...
<a name="recherche_generique_avec_hlitrecherche_ELTPARAGRAPHE000269"></a>
...
<a name="utiliser_une_cle_composee_pour_realiser_des_filtres_ELTTEXTE000598"></a>


### Fonctions disponibles pour réaliser des filtres
<a name="fonctions_disponibles_pour_realiser_des_filtres_ELTPARAGRAPHE000294"></a>

En plus de la fonction [HFiltre](../WDLang4/3044100.md), le WLangage propose différentes fonctions permettant de réaliser des filtres spécifiques. Ces fonctions peuvent manipuler des clés composées:
...
<a name="filtre_entre_deux_valeurs_donnees_deux_bornes_ELTPARAGRAPHE000305"></a>
...
<a name="filtre_partir_une_valeur_donnee_ELTPARAGRAPHE000324"></a>
...
<a name="filtre_sur_les_premiers_composants_cle_ELTPARAGRAPHE000343"></a>
...
<a name="remarque_filtre_avec_condition_selection_ELTPARAGRAPHE000360"></a>

Si la condition du filtre porte sur plusieurs rubriques correspondant à une clé composée de la table, la clé de parcours automatiquement choisie pour le filtre sera cette clé composée.
...
[Éditeur de schémas des données : Description des liaisons](../WDLang4/2011008.md)
