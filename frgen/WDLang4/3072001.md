...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Les fonctions SQL permettent de manipuler des bases de données locales (de type Web SQL database). Pour plus de détails, consultez [Accès en mode local à une base de données (SQLite)](../WDLang4/9000119.md).![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) La fonction **SQLColonne** renvoie uniquement les caractéristiques des colonnes d'une requête donnée. La requête doit avoir renvoyé un résultat pour obtenir ses caractéristiques.
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Les résultats concernant les types et les tailles des colonnes peuvent être différents des résultats obtenus en WINDEV.
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) **Attention** : Si la requête n'a pas renvoyé de résultat, les caractéristiques des colonnes ne peuvent pas être connues. 
...
<a name="detail_des_informations_sur_les_colonnes_ELTPARAGRAPHE000173"></a>Si le paramètre &lt;Détails&gt; est à <u><u><u><u>Vrai</u></u></u></u>, la chaîne de caractères contient les noms de toutes les colonnes d'une table avec diverses informations sur ces colonnes (nom, type, taille) sous la forme : 
...
<a name="NOTE0_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 

### Astuce : Comment accélérer le temps d'exécution de la fonction SQLColonne ? 
<a name="astuce_comment_accelerer_temps_execution_fonction_sqlcolonne_ELTPARAGRAPHE000359"></a>Il suffit de préfixer le nom de la table par le propriétaire : le résultat sera quasi immédiat : 
