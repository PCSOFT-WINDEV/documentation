...
- La fonction **PageVersDonnées** ne permet pas d'écrire dans la table : seules les variables des rubriques de la table sont affectées (c'est-à-dire les variables de l'enregistrement chargé en mémoire). Pour modifier les enregistrements, il faut utiliser les fonctions [HAjoute](../WDLang4/3044147.md), [HModifie](../WDLang4/3044042.md), [HEcrit](../WDLang4/3044092.md), etc.
...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_une_table_ELTPARAGRAPHE000090"></a>
...
<a name="mise_jour_des_rubriques_cas_particuliers_ELTPARAGRAPHE000106"></a>



- Pour affecter automatiquement la valeur NULL à une rubrique avec la fonction **PageVersDonnées**:
...
- La fonction **PageVersDonnées** n'affecte pas les rubriques pour les champs de type Image. Utilisez la fonction [HAttacheMémo](../WDLang4/3044173.md).
