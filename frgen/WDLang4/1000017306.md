...
### Principe
<a name="principe_ELTPARAGRAPHE000026"></a>
...
<a name="quand_compresser_les_trames_reseau_ELTPARAGRAPHE000039"></a>
...
La fonction [HQualitéConnexion](../WDLang4/1000018291.md) peut être utilisée en dernier recours pour comparer les performances d'une connexion compressée et celles d'une connexion non compressée.
<a name="NOTE2_3"></a>


### Comment utiliser la compression de trames?
<a name="comment_utiliser_compression_trames_ELTPARAGRAPHE000070"></a>

La compression des trames est une propriété de la connexion.

**Pour utiliser la compression de trames**: 

- ***si la connexion est définie dans l'éditeur de schémas des données***, il est possible de modifier les caractéristiques de la connexion:

	- sous le volet "Schéma des données", dans le groupe "Connexion", cliquez sur "Connexions". 
...
- ***si la connexion est définie par programmation***, plusieurs possibilités sont à votre disposition:
	...
	- fonctions [HOuvreConnexion](../WDLang4/3044107.md) et [HDécritConnexion](../WDLang4/3044205.md): le paramètre &lt;Informations étendues&gt; permet de spécifier si la compression doit être réalisée.

	- propriété [Compression](../Proprietes/1000017276.md) (utilisable par exemple avec le type [Connexion](../WDLang4/1514073.md)): cette propriété permet de définir si la compression des données doit être réalisée.
...
[Compression (Propriété)](../WDLang4/1000017276.md)
