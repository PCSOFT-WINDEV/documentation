...
|   |
| --- |
| **Attention** : La fonction **HRégénèreTable** permet de recréer une table à partir de la description du journal. <br><br>**Cette fonction est réservée à une utilisation avancée.** Mal utilisée, cette fonction peut détruire ou corrompre les données. |
...
HRégénèreTable("C:\Journal\ClientJNL.fic", hStructure + hDonnées)
```
...
### Régénération de la table en mode HFSQL Classic
...
- <u><u><u><u>Vrai</u></u></u></u> si la table a été régénérée,
...
| *hStructure* | Un nouveau table vide est créé à partir de la description de la table contenue dans le fichier journal. Si la table existe déjà, elle est effacée puis recréée. |
...
[&lt;Variable Connexion&gt;.RégénèreTable (Fonction)](../WDLang4/1000023964.md)
