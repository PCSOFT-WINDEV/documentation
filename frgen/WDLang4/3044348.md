...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Remarque**: Il est conseillé d'afficher les vignettes dans un champ Vignette (et non dans un champ Image). 

![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Pour utiliser les vignettes HFSQL sous Linux, la librairie libfreetype6 (libfreetype.so.6) doit être installée sur le poste en cours.
...
<a name="gerer_des_vignettes_hfsql_ELTPARAGRAPHE000043"></a>

Pour gérer des vignettes HFSQL: 

1. Sous l'éditeur de schémas des données, sélectionnez la table contenant la rubrique de type mémo binaire HFSQL.

2. Double-cliquez sur la table pour afficher la description des rubriques.

3. Sélectionnez la rubrique voulue.

4. Cochez l'option "Gestion automatique des vignettes" et cliquez sur le bouton "Editer".
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Vignettes%20HFSQL%20-%20HC%20N%B0001.GIF)
...
<a name="taille_champ_affichant_image_taille_vignette_ELTPARAGRAPHE000090"></a>
...
### Nombre de vignettes
<a name="nombre_vignettes_ELTPARAGRAPHE000099"></a>
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Les vignettes sont disponibles uniquement en HFSQL Client/Serveur sur les rubriques d'une table.
<a name="NOTE4_2"></a>


### Version 9 et inférieure
<a name="version_9_inferieure_ELTPARAGRAPHE000122"></a>
...
Le tableau suivant présente l'utilisation des mémos binaires et des vignettes dans une application 9 (ou inférieure) et dans une application 19 utilisant les mêmes tables:
