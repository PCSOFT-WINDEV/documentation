...
## Blocage des tables : correspondance WINDEV 5.5 et les versions supérieures
...
<a name="blocage_version_55_ELTTEXTE000182"></a>
...
<a name="blocage_dans_les_versions_suivantes_ELTTEXTE000206"></a>
...
**Dans une nouvelle application WINDEV 2026, par défaut, en mode multi-utilisateurs, la gestion des blocages est automatiquement gérée par le moteur HFSQL**. Il est possible de la personnaliser grâce à la fonction [HSurErreur](../WDLang4/3044017.md).
...
<a name="blocages_lors_migration_projet_vers_une_version_superieure_ELTTEXTE000230"></a>
...
**Remarque** : Un projet migré en version 2026 conservera sa propre gestion des blocages. Le code est migré pour que cette gestion des blocages continue à fonctionner.
...
## Remarques
<a name="remarques_ELTTEXTE000254"></a>




### Cas HModePerso(Vrai)
<a name="cas_hmodepersovrai_ELTPARAGRAPHE000058"></a>
...
### Cas HModePerso(Faux)
<a name="cas_hmodepersofaux_ELTPARAGRAPHE000074"></a>
...
- Attention : Dans le cas d'une lecture d'un enregistrement bloqué en lecture/écriture (par exemple si la fonction [HBloqueTable](../WDLang4/3044153.md) a été appelée) :
...
### Cas HModeSemiPerso()
<a name="cas_hmodesemiperso_ELTPARAGRAPHE000097"></a>
...
### Cas HModeAuto
<a name="cas_hmodeauto_ELTPARAGRAPHE000124"></a>
