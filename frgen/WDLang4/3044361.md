...
**Remarque**: La fonction [HErreurInfo](../WDLang4/3044071.md) renvoie une information détaillée sur la dernière erreur survenue lors de la gestion des fichiers par un Connecteur Natif.
...
<a name="les_differents_codes_erreur_communs_tous_les_connecteurs_natifs_ELTTEXTE000310"></a>
...
Cette opération nécessite un parcours amorcé. Or aucune parcours n'a été amorcé sur la table spécifiée.
...
**17: Erreur WLangage**
Erreur de programmation WLangage relative aux possibilités du Connecteur Natif. La structure de la table ne permet pas cette opération. Aucune rubrique de parcours satisfaisante n'a été trouvée.
...
Erreur de programmation ou modification non compatible de la structure du fichier sur la base. La description du fichier spécifié sur la base n'est pas compatible avec la description du fichier dans le schéma des données.
Plusieurs solutions sont envisageables:

- Synchroniser le schéma des données avec la base de données et recompiler le programme.

- Modifier la structure du fichier sur la base.

- Recréer le fichier avec la fonction **HCrée** (les enregistrements contenus dans le fichier sont alors perdus). 
...
Le fichier n'existe pas sur la base de données. Utilisez la fonction **HCrée** pour créer le fichier.
...
<a name="les_differents_codes_erreur_specifiques_certains_connecteurs_natifs_ELTTEXTE000334"></a>
...
<a name="codes_erreurs_specifiques_auconnecteur_natif_mysql_ELTPARAGRAPHE000227"></a>
