...
Si ce paramètre correspond à une chaîne vide (""), le fichier de description sera créé dans le répertoire en cours des tables HFSQL (défini sous l'éditeur de schémas des données ou par programmation).
...
<a name="replication_journalee_repertoires_creation_des_fichiers_necessaires_replication_journalisation_ELTPARAGRAPHE000165"></a>
...
Par défaut, l'arborescence des fichiers est la suivante (exemple pour l'application GesCom):<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Replic_repertoire.gif)
...
[HGèreRéplication (Fonction)](../WDLang4/3044067.md)
...
[HRecréeRéplicaAbonné (Fonction)](../WDLang4/3044350.md)
