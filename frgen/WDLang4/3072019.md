...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Les requêtes créées avec l'éditeur de requête doivent être spécifiées sous forme d'une chaîne de caractères avec guillemets. 
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Les colonnes peuvent être récupérées dans n'importe quel ordre.
...
<a name="ligne_cours_requete_ELTPARAGRAPHE000102"></a>La ligne en cours est positionnée par la fonction [SQLFetch](../WDLang4/3072011.md).
...
<a name="colonnes_requete_ELTPARAGRAPHE000114"></a>
...
- Pour lire les colonnes de type mémo, utilisez la fonction [SQLLitMémo](../WDLang4/3072020.md). Pour lire les colonnes de type mémo texte, utilisez la fonction [SQLLitMémoTexte](../WDLang4/3072012.md). 
	![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Les fonctions [SQLLitMémo](../WDLang4/3072020.md) et [SQLLitMémoTexte](../WDLang4/3072012.md) sont inutiles.
	![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) La lecture des colonnes de type mémo n'est pas disponible.
...
- La même colonne ne peut pas être récupérée plusieurs fois à la suite. En effet, la seconde fois, le résultat récupéré sera une chaîne vide.
	![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) La même colonne peut être récupérée plusieurs fois à la suite.
...
<a name="requete_sans_resultat_ELTPARAGRAPHE000169"></a>La fonction **SQLLitCol** ne doit pas être appelée si la requête n'a pas renvoyé de résultat : il faut tester la variable SQL.EnDehors après s'être positionné dans le résultat de la requête et avant d'appeler la fonction **SQLLitCol**.
...
<a name="utilisation_tabulations_dans_les_rubriques_ELTPARAGRAPHE000187"></a>Les fonctions SQL permettent d'insérer des tabulations dans les rubriques des fichiers.
...
<a name="NOTE0_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/us/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/us/HFCS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/us/HF55.png)![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png) 

### Fonctions SQLCol et SQLLitCol
<a name="fonctions_sqlcol_docparampagetitleshort_ELTPARAGRAPHE000236"></a>Les fonctions [SQLCol](../WDLang4/3072018.md) et **SQLLitCol** sont équivalentes lors d'un accès à des données via OLE DB ou HFSQL. Il faut cependant respecter le type de parcours associé à chacune de ces fonctions :
...
<a name="NOTE0_6"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png)![ODBC](https://doc.pcsoft.fr/ext/images/us/ODBC.png) 

### Récupération de rubriques de type Float sur Oracle (via ODBC)
<a name="recuperation_rubriques_type_float_sur_oracle_via_odbc_ELTPARAGRAPHE000268"></a>Par défaut, le séparateur décimal utilisé pour les rubriques de type Float sur Oracle est le point. Or le driver ODBC renvoie la valeur avec en utilisant la virgule comme séparateur décimal. Lors de l'affectation de la valeur dans un champ de type numérique, les décimales sont perdues.
...
[SQLLitMémo (Fonction)](../WDLang4/3072020.md)
