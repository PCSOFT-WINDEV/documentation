...
<a name="fonctionnement_pipeline_ELTPARAGRAPHE000079"></a>Lorsque l'ensemble des commandes souhaitées auront été ajoutées dans le pipeline, les résultats pourront être récupérés avec la fonction [RedisPipelineRécupère](../WDLang4/1000023543.md).
