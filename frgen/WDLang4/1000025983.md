...
### Convertir en chaîne le contenu d'un enregistrement pour la table spécifiée

`<Résultat> = HEnregistrementVersChaîne([<Table> [, <Séparateur Rubrique> [, <Séparateur Tableau> [, <Format>]]]])`
---
...
Nom de la table (vue ou requête) manipulée. Si ce nom n'est pas spécifié, la fonction **HEnregistrementVersChaîne** va manipuler la dernière table utilisée par la dernière fonction de gestion HFSQL (fonction commençant par la lettre H).
...
[Enregistrement (Type de variable)](../WDLang4/1000020962.md)
...
[&lt;Source&gt;.EnregistrementVersChaîne (Fonction)](../WDLang4/1000026034.md)
