...
<a name="informations_mises_jour_parametre_nest_pas_precise_ELTPARAGRAPHE000099"></a>
...
<a name="informations_mises_jour_parametre_est_precise_parcours_est_realise_avec_sqlpremiersqlcol_ELTPARAGRAPHE000155"></a>
...
<a name="NOTE0_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 
...
<a name="informations_mises_jour_parametre_est_precise_parcours_est_realise_avec_sqlfetchsqllitcol_ELTPARAGRAPHE000270"></a>
...
| *SQL.MesErreur* | Chaîne de caractères | Libellé de l'erreur. Consultez la documentation du driver utilisé pour connaître sa signification. |
| *SQL.NbCol* | Entier | Nombre de colonnes du résultat.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Remarque : pour obtenir cette information, la requête doit avoir renvoyé un résultat. |
| *SQL.Requete* | Entier | Numéro de la requête en cours. |
| *SQL.TitreCol [n]* | Chaîne de caractères | Titre par défaut de la colonne spécifiée. |
