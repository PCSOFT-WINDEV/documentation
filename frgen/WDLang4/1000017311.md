...
<a name="historique_des_incidentsnotifications_ELTTEXTE000221"></a>
...
<a name="historique_des_notifications_affiche_dans_centre_controle_hfsql_ELTPARAGRAPHE000074"></a>
...
<a name="acceder_historique_des_notifications_par_programmation_ELTPARAGRAPHE000091"></a>

L'historique des notifications est enregistré dans une table HFSQL présente dans la base de données système du serveur: "Alert.fic". 

Il est possible de manipuler cette table par programmation de la façon suivante: 
...
<a name="recevoir_les_notifications_via_email_wdbal_ELTTEXTE000257"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000104"></a>
...
<a name="centre_controle_hfsql_ELTPARAGRAPHE000116"></a>
...
4. Dans la liste des configurations possibles, cliquez sur "Notifications". L'écran de configuration des notifications apparaît: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_HF_Gestion_Serveur%20-%20HC%20N%B0014.gif&type=thumb)
...
6. Créez les destinataires des notifications: 
	...
	- Le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_HF_Email.gif) permet d'ajouter un destinataire pour l'envoi par email. Indiquez l'adresse email du destinataire et validez. 

	- Le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_HF_Bal.gif) permet d'ajouter un destinataire pour l'envoi via la messagerie WDBal des Centres de Contrôle. Sélectionnez les intervenants concernés et validez. 
...
### Programmation
<a name="programmation_ELTPARAGRAPHE000147"></a>Pour configurer l'envoi des notifications HFSQL par programmation, le WLangage met à votre disposition plusieurs fonctions WLangage: 
