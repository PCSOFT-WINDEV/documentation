...
`<Résultat> = <Table destination>.CopieEnreg(<Source> [, <Rubrique destination> [, <Rubrique source>]] [, <Options>])`
---
...
**`<Table destination> : (Nom de champ)`**
...
`<Résultat> = <Table destination>.CopieEnreg(<Enregistrement source> [, <Rubrique destination> [, <Rubrique source>]] [, <Options>])`
---
...
### Les valeurs copiées
<a name="les_valeurs_copiees_ELTPARAGRAPHE000365"></a>
...
<a name="utilisation_des_listes_rubriques_ELTPARAGRAPHE000383"></a>
...
### Rubriques Tableau
<a name="rubriques_tableau_ELTPARAGRAPHE000397"></a>
...
<a name="erreurs_nentrainant_pas_modification_enregistrement_destination_ELTPARAGRAPHE000417"></a>
