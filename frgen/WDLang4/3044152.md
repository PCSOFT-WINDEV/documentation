...
`<Résultat> = HBloqueNumEnr([<Table> [, <Enregistrement à bloquer>]] [, <Blocage>])`
---
...
Si ce nom n'est pas spécifié, la fonction **HBloqueNumEnr** va manipuler la dernière table utilisée par la dernière fonction de gestion HFSQL (fonction commençant par la lettre H).
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) La fonction **HBloqueNumEnr** bloque uniquement l'enregistrement en cours. Il est impossible de spécifier un numéro d'enregistrement différent de celui en cours (Pour désigner l'enregistrement en cours, utilisez la constante *hNumEnrEnCours*).
...
<a name="modification_type_blocage_sur_enregistrement_ELTPARAGRAPHE000165"></a>
...
<a name="influence_mode_blocage_ELTPARAGRAPHE000176"></a>

Si la table est en mode de blocage *hModeMono* (voir la fonction [HMode](../WDLang4/3044039.md)), la fonction **HBloqueNumEnr** n'a aucun effet.
<a name="NOTE0_3"></a>


### Echec du blocage
<a name="echec_blocage_ELTPARAGRAPHE000190"></a>
...
### Nombre de blocages
<a name="nombre_blocages_ELTPARAGRAPHE000208"></a>
...
<a name="connecteur_natif_sql_server_blocage_uniquement_ecriture_ELTPARAGRAPHE000219"></a>
...
<a name="gestion_des_blocages_ole_ELTPARAGRAPHE000243"></a>
...
<a name="persistance_blocage_ELTPARAGRAPHE000256"></a>
