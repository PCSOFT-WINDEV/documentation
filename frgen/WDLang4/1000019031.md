...
### Conseils
<a name="conseils_ELTPARAGRAPHE000022"></a>
...
- ne jamais réaliser un copier / coller manuel des tables HFSQL dans les noeuds (même en ayant arrêté les noeuds). 

- toujours passer par le cluster pour importer les données: 

	- via le Centre de Contrôle HFSQL. 

	- via une application utilisant la fonction [HCopieTable](../WDLang4/3044282.md).
...
<a name="configurer_dns_depuis_centre_controle_hfsql_ELTPARAGRAPHE000134"></a>
...
<a name="installer_nouveau_serveur_hfsql_sur_poste_local_comme_noeud_cluster_ELTPARAGRAPHE000159"></a>
...
<a name="desinstaller_nœud_cluster_ELTPARAGRAPHE000175"></a>
