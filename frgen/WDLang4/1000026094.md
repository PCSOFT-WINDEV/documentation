...
***En anglais : HExecuteQueryAsynchronous***
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000026142&name=hexecuterequeteasynchrone_fonction">Voir des exemples supplémentaires</a>
...
![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) Si ce paramètre n'est pas précisé et si la requête concerne des tables accédées par OLE DB ou par un Connecteur Natif, la requête est exécutée via la connexion utilisée par la première table rencontrée dans la requête. Si la connexion utilisée par une table est modifiée avant l'utilisation de la fonction **HExécuteRequêteAsynchrone**, la nouvelle connexion sera utilisée.
...
<a name="pourquoi_utiliser_constante_hrequetesanscorrection_ELTPARAGRAPHE000236"></a>
...
<a name="passage_parametres_requete_ELTPARAGRAPHE000279"></a>
