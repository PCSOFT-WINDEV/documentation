...
<a name="utilisation_des_triggers_ELTTEXTE000174"></a>


### Bases de données concernées
<a name="bases_donnees_concernees_ELTPARAGRAPHE000028"></a>
...
<a name="hfsql_classic_hfsql_clientserveur_ELTPARAGRAPHE000041"></a>
...
### Avantages
<a name="avantages_ELTPARAGRAPHE000063"></a>
...
**Attention**: Une modification de table qui passe par une requête ne déclenche pas les triggers client (constante *hModifieTable* utilisée dans [HExécuteRequête](../WDLang4/3044080.md)).
...
<a name="types_triggers_disponibles_ELTTEXTE000210"></a>
Deux types de trigger sont disponibles: 

- Les triggers "AVANT":
	Un trigger "AVANT" est appelé *avant* l'exécution d'une fonction HFSQL ([HAjoute](../WDLang4/3044147.md), [HModifie](../WDLang4/3044042.md), [HSupprime](../WDLang4/3044018.md), ...) ou une fonction de gestion des champs Table liée aux données.
...
- Les triggers "APRÈS":
	Un trigger "APRÈS" est appelé *après* l'exécution d'une fonction HFSQL (sauf si le programme a été interrompu pendant l'exécution de cette fonction) ou une fonction de gestion des champs Table liée aux données. 
