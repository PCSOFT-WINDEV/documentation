...
`<Résultat> = HRaye([<Table> [, <Numéro d'enregistrement> [, <Options>]]])`
---
...
Si ce paramètre correspond à une chaîne vide (""), la fonction **HRaye** manipule la dernière table utilisée par la dernière fonction de gestion HFSQL (fonction commençant par la lettre H).
...
<a name="manipulations_enregistrement_raye_ELTPARAGRAPHE000158"></a>
...
<a name="nombre_enregistrements_rayes_ELTPARAGRAPHE000236"></a>

La fonction [HNbEnr](../WDLang4/3044006.md) permet de connaître le nombre d'enregistrements rayés dans la table.
...
### Version de la table
<a name="version_table_ELTPARAGRAPHE000250"></a>

En cas de succès de la fonction **HRaye**, le numéro de version de la table est modifié. Ce numéro de version est donné par la fonction [HVersion](../WDLang4/3044020.md).
<a name="NOTE0_4"></a>


### Rayer un enregistrement à partir d'une requête
<a name="rayer_enregistrement_partir_une_requete_ELTPARAGRAPHE000264"></a>
...
### Cas particuliers
<a name="cas_particuliers_ELTPARAGRAPHE000291"></a>
...
### Tables xBase
<a name="tables_xbase_ELTPARAGRAPHE000329"></a>

La fonction [HSupprime](../WDLang4/3044018.md) a le même effet que la fonction **HRaye**: l'enregistrement est rayé et non supprimé. L'enregistrement peut donc être réactivé par la fonction [HModifie](../WDLang4/3044042.md). Dans ce cas, la fonction [HEtat](../WDLang4/3044081.md) renvoie la constante *hEtatRaye* sur un enregistrement supprimé (et non la constante *hEtatSup*).
