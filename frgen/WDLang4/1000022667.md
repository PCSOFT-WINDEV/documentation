...
## &lt;Variable Connexion&gt;.InfoDroitsTable (Fonction)
...
`<Résultat> = <Connexion>.InfoDroitFichier(<Utilisateur/Groupe> , <Droits> , <Base de données> , <Table> [, <Mode d'affichage>])`
---
...
## Remarques
Pour modifier les droits sur une table pour un utilisateur ou un groupe, utilisez la fonction [&lt;Variable Connexion&gt;.ModifieDroitsTable](../WDLang4/1000022709.md).
