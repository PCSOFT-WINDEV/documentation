...
Renvoie une liste de clés à ajouter aux tables afin d'améliorer les performances des requêtes. 
<a name="Exemple1"></a>
...
|   |   |
| --- | --- |
| *hSCSimplifié* non précisé<br>(Valeur par défaut) | &lt;Résultat&gt; correspond à un message lisible, à l'attention du développeur, contenant la liste des clés à ajouter aux tables pour optimiser les requêtes. Ce texte est au format RTF. |
| *hSCSimplifié* précisé | &lt;Résultat&gt; correspond à la liste des clés manquantes, et si aucune clé n'est nécessaire, &lt;Résultat&gt; correspond à une chaîne vide. La liste des clés manquantes est de la forme: <br><br><pre><code><Fichier 1> + TAB + <Clé 1> + <EOT> + <Clé 2> + ...<br> + <Clé N> + RC + ... + RC + <Fichier N> + TAB + <Clé 1> + <br><EOT> + <Clé 2> + ... + <Clé N></code></pre><br> où: <br><br>- &lt;Table N&gt; correspond à la table concernée par l'optimisation. <br><br>- &lt;Clé N&gt; correspond au nom de la clé à ajouter. <br><br><br> |
...
[HSuggèreCléDébut (Fonction)](../WDLang4/1000025905.md)
