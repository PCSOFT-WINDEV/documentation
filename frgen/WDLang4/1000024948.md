...
| *hAvecTransaction* | Seules les requêtes d'écriture (INSERT, UPDATE et DELETE) sont exécutées dans une transaction.<br><br>Une transaction est démarrée, les enregistrements sont bloqués en écriture pendant l'exécution de la requête et débloqués à la fin de son exécution, que la requête échoue ou non. La transaction est donc toujours terminée à la fin de l'exécution de la fonction **&lt;Source&gt;.ExécuteRequêteSQL**. Pour les requêtes d'écriture, il n'y a pas de source de données: l'appel de la fonction [&lt;Source&gt;.LibèreRequête](../WDLang4/1000025011.md) est inutile.<br><br>Si la requête ne peut pas se terminer normalement (blocage d'enregistrements, coupure de courant, ...), la transaction est annulée et les tables sont remises dans l'état avant l'exécution de la requête.<br><br>Remarque: l'exécution de la requête pourra être fortement ralentie.<br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Cette constante est disponible uniquement pour les bases de données HFSQL. Cette constante n'est pas disponible pour les bases de données SQLite.![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette constante n'est pas disponible. |
| *hModifieTable*<br>(constante combinable avec les autres constantes) | <br><br>- **Sur des tables HFSQL**: Lors de la modification du résultat de la requête (fonctions [&lt;Source&gt;.Ajoute](../WDLang4/1000024187.md), [&lt;Source&gt;.Ecrit](../WDLang4/1000024331.md), [&lt;Source&gt;.Modifie](../WDLang4/1000025038.md), [&lt;Source&gt;.Raye](../WDLang4/1000025051.md), [&lt;Source&gt;.Supprime](../WDLang4/1000025071.md)), ces modifications seront reportées dans les tables intervenant dans la requête. <br>	Si cette option n'est pas précisée, seul le résultat de la requête est modifié. <br>	Pour plus de détails sur la modification du résultat d'une requête, consultez [Modifier le contenu d'une requête](../WDLang4/3044234.md).<br><br>- **Sur des tables non HFSQL**, la constante *hModifieTable* est inutile: les tables intervenant dans la requête sont automatiquement modifiées lors de la modification du résultat de la requête.<br><br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Cette constante est disponible uniquement pour les bases de données HFSQL. Cette constante n'est pas disponible pour les bases de données SQLite.![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette constante n'est pas disponible.![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Accès par JDBC: Cette constante n'est pas disponible. |
...
- soit à une connexion définie sous l'éditeur de schémas des données ou par programmation avec la fonction [HDécritConnexion](../WDLang4/3044205.md) ou [&lt;Variable Connexion&gt;.OuvreConnexion](../WDLang4/1000023962.md). 
...
<a name="lecture_des_donnees_lors_initialisation_ELTPARAGRAPHE001029"></a>
...
<a name="texte_requete_sql_ELTPARAGRAPHE001064"></a>
...
<a name="executer_une_requete_sql_parametree_ELTPARAGRAPHE001076"></a>
...
<a name="injection_sql_comment_sen_premunir_ELTPARAGRAPHE001124"></a>
...
### Jointures
<a name="jointures_ELTPARAGRAPHE001162"></a>
...
<a name="pourquoi_utiliser_constante_hrequetesanscorrection_ELTPARAGRAPHE001176"></a>
...
| --- | --- |
| Détermination automatique de la connexion associée aux tables présentes dans la requête. | La connexion à utiliser doit être précisée dans la fonction **&lt;Source&gt;.ExécuteRequêteSQL**. |
...
<a name="condition_sur_une_cle_composee_dans_une_requete_sql_ELTPARAGRAPHE001230"></a>
...
<a name="requetes_sur_des_tables_hfsql_ELTPARAGRAPHE001248"></a>
...
<a name="optimisation_pour_executer_plusieurs_fois_une_meme_requete_acces_natifs_oracle_sql_server_uniquement_ELTPARAGRAPHE001302"></a>
...
<a name="specifier_recuperer_des_valeurs_lors_execution_une_requete_cas_des_procedures_stockees_ELTPARAGRAPHE001346"></a>
...
<a name="requetes_sql_fonction_docparampagetitleshort_execution_requetes_sql_creees_par_editeur_requetes_ELTPARAGRAPHE001400"></a>
...
<a name="parcours_des_requetes_fonction_litpremierwdlang41000025022md_ELTPARAGRAPHE001446"></a>
