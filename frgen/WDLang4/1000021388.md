...
- La fonction **&lt;Fenêtre&gt;.DepuisSource** n'effectue aucune lecture de la table. C'est la valeur de l'enregistrement chargé en mémoire qui est utilisée pour initialiser les champs. Il faut donc qu'un enregistrement soit au préalable chargé en mémoire : 
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette fonction est également disponible pour les pages WEBDEV. Elle est équivalente à la fonction [&lt;Page&gt;.DepuisSource](../WDLang4/1000021393.md). 
...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_une_table_ELTPARAGRAPHE000265"></a>
...
<a name="liaison_avec_une_rubrique_types_liaisons_ELTPARAGRAPHE000281"></a>
...
- **Champ Combo auto-alimenté lié à une table HFSQL** : La fonction **&lt;Fenêtre&gt;.DepuisSource** ne doit pas se trouver dans l'événement "Déclarations globales" de la fenêtre. La fonction doit être présente dans l'événement "Initialisation" de la fenêtre.
