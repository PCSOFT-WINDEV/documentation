...
- Dans le champ de saisie "Source de données", saisissez le chemin complet du fichier .WDD de description du schéma des données (optionnel, permet la récupération des contraintes d'intégrité).

- Laissez vides les champs "Nom d'utilisateur" et "Mot de passe".

- Dans la combo "Catalogue initial à utiliser", saisissez le chemin complet d'accès aux tables.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=oledb_excel.gif)
...
5. Dans la fenêtre des "Informations Avancées", ajoutez une propriété nommée "Extended Properties" si nécessaire:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=oledb_crystal2.gif)
...
- Dans le champ de saisie "Nom de fichier ou de serveur", saisissez le chemin complet du schéma des données (optionnel).

- Laissez vides les champs "Nom d'utilisateur" et "Mot de passe".

- Dans la liste "Catalogue initial", saisissez le chemin complet d'accès aux tables.
...
<a name="exemple_code_utilisant_provider_ole_pour_hfsql_ELTPARAGRAPHE000094"></a>
...
[Provider OLE DB pour HFSQL](../WDLang4/9000059.md)
