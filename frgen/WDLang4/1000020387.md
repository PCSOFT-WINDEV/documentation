...
***En anglais : HNotifAddCCRecipient***
...
**Remarque**: L'envoi via les Centres de Contrôle utilise les paramètres spécifiés avec la fonction [HNotifConfigure](../WDLang4/1000020390.md) (base des Centres de Contrôle, ...). 
<a name="Exemple1"></a>
