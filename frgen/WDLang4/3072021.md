...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Seules les caractéristiques non détaillées de chaque élément sont listées.

![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le qualifiant et le propriétaire de la table ne sont pas affichés.
