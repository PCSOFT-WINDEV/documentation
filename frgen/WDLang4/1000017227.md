...
<a name="installation_serveur_replication_ELTTEXTE000200"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000031"></a>Le serveur de réplication peut être installé :
...
<a name="installation_pack_ELTPARAGRAPHE000041"></a>Le pack d'installation permet d'installer ou de désinstaller le serveur de réplication.
...
### Remarque
<a name="remarque_ELTPARAGRAPHE000059"></a>L'interface Web du serveur de réplication nécessite la création d'un alias sur le serveur Web. Cette création est normalement automatisée.
...
```txt
Alias /SRVRPL_WEB/ "D:/PC SOFT/Serveur Replication 2024/SRVRPL/SRVRPL_WEB/"
<Directory "D:/PC SOFT/Serveur Replication 2024/SRVRPL/SRVRPL_WEB/">
Order allow,deny
Allow from all
</Directory>
```
...
### Droits d'accès
<a name="droits_acces_ELTPARAGRAPHE000068"></a>Le serveur de réplication utilise une base de données localisée dans le dossier "\\ProgramData\\ReplicSRV\\". Il est donc nécessaire de donner les droits complets sur ce dossier pour le compte utilisé par le serveur Web (invité internet) afin qu'il accède aux disques.
...
<a name="utilisation_site_parametrage_des_replications_ELTTEXTE000236"></a>
...
### Gérer les comptes
<a name="gerer_les_comptes_ELTPARAGRAPHE000087"></a>L'onglet "Comptes" permet de gérer les différents comptes des utilisateurs de la réplication. Par défaut, seul l'administrateur existe.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ServReplic_Compte.gif)
...
<a name="gerer_les_publications_ELTPARAGRAPHE000102"></a>L'onglet "Publications" permet de gérer les publications des réplications, c'est-à-dire les réplications qui pourront être utilisées par le serveur de réplication.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ServReplic_publication.gif)
...
<a name="gerer_les_abonnements_ELTPARAGRAPHE000121"></a>L'abonnement à une publication est réalisé : 
...
[Réplication universelle assistée automatique](../WDLang4/9000046.md)
