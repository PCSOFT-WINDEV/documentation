...
Le driver est disponible en lecture et en écriture. Une application écrite dans un langage tiers peut lire et écrire dans des tables HFSQL.
...
## Installation
<a name="installation_ELTTEXTE000249"></a>
...
<a name="utiliser_driver_odbc_pour_hfsql_classic_clientserveur_ELTPARAGRAPHE000059"></a>
...
8. Sélectionnez le fichier WDD correspondant au schéma des données grâce au bouton de parcours.

9. Dans la liste des schémas des données, sélectionnez le schéma des données voulu et validez.

10. Si la base de données est au format "HFSQL Classic", cochez l'option "HFSQL Classic" puis sélectionnez le répertoire des tables correspondant grâce au bouton de parcours. Toutes les tables HFSQL Classic correspondant au schéma des données sélectionné sont regroupées dans ce répertoire. 
	Attention: il est nécessaire de sélectionner un répertoire de fichier par schéma des données. 
	Validez (bouton "OK").
...
<a name="gestion_des_requetes_open_file_ELTPARAGRAPHE000109"></a>

Il est possible d'utiliser des requêtes de type OPEN FILE sur des tables HFSQL en précisant:
...
### Accéder à des tables HFSQL Client/Serveur
<a name="acceder_des_tables_hfsql_clientserveur_ELTPARAGRAPHE000127"></a>
...
<a name="requete_type_insert_ELTPARAGRAPHE000144"></a>
...
<a name="remarques_limites_ELTTEXTE000315"></a>


### Suppression d'un driver
<a name="suppression_driver_ELTPARAGRAPHE000153"></a>
...
<a name="utiliser_version_plus_recente_driver_ELTPARAGRAPHE000160"></a>
...
### Remarque
<a name="remarque_ELTPARAGRAPHE000176"></a>
