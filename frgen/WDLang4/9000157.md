...
<a name="quand_utiliser_une_vue_sql_ELTPARAGRAPHE000018"></a>
...
## Créer une vue SQL
<a name="creer_une_vue_sql_ELTTEXTE000250"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000043"></a>

Il existe plusieurs méthodes pour créer une vue SQL: 

- Création de la vue SQL depuis l'éditeur de schémas des données. Dans ce cas, pour utiliser la vue, une mise à jour des données sur le serveur est nécessaire. Cette mise à jour peut être effectuée: 
...
<a name="creation_depuis_editeur_schemas_des_donnees_ELTPARAGRAPHE000062"></a>

Pour créer une vue SQL depuis l'éditeur de schémas des données:
...
4. La vue SQL est créée. Par défaut, elle n'est pas associée à une connexion. Pour associer la vue à une connexion définie sous l'éditeur de schémas des données:

	- Sous le volet "Schéma des données", sélectionnez la vue SQL qui vient d'être créée. 
...
5. Générez le schéma des données pour utiliser la vue SQL dans le code de l'application: sous le volet "Schéma des données", dans le groupe "Schéma des données", déroulez "Génération" et sélectionnez "Génération". 
...
<a name="creation_utilisant_code_sql_ELTPARAGRAPHE000091"></a>Pour créer une vue SQL en utilisant du code SQL, il suffit d'utiliser l'instruction CREATE VIEW dans le code SQL de la requête. Par exemple: 
...
<a name="utiliser_une_vue_sql_ELTTEXTE000286"></a>
...
- soit avec l'éditeur de requêtes. 
	Si la vue SQL a été créée sous l'éditeur de schémas des données, la vue apparaît dans la liste des éléments disponibles pour créer la requête. 
...
Remarque: Le paramètre **ConnexionHFSQL** doit être précisé si la vue n'a pas été créée sous l'éditeur de schémas des données ou si la vue définie sous l'éditeur de schémas des données n'a pas été associée à une connexion. 
...
### Droits sur une vue
<a name="droits_sur_une_vue_ELTPARAGRAPHE000125"></a>
...
<a name="modification_contenu_une_vue_sql_ELTPARAGRAPHE000149"></a>
...
- La vue SQL doit porter sur une et une seule table. 
...
<a name="fonctions_wlangage_permettant_manipuler_une_vue_sql_ELTTEXTE000322"></a>
...
[HInfoDroitVue (Fonction)](../WDLang4/1000021475.md)

[HModifieDroitVue (Fonction)](../WDLang4/1000021368.md)

[HMiseAJourVue (Fonction)](../WDLang4/1000021520.md)

[Instructions SQL ](../WDLang4/2034001.md)

[Vue matérialisée](../WDLang4/9000159.md)
