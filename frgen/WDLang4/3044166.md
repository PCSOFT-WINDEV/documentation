...
**Remarque**: La table et les fichiers d'index décrits seront créés avec la fonction [HDBCrée](../WDLang4/3044171.md) (au format dBase 3 uniquement). Ainsi, les index de format autre que NDX ne peuvent pas être créés avec la fonction **HDBDécritIndex**.
<a name="Exemple1"></a>
...
<a name="utilisation_espaces_dans_les_parametres_ELTPARAGRAPHE000072"></a>Les paramètres ne doivent pas être séparés par des espaces, par exemple il ne faut pas écrire:
...
<a name="description_index_ELTPARAGRAPHE000084"></a>
...
- Pour utiliser la fonction **HDBDécritIndex**, le fichier doit être décrit avec la fonction [HDBDécritTable](../WDLang4/3044172.md).
