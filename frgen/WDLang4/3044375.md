...
<a name="comment_faire_une_recherche_fulltext_ELTTEXTE000429"></a>
Pour effectuer une recherche "full-text", il est nécessaire de: 

1. Créer un index full-text dans la table concernée par cette recherche.
...
<a name="comment_creer_index_fulltext_ELTTEXTE000453"></a>
La création d'un index full-text est réalisée sous l'éditeur de schémas des données.

Pour créer un index full-text:

1. Dans l'éditeur de schémas des données, affichez la description des rubriques du fichier concerné (option "Description des rubriques" du menu contextuel).

2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Manipulations_rubriques%20-%20HC%20N%B0001%208.gif). La fenêtre de définition de l'index full-text apparaît. Sélectionnez les rubriques intervenant dans la composition de l'index full-text. Seules les rubriques de type "Texte" et "Mémo Texte" présentes dans la description du fichier sont proposées. Validez.
...
6. Enregistrez et générez le schéma des données. Lors de la génération du schéma des données, la description des tables est modifiée et l'index full-text est créé (table d'extension ".FTX").
...
### Remarques
<a name="remarques_ELTPARAGRAPHE000128"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Il est possible de gérer les index full-text dans les tables décrites par programmation: il suffit d'utiliser une variable de type [Description d'IndexFullText](../WDLang4/1000017461.md) pour décrire l'index, puis la fonction [HDécritIndexFullText](../WDLang4/1000017407.md) pour valider la création de l'index.

- A tout moment, il est possible de modifier la composition d'un index full-text existant: il suffit de cliquer sur le bouton "Editer l'index" dans la partie gauche de la description de la rubrique sous l'éditeur de schémas des données.

- Pour créer une rubrique de type Index full-text, une génération du schéma des données et une modification automatique des données sont obligatoires.
...
<a name="definition_des_mots_creux_ELTPARAGRAPHE000151"></a>
...
<a name="definition_des_synonymes_ELTPARAGRAPHE000182"></a>
...
<a name="comment_creer_une_requete_pour_effectuer_une_recherche_fulltext_ELTTEXTE000495"></a>
...
<a name="recherche_fulltext_editeur_requetes_ELTPARAGRAPHE000213"></a>
...
<a name="recherche_fulltext_requete_code_sql_ELTPARAGRAPHE000227"></a>Pour créer une requête réalisant une recherche full-text en code SQL, il suffit d'utiliser la syntaxe: 
...
<a name="syntaxe_valeur_recherche_ELTPARAGRAPHE000259"></a>
...
<a name="cas_particuliers_des_mots_composes_separes_par_tiret_ELTPARAGRAPHE000311"></a>
...
<a name="analyser_resultat_une_requete_fulltext_ELTTEXTE000543"></a>
Le résultat d'une requête full-text donne pour chaque enregistrement de la table concernée la pertinence de l'enregistrement par rapport à la valeur de recherche.
...
<a name="gerer_les_index_fulltext_par_programmation_ELTTEXTE000567"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) La création d'un index full-text dans une table créée par programmation peut être réalisée grâce à une variable de type [Description d'IndexFullText](../WDLang4/1000017461.md).
...
[Fonctions SQL utilisables dans les requêtes SQL](../WDLang4/2034005.md)
