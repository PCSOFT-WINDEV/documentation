...
- Chaque développeur a sur son poste une copie locale des différents projets sur laquelle il travaille. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GestionnaireDeSources1.gif)
...
- Les autres développeurs sont automatiquement avertis de cette réintégration. Ils peuvent alors mettre à jour leur copie locale. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GestionnaireDeSources_synch.gif)
...
1. Sous le volet "GDS", dans le groupe "Ajouter le projet", cliquez sur "Ajouter le projet dans le GDS". L'assistant d'ajout d'un projet dans le GDS se lance : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0001.jpg&type=thumb)
...
4. Indiquez les paramètres du serveur HFSQL installé précédemment : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0002.jpg&type=thumb)
...
7. Passez à l'étape suivante. L'utilisateur en cours n'est pas autorisé à accéder au serveur HFSQL. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0003.jpg&type=thumb)
Nous allons créer cet utilisateur : renseignez les informations demandées et cliquez sur le bouton "Créer le compte".

8. L'assistant nous propose de placer le projet dans le sous-répertoire "Projets" de la base de sources. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0004.jpg&type=thumb)
Nous allons accepter cet emplacement. Passez à l'étape suivante.

9. L'assistant nous demande de sélectionner les différents éléments du projet à ajouter dans la base de sources. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0005.jpg&type=thumb)
...
Lors de l'intégration dans le GDS de projets partageant diverses ressources (schéma des données, pages, etc.), ces ressources peuvent également être partagées entre les différents projets présents dans le GDS. Ainsi, le même élément n'est intégré qu'une seule fois dans le GDS et les modifications sont automatiquement reportées dans les autres projets.

<a name="NOTE4_3"></a>


### Ouverture du projet depuis le GDS
<a name="ouverture_projet_depuis_gds_ELTPARAGRAPHE000199"></a>
...
2. Dans l'onglet "HFSQL C/S", indiquer les paramètres de localisation de la base de sources et valider (cette étape est nécessaire uniquement si le projet en cours sous l'éditeur n'appartient pas au GDS) : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0006.jpg&type=thumb)


3. Dans la fenêtre qui s'affiche, indiquer si nécessaire la connexion et le répertoire local : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0007.jpg&type=thumb)
...
<a name="modification_parametre_projet_ELTPARAGRAPHE000250"></a>

Nous allons modifier le projet en demandant à afficher le thème sur les boîtes de dialogue :

1. Affichez la description du projet : sous le volet "Projet", dans le groupe "Projet", cliquez sur "Description".

2. Cliquez sur l'onglet "Thème".

3. Cochez l'option "Appliquer le thème sur les boîtes de dialogue (OuiNon et OKAnnuler)".
...
1. Tout d'abord la fenêtre d'extraction automatique du projet s'affiche. En effet, nous modifions une caractéristique du projet, il est nécessaire d'extraire le projet. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0008.jpg&type=thumb)
...
<a name="modification_une_page_projet_ELTPARAGRAPHE000302"></a>
...
1. Sélectionnez la page "PAGE_Fiche_du_produit" dans le volet "Explorateur du projet" et double-cliquez sur l'élément pour l'ouvrir sous l'éditeur de pages. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0011.jpg&type=thumb)


2. L'extraction automatique est activée à la première modification : il suffit de déplacer un champ pour extraire l'élément. Il est également possible d'utiliser l'icône "Extraire" présente dans le ruban du volet GDS (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0010%201.jpg)). 

3. La fenêtre d'extraction apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0012.jpg&type=thumb)
...
2. Testez la page (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Go_Page_WB_GAF.jpg) parmi les boutons d'accès rapide). 
...
<a name="reintegration_element_extrait_ELTPARAGRAPHE000357"></a>
...
2. Sous le volet "GDS", dans le groupe "Elément en cours", cliquez sur le bouton "Réintégrer". La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0013.jpg&type=thumb)
