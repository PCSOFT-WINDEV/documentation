...
<a name="lecon_2_administrer_une_base_donnees_clientserveur_ELTTEXTE000262"></a>
...
<a name="lancement_centre_controle_hfsql_ELTPARAGRAPHE000069"></a>
...
2. La fenêtre de bienvenue dans le Centre de Contrôle HFSQL s'affiche. Le schéma des données du projet en cours est automatiquement sélectionné. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0008.jpg&type=thumb)
...
4. Cliquez si nécessaire sur l'onglet vertical "HFSQL C/S". La liste des tables au format HFSQL Client/Serveur s'affiche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0009.jpg&type=thumb)
Le Centre de Contrôle liste ici les tables Client/Serveur trouvées dans le schéma des données lié au projet en cours. Aucune connexion n'est réalisée : les noms des tables apparaissent grisés.
...
<a name="creer_compte_utilisateur_dans_centre_controle_hfsql_ELTTEXTE000385"></a>
...
L'utilisation de compte utilisateur permet de sécuriser l'accès aux données. En effet, tous les utilisateurs du site ne sont pas des administrateurs. A chaque utilisateur (ou groupe d'utilisateurs), il est possible d'associer des droits. Certains utilisateurs peuvent par exemple ne pas avoir le droit d'écrire dans certaines tables.
...
<a name="connexion_base_donnees_hfsql_clientserveur_ELTPARAGRAPHE000121"></a>

Pour se connecter directement à la base de données Site_WEBDEV_Complet présente sur le serveur :

1. Déroulez le menu ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0009%201.jpg) situé en haut à gauche du Centre de Contrôle HFSQL et sélectionnez l'option "Se connecter à un serveur HFSQL".

2. La fenêtre de bienvenue dans le Centre de Contrôle HFSQL s'affiche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0012.jpg&type=thumb)
...
- dans la partie droite de l'écran, un nouvel onglet est affiché permettant de voir les caractéristiques du serveur HFSQL. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0013.jpg&type=thumb)
...
<a name="creation_utilisateur_ELTPARAGRAPHE000140"></a>
...
1. Dans la partie droite de l'écran, sélectionnez l'onglet "Utilisateurs". Cet onglet permet de gérer les utilisateurs du serveur. 
	Pour le moment, seul l'utilisateur "Admin" est présent. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0014.jpg&type=thumb)
...
3. Saisissez par exemple les informations suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0015.jpg&type=thumb)
...
<a name="selection_des_droits_pour_nouvel_utilisateur_ELTPARAGRAPHE000163"></a>
...
4. Dans la liste des droits, pour l'action "Droit de se connecter au serveur (connexion cryptée et non cryptée)", cliquez dans la colonne "Droit défini" et sélectionnez la coche verte. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0016.jpg&type=thumb)
...
1. Dans le Centre de Contrôle HFSQL, déroulez la base de données "Site_WEBDEV_Complet", puis double-cliquez sur la table Client (à gauche de l'écran).

2. Sous le volet "Client", dans le groupe "Droits", cliquez sur "Gestion des droits de la table".

3. Sélectionnez l'utilisateur "Test" dans la liste des utilisateurs. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0017.jpg&type=thumb)
...
## En résumé
<a name="resume_ELTTEXTE000445"></a>
...
| [Leçon précédente](../TutoWB/1410087211.md) | [Sommaire](../TutoWB/1410087510.md) |
| --- | --- |
