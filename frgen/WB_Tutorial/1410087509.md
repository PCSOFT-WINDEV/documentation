...
### Présentation
<a name="presentation_ELTPARAGRAPHE000083"></a>
...
<a name="ouverture_projet_webisation_ELTPARAGRAPHE000107"></a>
...
Remarque : Dans certains cas, de nouveaux développements peuvent être nécessaires pour adapter le fonctionnement de l'application au Web. Par exemple, si l'application utilisait un champ Traitement de texte, il peut être nécessaire d'utiliser un champ HTML, avec si nécessaire adaptation du schéma des données pour gérer le format HTML.
