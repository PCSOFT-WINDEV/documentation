...
<a name="lecon_4_ajouter_produit_ELTTEXTE000389"></a>
...
<a name="ajout_nouveau_produit_via_page_fiche_produit_ELTTEXTE000449"></a>


### Gestion de l'ajout lors de l'initialisation de la page
<a name="gestion_ajout_lors_initialisation_page_ELTPARAGRAPHE000040"></a>
...
5. Il reste maintenant à gérer la valeur "-1" (cas de l'ajout d'un enregistrement). Remplacez le code :
	...
	- Si l'identifiant du produit vaut -1, nous sommes dans le cas de l'ajout d'un produit. Dans ce cas, la fonction [RAZ](../WDLang4/1000025052.md) est exécutée. Cette fonction initialise les variables des rubriques de la table "Produit" avec les valeurs par défaut pour gérer un nouvel enregistrement.
...
<a name="gestion_ajout_lors_validation_page_ELTPARAGRAPHE000086"></a>
...
4. Dans l'événement "Clic xxx (Serveur)", remplacez le code existant par le code suivant :
	...
	Examinons ce code : la fonction [&lt;Table&gt;.Enregistre](../WDLang4/1000024606.md) permet de tester si l'enregistrement est déjà présent dans la table "Produit", et selon le cas elle permet soit de l'ajouter, soit de le modifier. 

5. Enregistrez les modifications (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Sauver_WB_GAF.jpg) ou Ctrl + S).
...
<a name="gestion_ajout_dans_menu_page_ELTPARAGRAPHE000110"></a>
...
6. Dans l'onglet "Général", dans la zone "Action de l'option" : 
	...
	- sélectionnez la page "PAGE_Fiche_du_produit".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0001.jpg)
...
8. Dans le bandeau du modèle, cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P3_Site%20Complet%20-%205%20Gestion%20des%20menus%20-%20HC%20N%B0002%201.jpg) pour propager les modifications du modèle à toutes les pages utilisant le modèle.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0002.jpg)
...
<a name="gestion_image_produit_ELTPARAGRAPHE000149"></a>

Dans la table Produit, une rubrique permet de stocker l'image associée au produit.
...
Pour cela, nous allons permettre à l'utilisateur d'uploader un fichier image présent sur son poste pour ensuite l'associer à la rubrique présente dans la table. Nous allons utiliser un champ Upload.L'upload consiste à copier un fichier du poste client vers le serveur.
...
3. Cliquez dans la page à la position où le champ doit être créé (par exemple en dessous du champ Image). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0003.jpg&type=thumb)
...
Une variable globale est ici manipulée car le chemin de l'image va ensuite être utilisé dans le code du bouton "Valider", pour enregistrer la nouvelle image dans la table.

Pour plus de détails sur les conditions d'utilisation des variables locales et globales, consultez le [Tuto sur le WLangage](../TutoWB/1410087226.md).
...
6. Pour déclarer la variable globale :
	...
	- Affichez l'événement "Déclaration globales" de la page (par exemple, sous l'éditeur de code, sous le volet "Code", dans la combo listant tous les événements, sélectionnez l'événement "Déclarations globales"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P3_Site%20WebDev%20-%20Fiche%20Produit%20-%202%20-%20HC%20N%B0004.jpg&type=thumb)
...
7. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Sauver_WB_GAF.jpg) parmi les boutons d'accès rapide. Les erreurs de compilation disparaissent.
...
Pour enregistrer l'image dans la table Produit :
...
2. Dans l'événement "Clic xxx (serveur)" du champ Bouton, saisissez le code suivant APRES l'appel de la fonction [&lt;Table&gt;.DepuisPage](../WDLang4/1000021405.md) :
...
3. Examinons ce code WLangage :
	...
	- Ce code vérifie le contenu de la variable globale ***CheminImage***. Si cette variable ne correspond pas à une chaîne vide, cela signifie que l'image a été téléchargée par l'utilisateur. Dans ce cas, la rubrique "Visuel" de la table Produit est remplie avec le contenu binaire de l'image. Ce contenu est récupéré grâce à la fonction [fChargeBuffer](../WDLang1/1000019410.md). 

	- La fonction [&lt;Table&gt;.Modifie](../WDLang4/1000025038.md) (déjà présente dans le code) permet d'enregistrer les changements dans la table.
...
<a name="test_ajout_produit_ELTPARAGRAPHE000287"></a>
...
1. Lancez le test du projet (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Go_Projet_WB_GAF.jpg) parmi les boutons d'accès rapide). La page listant les produits s'affiche. 
...
## En résumé
<a name="resume_ELTTEXTE000669"></a>
...
| [Leçon précédente](../TutoWB/1410087488.md) | [Sommaire](../TutoWB/1410087510.md) |
| --- | --- |
