...
<a name="resultat_exemple_ELTPARAGRAPHE000086"></a>

Détaillons le résultat dans le cas de notre exemple.

- L'onglet "Synthèse" présente les dix traitements les plus consommateurs de temps. Dans notre exemple, nous pouvons voir que la procédure locale "MetAJourStockProduits" prend plus de 3 secondes à s'exécuter (ce temps peut varier en fonction de la puissance de votre machine). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P10_Analyseur%20de%20performances%20-%20HC%20N%B0002.jpg&type=thumb)


- L'onglet "Cartographie" permet d'identifier de manière visuelle ce qui a pris le plus de temps. Dans notre cas, c'est un appel à la fonction [HTTPRequête](../WDLang3/3043007.md) : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P10_Analyseur%20de%20performances%20-%20HC%20N%B0003.jpg&type=thumb)


- L'onglet "Détail" présente tous les traitements ou événements appelés du plus long au plus rapide. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P10_Analyseur%20de%20performances%20-%20HC%20N%B0004.jpg&type=thumb)
...
2. En cliquant sur le bouton "Appels", le détail des appels de la procédure **MetAjourStockProduits** apparaît.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P10_Analyseur%20de%20performances%20-%20HC%20N%B0005.jpg&type=thumb)
...
<a name="optimisation_projet_ELTPARAGRAPHE000126"></a>
...
6. Sous l'onglet "Cartographie", la fonction [HTTPRequête](../WDLang3/3043007.md) n'apparaît plus avec la même importance. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P10_Analyseur%20de%20performances%20-%20HC%20N%B0006.jpg&type=thumb)
...
Dans ce cas, seul le code présent entre les fonctions [AnalyseurDébut](../WDLang1/3013012.md) et [AnalyseurFin](../WDLang1/3013002.md) est schéma des données. Le résultat est enregistré sous forme d'un fichier WPF qui peut être lu par WEBDEV. 
