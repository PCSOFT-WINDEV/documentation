...
<a name="lecon_6_les_procedures_ELTTEXTE000145"></a>
...
<a name="premiere_procedure_ELTTEXTE000242"></a>
...
1. Dans le volet "Code" du ruban, dans le groupe "Procédures", déroulez "Nouveau" et sélectionnez "Nouvelle procédure globale (Serveur)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P13_Ma_premiere_procedure%20-%20HC%20N%B0001.jpg&type=thumb)


2. Dans la fenêtre de sauvegarde de l'élément qui s'affiche, un nom est proposé par défaut pour la collection de procédures globales. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P13_Ma_premiere_procedure%20-%20HC%20N%B0002.jpg)
Conservez ce nom et validez (bouton "OK"). 

3. Une nouvelle fenêtre s'affiche permettant de saisir le nom de la procédure et ses caractéristiques : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P13_Ma_premiere_procedure%20-%20HC%20N%B0003.jpg)
...
5. La procédure globale "Bienvenue" est affichée sous l'éditeur de code. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P13_Ma_premiere_procedure%20-%20HC%20N%B0004.jpg)
...
## Paramètres d'une procédure
<a name="parametres_une_procedure_ELTTEXTE000505"></a>


### Qu'est-ce qu'un paramètre ?
<a name="questce_quun_parametre_ELTPARAGRAPHE000037"></a>
...
7. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Projet_WB_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="gestion_des_parametres_passage_par_reference_par_valeur_ELTPARAGRAPHE000044"></a>
...
4. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Projet_WB_GAF.jpg) parmi les boutons d'accès rapide.
...
### Renvoyer une valeur
<a name="renvoyer_une_valeur_ELTPARAGRAPHE000051"></a>
...
<a name="parametres_obligatoires_optionnels_ELTPARAGRAPHE000058"></a>
...
## En résumé
<a name="resume_ELTTEXTE000774"></a>
