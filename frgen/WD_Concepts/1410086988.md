...
<a name="gestionnaire_sources_ELTTEXTE000488"></a>
...
<a name="principe_utilisation_ELTPARAGRAPHE000034"></a>**Installation**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GestionnaireDeSources1.gif)
...
<a name="creer_une_base_sources_pour_gds_ELTTEXTE000582"></a>
...
### Sauvegardes
<a name="sauvegardes_ELTPARAGRAPHE000074"></a>Il est conseillé de faire régulièrement des sauvegardes de la base de sources du GDS. Ces sauvegardes peuvent être effectuées grâce à l'administrateur du GDS.
...
<a name="configurer_projet_pour_travailler_avec_gds_ELTTEXTE000642"></a>
...
<a name="ajouter_projet_dans_gds_ELTPARAGRAPHE000092"></a>**Pour ajouter un projet local dans le GDS** :
...
<a name="partage_ressources_ELTPARAGRAPHE000121"></a>Vous avez importé dans le gestionnaire de sources un premier projet. Ce projet contient des éléments partagés avec d'autres projets (classes, fenêtres, procédures, feuilles de styles, analyse, etc.).
...
<a name="travailler_avec_gds_ELTTEXTE000678"></a>


### Options d'un projet concernant le GDS
<a name="options_projet_concernant_gds_ELTPARAGRAPHE000142"></a>Plusieurs options permettent de configurer un projet manipulé avec le Gestionnaire de Sources. Ces options sont regroupées dans l'onglet "GDS" de la description du projet (option "Description" sous le volet "Projet"). Ces options sont cochées par défaut.
...
### Extraire un élément
<a name="extraire_element_ELTPARAGRAPHE000195"></a>**Les différents modes d'extraction**
...
<a name="reintegrer_element_ELTPARAGRAPHE000244"></a>Les éléments extraits du Gestionnaire de sources apparaissent entourés d'un trait rouge sous l'éditeur de projet.
...
<a name="modes_gestion_projet_ELTPARAGRAPHE000263"></a>Deux modes de gestion du projet sont disponibles avec le GDS :
...
<a name="travailler_mode_deconnecte_avec_gds_ELTTEXTE000720"></a>
...
<a name="administrateur_gds_ELTTEXTE000744"></a>
