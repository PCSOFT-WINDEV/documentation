...
<a name="creation_une_fenetre_ELTTEXTE001027"></a>
...
<a name="creation_fenetres_vierges_ELTPARAGRAPHE000084"></a>**Pour créer une fenêtre vierge** :

1. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_ICO_Cr%E9er_cpt.gif) parmi les boutons d'accès rapide. La fenêtre de création d'un nouvel élément s'affiche : cliquez sur "Fenêtre" puis sur "Fenêtre". L'assistant de création d'une fenêtre se lance.
...
### Fenêtre interne
<a name="fenetre_interne_ELTPARAGRAPHE000108"></a>Une fenêtre interne est une fenêtre sans barre de titre, ni barre de message qui sera directement incluse dans les autres fenêtres de votre application grâce au champ "Fenêtre interne".
...
<a name="fenetre_basee_sur_modele_fenetres_ELTPARAGRAPHE000128"></a>WINDEV permet également de créer une fenêtre basée sur un modèle de fenêtres. Dans ce cas, il suffit de sélectionner le modèle de fenêtres voulu.
...
<a name="manipulations_simples_sur_une_fenetre_depuis_editeur_ELTTEXTE001069"></a>
...
<a name="principales_caracteristiques_une_fenetre_ELTTEXTE001093"></a>


### Caractéristiques
<a name="caracteristiques_ELTPARAGRAPHE000170"></a>Une fenêtre peut accueillir tous les types de champs disponibles. Une fenêtre peut :
...
<a name="fenetre_description_ELTPARAGRAPHE000227"></a>La fenêtre de description est une fenêtre à onglets, regroupant toutes les caractéristiques paramétrables de la fenêtre.
...
<a name="affichage_des_caracteristiques_ELTPARAGRAPHE000238"></a>Pour afficher la fenêtre de description :

- soit double-cliquez sur le fond de la fenêtre.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Detail_Description_FEN%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="caracteristiques_par_onglet_ELTPARAGRAPHE000252"></a>Ce paragraphe présente rapidement les différentes catégories de caractéristiques affichées par onglet.
...
## Fenêtre et image
<a name="fenetre_image_ELTTEXTE001135"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000314"></a>Pour optimiser le look des fenêtres de vos applications, WINDEV permet d'utiliser :
...
<a name="configuration_image_fond_ELTPARAGRAPHE000328"></a>La configuration est effectuée dans l'onglet "Image" de la description de la fenêtre.
...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMG_MAGENTA1.gif)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMG_MAGENTA2.gif)<br> |
...
Image originale :
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMG_SYM_HV.gif)
...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMG_SYM_H.gif)<br> | <br><br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMG_SYM_V.gif)<br> |
...
Le mode 9 images consiste à découper l'image de fond en 9 zones. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Mode9image3.gif)
...
Lors du redimensionnement de la fenêtre, seules les zones 2, 4, 6, 8 et 5 changent de taille pour occuper tout l'espace : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Mode9image2.gif)
...
### Fenêtre détourée
<a name="fenetre_detouree_ELTPARAGRAPHE000453"></a>WINDEV permet de détourer les fenêtres. Les fenêtres auront ainsi des formes originales (fenêtre en forme de cercle, d'ordinateur, etc.).
...
<a name="ouvrir_une_fenetre_popup_ELTTEXTE001186"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000470"></a>WINDEV permet d'ouvrir des fenêtres de type "popup".
...
Par exemple :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Ouvrir%20une%20fenetre%20popup%20-%20HC%20N%B0001.gif)
...
<a name="grisage_automatique_des_fenetres_ELTTEXTE001210"></a>
...
Par exemple :
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Grisage%20automatique%20des%20fenetres%20-%20HC%20N%B0001.gif&type=thumb)


Etape 1 : Vous modifiez des informations concernant un client puis vous cliquez sur le bouton "Valider".
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Grisage%20automatique%20des%20fenetres%20-%20HC%20N%B0002.gif&type=thumb)
...
## Fenêtre interne
<a name="fenetre_interne_ELTTEXTE001234"></a>
...
## Modèles de fenêtres
<a name="modeles_fenetres_ELTTEXTE001258"></a>
...
<a name="evenements_associes_aux_fenetres_ELTTEXTE001282"></a>


### Evénements gérés par défaut
<a name="evenements_geres_par_defaut_ELTPARAGRAPHE000568"></a>WINDEV gère par défaut les événements suivants (ordre d'apparition sous l'éditeur de code) :
...
<a name="evenements_optionnels_ELTPARAGRAPHE000616"></a>Plusieurs événements optionnels peuvent être gérés. Il suffit de : 
...
<a name="les_menus_contextuels_ELTTEXTE001312"></a>
...
Par exemple : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Les%20menus%20contextuels%20-%20HC%20N%B0001.gif)

<a name="NOTE11_2"></a>


### Fenêtres d'édition des menus contextuels
<a name="fenetres_edition_des_menus_contextuels_ELTPARAGRAPHE000665"></a>WINDEV permet de créer et de modifier des menus contextuels personnalisés dans une fenêtre d'édition particulière. Pour mieux comprendre la gestion des menus contextuels personnalisés, voici le vocabulaire lié à cette fenêtre d'édition :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Les%20menus%20contextuels%203%20-%20HC%20N%B0001.gif)

<a name="NOTE11_3"></a>


### Fonctionnalités disponibles
<a name="fonctionnalites_disponibles_ELTPARAGRAPHE000675"></a>WINDEV permet de :
...
<a name="menu_contextuel_systeme_par_defaut_ELTPARAGRAPHE000692"></a>Les types de champ suivants ont un menu contextuel système par défaut (affiché si aucun menu contextuel personnalisé n'est associé au champ) :

- un champ de saisie :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Les%20menus%20contextuels%20-%20HC%20N%B0003.gif)
Pour plus de détails sur la traduction de ce menu, consultez l'aide en ligne.

- une colonne de table :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Les%20menus%20contextuels%202%20-%20HC%20N%B0001.gif)
Pour plus de détails sur la traduction de ce menu, consultez l'aide en ligne.

- un champ ActiveX :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Les%20menus%20contextuels%20-%20HC%20N%B0005.gif)
...
<a name="les_menus_principaux_ELTTEXTE001354"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000722"></a>Un menu principal est obligatoirement associé à une fenêtre. Ce menu est affiché sous la barre de titre de la fenêtre sous WINDEV. En règle générale, les applications contiennent une fenêtre menu. Cette fenêtre contient uniquement un menu principal et permet d'accéder aux autres fenêtres de l'application.

Par exemple :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Les%20menus%20principaux%20-%20HC%20N%B0001.gif)

<a name="NOTE12_2"></a>


### Vocabulaire associé aux menus principaux
<a name="vocabulaire_associe_aux_menus_principaux_ELTPARAGRAPHE000734"></a>Pour manipuler simplement un menu principal, il est nécessaire de connaître le vocabulaire suivant :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Les%20menus%20principaux%20-%20HC%20N%B0002.gif)

<a name="NOTE12_3"></a>


### Fonctionnalités disponibles
<a name="fonctionnalites_disponibles_ELTPARAGRAPHE000744"></a>WINDEV permet de :
...
<a name="les_options_menus_ELTTEXTE001390"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000777"></a>Un menu (contextuel personnalisé ou principal) est composé d'une ou de plusieurs options et sous-options. Chaque option permet d'exécuter un code WLangage.
...
<a name="manipuler_les_options_menu_sous_editeur_ELTPARAGRAPHE000810"></a>L'éditeur de fenêtres permet de réaliser très simplement les manipulations suivantes :
...
<a name="manipuler_les_options_menu_par_programmation_ELTPARAGRAPHE000837"></a>La manipulation d'une option de menu est identique que le menu soit un menu contextuel ou un menu principal.
...
## La barre de message
<a name="barre_message_ELTTEXTE001426"></a>
...
<a name="fenetre_description_une_barre_message_ELTPARAGRAPHE000874"></a>La fenêtre de description d'une barre de message permet de :
...
<a name="type_une_case_barre_message_ELTPARAGRAPHE000889"></a>Le type de la case permet d'afficher :
...
<a name="caracteristiques_une_case_barre_message_ELTPARAGRAPHE000921"></a>La fenêtre de description de la barre de message permet également de définir les différentes caractéristiques d'affichage des cases de la barre de message.
