...
## Présentation
<a name="presentation_ELTTEXTE000578"></a>
...
<a name="comment_fonctionne_groupware_utilisateur_ELTTEXTE000602"></a>
...
### Le niveau utilisateur
<a name="niveau_utilisateur_ELTPARAGRAPHE000050"></a>
...
### Le niveau superviseur
<a name="niveau_superviseur_ELTPARAGRAPHE000061"></a>
...
**Remarque**: Toutes les informations concernant les utilisateurs et leurs droits sont stockées dans des tables au format HFSQL (Classic ou Client/Serveur).
...
<a name="mise_place_groupware_utilisateur_ELTTEXTE000638"></a>


### Ajouter le groupware utilisateur dans une application
<a name="ajouter_groupware_utilisateur_dans_une_application_ELTPARAGRAPHE000086"></a>
...
3. La fenêtre de paramétrage du groupware utilisateur permet d'activer le groupware utilisateur et de définir: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9grer%20le%20GPU2%20-%20HC%20N%B0001.gif&type=thumb)
...
- Le type de base de données et l'emplacement des tables du groupware utilisateur (Groupware utilisateur classique). 
...
Plusieurs types de groupware sont proposés: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9grer%20le%20GPU2%20-%20HC%20N%B0001%202.gif&type=thumb)
...
- **Groupware utilisateur classique**: Le groupware utilisateur sera intégré dans sa version "Classique": le groupware utilisateur sera associé uniquement à votre application, et la définition des droits sera effectuée depuis l'application. 
	...
	- l'onglet "Tables" permettant de spécifier le type de base de données utilisée ainsi que le type d'identification. 
...
- **Vous n'utilisez pas une plateforme PCSCloud**: installez les éléments suivants: 
 ...
 Pour plus de détails, consultez la page [Configuration d'un serveur d'authentification (Groupware utilisateur et Store Privé)](../WDLang3/1000021311.md).
...
Plusieurs modes de lancement sont disponibles:  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9grer%20le%20GPU2%20-%20HC%20N%B0001%201.gif&type=thumb)
...
<a name="options_groupware_utilisateur_classique_avec_serveur_authentification_ELTPARAGRAPHE000172"></a>

Plusieurs modes de personnalisation du groupware utilisateur sont disponibles: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9grer%20le%20GPU2%20-%20HC%20N%B0002.gif&type=thumb)


- **Pas de personnalisation**: 
	WINDEV se charge de tout. Il suffit de lancer l'application pour configurer les accès des utilisateurs. 
	Les fenêtres du groupware utilisateur peuvent utiliser automatiquement le thème de l'application. Il suffit de cocher l'option "Appliquer le gabarit du projet sur les fenêtres non personnalisées lors de l'exécution".
...
- **Personnalisation complète (mode expert)** - Groupware utilisateur classique uniquement: 
	Toute la programmation du groupware utilisateur est automatiquement intégrée à votre application. Le composant interne **WDGPU** est intégré à votre projet. Ce composant contient un schéma des données ainsi que toutes les fenêtres, requêtes, classes et procédures nécessaires à la gestion du groupware utilisateur. Vous pouvez ainsi personnaliser totalement toutes les fenêtres utilisées par le groupware utilisateur.




L'option "Appliquer le thème du projet sur les fenêtres non personnalisées lors de l'exécution" permet d'appliquer le thème de votre projet sur les fenêtres spécifiques au groupware utilisateur si celles-ci n'ont pas été personnalisées. 
...
- les tables sont en Français. Pour utiliser des données en anglais, il suffit de cocher l'option "Tables en anglais". 

- les tables du groupware utilisateur ont un mot de passe spécifique. Ce mot de passe est: "PCSGPW2001".
	...
	Remarque: Ce mot de passe est utilisé par exemple lors de la ré-indexation ou de l'ouverture des tables avec l'outil WDMAP.




Pour plus de détails sur ces tables et leur configuration (répertoire d'installation, etc.), consultez l'aide en ligne.


### Options spécifiques au groupware utilisateur classique
<a name="options_specifiques_groupware_utilisateur_classique_ELTPARAGRAPHE000220"></a>

Si le groupware utilisateur classique est utilisé, l'onglet "Tables" permet de configurer:
...
En mode "groupware utilisateur classique", le groupware utilisateur utilise plusieurs tables spécifiques. Ces tables permettent notamment de gérer les utilisateurs, les groupes, les droits et les éléments de l'application. Le groupware utilisateur classique peut être utilisé:

- soit avec des tables HFSQL Classic. Dans ce cas, un clic sur le lien "Répertoire par défaut" permet de spécifier si nécessaire l'emplacement des tables.

- soit avec des tables HFSQL Client/Serveur. Dans ce cas, un clic sur le lien "Cliquez ici pour saisir les paramètres du serveur" permet de définir les paramètres d'accès à la base de données HFSQL Client/Serveur, ainsi que le répertoire des fichiers.
...
- **Identification entièrement gérée par le groupware utilisateur**: 
	Les login et mot de passe sont enregistrés dans les tables du groupware utilisateur.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9grer%20le%20GPU2%20-%20HC%20N%B0004.gif&type=thumb)



### Options spécifiques au groupware utilisateur avec serveur d'authentification
<a name="options_specifiques_groupware_utilisateur_avec_serveur_authentification_ELTPARAGRAPHE000266"></a>
...
<a name="tester_application_groupware_utilisateur_classique_ELTPARAGRAPHE000283"></a>
...
<a name="creer_executable_windev_ELTPARAGRAPHE000309"></a>
...
Vous pouvez ainsi définir l'emplacement des tables du groupware utilisateur.
<a name="NOTE3_4"></a>


### Installer une application utilisant le groupware utilisateur classique
<a name="installer_une_application_utilisant_groupware_utilisateur_classique_ELTPARAGRAPHE000324"></a>
...
L'assistant propose un écran spécifique au groupware utilisateur classique permettant de configurer l'emplacement des tables propres au groupware utilisateur.

**Remarques**:

- Si vous avez paramétré les tables du groupware utilisateur pour votre client, il est nécessaire de les sélectionner lors de la préparation de l'installation. Il est donc nécessaire de personnaliser la liste des fichiers de l'installation.

- Si vous n'avez pas paramétré les tables du groupware, lors du premier lancement de l'application, seule l'utilisateur Superviseur existera dans l'application.
...
<a name="parametrer_application_utilisant_groupware_utilisateur_classique_ELTTEXTE000698"></a>
...
1. Lancer l'application (exécutable ou test depuis WINDEV) et se connecter en tant que superviseur:
	...
	- Mot de passe: superviseur <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9grer%20le%20GPU2%20-%20HC%20N%B0007.gif&type=thumb)





2. Choisir l'option "Configurer le groupware". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9grer%20le%20GPU2%20-%20HC%20N%B0008.gif&type=thumb)
...
<a name="gerer_les_utilisateurs_ELTPARAGRAPHE000381"></a>
...
- associer des utilisateurs à des groupes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9grer%20le%20GPU2%20-%20HC%20N%B0009.gif&type=thumb)
...
### Gérer les droits
<a name="gerer_les_droits_ELTPARAGRAPHE000417"></a>
...
### Afficher les statistiques
<a name="afficher_les_statistiques_ELTPARAGRAPHE000441"></a>
...
### Migrer des données
<a name="migrer_des_donnees_ELTPARAGRAPHE000450"></a>

A partir de la version 18, le groupware utilisateur a évolué. Les tables utilisées par le groupware utilisateur ne sont plus les mêmes.
...
<a name="conseils_pour_une_application_gerant_groupware_utilisateur_ELTTEXTE000746"></a>


### Utilisation de groupes de champs
<a name="utilisation_groupes_champs_ELTPARAGRAPHE000463"></a>
...
<a name="visibilite_des_champs_ELTPARAGRAPHE000478"></a>
...
<a name="definition_des_droits_ELTPARAGRAPHE000500"></a>

Pour obtenir une définition des droits correspondant aux fonctionnalités de votre application, il est conseillé:

- soit d'effectuer la configuration des droits voulue par l'utilisateur de votre application avant de créer la procédure d'installation. Il suffit alors d'ajouter les tables du groupware lors de la création de l'installation de l'application.
