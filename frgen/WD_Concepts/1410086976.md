...
<a name="les_differents_types_champs_une_fenetre_ELTPARAGRAPHE000023"></a>
...
<a name="creer_nouveau_champ_ELTPARAGRAPHE000101"></a>
...
<a name="creer_champ_associe_une_rubrique_ELTPARAGRAPHE000116"></a>

Tous les champs d'une fenêtre peuvent être associés à une rubrique de table, SAUF:
...
- Drag and Drop depuis le volet "schéma des données".
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Fen_Detail_Champ_Saisie%20-%20HC%20N%B0001.gif)
...
<a name="affichage_des_caracteristiques_ELTPARAGRAPHE000183"></a>
...
<a name="caracteristiques_par_onglet_ELTPARAGRAPHE000201"></a>
...
Cet onglet permet de sélectionner la rubrique (d'une table ou d'une requête) à laquelle le champ est relié. Selon l'enregistrement en cours, le contenu de la rubrique reliée sera affiché dans le champ.
...
<a name="les_poignees_des_champs_ELTPARAGRAPHE000275"></a>
...
- Les ***thèmes noirs*** (ou d'une autre couleur suivant le gabarit utilisé) permettent de visualiser le champ sélectionné et de le redimensionner.
...
<a name="manipulations_disponibles_ELTPARAGRAPHE000297"></a>
...
- Utiliser un champ hors fenêtre. Ce champ sera visible uniquement en édition et ne sera pas visible en exécution.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Manipuler%20les%20champs%20sous%20l'%E9diteur%20-%20HC%20N%B0001.gif)
...
### Les règles
<a name="les_regles_ELTPARAGRAPHE000344"></a>
...
Par exemple, dans le cas d'une fenêtre: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Alignement%20des%20champs%20-%20HC%20N%B0001.gif)
...
### Grille magnétique
<a name="grille_magnetique_ELTPARAGRAPHE000385"></a>
...
<a name="correcteur_interface_temps_reel_ELTPARAGRAPHE000394"></a>
...
<a name="correcteur_interface_avance_ELTPARAGRAPHE000403"></a>
...
<a name="les_options_alignement_ELTPARAGRAPHE000414"></a>
...
Pour afficher ces options, sous le volet "Affichage", cliquez sur l'icône de regroupement ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_regroup.gif) du groupe "Options".
<a name="NOTE6_2"></a>


### Rendre visible / invisible un champ
<a name="rendre_visible_invisible_champ_ELTPARAGRAPHE000483"></a>
...
<a name="verrouiller_deverrouiller_champ_ELTPARAGRAPHE000507"></a>
...
<a name="encadrer_non_champ_ELTPARAGRAPHE000535"></a>
...
- par programmation grâce aux propriétés WLangage.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Ancrage%20des%20champs%202%20-%20HC%20N%B0002.gif&type=thumb)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Ancrage%20des%20champs%202%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="ancrer_champ_sous_editeur_ELTPARAGRAPHE000585"></a>
...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=SansAncrage.gif) | **Aucun ancrage**: Le champ n'est pas modifié lorsque la taille de la fenêtre est modifiée. Aucune option d'ancrage n'est sélectionnée. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=A_Largeur.gif) | **Largeur**: Le champ s'étire vers la droite lorsque la fenêtre s'agrandit. Pour faire varier la vitesse d'étirement du champ par rapport à la fenêtre, utilisez le taux d'ancrage en largeur. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=A_Droite.gif) | **Droite**: Le champ se déplace vers la droite lorsque la fenêtre s'agrandit. Pour que le champ se déplace plus ou moins vite, utilisez le taux d'ancrage à droite. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=centre_Largeur.gif) | **Centré en largeur**: Le champ reste centré en largeur dans la fenêtre quelle que soit la largeur de la fenêtre. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=A_Hauteur.gif) | **Hauteur**: Le champ s'étire vers le bas lorsque la hauteur de la fenêtre s'agrandit. Pour faire varier la vitesse d'étirement du champ par rapport à la fenêtre, utilisez le taux d'ancrage en hauteur. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=A_Largeur_Hauteur.gif) | **Largeur et Hauteur**: Le champ s'étire vers la droite et vers le bas lorsque la fenêtre s'agrandit. Pour faire varier la vitesse d'étirement du champ par rapport à la fenêtre, utilisez le taux d'ancrage en hauteur et le taux d'ancrage en largeur. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=A_Droite_Hauteur.gif) | **Hauteur et Droite**: Le champ s'étire vers le bas et se déplace vers la droite lorsque la fenêtre s'agrandit. <br>Pour que le champ se déplace plus ou moins vite, utilisez le taux d'ancrage à droite. <br>Pour faire varier la vitesse d'étirement du champ par rapport à la fenêtre, utilisez le taux d'ancrage en hauteur. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Repart_Verticale.gif) | **Répartition Verticale**: Cette option n'est disponible que lorsque plusieurs champs sont sélectionnés. Les options d'ancrage permettent alors de conserver une répartition verticale des champs sélectionnés lorsque la fenêtre s'agrandit en hauteur. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=A_Bas.gif) | **Bas**: Le champ se déplace vers le bas lorsque la fenêtre est agrandie vers le bas. Pour que le champ se déplace plus ou moins vite, utilisez le taux d'ancrage en bas. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=A_Largeur_Bas.gif) | **Largeur et Bas**: Le champ s'étire vers la droite et se déplace vers le bas lorsque la fenêtre s'agrandit. <br>Pour que le champ se déplace plus ou moins vite, utilisez le taux d'ancrage en bas. <br>Pour faire varier la vitesse d'étirement du champ par rapport à la fenêtre, utilisez le taux d'ancrage en largeur. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=A_Droite_Bas.gif) | **Droite et Bas**: Le champ se déplace vers la droite et vers le bas lorsque la fenêtre s'agrandit. Pour que le champ se déplace plus ou moins vite, utilisez le taux d'ancrage en bas et le taux d'ancrage à droite. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Centre_Hauteur_A_Bas.gif) | **Centré horizontal en bas**: Le champ reste centré en largeur dans la fenêtre quelle que soit la largeur de la fenêtre. Cependant, le champ est ancré en bas et se déplace vers le bas lorsque la fenêtre s'agrandit.<br><br>Pour que le champ se déplace plus ou moins vite, utilisez le taux d'ancrage en bas. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=centre_Hauteur.gif) | **Centré en hauteur**: Le champ reste centré en hauteur dans la fenêtre quelle que soit la hauteur de la fenêtre. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Repart_Horizontale.gif) | **Répartition Horizontale**: Cette option n'est disponible que lorsque plusieurs champs sont sélectionnés. Les options d'ancrage permettent alors de conserver une répartition horizontale des champs sélectionnés lorsque la fenêtre s'élargit. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=centre_Vertical_Droite.gif) | **Centré vertical à droite**: Le champ reste centré en hauteur dans la fenêtre quelle que soit la hauteur de la fenêtre. <br><br>Cependant, le champ est ancré à droite et se déplace vers la droite lorsque la fenêtre est élargie. <br>Pour que le champ se déplace plus ou moins vite, utilisez le taux d'ancrage à droite. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=centre_Hauteur_Largeur.gif) | **Centré**: Le champ reste centré en hauteur et en largeur dans la fenêtre quelle que soit la taille de la fenêtre. |
...
<a name="exemple_parametrage_ancrage_des_champs_ELTPARAGRAPHE000688"></a>

Pour illustrer les possibilités d'ancrage des champs dans les fenêtres, voici un exemple détaillé.

Fenêtre originale:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Exemple%20de%20parametrage%20de%20l'ancrage%20des%20champs%20-%20HC%20N%B0001.gif)


Fenêtre agrandie :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Exemple%20de%20parametrage%20de%20l'ancrage%20des%20champs%20-%20HC%20N%B0002.gif)


**Pour obtenir ce résultat**:

1. Sélectionnez les champs Bouton [&lt;-] et [-&gt;]: ces champs doivent être centrés en hauteur et en largeur (option ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=centre_Hauteur_Largeur.gif)).
...
3. Sélectionnez les 3 champs Bouton: ces champs doivent s'étirer à droite proportionnellement (option ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Repart_Horizontale.gif)).
...
### Mise en place
<a name="mise_place_ELTPARAGRAPHE000738"></a>
...
3. En exécution, le temps restant est automatiquement affiché.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Fenetre-btn_Auto.gif&type=thumb)
...
### Programmation
<a name="programmation_ELTPARAGRAPHE000755"></a>

Il est possible également de définir un champ Bouton de validation automatique grâce à la fonction [DélaiAvantFermeture](../WDLang1/3038040.md).
<a name="NOTE8_4"></a>


### FAA: Fonctionnalité Automatique de votre Application
<a name="faa_fonctionnalite_automatique_votre_application_ELTPARAGRAPHE000767"></a>
