...
## Introduction
<a name="introduction_ELTTEXTE000368"></a>
...
- [éditeur de schémas des données](#NOTE2_2).
...
<a name="les_differents_editeurs_ELTTEXTE000392"></a>


### Editeur de projet
<a name="editeur_projet_ELTPARAGRAPHE000051"></a>
...
<a name="editeur_schemas_des_donnees_ELTPARAGRAPHE000068"></a>

L'Éditeur de schémas des données permet de décrire les caractéristiques et la structure des tables.

L'éditeur de schémas des données supporte la méthode Merise (MCD et MLD).

L'éditeur de schémas des données permet principalement deux types de descriptions d'une base de données:

- description directe du schéma des données lié au projet (appelé aussi Modèle Logique des Données (MLD)).

- description du Modèle Conceptuel des Données (MCD) puis génération automatique du schéma des données.




Voici quelques caractéristiques de l'éditeur de schémas des données:

- Editeur WYSIWYG ("What You See Is What You Get"). Vous visualisez directement toutes les tables et les liaisons de votre projet.

- Création et description des tables et de leurs rubriques.

- Mise en forme automatique des liaisons du schéma des données.
...
- Description indépendante des tables.

- Cryptage des tables.

- Modification automatique des tables en cas de modification de la structure des tables.

- Vérification de l'intégrité référentielle.

- Génération automatique du schéma des données.

- Zoom sur l'éditeur de schémas des données.

- Insertion de commentaires dans le graphe du schéma des données.

- Interaction des différents volets avec les différents éléments du schéma des données.
...
### Editeur UML
<a name="editeur_uml_ELTPARAGRAPHE000100"></a>
...
- de construire un modèle UML par rétro-schéma des données de votre projet.
...
### Editeur de requêtes
<a name="editeur_requetes_ELTPARAGRAPHE000139"></a>

L'éditeur de requêtes permet de créer automatiquement des requêtes sur les tables. 
...
### Editeur de fenêtres
<a name="editeur_fenetres_ELTPARAGRAPHE000166"></a>

L'éditeur de fenêtres permet de décrire les caractéristiques de l'interface utilisateur de votre projet.

De nombreux thèmes (feuilles de styles associées à la fenêtre) et types de fenêtres sont proposés. Ils permettent d'améliorer l'ergonomie de vos fenêtres et de rendre vos applications conviviales.
...
- Thèmes de fenêtres et styles de champs prédéfinis.
...
### Editeur d'états
<a name="editeur_etats_ELTPARAGRAPHE000196"></a>
...
- Thèmes d'états et styles de champs prédéfinis.
...
### Editeur de code
<a name="editeur_code_ELTPARAGRAPHE000219"></a>
...
### Editeur d'aide
<a name="editeur_aide_ELTPARAGRAPHE000258"></a>
...
### Editeur d'images
<a name="editeur_images_ELTPARAGRAPHE000281"></a>
