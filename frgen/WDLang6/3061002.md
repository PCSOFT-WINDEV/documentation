...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003061002&name=graveurajouterepertoire_fonction">Voir des exemples supplémentaires</a>
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Le chemin du répertoire est relatif au serveur Web.
...
|   |   |
| --- | --- |
| *graveurAjoutInterruptible* | Le parcours peut être interrompu en utilisant la touche ECHAP.<br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette constante n'a aucun effet. |
...
[GraveurAjouteFichier (Fonction)](../WDLang6/3061001.md)
