...
- [Manipulations simples de fichiers PDF en WLangage](#NOTE2_1) : Vérification de la protection, extraction d'une page, fusion de PDF, etc.
...
<a name="manipulations_simples_des_fichiers_pdf_wlangage_ELTTEXTE000195"></a>
...
<a name="manipulations_contenu_fichier_pdf_wlangage_ELTTEXTE000280"></a>


### Les types de variables
<a name="les_types_variables_ELTPARAGRAPHE000050"></a>Pour manipuler plus simplement le contenu d'un fichier PDF, le WLangage propose différents types de variables : 
...
<a name="manipulations_avec_les_types_variables_ELTPARAGRAPHE000056"></a>Une variable de type [pdfDocument](../WDLang6/1000024909.md) permet de charger en mémoire le contenu d'un fichier PDF. Par exemple : 
...
<a name="lire_ecrire_dans_les_champs_formulaire_pdf_ELTPARAGRAPHE000088"></a>Pour chaque page d'un document PDF, il est possible de parcourir les champs de la page dans une variable de type [pdfChamp](../WDLang6/1410090536.md). 

Pour chaque champ, il est possible de lire et de modifier si nécessaire la valeur du champ dans une variable de type [pdfOptionChamp](../WDLang6/1410090533.md). 
...
<a name="fonctions_permettant_manipuler_une_variable_type_pdfdocument_ELTPARAGRAPHE000103"></a>Des fonctions PDF spécifiques permettent de manipuler les variables de type [pdfDocument](../WDLang6/1000024909.md) : 
