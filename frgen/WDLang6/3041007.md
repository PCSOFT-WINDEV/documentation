...
La fonction **gpwOuvreConnexion** permet de définir et ouvrir une connexion pour les tables du groupware utilisateur. Pour utiliser la même connexion sur toutes les tables de l'application, il suffit d'utiliser la fonction [HChangeConnexion](../WDLang4/3044150.md). Ensuite, la fonction [gpwOuvre](../WDLang6/3041002.md) permet d'indiquer le positionnement des tables permettant de gérer les droits, et des tables permettant d'identifier les utilisateurs.
<a name="Exemple1"></a>
...
SINON 
	...
	SI nRes <> gpwOk ALORS 
		...
		FIN 
	FIN 
	// Utilisation de la même connexion pour toutes les tables 
...
```wl
// Changer le mot de passe des tables du groupware utilisateur par programmation
// Exemple avec la table GPWUTILISATEUR
gpwInitAnalyse()
...
HCréeSiInexistant(GPWUTILISATEUR)
...
Utilisez la fonction [gpwOuvre](../WDLang6/3041002.md) pour indiquer le positionnement des tables permettant de gérer les droits, et les tables permettant d'identifier les utilisateurs. Les répertoires indiqués doivent être relatifs au répertoire du serveur.

**`<Nom de la connexion> : (Chaîne de caractères)`**

Nom de la nouvelle connexion à définir et à ouvrir. Ce nom ne doit pas être déjà utilisé par une autre connexion (connexion définie dans le schéma des données, ou définie avec la fonction [HOuvreConnexion](../WDLang4/3044107.md) ou [HDécritConnexion](../WDLang4/3044205.md)).
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) Les mots-clés reconnus pour le Connecteur Natif MySQL: 
...
![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png) Les mots-clés reconnus pour l'accès par un provider OLE DB:
...
Nom de la variable de type [Connexion](../WDLang4/1514073.md) à ouvrir. Ce nom ne doit pas être déjà utilisé par une autre connexion (connexion définie dans le schéma des données, ou définie avec la fonction [HOuvreConnexion](../WDLang4/3044107.md) ou [HDécritConnexion](../WDLang4/3044205.md)).
...
<a name="utiliser_une_chaine_caracteres_pour_provider_ole_ELTPARAGRAPHE000368"></a>
...
1. Dans l'éditeur de schémas des données, affichez la fenêtre de description des connexions: sous le volet "Schéma des données", dans le groupe "Connexion", cliquez sur "Connexions".

2. Sélectionnez le provider à utiliser (combo "Connexion par").

3. La chaîne de caractères correspondant au provider s'affiche. Cette chaîne de caractères peut être utilisée dans la syntaxe 2 à la place des constantes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=HOuvreConnexion.gif)
...
<a name="cas_echec_description_connexion_nest_pas_conservee_ELTPARAGRAPHE000392"></a>
...
<a name="deux_connexions_sont_ouvertes_sur_serveur_ELTPARAGRAPHE000401"></a>
...
<a name="validite_connexion_ELTPARAGRAPHE000408"></a>

La fonction **gpwOuvreConnexion** se comporte comme la fonction [HDécritConnexion](../WDLang4/3044205.md): cette fonction ne fait pas immédiatement la connexion. 
...
<a name="NOTE0_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 

### Pseudo connexion à une base de données HFSQL Classic
<a name="pseudo_connexion_une_base_donnees_hfsql_classic_ELTPARAGRAPHE000435"></a>

Des tables OLE DB ou natives sont décrites sous l'Éditeur de schémas des données. Pour manipuler ces descriptions avec une base de données HFSQL Classic, le paramètre &lt;Provider OLE DB ou Connecteur Natif&gt; doit correspondre à la constante *hAccèsHF7*.
...
[Groupware utilisateur et tables Client/Serveur](../WDLang6/1000021177.md)
