...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003061005&name=graveurefface_fonction">Voir des exemples supplémentaires</a>
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) La gravure de CD et DVD sera réalisée sur le serveur Web. Pour graver des CD ou des DVD, le serveur doit être sous Windows XP ou supérieur. Pour graver des CD sous Windows 2003 Serveur, il est nécessaire d'activer le service de gravure IMAPI (nommé "Service COM de gravage de CD IMAPI"). Pour graver des DVD sous Windows 2003 Serveur, il est nécessaire d'installer en plus la mise à jour KB932716. 
...
[GraveurEnregistre (Fonction)](../WDLang6/3061006.md)
