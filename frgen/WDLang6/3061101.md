...
Toutes les fenêtres de l'application sont alors iconisées et rendues invisibles. Si l'utilisateur veut restaurer l'application, un mot de passe est nécessaire. La fenêtre suivante est affichée par défaut:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Verrouillage_appli%20-%20HC%20N%B0001.gif)
...
<a name="mettre_place_verrouillage_application_depuis_editeur_ELTPARAGRAPHE000037"></a>
...
<a name="mettre_place_verrouillage_application_par_programmation_ELTPARAGRAPHE000065"></a>

Pour mettre en place le verrouillage de l'application par programmation, il suffit d'utiliser les fonctions [VerrouXXX](../WDLang6/3061100.md).
<a name="NOTE2_3"></a>


### Modifier la fenêtre utilisée pour le verrouillage d'application
<a name="modifier_fenetre_utilisee_pour_verrouillage_application_ELTPARAGRAPHE000075"></a>

Si votre application utilise le verrouillage automatique, la fenêtre de verrouillage n'apparaît pas dans votre projet. Cependant, il est possible de lui appliquer le thème du projet en utilisant la fonction [ChangeGabarit](../WDLang1/3013026.md).
