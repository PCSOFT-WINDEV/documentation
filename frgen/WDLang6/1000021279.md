...
MonImage est Image = PDFExtraitPage(MonPDF, 3)
```
<a name="Exemple3"></a>
...
// Recherche dans la table DOC_Contact le libellé contenu dans le champ Table.
...
[&lt;Variable pdfDocument&gt;.ExtraitPage (Fonction)](../WDLang6/1410090338.md)
