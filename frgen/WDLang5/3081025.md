...
|   |   |
| --- | --- |
| *XMLAvecNamespace* | Recherche sur les éléments contenant un namespace.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
