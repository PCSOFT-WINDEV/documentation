...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) En WINDEV, la lecture de codes-barres est réalisée grâce à un appareil spécialisé branché sur le port série du poste. 
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) En WEBDEV, il est possible de lire un code-barres présent dans une image.
	Pour plus de détails, consultez [Lire un code-barres dans une site WEBDEV](#NOTE3b_1).

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Dans les applications Android, la lecture du code-barres est réalisée via la caméra de l'appareil.  
	Pour plus de détails, consultez [Lire un code-barres dans une application Android](#NOTE4_1).

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Dans les applications iPhone/iPad, la lecture de nombreux codes-barres est disponible. Il est possible de : 
