...
### Cas particuliers
<a name="cas_particuliers_ELTPARAGRAPHE000085"></a>
...
### Assistant de code
<a name="assistant_code_ELTPARAGRAPHE000108"></a>L'éditeur de code propose un assistant de code permettant de générer le code de la fonction **XMLLit**. Pour l'utiliser, tapez "XMLLit(" sous l'éditeur de code puis sélectionnez l'option "Assistant de la fonction XMLLit".
...
[XMLEcrit (Fonction)](../WDLang5/1000017031.md)
