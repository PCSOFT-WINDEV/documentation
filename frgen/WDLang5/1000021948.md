...
<a name="declaration_application_android_dans_facebook_ELTPARAGRAPHE000317"></a>Dans un premier temps, il est bien entendu nécessaire de créer avec WINDEV Mobile une application Android utilisant l'identification Facebook et/ou l'API Facebook.
...
<a name="declaration_application_ios_dans_facebook_ELTPARAGRAPHE000365"></a>Dans un premier temps, il est bien entendu nécessaire de créer avec WINDEV Mobile une application iOS utilisant l'identification Facebook et/ou l'API Facebook.
...
<a name="declaration_site_webdev_dans_facebook_ELTPARAGRAPHE000400"></a>Dans un premier temps, il est bien entendu nécessaire de créer avec WEBDEV un site utilisant l'identification Facebook et/ou l'API Facebook.
