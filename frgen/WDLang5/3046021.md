...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003046021&name=iinitrequeteetat_fonction">Voir des exemples supplémentaires</a>
...
<a name="execution_une_requete_etat_base_sur_cette_requete_ELTPARAGRAPHE000133"></a>Lors de l'impression d'un état basé sur une requête, si la requête a déjà été exécutée, elle n'est pas ré-exécutée. Pour forcer la ré-exécution de la requête (ajout d'enregistrements par exemple), il suffit d'utiliser les fonctions [HExécuteRequête](../WDLang4/3044080.md) ou **iInitRequêteEtat**.
<a name="NOTE0_3"></a>


### Libération de la requête
<a name="liberation_requete_ELTPARAGRAPHE000148"></a>Lors de l'impression d'un état basé sur une requête initialisée avec la fonction **iInitRequêteEtat**, la requête est libérée à la fin de l'impression de l'état (comportement identique à l'appel de la fonction [HAnnuleDéclaration](../WDLang4/3044174.md)).
<a name="NOTE0_4"></a>


### Divers
<a name="divers_ELTPARAGRAPHE000163"></a>
