...
|   |   |
| --- | --- |
| *sfCréationSiInexistant* | Si l'enregistrement n'existe pas, il est automatiquement créé.<br><br> |
...
## Remarques
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 

### Cas d'erreurs possibles
<a name="cas_erreurs_possibles_ELTPARAGRAPHE000135"></a>
...
[&lt;Variable sfConnexion&gt;.Modifie (Fonction)](../WDLang5/1000018771.md)
