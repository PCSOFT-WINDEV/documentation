...
|   |   |
| --- | --- |
| *iPDFNiveauGris* | PDF généré en noir et blanc. <br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'est pas disponible. |
...
| *iQualitéElevée* | Qualité de compression élevée<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'est pas disponible. |
| *iQualitéFaible* | Qualité de compression faible<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'est pas disponible. |
| *iQualitéMaximale* | Qualité de compression maximale<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'est pas disponible. |
| *iQualitéMinimale* | Qualité de compression minimale<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'est pas disponible. |
| *iQualitéMoyenne* | Qualité de compression moyenne<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'est pas disponible. |
| *iSignetAucun* | Aucun signet n'est pris en compte dans le PDF |
| *iSignetPage* | Les signets sont pris en compte dans le PDF. Un signet est automatiquement défini pour chaque page du PDF. Chaque signet a pour nom "Page &lt;numéro de la page&gt;" (par exemple "Page 1"). |
...
<a name="gestion_format_pdfa_ELTPARAGRAPHE000361"></a>Limitations : 
