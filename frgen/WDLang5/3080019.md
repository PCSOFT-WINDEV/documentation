...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003080019&name=xlstypecolonne_fonction">Voir des exemples supplémentaires</a>
...
<a name="type_des_donnees_saisies_une_colonne_prise_compte_des_colonnes_vides_ELTPARAGRAPHE000200"></a>Les colonnes vides peuvent être prises en compte ou non. Par exemple :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=xlsTypeColonne.gif)
...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000209"></a>La fonction **xlsTypeColonne** génère une erreur dans les cas suivants :
...
[xlsTitreColonne (Fonction)](../WDLang5/3080012.md)
