...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003080021&name=xlsdonnee_fonction">Voir des exemples supplémentaires</a>
...
<a name="contenu_des_cellules_prise_compte_des_lignes_colonnes_vides_ELTPARAGRAPHE000143"></a>Les lignes et les colonnes vides peuvent être prises en compte ou non. Par exemple :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=xlsDonnee.gif)
...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000153"></a>En cas d'erreur, la fonction **xlsDonnée** renvoie une chaîne vide (""). Pour connaître le libellé de l'erreur, utilisez la fonction [xlsMsgErreur](../WDLang5/3080016.md) ou la fonction [ErreurInfo](../WDLang1/3013008.md) avec la constante *errMessage*.
...
<a name="type_donnee_recuperee_ELTPARAGRAPHE000178"></a>Quel que soit le format de cellule défini sous Excel, la fonction **xlsDonnée** renvoie une chaîne.
