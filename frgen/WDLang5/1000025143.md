...
<a name="execution_une_requete_etat_base_sur_cette_requete_ELTPARAGRAPHE000282"></a>Lors de l'impression d'un état basé sur une requête, si la requête a déjà été exécutée, elle n'est pas ré-exécutée. Pour forcer la ré-exécution de la requête (ajout d'enregistrements par exemple), il suffit d'utiliser les fonctions [&lt;Source&gt;.ExécuteRequête](../WDLang4/1000024944.md) ou **&lt;Etat&gt;.InitRequête**.
<a name="NOTE0_3"></a>


### Libération de la requête
<a name="liberation_requete_ELTPARAGRAPHE000300"></a>Lors de l'impression d'un état basé sur une requête initialisée avec la fonction **&lt;Etat&gt;.InitRequête**, la requête est libérée à la fin de l'impression de l'état (comportement identique à l'appel de la fonction [&lt;Source&gt;.AnnuleDéclaration](../WDLang4/1000024192.md)).
<a name="NOTE0_4"></a>
