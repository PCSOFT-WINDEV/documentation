...
- **directement sur l'imprimante** ([syntaxe 1](#SYNTAXE1)). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) dans une [mini-fenêtre d'aperçu](../WDChamp/1011094.md) ([syntaxe 1](#SYNTAXE1)).

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **dans le visualisateur de rapports** ([syntaxe 2](#SYNTAXE7)). L'utilisateur peut ainsi visualiser le résultat de l'impression à l'écran, page par page. Dans ce visualisateur, il est possible de :
...
- **directement dans un fichier** texte, HTM, RTF, PDF, PRN ou XML ([syntaxe 3](#SYNTAXE3)).
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Pour obtenir une impression identique lors du développement et sur le site déployé, il est conseillé de réaliser des impressions génériques (par exemple avec les constantes *iPDFGénérique*, ...).
	![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Dans cette version, l'impression se fait uniquement dans un fichier PDF.

- **directement un duplicata** ([syntaxe 4](#SYNTAXE4)).

- **directement sur un fax** ([syntaxe 6](#SYNTAXE5) et [syntaxe 7](#SYNTAXE6), envoi d'un état vers un numéro de fax par exemple). Pour plus de détails sur la gestion des fax, consultez [Envoyer des fax](../WDLang3/3037002.md). 




![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Seules les impressions au format PDF sont disponibles.![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png) Remarque : La fonction **iDestination** permet également de connaître le type d'impression effectuée (utilisation dans le code d'ouverture de l'état ou dans le code "Avant réimpression" de l'état). Pour plus de détails, consultez la [syntaxe 8](#SYNTAXE8).
<a name="Exemple1"></a>
...
<a name="Exemple2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 
```wl
...
|   |   |
| --- | --- |
| *iImprimante* | Impression directe sur l'imprimante. <br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) <br><br>- Cette fonctionnalité est notamment utilisée pour les sites Intranet. <br><br>- Sur le serveur d'application (en déploiement), l'impression se fait uniquement sur les imprimantes connectées au serveur. Dans ce cas, une configuration spécifique est nécessaire. Pour plus de détails, consultez [Configuration du serveur pour réaliser une impression](../WDChamp/1011002.md).<br><br>- Pour les sites Internet, il est conseillé de réaliser l'impression sous forme d'un fichier au format PDF générique. <br><br><br> |
| *iMiniAperçu* | Impression dans un mini-aperçu. Ce mini-aperçu permet de visualiser les différentes pages à imprimer et de définir les options d'impression. Il est également possible de réaliser des exports. <br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
...
| *i2PagesAvecCouverture*<br>*iapZoom2PagesAvecCouverture* | Aperçu affichant 2 pages en même temps, avec la première page en couverture (la première page est une page de droite). |
...
| *iXLS* | Impression directe dans un fichier XLS. Le fichier a pour nom &lt;Nom de l'état&gt;.XLS (où &lt;Nom de l'état&gt; correspond au nom de l'état défini sous l'éditeur d'états). Ce fichier est créé dans le répertoire de l'application. <br>Si le paramètre &lt;Nom du fichier à créer&gt; est précisé, le nom du fichier sera &lt;Nom du fichier à créer&gt;.XLS. Aucun aperçu ne sera affiché.<br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Si le répertoire du fichier n'est pas précisé, le fichier est généré dans le répertoire des données du site. Ce répertoire est paramétrable grâce à l'outil WDCOMPTE. Ce répertoire peut être connu grâce à la fonction [fRepDonnées](../WDLang1/3036001.md). Il est conseillé d'utiliser la fonction [iDernierFichier](../WDLang5/3046068.md) pour ouvrir le dernier fichier généré.<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
...
| *iXML* | Impression directe dans un fichier XML. Le fichier a pour nom &lt;Nom de l'état&gt;.XML (où &lt;Nom de l'état&gt; correspond au nom de l'état défini sous l'éditeur d'états). Ce fichier est créé dans le répertoire de l'application. <br>Si le paramètre &lt;Nom du fichier à créer&gt; est précisé, le nom du fichier sera &lt;Nom du fichier à créer&gt;.XML. Aucun aperçu ne sera affiché.<br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Si le répertoire du fichier n'est pas précisé, le fichier est généré dans le répertoire des données du site. Ce répertoire est paramétrable grâce à l'outil WDCOMPTE. Ce répertoire peut être connu grâce à la fonction [fRepDonnées](../WDLang1/3036001.md). Il est conseillé d'utiliser la fonction [iDernierFichier](../WDLang5/3046068.md) pour ouvrir le dernier fichier généré.<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
...
### Imprimer directement sur une imprimante PCL (conservé par compatibilité)
...
<a name="SYNTAXE8"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png) 
...
<a name="quand_utiliser_fonction_docparampagetitleshort_ELTPARAGRAPHE000912"></a>La fonction **iDestination** doit être la première fonction d'impression appelée. Elle doit donc figurer avant les fonctions [iImprime](../WDLang5/3046031.md), [iCréePolice](../WDLang5/3046045.md), etc. Mais la fonction **iDestination** doit être appelée **après** les fonctions [iConfigure](../WDLang5/3046072.md) ou [iParamètre](../WDLang5/3046008.md).
...
<a name="android_impression_format_pdf_ELTPARAGRAPHE000950"></a>Par défaut, si la fonction **iDestination** n'est pas appelée avant de lancer une impression PDF, un fichier "document.pdf" sera généré dans le répertoire des fichiers de l'application. 
...
### Impression au format PDF
<a name="impression_format_pdf_ELTPARAGRAPHE000971"></a>Le fichier PDF généré peut être directement imprimé via la fonction [iImprimePDF](../WDLang5/1000020519.md).

![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Le fichier PDF généré peut également être visualisé via le champ [Lecteur PDF](../WDChamp/1410087036.md). 
<a name="NOTE0_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 

### Impression en HTML
<a name="impression_html_ELTPARAGRAPHE000992"></a>
...
### Impression en XLS
<a name="impression_xls_ELTPARAGRAPHE001007"></a>
...
### Impression en RTF
<a name="impression_rtf_ELTPARAGRAPHE001016"></a>
...
<a name="NOTE0_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 

### Configuration de l'imprimante pour l'impression en HTML, RTF et Texte
<a name="configuration_imprimante_pour_impression_html_rtf_texte_ELTPARAGRAPHE001031"></a>
...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Si aucune imprimante n'est connectée au serveur, une imprimante fictive est utilisée.
...
<a name="impression_format_prn_ELTPARAGRAPHE001046"></a>Lors d'une impression au format PRN, le fichier PRN est spécifique à l'imprimante sélectionnée. Ce fichier est directement créé par le driver de l'imprimante, c'est un fichier binaire interprétable par l'imprimante.
...
### Impression en XML
<a name="impression_xml_ELTPARAGRAPHE001063"></a>Lors d'une impression au format XML, seules les données sont imprimées. Les caractéristiques de mise en page (traits, ...) ne sont pas prises en compte.
<a name="NOTE0_8"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 

### Caractéristiques d'impression
<a name="caracteristiques_impression_ELTPARAGRAPHE001072"></a>
...
<a name="impression_sur_fax_ELTPARAGRAPHE001088"></a>Deux syntaxes permettent d'envoyer une impression sur un fax :
...
<a name="impression_fax_mode_paysage_ELTPARAGRAPHE001112"></a>Pour paramétrer l'impression d'un fax en mode paysage (impression de plusieurs fax, dont un en mode paysage), il est nécessaire d'utiliser les fonctions d'impression dans l'ordre suivant :
...
<a name="NOTE0_12"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 

### Fin d'impression
<a name="fin_impression_ELTPARAGRAPHE001152"></a>La fonction [iFinImprime](../WDLang5/3046053.md) doit nécessairement être appelée pour terminer l'édition sauf après un appel à la fonction [iImprimeEtat](../WDLang5/3046032.md).
...
[iLien (Fonction)](../WDLang5/3046018.md)

[iFinImprime (Fonction)](../WDLang5/3046053.md)

[Fonctions d'impression](../WDLang5/3046065.md)

[Envoyer des fax avec WINDEV et WEBDEV](../WDLang5/3037002.md)

[FichierAffiche (Fonction)](../WDLang5/3012005.md)

[Imprimer en WLangage](../WDLang5/3046012.md)

[Imprimer sous Linux](../WDLang5/9000078.md)

[Mini fenêtre d'aperçu](../WDLang5/1011094.md)
