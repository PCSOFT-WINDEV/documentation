...
- l'affichage ou non des volets (et des boutons présents) du ruban. Pour plus de détails, consultez [Visualisateur de rapports](../WDChamp/1011085.md).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Apercu_Volet_Apercu.gif&type=thumb)
...
- Si l'application autorise le lancement du logiciel "Etats & Requêtes" livré avec WINDEV, 2 boutons supplémentaires peuvent apparaître dans le visualisateur de rapports. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Apercu_impression%20-%20HC%20N%B0002%201.gif)
