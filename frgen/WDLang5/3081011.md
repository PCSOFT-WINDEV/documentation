...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) La liste des attributs est triée par ordre alphabétique. Cet attribut est donc ajouté selon l'ordre alphabétique.
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Attention : Il n'est pas possible de créer des éléments (balise ou attribut) avec des caractères accentués. 
...
### Gestion de l'ajout 
<a name="gestion_ajout_ELTPARAGRAPHE000076"></a>
...
<a name="enregistrer_les_modifications_dans_fichier_xml_ELTPARAGRAPHE000087"></a>Pour enregistrer les modifications effectuées dans un fichier XML, vous devez :
...
<a name="fonctions_xml_threads_ELTPARAGRAPHE000114"></a>Si votre application utilise des threads, le document XML est partagé entre tous ces threads. Pour plus de détails sur la gestion des threads, consultez [Gestion des threads](../WDLang1/3077026.md).
