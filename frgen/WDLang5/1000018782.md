...
1. Ajoutez le document XML dans le projet grâce à une des méthodes suivantes : 
	...
	- sous le volet "Projet", dans le groupe "Projet", déroulez "![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_listeprojet.gif) Liste des éléments" et cliquez sur "Liste des éléments du projet". La liste des éléments du projet s'affiche. Cliquez sur le bouton "Ajouter" et sélectionnez le document XML.
...
<a name="proprietes_specifiques_description_des_variables_type_xmldocument_ELTPARAGRAPHE000092"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une variable de type **xmlDocument** :
...
<a name="utiliser_indirection_sur_les_chemins_dans_document_xml_ELTPARAGRAPHE000137"></a>Il est possible d'utiliser les opérateurs d'indirection pour construire le chemin d'un élément dans un document XML. 
...
<a name="fonctions_utilisant_les_variables_type_xmldocument_ELTPARAGRAPHE000149"></a>
...
[XMLDocument (Fonction)](../WDLang5/3081008.md)
