...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Seules les requêtes de calcul effectuées dans un document XML sont supportées en PHP.
...
## Syntaxe
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Syntaxe non disponible en PHP et en code navigateur
...
<a name="SYNTAXE2"></a>
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Syntaxe non disponible en Android et Android Widget
...
<a name="syntaxe_2_executer_une_requete_xpath_sur_document_xml_lecture_resultat_requete_ELTPARAGRAPHE000178"></a>

Si la fonction **XMLExécuteXPath** renvoie <u><u><u><u>Vrai</u></u></u></u>, la requête a été correctement exécutée. Le résultat de la requête peut être lu de la manière suivante:
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000279"></a>
...
<a name="fonctions_xml_threads_ELTPARAGRAPHE000467"></a>Si votre application utilise des threads, le document XML est partagé entre tous ces threads. Pour plus de détails sur la gestion des threads, consultez [Gestion des threads](../WDLang1/3077026.md).
