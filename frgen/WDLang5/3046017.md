...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Seules les images au format JPEG peuvent être imprimées.![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Il est déconseillé d'utiliser des images au format GIF (ce format n'est pas complètement géré par le système Android).
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003046017&name=iimprimeimage_fonction">Voir des exemples supplémentaires</a>
...
|   |   |
| --- | --- |
| *iAffichageHomoCentré* | L'image est étirée ou réduite pour occuper de manière optimale l'espace défini sans être déformée. Elle est centrée dans la zone définie par &lt;X1&gt;, &lt;Y1&gt;, &lt;X2&gt; et &lt;Y2&gt;.<br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Img_HomoCentre.GIF)<br> |
| *iAffichageHomothétique* | L'image est affichée en &lt;X1&gt; &lt;Y1&gt; sans déformation. Elle occupe soit toute la hauteur définie par &lt;X1&gt; et &lt;X2&gt;, soit toute la largeur définie par &lt;Y1&gt; et &lt;Y2&gt;.<br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Img_Homo.GIF)<br> |
| *iAffichageNormal*<br>(Valeur par défaut) | L'image est affichée dans la totalité du rectangle défini par &lt;X1&gt;, &lt;Y1&gt;, &lt;X2&gt; et &lt;Y2&gt;. L'image peut être déformée.<br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Img_Normal.GIF)<br> |

![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Ce paramètre n'est pas supporté.
...
### Divers
<a name="divers_ELTPARAGRAPHE000246"></a>
...
<a name="impression_dans_fichier_html_ELTPARAGRAPHE000256"></a>Si la fonction **iImprimeImage** est utilisée lors d'une impression dans un état (créé avec l'éditeur d'états) au format HTML, l'image imprimée sera déformée.
<a name="NOTE0_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 

### Impression en PDF
<a name="impression_pdf_ELTPARAGRAPHE000268"></a>Si seules les coordonnées du point haut gauche de l'image sont indiquées, la largeur de l'image dépend du DPI de l'imprimante.
...
[iHauteurImage (Fonction)](../WDLang5/3046057.md)

[iFinImprime (Fonction)](../WDLang5/3046053.md)

[InfoBitmap (Fonction)](../WDLang5/3029015.md)
