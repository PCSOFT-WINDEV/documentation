...
<a name="les_elements_proposes_par_wlangage_ELTTEXTE000391"></a>
...
<a name="declaration_application_dans_facebook_ELTTEXTE000455"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Déclaration de l'application WINDEV dans Facebook
<a name="declaration_application_windev_dans_facebook_ELTPARAGRAPHE000068"></a>Dans un premier temps, il est bien entendu nécessaire de créer avec WINDEV une application Windows utilisant l'identification Facebook et/ou l'API Facebook. 
...
<a name="declaration_application_android_dans_facebook_ELTPARAGRAPHE000106"></a>Dans un premier temps, il est bien entendu nécessaire de créer avec WINDEV Mobile une application Android utilisant l'identification Facebook et/ou l'API Facebook.

Remarque : Certains éléments nécessaires à la création de l'application Facebook vous sont fournis dans [l'assistant de génération d'une application Android (écran "Facebook")](../Editeurs/9000109.md). Pour que l'étape Facebook apparaisse dans cet assistant, il est nécessaire d'utiliser une fonction WLangage liée à Facebook. 
...
<a name="declaration_application_ios_dans_facebook_ELTPARAGRAPHE000151"></a>Dans un premier temps, il est bien entendu nécessaire de créer avec WINDEV Mobile une application iOS utilisant l'identification Facebook et/ou l'API Facebook.
...
<a name="declaration_site_webdev_dans_facebook_ELTPARAGRAPHE000183"></a>Dans un premier temps, il est bien entendu nécessaire de créer avec WEBDEV un site utilisant l'identification Facebook et/ou l'API Facebook.
...
<a name="mise_place_identification_facebook_dans_application_windev_windev_mobile_dans_site_webdev_ELTTEXTE000497"></a>


### Mise en place de la connexion
<a name="mise_place_connexion_ELTPARAGRAPHE000217"></a>Pour se connecter à Facebook, il suffit de : 
...
1. Paramétrer une session Facebook (variable de type [fbSession](../WDLang5/1000021851.md)). Dans les différentes propriétés de cette variable, vous devez indiquer : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) le "App ID" et le "App Secret" fournis lors de l'inscription de l'application à Facebook. 

	- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) le "App ID" fourni lors de l'inscription de l'application à Facebook. 




2. Lancer la connexion avec la fonction [FBOuvreSession](../WDLang5/1000021835.md).
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Une page Web s'affiche dans le navigateur par défaut permettant à l'utilisateur de saisir son login et son mot de passe.

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) La fonction utilise par défaut le compte Facebook entré par l'utilisateur sur le téléphone (si ce compte est fourni). 

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) La permission "public_profile" est toujours requise lors de l'ouverture d'une session Facebook. Si cette permission n'a pas été spécifiée dans la liste des permissions de la variable [fbSession](../WDLang5/1000021851.md) passée en paramètre à la fonction **FBOuvreSession**, cette permission sera automatiquement demandée.
...
<a name="utilisation_api_facebook_ELTPARAGRAPHE000275"></a>La fonction [FBRequête](../WDLang5/1000021838.md) permet d'effectuer des requêtes auprès de Facebook.
...
[Génération d'une application pour Android](../WDLang5/9000109.md)
