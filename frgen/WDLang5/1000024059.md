...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette fonction ne peut pas être utilisée pour un état programmé (créé avec les fonctions d'impression iXXX). 
<a name="Exemple1"></a>
...
|   |   |
| --- | --- |
| *relationAlternative*<br>(Valeur par défaut) | Spécification de fichier correspondant à une représentation alternative du contenu. Exemple : fichier audio. |
...
<a name="format_fichier_pdf_ELTPARAGRAPHE000134"></a>La fonction **iAjoutePièceJointe** permet uniquement d'ajouter des fichiers dans les fichiers PDF au format PDF standard et PDF/A-3b. 
