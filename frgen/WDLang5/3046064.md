...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) à l'aide d'un appareil spécialisé et récupérées dans une application WINDEV. 
	Pour les codes-barres de type QR Code, il est également possible de lire un code-barres présent dans une image. 

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) à l'aide de l'appareil photo d'un téléphone Android et récupérées dans une application Android.

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) à l'aide de l'appareil photo d'un iPhone ou iPad et récupérées dans une application iOS. Pour les codes-barres de type QR Code, il est également possible de lire un code-barres présent dans une image.
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CodeBarreUPC.gif)<br> | Code-barres des produits vendus en supermarché (US). Sa taille globale est de 12 chiffres. Il contient :<br><br>- le code du fabricant (5 caractères).<br><br>- le code du produit (5 caractères).<br><br>- un numéro système.<br><br>- un caractère de contrôle.<br><br><br> |
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CodeBarre2Parmi5.gif)<br> | Code-barres utilisé en milieu industriel, compacte avec un maximum de 18 chiffres par pouces. Il est surtout utilisé pour une lecture entièrement automatisée. <br> |
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CodeBarreCodabar.gif)<br> | Code-barres utilisé en librairie, dans les banques de sang. Il accepte outre les chiffres, les caractères : "$ABCD./+:-". |
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CodeBarreMSI.gif)<br> | Codage réalisé bit par bit, chaque bit étant l'association d'une barre pleine et d'une barre vide. Il accepte 10 chiffres et 6 caractères additionnels.<br>Caractéristiques gérées pour ce code-barres :<br><br>- Code-barres avec vérification : le dernier caractère du code-barres correspond à un caractère de vérification.<br><br>- Code-barres étendu : un code-barres étendu peut contenir les 128 caractères présents dans le code ASCII.<br><br><br> |
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CodeBarreCode39.gif)<br> | Premier code-barres alphanumériques développé. Originellement, il accepte seulement les 26 lettres de l'alphabet en majuscules. Avec extension, les 128 codes ASCII sont accessibles.<br>Le **Code 93** est une extension du code 39. |
