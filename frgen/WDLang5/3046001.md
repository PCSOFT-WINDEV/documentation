...
- l'affichage ou non des volets (et des boutons présents) du ruban. Pour plus de détails, consultez [Aperçu avant impression](../WDChamp/1011085.md).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Apercu_Volet_Apercu.gif)
...
- Si l'application autorise le lancement du logiciel "Etats & Requêtes" livré avec WINDEV, 2 boutons supplémentaires peuvent apparaître dans l'aperçu avant impression. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=icone_Apercu_EtatRequete.gif)
