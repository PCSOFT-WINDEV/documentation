...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003081032&name=xmlretourposition_fonction">Voir des exemples supplémentaires</a>
...
<a name="fonctions_xml_threads_ELTPARAGRAPHE000239"></a>Si votre application utilise des threads, le document XML est partagé entre tous ces threads. Pour plus de détails sur la gestion des threads, consultez [Gestion des threads](../WDLang1/3077026.md).
...
[XMLSauvePosition (Fonction)](../WDLang5/3081033.md)
