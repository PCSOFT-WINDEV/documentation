...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003046045&name=icreepolice_fonction">Voir des exemples supplémentaires</a>
...
| *iCondense* | Caractères condensés<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette option est ignorée. |
| *iEtendu* | Caractères étendus<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette option est ignorée. |
| *iGras* | Police en gras |
| *iItalique* | Police italique |
| *iLarge* | Caractères larges<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette option est ignorée. |
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) **Impressions en PDF** : seules les polices suivantes sont supportées : Courier, Helvetica, Times, Symbol et ZapfDingbats. Si le nom de la police spécifié ne correspond pas à une police supportée, la police Helvetica sera utilisée en substitution.
...
### Police par défaut
<a name="police_par_defaut_ELTPARAGRAPHE000233"></a>Si la fonction **iCréePolice** n'est pas utilisée, la police par défaut a les caractéristiques suivantes : 
...
<a name="obtenir_liste_des_polices_installees_sur_poste_ELTPARAGRAPHE000267"></a>Pour obtenir la liste des polices installées sur une machine :
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) La fonction [PoliceListe](../WDLang1/3060003.md) permet d'obtenir la liste des polices installées sur un poste.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) La fonction [iSelectPolice](../WDLang5/3046055.md) permet de créer une police d'impression à partir de la fenêtre standard de sélection de polices de Windows
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) pour sélectionner la police utilisée dans les graphes (fonctions [grPoliceEtiquette](../WDLang3/3042012.md), [grPoliceLégende](../WDLang3/3042037.md), [grPoliceTitre](../WDLang3/3042048.md), [grPoliceTitreAxe](../WDLang3/3042059.md)).
...
### Divers
<a name="divers_ELTPARAGRAPHE000346"></a>
...
[iPolice (Fonction)](../WDLang5/3046014.md)

[iPoliceDidot (Fonction)](../WDLang5/3046016.md)

[iRAZ (Fonction)](../WDLang5/3046067.md)

[iSelectPolice (Fonction)](../WDLang5/3046055.md)
