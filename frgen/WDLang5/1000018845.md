...
|   |   |
| --- | --- |
| *iDplCertificat* | Utilise le certificat spécifié pour signer le duplicata.<br><br>**Remarque** : Depuis le visualisateur de rapports, cette signature sera utilisée : <br><br>- si l'état est imprimé via l'option d'export "Duplicata"  : ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_duplicata.gif)<br><br>- si l'état est imprimé via l'option d'impression sur une imprimante.<br><br><br> |
...
<a name="impression_duplicata_depuis_visualisateur_rapports_ELTPARAGRAPHE000137"></a>Si un duplicata a été demandé avant d'afficher l'impression dans le visualisateur de rapports, le duplicata sera généré lors de l'impression physique réalisée depuis le visualisateur de rapports. 
...
- les duplicata générés par l'option "Duplicata" (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_duplicata.gif)) présente dans le visualisateur de rapports. 
...
- Pour ne pas proposer l'impression de duplicata depuis le visualisateur de rapports (option ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_duplicata.gif)), utilisez la fonction [iParamètreVisualisateur](../WDLang5/1000024634.md). 
...
[iDernierFichier (Fonction)](../WDLang5/3046068.md)

[iDestination (Fonction)](../WDLang5/3046074.md)

[iImprimeDuplicata (Fonction)](../WDLang5/1000018842.md)
