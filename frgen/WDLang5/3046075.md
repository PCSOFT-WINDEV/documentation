...
- <u><u><u><u>Vrai</u></u></u></u> (par défaut) pour effectuer immédiatement le calcul de la position verticale. 

- <u><u><u><u>Faux</u></u></u></u> si le calcul de la position verticale doit être effectué uniquement lors de l'impression (cas d'imbrication de positions par exemple). Pour plus de détails, consultez [les remarques](#NOTE0_2).  
...
<a name="origine_marges_physiques_ELTPARAGRAPHE000077"></a>L'origine (0,0) est située dans le coin supérieur gauche de la feuille. Cette origine tient compte des marges physiques de l'imprimante.

Chaque imprimante gère des marges physiques dans lesquelles aucune impression n'est possible. La fonction [iMarge](../WDLang5/3046011.md) permet de définir des marges "logiques" d'impression. Si des marges logiques ont été définies, la fonction **iPosY** gère la position verticale par rapport à ces nouvelles marges.
...
<a name="gestion_parametre_ELTPARAGRAPHE000094"></a>Lorsque le paramètre &lt;Position Verticale&gt; est précisé dans la fonction **iPosY**, la fonction effectue deux actions en même temps :
...
<a name="combinaison_positions_ELTPARAGRAPHE000123"></a>Lors de la combinaison de positions, des effets inattendus peuvent être observés. Par exemple, le code :
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=PosY_1.GIF)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=PosY_2.GIF)
...
Pour obtenir un résultat identique, il suffit d'utiliser (dans la première syntaxe) la fonction **iPosY** avec le paramètre <u><u><u><u>Faux</u></u></u></u> : la fonction iPosY(30, Faux) ne sera réellement exécutée que lors de l'impression.

La même manipulation peut être réalisée avec la fonction [iPosX](../WDLang5/3046015.md).
...
<a name="impression_java_android_ELTPARAGRAPHE000162"></a>Les impressions peuvent être moins précises car la résolution des impressions est de 72 points par pouce (ppp) même si l'imprimante supporte des résolutions plus importantes.
...
### Divers
<a name="divers_ELTPARAGRAPHE000192"></a>La fonction **iPosY** ne doit pas être utilisée dans un paramètre de la fonction [iImprimeMot](../WDLang5/3046034.md).
...
[iMarge (Fonction)](../WDLang5/3046011.md)
