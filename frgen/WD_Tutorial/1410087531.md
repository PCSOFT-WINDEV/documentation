...
<a name="partagez_vos_sources_grace_gds_ELTTEXTE000470"></a>
...
<a name="principe_gds_gestionnaire_sources_ELTTEXTE000530"></a>
...
## La base de sources
<a name="base_sources_ELTTEXTE000563"></a>
...
<a name="integration_projet_existant_dans_gds_ELTTEXTE000596"></a>
...
1. Sous le volet "GDS", dans le groupe "Ajouter le projet", cliquez sur "Ajouter le projet dans le GDS". L'assistant d'ajout d'un projet dans le GDS se lance : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0001.jpg&type=thumb)
Nous n'avons pas précédemment créé de base de sources. Nous allons donc en créer une.
	

2. Cliquez sur le lien "Base locale" pour créer une base de source locale au poste de développement. La fenêtre permettant de créer la base de sources s'affiche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0002.jpg&type=thumb)
...
7. L'assistant nous propose de placer le projet dans le sous-répertoire "Projets" de la base de sources. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0003.jpg&type=thumb)
Nous allons accepter cet emplacement. Passez à l'étape suivante.

8. L'assistant nous demande de sélectionner les différents éléments du projet à ajouter dans la base de sources. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0004.jpg&type=thumb)
...
Lors de l'intégration dans le GDS de projets partageant diverses ressources (schéma des données, fenêtres, etc.), ces ressources peuvent également être partagées entre les différents projets présents dans le GDS. Ainsi, le même élément n'est intégré qu'une seule fois dans le GDS et les modifications sont automatiquement reportées dans les autres projets.
...
<a name="premiere_ouverture_projet_depuis_gds_ELTPARAGRAPHE000182"></a>
...
2. Indiquer les paramètres de localisation de la base de sources et valider (cette étape est nécessaire uniquement si le projet en cours sous l'éditeur n'appartient pas au GDS) : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0005.jpg&type=thumb)


3. Dans la fenêtre qui s'affiche, indiquer si nécessaire la connexion et le répertoire local : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0006.jpg&type=thumb)
...
<a name="manipulation_projet_via_gds_ELTTEXTE000653"></a>
...
<a name="modification_parametre_projet_ELTPARAGRAPHE000230"></a>

Nous allons modifier le projet en demandant à afficher le thème sur les fenêtres système :
...
1. Tout d'abord la fenêtre d'extraction automatique du projet s'affiche. En effet, nous modifions une caractéristique du projet, il est nécessaire d'extraire le projet. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0007.jpg&type=thumb)
...
WINDEV propose plusieurs modes d'extraction. Pour plus de détails, consultez [Les modes de gestion du projet](../Editeurs/2038004.md). 
...
<a name="modification_une_fenetre_projet_ELTPARAGRAPHE000286"></a>
...
1. Sélectionnez la fenêtre "FEN_Fiche_du_produit" dans l'explorateur du projet et double-cliquez sur l'élément pour l'ouvrir sous l'éditeur de fenêtres. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0008.jpg&type=thumb)


2. L'extraction automatique est activée à la première modification : il suffit de déplacer un champ pour extraire l'élément. Il est également possible d'utiliser l'icône "Extraire" présente dans le ruban (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0008%201.jpg)).

3. La fenêtre d'extraction apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0009.jpg&type=thumb)
...
<a name="reintegration_element_extrait_ELTPARAGRAPHE000343"></a>
...
Sous le volet "GDS", dans le groupe "Elément en cours", cliquez sur le bouton "Réintégrer". La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0010.jpg&type=thumb)
...
<a name="pour_aller_plus_loin_ELTTEXTE000731"></a>
