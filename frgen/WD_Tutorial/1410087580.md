...
- Affichage du contenu des rubriques des tables, etc.
...
### Lancer le débogueur
<a name="lancer_debogueur_ELTPARAGRAPHE000097"></a>
...
2. Un point rouge apparaît pour matérialiser le point d'arrêt. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_Tuto_Debogueur_WD%20-%20HC%20N%B0001.jpg)
...
3. L'éditeur de code apparaît en mode "Débogage" : un bandeau orange est affiché en bas de l'éditeur et le volet "Débogueur" du ruban est sélectionné. La ligne en cours d'exécution est précédée d'une petite flèche (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_D%E9bogueur%201%20-%20HC%20N%B0003.jpg)). Une bulle d'aide permet de voir le contenu des variables manipulées dans la ligne de code. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_Tuto_Debogueur_WD%20-%20HC%20N%B0002.jpg&type=thumb)
...
### Exécuter pas à pas
<a name="executer_pas_pas_ELTPARAGRAPHE000144"></a>
...
<a name="executer_ensemble_lignes_ELTPARAGRAPHE000166"></a>
...
<a name="definir_instruction_suivante_executer_ELTPARAGRAPHE000194"></a>
...
1. A l'aide de la souris, déplacez la flèche indiquant la ligne en cours d'exécution (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_D%E9bogueur%201%20-%20HC%20N%B0003.jpg)) sur la ligne de code contenant la fonction "Trace" présente dans le SI : 
...
<a name="ajouter_une_expression_pour_surveiller_evolution_valeur_ELTPARAGRAPHE000217"></a>
