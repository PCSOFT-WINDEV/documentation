...
<a name="lecon_7_envoyer_email_ELTTEXTE000597"></a>
...
## Présentation
<a name="presentation_ELTTEXTE000633"></a>
...
Dans cette leçon, nous allons créer une fenêtre permettant à l'utilisateur d'envoyer un email depuis l'application "WD Application Complète". Cette fenêtre est la suivante : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0004.jpg&type=thumb)


L'envoi de l'email va utiliser le protocole SMTP.  WINDEV propose plusieurs méthodes pour envoyer et recevoir des emails. Pour plus de détails, consultez [Communiquez par emails](../WDLang3/3032007.md).
...
<a name="une_fenetre_pour_envoyer_des_emails_ELTTEXTE000666"></a>
...
<a name="creation_fenetre_ELTPARAGRAPHE000064"></a>

Créez une nouvelle fenêtre :

1. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Cr%E9er1_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="creation_des_champs_parametrage_envoi_ELTPARAGRAPHE000079"></a>
...
1. Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Saisie_GAF.jpg).
...
|   |
| --- |
| **A vous de jouer** : <br>De la même manière, créez 2 nouveaux champs de saisie : <br><br>- Un champ de saisie SAI_Port permettant de saisir le port du serveur SMTP. Ce champ a pour libellé "Port". <br><br>- Un champ de saisie SAI_Utilisateur permettant de saisir le nom de l'utilisateur. <br><br><br> |
...
2. Sous le volet "Alignement", dans le groupe "Interne et externe", cliquez sur "Justifier (Int. et Ext.)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0006.jpg&type=thumb)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0001.jpg)


3. Enregistrez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Enregistrer_GAF.jpg) ou Ctrl + S).
...
<a name="creation_des_champs_permettant_saisir_les_caracteristiques_email_ELTPARAGRAPHE000165"></a>
...
Le champ permettant la saisie de l'adresse du destinataire va être un champ proposant les adresses des clients présents dans la base de données mais aussi permettant à l'utilisateur de saisir une autre adresse. Pour cela, nous allons utiliser un champ de type "Combo avec saisie" lié à la table Client.
...
4. Sélectionnez la table Client. Passez à l'étape suivante.
...
1. Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Saisie_GAF.jpg). La forme du champ apparaît sous le curseur de la souris.
...
Alignez les différents champs présents dans la fenêtre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0002.jpg&type=thumb)
...
<a name="code_wlangage_permettant_envoyer_email_ELTTEXTE000726"></a>
...
Enregistrez la fenêtre et son code (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Enregistrer_GAF.jpg) ou Ctrl + S).
...
<a name="ameliorations_fenetre_ELTTEXTE000750"></a>
...
<a name="fermeture_fenetre_ELTPARAGRAPHE000405"></a>
...
### Mise en forme
<a name="mise_forme_ELTPARAGRAPHE000428"></a>
...
Voyons maintenant si l'ordre de navigation entre les différents champs de la page est cohérent.  L'ordre de navigation des champs est l'ordre dans lequel l'utilisateur pourra saisir les valeurs dans les différents champs de la fenêtre. Le passage d'un champ à un autre sera effectué lors de l'appui sur la touche Tab pendant l'exécution.
L'ordre de saisie par défaut correspond à l'ordre de création des champs. 
...
3. Les numéros sont modifiés et apparaissent désormais dans l'ordre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0003.jpg&type=thumb)


4. Appuyez à nouveau sur la touche F5 pour faire disparaître les numéros.

5. Enregistrez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Enregistrer_GAF.jpg) ou Ctrl + S).
...
<a name="ouverture_fenetre_depuis_menu_deroulant_ELTPARAGRAPHE000469"></a>

La fenêtre de gestion des emails va être ouverte directement depuis une option du menu déroulant de la fenêtre "FEN_Menu". Nous avons créé le menu déroulant de la fenêtre dans la [leçon 5 de ce tuto](../TutoWD/1410087492.md).
...
Lancez le test du projet (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide) et l'ouverture de la fenêtre d'envoi d'emails via l'option "Menu .. Envoyer un email". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0004.jpg&type=thumb)
...
## En résumé
<a name="resume_ELTTEXTE000810"></a>
**Projet corrigé**
...
Cette leçon nous a permis de découvrir comment proposer l'envoi d'un email dans une application WINDEV. Bien entendu, les applications WINDEV peuvent également proposer la lecture des emails reçus. Pour plus de détails, consultez [Lire un email](../WDLang3/3032037.md). 

Ce tuto présentant le développement d'une application de gestion est terminé. Nous vous conseillons de suivre le tuto [Déployer l'application](../TutoWD/1410087528.md) pour apprendre comment créer l'exécutable de votre application et comment déployer cette application chez vos utilisateurs. 



| [Leçon précédente](../TutoWD/1410087538.md) | [Sommaire](../TutoWD/1410087560.md) |
| --- | --- |
