...
<a name="lecon_1_des_fenetres_pour_saisir_modifier_des_donnees_ELTTEXTE001007"></a>
...
<a name="presentation_exemple_utilise_dans_tuto_ELTTEXTE001043"></a>
Dans ce tuto, nous allons réaliser une application manipulant des tables au format HFSQL Classic.
...
Ces manipulations vous feront découvrir plusieurs aspects de la gestion des tables et vous feront également utiliser certaines fonctionnalités bien utiles de WINDEV.
<a name="NOTE2_2"></a>


### Ouverture du projet exemple
<a name="ouverture_projet_exemple_ELTPARAGRAPHE000052"></a>
...
Dans cette leçon, nous nous concentrons sur la création de fenêtres permettant de manipuler des tables. Nous allons donc manipuler un projet vide, déjà créé. 
La création de projet est abordée dans le tuto [Créer un projet WINDEV et son schéma des données](../TutoWD/1410087520.md).
...
<a name="creation_une_fenetre_listant_les_produits_ELTTEXTE001082"></a>
...
1. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Cr%E9er1_GAF.jpg) parmi les boutons d'accès rapide (ou utilisez le raccourci Ctrl + N).
...
5. Dans la fenêtre de sauvegarde de l'élément créé, indiquez le titre de la fenêtre : "Menu". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0001.jpg)
...
Dans ce tuto, nous utilisons **un modèle de fenêtres** pour donner un look homogène aux différentes fenêtres de notre application. Ce modèle FENMOD_Modèle contient un logo qui apparaîtra sur toutes les fenêtres : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0007%201.jpg&type=thumb)
 Pour plus de détails, consultez [Les modèles de fenêtres](../WDChamp/9000086.md).

<a name="NOTE3_3"></a>


### Création des champs
<a name="creation_des_champs_ELTPARAGRAPHE000110"></a>

Pour créer la liste des produits, nous allons utiliser un champ Table. Ce champ va afficher les données de la table "Produit".**Qu'est-ce qu'un champ Table ?**
Ne confondez pas "Table" et "champ Table".

- On parle de **Table** pour une base de données de type SQL.

- On parle de **champ Table** pour visualiser en tableau des données (ou "browse" ou encore "feuille de données"). Dans ce cas, ces données peuvent être saisies ou provenir d'une table.
...
3. Le champ Table que nous sommes en train de créer doit afficher les enregistrements de la table "Produit". 
	Dans l'assistant, sélectionnez l'option "Afficher des données d'une table ou d'une requête existante". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0002.jpg&type=thumb)
Passez à l'étape suivante de l'assistant (bouton "Suivant").

4. L'assistant propose les différentes tables et les requêtes présentes dans le projet en cours. 
	Dépliez "Schéma des données" si nécessaire et sélectionnez la table "Produit". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0003.jpg&type=thumb)
Passez à l'étape suivante.

5. L'assistant propose la liste des rubriques présentes dans la table "Produit". 
	Par défaut, toutes les rubriques sont cochées pour être affichées dans le champ Table. Dans notre cas, nous allons afficher toutes les rubriques SAUF l'identifiant "IDProduit" qui correspond à l'identifiant automatique de la table. 
	Décochez "IDProduit".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0004.jpg&type=thumb)
Passez à l'étape suivante.

6. L'assistant propose ensuite de sélectionner la rubrique de tri. Cette rubrique va être utilisée pour trier les données affichées dans le champ Table. Les rubriques proposées dans l'assistant correspondent à des rubriques définies comme clés dans le schéma des données. Nous allons trier les produits selon leur libellé. 
	Cliquez sur la ligne "Libellé".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0005.jpg&type=thumb)


7. Terminez l'assistant. 

8. Le champ Table est automatiquement créé dans la fenêtre. Le champ est automatiquement positionné et agrandi afin d'occuper tout l'espace disponible dans la fenêtre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0007.jpg&type=thumb)
...
### Test de la fenêtre
<a name="test_fenetre_ELTPARAGRAPHE000175"></a>
...
<a name="les_possibilites_champ_table_ELTPARAGRAPHE000188"></a>

Mettons-nous quelques instants à la place de l'utilisateur final pour voir les possibilités du champ Table en exécution. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0008.jpg&type=thumb)
Quelques remarques :

- Des petits pictogrammes apparaissent en haut des colonnes :

	- la double flèche indique que la colonne peut être triée (colonne "Référence" ou "Libellé" par exemple). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0008%201.jpg)
Par exemple, cliquez deux fois successivement sur la colonne "Libellé" : les données affichées sont triées différemment. Une flèche à gauche de la colonne indique que la colonne est triée ainsi que le sens de tri.
	...
	- la loupe indique qu'une recherche peut être réalisée directement dans la colonne. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0008%202.jpg)
Par exemple, cliquez sur la loupe de la colonne "Référence". Une zone de saisie apparaît et vous permet de saisir la référence recherchée. Saisissez "REF-010". Automatiquement, le produit correspondant à cette référence est affiché. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0009.jpg)
...
- Un menu contextuel est disponible sur le champ Table et sur chacune de ses colonnes. Ce menu contextuel peut être affiché :
 ...
 Ce menu contextuel permet notamment d'exporter le contenu du champ Table au format Excel (ou OpenOffice.org Calc), au format Word (ou OpenOffice.org Writer), de l'imprimer, etc. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0010.jpg&type=thumb)





En quelques minutes, nous venons de voir et de tester quelques fonctionnalités qui sont automatiquement incluses avec le champ Table. Vous n'avez rien à programmer pour proposer ces fonctionnalités à vos utilisateurs. Ces fonctionnalités sont appelées "FAA" (Fonctionnalités Automatiques de votre Application).De nombreux champs proposent des FAA par défaut. Si ces fonctionnalités ne doivent pas être proposées (pour des raisons de sécurité ou de confidentialité), il est possible de les désactiver sous l'éditeur ou par programmation. 

Pour plus de détails, consultez [Fonctionnalités Automatiques de vos Applications (FAA)](../Editeurs/9000022.md).
...
<a name="creation_une_fenetre_fiche_produit_ELTTEXTE001166"></a>


### Création de la fenêtre
<a name="creation_fenetre_ELTPARAGRAPHE000235"></a>
...
|   |
| --- |
| **A vous de jouer** : <br>Comme nous avons déjà créé une fenêtre dans cette leçon, voici juste quelques indications : <br><br>- La fenêtre doit être basée sur le modèle FENMOD_Modèle. <br><br>- Le titre de la fenêtre est "Fiche du produit" (et le nom proposé est donc "FEN_Fiche_du_produit").<br><br><br> |
...
<a name="creation_des_champs_lies_aux_donnees_ELTPARAGRAPHE000252"></a>

Dans notre exemple, cette fenêtre "Fiche" va afficher le contenu des différentes rubriques présentes dans la table "Produit".

Pour créer les différents champs, nous allons utiliser directement les rubriques de la table Produit :
...
2. Cliquez sur la flèche à gauche de la table "Produit" : les rubriques de la table sont listées. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0001.jpg)
...
4. Effectuez un "Drag and Drop" (glisser/déplacer) de ces rubriques vers la fenêtre que vous venez de créer. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0002.jpg&type=thumb)


5. Différents champs sont automatiquement créés dans la fenêtre. Ces champs sont automatiquement liés à la rubrique correspondante dans la table. Pour le vérifier :

	- Sélectionnez par exemple le champ "Référence".

	- Affichez le menu contextuel (clic droit) et sélectionnez l'option "Description".

	- Affichez l'onglet "Liaison" de la fenêtre de description : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0003.jpg&type=thumb)
...
Repositionnez les champs dans la fenêtre et redimensionnez la fenêtre afin d'obtenir l'UI suivante : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0004.jpg&type=thumb)

<a name="NOTE4_3"></a>


### Création des boutons
<a name="creation_des_boutons_ELTPARAGRAPHE000282"></a>
...
1. Sous le volet "Création", dans le groupe "Champs usuels", déroulez "Bouton" (cliquez sur la flèche située sous ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Bouton_GAF.jpg)).
...
3. Cliquez ensuite en dessous du champ Bouton "Valider" pour créer le champ. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0005.jpg&type=thumb)
...
<a name="ameliorations_fenetre_fiche_produit_ELTTEXTE001202"></a>
...
<a name="alignement_des_champs_ELTPARAGRAPHE000339"></a>
...
2. Dans le ruban, affichez le volet "Alignement" de WINDEV. Ce volet contient toutes les options d'alignement disponibles pour les champs. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0006.jpg&type=thumb)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0007.jpg&type=thumb)



### Redimensionnement de la fenêtre
<a name="redimensionnement_fenetre_ELTPARAGRAPHE000359"></a>
...
2. Dans la barre de message, saisissez la nouvelle dimension de la fenêtre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0007%201.jpg)
Nous allons saisir par exemple 745 x 345. 
...
<a name="rendu_visuel_fenetre_ELTPARAGRAPHE000373"></a>
...
2. Agrandissez la fenêtre à l'aide de la poignée d'agrandissement au bas de la fenêtre. La position des champs n'est pas modifiée et la fenêtre affiche une grande zone vide.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0008.jpg&type=thumb)
...
<a name="gestion_des_ancrages_ELTPARAGRAPHE000400"></a>
...
1. Les champs Bouton "Valider" et "Annuler" doivent toujours être collés à droite.
	...
	- Dans la fenêtre de définition des ancrages, sélectionnez l'option "Droite". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0009.jpg)


	- Validez. 

- Des petites flèches rouges apparaissent sous l'éditeur indiquant que les champs sont ancrés à droite.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0010.jpg)
...
2. Les champs de saisie doivent s'agrandir en largeur :
	...
	- Dans la fenêtre de définition des ancrages, sélectionnez l'option "Largeur" (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0004%202.jpg)).
...
4. Le champ "Description" peut contenir une description du produit plus ou moins importante. C'est le champ le plus important de la fenêtre : il est nécessaire qu'il occupe le maximum de place disponible. Appliquez-lui un ancrage en largeur et hauteur (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0002%202.jpg)).
...
7. Nous allons tester à nouveau le fonctionnement de cette fenêtre en aperçu :
	...
	- Agrandissez la fenêtre : les champs suivent bien l'agrandissement en largeur et en hauteur. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0011.jpg&type=thumb)
...
<a name="affichage_fiche_depuis_liste_des_produits_ELTTEXTE001268"></a>
...
<a name="redimensionnement_fenetre_sous_editeur_ELTPARAGRAPHE000487"></a>

Nous allons tout d'abord modifier la fenêtre "FEN_Menu" afin de créer un champ Bouton. 

Placez-vous sur la fenêtre "Menu" : cliquez sur le bouton "FEN_Menu" dans la barre des documents ouverts : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0012.jpg)
...
<a name="creation_champ_bouton_ELTPARAGRAPHE000508"></a>
...
2. Dans la liste des champs Bouton prédéfinis, saisissez "Modifier" dans la zone de recherche. Cliquez sur "Bouton Modifier". La forme du champ apparaît sous la souris. Cliquez ensuite à droite du champ Table pour créer le champ Bouton. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0013.jpg&type=thumb)
...
3. Examinons ce code WLangage : la fonction [&lt;Fenêtre&gt;.Ouvre](../WDLang1/1000023903.md) permet d'ouvrir la fenêtre "FEN_Fiche_du_produit".

4. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Enregistrer_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="affichage_produit_selectionne_dans_champ_table_ELTPARAGRAPHE000552"></a>

Nous allons maintenant modifier la fenêtre "FEN_Fiche_du_produit" pour afficher le produit sélectionné dans le champ Table.

Affichez la fenêtre "FEN_Fiche_du_produit" sous l'éditeur : cliquez sur le bouton correspondant dans la barre des documents ouverts. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0012%201.jpg)
...
2. Dans l'événement "Fin d'initialisation de FEN_Fiche_du_produit", saisissez le code WLangage suivant :
	...
	La fonction [&lt;Table&gt;.VersFenêtre](../WDLang4/1000021397.md) permet d'afficher dans les champs les données présentes dans la table, pour l'enregistrement en cours. Dans notre cas, l'enregistrement en cours sera l'enregistrement sélectionné dans le champ Table de la fenêtre "FEN_Menu".
...
2. Testez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Fenetre_WD_GAF.jpg) parmi les boutons d'accès rapide).
...
<a name="gestion_modification_produit_ELTTEXTE001328"></a>
...
<a name="modification_image_produit_ELTPARAGRAPHE000604"></a>
...
3. Redimensionnez si nécessaire le champ Bouton (à l'aide des poignées) pour que le champ ait la même largeur que le champ Image.
	Lors du redimensionnement du champ, un effet de magnétisme automatique simplifie l'alignement du champ Bouton avec le champ Image.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0001.jpg&type=thumb)
...
5. Dans la fenêtre de code qui apparaît, saisissez le code WLangage suivant dans l'événement "Clic sur" :
	...
	fSélecteurImage(
	```
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0002.jpg)
...
7. Conservez toutes les options par défaut de l'assistant et validez. Le code WLangage correspondant est automatiquement inséré.
	La fonction [fSélecteurImage](../WDLang1/3036037.md) permet d'ouvrir la fenêtre de sélection d'un fichier image et de l'associer à la variable "Fichier". 
...
<a name="validation_des_modifications_produit_ELTPARAGRAPHE000665"></a>
...
2. Dans l'événement "Clic sur", saisissez le code WLangage suivant :
	...
	- La fonction [&lt;Table&gt;.DepuisFenêtre](../WDLang4/1000021403.md) permet d'initialiser les rubriques avec les valeurs des champs liés, pour l'enregistrement courant. Cette fonction est donc équivalente aux lignes suivantes :
...
3. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Enregistrer_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="test_modification_produit_ELTPARAGRAPHE000726"></a>
...
1. Lancez le test du projet (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Go_Projet_acces_rapide.jpg)
...
2. WINDEV demande de sélectionner la première fenêtre du projet. Dans notre cas, cette fenêtre correspond à "FEN_Menu". Sélectionnez cette fenêtre et validez.
	La première fenêtre du projet correspond à la première fenêtre ouverte au lancement de l'application. Pour plus de détails, consultez [Première fenêtre du projet](../Editeurs/9000177.md).
...
10. Cliquez sur le bouton "Annuler". La modification de l'image n'a pas été prise en compte dans la table.
...
<a name="creation_nouveau_produit_ELTTEXTE001397"></a>
...
- Nous modifierons ensuite le code de la fenêtre "Fiche du produit" pour gérer l'ajout dans la table Produit.
...
<a name="ajout_champ_bouton_ELTPARAGRAPHE000767"></a>
...
2. Positionnez le champ Bouton "Nouveau" au-dessus du champ Bouton "Modifier" (si nécessaire modifiez la position du champ Bouton "Modifier"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0003.jpg&type=thumb)
...
Examinons ce code :
		...
		- La fonction [&lt;Fenêtre&gt;.Ouvre](../WDLang1/1000023903.md) permet d'ouvrir la fiche du produit pour saisir le nouvel enregistrement.

		- La fonction [&lt;Table&gt;.Affiche](../WDLang1/3074003.md) permet de réafficher le champ Table. Dans ce code, la constante ***taCourantEnreg*** est utilisée pour réafficher le champ Table à partir de l'enregistrement courant.
...
<a name="ajout_nouvel_enregistrement_dans_table_ELTPARAGRAPHE000803"></a>
...
Examinons ce code WLangage :
		...
		- Si la fonction [&lt;Table&gt;.RAZ](../WDLang4/1000025052.md) a été appelée précédemment, la propriété renvoie <u><u><u><u>Vrai</u></u></u></u> (cas du clic sur le bouton "Nouveau") et l'enregistrement doit être créé par la fonction [&lt;Table&gt;.Ajoute](../WDLang4/1000024187.md).

		- Dans le cas contraire, l'enregistrement en cours existe déjà et doit être modifié par la fonction [&lt;Table&gt;.Modifie](../WDLang4/1000025038.md).

		- La fonction [&lt;Table&gt;.Ajoute](../WDLang4/1000024187.md) ajoute l'enregistrement dans la table. Cette fonction prend les valeurs en mémoire et écrit le contenu des rubriques de la table dans la table elle-même. Les index sont immédiatement et automatiquement mis à jour. Ici, la table mise à jour est bien entendu la table "Produit".
...
<a name="test_ajout_produit_ELTPARAGRAPHE000847"></a>
...
3. Saisissez un nouveau produit avec les caractéristiques suivantes :
	...
	- Prix : 150 <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0004.jpg&type=thumb)
...
7. Validez. Une fenêtre spécifique apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0005.jpg&type=thumb)
...
Pour plus de détails, consultez [Gestion automatique des erreurs](../WDLang1/3034010.md). 

<a name="NOTE6_5"></a>


### Visualiser les enregistrements saisis
<a name="visualiser_les_enregistrements_saisis_ELTPARAGRAPHE000889"></a>
...
Mais dans certains cas, lors de tests par exemple, il peut être nécessaire de voir directement le contenu de la table.

WINDEV propose un outil simple permettant de voir le contenu des tables pendant le développement de l'application (lorsque par exemple, les fenêtres de visualisation n'ont pas encore été créées). 

Cet outil s'appelle WDMAP. Nous allons l'utiliser pour voir le contenu de la table Produit.

Pour lancer WDMAP :

1. Sous le volet "Outils", dans le groupe "Base de données", cliquez sur "WDMap". 

2. Sélectionnez la table "Produit". Le contenu de la table s'affiche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0006.jpg&type=thumb)
...
## En résumé
<a name="resume_ELTTEXTE001454"></a>
**Projet corrigé**
...
| [Sommaire](../TutoWD/1410087560.md) | [Leçon suivante](../TutoWD/1410087533.md) |
| --- | --- |
