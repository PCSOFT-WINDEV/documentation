...
WINDEV et WEBDEV 2026 proposent un Connecteur Natif à MySQL (également appelé Accès Natif à MySQL). Ce Connecteur Natif permet d'accéder à une base MySQL sans drivers externes depuis un programme en WLangage.

**Attention**: Cette version du Connecteur Natif MySQL ne fonctionne qu'avec WINDEV et WEBDEV version 2026. Le Connecteur Natif MySQL n'est pas disponible pour WINDEV Mobile. Si vous utilisez WINDEV Mobile, l'accès à une base étrangère (MySQL, Oracle, SQL Server) doit être réalisé par l'intermédiaire d'un [Webservice](../WDLang4/1000021063.md) fourni avec WINDEV Mobile. Pour plus de détails, consultez l'aide de la fonction [SQLConnecteWS](../WDLang4/1000021031.md). 
...
<a name="configuration_necessaire_ELTTEXTE000260"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) 
...
- Couche cliente de MySQL (fichier LibMySQL.DLL)
	...
	- Couche Cliente 32 bits pour utiliser le Connecteur Natif MySQL 32 bits (version 5.x testée).
...
<a name="les_fichiers_necessaires_ELTPARAGRAPHE000057"></a>
...
- La DLL ***wd310msql.dll***: Nécessaire au Connecteur Natif 32 bits à une base MySQL. Ce fichier est livré avec le Connecteur Natif MySQL pour WINDEV ou WEBDEV.

- La DLL ***wd310msql64.dll***: Nécessaire au Connecteur Natif 64 bits à une base MySQL. Ce fichier est livré avec le Connecteur Natif MySQL pour WINDEV ou WEBDEV.
...
<a name="installation_une_nouvelle_version_mysql_ELTPARAGRAPHE000090"></a>
...
<a name="NOTE3_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) 

### Fichiers nécessaires à l'utilisation du Connecteur Natif MySQL sous Linux
<a name="fichiers_necessaires_utilisation_connecteur_natif_mysql_sous_linux_ELTPARAGRAPHE000103"></a>
...
2. Si vous utilisez un site WEBDEV, copiez les DLL suivantes dans le répertoire du serveur d'application WEBDEV:
	...
	- wd310hf.so: librairie HFSQL

	- wd310msql.so: librairie du Connecteur Natif 32 bits

	- wd310msql64.so: librairie du Connecteur Natif 64 bits

	- wd310sql.so: librairie SQL
...
## Utilisation
<a name="utilisation_ELTTEXTE000302"></a>


### Utiliser le Connecteur Natif MySQL dans vos applications WINDEV et sites WEBDEV
<a name="utiliser_connecteur_natif_mysql_dans_vos_applications_windev_sites_webdev_ELTPARAGRAPHE000156"></a>
...
- L'option "Créer les tables automatiquement au moment de leur ouverture" (disponible dans l'onglet "Tables" de la description du projet) est prise en compte par le Connecteur Natif MySQL. 
...
<a name="optimisations_des_fonctions_hfsql_ELTPARAGRAPHE000186"></a>
...
[Connecteur Natif MySQL: Programmation à l'aide des fonctions HFSQL](../WDMySQL/5517003.md)

[Connecteur Natif MySQL: Programmation à l'aide des fonctions SQL](../WDMySQL/5517004.md)

[Connecteur Natif MySQL: Spécificités et remarques](../WDMySQL/5517002.md)
