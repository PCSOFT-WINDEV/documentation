...
## Utilisation
<a name="utilisation_ELTTEXTE000171"></a>


### Cas d'utilisation
<a name="cas_utilisation_ELTPARAGRAPHE000020"></a>
...
- soit utilisez l'outil d'administration de MySQL. Dans ce cas, n'utilisez pas la fonction [HCrée](../WDLang4/3044255.md) dans votre programme. En effet, la fonction [HCrée](../WDLang4/3044255.md) supprime la table (ordre "DROP TABLE") si elle existe déjà afin de pouvoir la recréer.
...
<a name="parcours_fichiers_ELTPARAGRAPHE000046"></a>
