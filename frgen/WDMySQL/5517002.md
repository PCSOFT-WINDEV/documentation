...
<a name="versions_necessaires_ELTPARAGRAPHE000018"></a>
...
<a name="utilisation_ordres_wlangage_dans_les_requetes_sql_ELTPARAGRAPHE000033"></a>
...
### Gestion de tables de données de taille importante
<a name="gestion_tables_donnees_taille_importante_ELTPARAGRAPHE000050"></a>

Lors de la manipulation de tables de données de taille importante, tous les enregistrements sont chargés en mémoire. Pour réduire l'occupation mémoire, il est conseillé de:
...
<a name="requetes_type_insert_identifiant_automatique_ELTPARAGRAPHE000070"></a>

Les requêtes de type INSERT (créées par programmation ou grâce à l'éditeur de requêtes) ne gèrent pas les identifiants automatiques. Pour utiliser un identifiant automatique, utilisez la fonction [HAjoute](../WDLang4/3044147.md) sur la table.
<a name="NOTE2_6"></a>


### PCS_ATTENTE_TRADUCTION
<a name="pcsattentetraduction_ELTPARAGRAPHE000080"></a>

La fonction [HCréation](../WDLang4/3044255.md) crée des tables de type "InnoDB" pour permettre la gestion des blocages et des transactions. Consultez [Connecteur Natif MySQL: Particularités](../WDMySQL/5517005.md) pour plus d'informations.
<a name="NOTE2_7"></a>


### Support de Unicode
<a name="support_unicode_ELTPARAGRAPHE000093"></a>
...
<a name="connexion_avec_certificats_ssl_ELTPARAGRAPHE000118"></a>
...
<a name="blocage_des_enregistrements_ELTPARAGRAPHE000168"></a>
...
<a name="enregistrements_identiques_ELTPARAGRAPHE000180"></a>
...
### Transactions
<a name="transactions_ELTPARAGRAPHE000189"></a>
...
<a name="rubriques_type_set_enum_ELTPARAGRAPHE000201"></a>
...
<a name="rubriques_type_xblob_ELTPARAGRAPHE000208"></a>
...
<a name="rubriques_type_tableau_ELTPARAGRAPHE000218"></a>
...
<a name="utilisation_requetes_insertupdate_pour_inserer_texte_dans_une_rubrique_type_longblob_memo_binaire_sur_mysql_ELTPARAGRAPHE000225"></a>
...
<a name="indexation_partielle_des_memos_indexation_fulltext_ELTPARAGRAPHE000253"></a>

L'indexation partielle des mémos ainsi que l'indexation full-text ne sont pas prises en compte:

- lors de l'importation des tables MySQL dans le schéma des données.
...
Si ces fonctionnalités sont définies dans le schéma des données, elles seront prises en compte uniquement lors de l'exécution de requêtes SQL (avec la constante *hRequêteSansCorrection*) utilisant les fonctions SQL "CREATE TABLE" et "MATCH AGAINST".
...
| En création de tables avec la fonction ***HCrée***, les noms des tables ne doivent pas contenir d'accent (Exemple: "FichierAccentué").<br>Ceci est un problème interne à MySQL (testé sur les versions **3.23.52-max-nt** et **3.23.47-max-nt** du serveur MySQL). L'exécution de l'ordre SQL "DROP TABLE", effectuée par [HCréation](../WDLang4/3044255.md) pour supprimer la table si elle existe déjà, peut provoquer un arrêt inopiné du serveur MySQL.<br>Consultez [Connecteur Natif MySQL: Particularités](../WDMySQL/5517005.md) pour plus d'informations. | [HCréation](../WDLang4/3044255.md) |
