...
<a name="details_onglet_connexions_ELTTEXTE000115"></a>
...
- l'option **Rafraichissement automatique** permet de réactualiser automatiquement la table présentant les différentes connexions en cours.
