...
<a name="generer_exemple_configuration_proxy_haproxy_ELTTEXTE000126"></a>
...
Pour générer un exemple de configuration, cliquez sur le lien **"Obtenir des éléments de configuration pour HAProxy"**. La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WBCluster_HAProxy.gif)
...
## Proxy et sécurité
<a name="proxy_securite_ELTTEXTE000150"></a>
...
[Installation d'un Cluster WEBDEV](../WDAdminDeploiement/1410086635.md)

[Mettre en place un Cluster WEBDEV](../WDAdminDeploiement/2030070.md)
