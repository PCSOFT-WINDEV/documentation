...
<a name="lancement_audit_statique_ELTPARAGRAPHE000026"></a>
...
La fenêtre d'audit s'ouvre :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=audit_statique_fen.gif&type=thumb)
...
<a name="liste_des_erreurs_detectees_par_audit_statique_ELTPARAGRAPHE000075"></a>
...
** **Problèmes dans le schéma des données du projet détectés par l'audit statique** **

|   |
| --- |
| Un connecteur natif est utilisé par le projet mais n'est pas installé sur le poste. |
| Conseil : Le schéma des données du projet ne possède aucune liaison. <br>Il est conseillé de créer des liaisons afin d'assurer la cohésion des données.<br><br>L'absence de définition des liaisons ne permet pas la gestion automatique de l'intégrité référentielle, ce qui est un risque pour la qualité de l'application. |
...
| Conseil : il est conseillé de désactiver l'archivage du schéma des données en GDS. |
| Conseil : il est conseillé de convertir le schéma des données du projet au nouveau format. Pour plus de détails, consultez [Nouveau format du schéma des données du projet](../Editeurs/2011011.md). |
...
| Une ou plusieurs requêtes portent sur des tables qui n'existent plus dans le schéma des données du projet. |
...
| Le thème du projet n'est pas installé sur le poste. |
...
### Présentation
<a name="presentation_ELTPARAGRAPHE000293"></a>
...
- Depuis le Widget "Audit statique" présent dans le [Tableau de Bord du projet](../Editeurs/9500221.md), cliquez sur la flèche grise du Widget. L'audit statique se lance. Sélectionnez l'onglet " Schéma des données de la bibliothèque".


ou

- Sous le volet "Projet", dans le groupe "Audit et performances", déroulez "Audit statique" et sélectionnez "Schéma des données de la bibliothèque (EXE, WDK, WDL)".
...
<a name="interpretation_des_resultats_audit_contenu_bibliotheque_ELTPARAGRAPHE000327"></a>
...
### Présentation
<a name="presentation_ELTPARAGRAPHE000342"></a>
...
- Depuis le Widget "Audit statique" présent dans le [Tableau de Bord du projet](../Editeurs/9500221.md), cliquez sur la flèche grise du Widget. L'audit statique se lance. Sélectionnez l'onglet "Schéma des données du pack d'installation".


ou

- Sous le volet "Projet", dans le groupe "Audit et performances", déroulez "Audit statique" et sélectionnez " Schéma des données du pack d'installation".
...
<a name="interpretation_des_resultats_audit_contenu_installation_ELTPARAGRAPHE000378"></a>
