...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_ExempleGeneral.gif)
...
Dans le graphe, un groupe de traitements peut être détaillé ou non. L'icône  ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_AugmenteDetails.gif) permet de détailler un groupe de traitements et l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_DiminueDetails.gif) permet de réduire un groupe de traitements.
...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_ExempleSansDetail.gif)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_ExempleAvecDetail.gif)<br> |



**Pour augmenter le niveau de détails** : 

- d'un traitement : double-cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_AugmenteDetails.gif) du traitement affiché dans la modélisation.

- de tous les traitements du graphe : cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_AugmenteDetailsTout.gif) de la barre d'outils.
...
- d'un traitement : double-cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_DiminueDetails.gif) du traitement.

- de tous les traitements du graphe : cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_DiminueDetailsTout.gif) de la barre d'outils.
...
- soit en double-cliquant sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Retro_BoutonCode.gif) du traitement.
...
[Rétro-modélisation des héritages](../Editeurs/2010106.md)
