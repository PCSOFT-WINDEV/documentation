...
2. Utilisez une des méthodes suivantes : 
	...
	- Sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez "Déboguer le projet avec l'audit activé". 
			![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Non disponible.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) soit grâce au fichier WX.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) soit directement par une combinaison de touches. 
...
<a name="fenetre_analyse_audit_dynamique_ELTPARAGRAPHE000232"></a>Lors du chargement d'un audit dynamique, la fenêtre suivante est affichée :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=audit_dyn_fen.gif)
...
[dbgActiveAudit (Fonction)](../Editeurs/1000018835.md)

[dbgEcritCommentaireAudit (Fonction)](../Editeurs/1000018839.md)

[dbgEcritWarningAudit (Fonction)](../Editeurs/1000018838.md)

[dbgEtatAudit (Fonction)](../Editeurs/1000018836.md)

[dbgOptionAudit (Fonction)](../Editeurs/1000018837.md)

[Fichier WX](../Editeurs/9000125.md)
