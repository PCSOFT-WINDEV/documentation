...
## Manipuler des tables MySQL, Oracle ou PostgreSQL
<a name="manipuler_des_tables_mysql_oracle_postgresql_ELTTEXTE000204"></a>


### Pour manipuler des tables MySQL, Oracle ou PostgreSQL en PHP avec les fonctions HFSQL :
<a name="pour_manipuler_des_tables_mysql_oracle_postgresql_php_avec_les_fonctions_hfsql_ELTPARAGRAPHE000029"></a>

Les tables décrites dans le schéma des données du projet doivent être du type correspondant à la base ciblée. La connexion au serveur est décrite dans le schéma des données.

Si cette condition est remplie, les tables peuvent être manipulées directement par les fonctions HFSQL disponibles en PHP.

Les champs Table liée aux données créés sous l'éditeur sont alors directement reliés aux tables décrites sous l'Éditeur de schémas des données.
<a name="NOTE2_2"></a>


### Remarques
<a name="remarques_ELTPARAGRAPHE000040"></a>
...
- Les noms des tables et des rubriques de la base de données ne doivent contenir ni caractères accentués, ni espaces.
...
<a name="les_fonctions_suivantes_sont_actuellement_disponibles_php_ELTPARAGRAPHE000060"></a>
...
## Manipuler des tables via ODBC
<a name="manipuler_des_tables_via_odbc_ELTTEXTE000651"></a>
Pour manipuler des tables via ODBC :

1. Définissez une source de données ODBC.
	Pour créer par exemple une source de données sur des tables HFSQL Classic ou Client/Serveur, consultez [Driver ODBC sur HFSQL Classic et Client/Serveur.](../WDLang4/3044179.md)
