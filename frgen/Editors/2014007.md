...
Le répertoire de génération correspond au répertoire associé à la configuration de projet de type "Composant externe".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_MemePoste.gif)
...
Lors de l'importation du composant externe dans un projet, il suffit de sélectionner le fichier WDI correspondant au composant dans le répertoire de distribution.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=composant-reseau.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=composant-instal.gif)
