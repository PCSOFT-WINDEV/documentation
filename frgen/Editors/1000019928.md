...
<a name="creer_projet_pour_catalyst_avec_windev_mobile_ELTTEXTE000206"></a>
...
3. Dans l'onglet "Général", cochez l'option Permettre l'exécution de l'application sur macOS Catalina ou supérieur (Mac Catalyst). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=catalyst%20-%20HC%20N%B0001.gif)
...
<a name="developper_une_application_pour_catalyst_avec_windev_mobile_ELTTEXTE000230"></a>
...
<a name="des_fonctions_specifiques_pour_mode_asynchrone_ELTPARAGRAPHE000063"></a>Pour afficher des informations à l'utilisateur, le WLangage propose des fonctions spécifiques :
...
<a name="exemple_simple_adaptation_code_mode_asynchrone_ELTPARAGRAPHE000090"></a>Pour comprendre comment adapter le code en asynchrone, voici un cas simple de vérification de saisie :
...
<a name="cas_complexe_adaptation_code_mode_asynchrone_ELTPARAGRAPHE000105"></a>Dans un champ Zone répétée, il est possible de demander à gérer automatiquement la gesture de suppression : 
...
[AvertissementAsynchrone (Fonction)](../Editeurs/1000025270.md)

[ConfirmerAsynchrone (Fonction)](../Editeurs/1000025305.md)

[DialogueAsynchrone (Fonction)](../Editeurs/1000025310.md)

[ErreurAsynchrone (Fonction)](../Editeurs/1000025306.md)

[ErreurAvecDélaiAsynchrone (Fonction)](../Editeurs/1000025428.md)

[InfoAsynchrone (Fonction)](../Editeurs/1000025269.md)

[InfoAvecDélaiAsynchrone (Fonction)](../Editeurs/1000025271.md)

[OKAnnulerAsynchrone (Fonction)](../Editeurs/1000025308.md)

[OuiNonAsynchrone (Fonction)](../Editeurs/1000025272.md)
