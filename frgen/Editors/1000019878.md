...
<a name="version_xcode_utiliser_ELTTEXTE000200"></a>
Les projets Xcode générés par **WINDEV Mobile 2026** sont adaptés à Xcode 11.2. Cette version de Xcode doit être utilisée pour le test et le déploiement d'applications pour iOS. 
...
<a name="compilation_sous_xcode_sur_mac_ELTTEXTE000224"></a>


### Transférer le projet WINDEV Mobile sur le MAC
<a name="transferer_projet_windev_mobile_sur_mac_ELTPARAGRAPHE000062"></a>Pour transférer le projet WINDEV Mobile sur le MAC :
...
3. Ouvrez le dossier sur le MAC et ouvrez le fichier nommé "Nom_du_projet.xcodeproj".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IOS_selection_projet_xCode1.gif)
...
<a name="gestion_des_signatures_sous_xcode_8_superieur_ELTPARAGRAPHE000075"></a>L'assistant de génération d'applications iOS offre la possibilité de gérer les signatures sous Xcode.

Si vous avez choisi cette option dans l'[assistant de génération](../Editeurs/1000019923.md), par défaut, lors de l'ouverture du projet sous Xcode, Xcode utilise le mode de signature "automatique". L'option "Automatically manage signing" est sélectionnée. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=XCode_signature1.gif)
...
Il est possible de choisir le mode de signature "manuel" en décochant l'option "Automatically manage signing". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=XCode_signature2.gif)
...
<a name="compiler_projet_sous_xcode_ELTPARAGRAPHE000093"></a>WINDEV Mobile génère automatiquement un projet Xcode pour vos compilations iOS. Pour vous faciliter la mise au point des applications, WINDEV Mobile génère un "Scheme" pour Xcode.
...
1. Dans la liste déroulante en haut à gauche, sélectionnez les options de compilation. Sélectionnez le scheme correspondant à votre application puis la cible de compilation (appareil actuellement connecté ou un simulateur). 
	![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png) **Application associée à une application Apple Watch** : Choisissez la cible combinée à Apple Watch ("&lt;appareil actuellement connecté ou simulateur&gt; + Apple Watch").
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IOS_Choix_cible1.gif)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IOS_selection_cible1.gif)


2. Pour lancer la compilation, cliquez sur l'option de menu "Product .. Clean" puis sur l'option de menu "Product .. Build". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IOS_compilation_build.gif)


3. Un compte-rendu de compilation apparaît en haut ("Succeeded" ou sinon le nombre de warnings et d'erreurs). Vous pouvez cliquer sur ces symboles pour voir la liste des erreurs/warnings.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IOS_resultat_Compilation.gif)


4. Une fois le programme compilé sans erreurs, vous pouvez lancer la simulation (Option "Product .. Run"). La fenêtre de simulation apparaît avec l'application.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IOS_simulation_iPhone.gif)
