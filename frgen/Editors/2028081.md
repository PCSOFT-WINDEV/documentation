...
- soit d'utiliser les paramètres de connexion définis dans le schéma des données ou par programmation. Dans ce cas, aucune information supplémentaire n'est demandée.
...
- soit de définir les paramètres de connexion lors de l'installation de l'application. L'assistant d'installation propose alors plusieurs options:
	...
	- configuration de la connexion aux tables HFSQL Client/Serveur.

	- installation des tables HFSQL Client/Serveur.
...
<a name="installation_serveur_choix_type_serveur_ELTTEXTE000181"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000027"></a>

Lors de son installation, une application WINDEV (monoposte ou réseau) peut proposer à l'utilisateur final d'installer un serveur HFSQL Client/Serveur. Pour cela, il est bien entendu nécessaire que l'application WINDEV utilise des tables HFSQL Client/Serveur dans la description de son schéma des données.
...
<a name="configuration_connexion_ELTTEXTE000205"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000048"></a>

Si votre application utilise une connexion à un serveur HFSQL Client/Serveur définie dans votre schéma des données, il est possible de configurer cette connexion automatiquement lors de l'installation de l'application finale.
...
### Configuration
<a name="configuration_ELTPARAGRAPHE000060"></a>
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Option_WDInst_HFSQL%20-%20HC%20N%B0002.gif&type=thumb)
...
- Si la connexion doit utiliser les options du schéma des données ou les valeurs indiquées dans l'assistant. Dans ce cas, il est nécessaire de spécifier les valeurs de la connexion à utiliser.
...
- Si l'installation doit créer une nouvelle base de données, l'utilisateur spécifié dans les paramètres de l'installation doit être un "super utilisateur". En effet, même si l'utilisateur a les droits de création de la base de données, il n'aura pas les droits de création de tables sur cette base.
...
<a name="installation_des_tables_ELTTEXTE000235"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000082"></a>

Lors de la création du programme d'installation de l'application, il est également possible de déployer directement les tables HFSQL Client/Serveur sur le serveur voulu.
<a name="NOTE4_2"></a>


### Paramétrage
<a name="parametrage_ELTPARAGRAPHE000089"></a>

Pour chaque table de l'application, il est possible d'indiquer grâce au bouton "Propriétés":

- l'emplacement actuel de la table à installer.
...
<a name="installation_application_ELTTEXTE000265"></a>
...
[Sélection de l'application ou des fichiers à installer ](../Editeurs/2028041.md)
