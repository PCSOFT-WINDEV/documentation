...
## Présentation
<a name="presentation_ELTTEXTE000406"></a>
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Ce mécanisme permet également d'exécuter des tâches planifiées et des tâches différées sur le Serveur d'Application WEBDEV. Pour plus de détails, consultez [Tâches planifiées et tâches différées](../WDLang2/1000019455.md).
...
## Comment le faire?
<a name="comment_faire_ELTTEXTE000430"></a>


### Automatiser une procédure
<a name="automatiser_une_procedure_ELTPARAGRAPHE000044"></a>
...
2. Affichez la fenêtre de description des automatismes de la procédure:
	...
	- Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_procauto.gif) présente dans le bandeau de la procédure.
...
3. Dans la fenêtre qui s'affiche, sélectionnez le type d'automatisme: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Proc_Auto%20-%20HC%20N%B0001.gif)
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) [Tâches WEBDEV](../WDLang2/1000019455.md).

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) [Exécution périodique lorsque l'application est en arrière-plan](../WDLang3/1000023473.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) [Exécution asynchone](../WDLang2/3055119.md).
...
<a name="cas_des_timers_procedures_differees_ELTPARAGRAPHE000096"></a>

Les options sont les suivantes: 

- Nombre de fois: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Timer_Comment.gif)
...
- Quand: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Timer_Quand.gif&type=thumb)
La procédure peut être exécutée:
...
- Nombre de fois: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Thread_Comment.gif)
La procédure peut:
	...
	- **utiliser ou non HFSQL**: Cette option permet de spécifier si le thread doit faire des accès à des tables HFSQL. 
...
- Quand: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Thread_Quand.gif&type=thumb)
La procédure peut être exécutée:
...
<a name="cas_thread_principal_ELTPARAGRAPHE000202"></a>

Cette option permet d'appeler une procédure dans le thread principal à partir d'un thread secondaire. Cette option est notamment utilisée pour accéder à l'UI. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Proc_Auto%20-%20HC%20N%B0004.gif&type=thumb)
...
## Remarques
<a name="remarques_ELTTEXTE000472"></a>
<a name="NOTE3_2"></a>


### Tableau récapitulatif
<a name="tableau_recapitulatif_ELTPARAGRAPHE000227"></a>
...
<a name="option_fin_evenement_contenant_appel_ELTPARAGRAPHE000295"></a>

Les procédures avec l'option "A la fin de l'événement contenant l'appel" appelées depuis une procédure de callback (par exemple procédures utilisées par les fonctions [fListeFichier](../WDLang1/3036058.md), [Evénement](../WDLang1/3015011.md), ...) sont exécutées à la fin de chaque appel de la callback.
...
<a name="arreter_une_procedure_automatique_ELTPARAGRAPHE000314"></a>

Pour arrêter une procédure automatique, il suffit d'utiliser la fonction [FinAutomatismeProcédure](../WDLang1/3013034.md).
<a name="NOTE3_5"></a>


### Procédure avec lancement automatique de threads
<a name="procedure_avec_lancement_automatique_threads_ELTPARAGRAPHE000324"></a>
...
<a name="programmation_orientee_objet_poo_ELTPARAGRAPHE000339"></a>
...
### Limitation WEBDEV
<a name="limitation_webdev_ELTPARAGRAPHE000353"></a>
...
[FinAutomatismeProcédure (Fonction)](../Editeurs/3013034.md)

[Environnement de l'éditeur de code ](../Editeurs/2029007.md)

[Paramètre d'une procédure/une fonction](../Editeurs/1513001.md)

[Procédure/Fonction](../Editeurs/1513002.md)

[Procédure/Fonction globale](../Editeurs/1513005.md)

[Procédure locale](../Editeurs/1513009.md)

[WEBDEV : Tâches planifiées et tâches différées](../Editeurs/1000019455.md)

[ExécuteThreadPrincipal (Fonction)](../Editeurs/1000019862.md)

[ExécuteThreadPrincipalAsynchrone (Fonction)](../Editeurs/1410088684.md)

[Tâches en arrière-plan](../Editeurs/1000023473.md)
