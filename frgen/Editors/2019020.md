...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Param%E8trage_test%20-%20HC%20N%B0001.gif)
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Utiliser un répertoire spécifique d'exécution](#NOTE3_3).

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Utiliser un manifeste spécifique pour le test](#NOTE3_4).

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Tester un projet en utilisant les droits d'un autre utilisateur](#NOTE3_5). Ce paramétrage permet de tester le comportement de l'application en simulant le mécanisme de l'UAC sous Windows Vista.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Spécifier des options de débogage particulières](#NOTE3_6).
...
### Ligne de commande
<a name="ligne_commande_ELTPARAGRAPHE000071"></a>
...
### Coffres-forts
<a name="coffresforts_ELTPARAGRAPHE000113"></a>

WINDEV donne la possibilité d'utiliser des coffres-forts de chaînes secrètes. Il est possible de sélectionner le type de chaînes secrètes utilisées lors des tests: 
...
<a name="repertoire_execution_ELTPARAGRAPHE000132"></a>
...
Par défaut, les tables prises en compte sont les tables présentes dans les répertoires spécifiés:

- dans la description du projet. Pour plus de détails, consultez [Description du projet: Onglet Tables](../Editeurs/2030052.md). 
...
4. Cliquez sur le bouton "Copier les fichiers". Vous pouvez choisir pour chaque table le répertoire dans lequel cette table doit être copiée:
...
### Manifeste Vista
<a name="manifeste_vista_ELTPARAGRAPHE000178"></a>
...
<a name="autre_compte_utilisateur_ELTPARAGRAPHE000204"></a>
...
### Options de débogage
<a name="options_debogage_ELTPARAGRAPHE000234"></a>
