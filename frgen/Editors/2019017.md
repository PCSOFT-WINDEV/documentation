...
- [Test et débogage du projet en cours sous l'éditeur](#NOTE2).

- [Lancement et débogage de l'exécutable correspondant au projet en cours](#NOTE3).

- [Débogage d'un exécutable déjà lancé sur le poste de développement](#NOTE4).
...
### Tester un projet
<a name="tester_projet_ELTPARAGRAPHE000032"></a>Pour tester un projet depuis l'éditeur : 

1. Sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez "Déboguer le projet" (Ctrl + F9). Il est également possible d'utiliser ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Projet_WD.gif) parmi les boutons d'accès rapide.
...
<a name="remarque_iconiser_non_editeur_lors_test_ELTPARAGRAPHE000317"></a>Par défaut, lors d'un test, l'éditeur s'icônise. Selon la configuration matérielle (écran large, 2 écrans, ...), cette icônisation n'est pas utile. 
...
<a name="parametrer_mode_test_ELTPARAGRAPHE000070"></a>Pour paramétrer le mode test, sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez "Paramétrage du mode test".

Pour plus de détails sur les différentes options, consultez [Options du mode Test](../Editeurs/2019020.md).
...
### Lancer le débogueur
<a name="lancer_debogueur_ELTPARAGRAPHE000171"></a>Plusieurs méthodes permettent de lancer le débogueur pendant le test de l'exécutable :
...
- **Lancement du débogueur par l'éditeur**. Dans ce cas, effectuez les manipulations suivantes :
	...
	- Dans le volet "Débogueur", dans le groupe "Déboguer", cliquez sur l'icône suivante ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=main_debog.gif).  
...
Pour plus de détails sur le débogueur, consultez [Exécuter un projet pas à pas](../Editeurs/2019001.md). 
<a name="NOTE5_2"></a>


### Arrêter le test
<a name="arreter_test_ELTPARAGRAPHE000203"></a>Pour arrêter le test, plusieurs méthodes sont possibles :
