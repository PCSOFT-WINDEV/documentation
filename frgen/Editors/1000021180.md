...
Lors du premier lancement, il est nécessaire d'utiliser l'utilisateur "Superviseur" et de choisir un mot de passe pour cet utilisateur. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GPU_Configurer_le_site%20-%20HC%20N%B0001.gif&type=thumb)


Après identification, un utilisateur qui est superviseur du groupware aura le choix entre lancer l'application et configurer le groupware.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GPU_Configurer_le_site%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="configuration_des_utilisateurs_des_groupes_ELTTEXTE000308"></a>


### Manipulation des utilisateurs et des groupes
<a name="manipulation_des_utilisateurs_des_groupes_ELTPARAGRAPHE000046"></a>
...
La création d'une hiérarchie "groupes/utilisateurs" permet de définir un héritage dans les droits d'accès. Par exemple, dans cette configuration: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=gpu_wb_UtilisateurGroupes.gif)
...
<a name="cas_particulier_utilisateur_visiteur_ELTPARAGRAPHE000111"></a>
...
<a name="configuration_des_droits_ELTTEXTE000338"></a>
...
2. La définition des droits commence par autoriser ou interdire l'accès aux pages et états du site: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P5_Groupware%20utilisateur%20-%20HC%20N%B0007.jpg&type=thumb)
...
## Statistiques
<a name="statistiques_ELTTEXTE000362"></a>
...
<a name="recuperation_donnees_ELTTEXTE000386"></a>
...
<a name="parametrage_mode_integre_ELTTEXTE000410"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GPU_Integre_WB%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="activer_cryptage_des_mots_passe_ELTTEXTE000434"></a>
