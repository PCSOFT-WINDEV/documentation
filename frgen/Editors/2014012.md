...
3. Pour configurer le mode de débogage du composant en cours, sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez "Paramétrage du mode test".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_debog.gif)


4. Sélectionnez l'option voulue. Vous pouvez :

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Tester le composant depuis le projet** (par défaut) :
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Tester le composant en exécutant un autre projet** : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Tester le composant depuis un exécutable** (WINDEV uniquement) : 
	...
	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Tester le composant depuis un site** (WEBDEV uniquement) : 
...
3. Dans l'onglet "Droits d'accès", choisissez le mode d'accès du composant sur les données du projet client. Pour utiliser le contexte du projet "client", sélectionnez l'option "Le composant va accéder aux tables, fenêtres, pages, états, etc. du projet client.".
