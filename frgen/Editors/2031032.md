...
Cette page d'aide présente différentes règles applicables à la conception des pages du Pattern RAD. Ces règles ont été utilisées pour concevoir les différents Patterns livrés avec WEBDEV 2026.
...
- Une table: Cette table est une table liée aux données, avec données chargées en mémoire.
...
Exemple: Page Table sur le fichier RADFichierA du pattern Modèle Simple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Pattern_RAD_WWTable.gif)

<a name="NOTE3_2"></a>


### Créer une page Table
<a name="creer_une_page_table_ELTPARAGRAPHE000084"></a>
...
<a name="cas_des_boutons_impression_ELTPARAGRAPHE000152"></a>
