...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Lors de la création de l'exécutable, la bibliothèque correspondant au projet est générée. Elle peut être intégrée ou non dans l'exécutable. Pour plus de détails, consultez [Créer un exécutable](../Editeurs/2025002.md). 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Lors de la création du programme d'installation d'un site dynamique, la bibliothèque du site est créée. Pour plus de détails, consultez [Déploiement d'un site](../Editeurs/2028039.md). 
