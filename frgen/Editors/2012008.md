...
4. Dans la liste qui s'ouvre, sélectionnez "C#". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CSHARP_Code_WL.gif)


5. Le bandeau devient bleu clair et les caractères "C#" apparaissent devant le nom de la procédure. Le code existant est mis en commentaires. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CSHARP_Code.gif)
...
[C# : Appel de procédure WLangage](../Editeurs/2012009.md)
