...
3. Créez un nouvel exécutable : cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_generation_exe.gif) parmi les boutons d'accès rapide.
