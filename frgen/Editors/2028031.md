...
<a name="fichiers_installer_ELTTEXTE000306"></a>
...
Par défaut, le programme d'installation sélectionne automatiquement toutes les fichiers présents dans le sous-répertoire EXE de votre projet à l'exception des tables (".FIC", ".NDX", ".MMO"). Les fichiers sélectionnés seront installés sur les postes utilisateurs.
...
<a name="cas_une_installation_avec_mise_jour_automatique_ELTPARAGRAPHE000043"></a>
...
## Framework WINDEV
<a name="framework_windev_ELTTEXTE000336"></a>


### Mode d'installation du framework
<a name="mode_installation_framework_ELTPARAGRAPHE000062"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fichier_a_installer%20-%20HC%20N%B0007.gif&type=thumb)
...
<a name="telechargement_framework_ELTPARAGRAPHE000086"></a>
...
Le programme d'installation utilisera la connexion Internet du poste en cours et la fenêtre suivante sera affichée: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fichier_a_installer%20-%20HC%20N%B0008.gif&type=thumb)


A chaque lancement de l'exécutable, tous les fichiers du framework WINDEV seront alors automatiquement chargés sur le site PC SOFT. La version du framework téléchargé correspondra à la version de WINDEV avec laquelle l'exécutable a été créé.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Install_Framework2.gif)
...
<a name="emplacement_framework_ELTPARAGRAPHE000103"></a>
...
- "&lt;Version de WINDEV&gt;" correspond au numéro de version de WINDEV avec laquelle l'exécutable a été créé (par exemple, "31.0" si l'exécutable a été créé avec WINDEV 2026).
...
<a name="proprietes_des_fichiers_installer_ELTTEXTE000372"></a>


### Onglet "Chemin"
<a name="onglet_chemin_ELTPARAGRAPHE000124"></a>

Cet onglet permet de spécifier: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fichier_a_installer%20-%20HC%20N%B0001.gif&type=thumb)
...
- le répertoire d'installation du fichier. Les raccourcis suivants peuvent être utilisés:
	...
	- **&lt;FicInst&gt;**: répertoire d'installation des fichiers de données. L'assistant de création du programme d'installation permet de paramétrer ce répertoire. Pour plus de détails, consultez [Paramétrer le répertoire des tables](../Editeurs/2028086.md).
...
### Onglet "Raccourcis"
<a name="onglet_raccourcis_ELTPARAGRAPHE000144"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fichier_a_installer%20-%20HC%20N%B0002.gif&type=thumb)
...
### Onglet "Version"
<a name="onglet_version_ELTPARAGRAPHE000180"></a>Par défaut, lors de la mise à jour d'une application, si des fichiers de même nom existent déjà dans le répertoire d'installation, ces fichiers sont remplacés (même si les fichiers remplacés sont plus récents que les fichiers installés). Aucune fenêtre d'avertissement ne s'affiche pour confirmer ces remplacements.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fichier_a_installer%20-%20HC%20N%B0003.gif&type=thumb)
...
### Onglet "Options"
<a name="onglet_options_ELTPARAGRAPHE000195"></a>
...
### Onglet "HFSQL" (uniquement pour les exécutables et les tables)
<a name="onglet_hfsql_uniquement_pour_les_executables_les_tables_ELTPARAGRAPHE000211"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fichier_a_installer%20-%20HC%20N%B0005.gif&type=thumb)

<a name="NOTE4_6"></a>


### Onglet "Framework" (uniquement pour les exécutables)
<a name="onglet_framework_uniquement_pour_les_executables_ELTPARAGRAPHE000225"></a>

Cet onglet permet de préciser le mode d'utilisation du framework. Les informations affichées dans cet onglet ne sont pas modifiables et dépendent des informations indiquées dans l'écran de l'assistant. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fichier_a_installer%20-%20HC%20N%B0006.gif&type=thumb)
