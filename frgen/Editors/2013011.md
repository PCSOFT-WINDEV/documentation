...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Indentation_du_code.gif)
...
2. Dans l'onglet "Code", cochez l'option "Indentation (le code collé est mis en forme et réindenté pour s'adapter à la mise en page)".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Coller-Code.gif)
