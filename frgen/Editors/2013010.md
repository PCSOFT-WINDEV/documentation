...
Remarque : Si votre projet est présent dans le GDS (Gestionnaire De Sources), il est possible de visualiser rapidement ce qui a été modifié. Pour plus de détails, consultez [Historique d'une ligne de code](#NOTE2_5).
...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000284"></a>
...
2. Dans l'onglet "Code", cochez l'option "Sauver l'historique des modifications du code". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Historique_code%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="visualiser_historique_code_ELTPARAGRAPHE000067"></a>Pour visualiser l'historique du code de votre projet :

1. Affichez le traitement dont l'historique doit être visualisé.

2. Sous le volet "Code", dans le groupe "Autres actions", déroulez "Historique" et sélectionnez "Voir l'historique des modifications". La fenêtre de consultation de l'historique apparaît.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Historique_code%20-%20HC%20N%B0004.gif)
...
3. Cliquez sur les différentes versions à gauche de la fenêtre pour faire défiler les différentes modifications effectuées sur le traitement en cours. Il est possible depuis cette fenêtre de :
	...
	- visualiser les différences entre l'élément sélectionné et la version en cours (bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Historique_code%20-%20HC%20N%B0004%201.gif)).

	- imprimer la version affichée (bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Historique_code%20-%20HC%20N%B0004%202.gif)).
...
<a name="recuperer_code_present_dans_historique_ELTPARAGRAPHE000099"></a>Pour récupérer un code présent dans l'historique :
...
<a name="purger_historique_code_ELTPARAGRAPHE000126"></a>Cette méthode permet de supprimer uniquement les modifications spécifiques à un traitement.
...
**Remarque** : La fenêtre de l'historique du code permet également de supprimer la modification en cours (bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeSupprime.gif)).
<a name="NOTE2_5"></a>


### Historique d'une ligne de code (projet dans le GDS (Gestionnaire De Source))
<a name="historique_une_ligne_code_projet_dans_gds_gestionnaire_source_ELTPARAGRAPHE000156"></a>Lorsqu'un projet est présent dans le GDS, l'éditeur de code propose un historique de la ligne de code avancé. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Historique_Code_GDS.gif)
...
- Option "Date et Auteur" activée : Sous le volet "Affichage", dans le groupe "Aide à l'édition", cochez l'option "Afficher la date et l'auteur" (touche F6). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Historique_code%20-%20HC%20N%B0002.gif)
...
<a name="sauvegarde_historique_code_ELTPARAGRAPHE000192"></a>Cette gestion de l'historique crée un sous-répertoire "Historique" dans le répertoire du projet. Ce répertoire contient les sous-répertoires suivants :
