...
4. Enregistrez ces modifications (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif)).

5. Régénérez le composant : cliquez sur l'icône de génération parmi les boutons d'accès rapide : ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_generation_Composant.gif)
...
3. Dans l'écran "Compatibilité du composant en déploiement", une vérification des modifications apportées est effectuée:
	...
	- **Si les modifications rendent le composant incompatible avec les versions antérieures**, l'écran s'affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=versionning_1.gif&type=thumb)
Mettez les numéros de version en phase (bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=versionning_2.gif)).
...
- ***Premier cas*** : Les applications en clientèle utilisent le composant (fichier .WDK) dans une version inférieure à 1.00C. Une erreur surviendra au chargement de ces applications.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=AppC_CompoA_MarchePascopier.jpg)
