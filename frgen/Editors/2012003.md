...
4. Copier l'assemblage généré dans le répertoire des assemblages partagés de Windows :
	...
	- Copier la librairie wd310net.dll dans le répertoire "c:\\Windows\\Assembly" (sinon l'instanciation de l'objet COM échouera avec l'erreur "fichier introuvable à l'emplacement spécifié").

	- Vérifier que la wd310vm.dll se trouve dans un répertoire du PATH.
