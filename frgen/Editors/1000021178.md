...
<a name="branchement_groupware_utilisateur_sur_annuaire_ldap_sans_gestion_droits_ELTPARAGRAPHE000024"></a>
...
3. Dans l'onglet "Tables": 
	...
	- Cochez l'option "Fenêtre de login uniquement (pas de gestion des droits)". Dans ce cas, le groupware utilisateur ne crée pas de tables. Il ne sera pas possible à un superviseur de définir les droits sur les fenêtres et sur les pages.
...
<a name="branchement_groupware_utilisateur_sur_annuaire_ldap_avec_gestion_droits_ELTPARAGRAPHE000052"></a>
...
3. Dans l'onglet "Tables":
	...
	- Décochez si nécessaire l'option "Fenêtre de login uniquement (pas de gestion des droits)". Dans ce cas, le groupware utilisateur crée des tables pour la gestion des utilisateurs et des droits. Il est possible à un superviseur de définir les droits sur les fenêtres et sur les pages.
...
4. Une fenêtre s'affiche permettant de réaliser l'importation de tous les utilisateurs.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=gpu_ldap.gif)
...
<a name="lancement_application_ELTPARAGRAPHE000106"></a>

**En mode lancement automatique**: 
Les caractéristiques du serveur LDAP doivent être saisies dans l'onglet "Tables" de la fenêtre de paramétrage du groupware utilisateur.
...
<a name="installation_application_utilisant_annuaire_ldap_ELTPARAGRAPHE000139"></a>
...
- de configurer l'emplacement des tables du groupware utilisateur.
