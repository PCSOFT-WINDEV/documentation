...
<a name="comment_partager_projet_windevwebdev_windev_mobile_via_git_ELTTEXTE000341"></a>
...
2. Modifiez le format de sauvegarde de tous les éléments du projet : 
	...
	- Dans l'onglet "Options" de la fenêtre de description du projet, pour l'option "Format de sauvegarde des éléments", sélectionnez l'option "Texte". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_Git_2%20-%20HC%20N%B0002.gif&type=thumb)
...
- Pour chaque élément de votre projet, il est possible de vérifier ou modifier le format d'enregistrement via l'option "Format" présente dans la fenêtre de description de l'élément. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_Git_2%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="ajouter_projet_dans_git_ELTPARAGRAPHE000084"></a>L'ajout d'un projet dans Git peut être réalisé : 
...
- depuis WINDEV, WEBDEV ou WINDEV Mobile : Sous le volet "GDS", dans le groupe "Ajouter le projet", cliquez sur "Ajouter le projet dans Git".
	...
	1. Dans le fenêtre qui s'affiche, indiquez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_Git_3%20-%20HC%20N%B0001.gif)
...
<a name="ouvrir_cloner_projet_git_dans_windev_webdev_windev_mobile_ELTPARAGRAPHE000119"></a>Pour ouvrir (cloner) un projet Git depuis WINDEV : 

1. Dans la fenêtre d'accueil, cliquez sur le lien "Git...". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_Git%20-%20HC%20N%B0001.gif&type=thumb)


2. Dans la fenêtre qui s'affiche, indiquez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_Git%20-%20HC%20N%B0002.gif)
...
4. Le projet est affiché dans WINDEV, WEBDEV, WINDEV Mobile et un volet spécifique "Git" est affiché dans le ruban. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_Git%20-%20HC%20N%B0004.gif&type=thumb)
...
- Ouvrez un projet Git depuis WINDEV, WEBDEV ou WINDEV Mobile. Dans l'option "Spécifiez l'URL du projet Git à cloner", indiquez l'adresse SSH fournie par Github (par exemple : git@github.com:xxxxx/ProjetTestGIT.git) puis cliquez sur le bouton "Cloner". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Git_ssh1.gif&type=thumb)


- Dans la fenêtre de connexion, spécifiez le chemin de la clé privée présente sur l'ordinateur et le mot de passe associé. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Git_ssh2.gif&type=thumb)
...
<a name="travailler_sur_projet_ELTPARAGRAPHE000167"></a>Vous travaillez sur un projet partagé via Git avec WINDEV, WEBDEV ou WINDEV Mobile comme d'habitude. Dans ce cas, vous pouvez modifier : 
...
### Options du ruban
<a name="options_ruban_ELTPARAGRAPHE000214"></a>Le volet du ruban spécifique au Git permet de : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_Git%20-%20HC%20N%B0005.gif&type=thumb)
