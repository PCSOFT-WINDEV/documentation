...
## Présentation
<a name="presentation_ELTTEXTE003357"></a>
...
| <br><br>- Fonctions et opérateurs sur les bits<br><br><br> | <br><br>- [BITAND, BITOR, BITXOR, BITNOT](#SQL_BITS)<br><br>- [BITANDNOT](#SQL_BITS)<br><br><br> |
...
## Fonctions SQL
<a name="fonctions_sql_ELTTEXTE003471"></a>


### Expression scalaire
<a name="expression_scalaire_ELTPARAGRAPHE000531"></a>
...
### LEFT
<a name="left_ELTPARAGRAPHE000581"></a>La fonction **LEFT** extrait la partie gauche (c'est-à-dire les premiers caractères) d'une expression.
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) Cette fonction ne peut pas être utilisée sur une source de données PostgreSQL.
...
<a name="mid_substr_substring_ELTPARAGRAPHE000614"></a>
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) CONCAT n'est pas géré par Sybase.
...
Remarque : Cette fonction n'est pas disponible pour les requêtes SQL exécutées sur des tables HFSQL en Android. 
...
### LEN / LENGTH
<a name="len_length_ELTPARAGRAPHE001458"></a>
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) SOUND LIKE n'est pas géré par Oracle, MySQL, Progress ou Informix. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) SOUNDEX2 et SOUNDEX2 LIKE ne sont pas gérés par Oracle, SQL Server, MySQL, Progress, Informix ou DB2. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) ADD_MONTHS n'est pas géré par SQL Server, MySQL, Informix, DB2 ou Sybase.
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) LAST_DAY n'est pas géré par Informix, DB2 ou Sybase.
<a name="SQL_DAY"></a>
...
### YEAR et MONTH
<a name="year_month_ELTPARAGRAPHE002149"></a>
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) Les fonctions CURRENT_TIME et CURTIME sont gérées par MySQL. La fonction CURRENTIME est également gérée par PostgreSQL.  
<a name="SQL_HOUR"></a>
...
### SECONDE
<a name="seconde_ELTPARAGRAPHE002237"></a>
...
### NOW
<a name="now_ELTPARAGRAPHE002267"></a>
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) La fonction NOW est gérée par MySQL. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) Ces fonctions sont gérées par MySQL et PostgreSQL. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) Les fonctions CURRENT_DATE et CURDATE sont gérées par MySQL.  
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) DATEADD est géré par SQL Server. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) ADDDATE est géré par MySQL. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) SUBDATE est géré par MySQL. 
<a name="SQL_DATEDIFF"></a>


### DATEDIFF et DATEDIFF_BIG
<a name="datediff_datediffbig_ELTPARAGRAPHE002521"></a>
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) MONTHS_BETWEEN n'est pas géré par MySQL, Informix, DB2 ou Sybase.
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) NEW_TIME n'est pas géré par SQL Server, MySQL, Progress, Informix, DB2 ou Sybase.
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) NEXT_DAY n'est pas géré par SQL Server, MySQL, Progress, Informix, DB2 ou Sybase. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) ROUND n'est pas géré par Progress, DB2 et Sybase. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png)  SYSDATE n'est pas géré par Informix et Sybase.
<a name="SQL_TRUNC"></a>
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) TRUNC n'est pas géré par SQL Server, MySQL, Progress, DB2 et Sybase.
<a name="SQL_ISDATE"></a>
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) COALESCE n'est pas géré par Progress ou Informix.
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png)  DECODE n'est pas géré par SQL Server, MySQL, Progress, Informix, DB2, Sybase et ACCESS.
<a name="SQL_CASE"></a>
...
<a name="operateurs_fonctions_sur_les_bits_ELTPARAGRAPHE003115"></a>
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Ces commandes ne sont pas disponibles.
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Cette commande n'est pas disponible.
