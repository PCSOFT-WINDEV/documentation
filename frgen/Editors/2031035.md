...
<a name="creation_page_vision_plus_ELTPARAGRAPHE000088"></a>
...
<a name="creation_des_elements_necessaires_dans_page_fiche_ELTPARAGRAPHE000147"></a>
...
2. Dans l'assistant de création de la combo, sélectionnez les options suivantes:
	...
	- Table: RADTableA pour une fiche sur RADTableB, RADTableB pour une fiche sur RADTableC.
...
1. Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_bouton.gif) puis cliquez dans la page.
