...
<a name="parametrer_utiliser_personnaliser_groupware_utilisateur_ELTPARAGRAPHE000068"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Configuration de l'application (définition des utilisateurs, des groupes, etc.)](../Editeurs/1000021154.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) [Configuration du site (définition des utilisateurs, des groupes, etc.)](../Editeurs/1000021180.md).

- [Groupware utilisateur dans une application multilingue](../Editeurs/1000021172.md). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Personnaliser le groupware utilisateur](../Editeurs/1000021170.md). 

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) [Personnaliser le groupware utilisateur](../Editeurs/1000021181.md).

- [Conseils pour réaliser une application gérant le groupware utilisateur](../Editeurs/2018003.md). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Créer l'exécutable d'une application WINDEV utilisant le groupware développeur et l'installer](../Editeurs/1000021173.md).
...
<a name="fonctionnement_groupware_utilisateur_ELTPARAGRAPHE000112"></a>
...
- Le groupware utilisateur de la version Française n'est pas compatible avec celui de la version Internationale: schéma des données différent, noms de fichiers différents, variables avec des noms différents, etc.
