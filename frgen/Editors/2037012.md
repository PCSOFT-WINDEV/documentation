...
- **Pour Windows Vista :** <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IIS_Version7.gif)


- **Pour Windows 7 :** <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IIS7_SevenFR.gif)
...
3. Indiquez le chemin :
	...
	- du fichier WD310AWP.EXE présent dans le sous-répertoire Programs\\Engine\\WINDOWS\\AWP. Ce chemin ne doit pas contenir d'espaces.

	- du fichier WD310INSTAWP.EXE présent dans le sous-répertoire Programs\\Engine\\WINDOWS\\AWP. Ce chemin ne doit pas contenir d'espaces.
...
7. Dans l'écran qui s'affiche :
	...
	- Indiquez l'alias du protocole CGI : wd310awp.
...
8. Sélectionnez WD310AWP dans le treeview.
...
12. Dans la fenêtre qui s'affiche :
	...
	- Dans le champ "Exécutable", indiquez le chemin du fichier WD310AWP.EXE présent dans le sous-répertoire "Programs\\Engine\\WINDOWS\\AWP". Vous pouvez utiliser le bouton "..." pour sélectionner ce fichier. Exemple : "C:\\WebDev\\AWP\\WD310awp.exe".
			Attention : 
...
4. Ajoutez un mappage de script :
	...
	- indiquez le chemin du fichier WD310AWP.EXE présent dans le sous-répertoire Programs\\Engine\\WINDOWS\\AWP. Ce chemin ne doit pas contenir d'espaces.
