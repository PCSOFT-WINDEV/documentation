...
<a name="integrer_assemblage_net_dans_projet_windev_webdev_ELTTEXTE000309"></a>
Pour intégrer des assemblages .NET dans le projet en cours :

1. Sous le volet "Projet", dans le groupe "Projet", déroulez "Importer" et sélectionnez "Un assemblage .NET".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Utiliser_Assemblage%20-%20HC%20N%B0001.gif&type=thumb)


2. Dans la fenêtre qui s'affiche, sélectionnez les différents assemblages .NET à intégrer dans le projet en cours. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Utiliser_Assemblage%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="utilisation_des_elements_assemblage_net_ELTPARAGRAPHE000067"></a>Les éléments suivants importés dans l'assemblage .NET peuvent être manipulés en WLangage :
...
- Attention : Les composants créés avec une version 11 ou inférieure utilisant .NET ne fonctionneront plus avec la version 2026. Il est nécessaire de re-générer les composants avec la version 2026.
...
<a name="utiliser_des_assemblages_standards_framework_net_4_inferieur_ELTTEXTE000365"></a>


### Utiliser des assemblages standards du framework .NET 4 (et inférieur)
<a name="utiliser_des_assemblages_standards_framework_net_4_inferieur_ELTPARAGRAPHE000163"></a>Pour utiliser des assemblages standards du framework .NET 4 (et inférieur) : 
...
<a name="utiliser_des_assemblages_standards_sdk_net_5_ELTPARAGRAPHE000180"></a>Pour utiliser des assemblages standards du SDK .NET 5 : 
...
<a name="utiliser_assemblage_net_cree_avec_windev_ELTTEXTE000395"></a>
...
<a name="liste_des_assemblages_net_utilises_dans_projet_ELTTEXTE000419"></a>
...
<a name="recharger_les_assemblages_net_ELTTEXTE000443"></a>
