...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Le RAD MVP n'est pas disponible. Un exemple utilisant les différentes classes permettant de réaliser une application MVP est disponible. 



Remarque : Il est également possible de créer automatiquement des états basés sur une classe. Pour plus de détails, consultez [Etat sur une classe (MVP)](../WDChamp/1011097.md).
...
<a name="les_etapes_generation_fenetre_ELTPARAGRAPHE000044"></a>

Pour générer une fenêtre en mode "RAD MVP" : 
...
2. Dans l'assistant : 
	...
	- Terminez l'assistant de création d'une fenêtre.
...
3. Dans l'assistant : 
	...
	- Sélectionnez la table à manipuler. 
...
<a name="les_elements_generes_par_rad_ELTPARAGRAPHE000076"></a>

Lors d'une génération d'une fenêtre Fiche et d'une fenêtre Table sur une table "MonFichierExemple", le RAD MVP génère 6 classes et 2 fenêtres.
...
<a name="wlangage_specificites_permettant_simplifier_architecture_mvp_ELTTEXTE000402"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000111"></a>
...
### Attribut "mapping"
<a name="attribut_mapping_ELTPARAGRAPHE000144"></a>

L'attribut **mapping** permet de réaliser une "liaison directe" entre la classe et la table.
...
- la fonction [MémoireVersTable](../WDLang1/3013070.md) va automatiquement recopier la valeur des membres de la classe dans les rubriques de l'enregistrement en cours de la table. 

- la fonction [TableVersMémoire](../WDLang1/3013071.md) va automatiquement recopier les rubriques de l'enregistrement en cours de la table dans les membres de la classe.
...
- Par défaut, pour que ce mécanisme fonctionne, les noms des membres de la classe doivent être identiques aux noms des rubriques dans la table.

- En cas de besoin : l'attribut **mapping** permet d'utiliser des préfixes ou des noms différents de ceux du schéma des données. Il suffit de réutiliser le mot-clé **mapping** sur les membres de la classe pour recréer la liaison entre le membre et sa rubrique du schéma des données. 
	Exemple : 
...
<a name="motscles_monfichiermappe_macleuniquemappee_ELTPARAGRAPHE000174"></a>
...
- **MonFichierMappé** référence la table définie avec le mot-clé **mapping** dans la classe "Modèle". 
	...
	Ce code va effectuer un appel à la fonction [HRAZ](../WDLang4/3044118.md) sur la table pour laquelle le RAD a été généré. 
...
### Attribut "associé"
<a name="attribut_associe_ELTPARAGRAPHE000207"></a>
...
<a name="attribut_presentation_gestion_actualisation_des_vues_ELTPARAGRAPHE000229"></a>
...
[DemandeMiseAJourUIParent](../Editeurs/1000023900.md)

[ExécuteMiseAJourUI](../Editeurs/1000023901.md)

[ExécuteMiseAJourUIParent](../Editeurs/1000023902.md)

[Créer une classe modèle](../Editeurs/1000021515.md)

[Etat sur une classe (MVP)](../Editeurs/1011097.md)
