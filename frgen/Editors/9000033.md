...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Cible_Cond_1.gif)
...
3. La fenêtre suivante s'affiche :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Cible_Cond_DescSimple.gif)
...
Le bouton "Avancé" permet de personnaliser les cibles en choisissant les plateformes disponibles : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Cible_Cond_DescAvance.gif)
...
- Pour ajouter une plateforme dans une cible :
	...
	- cliquez sur le bouton d'ajout ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Cible_Cond_BtnAjout.gif).
...
- Pour supprimer une plateforme dans une cible :
	...
	- cliquez sur le bouton de suppression ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Cible_Cond_BtnSupp.gif).
...
Pour réaliser cette opération, il suffit de cliquer sur le bouton correspondant à la plateforme à afficher en haut à droite du code-cible.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Cible_Cond_2.gif)
...
[Instruction de compilation : SI CibleExécution](../Editeurs/1510028.md)
