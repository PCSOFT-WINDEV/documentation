...
<a name="creer_une_configuration_ELTPARAGRAPHE000058"></a>
...
1. Dans le volet "Explorateur de projet", affichez le menu contextuel de l'option "Configurations" et sélectionnez "Nouvelle configuration". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Config_Projet_explo.gif)
...
Cette configuration pourra être modifiée via l'option "Description" du menu contextuel de la configuration de projet dans le volet "Explorateur de projet". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Config_Projet_explo_2.gif)
...
- En mode GO, les fichiers utilisés sont les fichiers présents dans le répertoire de la configuration (fichiers INI, tables, etc.). 
...
<a name="travailler_sur_une_configuration_projet_ELTPARAGRAPHE000117"></a>

La sélection de la configuration de travail se fait via le volet "Explorateur de projet": il suffit de double-cliquer sur la configuration voulue ou de sélectionner l'option "Activer cette configuration" du menu contextuel. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Config_projet_liste_explo.gif)
...
<a name="generer_une_configuration_projet_ELTPARAGRAPHE000134"></a>

Pour générer le résultat d'une configuration de projet: 

1. Affichez la fenêtre de gestion des configurations de projet: dans le volet "Explorateur de projet", affichez le menu contextuel de l'option "Configurations" et sélectionnez "Gérer les configurations". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Config_Projet_explo.gif)
...
<a name="ajouter_element_dans_une_configuration_projet_ELTPARAGRAPHE000151"></a>
...
Remarque: Lors de l'enregistrement d'un nouvel élément, la fenêtre suivante s'affiche:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Config_Ajout.GIF)
...
<a name="exclure_element_une_configuration_projet_ELTPARAGRAPHE000186"></a>
...
- il n'y a pas de schéma des données du code: pas de renommage intelligent. 
...
<a name="dupliquer_une_configuration_projet_ELTPARAGRAPHE000213"></a>
...
2. Affichez le menu contextuel de la description et sélectionnez l'option "Dupliquer". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Config_Projet_explo_2.gif)
...
<a name="supprimer_une_configuration_projet_ELTPARAGRAPHE000253"></a>
...
<a name="caracteristiques_une_configuration_projet_ELTPARAGRAPHE000268"></a>
...
- **Onglet "Eléments**" affichant la liste des éléments présents dans la configuration. 
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Cet onglet permet également de connaître et paramétrer les animations d'ouverture et/ou de fermeture des fenêtres de la configuration de projet via le bouton "Animations de fenêtre". Pour plus de détails, consultez [Animation de fenêtre](../WDLang1/3038054.md). 
...
- **Onglet "Compatibilité"** listant les options de compatibilité de la configuration de projet. Ces options concernent: 
	...
	- les options multiplateforme: Il est possible de: 
		...
		- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Afficher les erreurs relatives aux sessions prélancées. 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) **Onglet "Unicode"** permettant de définir le mode d'utilisation des chaînes UNICODE ou ANSI en exécution.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Onglet "Télémétrie"** permettant d'activer la télémétrie pour la configuration courante en spécifiant ses paramètres. Pour plus de détails, consultez [Activer la télémétrie](../WDLang1/1410086582.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Onglet "GPU"** permettant d'activer ou non le Groupware utilisateur pour la configuration en cours.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Onglet "GPU / Store Privé"** permettant d'activer ou non pour la configuration en cours le groupware utilisateur et/ou le déploiement sur le Store Privé.
...
<a name="caracteristiques_presentes_dans_onglet_general_ELTPARAGRAPHE000345"></a>

Les options disponibles dans l'onglet "Général" sont les suivantes: 

- **les informations générales**: le nom et la description de la configuration.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Configuration_de_projet2%20-%20HC%20N%B0002%201.gif)


- **les informations de génération**: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Configuration_de_projet2%20-%20HC%20N%B0002%202.gif)
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) les actions à effectuer avant la génération Gradle.

- les premières fenêtres ou premières pages. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Configuration_de_projet2%20-%20HC%20N%B0002%203.gif)


	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **la première fenêtre du projet**: Permet de sélectionner la première fenêtre qui sera affichée lors du lancement du projet (ou de l'exécutable associé). 
...
- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) **la première fenêtre pour téléphones**: Permet de sélectionner la première fenêtre qui sera affichée lors du lancement de l'application sur un téléphone. 
			Le bouton [...] permet d'afficher l'aperçu de toutes les fenêtres du projet pour une sélection plus rapide.
			Pour plus de détails, consultez [Première fenêtre du projet](../Editeurs/9000177.md).

- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) **la première fenêtre pour tablettes**: Permet de sélectionner la première fenêtre qui sera affichée lors du lancement de l'application sur une tablette. 
			Le bouton [...] permet d'afficher l'aperçu de toutes les fenêtres du projet pour une sélection plus rapide.
			Pour plus de détails, consultez [Première fenêtre du projet](../Editeurs/9000177.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **la page d'accueil**: Permet de sélectionner la page d'accueil du site.
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **la première page en mode session**: Permet de sélectionner la première page en mode session du projet. 
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **la page d'erreur**: Permet de sélectionner la page utilisée pour afficher les erreurs du site. 
...
- **les caractéristiques de l'exécutable**. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Configuration_de_projet2%20-%20HC%20N%B0002%204.gif)
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **SBOM**
	L'option **"Générer la nomenclature logicielle lors de la génération de l'exécutable"** permet de générer un fichier JSON de type "&lt;Nom application&gt;.sbom.json" qui répertorie de manière exhaustive pour l'application générée tous les composants logiciels et leurs dépendances. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Configuration_de_projet2%20-%20HC%20N%B0002%205.gif)


- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) **les options spécifiques Android**: 
...
- Pour ouvrir directement le répertoire de génération d'une configuration: 
	...
	- Sous le volet "Accueil", dans le groupe "Général", déroulez ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rep_Projet.gif) et sélectionnez "Explorer le répertoire de génération". 
