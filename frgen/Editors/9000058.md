...
<a name="deboguer_une_page_php_ELTPARAGRAPHE000020"></a>Pour déboguer une page en PHP : 
...
2. Lancez le test de votre page (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Go_Page_bl.gif)).
...
<a name="deboguer_projet_php_ELTPARAGRAPHE000051"></a>Pour déboguer un projet en PHP : 

1. Sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez "Déboguer le projet PHP en mode simulation". Cette option de menu doit être sélectionnée (une coche doit apparaître devant l'option).

2. Lancez le test de votre projet (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_GO_Projet_WB_bl.gif)).
...
- Des différences de fonctionnement peuvent être observées :
	...
	- les URL ne sont pas gérées de la même façon en mode WEBDEV dynamique et en mode PHP : certaines manipulations directes d'URL (par exemple avec la propriété [URL](../Proprietes/2510132.md)) peuvent ne pas fonctionner en mode débogage.
