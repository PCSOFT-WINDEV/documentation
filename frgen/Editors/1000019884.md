...
![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png) **Application associée à une application Apple Watch** : Deux identifiants supplémentaires doivent être créés : 
...
- Faites glisser par Drag and Drop le certificat de "provisioning" téléchargé précédemment dans l'environnement Xcode. Il sera installé automatiquement.
	![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png) **Application associée à une application Apple Watch** : Répétez cette opération pour les deux certificats de "Provisioning" supplémentaires créés pour l'application Apple Watch.
