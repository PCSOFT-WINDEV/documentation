...
Une règle métier peut être simple ou élaborée.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RegleMetier.GIF)
Les règles métier proviennent du cahier des charges, de l'architecte du projet, du chef de projet, des développeurs, ...

![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Les règles métier peuvent également provenir des suggestions faites par les utilisateurs de l'application, grâce au [Menu "?"](../Editeurs/9000070.md). Dans ce cas, le [composant Feedback](../Editeurs/2014013.md) est utilisé. 
...
Ce paramétrage s'effectue grâce au bouton "Filtre" :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FiltreMetier.GIF)
...
1. Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_NewRegle.GIF) dans le [volet "Règles métier"](../Editeurs/2027024.md). La fenêtre d'édition de la règle métier s'ouvre.
...
3. Pour associer à la règle métier :
	...
	- l'image présente dans le presse-papiers, cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_ImgRegle.GIF).

	- une partie de l'image de l'écran, cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_ImgRegleLasso.GIF) et sélectionnez la partie de l'image voulue.

	- un fichier image, cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_ImgRegleFic.GIF) et sélectionnez le fichier image voulu.

	- le document présent dans le scanner du poste en cours, cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_ImgRegleScan.GIF).
...
- L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IcoSelectManu.GIF) indique les éléments sélectionnés manuellement et l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IcoSelectAuto.GIF) indique les éléments sélectionnés automatiquement.




![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Les règles métier peuvent également provenir des suggestions faites par les utilisateurs de l'application, grâce au [Menu "?"](../Editeurs/9000070.md). Dans ce cas, le [composant Feedback](../Editeurs/2014013.md) est utilisé. Ces règles métier sont affichées en rouge. 
<a name="NOTE2_3"></a>


### Modifier une règle métier
<a name="modifier_une_regle_metier_ELTPARAGRAPHE000128"></a>Pour modifier une règle métier, cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_ModifRegle.GIF) dans le [volet "Règles métier"](../Editeurs/2027024.md) et effectuez les modifications voulues.
...
Pour valider une règle métier, cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_ModifRegle.GIF) dans le [volet "Règles métier"](../Editeurs/2027024.md) et définissez l'état de chaque élément lié à la règle métier. Cet état peut correspondre à :
...
<a name="rendre_une_regle_metier_obsolete_ELTPARAGRAPHE000165"></a>Pour rendre une règle métier obsolète, cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_RegleObsolete.GIF) dans le [volet "Règles métier"](../Editeurs/2027024.md).
...
- toutes les règles métier du projet en imprimant le dossier du projet : sous le volet "Accueil", dans le groupe "Général", déroulez ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_imprimer.gif) et sélectionnez "Imprimer le dossier du projet".
...
La fenêtre d'administration des règles métier (icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_regle_admin.GIF)) permet de :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Cette fenêtre permet également de récupérer les demandes effectuées par les utilisateurs finaux. Pour plus de détails, consultez [Composant Feedback](../Editeurs/2014013.md). 
<a name="NOTE3_2"></a>
...
1. Affichez la fenêtre d'administration des règles métier (icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_regle_admin.GIF)).
...
<a name="afficher_volet_regles_metier_des_regles_metier_sont_associees_ELTPARAGRAPHE000348"></a>L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IcoPunaiseRegle.GIF) permet d'afficher constamment le volet "Règles métier" s'il y a au moins une règle métier associée à l'élément en cours.
<a name="NOTE4_2"></a>
...
[Le volet "Règles métier"](../Editeurs/2027024.md)
