...
1. Selon la configuration de projet en cours : 
	...
	- Si la configuration de projet en cours ne correspond pas à l'archive Java, utilisez les boutons d'accès rapide : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_generation_java.gif)
