...
Le schéma ci-dessous présente un récapitulatif des liaisons entre les champs et les données :  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=3tiers_databinding.gif)
