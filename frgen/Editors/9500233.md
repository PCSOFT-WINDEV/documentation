...
- Bulles d'aide standard : 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Bulles_aide_personnalisees%20-%20HC%20N%B0001.gif)


- Bulles d'aide du thème : 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Bulles_aide_personnalisees%20-%20HC%20N%B0003.gif)


- Bulles d'aide avec un style personnalisé : 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Bulles_aide_personnalisees%20-%20HC%20N%B0005.gif)
...
<a name="personnaliser_les_bulles_aide_ELTPARAGRAPHE000061"></a>
...
2. Dans l'onglet "Style", spécifiez le type de bulle d'aide à utiliser pour le projet : 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Bulles_aide_personnalisees%20-%20HC%20N%B0002.gif&type=thumb)


	- Standard : les bulles d'aide sont standard, affichées sur fond jaune bulle. 

- Défini par le thème : les bulles d'aide utilisées sont les bulles d'aide présentes dans le thème utilisé par le projet. 

- Personnalisé : l'éditeur de styles de la bulle d'aide s'affiche afin de définir les options de personnalisation : 
			<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Bulles_aide_personnalisees%20-%20HC%20N%B0004.gif)
...
<a name="cas_particulier_utiliser_une_fenetre_application_pour_personnaliser_les_bulles_aide_ELTPARAGRAPHE000119"></a>
...
[Les différents types d'aide dans une application WINDEV](../Editeurs/2010012.md)

[Bulle (Propriété)](../Editeurs/2510005.md)

[BulleActive (Fonction)](../Editeurs/3025014.md)

[BulleAutomatique (Propriété)](../Editeurs/1000018996.md)

[BulleDélai (Fonction)](../Editeurs/3025051.md)

[BulleLargeurMax (Fonction)](../Editeurs/1000022257.md)
