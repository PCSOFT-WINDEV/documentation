...
4. Parmi les boutons d'accès rapide, cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cr%E9er_un_Assemblage%20-%20HC%20N%B0001%201.gif) pour générer l'assemblage ".NET". L'assistant de création d'un assemblage .NET se lance.

5. Indiquez les propriétés de l'assemblage .NET que vous allez créer: nom du ficher, société, description, copyright, etc. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cr%E9er_un_Assemblage%20-%20HC%20N%B0002.gif)
...
7. Sélectionnez les différents éléments WINDEV (projet, fenêtres, classes, ...) à intégrer dans l'assemblage .NET.
	...
	- Le bouton "WDU" permet d'afficher les éléments présents dans une bibliothèque précédemment créée.
		...
		- le schéma des données du projet sera associé à l'assemblage .NET.
...
9. Sélectionnez: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cr%E9er_un_Assemblage%20-%20HC%20N%B0003.gif)
...
<a name="conseils_pour_optimiser_code_des_classes_ELTPARAGRAPHE000120"></a>
...
<a name="types_des_parametres_des_valeurs_retour_ELTPARAGRAPHE000132"></a>
...
<a name="parametres_entree_sortie_ELTPARAGRAPHE000141"></a>
...
<a name="consequence_code_utilisation_assemblage_plus_simple_ELTPARAGRAPHE000148"></a>
...
1. Parmi les boutons d'accès rapide, sélectionnez le mode de génération "Créer la procédure d'installation de l'assemblage".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cr%E9er_un_Assemblage%20-%20HC%20N%B0001.gif)
