...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000367"></a>


### Créer un projet PHP
<a name="creer_projet_php_ELTPARAGRAPHE000096"></a>

Pour créer un  projet WEBDEV PHP :

1. Créez un projet WEBDEV (pour plus de détails, consultez [Créer un projet WEBDEV](../Editeurs/2030042.md)). Par défaut, un nouveau projet WEBDEV est un projet de type Session. 
...
2. Définissez le type de génération PHP pour le nouveau projet :  
	...
	- Modifiez le type du site pour le passer en PHP : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ProjetPHP.gif&type=thumb)
...
### Le RAD PHP
<a name="rad_php_ELTPARAGRAPHE000163"></a>Comme sur tout projet WEBDEV associé à une analyse, vous pouvez utiliser le RAD pour générer les pages de votre site PHP.
...
<a name="saisir_code_php_ELTPARAGRAPHE000177"></a>Les codes exécutés sur le poste serveur sont représentés sous l’éditeur de code par un bandeau Jaune ou Rose.
...
<a name="test_projet_php_ELTPARAGRAPHE000189"></a>Lors du GO d'un projet PHP, le répertoire courant est le répertoire "&lt;NomProjet&gt;_WEB" et non pas le répertoire "EXE" créé automatiquement lors de la création d'un projet PHP.
<a name="NOTE2_4"></a>


### Déploiement d'un site PHP
<a name="deploiement_site_php_ELTPARAGRAPHE000196"></a>Le déploiement d'un site PHP se fait par l'intermédiaire de l'outil [WDDeploy](../WDDeploie/3533001.md).
...
<a name="pages_php_avec_sans_contexte_ELTTEXTE000415"></a>
...
## Limitations
<a name="limitations_ELTTEXTE000445"></a>
