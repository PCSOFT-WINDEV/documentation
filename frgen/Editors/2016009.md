...
<a name="les_differentes_etapes_ELTTEXTE000723"></a>
...
- L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) indique un conseil. Les instructions données dans ces conseils ne sont pas obligatoires mais permettent une meilleure organisation pour la création d'un gabarit de fenêtre.
...
<a name="etape_1_creation_projet_gabarit_ELTTEXTE000747"></a>
...
1. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_nouveau.gif) parmi les boutons d'accès rapide. La fenêtre de création d'un nouvel élément s'affiche. 
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour identifier facilement vos projets gabarit, nous vous conseillons d'utiliser la notation suivante : "Gabarit_&lt;NomDuGabarit&gt;". Par exemple, si le nom du gabarit est Caraïbe, le projet s'appellera "Gabarit_Caraïbe".
...
<a name="etape_2_creation_une_fenetre_contenant_les_styles_des_champs_ELTTEXTE000786"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000097"></a>La création d'un gabarit consiste aussi bien à définir les caractéristiques des fenêtres (image de fond, type de cadre, etc.) que les caractéristiques des champs (police utilisée, dimensions, etc.).
...
**Remarques** :
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Seuls les styles des types de champs utilisés dans vos applications doivent être définis. Par exemple, si vos applications n'utilisent pas de champ Spin, il n'est pas nécessaire de définir un style pour ce type de champ. La définition du style par défaut se fera directement dans le fichier gabarit (extension ".STY").
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Plusieurs styles peuvent être définis pour le même type de champ.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Travail en GDS : pensez à extraire votre feuille de styles (fichier ".STY") avant de créer la fenêtre contenant les styles des champs.
<a name="NOTE3_2"></a>


### Créer une fenêtre contenant les styles des champs
<a name="creer_une_fenetre_contenant_les_styles_des_champs_ELTPARAGRAPHE000117"></a>Pour créer une fenêtre contenant les styles des champs : 
...
4. Indiquez le nom du champ dans l'onglet "Général" de la fenêtre de description (option "Description" du menu contextuel).
	![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour identifier plus facilement le style du champ en cours, nous vous conseillons d'utiliser la notation suivante : "&lt;NomDuGabarit&gt;_&lt;TypeDuChamp&gt;". Par exemple, "Caraïbe_ChampSaisieStandard".
...
7. Enregistrez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif)).




![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour identifier plus rapidement cette fenêtre, nous vous conseillons d'utiliser la notation suivante : &lt;NomDuGabarit&gt;_Champ". Par exemple, "Caraïbe_Champ".
...
- ***les boutons standard*** utilisés pour les boutons de type "Ouvrir", "OK" ou "Imprimer" par exemple : créez un bouton de dimensions 80 x 24.
	![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour identifier le bouton standard, nous vous conseillons d'utiliser la notation suivante : "&lt;NomDuGabarit&gt;_BtnStandard". Par exemple, "Caraïbe_BtnStandard".
...
- ***les boutons de parcours*** utilisés pour parcourir les différents enregistrements affichés dans la fenêtre : créez quatre boutons de dimensions 20 x 24.
	![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour identifier les boutons de parcours, nous vous conseillons d'utiliser la notation suivante : "&lt;NomDuGabarit&gt;_Btn&lt;FonctionBouton&gt;". Par exemple, "Caraïbe_BtnPremier", "Caraïbe_BtnPrécédent", "Caraïbe_BtnSuivant" et "Caraïbe_BtnDernier".
...
<a name="etape_3_creation_une_fenetre_gabarit_reference_ELTTEXTE000816"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000159"></a>Toutes les fenêtres d'un même gabarit vont utiliser des caractéristiques communes (image de fond, dimension, type de cadre, etc.). Pour éviter de définir ces caractéristiques dans chaque nouvelle fenêtre gabarit, nous vous conseillons de créer une fenêtre gabarit de base.
...
<a name="creer_une_fenetre_reference_dans_votre_projet_gabarit_ELTPARAGRAPHE000168"></a>Pour créer une fenêtre de référence dans votre projet gabarit : 
...
2. Dans la description de la fenêtre (option "Description" du menu contextuel), spécifiez :
	...
	- ***le titre de la fenêtre*** dans l'onglet "Général".
			![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour connaître directement le gabarit utilisé, nous vous conseillons d'utiliser la notation suivante : "&lt;NomDuGabarit&gt;". Par exemple, "Caraïbe".
	...
	- ***les caractéristiques de la fenêtre*** dans l'onglet "UI". 
			...
			![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour la taille de la fenêtre, il est conseillé de spécifier les valeurs suivantes :
...
- ***l'image de fond*** (si nécessaire) ***et ses caractéristiques*** (position, symétrie, etc.) dans l'onglet "Image".
			![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Si la fenêtre est redimensionnable, l'utilisation du [mode 9 images](../WDChamp/1010012.md) est conseillée. Le [mode 9 images](../WDChamp/1010012.md) permet d'optimiser toutes les possibilités d'agrandissement de l'image de fond.
			![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Nous vous conseillons d'utiliser la notation suivante pour cette image : "&lt;NomDuGabarit&gt;_Fond.&lt;Extension&gt;". Par exemple, "Caraïbe_Fond.BMP".

- ***le style souhaité*** (couleur de fond, type de cadre, etc.) dans l'onglet "Style".

3. Enregistrez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif)).




![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour identifier plus facilement cette fenêtre, nous vous conseillons d'utiliser la notation suivante : "&lt;NomDuGabarit&gt;_Référence". Par exemple, "Caraïbe_Référence".
<a name="NOTE4_3"></a>


### Ajout d'éléments à la fenêtre référence
<a name="ajout_elements_fenetre_reference_ELTPARAGRAPHE000218"></a>**Des champs peuvent être ajoutés à la fenêtre référence** (principalement des champs libellé et des champs image). Par exemple, le nom et le logo d'une entreprise peuvent être affichés dans les fenêtres. 
Ces champs sont alors appelés "Images de décor". Ces champs font partie de l'interface des fenêtres.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Quelques conseils pour une utilisation simplifiée des "Images de décor" :
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) **Utilisation de fichiers image** : Si des images sont utilisées dans votre fenêtre de référence (images utilisées dans les "images de décor" par exemple), nous vous conseillons de :
...
<a name="etape_4_creation_une_fenetre_type_gabarit_ELTTEXTE000852"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000243"></a>Pour utiliser le gabarit sur les fenêtres de votre application, il est nécessaire de créer une fenêtre de type gabarit. Par défaut, une seule fenêtre est nécessaire : la fenêtre de type "Vierge".
...
<a name="creer_une_fenetre_gabarit_pour_les_fenetres_vierge_ELTPARAGRAPHE000252"></a>Pour créer une fenêtre gabarit pour les fenêtres "Vierge" : 
...
2. Enregistrez la fenêtre sous un nom différent : sous le volet "Accueil", dans le groupe "Général", déroulez "Enregistrer" et sélectionnez "Enregistrer sous". Cette nouvelle fenêtre comporte automatiquement toutes les caractéristiques de la fenêtre modèle.
	![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour identifier plus facilement cette fenêtre gabarit, nous vous conseillons d'utiliser la notation suivante : "FenêtreVierge".
...
6. Enregistrez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif)).
...
<a name="creer_une_fenetre_gabarit_pour_les_fenetres_rad_rad_conserve_par_compatibilite_ELTPARAGRAPHE000315"></a>Pour créer une fenêtre gabarit pour les fenêtres RAD (RAD conservé par compatibilité) : 
...
3. Enregistrez la fenêtre sous un nom différent : sous le volet "Accueil", dans le groupe "Général", déroulez "Enregistrer" et sélectionnez "Enregistrer sous". Cette nouvelle fenêtre comporte automatiquement toutes les caractéristiques de la fenêtre modèle.
	![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=i_blue_sm.jpg) Pour identifier plus facilement les différentes fenêtres gabarit, nous vous conseillons d'utiliser un nom de fenêtre correspondant à la fenêtre RAD associée. Par exemple : "Fch_tbl_relie" pour une fenêtre fiche avec table reliée.
...
10. Enregistrez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif)).
...
<a name="ajout_boutons_supplementaires_rad_conserve_par_compatibilite_ELTPARAGRAPHE000416"></a>Lors de la création d'une fenêtre RAD, WINDEV crée automatiquement tous les boutons nécessaires à l'utilisation de la fenêtre. Ces boutons adoptent le style par défaut des boutons (défini dans la fenêtre de description des champs).
...
<a name="etape_5_creation_finale_gabarit_ELTTEXTE000900"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000485"></a>Pour utiliser un gabarit personnalisé dans vos applications, il est nécessaire de créer le gabarit final. Pour cela, il suffit d'exporter vers un gabarit :
...
### Créer un gabarit
<a name="creer_gabarit_ELTPARAGRAPHE000503"></a>Pour créer un gabarit :
...
<a name="creer_apercu_gabarit_ELTPARAGRAPHE000603"></a>Pour créer un aperçu de gabarit : 
...
[Créer un gabarit à partir d'un gabarit existant](../Editeurs/2016023.md)
