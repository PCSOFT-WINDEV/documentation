...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) [WDTestSite](../WDTestSite/3538003.md) qui permet de réaliser différents tests sur un site WEBDEV.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Avec WINDEV et WINDEV Mobile, il est possible de réaliser des tests automatiques sur :
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Un exécutable](../Editeurs/2019029.md).
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Il est également possible d'importer des scénario de test créés par les utilisateurs. Pour plus de détails, consultez [Tests automatiques créés par l'utilisateur](../Editeurs/2019031.md).
<a name="NOTE2_2"></a>
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Avec WEBDEV, il est possible de réaliser des tests automatiques sur :
