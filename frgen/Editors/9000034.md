...
1. Créez les différents éléments de votre composant (fenêtres, pages, etc.).
	Rappel : L'utilisation de l'instruction [COMPILE SI](../Motscles/1510021.md) ou de l'instruction [SI CibleExécution](../Motscles/1510028.md) permet de rendre les traitements utilisables quels que soient l'environnement, la plateforme ou le type de génération. Il est également possible d'utiliser les fonctions [EnModeComposant](../WDLang1/3013023.md), [EnModeJava](../WDLang1/3013058.md), [EnModePHP](../WDLang1/3013057.md), [EnModeWeb](../WDLang1/3013042.md), etc.
...
3. Dans l'assistant de création d'une configuration :
	...
	- Dans l'étape "Compatibilité de la configuration", indiquez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_factory%20-%20HC%20N%B0001.gif&type=thumb)
...
[Compatibilité Composant externe et application déployée](../Editeurs/2014010.md)
