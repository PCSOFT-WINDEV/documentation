...
<a name="lancer_analyseur_temps_reel_atr_ELTTEXTE000196"></a>
...
- **en s'attachant à un exécutable ou un site en cours d'exécution**: 
	...
	3. Attachez-vous à l'exécutable: sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez l'option voulue: 
		...
		- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Sur un exécutable déjà lancé sur le poste en cours ou sur un poste distant. 

		- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Sur un site ou une connexion existante. 
...
<a name="lire_resultat_analyseur_temps_reel_ELTTEXTE000220"></a>
Le volet "Analyseur Temps Réel" est composé de plusieurs parties: 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Analyseur_temps_r%E9el%20-%20HC%20N%B0001.gif)


1. Période visualisée. 

2. Bouton permettant d'arrêter ou de poursuivre le schéma des données en temps réel.
...
- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Analyseur_temps_r%E9el%20-%20HC%20N%B0001%203.gif) Loupe: Permet de visualiser les valeurs passées en paramètre à la fonction lors de son exécution. 

- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Analyseur_temps_r%E9el%20-%20HC%20N%B0001%202.gif) Code: Permet de visualiser dans l'éditeur de code le traitement qui a été exécuté (par exemple, permet d'afficher le code de la procédure locale contenant la fonction exécutée). 

- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Analyseur_temps_r%E9el%20-%20HC%20N%B0001%201.gif) Position: Permet de se positionner sur la ligne de code d'appel de la fonction sélectionnée. 
...
[dbgActiveLog (Fonction)](../Editeurs/1000017137.md)

[Volet "Analyseur Temps Réel"](../Editeurs/2027040.md)
