...
## Présentation
<a name="presentation_ELTTEXTE000318"></a>
...
<a name="afficher_gestionnaire_tests_ELTTEXTE000342"></a>
Le volet "Explorateur de projet" affiche l'ensemble des tests automatiques existants sur les différents éléments du projet (dossier "Tests").  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestionnaire%20de%20tests%201%20-%20HC%20N%B0001.gif)
...
<a name="fonctionnalites_gestionnaire_tests_ELTTEXTE000366"></a>


### Fenêtre de gestion des listes de tests d'un élément
<a name="fenetre_gestion_des_listes_tests_element_ELTPARAGRAPHE000054"></a>La fenêtre de gestion des tests automatiques d'un élément est la suivante :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestionnaire%20de%20tests%201%20-%20HC%20N%B0001%201.gif)
...
- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestionnaire%20de%20tests%203%20-%20HC%20N%B0001.gif) : test passé sans erreur. 

- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestionnaire%20de%20tests%203%20-%20HC%20N%B0002.gif) : test modifié. 

- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestionnaire%20de%20tests%203%20-%20HC%20N%B0003.gif) : test en erreur. 
...
### Options du ruban
<a name="options_ruban_ELTPARAGRAPHE000094"></a>Certaines fonctionnalités de l'éditeur de tests sont regroupées dans l'onglet "Tests automatiques" du ruban. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestionnaire%20de%20tests%201%20-%20HC%20N%B0001%202.gif)
...
<a name="description_une_liste_tests_scenario_ELTTEXTE000396"></a>


### Description d'une liste de tests
<a name="description_une_liste_tests_ELTPARAGRAPHE000145"></a>Pour afficher la description d'une liste de tests : 
...
- "Général" : Permet d'indiquer : 
	...
	- le type des tests présents dans la liste de tests : 
		...
		- Tests d'application : test automatique de l'application, enregistré avec WDAutomate. Pour plus de détails, consultez [Tests automatiques sur un exécutable](../Editeurs/2019029.md). 
...
<a name="description_scenario_ELTPARAGRAPHE000171"></a>Pour afficher la description d'un scénario de test : 
...
- "Détails" : Permet d'indiquer (dans le cas d'une fenêtre) : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestionnaire%20de%20tests%202%20-%20HC%20N%B0002.gif&type=thumb)
...
## Code d'un scénario
<a name="code_scenario_ELTTEXTE000426"></a>
...
<a name="evenement_avant_test_ELTPARAGRAPHE000216"></a>L'événement "Avant le test" permet par exemple de : 
...
<a name="evenement_scenario_test_ELTPARAGRAPHE000233"></a>L'événement "Scénario du test" correspond au code exécuté par le test. 
...
<a name="evenement_apres_test_ELTPARAGRAPHE000266"></a>L'événement "Après le test" permet par exemple de vérifier les résultats du test (par exemple par rapport à des données présentes dans un fichier Etalon). De manière générale, cet événement permet de fermer et de libérer tous les éléments ouverts et alloués dans l'événement "Avant le test".
...
[Volet "Résultats des tests"](../Editeurs/2027037.md)

[Tests automatiques sur un exécutable](../Editeurs/2019029.md)
