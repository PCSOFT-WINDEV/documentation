...
L'éditeur de requêtes permet de créer une requête en saisissant du code SQL (si vous maîtrisez ce langage).[Le logiciel Etats & Requêtes](../Presentation/3088004.md) ne permet pas de créer des requêtes en code SQL utilisant les ordres [INSERT](../Editeurs/2034001.md), [UPDATE](../Editeurs/2034001.md) ou [DELETE](../Editeurs/2034001.md).
...
<a name="creer_une_requete_code_sql_ELTPARAGRAPHE000038"></a>
...
8. Sauvegardez le code SQL (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif)).
...
<a name="retroanalyse_requete_code_sql_ELTPARAGRAPHE000078"></a>

La rétro-analyse de la requête en code SQL permet de représenter graphiquement la requête à partir des tables présentes dans le code SQL et dans le schéma des données du projet.
...
<a name="modes_execution_une_requete_code_sql_ELTTEXTE000244"></a>
...
[Comment créer et exécuter une requête SQL par programmation ?](../Editeurs/20009.md)
