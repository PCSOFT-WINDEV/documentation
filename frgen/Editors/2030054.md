...
<a name="url_rewriting_comment_faire_ELTTEXTE000263"></a>


### Mise en place de l'URL Rewriting sur un site AWP
<a name="mise_place_url_rewriting_sur_site_awp_ELTPARAGRAPHE000036"></a>Pour configurer l'URL Rewriting d'un site, sous le volet "Page", dans le groupe "Référencement", cliquez sur "URL Rewriting".

Une fenêtre de configuration offre une vue globale de toutes les règles de rewriting du projet. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=URLRewriting_fenppale.gif)
...
- WEBDEV génère une URL de rewriting par défaut. Pour paramétrer les règles d'une page en particulier, cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Btn_Parcourir.gif) (2) à droite de la table.
...
<a name="parametrage_des_regles_reecriture_une_page_ELTPARAGRAPHE000069"></a>Pour chaque page dont l'URL doit être réécrite, la fenêtre d'options propose les informations suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=URLRewriting_page.gif)
...
- La colonne "Type" (1) permet de choisir si l'élément de l'URL est une composante fixe ou un paramètre :
	...
	- Une composante fixe est une portion invariable de l'URL. Les composantes fixes peuvent être multilingues (il suffit de cliquer dans la colonne ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=URLRewriting_multilangue.gif) pour saisir les valeurs dans les autres langues du projet).
...
<a name="remarques_sur_les_regles_reecriture_ELTPARAGRAPHE000123"></a>
...
2. **Vérifier le paramétrage du serveur Web utilisé.** L'URL rewriting ne fonctionnera que si serveur Web appelle correctement le Serveur d'Application WEBDEV.
	**Note** : Ces points sont vérifiés par le diagnostic du serveur d'application WEBDEV en mettant le bon nom de serveur virtuel dans le champ de saisie "Nom/IP" à côté du bouton "Diagnostic" de l'onglet "Avancé".
	...
	- ".awp" doit être associé au moteur WEBDEV 2026 dans le site virtuel.
...
[Gestion automatique des URL courtes](../Editeurs/2030058.md)
