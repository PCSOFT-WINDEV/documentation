...
La liste de tous les tests automatiques existants peut être visualisée dans le dossier "Tests" du volet "Explorateur de projet". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestionnaire%20de%20tests%201%20-%20HC%20N%B0001.gif)
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Il est possible de passer les différents tests directement sur l'exécutable. Pour plus de détails, consultez [Tester un exécutable](../Editeurs/2019029.md).
