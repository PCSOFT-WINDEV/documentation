...
<a name="conseils_programmation_ELTTEXTE000181"></a>


### Emplacement des fichiers manipulés par l'application
<a name="emplacement_des_fichiers_manipules_par_application_ELTPARAGRAPHE000023"></a>
...
- **Si une application doit créer ou modifier des tables HFSQL**, ces tables doivent être localisées par exemple dans le répertoire correspondant à l'application (connu avec la fonction [SysRep](../WDLang1/3073026.md) et la constante *srAppDataCommun*).
...
<a name="utilisation_base_registre_ELTPARAGRAPHE000053"></a>
...
<a name="adapter_une_application_existante_pour_windows_vista_superieur_ELTTEXTE000211"></a>
...
Si votre application est une application Monoposte utilisant des tables, il est nécessaire de modifier l'emplacement des tables dans votre application pour respecter les normes de programmation Vista/7 (voir paragraphe ci-dessus).

Chez l'utilisateur final, plusieurs cas peuvent se présenter: 

- Si l'application a été lancée en tant qu'administrateur (utilisation d'un manifeste administrateur ou case à cocher utilisée dans les propriétés de l'exécutable), les tables de l'application sont présentes dans le répertoire spécifié dans votre application.

- Si l'application a été lancée en tant qu'utilisateur simple, Windows Vista/7 a automatiquement virtualisé les répertoires utilisés (si l'accès à ces répertoire était interdit pour cet utilisateur). Les tables de l'application sont présentes dans le répertoire: C:\\Users\\&lt;LOGIN&gt;AppData\\Local\\VirtualStore\\Windows\\
...
<a name="exemples_fonctions_affectees_par_gestion_des_droits_utilisateur_sous_vista_superieur_ELTTEXTE000235"></a>


### Familles de fonctions pouvant être affectées par le mécanisme de l'UAC
<a name="familles_fonctions_pouvant_etre_affectees_par_mecanisme_uac_ELTPARAGRAPHE000081"></a>
...
[Le mécanisme de l'UAC sous Windows Vista (et supérieur)](../Editeurs/2025014.md)

[FAQ à propos de Windows Vista et supérieur](../Editeurs/2025016.md)

[Windows : Ce qu'il faut prendre en compte si vos clients utilisent Vista (et supérieur)](../Editeurs/2025015.md)
