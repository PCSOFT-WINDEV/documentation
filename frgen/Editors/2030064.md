...
<a name="mode_gestion_des_erreurs_compilation_ELTPARAGRAPHE000038"></a>Pour les sites, composants, bibliothèques et Webservices, par défaut, les erreurs 64 bits sont toujours activées. 
<a name="NOTE3_3"></a>


### Erreurs de compilation spécifiques au 64 bits
<a name="erreurs_compilation_specifiques_64_bits_ELTPARAGRAPHE000045"></a>Si l'application "32 bits" utilisait des API Windows ou des dll externes, le passage en mode "64 bits" peut générer des erreurs de compilation. Ces erreurs de compilation sont bien entendu spécifiques au mode "64 bits". 
...
## Limites
<a name="limites_ELTTEXTE000232"></a>


### Limites diverses
<a name="limites_diverses_ELTPARAGRAPHE000096"></a>
...
<a name="base_registre_fichiers_systeme_ELTPARAGRAPHE000112"></a>
