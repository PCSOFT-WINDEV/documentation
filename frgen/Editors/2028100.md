...
1. Créez l'exécutable de l'application (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Generation_Exe.gif) parmi les icônes d'accès rapide). 

2. Lancez la création de la procédure d'installation : 

	- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Generation_Exe.gif) parmi les icônes d'accès rapide. 
...
1. Lancez le programme d'installation précédemment créé. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Installation_a_2_niveaux%20-%20HC%20N%B0001.gif&type=thumb)
...
## Remarques
<a name="remarques_ELTTEXTE000231"></a>
<a name="NOTE3_2"></a>


### Protocoles utilisés
<a name="protocoles_utilises_ELTPARAGRAPHE000110"></a>L'installation et les mises à jour de l'application de référence sur le serveur sont faites par le protocole FTP.
...
<a name="page_telechargement_ELTPARAGRAPHE000124"></a>Lors du déploiement de l'application, une page htm est automatiquement créée avec un lien vers le fichier d'installation de l'application cliente (lien vers le fichier Installe.exe).
...
[Installations avec prise en charge du Push](../Editeurs/2028098.md)
