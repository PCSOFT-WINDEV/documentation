...
Nouveauté majeure de l'iPhone, la Dynamic Island (îlot dynamique) transforme l'encoche noire en un widget. <br>![Dynamic Island ouverte, avec message d'action](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=iphone14-Dynamic-Island-pizza-min.png)
...
<a name="comment_gerer_dynamic_island_dans_vos_applications_ios_ELTTEXTE000164"></a>
<a name="NOTE1_2"></a>
...
3. Dans la zone "Description de la plateforme", ajoutez une plateforme "iPhone14" et supprimez si nécessaire la description "iPhone générique". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Dynamic_Island%20-%20HC%20N%B0001.gif)


4. Validez les 2 fenêtres. 

5. La coque affichée dans l'éditeur de fenêtres affiche désormais une encoche noire "Dynamic Island". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Dynamic_Island%20-%20HC%20N%B0002.gif)
...
### Programmation
<a name="programmation_ELTPARAGRAPHE000051"></a>Pour mettre en place la fonctionnalité Dynamic Island : 
...
<a name="generation_application_ios_ELTPARAGRAPHE000078"></a>Lors de la génération de l'application iOS, l'assistant de génération propose des options spécifiques pour la gestion du Dynamic Island.
...
Nécessite Xcode en version 14.1 minimum." permet d'indiquer que l'application doit inclure les fichiers nécessaires à la gestion du Dynamic Island. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Dynamic_Island%20-%20HC%20N%B0003.gif&type=thumb)
Les noms des structures et fichiers nécessaires sont à préciser dans l'étape suivante de l'assistant. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Dynamic_Island%20-%20HC%20N%B0004.gif&type=thumb)
...
[iOSApplicationOpenURLProcédure (Fonction)](../Editeurs/1410089346.md)
