...
Remarque : Pour bénéficier de la gestion des images de type SVG, la librairie QT installée doit supporter le format d'image SVG. Pour plus de détails, consultez le paragraphe [Diffuser une application Linux](#NOTE6_1). 
...
<a name="creer_projet_pour_linux_avec_windev_ELTTEXTE000342"></a>
...
- Ajouter une nouvelle configuration Linux dans votre projet (et si nécessaire supprimer la configuration Windows). Pour plus de détails, consultez [Créer une configuration de projet pour Linux](#NOTE3_1). 
...
<a name="creer_une_configuration_projet_pour_linux_ELTTEXTE000366"></a>
...
**Remarque** : Il est possible à tout moment possible d'inclure ou d'exclure des éléments du projet dans la configuration de projet grâce au volet "Explorateur de projet" (option "Inclure dans la configuration courante" ou option "Exclure de la configuration courante"). Pour plus de détails, consultez [Configuration de projet](../Editeurs/9000030.md). 
...
<a name="tester_projet_windev_linux_ELTTEXTE000390"></a>
...
<a name="creer_executable_linux_ELTTEXTE000414"></a>
Pour créer l'exécutable Linux : 

1. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_Generer_exelx.gif) parmi les boutons d'accès rapide (ce bouton est présent si la configuration en cours est une configuration Linux). 
...
Remarque : Pour ouvrir un explorateur de fichiers sur le répertoire de génération de l'application, sous le volet "Accueil", dans le groupe "Général", déroulez l'option ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rep_Projet.gif) et sélectionnez "Ouvrir le répertoire de génération". 
...
<a name="diffuser_executable_linux_ELTTEXTE000438"></a>
...
<a name="utilisation_executable_linux_ELTPARAGRAPHE000262"></a>Pour utiliser un  exécutable Linux, il est nécessaire d' **installer la librairie QT (Core et GUI)**, version 5 minimale. 
...
[Application WINDEV pour Linux : Particularités](../Editeurs/9000115.md)

[Comment faire un site pour Linux? ](../Editeurs/9000055.md)

[Application Linux : Conseils et astuces](../Editeurs/9000122.md)
