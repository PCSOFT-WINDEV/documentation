...
<a name="surlignage_des_elements_selectionnes_ELTTEXTE000474"></a>
Dans l'éditeur de code, à chaque fois que le curseur est placé sur un identifiant (variable, procédure, table, ...), toutes les utilisations de cet identifiant dans le code courant sont surlignées. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Surbrillance_Element.gif)


De même, si le curseur de la souris est positionné sur une instruction de bloc (SI, ALORS, SINON, POUR, FIN, BOUCLE, QUAND EXCEPTION DANS, ...), les différents éléments de ce bloc sont surlignés. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Surbrillance_bloc.gif)




Enfin, la ligne en cours est également rapidement identifiable grâce à des pointillés permettant de surligner la ligne courante. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_surlignage_ligne.gif)
...
<a name="selection_sous_editeur_code_ELTTEXTE000498"></a>


### Sélectionner des lignes de code
<a name="selectionner_des_lignes_code_ELTPARAGRAPHE000122"></a>
...
<a name="selection_rectangle_ELTPARAGRAPHE000138"></a>
...
La zone peut ensuite être copiée/coupée avec le menu contextuel. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Selection_rectangle.gif)
**Remarque** : Lorsque la zone est collée vers une zone rectangulaire, le texte copié s'insère également en rectangle. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Selection_rectangle_2.gif)



### Sélection par niveau de blocs
<a name="selection_par_niveau_blocs_ELTPARAGRAPHE000161"></a>
...
<a name="manipulation_une_plusieurs_lignes_code_ELTTEXTE000534"></a>
...
<a name="deplacement_lignes_code_ELTPARAGRAPHE000184"></a>
...
<a name="duplication_lignes_code_ELTPARAGRAPHE000189"></a>
...
<a name="supprimer_des_parties_lignes_code_ELTPARAGRAPHE000196"></a>
...
<a name="passer_ligne_suivante_ELTPARAGRAPHE000204"></a>
...
<a name="information_sur_les_lignes_code_selectionnees_ELTPARAGRAPHE000216"></a>
...
<a name="faire_defiler_les_lignes_code_ELTPARAGRAPHE000228"></a>
...
<a name="inversion_une_affectation_ELTPARAGRAPHE000248"></a>
...
<a name="manipuler_plusieurs_lignes_code_multicurseur_ELTTEXTE000609"></a>
...
Pour définir plusieurs curseurs, il suffit d'utiliser la combinaison de touches CTRL + Alt et de cliquer sur l'emplacement du curseur supplémentaire. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=multicurseur_avant.gif)
...
<a name="ajout_automatique_guillemets_crochets_parentheses_ELTTEXTE000633"></a>
...
<a name="passage_texte_majusculesminuscules_ELTTEXTE000657"></a>
...
<a name="suppression_des_lignes_vides_ELTTEXTE000681"></a>
...
<a name="fenetre_description_element_cours_depuis_editeur_code_ELTTEXTE000714"></a>
...
<a name="deplacement_procedures_methodes_ELTTEXTE000738"></a>
...
<a name="creation_une_procedure_clavier_ELTTEXTE000762"></a>
