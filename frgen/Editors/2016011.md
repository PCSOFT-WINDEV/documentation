...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Seuls les gabarits sur les états sont disponibles. Pour définir l'interface des pages d'un site, utilisez :

- un [modèle de pages](../WDChamp/1012015.md).

- une [ambiance](../Editeurs/2016020.md). 
...
- Il est également possible d'associer un gabarit à un projet (option "Thème du projet" dans l'onglet "Style" de la description du projet). Le gabarit sélectionné sera proposé par défaut lors de la création d'une fenêtre ou d'un état.
...
[Création d'un gabarit de fenêtres](../Editeurs/2016009.md)

[Création d'un gabarit d'état](../Editeurs/2016005.md)
