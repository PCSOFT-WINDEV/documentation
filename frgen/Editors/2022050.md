...
2. Utilisez le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_synchro_explorateur.gif) pour afficher dans le volet "Explorateur de projet" l'élément actuellement affiché sous l'éditeur. Le détail des variables disponibles à partir de la fenêtre ou de la page est affiché dans le volet "Explorateur de projet".
...
[FenêtreVersSource (Fonction)](../Editeurs/1000017342.md)

[SourceVersFenêtre (Fonction)](../Editeurs/1000017341.md)
