...
**Exemple**: Fenêtre de relation dans le pattern RAD Simple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Pattern_RAD_WDRelation.gif)

<a name="NOTE3_2"></a>


### Créer une fenêtre de relation
<a name="creer_une_fenetre_relation_ELTPARAGRAPHE000099"></a>
...
3. Dans l'onglet "Contenu" de la fenêtre de description du superchamp, spécifiez:
	...
	- la table parcourue: RADFichierB.
