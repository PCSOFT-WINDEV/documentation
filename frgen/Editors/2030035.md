...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) L'analyseur de performance ne fonctionne pas avec un site AWP.
...
<a name="lancer_analyseur_performances_ELTTEXTE000331"></a>


### Lancer l'analyseur de performances
<a name="lancer_analyseur_performances_ELTPARAGRAPHE000033"></a>
...
- **Directement depuis l'éditeur de WINDEV, WINDEV Mobile ou WEBDEV**: sous le volet "Projet", dans le groupe "Audit et performances", déroulez "Analyser les performances" et sélectionnez "Analyser les performances". Dans ce cas, le projet est alors automatiquement exécuté en mode test. Vous pouvez exécuter le traitement à optimiser dans votre application. 
	...
	Le schéma des données de performances affiche alors le résultat du schéma des données. Ce résultat est enregistré sous forme d'un fichier WPF.
	![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png) Le test est réalisé sous le simulateur. 
...
- **Lors du débogage** grâce au schéma des données de performances entre deux points d'arrêt. Il suffit de définir le point d'arrêt de démarrage et celui de terminaison de l'analyseur de performances. Seul le code présent entre ces deux points d'arrêt sera schéma des données. Le rapport sera automatiquement affiché sous l'éditeur à la fin du schéma des données. Pour plus de détails, consultez [Gestion des points d'arrêt](../Editeurs/2019005.md).  

- **Depuis n'importe quelle application**: l'appui sur la combinaison de touches **WIN + Maj + F10** a un effet équivalent à l'appel de la fonction [AnalyseurDébut](../WDLang1/3013012.md). 
	Dans ce cas, le schéma des données se termine à l'arrêt de l'application ou directement avec le raccourci WIN + Maj + F11. 
	A l'arrêt de l'enregistrement, l'emplacement du rapport de schéma des données est copié dans le presse-papiers.
...
- Si le Widget "Performances" est activé dans le [Tableau de bord du projet](../Editeurs/9500221.md), l'analyseur de performances est automatiquement lancé à chaque GO du projet. Le rapport de performances correspondant est enregistré dans le répertoire du projet. En cas de problèmes, un clic sur le lien "Cliquez ici pour voir le détail" permet d'afficher le rapport de performances. 
...
<a name="enregistrer_ouvrir_fichier_des_statistiques_ELTPARAGRAPHE000110"></a>
...
<a name="optimiser_traitement_aide_optimiseur_performances_ELTTEXTE000383"></a>


### Lire le résultat de l'analyseur de performances
<a name="lire_resultat_analyseur_performances_ELTPARAGRAPHE000158"></a>

Le schéma des données de performances présente le résultat du schéma des données dans deux onglets:
...
Pour chaque traitement, les informations suivantes sont affichées:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Analyseur%20performances%20-%20HC%20N%B0004%201.gif)



|   |   |   |
| --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle1.gif)<br> | Parent | Elément ou traitement qui a appelé la fonction. |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle2.gif)<br> | Fonction | Fonction, traitement, événement ou procédure exécutée. |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle3.gif)<br> | Temps Total | Temps d'exécution de la fonction. |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle4.gif)<br> | Nb appels | Nombre d'appels effectués à la fonction (procédure, événement ou traitement). |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle5.gif)<br> | Temps 1 appel | Temps d'exécution d'un appel à la fonction (procédure, événement ou traitement) |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle6.gif)<br> | % code | Pourcentage du temps passé dans le traitement de la fonction ou de la procédure (code du développeur pouvant être optimisé). |
...
<a name="choisir_traitement_optimiser_ELTPARAGRAPHE000214"></a>
...
<a name="optimiser_traitement_ELTPARAGRAPHE000226"></a>
...
3. L'onglet suivant apparaît:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Analyseur%20performances%20-%20HC%20N%B0004.gif&type=thumb)
...
- Pour visualiser rapidement le traitement en cours, il suffit de cliquer sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Detail_Description_FEN_btnCode%20-%20HC%20N%B0001%201.GIF). L'analyseur reste ouvert et vous pouvez modifier le code en cours.
...
[AnalyseurDébut (Fonction)](../Editeurs/3013012.md)

[AnalyseurFin (Fonction)](../Editeurs/3013002.md)
