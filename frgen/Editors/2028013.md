...
<a name="proposer_execution_programme_ELTTEXTE000377"></a>
...
<a name="specifier_executable_lancer_associer_des_parametres_cet_executable_ELTPARAGRAPHE000078"></a>

Pour spécifier l'exécutable à lancer et associer des paramètres à cet exécutable: 

1. Sélectionnez l'option "Paramètres de l'installation .. Fin de l'installation".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Options%20install_WDINST%20-%20HC%20N%B0005%204.gif&type=thumb)
...
2. Saisissez l'exécutable à exécuter à la fin de l'installation de l'application (option "Ligne de commande").
	...
	- Au nom et au chemin complet du fichier exécutable. Il est possible d'utiliser les mots-clés suivants:
		...
		- **- &lt;FicInst&gt;**: répertoire d'installation des fichiers de données. L'éditeur d'installation WDInst permet de paramétrer ce répertoire. 
						Pour plus de détails, consultez [Paramétrer le répertoire des tables](../Editeurs/2028017.md).
...
<a name="pas_proposer_lancement_execution_application_fin_installation_ELTPARAGRAPHE000106"></a>
...
<a name="desinstallation_application_ELTTEXTE000413"></a>
Il est possible d'inclure le désinstalleur avec lors de l'installation de l'application. Ainsi, l'application pourra être désinstallée par les options de Windows. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Options%20install_WDINST%20-%20HC%20N%B0005%202.gif&type=thumb)
...
## Modifier l'identifiant utilisé pour l'application
<a name="modifier_identifiant_utilise_pour_application_ELTTEXTE000437"></a>
...
<a name="modifier_identifiant_utilise_pour_application_dans_base_registre_ELTPARAGRAPHE000133"></a>

Pour modifier l'identifiant utilisé pour la désinstallation de l'application: 

1. Sélectionnez l'option "Paramètres de l'installation .. Fin de l'installation".

2. Saisissez le nouvel identifiant de l'application.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Options%20install_WDINST%20-%20HC%20N%B0005%203.gif&type=thumb)
...
## Modifier ou créer le fichier "AutoExec.BAT"
<a name="modifier_creer_fichier_autoexecbat_ELTTEXTE000467"></a>
...
### Modifier ou créer le fichier "AutoExec.BAT"
<a name="modifier_creer_fichier_autoexecbat_ELTPARAGRAPHE000164"></a>

Pour modifier ou créer le fichier "AutoExec.BAT": 

1. Sélectionnez l'option "Paramètres de l'installation .. Configuration du système".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Options%20install_WDINST%20-%20HC%20N%B0006%201.gif&type=thumb)
...
## Modifier ou créer des fichiers ".INI"
<a name="modifier_creer_des_fichiers_ini_ELTTEXTE000497"></a>
...
<a name="modifier_creer_des_fichiers_ini_lors_installation_ELTPARAGRAPHE000228"></a>

Pour modifier ou créer des fichiers ".INI" lors de l'installation: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Options%20install_WDINST%20-%20HC%20N%B0006%202.gif&type=thumb)
...
2. Spécifiez le fichier ".INI" considéré. Ce fichier sera créé si nécessaire. Vous pouvez indiquer:
	...
	- Le nom et le chemin complet du fichier.
		...
		- **&lt;RepWin&gt;**: répertoire de Windows des postes utilisateurs.
						"&lt;RepInst&gt;\\MonRépertoire\\MaTable.INI".




- Le nom du fichier. Le fichier sera recherché ou créé dans le répertoire de Windows. "MaTable.INI".
...
<a name="modifier_creer_des_entrees_dans_base_registre_ELTTEXTE000533"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000262"></a>
...
<a name="modifier_creer_des_entrees_dans_base_registre_lors_installation_ELTPARAGRAPHE000296"></a>

Pour modifier ou créer des entrées dans la base de registre lors de l'installation: 

1. Sélectionnez l'option "Paramètres de l'installation .. Configuration du système".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Options%20install_WDINST%20-%20HC%20N%B0006%203.gif&type=thumb)
...
[WDInst : paramétrer le répertoire des tables et des fichiers du groupware utilisateur](../Editeurs/2028017.md)
