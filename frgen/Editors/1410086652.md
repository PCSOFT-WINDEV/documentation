...
- Cette page d'aide présente la mise en place de la fonctionnalité "Store Privé". Pour la mise en place de la fonctionnalité Groupware utilisateur, consultez [Groupware utilisateur Mobile (Android et iOS)](../Editeurs/1410086648.md).
...
<a name="mettre_place_store_prive_pour_une_application_mobile_ELTTEXTE000449"></a>
...
<a name="etape_1_configuration_serveur_ELTPARAGRAPHE000070"></a>
...
<a name="etape_2_activez_store_prive_dans_votre_projet_mobile_ELTPARAGRAPHE000092"></a>
...
- La langue des tables: Par défaut, les tables utilisées par le Store Privé sont en français mais il est possible d'utiliser les tables en langue anglaise.
...
<a name="etape_3_generez_uploadez_application_sur_store_prive_android_ELTPARAGRAPHE000181"></a>
...
4. Le fichier apk correspondant à l'application est généré dans le sous répertoire "Exe" du répertoire du projet. 
	Pour afficher ce dossier dans l'explorateur de fichiers, sous le volet "Accueil", dans le groupe "Général", déroulez l'option ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Rep_Projet.gif) et sélectionnez "Explorer le répertoire de génération". 
...
Pour plus de détails sur le site d'administration du Store Privé, consultez [Site d'administration des services BaaS](../WDLang3/1410086668.md). 
...
<a name="etape_3_generez_uploadez_application_sur_store_prive_ios_ELTPARAGRAPHE000270"></a>

Avant de générer une application iOS, assurez-vous que vous possédez un certificat permettant de réaliser un déploiement "Entreprise" (voir [Déploiement In-House](../Editeurs/1000019926.md)). 
...
5. Affichez ce dossier dans l'explorateur de fichier: sous le volet "Accueil", dans le groupe "Général", déroulez l'option ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Rep_Projet.gif) et sélectionnez "Explorer le répertoire de génération". 
...
4. Quand le traitement est terminé, une fenêtre montre l'archive IPA, cliquez sur "Distribute App". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MDM_IOS_01.gif)
L'assistant se lance.

5. Dans l'assistant: 

	- Sélectionnez "Enterprise". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MDM_IOS_02.gif)


	- Cliquez sur "Next" deux fois.

- L'assistant demande les URL correspondant aux informations sur l'application. Ces URL doivent être de type "https" (il suffit de saisir "https" dans les champs). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MDM_IOS_04.gif)
...
2. Connectez-vous au site d'administration. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MDM_IOS_08.gif&type=thumb)
...
3. Le site WDBaaS propose d'uploader des versions de l'application via son archive (fichier ".ipa" et fichier ".manifest"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MDM_IOS_09.gif)
...
[Déploiement In-House](../Editeurs/1000019926.md)

[Installation des services BaaS](../Editeurs/1000021311.md)
