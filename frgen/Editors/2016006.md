...
- associé à un style (par exemple un style de la feuille de styles personnalisée ou un style de la feuille de styles du thème).
...
<a name="creer_style_partir_description_champ_conseille_ELTPARAGRAPHE000040"></a>
...
3. Créez un nouveau style à partir des modifications effectuées: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Style_d_un_champ%20-%20HC%20N%B0001.gif&type=thumb)
Deux méthodes sont possibles:

	- Cliquez sur le lien "Transformer en nouveau style". 

	- Déroulez le menu ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Style_d_un_champ%20-%20HC%20N%B0001%202.gif) et sélectionnez l'option "Transformer en nouveau style". 
...
<a name="creer_style_partir_fenetre_gestion_des_styles_ELTPARAGRAPHE000064"></a>
...
Par exemple, un libellé utilise le style "Entête". Par défaut, la police de ce style est noire. Pour une fenêtre spécifique, la couleur de la police doit être rouge. Pour ne pas créer un nouveau style et pour continuer à suivre les évolutions du style "Entête", il suffit de modifier la couleur de la police dans la description du style: le style du champ est automatiquement surchargé.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Style_d_un_champ%20-%20HC%20N%B0001%201.gif)
...
**Remarque**: En cliquant sur le nombre de surcharges, une fenêtre liste les surcharges réalisées. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Style_d_un_champ%20-%20HC%20N%B0002.gif)
Il est possible de:
...
- Un champ lié à la feuille de style d'un thème est surchargé. Il est conseillé de conserver les surcharges. En effet, si le style est ajouté à la feuille de style du projet, le champ perd la liaison avec le thème et il n'héritera plus des modifications réalisées dans le style du thème.
