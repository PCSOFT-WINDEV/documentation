...
- Utiliser directement l'option "Editer la bulle d'aide" du menu contextuel du champ.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_Bulle%20d_aide%20-%20HC%20N%B0001.gif)
Le texte de la bulle d'aide est affiché en modification. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_Bulle%20d_aide%20-%20HC%20N%B0002.gif)


- Utiliser la personnalisation de l'interface : 

	- Passer en mode modification (option "Personnaliser l'interface .. Passer en mode modification" du menu contextuel de la fenêtre). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_Bulle%20d_aide_2%20-%20HC%20N%B0001.gif)


	- Sélectionner le champ et sélectionner l'option "Editer la bulle d'aide" du menu contextuel du champ. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_Bulle%20d_aide_2%20-%20HC%20N%B0002.gif)
...
2. Le bouton "Options" permet de définir les différentes options autorisées. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMH_Modifiable_2%20-%20HC%20N%B0003.gif)
...
<a name="recuperation_des_modifications_ELTTEXTE000264"></a>
...
La fenêtre qui s'affiche liste les différentes fenêtres modifiées avec la modification réalisée. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMH_Modifiable_3%20-%20HC%20N%B0001.gif)
...
[UI modifiable par l'utilisateur final](../Editeurs/1000021853.md)

[FenEditionMode (Propriété)](../Editeurs/1000021824.md)
