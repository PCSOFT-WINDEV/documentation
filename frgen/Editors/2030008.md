...
<a name="traduction_interface_autoextraction_ELTPARAGRAPHE000145"></a>L'interface de l'auto-extracteur peut utiliser une langue différente de la langue par défaut (le français).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Zipcreeexe.gif)
