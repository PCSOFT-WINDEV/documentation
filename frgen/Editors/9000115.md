...
<a name="principe_generation_une_application_linux_avec_windev_ELTPARAGRAPHE000011"></a>WINDEV permet de générer une application Linux très simplement. Le développement de l'application se fait comme pour toutes les applications WINDEV en WLangage.
...
<a name="les_fonctionnalites_suivantes_sont_disponibles_sous_linux_ELTPARAGRAPHE000024"></a>De nombreuses fonctions sont disponibles pour les applications WINDEV sous Linux. Il n'est pas possible de donner une liste exhaustive, cette liste évoluant avec chaque version. 

Il est conseillé de consulter la documentation de chaque fonction. Le sigle ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=menu_btn_linux_1.gif) indique si la fonction est disponible en Linux et ses limitations.
...
<a name="utilisation_executable_linux_ELTPARAGRAPHE000058"></a>Pour utiliser un exécutable Linux, il est nécessaire d'installer la librairie QT (Core et GUI), version 5 minimale. 
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000082"></a>Les champs/fenêtres gérés actuellement sont les suivants : 
...
[Créer une application WINDEV pour Linux](../Editeurs/9000114.md)
