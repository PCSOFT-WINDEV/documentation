...
Exemple: Fenêtre Table sur le fichier RADFichierA du pattern Modèle Simple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Pattern_RAD_WDTable.gif)
...
12. Ajoutez si nécessaire les [boutons de liaison](../Editeurs/2031028.md).

13. Ajoutez si nécessaire les [boutons Vision Plus](../Editeurs/2031029.md).
...
<a name="cas_des_boutons_impression_ELTPARAGRAPHE000157"></a>
