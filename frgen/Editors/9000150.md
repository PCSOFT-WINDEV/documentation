...
<a name="volet_rechercher_remplacer_ELTPARAGRAPHE000018"></a>
...
La recherche peut porter sur:  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Recherche_Texte.gif)
...
<a name="recherche_texte_les_differentes_options_recherche_ELTPARAGRAPHE000082"></a>

Le volet "Rechercher - Remplacer" propose de nombreuses options pour rechercher un texte: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rechercher_VoletNum.gif&type=thumb)
...
- **Dans** (2): 
	Le texte recherché peut correspondre aussi bien à du code, au nom d'un élément ou à un mot dans le libellé d'un champ. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rechercher_dans.gif)
...
- **Pour** (3): 
	Cette option permet d'indiquer la cible de la recherche, c'est-à-dire les éléments pris en compte dans la recherche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rechercher_pour.gif)
La cible peut être: 
...
- **De** (4): 
	...
	- dans un composant interne particulier.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rechercher_de.gif)
...
- Mot se termine par: l'expression recherchée se termine par l'expression saisie.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rechercher_avec.gif)
...
- sur l'UI: il est possible de prendre en compte ou d'ignorer:  
	...
	- Les liaisons: cette option correspond aux liaisons du schéma des données (contraintes d'intégrité)

	- Les propriétés multilingues: cette option correspond aux caractéristiques multilingues (dans le cas de projet multilingue)

	- Les tables et les rubriques: cette option correspond aux tables décrites dans le schéma des données, à la description de chaque table et à la description des rubriques. 
...
<a name="texte_recherche_utilisation_des_speciaux_des_caracteres_joker_star_wildcard_ELTPARAGRAPHE000177"></a>
...
- Le caractère \* permet de remplacer un ou plusieurs caractères. Ce caractère joker peut être utilisé à tout emplacement dans le mot recherché.
	...
	- Client.\* = permet de rechercher toutes les affectations de rubriques de la table Client. 
...
<a name="remplacer_texte_recherche_ELTPARAGRAPHE000205"></a>
...
<a name="recherche_dans_des_elements_ELTPARAGRAPHE000221"></a>
...
- toutes les classes qui utilisent la table HFSQL "Client", 
...
3. Sélectionnez le type d'élément concerné par la recherche: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Recherche_dans_les_editeurs_2%20-%20HC%20N%B0002.gif)


4. Construisez le critère de recherche. Indiquez par exemple le type d'élément à prendre en compte, le critère à prendre en compte et sa valeur. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Recherche_dans_les_editeurs_2%20-%20HC%20N%B0003.gif&type=thumb)
...
6. Lancez la recherche avec le bouton "Rechercher". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Recherche_dans_les_editeurs_2%20-%20HC%20N%B0004.gif&type=thumb)
...
Pour regrouper les occurrences d'une même ligne, cliquez sur les boutons ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Recherche_Occurrence1.gif) et ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Recherche_Occurrence2.gif). Si le terme recherché apparaît plus d'une fois dans une ligne de code donnée, il n'est pas forcément utile d'afficher plus d'une fois cette ligne dans le résultat. 
<a name="NOTE5_2"></a>


### Filtrage des résultats à l'affichage (recherche texte uniquement)
<a name="filtrage_des_resultats_affichage_recherche_texte_uniquement_ELTPARAGRAPHE000281"></a>Une fois les résultats affichés, il est possible d'appliquer un filtre pour ne visualiser que certains types de réponses. Il est possible d'afficher uniquement des réponses provenant du code et/ou de l'UI et ceci avec des niveaux plus fins.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rechercher_filtre.gif)

<a name="NOTE5_3"></a>


### Conserver les résultats d'une recherche: afficher plusieurs volets de recherche
<a name="conserver_les_resultats_une_recherche_afficher_plusieurs_volets_recherche_ELTPARAGRAPHE000289"></a>
...
Pour conserver la recherche en cours, cliquez sur le verrou placé en haut à droite de la fenêtre de recherche: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Recherche_verrouillage.gif)
<a name="NOTE5_4"></a>


### Historique des recherches
<a name="historique_des_recherches_ELTPARAGRAPHE000303"></a>
...
Vous avez aussi la possibilité d'épingler une recherche afin de la conserver comme un favori pour la trouver plus rapidement plus tard.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Recherche_historique.gif)



## Voir aussi

[Le volet "Rechercher - Remplacer"](../Editeurs/2027013.md)

[Gestion des points d'arrêt](../Editeurs/2019005.md)
