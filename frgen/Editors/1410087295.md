...
- **Tester la visite guidée** directement depuis l'assistant (bouton "Tester"). Dans ce cas, le code de la visite guidée est automatiquement inséré dans le code d'initialisation de la fenêtre en cours, et le test de la fenêtre est lancé. Les différentes bulles de la visite guidée sont affichées. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Visite_guid%E9e%20-%20HC%20N%B0006.gif)


- **Valider l'assistant**. Dans ce cas, l'assistant propose d'intégrer (ou de remplacer) le code généré dans l'événement "Initialisation" de la fenêtre en cours, ou de copier ce code dans le presse-papiers. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Visite_guid%E9e%20-%20HC%20N%B0007.gif)
...
Ces options sont les suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Visite_guid%E9e%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="parametrage_etape_ELTPARAGRAPHE000150"></a>Pour chaque étape, il est nécessaire d'indiquer les éléments spécifiques à l'étape : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Visite_guid%E9e%20-%20HC%20N%B0004.gif)


- le **champ à mettre en évidence**. Pour simplifier la saisie du nom du champ : 

	1. Utilisez le bouton permettant de pointer le champ concerné dans la fenêtre de votre projet. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Visite_guid%E9e%20-%20HC%20N%B0003.gif)


	2. Cliquez sur le champ voulu. 

3. Validez le choix du champ. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Visite_guid%E9e%20-%20HC%20N%B0002.gif)
...
2. Indiquer les paramètres spécifiques à l'étape en cours. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Visite_guid%E9e%20-%20HC%20N%B0005.gif)
...
Le code généré pour la visite guidée utilise toutes les fonctions WLangage permettant la gestion des visites guidées : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Visite_guid%E9e%20-%20HC%20N%B0008.gif)
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Remarque : Il n'est pas possible d'accéder à un volet d'onglet, une ligne d'un champ Zone répétée, une ligne d'un champ Table, etc. Si des crochets sont utilisés dans le nom du champ ([ ]), une erreur de compilation est affichée. 
