...
Les projets créés à partir de la version 27 profitent automatiquement de cette nouvelle technologie. Pour les projets créés avec une version précédente, le changement de technologie est réalisé à l'aide d'un assistant spécifique. Pour plus de détails, consultez [Assistant de migration des messages multilingues](../Editeurs/9000206.md). 
...
<a name="traduire_les_messages_format_27_superieur_ELTTEXTE000380"></a>
...
2. Sélectionner l'option "Traduire" du menu contextuel. La fenêtre de traduction des messages s'affiche.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Traduction_messages_hc3.gif)


3. Saisissez la traduction du message et validez.
	L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_multilangue%20-%20HC%20N%B0003%201.gif) présente dans le libellé de la langue permet d'afficher un menu permettant de simplifier les traductions. Pour plus de détails, consultez [Saisie de textes multilingues](../WDLang1/1000020822.md).

4. Une icône apparaît à droite du message traduit. Cette icône indique que le message en cours est un message multilingue. L'icône permet d'accéder rapidement à la fenêtre de traduction.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=code-drapeau.gif)
Le survol de l'icône affiche dans une bulle les différentes traductions existantes pour la chaîne dans toutes les langues du projet.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_drapeau18.gif)
...
<a name="manipulation_des_messages_ELTTEXTE000437"></a>


### Convertir les chaînes de caractères présentes dans le code en messages multilingues
<a name="convertir_les_chaines_caracteres_presentes_dans_code_messages_multilingues_ELTPARAGRAPHE000086"></a>Pour convertir les chaînes de caractères présentes dans le code en messages multilingues :
...
Pour plus de détails, consultez [Gestionnaire de chaînes](../Editeurs/1410087308.md). 
<a name="NOTE2_3"></a>


### Parcourir les différents messages à traduire présents dans les différents éléments d'un projet
<a name="parcourir_les_differents_messages_traduire_presents_dans_les_differents_elements_projet_ELTPARAGRAPHE000144"></a>Pour parcourir les différents messages à traduire présents dans les différents éléments d'un projet :
...
<a name="faire_une_recherche_dans_les_differents_messages_traduits_ELTPARAGRAPHE000167"></a>Pour faire une recherche dans les différents messages traduits :
...
3. Spécifiez les options : 
	...
	- Dans les options avancées (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_VoletRech_avance.gif)), indiquez que la recherche doit être faite dans les chaînes multilingues du code. 
...
<a name="rechercher_supprimer_les_messages_inutilises_ELTPARAGRAPHE000195"></a>Pour rechercher et supprimer les messages inutilisés :
...
<a name="caracteristiques_message_traduire_ELTTEXTE000479"></a>


### Caractéristiques
<a name="caracteristiques_ELTPARAGRAPHE000219"></a>
...
<a name="traduire_les_messages_messages_format_26_anterieur_ELTTEXTE000509"></a>


### Traduire le message en cours de saisie (messages au format 26 et antérieur)
<a name="traduire_message_cours_saisie_messages_format_26_anterieur_ELTPARAGRAPHE000243"></a>Pour traduire le message en cours de saisie :

1. Sélectionnez le texte à traduire.

2. Sélectionner l'option "Traduire" du menu contextuel. La fenêtre de traduction des messages s'affiche.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code_Message_multi.gif)


3. Saisissez la traduction du message et validez.
	L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_multilangue%20-%20HC%20N%B0003%201.gif) présente dans le libellé de la langue permet d'afficher un menu permettant de simplifier les traductions. Pour plus de détails, consultez [Saisie de textes multilingues](../WDLang1/1000020822.md).
	**Remarque** : L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MessTRaduit_Loupe.gif) permet de rechercher un message. Le volet "Rechercher - Remplacer" s'affiche avec toutes les options nécessaires.
...
<a name="messages_multilingues_relies_ELTPARAGRAPHE000273"></a>Un message multilingue peut être copié/collé à plusieurs emplacements dans plusieurs traitements ou événements d'un même projet. 
...
Lorsque le lien est conservé, un pictogramme spécifique signale que le message multilingue est utilisé à plusieurs endroits dans le code.<br>![Le pictogramme indique que ce message est utilisé à plusieurs endroits dans le code. Une modification aura donc un impact dans toutes les utilisations](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MsgMultilanguesRelies.gif)


Dans ce cas, la fenêtre de gestion des messages multilingues (ouverte par la combinaison de touches Ctrl + T utilisée sur le message) permet de connaître les différentes utilisations du message (icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MessTraduit_refcroisees.gif)).


## Voir aussi

[Traduction du code ](../Editeurs/2013003.md)

[Développer des applications multilingues](../Editeurs/3054008.md)

[Saisie de l'interface dans les différentes langues](../Editeurs/3054009.md)

[Messages multilingues : Conversion au nouveau format (version 27 et supérieure)](../Editeurs/9000206.md)

[Gestionnaire des chaînes du projet](../Editeurs/1410087308.md)
