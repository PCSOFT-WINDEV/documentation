...
2. Une fois connecté, sélectionnez l'option "Certificates, identifers and profiles".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IOS_XCode8_1.gif)
...
1. Sélectionnez le mode de gestion de la signature. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant_generation_xcode8%20-%20HC%20N%B0001.gif&type=thumb)
