...
<a name="les_options_groupware_utilisateur_ELTTEXTE000405"></a>


### Mettre en place le groupware utilisateur dans votre application
<a name="mettre_place_groupware_utilisateur_dans_votre_application_ELTPARAGRAPHE000025"></a>
...
<a name="options_onglet_general_ELTTEXTE000429"></a>
...
- **Vous n'utilisez pas une plateforme PCSCloud**: installez les éléments suivants: 
 ...
 Pour plus de détails, consultez la page [Installation des services BaaS](../WDLang3/1000021311.md).
...
### Mode de lancement
<a name="mode_lancement_ELTPARAGRAPHE000097"></a>
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) L'option "Lancement manuel par un modèle de champs" permet d'intégrer la page de connexion du groupware utilisateur dans le site. Il est ainsi possible de conserver le groupware utilisateur automatique (et ses mises à jour) tout en pouvant personnaliser la page de connexion.
...
<a name="options_onglet_options_ELTTEXTE000465"></a>


### Personnalisation du groupware
<a name="personnalisation_groupware_ELTPARAGRAPHE000129"></a>
...
- **Pas de personnalisation**: 
	...
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Les fenêtres du groupware utilisateur peuvent utiliser automatiquement le thème de l'application. Il suffit de cocher l'option “Appliquer le gabarit du projet sur les fenêtres non personnalisées lors de l'exécution”.
	...
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Remarque: Cette option est compatible avec le groupware utilisateur intégré (option "Lancement manuel par un modèle de champs").
...
- **Personnaliser l'UI de connexion**: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Le composant interne **WDGPU** est intégré à votre projet. Ce composant contient la fenêtre de login et la procédure associée. Vous pouvez ainsi personnaliser la connexion au groupware utilisateur.

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Le composant interne **WDGPU_WB** est intégré à votre projet. Ce composant contient toutes les pages, modèles de pages, modèles de champs et procédures nécessaires à l'identification de l'utilisateur. Vous pouvez ainsi personnaliser totalement toutes les pages de connexion utilisées par le groupware utilisateur.
...
### Sécurité
<a name="securite_ELTPARAGRAPHE000174"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Autoriser l'édition des états et des requêtes de l'application dans "Etats et Requêtes"**: Si cette option est cochée, l'utilisation du logiciel "Etats et Requêtes" sera autorisée pour les états et les requêtes de l'application. 
...
<a name="login_automatique_mode_test_ELTPARAGRAPHE000188"></a>
...
### Langue des tables
<a name="langue_des_tables_ELTPARAGRAPHE000198"></a>

Par défaut, les tables spécifiques au groupware utilisateur sont en français mais il est possible d'utiliser les tables en langue anglaise. 
<a name="NOTE_3_7"></a>


### Mot de passe des tables
<a name="mot_passe_des_tables_ELTPARAGRAPHE000205"></a>
...
- Le changement du mot de passe est pris en compte uniquement s'il est réalisé avant la création des tables du Groupware utilisateur. 

- Ce mot de passe est utilisé par exemple lors de la ré-indexation des tables ou lors de l'ouverture des tables avec l'outil WDMAP.
...
## Onglet "Tables" (Groupware utilisateur classique)
<a name="onglet_tables_groupware_utilisateur_classique_ELTTEXTE000513"></a>


### Type de base de données (uniquement en mode "Lancement automatique)
<a name="type_base_donnees_uniquement_mode_lancement_automatique_ELTPARAGRAPHE000221"></a>

Le groupware utilisateur manipule des tables permettant d'identifier les utilisateurs et de définir leurs droits. 

Ces tables peuvent être:

- au format HFSQL Classic (par défaut). Il est nécessaire de spécifier le répertoire des tables. 
...
<a name="type_identification_ELTPARAGRAPHE000241"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Utilisation de l'authentification Windows. 
...
<a name="onglet_oauth_groupware_utilisateur_classique_ELTTEXTE000549"></a>
...
<a name="onglet_serveur_groupware_utilisateur_avec_serveur_authentification_ELTTEXTE000573"></a>
...
<a name="onglet_email_groupware_utilisateur_avec_serveur_authentification_ELTTEXTE000597"></a>
