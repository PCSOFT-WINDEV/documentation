...
<a name="activer_les_erreurs_compilation_ELTPARAGRAPHE000021"></a>
...
2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Erreur_IHM.gif).
...
<a name="corriger_une_erreur_ELTPARAGRAPHE000080"></a>
...
<a name="desactiver_une_erreur_compilation_ELTPARAGRAPHE000092"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Vérification de l'existence des fenêtres internes utilisées par les champs Fenêtre interne.

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Vérification de l'existence des pages internes utilisées par les champs Page interne.

- Vérification qu'une table ancrée contient bien une colonne ancrée.

- Vérification des liaisons avec les rubriques des tables ou avec les variables.

- Vérification de l'existence des libellés des champs dans toutes les langues.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Vérification qu'un raccourci n'existe pas plusieurs fois dans une même fenêtre.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Vérification des liens corrompus dans les ruptures de tables.
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Vérification des zones de superposition invalides.

- Vérification que le libellé d'un bouton ne dépasse pas du champ.

- Vérification des liaisons de type databinding identiques.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Vérification de l'utilisation de menus avec des looks différents ("système" et "non système") dans une même fenêtre

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Vérification des bulles d'aide dans une fenêtre. Erreur si plusieurs champs ont la même bulle d'aide.

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Erreurs spécifiques au Responsive Web Design: Erreur de superposition de blocs, Erreur d'ordre d'affichage, etc. Pour plus de détails, consultez [Responsive Web Design: Des erreurs d'UI spécifiques](../WDChamp/9000178.md).
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Vérification de l'utilisation des polices. Si les polices utilisées ne sont pas natives et si elles ne sont pas intégrées au projet, une erreur est affichée.
