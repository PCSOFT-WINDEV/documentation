...
<a name="creer_une_application_net_partir_projet_windev_ELTTEXTE000295"></a>


### Créer une application .NET
<a name="creer_une_application_net_ELTPARAGRAPHE000023"></a>

Pour créer une application .NET à partir d'un projet WINDEV:

1. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_generer_exenet.gif) parmi les boutons d'accès rapide. L'assistant de génération d'une application .NET se lance. 
	...
	- Créer une nouvelle configuration pour votre projet. Cette configuration est automatiquement proposée en déroulant l'icône de génération et en sélectionnant l'option "Autres générations .. Générer une application .NET". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Generation_Exenet.gif)
...
<a name="details_des_operations_ELTTEXTE000325"></a>




### Options générales de l'exécutable
<a name="options_generales_executable_ELTPARAGRAPHE000089"></a>
...
<a name="icone_programme_executable_ELTPARAGRAPHE000113"></a>
...
- les icônes doivent avoir été créées par un outil classant les icônes par taille croissante et par résolution de couleurs croissante. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=icoxp.gif)
...
<a name="proprietes_executable_ELTPARAGRAPHE000160"></a>
...
### Numéro de version
<a name="numero_version_ELTPARAGRAPHE000172"></a>
...
<a name="librairies_framework_windev_fichiers_dll_utilisees_par_programme_executable_ELTPARAGRAPHE000199"></a>
...
**Rappel**: Par défaut, le programme d'installation sélectionne automatiquement toutes les fichiers présents dans le sous-répertoire "EXE" d'un projet à l'exception des tables (".FIC", ".NDX", ".MMO"). Pour plus de détails, consultez [Programme d'installation](../Editeurs/2028001.md).
