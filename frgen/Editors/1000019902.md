...
Pour lancer la génération de l'application dans WINDEV Mobile, cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Generation_iOS_WM_bl.gif) parmi les boutons d'accès rapide.

Sur l'écran ci-dessous, insérez l'App Id fourni par Apple : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Applestore_dep1.gif&type=thumb)
...
Une fois connecté, cliquez sur l'option "Certificates, Identifiers & Profiles".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=23_IOS_Deploiement1.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=23_IOS_Deploiement2.gif)


- L'assistant de création d'un nouveau profile se lance. Sélectionnez : 

	- le type : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=23_IOS_Deploiement3.gif)


	- l'identifiant : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=23_IOS_Deploiement4.gif)

- Indiquez le nom du profile : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=23_IOS_Deploiement6.gif)


- Le profile est généré et peut être téléchargé. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=23_IOS_Deploiement7.gif)
...
- Cliquez sur "Mes apps". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=itunes_connect1.gif)


- Ajoutez votre application grâce au bouton "Nouvelle app". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=itunes_connect2.gif)


- Renseignez les différentes informations demandées : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=itunes_connect3.gif)
...
- Une fois l'application compilée, il est nécessaire de construire une archive par le menu "Product .. Archive". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=XCode_archive1.gif)

	Remarque : Si l'option "Archive" est grisée, désélectionnez le device cible précisé et sélectionnez "Aucun/Any". 

- L'organizer se lance automatiquement sur l'onglet "Archive".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=xcode_archive2.gif)
...
- Créez si nécessaire une version de l'application. Le numéro de version de l'application doit correspondre au numéro de version précisé lors de la création de la génération de l'application sous WINDEV Mobile (ou au moins le numéro de version WINDEV Mobile doit commencer par le même numéro). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=itunes_connect4.gif)
...
[Déploiement ad Hoc](../Editeurs/1000019884.md)
