...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000289"></a>
...
2. Dans l'onglet "Compilation", dans la section "Norme de programmation", cochez les options voulues : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Compilation_Norme%20-%20HC%20N%B0001.gif)
...
<a name="corriger_une_erreur_norme_programmation_ELTPARAGRAPHE000137"></a>Les erreurs de norme de programmation sont listées dans le volet des erreurs de compilation.
...
<a name="surcharger_une_erreur_norme_programmation_ELTPARAGRAPHE000149"></a>Par défaut, la norme de programmation définie au niveau des options du projet s'applique à tous les éléments du projet. Il est cependant possible de surcharger cette norme par élément (fenêtre, état, page, composant interne). 

**Pour surcharger la norme de programmation d'une fenêtre ou d'une page** :

1. Affichez la fenêtre de description de l'élément. 

2. Dans l'onglet "Détail", cliquez sur le bouton "Norme de programmation". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Compilation_Norme%20-%20HC%20N%B0003.gif&type=thumb)


3. Dans la fenêtre qui s'affiche, sélectionnez le mode de traitement de chacune des options : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Compilation_Norme%20-%20HC%20N%B0004.gif)
...
<a name="desactiver_une_erreur_norme_programmation_ELTPARAGRAPHE000203"></a>Pour désactiver une erreur de norme de programmation : 
