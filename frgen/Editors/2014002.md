...
## Présentation
<a name="presentation_ELTTEXTE000625"></a>
...
<a name="creation_composant_externe_ELTTEXTE000649"></a>
...
1. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_nouveau.gif) parmi les boutons d'accès rapide. Dans la fenêtre qui s'affiche, cliquez sur "Projet". L'assistant de création d'un projet s'affiche.
...
7. Indiquez le nom du projet et son emplacement. Ces options ne seront pas modifiables. Le projet correspond à un fichier ".WDP" pour WINDEV. Ce fichier pourra être ouvert avec les produits WEBDEV et WINDEV Mobile. Pour plus de détails, consultez [Projet Commun](../Editeurs/2030049.md).
...
<a name="developper_composant_externe_ELTTEXTE000673"></a>
...
1. **Eléments du composant externe**: 
	...
	2. Dans le menu contextuel de l'élément (clic droit), sélectionnez l'option "Configurations". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Configuration_de_projet2%20-%20HC%20N%B0001.gif&type=thumb)
...
4. **Déclaration des éléments et visibilité**
	...
	Remarque: Si un composant externe utilise un schéma des données et des tables, par défaut, les fonctions HFSQL manipuleront ces éléments dans un contexte HFSQL indépendant. Ce fonctionnement peut être modifié dans les options avancées du composant.
...
### Remarque
<a name="remarque_ELTPARAGRAPHE000152"></a>
...
<a name="options_composant_externe_ELTTEXTE000703"></a>
Différentes options peuvent influer sur le comportement du composant externe: 

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Activation de la génération de classes Tailwind CSS.

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Activation de la Content Security Policy (CSP).

- Droits d'accès du composant sur les éléments de l'application utilisant le composant.

- Mode de gestion des thèmes sur les éléments du composant.
...
<a name="definir_modifier_les_options_composant_ELTPARAGRAPHE000181"></a>
...
2. Dans l'onglet "Général": 
	...
	- Si le composant est disponible en WEBDEV, vous pouvez: 
		...
		- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Activer la génération de classes Tailwind CSS. 
						Pour plus de détails, consultez [WEBDEV et Tailwind CSS](../Editeurs/1410086657.md). 
						

		- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Activer la Content Security Policy (CSP).
...
- Accédez aux options avancées en cliquant sur "Options du composant". Vous pouvez alors définir: 
	...
	- [Les droits d'accès du composant sur les éléments de l'application utilisant le composant](#NOTE4_3).

	- [Le mode de gestion des thèmes sur les éléments du composant](#NOTE4_4).
...
<a name="droits_acces_composant_sur_projet_client_ELTPARAGRAPHE000225"></a>Trois possibilités:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Creer_un_composant_et_le_distribuer%20-%20HC%20N%B0002.gif)


- **Le composant n'accèdera pas aux tables, fenêtres, pages, états, etc. du projet client.**
	Le composant et son application hôte utilisent des contextes indépendants (option par défaut). Le composant ne pourra manipuler ni les tables, ni les éléments du projet hôte.
...
- **Le composant va accéder aux tables du projet client.**
	Le composant est autorisé à manipuler uniquement les tables de l'application hôte. Dans ce cas, les contextes HFSQL seront identiques.
	Si cette option est sélectionnée, l'événement "Initialisation" du projet du composant sera appelé lors du chargement du composant par le projet hôte.

- **Le composant va accéder aux tables, fenêtres, pages, états, etc. du projet client.**
	Le composant est autorisé à manipuler les tables de l'application hôte ainsi que ses éléments (fenêtres, états, ...). Dans ce cas, les contextes d'exécution seront identiques.
...
**Quand autoriser le composant à manipuler les tables de l'application hôte?**
Par exemple, si l'application livrée est constituée d'une application principale et d'options fournies sous forme de composants. Dans ce cas, les composants manipulent les tables de l'application principale.

**Remarque**: Si le composant est autorisé à manipuler les tables et possède son propre schéma des données, le schéma des données du composant sera ignoré. Le composant utilisera le schéma des données du projet hôte.

Dans notre exemple, lors du développement d'un composant, ce composant peut être associé au schéma des données de l'application principale. Ainsi, l'utilisation des déclarations externes pour manipuler les tables est inutile. De plus, la complétion sera automatique sous l'éditeur de code.

Pour plus de détails sur les contextes HFSQL, consultez [Contexte HFSQL](../WDChamp/1010029.md).
<a name="NOTE4_4"></a>


### Style: Mode de gestion des thèmes sur les éléments du composant.
<a name="style_mode_gestion_des_themes_sur_les_elements_composant_ELTPARAGRAPHE000280"></a>

Par défaut, il est possible d'appliquer le thème du projet hôte sur les différents éléments du composant externe. Pour plus de détails sur les thèmes, consultez [Thèmes](../Editeurs/2016011.md).
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Creer_un_composant_et_le_distribuer%20-%20HC%20N%B0003.gif)


Remarques: 

- L'onglet "Style" des options avancées du composant externe permet d'autoriser ou non l'application du thème par le projet client. 

- Pour ne pas appliquer le thème du projet client sur une fenêtre du composant externe:

	1. Affichez la fenêtre de description de la fenêtre du composant. 

	2. Dans l'onglet "Style", dans la zone "Thèmes", cochez l'option "Toujours conserver le style/thème d'origine".
...
<a name="generer_composant_externe_ELTTEXTE000763"></a>
...
- dans les boutons d'accès rapide, cliquez sur l'icône de génération du composant: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_generation_Composant.gif)
...
### Générer un composant externe
<a name="generer_composant_externe_ELTPARAGRAPHE000336"></a>
...
|   |   |
| --- | --- |
| &lt;Nom du composant&gt;.WDK | Ce fichier contient tous les éléments à redistribuer (fenêtres, états, etc.).<br><br>Ce fichier est nécessaire lors du déploiement des applications utilisant le composant externe. |
...
<a name="generer_composant_externe_pour_android_ELTPARAGRAPHE000460"></a>
...
7. La liste des fichiers intégrés au composant est affichée. Cette liste est construite à partir des fichiers présents dans le dossier "Autres" du volet "Explorateur de projet". Il est possible d'intégrer par exemple: 
	...
	- des tables HFSQL utilisées par l'application, etc. 
...
9. Indiquez si des librairies doivent être intégrés au composant Android. Il est possible d'intégrer: 
	...
	- la librairie HFSQL. 
			 Cette librairie est nécessaire si votre composant utilise des tables HFSQL.
...
<a name="generer_composant_externe_pour_ios_ELTPARAGRAPHE000550"></a>
...
2. Spécifiez les options des fichiers: 
	...
	- **Si les fichiers ont l'option "Ecriture" décochée**, ces fichiers pourront ensuite:
		...
		- soit être utilisés directement (fichiers à lire par exemple: fichiers son, image, etc.). Ces fichiers sont intégrés à l'application et ne seront pas extraits. La fonction [fRepRessource](../WDLang1/1000020166.md) permet d'accéder en lecture à ces fichiers.  
...
[GDS : Gestion des composants](../Editeurs/2038015.md)
...
[Visibilité des éléments d'un composant externe](../Editeurs/2014009.md)
