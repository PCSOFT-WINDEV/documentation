...
<a name="integration_fichiers_javascript_ELTPARAGRAPHE000022"></a>Il est possible d'inclure dans un site ou dans une page un ou plusieurs fichiers Javascript (\*.js). Ces fichiers seront utilisés par la ou les pages HTML générées. Ces fichiers doivent être présents dans le répertoire "&lt;NomProjet&gt;_WEB" du site.
...
3. Dans la zone "Ressources externes", il est possible d'ajouter des ressources Javascript : 
	...
	- Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeAjouterPropriete.gif) et sélectionnez le chemin du fichier Javascript.
...
4. Cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeAjouterPropriete.gif) et sélectionnez le chemin du fichier Javascript.
...
<a name="detection_automatique_encodage_ELTPARAGRAPHE000137"></a>Si l'encodage est &lt;Non défini&gt;, une détection automatique de l'encodage est effectuée :
