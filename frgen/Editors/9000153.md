...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) [Comment créer un agencement pour une fenêtre WINDEV Mobile](#NOTE2_1). 
...
2. Sous le volet "Fenêtre", dans le groupe "Agencements", déroulez "Agencements" et sélectionnez l'option "Ajouter des agencements". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Agencement%201%20-%20HC%20N%B0001.jpg)


3. L'assistant d'ajout d'un agencement se lance. Passez si nécessaire l'étape de présentation. 

4. L'assistant propose de gérer les différences entre le téléphone et la tablette. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Agencement%201%20-%20HC%20N%B0002.jpg)
Il est possible de : 
...
6. L'assistant propose de gérer l'orientation Portrait/Paysage de l'application. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Agencement%201%20-%20HC%20N%B0003.jpg)
Il est possible de : 
...
8. L'assistant propose d'utiliser une présentation différente pour chaque plateforme utilisée (par exemple, une présentation sous iOS et une présentation sous Android). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Agencement%201%20-%20HC%20N%B0004.jpg)
...
11. Si nécessaire les différents agencements sont créés. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Agencement%201%20-%20HC%20N%B0005.jpg&type=thumb)
...
4. **Si le projet WINDEV contient au moins une plateforme mobile**, l'assistant d'ajout d'un agencement se lance. Passez si nécessaire l'étape de présentation. 
	...
	1. L'assistant propose de gérer les différences entre le téléphone et la tablette. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Agencement%201%20-%20HC%20N%B0002.jpg)
Il est possible de : 
...
3. L'assistant propose de gérer l'orientation Portrait/Paysage de l'application. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Agencement%201%20-%20HC%20N%B0003.jpg)
Il est possible de : 
...
3. La fenêtre d'ajout d'agencements apparaît. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Agencement_FI%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="gestion_des_champs_dans_les_agencements_ELTPARAGRAPHE000213"></a>Par défaut, la dissociation automatique est activée (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Agencement_Page_manip%20-%20HC%20N%B0001.gif)) : 
...
<a name="menu_contextuel_des_champs_specifique_aux_agencements_ELTPARAGRAPHE000232"></a>Le menu contextuel "Agencements" des champs permet également de gérer la dissociation ou non des caractéristiques du champ. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Agencement_Dissocier.gif)
...
<a name="cas_particulier_action_bar_ELTPARAGRAPHE000261"></a>Le champ Action Bar est disponible en Android et iOS. 
...
<a name="menu_contextuel_des_agencements_ELTPARAGRAPHE000270"></a>Le menu contextuel des vignettes des agencements disponibles permet de gérer les agencements : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Agencement_MenuCtx.gif)
...
Lors de la comparaison de fenêtres contenant des agencements, les différences sur chaque agencement sont présentées. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Agencement_Diff.gif&type=thumb)
...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) L'agencement est automatiquement modifié lorsque l'appareil passe du mode portrait au mode paysage.

Il est possible de définir les paramètres de l'agencement (option "Description" du menu contextuel de la barre de titre de l'agencement) pour chaque plateforme : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Agencements_propri%E9t%E9s%20-%20HC%20N%B0001.gif)
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Attention, l'indication Téléphone / Tablette est uniquement prise en compte pour la taille de la fenêtre sous l'éditeur. Cette information n'est pas prise en compte en exécution. 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Système d'exploitation. Si "Multi OS" est sélectionné, l'agencement pourra être lancé sur tous les OS. Il est possible de sélectionner des systèmes spécifiques (les systèmes proposés correspondent aux plateformes définies pour le projet).

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Orientation de la fenêtre. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Plateforme d'édition.




![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Selon le type de la fenêtre exécutée, l'ordre des paramètres pris en compte varient. Ainsi : 
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) L'indication de la taille de la plateforme n'est pas prise en compte en exécution (tablette/téléphone). L'agencement le plus grand est choisi. 
...
- de forcer l'agencement à utiliser (fonction [FenChangeAgencement](../WDLang1/1000021056.md)). Il suffit d'indiquer en paramètre le numéro de l'agencement à utiliser. Ce numéro est indiqué dans la barre de titre de l'agencement. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Agencement_Numero.gif&type=thumb)
...
[FenChangeAgencement (Fonction)](../Editeurs/1000021056.md)

[FenAgencementEnCours (Fonction)](../Editeurs/1000021133.md)

[Configuration de projet](../Editeurs/9000030.md)

[Agencements WEBDEV](../Editeurs/1410086642.md)
