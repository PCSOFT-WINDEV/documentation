...
<a name="mettre_place_une_replication_serveurs_hfsql_ELTTEXTE000276"></a>


### Configurer une réplication avec le Centre de Contrôle HFSQL
<a name="configurer_une_replication_avec_centre_controle_hfsql_ELTPARAGRAPHE000041"></a>
...
<a name="definir_serveur_abonne_depuis_centre_controle_hfsql_ELTPARAGRAPHE000063"></a>
...
5. Cochez l'option "Le serveur est abonné ou spare (va recevoir des données répliquées)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_HF_Replication_Serveur%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="definir_serveur_maitre_depuis_centre_controle_hfsql_ELTPARAGRAPHE000088"></a>
...
<a name="definir_une_replication_sur_serveur_maitre_ELTPARAGRAPHE000110"></a>
...
4. Sélectionnez les éléments à répliquer. Il est possible de répliquer:
	...
	- une sélection de bases de données ou de tables. 


 Remarques: 

- Il est possible d'exclure certaines tables de la réplication. Si cette option a été sélectionnée, l'étape suivante de l'assistant permet de sélectionner les éléments à exclure. 
...
<a name="gerer_les_replications_existantes_ELTTEXTE000318"></a>
