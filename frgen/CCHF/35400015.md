...
### Onglet "Général"
<a name="onglet_general_ELTPARAGRAPHE000039"></a>
...
Par défaut, seuls les noms des tables sont affichés. 
...
Remarque: L'option "Masquer les répertoires de sauvegardes" permet d'afficher uniquement les répertoires contenant les tables de la base. 
...
- Optimiser et réparer: Cette option permet d'afficher la fenêtre de configuration de l'optimisation et de la réparation des tables HFSQL.
...
### Onglet "Connexions"
<a name="onglet_connexions_ELTPARAGRAPHE000076"></a>
...
<a name="onglet_elements_planifies_ELTPARAGRAPHE000116"></a>
...
### Onglet "Sauvegardes"
<a name="onglet_sauvegardes_ELTPARAGRAPHE000147"></a>
...
### Onglet "Liaisons"
<a name="onglet_liaisons_ELTPARAGRAPHE000169"></a>

Cet onglet présente toutes les informations concernant les liaisons entre les tables présentes dans la base de données HFSQL Client/Serveur.
...
<a name="onglet_procedures_stockees_ELTPARAGRAPHE000188"></a>
...
<a name="onglet_requetes_stockees_ELTPARAGRAPHE000231"></a>
...
### Onglet "Paramètres"
<a name="onglet_parametres_ELTPARAGRAPHE000245"></a>
...
### Onglet "Blocages"
<a name="onglet_blocages_ELTPARAGRAPHE000281"></a>

Cet onglet permet de gérer les blocages pour l'ensemble des tables de la base de données courante. 
...
Pour la base de données HFSQL Client/Serveur sélectionnée, le ruban propose les actions suivantes: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_HF_Gestion_Serveur%20-%20HC%20N%B0001%201.gif)
...
- Dans le groupe "Tables", l'option "Optimiser et réparer" permet d'optimiser une ou plusieurs tables. Pour plus de détails, consultez [Optimiser et réparer des tables](../CCHF/3540007.md). 
