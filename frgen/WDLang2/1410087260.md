...
| *popupSourisXY* | La page Popup sera ouverte à la position de la souris. Cette constante ne peut être utilisée que dans un événement navigateur (d'un champ ou d'une page). Cette constante ne peut pas être utilisée :<br><br>- dans les procédures navigateur.<br><br>- dans les événements appelés directement ou indirectement depuis une procédure navigateur (par l'intermédiaire de la fonction [ExécuteTraitement](../WDLang1/3013031.md) par exemple).<br><br>- dans le code navigateur d'un champ Bouton ou d'un champ Lien.<br><br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette constante n'est pas disponible. |
