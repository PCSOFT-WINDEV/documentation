...
2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Proc_auto_Ico.gif) dans le bandeau de l'éditeur de code. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_Tache_plan1.gif)
...
3. Dans la fenêtre de configuration de l'automatisme de la procédure, sélectionnez "Tâche WEBDEV", puis "Tâche différée" et configurez les différents paramètres de la tâche différée : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_Tache_diff.gif)
...
5. Pour lancer l'exécution de la procédure différée dans votre projet : 
	...
	- soit saisissez directement le nom de la fonction : une icône spécifique apparaît à coté du nom de la fonction : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_Tache_diff_code.gif)
...
4. Dans la fenêtre de configuration de l'automatisme de la procédure, sélectionnez "Tâches WEBDEV", puis Tâche planifiée" et configurez les différents paramètres de la planification : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_Tache_plan2.gif)
...
[ExécuteProcédureDifférée (Fonction)](../WDLang2/1000020682.md)

[EnModeProcédureDifférée (Fonction)](../WDLang2/1000020665.md)

[Procédures automatiques](../WDLang2/9000072.md)
