...
<a name="conditions_utilisation_ELTPARAGRAPHE000210"></a>
...
<a name="zone_repetee_multiselection_ELTPARAGRAPHE000233"></a>

Si la fonction **ZoneRépétéeDéplaceLigne** est utilisée sur un champ Zone répétée multisélection:
...
**Attention**: La fonction **ZoneRépétéeDéplaceLigne** ne retourne pas de code d'erreur. Pour savoir si cette fonction a généré une erreur, utilisez la fonction [ErreurInfo](../WDLang1/3013008.md) avec la constante *errMessage*.
