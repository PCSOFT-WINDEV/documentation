...
<a name="comment_mettre_place_des_transactions_securisees_par_protocole_tlsssl_ELTTEXTE000207"></a>
...
La procédure complète à suivre pour obtenir un certificat SSL est détaillée dans [Obtention d'un certificat TSL (SSL) pour IIS](../WDLang2/1000019454.md).
...
<a name="inserer_des_transactions_securisees_par_tlsssl_dans_site_webdev_ELTTEXTE000231"></a>
...
### Mise en place
<a name="mise_place_ELTPARAGRAPHE000070"></a>Pour ouvrir une page en mode sécurisé :
...
<a name="revenir_mode_normal_transaction_non_securisee_dans_navigateur_cours_ELTPARAGRAPHE000096"></a>Pour revenir en mode normal (transaction non sécurisée) dans le navigateur en cours :
...
<a name="cas_particulier_ouverture_une_page_mode_securise_avec_fonction_navigateurouvre_ELTPARAGRAPHE000122"></a>Pour ouvrir une page en mode sécurisé avec la fonction [NavigateurOuvre](../WDLang2/3055006.md) : 
...
[Obtention d'un certificat TSL (SSL) pour IIS](../WDLang2/1000019454.md)
