...
![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) Cette fonction est disponible en Ajax uniquement pour les nouveaux Upload monofichiers ou multifichiers.
<a name="Exemple1"></a>
...
TableSource, FichierDest sont des chaînes
...
TableSource = UploadNomTable(SAI_Table)
// Si TableSource existe, on la copie dans le répertoire des documents sur le serveur
SI TableSource <> "" ALORS
	...
	// Copie du fichier
	fCopieTable(TableSource, FichierDest)
FIN
```
...
### Sessions prélancées
<a name="sessions_prelancees_ELTPARAGRAPHE000107"></a>
