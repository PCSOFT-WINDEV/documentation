...
<a name="afficher_une_page_differente_premiere_page_site_ELTPARAGRAPHE000138"></a>Le paramètre &lt;Page&gt; peut correspondre à n'importe quelle page du site. Cette page doit avoir l'option "Accessible par la fonction SiteDynamiqueAffiche" cochée dans l'onglet "Général" de la description de la page.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=SiteDynamiqueAffiche%20prob.gif)
