...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette syntaxe n'est pas disponible dans cette version.1. Code permettant d'afficher la page en lui passant des paramètres :
