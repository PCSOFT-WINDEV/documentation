...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Ces effets de transition sont pris en compte lors de l'utilisation de la fonction **ImageSuivant**. 

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Ces effets de transition ne sont pas pris en compte lors de l'utilisation de la fonction **ImageSuivant**. En effet, la page est totalement rafraîchie. Pour prendre en compte ces effets, il suffit d'utiliser un code en mode Ajax. 
