...
<a name="utilisation_fonction_tableajoute_ELTTEXTE000164"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000023"></a>

La fonction [TableAjoute](../WDLang1/3074017.md) permet d'ajouter une ligne dans un champ de type Table géré par programmation. Pour ajouter la ligne, il faut:
...
<a name="utilisation_fonction_tableajouteligne_ELTTEXTE000194"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000054"></a>

La fonction [TableAjouteLigne](../WDLang1/3074006.md) permet d'ajouter une ligne dans un champ de type Table géré par programmation. La différence avec la méthode précédente (utilisation de la fonction [TableAjoute](../WDLang1/3074017.md)) est seulement une différence de syntaxe.
...
<a name="utilisation_fonction_fichierverstablememoire_ELTTEXTE000224"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000083"></a>

La fonction [FichierVerstableMémoire](../WDLang1/3074005.md) permet de remplir à partir d'une table (ou d'une requête SQL) un champ Table géré par programmation en une seule opération (sans faire de boucle de remplissage). 
...
### Exemple de code
<a name="exemple_code_ELTPARAGRAPHE000093"></a>
...
[TableAjoute (Fonction)](../CommentLeFaire/3074017.md)

[TableAjouteLigne (Fonction)](../CommentLeFaire/3074006.md)

[FichierVersTableMémoire (Fonction)](../CommentLeFaire/3074005.md)
