...
- Ouverture [Multifenêtrage libre](#NOTE2_1)
...
## Ouverture modale
<a name="ouverture_modale_ELTTEXTE000183"></a>
...
- La fonction WLangage [Ouvre](../WDLang1/3038035.md) permet d'ouvrir une fenêtre en Modal. Il est bien entendu possible d'accéder aux champs des fenêtres dessous par programmation.

- La fonction [Ferme](../WDLang1/3038018.md) permet de fermer cette fenêtre et redonne le focus à la fenêtre de dessous.
...
<a name="ouverture_multifenetrage_ELTTEXTE000207"></a>
...
La programmation pour gérer en simultané plusieurs fenêtres ouvertes est parfois complexe, surtout dans la gestion des contextes de tables ou dans la gestion des variables globales. Il est conseillé de se limiter à moins de 10 fenêtres ouvertes simultanément.
...
- Les fonctions [OuvreFille](../WDLang1/3038021.md) et [OuvreSoeur](../WDLang1/3038045.md) permettent d'ouvrir une fenêtre en mode multifenêtrage.
...
<a name="ouverture_mdi_multi_document_interface_ELTTEXTE000231"></a>
...
- La fonction [MDIOuvre](../WDLang1/3052005.md) permet d'ouvrir une fenêtre en mode MDI.
...
## Ouverture POPUP
<a name="ouverture_popup_ELTTEXTE000255"></a>
...
- Les fonctions [OuvrePopup](../WDLang1/3038046.md) ou [OuvrePopupPosition](../WDLang1/3038047.md) permettent d'ouvrir une fenêtre en mode POPUP.
