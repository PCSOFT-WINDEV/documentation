...
2. Choisissez de créer une requête de sélection (option "Sélection (SELECT)"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0001.gif&type=thumb)

	Passez à l'étape suivante de l'assistant.

3. La fenêtre de description de la requête s'affiche.

4. Donnez un nom et un libellé à la requête : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0002.gif&type=thumb)
...
6. Double-cliquez sur le nom de la rubrique pour l'ajouter dans la liste des rubriques de la requête : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0003.gif)


7. Dans la partie droite de l'éditeur, cliquez sur le bouton "Somme". La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0004.gif)


8. Validez. La fenêtre de description de la requête est mise à jour : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0005.gif)


9. Validez la fenêtre de description de la requête. La requête apparaît sous l'éditeur : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0006.gif)


10. Enregistrez la requête (Ctrl + S). 

11. Visualisez le code SQL en appuyant sur la touche F2 : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0007.gif)
...
3. Ajoutez cette rubrique aux rubriques de la requête (double-cliquez sur le nom de la rubrique par exemple). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0008.gif)


4. Validez la fenêtre de description de la requête. La requête apparaît sous l'éditeur : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0009.gif)


5. Enregistrez la requête (Ctrl + S). 

6. Visualisez le code SQL en appuyant sur la touche F2 : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Somme%20-%20HC%20N%B0010.gif)
...
[Opérations dans une requête de sélection : ajout et suppression ](../CommentLeFaire/2032015.md)
