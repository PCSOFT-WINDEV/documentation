...
Il existe plusieurs méthodes pour parcourir une table selon un filtre :
...
<a name="methode_1_fonctions_parcours_ELTTEXTE000221"></a>
...
```wl
// Parcours des enregistrements de la table Client dont la ville est MONTPELLIER. 
...
<a name="methode_2_instruction_pour_tout_ELTTEXTE000251"></a>
L'instruction [POUR TOUT](../Motscles/1510013.md) permet de parcourir les enregistrements d'une table. Dans notre cas, cette instruction va permettre de lire les enregistrements d'une table avec un filtre.
...
<a name="methode_3_fonction_hfiltre_ELTTEXTE000281"></a>


1. Utilisez la fonction [HFiltre](../WDLang4/3044100.md) pour appliquer un filtre d'enregistrements sur la table.

2. Parcourez la table filtrée, avec les fonctions de parcours classiques. 
...
<a name="methode_4_utilisation_une_requete_sql_ELTTEXTE000311"></a>
Pour parcourir la table avec un filtre via une requête :
...
3. Lire le résultat de la requête en réalisant un parcours de table standard. 
...
[HFiltre (Fonction)](../CommentLeFaire/3044100.md)

[Instruction POUR TOUT / POUR TOUS (parcours de fichiers de données)](../CommentLeFaire/1510013.md)

[HLitRecherche (Fonction)](../CommentLeFaire/3044050.md)
