...
2. Choisissez de créer une requête de sélection (option "Sélection (SELECT)"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_tri-%20HC%20N%B0001.gif&type=thumb)

	Passez à l'étape suivante de l'assistant.

3. La fenêtre de description de la requête s'affiche.

4. Donnez un nom et un libellé à la requête : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Tri%20-%20HC%20N%B0002.gif&type=thumb)
...
6. Double-cliquez sur les noms des rubriques pour les ajouter dans la liste des rubriques de la requête : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Tri%20-%20HC%20N%B0003.gif)
...
8. Dans la partie droite de l'éditeur, cliquez sur le bouton "Trier". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Tri%20-%20HC%20N%B0004.gif)


9. Dans le menu qui s'affiche, sélectionnez "Trier sur la rubrique sélectionnée". La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Tri%20-%20HC%20N%B0005.gif)


10. Sélectionnez l'ordre du tri (croissant dans notre exemple).

11. Validez. La fenêtre de description de la requête est mise à jour : une flèche avec le numéro du tri est affichée. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Tri%20-%20HC%20N%B0006.gif)


12. Validez la fenêtre de description de la requête. La requête apparaît sous l'éditeur : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Tri%20-%20HC%20N%B0007.gif)


13. Enregistrez la requête (Ctrl + S). 

14. Visualisez le code SQL en appuyant sur la touche F2 : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Requ%EAte_Tri%20-%20HC%20N%B0008.gif)
...
[Ordre de tri des enregistrements d'une requête de sélection ](../CommentLeFaire/2032005.md)
