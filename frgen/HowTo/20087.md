...
[Importation des éléments nécessaires](#importation_des_elements_necessaires_ELTTEXTE000383)

[Modification de la page "retourboutique"](#modification_page_retourboutique_ELTTEXTE000407)

[Ajout du code de localisation de la base du composant](#ajout_code_localisation_base_composant_ELTTEXTE000431)

[Personnalisation de la page de paiement](#personnalisation_page_paiement_ELTTEXTE000455)

[#Le lien "Payer"](#lien_payer_ELTPARAGRAPHE000139)

[#Les autres liens: où mettre le code qui enregistre le paiement?](#les_autres_liens_mettre_code_qui_enregistre_paiement_ELTPARAGRAPHE000213)

[Test du paiement](#test_paiement_ELTTEXTE000491)

[Les éléments à déployer pour le paiement](#les_elements_deployer_pour_paiement_ELTTEXTE000515)

[Problèmes les plus fréquents](#problemes_les_plus_frequents_ELTTEXTE000539)

[#Erreur : La page de retour n'a pas renvoyé le résultat attendu](#erreur_page_retour_pas_renvoye_resultat_attendu_ELTPARAGRAPHE000266)

[#Après déploiement, un message indique : "Commande à mettre en attente avec intervention humaine nécessaire"](#apres_deploiement_message_indique_commande_mettre_attente_avec_intervention_humaine_necessaire_ELTPARAGRAPHE000302)

[#Comment activer les log (WLOG) et les lire ?](#comment_activer_les_log_wlog_les_lire_ELTPARAGRAPHE000331)
...
<a name="importation_des_elements_necessaires_ELTTEXTE000383"></a>
...
2. Importez le composant externe "WW_PaiementSecurise". 
	...
	- Sous le volet "Projet", dans le groupe "Projet", déroulez "Importer" et sélectionnez "Un composant externe .. A partir d'un fichier". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0001.gif&type=thumb)
...
- La fenêtre de description du composant apparaît. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0002.gif)
...
3. Afin d'avoir une base pour intégrer le paiement sécurisé, nous vous proposons d'importer également 2 pages spécifiques dans votre projet: 
	...
	- Sous le volet "Projet", dans le groupe "Projet", déroulez "Importer" et sélectionnez "Des éléments WEBDEV et leurs dépendances". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0003.gif&type=thumb)
...
- La liste des pages s'affiche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0004.gif)

4. Recompilez le projet pour prendre en compte ces pages: sous le volet "Projet", dans le groupe "Projet", déroulez "Recompiler et synchroniser" et sélectionnez "Recompiler le projet et générer les pages HTML". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0005.gif&type=thumb)
...
<a name="modification_page_retourboutique_ELTTEXTE000407"></a>
...
4. Dans l'onglet "Général", modifiez la page interne liée au champ: remplacez "PI_Payback" par "PaiementSécurisé.PI_Payback". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0006.gif&type=thumb)


5. Enregistrez la page (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Enregistrer.gif)). 

6. Enregistrez une copie de cette page avec un nom personnalisé: sous le volet "Accueil", dans le groupe "Général", déroulez "Enregistrer" et sélectionnez "Enregistrer sous". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0007.gif)


7. Dans la fenêtre qui s'affiche, indiquez le nouveau nom de la page et validez. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0008.gif)
...
8. Assurez-vous que cette page ne soit pas référencée: 
	...
	- Dans l'onglet "Détail", l'option "Interdire le référencement" doit être cochée. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0009.gif&type=thumb)
...
<a name="ajout_code_localisation_base_composant_ELTTEXTE000431"></a>
...
<a name="personnalisation_page_paiement_ELTTEXTE000455"></a>
...
4. Ajustez le type de la page en fonction du type de page souhaité dans votre projet: Session, AWP, mode Zoning, mode Responsive, ...<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0010.gif&type=thumb)


5. Dans le cas de ATOS, assurez-vous que le lien "Payer" a bien comme destination l'iFrame "IFRM_PAIEMENT". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise%20-%20HC%20N%B0011.gif&type=thumb)
...
### Le lien "Payer"
<a name="lien_payer_ELTPARAGRAPHE000139"></a>
...
<a name="les_autres_liens_mettre_code_qui_enregistre_paiement_ELTPARAGRAPHE000213"></a>
...
## Test du paiement
<a name="test_paiement_ELTTEXTE000491"></a>
...
<a name="les_elements_deployer_pour_paiement_ELTTEXTE000515"></a>
Lors du déploiement, il faut **exclure** du déploiement les tables HFSQL "Transaction" qui contiennent les transactions de tests effectuées en local:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CLF_Paiement_securise_Ato2.gif)
...
<a name="problemes_les_plus_frequents_ELTTEXTE000539"></a>


### Erreur : La page de retour n'a pas renvoyé le résultat attendu
<a name="erreur_page_retour_pas_renvoye_resultat_attendu_ELTPARAGRAPHE000266"></a>
...
<a name="apres_deploiement_message_indique_commande_mettre_attente_avec_intervention_humaine_necessaire_ELTPARAGRAPHE000302"></a>
...
<a name="comment_activer_les_log_wlog_les_lire_ELTPARAGRAPHE000331"></a>

La création de log (WLog) est une fonctionnalité du WLangage qui permet d'enregistrer dans un fichier toutes les lignes de code qui s'exécutent dans un fichier WLOG avec plus ou moins de détails. Pour cela, il faut utiliser la fonction [dbgActiveLog](../WDLang1/1000017137.md). 
