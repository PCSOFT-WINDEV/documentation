...
<a name="mode_ligne_commande_ELTPARAGRAPHE000011"></a>
...
| /WDD=&lt;Chemin schéma des données&gt; | Chaîne de caractères contenant le chemin du schéma des données WINDEV, WEBDEV ou WINDEV Mobile. Si ce chemin contient des espaces, il doit être mis entre guillemets. |
| /PWD=&lt;Mot de passe (non crypté) du schéma des données&gt; | Chaîne de caractères contenant le mot de passe du schéma des données WINDEV, WEBDEV ou WINDEV Mobile. Si ce mot de passe contient des espaces, il doit être mis entre guillemets. |
| /WDD55=&lt;Chemin schéma des données WINDEV 5.5&gt; | Chaîne de caractères contenant le chemin du schéma des données WINDEV 5.5. Si ce chemin contient des espaces, il doit être mis entre guillemets. |
| /PWD55=&lt;Mot de passe (non crypté) du schéma des données WINDEV 5.5&gt; | Chaîne de caractères contenant le mot de passe du schéma des données WINDEV 5.5. Si ce mot de passe contient des espaces, il doit être mis entre guillemets. |
| /SRCDIR=&lt;Répertoire des tables Hyper File 5.5 recherchées&gt; | Chaîne de caractères contenant le chemin des tables Hyper File 5.5 à convertir. |
| /DSTDIR=&lt;Répertoire des tables converties&gt; | Chaîne de caractères contenant le répertoire où les tables converties au format HFSQL Classic seront créées. |
| /FILE=&lt;Table source&gt; | Chaîne de caractères contenant:<br><br>- soit le chemin de la table Hyper File 5.5 à convertir<br><br>- soit le nom de la table à convertir sur le serveur.<br><br><br> |
| /NAME=&lt;Nom logique dans le schéma des données WINDEV 5.5 du fichier à convertir&gt; | Chaîne de caractères correspondant au nom logique de la table à convertir dans le schéma des données WINDEV, WEBDEV ou WINDEV Mobile. |
...
| /MODE=[HF5 \ EXTERN \ XML \ TEXT] Type des fichiers sources | Définit le format des fichiers à importer:<br><br>- HF5: tables Hyper File 5.5<br><br>- EXTERN: fichiers/tables externes (exemple: base C/S)<br><br>- XML: fichiers XML<br><br>- TEXT: fichiers texte<br><br><br> |
...
<a name="exemple_utilisation_script_ELTPARAGRAPHE000160"></a>

La ligne de commande suivante permet d'exécuter la description de conversion "C:\\MonRépertoire\\MaDescription.WDV". En cas d'erreur, un message sera affiché à la fin de la modification automatique des tables (paramètre "-error"). L'assistant de la modification automatique des tables ne se lancera pas.
...
<a name="exemple_utilisation_ELTPARAGRAPHE000169"></a>
...
<a name="exemple_conversion_seul_fichier_ELTPARAGRAPHE000181"></a>
...
<a name="exemple_conversion_utilisant_connecteur_natif_acces_natif_ELTPARAGRAPHE000190"></a>

La ligne de commande suivante permet de convertir à l'aide du Connecteur Natif Oracle la table "DEMO.CUSTOMER". Cette table a pour nom logique "CUSTOMER" sur le serveur "MARS". La table HFSQL Classic sera créée dans le répertoire "c:\\data".
...
[WDConver : Utilisation en mode interactif](../WDConver/3512002.md)
