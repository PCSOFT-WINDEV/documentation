...
<a name="generateur_de_visite_guidee_interactive_le_moyen_moderne_de_faire_decouvrir_des_nouveautes_ou_un_mode_operatoire"></a>
...
[EnModeVisiteGuidée](../WDLang1/1410090218.md), [VisiteGuidéeDémarre](../WDLang6/1410090176.md), [VisiteGuidéeArrête](../WDLang6/1410090225.md), [VisiteGuidéeChangeEtape](../WDLang6/1410090229.md), [VisiteGuidéeInfo](../WDLang6/1410090219.md)
permettent de piloter la Visite Guidée. 
Par exemple, la fonction WLangage [VisiteGuidéeDémarre](../WDLang6/1410090176.md) déclenche la première étape du tableau : l'affichage de la première bulle.
...
Le type [VisiteGuidée](../WDLang6/1410090170.md) permet de :
...
Le type [VisiteGuidéeEtape](../WDLang6/1410090178.md) permet lui de définir les propriétés spécifiques à une étape. 
...
MesNouveautés.Effet.DuréeAnimation = 1s
...
Pour plus de détails, consultez [Cloner un gabarit ou une ambiance](../Editeurs/1410087314.md). 
...
<a name="7_nouveaux_champs_metier"></a>
...
Un graphique peut comporter une ou plusieurs catégories.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Graphe%20Waffle%202.png)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Graphe%20Waffle%201.png)
Il est possible d'assembler plusieurs graphes afin de comparer différentes séries.

Pour plus de détails, consultez [Les graphes de type "Waffle"](../WDChamp/1000021041.md). 
...
La famille de [fonctions WLangage gr](../WDLang3/3042003.md) habituelle permet de manipuler ce type de graphe.
...
une personnalisation plus fine : arrondi sur barre, etc.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=HistoLook%20dans%20Appli.png)
...
Cela permet d'éviter des zones vides inutilisées en fonction des données réelles.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA%20-%20axe%20graphe%20menu%20seul.png)
...
<a name="la_signature_electronique_dans_vos_applications_et_vos_sites"></a>
...
Pour plus de détails, consultez [Docusign : Signature électronique](../Editeurs/9000217.md). 
...
Pour plus de détails, consultez [Docusign : Signature électronique](../Editeurs/9000217.md).
		...
		Pour simplifier le développement, un assistant intuitif permet de générer le code nécessaire.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=docusign_assistant.png)
...
Il est également possible de positionner des guides sur ces règles.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=wd-editeur-d-image-regles-et-guides-exageration.png)
...
Il suffit d'appeler les fonctions WLangage de la famille [SaaS](../WDLang3/9500213.md) de gestion de licence, etc. 
...
<a name="environnement"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Loupe%20recherche%207%20bulle.png)
...
Pour plus de détails, consultez [Centre de Gestion de Projets : Kanban](../CCSuivi/3540731.md).
...
<a name="securite_par_mot_de_passe_groupware_utilisateur"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Groupware_GPU_MotDePasse_Renforce.png)
...
- La nouvelle fonction WLangage [gpwListeUtilisateur](../WDLang6/1410089604.md) permet de lister l'ensemble des utilisateurs.
...
Pour plus de détails, consultez [Partagez vos projets via Git](../Editeurs/9500230.md). 
...
Pour plus de détails, consultez [GDS : Récupérer les modifications effectuées dans une branche](../Editeurs/2038030.md). 
...
Pour plus de détails, consultez [Administrateur du GDS : Gestion de la base de sources](../Editeurs/2038021.md). 
...
Pour plus de détails, consultez [IA dans l'éditeur de code](../Editeurs/9000219.md). 
...
Pour plus de détails, consultez [Administrateur du GDS : outils disponibles](../Editeurs/2038023.md). 
...
Pour plus de détails, consultez [Correcteurs disponibles dans l'éditeur de code](../Editeurs/9000073.md). 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX%20-%20Bulle%20info%20dans%20code%20-%20proc.png)
...
Pour plus de détails, consultez [Le volet "Hashtags du code"](../Editeurs/2027039.md). 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20chaines%20multilangues.png)
...
Pour plus de détails, consultez [Gestionnaire des chaînes du projet](../Editeurs/1410087308.md). 
...
Pour plus de détails, consultez [Gestion des points d'arrêt](../Editeurs/2019005.md). 
...
Pour plus de détails, consultez [IAModèleDétecte](../WDLang6/1410087982.md). 
...
Pour plus de détails, consultez [Gestion de la valeur NULL : Activation des types nullables](../Motscles/1511031.md). 
...
Les Callbacks auront ainsi forcément le nombre de paramètres attendus, et la valeur de retour attendue.
		...
		Une variable qui possède l'attribut [Immuable](../POO/6010006.md) ne peut être affectée qu'une seule fois, et plus jamais modifiée. 
...
Pour plus de détails, consultez [Instruction de compilation : COMPILE SI](../Motscles/1510021.md). 
		...
		3 nouveaux types WLangage font leur apparition : [gglDrive](../WDLang3/1410089374.md), [oDrive](../NonDocumente/1410089377.md), [dpDrive](../NonDocumente/1410089378.md). 
...
Sécurité automatique, il est impossible de passer des paramètres incompatibles. Exemple :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code%20type%20sur%20le%20type%20champ.png)


Pour plus de détails, consultez [Champ (Type de variable)](../WDLang1/1000020967.md). 
...
Exemple :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Code%20cr%E9er%20ses%20fonctions%20sur%20les%20champs.png)
...
Par exemple : [France.VérifieNuméroFiscal](../WDLang1/1410089496.md)
...
Pour plus de détails, consultez [Fonctions de gestion des identifiants administratifs](../WDLang1/1410089156.md). 
...
Le protocole d'identification JWT (Json Web Token) est supporté nativement par le WLangage en version 2024.
		...
		En version 2024, il devient facile d'interroger un DNS grâce à la nouvelle fonction [DNSInterroge](../WDLang3/1410089873.md) :
...
- recherche sur un DNS particulier ou sur le premier trouvé.
		...
		En version 2024, les paramètres d'une procédure qui attend différents paramètres (et pas un tableau), peuvent être contenus dans un tableau qui sera analysé par la fonction WLangage [TableauVersParamètres](../WDLang1/1410089937.md) pour en extraire ces paramètres. 
...
Pour plus de détails, consultez [Chaînes littérales : chaînes de caractères monolignes et multilignes](../Motscles/1512011.md). 
		...
		L'opérateur [Modulo](../Motscles/1511002.md) accepte maintenant l'opérateur % comme synonyme.
...
Pour plus de détails, consulter [Opérateurs logiques](../Motscles/1512003.md). 
		...
		Un nouveau type pour formater les nombres fait son apparition : [FormatNumérique](../WDLang1/1410089836.md). 
...
Le nouveau Type WLangage [CodeWLangageMiseEnForme](../WDLang1/1410090146.md) est votre ami. 
Sont gérés :
...
- Nouvelle syntaxe de [fLitLigne](../WDLang1/3036031.md) à callback.
...
Créer un Champ Favori se réalise facilement d'un clic droit.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Passer%20un%20champ%20en%20favori.png)
...
Une fois le champ Favori positionné dans la fenêtre ou la page, vous pouvez modifier librement les paramètres de ce champ. Inutile de surcharger ses caractéristiques.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champs%20favoris%20-%20attributs.png)
...
Pour plus de détails, consultez [Champs favoris](../Editeurs/9000220.md).
...
- La nouvelle constante **httpTraceInfo** pour le type [httpRequête](../WDLang3/1000021158.md) permet de récupérer le log d'info de cURL et de OpenSSL.
...
Pour plus de détails, consultez les caractéristiques du type de variable [xmlSignature](../WDLang5/1000020736.md). 
		...
		La nouvelle fonction [XMLVérifieSignature](../WDLang5/1410090391.md) permet de vérifier la validité d'un fichier XML signé reçu.
...
<a name="generation_automatique"></a>
...
En version 2024, ces messages s'affichent si possible dans la langue du client : français, anglais, espagnol.
		...
		Pour gérer des cas particuliers de corruption physique de fichier de réplication (.HYL), la nouvelle fonction WLangage [hrsIgnoreErreur](../WDLang4/1410090182.md) et une option dans le Centre de Contrôle HFSQL permettent d'ignorer la partie corrompue du fichier. 
L'option, à utiliser avec discernement, peut rendre des services en phase d'exploitation.
		...
		La fonction [HRequêteExécutée](../WDLang4/1410090242.md) permet de savoir si une requête a déjà été exécutée.
...
- Il est possible de récupérer la liste des fichiers surveillés par la fonction WLangage [HListeFichiersSurveillés](../WDLang4/1410089900.md).
...
| ST_CROSSES | Permet de savoir si l'une des deux géométries possède une partie de ses points intérieurs en commun avec la seconde géométrie (et non pas obligatoirement la totalité de ses points).<br>L'intersection représentée par ces points en commun doit répondre à 2 critères :<br><br>- cette intersection doit avoir une dimension inférieure à celles des géométries comparées.<br><br>- cette intersection ne doit pas être égale à une des deux géométries comparées.<br><br><br> |
...
<a name="hfsqldrive_vos_bases_de_donnees_hfsql_dans_le_cloud_en_3_clics_hfsql_cluster"></a>
...
- La fonction WLangage [hCopieFichier](../WDLang4/3044282.md) est disponible en mode cluster.
...
<a name="rgpd_&_hfsql_anonymisation_automatique_des_donnees"></a>
...
Pour plus de détails, consultez [Anonymisation automatique des données](../WDLang4/9000215.md). 
...
Il suffit de spécifier la règle d'anonymisation dans les 7 onglets de la définition de la rubrique.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Anonymisation_7Onglets_brouillage.png)
...
Les fonctions WLangage [hModifie](../WDLang4/3044042.md), etc. sont sans effet sur une rubrique anonymisée : elles ne modifient jamais la valeur d'une rubrique anonymisée. 
...
<a name="hfsql_stocke_et_manipule_les_donnees_spatiales_terrestres"></a>
...
Pour plus de détails, consultez [Gérer les données spatiales dans les bases de données HFSQL](../WDLang4/1410090447.md). 
...
Pour le système géométrique (2D), vous bénéficiez des nouveaux types [Point2D](../WDLang4/1410090100.md), [Polygone2D](../WDLang4/1410090122.md), [Polyligne2D](../WDLang4/1410090109.md), etc.
Le nouveau type MultiXXX permet de stocker un ensemble de types précédents. 
Ces types sont également disponibles pour le système géographique : [PointGéo](../WDLang4/1410090102.md), [PolygoneGéo](../WDLang4/1410090127.md), [PolyligneGéo](../WDLang4/1410090128.md), etc.
...
Il suffit de stocker les données dans les nouvelles rubriques de type [PointGéo](../WDLang4/1410090102.md), [PolygoneGéo](../WDLang4/1410090127.md), [PolyligneGéo](../WDLang4/1410090128.md), etc.
...
Pour plus de détails, consultez [Fonctions Modbus](../WDLang3/1000025953.md). 
...
Pour plus de détails, consultez [Fonctions BitcoinCore](../WDLang1/1410090347.md). 
...
Pour plus de détails, consultez [Validité d'un certificat SSL](../RobotMonitor/3541127.md). 
...
Pour plus de détails, consultez [Contrôle : Connectivité HTTP](../RobotMonitor/3541112.md). 
...
<a name="big_data"></a>
		...
		La nouvelle fonction [RedisDeconnecte](../WDLang4/1410089738.md) permet de se déconnecter de la base sans avoir à terminer le process.
