...
Si des polices ont été oubliées, une erreur d'UI est générée.
		...
		<br>![Le contenu du champ de Recherche est enrichi](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20Markdown%202.png)<br>![Libellé du champ de saisie formaté](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20Markdown%20lib%20ch%20saisie.png)
...
Sans qu'aucun code ne soit nécessaire, vous incluez dans vos applis la possibilité de modifier photos et images.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20Editeur%20d'images2.png)
...
<br>![Le menu du champ Editeur d'images mobile](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20Editeur%20d'images.png)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20Action%20bar%201.png)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20Action%20bar%202.png)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20Action%20bar%203.png)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20Action%20bar%206.png)
...
Si nécessaire, le Kanban se repositionne sur la liste (colonne) d'arrivée pour effectuer la manipulation.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Kanban%20Mobile.png)
En mode paysage, plusieurs listes (colonnes) sont affichées.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Kanban%20Mobile%201.png)
...
Le texte complet s'affiche alors.<br>![Le texte est tronqué, et l'appui sur "Voir plus" affiche le texte complet](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20-%20Champ%20m%E9tier%20voir%20plus.png)
		...
		Le Champ Métier "Badge" affiche un badge contenant une valeur sur un champ : image, bouton, etc.<br>![Un comportement d'UI standard](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM-ChampM%E9tier1%20ROND.png)
...
La présentation est adaptée pour un usage mobile.<br>![Chaque destination sélectionnée est ajoutée aux jetons](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM-ChampM%E9tier3.png)
		...
		Le Champ Métier "Complétion d'adresse" (voir Nouveauté 202) est également proposé en mobile : l'affichage est adapté à une utilisation tactile.<br>![Une liste de propositions d'adresses s'affiche](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM-ChampM%E9tier2.png)
...
```
<br>![Le clic sur le bouton OUVRIR du site ou du mail lance l'application et ouvre la fiche de l'annonce sélectionnée](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=OUvrir%20une%20appli%20depuis%20un%20lien.png)
...
Il suffit de passer la callback à appeler à la nouvelle fonction WLangage [DeepLinkProcédure](../WDLang3/1410089051.md).
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM%20-%20Page%20Webdev%20dans%20App%20mobile.png)
...
- plus des nouveautés spécifiquement destinées à iOS. 
		...
		<br>![Le nouvel iPhone 14 et la nouvelle Apple Watch Series 8](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=iphone14-Dynamic-Island-ferm%E9e-pizza-min.png)
...
Toutes les versions de l'iPhone 14 et la montre AppleWatch Series 8 sont supportées.
		...
		<br>![Dynamic Island ouverte, avec message d'action](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=iphone14-Dynamic-Island-pizza-min.png)
...
Pour plus de détails, consultez [Dynamic Island](../Editeurs/1000019930.md). 
...
Pour plus de détails, consultez [Saisir du code Kotlin](../Editeurs/9000209.md).
		...
		<br>![Typiquement une application de paiement est une Activity](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM-Paiement-Mobile-Fenetre-Activity-SANS-Recadrage.jpg)
