...
[DiagrammeCharge](../WDLang1/1410088123.md), [DiagrammeSauve](../WDLang1/1410088122.md), [DiagrammeVersImage](../WDLang1/1410088144.md), DiagrammeVersSVG, [iImprimeDiagramme](../WDLang5/1410088189.md)... 
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-PDF-Remplissage.jpg&type=thumb)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-PDF-Ajout-De-Filigrane.gif&type=thumb)
...
L'ajout de filigrane est également possible par programmation. 
		...
		La fonction WLangage [PDFSigne](../WDLang6/1000022241.md) permet déjà de signer un document par programmation. 
...
En cliquant sur ce bandeau, l'utilisateur final peut consulter les signatures. <br>![Informations faciles à lire](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD%20-%20informations%20signtaure.jpg)
...
<br>![Une signature manuscrite insérée dans le document PDF](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-PDF-Signature.gif)
		...
		Indépendamment du champ Lecteur PDF, les nouvelles options *NiveauDeGris* et *NoirEtBlanc* de la fonction [iParamètrePDF](../WDLang5/3046007.md) permettent la génération d'un document PDF en noir et blanc ou en nuances de gris. 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX-PDF-Noir-X-Blanc.png)
...
Ce type de graphe est principalement utilisé pour comparer des objectifs ou des parts de marché, ou illustrer une progression, en sachant que le cercle complet représente 100%.<br>![Un graphe circulaire de progrès](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-Graphe-Progres%20Contraste.png)
...
En version 27, il n'y a rien à coder pour lancer cet OCR. <br>![L'utilisateur sélectionne la zone, et hop, l'OCR est effectué !](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX-Editeur-images-OCR.gif)
...
Pour flouter un champ il suffit d'utiliser la nouvelle fonction WLangage [dFlou](../WDLang1/1410088153.md), en passant le nom du champ et le taux de floutage en paramètres. 
...
Le cas des éventuels noms de projet en doublon est géré. 
		...
		La nouvelle fenêtre de choix des styles est bien plus ergonomique et agréable à utiliser. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-Style-Choix-table.png)
...
Un nouveau volet fait son apparition dans l'environnement pour visualiser cet arbre. 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD%20-%20Aide%20int%E9gr%E9e.gif)
...
<a name="gds_gestionnaire_de_sources_collaboratif"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX-GDS-Volet%20etat%20des%20elements.gif)
...
Ce volet permet également d'envoyer un message au développeur ayant effectué l'extraction.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GDS_Revisions.gif)
...
- sauver l'élément sur disque. 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX-GDS-Syst%E8me%20de%20notif.gif)
...
Si l'environnement est fermé, le message est conservé en attente et s'affichera à l'ouverture. 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX-GDS-Panneau%20Element%20extrait.jpg)
...
Autre exemple : après avoir saisi une ligne contenant une fonction [hLitPremier](../WDLang4/3044051.md), dès la saisie de la lettre "h", l'assistance propose hLitSuivant... 
Cette nouvelle assistance prédictive est très agréable à utiliser. 
		...
		L'assistance à la saisie dans l'éditeur de code propose une assistance sur tous les tableaux dans les types avancés. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD%20Assistance%20type%20avanc%E9.gif)
...
- définition des paramètres des fonctions [HTTPEnvoie](../WDLang3/1000021183.md) et [RESTEnvoie](../WDLang3/1000021476.md)

- initialisation du type [httpRequête](../WDLang3/1000021158.md)

- utilisation de la fonction [AuthIdentifie](../WDLang3/1000022219.md)
...
Pratique ! <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Debogueur%20Status%20bar.jpg)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD%20-%20Flou%20%E9diteur%20%E9tat.gif)
		...
		La nouvelle propriété WLangage [Occulté](../Proprietes/1410087964.md) et les nouvelles constantes Flou et Biffure permettent d'indiquer le nom de la zone ou des champs à flouter (ou à recouvrir) lors de l'impression d'un état. 
...
La famille de fonctions IA [IADétecte](../WDLang6/1410087942.md) et [IAModèleDétecte](../WDLang6/1410087982.md), et les nouveaux types WLangage [IARésultatImage](../WDLang6/1410087965.md), et [IAModèleRéseauDeNeurones](../WDLang6/1410088095.md), permettent une programmation facile. 
...
La fonction WLangage [IADétecte](../WDLang6/1410087942.md) renvoie un tableau de [IARésultatImage](../WDLang6/1410087965.md) contenant le type de l'objet, les coordonnées du polygone qui contient l'objet et l'indice de confiance. 
...
Tout comme les opérateurs += et -=, ils simplifient le code source. 
		...
		Commentaires au milieu d'unE ligne de code : entre /\* et #STARSTAR# indique le début du commentaire, et \*/ indique la fin du commentaire, qui peut être multiligne. 
...
Les nouvelles fonctions WLangage RegExRecherche et [RegExRemplace](../WDLang1/1000026275.md) font ainsi leur apparition. 
...
Deux fonctions WLangage font leur apparition en version 27 pour calculer ce CRC et pour vérifier ce CRC : [LuhnCalcule](../WDLang1/1410087276.md) et [LuhnVérifie](../WDLang1/1410087277.md). 
...
Les fonctions [hashChaîne](../WDLang1/1000007111.md) et [hashFichier](../WDLang1/1000007112.md) acceptent une nouvelle constante PBKDF2 qui attend le sel, le nombre d'itérations et la taille de la clé en sortie. 
...
|   |   |
| --- | --- |
| [HTMLInsèreAvant](../WDLang5/1410087609.md) | [HTMLInsèreAprès](../WDLang5/1410087610.md) |
| [HTMLEncadre](../WDLang5/1410087611.md) | [HTMLEncadreTousLesFils](../WDLang5/1410087612.md) |
| [HTMLDésencadreTousLesFils](../WDLang5/1410087613.md) | [HTMLSupprime](../WDLang5/1410087614.md) |
| [HTMLInsèrePremierFils](../WDLang5/1410087615.md) | [HTMLInsèreDernierFils](../WDLang5/1410087616.md) |
| [HTMLSupprimeFils](../WDLang5/1410087617.md) | [HTMLModifieAttribut](../WDLang5/1410087618.md) |
| [HTMLModifieAttribut](../WDLang5/1410087618.md) | [HTMLSupprimeAttribut](../WDLang5/1410087619.md) |
		...
		La fonction historique [IniEcrit](../WDLang1/3013039.md) n'acceptait à ce jour qu'une chaine comme paramètre. 
Depuis la version 27, la fonction [IniEcrit](../WDLang1/3013039.md) accepte un paramètre de type Entier, Réel, Booléen...
...
Cela est utile en particulier lors de l'usage d'API externes qui ne fonctionnent que dans un mode, soit 32 bits, soit 64 bits. 
		...
		La nouvelle fonction WLangage [dFlou](../WDLang1/1410088153.md) permet de flouter le rectangle dont les coordonnées sont passées en paramètre. 
...
Le rayon du flou est à passer en paramètre. 
		...
		La fonction WLangage [CrypteStandard](../WDLang1/1000021293.md) gère l'ensemble des paramètres de cryptage (de chiffrement) de manière automatique. 
...
La version 27 permet de forcer l'utilisation de http2. 
		...
		Ajouter un noeud dans un en-tête de webservice SOAP s'effectue avec la nouvelle fonction [SoapAjouteEntête](../WDLang3/3069001.md). 
...
<a name="xml"></a>
		...
		En version 27, les nouvelles fonctions WLangage [JSONVersXML](../WDLang1/1410087330.md) et [XMLVersJSON](../WDLang5/1410087331.md) permettent d'effectuer automatiquement une conversion d'un format à l'autre. 
...
```
Un nouveau type WLangage [JSONXMLConvertisseur](../WDLang5/1410087323.md) propose un ensemble d'options pour paramétrer la conversion et permettre une conversion personnalisée : conversion des attributs XML, des Namespaces, balises vides... 
...
L'initialisation du moteur Python s'effectue à l'aide de la fonction [PythonInitialise](../WDLang6/1410088100.md). 
...
Au cours de la transaction, la fonction WLangage [HTransactionPointDeSauvegarde](../WDLang4/1410087841.md) permet de définir et nommer un point de retour possible. 
Pour annuler la partie de transaction qui a eu lieu après ce point, il suffit d'utiliser la fonction [HTransactionRetourneAuPointDeSauvegarde](../WDLang4/1410087842.md). 
...
et le tour est joué ! 
		...
		En version 27 la fonction [HExporteJSON](../WDLang4/1000021964.md) permet également d'exporter le fichier de données ou la requête vers un type JSON du WLangage, et plus obligatoirement vers un fichier sur disque. 
...
- Nouvelle fonction WLangage [hClusterNoeudMaître](../WDLang4/1410087885.md) pour connaître le maître du cluster 
...
<a name="tests_automatiques"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD%20-%20Test%20unitaire%20depuis%20bandeau%20copie%20PP.jpg)
...
La fonction WLangage [TestVérifie](../WDLang1/1000017023.md) permet de s'assurer que le résultat d'un test unitaire est correct. 
En version 27, lors d'un échec de la fonction [TestVérifie](../WDLang1/1000017023.md), le test s'arrête automatiquement dans le débogueur sur l'itération en cours : vous savez quel est le jeu de données qui était utilisé pour le test (itération en cours), le débogage est plus simple. 
...
[Brochure des nouveautés 27 : nouveautés WINDEV Mobile](../Presentation/9500008.md)
