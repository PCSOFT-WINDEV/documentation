...
Pour plus de détails, consultez [Le champ Kanban](../WDChamp/1410087203.md). 
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ%20Kanban%20_%20Les%20Cartes.png)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ%20Kanban%20-%20Les%20Cartes%203.png)<br>![Les cartes Kanban sont totalement personnalisables. Ce sont des Fenêtres ou des Pages internes](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ%20Kanban%20_%20Les%20Cartes%202.png)
...
Pour plus de détails, consultez [Le champ Kanban](../WDChamp/1410087203.md). 
		...
		Typiquement, les informations d'un Kanban sont stockées dans une table.
Le format des données est totalement libre.
Concernant la structure d'une table de tâches, il faut simplement prévoir les rubriques devant contenir les informations du tableau Kanban:
...
Un exemple complet est livré, utilisant une table HFSQL.
...
Pour gérer le contenu d'un Kanban, un nouveau type natif fait son apparition en WLangage, le type [kbCarte](../WDLang1/1410089167.md).

Le type [kbCarte](../WDLang1/1410089167.md) contient les propriétés suivantes:
...
Pour plus de détails, consultez [Fonctions de gestion des champs Kanban](../WDLang1/1410089375.md). 
...
Pour plus de détails, consultez [Evénements associés à un champ Kanban](../WDChamp/1410087205.md). 
		...
		Pour faciliter le filtrage dans un Kanban, la nouvelle fonction [KanbanFiltre](../WDLang1/1410089534.md) fait son apparition dans le WLangage en version 28.
...
Par exemple le mode d'utilisation sur téléphone en mode vertical tient compte de la faible largeur de l'écran.
		...
		Un Kanban existant peut être exporté sous la forme d'une image PNG par programmation à l'aide de la nouvelle fonction WLangage [KanbanVersImage](../NonDocumente/1410089138.md).
...
Ce type de graphe est principalement utilisé pour comparer des objectifs ou des parts de marché, ou illustrer une progression. La valeur n'est pas représentée par la largeur de la part, mais par sa longueur.<br>![Un graphe Aire Polaire](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Graphe%20aire%20polaire.jpg)
...
- ...
		...
		Les nouvelles fonctions WLangage [MarkdownVersDocx](../WDLang1/1410089153.md), [MarkdownVersPDF](../WDLang1/1410089119.md) et [MarkdownVersHTML](../WDLang1/1410088874.md) permettent la conversion des textes Markdown vers ces formats.
...
C'est l'objet de la propriété [Note](../Proprietes/2510085.md), qui permet de stocker des chaînes.
En version 28, la nouvelle propriété [Extra](../Proprietes/1410089327.md) permet, elle, de stocker des couples "clé/valeur" de tout type afin de stocker des informations plus structurées que de simples chaînes: des objets, un enregistrement, une requête...
...
La fonction WLangage [ChangeFenêtreSource](../WDLang1/3038053.md) supporte le nouveau paramètre "chaîne vide".
...
L'utilisateur final saisit les informations, puis imprime ou sauvegarde le formulaire.<br>![Un formulaire PDF à saisir](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-Champ-PDF-Programmation-PDF-Editeur-d-Etat.png)
...
L'OCR s'effectue sur une zone spécifiée par l'utilisateur final.<br>![La fonction OCR automatique permet par exemple de récupérer un IBAN présent sous forme d'image pour le copier/coller.](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=OCR%20PDF%20yacht.jpg)
...
La vitesse de génération est 2 à 25 fois plus rapide en version 28, selon la taille des documents.
		...
		<br>![Selon le niveau de qualité choisi, la taille du fichier PDF varie](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Qualite%20PDF%20parametrable.png)
...
Le nouveau paramètre Qualité de la fonction WLangage [pdfSauve](../WDLang1/1000024898.md) permet de fixer ce taux: Automatique, Elevée, Moyen et Faible.
...
<br>![L'utilisateur final connaît l'état de la signature du PDF](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Signature%20PDF.png)
...
Le nouveau type [pdfSignet](../WDLang6/1410089195.md) et ses nouvelles propriétés Titre et NuméroPage, la nouvelle propriété Signet, et la nouvelle fonction WLangage [LecteurPDFAfficheSignet](../WDLang1/1410089202.md) font leur apparition dans ce but.
...
<a name="editeur_d_analyses_schema_des_donnees"></a>
		...
		ÉDITEUR DE SCHÉMAS DES DONNÉES SCHÉMA DES DONNÉES
	

	
		 
	
		Edition des tables (table) facilitée: nouvelle fenêtre "7 onglets" plus riche
	

	
		Dans l'Éditeur de schémas des données, la description des propriétés d'une Table a été revue et simplifiée: cette description bénéficie maintenant d'une meilleure UX via les 7 onglets.<br>![Un des onglets de la description de Table](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX-Analyse-Edition%20des%20tables.png)
		...
		Modifications sur une sélection de tables (tables)
	

	
		En version 28, l'Éditeur de schémas des données permet de sélectionner un ensemble de tables pour effectuer une modification sur cet ensemble en une seule manipulation.
Il n'est plus nécessaire de répéter les manipulations sur chaque description.
		...
		Duplication d'une description de rubrique: dans une même table, dans une autre table (table)
	

	
		La duplication d'une description de rubrique est disponible, à la fois dans une même table (la même table) et entre tables (tables) différentes.
		...
		Dans l'Éditeur de schémas des données, les rubriques sont maintenant précédées d'une icône représentative, et leur graisse indique leur type: clé primaire, unique...<br>![Le choix est plus visuel](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX-Analyse-Icones%20representatives.png)
...
En version 28, cette recompilation (migration automatique en version 28) s'effectue 2 fois plus rapidement.
		...
		<br>![L'éditeur WDSCRIPT livré en standard permet de saisir, exécuter et sauver du code WLangage](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-console-WL.png)
...
Les scripts permettent de créer facilement des traitements batch.
		...
		<br>![Les nouveaux toasts](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notification%20Automatic%20Update.jpg)
Lorsqu'une nouvelle version de l'environnement est disponible sur le site de PC SOFT, l'environnement lui-même vous prévient et vous propose la mise à jour: un toast s'affiche.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notifications%20Plus%20Lisibles.jpg)
...
En version 28, l'appui sur la touche 0 du pavé numérique permet de visualiser les règles de magnétisme utilisées.
		...
		<br>![Des poignées faciles à saisir](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Poignes%20Ergonomiques.png)
...
En version 28, l'édition de cette image depuis l'onglet Style est facilitée par la présence d'un bouton d'édition.<br>![Editez directement l'image](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=7%20onglets%20-%20%E9diter%20image%20PP.jpg)
...
En version 28, l'environnement détaille précisément la raison de ce grisage.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD%20-%20Edition%20champ.png)
...
A chaque fois que cela est possible, une image de la base de données est utilisée.<br>![La gestion des images devient plus visuelle dans les 7 onglets](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Aper%E7u%20r%E9el%20modes%20image.png)
...
Les styles sont présentés par ordre d'intérêt.
		...
		En version 28, le catalogue d'images permet de modifier directement une image sélectionnée: recadrer, changer les couleurs, ajouter du texte, etc.<br>![L'image sélectionnée peut être directement modifiée](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Catalogue%20d'images%20-%20Editer%20l'image.jpg)
...
<a name="securite_par_mot_de_passe_groupware_utilisateur"></a>
		...
		<br>![La nouvelle fenêtre de login par défaut](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-LoginGroupware1.png)
...
<a name="gds_gestionnaire_de_sources_collaboratif"></a>
		...
		Amélioration du DIFF et du merge de schéma des données (schémas des données)
...
Pour plus de détails, consultez: [Le volet "Hashtags du code"](../Editeurs/2027039.md). 
...
Pour plus de détails, consultez: [RegexVérifie](../WDLang1/1000026273.md). 
...
<a name="debogueur"></a>
		...
		Schéma des données des durées de traitement en temps réel et sur fichier de log
	

	
		<br>![La barre orange met en évidence un blocage](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Extrait%20thread.png)
...
Pour plus de détails, consultez [Analyseur Temps Réel (ATR)](../Editeurs/9500237.md). 
		...
		Le schéma des données des logs d'exécution devient plus aisé en version 28:
...
- Un mode interactif de schéma des données des logs fait son apparition: affichage de courbes, etc.
...
La fonction WLangage [RécupèreDéfinition](../WDLang1/1000019333.md) permet maintenant également de connaitre le prototype complet d'un état: liste des paramètres et leur type.
...
<a name="intelligence_artificielle"></a>
		...
		La nouvelle fonction d'intelligence artificielle [IADétecteContour](../WDLang6/1410089109.md) détecte les contours d'une image.
La fonction renvoie un tableau de polygones de l'ensemble des formes qui ont été détectées dans l'image.<br>![L'IA détecte les contours](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-Detection-de-contours-2.jpg)
...
<a name="analyse_ralentissement"></a>
		...
		SCHÉMA DES DONNÉES DES RALENTISSEMENTS D'APPLICATION EN TEMPS REEL OU SUR FICHIER DE LOG
...
Pour plus de détails, consultez [Analyseur Temps Réel (ATR)](../Editeurs/9500237.md). 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Extrait%20thread%20en%20temps%20r%E9el.png)
...
Le schéma des données du code permet de trouver l'origine d'un ralentissement.
...
Pour plus de détails, consultez [Analyseur Temps Réel (ATR)](../Editeurs/9500237.md). 
		...
		Un schéma des données en temps réel ou sur fichier de log
	

	
		Le schéma des données s'effectue au choix selon 3 modes:
...
L'écriture dans le fichier de log se gère par programmation ([dbgActiveLog](../WDLang1/1000017137.md)).
...
Pour plus de détails, consultez [Chaînes de caractères](../Motscles/1514044.md).
...
Vos fonctions apparaissent dans l'assistance de code du type ciblé.<br>![Votre fonction apparaît (en vert) dans la complétion](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD%20-%20RemplaceTabPar4Espaces.png)
Note: ces fonctions existent également en syntaxe historique.
		...
		Le nouveau type avancé [FichierDisque](../WDLang1/1410088883.md) permet de manipuler de manière élégante (sans gérer de numéro de handle!) des fichiers sur disque: fichier binaire, fichier de paramètres, fichier texte...
...
Le type [FichierDisque](../WDLang1/1410088883.md) propose également de gérer les fichiers temporaires.
...
Le lecteur d'email du destinataire pourra ainsi proposer d'ajouter ce rendez-vous dans l'agenda du destinataire.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ajout%20RDV.png)
...
Pour plus de détails, consultez [Fonctions SCP](../WDLang3/1410089311.md).
...
Les fonctions WLangage [Proxy](../WDLang3/3043002.md), [SocketProxy](../WDLang3/1410088761.md) et [FTPProxy](../WDLang3/1000019366.md) permettent de paramétrer l'adresse du Proxy Socks 5.
...
- la fonction [dRotation](../WDLang1/3029024.md) propose une option pour adapter la taille après rotation.

- la fonction [dModifieContraste](../WDLang1/1410088872.md) fait son apparition.
...
La fonction se base sur un algorithme Homéomorphique.<br>![L'image est redressée](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD-Nouvelle-Fonction-Redresse.png)
...
Les nouvelles fonctions WLangage [ComposantCharge](../WDLang1/3014023.md) et [ComposantExécute](../WDLang1/1410089107.md) feront votre bonheur!
Combinée avec la gestion des interfaces POO, cette nouveauté permet une architecture plus formalisée.
		...
		La nouvelle fonction WLangage [GénèreImageGéométrique](../WDLang1/1410088705.md) génère une image aléatoire contenant des formes simples géométriques afin, par exemple, de remplir le champ "photo" d'un utilisateur et ne pas le laisser vide tant qu'il n'a pas fourni sa propre photo.<br>![Plutôt que laisser une photo non choisie "vide", 
il est possible de générer une image géométrique dans le champ](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WX-Generation-Image-geometrique.png)
...
Brésil: CNPJ, CPF
		...
		La nouvelle fonction [IBANValide](../WDLang1/1410089019.md) permet de vérifier qu'un IBAN passé en paramètre est valide.
Cela évite de lancer une recherche sur un numéro incorrect.
Attention: cela ne signifie pas que le compte existe.
		...
		La nouvelle fonction PicCaptureLasso active le lasso sur l'écran, récupère le résultat de la sélection, effectue un OCR sur cette sélection, et renvoie le texte résultant.<br>![Lancez un OCR sur une zone](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=OCR%20PDF.png)
...
En version 28, lorsqu'une description externe est invalide, une erreur de compilation le signale.
		...
		La fonction [DemandeMiseAJourUI](../WDLang1/1000023899.md) permet de déclencher par programmation l'événement "Demande de mise à jour de l'affichage de la fenêtre".
...
- elle fonctionne en syntaxe préfixée.
		...
		La nouvelle fonction [ExécuteThreadPrincipalAsynchrone](../WDLang1/1410088684.md) permet d'appeler le thread principal sans attendre que celui-ci réponde.
...
<a name="webservices"></a>
		...
		Les Webservices SOAP et REST créés avec WINDEV peuvent générer à la demande des logs d'exécution grâce à la fonction [dbgActiveLog](../WDLang1/1000017137.md).
...
<a name="iot"></a>
		...
		La nouvelle fonction [ModbusEnvoieTrameBrute](../WDLang3/1410089145.md) permet d'envoyer un buffer "brut" à un périphérique Modbus.
...
La version 28 permet de définir une clé primaire. Par exemple, un identifiant auto est en général une clé primaire.
		...
		La fonction WLangage [HExécuteRequêteAsynchrone](../WDLang4/1000026094.md) a bénéficié d'une augmentation impressionnante de ses performances.
La vitesse de traitement augmente!
		...
		La fonction [HSurveille](../WDLang4/1000022407.md) permet à une application d'être avertie lorsqu'une modification effectuée par une autre application se produit sur la table spécifiée.
...
Il est toujours possible d'utiliser un compte administrateur sans mot de passe en le spécifiant explicitement dans la recette Docker.
		...
		La fonction WLangage [HSimuleRéseau](../WDLang4/1000018954.md) permet de simuler la vitesse d'un réseau lors des tests d'une application.
...
Cette vérification schéma des données les requêtes et signale les éventuelles clés manquantes pour obtenir les meilleures performances possibles.
...
Cette nouveauté est disponible pour les bases: MS SQL Server, Oracle, MySQL, Sybase, Progress, Informix, DB2, SQLite, MariaDB.
		...
		L'import simultané de plusieurs tables dans le Schéma des Données (Schéma des Données) dépose les tables de manière séquentielle.
...
Pour plus de détails, consultez l'aide des variables [httpRequête](../WDLang3/1000021158.md).
...
<a name="blockchain"></a>
		...
		La nouvelle fonction WLangage [BitcoinAdresseValide](../WDLang1/1410088858.md) permet de savoir si une adresse bitcoin (adresse BTC qui permet de désigner la destination d'un paiement en Bitcoins) est valide.
...
Pour plus de détails, consultez l'aide de la fonction [PiloteDnD](../WDLang1/1410088663.md). 
...
La nouvelle fonction [MongoExécuteLotOpérations](../WDLang4/1410089189.md) et les types de la famille [mongoOpération](../WDLang4/1410089157.md) permettent ce traitement par lots.
...
[Brochure des nouveautés 28 : Nouveautés WINDEV](../Presentation/9500011.md)
