...
- Saisie d'email avec jetons. 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB-Champ-Metier-Iframe-PDF%20BIS.gif&type=thumb)
...
Comme il s'agit d'un Champ Métier, le code source est livré et totalement modifiable et paramétrable. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB-Champ-Metier-Combo-Quantite-Amazon-Passant-En-Mode-Saisie.gif&type=thumb)
...
Tous les éléments sont paramétrables. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB-Champ-Metier-Agenda-Timeline.gif&type=thumb)
...
<a name="nouveau_champ_editeur_de_diagrammes_web"></a>
...
En version 27, la rotation des champs est visible directement dans l'éditeur de pages. <br>![Les champs inclinés sont visualisés dans l'éditeur de pages](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB-Rotation-des-champs-Edition.jpg)
...
Il suffit d'utiliser les propriétés [LargeurRessource](../Proprietes/1000020110.md) et [HauteurRessource](../Proprietes/1000020109.md), LargeurDate et HauteurDate. <br>![Un champ Planning avec WEBDEV 27](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20Planning%20Hauteur%20ressource%20par%20prog.gif)
...
<a name="11_nouveautes_incontournables_sur_les_tables_webdev"></a>
...
Ces pages sont proposées à la création de page vierge. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20Page%20pr%E9d%E9finie.gif)
...
<a name="editeur_de_pages_plus_rapide"></a>
...
Il est possible d'éditer le champ directement depuis cette liste. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20RWD%20fen%20toutes%20les%20surcharges.jpg)
...
La notion de Cluster permet d'installer autant de serveurs d'application que désiré, et ainsi de répartir la charge du site entre ces serveurs. 
		...
		L'installation d'un cluster est simple, elle s'effectue en 4 étapes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Serveur%20Application%20Cluster.gif)
...
<a name="saas"></a>
		...
		L'administrateur du SaaS devient mobile friendly : administrez votre SaaS depuis un téléphone ! <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM-SaaS-Mobile.png)
...
Une fois une forme détectée, votre site peut proposer les traitements de votre choix : éditer l'image, la sauvegarder, la recadrer, la rechercher... <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB-Reconnaissance-de-forme_Avatar.png)
		...
		La fonction [PageAdresse](../WDLang2/3058010.md) propose une nouvelle constante paComplèteAuto qui renvoie l'URL avec le protocole utilisé pour son affichage : http ou https. 
...
| [EmailExporteHTML](../WDLang3/1000026173.md) | [géoRécupèreAdresse](../WDLang3/1000019797.md) | [HClusterNoeudMaitre](../WDLang4/1410087885.md) |
...
| [PDFRécupèreDateSignature](../WDLang6/1410088121.md) | [PythonAjouteChemin](../WDLang6/1410088169.md) | [PythonExécute](../WDLang6/1410088102.md) |
| [PythonInitialise](../WDLang6/1410088100.md) | [PythonTermine](../WDLang6/1410088101.md) | [RedisAffecte](../WDLang4/1410088170.md) |
| [RedisRécupère](../WDLang4/1410088171.md) | [RegexCherche](../WDLang1/1000026274.md) | [RegexRemplace](../WDLang1/1000026275.md) |
| [WebserviceEcritCodeHTTPPersonnalisé](../WDLang3/1410087803.md) | [XMLVersJSON](../WDLang5/1410087331.md) |   |
...
<a name="wlangage_navigateur"></a>
		...
		En version 27, la fonction WLangage [PageAffiche](../WDLang2/3058008.md) est disponible en code Navigateur. Cela simplifie la programmation.
...
- [TableInfoXY](../WDLang1/3074007.md) : Renvoie pour une position donnée dans un champ Table soit le nom de la colonne affichée pour la position indiquée, soit l'indice de la ligne ou de la colonne pour la position indiquée.

- [WebSocketClientConnecte](../WDLang3/1410087751.md) : Se connecte à un serveur de WebSocket

- [WebSocketClientConnecteSSL](../WDLang3/1410087752.md) : Se connecte à un serveur de WebSocket sécurisé.
...
<a name="json"></a>
		...
		Les nouvelles fonctions WLangage [JSONVersXML](../WDLang1/1410087330.md) et [XMLVersJSON](../WDLang5/1410087331.md) disponibles en code Serveur permettent de convertir facilement le Json et le XML d'un format à l'autre.
...
| --- | --- | --- |
| [ChaîneSupprimeDoublon](../WDLang1/1410087412.md) | [ChaîneVersNumérique](../WDLang1/1410087852.md) | [dFlou](../WDLang1/1410088153.md) |
| [EmailExporteHTML](../WDLang3/1000026173.md) | [géoRécupèreAdresse](../WDLang3/1000019797.md) | [HTMLDésencadreTousLesFils](../WDLang5/1410087613.md) |
| [HTMLEncadre](../WDLang5/1410087611.md) | [HTMLEncadreTousLesFils](../WDLang5/1410087612.md) | [HTMLInsèreAprès](../WDLang5/1410087610.md) |
| [HTMLInsèreAvant](../WDLang5/1410087609.md) | [HTMLInsèreDernierFils](../WDLang5/1410087616.md) | [HTMLInsèrePremierFils](../WDLang5/1410087615.md) |
| [HTMLModifieAttribut](../WDLang5/1410087618.md) | [HTMLSupprime](../WDLang5/1410087614.md) | [HTMLSupprimeAttribut](../WDLang5/1410087619.md) |
| [HTMLSupprimeFils](../WDLang5/1410087617.md) | [HTransactionPointDeSauvegarde](../WDLang4/1410087841.md) | [HTransactionRetourneAuPointDeSauvegarde](../WDLang4/1410087842.md) |
| [IADétecte](../WDLang6/1410087942.md) | [IAModèleDétecte](../WDLang6/1410087982.md) | [JSONVersXML](../WDLang1/1410087330.md) |
| [LuhnCalcule](../WDLang1/1410087276.md) | [LuhnVérifie](../WDLang1/1410087277.md) | [PDFAjouteFiligrane](../WDLang6/1410087843.md) |
| [PDFAjouteImage](../WDLang6/1410087847.md) | [PDFNbSignature](../WDLang6/1410088119.md) | [PDFRécupèreDateSignature](../WDLang6/1410088121.md) |
| [PythonAjouteChemin](../WDLang6/1410088169.md) | [PythonExécute](../WDLang6/1410088102.md) | [PythonInitialise](../WDLang6/1410088100.md) |
| [PythonTermine](../WDLang6/1410088101.md) | [RedisAffecte](../WDLang4/1410088170.md) | [RedisRécupère](../WDLang4/1410088171.md) |
| [RegexCherche](../WDLang1/1000026274.md) | [RegexRemplace](../WDLang1/1000026275.md) | [SocketConnecteSSL](../WDLang3/1000017042.md) |
...
- l'ouverture des pages référençables depuis des pages non référençables doit être effectuée soit par un lien, soit par un bouton de type "lien" ou soit à l'aide de la propriété **Url**, et non pas par l'appel de la fonction [PageAffiche](../WDLang2/3058008.md) en code serveur
