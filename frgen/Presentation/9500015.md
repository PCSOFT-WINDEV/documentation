...
- Signature tactile.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20CM%20FAQ.png)
...
Bien entendu la liste des FAQ peut être dynamique et provenir d'une base de données.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20CM%20Cartes%20d%E9filantes.png)
Le Champ Métier "Cartes défilantes" permet de faire défiler des contenus présents dans les plans d'une cellule.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB-Champ-metier-upload-attente-carre.png)
...
L'upload est annulable par fichier.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20Signature%20tactile.png)
...
Le choix "TOUT REFUSER" est systématiquement proposé.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20champ%20metier%20cookie.png)
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20CM%20Libell%E9%20%E9ditable.png)
...
Voir nouveautés 001 à 013.
		...
		Les types et les fonctions WLangage de la Visite Guidée ([VisiteGuidéeEtape](../WDLang6/1410090178.md), etc) sont disponibles en code Navigateur. 
...
Il est possible de regrouper les champs.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20Remplissage%20Auto%20Formulaires.png)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB-Remplissage-auto-de-formulaire-par-le-navigateur-3-choix.png)
...
Voir nouveauté 022.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_graphe%20waffle.png)
...
<a name="reseaux_sociaux_outils_de_communication"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=NavigateurPartage.png)
En version 2024, une nouvelle fonction [NavigateurPartage](../WDLang2/1410089642.md) permet d'ouvrir sur une fenêtre qui propose le partage d'un document ou d'un lien à travers les réseaux sociaux : Whatsapp, Messenger, Instagram, Mail, etc.
...
Voir Nouveautés 804 à 884.
		...
		Dans une procédure Serveur appelée depuis un code Navigateur, il est maintenant possible d'utiliser la fonction [PageAffiche](../WDLang2/3058008.md). 
La fonction [PageAffiche](../WDLang2/3058008.md) devient disponible partout.
...
La nouvelle propriété **SameSite** du type [Cookie](../WDLang3/1000019222.md) permet de lutter contre les attaques pirates de type XSRF (CSRF).
...
Pour plus de détails, consultez [WEBDEV et Tailwind CSS](../Editeurs/1410086657.md). 
		...
		Pour utiliser Tailwind CSS avec WEBDEV 2024, il suffit d'activer l'option dans le projet !<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=tailwind_option.png)
...
Les fonctions WLangage [AjaxExécute](../WDLang2/3055114.md) et [AjaxExécuteAsynchrone](../WDLang2/3055115.md) des précédentes versions deviennent inutiles, mais sont bien entendues conservées par compatibilité. 
Voir Nouveauté 910.
...
Note : lorsque ce nombre est à zéro, cela veut dire qu'il n'y a pas d'appel à cette procédure dans le code Navigateur du projet. Dans ce cas pour éviter les appels malveillants, le Serveur d'Application refuse les appels directs à cette procédure depuis le navigateur.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB%20-%20bandeau%20Ajax%20nbre%20d%20appels.png)
...
<a name="awp"></a>
		...
		Les nouvelles fonctions WLangage [PageEcritCodeHttp](../WDLang2/1410090194.md) et [PageEcritCodeHttpPersonnalisé](../WDLang2/1410090195.md) permettent de renseigner le code HTTP personnalisé qui sera retourné lors de l'appel AWP.
...
depuis un code Navigateur.
		...
		En version 2024, depuis un code Navigateur, l’appel d’une procédure Serveur ne nécessite plus de passer par la fonction [AjaxExécute](../WDLang2/3055114.md) ou [AjaxExécuteAsynchrone](../WDLang2/3055115.md).
...
Dans l’éditeur de code, une icone indique que l’appel est effectué sur une procédure Serveur et non pas une procédure Navigateur.
		...
		Les anciennes versions de WEBDEV nécessitaient d’utiliser la fonction WLangage [AjaxExécute](../WDLang2/3055114.md) pour qu’une procédure Serveur s’exécute en Ajax. Il n’était possible de passer que des chaines en paramètres, et de ne récupérer que des chaines en valeur de retour.
...
|   |   |
| --- | --- |
| [NavigateurPartage](../WDLang2/1410089642.md) | Lance le partage natif de l'appareil. |
