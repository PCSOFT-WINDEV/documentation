...
L'onglet "Contrôle" de WDADMINEXE permet de gérer l'état de l'application et les messages affichés selon l'état de l'application : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDAdminExe%20-%20HC%20N%B0001.gif)
...
Les options de durée des contrôles sont les suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDAdminExe%20-%20HC%20N%B0001%201.gif)
...
L'onglet "Contrôle" de WDADMINEXE permet de gérer la vérification des mises à jour : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDAdminExe_2%20-%20HC%20N%B0001.gif)
