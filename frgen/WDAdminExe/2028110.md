...
<a name="deployer_push_sur_les_postes_clients_ELTPARAGRAPHE000106"></a>Pour déployer en push sur les postes clients :

1. Lancez WDAdminExe (voir ci-dessus).

2. Affichez l'onglet "Push" de la fenêtre principale : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDAdminExe_2%20-%20HC%20N%B0002.gif&type=thumb)
...
8. Cliquez sur "Lancer l'installation en PUSH..." pour déclencher l'installation.
	La fenêtre de lancement de l'installation s'affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDAdminExe_2%20-%20HC%20N%B0003.gif&type=thumb)
...
<a name="services_necessaires_sur_les_postes_cibles_ELTPARAGRAPHE000158"></a>**Remarque** : Selon les versions de Windows utilisées, les noms de ces services dans la panneau de configuration peuvent varier.
...
<a name="services_necessaires_sur_poste_realisant_installation_push_ELTPARAGRAPHE000170"></a>Sur le poste réalisant l'installation en mode Push, le service "Station de travail" ("lanmanworkstation") doit être démarré.
...
[Installations avec prise en charge du Push](../WDAdminExe/2028098.md)
