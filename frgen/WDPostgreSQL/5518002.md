...
## Remarques générales
<a name="remarques_generales_ELTTEXTE000320"></a>
...
<a name="utilisation_ordres_wlangage_dans_les_requetes_sql_ELTPARAGRAPHE000030"></a>
...
<a name="gestion_tables_donnees_taille_importante_ELTPARAGRAPHE000037"></a>
...
<a name="support_unicode_avec_les_fonctions_hfsql_ELTPARAGRAPHE000057"></a>
...
<a name="gestions_des_alphabets_avec_les_fonctions_sql_ELTPARAGRAPHE000090"></a>
...
### Certificats SSL
<a name="certificats_ssl_ELTPARAGRAPHE000107"></a>
...
<a name="specificites_generales_ELTTEXTE000374"></a>


### Blocage des enregistrements
<a name="blocage_des_enregistrements_ELTPARAGRAPHE000150"></a>
...
<a name="enregistrements_identiques_ELTPARAGRAPHE000157"></a>
...
<a name="rubriques_type_tableau_ELTPARAGRAPHE000166"></a>
...
<a name="indexation_partielle_des_memos_indexation_fulltext_ELTPARAGRAPHE000173"></a>

L'indexation partielle des mémos ainsi que l'indexation full-text ne sont pas prises en compte:

- lors de l'importation des tables PostgreSQL dans le schéma des données.
...
Si ces fonctionnalités sont définies dans le schéma des données, elles seront prises en compte uniquement lors de l'exécution de requêtes SQL (avec la constante *hRequêteSansCorrection*).
<a name="NOTE3_5"></a>


### Requêtes imbriquées
<a name="requetes_imbriquees_ELTPARAGRAPHE000188"></a>
...
<a name="specificites_pour_les_fonctions_hfsql_sql_ELTTEXTE000422"></a>
...
<a name="gestion_des_identifiants_automatiques_ELTPARAGRAPHE000220"></a>
...
```txt
ALTER SEQUENCE "MaTableDeDonnées_IdAuto_seq" RESTART WITH 5
```
...
<a name="ordres_sql_non_geres_ELTPARAGRAPHE000238"></a>
