...
Par exemple : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatPartieTableau.gif)
...
## Avantage
<a name="avantage_ELTTEXTE000137"></a>
...
## Exemples
<a name="exemples_ELTTEXTE000161"></a>
Quelques exemples d'états avec tableau :

- Bon de commande (tableau simple) :
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_overview1.gif&type=thumb)


- Liste de produits (tableau simple) : 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatListe2.gif&type=thumb)


- Ventes par année et par client (tableau croisé) : 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatTableaucroise2.gif&type=thumb)
...
[Créer un tableau dans un état](../WDChamp/1013052.md)
