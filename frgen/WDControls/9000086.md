...
## Présentation
<a name="presentation_ELTTEXTE000418"></a>
...
<a name="creation_modele_fenetres_ELTTEXTE000442"></a>
...
<a name="creer_modele_fenetres_ELTPARAGRAPHE000059"></a>Pour créer un modèle de fenêtres :
...
7. Sous le volet "Accueil", dans le groupe "Général", cliquez sur "Enregistrer" (ou cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif) parmi les boutons d'accès rapide).

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Mod%E8les%20de%20fen%EAtres%20-%20HC%20N%B0001.gif)
...
<a name="creer_modele_fenetres_partir_une_fenetre_existante_ELTPARAGRAPHE000105"></a>Pour créer un modèle de fenêtres à partir d'une fenêtre existante : 
...
<a name="appliquer_modele_fenetres_ELTTEXTE000478"></a>


### Créer une nouvelle fenêtre basée sur un modèle de fenêtres
<a name="creer_une_nouvelle_fenetre_basee_sur_modele_fenetres_ELTPARAGRAPHE000138"></a>Pour créer une nouvelle fenêtre basée sur un modèle de fenêtres : 
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Mod%E8les%20de%20fen%EAtres%20-%20HC%20N%B0002.gif)

<a name="NOTE3_2"></a>


### Appliquer un modèle sur une fenêtre existante
<a name="appliquer_modele_sur_une_fenetre_existante_ELTPARAGRAPHE000165"></a>Pour appliquer un modèle sur une fenêtre existante : 
...
### Remarques
<a name="remarques_ELTPARAGRAPHE000195"></a>
...
- Dans cette version : 
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) l'action bar du modèle n'est pas appliqué dans la fenêtre utilisant le modèle.
...
<a name="ouvrir_modele_associe_une_fenetre_ELTTEXTE000514"></a>
...
<a name="reporter_les_modifications_effectuees_sur_modele_ELTTEXTE000538"></a>
...
- directement depuis le modèle de fenêtres, en cliquant sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Modele_MAJ.gif) dans le bandeau orange du modèle. 
...
<a name="tester_modele_fenetres_ELTTEXTE000562"></a>
...
2. Cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_Go_Fenetre_WD_bl.gif) parmi les boutons d'accès rapide.
...
<a name="liste_des_modeles_utilises_ELTTEXTE000586"></a>
Pour afficher la liste des modèles utilisés pour une fenêtre, sous le volet "Fenêtre", dans le groupe "Modèles", déroulez "Modèles" et sélectionnez "Liste des modèles utilisés".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Modele_Liste%20-%20HC%20N%B0001.gif)
...
<a name="synchronisation_des_fenetres_des_modeles_fenetres_ELTTEXTE000610"></a>
...
## Exemple
<a name="exemple_ELTTEXTE000634"></a>
...
[Modèles de fenêtres et héritage](../WDChamp/9000087.md)
