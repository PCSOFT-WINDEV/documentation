...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Si un menu contextuel des FAA est disponible pour ce champ ou cette fenêtre, il est possible :
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Le menu contextuel s'adapte à l'appareil utilisé. 

	- sous iPhone, le menu contextuel s'affiche en bas de l'écran : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM-iOS-Menu%20Contextuel-iPhone.jpg)


	- sous iPad, les menus contextuels peuvent être affichés n'importe où : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM-iOS-Menu%20Contextuel-iPad.jpg)
...
1. Sous le volet "Fenêtre", dans le groupe "Barres et menus", déroulez "Menus contextuels" et sélectionnez "Nouveau menu contextuel". La fenêtre d'édition du nouveau menu contextuel personnalisé s'ouvre.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_contextuel_personnalis%E9%20-%20HC%20N%B0001.gif)
...
2. Modifiez si nécessaire la description du menu contextuel (nom du menu contextuel, ...) : 
	...
	- Sélectionnez l'option "Description du menu contextuel". Vous pouvez : 
		...
		- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Indiquer si le menu doit utiliser : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Indiquer le libellé du menu contextuel.

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Spécifier si le menu contextuel doit être déplacé dans l'action bar.
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Les menus contextuels ne peuvent avoir qu'un seul niveau de menu. Il n'est pas possible d'utiliser des sous-menus.

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Limites spécifiques : 

	- Les séparateurs ne sont pas disponibles. 

	- Les coches devant les options ne sont pas disponibles. 

	- Il n'est pas possible de modifier la couleur de fond et la couleur de texte par les propriétés [Couleur](../Proprietes/2510071.md) et [CouleurFond](../Proprietes/2510022.md).

	- La propriété [Grise](../Proprietes/1000019648.md) rend invisible les options. 




- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Limites spécifiques : 
...
3. Le champ "Menu contextuel" permet de paramétrer le menu contextuel :
	...
	- le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) permet de créer un nouveau menu contextuel.
...
- Pour éditer le menu contextuel personnalisé sélectionné, cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) à droite du champ "Menu contextuel" et sélectionnez l'option "Editer ce menu contextuel".
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Pour plus de détails sur le menu contextuel des FAA, consultez [Configurer les menus des FAA](../Editeurs/2010040.md).
...
- depuis l'onglet "UI" de la description d'une fenêtre ou d'un champ associé à ce menu contextuel :
	...
	- Cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) à droite du champ "Menu contextuel" et sélectionnez l'option "Editer ce menu contextuel".
