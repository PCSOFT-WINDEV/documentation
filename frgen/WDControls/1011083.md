...
Exemple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_Tableau_H.gif&type=thumb)


**Sources de l'état Tableau hiérarchique**
Les sources de l'état Tableau hiérarchique peuvent être: 

- un ou plusieurs tables,
...
<a name="creer_etat_type_tableau_hierarchique_ELTTEXTE000185"></a>
...
3. Si vous choisissez "D'une ou plusieurs tables", l'assistant permet de définir:

	- les fichiers qui serviront de source à l'état: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_TabH_Assistant.gif&type=thumb)


	- les rubriques à imprimer, leurs libellés et leurs blocs: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_TabH_Assistant_rub.gif&type=thumb)
...
6. Sélectionnez le thème à utiliser. 
...
### Remarques
<a name="remarques_ELTPARAGRAPHE000085"></a>
...
- L'onglet "Données" de la fenêtre de description de l'état permet de connaître et de modifier la source des données. Si l'état est basé sur: 
	...
	- des tables, les différents niveaux de la hiérarchie sont visibles et modifiables. 
...
[Etat sur un champ Table hiérarchique](../WDChamp/1011082.md)

[SélectionSeule (Propriété)](../WDChamp/2511017.md)

[ConserverHiérarchieVisible (Propriété)](../WDChamp/1000021055.md)

[ProfondeurHiérarchique (Propriété)](../WDChamp/1000021027.md)
