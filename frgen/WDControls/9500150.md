...
<a name="champ_saisie_type_jetons_texte_ELTTEXTE000281"></a>
...
Lorsqu'un grand nombre de possibilités de choix multiples (par exemple sélectionner plusieurs couleurs parmi des dizaines) est offert à l'utilisateur final, le champ à jetons est un moyen aisé de présenter ces choix de manière synthétique. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Jeton%20-%20HC%20N%B0003.gif)
...
<a name="fonctionnement_champ_saisie_jetons_execution_ELTPARAGRAPHE000030"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Si la multisélection est activée, l'utilisateur peut sélectionner plusieurs jetons via la touche Ctrl.




![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **FAA (Fonctionnalités automatiques de vos applications)**
Plusieurs FAA sont disponibles via le menu contextuel des jetons :

- Modifier : Permet d'éditer le texte d'un jeton pour le modifier. 

- Couper : Permet de copier le texte du jeton et de supprimer le jeton. 
	Si la multisélection est possible, cette option coupe tous les jetons sélectionnés.

- Copier : Permet de copier le texte d'un jeton. 
	Si la multisélection est possible, cette option copie tous les jetons sélectionnés.

- Tout copier : Permet de copier le texte de tous les jetons. 

- Coller : Permet de coller le ou les jetons précédemment copiés ou le texte présent dans le presse-papiers. 
...
<a name="caracteristiques_champ_saisie_type_jetons_texte_ELTTEXTE000311"></a>


### Créer un champ de saisie de type Jetons de texte
<a name="creer_champ_saisie_type_jetons_texte_ELTPARAGRAPHE000084"></a>Pour créer un champ de saisie de type Jetons de texte : 
...
**Remarque** : Il est également possible de créer un champ de saisie de type Jetons de texte à partir d'une liste de champs prédéfinis livrés en standard en déroulant "Saisie" (sous l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_saisie.gif)). La liste des champs disponibles avec leur aperçu au gabarit du projet apparaît. Il suffit de cliquer sur "Saisie jetons" ou "Saisie eMail à jetons" pour créer un champ de saisie de type Jetons de texte dans l'éditeur.


### Options spécifiques au champ de saisie de type Jetons de texte
<a name="options_specifiques_champ_saisie_type_jetons_texte_ELTPARAGRAPHE000107"></a>La fenêtre de description du champ de saisie de type Jetons de texte permet de définir : 
...
L'onglet "Général" de la fenêtre de description du champ propose les options suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Jeton%20-%20HC%20N%B0001.gif)
...
- **Jetons multi-sélectionnables** : Permet de réaliser une multi-sélection des jetons (via la touche Ctrl par exemple). Cette option est manipulable par programmation grâce à la propriété [Multisélection](../Proprietes/1000017054.md).




L'onglet "Détail" permet de définir toutes les options de saisie des champs de saisie avec jeton. Les options "Est source" et "Est cible" permettent notamment de gérer le Drag and Drop automatique des jetons. Pour plus de détails sur le Drag and Drop automatique, consultez [Drag and Drop automatique](../WDLang1/3030012.md).
Remarque : Lors du Drag et Drop d'un jeton, l'événement "A chaque modification du champ" est exécuté.  

L'onglet "Style" de la fenêtre de description du champ permet de définir : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Jeton%20-%20HC%20N%B0002.gif)
...
<a name="manipuler_champ_saisie_type_jetons_texte_par_programmation_ELTTEXTE000341"></a>


### Evénements associés
<a name="evenements_associes_ELTPARAGRAPHE000181"></a>En exécution, l'utilisateur peut ajouter, supprimer ou sélectionner des jetons dans un champ de saisie. 
...
<a name="fonctions_proprietes_wlangage_associees_ELTPARAGRAPHE000202"></a>Pour manipuler un champ de saisie de type Jetons de texte par programmation, le WLangage met à votre disposition : 
...
<a name="ajouter_des_jetons_dans_saisie_assistee_ELTPARAGRAPHE000223"></a>Il est possible d'ajouter une liste de jetons dans la saisie assistée grâce à la fonction [SaisieAssistéeAjoute](../WDLang1/1000020043.md). 
...
[Fonctions de gestion des jetons](../WDChamp/1000024042.md)

[Fonctions de gestion des jetons (syntaxe préfixée)](../WDChamp/1000024048.md)

[Jeton (Type de variable)](../WDChamp/1000023942.md)

[Jeton (Propriété)](../WDChamp/1000023976.md)

[JetonActif (Propriété)](../WDChamp/1000023782.md)

[JetonAutoriseDoublon (Propriété)](../WDChamp/1000023784.md)

[JetonListeSéparateur (Propriété)](../WDChamp/1000023783.md)

[JetonSupprimable (Propriété)](../WDChamp/1000024025.md)
