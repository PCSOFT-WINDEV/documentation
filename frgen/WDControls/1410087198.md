...
<a name="effectuer_une_recherche_dans_document_une_modification_sur_resultat_recherche_ELTPARAGRAPHE000260"></a>Pour effectuer une recherche dans un document Traitement de texte, il suffit d'utiliser la fonction [&lt;Traitement de texte&gt;.Recherche](../WDLang1/1000024271.md). 
...
<a name="manipuler_selection_ELTPARAGRAPHE000298"></a>Pour manipuler la sélection actuellement réalisée dans un champ Traitement de texte, il est possible de récupérer cette sélection dans une variable de type [docFragment](../WDLang1/1000022482.md). 
...
<a name="ajouter_texte_dans_document_ELTPARAGRAPHE000324"></a>**Pour ajouter du texte dans un document existant**, il existe plusieurs méthodes : 
...
<a name="ajouter_saut_page_dans_document_ELTPARAGRAPHE000388"></a>Pour ajouter par programmation un saut de page dans un document, il suffit d'utiliser le code suivant : 
...
### Gestion des signets
<a name="gestion_des_signets_ELTPARAGRAPHE000425"></a>Il est possible de gérer les signets dans un document de type Traitement de texte. Quelques exemples : 
...
<a name="enchainer_des_etats_des_documents_type_traitement_texte_ELTPARAGRAPHE000455"></a>De la même manière qu'il est possible d'enchaîner des états, il est également possible d'enchaîner des états et des documents de type Traitement de texte. 
...
<a name="proprietes_associees_champ_traitement_texte_ELTPARAGRAPHE000478"></a>Les propriétés suivantes sont spécifiques au champ Traitement de texte. Elles permettent essentiellement de manipuler les caractéristiques du champ : 
...
[Fonctions de gestion du champ Traitement de texte (syntaxe préfixée)](../WDChamp/1000024544.md)
