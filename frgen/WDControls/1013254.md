...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) ***une valeur renvoyée spécifique***. Cette valeur renvoyée est spécifiée dans l'onglet "Contenu" de la fenêtre de description du champ.


![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Utiliser la numérotation ou les valeurs renvoyées ?**
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Remarque** : Plusieurs fonctions WLangage permettent d'ajouter, d'insérer ou de supprimer des options dans un champ Sélecteur. Pour plus de détails, consultez [Fonctions de gestion des champs Sélecteur](../WDLang1/1000020616.md).
...
<a name="initialiser_choix_champ_selecteur_ELTTEXTE000403"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) la fonction [FichierVersEcran](../WDLang4/3044210.md). 

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) la fonction [FichierVersPage](../WDLang4/3044148.md).
...
<a name="afficher_champ_selecteur_sans_option_par_defaut_ELTPARAGRAPHE000085"></a>Par défaut, un champ Sélecteur est toujours positionné sur une position (1 par défaut).
...
<a name="recuperer_option_selectionnee_dans_champ_selecteur_ELTTEXTE000433"></a>


### Cas d'un champ Sélecteur renvoyant un entier
<a name="cas_champ_selecteur_renvoyant_entier_ELTPARAGRAPHE000106"></a>**Pour récupérer l'indice de l'option sélectionnée** dans le champ Sélecteur, utilisez la syntaxe suivante : 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) la fonction [EcranVersFichier](../WDLang4/3044146.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) la fonction [PageVersFichier](../WDLang4/3044022.md). 
...
<a name="cas_champ_selecteur_renvoyant_une_valeur_ELTPARAGRAPHE000145"></a>**Pour récupérer la valeur de l'option sélectionnée** dans le champ Sélecteur, utilisez la syntaxe suivante :
...
<a name="selon_prerempli_sur_les_champs_selecteur_ELTPARAGRAPHE000192"></a>Lors de la saisie sous l'éditeur de code de l'instruction SELON relative à un champ Sélecteur, l'éditeur de code ajoute automatiquement les CAS correspondant aux différentes options du champ Sélecteur. Le libellé de chaque option est ajouté automatiquement en commentaire de la ligne. 

Quelques exemples : 

- Code pour un champ Sélecteur renvoyant un entier : la saisie de "SELON SEL_Civilité" sous l'éditeur de code affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Selon_auto_Selecteur2.gif)


- Code pour un champ Sélecteur renvoyant une valeur : la saisie de "SELON SEL_PlatDuJour" sous l'éditeur de code affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Selon_auto_Selecteur1.gif)
...
<a name="modifier_libelle_champ_selecteur_ELTTEXTE000469"></a>
...
<a name="cas_des_champs_selecteur_avec_souslibelles_ELTPARAGRAPHE000238"></a>La propriété [SousLibellé](../Proprietes/1000017232.md) permet de connaître et de modifier les sous-libellés des options du champ Sélecteur.
...
<a name="modifier_les_couleurs_des_libelles_des_options_champ_selecteur_ELTTEXTE000499"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Pour modifier les couleurs des libellés des options d'un champ Sélecteur, il est possible d'utiliser la syntaxe suivante : 
...
<a name="proprietes_specifiques_aux_champs_selecteur_ELTTEXTE000523"></a>
...
[Manipuler un champ Sélecteur par programmation (syntaxe préfixée)](../WDChamp/1013321.md)
