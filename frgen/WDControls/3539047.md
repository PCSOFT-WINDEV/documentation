...
<a name="afficher_une_page_awp_parametree_depuis_une_page_webdev_par_programmation_ELTPARAGRAPHE000082"></a>![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) **Code serveur** : Pour afficher une page AWP paramétrée depuis une page WEBDEV par programmation, utilisez la fonction [PageAffiche](../WDLang2/3058008.md) :
...
```
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) **Code navigateur** : Pour afficher une page AWP paramétrée depuis une page WEBDEV par programmation, utilisez la fonction [FichierAffiche](../WDLang2/3012005.md). Dans ce cas, plusieurs cas sont possibles. 

1. **Affichage d'une page AWP depuis une page en mode Session**

	- Cas 1 : si la page à afficher est présente dans le site en cours, le nom de la page doit correspondre au chemin complet dans l'URL de la page suivi des paramètres à passer à la page.
			
		```wl
		FichierAffiche(RépertoireWeb() + "FR/PAGE_MaPage.AWP?P1=125&P2=Durand")
		```


	- Cas 2 : si la page à afficher est présente dans un autre site, le nom de la page doit correspondre à l'URL complète de la page suivie des paramètres à passer à la page.
			
		```wl
		FichierAffiche("http://MonSite/MonRep/FR/PAGE_MaPage.AWP?P1=125&P2=Durand")
		```
...
2. **Affichage d'une page AWP depuis une autre page AWP**

	- Cas 1 : si la page à afficher est présente dans le site en cours et dans la même langue, le nom de la page doit correspondre au chemin relatif de la page par rapport au répertoire de la langue. Le nom de la page est suivi des paramètres à passer à la page. 
			
		```wl
		FichierAffiche("PAGE_MaPage.AWP?P1=125&P2=Durand")
		```


	- Cas 2 : si la page à afficher est présente dans le site en cours, dans une langue différente, le nom de la page doit correspondre au chemin relatif de la page par rapport au répertoire de la langue d'origine. Le nom de la page est suivi des paramètres à passer à la page.
			
		```wl
		FichierAffiche("../FR/PAGE_MaPage.AWP?P1=125&P2=Durand")
		```


	- Cas 3 : si la page à afficher est présente dans un autre site, le nom de la page doit correspondre à l'URL complète de la page suivie des paramètres à passer à la page.
...
[PageVersEmail (Fonction)](../WDChamp/3058027.md)
