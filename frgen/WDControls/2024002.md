...
- [utiliser les fenêtres standard (fenêtres d'impression et visualisateur de rapports)](#NOTE2).

- [appliquer le gabarit du projet (fenêtres d'impression et visualisateur de rapports)](#NOTE3).

- [personnaliser les fenêtres (fenêtres d'impression et visualisateur de rapports)](#NOTE4).

- [utiliser des fenêtres spécifiques pour le visualisateur de rapport et pour l'impression](#NOTE5). 
...
Pour connaître les fenêtres utilisées par défaut, consultez [Personnalisation du visualisateur de rapports : Fenêtres disponibles](../WDChamp/9000162.md). 
<a name="NOTE2_2"></a>


### Utiliser les fenêtres standard d'impression
<a name="utiliser_les_fenetres_standard_impression_ELTPARAGRAPHE000043"></a>Pour utiliser les fenêtres standard d'impression dans votre projet :
...
3. Dans l'option "Visualisateur de rapports", sélectionnez l'option "Standard (sans thème)".
...
3. Dans l'option "Visualisateur de rapports", sélectionnez "Au thème du projet".
...
<a name="modifications_pouvant_etre_effectuees_dans_les_fenetres_impression_importees_ELTPARAGRAPHE000144"></a>Les fenêtres d'impression importées dans votre projet peuvent être manipulées comme n'importe quelle autre fenêtre de votre application.
...
- ***supprimer ces champs*** (touche Suppr). Les fonctionnalités correspondantes ne seront alors plus proposées à l'utilisateur.
	...
	- soit d'utiliser la fonction [iParamètreVisualisateur](../WDLang5/1000024634.md). Il est par exemple possible de paramétrer les options affichées pour tous les états à imprimer de l'application. 
...
- ***ajouter du code à ces champs*** (touche F2). Dans ce cas, le code WLangage saisi sera exécuté **après** le code WLangage créé dynamiquement par WINDEV.
	...
	- La fonction [Ferme](../WDLang1/3038018.md) ne doit pas être utilisée dans le code des champs du visualisateur de rapports personnalisé. 
...
Pour plus de détails sur le fonctionnement du visualisateur de rapports, consultez [Le visualisateur de rapports standard](../WDChamp/1011085.md).
...
<a name="applications_multilingues_ELTPARAGRAPHE000234"></a>Par défaut, toutes les fenêtres d'impression WINDEV gèrent le français et l'anglais. Pour gérer des langues supplémentaires dans ces fenêtres, il est nécessaire de personnaliser ces fenêtres.
...
[Personnalisation du visualisateur de rapports : Fenêtres disponibles](../WDChamp/9000162.md)
