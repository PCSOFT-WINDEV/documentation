...
<a name="principe_impression_dans_une_application_iphoneipad_mode_universal_windows_app_ELTTEXTE000166"></a>
...
3. Selon vos besoins, vous pourrez ensuite:
	...
	- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) imprimer le fichier PDF généré via le système d'impression iOS (fonction [iImprimePDF](../WDLang5/1000020519.md)).
...
- [l'impression par programmation d'un état sur table.](../WDChamp/1011052.md)
