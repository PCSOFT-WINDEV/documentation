...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Table_Ajax_detail.gif)
...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CErcle1.gif) | Les colonnes sont redimensionnables. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle2.gif) | Il est possible d'effectuer des recherches dans le champ via la loupe. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle3.gif) | Les colonnes sont triables. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle4.gif) | Le fond du bandeau de sélection peut correspondre à une image. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle5.gif) | Un ascenseur remplace automatiquement la réglette. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle6.gif) | Les cellules du champ Table peuvent être en saisie. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle7.gif) | Les lignes du champ Table sont en multisélection. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Cercle8.gif) | Les colonnes peuvent être ancrées.<br>Le champ Table peut avoir un ascenseur horizontal. |
...
- Liste de valeurs (combo)
	![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Ce type de données n'est pas disponible.
