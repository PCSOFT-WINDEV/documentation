...
2. Le champ Menu contextuel apparaît en édition dans l'éditeur. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0001.gif)
...
Les caractéristiques principales sont les suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0002.gif)


- Orientation du menu (Onglet "Général") : Les options sont les suivantes : 

	- **Vertical Popup** (par défaut) : Le sous-menu d'une option du menu contextuel s'affiche à droite de l'option parente. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0003.gif)


	- **Vertical Déroulant** : Le sous-menu d'une option du menu contextuel s'affiche en dessous de l'option parente. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0004.gif)
...
3. Le champ "Menu contextuel" permet de paramétrer le menu contextuel :
	...
	- le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Fleche.gif) permet de créer un nouveau menu contextuel. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0006.gif)


	- la combo permet de sélectionner directement le menu contextuel voulu. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0005.gif)
...
- Pour éditer le menu contextuel sélectionné, cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Fleche.gif) à droite du champ "Menu contextuel" et sélectionnez l'option "Editer ce menu contextuel".
...
- depuis l'onglet "UI" de la description d'une page ou d'un champ associé à ce menu contextuel :
	...
	- Cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Fleche.gif) à droite du champ "Menu contextuel" et sélectionnez l'option "Editer ce menu contextuel".
...
[Manipuler un champ Menu contextuel par programmation](../WDChamp/1410087243.md)

[Propriétés associées au champ Menu contextuel](../WDChamp/1410087223.md)

[Evénements associés à un champ Menu contextuel](../WDChamp/1410087219.md)

[Manipuler les options de menu WEBDEV](../WDChamp/1010042.md)

[Option de menu : opération effectuée et action](../WDChamp/1010044.md)

[Programmer un menu déroulant WEBDEV](../WDChamp/1010043.md)
