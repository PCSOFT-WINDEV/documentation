...
1. Spécifier le mode d'impression de l'état (impression directe, génération d'une page HTML, génération d'un fichier PDF, etc.) avec la fonction [iDestination](../WDLang5/3046074.md).
