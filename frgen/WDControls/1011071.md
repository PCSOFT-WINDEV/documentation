...
## Présentation
<a name="presentation_ELTTEXTE000435"></a>
...
<a name="visualiser_modifier_description_etat_ELTTEXTE000459"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000033"></a>
...
<a name="gestion_source_donnees_ELTPARAGRAPHE000048"></a>
...
- modifier la source de données de l'état (onglet "Données" de la description de l'état):<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Manipuler_un_%E9tat%20-%20HC%20N%B0001.gif)


	- soit en changeant le type de la source d'alimentation de l'état (passer par exemple d'un état sur requête à un état sur table ou sur une zone mémoire).
...
<a name="options_affichage_dans_visualisateur_rapports_ELTPARAGRAPHE000066"></a>

Le paramétrage des options d'affichage dans le visualisateur de rapports est réalisé dans l'onglet "UI" de la description de l'état. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Manipuler_un_%E9tat%20-%20HC%20N%B0002.gif)
Il est possible de:
...
- paramétrer le message d'attente affiché lors de la sélection et du tri des enregistrements.
	![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Cette option n'est pas prise en compte.
...
### Gestion des blocs
<a name="gestion_des_blocs_ELTPARAGRAPHE000085"></a>

Un état est constitué de différents blocs. Pour plus de détails sur la gestion des blocs, consultez [Blocs d'un état](../WDChamp/1011040.md).
...
L'onglet "Format" de la fenêtre de description de l'état permet de configurer: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Manipuler_un_%E9tat%20-%20HC%20N%B0004.gif)
...
L'onglet "Options" de la fenêtre de description de l'état permet de configurer: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Manipuler_un_%E9tat%20-%20HC%20N%B0005.gif)
...
### Image de fond
<a name="image_fond_ELTPARAGRAPHE000190"></a>

La majorité des types d'états peuvent être réalisés à partir d'un formulaire. L'onglet "Fond" permet de définir l'image utilisée en tant que formulaire dans l'état. Cette image pourra au choix être imprimée ou non avec l'état. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Manipuler_un_%E9tat%20-%20HC%20N%B0006.gif)
...
### Langue
<a name="langue_ELTPARAGRAPHE000207"></a>
...
<a name="ouvrir_fermer_enregistrer_etat_ELTTEXTE000525"></a>


### Ouvrir un état
<a name="ouvrir_etat_ELTPARAGRAPHE000244"></a>
...
- cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_ouvrir.gif) parmi les boutons d'accès rapide et sélectionnez "Ouvrir". Sélectionnez ensuite le fichier de type "WDE" à ouvrir. 
...
### Fermer un état
<a name="fermer_etat_ELTPARAGRAPHE000273"></a>
...
### Enregistrer un état
<a name="enregistrer_etat_ELTPARAGRAPHE000297"></a>

**Pour enregistrer l'état en cours**, utilisez une des méthodes suivantes: 

- sous le volet "Accueil", dans le groupe "Général", cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif).

- utilisez le raccourci clavier Ctrl + S. 

- cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif) parmi les boutons d'accès rapide.
...
<a name="recuperation_automatique_ELTPARAGRAPHE000336"></a>
