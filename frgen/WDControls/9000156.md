...
<br>![Un simple mouvement du doigt rafraîchit l'affichage](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WM-PullToRefresh.jpg)
...
4. ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Spécifiez si nécessaire la couleur de la jauge utilisée par défaut. Cette couleur est prise en compte lors de l'utilisation de l'affichage par défaut (option "Aucune").
...
- Le premier plan est affiché pendant le scroll, tant que le bandeau de rafraîchissement n'a pas été affiché en totalité. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=PullToRefresh1.gif)
Ce plan est composé d'une image et d'un libellé. Ce libellé décrit l'action associée à la gesture en cours.

- Le second plan est affiché pendant le scroll lorsque le bandeau de rafraîchissement est affiché en totalité et tant que l'utilisateur n'a pas relâché le pointeur. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=PullToRefresh1.gif)
...
- Le dernier plan est affiché pendant le rafraîchissement des données. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=PullToRefresh3.gif)
...
[TableRafraîchissementVisible (Fonction)](../WDChamp/1000021196.md)

[ZoneRépétéeRafraîchissementVisible (Fonction)](../WDChamp/1000021195.md)

[FenRafraîchissementVisible (Fonction)](../WDChamp/1000023419.md)
