...
1. En tranche Bureau, trois images et trois libellés sont affichés. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Erreur%20compilation%20Ordre%20des%20champs%20-%20HC%20N%B0001.gif&type=thumb)
...
5. Des erreurs d'UI apparaissent. En double-cliquant sur l'erreur de superposition, la visualisation des erreurs de superposition est automatiquement activée. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Erreur%20compilation%20Ordre%20des%20champs%20-%20HC%20N%B0007.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD_ErreurTrancheBureau.gif)
Dans la tranche inférieure (Tablette ou Mobile), WEBDEV découpe de la même façon, une ligne pour les images et une ligne pour les libellés. La ligne comprenant les images et la ligne comprenant les libellés n'ayant plus la même hauteur, les deux lignes se superposent.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD_ErreurTrancheMobile.gif)
...
[Erreurs de compilation d'UI](../WDChamp/9000104.md)
