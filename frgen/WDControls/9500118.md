...
### Champ d'une page
<a name="champ_une_page_ELTPARAGRAPHE000013"></a>Le champ Image à défilement automatique permet de visualiser un ensemble d'images présent dans un ou plusieurs répertoires du site. Le parcours des images est effectué automatiquement. 
...
<a name="utiliser_une_image_defilement_automatique_dans_site_webdev_ELTTEXTE000221"></a>
...
3. Dans l'onglet "UI", dans la zone "Défilement automatique", cochez l'option "Faire défiler les images d'un répertoire ou d'une liste programmée" puis indiquez les différentes options concernant le défilement : 
	...
	- **Démarrer automatiquement**. Si cette option n'est pas sélectionnée, il est possible de démarrer le défilement grâce à la fonction [ImageLanceDéfilement](../WDLang2/1000019427.md). 
...
<a name="programmation_une_image_defilement_automatique_ELTTEXTE000245"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000084"></a>Les champs proposant un défilement automatique peuvent être manipulés par programmation grâce à différentes fonctions et propriétés WLangage. Ces fonctions et propriétés sont disponibles également en code navigateur et en PHP. 


### Définition des images à afficher lors du défilement
<a name="definition_des_images_afficher_lors_defilement_ELTPARAGRAPHE000091"></a>Les images affichées dans le champ lors du défilement peuvent être : 
...
### Fonctions WLangage
<a name="fonctions_wlangage_ELTPARAGRAPHE000109"></a>Différentes fonctions du WLangage permettent de gérer les images à défilement automatique. Ces fonctions sont les suivantes :
...
### Propriétés WLangage
<a name="proprietes_wlangage_ELTPARAGRAPHE000122"></a>Différentes propriétés du WLangage permettent de gérer les images à défilement automatique. Ces propriétés sont les suivantes :
...
[Fonctions de gestion des images](../WDChamp/1000019452.md)
...
[Image avec défilement automatique (WEBDEV) (syntaxe préfixée)](../WDChamp/9500151.md)
