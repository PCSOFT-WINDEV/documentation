...
Dans l'exemple suivant, un champ Zone répétée contient 4 champs de saisie.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Flexbox_Exemple2%20-%20HC%20N%B0005.gif&type=thumb)
Quand le navigateur est agrandi en largeur, les 2 premières zones de saisie doivent rester en largeur fixe et l'espace supplémentaire doit être distribué ainsi : 20 % pour la 3ème zone (libellé complet), 80 % pour la 4ème zone (descriptif). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Flexbox_Exemple2%20-%20HC%20N%B0004.gif&type=thumb)
...
2. Dans l'onglet "Général" de la fenêtre de description du champ Flexbox, les différents champs sont affichés. Pour obtenir un agrandissement des champs, il suffit de définir l'option "flex-grow" pour le troisième et le quatrième champ. Dans notre cas, nous avons quatre champs de saisie. Les options suivantes doivent être modifiées : 
	...
	- pour le troisième champ de saisie, l'option "flex-grow" a pour valeur 20. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Flexbox_Exemple2%20-%20HC%20N%B0003.gif&type=thumb)
