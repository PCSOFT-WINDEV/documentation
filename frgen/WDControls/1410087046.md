...
<a name="champ_disposition_dans_champ_zone_repetee_ELTPARAGRAPHE000078"></a>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Dans une fenêtre, un champ Disposition peut être utilisé dans un champ Zone répétée : 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Dans une page, le champ Disposition peut être utilisé dans un champ d'un champ Zone répété. Si vous voulez par exemple, créer un champ Zone répétée permettant d'obtenir une interface optimisée  : 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) L'onglet "Général" permet également de définir le style CSS de la cellule en cours.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) L'option **"Réduire le parent"** permet de réduire si nécessaire le parent. Si le parent est la fenêtre, la réduction sera appliquée uniquement lors de l'ouverture de la fenêtre.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Remarques : 
...
<a name="exemple_des_differents_types_debordement_ELTPARAGRAPHE000189"></a>**Exemple** : Un champ Disposition est créé sous l'éditeur de fenêtres. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_disposition_auto%20-%20HC%20N%B0001.gif)
...
- Au Go, la fenêtre affiche tous les champs. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_disposition_auto%20-%20HC%20N%B0002.gif)
...
- En ajoutant le numéro de téléphone, l'adresse email et un commentaire, le champ Disposition s'agrandit ainsi que la fenêtre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_disposition_auto%20-%20HC%20N%B0004.gif)
...
- En ajoutant un commentaire, un ascenseur apparaît automatiquement dans le champ Disposition pour faire défiler les différents éléments affichés. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=champ_disposition_Ascenseur%20-%20HC%20N%B0001.gif)
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Exemple 4 : Option **Agrandir le champ pousse les champs autour** avec gestion de la réduction de la fenêtre par programmation

- Au Go, la fenêtre affiche tous les champs. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_disposition_auto%20-%20HC%20N%B0002.gif)


- En supprimant le numéro de téléphone et l'adresse email, le champ Disposition se réduit, ainsi que la fenêtre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_disposition_auto%20-%20HC%20N%B0003.gif)
