...
Exemple : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_gantt%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="creer_etat_diagramme_gantt_ELTTEXTE000282"></a>
...
13. L'état en cours de création s'affiche sous l'éditeur d'états.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_gantt%20-%20HC%20N%B0001.gif&type=thumb)
...
[**Le logiciel Etats & Requêtes**](../Presentation/3088004.md) ne permet pas de créer des états de type Diagramme de Gantt. Cependant, il est possible de personnaliser des états de type Diagramme de Gantt créés sous l'éditeur d'états intégré (couleur, polices, taille, ...).
...
<a name="champ_diagramme_gantt_dans_etat_ELTTEXTE000327"></a>
...
- **L'état personnalisé pour afficher les tâches**. 
	...
	- Si l'option "Etat prédéfini" est sélectionnée, un état prédéfini est automatiquement ajouté au projet. Par défaut, cet état a pour nom "ETAT_WinDevVueTacheGantt" et est automatiquement utilisé pour l'affichage des tâches.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_WinDevvueGantt.gif)
...
<a name="imprimer_etat_type_diagramme_gantt_ELTTEXTE000351"></a>
...
### Exemple
<a name="exemple_ELTPARAGRAPHE000199"></a>L'ensemble des informations à imprimer est contenu dans le champ Table hiérarchique "TABLEH_Planning" présent dans la fenêtre "FEN_Gantt".
...
[Le champ Diagramme de Gantt](../WDChamp/1000030001.md)
