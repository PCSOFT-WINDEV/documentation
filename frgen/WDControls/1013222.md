...
Pour créer une colonne de type Combo, il suffit de sélectionner l'option "Combo" dans le type de la colonne :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Table_Combo.gif&type=thumb)
...
### Limites en Java
<a name="limites_java_ELTPARAGRAPHE000064"></a>En Java, les caractéristiques suivantes ne sont pas gérées :
...
<a name="initialisation_contenu_colonne_type_combo_ELTPARAGRAPHE000078"></a>Le contenu de la colonne de type Combo peut être initialisé :

- sous l'éditeur, dans le détail de la colonne : il ne peut alors pas être graphique.

- par programmation avec la fonction [ListeAjoute](../WDLang1/3049004.md), par exemple dans l'événement "Initialisation" du champ Table.
...
<a name="recuperation_contenu_une_colonne_type_combo_ELTPARAGRAPHE000132"></a>La valeur sélectionnée dans une colonne de type Combo peut être récupérée avec la propriété [Valeur](../Proprietes/2510130.md).
<a name="NOTE4_4"></a>
...
[Colonnes de type Combo dans les champs Table (syntaxe préfixée)](../WDChamp/9500152.md)
