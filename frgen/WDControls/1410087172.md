...
## Spécificités WEBDEV
<a name="specificites_webdev_ELTTEXTE000433"></a>


### Programmation du champ Editeur de diagrammes sous WEBDEV
<a name="programmation_champ_editeur_diagrammes_sous_webdev_ELTPARAGRAPHE000139"></a>Le champ Editeur de diagrammes peut être manipulé en code serveur via les différents types de variables et les différentes fonctions WLangage. 
...
- Il n'est pas possible d'utiliser la fonction [AJAXExécute](../WDLang2/3055114.md) dans les traitements navigateur. 
...
<a name="exemple_connaitre_modifier_forme_selectionnee_ELTPARAGRAPHE000163"></a>Dans le champ Editeur de diagrammes d'un site WEBDEV, pour récupérer les caractéristiques de la forme sélectionnée ou les modifier, il est possible d'utiliser la propriété Sélection. 
...
<a name="exemple_recuperer_indice_forme_ajoutee_dans_champ_editeur_diagrammes_ELTPARAGRAPHE000182"></a>Dans le champ Editeur de diagrammes d'un site WEBDEV, il est possible de récupérer l'indice de la forme ajoutée, via l'événement navigateur "Ajout d'une forme" du champ. 
...
- Code serveur "Clic sur" du champ Bouton BTN_Ajout (option "Ajax" activée): 
	...
	MaForme est diagForme <- diagramme.Forme[nIndice]
	```
