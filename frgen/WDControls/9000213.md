...
- [Les pages en mode AWP](../WDChamp/3539026.md). 
...
## Les pages en mode session
<a name="les_pages_mode_session_ELTTEXTE000129"></a>
...
Le principe est le suivant : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=PageAffiche_Ctx.gif)
...
## Les pages en mode "Session référençable"
<a name="les_pages_mode_session_referencable_ELTTEXTE000153"></a>
