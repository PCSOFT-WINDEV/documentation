...
<a name="evenements_geres_par_defaut_ELTTEXTE000136"></a>
...
| Après chargement d'un document | Exécuté après le chargement d'un document dans le champ Lecteur PDF. Cet événement n'est pas exécuté lors de la manipulation du champ via les fonctions de gestion du champ Lecteur PDF (par exemple, lors de l'ouverture d'un document via la fonction [LecteurPDFOuvre](../WDLang1/1000023452.md)). |
| Avant fermeture du document | Exécuté avant la fermeture du document dans le champ Lecteur PDF. Cet événement n'est pas exécuté lors de la manipulation du champ via les fonctions de gestion du champ Lecteur PDF (par exemple, lors de l'ouverture d'un nouveau document via la fonction [LecteurPDFOuvre](../WDLang1/1000023452.md)). |
| Rafraîchissement du ruban | Exécuté lorsque le ruban doit être mis à jour (par exemple pour afficher le nombre de pages du document PDF). <br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Cet événement n'est pas disponible. |
...
<a name="evenements_optionnels_ELTTEXTE000160"></a>
