...
<a name="initialiser_champ_liste_image_ELTTEXTE000141"></a>


### Initialiser un élément
<a name="initialiser_element_ELTPARAGRAPHE000164"></a>

Pour initialiser un élément d'un champ Liste image, utilisez la fonction [&lt;Liste&gt;.Ajoute](../WDLang1/1000017319.md).
...
<a name="remplir_champ_liste_image_ELTPARAGRAPHE000185"></a>Pour initialiser un champ Liste image, il suffit d'utiliser une boucle d'itération pour initialiser tous les éléments du champ.
...
<a name="selectionner_element_dans_champ_liste_image_ELTTEXTE000214"></a>


### Sélectionner l'élément de la ligne &lt;Indice&gt;
<a name="selectionner_element_ligne_ELTPARAGRAPHE000237"></a>
...
<a name="positionner_sur_dernier_element_champ_liste_image_ELTPARAGRAPHE000264"></a>
...
<a name="recuperer_element_selectionne_dans_champ_liste_image_ELTTEXTE000305"></a>


### Récupérer l'indice de l'élément sélectionné
<a name="recuperer_indice_element_selectionne_ELTPARAGRAPHE000328"></a>
...
<a name="recuperer_valeur_element_selectionne_ELTPARAGRAPHE000374"></a>
...
<a name="proprietes_specifiques_gestion_des_champs_liste_image_ELTTEXTE000396"></a>
...
| [TableParcourue](../Proprietes/2510040.md) | Permet de connaître et de modifier la table ou la requête utilisée pour l'affichage des enregistrements dans les champs Liste image table. |
