...
<a name="passer_des_parametres_une_fenetre_lors_son_ouverture_ELTTEXTE000319"></a>


### Passage de paramètres: cas général
<a name="passage_parametres_cas_general_ELTPARAGRAPHE000038"></a>
...
<a name="parametres_passes_par_valeur_ELTPARAGRAPHE000075"></a>
...
<a name="donner_une_valeur_par_defaut_aux_parametres_dans_declaration_ELTPARAGRAPHE000089"></a>
...
### Paramètres nommés
<a name="parametres_nommes_ELTPARAGRAPHE000100"></a>
...
<a name="portees_des_parametres_ELTPARAGRAPHE000133"></a>
...
<a name="renvoyer_une_valeur_lors_fermeture_une_fenetre_ELTTEXTE000367"></a>
...
2. Récupérez dans une variable la valeur renvoyée par la fenêtre lors de sa fermeture. Cette variable contient le résultat de la fonction [Ouvre](../WDLang1/3038035.md).
	...
	// Schéma des données du résultat renvoyé par la fenêtre
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Cas particulier: Valeur renvoyée par une fenêtre fille dans une application WINDEV Mobile**
...
<a name="tester_une_fenetre_parametree_ELTTEXTE000397"></a>
...
2. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_Go_Fenetre_WD_bl.gif) parmi les boutons d'accès rapide (ou appuyez sur la touche F9). La fenêtre suivante apparaît:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fen%EAtre_param%E9tr%E9e%20-%20HC%20N%B0001.gif)
...
[Ouvre (Fonction)](../WDChamp/3038035.md)

[OuvreFille (Fonction)](../WDChamp/3038021.md)

[OuvreSoeur (Fonction)](../WDChamp/3038045.md)

[OuvreFenêtreMobile (Fonction)](../WDChamp/1000021018.md)

[OuvrePopup (Fonction)](../WDChamp/3038046.md)

[OuvrePopupPosition (Fonction)](../WDChamp/3038047.md)

[ChangeFenêtreSource (Fonction)](../WDChamp/3038053.md)

[FIListeAjoute (Fonction)](../WDChamp/1000020558.md)

[FIListeInsère (Fonction)](../WDChamp/1000020945.md)

[PanneauCrée (Fonction)](../WDChamp/1000023989.md)
