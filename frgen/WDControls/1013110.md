...
<a name="evenements_geres_par_webdev_ELTPARAGRAPHE000123"></a>WEBDEV gère par défaut les événements suivants (ordre d'apparition sous l'éditeur de code) :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) L'événement **"Enroulé, Déroulé d'un noeud"** est exécuté lorsque une branche du champ Arbre est enroulée ou déroulée par clic ou double-clic de l'utilisateur.
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Il est possible de déclarer une procédure dans l'événement "Enroulé,Déroulé d'un noeud".**Exemple** : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ARBRECODE.gif)
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Pour ajouter un événement optionnel :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) L'événement "Filtrage des enregistrements" est exécuté juste après l'affichage d'une ligne du champ Arbre. Il est donc exécuté :
