...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) sur tous les champs d'une fenêtre. Pour plus de détails, consultez [L'effet parallaxe dans l'éditeur de fenêtres](#NOTE2_1).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) sur les champs conteneur d'une page : Cellule, Zone de mise en page, Zone de texte Riche, champ Modèle de champs. Pour plus de détails, consultez [L'effet parallaxe dans l'éditeur de pages](#NOTE3_1).
...
2. Dans l'onglet "UI", déroulez l'option "Parallaxe". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Effet_de_parallaxe%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="effet_parallaxe_dans_editeur_pages_ELTTEXTE000280"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000101"></a>L'éditeur de pages propose un effet de parallaxe de champ et un effet parallaxe d'image de fond. 
...
<a name="definir_effet_parallaxe_sous_editeur_pages_ELTPARAGRAPHE000114"></a>Pour définir l'effet de parallaxe d'un champ : 
...
3. **Pour ajouter un effet parallaxe de champ** : 
	...
	- Dans la fenêtre qui s'affiche, choisissez l'option voulue : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Effet_parallaxe_WB%20-%20HC%20N%B0001.gif)
...
4. **Pour ajouter un effet parallaxe d'image de fond** : 
	...
	- L'effet est ajouté au style. Cliquez sur le bouton "Détail" pour configurer l'effet. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Effet_parallaxe_WB%20-%20HC%20N%B0002.gif)
...
[TauxParallaxeHauteur (Propriété)](../WDChamp/1000021921.md)

[TauxParallaxeY (Propriété)](../WDChamp/1000021922.md)
