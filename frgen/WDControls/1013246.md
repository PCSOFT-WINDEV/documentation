...
## Evénements gérés
<a name="evenements_geres_ELTTEXTE000314"></a>
...
| Sortie (de la colonne) | Exécuté lors du changement de champ (touche TAB, changement de champ par la souris, etc.). |
...
<a name="evenements_geres_par_webdev_ELTPARAGRAPHE000094"></a>WEBDEV gère les événements suivants pour les colonnes du champ Table : 
...
| Clic sur le titre (code navigateur) | Exécuté lorsque l'utilisateur clique sur le titre de la colonne. |
...
| Sortie (de la colonne) avec modification (code navigateur) | Exécuté lors du changement de champ après modification (touche TAB, changement de champ par la souris, etc.). |
| Sortie (de la colonne) (code navigateur) | Exécuté lors du changement de champ sans modification (touche TAB, changement de champ par la souris, etc.). |
| En sortie de ligne si modification (code serveur) | Exécuté lorsque l'utilisateur modifie le contenu d'une colonne. Cet événement est exécuté uniquement en sortie de ligne. |
...
| Clic sur le titre (code navigateur) | Exécuté lorsque l'utilisateur clique sur le titre de la colonne. |
| Clic sur le titre (code serveur) | Exécuté lorsque l'utilisateur clique sur le titre de la colonne. |
...
| Entrée de champ (code navigateur) | Exécuté lorsque la colonne prend le focus. |
| A chaque modification champ (code navigateur) | Exécuté lorsque l'utilisateur modifie le contenu d'une colonne. |
| Sortie avec modification (code navigateur) | Exécuté lors du changement de champ avec modification de la colonne. |
| Sortie de champ (code navigateur) | Exécuté lors du changement de champ. |
| A chaque modification du champ (code serveur) | Exécuté lorsque l'utilisateur modifie le contenu d'une colonne. |
| Clic sur champ (code serveur) | Exécuté lorsque l'utilisateur clique sur une colonne. |
| A chaque recherche avec la loupe (code serveur) | Exécuté lorsque l'utilisateur utilise la loupe pour effectuer une recherche. |
| Clic sur le titre (code serveur) | Exécuté lorsque l'utilisateur clique sur le titre de la colonne. |
| Clic sur le titre (code navigateur) | Exécuté lorsque l'utilisateur clique sur le titre de la colonne. |
| A chaque application du filtre avec l'entonnoir (code serveur) | Exécuté lorsque l'utilisateur utilise l'entonnoir pour filtrer les enregistrements. |
...
<a name="evenements_optionnels_ELTTEXTE000344"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Plusieurs événements optionnels peuvent être gérés.
...
- le tri des colonnes (**événement "A chaque tri"**). Cet événement est exécuté lorsque l'utilisateur trie la colonne à l'aide des icônes ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeCroissant.gif) et ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeDecroissant.gif).
...
<a name="code_tri_une_colonne_ELTPARAGRAPHE000262"></a>Lorsque l'utilisateur clique sur le titre d'une colonne d'un champ Table, le code de tri de la colonne est automatiquement appelé.
