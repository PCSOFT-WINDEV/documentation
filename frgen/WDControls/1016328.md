...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [lié à une table](../WDChamp/1016325.md). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [lié à une variable](../WDChamp/1016325.md). 
...
<a name="manipuler_champ_agenda_par_programmation_ELTTEXTE000163"></a>


### Ajouter un rendez-vous
<a name="ajouter_rendezvous_ELTPARAGRAPHE000186"></a>

L'ajout d'un rendez-vous dans un champ Agenda est réalisé grâce à la fonction [&lt;Agenda&gt;.AjouteRendezVous](../WDLang1/1000022894.md). Cette fonction accepte deux syntaxes: 
...
### Remplir un champ Agenda avec les données présentes dans une table HFSQL
<a name="remplir_champ_agenda_avec_les_donnees_presentes_dans_une_table_hfsql_ELTPARAGRAPHE000226"></a>

Les enregistrements sont stockés dans une table HFSQL. Le remplissage initial du champ Agenda peut être réalisé par un parcours de la table via la syntaxe POUR TOUT et par l'ajout de chaque rendez-vous via la fonction [&lt;Agenda&gt;.AjouteRendezVous](../WDLang1/1000022894.md).
...
FIN
```
**Rappel**: Il est également possible d'utiliser un champ Agenda lié à une table. Pour plus de détails, consultez [Champ Agenda lié à une table](../WDChamp/1016325.md).


### Récupérer une liste de rendez-vous
<a name="recuperer_une_liste_rendezvous_ELTPARAGRAPHE000254"></a>

La fonction [&lt;Agenda&gt;.ListeRendezVous](../WDLang1/1000022886.md) permet de récupérer: 
...
<a name="afficher_champ_agenda_partir_une_date_specifique_ELTPARAGRAPHE000294"></a>

Pour afficher le champ Agenda à partir d'une date spécifique, utilisez la fonction [&lt;Agenda&gt;.Position](../WDLang1/1000022897.md).
...
<a name="supprimer_rendezvous_ELTPARAGRAPHE000317"></a>

La fonction [&lt;Agenda&gt;.SupprimeRendezVous](../WDLang1/1000022877.md) permet de supprimer: 
...
La fonction [&lt;Agenda&gt;.SupprimeTout](../WDLang1/1000022898.md) permet de supprimer tous les rendez-vous présents dans le champ Agenda.


### Modifier l'affichage du champ
<a name="modifier_affichage_champ_ELTPARAGRAPHE000349"></a>

L'affichage courant d'un champ Agenda peut être modifié via les fonctions suivantes: 

- [&lt;Agenda&gt;.AffichePériodePrécédente](../WDLang1/1000022878.md) et [&lt;Agenda&gt;.AffichePériodeSuivante](../WDLang1/1000022896.md): Ces deux fonctions permettent de modifier la période d'affichage (identique à l'utilisation du bouton spin présent en haut du champ Agenda). 

- [&lt;Agenda&gt;.ChangeMode](../WDLang1/1000022879.md): Cette fonction permet de modifier le mode d'affichage du champ: jour, semaine, mois.

- [&lt;Agenda&gt;.HeureAffichée](../WDLang1/1000022892.md): Cette fonction permet de définir la plage horaire affichée.
...
<a name="utilisation_menu_contextuel_faa_ELTTEXTE000375"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Possibilités du menu contextuel
<a name="possibilites_menu_contextuel_ELTPARAGRAPHE000400"></a>
...
**Exemple**: Pour mémoriser dans une table RDV, un rendez-vous que l'utilisateur ajoute via le menu contextuel, il suffit de saisir dans l'événement "Entrée en saisie d'un rendez-vous": 
...
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000429"></a>
...
<a name="gestion_des_jours_feries_ELTTEXTE000446"></a>
...
<a name="proprietes_specifiques_aux_champs_agenda_ELTTEXTE000484"></a>
...
[RendezVous (Type de variable)](../WDChamp/1000019244.md)
