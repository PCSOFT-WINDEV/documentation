...
## Présentation
<a name="presentation_ELTTEXTE000438"></a>
...
- L'onglet "Détail" permet de sélectionner : 
	...
	- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) [le remplissage du champ Zone répétée par programmation (affichage d'une jauge ou d'une fenêtre, ...)](#NOTE5_Remplissage).

	- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) [le paramétrage du champ de recherche](#NOTE4_1_Recherche). 
...
<a name="mode_selection_onglet_fenetre_description_ELTTEXTE000462"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Sélection multiple par simple clic** : Cette option permet de réaliser une multisélection à la souris. Si cette option est sélectionnée, il suffit de cliquer sur une ligne pour que celle-ci soit ajoutée ou enlevée de la multisélection. 

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Mode de sélection Android/iOS** : Cette option permet de masquer le bandeau de sélection après la sélection. Cela permet d'obtenir le fonctionnement standard sur ces plateformes : le bandeau apparaît uniquement lors de l'appui sur la ligne. Le code de sélection de ligne est ensuite exécuté.  
...
<a name="mode_affichage_onglet_detail_fenetre_description_ELTTEXTE000486"></a>
...
<a name="mode_standard_vertical_mode_galerie_colonne_ancrage_des_colonnes_ELTPARAGRAPHE000131"></a><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_ZR_NbColWD.GIF)
...
<a name="NOTE3_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Mode standard horizontal : Ancrage des lignes**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_ZR_NbColWD_H.GIF)
...
- **Hauteur et nombre de lignes fixes (en haut)** : Il suffit d'indiquer le nombre de lignes à afficher et la hauteur des lignes. 
	...
	![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Cette option n'est pas disponible.
...
<a name="autres_parametres_onglet_detail_ELTTEXTE000528"></a>
<a name="NOTE4_1_Saisie"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Paramètres de saisie
<a name="parametres_saisie_ELTPARAGRAPHE000206"></a>Les paramètres de saisie permettent de spécifier le comportement des champs Zone répétée fichier en saisie. Les options possibles sont les suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_ZR_NbColWD%202.gif)
...
### Ascenseur
<a name="ascenseur_ELTPARAGRAPHE000223"></a>L'affichage de l'ascenseur horizontal/vertical peut être : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_ZR_NbColWD%203.gif)
...
<a name="deplacements_gestures_ELTPARAGRAPHE000237"></a>Les options suivantes sont disponibles : 
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Des options spécifiques de déplacements et gestures peuvent également être définies. Pour plus de détails, consultez [Zone répétée : Déplacements et gestures](../WDChamp/1013295.md).
<a name="NOTE4_1_Recherche"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Champ de recherche
<a name="champ_recherche_ELTPARAGRAPHE000266"></a>Le champ Zone Répétée peut proposer d'effectuer une recherche dans les données affichées. Les options proposées sont : 
...
<a name="pendant_remplissage_champ_zone_repetee_par_programmation_ELTPARAGRAPHE000282"></a>Pendant le remplissage d'un champ Zone répétée manipulée par programmation, il est possible d'afficher des informations spécifiques : 
...
2. Dans l'onglet "Détail" de la fenêtre de description du champ, cochez l'option "Afficher une Fenêtre interne par dessus les lignes".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_ZR_NbColWD%201.gif)
...
<a name="contenu_chaque_ligne_variable_onglet_contenu_ELTTEXTE000576"></a>
Les champs Zone répétée offrent la possibilité de personnaliser totalement l'apparence des répétitions : mise en page, contenu, etc. Il est ainsi possible par exemple d'imbriquer des zones répétées dans des zones répétées. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=278-WM-ZR%20Variable.jpg)
...
### Mise en place
<a name="mise_place_ELTPARAGRAPHE000339"></a>Pour créer un champ Zone répétée avec un contenu variable : 
...
3. Dans l'onglet "Contenu" de la description du champ : 
	...
	- Indiquez le mode de déchargement des fenêtres internes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Caracteristiques_ZR_WD%20-%20HC%20N%B0002.gif)
...
<a name="caracteristiques_des_fenetres_internes_ELTPARAGRAPHE000375"></a>Les caractéristiques de largeur et de hauteur des fenêtres internes sont les suivantes : 
...
[ZoneRépétéeAjouteFI (Fonction)](../WDChamp/1000023439.md)

[ZoneRépétéeInsèreFI (Fonction)](../WDChamp/1000023440.md)

[ZoneRépétéeModifieFI (Fonction)](../WDChamp/1000023441.md)
