...
- correspondre à une rubrique mémo d'une table ou d'une requête, etc. 

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) correspondre à un champ Tableur présent dans une fenêtre. 
...
- Onglet "Liaison": Permet de définir la liaison du champ Tableur. Le champ peut être: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) lié avec un champ d'une fenêtre de l'application.
...
<a name="manipulation_champ_tableur_dans_etat_par_programmation_ELTPARAGRAPHE000077"></a>
...
[Etat Tableur](../WDChamp/1011095.md)
