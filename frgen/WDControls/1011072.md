...
Il est également possible d'intégrer cet état à vos applications. L'utilisateur pourra ainsi lancer l'impression de l'état directement depuis un bouton, une option de menu par exemple.**Si vous utilisez le logiciel Etats & Requêtes**, il est possible d'imprimer un état :

- soit en lançant une impression (icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_Imprimer_cpt.gif)).
...
<a name="principe_impression_windev_ELTTEXTE000166"></a>
