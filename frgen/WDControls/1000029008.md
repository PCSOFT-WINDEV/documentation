...
Les fonctionnalités du menu contextuel sur les lignes et les colonnes sont les suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_TCD.gif)
...
- [Granularité (semaine/quinzaine/semestre)](#NOTE2_Ajouter), 
...
Les fonctionnalités du menu contextuel sur les cellules sont les suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_TCD_Cellule.gif)
...
<a name="les_fonctionnalites_menu_contextuel_ELTTEXTE000447"></a>
<a name="NOTE2_1"></a>


### Supprimer les colonnes et les lignes
<a name="supprimer_les_colonnes_les_lignes_ELTPARAGRAPHE000129"></a>
...
<a name="replierdeplier_les_colonnes_les_lignes_ELTPARAGRAPHE000150"></a>
...
<a name="granularite_semaine_quinzaine_semestre_ELTPARAGRAPHE000174"></a>Si le tableau croisé dynamique ne contient pas assez de détails, il est possible d'ajouter des colonnes pour affiner les statistiques affichées. 
...
<a name="reorganiser_les_entetes_lignes_colonnes_ELTPARAGRAPHE000191"></a>

Cette option permet de modifier l'affichage des lignes et des colonnes dans le champ Tableau Croisé dynamique. 

Lorsque cette option est sélectionnée, le tableau croisé dynamique passe en édition. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TCD_Inverser_dim1.gif)
...
- d'inverser les dimensions. Il suffit de sélectionner l'entête voulu et de le déplacer par un simple "Drag and Drop" vers la position voulue. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TCD_Inverser_dim2.gif)
...
<a name="inverser_les_entetes_lignes_colonnes_ELTPARAGRAPHE000213"></a>Cette option permet de faire pivoter les données du champ Tableau croisé dynamique. Toutes les colonnes deviennent des lignes et toutes les lignes deviennent des colonnes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WD%20-%20TCD%20Faire%20Pivoter.jpg)
...
<a name="comparer_les_periodes_ELTPARAGRAPHE000228"></a>
...
- Une fenêtre s'affiche permettant de saisir les caractéristiques de la comparaison : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_TCD_Comparer%20-%20HC%20N%B0001.gif&type=thumb)
...
- La validation de cette fenêtre entraîne le recalcul des données affichées, pour obtenir uniquement les données de la comparaison. Par exemple : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_TCD_Comparer%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="exporter_champ_tableau_croise_dynamique_vers_excel_ELTPARAGRAPHE000264"></a>

Cette option permet d'exporter le contenu du tableau croisé dynamique vers Excel. Cette option correspond à la fonction [TCDVersExcel](../WDLang1/1000020703.md). Il suffit d'indiquer le nom du fichier XLS à créer. Le document créé peut être ouvert directement. Le contenu du document XLS créé correspond exactement aux données affichées dans le tableau croisé dynamique. Les colonnes cachées ou repliées ne seront pas visibles dans le fichier XLS. 
<a name="NOTE2_4"></a>


### Charger/Sauvegarder le contenu du tableau croisé dynamique
<a name="chargersauvegarder_contenu_tableau_croise_dynamique_ELTPARAGRAPHE000274"></a>

Pour éviter le recalcul d'un tableau croisé dynamique affiché précédemment, il est possible de sauvegarder le contenu du tableau croisé dynamique dans un fichier sur le disque afin de le ré-ouvrir plus tard ou de l'envoyer à une autre personne. Cette option correspond à la fonction [TCDSauve](../WDLang1/1000020471.md). 
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_TCD_Cryptage%20-%20HC%20N%B0002.gif)
...
<a name="restaurer_taille_les_regroupements_initiaux_ELTPARAGRAPHE000303"></a>
...
<a name="memoriser_taille_les_regroupements_ELTPARAGRAPHE000312"></a>
...
Le menu contextuel d'une cellule permet à l'utilisateur de changer simplement la couleur d'une cellule du champ Tableau croisé dynamique. Il est ainsi possible de retrouver facilement des éléments importants dans le tableau croisé dynamique. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_TCD_Cellule_Coul1.gif)


Astuce : La dernière couleur utilisée est automatiquement proposée dans le menu contextuel de la cellule. Pratique pour appliquer la même couleur sur plusieurs cellules. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_TCD_Cellule_Coul2.gif)
...
## Paramétrage
<a name="parametrage_ELTTEXTE000531"></a>


### Paramétrage du menu automatique dans un champ Tableau croisé dynamique
<a name="parametrage_menu_automatique_dans_champ_tableau_croise_dynamique_ELTPARAGRAPHE000341"></a>
...
3. Choisir le menu désiré dans la combo "Menu contextuel". Il est possible de : 
	...
	- "Ajouter un menu contextuel" : Si cette option est cochée, vous pouvez sélectionner le menu contextuel personnalisé à afficher. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fonctionnalites_auto_Menu2.gif)
...
[TCDComparePériode (Fonction)](../WDChamp/1000024869.md)
