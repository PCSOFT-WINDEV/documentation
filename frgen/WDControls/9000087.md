...
3. Le carré jaune a été remplacé par un carré bleu, indiquant que ce champ peut être surchargé.
	![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ModeleFen_IHMNonSurchargee.gif)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ModeleFen_IHMSurchargee.gif)

4. Vous pouvez maintenant modifier tous les aspects de l'interface du bouton : dimensions, position, style, ... <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ModeleFen_IHMModifiee.gif)
...
5. Deux sections de code de clic sont présents : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ModeleFen_CodeNonSurcharge.gif)
