...
**Rappel**: Une vue HFSQL correspond à une "image mémoire" de tout ou partie d'une table. Une vue est stockée en mémoire, ce qui la rend insensible aux modifications effectuées sur la table associée. Une fois créée, une vue se manipule comme une table HFSQL. Pour plus de détails, consultez [Les vues HFSQL](../WDLang4/3044248.md).
...
[Le logiciel Etats & Requêtes](../Presentation/3088004.md) ne permet pas de créer des états sur une vue HFSQL. Cependant, il est possible de personnaliser des états sur une vue HFSQL créés sous l'éditeur d'états intégré (couleur, polices, taille, ...).
...
<a name="creer_etat_sur_une_vue_hfsql_ELTTEXTE000340"></a>
...
6. Sélectionnez la table de base de la vue HFSQL associée à l'état.
...
<a name="imprimer_etat_sur_une_vue_hfsql_ELTTEXTE000364"></a>


### Pour imprimer un état sur une vue HFSQL
<a name="pour_imprimer_etat_sur_une_vue_hfsql_ELTPARAGRAPHE000143"></a>
...
- La propriété [NomSource](../Proprietes/2511035.md) utilisée dans le code de l'état permet de connaître et de changer la table de base de la vue HFSQL associée à l'état.
...
### Exemple WINDEV
<a name="exemple_windev_ELTPARAGRAPHE000217"></a>
...
### Exemple WEBDEV
<a name="exemple_webdev_ELTPARAGRAPHE000243"></a>

L'internaute sélectionne la référence d'une commande dans une liste. Le champ Bouton "BTN_Imprimer" permet de:

- créer la vue HFSQL "VueCommande" contenant les lignes de la commande sélectionnée (fonction [HCréeVue](../WDLang4/3044159.md)).

- imprimer l'état "ETAT_Vue" dans un fichier PDF (fonction [iImprimeEtat](../WDLang5/3046032.md)).
