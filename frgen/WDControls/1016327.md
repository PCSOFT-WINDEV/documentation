...
<a name="parametrage_menu_automatique_dans_champ_agenda_ELTPARAGRAPHE000046"></a>Le menu contextuel du champ Agenda peut bien évidemment être désactivé. Pour paramétrer l'affichage du menu contextuel du champ Agenda, vous devez :
...
- Par programmation, la fonction [FAADésactive](../WDLang1/1000022018.md) permet de supprimer certaines options du menu contextuel des FAA spécifique aux champs Agenda. Différentes constantes peuvent être utilisées selon l'option à désactiver : 
...
### Option "Imprimer"
<a name="option_imprimer_ELTPARAGRAPHE000098"></a>L'option "Imprimer" permet d'imprimer le contenu du champ Agenda. Une fenêtre spécifique s'affiche permettant de configurer l'impression de l'agenda. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_Imp_Planning.gif)
...
- L'impression réalisée prend en compte le sens d'écriture spécifié avec la propriété [SensEcriture](../Proprietes/2513020.md) au niveau de la fenêtre et / ou au niveau du champ Agenda.
...
- Pour ne pas proposer l'option "Imprimer" dans le menu contextuel du champ Agenda, utilisez la fonction [FAADésactive](../WDLang1/1000022018.md) avec la constante *faaImprimerAgenda*.
...
<a name="personnaliser_fenetre_parametrage_impression_agenda_ELTPARAGRAPHE000140"></a>WINDEV offre la possibilité d'intégrer la fenêtre de configuration de l'impression de l'agenda utilisée par la FAA dans votre application. Il est ainsi possible de personnaliser par exemple :
...
- Pour ne pas proposer l'option "Envoyer par email" dans le menu contextuel du champ Agenda, utilisez la fonction [FAADésactive](../WDLang1/1000022018.md) avec la constante *faaEnvoyerFichierEmail*. 
