...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) La mise en place d'un total sur une rupture permet d'effectuer automatiquement un calcul (somme, comptage, moyenne) pour toutes les lignes d'une rupture donnée. Par exemple, un total sur une rupture permet de calculer le chiffre d'affaires généré par client. 
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) les champs Table en mode Classique, Ajax et Navigateur.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) En exécution, un double-clic sur une rupture permet d'enrouler ou de dérouler cette rupture.
...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000392"></a>
...
2. Dans l'onglet "Contenu", cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_rupture_table.gif). La fenêtre de gestion des ruptures apparaît.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Les sommes, moyennes et comptages sont automatiques dans les ruptures du champ Table. Les champs des hauts et bas de ruptures peuvent afficher ces calculs. Pour plus de détails, consultez [Calculs automatiques dans les ruptures de table](#NOTE4_1).

**Remarques** : 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Dans la description du champ Table (onglet "Contenu"), il est possible de paramétrer si les ruptures doivent afficher ou non un bouton permettant d'enrouler/dérouler la rupture (option "Ruptures avec enroulé/déroulé").

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Dans la description du champ Table (onglet "Contenu"), si le remplissage est de type "Chargé en mémoire", les ruptures peuvent être enroulées/déroulées par un simple clic dans le fond de la rupture (option "Ruptures enroulables/déroulables par simple clic dans le fond").

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Dans la description du champ Table, il est possible de paramétrer l'image utilisée pour dessiner les boutons "+" et "-" dans les ruptures des tables. Il faut pour cela sélectionner l'élément "Rupture, cadre en création" dans l'onglet "Style" de la table puis cliquer sur le bouton "Image Plus/Moins des ruptures".
...
<a name="manipulation_des_champs_presents_dans_les_hauts_les_bas_ruptures_ELTTEXTE000428"></a>
...
<a name="calculs_automatiques_dans_les_ruptures_champ_table_ELTTEXTE000458"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 
...
<a name="manipulation_des_hauts_bas_rupture_ELTTEXTE000482"></a>
...
| [Hauteur](../Proprietes/2510050.md) | Permet de connaître et de modifier la hauteur d'un haut ou d'un bas de rupture.<br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Non disponible. |
...
<a name="fonctions_wlangage_specifiques_aux_champs_table_avec_ruptures_ELTTEXTE000512"></a>
...
<a name="gestion_des_ruptures_dans_les_champs_table_par_programmation_ELTTEXTE000587"></a>
...
[TableEnumèreRupture (Fonction)](../WDChamp/1000022418.md)

[Fonctions de gestion des ruptures](../WDChamp/1000022793.md)

[Propriétés associées aux ruptures d'un champ Table](../WDChamp/9500144.md)
