...
Exemple : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_Planning.gif&type=thumb)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_Planning_Editeur.gif&type=thumb)
...
<a name="creer_etat_planning_ELTTEXTE000234"></a>


### Création de l'état
<a name="creation_etat_ELTPARAGRAPHE000029"></a>
...
- la source de données de l'état (table, requête, champ Planning, ...). Pour plus de détails, consultez [Source de données d'un état](../WDChamp/1011055.md).
...
<a name="informations_specifiques_creation_planning_ELTPARAGRAPHE000062"></a>
...
- Nombre de jours à afficher dans le champ Planning : Il est possible d'imprimer le planning : 
	...
	- avec un nombre de jours personnalisé. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ass_Creation_pln.gif)
...
**Remarque** :  Si l'état Planning est lié à une source de données (requête, table), il est nécessaire d'indiquer dans la suite de l'assistant les rubriques à prendre en compte pour l'affichage du planning et des rendez-vous. Les informations principales à indiquer sont : 
...
<a name="caracteristiques_etat_planning_champ_planning_ELTTEXTE000264"></a>


### Caractéristiques du Planning (Editeur d'états)
<a name="caracteristiques_planning_editeur_etats_ELTPARAGRAPHE000094"></a>
...
Remarque : Vérifiez que la zone d'affichage des rendez-vous à la journée est correctement dimensionnée sous l'éditeur d'états. Il est possible de la redimensionner si nécessaire.
	...
	- l'état personnalisé pour afficher les rendez-vous. 
		...
		- Si l'option "Etat prédéfini" est sélectionnée, un état prédéfini est automatiquement ajouté au projet. Par défaut, cet état a pour nom "ETAT_WinDevVueRDV" et est automatiquement utilisé pour l'affichage des rendez-vous.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_WinDevvueRDV.gif)
...
- Si le champ Planning est lié à une source de données (table, requêtes, ...), l'onglet "Contenu" de la fenêtre de description du champ permet de lier les données du rendez-vous avec les données présentes dans la source de données. 
...
<a name="manipulation_planning_dans_etat_par_programmation_ELTTEXTE000297"></a>


### Fonctions WLangage
<a name="fonctions_wlangage_ELTPARAGRAPHE000149"></a>Différentes fonctions WLangage sont disponibles dans l'éditeur d'états pour manipuler les champs Planning. Ces fonctions sont les suivantes : 
...
### Propriétés WLangage
<a name="proprietes_wlangage_ELTPARAGRAPHE000157"></a>Différentes propriétés WLangage sont disponibles dans l'éditeur d'états pour manipuler les champs Planning. Ces propriétés sont les suivantes : 
...
[Etat sur un champ Planning](../WDChamp/1011080.md)
