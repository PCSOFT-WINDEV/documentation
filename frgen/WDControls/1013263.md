...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) champ Graphe,

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) champ Table,

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) champ Fenêtre interne,
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Grâce aux fenêtres internes, tous les champs de la colonne conteneur peuvent avoir un contenu différent pour chaque ligne du champ Table. 

![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Les colonnes de type Conteneur sont disponibles également pour les champs Table hiérarchique.
...
<a name="comment_creer_une_colonne_champ_table_type_conteneur_ELTTEXTE000378"></a>


### Les différentes étapes
<a name="les_differentes_etapes_ELTPARAGRAPHE000093"></a>Pour créer une colonne d'un champ Table de type Conteneur : 
...
<a name="champ_principal_une_colonne_conteneur_ELTPARAGRAPHE000111"></a>Le champ principal d'une colonne Conteneur correspond au champ manipulé par défaut dans la colonne. Par exemple :
...
- Les ajouts ou modifications réalisés par programmation : la valeur de la colonne indiquée par exemple dans la fonction [TableAjouteLigne](../WDLang1/3074006.md) sera affectée au champ principal.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Dans les colonnes de type Conteneur, les champs Interrupteur doivent être affectés avec une chaîne au format "&lt;Vrai/Faux&gt;;&lt;Vrai/Faux&gt;;&lt;Vrai/Faux&gt;...". 
...
<a name="NOTE2_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remarques : Fenêtre interne, champ Graphe et champ Table dans une colonne de type Conteneur** :
...
<a name="utilisation_une_colonne_type_conteneur_ELTTEXTE000420"></a>


### Champ Table fichier ou champ Table sur variable
<a name="champ_table_fichier_champ_table_sur_variable_ELTPARAGRAPHE000170"></a>Un champ Table fichier peut contenir une ou plusieurs colonnes de type Conteneur. Les champs de cette colonne Conteneur peuvent par exemple afficher les enregistrements du fichier de données.
...
<a name="champ_table_par_programmation_ELTPARAGRAPHE000190"></a>Un champ Table par programmation peut contenir une ou plusieurs colonnes de type Conteneur. Le champ principal de la colonne Conteneur sera directement manipulé par les fonctions de programmation du champ Table.

Par exemple, lors de l'ajout d'une ligne avec la fonction [TableAjouteLigne](../WDLang1/3074006.md), seul le champ principal de la colonne sera affecté avec la valeur définie par la colonne. Si plusieurs champs doivent être initialisés dans la colonne, il est nécessaire d'utiliser la syntaxe décrite dans le paragraphe suivant. Par exemple :
...
<a name="manipuler_les_champs_colonne_conteneur_ELTPARAGRAPHE000210"></a>Les champs d'une colonne Conteneur peuvent être manipulés grâce à la syntaxe suivante :
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Ajout d'une ligne dans un champ Table contenu dans une colonne Conteneur :
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Manipulation d'un champ Interrupteur inséré dans une fenêtre interne : 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Changer la fenêtre interne contenue dans un champ Fenêtre interne d'une colonne Conteneur : 
...
<a name="limite_type_champs_non_disponibles_ELTTEXTE000456"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Dans une colonne de type Conteneur, tous les champs peuvent être utilisés, soit directement, soit via une fenêtre interne. 

![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Dans une colonne de type Conteneur, seuls les champs suivants peuvent être utilisés : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Dans une colonne de type Conteneur, les champs suivants ne sont pas supportés : 
...
[Colonne de champ Table de type Conteneur (syntaxe préfixée)](../WDChamp/1013332.md)
