...
| A chaque modification | Exécuté à chaque modification du contenu du champ (changement de position du curseur). |
...
| Sortie avec modification (Code navigateur) | Exécuté lorsque l'internaute modifie le contenu du champ. |
| A chaque modification (Code serveur) | Exécuté lorsque l'internaute modifie le contenu du champ. |
...
<a name="evenements_optionnels_ELTTEXTE000164"></a>
