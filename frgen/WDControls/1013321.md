...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Remarque** : Plusieurs fonctions WLangage permettent d'ajouter, d'insérer ou de supprimer des options dans un champ Sélecteur. Pour plus de détails, consultez [Fonctions de gestion des champs Sélecteur](../WDLang1/1000021190.md).
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) la fonction [FichierVersEcran](../WDLang4/1000021387.md). 

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) la fonction [FichierVersPage](../WDLang4/1000021389.md).
...
<a name="afficher_champ_selecteur_sans_option_par_defaut_ELTPARAGRAPHE000226"></a>Par défaut, un champ Sélecteur est toujours positionné sur une position (1 par défaut).
...
<a name="recuperer_option_selectionnee_dans_champ_selecteur_ELTTEXTE000241"></a>


### Cas d'un champ Sélecteur renvoyant un entier
<a name="cas_champ_selecteur_renvoyant_entier_ELTPARAGRAPHE000264"></a>**Pour récupérer l'indice de l'option sélectionnée** dans le champ Sélecteur, utilisez la syntaxe suivante : 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) la fonction [EcranVersFichier](../WDLang4/1000021385.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) la fonction [PageVersFichier](../WDLang4/1000021390.md). 
...
<a name="cas_champ_selecteur_renvoyant_une_valeur_ELTPARAGRAPHE000304"></a>**Pour récupérer la valeur de l'option sélectionnée** dans le champ Sélecteur, utilisez la syntaxe suivante :
...
<a name="modifier_libelle_champ_selecteur_ELTTEXTE000366"></a>
...
<a name="cas_des_champs_selecteur_avec_souslibelles_ELTPARAGRAPHE000416"></a>La propriété [SousLibellé](../Proprietes/1000017232.md) permet de connaître et de modifier les sous-libellés des options du champ Sélecteur.
...
<a name="modifier_les_couleurs_des_libelles_des_options_champ_selecteur_ELTTEXTE000425"></a>
...
<a name="proprietes_specifiques_aux_champs_selecteur_ELTTEXTE000468"></a>
