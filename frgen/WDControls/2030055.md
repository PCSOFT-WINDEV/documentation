...
Remarque : Cette page d'aide présente comment transformer des pages en mode Session en pages en mode Session référençable. Pour passer un site en mode AWP en mode Session référençable, consultez [Passez vos sites AWP en mode session référençable](../WDChamp/2030030.md). 
<a name="NOTE1_2"></a>


### Principe des pages référençables en mode session
<a name="principe_des_pages_referencables_mode_session_ELTPARAGRAPHE000032"></a>Lorsqu'une adresse correspondant à une page WEBDEV référençable est saisie dans le navigateur, le Serveur d'application WEBDEV : 
...
<a name="transformer_une_page_mode_session_page_referencable_ELTPARAGRAPHE000050"></a>Pour transformer une page en mode Session en page référençable : 
...
2. Dans l'onglet "Général", dans la zone "Type de page" : 
	...
	- Indiquez si nécessaire le nom de la page à utiliser dans l'URI. Ce nom peut être différent du nom de la page sous l'éditeur. 
			Remarque : Si le site est multilingue, ce nom peut être saisi dans les différentes langues du projet. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Page_session_reference%20-%20HC%20N%B0002.gif&type=thumb)





3. Dans l'onglet "Détail", spécifiez les expressions et mots-clés permettant d'optimiser le référencement de la page (bouton "Editer les expressions et les mots-clés"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Page_session_reference%20-%20HC%20N%B0003.gif&type=thumb)
...
- Une page référençable peut être ouverte : 
	...
	- soit par un champ Lien ou un champ Bouton (solution conseillée). Dans la fenêtre de description du champ utilisé : 
		...
		- sélectionnez le nom de la page à ouvrir. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Page_session_reference%20-%20HC%20N%B0004.gif)


		- cliquez sur "Paramètres" pour spécifier les paramètres à passer à la page. Chaque paramètre peut correspondre à une valeur fixe, un champ ou une variable. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Page_session_reference%20-%20HC%20N%B0005.gif)
...
- La fonction [PagePrécédente](../WDLang2/3058017.md) ne peut pas être utilisée dans une page référençable. En effet, la page précédente peut être n'importe quelle page, et notamment une page n'appartenant pas au site en cours.  
...
[Passez vos sites AWP en mode session référençable](../WDChamp/2030030.md)
