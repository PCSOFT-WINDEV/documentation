...
## Présentation
<a name="presentation_ELTTEXTE000413"></a>
...
[**Le logiciel Etats & Requêtes**](../Presentation/3088004.md) ne permet pas de créer des états sur un champ Table. Cependant, il est possible de personnaliser des états sur un champ Table créés sous l'éditeur d'états intégré (couleur, polices, taille, ...).
...
<a name="caracteristiques_etat_sur_champ_table_ELTTEXTE000446"></a>
...
- Chaque colonne du champ Table correspond à un champ Libellé (même les colonnes invisibles).
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Remarque: Les colonnes définies comme ne devant pas être imprimées (option "Export et impression" dans l'onglet "Général" de la description de la colonne) ne sont pas prises en compte. 
...
**Attention**: Les données imprimées dans l'état sont triées selon la colonne de tri définie pour le champ Table.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatTable.gif&type=thumb)
...
<a name="creer_etat_sur_champ_table_depuis_editeur_fenetres_ELTTEXTE000470"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) L'éditeur de fenêtres permet de créer automatiquement un état sur un champ Table et un bouton permettant de lancer l'impression de l'état. Aucune programmation n'est nécessaire. 
...
<a name="creer_automatiquement_etat_bouton_permettant_lancer_impression_etat_ELTPARAGRAPHE000087"></a>
...
<a name="caracteristiques_etat_sur_champ_table_cree_ELTPARAGRAPHE000119"></a>
...
- le thème de l'état créé correspond au thème du projet en cours.
...
<a name="creer_etat_sur_champ_table_depuis_editeur_etats_ELTTEXTE000506"></a>
...
### Créer un état sur un champ Table depuis l'éditeur d'états
<a name="creer_etat_sur_champ_table_depuis_editeur_etats_ELTPARAGRAPHE000161"></a>
...
<a name="imprimer_etat_sur_champ_table_ELTTEXTE000536"></a>


### Imprimer un état sur un champ Table
<a name="imprimer_etat_sur_champ_table_ELTPARAGRAPHE000268"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Si la fenêtre contenant le champ Table source de l'état est ouverte plusieurs fois (ouverture non modale par la fonction [OuvreFille](../WDLang1/3038021.md)), il faut passer en paramètre à l'état le nom complet du champ Table à imprimer. Par exemple: 
...
### Exemple WINDEV
<a name="exemple_windev_ELTPARAGRAPHE000342"></a>
...
### Exemple WEBDEV
<a name="exemple_webdev_ELTPARAGRAPHE000358"></a>
