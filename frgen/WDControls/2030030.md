...
2. Dans l'onglet "Projet" de la fenêtre de description du projet, dans la zone "Type de site", sélectionnez "Session". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Page_session_reference%20-%20HC%20N%B0001.gif&type=thumb)
...
2. Dans l'onglet "Général" : 
	...
	- Si la page est référençable, cochez l'option "Référençable". Si nécessaire, modifiez le nom à utiliser dans l'URI. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Page_session_reference%20-%20HC%20N%B0002.gif&type=thumb)
...
[Page référençable en mode session](../WDChamp/2030055.md)

[Les pages AWP](../WDChamp/3539009.md)

[Page AWP sans UI](../WDChamp/9000197.md)
