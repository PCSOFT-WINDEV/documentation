...
N'hésitez pas à consulter la documentation de ces fonctions. Pour plus de détails, consultez la [liste des fonctions de gestion des champs Table hiérarchique](../WDLang1/1000021941.md). 
...
<a name="initialisation_champ_table_hierarchique_ELTTEXTE000215"></a>
Pour remplir par programmation un champ Table hiérarchique, il est possible d'utiliser les fonctions suivantes : 

- [&lt;Table&gt;.AjouteLigne](../WDLang1/1000023404.md), [&lt;Table hiérarchique&gt;.AjouteFils](../WDLang1/1000021891.md), [&lt;Table&gt;.InsèreLigne](../WDLang1/1000023407.md) et [&lt;Table hiérarchique&gt;.InsèreFils](../WDLang1/1000021934.md) : dans chaque ligne, la valeur de chaque colonne est séparée par des virgules. 

- [&lt;Table&gt;.Ajoute](../WDLang1/1000023600.md) et [&lt;Table&gt;.Insère](../WDLang1/1000024260.md) : dans une ligne, la valeur de chaque colonne est séparée par TAB.




Si une nouvelle ligne a été ajoutée dans un champ Table hiérarchique avec la fonction [&lt;Table&gt;.Ajoute](../WDLang1/1000023600.md), [&lt;Table&gt;.Insère](../WDLang1/1000024260.md), [&lt;Table&gt;.AjouteLigne](../WDLang1/1000023404.md), [&lt;Table hiérarchique&gt;.AjouteFils](../WDLang1/1000021891.md), [&lt;Table&gt;.InsèreLigne](../WDLang1/1000023407.md) ou [&lt;Table hiérarchique&gt;.InsèreFils](../WDLang1/1000021934.md), la propriété [Nouveau](../Proprietes/2510073.md) est à <u><u><u><u>Vrai</u></u></u></u> (sinon elle est à <u><u><u><u>Faux</u></u></u></u>).

![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remarque** : Pour optimiser le remplissage d'un champ Table hiérarchique, il est possible d'utiliser la propriété [AjouteFilsDifféré](../Proprietes/1000020927.md) sur les lignes du champ Table hiérarchique. 
...
<a name="ajout_modification_lignes_dans_champ_table_hierarchique_ELTTEXTE000335"></a>


### Ajout de lignes dans un champ Table hiérarchique
<a name="ajout_lignes_dans_champ_table_hierarchique_ELTPARAGRAPHE000358"></a>La création d'une ligne dans un champ Table hiérarchique n'est pas automatique. Elle doit être demandée explicitement par un appel aux fonctions :

- [&lt;Table&gt;.Ajoute](../WDLang1/1000023600.md), [&lt;Table&gt;.AjouteLigne](../WDLang1/1000023404.md) ou [&lt;Table hiérarchique&gt;.AjouteFils](../WDLang1/1000021891.md) : ajoute une ligne à la fin du champ,

- [&lt;Table&gt;.Insère](../WDLang1/1000024260.md), [&lt;Table&gt;.InsèreLigne](../WDLang1/1000023407.md) ou [&lt;Table hiérarchique&gt;.InsèreFils](../WDLang1/1000021934.md) : ajoute une ligne à l'indice spécifié ou à l'indice en cours. 


![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remarque** : Si l'option "Saisie en cascade" n'est pas sélectionnée :
...
- Pour insérer automatiquement une ligne dans un champ Table hiérarchique vide, utilisez la fonction [&lt;Table&gt;.Ajoute](../WDLang1/1000023600.md) ou [&lt;Table&gt;.AjouteLigne](../WDLang1/1000023404.md).
...
<a name="modification_une_ligne_une_colonne_ELTPARAGRAPHE000423"></a>Le contenu des lignes et des colonnes d'un champ Table hiérarchique peut être modifié :
...
- par programmation :
	...
	- avec la fonction [&lt;Table&gt;.Modifie](../WDLang1/1000024273.md) ou la fonction [&lt;Table&gt;.ModifieLigne](../WDLang1/1000024275.md) pour modifier le contenu de la ligne en cours ou d'une ligne donnée.
			Par exemple : 
...
<a name="reprendre_saisie_dans_une_colonne_ELTPARAGRAPHE000499"></a>La fonction [DonneFocusEtRetourUtilisateur](../WDLang1/1410088107.md) peut être utilisée pour se replacer en saisie sur une colonne, de la ligne en cours. Par exemple :
...
<a name="ajout_suppression_une_colonne_ELTPARAGRAPHE000516"></a>Il est possible de :
...
<a name="gestion_des_colonnes_calculees_ELTPARAGRAPHE000535"></a>La formule de calcul d'une colonne calculée doit être décrite dans l'événement "Affichage d'une ligne" du champ Table. Par exemple :
...
<a name="operations_sur_les_lignes_les_cellules_ELTTEXTE000541"></a>


### Suppression d'une ligne
<a name="suppression_une_ligne_ELTPARAGRAPHE000564"></a>La suppression d'une ligne doit être demandée explicitement à l'aide des fonctions [&lt;Table&gt;.Supprime](../WDLang1/1000024289.md) et [&lt;Table hiérarchique&gt;.SupprimeFils](../WDLang1/1000021938.md).

- La syntaxe utilisée pour la fonction [&lt;Table&gt;.Supprime](../WDLang1/1000024289.md) est : 
	
	```txt
	<Champ Table hiérarchique>.Supprime([<Indice>])
	```

	Si l'indice est précisé, la fonction [&lt;Table&gt;.Supprime](../WDLang1/1000024289.md) supprime la ligne correspondant à l'indice. Sinon, elle supprime la ligne en cours.
	La suppression d'une ligne du champ Table hiérarchique supprime toutes les valeurs des colonnes pour cette ligne.

- La syntaxe utilisée pour la fonction [&lt;Table hiérarchique&gt;.SupprimeFils](../WDLang1/1000021938.md) est : 
...
<a name="selection_une_ligne_ELTPARAGRAPHE000622"></a>La sélection d'une ligne s'effectue avec la fonction [&lt;Table&gt;.SelectPlus](../WDLang1/1000024287.md).
...
<a name="recuperation_une_ligne_une_cellule_ELTPARAGRAPHE000645"></a>Le contenu d'un champ Table hiérarchique peut être récupéré :
...
<a name="valeur_une_cellule_ligne_cours_ELTPARAGRAPHE000658"></a>Pour récupérer la valeur d'une colonne (ou cellule) de la ligne en cours, la syntaxe est la même que pour un champ de saisie simple : 
...
<a name="valeur_une_cellule_pour_une_ligne_specifique_ELTPARAGRAPHE000673"></a>Pour récupérer la valeur d'une colonne qui n'est pas sur la ligne en cours, il faut passer l'indice de la ligne : 
...
<a name="contenu_ligne_cours_ELTPARAGRAPHE000688"></a>Pour récupérer le contenu de la ligne en cours : 
...
<a name="contenu_une_ligne_specifique_ELTPARAGRAPHE000700"></a>Pour récupérer le contenu de la ligne d'indice &lt;Indice&gt; :

```txt
<Valeur> = <Champ Table hiérarchique>[<Indice>]
```

**Remarque** : l'indice de la ligne en cours peut être connu par la fonction [&lt;Table&gt;.Select](../WDLang1/1000024284.md). Par exemple : 
...
<a name="operations_sur_arborescence_ELTTEXTE000721"></a>


### Enrouler tous les noeuds d'un champ Table hiérarchique
<a name="enrouler_tous_les_noeuds_champ_table_hierarchique_ELTPARAGRAPHE000744"></a>Pour enrouler tous les noeuds de l'arbre d'un champ Table hiérarchique, utilisez la fonction [&lt;Table&gt;.EnrouleTout](../WDLang1/1000021847.md). La syntaxe utilisée est : 
...
<a name="derouler_tous_les_noeuds_champ_table_hierarchique_ELTPARAGRAPHE000766"></a>Pour dérouler tous les noeuds de l'arbre d'un champ Table hiérarchique, utilisez la fonction [&lt;Table&gt;.DérouleTout](../WDLang1/1000021834.md). La syntaxe utilisée est :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Remarque : Si le champ Table hiérarchique utilise le remplissage différé des sous-niveaux via la propriété [AjouteFilsDifféré](../Proprietes/1000020927.md), la procédure de remplissage des sous-niveaux sera exécutée pour chaque nouvel élément déroulé. 
<a name="NOTE5_3"></a>


### Connaître le numéro de la ligne enroulée/déroulée
<a name="connaitre_numero_ligne_enrouleederoulee_ELTPARAGRAPHE000797"></a>Pour connaître le numéro de la ligne qui est enroulée ou déroulée, il suffit d'utiliser le code "Enroulé, déroulé" d'un noeud du champ Table hiérarchique : 
...
<a name="definir_prochain_etat_ligne_ajoutee_ELTPARAGRAPHE000809"></a>Il est possible de définir pour un champ Table hiérarchique l'état de la prochaine ligne qui sera ajoutée, à savoir enroulée ou déroulée. Pour cela, utilisez la propriété [Enroulé](../Proprietes/2513014.md).
...
<a name="connaitre_modifier_les_images_des_lignes_ELTPARAGRAPHE000824"></a>Pour connaître et modifier les images des lignes d'un champ Table hiérarchique, utilisez les propriétés :
...
<a name="colonne_hierarchique_type_interrupteur_ELTPARAGRAPHE000845"></a>Il est possible de définir dans un champ Table hiérarchique une colonne de type Interrupteur comme "Colonne hiérarchique". Dans ce cas, la colonne interrupteur permet de gérer la hiérarchie.
...
<a name="connaitre_parent_les_fils_element_ELTPARAGRAPHE000864"></a>Il est possible de connaître le parent ou les fils d'un élément grâce aux fonctions suivantes : 

- [&lt;Table hiérarchique&gt;.RécupèreParent](../WDLang1/1000021937.md) : Renvoie le "parent" d'un élément, c'est-à-dire l'élément de niveau immédiatement supérieur. 

- [&lt;Table hiérarchique&gt;.RécupèreFils](../WDLang1/1000021936.md) : Renvoie les fils d'un élément, c'est-à-dire les éléments de niveau immédiatement inférieur.
...
<a name="proprietes_specifiques_aux_champs_table_hierarchique_ELTTEXTE000880"></a>
...
[Fonctions de gestion des champs Table hiérarchique (syntaxe préfixée)](../WDChamp/1000021941.md)

[Propriétés associées au champ Table hiérarchique](../WDChamp/1015003.md)

[Evénements associés aux champs Table hiérarchique](../WDChamp/1015002.md)

[Comment remplir un champ Table hiérarchique ? ](../WDChamp/20051.md)

[Manipuler un champ Table hiérarchique par programmation](../WDChamp/1015004.md)
