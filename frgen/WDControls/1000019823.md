...
L'assistant de génération d'une application Android contenant un champ Carte récupère automatiquement une empreinte SHA-1 du certificat. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Carte1_Bis.gif&type=thumb)
...
4. Dans la liste des API associés au projet, activez le service Google Maps Android API v2 en positionnant l'interrupteur sur ON. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Google1.gif&type=thumb)
...
2. Cliquez sur "CREATE NEW KEY". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Google2.gif&type=thumb)


3. Dans la fenêtre popup qui s'ouvre, cliquez sur "Android key". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Google3.gif)


4. Collez l'empreinte SHA-1 du certificat (générée par WINDEV Mobile). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Google4.gif)


5. Récupérez la clé générée dans la section "Key for Android apps (with certificates)".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Google5.gif&type=thumb)


6. La clé obtenue peut être copiée dans l'assistant de génération de l'application Android. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Carte1_Bis.gif&type=thumb)
