...
Une rupture dans un champ Zone répétée permet de regrouper des données correspondant à un ou plusieurs arguments.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RuptureZR.GIF)
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Les champs Zone répétée en mode Classique, Ajax et Navigateur.




![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Les ruptures ne sont pas disponibles en Java.
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Les ruptures dans les champs Zone répétée ne sont pas disponibles dans les champs Zone répétée multicolonne. 
...
## Ajout d'une rupture
<a name="ajout_une_rupture_ELTTEXTE000368"></a>


### Ajouter une rupture
<a name="ajouter_une_rupture_ELTPARAGRAPHE000072"></a>
...
2. Dans l'onglet "Contenu", cliquez sur le bouton <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=BtnRupture.GIF)
. La fenêtre de gestion des ruptures apparaît: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FenRupture.GIF)
...
3. Sélectionnez la rubrique ou l'attribut sur lequel une rupture doit être effectuée. Il est possible de sélectionner plusieurs rubriques et/ou attributs pour effectuer plusieurs ruptures. 
	...
	- ***Dans un champ Zone répétée lié à une table***:
		...
		- *parcours programmé*: les rubriques de la table, les attributs liés à ces rubriques et les attributs liés à aucune rubrique sont proposés.
...
6. Indiquez le mode de fonctionnement des ruptures: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) si les ruptures doivent être des "Ruptures avec enroulé/déroulé". Si cette option est cochée, un bouton "+ /-" est automatiquement ajouté dans le haut de rupture. Ce bouton permettra à l'utilisateur d'enrouler ou de dérouler la rupture à sa convenance. 

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) si les ruptures doivent être des "Ruptures enroulables/déroulables par simple clic dans le fond". Si cette option est cochée, il suffit à l'utilisateur de cliquer dans le haut de rupture pour enrouler ou dérouler la rupture à sa convenance.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Un haut de rupture peut être toujours visible. Dans ce cas, lors du défilement, le bandeau de la rupture ne sera pas déplacé. Pour rendre un haut de rupture toujours visible: 
...
<a name="haut_bas_rupture_ELTPARAGRAPHE000119"></a>
...
<a name="image_des_boutons_rupture_ELTPARAGRAPHE000143"></a>
...
5. Dans la zone qui s'affiche, saisissez le chemin de l'image du bouton des ruptures. Cette image est une image à 2 états (plus et moins) au format 24 x 12. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Rupture_Perso_Btn.gif&type=thumb)
...
<a name="manipulation_des_champs_presents_dans_les_hauts_les_bas_ruptures_ELTTEXTE000404"></a>


### Initialiser les champs présents dans les hauts et les bas de ruptures
<a name="initialiser_les_champs_presents_dans_les_hauts_les_bas_ruptures_ELTPARAGRAPHE000159"></a>
...
<a name="recuperer_valeur_des_champs_presents_dans_les_hauts_les_bas_ruptures_ELTPARAGRAPHE000190"></a>
...
<a name="calculs_automatiques_dans_les_ruptures_des_champs_zone_repetee_ELTTEXTE000434"></a>
...
5. Sélectionnez l'élément sur lequel le calcul doit être effectué. Il est possible d'effectuer le calcul sur:
	...
	- Une rubrique de la table (uniquement pour les champs Zone répétée liées aux données).
...
<a name="manipulation_des_hauts_des_bas_ruptures_par_programmation_ELTTEXTE000458"></a>
...
<a name="fonctions_associees_aux_hautsbas_ruptures_ELTPARAGRAPHE000261"></a>Les fonctions associées aux hauts / bas de ruptures sont les suivantes:
...
<a name="proprietes_associees_aux_hauts_bas_ruptures_ELTPARAGRAPHE000269"></a>Plusieurs propriétés permettent de manipuler les ruptures par programmation, principalement: 
...
<a name="gestion_des_ruptures_dans_les_champs_zone_repetee_par_programmation_ELTTEXTE000559"></a>
...
[Propriétés associées aux ruptures d'un champ Zone répétée](../WDChamp/1010045.md)

[Mémoriser les ruptures dans les champs Table/Zone répétée (FAA)](../WDChamp/9500138.md)

[Fonctions de gestion des ruptures](../WDChamp/1000022793.md)

[Evénements associés à une rupture](../WDChamp/1013348.md)
