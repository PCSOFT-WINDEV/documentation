...
### Imprimer un état sur une variable
<a name="imprimer_etat_sur_une_variable_ELTPARAGRAPHE000127"></a>
...
<a name="exemples_windev_windev_mobile_ELTPARAGRAPHE000179"></a>
...
### Exemple WEBDEV
<a name="exemple_webdev_ELTPARAGRAPHE000194"></a>
...
<a name="imprimer_etat_parametre_base_sur_une_variable_ELTPARAGRAPHE000215"></a>
...
3. Paramétrer la destination de l'impression de l'état:
	...
	- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) En WINDEV Mobile, grâce à la fonction [iConfigure](../WDLang5/3046072.md) ou [iParamètre](../WDLang5/3046008.md). Ces fonctions ouvrent une boîte de dialogue dans laquelle l'utilisateur sélectionne l'imprimante à utiliser par défaut.
			Pour plus de détails, consultez [Modes d'impression d'un état](../WDChamp/1011031.md).
...
<a name="exemple_windev_windev_mobile_ELTPARAGRAPHE000268"></a>
...
### Exemple WEBDEV
<a name="exemple_webdev_ELTPARAGRAPHE000286"></a>
