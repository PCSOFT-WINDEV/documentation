...
- ** 2ème méthode** :
	...
	3. Cliquez une nouvelle fois sur le champ. Le curseur de la souris se transforme en curseur de saisie.
		...
		- dans une fenêtre :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=LibelleModifDirect.gif)


		- dans un état :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=LibelleModifDirectetat.gif)
...
2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Combo_des_saisie_btn_multilangue.gif) située à côté de la combo "Masque de saisie" ou "Masque" (onglet "Général" ou "Détail"). Par défaut, le même masque est associé à toutes les langues gérées par la fenêtre, la page ou l'état.
...
2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) située à côté de l'option "Image" ou "Image de fond" (onglet "Général" ou "Style"), puis sélectionnez l'option "Multilingue". 
	Par défaut, le même fichier est associé à toutes les langues gérées par la fenêtre, la page ou l'état.

3. Pour chaque langue, cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif), sélectionnez l'option "Parcourir", puis sélectionnez l'image correspondant à la langue. 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png) Dans les champs d'une fenêtre, pour chaque langue gérée par la fenêtre, il est possible de définir :
...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Les fenêtres d'aide ne sont pas disponibles.
<a name="NOTE5_2"></a>
...
[Développer des applications multilingues](../WDChamp/3054008.md)
