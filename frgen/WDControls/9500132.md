...
- propose d'imprimer en mode paysage, <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_Imprimer_Table_portrait.gif)


- informe que toutes les colonnes ne pourront pas être imprimées sur une même page. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=FAA_Imprimer_Table_grand.gif)
...
[Imprimer le contenu d'une table hiérarchique (FAA)](../WDChamp/1015008.md)
