...
2. Indiquez le nom de la tranche et sa taille puis validez. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Ancrages%20-%20HC%20N%B0005.gif)
...
3. Dans la fenêtre qui s'affiche, il est possible de paramétrer : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Ancrages%20-%20HC%20N%B0004.gif)
...
Ces options sont également disponibles dans le volet "Tranches" de WEBDEV. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Ancrages%20-%20HC%20N%B0003.gif&type=thumb)
...
- Cette surcharge peut être visualisée : 
	...
	- dans la liste des surcharges de la tranche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20tranches%20-%20HC%20N%B0003.gif&type=thumb)


		- via l'option "Tranches .. Liste des surcharges pour tous les champs" du menu contextuel d'un champ.

- via l'option "Liste des surcharges" du menu contextuel de l'entête de la tranche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20tranches%20-%20HC%20N%B0002.gif)

- dans la liste des surcharges du champ pour la tranche en cours. Pour afficher cette liste, sélectionnez l'option "Tranches .. Liste des surcharges pour les champs sélectionnés".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20tranches%20-%20HC%20N%B0004.gif&type=thumb)
...
2. Sélectionnez l'option "Tranches", puis dans la section "Visibilité par tranche", sélectionnez la tranche où le champ doit disparaître. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20tranches%20-%20HC%20N%B0004%201.gif&type=thumb)
