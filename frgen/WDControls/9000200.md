...
<a name="creer_une_fenetre_type_widget_ios_ELTPARAGRAPHE000016"></a>Pour créer une fenêtre de type Widget iOS dans une configuration Widget iOS : 
...
3. Une nouvelle fenêtre est créée sous l'éditeur. Seuls 2 types de champs sont disponibles dans les fenêtres Widget iOS 14 : [les champs Libellé](../WDChamp/1013179.md) et [les champs Image](../WDChamp/1013218.md).
...
2. Dans l'onglet "UI", sélectionnez "Widget (Android/iOS14+)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0001.gif)
...
<a name="taille_une_fenetre_widget_ELTPARAGRAPHE000047"></a>La taille d'une fenêtre Widget est définie en nombre de cellules verticales et horizontales. Cette taille est paramétrable dans l'onglet "UI" de la fenêtre de description : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0003.gif)


Sous iOS, plusieurs tailles standards sont utilisées : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0002.gif)
...
<a name="reaffichage_fenetre_widget_ELTPARAGRAPHE000094"></a>L'affichage du dessin d'une fenêtre Widget est effectué par le processus qui gère l'écran d'accueil de l'appareil. Cet affichage de la fenêtre du Widget n'est pas effectué en permanence. Il est mis à jour dans les cas suivants : 
...
<a name="image_description_widget_ELTPARAGRAPHE000108"></a>Lors de l'installation d'un Widget sur le bureau, l'utilisateur dispose de la liste des Widgets présents sur son poste. Cette liste contient pour chaque Widget : 
...
La description du Widget est saisie dans l'onglet "UI" de la fenêtre de description de la fenêtre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0003%202.gif)
...
<a name="fermeture_une_fenetre_widget_ELTPARAGRAPHE000167"></a>Il n'est pas possible de demander explicitement la fermeture d'une fenêtre de type Widget. La fonction [Ferme](../WDLang1/3038018.md) déclenchera une erreur fatale si elle est utilisée en mode Widget. 
...
[Développer une application Widget iOS 14](../WDChamp/1000019929.md)

[Fonctions Widget](../WDChamp/1410087601.md)
