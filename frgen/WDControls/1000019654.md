...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [lié à une table](../WDChamp/1000019543.md).

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [lié à une variable](../WDChamp/1000019543.md).
...
<a name="manipuler_champ_planning_par_programmation_ELTTEXTE000177"></a>


### Ajouter une ressource
<a name="ajouter_une_ressource_ELTPARAGRAPHE000200"></a>

L'ajout d'une ressource dans un champ Planning est réalisé grâce à la fonction [&lt;Planning&gt;.AjouteRessource](../WDLang1/1000022905.md). Cette ressource peut correspondre à une personne, une salle, ...
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Remarque: La fonction [&lt;Planning&gt;.AjouteRessource](../WDLang1/1000022905.md) permet d'insérer une image dans le titre de la ressource.


### Ajouter un rendez-vous
<a name="ajouter_rendezvous_ELTPARAGRAPHE000236"></a>

L'ajout d'un rendez-vous dans un champ Planning est réalisé grâce à la fonction [&lt;Planning&gt;.AjouteRendezVous](../WDLang1/1000022904.md). Cette fonction accepte deux syntaxes: 
...
### Remplir un champ Planning avec les données présentes dans une table HFSQL
<a name="remplir_champ_planning_avec_les_donnees_presentes_dans_une_table_hfsql_ELTPARAGRAPHE000281"></a>

Les enregistrements sont stockés dans une table HFSQL. Le remplissage initial du champ Planning peut être réalisé par un parcours de la table via la syntaxe POUR TOUT et par l'ajout de chaque rendez-vous via la fonction [&lt;Planning&gt;.AjouteRendezVous](../WDLang1/1000022904.md).
...
<a name="recuperer_une_liste_rendezvous_ELTPARAGRAPHE000302"></a>

La fonction [&lt;Planning&gt;.ListeRendezVous](../WDLang1/1000022909.md) permet de récupérer: 
...
<a name="afficher_planning_partir_une_ressource_specifique_une_date_specifique_ELTPARAGRAPHE000350"></a>
...
<a name="supprimer_rendezvous_ELTPARAGRAPHE000391"></a>

La fonction [&lt;Planning&gt;.SupprimeRendezVous](../WDLang1/1000022912.md) permet de supprimer: 
...
<a name="supprimer_une_ressource_ELTPARAGRAPHE000416"></a>

La fonction [&lt;Planning&gt;.SupprimeRessource](../WDLang1/1000022913.md) permet de supprimer une ressource du champ Planning.
...
<a name="modifier_affichage_champ_ELTPARAGRAPHE000444"></a>
...
<a name="manipuler_rendezvous_par_programmation_ELTTEXTE000470"></a>
...
<a name="utilisation_menu_contextuel_faa_ELTTEXTE000523"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Le champ Planning est associé par défaut à un menu contextuel (FAA). Via le menu contextuel du champ Planning, il est possible de: 
...
<a name="utilisation_avancee_des_evenements_associes_champ_planning_ELTTEXTE000569"></a>


### Utilisation avancée des événements avec procédure
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000592"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Ce principe peut être appliqué à tous les événements appelés par le menu contextuel du champ Planning. Exemple: Ouverture d'une fenêtre de saisie du rendez-vous.  
...
<a name="gestion_des_jours_feries_ELTTEXTE000613"></a>
...
<a name="proprietes_specifiques_aux_champs_planning_ELTTEXTE000651"></a>
