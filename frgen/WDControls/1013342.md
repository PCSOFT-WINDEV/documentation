...
<a name="quel_moment_les_calculs_automatiques_sont_effectues_ELTTEXTE000085"></a>
...
- lorsqu'un traitement effectue un ajout ou une modification sur un champ Table avec calculs :
	...
	- les totaux sont recalculés à la fin du traitement (ou lors de l'utilisation de la fonction [Multitâche](../WDLang1/3015004.md)).
...
<a name="recuperer_valeur_calcul_automatique_ELTTEXTE000134"></a>
...
<a name="modifier_les_caracteristiques_des_calculs_automatiques_par_programmation_ELTTEXTE000196"></a>
...
<a name="proprietes_utilisables_sur_les_cellules_calcul_des_colonnes_ELTPARAGRAPHE000235"></a>
...
<a name="exporter_les_resultats_des_calculs_automatiques_ELTTEXTE000336"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Export via les FAA (Fonctionnalités Automatiques de vos Applications) du champ Table
<a name="export_via_les_faa_fonctionnalites_automatiques_vos_applications_champ_table_ELTPARAGRAPHE000361"></a>Le menu contextuel des champs Table et Table hiérarchique propose par défaut des options permettant d'exporter le contenu du champ. 
...
<a name="export_via_les_fonctions_wlangage_ELTPARAGRAPHE000378"></a>Diverses fonctions WLangage permettent d'exporter le contenu d'un champ Table dans un format spécifique (Word, Excel, XML, etc.). Lors de cet export, par défaut les lignes correspondant à un calcul sont également exportées.
...
[Programmation de calculs personnalisés dans les champs Table (syntaxe préfixée)](../WDChamp/1013341.md)
