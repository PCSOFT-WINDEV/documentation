...
**Remarque** : De nombreuses fonctions du WLangage sont spécifiques à la gestion des champs de type Combo. Pour plus de détails, consultez : [les fonctions de gestion des champs Liste et Combo](../WDLang1/1000017419.md) et [fonctions spécifiques à la gestion des champs Combo](../WDLang1/3026006.md).
...
<a name="initialiser_remplir_champ_combo_ELTTEXTE000156"></a>


### Initialiser un élément
<a name="initialiser_element_ELTPARAGRAPHE000179"></a>Pour initialiser un élément d'un champ Combo avec ou sans saisie, utilisez la fonction [&lt;Liste&gt;.Ajoute](../WDLang1/1000017319.md).
...
```
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Sous Android, il n'est pas possible d'affecter une valeur négative ou nulle à un champ Combo. Si le champ Combo n'est pas vide, il doit nécessairement avoir un élément sélectionné. Une erreur sera affichée si une valeur négative ou nulle est affectée à un champ Combo.
<a name="NOTE2_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) 

### Initialiser le champ de saisie (champ Combo avec saisie)
<a name="initialiser_champ_saisie_champ_combo_avec_saisie_ELTPARAGRAPHE000202"></a>Pour initialiser le champ de saisie d'un champ Combo avec saisie, utilisez :
...
- soit la fonction [&lt;Liste&gt;.Ajoute](../WDLang1/1000017319.md).
...
<a name="remplir_champ_combo_ELTPARAGRAPHE000234"></a>Pour initialiser un champ Combo, il suffit d'utiliser une boucle d'itération pour initialiser tous les éléments du champ.
...
<a name="selectionner_element_dans_champ_combo_ELTTEXTE000252"></a>


### Sélectionner un élément dans un champ Combo
<a name="selectionner_element_dans_champ_combo_ELTPARAGRAPHE000275"></a>Pour sélectionner l'élément de la ligne &lt;Indice&gt;, utilisez :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) **Remarque** : Pour un champ Combo avec saisie, seule la seconde syntaxe est possible.
...
<a name="selectionner_dernier_element_champ_combo_ELTPARAGRAPHE000321"></a>Pour se positionner sur le dernier élément du champ Combo, utilisez :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) **Remarque** : Pour un champ Combo avec saisie, seule la dernière syntaxe est possible.
...
<a name="recuperer_element_selectionne_dans_champ_combo_ELTTEXTE000371"></a>


### Récupérer l'indice de l'élément sélectionné
<a name="recuperer_indice_element_selectionne_ELTPARAGRAPHE000394"></a>Pour récupérer l'indice de l'élément sélectionné, utilisez :
...
<a name="recuperer_valeur_element_selectionne_ELTPARAGRAPHE000408"></a>Pour récupérer la valeur de l'élément sélectionné, utilisez une des syntaxes suivantes :
...
- Syntaxe 3 : Champ Combo avec ou sans saisie : Propriété [ValeurAffichée](../Proprietes/2510129.md)
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Code serveur uniquement
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Syntaxe spécifique : Champ Combo avec saisie :
...
<a name="chercher_element_dans_champ_combo_avec_table_ELTTEXTE000435"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Pour rechercher un élément dans un champ Combo avec table, utilisez la fonction [TableCherche](../WDLang1/3074015.md).

**Rappel** : Pour effectuer une recherche dans un champ Combo "classique", utilisez la fonction [&lt;Liste&gt;.Cherche](../WDLang1/1000017320.md).
...
<a name="proprietes_specifiques_gestion_des_champs_combo_ELTTEXTE000473"></a>
