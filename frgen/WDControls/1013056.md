...
Par exemple, un champ "RTF" permet d'afficher le texte suivant :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RTFimage1.gif)
...
- par programmation (propriété [Libellé](../Proprietes/2510053.md)).
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remarque** : Il est également possible d'utiliser la fonction [RTFCharge](../WDLang1/3025041.md) pour affecter le champ RTF.
...
[Propriétés associées au champ RTF](../WDChamp/1013054.md)
