...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) En WINDEV et WINDEV Mobile, c'est une fenêtre interne. 

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) En WEBDEV, c'est une page interne. 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) **Onglet "Détail" : Position du menu contextuel**
Le menu contextuel du champ Tableau de bord permet à l'internaute de : 

- Passer en mode édition. Le mode édition permet à l'internaute de changer l'ordre des widgets, de modifier leur taille, ... La configuration des options proposées peut être réalisée avec la fonction [TDBMode](../WDLang1/1000020956.md). 
...
- spécifier le bouton à utiliser (option "Utiliser le bouton"). Par défaut, un bouton est créé lors de la création du champ Tableau de bord. Il est possible d'utiliser un autre bouton présent dans la page. Ce bouton doit être associé à l'action "Ouvrir le menu du Tableau de bord" (Onglet "Général" de la fenêtre de description du bouton). Si le bouton "Aucun" est sélectionné, le menu contextuel ne sera pas proposé. 
	Remarque : Pour ne pas proposer le menu contextuel par programmation, il est possible de le rendre invisible avec la propriété [Visible](../Proprietes/2510138.md). 

- indiquer la position du bouton qui ouvrira le menu contextuel (option "à la position"). Ce bouton peut être positionné en haut à gauche, en haut à droite, en bas à gauche, en bas à droite du champ Tableau de bord. 
...
- **Mémoriser la configuration des Widgets** : Cette option permet de sauvegarder automatiquement à la fermeture de la fenêtre (ou de la page) la configuration du champ Tableau de bord réalisée par l'utilisateur. Cette configuration sera automatiquement ré-affichée lors de la prochaine ouverture de la fenêtre (ou de la page).  
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Remarque : L'utilisateur peut configurer son Tableau de bord grâce au menu contextuel des FAA (Fonctionnalités Automatiques de vos Applications). Pour plus de détails, consultez [FAA du champ Tableau de bord](../WDChamp/1000031005.md). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Mode édition permanent** : Cette option permet de proposer le champ Tableau bord en mode édition directement lors de son affichage. L'utilisateur pourra directement déplacer, redimensionner ou masquer les widgets. 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) une fenêtre interne. 

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) une page interne. 
...
2. Dans la fenêtre qui s'ouvre : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) sélectionnez la ou les fenêtres internes à ajouter comme Widget et validez.

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) sélectionnez la ou les pages internes à ajouter comme Widget et validez.
...
[Manipuler un champ Tableau de bord par programmation](../WDChamp/1000031004.md)

[Manipuler un champ Tableau de bord par programmation (syntaxe préfixée)](../WDChamp/1000031006.md)

[Propriétés associées au champ Tableau de bord](../WDChamp/1000031003.md)

[Evénements associés à un champ Tableau de bord](../WDChamp/1000031002.md)

[Fonctions de gestion des champs Tableau de bord](../WDChamp/1000021048.md)

[Fonctions de gestion des champs Tableau de bord (syntaxe préfixée)](../WDChamp/1000022537.md)

[Champ Tableau de bord : Fonctionnalités Automatiques de vos Applications (FAA)](../WDChamp/1000031005.md)
