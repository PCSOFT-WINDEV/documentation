...
<a name="questce_quun_element_ELTTEXTE000260"></a>
...
| Table | Rubriques d'une table |   |

Les options de menu et les rubriques d'une table font l'objet d'une manipulation particulière. Pour plus de détails, consultez les paragraphes [Cas particulier: Rubriques](#NOTE3_2) et [Cas particulier: Options de menu](#NOTE4_2).
...
<a name="manipulation_element_ELTTEXTE000284"></a>
Pour manipuler un élément (page, fenêtre, état, requête ou table) dans un événement ou traitement WLangage, il suffit d'utiliser le nom de cet élément. Ce nom peut être utilisé:
...
<a name="manipulation_element_2_niveau_ELTTEXTE000308"></a>
...
### Je suis désolé, je n'ai pas reçu le texte à modifier. Pourriez-vous le fournir afin que je puisse effectuer les remplacements demandés 
<a name="suis_desole_nai_pas_recu_texte_modifier_pourriezvous_fournir_afin_que_puisse_effectuer_les_remplacements_demandes_ELTPARAGRAPHE000105"></a>

Pour manipuler par programmation une rubrique d'une table ou d'une requête, il suffit:

- soit d'utiliser directement le nom de la rubrique. Cette syntaxe est valable uniquement si la rubrique est manipulée à l'aide d'une fonction ou d'une propriété dans laquelle le nom de la table ou de la requête à laquelle la rubrique appartient est spécifié.
...
<a name="manipulation_element_3_niveau_ELTTEXTE000338"></a>
...
<a name="NOTE4_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 

### Cas particuliers: Options de menus
<a name="cas_particuliers_options_menus_ELTPARAGRAPHE000145"></a>
...
<a name="recuperer_nom_element_dans_code_ELTTEXTE000368"></a>
...
<a name="recuperer_nom_element_grace_drag_and_drop_ELTPARAGRAPHE000195"></a>
