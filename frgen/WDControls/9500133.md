...
<a name="etat_initial_champ_table_ELTTEXTE000358"></a>
L'état initial du champ Table peut être:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Table_Ini_WB.gif)
...
<a name="detail_des_options_affichage_ELTTEXTE000382"></a>


### Mode de sélection d'une ligne
<a name="mode_selection_une_ligne_ELTPARAGRAPHE000110"></a>
...
Les modes de sélection disponibles sont les suivants: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Table_ModeSel_WB.gif)
...
- Champs Table en mode "Serveur": la sélection multiple est disponible uniquement pour les champs Table liée aux données. 
...
<a name="mode_selection_une_cellule_table_par_programmation_ELTPARAGRAPHE000138"></a>
...
Les modes de sélection disponibles sont les suivants: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Caracteristiques_des_tables_WB%20-%20HC%20N%B0005.gif)
...
### Options d'affichage
<a name="options_affichage_ELTPARAGRAPHE000167"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Table_Options_WB.gif)
...
- Si l'option "Avec titres de colonnes" est sélectionné, le bouton **"Editer les sur-entêtes de colonnes"** permet de définir des titres supplémentaires affichés au-dessus du titre d'une ou plusieurs colonnes. Pour définir un sur-entête de colonnes:
	...
	3. Dans la fenêtre qui s'ouvre, les différentes colonnes de la table sont affichées.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TableAjouteSurEntete_Edit.gif&type=thumb)
...
- **Afficher un bouton 'burger' avec le menu contextuel d'export**: un menu contextuel associé au champ (icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Table_menuctx.gif)) est affiché. Ce menu contextuel permettra à l'internaute d'exporter le contenu du champ Table vers un fichier Excel, Word, XML (avec feuille de styles) ou d'imprimer en PDF. Ce fichier sera téléchargé sur le poste de l'internaute.
...
**Exemple**: Champ Table Serveur avec titre des colonnes, gestion d'un bandeau de sélection, un menu contextuel d'export et un bandeau de sélection: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Table_avec-options.gif)
...
<a name="ascenseurs_dans_champ_table_ELTTEXTE000418"></a>
