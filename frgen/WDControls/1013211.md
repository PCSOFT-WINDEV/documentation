...
- [Champ Libellé (de type texte, monétaire, Markdown, RTF, HTML, Date, Heure)](#NOTE2).
	![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Champ Libellé RTF non disponible.
...
- [Champ Graphe](#NOTE2_8).
	![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Non disponible.
...
### Champ Libellé
<a name="champ_libelle_ELTPARAGRAPHE000105"></a>
...
Exemples:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Libelle_1.gif&type=thumb)
...
- soit sous l'éditeur d'états. Dans ce cas, deux méthodes sont possibles:
	...
	- Méthode 1:
		...
		4. Modifiez si nécessaire la mise en forme du libellé:
			...
			- dans le cas d'un libellé de type texte: grâce aux options de mise en forme présentes sous le volet "Modification", dans le groupe "Édition rapide" du ruban:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_EditionRapide.gif)


			- dans le cas d'un libellé de type RTF: grâce à la barre de mise en forme qui s'affiche au-dessus du champ:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_BarreRTF.gif)
...
- Méthode 2:
	...
	4. Modifiez si nécessaire la mise en forme du libellé dans l'onglet "Style".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_LibelleStyle.gif)
...
### Champ Calculé
<a name="champ_calcule_ELTPARAGRAPHE000240"></a>
...
Exemples:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Calcule.gif)
...
### Champ Image
<a name="champ_image_ELTPARAGRAPHE000272"></a>

Le champ "Image" permet d'afficher une image dans l'état. L'image affichée dans le champ peut:

- être sélectionnée directement depuis la fenêtre de description du champ (onglet "Général") en cliquant sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif): 
...
- correspondre au contenu d'une rubrique de la source de données (par exemple, si la source de données est une table HFSQL, la rubrique peut être de type mémo Image ou de type chaîne de caractères contenant le chemin complet de l'image). Le champ "Image" est alors lié à cette rubrique.
	Remarque: La rubrique (ou la variable) liée au champ est définie dans l'onglet "Liaison" de la fenêtre de description du champ. 
...
Pour sélectionner une image par langue, cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) et sélectionnez l'option "Multilingue". 

Pour plus de détails, consultez [Le champ Image](../WDChamp/1013218.md).
<a name="NOTE2_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) 

### Champ Code-barres
<a name="champ_codebarres_ELTPARAGRAPHE000307"></a>

Le champ "Code-barres" permet d'imprimer très simplement des codes-barres dans vos états.
...
Exemple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_CodeBarres.gif)
...
### Champ Pré-défini
<a name="champ_predefini_ELTPARAGRAPHE000333"></a>
...
Exemple:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_Champ_Predefini.gif)
...
### Champ Graphe
<a name="champ_graphe_ELTPARAGRAPHE000359"></a>
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Ce champ n'est pas disponible. Pour afficher un graphe dans un état, il est possible de: 

	- Créer un graphe dans une fenêtre via un champ Graphe.

	- Sauver une image du graphe avec la fonction [grSauveImage](../WDLang3/1000024953.md). 
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Seuls les champs Graphe créés à partir de la version 17 (ou mis à jour) sont disponibles.
...
Exemple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_graphe.gif&type=thumb)
...
- les caractéristiques des séries: 
	...
	- la source et les données affichées par les étiquettes de catégorie (programmation, table, requête, tableau WLan­gage, source de données de l'état). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtiquetteCategorie.gif)


	- le libellé de la série (utilisé pour les étiquettes de séries): <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtiquetteSerie.gif)
...
### Champ Forme
<a name="champ_forme_ELTPARAGRAPHE000423"></a>
...
### Champ Interrupteur
<a name="champ_interrupteur_ELTPARAGRAPHE000436"></a>

Un champ "Interrupteur" correspond à une case à cocher.

Si la valeur du champ est à <u><u><u><u>Vrai</u></u></u></u>, la case est cochée: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Interrupteur_CaseCochee.gif)

Si la valeur du champ est à <u><u><u><u>Faux</u></u></u></u>, la case est décochée: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Interrupteur_CaseDecochee.gif)

Un champ "Interrupteur" peut être lié à une rubrique ou une variable de la source de données de l'état. Par exemple, si la source de données correspond à une table HFSQL, la rubrique peut être de type booléen ou de type interrupteur.

La taille, la couleur de fond et la couleur de la case à cocher sont entièrement paramétrables.

Exemple:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Interrupteur-Etat.gif)
**Remarque**: La rubrique ou la variable liée au champ est définie dans l'onglet "Liaison" de la fenêtre de description du champ. 
<a name="NOTE2_11"></a>


### Champ Etat Interne
<a name="champ_etat_interne_ELTPARAGRAPHE000465"></a>
...
- un état affichant les données sous forme de graphe. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatInterne.gif&type=thumb)
...
### Champ Lien URL
<a name="champ_lien_url_ELTPARAGRAPHE000508"></a>
...
Exemple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Lien.gif&type=thumb)
...
### Champ de saisie
<a name="champ_saisie_ELTPARAGRAPHE000526"></a>
...
- Le champ de saisie n'est pas lié à une rubrique d'une table ou d'une requête. Pour afficher des informations provenant d'une table ou d'une requête, il est nécessaire de réaliser une affectation du champ par programmation.
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Ce type de champ n'est pas disponible (Acrobat sur iOS ne gère pas la saisie).


Pour plus de détails, consultez [Etats avec saisie](../WDChamp/1011074.md).

<a name="NOTE2_15"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Champ Signature
<a name="champ_signature_ELTPARAGRAPHE000570"></a>

Le champ "Signature" permet de signer les états imprimés au format PDF. Deux types de signatures sont disponibles: 
...
[Options d'édition d'un état](../WDChamp/1011030.md)
...
[Propriétés des états et de leurs champs](../WDChamp/2515010.md)
