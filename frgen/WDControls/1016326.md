...
<a name="manipuler_champ_agenda_par_programmation_ELTTEXTE000355"></a>


### Ajouter un rendez-vous
<a name="ajouter_rendezvous_ELTPARAGRAPHE000063"></a>

L'ajout d'un rendez-vous dans un champ Agenda est réalisé grâce à la fonction [AgendaAjouteRendezVous](../WDLang1/1000018877.md). Cette fonction accepte deux syntaxes: 
...
<a name="remplir_champ_agenda_avec_les_donnees_presentes_dans_une_table_hfsql_ELTPARAGRAPHE000098"></a>

Les enregistrements sont stockés dans une table HFSQL. Le remplissage initial du champ Agenda peut être réalisé par un parcours de la table via la syntaxe POUR TOUT et par l'ajout de chaque rendez-vous via la fonction [AgendaAjouteRendezVous](../WDLang1/1000018877.md).
...
<a name="recuperer_une_liste_rendezvous_ELTPARAGRAPHE000122"></a>

La fonction [AgendaListeRendezVous](../WDLang1/1000018880.md) permet de récupérer: 
...
<a name="afficher_champ_agenda_partir_une_date_specifique_ELTPARAGRAPHE000157"></a>

Pour afficher le champ Agenda à partir d'une date spécifique, utilisez la fonction [AgendaPosition](../WDLang1/1000018889.md).
...
<a name="supprimer_rendezvous_ELTPARAGRAPHE000168"></a>

La fonction [AgendaSupprimeRendezVous](../WDLang1/1000018881.md) permet de supprimer: 
...
<a name="modifier_affichage_champ_ELTPARAGRAPHE000193"></a>
...
<a name="utilisation_menu_contextuel_faa_ELTTEXTE000416"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Possibilités du menu contextuel
<a name="possibilites_menu_contextuel_ELTPARAGRAPHE000216"></a>
...
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000242"></a>
...
<a name="proprietes_specifiques_aux_champs_agenda_ELTTEXTE000472"></a>
