...
<a name="evenements_geres_par_defaut_ELTTEXTE000111"></a>
...
| A chaque modification | Exécuté à chaque clic sur une option du champ Bouton segmenté (uniquement si la sélection est modifiée). <br><br>Cet événement reçoit en paramètre l'indice de l'option modifiée. |
...
<a name="evenements_optionnels_ELTTEXTE000135"></a>
