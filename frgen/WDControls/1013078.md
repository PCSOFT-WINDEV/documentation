...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Les plans sont utilisables sur les pages et les champs conteneurs. Pour plus de détails, consultez [Les plans en WEBDEV](../WDChamp/1013080.md)

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) L'éditeur de fenêtres propose une gestion des plans avancée permettant notamment de nommer les plans. Pour plus de détails, consultez [Edition des plans sous l'éditeur de fenêtres](#NOTE3_1_Nommage).
...
<a name="affecter_plusieurs_champs_plusieurs_plans_ELTTEXTE000392"></a>
...
<a name="selectionner_plan_affiche_sous_editeur_ELTTEXTE000416"></a>
Pour afficher un plan spécifique sous l'éditeur, vous pouvez :

- **Sous l'éditeur de fenêtres** : sous le volet "Fenêtre", dans le groupe "Associer", déroulez "Plans". Dans la fenêtre qui s'affiche, il suffit de choisir le plan à afficher dans la section "Navigation". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=plan18.gif&type=thumb)
...
- Saisir directement le numéro du plan à afficher dans la barre de message de l'éditeur de fenêtres ou d'états. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=PlanFenetre.gif)
...
<a name="edition_des_plans_sous_editeur_fenetres_ELTTEXTE000440"></a>


### Gestion des plans
<a name="gestion_des_plans_ELTPARAGRAPHE000148"></a>La gestion des plans peut être réalisée depuis l'éditeur de fenêtres. Il est possible de : 
...
<a name="afficher_fenetre_gestion_des_plans_ELTPARAGRAPHE000168"></a>**Pour afficher la fenêtre de gestion des plans** (et visualiser les différents plans de la fenêtre) : 

1. Sous le volet "Fenêtre", dans le groupe "Associer", déroulez "Plans" et sélectionnez l'option "Editer les plans" (ou les touches de raccourcis Alt + Page suiv). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Les_plans-nommage%20-%20HC%20N%B0001.gif)


2. La fenêtre affichée présente un aperçu (une vignette) de tous les plans de la fenêtre. Ces vignettes sont classées selon leur numéro d'ordre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Les_plans-nommage%20-%20HC%20N%B0002.gif&type=thumb)
...
### Nommer les plans
<a name="nommer_les_plans_ELTPARAGRAPHE000194"></a>Par défaut, les plans sont numérotés. Si un plan est supprimé, tous les plans suivants sont automatiquement renumérotés. Pour ne pas dépendre du numéro du plan, l'éditeur de fenêtres permet de nommer et de réorganiser les plans d'une fenêtre. 

Pour nommer les plans : 

1. Dans la fenêtre de gestion des plans, sélectionnez la vignette du plan à renommer. 

2. Cliquez sur l'icône "Crayon" : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Les_plans-nommage%20-%20HC%20N%B0002%201.gif)


3. Saisissez le nom du plan dans la zone qui s'affiche : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Les_plans-nommage%20-%20HC%20N%B0003.gif)
...
<a name="modifier_ordre_des_plans_ELTPARAGRAPHE000213"></a>Par défaut, les plans sont affichés selon leur ordre de création. La fenêtre de gestion des plans permet de modifier l'ordre des plans. 
...
<a name="ajouter_supprimer_des_plans_ELTPARAGRAPHE000235"></a>La fenêtre de gestion des plans permet d'ajouter ou de supprimer des plans vides.  
...
2. Affichez le menu contextuel de la sélection (clic droit) et sélectionnez l'option "Insérer un plan vide". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Les_plans-nommage%20-%20HC%20N%B0005.gif)
...
2. Affichez le menu contextuel de la sélection (clic droit) et sélectionnez l'option "Commencer au plan". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Les_plans-nommage%20-%20HC%20N%B0005%201.gif)
...
<a name="changer_plan_par_programmation_ELTTEXTE000488"></a>
...
<a name="changer_plan_dans_une_fenetre_ELTPARAGRAPHE000280"></a>Le changement de plan dans une fenêtre peut être réalisé à tout moment. Souvent, un bouton permet de changer de plan. 
...
<a name="changer_plan_dans_etat_ELTPARAGRAPHE000297"></a>Le changement de plan dans un état doit être fait pendant l'impression de l'état. Il est conseillé d'utiliser la propriété [Plan](../Proprietes/2510094.md) dans un des événements associés à l'état, aux blocs ou aux champs. 
...
[Plan (Propriété)](../WDChamp/2510094.md)

[Bloc Itération (ou bloc de substitution)](../WDChamp/1011039.md)

[iSubstBloc (Fonction)](../WDChamp/3046048.md)

[Les plans en WEBDEV](../WDChamp/1013080.md)
