...
<a name="caracteristiques_rubrique_ELTTEXTE000191"></a>
Un champ Image peut correspondre à une rubrique d'une table, d'une requête, ... Deux types de rubriques peuvent être associés à un champ Image:
...
Dans les deux cas, le champ Image permet d'afficher les informations contenues dans la table.
...
### Stocker les images dans la table sous forme de rubrique Texte
<a name="stocker_les_images_dans_table_sous_forme_rubrique_texte_ELTPARAGRAPHE000023"></a>

Cette solution permet de stocker dans la table le chemin des images.

**Pour gérer les images sous forme de rubrique Texte**: 

1. Dans l'éditeur de schémas des données: 
	...
	- Générez le schéma des données pour prendre en compte les modifications.
...
2. Dans la fenêtre (ou la page) devant permettre de saisir / visualiser l'image:
	...
	- Créez un champ de saisie lié à la rubrique PHOTO_Chemin (dans notre exemple, ce champ s'appelle SAI_Photo). 
			Pour créer ce champ, vous pouvez par exemple réaliser un "Drag and Drop" de la rubrique présente dans le volet "Schéma des Données" vers votre fenêtre/page. 
...
3. L'enregistrement des informations dans la table sera effectué automatiquement lors de l'utilisation:

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) de la fonction [EcranVersFichier](../WDLang4/3044146.md).

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) de la fonction [PageVersDonnées](../WDLang4/3044022.md). 
...
### Stocker les images dans la table sous forme de rubrique "Image"
<a name="stocker_les_images_dans_table_sous_forme_rubrique_image_ELTPARAGRAPHE000079"></a>

Cette solution permet de stocker directement dans la table les images.
...
2. Dans la fenêtre (ou la page) devant permettre de saisir / visualiser l'image:
	...
	- Créez un champ Image (dans notre exemple IMG_Photo). Ce champ Image est relié à la rubrique "Son, image, binaire" créée dans le schéma des données.  Pour créer ce champ, vous pouvez par exemple réaliser un "Drag and Drop" de la rubrique présente dans le volet "Schéma des données" vers votre fenêtre / page.
...
<a name="recuperer_contenu_image_dans_une_rubrique_ELTTEXTE000245"></a>
...
## Vignettes HFSQL
<a name="vignettes_hfsql_ELTTEXTE000292"></a>
