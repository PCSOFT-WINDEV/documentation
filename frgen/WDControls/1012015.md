...
6. Sous le volet "Accueil", dans le groupe "Général", cliquez sur "Enregistrer" (ou cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Enregistrer.gif) parmi les boutons d'accès rapide).




Le modèle de pages correspond à un fichier d'extension ".WWT".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=modele_carreJaune.gif&type=thumb)
...
- Sélectionnez le modèle voulu et cliquez sur le bouton "Ouvrir le modèle" (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_ouvrir_modele.gif)).
...
- directement depuis le modèle de pages, en cliquant sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Modele_MAJ.gif) dans le bandeau du modèle.
...
2. Cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Page_bl.GIF) parmi les boutons d'accès rapide.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ModelePage_ListeModele.gif)
