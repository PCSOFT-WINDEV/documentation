...
3. Affichez l'onglet "Contenu" de la fenêtre de description du champ Table hiérarchique. Sélectionnez le mode de remplissage "Par variable". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TableH_Variable_Contenu.gif&type=thumb)
...
### Créer un champ Table hiérarchique sur variable
<a name="creer_champ_table_hierarchique_sur_variable_ELTPARAGRAPHE000055"></a>Pour créer un champ de type Table hiérarchique sur variable :
...
4. Définissez les différentes sources du champ Table hiérarchique. En effet, un champ Table hiérarchique sur variable est lié à différentes sources, permettant d'afficher des enregistrements imbriqués.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_Table_Hierachique_Var_as.gif)
