...
2. Dans l'onglet "UI", cochez l'option "Epinglé (fixed)". Trois modes sont disponibles : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_ZoneEpingle_modes.gif&type=thumb)
...
4. Cliquez sur "Paramètres" pour choisir le mode de gestion de l'épingle. Trois modes sont disponibles : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WB_CelluleEpingle_modes.gif&type=thumb)
...
[Champ épinglé dans une fenêtre](../WDChamp/9000202.md)
