...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) WEBDEV gère par défaut les événements suivants (ordre d'apparition sous l'éditeur de code) :
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) En PHP, les événements WLangage associés à une page sont les suivants : 
...
| Initialisation (Code serveur) | **Cas 1 : Page avec contexte :** <br>Exécuté qu'une seule fois, au premier affichage de la page pour initialiser le contexte. <br>L'ordre d'exécution des événements est le suivant :<br><br>- Initialisation des champs de la page.<br><br>- Initialisation de la page.<br><br><br>**Cas 2 : Page sans contexte :** <br>Exécuté à chaque affichage de la page. Permet d'exécuter un traitement à chaque fois que le serveur réaffiche la page (par exemple un traitement permettant de vérifier si l'internaute est bien identifié par son login).<br>L'ordre d'exécution des événements est le suivant :<br><br>- Initialisation des champs de la page.<br><br>- Initialisation de la page.<br><br><br> |
| 1er affichage de la page (Code serveur) | **Uniquement pour les pages PHP sans contexte**<br>Exécuté qu'une seule fois, au premier affichage de la page. <br>L'ordre d'exécution des événements est le suivant :<br><br>- Initialisation des champs de la page.<br><br>- Initialisation de la page.<br><br><br> |
| A chaque affichage de la page (Code serveur) | **Uniquement pour les pages PHP avec contexte**<br>Exécuté à chaque affichage de la page. Permet d'exécuter un traitement à chaque fois que le serveur réaffiche la page (par exemple un traitement permettant de vérifier si l'internaute est bien identifié par son login). <br><br>**Rappel** : L'événement "Initialisation" de la page est exécuté qu'une seule fois, au premier affichage de la page pour initialiser le contexte.<br><br>Dans le cas d'une page Ajax, cet événement est exécuté pour chaque requête effectuée au serveur. |
| Chargement (onload) de la page (Code navigateur) | Code navigateur exécuté lors de l'affichage de la page dans le navigateur (réalisé par exemple par les fonctions [PageAffiche](../WDLang2/3058008.md) ou [PageActualise](../WDLang2/3058011.md)). |
...
[NavigateurHistoriqueModifie (Fonction)](../WDChamp/1000023459.md)

[NavigateurHistoriqueAjoute (Fonction)](../WDChamp/1000023458.md)
