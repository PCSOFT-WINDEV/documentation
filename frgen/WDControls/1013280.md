...
1. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_nouveau.gif) parmi les boutons d'accès rapide. La fenêtre de création d'un nouvel élément s'affiche : cliquez sur "Page" puis sur "Page". L'assistant de création d'une page se lance.
...
- ![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Il n'est pas possible d'utiliser deux fois la même page interne dans la même page.
...
[Propriétés WLangage associées aux champs Page interne](../WDChamp/1013282.md)

[Evénements associés aux champs Page interne](../WDChamp/1013347.md)
