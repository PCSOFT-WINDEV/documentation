...
<a name="initialiser_champ_liste_image_ELTTEXTE000371"></a>


### Initialiser un élément
<a name="initialiser_element_ELTPARAGRAPHE000031"></a>

Pour initialiser un élément d'un champ Liste image, utilisez la fonction [ListeAjoute](../WDLang1/3049004.md).
...
<a name="remplir_champ_liste_image_ELTPARAGRAPHE000049"></a>Pour initialiser un champ Liste image, il suffit d'utiliser une boucle d'itération pour initialiser tous les éléments du champ.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) La fonction [ListeProcédureChargeImage](../WDLang1/1410090789.md) permet de définir une procédure WLangage qui sera appelée lors de l'affichage des lignes de la liste. Cette procédure permet d'utiliser des images dynamiques (et non obligatoirement stockées sur le disque).  
...
<a name="selectionner_element_dans_champ_liste_image_ELTTEXTE000401"></a>


### Sélectionner l'élément de la ligne &lt;Indice&gt;
<a name="selectionner_element_ligne_ELTPARAGRAPHE000082"></a>
...
<a name="positionner_sur_dernier_element_champ_liste_image_ELTPARAGRAPHE000106"></a>
...
<a name="recuperer_element_selectionne_dans_champ_liste_image_ELTTEXTE000431"></a>


### Récupérer l'indice de l'élément sélectionné
<a name="recuperer_indice_element_selectionne_ELTPARAGRAPHE000149"></a>
...
<a name="recuperer_valeur_element_selectionne_ELTPARAGRAPHE000189"></a>
...
<a name="proprietes_specifiques_gestion_des_champs_liste_image_ELTTEXTE000467"></a>
