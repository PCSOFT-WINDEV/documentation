...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) lors de l'utilisation du menu contextuel du champ Agenda. 

- lors de l'utilisation de la souris ou du doigt.

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) lors de l'utilisation de la croix de suppression.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Exemple** : Pour mémoriser dans un fichier de données RDV, un rendez-vous que l'utilisateur ajoute via le menu contextuel, il suffit de saisir dans l'événement "Entrée en saisie d'un rendez-vous" : 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Il suffit pour cela de créer une fenêtre avec les informations à remplir. 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Il suffit pour cela de créer une popup avec les informations à remplir.
