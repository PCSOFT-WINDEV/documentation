...
1. Si vous possédez une clé Google Maps API, saisissez-la. Dans le cas contraire, cliquez sur "Obtenir une clé". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Carte1.gif)


2. Pour obtenir la clé, 3 étapes sont nécessaires : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_Carte2.gif)
