...
- **MDI** : 
	Ces fenêtres doivent respecter certaines contraintes propres aux applications MDI (Multiple Document Interface). Dans une application MDI, la fenêtre principale de l'application contient toutes les fenêtres de l'application. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P1_Fenetres%20MDI%20-%20HC%20N%B0001.gif&type=thumb)
