...
- Sous l'éditeur: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_composite_Editeur.gif&type=thumb)


- En exécution: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=etatcomposite.gif&type=thumb)
...
<a name="creer_etat_composite_ELTTEXTE000208"></a>
...
- **Créer un nouveau sous-état**.
	...
	1. Sélectionnez: 
		...
		- le type de sous-état à créer (fiche, tableau, etc.). Pour plus de détails, consultez [Types d'états](../WDChamp/1011054.md).

		- la source de données du sous-état (table, requête, etc.). Pour plus de détails, consultez [Source de données d'un état](../WDChamp/1011055.md).
...
<a name="caracteristiques_des_etats_composites_leurs_sousetats_ELTTEXTE000232"></a>


### Caractéristiques spécifiques aux états composites
<a name="caracteristiques_specifiques_aux_etats_composites_ELTPARAGRAPHE000088"></a>
...
- Pour visualiser la fenêtre de description de l'état composite, plusieurs possibilités: 
	...
	- Sous le volet "Modification", cliquez sur le bouton de regroupement ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_regroup.gif) du groupe "Etat composite". 
...
<a name="caracteristiques_des_sousetats_ELTPARAGRAPHE000114"></a>
...
- Pour visualiser la fenêtre de description du sous-état: 
	...
	2. Sous le volet "Modification", cliquez sur le bouton de regroupement ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_regroup.gif) du groupe "Etat". Il est également possible de sélectionner l'option "Description du sous-état" du menu contextuel de l'état.
...
[iInitSousEtat (Fonction)](../WDChamp/1000019503.md)

[iChangeSousEtatSource (Fonction)](../WDChamp/1000019621.md)
