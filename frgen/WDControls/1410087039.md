...
- Affecter le champ Lecteur PDF directement avec le fichier PDF. Par exemple : 
 ...
 Cas des mots de passe : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Si un mot de passe est utilisé pour protéger le fichier en ouverture, une fenêtre sera affichée pour saisir le mot de passe. 

	- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Il n'est pas possible d'ouvrir un fichier PDF protégé en ouverture.
