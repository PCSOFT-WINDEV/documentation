...
<a name="presentation_champ_zone_texte_riche_ELTTEXTE000210"></a>
...
<a name="creer_champ_zone_texte_riche_ELTTEXTE000234"></a>


### Création du champ
<a name="creation_champ_ELTPARAGRAPHE000033"></a>Pour créer un champ de type Zone de Texte Riche : 

1. Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur "Zone de Texte Riche". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ZTR_Creation.gif)
...
<a name="saisir_texte_dans_champ_zone_texte_riche_ELTPARAGRAPHE000050"></a>Pour saisir du texte dans le champ Zone de Texte Riche : 

1. Sélectionnez le champ. 

2. Cliquez sur le champ : un bandeau jaune apparaît autour du champ et le champ passe en mode édition. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ZTR_Edition_bandeau_Jaune.gif)
...
3. En mode édition : 
	...
	- le ruban de l'éditeur s'adapte à la saisie dans le champ : toutes les options d'édition disponibles sont affichées : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ZTR_Edition_ruban.gif)
...
<a name="inserer_lien_dans_champ_zone_texte_riche_ELTPARAGRAPHE000079"></a>Pour insérer un lien dans le champ Zone de Texte Riche : 
...
<a name="inserer_une_image_dans_champ_zone_texte_riche_ELTPARAGRAPHE000106"></a>Pour insérer une image dans le champ Zone de Texte Riche : 
...
<a name="inserer_une_icone_police_dans_champ_zone_texte_riche_ELTPARAGRAPHE000137"></a>Pour ajouter une icône dans un libellé HTML : 

1. Positionnez le curseur de la souris dans le texte HTML à modifier.

2. Cliquez sur le bouton **Icônes de police** ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestion_des_polices_icones%20-%20HC%20N%B0001%201.gif). 

3. La fenêtre suivante s'affiche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Gestion_des_polices_icones%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="caracteristiques_champ_zone_texte_riche_ELTTEXTE000295"></a>
...
[Manipuler un champ Zone de Texte Riche par programmation](../WDChamp/1000032004.md)

[Propriétés associées au champ Zone de Texte Riche](../WDChamp/1000032003.md)

[Evénements associés à un champ Zone de Texte Riche](../WDChamp/1000032002.md)
