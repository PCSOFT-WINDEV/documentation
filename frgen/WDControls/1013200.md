...
- Dans l'onglet "Général": 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Orientation du champ**:
			Dans une fenêtre d'une application WINDEV, un champ table peut être horizontal ou vertical. 

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Mode de recherche**: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Calculs sur les colonnes**: 
...
- Dans l'onglet "UI": 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Gestion du remplissage**: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Affichage du détail d'une ligne**: 
...
<a name="etat_initial_champ_table_ELTPARAGRAPHE000129"></a>

L'état initial d'un champ Table peut être:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Table_Ini_WD.gif)
...
- **En saisie**: L'utilisateur pourra saisir dans les différentes colonnes du champ si ces colonnes sont en saisie.
	![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Le champ Table n'est pas disponible en saisie. Il est disponible en lecture seulement.
...
<a name="mode_selection_onglet_ELTPARAGRAPHE000191"></a>
...
Les modes de sélection disponibles sont les suivants:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Table_ModeSel_WD16.gif)
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Seul le mode de sélection des lignes est disponible.
<a name="NOTE5_Remplissage"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Gérer le remplissage d'un champ Table par programmation (Onglet "UI")
<a name="gerer_remplissage_champ_table_par_programmation_onglet_ELTPARAGRAPHE000237"></a>
...
<a name="afficher_detail_une_ligne_dans_une_fenetre_interne_onglet_ELTPARAGRAPHE000292"></a>
...
<a name="parametres_ascenseur_ELTPARAGRAPHE000361"></a>

Par défaut, les ascenseurs des champs Table (lié à une table, par programmation ou sur variable) sont proportionnels. La taille de l'ascenseur est proportionnelle au nombre d'éléments à afficher.
...
Les options concernant l'ascenseur sont regroupées dans l'onglet "Détail" de la description du champ Table:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_Table_Ascenseur.gif)
...
<a name="options_affichage_des_colonnes_onglet_detail_ELTPARAGRAPHE000382"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Champ_table_TitreCol19.gif)
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Éditer les sur-entêtes de colonnes**: Il est possible de définir des sur-entêtes de colonnes. Un sur-entête de colonnes est un titre supplémentaire affiché au-dessus du titre d'une ou plusieurs colonnes. Pour plus de détails, consultez [Gestion des titres des colonnes dans un champ Table](../WDChamp/1013330.md). 
...
<a name="forcer_titre_monoligne_ELTPARAGRAPHE000457"></a>
...
<a name="mode_saisie_compatible_55_ELTPARAGRAPHE000472"></a>
