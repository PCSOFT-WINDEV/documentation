...
**Caractéristiques d'un état sur un fichier texte**: Chaque ligne du fichier texte doit correspondre à un enregistrement. Chaque ligne contient plusieurs informations, appelées rubriques. Chaque rubrique est séparée par un séparateur.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatFichierTexte.gif)
...
<a name="utiliser_assistant_creation_etat_sur_fichier_texte_ELTTEXTE000549"></a>


### Création d'un état sur un fichier texte avec lecture automatique des enregistrements
<a name="creation_etat_sur_fichier_texte_avec_lecture_automatique_des_enregistrements_ELTPARAGRAPHE000033"></a>
...
9. Sélectionnez le fichier texte contenant les enregistrements.
	...
	- Les libellés des rubriques ne doivent pas être spécifiés dans ce fichier texte. Par exemple:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatFichierTexte3.gif)
...
<a name="caracteristiques_fichier_texte_lors_deploiement_application_ELTPARAGRAPHE000134"></a>
...
<a name="programmer_entierement_lecture_des_enregistrements_ELTTEXTE000579"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000160"></a>
...
<a name="creer_etat_sur_fichier_texte_avec_lecture_programmee_des_enregistrements_ELTPARAGRAPHE000170"></a>
...
9. Sélectionnez le thème de l'état si nécessaire.
...
<a name="programmer_lecture_des_enregistrements_ELTPARAGRAPHE000235"></a>
...
<a name="ordre_execution_des_differents_evenements_wlangage_ELTPARAGRAPHE000290"></a>
...
<a name="modifier_methode_lecture_des_enregistrements_etat_sur_fichier_texte_ELTTEXTE000621"></a>
...
1. Affichez la fenêtre de description de l'état en utilisant une des méthodes suivantes: 
	...
	- sous le volet "Modification", cliquez sur l'icône de regroupement ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_regroup.gif) du groupe "Etat". 
...
<a name="imprimer_etat_sur_fichier_texte_ELTTEXTE000645"></a>
...
<a name="NOTE5_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Exemple WINDEV et WINDEV Mobile
<a name="exemple_windev_windev_mobile_ELTPARAGRAPHE000449"></a>
...
### Exemple WEBDEV
<a name="exemple_webdev_ELTPARAGRAPHE000468"></a>
