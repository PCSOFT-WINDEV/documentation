...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Le WLangage propose également des fonctions pour créer des ruptures par programmation : 
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Dans une page (code serveur) : 
...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Dans une page (code navigateur) : 
...
- ![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Dans une page (PHP) : 
