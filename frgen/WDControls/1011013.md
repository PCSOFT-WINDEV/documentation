...
- soit ***la requête est basée sur des données provenant d'une connexion*** (non disponible sous WINDEV Mobile). 
	Remarque: Ce type d'état sur requête est disponible même si aucun schéma des données n'est associé au projet WINDEV ou WEBDEV.
...
<a name="etat_sur_requete_independante_ELTTEXTE000626"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000108"></a>

La requête doit être créée avant la création de l'état (pour plus de détails, consultez [Créer une requête](../Editeurs/2032059.md)). Lors de la création de l'état, il suffit de spécifier le nom de la requête utilisée.
...
<a name="creer_etat_sur_requete_independante_ELTPARAGRAPHE000120"></a>
...
12. Sélectionnez le thème de l'état si nécessaire.
...
<a name="etat_sur_requete_integree_ELTTEXTE000656"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000218"></a>
...
<a name="creer_etat_sur_requete_integree_ELTPARAGRAPHE000248"></a>
...
<a name="manipuler_une_rubrique_requete_integree_depuis_code_etat_ELTPARAGRAPHE000364"></a>Pour accéder à une rubrique de la requête intégrée depuis un des codes de l'état, de ses champs ou de ses blocs, utilisez la syntaxe:
...
<a name="etat_base_sur_une_requete_parametree_ELTTEXTE000692"></a>
...
**Si la requête est créée avec le logiciel Etats & Requêtes**, il n'est pas nécessaire d'utiliser la fonction [iInitRequêteEtat](../WDLang5/3046021.md) pour spécifier les paramètres de la requête. En effet, lors de l'exécution d'un état sur une requête paramétrée depuis le logiciel Etats & Requêtes, une fenêtre s'affiche permettant de saisir les paramètres de la requête.
...
<a name="imprimer_etat_base_sur_une_requete_ELTTEXTE000725"></a>
...
<a name="imprimer_etat_base_sur_une_requete_sans_parametre_ELTPARAGRAPHE000444"></a>

Pour imprimer une requête sans paramètre, il suffit de:

1. Paramétrer la destination de l'impression de l'état:

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) En WINDEV, grâce à la fonction [iDestination](../WDLang5/3046074.md) (visualisateur de rapports, impression dans un fichier HTML, ...).

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) En WEBDEV, grâce à la fonction [iDestination](../WDLang5/3046074.md) (impression dans un fichier HTML, ...).
...
2. Préciser le nom de l'état à imprimer grâce à la fonction [iImprimeEtat](../WDLang5/3046032.md).
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Sous WINDEV: pour imprimer l'état "ETAT_Requete":
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Sous Android et iOS: pour imprimer l'état "ETAT_Requete":
	...
	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Sous WEBDEV: pour imprimer l'état "ETAT_Requete" au format HTML:
...
<a name="imprimer_etat_base_sur_une_requete_avec_parametres_ELTPARAGRAPHE000498"></a>
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Sous Android et iOS: 
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Code WEBDEV:
