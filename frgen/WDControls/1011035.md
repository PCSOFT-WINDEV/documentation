...
Dans l'exemple suivant, dans l'assistant de création de l'état, le mode de tri est défini: les données sélectionnées dans la table "Client" seront triées par le nom du pays puis pour chaque région par le nom du client.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_Appli%20compl%E8te%20-%20Imprimer%20liste%20clients%20-%20HC%20N%B0005.jpg)
...
2. Cliquez sur le bouton "Nouveau critère de tri" (icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=etatIconeNewcritereTri.gif)).
...
- La modification d'un critère de tri depuis l'éditeur d'états peut être réalisée uniquement sur les états basés sur une table ou sur une zone mémoire.
...
### Modifier un critère de tri présent dans un état basé sur une table ou sur une zone mémoire
<a name="modifier_critere_tri_present_dans_etat_base_sur_une_table_sur_une_zone_memoire_ELTPARAGRAPHE000123"></a>

Pour modifier un critère de tri présent dans un état basé sur une table ou sur une zone mémoire:
...
<a name="modifier_sens_tri_critere_present_dans_etat_base_sur_une_requete_ELTPARAGRAPHE000176"></a>
...
### Supprimer un critère de tri
<a name="supprimer_critere_tri_ELTPARAGRAPHE000217"></a>
...
3. Cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeSuppcritereTri.gif).
...
Une procédure de tri peut être mise en place dans un état sur une table ou dans un état sur une zone mémoire. Cette procédure peut par exemple modifier dynamiquement les critères de tri.

Pour mettre en place une procédure de tri:

1. Sous le volet "Modification", dans le groupe "Etat", cliquez sur "Éditer les tris". La liste des critères de tri de l'état s'affiche.

2. Cliquez sur le bouton "Nouveau critère de tri" (icône ![Nouveau tri](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=etatIconeNewcritereTri.gif)).
