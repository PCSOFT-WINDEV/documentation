...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) La persistance des données est réalisée uniquement par programmation. Les informations sont sauvegardées dans un cookie navigateur. 
...
<a name="activer_desactiver_persistance_champ_dans_une_fenetre_ELTPARAGRAPHE000058"></a>Pour activer ou désactiver la persistance d'un champ dans une fenêtre : 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remarque** : Ce mécanisme peut être mis en place par l'utilisateur lui-même grâce à l'option ["Mémoriser" du menu contextuel des champs (FAA)](../WDChamp/9500128.md). 
...
## Fonctionnement
<a name="fonctionnement_ELTTEXTE000352"></a>


### Mode de fonctionnement
<a name="mode_fonctionnement_ELTPARAGRAPHE000086"></a>**Lorsque le mécanisme de persistance d'un champ est activé** : 

- Le contenu du champ est mémorisé lors de la fermeture de l'application. 
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Ces informations sont stockées par défaut dans la base de registre dans la clé "HKEY_CURRENT_USER\\Software\\&lt;Société&gt;\\&lt;Nom du projet&gt;". Cette clé peut être connue par programmation grâce à la fonction [ProjetInfo](../WDLang1/3064004.md).
...
<a name="fonctionnement_avance_ELTTEXTE000382"></a>


### Mémorisation des variables globales d'un projet
<a name="memorisation_des_variables_globales_projet_ELTPARAGRAPHE000145"></a>Le mécanisme de persistance permet non seulement de mémoriser des champs, mais également des variables ou tout autre information nécessaire à une application.
...
### Mise en place
<a name="mise_place_ELTPARAGRAPHE000154"></a>Il est nécessaire d'utiliser les fonctions [ChargeParamètre](../WDLang1/3025047.md) et [SauveParamètre](../WDLang1/3025046.md).
...
### Optimisation
<a name="optimisation_ELTPARAGRAPHE000219"></a>Dans ces cas particuliers, il suffit de "désactiver" les traitements potentiellement longs pendant leur restauration automatique. Il est possible d'utiliser la méthode suivante : 
...
<a name="gestion_persistance_des_donnees_avec_les_fonctions_wlangage_ELTTEXTE000442"></a>
...
[InitParamètre (Fonction)](../WDChamp/3025044.md)

[SauveParamètre (Fonction)](../WDChamp/3025046.md)

[ChargeParamètre (Fonction)](../WDChamp/3025047.md)

[Mémoriser la saisie effectuée (FAA)](../WDChamp/9500128.md)

[DésactiveFAA (Fonction)](../WDChamp/3013061.md)

[ExécuteFAA (Fonction)](../WDChamp/3013060.md)
