...
**Remarque** : De nombreuses fonctions du WLangage sont spécifiques à la gestion des champs de type Liste. Pour plus de détails, consultez [les fonctions de gestion des champs Liste](../WDLang1/1000017419.md).
...
<a name="initialiser_element_ELTPARAGRAPHE000170"></a>Pour initialiser un élément d'un champ Liste, utilisez la fonction [&lt;Liste&gt;.Ajoute](../WDLang1/1000017319.md).
...
<a name="remplir_champ_liste_ELTPARAGRAPHE000195"></a>Pour initialiser un champ Liste, il suffit d'utiliser une boucle d'itération pour initialiser tous les éléments du champ Liste.
...
<a name="selectionner_une_ligne_ELTPARAGRAPHE000236"></a>Pour sélectionner l'élément de la ligne &lt;Indice&gt;, utilisez :
...
<a name="positionner_sur_dernier_element_ELTPARAGRAPHE000263"></a>Pour se positionner sur le dernier élément du champ Liste, utilisez :
...
**Remarque** : Pour les champs Liste multisélection, la fonction [&lt;Liste&gt;.Select](../WDLang1/1000017336.md) permet de récupérer les éléments sélectionnés.
...
<a name="recuperer_valeur_element_selectionne_ELTPARAGRAPHE000368"></a>Pour récupérer la valeur de l'élément sélectionné, utilisez une des syntaxes suivantes :
...
[Comment gérer une multisélection dans un champ Liste ?](../WDChamp/20012.md)
