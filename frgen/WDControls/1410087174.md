...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) survol souris,

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) bouton gauche relâché,
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) le survol d'un élément affiche une bulle d'aide.
...
3. Pour que le champ soit en "Lecture seule", utilisez une des méthodes suivantes : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Méthode 1 : Dans l'onglet "UI" de la fenêtre de description du champ, sélectionnez l'option "Lecture seule".
...
[Diagramme (Type de variable)](../WDChamp/1410088055.md)
