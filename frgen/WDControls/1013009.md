...
- d'une rubrique d'une table ou d'une requête.
...
<a name="graphe_alimente_par_programmation_ELTTEXTE000196"></a>
...
### Remarques
<a name="remarques_ELTPARAGRAPHE000078"></a>
...
## Cas particulier
<a name="cas_particulier_ELTTEXTE000277"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Champ Graphe d'une fenêtre ou d'une page basé sur un champ Table construit avec la fonction TableConstruitLiaisonDonnées
<a name="champ_graphe_une_fenetre_une_page_base_sur_champ_table_construit_avec_fonction_tableconstruitliaisondonnees_ELTPARAGRAPHE000115"></a>

Si vous créez un nouveau graphe alimenté par un champ Table rempli avec la fonction [TableConstruitLiaisonDonnées](../WDLang1/3074002.md) à partir d'une requête, il est nécessaire d'indiquer que les colonnes correspondent à _COL1, _COL2, ...
