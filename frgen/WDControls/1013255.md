...
<a name="creer_une_fenetre_interne_ELTPARAGRAPHE000051"></a>
...
3. Cliquez sur l'onglet "Fenêtre interne" et sélectionnez "Vierge" (si nécessaire sélectionnez également le thème associé). Validez pour créer la fenêtre.
...
- Dans l'onglet "UI" de la fenêtre de description, vous pouvez indiquer si la fenêtre interne doit reprendre le thème de la fenêtre hôte (c'est-à-dire de la fenêtre affichant la fenêtre interne). Il suffit pour cela de cocher l'option "Applique le thème du projet de la fenêtre hôte".
...
<a name="creer_champ_type_fenetre_interne_ELTPARAGRAPHE000087"></a>
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Il est possible de faire défiler des fenêtres internes dans un champ Fenêtre interne par un simple mouvement de doigt. Pour plus de détails, consultez [Changement du contenu d'une fenêtre interne par gesture](../WDChamp/1013277.md). 
<a name="NOTE2_3"></a>


### Créer une fenêtre interne à partir de champs existants
<a name="creer_une_fenetre_interne_partir_champs_existants_ELTPARAGRAPHE000120"></a>
...
<a name="appliquer_modele_fenetre_une_fenetre_interne_ELTPARAGRAPHE000190"></a>
...
<a name="afficher_apercu_des_fenetres_internes_100_ELTPARAGRAPHE000218"></a>
