...
- [Associer un champ à une rubrique d'une table](#NOTE3)
...
<a name="creer_champ_simple_ELTPARAGRAPHE000048"></a>

Pour créer un champ dans un état:

1. Sous le volet "Création", cliquez sur le type de champ à créer: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Etat_Ruban_Creation.gif&type=thumb)
...
<a name="creer_champ_partir_champ_dictionnaire_ELTPARAGRAPHE000063"></a>

Un champ d'un état peut être créé à partir d'un champ présent dans un dictionnaire. Un dictionnaire permet de conserver des éléments (champs, états, ...) en prévision d'une prochaine ré-utilisation dans de nouveaux projets. Pour plus de détails, consultez le [Dictionnaire](../Editeurs/2023002.md).
...
<a name="creer_champ_avec_contenu_pressepapiers_ELTPARAGRAPHE000087"></a>
...
<a name="creer_champ_image_partir_fichier_image_par_drag_and_drop_ELTPARAGRAPHE000133"></a>
...
## Associer un champ à une rubrique d'une table ou à une variable
<a name="associer_champ_une_rubrique_une_table_une_variable_ELTTEXTE000533"></a>
Il est possible d'associer: 

- un champ d'un état (de type Libellé, Calculé, Image, Code-barres, Interrupteur, Lien ou Graphe) à une rubrique d'une table présente ou non dans la source de données de l'état.
...
Pour associer un champ existant à une rubrique d'une table ou à une variable:
...
**Remarque**: Il est également possible de créer directement un champ Libellé à partir d'une rubrique d'une table:
...
<a name="selectionner_plusieurs_champs_dans_etat_ELTPARAGRAPHE000176"></a>

L'éditeur d'états permet de sélectionner un ou plusieurs champs d'un état à l'aide du clavier ou de la souris. Pour plus de détails, consultez [Sélectionner un ou plusieurs champs](../Editeurs/2026007.md).
<a name="NOTE4_2"></a>


### Supprimer un ou plusieurs champs d'un état
<a name="supprimer_plusieurs_champs_etat_ELTPARAGRAPHE000186"></a>
...
<a name="copier_champ_dans_meme_etat_ELTPARAGRAPHE000206"></a>
...
<a name="copier_champ_etat_dans_autre_etat_ELTPARAGRAPHE000246"></a>
...
<a name="copier_style_champ_ELTPARAGRAPHE000294"></a>
...
<a name="deplacer_plusieurs_champs_etat_ELTPARAGRAPHE000306"></a>
...
<a name="verrouiller_des_champs_ELTPARAGRAPHE000321"></a>
...
<a name="aligner_les_champs_etat_ELTPARAGRAPHE000336"></a>
...
### Présentation
<a name="presentation_ELTPARAGRAPHE000366"></a>

Généralement, les champs appartiennent à un état. Ces champs apparaissent donc dans l'état en édition et en exécution.

Il est également possible de positionner un champ dans la fenêtre d'accueil d'un état: le champ est alors "hors état". Ce champ sera visible uniquement en édition. Ce champ ne sera pas imprimé. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatFenAccueil.gif)
...
<a name="creer_champ_hors_etat_ELTPARAGRAPHE000377"></a>
