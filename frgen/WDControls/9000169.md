...
2. Affichez la page modèle "PAGEMOD_Principal" sous l'éditeur.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%201%20-%20HC%20N%B0001.gif&type=thumb)
...
4. Dans l'onglet "Général", sélectionnez l'option "Tranches (Responsive historique pour compatibilité)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%201%20-%20HC%20N%B0002.gif)
...
L'éditeur se transforme : un nouveau bandeau spécifique au mode d'édition "Responsive Web Design" apparaît. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20Bandeau%20entete%201%20-%20HC%20N%B0001%201.gif)
...
Rappel : une tranche représente une taille de navigateur pour un appareil spécifique.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%201%20-%20HC%20N%B0003.gif&type=thumb)
...
7. Replacez le champ Barre de navigation sur le bandeau noir. Vous obtenez l'interface suivante : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0001.gif&type=thumb)
...
2. Cliquez dans la zone centrale de la barre de navigation. Cette zone est hachurée. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0002.gif)


3. Cliquez à nouveau dans la partie hachurée : le menu déroulant apparaît. Il est automatiquement affiché en mode vertical. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0003.gif)
...
Par exemple, si vous sélectionnez la tranche Mobile : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0004.gif)
...
- **Pour les images** : changez leurs paramètres d'ancrage pour qu'elles ne soient pas déformées.
	Pour cela, affichez le menu contextuel de l'image (clic droit) et sélectionnez "Ancrage". Dans la fenêtre qui s'affiche, choisissez les options "Largeur fixe" et "Hauteur fixe". Ainsi, l'image conservera ses proportions d'origine quelle que soit la tranche active.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0006.gif)





Après modification, la tranche Mobile devient : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%203%20-%20HC%20N%B0001.gif)
...
2. Sous le volet "Page", dans le groupe "Description", déroulez "Modèles" et sélectionnez l'option "Liste des modèles utilisés". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%203%20-%20HC%20N%B0002.gif)
...
3. Dans l'onglet "Détail", dans la partie "Paramètres du mode d'affichage", sélectionnez "Nombre de colonnes par tranche". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%203%20-%20HC%20N%B0004.gif)
...
- Cliquez sur l'icône symbolisant le Responsive Web Design : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%203%20-%20HC%20N%B0004%201.gif)
...
Dans la tranche "Bureau" (ou "Tablette"), vous obtenez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0001.gif)


Dans la tranche "Mobile", vous obtenez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0002.gif&type=thumb)
...
- Exécution en mode Bureau : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0003.gif)


- Exécution en mode Tablette : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0004.gif&type=thumb)


- Exécution en mode Mobile : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0005.gif&type=thumb)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%205%20-%20HC%20N%B0001.gif)


**Première étape** : Mettre à niveau la page avec le modèle (afin que la page passe en mode Responsive Web Design) : sous le volet "Page", dans le groupe "Description", déroulez "Modèles" et sélectionnez l'option "Liste des modèles utilisés". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%205%20-%20HC%20N%B0002.gif)
...
Nous allons donc passer sur la tranche "Mobile" et déplacer les champs pour obtenir le résultat final suivant : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%205%20-%20HC%20N%B0003.gif&type=thumb)
...
Conseil : Ne pas oublier de modifier la marge interne du champ Zone de texte riche afin de ne pas tronquer ou chevaucher les champs en dessous.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0001.gif&type=thumb)
...
- Exécution en mode "Bureau" : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0002.gif)


- Exécution en mode "Tablette" : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0003.gif)


- Exécution en mode "Mobile" : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0004.gif)
...
- modifier le code HTML du champ car la carte dessinée a une taille fixe imposée (largeur 604, hauteur 300) : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0005.gif)
...
[Responsive Web Design : Gérer un bandeau d'entête](../WDChamp/9000174.md)
