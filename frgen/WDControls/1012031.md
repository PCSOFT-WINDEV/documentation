...
4. Pour définir l'image de fond de la page : 
	...
	- Sélectionnez l'image à utiliser en fond de la page (via le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) du champ "Image de fond") : 
...
4. Indiquez les caractéristiques de l'image de fond : 
	...
	- Sélectionnez l'image à utiliser en fond du navigateur (via le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) du champ "Image de fond") : 
