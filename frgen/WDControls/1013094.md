...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Remarque : Si le libellé est en RTF (option "RTF" cochée dans l'onglet "Général" de la description du champ), le nouveau libellé pourra contenir ou non du texte RTF.  
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) La propriété [Enfoncé](../Proprietes/2510038.md) permet de connaître l'état du champ Bouton :
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) La destination d'un champ Bouton est définie sous l'éditeur de pages en même temps que l'action à effectuer (dans la fenêtre de description du champ Bouton). Pour plus de détails, consultez [Action associée au champ Bouton](../WDChamp/1013071.md).
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Pour modifier l'image affichée dans le champ Bouton, utilisez la propriété [Image](../Proprietes/2510034.md) :
