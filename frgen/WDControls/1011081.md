...
[**Le logiciel Etats & Requêtes**](../Presentation/3088004.md) ne permet pas de créer des états sur un champ Agenda. Cependant, il est possible de personnaliser des états sur un champ Agenda créés sous l'éditeur d'états intégré (couleur, polices, taille, ...).
...
<a name="caracteristiques_etat_sur_champ_agenda_ELTTEXTE000273"></a>
...
<a name="creer_etat_sur_champ_agenda_depuis_editeur_etats_ELTTEXTE000297"></a>
...
<a name="imprimer_etat_sur_champ_agenda_ELTTEXTE000327"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Si la fenêtre contenant l'agenda source de l'état est ouverte plusieurs fois (ouverture non modale par la fonction [OuvreFille](../WDLang1/3038021.md)), il faut passer en paramètre à l'état le nom complet de l'agenda à imprimer. Par exemple : 
