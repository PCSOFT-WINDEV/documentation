...
<a name="presentation_champ_etat_interne_ELTTEXTE000252"></a>
...
<a name="avantages_des_etats_internes_par_rapport_aux_etats_imbriques_ELTTEXTE000276"></a>
...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000300"></a>


### Créer un état principal composé de plusieurs états secondaires
<a name="creer_etat_principal_compose_plusieurs_etats_secondaires_ELTPARAGRAPHE000054"></a>Pour créer un état principal composé de plusieurs états secondaires : 
...
6. Testez l'état principal (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_fenetre_WD_bl.GIF) parmi les boutons d'accès rapide) pour vérifier l'impression de votre état.
...
<a name="etat_principal_non_vierge_ELTPARAGRAPHE000092"></a>Si l'état principal et les états secondaires ont la même source de données, il est conseillé d'utiliser un contexte HFSQL indépendant :
...
<a name="passer_des_parametres_etat_interne_ELTPARAGRAPHE000153"></a>Les paramètres donnés à l'état (lors de l'appel à la fonction [iImprimeEtat](../WDLang5/3046032.md)) sont automatiquement transmis à l'état interne. Attention, dans ce cas, le passage par référence des paramètres n'est pas garanti. 
...
## Notes
<a name="notes_ELTTEXTE000360"></a>


### Dimension des états secondaires
<a name="dimension_des_etats_secondaires_ELTPARAGRAPHE000168"></a>Lors de l'impression de l'état principal, la largeur des états secondaires est ajustée en fonction de la largeur du champ "Etat interne".
...
<a name="diminuer_largeur_etat_secondaire_ELTPARAGRAPHE000181"></a>Pour diminuer la largeur d'un état secondaire :
...
<a name="saut_page_etat_secondaire_ELTPARAGRAPHE000192"></a>Les sauts de page définis dans un état secondaire seront ignorés lors de l'impression de l'état principal.
<a name="NOTE4_4"></a>


### Ouverture de l'état interne
<a name="ouverture_etat_interne_ELTPARAGRAPHE000201"></a>Le menu contextuel du champ "Etat Interne" sous l'éditeur permet d'ouvrir directement l'état interne grâce à l'option "Ouvrir l'état interne". 
...
[Propriétés associées au champ Etat Interne](../WDChamp/1013061.md)
