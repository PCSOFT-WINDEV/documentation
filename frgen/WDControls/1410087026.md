...
1. Sous le volet "Création", dans le groupe "Intégration", cliquez sur "Composant Web". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_WEB%20-%20HC%20N%B0001.gif&type=thumb)
...
- soit dans l'onglet "Général" de la description du champ : 
	...
	1. Dans la zone "Codes sources HTML - CSS - JS", cliquez sur "Editer". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_WEB%20-%20HC%20N%B0003%201.gif)


	2. Une fenêtre apparaît, permettant de saisir les différents codes nécessaires. 

3. Collez les différents codes nécessaires à votre composant. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_WEB%20-%20HC%20N%B0004.gif&type=thumb)

- soit dans les onglets de code associés au champ : 

	1. Sélectionnez le champ Composant Web. 

	2. Trois onglets spécifiques sont affichés en haut de l'éditeur de page : "HTML", "CSS" et "Javascript". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_WEB%20-%20HC%20N%B0011.gif)


	3. Dans chaque onglet, saisissez le code nécessaire à votre composant. Par exemple : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_WEB%20-%20HC%20N%B0008.gif&type=thumb)
...
- Ajouter des ressources externes en saisissant directement l'url de la ressource Javascript ou CSS. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Composant_WEB%20-%20HC%20N%B0003%202.gif&type=thumb)
...
[Manipuler un champ Composant Web par programmation](../WDChamp/1410087029.md)

[Propriétés associées au champ Composant Web](../WDChamp/1410087028.md)

[Evénements associés à un champ Composant Web](../WDChamp/1410087027.md)
