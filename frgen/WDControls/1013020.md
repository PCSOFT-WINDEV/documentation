...
| Chargement (onload) (Code navigateur) | Exécuté à chaque chargement et affichage de l'image du code-barres par le navigateur. |
| Clic (Code navigateur) | Exécuté lorsque l'utilisateur clique sur le champ. |
| Clic (Code serveur) | Exécuté lorsque l'utilisateur clique sur le champ. |
