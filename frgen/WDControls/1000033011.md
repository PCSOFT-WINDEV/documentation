...
## Volet "Accueil"
<a name="volet_accueil_ELTTEXTE000418"></a>
Le volet "Accueil" permet de faire toutes les manipulations de base sur un fichier ".xlsx". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0001.gif&type=thumb)
Ce volet propose les groupes suivants : 

- **Document** : Permet d'ouvrir, créer, enregistrer ou imprimer un fichier ".xlsx".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0001%201.gif)
Il est possible de :
...
- **Presse-papiers** : Permet de gérer le presse-papiers (copier / coller).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0001%202.gif)


- **Police** : Permet de gérer la police du texte en cours. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0001%203.gif)
Il est possible de :
...
- **Alignement** : Permet de gérer l'alignement des différents éléments : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0001%204.gif)


	- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0001%205.gif) : Permet de gérer l'alignement vertical du texte dans la cellule. 

- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0001%206.gif) : Permet de gérer la rotation du texte dans la cellule. 
...
- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0001%207.gif) : Permet de gérer l'alignement horizontal du texte dans la cellule. 

- Fusionner et centrer : Permet de fusionner des cellules et de centrer le résultat de la fusion. 

- **Nombre** : Permet de gérer les caractéristiques de la sélection : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0003.gif)
...
- **Styles** : Permet de mettre sous forme de tableau une plage de cellules. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0004.gif)


- **Cellules** : Permet d'insérer, de supprimer ou d'effacer des cellules. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0005.gif)
Il est possible de : 

	- insérer des cellules, des lignes, des colonnes ou des feuilles. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0006.gif)


	- supprimer des cellules, des lignes, des colonnes ou des feuilles. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0007.gif)

- **Edition** : Permet de réaliser les recherches, les remplacements et de trier les données. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0009.gif)
...
<a name="effectuer_rechercherremplacer_ELTPARAGRAPHE000085"></a>**Pour effectuer une recherche dans un classeur** : 

1. Sous le volet "Accueil", dans le groupe "Edition", cliquez sur "Rechercher" (ou utilisez le raccourci Ctrl + F). 

2. Dans la fenêtre qui s'affiche, indiquez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban_Rech%20-%20HC%20N%B0001.gif)
...
3. Validez la recherche : 
	...
	- En cliquant sur "Rechercher", les différents éléments correspondants sont mis en surbrillance et le premier est sélectionné. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban_Rech%20-%20HC%20N%B0003.gif&type=thumb)
...
2. Dans la fenêtre qui s'affiche, indiquez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban_Rech%20-%20HC%20N%B0002.gif)
...
## Volet "Insertion"
<a name="volet_insertion_ELTTEXTE000448"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0011.gif)
...
<a name="insertion_une_image_ELTPARAGRAPHE000138"></a>Pour insérer une image : 
...
<a name="inserer_parcourir_visualiser_les_commentaires_ELTPARAGRAPHE000157"></a>Dans une feuille excel, il est possible d'associer un commentaire à chaque cellule. Ce commentaire est un texte simple affiché sous forme de "bulle". 
...
## Volet "Formule"
<a name="volet_formule_ELTTEXTE000484"></a>
Le volet "Formule" permet d'accéder à tous les calculs et les formules de calcul disponibles. Ce volet permet également de gérer le nommage des cellules. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0012.gif)
Ce volet propose les groupes suivants : 
...
<a name="bibliotheque_formules_ELTPARAGRAPHE000226"></a>Le champ Tableur propose de nombreuses formules utilisables dans les cellules d'un champ Tableur. 
...
<a name="utilisation_des_noms_definis_ELTPARAGRAPHE000243"></a>Le champ Tableur permet de nommer les cellules. Il est ainsi possible d'utiliser ces cellules nommées dans les formules (au lieu de l'identification classique des cellules). 
...
3. Dans la fenêtre qui s'affiche, indiquez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0018.gif)
...
2. La fenêtre qui s'affiche présente les différentes cellules nommées du document en cours avec leurs caractéristiques. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0019.gif)
Il est possible de : 
...
## Volet "Mise en page"
<a name="volet_mise_page_ELTTEXTE000520"></a>
Le volet "Mise en page" permet de gérer la mise en page du fichier xlsx affiché dans le champ Tableur. Cette mise en page est utilisée notamment lors de l'impression du fichier. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0013.gif)
Ce volet propose les groupes suivants : 
...
- Connaître le format de la page et le personnaliser si nécessaire (option "Marges") : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0014.gif)


- Modifier l'orientation de la page. L'option "Orientation" permet de passer du mode Portrait au mode Paysage. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0015.gif)


- Paramétrer la mise à l'échelle. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0016.gif)
...
## Volet "Affichage"
<a name="volet_affichage_ELTTEXTE000550"></a>
Le volet "Affichage" propose les options d'affichage du fichier xlsx dans le champ Tableur. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tableur_Ruban%20-%20HC%20N%B0017.gif)
Ce volet propose les groupes suivants : 
...
<a name="cryptage_fichier_xlsx_aide_mot_passe_ELTPARAGRAPHE000315"></a>Il est possible de crypter un ficher xlsx à l'aide d'un mot de passe. 
...
Remarque : A l'ouverture du fichier xlsx , le mot de passe sera automatiquement demandé avant son affichage. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ChampTT_mdp%20-%20HC%20N%B0002.gif)



### Protection de la feuille courante contre la modification
<a name="protection_feuille_courante_contre_modification_ELTPARAGRAPHE000332"></a>Il est possible de protéger une feuille d'un ficher xlsx contre la modification à l'aide d'un mot de passe. 
