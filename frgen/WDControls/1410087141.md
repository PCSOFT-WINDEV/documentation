...
- **Interdit l'exécution des scripts JavaScript** : 
	...
	![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Cette option n'est pas prise en compte : l'exécution des scripts est toujours autorisée.
 ...
 où : 
		...
		- &lt;Paramètre N&gt; correspond aux différents paramètres à passer à la procédure : 
			...
			- Nombre de paramètres : 
				...
				- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) entre 0 et N.
...
- Type des paramètres : 
	...
	- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Les paramètres de la procédure WLangage seront passés selon leur type en tant que boolean, string, number, null. 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Autoriser les popups** : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) affiche des boutons de zoom.




![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) **Pour jouer des vidéos HTML 5 dans un champ d'affichage HTML** : 
