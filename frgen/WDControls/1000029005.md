...
Par défaut, le contenu d'un tableau croisé dynamique est calculé à partir de toutes les données présentes dans les tables prises en compte par le champ Tableau croisé dynamique. 
...
<a name="filtrer_les_entetes_lignes_colonnes_ELTPARAGRAPHE000040"></a>
...
<a name="utiliser_une_procedure_filtre_ELTPARAGRAPHE000055"></a>
...
2. Dans le détail de l'entête, cliquez sur "Aucun" à côté de "Filtre". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TCDFiltre.gif)
