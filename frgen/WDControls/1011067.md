...
Par exemple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatFormulaire.gif&type=thumb)
...
Par exemple:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EtatFormulaireExecution.gif&type=thumb)
...
<a name="creer_etat_type_formulaire_ELTTEXTE000311"></a>
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Les formats d'image supportés sont: 
...
<a name="informations_specifiques_formulaire_ELTPARAGRAPHE000080"></a>
...
<a name="integrer_formulaire_dans_etat_ELTTEXTE000375"></a>
...
### Intégrer un formulaire dans un état
<a name="integrer_formulaire_dans_etat_ELTPARAGRAPHE000129"></a>
...
### Image du formulaire
<a name="image_formulaire_ELTPARAGRAPHE000152"></a>
...
<a name="etat_multipages_base_sur_fichier_pdf_ELTPARAGRAPHE000197"></a>

Si vous avez choisi que l'état affiche toutes les pages d'un fichier PDF, si l'état est basé sur une table ou une requête, les différentes pages seront imprimées pour chaque enregistrement de la source de données utilisée.

**Attention**: Ce type d'état peut consommer beaucoup de ressources mémoire (notamment en aperçu avant impression).

![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Fonctionnalité non disponible.
<a name="NOTE4_3"></a>


### Remarques: Utilisation d'un fichier PDF en fond de page
<a name="remarques_utilisation_fichier_pdf_fond_page_ELTPARAGRAPHE000210"></a>
...
<a name="proposer_une_saisie_dans_etat_sur_formulaire_ELTPARAGRAPHE000225"></a>
