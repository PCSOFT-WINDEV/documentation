...
7. Configurez le mode d'édition du responsive :
	...
	- Affichez le menu contextuel de la tranche "Bureau" (clic droit sur la zone bleue "Bureau par défaut"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Editeur%20-%20HC%20N%B0003.gif)
...
<a name="les_differents_elements_editeur_ELTPARAGRAPHE000095"></a>La page créée en mode "Responsive Web Design" est affichée sous un éditeur utilisant des options spécifiques (ici, page créée en mode "Desktop First : Edition en taille min")  : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Editeur%20-%20HC%20N%B0004.gif&type=thumb)
...
Nous allons paramétrer les ancrages pour la page suivante (notre page exemple est dans le mode **Desktop First**) : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Exemple%20Ancrage%20-%20HC%20N%B0001.gif&type=thumb)
Les champs ont été créés sur la page avec les options d'ancrage par défaut. 

Utilisons le navigateur d'édition pour visualiser le comportement des champs lors du redimensionnement du navigateur. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Exemple%20Ancrage%20-%20HC%20N%B0002.gif&type=thumb)
Nous nous apercevons rapidement que les images dans les 2 champs en haut de l'écran sont tronquées. 

Si nous continuons de diminuer la largeur du navigateur, le titre apparaît sur plusieurs lignes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Exemple%20Ancrage%20-%20HC%20N%B0003.gif&type=thumb)
...
- Tranche Bureau : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Exemple%20Ancrage%20bis%20-%20HC%20N%B0001.gif&type=thumb)


- En redimensionnant (tranche Tablette) : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Exemple%20Ancrage%20-%20HC%20N%B0005.gif&type=thumb)





**Mode avancé : Exemple de surcharge** : il est également possible de surcharger la position du champ Graphe et du champ Libellé en mode Mobile : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=RWD%20-%20Exemple%20Ancrage%20-%20HC%20N%B0007.gif&type=thumb)
