...
En option, WINDEV et WEBDEV 2026 proposent un Connecteur Natif Oracle (également appelé Accès Natif Oracle). Ce Connecteur Natif permet d'accéder à une base Oracle sans drivers externes depuis un programme en WLangage.
...
<a name="configuration_necessaire_ELTTEXTE000318"></a>
...
- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Le Connecteur Natif utilise la dll OCI.DLL de la couche client Oracle pour accéder au serveur Oracle. Les 2 couches clients mentionnées ci-dessus contiennent cette dll.
...
- ![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Le Connecteur Natif utilise la dll libclntsh.so de la couche client Oracle pour accéder au serveur Oracle. Les 2 couches clients mentionnées ci-dessus contiennent cette dll.
...
## Compatibilité
<a name="compatibilite_ELTTEXTE000360"></a>
...
## Utilisation
<a name="utilisation_ELTTEXTE000390"></a>


### Pour utiliser le Connecteur Natif Oracle dans vos applications WINDEV ou vos sites WEBDEV :
<a name="pour_utiliser_connecteur_natif_oracle_dans_vos_applications_windev_vos_sites_webdev_ELTPARAGRAPHE000171"></a>Pour utiliser ORACLE en natif, il faut programmer :
...
- Il est possible si nécessaire de spécifier des [informations optionnelles (également appelées options étendues) de connexion](../WDLang4/9000124.md).
...
<a name="optimisations_des_fonctions_hfsql_ELTPARAGRAPHE000208"></a>
...
<a name="gestion_jeu_caracteresde_languedu_territoire_ELTTEXTE000420"></a>


### Fonctionnement
<a name="fonctionnement_ELTPARAGRAPHE000219"></a>Le Connecteur Natif fixe les propriétés NLS_LANGUAGE et NLS_TERRITORY aux valeurs correspondant à la langue et au pays en cours dans l'application au moment de l'ouverture de la connexion.
...
### Attention
<a name="attention_ELTPARAGRAPHE000238"></a>**Dans tous les cas, Il est fortement déconseillé de changer d'alphabet après l'ouverture de la connexion sous peine de déphasage des jeux de caractères.**
...
[Connecteur Natif Oracle: Programmation à l'aide des fonctions SQL](../WDOracle/5513002.md)

[Connecteur Natif Oracle: Programmation à l'aide des fonctions HFSQL](../WDOracle/5513006.md)

[Connecteur Natif Oracle: Spécificités et remarques](../WDOracle/5513007.md)

[Connecteur Natif Oracle : Exécuter plusieurs fois une même requête](../WDOracle/5513009.md)

[Connecteur Natif Oracle : Récupérer la valeur de sortie d'une procédure stockée](../WDOracle/5513008.md)
