...
2. Dans la fenêtre qui s'ouvre (elle liste les différentes connexions existantes), cliquez sur le bouton "Ajouter" pour créer une nouvelle connexion. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Parametrage.gif)


3. Donnez les paramètres de la connexion : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Connexion.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=options.gif)
...
4. Cliquez sur le bouton "Tester la connexion". Le compte-rendu apparaît.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=test.gif)
