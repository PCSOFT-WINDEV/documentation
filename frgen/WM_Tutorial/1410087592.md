...
1. Dans le volet "Code" du ruban, dans le groupe "Procédures", déroulez "Nouveau" et sélectionnez "Nouvelle procédure globale". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P3_WM_WLangage%20-%20HC%20N%B0003.jpg)


2. Dans la fenêtre de sauvegarde de l'élément qui s'affiche, un nom est proposé par défaut pour la collection de procédures globales. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P3_WM_WLangage%20-%20HC%20N%B0004.jpg)
Conservez ce nom et validez (bouton "OK"). 

3. Une nouvelle fenêtre s'affiche permettant de saisir le nom de la procédure et ses caractéristiques : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P3_WM_WLangage%20-%20HC%20N%B0005.jpg)
...
<a name="questce_quun_parametre_ELTPARAGRAPHE000038"></a>
...
7. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_simu_PRJ_WM_GAF.jpg) parmi les boutons d'accès rapide. 
...
<a name="gestion_des_parametres_passage_par_reference_par_valeur_ELTPARAGRAPHE000045"></a>
...
4. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_simu_PRJ_WM_GAF.jpg) parmi les boutons d'accès rapide. 
...
### Renvoyer une valeur
<a name="renvoyer_une_valeur_ELTPARAGRAPHE000052"></a>
...
<a name="parametres_obligatoires_optionnels_ELTPARAGRAPHE000059"></a>
