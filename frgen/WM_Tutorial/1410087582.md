...
<a name="lecon_7_consommer_webservice_ELTTEXTE000317"></a>
...
### Exemple pratique
<a name="exemple_pratique_ELTPARAGRAPHE000046"></a>
...
<a name="importation_webservice_soap_ELTTEXTE000392"></a>
...
3. Indiquez l'adresse à laquelle la description WSDL du Webservice doit être importée : 
	...
	Rappel : Ce Webservice permet d'interroger une base fournisseur pour vérifier la disponibilité (stock) d'un produit à partir de sa référence. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Consommation%20WS%20-%20HC%20N%B0001.jpg&type=thumb)


4. Passez à l'étape suivante. L'importation du Webservice est réalisée. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Consommation%20WS%20-%20HC%20N%B0002.jpg&type=thumb)
...
Arrêtons-nous un instant sur les informations affichées dans le volet "Explorateur de projet" : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Consommation%20WS%20-%20HC%20N%B0003.jpg)
...
<a name="consommation_webservice_soap_ELTTEXTE000416"></a>
...
### Appel au Webservice
<a name="appel_webservice_ELTPARAGRAPHE000108"></a>
...
4. Ajoutez un champ Bouton :
	...
	- Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Bouton_WM_GAF.jpg).
...
5. Modifiez les caractéristiques du champ (option "Description" du menu contextuel). Ce champ a pour nom "BTN_Stock" et pour libellé "Stock". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Consommation%20WS%20-%20HC%20N%B0005.jpg)
...
8. Fermez l'éditeur de code et enregistrez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Sauver_WM_GAF.jpg) ou Ctrl + S).
...
<a name="test_fonctionnement_webservice_ELTPARAGRAPHE000146"></a>
...
2. Lancez le test de la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide).

3. Double-cliquez sur un produit : la fiche produit s'affiche. 

4. Cliquez sur "Stock". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_MP%20-%20Consommation%20WS%20-%20HC%20N%B0006.jpg&type=thumb)
...
## Consommation d'un Webservice REST
<a name="consommation_webservice_rest_ELTTEXTE000452"></a>
...
<a name="appel_webservice_rest_ELTPARAGRAPHE000171"></a>
...
4. Fermez l'éditeur de code et enregistrez la fenêtre (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Sauver_WM_GAF.jpg) ou Ctrl + S).
...
<a name="test_appel_webservice_rest_ELTPARAGRAPHE000203"></a>
