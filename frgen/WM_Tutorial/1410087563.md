...
<a name="lecon_1_mon_premier_projet_androidios_ELTTEXTE000309"></a>
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=dur%E9e.png) 1 h
...
<a name="projet_multiplateforme_ELTTEXTE000345"></a>
...
## Création du projet
<a name="creation_projet_ELTTEXTE000369"></a>
...
3. Cliquez sur "Créer un projet" (icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet%20-%20HC%20N%B0001%201.jpg)) puis sur "Application Android ou iOS". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet%20-%20HC%20N%B0001.jpg&type=thumb)
...
5. La première étape de l'assistant permet de définir la plateforme d'exécution du projet : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet%20-%20HC%20N%B0002.jpg&type=thumb)
Nous créons une application multiplateforme, sélectionnez "Multiplateforme Android et iOS" et passez à l'étape suivante. 

6. L'assistant propose de choisir le type d'appareils concernés par le projet : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet%20-%20HC%20N%B0003.jpg&type=thumb)
...
8. L'assistant propose ensuite de définir la charte graphique. Sélectionnez "Phoenix_Palette". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet%20-%20HC%20N%B0004.jpg&type=thumb)
...
<a name="premiere_fenetre_afficher_message_ELTTEXTE000420"></a>
...
<a name="comment_creer_fenetre_ELTPARAGRAPHE000116"></a>
...
2. Dans la liste des fenêtres proposées, sélectionnez "Vierge" (la configuration par défaut sélectionnée étant "iOS", l'assistant propose de créer une fenêtre pour iPhone). Le nom du thème utilisé est affiché en bas à droite de l'assistant. 
...
1. Indiquez le titre de l'élément : "Bienvenue". Le nom de l'élément est automatiquement proposé : "FEN_Bienvenue". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet2%20-%20HC%20N%B0001.jpg)
...
La fenêtre est affichée dans l'éditeur de fenêtres. La configuration par défaut étant une configuration iOS, elle adopte le look des fenêtres iOS.  Cette fenêtre est composée de plusieurs zones : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon_Premier_Projet_IOS%20-%20HC%20N%B0001.jpg)
...
<a name="affichage_message_ELTPARAGRAPHE000150"></a>
...
1. Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Bouton_WM_GAF.jpg). Le champ apparaît en création sous la souris.

2. Déplacez la souris dans la fenêtre vers la position où le champ doit être créé (par exemple en haut de la fenêtre). Pour poser le champ dans la fenêtre, il suffit de cliquer dans la fenêtre. Le champ est créé et des poignées sont affichées pour indiquer que le champ est sélectionné.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon_Premier_Projet_IOS%20-%20HC%20N%B0002.jpg)
...
2. Modifiez les caractéristiques du champ en saisissant les informations suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet2%20-%20HC%20N%B0004.jpg&type=thumb)
...
2. Sous le volet "Alignement" du ruban, dans le groupe "Centrage et répartition", cliquez sur "Centrer dans le parent (Horz.)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet2%20-%20HC%20N%B0005.jpg)
...
Dans cette leçon, nous souhaitons afficher un message dans une boîte de dialogue lors du clic sur le bouton. Pour cela, nous allons utiliser notre première fonction WLangage, la fonction [Info](../WDLang1/3021011.md).
...
Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Sauver_WM_GAF.jpg) parmi les boutons d'accès rapide ou en utilisant la combinaison de touches Ctrl + S.
...
## En résumé
<a name="resume_ELTTEXTE000492"></a>
Cette leçon nous a permis de créer un projet, une fenêtre et un champ : les éléments les plus importants d'une application. 

Dans la prochaine leçon, nous allons tester directement le fonctionnement de cette fenêtre.**Projet corrigé** : 
...
| [Sommaire](../TutoWM/1410087586.md) | [Leçon suivante](../TutoWM/1410087596.md) |
| --- | --- |
