...
### Génération de l'application Android
<a name="generation_application_android_ELTPARAGRAPHE000047"></a>

Pour générer l'application Android :

1. Sélectionnez si nécessaire la plateforme Android dans le volet "Explorateur de projet".

2. Sous le volet "Projet", dans le groupe "Génération", cliquez sur "Générer" (vous pouvez également cliquer sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Generation_Android_WM_GAF.jpg) parmi les boutons d'accès rapide).
...
6. L'assistant vérifie la présence des outils nécessaires à la génération de l'application Android.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_WM%20-%20Mon%20Premier%20Projet%20-%20HC%20N%B0007.jpg&type=thumb)
...
8. Passez à l'étape suivante en cliquant sur les touches fléchées au bas de l'assistant. L'étape suivante de l'assistant permet de :
	...
	- définir l'adresse email utilisée par défaut si un rapport d'erreur doit être envoyé. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_D%E9ploiement%20Android%20-%20HC%20N%B0001.jpg&type=thumb)
...
13. L'étape suivante permet d'intégrer les tables dans l'application. Pour notre exemple, des tables HFSQL préremplies sont disponibles. Nous allons les livrer avec l'application. Dans ce cas, il est nécessaire de les indiquer dans l'étape "Intégration de fichiers".

	- Cliquez sur le bouton "Ajouter".

	- Sélectionnez les tables (fichiers .fic, .ndx et .mmo) présentes dans le répertoire "EXE\\Application Android" du projet. La liste des fichiers apparaît.

	- Validez.
			Si votre projet utilise uniquement la plateforme Android, les tables sont à sélectionner dans le répertoire EXE du projet.





14. Pour chaque fichier, cochez la case "Ecriture" (nécessaire pour pouvoir modifier les données depuis l'application).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_D%E9ploiement%20Android%20-%20HC%20N%B0002.jpg&type=thumb)


15. Passez à l'étape suivante. 

16. Validez les étapes suivantes jusqu'à l'étape "Configuration" qui permet de configurer les options du SDK Android et l'emplacement de l'installation. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_D%E9ploiement%20Android%20-%20HC%20N%B0004.jpg&type=thumb)


17. Passez à l'étape suivante. 

18. Cette étape est spécifique à l'utilisation du champ Carte. Elle permet de saisir la clé nécessaire à l'utilisation du champ Carte. Si vous possédez une clé Google Maps API, saisissez-la. Dans le cas contraire, cliquez sur "Obtenir une clé".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_D%E9ploiement%20Android%20-%20HC%20N%B0005.jpg&type=thumb)


19. Passez à l'étape suivante. 

20. Terminez l'assistant. La génération est automatiquement effectuée en tâche de fond. Trois petits points (...) apparaissent dans la barre de titre de WINDEV Mobile pour indiquer que la génération est en cours. Une fenêtre de type popup est également affichée, précisant les étapes de la génération. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_D%E9ploiement%20android%20fin%20-%20HC%20N%B0002.jpg)


21. A la fin de la génération, la fenêtre popup permet de copier et d'exécuter l'application directement sur l'appareil relié au poste ou sur un émulateur (bouton "Déployer"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_D%E9ploiement%20android%20fin%20-%20HC%20N%B0003.jpg)
...
### Présentation
<a name="presentation_ELTPARAGRAPHE000158"></a>
...
<a name="deploiement_via_google_play_ELTPARAGRAPHE000171"></a>
...
<a name="deploiement_via_serveur_web_ELTPARAGRAPHE000190"></a>
...
<a name="deploiement_depuis_ELTPARAGRAPHE000209"></a>
...
<a name="copier_application_sur_appareil_mobile_ELTPARAGRAPHE000246"></a>
...
### Déploiement via le Store Privé fourni avec WINDEV Mobile
<a name="deploiement_via_store_prive_fourni_avec_windev_mobile_ELTPARAGRAPHE000261"></a>
