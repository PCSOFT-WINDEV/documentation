...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDDixio%20-%20HC%20N%B0001.gif)
...
<a name="utiliser_wddixio_avec_projet_windev_webdev_windev_mobile_ELTTEXTE000262"></a>
...
2. WDDIXIO est automatiquement icônisé dans la barre des tâches de Windows :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDDixioBarreTaches.gif)
...
2. Cliquez sur le bouton "Traduire" ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Combo_des_saisie_btn_multilangue.GIF) (disponible par exemple dans la fenêtre de description d'un champ).
...
3. Si le texte à traduire :
	...
	- n'est pas strictement identique à une expression traduite, WDDIXIO s'ouvre et propose automatiquement les différentes traductions possibles. Les traductions sont listées selon leur pertinence. L'icône présente devant chaque traduction indique le degré de pertinence de la traduction. 
		...
		- Sous WDDIXIO : sélectionnez si nécessaire la traduction voulue et utilisez le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDDixio%20-%20HC%20N%B0001%201.gif) pour copier la traduction.  
...
<a name="utiliser_wddixio_tant_quapplication_independante_ELTTEXTE000286"></a>
...
7. Sélectionnez l'expression voulue dans la langue de traduction. Cliquez sur le bouton "Copier" (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDDixio%20-%20HC%20N%B0001%201.gif)). L'expression sélectionnée sera récupérée dans le presse-papiers. 
...
## Notes
<a name="notes_ELTTEXTE000310"></a>


### Options de WDDIXIO
<a name="options_wddixio_ELTPARAGRAPHE000129"></a>Le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Trad_param.gif) permet de configurer les options de WDDIXIO. Ces options sont partagées avec WDTRAD. Les options non disponibles dans WDDIXIO sont grisées. 
...
<a name="parametrage_des_langues_ELTPARAGRAPHE000173"></a>Pour chaque langue utilisée dans WDDIXIO, le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDDixio%20-%20HC%20N%B0001%202.gif) permet de paramétrer les options de la langue : 
...
<a name="traductions_dans_plusieurs_langues_ELTPARAGRAPHE000183"></a>Par défaut, WDDIXIO propose deux langues : une langue de référence et une langue de traduction. Il est possible d'ajouter une troisième langue afin d'obtenir deux langues de traduction. Ainsi, il est possible de traduire un texte français en anglais et en espagnol. Ce mode de traduction est utilisable notamment avec des dictionnaires Web. 

Pour ajouter une nouvelle langue, cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDDixio%20-%20HC%20N%B0001%204.gif). Pour supprimer une langue, cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDDixio%20-%20HC%20N%B0001%203.gif). 
