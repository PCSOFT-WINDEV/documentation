...
- [contrôler l'application à distance](#NOTE2_1),

- [informer sur la dernière mise à jour](#NOTE3_1),

- [connaître les caractéristiques des utilisateurs de l'application](#NOTE4_1).
...
<a name="controle_distance_application_ELTTEXTE000197"></a>


### Contrôle à distance de l'application
<a name="controle_distance_application_ELTPARAGRAPHE000029"></a>Le contrôle à distance d'une application WINDEV permet au responsable d'une application utilisée en réseau de gérer l'arrêt (automatique ou forcé) de l'application pour tous les utilisateurs en cours. Cet arrêt de l'application peut être nécessaire par exemple lors d'une mise à jour de l'application ou de la base de données.
...
<a name="etat_application_ELTPARAGRAPHE000037"></a>
...
### Durée des contrôles
<a name="duree_des_controles_ELTPARAGRAPHE000062"></a>
...
<a name="gestion_deconnexion_des_utilisateurs_automatique_ELTPARAGRAPHE000071"></a>Pour que la gestion de la déconnexion des utilisateurs de l'application soit automatique, il suffit de cocher l'option "Fonctionnement normal".
...
<a name="informer_sur_derniere_mise_jour_ELTTEXTE000239"></a>
...
<a name="connaitre_les_caracteristiques_des_utilisateurs_application_ELTTEXTE000263"></a>
