...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Client MS Exchange : l'email est supprimé de la boîte de réception des messages.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Messagerie Lotus Notes ou Outlook : l'email est supprimé de la boîte de réception des messages.
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Seule la suppression d'emails par le protocole POP3 est disponible.
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003032027&name=emailsupprimemessage_fonction">Voir des exemples supplémentaires</a>
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Les variables de type [emailSessionPOP3](../WDLang3/1000018759.md) et [emailSessionIMAP](../WDLang3/1000018957.md) ne sont pas disponibles.
...
<a name="utilisation_protocole_pop3_ELTPARAGRAPHE000184"></a>Si le paramètre &lt;Numéro message&gt; :
...
<a name="suppression_messages_nombre_messages_recus_protocole_pop3_ELTPARAGRAPHE000209"></a>Si un message a été supprimé par la fonction **EmailSupprimeMessage** : 
...
<a name="utilisation_client_exchange_lotus_notes_outlook_ELTPARAGRAPHE000245"></a>Le dernier message lu est supprimé des messages reçus. Ce message ne sera plus visualisé lors du parcours des messages par les fonctions [EmailLitPremier](../WDLang3/3032014.md) et [EmailLitSuivant](../WDLang3/3032004.md).
...
[EmailDétruit (Fonction)](../WDLang3/1000021553.md)
