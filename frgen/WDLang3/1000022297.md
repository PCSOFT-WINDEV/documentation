...
<a name="messages_supprimes_protocole_imap_ELTPARAGRAPHE000283"></a>Si un message a été supprimé par la fonction [EmailSupprimeMessage](../WDLang3/3032027.md), ce message est réellement supprimé de la session : 
