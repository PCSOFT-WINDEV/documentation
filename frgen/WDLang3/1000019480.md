...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_notif1.gif)


Il est possible de les dérouler pour en visualiser le détail. 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Android_notif2.gif)
...
L'utilisateur final a la possibilité de modifier localement les paramètres des catégories de notification d'une application : activer/désactiver l'affichage des notifications de la catégorie, modifier la priorité des notifications, associer un son particulier, etc. Ces modifications s'effectuent depuis l'écran de paramétrage des notifications de l'application : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Categorie_notification.gif)
