...
<a name="gestion_theme_sombre_ELTPARAGRAPHE000023"></a>
...
2. Dans l'onglet "Style", cochez l'option "Autoriser le passage en thème sombre (automatique ou manuellement via la fonction ChangeThème)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Theme_sombre%20-%20HC%20N%B0001.gif&type=thumb)
...
- Le projet est associé à un seul thème. Ce thème correspond au thème clair. Les fenêtres sont toujours éditées en thème clair. Le thème utilisé pour le thème sombre est le thème **BlackStellar**. 

- Astuce: Utilisez si possible les styles des thèmes. Si des couleurs ou images sont fixées par programmation, utilisez les événements optionnels "Application du thème clair/sombre" pour utiliser une couleur spécifique en fonction du thème utilisé. 
...
<a name="tester_une_application_gerant_theme_sombre_dans_simulateur_ELTPARAGRAPHE000056"></a>

Lorsque le thème sombre est géré pour un projet WINDEV Mobile, le simulateur propose une option supplémentaire (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Theme_sombre%20-%20HC%20N%B0002%201.gif)) permettant de basculer l'application d'un thème à l'autre. 

Exemple: 

1. Lancement du test de l'application: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Theme_sombre%20-%20HC%20N%B0002.gif)

	 Par défaut, le thème clair est utilisé. 

2. Clic sur l'icône de passage au thème sombre: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Theme_sombre%20-%20HC%20N%B0002%201.gif). 

3. Affichage de la fenêtre en test avec le thème sombre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Theme_sombre%20-%20HC%20N%B0003.gif)
...
<a name="cas_particulier_pas_utiliser_theme_sombre_sur_une_fenetre_ELTPARAGRAPHE000075"></a>
...
2. Dans l'onglet "Style", cochez l'option "Ne pas appliquer le thème sombre". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Theme_sombre%20-%20HC%20N%B0004.gif&type=thumb)
...
### Présentation
<a name="presentation_ELTPARAGRAPHE000093"></a>
...
<a name="evenements_specifiques_ELTPARAGRAPHE000101"></a>
