...
| *sEveErreur* | Détection d'une erreur sur la ligne<br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
| *sEveErreurImprimante* | Erreur d'imprimante détectée<br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
| *sEveFileEntrée80* | Le buffer d'entrée est plein à 80%<br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
| *sEveRing* | Détection du signal "Ring" (sonnerie) |
| *sEveRLSD* | Changement d'état RLSD<br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
