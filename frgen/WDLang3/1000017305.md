...
| *emailAdresseRefusée* | L'adresse a été refusée par le serveur de mails. La fonction [ErreurInfo](../WDLang1/3013008.md) permet d'obtenir la cause du refus.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
|   |   |
| --- | --- |
| *emailValideParServeur* | Vérifie que le serveur d'emails SMTP du domaine auquel appartient l'adresse accepte l'adresse en entrée. La vérification de la syntaxe de l'adresse email est automatiquement effectuée (constante *emailValideSyntaxe*).<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Cette constante n'est pas disponible. |
| *emailValideSyntaxe*<br>(Valeur par défaut) | Vérifie la syntaxe de l'adresse email. Le TLD (Top Level Domain) n'est pas vérifié. |
| *emailValideSyntaxeStrict* | Vérifie la syntaxe de l'adresse email ainsi que le TLD (Top Level Domain) par rapport à la liste des TLD existants (voir Remarques).<br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
...
### Adresse email à vérifier
<a name="adresse_email_verifier_ELTPARAGRAPHE000117"></a>
...
<a name="validation_par_serveur_conditions_necessaires_ELTPARAGRAPHE000135"></a>Pour utiliser la validation par serveur (constante *emailValideParServeur*), l'application doit pouvoir contacter :
...
<a name="liste_des_tld_utilises_lors_une_validation_syntaxique_stricte_ELTPARAGRAPHE000151"></a>Lors d'une vérification syntaxique stricte (constante *emailValideSyntaxeStrict*), une liste de TLD internationaux et de TLD de pays est utilisée. 
