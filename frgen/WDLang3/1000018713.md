...
<a name="proprietes_specifiques_description_des_variables_type_email_ELTPARAGRAPHE000048"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une variable de type **Email** :

| **Nom** | **Type manipulé** | **Effet** |
| --- | --- | --- |
| AccuséRéception | Booléen | **En envoi,** permet de demander un accusé de réception au destinataire (<u><u><u>Vrai</u></u></u>). Le destinataire n'est pas obligé d'envoyer un accusé de réception.<br><br>**En réception,** permet de savoir si l'expéditeur a demandé un accusé de réception (<u><u><u>Vrai</u></u></u>) ou non (<u><u><u>Faux</u></u></u>).<br>Si la confirmation de lecture est demandée, elle est prioritaire sur l'accusé de réception.<br><br>Cette propriété vaut <u><u><u>Faux</u></u></u> par défaut.<br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette propriété n'est pas gérée par Outlook sous Windows. |
| AdresseExpéditeur | Chaîne de caractères | Adresse à laquelle la réponse au message doit être envoyée (127 caractères maximum). Correspond au **Reply-To**. Pour plus de détails, consultez [Correspondance entre les propriétés et la norme RFC](#NOTE0_2).<br><br>Remarque : Si l'adresse contient des caractères spéciaux, des accents, utilisez la constante *emailOptionEncodeEntête* lors de l'envoi du message avec la fonction [EmailEnvoieMessage](../WDLang3/3032005.md).<br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Sous Outlook**, cette variable est ignorée. Le nom du compte de la session en cours est utilisé pour remplir cette variable.<br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Sous Lotus**, si l'expéditeur n'est pas renseigné, le login Lotus est utilisé. |
| AdresseRetourErreur | Chaîne de caractères | Adresse de retour en cas d'erreur. Cette adresse est gérée par les protocoles POP3, IMAP et SMTP. Pour plus de détails, consultez [Correspondance entre les propriétés et la norme RFC](#NOTE0_2). <br><br>Remarque : Si l'adresse contient des caractères spéciaux, des accents, utilisez la constante *emailOptionEncodeEntête* lors de l'envoi du message avec la fonction [EmailEnvoieMessage](../WDLang3/3032005.md).<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Non disponible. |
...
| ConfirmationLecture | Booléen | **En envoi**, permet de demander une confirmation de lecture au destinataire (<u><u><u>Vrai</u></u></u>). Le destinataire n'est pas obligé d'envoyer une confirmation de lecture.<br><br>**En réception**, permet de savoir si l'expéditeur a demandé une confirmation de lecture (<u><u><u>Vrai</u></u></u>) ou non.<br>Si la confirmation de lecture est demandée, elle est prioritaire sur l'accusé de réception.<br><br>Par défaut, cette propriété vaut <u><u><u>Faux</u></u></u>.<br><br>Pour plus de détails, consultez [Correspondance entre les propriétés et la norme RFC](#NOTE0_2).<br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette propriété n'est pas gérée sous Lotus Notes. <br><br>Cette propriété est gérée par Outlook sous Windows. |
...
| EnDehors | Booléen | Indique si un message a pu être lu sur le serveur : <br><br>- <u><u><u>Faux</u></u></u> si le message a été lu.<br><br>- <u><u><u>Vrai</u></u></u> si le message n'a pas été lu.<br><br><br> |
| Entête | Tableau de [emailEntête](../WDLang3/1000020774.md) | Entêtes de l'email. |
| Expéditeur | Chaîne de caractères | Adresse email de l'expéditeur. Cette adresse doit être valide. <br><br>Un nom d'expéditeur peut être donné en complément de l'adresse email. Ce nom sera affiché en priorité par rapport à l'adresse email dans une application de messagerie ou un webmail. Cette propriété utilise alors le format suivant : <br><br><pre><code>"<Nom> <adresse@domaine.com>"</code></pre><br><br><br>Pour plus de détails, consultez [Correspondance entre les propriétés et la norme RFC](#NOTE0_2).<br><br>Remarque : Si l'expéditeur contient des caractères spéciaux, des accents, utilisez la constante *emailOptionEncodeEntête* lors de l'envoi du message avec la fonction [EmailEnvoieMessage](../WDLang3/3032005.md).<br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Sous Outlook**, cette variable est ignorée. Le nom du compte de la session en cours est utilisé pour remplir cette variable.<br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Sous Lotus**, si l'expéditeur n'est pas renseigné, le login Lotus est utilisé. |
...
| Référence | Chaîne de caractères | Identifiant unique d'un ou de plusieurs emails de référence liés à la conversation en cours.<br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette propriété n'est pas gérée sous Lotus Notes.<br><br><br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette propriété n'est pas gérée par Outlook sous Windows. |
...
| Source | Chaîne de caractères | Contient la source du message reçu (sujet, expéditeur, destinataire, contenu, ...).<br><br><br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette propriété n'est pas gérée par Outlook sous Windows. |
...
<a name="correspondance_entre_les_proprietes_norme_rfc_ELTPARAGRAPHE000472"></a>
...
### Fonctions WLangage
<a name="fonctions_wlangage_ELTPARAGRAPHE000560"></a>Les fonctions suivantes peuvent être utilisées pour manipuler une variable de type Email :
