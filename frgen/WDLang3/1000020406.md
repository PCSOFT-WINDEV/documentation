...
### Réinitialisation
<a name="reinitialisation_ELTPARAGRAPHE000176"></a>Pour réinitialiser le contenu d'une variable de type **nfcDonnée**, il est possible d'utiliser la fonction [VariableRAZ](../WDLang1/3013069.md).
