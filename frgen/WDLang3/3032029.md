...
## Présentation
<a name="presentation_ELTTEXTE000772"></a>
...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Remarque : La structure Email est utilisée par les fonctions [EmailLanceAppli](../WDLang3/1000019564.md) / [EmailOuvreMessagerie](../WDLang2/3032021.md) pour initialiser : 

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) l'application native d'envoi d'emails de l'appareil Android. 

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) l'application native d'envoi d'emails de l'iPhone ou de l'iPad. 
...
<a name="les_differentes_variables_structure_email_ELTTEXTE000796"></a>
...
| **Email.EnDehors** | Booléen indiquant si un message a pu être lu. Email.EnDehors retourne <u><u><u><u>Faux</u></u></u></u> lorsqu'un message a été lu et <u><u><u><u>Vrai</u></u></u></u> lorsque le message n'a pas été lu.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
| **Email.Erreur** | Chaîne de caractères contenant le message d'erreur.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
...
| **Email.HTML** | Chaîne de caractères contenant le message avec une mise en forme HTML. Limité à 4 Go.<br>Ce membre est géré uniquement en POP3 / SMTP.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
| **Email.ID** | Identifiant unique de l'email (chaîne de caractères). Cet identifiant est constant pour toute la durée de vie de l'email. Cet identifiant est initialisé lors de l'envoi de l'email (fonction [EmailEnvoieMessage](../WDLang3/3032005.md)).<br><br>Remarque : Si l'identifiant contient des caractères spéciaux ou des accents, utilisez la constante **emailOptionEncodeEntête** lors de l'envoi du message avec la fonction [EmailEnvoieMessage](../WDLang3/3032005.md).<br><br>**Logiciel de messagerie Outlook et Lotus Notes uniquement**<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
| **Email.IdentifiantAttache** | Tableau de chaînes de caractères contenant l'identifiant des fichiers attachés inclus dans un message HTML.<br>Cette variable est renseignée uniquement lors de la réception d'un email.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
| **Email.IdentifiantMail** | Identifiant de l'email (mode asynchrone uniquement)<br>WEBDEV uniquement<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
...
| **Email.Priorité** | Constante de type Entier contenant le type de priorité de l'email. Les valeurs possibles sont les suivantes :<br><br>- ***emailPrioritéBasse*** : utilisé par exemple pour les emails très peu urgents.<br><br>- ***emailPrioritéHaute*** : utilisé par exemple pour les emails urgents.<br><br>- ***emailPrioritéNormale*** (Valeur par défaut) : utilisé par exemple pour les emails non urgents.<br><br><br><br><br>Attention : Ce membre est géré uniquement en POP3 / SMTP.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
| **Email.Référence** | Chaîne de caractères. Identifiant unique d'un ou de plusieurs emails de référence liés à la conversation en cours.<br>Ce membre n'est pas géré sous Lotus Notes.<br>Ce membre n'est pas géré par Outlook sous Windows.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
...
| **Email.Source** | Chaîne de caractères contenant la source du message reçu (sujet, expéditeur, destinataire, contenu, ...).<br><br>Ce membre n'est pas géré par Outlook sous Windows.<br><br>![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Non disponible. |
...
| **Email.TexteBrut** | Chaîne de caractères contenant le texte brut du message. Cette variable est disponible en réception uniquement.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Non disponible. |
...
<a name="accuse_reception_email_ELTPARAGRAPHE000550"></a>Deux variables permettent de gérer l'accusé de réception d'un email : ***Email.ConfimationLecture*** et ***Email.AccuséRéception***.
...
<a name="variables_structure_email_faisant_partie_entete_email_ELTPARAGRAPHE000563"></a>Lors de la lecture de l'entête de l'email, la structure email est automatiquement mise à jour en fonction du contenu de l'entête du message.
...
<a name="quelles_fonctions_utilisent_structure_email_ELTTEXTE000832"></a>
...
<a name="les_valeurs_variable_emailerreur_ELTTEXTE000856"></a>
