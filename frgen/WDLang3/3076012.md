...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Application PABX** : Dans le cadre d'une application PABX, chaque ligne apparaît comme un périphérique. Pour numéroter sur une ligne téléphonique, il faut donc à chaque fois :
