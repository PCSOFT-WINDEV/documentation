...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) L'utilisation d'un Webservice dans un projet Java nécessite une machine virtuelle Java (JRE) en version 6 (ou 1.6) ou supérieure.
...
<a name="importer_webservice_soap_dans_projet_ELTTEXTE000550"></a>


### Importation
<a name="importation_ELTPARAGRAPHE000059"></a>

Pour importer un Webservice SOAP :

1. Sous le volet "Projet", dans le groupe "Projet", déroulez "Importer" et sélectionnez "Un Webservice". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Importer_un_service_Web_XML%20-%20HC%20N%B0001.gif&type=thumb)
...
3. Indiquez la localisation du WSDL (prononcer wizdeul). Ce fichier correspond à la description du webservice. Il contient la description de chaque fonction contenue dans le Webservice ainsi que leurs paramètres. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Importer_un_service_Web_XML%20-%20HC%20N%B0002.gif)
...
4. Terminez l'assistant. Un message apparaît indiquant que l'importation est terminée. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Importer_un_service_Web_XML%20-%20HC%20N%B0003.gif&type=thumb)
...
<a name="volet_explorateur_projet_visualiser_webservice_ELTPARAGRAPHE000099"></a>

Le Webservice importé est présent dans le volet "Explorateur de projet", dossier "Webservices importés" : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Importer_un_service_Web_XML%20-%20HC%20N%B0004.gif)
...
<a name="description_proprietes_webservice_soap_ELTTEXTE000589"></a>


### Mettre à jour la description d'un Webservice
<a name="mettre_jour_description_webservice_ELTPARAGRAPHE000122"></a>
...
<a name="proprietes_webservice_modifiables_dans_editeur_ELTPARAGRAPHE000136"></a>
...
<a name="utilisation_webservice_soap_ELTTEXTE000619"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000152"></a>
...
<a name="comment_ecrire_dans_entete_http_appel_webservice_soap_ELTPARAGRAPHE000178"></a>
...
<a name="proprietes_associees_webservice_soap_ELTPARAGRAPHE000221"></a>
...
<a name="proprietes_disponibles_sur_les_types_variables_ELTPARAGRAPHE000358"></a>
...
| Valeur | Variant | Valeur de la variable.<br><br>**Remarque** : Cette propriété est accédée par défaut lorsque seul le nom de la variable est utilisé. Par exemple :<br><br><br><pre><code>monWebservice.VariableRequete = SAI_Valeur</code></pre><br>est équivalent à :<br><br><br><pre><code>monWebservice.VariableRequete.Valeur = SAI_Valeur</code></pre><br> |


![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Il n'est pas possible d'utiliser une méthode gérant un contexte partagé.
<a name="NOTE4_4"></a>


### Manipulation avancée du flux XML du Webservice
<a name="manipulation_avancee_flux_xml_webservice_ELTPARAGRAPHE000420"></a>
...
<a name="cas_particulier_webservice_renvoie_resultat_dans_type_non_reconnu_par_windev_webdev_windev_mobile_ELTPARAGRAPHE000450"></a>
...
<a name="distribuer_une_application_windev_qui_utilise_webservice_soap_ELTTEXTE000699"></a>
