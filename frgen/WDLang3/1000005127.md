...
<a name="colonnes_type_dateheure_ELTPARAGRAPHE000121"></a>Les recherches de type "Identique" (constante *notesEgal*) effectuées dans les colonnes de type DateHeure peuvent être erronées. En effet, la précision de la valeur stockée par la colonne peut être supérieure à la précision de la valeur recherchée.
