...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) La fonction **géoSuiviProcédure** peut être utilisée en mode arrière-plan. Il est recommandé de ne pas accéder à l'interface ou d'ouvrir des fenêtres dans la procédure WLangage car iOS n'autorise pas les accès à l'interface lorsque l'application est en arrière-plan. 
