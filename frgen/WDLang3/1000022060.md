...
| Permission | Entier | Permissions de la caractéristique.<br><br>![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Cette propriété est inutile et vaut toujours 0. <br><br>Cette propriété est disponible en lecture seulement. |
