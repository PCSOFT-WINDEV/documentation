...
## &lt;Variable ftpConnexion&gt;.ListeTable (Fonction)
...
Pour plus de détails sur cette procédure, consultez [Paramètres de la procédure utilisée par la fonction &lt;Variable ftpConnexion&gt;.ListeTable](../WDLang3/1000025351.md).
...
<a name="procedure_manipulant_chaque_fichier_liste_ELTPARAGRAPHE000308"></a>

Pour plus de détails sur les paramètres de la procédure &lt;Procédure WLangage&gt;, consultez [Paramètres de la procédure utilisée par la fonction &lt;Variable ftpConnexion&gt;.ListeTable](../WDLang3/1000025351.md). 

**Attention**: Dans la procédure &lt;Procédure WLangage&gt;:

- aucune fonction FTP utilisant la même connexion que celle de la fonction **&lt;Variable ftpConnexion&gt;.ListeTable** ne doit être appelée.
...
### Délai
<a name="delai_ELTPARAGRAPHE000356"></a>
