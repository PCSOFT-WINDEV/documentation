...
<a name="conditions_utilisation_ELTPARAGRAPHE000313"></a>La suppression de fichiers dans une archive ne peut être réalisée que si :
...
### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000356"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000371"></a>Lors de l'ajout d'un fichier dans une archive, un indice est automatiquement attribué au fichier. Cet indice correspond à l'ordre d'intégration des fichiers dans l'archive.
...
### Chemin mémorisé
<a name="chemin_memorise_ELTPARAGRAPHE000393"></a>Le tableau ci-dessous présente les chemins mémorisés dans l'archive en fonction :
