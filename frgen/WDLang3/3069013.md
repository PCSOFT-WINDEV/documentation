...
<DIV class="specObsolete">
	...
	A partir de la version <B>29</B>,  cette fonction est conservée par compatibilité. 
...
- **Cette fonction est d'un usage avancé permettant de gérer certains cas particuliers. Dans la majorité des cas, il est recommandé d'importer le wsdl du webservice SOAP**. Pour plus de détails, consultez [Importation/consommation de Webservices](../WDLang3/3086001.md). 
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003069013&name=soapexecute_fonction">Voir des exemples supplémentaires</a>
...
<a name="parametres_procedure_executer_ELTPARAGRAPHE000121"></a>Pour passer des paramètres à une procédure exécutée sur un serveur SOAP, WINDEV utilise la structure suivante :
...
### Type du paramètre
<a name="type_parametre_ELTPARAGRAPHE000180"></a>Le type du paramètre peut être :
...
<a name="appel_fonction_soapexecute_ELTPARAGRAPHE000282"></a>Après l'appel de la fonction **SOAPExécute** :
...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000308"></a>La fonction **SOAPExécute** retourne <u><u><u><u>Faux</u></u></u></u> si aucune communication avec le serveur SOAP n'a été établie. Pour connaître le libellé de l'erreur, utilisez la fonction [ErreurInfo](../WDLang1/3013008.md) avec la constante *errMessage*.
...
[SOAPErreur (Fonction)](../WDLang3/3069005.md)
