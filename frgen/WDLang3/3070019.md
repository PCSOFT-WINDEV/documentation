...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Pour utiliser les sockets sur le poste serveur, il est nécessaire de cocher l'option "Autoriser les sockets serveur" dans l'administrateur WEBDEV.
...
### Le protocole UDP
<a name="protocole_udp_ELTPARAGRAPHE000084"></a>
...
<a name="fonctionnement_des_sockets_udp_ELTPARAGRAPHE000104"></a>

Il est possible re-ouvrir un port déjà ouvert par une autre application. Le port sera fermé uniquement lors de l'appel à la fonction [SocketFerme](../WDLang3/3070015.md) ou lors de la terminaison de l'application qui l'a ouvert.
<a name="NOTE0_4"></a>
...
<a name="permissions_requises_ELTPARAGRAPHE000259"></a>
