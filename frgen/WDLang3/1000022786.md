...
// pour schéma des données du contenu
...
### Sessions prélancées
<a name="sessions_prelancees_ELTPARAGRAPHE000103"></a>
...
<a name="passage_parametres_dans_les_donnees_brutes_requete_methode_post_put_ELTPARAGRAPHE000109"></a>

Pour transmettre des paramètres dans les données brutes de la requête (méthode POST, PUT, ...) depuis une application WINDEV ou WEBDEV, il est par exemple possible d'utiliser la propriété **Contenu** d'une variable de type [restRequête](../WDLang3/1000021481.md). 
