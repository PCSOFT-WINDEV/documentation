...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003056025&name=netrecuperefichier_fonction">Voir des exemples supplémentaires</a>
...
<a name="progression_transfert_fichiers_ELTPARAGRAPHE000063"></a>La gestion de la progression du transfert de fichiers est uniquement réalisée sur le programme client FTP.
...
<a name="frequence_evenement_ELTPARAGRAPHE000106"></a>Le paramètre &lt;Fréquence événement&gt; permet de définir la fréquence minimum d'envoi de message. Par exemple, pour un fichier d'une taille de 1 Mo et une fréquence de 10%, on recevra un message à chaque fois que 100Ko sont transférés.
...
[NetEnvoieFichier (Fonction)](../WDLang3/3056005.md)
