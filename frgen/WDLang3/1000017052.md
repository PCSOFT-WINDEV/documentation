...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1001000017052&name=dotnetdelegue_fonction">Voir des exemples supplémentaires</a>
...
### Vocabulaire
<a name="vocabulaire_ELTPARAGRAPHE000045"></a>
...
<a name="comment_utiliser_delegate_dotnet_avec_windev_ELTPARAGRAPHE000057"></a>Pour utiliser un delegate DotNet avec WINDEV, il faut : 
...
<a name="comment_traiter_les_evenements_net_ELTPARAGRAPHE000083"></a>Pour traiter les événements .Net, il faut : 
...
### Astuce
<a name="astuce_ELTPARAGRAPHE000127"></a>Dans la procédure WLangage, il est possible :
