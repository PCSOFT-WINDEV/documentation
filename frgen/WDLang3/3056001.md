...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003056001&name=netenvoiebuffer_fonction">Voir des exemples supplémentaires</a>
...
<a name="caracteristiques_envoi_ELTPARAGRAPHE000048"></a>La chaîne est envoyée grâce au message Windows WM_COPYDATA(74). 
...
<a name="recuperation_message_sur_serveur_ELTPARAGRAPHE000057"></a>Pour récupérer la chaîne envoyée et les informations complémentaires sur le serveur, il faut intercepter l'événement 74 grâce à la fonction [Evénement](../WDLang1/3015011.md) (voir l'exemple complet).
