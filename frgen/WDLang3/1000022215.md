...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_FireBase1.gif&type=thumb)
...
- Cliquez sur le bouton "Ajouter Firebase à votre application Android". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_FireBase2.gif&type=thumb)


- Renseignez le nom de package de l'application avec celui saisi dans l'assistant de génération Android. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_FireBase3.gif)


- Cliquez sur le bouton "Enregistrer l'application". 

- L'étape suivante permet de télécharger le fichier "google-services.json".  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_FireBase4.gif&type=thumb)
...
- Affichez les paramètres de votre application : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_FireBase5.gif&type=thumb)


- Dans la partie concernant l'application Android, téléchargez le fichier "google-services.json". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_FireBase5B.gif&type=thumb)



Ce fichier doit être fourni dans l'assistant de génération de l'application : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Push_Android_firebase%20-%20HC%20N%B0001.gif)
...
- Copiez l'identifiant de la clé serveur. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_FireBase6.gif&type=thumb)
...
- Cliquez sur l'onglet "Comptes de services", puis cliquez sur "Générer une nouvelle clé privée". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Notif_FireBase7.gif&type=thumb)
