...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) La gestion des ports parallèles et infrarouges n'est pas disponible.

![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette fonction concerne le poste serveur.
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003062013&name=souvre_fonction">Voir des exemples supplémentaires</a>
...
## Syntaxe
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Non disponible en Linux, Android et Widget Android
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Si ce paramètre n'est pas spécifié, aucun délai d'attente ne sera appliqué. La constante *sTimeoutDéfaut* n'est pas disponible. Si un délai est spécifié, il sera appliqué uniquement sur les opérations de lecture sur les ports série. 
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Attention :  

- Cet identifiant ne correspond pas au numéro du port série concerné. 

- La gestion des ports parallèles n'est pas disponible.

- ![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) La gestion des ports infrarouges n'est pas disponible.
...
- Nom du port série : :
	...
	- ![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Nom du port série en Java : /dev/ttyS4, /dev/ttyS5, ... /dev/ttyS9.

	- ![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Nom du port série en Linux (par exemple /dev/ttyS1).

	- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Nom du port série renvoyé par la fonction [sListePort](../WDLang3/1000025980.md).
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Rappel :  
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Si le fichier WIN.INI contient des valeurs d'initialisation pour le port série spécifié, ces valeurs sont utilisées.

- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Il est possible d'obtenir la liste des ports séries et des ports parallèles grâce aux entrées suivantes de la base de registre :
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) **Cas particulier sous Linux** : 
...
<a name="specificites_android_widget_android_ELTPARAGRAPHE000257"></a>Sous Android et en mode Widget Android, les fonctions de manipulations des ports séries et parallèles sont utilisables : 
...
[sEvénement (Fonction)](../WDLang3/3062014.md)

[sFerme (Fonction)](../WDLang3/3062010.md)

[sFinEvénement (Fonction)](../WDLang3/3062008.md)

[Fonctions de gestion des ports série et parallèle](../WDLang3/3062003.md)

[sListePort (Fonction)](../WDLang3/1000025980.md)
