...
### Rappel
<a name="rappel_ELTPARAGRAPHE000302"></a>
...
<a name="exemple_chemin_extrait_ELTPARAGRAPHE000317"></a>Si le chemin mémorisé est "C:\\Temp\\Donnée\\Fichier.txt", la fonction **&lt;Variable zipArchive&gt;.ExtraitChemin** renvoie :
...
### Chemin mémorisé
<a name="chemin_memorise_ELTPARAGRAPHE000343"></a>Le tableau ci-dessous présente les chemins mémorisés dans l'archive en fonction :
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000416"></a>Lors de l'ajout d'un fichier dans une archive, un indice est automatiquement attribué au fichier. Cet indice correspond à l'ordre d'intégration des fichiers dans l'archive. Pour sélectionner un fichier de l'archive, il est possible d'utiliser :
