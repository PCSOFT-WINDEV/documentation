...
<a name="envoi_direct_commandes_ELTPARAGRAPHE000161"></a>L'envoi directe de commandes se fait à l'aide de la fonction [&lt;Variable sshSession&gt;.Commande](../WDLang3/1410091176.md). Les paramètres de connexion au serveur SSH doivent être décrits dans une variable de type [sshSession](../WDLang3/1000021157.md).
...
<a name="dialogue_avec_serveur_ssh_ELTPARAGRAPHE000222"></a>Le dialogue avec le serveur SSH se fait à l'aide des fonctions suivantes :
...
La connexion au serveur s'effectue grâce à la fonction WLangage [&lt;Variable sshSession&gt;.ConnecteShell](../WDLang3/1000021163.md). Cette fonction attend en paramètre une variable de type [sshSession](../WDLang3/1000021157.md) qui contient les informations de connexion au serveur SSH :
...
L'envoi des commandes s'effectue via la fonction [&lt;Variable sshSession&gt;.Ecrit](../WDLang3/1000021166.md). Cette fonction attend en paramètres :
...
La lecture des résultats et sorties s'effectue à l'aide de la fonction WLangage [&lt;Variable sshSession&gt;.Lit](../WDLang3/1000021167.md). Cette fonction permet de lire le texte renvoyé par le serveur SSH.

**Etape 4 : La déconnexion**
La déconnexion du serveur SSH s'effectue de manière très simple avec la fonction WLangage [&lt;Variable sshSession&gt;.DéconnecteShell](../WDLang3/1000021164.md) en lui passant en paramètre la connexion :
