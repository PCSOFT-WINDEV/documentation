...
- ![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) La gestion des ports infrarouges n'est pas disponible.

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette fonction renvoie les informations concernant le poste serveur.
...
- Identifiant du port renvoyé par la fonction [sOuvre](../WDLang3/3062013.md) (si cette fonction a été appelée avec un nom de port). 
	![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Seul ce type de paramètre est disponible.
...
|   |   |
| --- | --- |
| CLRBREAK | Efface le signal "Break line".<br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette fonction n'est pas supportée. |
| CLRDTR | Efface le signal DTR. |
| CLRRTS | Efface le signal RTS. |
| RESETDEV | Ré-initialise le périphérique si possible.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette fonction n'est pas supportée. |
| SETBREAK | Active le signal "Break line".<br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette fonction n'est pas supportée. |
| SETDTR | Envoie le signal DTR. |
| SETRTS | Envoie le signal RTS. |
| SETXOFF | La transmission se comporte comme si le caractère XOFF avait été reçu.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette fonction n'est pas supportée. |
| SETXON | La transmission se comporte comme si le caractère XON avait été reçu.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette fonction n'est pas supportée. |
...
<a name="specificites_android_widget_android_ELTPARAGRAPHE000189"></a>Sous Android et en mode Widget Android, les fonctions de manipulations des ports séries et parallèles sont utilisables : 
