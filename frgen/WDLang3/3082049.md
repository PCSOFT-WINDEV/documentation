...
Supprime un ensemble de fichiers contenu dans une archive. Cette fonction est plus rapide que la fonction [zipSupprimeFichier](../WDLang3/3082041.md) exécutée pour chaque fichier.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) au nom d'un champ Jauge présent dans une fenêtre. Cette jauge affichera la progression de la suppression du fichier manipulé.  
...
<a name="conditions_utilisation_ELTPARAGRAPHE000144"></a>La suppression de fichiers dans une archive ne peut être réalisée que si :
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Seules les archives au format ZIP sont disponibles.
<a name="NOTE0_2"></a>


### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000174"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000188"></a>Après une suppression de fichiers, les fichiers présents dans une archive sont ré-indicés. Les indices des fichiers suivant le fichier supprimé sont automatiquement décrémentés de 1.
<a name="NOTE0_4"></a>


### Chemin mémorisé
<a name="chemin_memorise_ELTPARAGRAPHE000197"></a>Le tableau ci-dessous présente les chemins mémorisés dans l'archive en fonction :
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) La constante *zipDisque*est équivalente à la constante *zipRépertoire*.
...
[&lt;Variable zipArchive&gt;.SupprimeListeFichier (Fonction)](../WDLang3/1000019153.md)
