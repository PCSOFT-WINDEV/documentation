...
<a name="proprietes_specifiques_description_des_variables_type_adresseemail_ELTPARAGRAPHE000041"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une adresse Email :
...
### Réinitialisation
<a name="reinitialisation_ELTPARAGRAPHE000088"></a>Pour réinitialiser le contenu d'une variable de type **AdresseEmail**, il est possible d'utiliser la fonction [VariableRAZ](../WDLang1/3013069.md).
