...
## Syntaxe
<a name="SYNTAXE1"></a>
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette syntaxe n'est pas disponible en code navigateur
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) L'adresse peut également correspondre à l'adresse IP obtenue par la fonction [NetAdresseIP](../WDLang3/3056023.md).![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) L'adresse doit être l'adresse IP du serveur (et non le nom du serveur).
