...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Si vous utilisez une application WINDEV sur le poste serveur et sur le poste client, le changement de mode de transmission doit être effectué sur le poste client **et** sur le poste serveur.
...
<a name="type_transmission_message_ELTPARAGRAPHE000152"></a>Le type de transmission du message définit le mode utilisé pour déterminer la longueur du message.
...
<a name="differences_fonctionnement_entre_les_constantes_socketmarqueurfin_socketmarqueurfinbuffer_ELTPARAGRAPHE000165"></a>Dans les deux cas, la lecture sur le socket attend de recevoir le marqueur de fin.
...
<a name="message_avec_marqueur_fin_ELTPARAGRAPHE000179"></a>Si l'encodage du message prend en compte le marqueur de fin, il n'est pas nécessaire de le préciser dans le message.
