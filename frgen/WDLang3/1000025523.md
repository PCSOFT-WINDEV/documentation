...
<a name="proprietes_specifiques_description_des_variables_type_carteimage_ELTPARAGRAPHE000025"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une image dans un champ Carte :
...
| Altitude | Entier | Altitude de l'image par rapport aux autres formes présentes dans le champ Carte. Permet de gérer les superpositions. <br><br>Une forme avec une altitude élevée sera dessiné par-dessus une forme avec une altitude inférieure. <br><br>Par défaut, cette propriété vaut 0. <br><br>![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Cette propriété n'est pas disponible. |
...
| Largeur | Réel | Largeur (en mètres) que doit occuper l'image sur la carte. <br><br>**Cette propriété est obligatoire.** |
...
### Fonctions WLangage
<a name="fonctions_wlangage_ELTPARAGRAPHE000155"></a>Les fonctions WLangage manipulant des variables de type **CarteImage** sont les suivantes : 
...
[CarteAjouteImage (Fonction)](../WDLang3/1000025532.md)

[CarteModifieImage (Fonction)](../WDLang3/1000025533.md)
