...
## Syntaxe
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Syntaxe non disponible sous Android et en mode Widget Android
### Écrit une chaîne de caractères dans le buffer de sortie d'un port
...
- Numéro de port :
	...
	- Numéro du port infrarouge : 1, 2, 3, ... 32 pour IR1, IR2, IR3, ... IR32.
			![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) La gestion des ports infrarouges n'est pas disponible.
...
- Identifiant du port renvoyé par la fonction [sOuvre](../WDLang3/3062013.md) (si cette fonction a été appelée avec un nom de port). 
	![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Seul ce type de paramètre est disponible.
...
- Une application 32 bits est bloquée pendant la durée du transfert. Pour éviter ce blocage, il faut préciser le temps d'attente entre deux écritures dans la fonction [sOuvre](../WDLang3/3062013.md). Lorsque le temps d'attente est terminé et si l'écriture n'a pas pu être réalisée, **sEcrit** renvoie 0.
	![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) La fonction **sEcrit** est bloquante durant le transfert même si une durée d'attente a été spécifiée dans la fonction [sOuvre](../WDLang3/3062013.md).
...
<a name="specificites_android_widget_android_ELTPARAGRAPHE000262"></a>Sous Android et en mode Widget Android, les fonctions de manipulations des ports séries et parallèles sont utilisables : 
