...
<a name="proprietes_specifiques_description_des_variables_type_wsreponse_ELTPARAGRAPHE000043"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une variable de type **wsRéponse** :
...
### Fonctionnement
<a name="fonctionnement_ELTPARAGRAPHE000093"></a>Le type **wsRéponse** permet d'avoir le source XML complet de la requête envoyée pour la consommation du Webservice.
