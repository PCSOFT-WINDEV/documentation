...
<a name="principe_serveur_websocket_ELTTEXTE000271"></a>
...
<a name="comment_utiliser_serveur_websocket_ELTTEXTE000295"></a>
Pour utiliser le serveur de WebSocket, vous devez: 

1. Installer le Serveur d'application WEBDEV 2026, qui permet d'administrer les serveurs de WebSocket (via l'onglet "WebSockets"). 
...
<a name="projet_type_serveur_websocket_ELTTEXTE000335"></a>


### Création du projet de type "Serveur de WebSocket"
<a name="creation_projet_type_serveur_websocket_ELTPARAGRAPHE000072"></a>
...
**Remarque**: Pour éditer les événements spécifiques d'un projet: sous le volet "Accueil", dans le groupe "Général", déroulez ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_code.gif) et sélectionnez "Code du projet".




### Contextes d'exécution
<a name="contextes_execution_ELTPARAGRAPHE000173"></a>
...
<a name="fonctions_wlangage_specifiques_pouvant_etre_utilisees_dans_projet_serveur_websocket_ELTPARAGRAPHE000197"></a>Les fonctions spécifiques pouvant être utilisées dans le serveur de WebSocket sont les suivantes: 
