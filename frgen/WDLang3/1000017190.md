...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000019245&name=httpenvoieformulaire_fonction">Voir des exemples supplémentaires</a>
...
<a name="SYNTAXE2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 
...
<a name="erreur_securite_dans_une_transaction_securisee_ELTPARAGRAPHE000210"></a>Lors d'une transaction sécurisée, certaines erreurs de sécurité peuvent faire échouer l'envoi du formulaire :
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) Syntaxe 2 : utilisation de la propriété **IgnoreErreur** de la variable [httpRequête](../WDLang3/1000021158.md).
...
FIN
```
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Les erreurs concernant la sécurité des transactions ne sont pas retournées par la fonction [ErreurInfo](../WDLang1/3013008.md) (la connexion est simplement refusée). Ces erreurs ne peuvent pas être ignorées. La variable HTTP.IgnoreErreur n'est pas disponible.
<a name="NOTE0_2"></a>


### Récupération
<a name="recuperation_ELTPARAGRAPHE000305"></a>La fonction [HTTPDonneRésultat](../WDLang3/3043001.md) permet de récupérer le résultat du dernier formulaire HTTP envoyé.
<a name="NOTE0_3"></a>
...
<a name="utilisation_proxy_ELTPARAGRAPHE000332"></a>Pour accéder à l'URL spécifiée dans la fonction **HTTPEnvoieFormulaire** via un proxy, utilisez la fonction [Proxy](../WDLang3/3043002.md).
<a name="NOTE0_5"></a>


### En-têtes d'authentification
<a name="entetes_authentification_ELTPARAGRAPHE000345"></a>Les entêtes d'authentification sont générées automatiquement dans les cas suivants :
