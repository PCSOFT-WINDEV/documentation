...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Pour utiliser les sockets sur le poste serveur, il est nécessaire de cocher l'option "Autoriser les sockets serveur" dans l'onglet "Avancé" de l'administrateur WEBDEV.
...
<a name="canal_communication_ELTPARAGRAPHE000095"></a>

Le canal de communication ouvert grâce à la fonction **SocketAccepte** doit être refermé par la fonction [SocketFerme](../WDLang3/3070015.md).
...
<a name="permissions_requises_ELTPARAGRAPHE000230"></a>
