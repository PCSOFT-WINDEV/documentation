...
- Pour optimiser l'ajout de fichiers dans une archive au format ZIP, WDZ et 7Z, l'ajout de fichiers doit être effectué entre les fonctions [zipDébutAjoutFichier](../WDLang3/1410091114.md) et [zipFinAjoutFichier](../WDLang3/1410091115.md). 
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003082008&name=zipajoutefichier_fonction">Voir des exemples supplémentaires</a>
...
<a name="condition_utilisation_ELTPARAGRAPHE000442"></a>
...
- ![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Seules les archives au format ZIP, TAR, gzip ou TGZ (TAR.GZ) sont disponibles.
...
<a name="niveau_compression_des_archives_zip_7z_ELTPARAGRAPHE000520"></a>

Par défaut, les fichiers ajoutés dans une archive au format ZIP ou 7z sont compressés. Il est possible de modifier le niveau de compression des fichiers ajoutés dans une archive grâce à la fonction [zipNiveauCompression](../WDLang3/3082054.md).
<a name="NOTE0_3"></a>


### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000532"></a>

Les codes d'erreur retournés sont les suivants:

- 1: Le chemin passé en paramètre n'existe pas.

- 2: Accès interdit: l'utilisateur n'a pas les droits nécessaires ou le fichier est en cours d'utilisation. Si la table à insérer est une table HFSQL, elle doit être fermée avec le code suivant:
...
<a name="ajout_fichier_deja_present_dans_archive_ELTPARAGRAPHE000556"></a>
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000567"></a>
...
<a name="chemin_conserve_archives_format_wdz_zip_ELTPARAGRAPHE000582"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Le répertoire en cours est: "C:\\Temp":
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le disque n'est pas conservé dans le chemin de l'archive.
...
[zipNiveauCompression (Fonction)](../WDLang3/3082054.md)

[&lt;Variable zipArchive&gt;.AjouteFichier (Fonction)](../WDLang3/1000019050.md)

[zipFinAjoutFichier (Fonction)](../WDLang3/1410091115.md)

[zipDébutAjoutFichier (Fonction)](../WDLang3/1410091114.md)
