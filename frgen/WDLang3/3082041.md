...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003082041&name=zipsupprimefichier_fonction">Voir des exemples supplémentaires</a>
...
<a name="conditions_utilisation_ELTPARAGRAPHE000172"></a>La suppression de fichiers dans une archive ne peut être réalisée que si :
...
### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000210"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000224"></a>Lors de l'ajout d'un fichier dans une archive, un indice est automatiquement attribué au fichier. Cet indice correspond à l'ordre d'intégration des fichiers dans l'archive.
...
### Chemin mémorisé
<a name="chemin_memorise_ELTPARAGRAPHE000243"></a>Le tableau ci-dessous présente les chemins mémorisés dans l'archive en fonction :
