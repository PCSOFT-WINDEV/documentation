...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003082040&name=zipinfofichier_fonction">Voir des exemples supplémentaires</a>
...
### Rappel
<a name="rappel_ELTPARAGRAPHE000230"></a>
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000244"></a>Lors de l'ajout d'un fichier dans une archive, un indice est automatiquement attribué au fichier. Cet indice correspond à l'ordre d'intégration des fichiers dans l'archive. Pour sélectionner un fichier de l'archive, il est possible d'utiliser :
...
### Chemin mémorisé
<a name="chemin_memorise_ELTPARAGRAPHE000259"></a>Le tableau ci-dessous présente les chemins mémorisés dans l'archive en fonction :
...
<a name="cryptage_fichier_dans_une_archive_ELTPARAGRAPHE000328"></a>Un fichier peut être crypté dans une archive grâce à la fonction [zipMotDePasse](../WDLang3/3082053.md).
...
[&lt;Variable zipArchive&gt;.InfoFichier (Fonction)](../WDLang3/1000019092.md)
