...
Il suffit de se connecter au portail et de cliquer sur le "+" en haut à droite : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Push_IOS_1.gif)


Le portail propose la création d'un certificat : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Push_IOS_2.gif)
...
- Double-cliquez sur le nom du fichier. Le certificat est automatiquement ajouté dans le trousseau d'accès : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Push_IOS_3.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Push_IOS_4.gif)
