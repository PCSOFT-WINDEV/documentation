...
<a name="fonctionnement_httprequete_httpdonneresultat_avec_une_destination_ELTPARAGRAPHE000080"></a>Si un fichier de sauvegarde du résultat de la requête HTTP est précisé avec la fonction **HTTPDestination** :
