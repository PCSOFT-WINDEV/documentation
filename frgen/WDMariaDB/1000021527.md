...
WINDEV et WEBDEV 2026 proposent un Connecteur Natif à MariaDB (également appelé Accès Natif à MariaDB). Ce Connecteur Natif permet d'accéder à une base MariaDB sans drivers externes depuis un programme en WLangage.

**Attention** : Cette version du Connecteur Natif MariaDB ne fonctionne qu'avec WINDEV et WEBDEV version 2026.
...
<a name="configuration_necessaire_ELTTEXTE000245"></a>
...
<a name="les_fichiers_necessaires_ELTPARAGRAPHE000054"></a>Les fichiers nécessaires à l'utilisation du Connecteur Natif MariaDB sont :
...
- La DLL ***wd310maria.dll*** : Nécessaire au Connecteur Natif 32 bits à une base MariaDB. Ce fichier est livré avec le Connecteur Natif MariaDB pour WINDEV et/ou WEBDEV.

- La DLL ***wd310maria64.dll*** : Nécessaire au Connecteur Natif 64 bits à une base MariaDB. Ce fichier est livré avec le Connecteur Natif MariaDB pour WINDEV et/ou WEBDEV.
...
<a name="installation_une_nouvelle_version_mariadb_ELTPARAGRAPHE000079"></a>Le dialogue entre le Connecteur Natif MariaDB et MariaDB utilise la DLL LibMariaDB.DLL livrée avec MariaDB. 
...
<a name="fichiers_necessaires_utilisation_connecteur_natif_mariadb_sous_linux_ELTPARAGRAPHE000092"></a>Pour utiliser le Connecteur Natif MariaDB sous Linux, les manipulations suivantes sont nécessaires :
...
- wd310maria.so : librairie du connecteur natif 32 bits

- wd310maria64.so : librairie du connecteur natif 64 bits
...
## Utilisation
<a name="utilisation_ELTTEXTE000287"></a>


### Utiliser le Connecteur Natif MariaDB dans vos applications WINDEV et sites WEBDEV
<a name="utiliser_connecteur_natif_mariadb_dans_vos_applications_windev_sites_webdev_ELTPARAGRAPHE000141"></a>Pour utiliser le Connecteur Natif MariaDB, il faut programmer dans l'application WINDEV ou dans le site WEBDEV :
...
- L'option "Créer les tables automatiquement au moment de leur ouverture" (disponible dans l'onglet "Fichiers" de la description du projet) est prise en compte par le Connecteur Natif MariaDB. 
...
<a name="optimisations_des_fonctions_hfsql_ELTPARAGRAPHE000171"></a>
...
[Connecteur Natif MariaDB: Programmation à l'aide des fonctions HFSQL](../WDMariaDB/1000021528.md)
