...
<a name="comment_traduire_fichier_messages_avec_wdtrad_ELTTEXTE000233"></a>
...
- WDTRAD propose deux modes de copie entre les messages extraits et les messages traduits. Pour plus de détails, consultez les [Différents modes de copie](../WDTRAD/3518018.md).

- Pour paramétrer le dictionnaire (ajouter/modifier/supprimer des ressources), sélectionnez l'option "Propriétés du dictionnaire" du menu contextuel de la table "Dictionnaire". Pour plus de détails, consultez [Propriétés du dictionnaire](../WDTRAD/3518022.md)

- Pour paramétrer WDTRAD, utilisez l'option "Edition .. Préférences". Le détail de ces options sont présentées dans [Options de WDTRAD](../WDTRAD/3518021.md). 
...
- Pour chaque langue, il est possible de paramétrer les caractéristiques de la langue : clavier utilisé, symboles. Pour plus de détails, consultez [Propriétés du dictionnaire](../WDTRAD/3518022.md). 
...
<a name="comment_rechercher_message_dans_wdtrad_ELTTEXTE000257"></a>
...
- effectuer une recherche simple : cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CurseurLoupe.gif) présente dans l'entête de colonne et saisissez le début du message recherché.
...
- Utiliser l'onglet "Rechercher" des propriétés du dictionnaire. 
...
<a name="comment_forcer_clavier_saisie_message_dans_wdtrad_ELTTEXTE000281"></a>
...
<a name="caracteres_specifiques_dans_les_messages_librairies_framework_messages_programmation_etc_ELTPARAGRAPHE000150"></a>Certains messages comportent :
