...
## Mise en place
<a name="mise_place_ELTTEXTE000249"></a>


### 1. Inclusion des fichiers de l'interface C de WINDEV
<a name="1_inclusion_des_fichiers_interface_windev_ELTPARAGRAPHE000031"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=mode3.gif)
...
<a name="2_inclusion_des_declarations_hfsql_ELTPARAGRAPHE000044"></a>
...
<a name="interfacage_avec_windev_ELTTEXTE000279"></a>


### 1. Déclaration du contexte HFSQL et des buffers de travail de chaque fichier:
<a name="1_declaration_contexte_hfsql_des_buffers_travail_chaque_fichier_ELTPARAGRAPHE000057"></a>
...
### 2. Héritage
<a name="2_heritage_ELTPARAGRAPHE000068"></a>
...
### 3. Constructeur
<a name="3_constructeur_ELTPARAGRAPHE000079"></a>
...
<a name="4_map_des_actions_utilisateur_dans_les_fenetres_ELTPARAGRAPHE000094"></a>

Le mécanisme de la classe CWDDialog permet d'associer les événements utilisateurs dans la fenêtre WINDEV à des méthodes de votre classe (à la manière de la fonction [nWDSetCallbackNext](../LangageExt/7513012.md)), mais de façon générale et automatique.
...
<a name="5_association_entre_membre_classe_champ_fenetre_ELTPARAGRAPHE000138"></a>
...
<a name="utilisation_hfsql_ELTTEXTE000327"></a>
L'utilisation des fonctions d'accès aux tables est bien sûr possible par l'appel de la fonction nWDExecute (voir définition de cette fonction). Toutefois, l'interface langage C++ fournit une classe de gestion des tables HFSQL nommée CVHFContext.
