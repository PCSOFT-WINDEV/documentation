...
| En 32 bits, la DLL **wd310sqlserver.dll** est nécessaire pour ce mode d'utilisation du Connecteur Natif via OLE DB.<br><br>En 64 bits, la DLL **wd310sqlserver64.dll** est nécessaire pour ce mode d'utilisation du Connecteur Natif via OLE DB. | En 32 bits, la DLL **wd310sqlserver2.dll** est nécessaire pour ce mode d'utilisation du Connecteur Natif via OBDC.<br><br>En 64 bits, la DLL **wd310sqlserver2_64.dll** est nécessaire pour ce mode d'utilisation du Connecteur Natif via ODBC. |
...
## Utilisation
<a name="utilisation_ELTTEXTE000219"></a>
...
[Connecteur Natif SQL Server: Programmation à l'aide des fonctions SQL](../WDSQLServer/5515010.md)

[Connecteur Natif SQL Server: Programmation à l'aide des fonctions HFSQL](../WDSQLServer/5515011.md)

[Connecteur Natif SQL Server : Récupérer la valeur de sortie d'une procédure stockée](../WDSQLServer/5515009.md)

[Connecteur Natif SQL Server : Exécuter plusieurs fois une même procédure stockée](../WDSQLServer/5515008.md)
