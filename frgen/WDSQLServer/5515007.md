...
2. Dans la fenêtre qui s'ouvre (elle liste les différentes connexions existantes), cliquez sur le bouton "Ajouter" pour créer une nouvelle connexion. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Parametrage_1.gif)


3. Donnez les paramètres de la connexion : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Connexion_1.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=options_1.gif)
...
4. Cliquez sur le bouton "Tester la connexion". Le compte-rendu apparaît. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=test_1.gif)
