...
Cette gestion des incidents est réalisée via un onglet de type "Incidents". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Incidents%20-%20HC%20N%B0001.gif&type=thumb)
...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000312"></a>


### Ajouter un incident
<a name="ajouter_incident_ELTPARAGRAPHE000067"></a>L'ajout d'un incident peut être réalisé selon plusieurs méthodes :
...
3. Si vous avez une tâche liée à une exigence actuellement en cours, le Centre de Gestion de Projets propose de lier automatiquement le nouvel incident à cette exigence. Cette option peut être modifiée dans le [Paramétrage du Centre de Gestion de Projets](../CCSuivi/3540710.md).

4. Dans la fenêtre de description de l'incident : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Incidents%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="modifier_incident_ELTPARAGRAPHE000131"></a>Pour modifier un incident :
...
<a name="corriger_incident_ELTPARAGRAPHE000145"></a>Pour corriger un incident :
...
- Si l'intervenant ayant créé l'incident utilise la messagerie intégrée WDBal livrée avec WINDEV, WEBDEV et WINDEV Mobile, un message sera automatiquement envoyé lui indiquant que l'incident a été corrigé. Les liens entre la messagerie et le Centre de Gestion de Projets sont configurés dans les [Paramètres du Centre de Gestion de Projets](../CCSuivi/3540710.md).
...
<a name="options_directement_accessibles_depuis_menu_contextuel_incident_ELTTEXTE000348"></a>
...
- Gérer la notification. Par défaut, les options de notification sont celles indiquées lors du [Paramétrage du Centre de Gestion de Projets](../CCSuivi/3540710.md) (option "Messagerie"). Il est cependant possible à l'utilisateur :
...
<a name="transfert_fiches_entre_deux_lots_incidents_ELTTEXTE000372"></a>
...
2. Cliquez sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=cc_sqe_transfertlot.gif). 
...
<a name="recuperer_projet_reproduction_joint_une_fiche_incident_ELTPARAGRAPHE000239"></a>Au moment du traitement de l'incident par le développeur, le projet de reproduction peut être récupéré en local en utilisant l'option "Installer les éléments de reproduction" du menu contextuel de la liste des incidents.
...
[Centre de Gestion de Projets : Tendance de création/correction des incidents](../CCSuivi/3540729.md)
