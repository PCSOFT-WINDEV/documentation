...
<a name="passer_une_base_hfsql_classic_une_base_hfsql_clientserveur_ELTTEXTE000276"></a>


### Les différentes étapes sont les suivantes
<a name="les_differentes_etapes_sont_les_suivantes_ELTPARAGRAPHE000032"></a>
...
## Mise en place
<a name="mise_place_ELTTEXTE000300"></a>


### Étape 1: Installer si nécessaire un serveur HFSQL Client/Serveur
<a name="etape_1_installer_necessaire_serveur_hfsql_clientserveur_ELTPARAGRAPHE000045"></a>

Pour utiliser les Centres de Contrôle avec une base de données HFSQL Client/Serveur, il est nécessaire d'installer un serveur HFSQL Client/Serveur sur un poste. Les tables des Centres de Contrôle seront installées sur ce serveur.
...
<a name="etape_2_configurer_les_differents_produits_pour_utiliser_les_centres_controle_mode_clientserveur_ELTPARAGRAPHE000056"></a>
...
- soit dans les paramètres du Centre de Gestion de Projets:  déroulez ![Menu Centre de Gestion de Projets](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) puis sélectionnez "Options".
...
### Etape 2: Astuce
<a name="etape_2_astuce_ELTPARAGRAPHE000096"></a>
...
<a name="utilisation_des_centres_controle_mode_clientserveur_ELTTEXTE000336"></a>


### Spécificités Client/Serveur
<a name="specificites_clientserveur_ELTPARAGRAPHE000111"></a>
...
<a name="gestion_des_intervenants_ELTPARAGRAPHE000123"></a>
...
<a name="utiliser_composant_feedback_avec_les_centres_controle_mode_clientserveur_ELTTEXTE000366"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Présentation
<a name="presentation_ELTPARAGRAPHE000154"></a>
...
- **en mode connecté**: Si WINDEV, WEBDEV ou WINDEV Mobile est installé sur le poste de l'utilisateur et que les données des Centres de Contrôle sont accessibles, les suggestions et dysfonctionnements seront immédiatement enregistrés dans le spool "Retours-Client" de votre application (si celle-ci est enregistrée dans le Centre de Gestion de Projets).

- **en mode déconnecté (par emails)**: Dans tous les autres cas, les suggestions et dysfonctionnements seront envoyés par emails à l'adresse de votre choix. Le Centre de Gestion de Projets permet de récupérer les emails envoyés afin de les enregistrer directement dans le spool "Retours-client" de votre application.
...
<a name="manipulations_faire_dans_les_applications_utilisant_composant_feedback_ELTPARAGRAPHE000172"></a>
...
3. Modifiez la ligne de code permettant d'indiquer le chemin des tables. Pour utiliser les Centres de Contrôle en mode Client/Serveur, la nouvelle ligne de code à utiliser est la suivante:
...
Dans ce code:
	...
	- &lt;base de données&gt;: Nom de la base de données HFSQL Client/Serveur correspondant aux tables des Centres de Contrôle.
...
**Si votre application utilise directement le composant Feedback**, il est nécessaire de modifier la configuration du chemin des tables (méthode Configure du composant, avec le paramètre fbCheminDonnéesCC). Voir ci-dessus.


## Voir aussi

[Les Centres de Contrôle](../CCSuivi/9000043.md)
