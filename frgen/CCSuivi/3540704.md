...
<a name="visualiser_les_taches_ELTTEXTE000392"></a>
Les tâches d'un intervenant sont visualisées dans un onglet de type Tâche. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P2_Suivi%20de%20projet%20-%20HC%20N%B0001.gif)
...
## Gestion des tâches
<a name="gestion_des_taches_ELTTEXTE000416"></a>


### Ajouter une nouvelle tâche standard
<a name="ajouter_une_nouvelle_tache_standard_ELTPARAGRAPHE000064"></a>L'ajout de tâches peut être effectué par un administrateur ou par l'intervenant lui-même.
...
3. Indiquez les caractéristiques de la tâche dans les différents onglets :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Tache%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="ajouter_une_nouvelle_tache_interruption_ELTPARAGRAPHE000133"></a>L'ajout de tâches d'interruption peut être effectué par l'intervenant lui-même. Pour plus de détails sur le fonctionnement des tâches d'interruption, consultez [Aide à la gestion du temps](../CCSuivi/3540711.md).
...
<a name="definir_tache_cours_ELTPARAGRAPHE000154"></a>Pour définir la tâche "En cours" :
...
4. Une fenêtre s'affiche :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Tache%20-%20HC%20N%B0002.gif&type=thumb)
...
### Modifier une tâche
<a name="modifier_une_tache_ELTPARAGRAPHE000188"></a>La modification de la tâche peut être effectuée :
...
### Annuler une tâche
<a name="annuler_une_tache_ELTPARAGRAPHE000201"></a>Pour annuler une tâche :
...
### Supprimer une tâche
<a name="supprimer_une_tache_ELTPARAGRAPHE000213"></a>Pour supprimer une tâche :
...
<a name="transferer_une_tache_autre_intervenant_ELTPARAGRAPHE000226"></a>Pour transférer une tâche à un autre intervenant :
...
<a name="liaison_entre_les_taches_ELTTEXTE000476"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000242"></a>Dans l'onglet de type "Tâches", il est possible de définir un ordre de réalisation des tâches (à l'aide des boutons fléchés situés à droite de la liste). 
...
<a name="comment_creer_une_liaison_entre_les_taches_ELTPARAGRAPHE000254"></a>Pour réaliser une liaison entre plusieurs tâches : 
...
6. Dans l'écran affiché, définissez : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Tache2%20-%20HC%20N%B0001.gif)
...
<a name="coefficient_multiplicatif_ELTTEXTE000506"></a>
...
## Imprimer les tâches
<a name="imprimer_les_taches_ELTTEXTE000530"></a>
Le Centre de Gestion de Projets propose différentes méthodes pour imprimer les tâches ou la liste des tâches. Vous pouvez :

- Imprimer directement la tâche, depuis l'écran de modification de la tâche (bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Imprimer.gif)).
