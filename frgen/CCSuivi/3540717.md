...
3. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeAjouterPropriete.gif) et sélectionnez "Nouvelle liste d'exigences". 

4. Dans la fenêtre qui s'affiche, vous pouvez saisir les caractéristiques de la liste dans l'onglet "Général" :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Exigence_Creation%20-%20HC%20N%B0002.gif)
...
3. Dans le ruban de l'onglet, cliquez sur "Nouvelle exigence" et sélectionnez le mode de création de l'exigence : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Creation_Exigence_simple26%20-%20HC%20N%B0001.gif)
...
### Création rapide
<a name="creation_rapide_ELTPARAGRAPHE000114"></a>Si vous choisissez "Création rapide", une fenêtre simplifiée de création d'exigence est affichée : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Creation_Exigence_simple26%20-%20HC%20N%B0002.gif&type=thumb)
...
Pour associer les tâches correspondantes aux intervenants, il suffit de saisir les intervenants voulus dans la zone "Intervenants". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Creation_Exigence_simple26%20-%20HC%20N%B0003.gif&type=thumb)
...
1. Dans la fenêtre de description de l'exigence, saisissez les caractéristiques de l'exigence dans l'onglet "Contenu" :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Exigence_Creation_Simple%20-%20HC%20N%B0001.gif&type=thumb)


	- Le titre de l'exigence. Ce nom doit résumer en quelques mots le contenu de l'exigence.

- La ou les cibles de l'exigence. Une exigence peut être spécifique à une plateforme (Windows, Linux, Android, etc.), à un client, etc. Le lien "Cliquez ici pour sélectionner les cibles à associer" permet de sélectionner une cible parmi les cibles proposées par défaut ou encore de créer et gérer vos propres cibles. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Exigence_Creation_Simple%20-%20HC%20N%B0003.gif)
...
- directement depuis la fenêtre de gestion des exigences : dans le volet "Exigences", dans le groupe "Gestion", cliquez "Listes d'exigences". Dans la fenêtre qui s'affiche, cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeAjouterPropriete.gif), option "Nouvelle exigence".
