...
3. Déroulez ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) puis sélectionnez "Intervenants".
...
La création et la gestion des exigences est réalisée depuis le Centre de Gestion de Projets. Pour plus de détails, consultez [Création des exigences](../CCSuivi/3540717.md).
...
<a name="associer_des_intervenants_projet_developpement_ELTPARAGRAPHE000153"></a>L'association des intervenants présents dans la base de données des Centres de Contrôle à un projet de développement peut être réalisée grâce au Centre de Gestion de Projets.

1. Lancez le Centre de Gestion de Projets depuis WINDEV, WEBDEV ou WINDEV Mobile : sous le volet "Outils", dans le groupe "Centres de Contrôle", cliquez sur "Gestion de Projets".

2. Recherchez votre projet de développement : déroulez ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) puis sélectionnez "Projets". Vous pouvez saisir le nom du projet à rechercher et cliquer sur le bouton loupe.
...
<a name="suivi_projet_par_centre_gestion_projets_ELTPARAGRAPHE000246"></a>L'onglet de type "Exigences" permet à un responsable d'avoir une vision globale de la situation d'une exigence ou d'un groupe d'exigences. 
