...
2. [Paramétrer la gestion des projets dans le Centre de Gestion de Projets](#NOTE3).

3. [Ajouter le composant Feedback dans votre projet (par l'intermédiaire du menu automatique '?')](#NOTE4).

4. [Paramétrer la gestion des spools dans le Centre de Gestion de Projets](#NOTE5).
...
<a name="etape_2_parametrer_gestion_des_projets_dans_centre_gestion_projets_ELTTEXTE000437"></a>
...
Pour plus de détails, consultez [Création d'un projet dans le Centre de Gestion de Projets](../CCSuivi/3540702.md).
...
<a name="etape_4_parametrer_gestion_des_spools_dans_centre_gestion_projets_ELTTEXTE000491"></a>
...
**Astuce** : Il est possible d'automatiser l'import des retours client afin de réaliser cette manipulation automatiquement tous les jours, toutes les semaines, tous les mois, ... Cette option est paramétrable dans les options du Centre de Gestion de Projets : déroulez ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) puis sélectionnez "Options". Cliquez sur "Options personnelles" et configurez les retours client.
...
2. Déroulez ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) puis sélectionnez "Importer les retours client".
...
[Base de données des Centres de Contrôle](../CCSuivi/3540720.md)

[Composant Feedback](../CCSuivi/2014013.md)
