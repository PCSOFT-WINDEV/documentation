...
- Directement depuis la fenêtre principale de WDSQL.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDSQL%20-%20HC%20N%B0007.gif&type=thumb)
...
- Enregistrées (option "Fichier .. Enregistrer une requête" ou raccourci F4 ou icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDSQL%20-%20HC%20N%B0006%201.gif)). Le fichier créé est de type ".SQL".

- [Exécutées](../WDSQL/3521014.md).

- Imprimées (cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDSQL%20-%20HC%20N%B0006%202.gif)).
...
1. Sélectionnez l'option "Fichier .. Créer une requête" (ou cliquez sur l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDSQL%20-%20HC%20N%B0006%205.gif)).
...
5. Triez si nécessaire les enregistrements selon une ou plusieurs rubriques :
	...
	- ***Dans l'ordre croissant*** : cliquez dans la colonne "Tri" correspondant à la ou les rubriques de tri. L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TriCroissant.gif) apparaît.

	- ***Dans l'ordre décroissant*** : cliquez dans la colonne "Tri" correspondant à la ou les rubriques de tri. L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TriDecroissant.gif) apparaît.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDSQL%20-%20HC%20N%B0005.gif&type=thumb)
