...
|   |
| --- |
| **Remarque**: Cette page décrit le format des fichiers texte manipulés par [WDMSG](../WDMsg/3518040.md).<br>**A partir de la version 15**, il est également possible de gérer des tables HFSQL (notamment pour permettre la gestion de tables de messages plus volumineuses).<br>**A partir de la version 19**, il est possible de gérer des fichiers WDMSG (notamment pour permettre la gestion des Zones de Texte Riche). <br><br>Le fichier d'extraction au format HFSQL ou MDMSG ne peut être manipulé qu'en utilisant l'outil [WDTRAD](../WDTRAD/3518010.md) livré avec WDMSG. |
...
<a name="exemple_structure_fichier_cree_par_wdmsg_ELTTEXTE000149"></a>
...
<a name="texte_constitue_plusieurs_lignes_ELTTEXTE000173"></a>
...
## Format RTF
<a name="format_rtf_ELTTEXTE000197"></a>
