...
Le fichier de comparaison est créé dans la langue de référence. Ce fichier de comparaison a le même format que la table d'extraction (fichier WDMSG, table HFSQL ou fichier texte). Pour plus de détails sur le format du fichier texte de comparaison, consultez le [format des fichiers texte des messages](../WDMsg/3518030.md)

Si ce fichier est au format texte, il peut être manipulé par [WDTRAD](../WDTRAD/3518010.md) ou un autre logiciel de traduction comme un fichier d'extraction.
Si ce fichier est au format HFSQL ou au format WDMSG, il peut uniquement être manipulé par [WDTRAD](../WDTRAD/3518010.md). 
...
### Comparer les messages d'un projet
<a name="comparer_les_messages_projet_ELTPARAGRAPHE000043"></a>
...
3. Choisissez la langue de référence. Les différents messages seront affichés dans cette langue de référence. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0007.gif&type=thumb)
Remarque: Le nom des langues personnalisées est également proposé. 

4. Passez à l'étape suivante de l'assistant.

5. Choisissez la langue à comparer. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0008.gif&type=thumb)
Remarque: Le nom des langues personnalisées est également proposé.
...
7. Sélectionnez les différents éléments (fenêtres, pages, états, etc.) dont les messages (libellé, message de code, etc.) doivent être comparés. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0009.gif&type=thumb)


8. Passez à l'étape suivante.

9. Choisissez le type de fichier à générer: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0003.gif&type=thumb)
...
11. Sélectionnez les différents paramètres du fichier de comparaison (ces paramètres sont détaillés ci-dessous). Ces paramètres sont les mêmes que lors d'une extraction simple. Votre fichier pourra être réintégré après correction.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0010.gif&type=thumb)


12. Passez à l'étape suivante.

13. Validez. Le fichier de comparaison est créé dans le répertoire choisi (par défaut, celui du projet). Ce fichier peut être traduit par un logiciel de traduction spécifique (format texte uniquement) ou à l'aide de [WDTRAD](../WDTRAD/3518010.md), outil d'aide à la saisie des traductions, livré avec WDMSG.
...
- Dans le cas d'une comparaison sous forme de tables au format HFSQL, 3 tables composent la table de comparaison:
...
<a name="parametres_comparaison_ELTPARAGRAPHE000116"></a>
...
<a name="parametre_comparaison_pour_logiciel_traduction_ELTPARAGRAPHE000130"></a>

Si vous utilisez [WDTRAD](../WDTRAD/3518010.md) pour traduire les messages de votre projet, les paramètres suivants ne sont pas nécessaires.
...
[Utilisation de WDMSG](../WDMsg/3518039.md)

[Extraire les messages d'un projet](../WDMsg/3518036.md)

[Extraire les messages ajoutés ou modifiés depuis la dernière extraction](../WDMsg/3518033.md)

[Format du fichier texte des messages](../WDMsg/3518030.md)

[Intégrer les messages dans un projet](../WDMsg/3518042.md)

[Comparer des champs](../WDMsg/9000175.md)
