...
### Extraire les messages ajoutés ou modifiés depuis la dernière extraction
<a name="extraire_les_messages_ajoutes_modifies_depuis_derniere_extraction_ELTPARAGRAPHE000024"></a>Pour extraire les messages ajoutés ou modifiés depuis la dernière extraction :
...
3. Sélectionnez les langues des messages à extraire. Ces langues correspondent aux langues déjà disponibles dans le projet, à traduire vers d'autres langues.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0011.gif&type=thumb)
...
7. Sélectionnez les différents éléments (fenêtres, pages, états, etc.) dont les messages (libellé, message de code, etc.) doivent être extraits.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0012.gif&type=thumb)
...
11. Sélectionnez les paramètres du fichier résultat, créé par l'extraction (voir [Détail des paramètres](#NOTE2_2)).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0013.gif&type=thumb)


12. Passez à l'étape suivante.

13. Sélectionnez l'option "Extraire uniquement les messages modifiés ou ajoutés".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Assistant%20WDMSG%20-%20HC%20N%B0014.gif&type=thumb)
...
<a name="parametres_extraction_ELTPARAGRAPHE000110"></a>Les paramètres d'extraction communs à tous les types de fichiers d'extraction sont les suivants :
...
<a name="parametre_extraction_pour_logiciel_traduction_ELTPARAGRAPHE000124"></a>Si vous utilisez [WDTRAD](../WDTRAD/3518010.md) pour traduire les messages de votre projet, les paramètres suivants ne sont pas nécessaires.
...
<a name="format_fichier_texte_des_messages_ELTPARAGRAPHE000151"></a>Le fichier texte d'extraction créé par WDMSG utilise un format spécifique. Pour plus de détails, consultez le [format des fichiers texte des messages](../WDMsg/3518030.md). 
