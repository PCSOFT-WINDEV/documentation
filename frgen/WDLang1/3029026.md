...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003029026&name=dsauveimagebmp_fonction">Voir des exemples supplémentaires</a>
...
<a name="image_presente_dans_champ_web_camera_ELTPARAGRAPHE000298"></a>Seule l'image affichée au moment de l'exécution de la fonction **dSauveImageBMP** est sauvegardée. Pour sauvegarder cette image, il est également possible d'utiliser :
...
<a name="dessin_code_navigateur_ELTPARAGRAPHE000331"></a>Il est possible d'affecter directement l'image sauvegardée en mémoire à un champ Image. Selon le navigateur utilisé, le résultat peut ne pas être celui attendu. 
...
[&lt;Variable Image&gt;.SauveBMP (Fonction)](../WDLang1/1000024366.md)
