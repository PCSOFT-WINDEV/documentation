...
- les tables spécifiques à l'utilisateur en cours (tables HFSQL .fic, .ndx, .mmo).
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Ce répertoire correspond au répertoire "/Library/" de l'application. Pour plus de détails sur ce répertoire, consultez la documentation du développement iOS Apple.  
