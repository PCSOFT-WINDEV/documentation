...
2. Dans la fenêtre qui s'ouvre, cochez l'option "Activer l'animation" et sélectionnez les paramètres de l'animation : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Anim_Fenetre2.gif)
...
4. Dans la fenêtre qui s'ouvre, cochez l'option "Activer l'animation" et sélectionnez les paramètres de l'animation : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Anim_Fenetre2.gif)
