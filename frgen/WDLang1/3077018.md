...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) En Java, les sémaphores, sections critiques et signaux sont uniques pour l'application qui les a créés. Ils ne peuvent pas être partagés entre plusieurs applications.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=SIGNAUX.gif)
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Méthode 1 : Utilisation des types SignalAutomatique et SignalManuel.**
...
3. Synchronisation des threads : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) grâce aux fonctions [SignalOuvre](../WDLang1/1000021271.md) et [SignalFerme](../WDLang1/1000021272.md).
