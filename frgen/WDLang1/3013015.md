...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003013015&name=compile_fonction">Voir des exemples supplémentaires</a>
<a name="Exemple1"></a>
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Ce paramètre n'est pas disponible. Cette fonction ne retourne pas de résultat.
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Code source en PHP de la procédure à compiler dynamiquement. Si ce code contient des guillemets, il est nécessaire de les doubler.

**`<Paramètres> : (Variable optionnelle de type CodeWLangageCompilation)`**

![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Nom de la variable de type [CodeWLangageCompilation](../WDLang1/1410090373.md) permettant de définir les paramètres de compilation (fonctions WLangage autorisées, interdites, etc.). 
Si ce paramètre n'est pas spécifié, toutes les fonctions WLangage sont autorisées. 


<a name="SYNTAXE2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 
...
<a name="utiliser_procedure_dynamique_ELTPARAGRAPHE000220"></a>
...
### Code dynamique
<a name="code_dynamique_ELTPARAGRAPHE000265"></a>
...
<a name="rubriques_dans_les_fonctions_hfsql_ELTPARAGRAPHE000315"></a>Si le code source utilisé pour la compilation dynamique exécute une fonction HFSQL nécessitant le nom d'une rubrique en paramètre, ce nom doit être donné sous la forme d'une chaîne de caractères entre guillemets. Par exemple, le code à utiliser pour la fonction [HLitRecherchePremier](../WDLang4/3044036.md) est le suivant :
...
[Procédure (Type de variable)](../WDLang1/1000018907.md)
