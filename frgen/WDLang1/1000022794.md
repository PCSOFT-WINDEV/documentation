...
<a name="proprietes_specifiques_description_des_variables_type_docnumerotation_ELTPARAGRAPHE000028"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une description de numérotation :
...
<a name="ajouter_une_description_numerotation_document_ELTPARAGRAPHE000082"></a>Pour ajouter une description de numérotation à un document, il est possible d'utiliser la fonction [Ajoute](../WDLang1/1000017348.md) via la syntaxe suivante : 
