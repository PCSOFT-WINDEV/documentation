...
Affiche un message dans une boîte de dialogue standard proposant les réponses "OK" et "Annuler" et renvoie la réponse de l'utilisateur.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fonctions_dialogue%20-%20HC%20N%B0006.gif)
...
- **Cette boîte de dialogue est bloquante**. Pour continuer l'exécution de l'application, l'utilisateur doit valider un des boutons. 
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Pour ne pas bloquer l'application, utilisez la fonction [OKAnnulerAsynchrone](../WDLang1/1000025308.md).
...
<a name="affichage_boite_dialogue_ELTPARAGRAPHE000167"></a>
...
<a name="saut_ligne_dans_boite_dialogue_ELTPARAGRAPHE000186"></a>La chaîne prédéfinie RC (Retour Chariot) peut être utilisée pour forcer le passage à la ligne suivante. Par exemple:
...
### Divers
<a name="divers_ELTPARAGRAPHE000204"></a>
...
### Pilotage
<a name="pilotage_ELTPARAGRAPHE000247"></a>

Il est possible de piloter un message OkAnnuler à l'aide de la fonction [PiloteOkAnnuler](../WDLang1/1000009007.md).
<a name="NOTE0_6"></a>
...
<a name="application_arriereplan_specificite_partir_android_10_ELTPARAGRAPHE000452"></a>A partir de Android 10, il n'est plus possible d'ouvrir une fenêtre lorsque l'application est en arrière-plan. 
