...
<a name="exemple_utilisation_ELTPARAGRAPHE000050"></a>

La fonction [FenEdDo](../WDLang1/1000021897.md) permet de créer des actions personnalisées (par exemple la création d'un champ) qui supportent le undo/redo.
...
### Erreur
<a name="erreur_ELTPARAGRAPHE000086"></a>

Si la fonction **FenEdDéclareUndo** est appelée en dehors d'une procédure ajoutée avec la fonction [FenEdDo](../WDLang1/1000021897.md), une erreur WLangage est affichée. 
