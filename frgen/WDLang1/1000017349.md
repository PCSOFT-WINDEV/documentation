...
- d'une propriété tableau d'un type de variable à deux dimensions (par exemple variable de type [xlsDocument](../WDLang5/1000017464.md)).




**Remarque** : Cette fonction est identique à [TableauAjouteLigne](../WDLang1/3075013.md).
...
<a name="ajout_une_ligne_dans_tableau_ELTPARAGRAPHE000101"></a>Lors de l'utilisation de la fonction **AjouteLigne** :
...
<a name="ajout_une_ligne_dans_une_propriete_tableau_type_avance_ELTPARAGRAPHE000130"></a>Lors de l'utilisation de la fonction **AjouteLigne** :
