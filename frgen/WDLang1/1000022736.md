...
L'imbrication des variables à partir d'une variable de type [Document](../WDLang1/1000022461.md) est la suivante : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TT_prog_Document.gif)
...
L'imbrication des variables à partir d'une variable de type [docFragment](../WDLang1/1000022482.md) est la suivante : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TT_prog_Fragment.gif)
...
[docTabulation (Type de variable)](../WDLang1/1000022573.md)

[docNiveauNumérotation (Type de variable)](../WDLang1/1000022799.md)
