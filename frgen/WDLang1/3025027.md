...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) La fonction **RepriseSaisie** peut être utilisée dans un événement navigateur (onchange, onclick, etc.), mais elle ne peut pas être utilisée dans une procédure locale ou une procédure globale navigateur.

Remarque : Cette fonction est identique à la fonction [DonneFocusEtRetourUtilisateur](../WDLang1/1410088107.md).  
<a name="Exemple1"></a>
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Nom du champ ou de la page qui doit prendre le focus (voir Remarques). Si ce paramètre n'est pas spécifié, le focus est donné au dernier champ en cours.

![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Nom du champ ou de la fenêtre qui doit prendre le focus (voir Remarques). Si ce paramètre n'est pas spécifié, le focus est donné au champ en cours.
...
### Prise de focus
<a name="prise_focus_ELTPARAGRAPHE000075"></a>La possession du "focus" est matérialisée de différentes manières :
...
<a name="fonctions_ecranpremier_donnefocus_docparampagetitleshort_ELTPARAGRAPHE000087"></a>Ces fonctions ont un comportement très différent :
...
### Erreur
<a name="erreur_ELTPARAGRAPHE000111"></a>Une erreur du WLangage apparaît si le &lt;Elément à manipuler&gt; ne correspond pas à un champ existant dans la fenêtre ou la page en cours.
...
<a name="fonction_docparampagetitleshort_sur_une_fenetre_ELTPARAGRAPHE000121"></a>Si le paramètre &lt;Elément à manipuler&gt; correspond à un nom de fenêtre, la fenêtre est activée. Le champ prenant le focus dans cette fenêtre correspondra :
...
<a name="fonction_docparampagetitleshort_sur_une_colonne_champ_table_ELTPARAGRAPHE000136"></a>La fonction **RepriseSaisie** donne le focus à la colonne spécifiée. Si le champ Table n'est pas en cours de saisie, le champ Table passe en saisie.
<a name="NOTE0_6"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 

### Fonction RepriseSaisie sur le champ en cours
<a name="fonction_docparampagetitleshort_sur_champ_cours_ELTPARAGRAPHE000151"></a>La fonction **RepriseSaisie** utilisée sans paramètre permet de donner le focus au champ en cours. Cette fonction, utilisée par exemple dans le code de sortie d'un champ de saisie, permet de forcer la saisie dans le champ en cours si les informations saisies ne correspondent pas aux informations attendues.
<a name="NOTE0_7"></a>
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) 

### Fonction RepriseSaisie sur le dernier champ en cours
<a name="fonction_docparampagetitleshort_sur_dernier_champ_cours_ELTPARAGRAPHE000166"></a>La fonction **RepriseSaisie** utilisée sans paramètre permet de donner le focus au dernier champ en cours. Cette fonction, utilisée par exemple dans le code de sortie d'un champ de saisie, permet de forcer la saisie dans le champ en cours si les informations saisies ne correspondent pas aux informations attendues.
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le code WLangage qui suit l'appel à la fonction **RepriseSaisie** n'est pas exécuté. L'exécution des traitements reprend :
...
<a name="fonction_docparampagetitleshort_fin_ELTPARAGRAPHE000313"></a>Après un appel à la fonction **RepriseSaisie**, le code suivant [l'instruction "FIN:"](../Motscles/1510014.md) n'est pas exécuté. La fonction **RepriseSaisie** peut être remplacée par l'appel à la fonction [EcranPremier](../WDLang1/3025039.md) suivie de RETOUR ou RENVOYER.
...
[DonneFocus (Fonction)](../WDLang1/3025001.md)

[Comment donner le focus à un champ d'une fenêtre ?](../WDLang1/20080.md)

[Comment donner le focus à une colonne d'un champ Table ?](../WDLang1/20018.md)
