...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Cette fonction est disponible uniquement pour simplifier la Webisation de projets WINDEV.  
<a name="Exemple1"></a>
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Ce paramètre correspond toujours au paramètre &lt;Valeur&gt;.
...
- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Sous l'éditeur, les tailles et les positions des champs des fenêtres Android ou iPhone correspondent toujours à un écran en 160 dpi (dot per inch).

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Lors de l'exécution de l'application, ces tailles et ces positions sont automatiquement converties en fonction du dpi natif de l'écran de l'appareil hôte.  Cela permet d'avoir un rendu WYSIWYG quel que soit le dpi de l'appareil.
