...
**Remarque** : Cette fonction est identique à [InsèreLigne](../WDLang1/1000017352.md).
...
Si &lt;Indice d'insertion&gt; est égal au nombre de lignes du tableau +1, la ligne est ajoutée à la fin du tableau (équivalent à la fonction [TableauAjouteLigne](../WDLang1/3075013.md)). 
...
<a name="insertion_une_ligne_ELTPARAGRAPHE000115"></a>Lors de l'utilisation de la fonction **TableauInsèreLigne** :
...
<a name="insertion_une_ligne_dans_une_propriete_tableau_type_avance_ELTPARAGRAPHE000138"></a>Lors de l'utilisation de la fonction **TableauInsèreLigne** :
