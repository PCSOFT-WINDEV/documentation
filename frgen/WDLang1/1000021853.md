...
- **Personnaliser l'interface** (option du menu contextuel de la fenêtre) : Permet à l'utilisateur final de personnaliser l'interface de la fenêtre (voir ci-dessous). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMH_Modifiable_1%20-%20HC%20N%B0001.gif)


- **Notes repositionnables** (option du menu contextuel de la fenêtre) : Permet à l'utilisateur final d'ajouter des notes repositionnables dans la fenêtre. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMH_Modifiable_1%20-%20HC%20N%B0002.gif)
...
- Lors du test d'une fenêtre ou du projet (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ico_Go_Fenetre_WD_bl.gif) et ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_GO_Projet_WD.gif)), les options de modification d'interface sont également disponibles. Si ces options sont utilisées, en fin de test, WINDEV propose automatiquement d'intégrer les modifications effectuées dans la fenêtre en cours. Pour plus de détails, consultez [Utilisation de la modification d'IHM lors d'un test de projet ou de fenêtre](../WDLang1/1000021927.md). 
...
- au niveau du projet. Les options seront prises en compte pour toutes les fenêtres du projet. 
	...
	2. Dans l'onglet "Avancé", cochez l'option "Modification de l'UI par l'utilisateur final". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMH_Modifiable_2%20-%20HC%20N%B0001.gif&type=thumb)
...
- au niveau de chaque fenêtre. Les options seront prises en compte uniquement pour la fenêtre sélectionnée. 
	...
	2. Dans l'onglet "Détail", cochez l'option "Modification de l'UI par l'utilisateur final". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMH_Modifiable_2%20-%20HC%20N%B0002.gif)
...
### Options disponibles
<a name="options_disponibles_ELTPARAGRAPHE000165"></a>Les options disponibles pour la modification de l'UI par l'utilisateur final sont les suivantes : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IMH_Modifiable_2%20-%20HC%20N%B0003.gif)
...
[Utilisation de la modification d'UI lors d'un test de projet ou de fenêtre](../WDLang1/1000021927.md)

[Fonctions de manipulation de l'UI par l'utilisateur final](../WDLang1/1000021854.md)

[Bulle d'aide des champs (FAA)](../WDLang1/1000021821.md)
