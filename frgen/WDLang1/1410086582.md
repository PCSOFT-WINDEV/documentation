...
2. Déployer l'application: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Créer le programme d'installation de l'application](#NOTE3_1).
...
<a name="activation_telemetrie_dans_description_projet_ELTPARAGRAPHE000067"></a>
...
3. Cochez l'option "Activez la télémétrie pour le projet" et renseignez les différents paramètres demandés: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=T%E9l%E9m%E9trie_Projet%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="activation_telemetrie_dans_description_une_configuration_ELTPARAGRAPHE000116"></a>
...
3. Différentes options sont disponibles: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=telemetrie%20-%20Options%20-%20HC%20N%B0001.gif&type=thumb)
...
Remarque: Si vous sélectionnez l'option "Utiliser des paramètres de télémétrie spécifiques", il est nécessaire de définir tous les paramètres de la télémétrie.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=telemetrie%20-%20Options%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="activation_telemetrie_lors_creation_executable_ELTPARAGRAPHE000161"></a>
...
4. Plusieurs options sont disponibles: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=telemetrie%20-%20Exe%20-%20HC%20N%B0004.gif)


	- **Utiliser les paramètres de télémétrie du projet**: Cette option permet d'utiliser les paramètres de télémétrie spécifiés dans la description du projet. Si la télémétrie n'est pas activée dans le projet, il n'est pas possible d'utiliser cette option. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=telemetrie%20-%20Exe%20-%20HC%20N%B0001.gif)
...
<a name="installation_une_application_gerant_telemetrie_ELTPARAGRAPHE000219"></a>
...
3. Dans la partie gauche de l'assistant, sélectionnez "Thème de l'installeur". 

4. Suivez les différentes étapes jusqu'à l'étape "Activation de la télémétrie". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Tel%E9m%E9trie%20-%20Installation%20-%20HC%20N%B0001.gif&type=thumb)
...
### Installation d'une application gérant la télémétrie
<a name="installation_une_application_gerant_telemetrie_ELTPARAGRAPHE000281"></a>
