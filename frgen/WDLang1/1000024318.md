...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Tri d'un tableau d'enregistrements selon 1 ou plusieurs rubriques.
...
- Nom de la variable de type Tableau associatif à manipuler.
	![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Les tableaux associatifs ne peuvent être être triés dans cette version.
...
|   |   |
| --- | --- |
| *tccOrdreLexicographique* | Tableau trié selon l'ordre linguistique.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
| *tccRespecteNumérique* | Tableau trié en respectant l'ordre des valeurs numériques.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
| *tccSansAccent* | Tableau trié sans tenir compte des accents.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
| *tccSansPonctuationNiEspace* | Tableau trié sans tenir compte des espaces et des ponctuations.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Les constantes permettant de spécifier les options de tri ne sont pas disponibles.
...
|   |   |
| --- | --- |
| *tccOrdreLexicographique* | Tableau trié selon l'ordre linguistique.<br>Cette option s'applique à toutes les colonnes sur lesquelles le tri est effectué.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
| *tccRespecteNumérique* | Tableau trié en respectant l'ordre des valeurs numériques.<br>Cette option s'applique à toutes les colonnes sur lesquelles le tri est effectué.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
| *tccSansAccent* | Tableau trié sans tenir compte des accents.<br>Cette option s'applique à toutes les colonnes sur lesquelles le tri est effectué.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
- Nom de la variable de type Tableau associatif à manipuler. Ce tableau peut être : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) un tableau associatif d'enregistrements.
...
|   |   |
| --- | --- |
| *tccOrdreLexicographique* | Tableau trié selon l'ordre linguistique.<br>Cette option s'applique à tous les membres sur lesquels le tri est effectué.<br>Cette option est utile uniquement sur les membres de type chaîne de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
| *tccRespecteNumérique* | Tableau trié en respectant l'ordre des valeurs numériques.<br>Cette option s'applique à tous les membres sur lesquels le tri est effectué.<br>Cette option est utile uniquement sur les membres de type chaîne de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
| *tccSansAccent* | Tableau trié sans tenir compte des accents.<br>Cette option s'applique à tous les membres sur lesquels le tri est effectué.<br>Cette option est utile uniquement sur les membres de type chaîne de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
| *tccSansPonctuationNiEspace* | Tableau trié sans tenir compte des espaces et des ponctuations.<br>Cette option s'applique à tous les membres sur lesquels le tri est effectué.<br>Cette option est utile uniquement sur les membres de type chaîne de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Tri d'un tableau d'enregistrements** : Nom des rubriques utilisées comme critère de tri. 
...
### Divers
<a name="divers_ELTPARAGRAPHE000775"></a>
...
- Pour ajouter un élément dans un tableau trié, utilisez la fonction [&lt;Tableau&gt;.AjouteTrié](../WDLang1/1000024301.md).
...
- Cette fonction est disponible sur les tableaux associatifs.
	![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette fonctionnalité n'est pas disponible.
...
<a name="exemples_procedure_tri_personnalisee_ELTPARAGRAPHE000801"></a>Exemple de procédure pour comparer 2 entiers :
...
[Trie (Fonction)](../WDLang1/1000017364.md)
