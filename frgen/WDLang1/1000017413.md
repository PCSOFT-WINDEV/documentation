...
<a name="conditions_utilisation_ELTPARAGRAPHE000082"></a>
...
- La fonction **TableRestaurePositionEtSélection** ne fonctionne pas sur les champs Table liée aux données à rebond (c'est-à-dire les champs Table liée aux données sans ascenseur proportionnel).
...
Les fonctions [TableSauvePositionEtSélection](../WDLang1/1000017412.md) et **TableRestaurePositionEtSélection** sont équivalentes à l'option "Mémoriser la position et la sélection" disponible dans l'onglet "Détail" de la description du champ.
...
[TableSauvePositionEtSélection (Fonction)](../WDLang1/1000017412.md)

[Le champ Table](../WDLang1/1013224.md)

[Le champ Table hiérarchique](../WDLang1/1015001.md)

[&lt;Table&gt;.RestaurePositionEtSélection (Fonction)](../WDLang1/1000024280.md)
