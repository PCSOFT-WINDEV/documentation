...
Procédure (également appelée "Callback") appelée par la fonction [fMemOuvre](../WDLang1/1000018917.md) si la zone mémoire est modifiée par une autre application WLangage. Cette procédure peut être une procédure locale, globale ou interne.
<a name="Exemple1"></a>
