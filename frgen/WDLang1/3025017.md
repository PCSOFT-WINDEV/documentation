...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003025017&name=champclone_fonction">Voir des exemples supplémentaires</a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Nom de la variable de type [Champ](../WDLang1/1000020967.md) à associer au champ cloné. 
...
<a name="SYNTAXE2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 
...
<a name="caracteristiques_champ_cree_ELTPARAGRAPHE000164"></a>Le champ créé partage tous les paramètres initiaux du champ source, en particulier :
...
- les paramètres modifiés après sa création (valeur, couleur, ...),
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) La couleur du champ cloné est la couleur actuelle du champ et non celle de la création du champ.
...
### Evénements exécutés
<a name="evenements_executes_ELTPARAGRAPHE000196"></a>L'événement "Initialisation" associé au champ est exécuté.
...
### Conseil
<a name="conseil_ELTPARAGRAPHE000208"></a>Il est conseillé d'utiliser cette fonction dans l'événement "Déclarations globales" de la fenêtre ou de la page ou dans l'événement "Ouverture" associé à l'état. Cette fonction ne doit pas être utilisée dans l'événement "Initialisation" du champ.
<a name="NOTE0_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 

### Clonage d'une colonne dans un champ Table
<a name="clonage_une_colonne_dans_champ_table_ELTPARAGRAPHE000217"></a>Dans une fenêtre, lors de l'utilisation de la fonction **ChampClone** sur une colonne du champ Table, le champ Table manipulé est entièrement vidé lors de la création de la nouvelle colonne.
<a name="NOTE0_5"></a>
...
[TableConstruitLiaisonDonnées (Fonction)](../WDLang1/3074002.md)

[MenuClone (Fonction)](../WDLang1/1000017257.md)
