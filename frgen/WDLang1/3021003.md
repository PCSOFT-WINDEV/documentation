...
Vos applications utilisent de nombreuses boîtes de dialogue systèmes? Vous utilisez un thème spécifique dans votre projet? Pourquoi ne pas personnaliser ces fenêtres et leur donner le "look" de votre application?

![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Vos utilisateurs sont habitués aux FAA sur les fenêtres? Pourquoi ne pas les proposer automatiquement sur les boîtes de dialogue? 

WINDEV et WINDEV Mobile permettent d'utiliser:

- Les fenêtres système. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Les fenêtres système avec les FAA. 
...
- Par défaut, dans un nouveau projet (version 28 et supérieure): 
	...
	- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) les boîtes de dialogue affichées sont des boîtes de dialogue système.

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) les boîtes de dialogue affichées sont des boîtes de dialogue "avec FAA".
...
## Comment le faire?
<a name="comment_faire_ELTTEXTE000414"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Utiliser les fenêtres "système" avec FAA (Fonctionnalités Automatiques de vos applications)
<a name="utiliser_les_fenetres_systeme_avec_faa_fonctionnalites_automatiques_vos_applications_ELTPARAGRAPHE000099"></a>
...
Vos utilisateurs pourront utiliser les FAA sur ces fenêtres: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fonctions_dialogue%20-%20HC%20N%B0010.gif)
...
<a name="personnaliser_les_fenetres_information_systeme_ELTPARAGRAPHE000161"></a>
...
2. Validez. Un composant interne nommé "WDFAA" est automatiquement intégré dans votre projet (s'il n'existe pas déjà). Ce composant contient les fenêtres "WINDEVMESSAGEBOX" et "WINDEVDIALOGBOX". Le thème de votre projet est appliqué sur ces fenêtres.
...
2. validez. Un composant interne nommé "WMFAA" est automatiquement intégré dans votre projet (s'il n'existe pas déjà). Ce composant contient les fenêtres "WINDEVMOBILEDIALOGBOX" et "WINDEVMOBILEMESSAGEBOX". Le thème de votre projet est appliqué sur ces fenêtres.}
...
### Conseils
<a name="conseils_ELTPARAGRAPHE000303"></a>
...
<a name="boites_dialogues_multilingues_ELTTEXTE000450"></a>


### Obtenir des boîtes de dialogues multilingues
<a name="obtenir_des_boites_dialogues_multilingues_ELTPARAGRAPHE000315"></a>
