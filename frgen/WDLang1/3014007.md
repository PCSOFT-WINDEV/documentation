...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Fonctionnement spécifique : 
...
| --- | --- |
| *teAlt* | Touche Alt. |
| *teBoutonD* | Bouton droit de la souris.<br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
| *teBoutonG* | Bouton gauche de la souris.<br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Ce paramètre est ignoré. Le compte-rendu est toujours synchrone.
...
[Externe (Mot réservé)](../WDLang1/1511013.md)

[Fonctions diverses Windows](../WDLang1/3014011.md)

[ToucheRaccourci (Propriété)](../WDLang1/1000021105.md)
