...
<a name="orientation_appareil_definitions_ELTPARAGRAPHE000132"></a>Le changement d'orientation peut être rapporté dans les trois dimensions suivantes : 
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Acceleration_Origine.gif)
...
<a name="arret_detection_ELTPARAGRAPHE000153"></a>Il est conseillé de stopper la détection des changements d'orientation si elle n'est plus nécessaire afin d'économiser la batterie de l'appareil. Pour cela, le paramètre &lt;Procédure WLangage&gt; doit correspondre à chaîne vide (""). 
