...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=type_monetaire_euro%20-%20HC%20N%B0001.gif&type=thumb)


![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Seules la devise mémorisée et la devise de saisie sont disponibles dans cette version.
...
## Devise mémorisée
<a name="devise_memorisee_ELTTEXTE000380"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000054"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=type_monetaire_euro%20-%20HC%20N%B0002%201.gif)
...
<a name="parametrer_devise_memorisee_ELTPARAGRAPHE000077"></a>
...
<a name="devise_saisie_affichee_ELTTEXTE000410"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000100"></a>
...
<a name="configuration_avancee_ELTPARAGRAPHE000123"></a>
...
<a name="parametrer_devise_affichee_ELTPARAGRAPHE000133"></a>
...
## Bulle d'aide
<a name="bulle_aide_ELTTEXTE000446"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Présentation
<a name="presentation_ELTPARAGRAPHE000161"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=type_monetaire_euro%20-%20HC%20N%B0002%203.gif)


Exemple:
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Eurobulle.gif)

<a name="NOTE4_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Règles de conversion dans la bulle d'aide
<a name="regles_conversion_dans_bulle_aide_ELTPARAGRAPHE000176"></a>
...
<a name="parametrer_affichage_bulle_aide_ELTPARAGRAPHE000190"></a>
...
## Double affichage
<a name="double_affichage_ELTTEXTE000482"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Présentation
<a name="presentation_ELTPARAGRAPHE000210"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=type_monetaire_euro%20-%20HC%20N%B0002%204.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=EuroDoubleaffichage2.gif)
...
Dans cet exemple, les prix seront enregistrés dans la table HFSQL uniquement en Francs.
<a name="NOTE5_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Fonctionnement du double affichage pour un champ de saisie
<a name="fonctionnement_double_affichage_pour_champ_saisie_ELTPARAGRAPHE000240"></a>
...
- Lors de l'utilisation de la fonction [DonnéesVersFenêtre](../WDLang4/3044210.md) si le champ suiveur n'est pas relié à une rubrique HFSQL.




**Cas particulier**: La conversion n'est pas réalisée si le champ suiveur est relié à une rubrique d'une table HFSQL.
<a name="NOTE5_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Fonctionnement du double affichage pour une colonne de table
<a name="fonctionnement_double_affichage_pour_une_colonne_table_ELTPARAGRAPHE000258"></a>
...
Dans le cas d'un champ Table liée aux données, il est nécessaire d'initialiser la colonne permettant le double affichage dans le code d'affichage d'une ligne du champ Table liée aux données. Le code utilisé peut être par exemple:
...
- COL_PUHT: nom de la colonne liée à une rubrique d'une table HFSQL, affichant la valeur en Francs.
...
**Rappel**: Les fonctions de lecture de table ou d'affichage d'une table dans le champ Table n'ont aucune incidence sur une colonne calculée.
<a name="NOTE5_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Configuration avancée
<a name="configuration_avancee_ELTPARAGRAPHE000283"></a>
...
<a name="parametrer_double_affichage_ELTPARAGRAPHE000305"></a>

Le champ suiveur est sélectionné sous l'éditeur de fenêtres ou l'éditeur d'états dans les caractéristiques du champ. WINDEV propose automatiquement la liste des champs de type "Monétaire + Euro" présents dans la fenêtre ou l'état en cours.
...
[Gérer l'Euro](../WDLang1/3033002.md)
