...
***En anglais : &lt;Image variable&gt;.DrawPolyline***
...
Dessine une ligne composée de plusieurs segments dans une variable de type [Image](../WDLang1/1000019650.md).
...
### Coordonnées
<a name="coordonnees_ELTPARAGRAPHE000616"></a>Les coordonnées sont indiquées par rapport au coin haut gauche de l'image (coordonnées (0,0)).
