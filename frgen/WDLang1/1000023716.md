...
**Remarque**: Par défaut, les procédures WLangage ne sont pas autorisées dans les formules pour des raisons de sécurité. En effet, un utilisateur malveillant pourrait par exemple appeler une procédure d'initialisation qui remet à 0 toutes les tables.
<a name="Exemple1"></a>
...
[TableurAutoriseProcédure (Fonction)](../WDLang1/1000021473.md)
