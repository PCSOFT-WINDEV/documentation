...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) **Cas d'un parcours sur une table ou sur une requête**: Si cette fonction est utilisée, elle déclenchera une exception. 
