...
### Colonne de table
<a name="colonne_table_ELTPARAGRAPHE000155"></a>La fonction **RTFSélection** permet de modifier la sélection de la cellule en cours de saisie. Il n'est pas possible de modifier une autre cellule.
...
### Attribut rtfCouleur
<a name="attribut_rtfcouleur_ELTPARAGRAPHE000170"></a>L'attribut *rtfCouleur* peut renvoyer ou recevoir la valeur *CouleurDéfaut* : la couleur du texte dépend alors des paramètres de couleurs définis dans le panneau de configuration de Windows.
