...
### Variables locales
<a name="variables_locales_ELTPARAGRAPHE000045"></a>Les variables locales du traitement courant peuvent être utilisées directement dans l'expression.
<a name="NOTE0_2"></a>


### Compilation de l'expression
<a name="compilation_expression_ELTPARAGRAPHE000052"></a>L'expression est recompilée à chaque appel de la fonction **EvalueExpression**. 
...
<a name="utilisation_une_procedure_composant_externe_ELTPARAGRAPHE000070"></a>L'expression est recompilée à chaque appel de la fonction **EvalueExpression**. 
...
### Code dynamique
<a name="code_dynamique_ELTPARAGRAPHE000083"></a>Les **constantes ne peuvent pas être utilisées** dans le code dynamique (définies avec le mot-clé [CONSTANTE](../Motscles/1514012.md)).
