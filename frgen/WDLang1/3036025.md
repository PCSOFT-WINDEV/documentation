...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003036025&name=fecritligne_fonction">Voir des exemples supplémentaires</a>
...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000203"></a>La fonction **fEcritLigne** génère une erreur dans les cas suivants :
...
<a name="position_dans_fichier_ELTPARAGRAPHE000235"></a>A l'ouverture d'un fichier, la position en cours correspond :
...
<a name="gestion_ansi_unicode_ELTPARAGRAPHE000260"></a>La fonction **fEcritLigne** permet d'écrire : 
...
[&lt;Variable FichierDisque&gt;.EcritLigne (Fonction)](../WDLang1/1410089042.md)
