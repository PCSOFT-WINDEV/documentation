...
<a name="conditions_utilisation_ELTPARAGRAPHE000102"></a>
...
<a name="caracteristiques_des_elements_ligne_ELTPARAGRAPHE000129"></a>
...
<a name="position_ligne_ajoutee_ELTPARAGRAPHE000377"></a>
...
<a name="limites_nombre_maximum_lignes_affichees_ELTPARAGRAPHE000395"></a>
...
<a name="champ_tabletable_hierarchique_table_modifications_dans_table_liee_ELTPARAGRAPHE000162"></a>
...
- **Si la saisie en cascade n'est pas activée**, la table liée aux données liée au champ table liée aux données n'est pas modifiée. Pour écrire le contenu de la ligne ajoutée dans la table liée, il est nécessaire d'utiliser la fonction [TableEnregistre](../WDLang1/3074008.md) après la fonction **TableAjouteLigneAvecAnimation**.
...
<a name="champ_tabletable_hierarchique_fichier_ajout_plusieurs_lignes_ELTPARAGRAPHE000183"></a>

A chaque appel de la fonction **TableAjouteLigneAvecAnimation** dans un champ Table ou Table hiérarchique fichier, une ligne virtuelle est créée dans le champ. Les informations ne seront enregistrées dans la table liée que lors de l'appel de la fonction [TableEnregistre](../WDLang1/3074008.md).
...
<a name="ajout_dans_champ_table_liee_aux_donnees_trigger_ELTPARAGRAPHE000204"></a>

Il est possible de déclencher un trigger lors de l'ajout d'un enregistrement dans un champ Table liée aux données. Pour plus de détails, consultez la documentation de la fonction [HDécritTrigger](../WDLang4/3044074.md).
<a name="NOTE0_8"></a>


### Champ Table/Table hiérarchique en saisie
<a name="champ_tabletable_hierarchique_saisie_ELTPARAGRAPHE000216"></a>
...
### Ajout d'image
<a name="ajout_image_ELTPARAGRAPHE000233"></a>
