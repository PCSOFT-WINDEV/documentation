...
<a name="constantes_definissant_des_messages_ELTPARAGRAPHE000065"></a>Les constantes définissant les divers messages possibles sont définies dans le fichier "WINCONST.WL" disponible dans le répertoire de WINDEV (sous-répertoire Personal\\External). Pour utiliser ce fichier dans vos applications, utilisez le code suivant :
