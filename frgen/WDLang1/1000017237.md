...
Imprime directement le contenu du champ Table spécifié sans avoir réalisé au préalable un état sur le champ Table. Une FAA (Fonctionnalité Automatique de votre Application) permet également à l'utilisateur d'imprimer directement le contenu du champ Table (voir [Menu automatique des champs Table](../Editeurs/9500102.md)).
...
- Il est possible d'utiliser la fonction [iDestination](../WDLang5/3046074.md) pour paramétrer la destination de l'impression.
...
- <u><u><u><u>Vrai</u></u></u></u> si l'impression a été réalisée, 
...
<a name="caracteristiques_impression_ELTPARAGRAPHE000108"></a>
...
- Le nombre total de pages n'est pas calculé dans les cas suivants:
	...
	- si le calcul du nombre total de pages dépasse 4 secondes sur un champ table liée aux données basé sur une table HFSQL Client/Serveur.
...
- Les caractéristiques de l'impression proposée sont les suivantes:
	...
	- Pour que l'impression respecte les couleurs de fond utilisées pour les différentes cellules du champ Table, utilisez la fonction [FAAParamètre](../WDLang1/1000022108.md) avec la constante *faaImprimeEtatSurTable* de la manière suivante: 
...
[Fonctions d'impression](../WDLang1/3046065.md)

[Fonctions de gestion des champs Table](../WDLang1/3074009.md)

[&lt;Table&gt;.Imprime (Fonction)](../WDLang1/1000024256.md)
