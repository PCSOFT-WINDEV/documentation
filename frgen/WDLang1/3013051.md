...
- A l'inverse de la fonction **LigneCommande**, la fonction [dbgSortieStandard](../WDLang1/3014020.md) permet à l'exécutable de retourner une valeur à l'application qui l'a lancé (écriture dans STDOUT).
...
[PageParamètre (Fonction)](../WDLang1/3058026.md)
