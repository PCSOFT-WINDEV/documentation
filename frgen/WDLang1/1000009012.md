...
<a name="limitation_des_champs_manipules_ELTPARAGRAPHE000083"></a>La fonction **PiloteSaisie** n'est pas compatible avec les champs suivants :
...
<a name="envoi_une_serie_touches_ELTPARAGRAPHE000112"></a>Lorsqu'une série de touches est envoyée, et que le champ manipulé contient des appels à la fonction [Multitâche](../WDLang1/3015004.md) dans son code de modification, certaines touches peuvent ne pas être prises en compte.
...
### Caractères spéciaux
<a name="caracteres_speciaux_ELTPARAGRAPHE000135"></a>Pour utiliser des caractères spéciaux, des codes spécifiques sont nécessaires pour identifier :
...
[PiloteSouris (Fonction)](../WDLang1/1000009011.md)

[EnvoieTouche (Fonction)](../WDLang1/3014014.md)
