...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Utilisée dans un événement navigateur (d'un champ ou d'une page), renvoie la position horizontale (X) du curseur de la souris selon l'origine spécifiée.
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) La fonction **SourisPosX** retourne la dernière position connue du doigt sur l'écran de l'appareil.
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Il est conseillé d'utiliser cette fonction uniquement dans les événements WLangage associés aux champs survolés par la souris.
