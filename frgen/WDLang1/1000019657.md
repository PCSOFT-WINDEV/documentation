...
<a name="partager_code_entre_une_application_windev_mobile_une_application_windev_standard_site_webdev_ELTPARAGRAPHE000086"></a>Grâce à la fonction **EnModeWindowsMobile**, il est possible de partager du code entre une application WINDEV Mobile et une application WINDEV standard ou un site WEBDEV.
...
<a name="execution_des_traitements_contenant_des_erreurs_compilation_ELTPARAGRAPHE000240"></a>Par défaut, le mécanisme de sécurité du WLangage se déclenche uniquement si la ligne contenant l'erreur de compilation est exécutée.
