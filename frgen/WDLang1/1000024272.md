...
<a name="conditions_utilisation_ELTPARAGRAPHE000276"></a>
...
<a name="caracteristiques_des_elements_ligne_ELTPARAGRAPHE000304"></a>
...
<a name="position_ligne_inseree_ELTPARAGRAPHE000322"></a>
...
<a name="limites_nombre_maximum_lignes_affichees_ELTPARAGRAPHE000344"></a>
...
<a name="champ_tabletable_hierarchique_table_modifications_dans_table_liee_ELTPARAGRAPHE000356"></a>
...
- **Si la saisie en cascade n'est pas activée**, le contenu de la table lié au champ n'est pas modifié. Pour écrire le contenu de la ligne insérée dans la table liée, il est nécessaire d'utiliser la fonction [&lt;Table&gt;.Enregistre](../WDLang1/1000024249.md) après la fonction **&lt;Table&gt;.InsèreLigneAvecAnimation**. 
...
<a name="champ_tabletable_hierarchique_fichier_insertion_plusieurs_lignes_ELTPARAGRAPHE000380"></a>

A chaque appel de la fonction **&lt;Table&gt;.InsèreLigneAvecAnimation** dans un champ Table ou Table hiérarchique fichier, une ligne virtuelle est créée dans le champ. Les informations ne seront enregistrées dans la table que lors de l'appel de la fonction [&lt;Table&gt;.Enregistre](../WDLang1/1000024249.md).
...
<a name="champ_tabletable_hierarchique_saisie_ELTPARAGRAPHE000406"></a>
...
### Insertion d'image
<a name="insertion_image_ELTPARAGRAPHE000424"></a>
