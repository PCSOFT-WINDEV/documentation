...
| *crypteRapide*<br>(Valeur par défaut) | La priorité a été donnée à la rapidité du cryptage (algorithme sur 128 bits).<br><br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) L'algorithme utilisé sera de type Blowfish.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Cette constante n'est pas disponible.<br><br>![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) L'algorithme utilisé sera de type Blowfish à 16 rondes. |
