...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Charge en mémoire la librairie .so spécifiée.
<a name="Exemple1"></a>
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Nom de la librairie .so à charger.
