...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Dans cette version, il est possible uniquement de connaître les attributs d'un répertoire.
...
- Une ou plusieurs lettres correspondant aux attributs du répertoire ("AH" par exemple). 
	...
	- **S** : Répertoire système. Le répertoire est un répertoire système de Windows. 
			![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette valeur n'est pas gérée.
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) L'accès aux lecteurs réseaux dépend des droits définis pour l'utilisateur du serveur Web.
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Seul l'attribut "R" peut être modifié (lecture seule / lecture - écriture).
...
<a name="modifier_les_attributs_repertoire_syntaxe_2_ELTPARAGRAPHE000190"></a>Après modification, les attributs du répertoire correspondent uniquement aux attributs spécifiés avec la fonction **fRepAttribut**. Par exemple, si le paramètre &lt;Attributs du répertoire&gt; correspond à "AR", le répertoire spécifié deviendra un répertoire archive en lecture seule.
...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000206"></a>La fonction **fRepAttribut** génère une erreur dans les cas suivants :
...
<a name="versions_precedentes_ELTPARAGRAPHE000231"></a>Cette fonction remplace la fonction **fRepDroit**, conservée par compatibilité avec WINDEV 5.5.
