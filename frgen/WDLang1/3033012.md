...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Ce paramètre est de type réel.
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Ce paramètre n'est pas disponible. Il n'est pas possible de récupérer l'écart d'arrondi.
...
### Table des changes
<a name="table_des_changes_ELTPARAGRAPHE000075"></a>Une ***table des changes ***est conservée en mémoire. A chaque monnaie sont associés :
...
<a name="NOTE0_2"></a>
![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) 
...
[eInitDevise (Fonction)](../WDLang1/3033003.md)

[eVersDevise (Fonction)](../WDLang1/3033001.md)

[eVersEuro (Fonction)](../WDLang1/3033005.md)
