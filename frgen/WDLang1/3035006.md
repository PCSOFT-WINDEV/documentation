...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Remarques** :

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Il est également possible d'exécuter une commande en mode console. Pour plus de détails, consultez [Fonctions de gestion de l'exécution des commandes en mode console](../WDLang1/1410090746.md).
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette fonction ne renvoie pas de résultat.
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Nom complet de l'application à lancer (avec le nom de package) avec si nécessaire les paramètres à passer au programme. 
...
| *exeIconise* | Le programme lancé est inactif et s'exécute icônisé.<br><br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le programme lancé est toujours actif : il s'exécute en "prenant la main" sur le programme en cours. 
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Ce paramètre n'est pas disponible.


<a name="SYNTAXE2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Ce paramètre est ignoré. Le programme lancé est actif, il s'exécute en "prenant la main" sur le programme en cours. 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Si le programme lancé est réalisé avec WINDEV ou WINDEV Mobile, il sera possible de récupérer la ligne de commande avec la fonction [LigneCommande](../WDLang1/3013051.md).
