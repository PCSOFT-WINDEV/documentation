...
|   |   |
| --- | --- |
| *tccOrdreLexicographique* | Tableau trié selon l'ordre linguistique.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
| *tccRespecteNumérique* | Tableau trié en respectant l'ordre des valeurs numériques.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
| *tccSansAccent* | Tableau trié sans tenir compte des accents.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
| *tccSansPonctuationNiEspace* | Tableau trié sans tenir compte des espaces et des ponctuations.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Ces constantes ne sont pas disponibles.
