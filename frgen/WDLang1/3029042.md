...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Dans une fenêtre, cette séquence de caractères permet d'insérer une image : 

- dans un élément d'un champ Liste ou d'un champ Combo.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) dans la barre de titre et/ou de message d'une fenêtre. 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Cette séquence de caractères peut être : 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette séquence de caractères n'est pas interprétée par les champs en WEBDEV. Cette fonction peut être utilisée pour formater la chaîne renvoyée par un Webservice WEBDEV consommé par une application WINDEV ou WINDEV Mobile.
...
### Insertion d'images
<a name="insertion_images_ELTPARAGRAPHE000263"></a>
...
<a name="hauteur_image_champ_liste_champ_combo_ELTPARAGRAPHE000297"></a>La hauteur de l'image affichée dans un élément d'un champ Liste ou champ Combo est tronquée au nombre de pixels indiqué lors de la création du champ (onglet "Style" de la description du champ).
...
<a name="image_dans_titre_une_colonne_champ_table_ELTPARAGRAPHE000308"></a>La propriété [ImageTitre](../Proprietes/1000018306.md) permet d'inclure simplement une image dans le titre d'une colonne d'un champ Table.
...
[ChargeImage (Fonction)](../WDLang1/3029022.md)

[gCadrage (Fonction)](../WDLang1/3029046.md)
...
[ImageTitre (Propriété)](../WDLang1/1000018306.md)

[Fonctions de manipulation de chaînes graphiques](../WDLang1/3029028.md)

[ChargePlancheImage (Fonction)](../WDLang1/1000018826.md)

[gImageExiste (Fonction)](../WDLang1/1000021860.md)
