...
- Nom de la colonne. 
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Ce résultat peut être affecté directement à une variable de type [Champ](../WDLang1/1000020967.md).
...
<a name="conditions_utilisation_ELTPARAGRAPHE000254"></a>

La fonction **&lt;Table&gt;.EnumèreColonne** peut être utilisée indifféremment sur:

- un champ table liée aux données ou par programmation. 
...
<a name="les_differents_types_indices_colonne_ELTPARAGRAPHE000274"></a>
