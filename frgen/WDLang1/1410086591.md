...
## Créer une télémétrie personnalisée
<a name="creer_une_telemetrie_personnalisee_ELTTEXTE000315"></a>
...
- via le volet "Explorateur de projet" : 
	...
	6. Enregistrez la télémétrie personnalisée (Ctrl + S ou ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Enregistrer.gif) parmi les boutons d'accès rapide).
...
- via l'éditeur de télémétrie : 
	...
	5. Enregistrez la télémétrie personnalisée (Ctrl + S ou ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ICO_Enregistrer.gif) parmi les boutons d'accès rapide).
...
<a name="creer_les_capteurs_telemetrie_personnalisee_les_widgets_associes_ELTTEXTE000339"></a>


### Créer les capteurs de la télémétrie personnalisée
<a name="creer_les_capteurs_telemetrie_personnalisee_ELTPARAGRAPHE000078"></a>Pour créer un capteur dans une télémétrie personnalisée : 

1. Sous le volet "Télémétrie personnalisée", dans le groupe "Capteurs", cliquez sur "Capteur". 

2. L'écran de paramétrage du capteur apparaît. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=T%E9l%E9m%E9trie_perso%20-%20HC%20N%B0001.gif)
...
<a name="creer_les_widgets_associes_aux_capteurs_sans_categorie_ELTPARAGRAPHE000105"></a>Si vous avez créé un capteur sans catégorie, plusieurs types de Widgets peuvent être créés pour afficher les données de ce type de capteur : 

- **Widget de type Valeur** : 

	1. Sous le volet "Télémétrie personnalisée", dans le groupe "Widgets", cliquez sur "Valeurs". 

	2. L'écran de paramétrage du widget apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=T%E9l%E9m%E9trie_perso%20-%20HC%20N%B0002.gif&type=thumb)
...
- **Widget de type Graphe** : 
	...
	2. L'écran de paramétrage du widget apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=T%E9l%E9m%E9trie_perso%20-%20HC%20N%B0003.gif&type=thumb)
Cet écran permet de spécifier : 
...
<a name="creer_les_widgets_associes_aux_capteurs_avec_categorie_ELTPARAGRAPHE000154"></a>Si vous avez créé un capteur avec catégorie, plusieurs types de Widgets peuvent être créés pour afficher les données de ce type de capteur : 

- **Widget de type Table** : 

	1. Sous le volet "Télémétrie personnalisée", dans le groupe "Widgets avec catégorie", cliquez sur "Table". 

	2. L'écran de paramétrage du widget apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=T%E9l%E9m%E9trie_perso%20-%20HC%20N%B0004.gif&type=thumb)
Cet écran permet de spécifier : 
...
- **Widget de type Temporel** : 
	...
	2. L'écran de paramétrage du widget apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=T%E9l%E9m%E9trie_perso%20-%20HC%20N%B0005.gif)
Cet écran permet de spécifier : 
...
- **Widget de type Répartition** : 
	...
	2. L'écran de paramétrage du widget apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=T%E9l%E9m%E9trie_perso%20-%20HC%20N%B0006.gif&type=thumb)
Cet écran permet de spécifier : 
...
## Placer dans le code les appels nécessaires à la gestion des capteurs
<a name="placer_dans_code_les_appels_necessaires_gestion_des_capteurs_ELTTEXTE000375"></a>
...
<a name="deployer_telemetrie_personnalisee_ELTTEXTE000415"></a>
...
Pour déployer la télémétrie personnalisée, cliquez sur l'option "Déployer" présente dans le volet "Télémétrie personnalisée". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=T%E9l%E9m%E9trie_perso%20-%20HC%20N%B0007.gif)
...
[TélémétrieAjouteMesure (Fonction)](../WDLang1/1000022168.md)

[TélémétrieAjoutePassage (Fonction)](../WDLang1/1000022174.md)
