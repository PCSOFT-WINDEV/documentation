...
<a name="position_colonne_ajoutee_ELTPARAGRAPHE000085"></a>
...
<a name="limites_nombre_maximum_colonnes_affichees_ELTPARAGRAPHE000100"></a>
...
<a name="champ_table_liee_aux_donnees_modifications_dans_table_liee_ELTPARAGRAPHE000111"></a>
...
Si la saisie en cascade n'est pas activée, la table liée aux données liée au champ Table liée aux données n'est pas modifiée. Pour écrire le contenu de la colonne ajoutée dans la table liée, il est nécessaire d'utiliser la fonction [TableEnregistre](../WDLang1/3074008.md) après la fonction **TableAjouteColonne**.
...
<a name="champ_table_liee_aux_donnees_ajout_plusieurs_colonnes_ELTPARAGRAPHE000136"></a>

A chaque appel de la fonction **TableAjouteColonne** dans un champ Table liée aux données, une colonne virtuelle est créée dans le champ. Les informations seront enregistrées dans la table uniquement lors de l'appel de la fonction [TableEnregistre](../WDLang1/3074008.md).

Si la fonction **TableAjouteColonne** est appelée successivement dans le même traitement sans être suivie de la fonction [TableEnregistre](../WDLang1/3074008.md), seul le PREMIER appel est effectif (les appels suivants sont ignorés). Une seule colonne est ajoutée dans le champ Table liée aux données.
<a name="NOTE0_6"></a>


### Ajout dans un champ Table liée aux données et Trigger
<a name="ajout_dans_champ_table_liee_aux_donnees_trigger_ELTPARAGRAPHE000157"></a>
...
### Ajout d'une image
<a name="ajout_une_image_ELTPARAGRAPHE000169"></a>
...
<a name="champ_table_saisie_ELTPARAGRAPHE000188"></a>
...
[&lt;Table&gt;.AjouteColonne (Fonction)](../WDLang1/1000023607.md)
