...
### Table des changes
<a name="table_des_changes_ELTPARAGRAPHE000064"></a>Une ***table des changes ***est conservée en mémoire. A chaque monnaie sont associés :
...
### Écart d'arrondi
<a name="ecart_arrondi_ELTPARAGRAPHE000379"></a>L'&lt;écart d'arrondi&gt; est calculé avec la formule suivante :
...
ResConversion = eVersDevise(50, eIEP, 2, Ecart)
```
