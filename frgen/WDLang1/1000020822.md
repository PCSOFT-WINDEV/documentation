...
- dans la fenêtre de description de l'élément (champ, fenêtre, état, page, etc.). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_multilangue%20-%20HC%20N%B0002.gif&type=thumb)


- lors de l'édition directe du libellé d'un champ : il suffit de passer en édition (via la touche Espace) puis d'utiliser le raccourci clavier Ctrl + T. La fenêtre de saisie des différentes langues du libellé apparaît : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_multilangue%20-%20HC%20N%B0003.gif)





Chaque langue définie dans le projet est identifiée par son drapeau, son nom et son numéro. Il suffit de saisir la traduction dans la langue voulue. Un menu spécifique (affiché via l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_multilangue%20-%20HC%20N%B0003%201.gif)) permet de simplifier les opérations de traduction. 
...
<a name="menu_pour_simplifier_les_operations_traduction_ELTTEXTE000142"></a><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_multilangue%20-%20HC%20N%B0004.gif)
