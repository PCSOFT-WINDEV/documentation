...
<DIV class="specObsolete">
	...
	A partir de la version <B>25</B>,  cette fonction est conservée par compatibilité. Il est conseillé d'utiliser la fonction [ExécuteMiseAJourUI](../WDLang1/1000023901.md).
...
<a name="mvp_attribut_presentation_ELTPARAGRAPHE000106"></a>L'attribut **présentation** permet d'associer une classe de la couche présentation à une vue (fenêtre, page ou état). Cet attribut est utilisé notamment lors de la déclaration globale des fenêtres générées par le RAD MVP.
