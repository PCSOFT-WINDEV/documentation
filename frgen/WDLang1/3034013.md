...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Le traitement automatique d'exception permet de gérer les erreurs du WLangage. Les erreurs présentes dans les fichiers Javascript externes ne sont pas gérées.
...
3. La fenêtre qui s'affiche permet de spécifier le type de traitement automatique à effectuer :
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Exception_auto_1.gif&type=thumb)
...
| ***opRelanceProgramme*** | Termine l'application et relance automatiquement l'application.<br><br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
