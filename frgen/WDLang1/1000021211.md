...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000021588&name=tacheparalleleexecute_fonction">Voir des exemples supplémentaires</a>
...
| *tpoThreadPrincipal* | Exécute la tâche dans le thread principal.<br>Cette constante peut être combinée avec une des autres constantes. <br>Attention: Cette constante ne peut pas être utilisée pour exécuter une tâche parallèle dans le thread principal depuis le thread principal. |
...
| --- | --- | --- |
| **Copie complète** | Copie: <br><br>	- les paramètres de connexion au sens large (connexions, chemins physiques, ...).<br><br>	- les positions, les filtres, ... définis sur les tables.<br><br>	- les requêtes. <br><br><br> | Consommation mémoire (sur le client et sur le serveur). |
...
[&lt;Description de TâcheParallèle&gt;.Exécute (Fonction)](../WDLang1/1000021669.md)
