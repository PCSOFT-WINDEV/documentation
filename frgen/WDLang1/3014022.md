...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Lorsque cette fonction est utilisée dans une page AWP, les assertions ne sont pas affichées.
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Les messages de la fonction **dbgAssertion** seront écrits dans le log ADB (au niveau "Assert"). Pour plus de détails, consultez [Gestion des logs ADB](../Editeurs/9000108.md).
