...
<a name="fonctionnement_log_execution_ELTPARAGRAPHE000264"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Remarque: Le log d'exécution peut être également démarré grâce au fichier ".wx" placé à côté de l'exécutable. Pour plus de détails, consultez [Log d'exécution](../Editeurs/2019030.md).
