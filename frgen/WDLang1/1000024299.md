...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette fonction est désormais disponible sur les listes WLangage.
	

- ![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette fonction est utilisable uniquement avec les variables de type Tableau.
...
<a name="ajout_element_dans_tableau_wlangage_ELTPARAGRAPHE000435"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Ajoute** :
...
<a name="ajout_element_dans_une_propriete_tableau_type_avance_ELTPARAGRAPHE000461"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Ajoute** :
...
<a name="ajout_element_dans_une_liste_ELTPARAGRAPHE000479"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Ajoute** :
...
<a name="ajout_tableau_dans_tableau_concatenation_ELTPARAGRAPHE000524"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Ajoute** :
...
<a name="ajout_une_liste_dans_une_liste_concatenation_ELTPARAGRAPHE000557"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Ajoute** :
...
<a name="conditions_utilisation_ELTPARAGRAPHE000636"></a>Cette fonction peut être utilisée avec des structures. Dans ce cas, il faut :
...
### Divers
<a name="divers_ELTPARAGRAPHE000658"></a>

- Pour ajouter un élément à une position donnée, utilisez la fonction [&lt;Tableau&gt;.Insère](../WDLang1/1000024309.md).
...
[&lt;Tableau&gt;.AjouteLigne (Fonction)](../WDLang1/1000024300.md)
...
[&lt;Tableau&gt;.Ajoute (Fonction)](../WDLang1/1000024295.md)
