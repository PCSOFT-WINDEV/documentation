...
<a name="configuration_projet_ELTPARAGRAPHE000052"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MCU_Projet.gif)
Dans cet écran:
...
- Si la saisie de MCU est autorisée sur les fenêtres du projet, il est possible de:
	...
	- ***Autoriser l'utilisation des ordres de lecture HFSQL***. Si cette option est cochée, l'utilisateur final pourra lire et se déplacer dans les enregistrements présents dans les tables HFSQL de l'application. Dans tous les cas, l'utilisateur final ne pourra pas modifier ou créer de nouveaux enregistrements ou de nouvelles tables.
...
<a name="description_des_fenetres_ELTPARAGRAPHE000084"></a>
...
Il suffit de cocher l'option "Interdire l'utilisation du MCU" dans l'onglet "Détail" de la description de la fenêtre.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MCU_Fenetre.GIF&type=thumb)

<a name="NOTE2_4"></a>


### Création de l'exécutable
<a name="creation_executable_ELTPARAGRAPHE000094"></a>
...
La saisie de nouvelles Macro-Codes Utilisateur dans une application est très simple. Si la fenêtre permet la saisie d'une Macro Code Utilisateur, l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MCU_Icone.gif) apparaît à côté de l'icône de réduction de la fenêtre. Lors du clic sur cette icone, un assistant apparaît, et permet à l'utilisateur final de créer et d'utiliser ses Macro-Codes Utilisateur.
...
3. Sélectionnez le ou les Macro-Codes Utilisateur à importer.
	Le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MCU_Import_diff.gif) permet de voir les modifications faites par l'utilisateur par rapport au code existant.
...
[Fonctions de gestion du MCU](../WDLang1/9000017.md)
