...
## Syntaxe
<a name="SYNTAXE1"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Attention : Ce paramètre est nécessaire sous les systèmes récents (supérieur ou égal à Android 2.6). 
...
<a name="gestion_des_certificats_webdev_ELTPARAGRAPHE000331"></a>Pour que les certificats soient visibles pour l'utilisateur du site, ils doivent être installés sur le serveur dans le magasin de certificats personnels de l'utilisateur Internet.
...
[CertificatSigneChaîne (Fonction)](../WDLang1/1000019296.md)
