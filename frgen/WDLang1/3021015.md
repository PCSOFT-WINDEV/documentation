...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fonctions_dialogue%20-%20HC%20N%B0009.gif)
...
- **Cette fenêtre d'avertissement est bloquante**. Pour continuer l'exécution de l'application, l'utilisateur doit valider un des boutons. 
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Pour ne pas bloquer l'application, utilisez la fonction [DialogueAsynchrone](../WDLang1/1000025310.md).
...
<a name="utilisation_syntaxe_avec_assistant_ELTPARAGRAPHE000148"></a>
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Le thème du projet en cours est automatiquement appliqué à la boîte de dialogue.
	![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Pour que le thème du projet soit appliqué à la boîte de dialogue, il faut :

	- appliquer le thème aux boîtes de dialogue (option "Personnaliser les fenêtres système (Info, OuiNon, Confirmer, Dialogue)" dans l'onglet "Style" de la fenêtre de description du projet).
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Pour permettre à l'utilisateur de saisir une valeur dans une boîte de dialogue, utilisez la fonction [Saisie](../WDLang1/3021016.md).
...
### Pilotage
<a name="pilotage_ELTPARAGRAPHE000256"></a>

Il est possible de piloter une boîte de dialogue à l'aide de la fonction [PiloteDialogue](../WDLang1/1000009004.md).
<a name="NOTE0_5"></a>
...
<a name="application_arriereplan_specificite_partir_android_10_ELTPARAGRAPHE000447"></a>A partir de Android 10, il n'est plus possible d'ouvrir une fenêtre lorsque l'application est en arrière-plan. 
