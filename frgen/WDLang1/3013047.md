...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png) jouer un son système. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) jouer un son d'une fréquence donnée pendant le temps désiré.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) un fichier WAV.

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) un fichier audio correspondant à tous les formats supportés par l'OS (wav, mp3, 3gp, ogg, ...). Un résumé des fichiers audio supportés est disponible à l'adresse suivante : [http://developer.android.com/guide/appendix/media-formats.html](http://developer.android.com/guide/appendix/media-formats.html). 
	Remarques : 
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) un fichier au format wav. 
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Le fichier audio à lire peut également être intégré à l'application via l'assistant de génération. Pour le lire, il suffit ensuite d'indiquer directement le nom du fichier (nom + extension). 

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Il n'est pas possible de jouer un fichier WAV se trouvant dans une rubrique mémo HFSQL.
...
<a name="arret_son_non_bloquant_ELTPARAGRAPHE000228"></a>Un son exécuté en mode non bloquant peut être arrêté par le code suivant, appelé par exemple sur une action de l'utilisateur (clic, modification d'un champ, etc.) : 
...
### Son et composant
<a name="son_composant_ELTPARAGRAPHE000257"></a>Par défaut, la fonction **Son** est non bloquante. Pour utiliser la fonction **Son** dans un composant sans bloquer l'application, il faut respecter les contraintes suivantes :
...
[MCIVolume (Fonction)](../WDLang1/3051012.md)
