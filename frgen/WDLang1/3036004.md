...
- ![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Si l'expression "\*.\*" est utilisée, seuls les fichiers avec extension seront copiés.

- ![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Les caractères jokers (\*,?) sont autorisés dans le chemin et le nom du fichier.
...
<a name="SYNTAXE2"></a>
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Non disponible en PHP
...
**Gestion des caractères joker  (\*, ?)** : Par défaut, les caractères jokers sont autorisés dans le nom du fichier.
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Si l'expression "\*.\*" est utilisée, seuls les fichiers avec extension seront copiés.
