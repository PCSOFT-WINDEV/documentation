...
***En anglais : TableInsertLineWithAnimation***
...
- Pour ajouter des éléments à la fin d'un champ Table, utilisez la fonction [TableAjouteLigne](../WDLang1/3074006.md) ou [TableAjouteLigneAvecAnimation](../WDLang1/1000022402.md).
...
<a name="conditions_utilisation_ELTPARAGRAPHE000116"></a>
...
<a name="caracteristiques_des_elements_ligne_ELTPARAGRAPHE000143"></a>
...
<a name="position_ligne_inseree_ELTPARAGRAPHE000160"></a>
...
- **Si la saisie en cascade n'est pas activée**, le contenu de la table lié au champ n'est pas modifié. Pour écrire le contenu de la ligne insérée dans la table liée, il est nécessaire d'utiliser la fonction [TableEnregistre](../WDLang1/3074008.md) après la fonction **TableInsèreLigneAvecAnimation**. 
...
<a name="champ_tabletable_hierarchique_fichier_insertion_plusieurs_lignes_ELTPARAGRAPHE000205"></a>

A chaque appel de la fonction **TableInsèreLigneAvecAnimation** dans un champ Table ou Table hiérarchique fichier, une ligne virtuelle est créée dans le champ. Les informations ne seront enregistrées dans la table que lors de l'appel de la fonction [TableEnregistre](../WDLang1/3074008.md).

Si la fonction **TableInsèreLigneAvecAnimation** est appelée successivement dans le même traitement sans être suivie de la fonction [TableEnregistre](../WDLang1/3074008.md), seul le PREMIER appel est effectif (les appels suivants sont ignorés). Une seule ligne est ajoutée dans le champ Table/Table hiérarchique fichier.
<a name="NOTE0_7"></a>


### Champ Table/Table hiérarchique en saisie
<a name="champ_tabletable_hierarchique_saisie_ELTPARAGRAPHE000226"></a>
...
### Insertion d'image
<a name="insertion_image_ELTPARAGRAPHE000243"></a>
