...
<a name="lancer_assistant_gestion_mcu_ELTPARAGRAPHE000020"></a>

Si la fenêtre permet la saisie d'un Macro-Code Utilisateur, l'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MCU_Icone.gif) apparaît: 
...
<a name="ajouter_macrocode_ELTPARAGRAPHE000039"></a>

Pour ajouter un Macro-Code Utilisateur:

1. Lancez l'assistant de gestion du MCU (icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MCU_Icone.gif) par défaut). 
...
<a name="envoyer_par_email_les_macrocodes_utilisateur_ELTPARAGRAPHE000068"></a>
...
## Limitations
<a name="limitations_ELTTEXTE000227"></a>


### Code saisi dans les Macro-Codes Utilisateur
<a name="code_saisi_dans_les_macrocodes_utilisateur_ELTPARAGRAPHE000084"></a>

- Les traitements d'exception (Quand Exception ...) n'ont aucun effet en MCU.

- Il n'est pas possible d'utiliser les fonctions HFSQL permettant la modification des tables (fonctions [HAjoute](../WDLang4/3044147.md), [HCrée](../WDLang4/3044255.md), [HCréeSiInexistant](../WDLang4/3044254.md), [HEcrit](../WDLang4/3044092.md), [HLibère](../WDLang4/3044064.md), [HModifie](../WDLang4/3044042.md), [HRaye](../WDLang4/3044121.md) et [HSupprime](../WDLang4/3044018.md)). Les fonctions Table\* correspondantes sont également interdites.

- La fonction [Compile](../WDLang1/3013015.md) ne peut pas être utilisée.

- Lors de la configuration de l'application, il est possible d'interdire l'utilisation des fonctions de parcours des tables.
