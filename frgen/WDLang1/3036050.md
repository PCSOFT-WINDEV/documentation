...
Le sélecteur de répertoires est le suivant (selon le système utilisé, l'apparence du sélecteur peut varier) :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fRepS%E9lecteur%20-%20HC%20N%B0001.gif)
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003036050&name=frepselecteur_fonction">Voir des exemples supplémentaires</a>
...
|   |   |
| --- | --- |
| *fCheminUnicode* | &lt;Résultat&gt; sera une chaîne de caractères au format Unicode.<br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'est pas disponible. |
| *frAncienAspect* | Permet d'utiliser l'ancien sélecteur de répertoire (ancien look). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=SelectRep.gif)<br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
| *frInterditDossierVirtuel* | &lt;Résultat&gt; ne contiendra pas les répertoires virtuels.<br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
