...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Projet_multilangue%20-%20HC%20N%B0001.gif&type=thumb)
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Toutes les langues du projet sont intégrées à l'archive JAVA.
...
1. Affichez la description de l'analyse : sous le volet "Schéma des données", dans le groupe "Élément courant", cliquez sur "Description". 
