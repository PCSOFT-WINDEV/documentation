...
- les tables communes à tous les utilisateurs (tables HFSQL .fic, .ndx et .mmo).
...
<a name="norme_programmation_sous_windows_vista_superieur_ELTPARAGRAPHE000074"></a>

Pour augmenter la sécurité des postes face aux vers et virus, Windows Vista (et supérieur) a mis en place le [mécanisme de l'UAC](../Editeurs/2025014.md) (le contrôle de compte utilisateur).
...
- **Si une application doit créer ou modifier des tables HFSQL locales ou des fichiers de configuration (.INI, .XML)**, ces tables doivent être localisées dans le répertoire correspondant à l'application.
...
[fRepGlobalCommun (Fonction)](../WDLang1/3036072.md)

[fRepGlobalUtilisateur (Fonction)](../WDLang1/3036073.md)
