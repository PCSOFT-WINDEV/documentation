...
- L'affichage d'un message d'erreur personnalisé. 
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette option n'est pas disponible.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Pour afficher un message personnalisé lors d'une erreur de programmation, il suffit de saisir le texte de l'erreur lors de la création de l'exécutable.
...
[Mécanisme des exceptions générales](../WDLang1/3034001.md)
