...
**A partir de la version 2025 Update 1**, si ces permissions sont nécessaire dans votre application, un pictogramme est présent dans l'étape des permissions dans l'assistant de génération de l'application. Ce picto indique que des justifications devront être faites en cas de publication sur le store. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=G%E9n%E9ration_media%20-%20HC%20N%B0002.gif&type=thumb)
