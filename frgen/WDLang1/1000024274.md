...
<a name="caracteristique_des_elements_colonne_ELTPARAGRAPHE000198"></a>
...
<a name="table_liee_aux_donnees_modifications_dans_table_liee_ELTPARAGRAPHE000218"></a>
...
Si la saisie en cascade n'est pas activée, la table liée aux données liée au champ Table liée aux données n'est pas modifiée. Pour écrire l'enregistrement dans la table, exécutez la fonction [&lt;Table&gt;.Enregistre](../WDLang1/1000024249.md) après la fonction **&lt;Table&gt;.ModifieColonne**.
...
<a name="modifications_realisees_dans_champ_table_liee_aux_donnees_ELTPARAGRAPHE000242"></a>
...
<a name="fonction_docparampagetitleshort_propriete_modifie_ELTPARAGRAPHE000265"></a>

La fonction **&lt;Table&gt;.ModifieColonne** n'a aucune influence sur la propriété [Modifié](../Proprietes/2510080.md). La propriété [Modifié](../Proprietes/2510080.md) permet de savoir si la colonne en cours a été modifiée directement par l'utilisateur (saisie directe dans le champ Table).
...
[TableModifieColonne (Fonction)](../WDLang1/1000017179.md)
