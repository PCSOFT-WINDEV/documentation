...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) En code navigateur, cette fonction est disponible uniquement pour les champs Table. Elle n'est pas disponible pour les champs Table hiérarchique. 
<a name="Exemple1"></a>
<a name="sample_code"></a>

## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003074007&name=tableinfoxy_fonction">Voir des exemples supplémentaires</a>
...
<a name="conditions_utilisation_ELTPARAGRAPHE000162"></a>La fonction **TableInfoXY** peut être utilisée indifféremment sur :
...
<a name="les_differents_types_indices_colonne_ELTPARAGRAPHE000185"></a>Il existe 2 types d'indices pour les colonnes :
