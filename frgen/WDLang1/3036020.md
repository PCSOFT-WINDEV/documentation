...
Débloque entièrement ou partiellement un fichier externe. Le fichier a été préalablement bloqué par la fonction [fBloque](../WDLang1/3036030.md).
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003036020&name=fdebloque_fonction">Voir des exemples supplémentaires</a>
...
<a name="deblocage_pas_ete_effectue_ELTPARAGRAPHE000103"></a>La fonction **fDébloque** renvoie <u><u><u><u>Faux</u></u></u></u> si le déblocage n'a pas été effectué. Le déblocage peut être effectué uniquement si :
...
<a name="deblocage_fichier_ELTPARAGRAPHE000124"></a>
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) **Cas particulier** : 
...
<a name="position_dans_fichier_ELTPARAGRAPHE000141"></a>A l'ouverture d'un fichier, la position en cours correspond :
