...
| *ccOrdreLexicographique* | Comparaison des chaînes de caractères selon l'ordre lexicographique (par exemple, le caractère 'é' est compris entre les caractères 'e' et 'f'). <br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette constante n'est pas disponible. |
| *ccRespecteNumérique* | Comparaison en tenant compte des numériques au sein des chaînes (dans ce cas, "10" est après "9"). |
| *ccSansAccent* | Comparaison sans tenir compte des accents.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
| *ccSansEspaceIntérieur* | Comparaison sans tenir compte des espaces présents à l'intérieur des chaînes de caractères à comparer.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Cette constante n'est pas disponible. |
| *ccSansPonctuationNiEspace* | Comparaison sans tenir compte de la ponctuation ni des espaces (voir Notes pour plus de détails).<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
<a name="equivalences_entre_fonction_docparampagetitleshort_les_operateurs_comparaison_ELTPARAGRAPHE000127"></a>
...
- **Opérateur ~=** : 
	...
	![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette syntaxe n'est pas disponible.
...
<a name="comparaison_des_numeriques_ELTPARAGRAPHE000167"></a>La constante *ccRespecteNumérique* effectue le tri en tenant compte de la valeur numérique représentée par les chiffres et non pas simplement de l'ordre alphabétique des chiffres.
...
<a name="caracteres_pris_compte_pour_ponctuation_les_espaces_ELTPARAGRAPHE000445"></a>Les caractères pris en compte pour la ponctuation et les espaces sont fournis par le système. Pour obtenir la liste de ces caractères, il suffit d'écrire le code WLangage suivant :
...
<a name="fonction_docparampagetitleshort_unicode_ELTPARAGRAPHE000307"></a>Il est possible d'utiliser des chaînes ANSI, Unicode et des buffers dans les différents paramètres de la fonction.
...
[Opérateurs de comparaison](../WDLang1/1512006.md)
