...
***En anglais : &lt;Table&gt;.CollapseExpand***
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Champ Table hiérarchique: 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) enroule ou déroule une fenêtre de détail affichée pour une ligne (Pour plus de détails, consultez [Gérer le détail d'une ligne d'un champ Table](../WDChamp/1013200.md)):
...
<a name="conditions_utilisation_ELTPARAGRAPHE000345"></a>
...
- un champ Table liée aux données.
...
<a name="branche_enrouler_derouler_ELTPARAGRAPHE000371"></a>
...
- Si le paramètre &lt;Ligne manipulée&gt; ou &lt;Branche manipulée&gt; correspond à la branche contenue dans la première ligne, toute la hiérarchie du champ Table hiérarchique est enroulée (équivalent à la fonction [&lt;Table&gt;.EnrouleTout](../WDLang1/1000021847.md)) ou déroulée (équivalent à la fonction [&lt;Table&gt;.DérouleTout](../WDLang1/1000021834.md)).

- Lors de l'appel à la fonction **&lt;Table&gt;.EnrouleDéroule**, si la branche spécifiée est déroulée et possède une procédure associée via la propriété [AjouteFilsDifféré](../Proprietes/1000020927.md), cette procédure sera exécutée.
...
<a name="gestion_bandeau_selection_lors_enroulement_ELTPARAGRAPHE000417"></a>
...
<a name="gestion_bandeau_selection_lors_deroulement_ELTPARAGRAPHE000434"></a>
...
<a name="vitesse_execution_pour_les_champs_table_hierarchique_ELTPARAGRAPHE000446"></a>
