...
<a name="position_colonne_inseree_ELTPARAGRAPHE000101"></a>
...
<a name="limites_nombre_maximum_colonnes_affichees_ELTPARAGRAPHE000116"></a>
...
<a name="champ_table_liee_aux_donnees_modifications_dans_table_liee_ELTPARAGRAPHE000127"></a>
...
Si la saisie en cascade n'est pas activée, la table liée aux données liée au champ Table liée aux données n'est pas modifiée. Pour écrire l'enregistrement dans la table, exécutez la fonction [TableEnregistre](../WDLang1/3074008.md) après la fonction **TableInsèreColonne**.
...
<a name="champ_table_liee_aux_donnees_insertion_plusieurs_colonnes_ELTPARAGRAPHE000148"></a>

A chaque appel de la fonction **TableInsèreColonne** dans un champ Table liée aux données, une colonne virtuelle est créée dans le champ Table liée aux données. Les informations seront enregistrées dans la table uniquement lors de l'appel de la fonction [TableEnregistre](../WDLang1/3074008.md).

Si la fonction **TableInsèreColonne** est appelée successivement dans le même traitement sans être suivie de la fonction [TableEnregistre](../WDLang1/3074008.md), seul le PREMIER appel est effectif (les appels suivants sont ignorés). Une seule colonne est ajoutée dans le champ Table liée aux données.
<a name="NOTE0_6"></a>


### Insertion d'une image
<a name="insertion_une_image_ELTPARAGRAPHE000169"></a>
...
<a name="champ_table_saisie_ELTPARAGRAPHE000187"></a>
...
[&lt;Table&gt;.InsèreColonne (Fonction)](../WDLang1/1000024261.md)
