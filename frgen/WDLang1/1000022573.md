...
<a name="proprietes_specifiques_description_des_variables_type_doctabulation_ELTPARAGRAPHE000025"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une variable de type **docTabulation** :
