...
| Service.DémarrageRetardé | Booléen | Indique que le service ne sera pas lancé immédiatement au démarrage du système mais légèrement plus tard.<br><br>![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) **Remarques** :<br><br>- Cet élément n'est pris en compte que pour les services Windows.<br><br>- Cet élément n'est pris en compte qu'à partir de Windows Vista.<br><br><br> |
| Service.Description | Chaîne de caractères | Description du service.<br><br>![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) **Remarque** : Cette information apparaît dans la rubrique "Nom complet" du gestionnaire de services. |
| Service.DescriptionLongue | Chaîne de caractères | Description détaillée du service.<br><br>![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) **Remarque** : cette information apparaît dans la rubrique "Description" du gestionnaire de services. |
