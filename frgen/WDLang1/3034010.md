...
2. Dans l'entête du code, cliquez sur "Si Erreur : par programme".
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Erreur_auto1.gif&type=thumb)


3. La fenêtre qui s'affiche permet de spécifier le type de traitement automatique à effectuer :
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Erreur_auto2.gif&type=thumb)
...
- Le code de gestion de l'erreur présent dans le traitement en cours est prioritaire sur les traitements automatiques dans les deux cas suivants :
	...
	- Test des erreurs avec la variable [ErreurDétectée](../WDLang1/3087001.md).
			![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Le code de gestion de l'erreur présent dans le traitement en cours n'est pas prioritaire sur les traitements automatiques : le traitement d'erreur du code ET le traitement automatique seront exécutés dans tous les cas.
...
| ***opRéessayer*** | La fonction ayant déclenché l'erreur est ré-exécutée.<br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible en Java. |
| ***opRelanceProgramme*** | Termine l'application et relance automatiquement l'application.<br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette constante n'est pas disponible. |
...
<a name="afficher_erreur_quitter_application_ELTPARAGRAPHE000111"></a>Si cette option est sélectionnée, si une erreur est rencontrée dans l'application la fenêtre suivante s'affiche automatiquement :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Erreur_auto_Fen1.gif)
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remarque** : si le composant "Feedback" est intégré à l'application (soit directement, soit par le menu utilitaire ("?") de votre application), l'utilisateur a également la possibilité d'envoyer le rapport d'erreur au fournisseur de l'application. 
<a name="NOTE2_5"></a>


### Afficher l'erreur et retourner en saisie dans la fenêtre courante
<a name="afficher_erreur_retourner_saisie_dans_fenetre_courante_ELTPARAGRAPHE000128"></a>Si cette option est sélectionnée, si une erreur est rencontrée dans l'application la fenêtre suivante s'affiche automatiquement :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Erreur_auto_Fen2.gif)
Dans cette fenêtre, l'utilisateur peut :
...
<a name="afficher_erreur_laisser_utilisateur_decider_ELTPARAGRAPHE000146"></a>Si cette option est sélectionnée, si une erreur est rencontrée dans l'application la fenêtre suivante s'affiche automatiquement :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Erreur_auto_Fen3.gif)
Dans cette fenêtre, l'utilisateur peut :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remarque** : si le composant "Feedback" est intégré à l'application (soit directement, soit par le menu utilitaire ("?") de votre application), l'utilisateur a également la possibilité d'envoyer le rapport d'erreur au fournisseur de l'application. ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Cette option a le même fonctionnement que l'option "Afficher l'erreur et retourner en saisie dans la fenêtre courante".
<a name="NOTE2_7"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Par défaut, les fenêtres de gestion des erreurs, des exceptions et des assertions sont intégrées à l'application. Ces fenêtres sont disponibles en français et en anglais. 
