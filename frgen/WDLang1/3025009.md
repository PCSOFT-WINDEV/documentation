...
<a name="champ_invisible_inactif_grise_ELTPARAGRAPHE000078"></a>Un champ invisible, inactif ou grisé est considéré comme étant présent dans la fenêtre ou dans la page.
...
### Divers
<a name="divers_ELTPARAGRAPHE000087"></a>**Attention** : Il ne faut pas utiliser un champ directement dans un traitement où vous testez son existence. Cela générera une erreur lors de l'exécution si le champ n'existe pas.
