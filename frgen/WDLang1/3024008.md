...
|   |   |
| --- | --- |
| *MotComplet* | Recherche un mot complet, c'est-à-dire entouré de caractères de ponctuation (caractère différent d'une lettre ou d'un chiffre) ou d'espaces.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/us/WBN.png) Cette constante n'est pas disponible. |
...
<a name="recherche_dans_tableau_gestion_des_ambiguites_ELTPARAGRAPHE000108"></a>Lorsque les chaînes à rechercher sont des sous-chaînes d'autres chaînes présentes dans le tableau, ce sont toujours les chaînes trouvées les plus longues qui sont prises en compte.
...
<a name="fonction_docparampagetitleshort_unicode_ELTPARAGRAPHE000123"></a>Il est possible d'utiliser des chaînes ANSI, Unicode et des buffers dans les différents paramètres de la fonction.
