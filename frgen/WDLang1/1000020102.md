...
**Remarque** : Cette fonction est équivalente à la fonction [TableauChercheParProcédure](../WDLang1/1000020101.md). 
...
nIndice = ChercheParProcédure(tabRéférence, ProcCompareRéférenceCourte, tcLinéaire, 0, "123456")
	...
	PROCEDURE INTERNE ProcCompareRéférenceCourte(Elément1, Recherche)
...
| *tcDichotomiqueConforme* | Recherche dichotomique croissante. <br>Ce mode de recherche est rapide mais il doit être utilisé sur un tableau trié par ordre croissant avec la même procédure de comparaison ou une procédure équivalente (voir fonction [TableauTrie](../WDLang1/3075007.md)). |
| *tcLinéaire* | Recherche linéaire. La recherche démarre :<br><br>- soit à partir du premier élément, si le paramètre &lt;Indice de départ&gt; vaut 0,<br><br>- soit à partir de la valeur du paramètre &lt;Indice de départ&gt;.<br><br><br>La recherche s'arrête au premier élément trouvé. |
...
<a name="procedure_wlangage_comparaison_ELTPARAGRAPHE000254"></a>Cette procédure de comparaison est de la forme : 
