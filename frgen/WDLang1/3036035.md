...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003036035&name=frepdeplace_fonction">Voir des exemples supplémentaires</a>
...
|   |   |
| --- | --- |
| *frConfirmer* | Le contenu du répertoire est déplacé après confirmation de l'écrasement du répertoire de même nom.<br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette constante n'est pas disponible. |
| *frJauge* | Une fenêtre de progression est affichée.<br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette constante n'est pas disponible. |
