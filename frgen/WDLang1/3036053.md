...
**Remarque** : **Sous Android et iOS**, la boîte de dialogue de sélection d'un fichier n'est pas disponible. Utilisez la fonction [AlbumSélecteur](../WDLang3/1000020186.md) (pour sélectionner un fichier de type Image ou Vidéo) ou la fonction [URISélecteur](../WDLang3/1000024026.md) pour tout type de fichier.
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003036053&name=fselecteur_fonction">Voir des exemples supplémentaires</a>
...
![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Ce paramètre peut être au format Ansi ou Unicode.
...
![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Ce paramètre peut être au format Ansi ou Unicode.![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Ce paramètre n'est pas pris en compte.
...
|   |   |
| --- | --- |
| *fCheminUnicode* | &lt;Résultat&gt; sera une chaîne de caractères au format Unicode. <br><br><br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'est pas prise en compte. |
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Ce paramètre n'est pas pris en compte.
...
<a name="extension_par_defaut_lors_creation_fichier_avec_constante_fselcree_ELTPARAGRAPHE000250"></a>L'extension d'un fichier sélectionné (fichier à créer) est différente selon :
...
<a name="clic_sur_fichier_dans_selecteur_fichiers_ELTPARAGRAPHE000350"></a>Pour exécuter un traitement spécifique lors d'un clic sur un fichier présent dans le sélecteur de fichiers, branchez un événement sur le message <u><u><u><u>WM_USER + 600</u></u></u></u> (1624). A la réception de ce message :
...
<a name="selection_repertoire_ELTPARAGRAPHE000367"></a>La fonction **fSélecteur** permet de sélectionner des fichiers. Pour sélectionner un répertoire, utilisez la fonction [fRepSélecteur](../WDLang1/3036050.md).
<a name="NOTE0_7"></a>
![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Lecteurs réseau, manifeste et UAC
<a name="lecteurs_reseau_manifeste_uac_ELTPARAGRAPHE000382"></a>Sous Windows Vista et supérieur, si l'UAC est active et si l'exécutable est généré avec un manifeste demandant des privilèges (voir [Génération de l'exécutable](../Editeurs/2025013.md)), le sélecteur de fichiers ouvert par la fonction **fSélecteur** n'aura pas accès aux lecteurs réseau associés à l'utilisateur qui a ouvert la session Windows. Pour plus de détails, consultez [FAQ à propos de Windows Vista et supérieur](../Editeurs/2025016.md).
<a name="NOTE0_8"></a>
...
<a name="quelques_exemples_selecteurs_fichiers_ELTPARAGRAPHE000400"></a>

![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) Le sélecteur de fichiers de Windows est le suivant :
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=SelecteurFichiers.gif)
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Le sélecteur de fichiers de Linux est le suivant : 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=SelecteurFichiers_LX.gif)
...
[fSélecteurImage (Fonction)](../WDLang1/3036037.md)

[fFiltreImage (Fonction)](../WDLang1/3036009.md)
...
[URISélecteur (Fonction)](../WDLang1/1000024026.md)

[AlbumSélecteur (Fonction)](../WDLang1/1000020186.md)
