...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000339"></a>
...
<a name="retour_chariot_fin_une_ligne_ELTPARAGRAPHE000384"></a>

La fonction [&lt;Variable FichierDisque&gt;.EcritLigne](../WDLang1/1410089042.md) permet d'insérer automatiquement un retour chariot (RC) à la fin de la ligne ajoutée. Pour insérer un retour chariot (RC) avec **&lt;Variable FichierDisque&gt;.Ecrit**, il suffit d'utiliser la constante *RC*.
...
...
ResEcriture = MaTable.Ecrit("Compte-rendu" + RC + "Ventes de mars 2021")
```
...
<a name="position_dans_fichier_ELTPARAGRAPHE000409"></a>
