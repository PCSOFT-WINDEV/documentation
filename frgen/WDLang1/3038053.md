...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) **Cas des défilements de fenêtres internes** : La fonction **ChangeFenêtreSource** permet de modifier la fenêtre actuellement affichée. Cette modification est enregistrée dans la liste des fenêtres internes à faire défiler. 
...
<a name="parametres_passes_fenetre_interne_ouvrir_ELTPARAGRAPHE000107"></a>Les paramètres sont récupérés dans l'événement de "Déclarations globales" de la fenêtre interne. Il suffit de saisir la ligne de code suivante au début du code de l'événement :
...
<a name="evenements_executes_lors_changement_fenetre_interne_ELTPARAGRAPHE000133"></a>Lors de l'utilisation de la fonction **ChangeFenêtreSource**, les événements suivants sont exécutés :
...
<a name="propriete_fenetresource_ELTPARAGRAPHE000168"></a>La propriété [FenêtreSource](../Proprietes/2511020.md) permet de connaître le nom de la fenêtre interne actuellement affichée dans un champ de type "Fenêtre Interne".
...
[&lt;Fenetre interne&gt;.ChangeFenêtreSource (Fonction)](../WDLang1/1000020950.md)
