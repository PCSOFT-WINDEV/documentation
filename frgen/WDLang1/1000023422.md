...
|   |   |
| --- | --- |
| *aDéfaut*<br>(Valeur par défaut) | Image par défaut (dossier fermé):![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=imageEnroule.gif) |
| *Null* | Aucune image |
...
|   |   |
| --- | --- |
| *aDéfaut*<br>(Valeur par défaut) | Image par défaut (dossier ouvert): ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=imagederoulee.gif) |
| *Null* | Aucune image |
...
<a name="branche_feuille_ELTPARAGRAPHE000302"></a>
...
<a name="ordre_priorite_pour_tri_ELTPARAGRAPHE000318"></a>
...
### Doublons
<a name="doublons_ELTPARAGRAPHE000334"></a>

L'acceptation des doublons est à manipuler avec précaution (constante *aAccepteDoublon*). En effet, il est nécessaire de gérer un identifiant spécifique pour identifier le niveau où l'ajout doit être effectué. Pour plus de détails, consultez [Gestion des doublons dans les champs Arbre](../WDChamp/1013325.md).

Si cette gestion n'est pas effectuée, quelques incohérences peuvent survenir.

Par exemple: Si deux "Niveau 2" existent, dans lequel faut-il rajouter "Niveau 3"? Impossible de trouver quel est le "Niveau 2" à manipuler. Par défaut, l'ajout sera effectué dans le premier élément trouvé.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=TVDoub.gif)
...
<a name="format_des_images_enrouleesderoulees_ELTPARAGRAPHE000359"></a>
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Les formats d'images reconnus sont les suivants:  GIF, JPEG, PNG ou SVG (selon le support des navigateurs).


### Type des images enroulées/déroulées
<a name="type_des_images_enrouleesderoulees_ELTPARAGRAPHE000408"></a>

Les images utilisées peuvent être:

- des fichiers image,

- des rubriques d'une table HFSQL de type "Mémo Binaire" contenant une image.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Les images utilisées peuvent uniquement être des fichiers image. Ces fichiers doivent être présents dans le répertoire "&lt;NomProjet&gt;_WEB". Ces images ne sont pas transformées lors de l'enregistrement de la page. Il n'est pas nécessaire d'utiliser la fonction [fRepWeb](../WDLang1/3036052.md) pour indiquer le chemin de l'image. Ce chemin est relatif au répertoire "&lt;NomProjet&gt;_WEB".**Remarque**: Il est conseillé d'utiliser des images 16 x 16 pixels (taille des petites icônes).
<a name="NOTE0_5"></a>


### Astuce concernant les images des branches
<a name="astuce_concernant_les_images_des_branches_ELTPARAGRAPHE000434"></a>
