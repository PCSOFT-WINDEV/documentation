...
- La fonction **&lt;Table&gt;.RestaurePositionEtSélection** ne fonctionne pas sur les champs Table liée aux données à rebond (c'est-à-dire les champs Table liée aux données sans ascenseur proportionnel).
...
Les fonctions [&lt;Table&gt;.SauvePositionEtSélection](../WDLang1/1000024283.md) et **&lt;Table&gt;.RestaurePositionEtSélection** sont équivalentes à l'option "Mémoriser la position et la sélection" disponible dans l'onglet "Détail" de la description du champ.
...
[&lt;Table&gt;.SauvePositionEtSélection (Fonction)](../WDLang1/1000024283.md)

[Le champ Table](../WDLang1/1013224.md)

[Le champ Table hiérarchique](../WDLang1/1015001.md)

[TableRestaurePositionEtSélection (Fonction)](../WDLang1/1000017413.md)
