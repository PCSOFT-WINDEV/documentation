...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **[Les boîtes de dialogue avancées](#NOTE3_1)**. 
...
- Les boîtes d'information ou d'erreur. Par exemple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fonctions_dialogue%20-%20HC%20N%B0004.gif)


- Les boîtes de question. Par exemple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fonctions_dialogue%20-%20HC%20N%B0007.gif)


- Les boîtes de confirmation. Par exemple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fonctions_dialogue%20-%20HC%20N%B0005.gif)
...
- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) **la saisie immédiate**.
	La saisie immédiate permet d'éviter la création d'une nouvelle fenêtre pour saisir uniquement une information. Grâce à la fonction [Saisie](../WDLang1/3021016.md), vous pouvez utiliser une simple boîte de dialogue pour saisir une donnée (champ de saisie ou case à cocher). L'utilisateur peut valider ou annuler la saisie.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fonctions_dialogue%20-%20HC%20N%B0008.gif)


- **l'interrogation directive**.
	 L'interrogation directive consiste à guider l'utilisateur dans la saisie de sa réponse, pour éviter toute ambiguïté: l'utilisateur répond à une question grâce à des boutons contenant le texte de l'action à effectuer. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=fonctions_dialogue%20-%20HC%20N%B0009.gif)
...
3. Sélectionnez le message à supprimer et cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=IconeSupprimeFavoris.gif).
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) proposer les FAA (Fonctionnalités Automatiques de vos Applications). L'utilisateur pourra ainsi paramétrer par exemple le raccourci clavier associé à chaque bouton ou l'exécution automatique du bouton. 
...
- être entièrement personnalisées. Il est ainsi possible de leur appliquer automatiquement le thème de l'application en cours ou d'utiliser des boîtes de dialogue multilingues. 
...
### Dialogue asynchrone
<a name="dialogue_asynchrone_ELTPARAGRAPHE000196"></a>
...
[DélaiAvantFermeture (Fonction)](../WDLang1/3038040.md)
