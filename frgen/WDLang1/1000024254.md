...
<a name="recalcul_des_donnees_ELTPARAGRAPHE000245"></a>Les lignes de calculs personnalisés sont automatiquement recalculées dès que le contenu du champ Table change.
...
<a name="personnalisation_ligne_calculs_ELTPARAGRAPHE000257"></a>Il est possible de personnaliser la ligne ajoutée (libellé, couleur, police, hauteur, ...) avec cette syntaxe :

```txt
<Champ Table>[Numéro ligne].<Propriété> = <Nouvelle valeur>
```
où &lt;Propriété&gt; peut correspondre à une des propriétés utilisable sur une colonne d'un champ Table. Pour plus de détails, consultez [Programmation de calculs personnalisés dans les champs Table](../WDChamp/1013341.md).
...
[&lt;Table&gt;.FormuleSupprimeTout (Fonction)](../WDLang1/1000024255.md)

[Programmation de calculs personnalisés dans les champs Table (syntaxe préfixée)](../WDLang1/1013341.md)

[TableFormuleAjoute (Fonction)](../WDLang1/1000022361.md)
