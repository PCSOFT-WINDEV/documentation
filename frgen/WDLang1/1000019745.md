...
<a name="position_plusieurs_pointeurs_ELTPARAGRAPHE000122"></a>Pour gérer la position de plusieurs pointeurs sur l'écran, l'appareil doit être muni d'un dispositif multi-points (multi-touch).
<a name="NOTE0_2"></a>
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Dans le simulateur ou l'émulateur Android, la fonction **GestePosY** permet uniquement de récupérer la position du premier pointeur.
...
[GestePosX (Fonction)](../WDLang1/1000019741.md)
