...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 
```wl
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Ce paramètre peut correspondre à un chemin complet ou relatif par rapport au répertoire en cours (connu avec la fonction [fRepEnCours](../WDLang1/3036022.md)). Ce paramètre est sensible à la casse. 
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Le nom de la procédure doit correspondre à une chaîne de caractères entre guillemets.

**`<Pointeur> : (Entier optionnel)`**

Pointeur passé à la procédure &lt;Procédure WLangage&gt;.

![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Paramètre passé à la fonction. Ce paramètre n'est pas obligatoirement un entier (il peut correspondre à une chaîne, ...).
...
| --- | --- |
| *fCheminUnicode* | &lt;Résultat&gt; sera une chaîne au format Unicode. <br><br> |
| *frInterruptible* | Le parcours peut être interrompu en utilisant la touche ECHAP.<br><br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Cette constante n'a aucun effet. |
| *frNonRécursif* | Le parcours est non récursif. Les sous-répertoires ne sont pas pris en compte. |
| *frRécursif*<br>(Valeur par défaut) | Le parcours est récursif. Les sous-répertoires sont automatiquement pris en compte. |
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Ce paramètre n'est pas pris en compte. Le parcours est non interruptible et non récursif.
