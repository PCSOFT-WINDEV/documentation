...
<a name="conditions_utilisation_ELTPARAGRAPHE000095"></a>
...
<a name="suppression_dans_champ_table_table_hierarchique_fichier_ELTPARAGRAPHE000122"></a>

La fonction **TableSupprimeAvecAnimation** supprime l'enregistrement correspondant dans la table associée au champ. Si des rubriques sont reliées à d'autres tables, aucune modification n'est effectuée automatiquement sur ces tables liées.
<a name="NOTE0_3"></a>


### Intégrité référentielle et champ Table ou Table hiérarchique fichier
<a name="integrite_referentielle_champ_table_table_hierarchique_fichier_ELTPARAGRAPHE000133"></a>

Si la gestion de l'intégrité référentielle est active (fonction [HGèreIntégrité](../WDLang4/3044058.md)), testez la fonction [HErreurIntégrité](../WDLang4/3044086.md) après l'appel de la fonction **TableSupprimeAvecAnimation** pour vérifier l'intégrité.
...
<a name="suppression_dans_champ_table_liee_aux_donnees_trigger_ELTPARAGRAPHE000152"></a>
...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000164"></a>
...
<a name="blocage_table_liee_ELTPARAGRAPHE000185"></a>

Si la table est bloquée dans le traitement en cours, la fonction **TableSupprimeAvecAnimation** supprime la ligne spécifiée et débloque la table.
<a name="NOTE0_7"></a>


### Suppression dans un champ Table par programmation avec un filtre de type "Contient"
<a name="suppression_dans_champ_table_par_programmation_avec_filtre_type_contient_ELTPARAGRAPHE000196"></a>
