...
**Remarque** : Cette fonction est identique à la fonction [TableauInsèreLigne](../WDLang1/3075014.md).
...
Si le paramètre &lt;Indice d'insertion&gt; est égal au nombre de lignes du tableau +1, la ligne est ajoutée à la fin du tableau (équivalent à la fonction [TableauAjouteLigne](../WDLang1/3075013.md)). 
...
<a name="insertion_une_ligne_ELTPARAGRAPHE000102"></a>Lors de l'utilisation de la fonction **InsèreLigne** :
...
<a name="insertion_une_ligne_dans_une_propriete_tableau_type_avance_ELTPARAGRAPHE000126"></a>Lors de l'utilisation de la fonction **InsèreLigne** :
...
- Pour ajouter une ligne à la fin d'un tableau à deux dimensions, utilisez la fonction [TableauAjouteLigne](../WDLang1/3075013.md) ou la fonction [AjouteLigne](../WDLang1/1000017349.md).
