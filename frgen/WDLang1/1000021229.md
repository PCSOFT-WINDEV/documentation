...
Plus simple encore, il est possible d'indiquer à la procédure **AfficheImage** qu'elle s'exécutera toujours dans le thread principal. Il suffit de cliquer sur le bouton ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Proc_auto_Ico.gif) dans le bandeau de l'éditeur de code et de cocher "Exécuter dans le thread principal". 
