...
| *animFlipAxeX* | Retournement autour de l'axe horizontal.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
| *animFlipAxeY* | Retournement autour de l'axe vertical.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
| *animFlipDiagonaleDescendante* | Retournement autour de la diagonale partant du point haut gauche au point bas droite.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
| *animFlipDiagonaleMontante* | Retournement autour de la diagonale partant du point haut droite au point bas gauche.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
| *animFondu* | Animation de type fondu enchaîné. |
| *animRecouvrement4Coin* | Affichage de l'image depuis les 4 coins avec recouvrement de l'état précédent.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
...
| *animRecouvrementZoom* | Nouvel état apparaissant depuis le centre avec un effet de zoom et un recouvrement de l'état précédent.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
| *animRétrécitPuis4Coin* | Rétrécissement de l'état précédent, puis apparition du nouvel état par les 4 coins.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
...
[AnimationAnnule (Fonction)](../WDLang1/1000020518.md)
