...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000018938&name=serviceinstalle_fonction">Voir des exemples supplémentaires</a>
...
- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) A partir de Windows Vista lorsque le mécanisme de l'UAC est activé, la fonction **ServiceInstalle** nécessite les droits d'administrateur.

- ![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) La fonction **ServiceInstalle** nécessite d'être exécutée avec les droits de l'utilisateur 'root'.
