...
<DIV class="specObsolete">
	...
	A partir de la version <B>27</B>,  cette fonction est conservée par compatibilité. Il est conseillé d'utiliser la fonction [gValeurMémorisée](../WDLang1/1410088363.md). 
...
- Pour que la récupération de la valeur définie par la fonction **gLien** soit active :
	...
	- soit utilisez la fonction [gLienActive](../WDLang1/3029036.md).
...
### Place de gLien
<a name="place_docparampagetitleshort_ELTPARAGRAPHE000110"></a>La fonction **gLien** peut être appelée à n'importe quelle place dans la ligne à ajouter.
...
### Valeur ajoutée
<a name="valeur_ajoutee_ELTPARAGRAPHE000127"></a>Lorsqu'une valeur est ajoutée par la fonction **gLien**, cette valeur n'est prise en compte ni dans le tri, ni pour les lettres d'appel.
...
La fonction [ListeCherche](../WDLang1/3049003.md) tient compte des valeurs ajoutées par la fonction **gLien**.
...
<a name="sensibilite_casse_ELTPARAGRAPHE000156"></a>La fonction **gLien** n'est pas sensible à la casse (minuscules/majuscules).
...
<a name="combos_autoalimentees_ELTPARAGRAPHE000173"></a>La fonction **gLien** est utilisée pour gérer les champs de type "Combo auto-alimentée".
...
### Élément récupéré
<a name="element_recupere_ELTPARAGRAPHE000185"></a>Lorsqu'un élément est récupéré dans un champ Combo ou Liste, l'ordre de priorité est le suivant :
...
### Champ Planning
<a name="champ_planning_ELTPARAGRAPHE000208"></a>Si les ressources du planning ont été créées avec la fonction [PlanningAjouteRessource](../WDLang1/1000019279.md) en utilisant la fonction **gLien**, le nom de la ressource obtenue par exemple avec la propriété [RessourceSélectionnée](../Proprietes/1000019445.md) correspondra à la valeur précisée dans la fonction **gLien** pour cette ressource.
...
<a name="cas_particulier_champ_combo_combo_dans_champ_table_ELTPARAGRAPHE000230"></a>Si la fonction **gLien** doit retourner une chaîne vide (""), le résultat obtenu est différent si le champ utilisé est un champ Combo ou une colone de type Combo dans une champ Table. 
...
Pour conserver le même code de récupération de la valeur de **gLien** pour un champ Combo et une colonne Combo, il est conseillé d'utiliser un champ Combo placé dans une [colonne de type conteneur](../WDChamp/1013263.md) du champ Table.
...
[gLienActive (Fonction)](../WDLang1/3029036.md)
