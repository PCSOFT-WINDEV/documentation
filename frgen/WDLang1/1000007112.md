...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000007118&name=hashfichier_fonction">Voir des exemples supplémentaires</a>
...
### Notes
<a name="notes_ELTPARAGRAPHE000660"></a>
...
<a name="disponibilite_des_algorithmes_ELTPARAGRAPHE000676"></a>![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Les algorithmes disponibles dépendent de la configuration du serveur PHP (présence de l'extension 'mhash', version 5 de PHP avec sa fonction native hash, etc).
