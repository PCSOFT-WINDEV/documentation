...
<a name="fonctionnement_champ_multimedia_mode_automatique_ELTPARAGRAPHE000068"></a>En mode automatique (constante *MultimédiaLecteurAutomatique*), le lecteur détermine le type de la vidéo en fonction de son extension. Ce mode ne fonctionne pas si le fichier n'a pas la bonne extension ou si le chemin est une URL vers une page/un script dynamique.


## Voir aussi

[Le champ Multimédia (WEBDEV)](../Proprietes/9500211.md)

[Propriétés associées au champ Vidéo](../Proprietes/9500212.md)
