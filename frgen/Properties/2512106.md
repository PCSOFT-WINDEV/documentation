...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png)![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) 
```wl
...
La propriété [CxTailleCache](../Proprietes/2512027.md) permet de définir la taille du cache d'une connexion MySQL. Cette propriété est conservée par compatibilité. Il est conseillé d'utiliser la propriété **TailleCache**.
<a name="NOTE0_2"></a>


### Récupération des enregistrements
<a name="recuperation_des_enregistrements_ELTPARAGRAPHE000113"></a>
...
<a name="NOTE0_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png)![OLE DB](https://doc.pcsoft.fr/ext/images/us/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/us/AN.png) 

### Gestion de la propriété TailleCache
<a name="gestion_propriete_docparampagetitleshort_ELTPARAGRAPHE000126"></a>
...
<a name="option_hrequetesanscorrection_ELTPARAGRAPHE000140"></a>
