...
- Connaître la formule d'une clé composée (définie sous l'éditeur de schémas des données ou définie par programmation).

- Définir la formule d'une clé composée (lors de la description de la table par programmation uniquement).
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000002512035&name=formulecle_propriete">Voir des exemples supplémentaires</a>
...
<a name="description_par_programmation_une_rubrique_cle_composee_ELTPARAGRAPHE000065"></a>

Lors de la description par programmation d'une rubrique de type clé composée, la propriété [Type](../Proprietes/2510131.md) n'est pas obligatoire (au contraire des rubriques simples définies par programmation). Cependant, il est nécessaire de décrire la composition de la clé avec la propriété **FormuleClé**.
