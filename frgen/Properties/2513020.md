...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Attention : Cette propriété est disponible uniquement dans les états.
...
<a name="modification_sens_ecriture_sur_une_fenetre_ELTPARAGRAPHE000084"></a>Lorsque le sens de l'écriture sur la fenêtre est inversé (constante *seDroiteAGauche*) :
...
<a name="modification_sens_ecriture_sur_champ_ELTPARAGRAPHE000095"></a>Lorsque le sens de l'écriture sur un champ est inversé (constante *seDroiteAGauche*), seul le mode d'affichage du champ concerné est modifié : les libellés des champs sont positionnés sur le coté droit du champ, les ascenseurs apparaissent sur le coté gauche du champ, ...
<a name="NOTE0_3"></a>


### Configuration nécessaire
<a name="configuration_necessaire_ELTPARAGRAPHE000102"></a>Le support des langues s'écrivant de droite à gauche est disponible uniquement pour les versions de Windows supérieures à Windows 95 et NT4.
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Cette propriété est disponible uniquement pour les états.


## Voir aussi

[DroiteAGauche (Propriété)](../Proprietes/1000017228.md)

[Propriétés associées aux fenêtres, aux pages et aux champs](../Proprietes/2510107.md)

[Projet multilingue](../Proprietes/3054011.md)
