...
Trace("Langue utilisée dans la table: ") + Client.Nom.Langue
```
...
Si les paramètres de la langue ont été définis dans le schéma des données comme devant être:
...
<a name="identifiants_langue_ELTPARAGRAPHE000090"></a>
...
<a name="identifiants_des_pays_ELTPARAGRAPHE000224"></a>
...
### Variantes
<a name="variantes_ELTPARAGRAPHE000446"></a>
...
[Gestion de l'Unicode dans les tables HFSQL](../Proprietes/3044371.md)
