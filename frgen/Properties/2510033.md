...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) une colonne de table affichée par un champ Combo.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette propriété est disponible uniquement en Lecture/Ecriture pour les champs d'un état. Pour les champs d'une page, cette propriété n'est pas disponible. **Remarque** : Le masque de saisie d'un champ est défini sous l'éditeur de fenêtres ou d'états, dans l'onglet "Général" de la description du champ. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MasqueSaisie.gif)
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) une variable de type [MasqueDeSaisie](../WDLang1/1000024886.md), permettant de gérer des masques de saisie avancés sur les champs de saisie, les combo avec saisie et les colonne d'un champ Table. 




![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Sous l'éditeur de fenêtres, pour les champs de saisie et les combos, il est possible d'utiliser une expression régulière pour construire le masque de validation : il suffit d'utiliser la chaîne "regexp:" avant l'expression régulière. Pour plus de détails, consultez [les remarques](#NOTE0_9).
...
<a name="champs_type_numerique_non_monetaires_ELTPARAGRAPHE000130"></a>**1. Masques de saisie prédéfinis**


|   |   |
| --- | --- |
| *maskBitcoin* | Masque numérique utilisé pour manipuler les Bitcoins. Le sigle correspondant au Bitcoin est affiché. <br><br>![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Cette constante n'est pas disponible. |
...
| *maskScientifique* | Masque numérique permettant d'utiliser la notation scientifique.<br><br>![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Cette constante n'est pas disponible. |
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Il est également possible de spécifier des masques de saisie hexadécimal (entre 0xF et 0xFFFFFFFFFFFFFFFFF). 
...
<a name="champs_type_monetaire_ELTPARAGRAPHE000260"></a>Les masques de saisie sont du même type que les masques numériques. La différence se situe dans la précision : les monétaires ont 17 chiffres significatifs pour la partie entière et 6 décimales maximum.
...
<a name="champs_type_monetaire_euro_ELTPARAGRAPHE000281"></a>Les masques de saisie sont du même type que les masques monétaires. Il est possible d'ajouter le caractère dollar ("$") dans le masque pour afficher la devise en cours.
...
### Champs de type Date
<a name="champs_type_date_ELTPARAGRAPHE000290"></a>Les masques de saisie pour les champs de type Date sont :
...
<a name="champs_type_heure_ELTPARAGRAPHE000402"></a>Les masques de saisie pour les champs de types heure sont :
...
<a name="champs_type_dateheure_ELTPARAGRAPHE000424"></a>Pour spécifier un masque de saisie de type DateHeure, il est nécessaire de :
...
<a name="champs_type_texte_sous_editeur_etats_ELTPARAGRAPHE000462"></a>Les masques définis sous l'éditeur d'états sont les suivants (onglet "Général" de la description du champ) :
...
<a name="champs_type_texte_sous_editeur_fenetres_ELTPARAGRAPHE000484"></a>
...
| *maskTelBelgique* | Numéro de téléphone au format Belge (avec gestion des indicatifs, des numéros nationaux et internationaux). <br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
| *maskTelCanada* | Numéro de téléphone au format Canadien ou Américain (XXX CCC-CCCC ou +1 XXX CCC-CCCC où XXX correspond au code régional et CCC-CCCC correspond au numéro local). <br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
| *maskTelFrance* | Numéro de téléphone au format Français (10 chiffres, regroupés par 2). Par exemple : "04 67 69 40 23" ou "36 99". |
| *maskTelSuisse* | Numéro de téléphone au format Suisse (0CC CCC CC CC ou +41 CC CCC CC CC).<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Cette constante n'est pas disponible. |
...
<a name="champs_type_jauge_ELTPARAGRAPHE000834"></a>Dans un champ de type Jauge, le masque de saisie permet de définir le formatage du texte affiché dans la jauge. Par défaut, le masque utilisé est "999,9 %". Il est possible d'utiliser les masques personnalisés disponibles pour un champ de type Texte.  
<a name="NOTE0_11"></a>


### Type de masque de saisie
<a name="type_masque_saisie_ELTPARAGRAPHE000841"></a>**Attention** : Le changement d'un masque peut se faire uniquement avec un masque de **même** type. Par exemple, il est impossible de remplacer le masque de saisie d'un champ de type DATE par un masque de saisie de type HEURE.
...
<a name="expressions_regulieres_dans_les_masques_saisie_ELTPARAGRAPHE000852"></a>Les expressions régulières utilisées dans cette propriété ne doivent pas être celles utilisées dans la fonction [VérifieExpressionRégulière](../WDLang1/3024032.md).
...
### Champ Tableur
<a name="champ_tableur_ELTPARAGRAPHE000906"></a>Le masque d'une cellule d'un champ Tableur peut être défini par la fonction [TableurTypeEtMasqueSélection](../WDLang1/1000021349.md). La propriété **MasqueSaisie** permet de modifier le masque de saisie défini (le type de la cellule n'est pas modifié). 
<a name="NOTE0_13"></a>


### Limites
<a name="limites_ELTPARAGRAPHE000919"></a>![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/us/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png) Dans un état, la propriété **MasqueSaisie** peut être utilisée uniquement sur :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Dans une fenêtre, la propriété **MasqueSaisie** s'applique uniquement aux :

- champs de saisie,

- colonnes de table,

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) colonnes de table affichées par un champ Combo.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/us/WBS.png) Cette propriété est disponible uniquement en Lecture / Ecriture pour les champs d'un état. Pour les champs d'une page, cette propriété n'est pas disponible. 

![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) En Java, la propriété **MasqueSaisie** s'applique uniquement aux éléments suivants :
...
[Le champ de saisie de type Date : Masques de saisie ou d'affichage](../Proprietes/1014016.md)

[Le champ Durée : Masques de saisie ou d'affichage](../Proprietes/1014019.md)

[Le champ Heure : Masques de saisie ou d'affichage](../Proprietes/1014017.md)

[Le champ Numérique ou Monétaire : Masques de saisie ou d'affichage](../Proprietes/1014015.md)

[Le champ Texte : Masques de saisie ou d'affichage](../Proprietes/1014014.md)

[Masques de saisie et masques d'affichage](../Proprietes/1014003.md)

[MasqueDeSaisie (Type de variable)](../Proprietes/1000024886.md)
