...
<a name="choix_des_langues_gerees_par_projet_analyse_ELTTEXTE000381"></a>
...
2. Affichez la fenêtre de description de l'analyse : sous le volet "Schéma des données", dans le groupe "Élément courant", cliquez sur "Description".
...
<a name="langues_gerees_par_les_differents_elements_projet_ELTPARAGRAPHE000112"></a>Par défaut, les différents éléments du projet (pages, états, code, classes, etc.) gèrent les mêmes langues que le projet dans lequel ils ont été créés.
...
<a name="saisie_interface_dans_les_differentes_langues_ELTTEXTE000417"></a>
...
<a name="langues_utilisant_alphabet_specifique_ELTPARAGRAPHE000183"></a>Si votre site gère des langues utilisant des alphabets spécifiques (Grec, Russe, etc.), il est nécessaire de saisir la traduction des différents messages multilingues en utilisant ces alphabets spécifiques.
...
3. Saisissez la traduction et validez. La ligne de code apparaît sous l'éditeur de code : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=code-drapeau.gif)


	- L'icône ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=code-drapeau%201.gif) indique que des traductions existent pour cette chaîne de caractères. Pour afficher la fenêtre de traduction, il suffit de cliquer sur cette icône.
...
<a name="choix_langue_par_programmation_ELTTEXTE000465"></a>
