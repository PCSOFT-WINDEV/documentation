...
<a name="gestionnaire_sources_ELTTEXTE000585"></a>
...
<a name="principe_utilisation_ELTPARAGRAPHE000063"></a>**Installation**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GestionnaireDeSources1.gif)
...
Pour profiter des modifications effectuées, les autres développeurs doivent synchroniser leur projet local avec le projet de référence (présent dans la base de sources).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=GestionnaireDeSources_synch.gif)
...
<a name="creer_une_base_sources_pour_gds_ELTTEXTE000615"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000109"></a>Pour partager un projet grâce au gestionnaire de sources, il est nécessaire de créer une base de sources. Cette base de sources doit être créée une seule fois sur un poste serveur.
...
<a name="quand_creer_une_base_sources_ELTPARAGRAPHE000142"></a>**La base de sources doit être créée une seule fois**.
...
### Sauvegardes
<a name="sauvegardes_ELTPARAGRAPHE000162"></a>Il est conseillé de faire régulièrement des sauvegardes de la base de sources du GDS. Ces sauvegardes peuvent être effectuées grâce à l'administrateur du GDS.
...
<a name="configurer_projet_pour_travailler_avec_gds_ELTTEXTE000651"></a>
...
<a name="ajouter_projet_dans_gds_ELTPARAGRAPHE000180"></a>**Pour ajouter un projet local dans le GDS** :
...
<a name="partage_ressources_ELTPARAGRAPHE000209"></a>Vous avez importé dans le gestionnaire de sources un premier projet. Ce projet contient des éléments partagés avec d'autres projets (classes, pages, procédures, feuilles de styles, etc.).
...
<a name="travailler_avec_gds_ELTTEXTE000687"></a>


### Options d'un projet concernant le GDS
<a name="options_projet_concernant_gds_ELTPARAGRAPHE000230"></a>Plusieurs options permettent de configurer un projet manipulé avec le Gestionnaire de Sources. Ces options sont regroupées dans l'onglet "GDS" de la description du projet (sous le volet "Projet", dans le groupe "Projet", cliquez sur "Description").
...
### Extraire un élément
<a name="extraire_element_ELTPARAGRAPHE000291"></a>**Les différents modes d'extraction**
...
<a name="reintegrer_element_ELTPARAGRAPHE000340"></a>Les éléments extraits du Gestionnaire de sources apparaissent entourés d'un trait rouge sous l'éditeur de projet.
...
<a name="modes_gestion_projet_ELTPARAGRAPHE000359"></a>Deux modes de gestion du projet sont disponibles avec le GDS :
...
<a name="travailler_mode_deconnecte_avec_gds_ELTTEXTE000729"></a>
...
<a name="administrateur_gds_ELTTEXTE000753"></a>
