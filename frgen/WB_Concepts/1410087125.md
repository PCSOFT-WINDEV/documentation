...
## Créer un champ
<a name="creer_champ_ELTTEXTE000630"></a>
...
| <br><br>- Champ Kanban,<br><br><br> | <br><br>- Champ Editeur de code,<br><br><br> |
...
<a name="creer_nouveau_champ_ELTPARAGRAPHE000149"></a>**Pour créer un champ** :
...
<a name="creer_champ_associe_une_rubrique_ELTPARAGRAPHE000164"></a>Mis à part les types de champs suivants, tous les champs d'une page peuvent être associés à une rubrique d'un fichier de données :
...
<a name="caracteristiques_champ_ELTTEXTE000666"></a>
...
<a name="affichage_des_caracteristiques_ELTPARAGRAPHE000210"></a>Pour afficher la fenêtre de description d'un champ :
...
<a name="caracteristiques_par_onglet_ELTPARAGRAPHE000228"></a>Ce paragraphe présente rapidement les différentes catégories de caractéristiques affichées par onglet.
...
<a name="manipuler_les_champs_sous_editeur_ELTTEXTE000702"></a>


### Les poignées des champs
<a name="les_poignees_des_champs_ELTPARAGRAPHE000298"></a>Lorsqu'un champ vient d'être créé ou lorsqu'il est sélectionné, il s'affiche avec des poignées. Les poignées permettent de :
...
<a name="manipulations_disponibles_ELTPARAGRAPHE000318"></a>L'éditeur de pages permet de :
...
<a name="alignement_des_champs_ELTTEXTE000732"></a>
...
### Grille magnétique
<a name="grille_magnetique_ELTPARAGRAPHE000353"></a>La grille magnétique permet de placer des repères (verticaux et horizontaux) dans la page. Les champs créés viennent se placer contre ces repères, comme si les champs et les repères étaient magnétisés. La grille magnétique permet ainsi d'aligner les champs selon les repères.
<a name="NOTE5_4"></a>


### Correcteur d'interface en temps réel
<a name="correcteur_interface_temps_reel_ELTPARAGRAPHE000362"></a>Lors du déplacement d'un champ dans une page, le correcteur d'interface en temps réel affiche automatiquement des guides. Ces guides sont magnétisés et permettent d'aligner le champ déplacé avec les champs présents dans la page.
<a name="NOTE5_5"></a>


### Correcteur d'interface avancé
<a name="correcteur_interface_avance_ELTPARAGRAPHE000371"></a>Le correcteur d'interface avancé est un outil permettant d'harmoniser la disposition des champs dans les différentes pages d'un site.
...
<a name="les_options_alignement_ELTPARAGRAPHE000382"></a>Pour aligner plusieurs champs, WEBDEV met à votre disposition :
...
<a name="zoom_parametrable_ELTPARAGRAPHE000426"></a>Il est possible de spécifier un facteur de zoom pour réduire ou agrandir l'affichage de la page en cours.
...
<a name="options_edition_des_champs_dans_une_page_ELTTEXTE000786"></a>
...
<a name="ancrer_champ_sous_editeur_ELTPARAGRAPHE000492"></a>Pour ancrer un champ :
...
3. Dans la fenêtre qui s'affiche, choisissez le type d'ancrage à utiliser. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ancrage_WebDev.gif&type=thumb)

	Trois types d'ancrages sont à définir :

	- ancrage en position : permet de définir la position du champ lors du redimensionnement du navigateur.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ancrage_Position_WB.gif)
	...
	- suivre le comportement du navigateur.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Ancrage_Largeur_WB.gif)
