...
- depuis Windows : sélectionnez l'option "Programmes .. WEBDEV 2026 .. Administrateur WEBDEV" depuis le menu "Démarrer".
...
<a name="interface_administrateur_webdev_ELTTEXTE000456"></a>
...
<a name="serveurs_websocket_installes_ELTPARAGRAPHE000160"></a>L'onglet "WebSockets" liste les différents serveurs de WebSockets WEBDEV installés sur le poste et gérés par l'administrateur WEBDEV. Pour chaque serveur de WebSockets, les informations suivantes sont affichées dans un tableau :
...
### Options avancées
<a name="options_avancees_ELTPARAGRAPHE000189"></a>L'onglet "Avancé" permet de paramétrer des fonctionnalités avancées au niveau du serveur :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=WDADMIN_Onglets%20-%20HC%20N%B0006.gif)
...
L'option **"Activer la page http[s]://&lt;serveur#XGTXLT#serveur#XGTXLT#serveur&gt;/" affiche une page présentant un lien vers chaque site installé sur le serveur.  
