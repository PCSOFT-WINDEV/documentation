...
## Présentation
<a name="presentation_ELTTEXTE000701"></a>
...
<a name="tester_projet_webdev_ELTTEXTE000725"></a>
...
- Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_GO_Projet_WB_bl.gif) parmi les boutons d'accès rapide.
...
- L'administrateur WEBDEV (WD310ADMIN.EXE).
	...
	**Remarque** : un test de projet peut être lancé depuis la page de test de l'administrateur (Onglet "Avancé" de WD310ADMIN, bouton "Page de test").
...
<a name="tester_projet_depuis_administrateur_webdev_ELTPARAGRAPHE000173"></a>Le lancement du test depuis l'administrateur WEBDEV (WD310Admin) permet par exemple de tester :
...
**Pour arrêter le test**, affichez l'administrateur WEBDEV (en cliquant sur l'icône 2026 présente dans la barre des tâches) et cliquez sur le bouton "Déconnecter" (onglet "Connexions").
...
<a name="tester_site_webdev_mode_awp_mode_session_distant_ELTTEXTE000761"></a>
...
## Tester une page
<a name="tester_une_page_ELTTEXTE000785"></a>
...
2. Cliquez sur ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ico_Go_Page_bl.gif) parmi les boutons d'accès rapide du menu de WEBDEV. Vous pouvez également utiliser le raccourci clavier F9.
...
## Tracer un projet
<a name="tracer_projet_ELTTEXTE000815"></a>
...
<a name="test_performances_ELTTEXTE000857"></a>
...
<a name="choisir_traitement_optimiser_ELTPARAGRAPHE000541"></a>Le choix du traitement à optimiser se fait en fonction de plusieurs critères :
...
<a name="tests_nonregression_ELTTEXTE000899"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000557"></a>Soucieux de la qualité des applications, plusieurs outils de tests sont à votre disposition :
...
### Tests automatiques
<a name="tests_automatiques_ELTPARAGRAPHE000571"></a>Chaque test est composé d'un scénario directement éditable dans l'interface du produit. Ce scénario est écrit en WLangage et peut être modifié à n'importe quel moment.
...
<a name="utilitaire_wdtestsite_ELTPARAGRAPHE000601"></a>WDTestSite est un utilitaire permettant de réaliser différents tests sur un site WEBDEV.
