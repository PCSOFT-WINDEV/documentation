...
| [Page précédente](../Concepts_WB/1410087461.md) | [Sommaire](../Concepts_WB/1410087102.md) | [Page suivante](../Concepts_WB/1410087463.md) |
| --- | --- | --- |
...
## Présentation
<a name="presentation_ELTTEXTE000560"></a>
...
<a name="comment_fonctionne_groupware_utilisateur_ELTTEXTE000584"></a>
...
Pour plus de détails sur la configuration du groupware par le superviseur consultez le chapitre [Le groupware utilisateur en pratique](#NOTE4_1).

**Remarque**: Toutes les informations concernant les utilisateurs et leurs droits sont stockées dans des tables au format HFSQL. 
...
<a name="mise_place_groupware_utilisateur_ELTTEXTE000620"></a>


### Ajouter le groupware utilisateur dans un site
<a name="ajouter_groupware_utilisateur_dans_site_ELTPARAGRAPHE000086"></a>
...
3. La fenêtre de paramétrage du groupware utilisateur permet d'activer le groupware utilisateur et de définir: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_WB%20Groupware%20U%20-%20HC%20N%B0001.gif&type=thumb)
...
Plusieurs types de groupware sont proposés: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_WB%20Groupware%20U%20-%20HC%20N%B0001%201.gif&type=thumb)
...
Plusieurs modes de lancement sont disponibles: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_WB%20Groupware%20U%20-%20HC%20N%B0001%202.gif&type=thumb)
...
<a name="options_groupware_utilisateur_classique_avec_serveur_authentification_ELTPARAGRAPHE000185"></a>

Plusieurs modes de personnalisation du groupware utilisateur sont disponibles: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_WB%20Groupware%20U%20-%20HC%20N%B0002.gif&type=thumb)


- **Pas de personnalisation**: toute la programmation du groupware utilisateur est automatiquement intégrée à votre site. Aucune personnalisation n'est possible. Le thème du projet est automatiquement appliqué à toutes les pages utilisées par le groupware utilisateur.
...
Pour plus de détails sur ces tables et leur configuration (répertoire d'installation, ...), consultez l'aide en ligne.




### Options spécifiques au groupware utilisateur classique
<a name="options_specifiques_groupware_utilisateur_classique_ELTPARAGRAPHE000223"></a>
...
En mode "groupware utilisateur classique", le groupware utilisateur utilise plusieurs tables spécifiques. Ces tables permettent notamment de gérer les utilisateurs, les groupes, les droits et les éléments du site. Le groupware utilisateur classique peut être utilisé:
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=P4_WB%20Groupware%20U%20-%20HC%20N%B0004.gif&type=thumb)



### Options spécifiques au groupware utilisateur avec serveur d'authentification
<a name="options_specifiques_groupware_utilisateur_avec_serveur_authentification_ELTPARAGRAPHE000264"></a>
...
<a name="tester_site_groupware_utilisateur_classique_ELTPARAGRAPHE000282"></a>
...
- Pour que la première page de votre site ne soit pas la page de login, cochez l'option "Lancement manuel par programmation" dans l'onglet "Général" des options du groupware Utilisateur. Il suffira d'utiliser la fonction du WLangage [gpwOuvre](../WDLang6/3041002.md) pour afficher la page de login.
...
- **Pour ne pas lancer le groupware utilisateur lors des tests du site**, il suffit de sélectionner l'option "Inactif" dans l'onglet "Général" des options du groupware utilisateur.
	Si vous rebranchez le groupware utilisateur par la suite, les tables utilisées précédemment pour le groupware utilisateur ne seront pas effacées.
...
<a name="installer_site_utilisant_groupware_utilisateur_classique_ELTPARAGRAPHE000310"></a>
...
Un écran spécifique au groupware utilisateur classique permet de configurer l'emplacement des tables propres au groupware utilisateur.
...
<a name="parametrer_site_utilisant_groupware_utilisateur_classique_ELTTEXTE000674"></a>
...
<a name="gerer_les_utilisateurs_ELTPARAGRAPHE000367"></a>
...
### Gérer les droits
<a name="gerer_les_droits_ELTPARAGRAPHE000400"></a>
...
### Afficher les statistiques
<a name="afficher_les_statistiques_ELTPARAGRAPHE000423"></a>
...
### Migrer des données
<a name="migrer_des_donnees_ELTPARAGRAPHE000432"></a>

A partir de la version 19, le groupware utilisateur a évolué. Les tables utilisées par le groupware utilisateur ne sont plus les mêmes.
...
<a name="conseils_pour_site_gerant_groupware_utilisateur_ELTTEXTE000722"></a>


### Utilisation de groupes de champs
<a name="utilisation_groupes_champs_ELTPARAGRAPHE000445"></a>
...
<a name="visibilite_des_champs_ELTPARAGRAPHE000460"></a>
...
<a name="definition_des_droits_ELTPARAGRAPHE000482"></a>

Pour obtenir une définition des droits correspondant aux fonctionnalités de votre site, il est conseillé:

- soit d'effectuer la configuration des droits voulue par le gestionnaire du site développé avant de créer la procédure d'installation. Il suffit alors d'ajouter les tables du groupware lors de la création de l'installation du site.
