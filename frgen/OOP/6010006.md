...
<a name="presentation_une_classe_ELTTEXTE000789"></a>
...
## Exemple de classe
<a name="exemple_classe_ELTTEXTE000813"></a>
...
Les informations affichées dans le volet "Explorateur de projet" sont les suivantes:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Classe_POO%20-%20HC%20N%B0001.gif)
...
<a name="creation_declaration_une_classe_ELTTEXTE000837"></a>


### Création d'une classe
<a name="creation_une_classe_ELTPARAGRAPHE000057"></a>
...
<a name="declaration_une_classe_ELTTEXTE000867"></a>
...
<a name="cas_particulier_declaration_des_membres_type_tableau_ELTPARAGRAPHE000178"></a>
...
<a name="serialisation_des_membres_une_classe_ELTPARAGRAPHE000225"></a>
...
<a name="immuabilite_des_membres_une_classe_ELTPARAGRAPHE000261"></a>
...
<a name="declaration_des_constantes_classe_ELTTEXTE000945"></a>


### Syntaxe
<a name="syntaxe_ELTPARAGRAPHE000293"></a>
...
<a name="detail_syntaxe_ELTPARAGRAPHE000300"></a>**&lt;Nom de la constante&gt;**
...
### Exemple
<a name="exemple_ELTPARAGRAPHE000315"></a>
...
<a name="creation_declaration_singleton_ELTTEXTE000981"></a>
...
<a name="creation_declaration_des_methodes_classes_ELTTEXTE001005"></a>


### Création d'une méthode de classe
<a name="creation_une_methode_classe_ELTPARAGRAPHE000341"></a>
...
<a name="syntaxe_declaration_une_methode_ELTPARAGRAPHE000389"></a>
...
### Détail de la syntaxe
<a name="detail_syntaxe_ELTPARAGRAPHE000396"></a>
...
<a name="suppression_une_methode_ELTPARAGRAPHE000483"></a>
...
<a name="creation_declaration_des_proprietes_ELTTEXTE001053"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000497"></a>
...
<a name="creation_une_propriete_classe_ELTPARAGRAPHE000512"></a>
...
<a name="droits_acces_une_propriete_ELTPARAGRAPHE000552"></a>
...
<a name="membres_proprietes_ELTPARAGRAPHE000568"></a>
...
### Héritage
<a name="heritage_ELTPARAGRAPHE000582"></a>
...
<a name="passage_proprietes_parametre_une_fonction_procedure_wlangage_ELTPARAGRAPHE000596"></a>
...
<a name="instances_classe_contexte_hfsql_independant_ELTTEXTE001113"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000634"></a>
...
### Syntaxe
<a name="syntaxe_ELTPARAGRAPHE000645"></a>La syntaxe à utiliser est la suivante:
...
- Le mot-clé "léger" provoque la copie immédiate d'une partie du contexte HFSQL. 
	Seuls les répertoires où se trouvent les tables en HFSQL Classic et/ou les connexions en HFSQL Client/Serveur sont mémorisés. 

- Le mot-clé "complet" provoque la copie immédiate du contexte HFSQL.
	Conseillé par exemple si le thread doit tenir compte des positions en cours dans les tables et requêtes du contexte de l'appelant.
...
### Utilisation
<a name="utilisation_ELTPARAGRAPHE000671"></a>
...
Il est déconseillé d'utiliser des instances de classes à contexte HFSQL indépendant pour simuler un alias sur une seule table HFSQL ou sur un enregistrement particulier d'une table HFSQL. La copie du contexte HFSQL porte en effet sur tous les éléments (les tables, vues, requêtes, connexions, etc.) du contexte et peut donc être très coûteuse en temps.
...
<a name="legende_des_icones_utilisees_ELTPARAGRAPHE000688"></a>
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ProcedurePublique.gif)<br> | Procédure publique |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ProcedureProtegee.gif)<br> | Procédure protégée |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=ProcedurePrivee.gif)<br> | Procédure privée |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MethVirtPublique.gif)<br> | Méthode virtuelle publique |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MethVirtProtegee.gif)<br> | Méthode virtuelle protégée |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MethVirtPrivee.gif)<br> | Méthode virtuelle privée |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MethStatPublique.gif)<br> | Méthode globale publique |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MethStatProtegee.gif)<br> | Méthode globale protégée |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=MethStatPrivee.gif)<br> | Méthode globale privée |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=213&name=Constante.gif)<br> | Constante |
...
<a name="nouveautes_depuis_version_9_ELTPARAGRAPHE000736"></a>
