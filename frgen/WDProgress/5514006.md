...
L'utilisation des fonctions SQL pour manipuler des données Progress n'implique pas une importation de la structure des fichiers dans le schéma des données. Cependant, les données doivent être manipulées uniquement par requêtes. Il n'est pas possible de lire directement le contenu des fichiers Progress.
...
<a name="configuration_administrateur_odbc_ELTTEXTE000177"></a>
...
## Programmation
<a name="programmation_ELTTEXTE000201"></a>


### 1. Ouverture de la connexion
<a name="1_ouverture_connexion_ELTPARAGRAPHE000038"></a>

La fonction [SQLConnecte](../WDLang4/3072005.md) permet d'ouvrir une connexion à une base de données Progress par le Connecteur Natif. Il est nécessaire de passer en paramètre à la fonction [SQLConnecte](../WDLang4/3072005.md) le type de la base utilisée, ici PROGRESS.
...
<a name="2_execution_requetes_ELTPARAGRAPHE000055"></a>
...
<a name="3_recuperation_resultat_ELTPARAGRAPHE000070"></a>
...
<a name="4_fermeture_connexion_ELTPARAGRAPHE000101"></a>
