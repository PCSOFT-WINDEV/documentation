...
**Attention** : Cette version du Connecteur Natif Progress ne fonctionne qu'avec WINDEV ou WEBDEV 2026. Ce Connecteur Natif est disponible uniquement en 32 bits.
...
<a name="configuration_necessaire_ELTTEXTE000172"></a>


### Conditions nécessaires à l'utilisation du Connecteur Natif Progress
<a name="conditions_necessaires_utilisation_connecteur_natif_progress_ELTPARAGRAPHE000022"></a>
...
<a name="les_fichiers_necessaires_ELTPARAGRAPHE000034"></a>Les fichiers nécessaires à l'utilisation du Connecteur Natif Progress sont :
...
- ***wd310prgs.dll*** : Nécessaire au Connecteur Natif à une base Progress. Ce fichier est livré avec le Connecteur Natif Progress.
...
<a name="connexion_une_base_progress_ELTPARAGRAPHE000046"></a>Le Connecteur Natif utilise la couche client Progress pour se connecter au serveur.
...
## Utilisation
<a name="utilisation_ELTTEXTE000208"></a>


### Utiliser le Connecteur Natif Progress dans vos applications WINDEV ou vos sites WEBDEV
<a name="utiliser_connecteur_natif_progress_dans_vos_applications_windev_vos_sites_webdev_ELTPARAGRAPHE000085"></a>Pour utiliser le Connecteur Natif Progress, il suffit de programmer :
...
[Connecteur Natif Progress: Programmation à l'aide des fonctions HFSQL](../WDProgress/5514001.md)

[Connecteur Natif Progress: Programmation à l'aide des fonctions SQL](../WDProgress/5514006.md)

[Connecteur Natif Progress : Spécificités et remarques ](../WDProgress/5514002.md)
