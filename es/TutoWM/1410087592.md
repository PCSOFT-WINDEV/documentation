...
| [Lección anterior](../TutoWM/1410087591.md) | [Tabla de contenido](../TutoWM/1410087586.md) | [Siguiente lección](../TutoWM/1410087593.md) |
| --- | --- | --- |
...
1. En la pestaña "Código", en el grupo "Procedimientos", despliegue "Nuevo" y seleccione "Nuevo procedimiento global". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=P3_WM_WLangage%20-%20HC%20N%B0002.jpg)


2. En la ventana que aparece, se muestra un nombre predeterminado para el conjunto de procedimientos globales. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=P3_WM_WLangage%20-%20HC%20N%B0003.jpg)
Conserve este nombre y valide (haga clic en "OK"). 

3. Aparece una nueva ventana que permite introducir el nombre del procedimiento y sus características: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=P3_WM_WLangage%20-%20HC%20N%B0004.jpg)
...
- Para llamar a un procedimiento, simplemente escriba el nombre de dicho procedimiento directamente en el código. Vamos a llamar al procedimiento desde el código de inicialización del proyecto:  
	...
	5. Probemos este código: haga clic en ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=ICO_GO_simu_PRJ_WM_GAF.jpg) en los botones de acceso rápido. 
...
7. Probemos este código: haga clic en ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=ICO_GO_simu_PRJ_WM_GAF.jpg) en los botones de acceso rápido. 
...
- Probemos esta funcionalidad en nuestro ejemplo: 
	...
	4. Probemos este código: haga clic en ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=ICO_GO_simu_PRJ_WM_GAF.jpg) en los botones de acceso rápido. 
