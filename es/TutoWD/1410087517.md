...
| [Lección anterior](../TutoWD/1410087516.md) | [Tabla de contenido](../TutoWD/1410087560.md) | [Siguiente lección](../TutoWD/1410087580.md) |
| --- | --- | --- |
...
- Si es necesario, abra el proyecto "WLanguage" de la primera lección (véase [Un proyecto para descubrir WLanguage](../TutoWD/1410087578.md) en la lección 2.1).
...
1. En la pestaña "Código", en el grupo "Procedimientos", despliegue "Nuevo" y seleccione "Nuevo procedimiento global". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=P2_Ma_premiere_procedure%20-%20HC%20N%B0001.jpg)
...
3. Aparece una nueva ventana que permite introducir el nombre del procedimiento y sus características: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=P2_Ma_premiere_procedure%20-%20HC%20N%B0003.jpg)
...
5. El procedimiento global "Welcome" aparece en el editor de código. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=P2_Ma_premiere_procedure%20-%20HC%20N%B0004.jpg)
...
- Para llamar a un procedimiento, simplemente escriba el nombre de dicho procedimiento directamente en el código. Vamos a llamar al procedimiento desde el código de inicialización del proyecto:  
	...
	5. Probemos este código: haga clic en ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=ICO_GO_Projet_WD_GAF.jpg) en los botones de acceso rápido. 

	6. Enseguida, aparece una ventana de información. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=P2_Ma_premiere_procedure%20-%20HC%20N%B0005.jpg)
...
7. Probemos este código: haga clic en ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=ICO_GO_Projet_WD_GAF.jpg) en los botones de acceso rápido. 
...
- Probemos esta funcionalidad en nuestro ejemplo: 
	...
	4. Probemos este código: haga clic en ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=ICO_GO_Projet_WD_GAF.jpg) en los botones de acceso rápido. 
...
- Haremos que el segundo parámetro sea opcional. De forma predeterminada, el IVA puede corresponder a 20 (otras tasas posibles son 10, 5,5 o 2,1). 
	...
	6. Probemos este código: haga clic en ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=ICO_GO_Projet_WD_GAF.jpg) en los botones de acceso rápido. 
