...
Nombre de XML Document a utilizar. Esta Document contiene el código XML y fue creada por [xmlDocument](../WDLang5/3081008.md). Si no se especifica este parámetro, la función **XMLNamespaceURI** se aplica al último documento XML manipulado en el hilo actual.  
