...
<a name="¿como_manejar_google_calendar_ELTTEXTE000330"></a>


### Gestionando un Google Calendar
<a name="gestionando_google_calendar_ELTPARAGRAPHE000037"></a>
...
<a name="creando_google_calendar_ELTPARAGRAPHE000058"></a>
...
4. Validar la creación de la Calendar con [GglWrite](../WDLang5/1000017401.md).
...
### Observación
<a name="observacion_ELTPARAGRAPHE000086"></a>
...
<a name="¿como_recuperar_google_calendar_sus_elementos_ELTTEXTE000366"></a>


### 1er método: recuperación de la lista de calendarios y recuperación de sus eventos
<a name="1er_metodo_recuperacion_lista_calendarios_recuperacion_sus_eventos_ELTPARAGRAPHE000100"></a>
...
2. Utilice la función [GglListCalendario](../WDLang5/1000017330.md). Esta función se utiliza para listar los calendarios disponibles. Los calendarios encontrados se asignan a las variables array de gglCalendar.

3. Utilice [GglFillCalendario](../WDLang5/1000017337.md) para recuperar los eventos. Los eventos pueden ser recuperados de un solo Calendar o de varios Calendar s. Los eventos a recuperar pueden ser filtrados (entre dos fechas, por ejemplo).
...
<a name="2º_metodo_recuperando_calendar_especifico_ELTPARAGRAPHE000130"></a>
...
2. Utilice la función [GglGetCalendario](../WDLang5/1000017410.md). Esta función se utiliza para recuperar el Google Calendar (y sus eventos) correspondiente al título especificado. 
...
## ¿Cómo añadir
<a name="¿como_anadir_ELTTEXTE000396"></a>
...
<a name="anadir_eventos_calendar_ELTPARAGRAPHE000169"></a>
...
4. Utilice [GglWrite](../WDLang5/1000017401.md) para actualizar la Calendar en el servidor.
...
<a name="modificando_los_eventos_calendar_ELTPARAGRAPHE000204"></a>
...
**Observación**: Puedes hacer varios cambios antes de usar [GglWrite](../WDLang5/1000017401.md).
...
<a name="borrar_evento_calendar_ELTPARAGRAPHE000234"></a>
...
**Observación**: Se pueden realizar varias supresiones antes de utilizar [GglWrite](../WDLang5/1000017401.md).
