...
3. Validar la creación de la Contact con [GglWrite](../WDLang5/1000017401.md).
...
2. Utilice la función [GglListContacto](../WDLang5/1000017344.md). Esta función se utiliza para listar los contactos. Los contactos encontrados se asignan a las variables array de gglContact.
