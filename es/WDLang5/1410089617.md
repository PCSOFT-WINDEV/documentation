...
- Se debe llamar a la función **xlsRecalculateAll** después de cambiar el valor o la fórmula de una o más celdas. Esta función actualiza los valores de las celdas en un libro que utiliza una fórmula.
