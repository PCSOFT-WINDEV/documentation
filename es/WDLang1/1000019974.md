...
Nombre de control Organigrama a utilizar. La control Organigrama es relacionado para una fuente de datos. En caso contrario (si la control se rellena mediante programación), **&lt;Organigrama de la organización&gt;.display** no tiene ningún efecto.
