...
Dibuja la cuerda de un círculo (intersección entre una elipse y una recta) en una variable de tipo [picLayer](../WDLang1/1000024604.md).
...
- La función **&lt;Variable picLayer&gt;.DrawChord** no está disponible en modo antialiasing (para obtener más detalles, consulte la ayuda sobre la función [&lt;Variable picLayer&gt;.ChangeMode](../WDLang1/1000024432.md)).

- La función **&lt;Variable picLayer&gt;.DrawChord** no está disponible para un dibujo con gestión del canal alfa (para obtener más información, consulte la ayuda de la función [&lt;Variable picLayer&gt;.StartDrawing](../WDLang1/1000024470.md)). Esta función no tiene ningún efecto.
...
La función **&lt;Variable picLayer&gt;.DrawChord** solo permite dibujar una cuerda: solo el contorno o área de la cuerda. Para dibujar una figura con relleno (sector delimitado por el centro del círculo y los dos puntos en el círculo), utilice la función [&lt;Variable picLayer&gt;.DrawSlice](../WDLang1/1000024561.md).
<a name="NOTE0_4"></a>
<a name="NOTE0_5"></a>
<a name="NOTE0_6"></a>
