...
Modifica la configuración de una control Cuadro de mando (definida en el editor) antes de su primera visualización.. Esto permite configurar y tener en cuenta los widgets declarados en la programación por [DashAddWidget](../WDLang1/1000020953.md).
...
- durante la primera llamada a **DashInitialConfiguration**, el tamaño del widget corresponde al tamaño de la ventana o página interna de origen (al menos 1 celda).
