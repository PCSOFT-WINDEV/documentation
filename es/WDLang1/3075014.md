...
**Observación**: Esta función es equivalente a la función [InsertLine](../WDLang1/1000017352.md).
...
Si &lt;índice de inserción&gt; es igual al número de filas del array + 1, el fila se añade en la última posición del array (equivalente al [ArrayAddLine](../WDLang1/3075013.md)). 
...
Cuando se llama a la función **ArrayInsertLine**:
...
```
Las filas insertadas mediante **ArrayInsertLine** se insertan automáticamente entre las filas existentes en el array.
