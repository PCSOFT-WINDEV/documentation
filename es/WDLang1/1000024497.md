...
Identifica el color de un pixel en una variable de tipo [WDPic](../WDLang1/1000023503.md).
...
Obtener los componentes del color devuelto por la función **&lt;Variable WDPic&gt;.PixelColor**:
