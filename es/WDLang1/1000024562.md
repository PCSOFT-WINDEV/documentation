...
Dibuja el sector de un círculo o elipse en una variable de tipo [WDPic](../WDLang1/1000023503.md) (en la capa de fondo).![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) **Atención**: Se requiere una configuración específica para usar esta función en Linux. Para obtener más información, consulte [Los dibujos](../WDLang1/3029035.md). 
<a name="Example1"></a>
...
Para dibujar una figura sin relleno (sin tener en cuenta el centro del círculo), utilice la función [&lt;Variable WDPic&gt;.DrawChord](../WDLang1/1000024468.md).
<a name="NOTE0_3"></a>
