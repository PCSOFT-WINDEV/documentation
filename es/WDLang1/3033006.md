...
**Observación**: El texto de una divisa se muestra en los controles de tipo "Monetario + Euro" si la máscara de entrada lo permite (se indica el signo $).
...
Leyenda de la moneda especificada.

**`<Currency>: (Entero o constante)`**

Identificador de la moneda o associated constante con la moneda (ver las Notas).  
...
### Intercambio tabla
<a name="intercambio_tabla_ELTPARAGRAPHE000051"></a>
