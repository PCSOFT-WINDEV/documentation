...
La control Agenda debe ser relacionado para una fuente de datos.. En caso contrario (si la control se rellena mediante programación), **OrganizerDisplay** no tiene efecto.  
