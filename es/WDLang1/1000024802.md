...
### Condiciones de uso
<a name="condiciones_uso_ELTPARAGRAPHE000345"></a>

La función **&lt;Tabla&gt;.CollapseExpand** puede utilizarse en: 
...
<a name="rama_contraer_expandir_ELTPARAGRAPHE000371"></a>

La función **&lt;Tabla&gt;.CollapseExpand** no tiene ningún efecto:
...
- Si el parámetro &lt;Fila manipulada&gt; o &lt;Rama manipulada&gt; corresponde a la rama de la primera fila, la jerarquía del control Tabla TreeView se contrae (equivalente a la función [&lt;Tabla&gt;.CollapseAll](../WDLang1/1000021847.md)) o expande (equivalente a la función [&lt;Tabla&gt;.ExpandAll](../WDLang1/1000021834.md)).

- Cuando se llama a la función **&lt;Tabla&gt;.CollapseExpand**, si la rama especificada está expandida y tiene un procedimiento asociado mediante la propiedad [AddChildDelayed](../Proprietes/1000020927.md), se ejecutará el procedimiento.
...
<a name="gestion_banda_seleccion_contraer_ELTPARAGRAPHE000417"></a>

**Para los controles Tabla TreeView**:

- Si la banda de selección estaba sobre un elemento del nodo a contraer, la banda se posiciona en el nodo contraído o expandido después de llamar a la función **&lt;Tabla&gt;.CollapseExpand**.
...
<a name="gestion_banda_seleccion_expandir_ELTPARAGRAPHE000434"></a>

La función **&lt;Tabla&gt;.CollapseExpand** no cambia la posición de la banda de selección.
<a name="NOTE0_5"></a>


### Velocidad de ejecución para controles Tabla TreeView
<a name="velocidad_ejecucion_para_controles_tabla_treeview_ELTPARAGRAPHE000446"></a>
