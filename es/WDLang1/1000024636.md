...
Declara el color y estilo predeterminado de las líneas, rectángulos y círculos, ... en una variable de tipo [WDPic](../WDLang1/1000023503.md) (en la capa de fondo).
...
- Esta opacidad se tendrá en cuenta si el dibujo en el control Imagen se inicializó con la constante *dWithOpacity* (función [&lt;Variable WDPic&gt;.StartDrawing](../WDLang1/1000024471.md)).
