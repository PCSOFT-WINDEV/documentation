...
Obtener los componentes del color devuelto por la función **&lt;Variable Image&gt;.PixelColor**:
...
### Función &lt;Variable Image&gt;.PixelColor, barras de desplazamiento y zoom automáticos
<a name="funcion_docparampagetitleshort_barras_desplazamiento_zoom_automaticos_ELTPARAGRAPHE000531"></a>

La opción "Barras de desplazamiento y zoom automáticos", disponible en los controles Imagen, no es compatible con la función **&lt;Variable Image&gt;.PixelColor**. Si se utiliza esta opción en el control Imagen, la función **&lt;Variable Image&gt;.PixelColor** inmoviliza la imagen. El zoom y las barras de desplazamiento también se inmovilizan.
<a name="NOTE0_5"></a>
<a name="NOTE0_6"></a>
