...
El elemento encontrado no está seleccionado. Para seleccionar el elemento encontrado, utilice la función [&lt;Caja de lista&gt;.SelectPlus](../WDLang1/1000017414.md).
...
<a name="busqueda_seleccion_control_list_box_ELTPARAGRAPHE000435"></a>Si las opciones utilizadas para rellenar el control List Box se definen en la ventana description del control (pestaña "Contenido"), se puede utilizar la siguiente sintaxis para buscar y seleccionar un elemento en un control List Box:
