...
Declara el color y estilo predeterminado de las líneas, rectángulos y círculos, ... en una variable de tipo [picLayer](../WDLang1/1000024604.md).
...
- Esta opacidad se tendrá en cuenta si el dibujo en el control Imagen se inicializó con la constante *dWithOpacity* (función [&lt;Variable picLayer&gt;.StartDrawing](../WDLang1/1000024470.md)).
