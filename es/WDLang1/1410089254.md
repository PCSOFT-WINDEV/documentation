...
Dibuja texto Markdown en una variable de tipo [Image](../WDLang1/1000019650.md).
<a name="Example1"></a>
...
En modo antialiasing ([&lt;Variable Image&gt;.ChangeMode](../WDLang1/1000024039.md)) o en modo opacidad ([&lt;Variable picLayer&gt;.StartDrawing](../WDLang1/1000024470.md)), la función **&lt;Variable Image&gt;.DrawTextMarkdown** solo está disponible para las fuentes TrueType.
