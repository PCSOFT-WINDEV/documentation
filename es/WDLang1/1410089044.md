...
La función **&lt;DiskFile Variable&gt;.Leer** genera un error en los siguientes casos:
...
La función **&lt;DiskFile Variable&gt;.Leer** lee los elementos especificados a partir de la posición actual. Una vez ejecutado **&lt;DiskFile Variable&gt;.Leer**, la posición actual es set al último byte leído.

Observación: Para leer siempre el principio del archivo, debe llamar a [&lt;Variable DiskFile&gt;.Seek](../WDLang1/1410089048.md) y luego a **&lt;DiskFile Variable&gt;.Leer**.
