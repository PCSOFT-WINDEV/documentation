...
<a name="parametros_del_degradado_ELTPARAGRAPHE000815"></a>Los parámetros de color se utilizan de la siguiente manera:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=drectangledegrade.gif)
