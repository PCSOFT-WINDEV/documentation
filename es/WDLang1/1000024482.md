...
Nombre de la variable de tipo [WDPic](../WDLang1/1000023503.md) en la que se realizará la combinación. Solo se manipulará la capa de fondo. Durante la combinación, esta imagen será considerada como la imagen de fondo.
...
- La función **&lt;Variable WDPic&gt;.AlphaBlend** combina las imágenes y conserva el canal alfa de la imagen de destino. Por lo tanto, no se utiliza el canal alfa de la imagen de origen.
