...
Nombre del procedimiento WLanguage ("callback") al que se llama después de cerrar la ventana. Para obtener más información sobre este procedimiento, consulte [Parámetros del procedimiento utilizado por la función OpenAsynchronous](../WDLang1/1410087805.md). 
