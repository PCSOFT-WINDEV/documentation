...
- para reanudar un archivo pausado por [MultimediaPause](../WDLang1/1000017207.md).
	Observación: Para poner en pausa la reproducción de un archivo multimedia, debe haberse iniciado mediante [MultimediaOpen](../WDLang1/1000017206.md) seguido de MultimediaPlay, especificando únicamente el nombre del control. 
