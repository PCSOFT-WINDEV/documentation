...
Observación: Esta función es equivalente a la función [gLinkActivate](../WDLang1/3029036.md). 
...
- Si la obtención de valores definidos con la función [gStoredValue](../WDLang1/1410088363.md) está activada en el control COMBO_COMBO1 (&lt;Activo&gt; = False): 
	COMBO_COMBO1.Value devuelve el número de pedido en el COMBO_COMBO1 control.
...
- Si **gStoredValueEnable**()=True, [ListSeek](../WDLang1/3049003.md) tiene en cuenta los valores añadidos por [gStoredValue](../WDLang1/1410088363.md).

- Si **gStoredValueEnable**()=False, [ListSeek](../WDLang1/3049003.md) ignora los valores añadidos por [gStoredValue](../WDLang1/1410088363.md). La búsqueda se realiza sobre el valor visualizado. 
