...
Observación: Esta función es equivalente a la función [StringToNum](../WDLang1/1410087852.md). 
<a name="Example1"></a>
...
**`<Initial string>: (Cadena de caracteres o memoria intermedia)`**
...
### Rango de conversión
<a name="rango_conversion_ELTPARAGRAPHE000118"></a>

**Val** convierte una cadena en un número entero si el valor está entre -9.223.372.036.854.775.808 y 9.223.372.036.854.775.807.
<a name="NOTE0_2"></a>


### Función Val y UNICODE
<a name="funcion_val_unicode_ELTPARAGRAPHE000129"></a>
...
Si un carácter de &lt;Cadena inicial&gt; no se reconoce como parte de un número, la función **Val** deja de leer la &lt;Cadena inicial&gt; y devuelve el número que corresponde a los caracteres ya leídos.
