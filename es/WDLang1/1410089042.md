...
### Gestión de errores
<a name="gestion_errores_ELTPARAGRAPHE000347"></a>

La función **&lt;DiskFile Variable&gt;.WriteLine** genera un error en los siguientes casos:
...
**Atención**: La función **&lt;DiskFile Variable&gt;.WriteLine** solo puede utilizarse en archivos de texto. Esta función no soporta el 0 binario (la operación de escritura se detiene).
<a name="NOTE0_2"></a>
...
<a name="modo_funcionamiento_windows_vista_posterior_ELTPARAGRAPHE000373"></a>
...
<a name="posicion_fichero_ELTPARAGRAPHE000396"></a>
...
La función **&lt;DiskFile Variable&gt;.WriteLine** escribe los elementos especificados a partir de la posición actual. Una vez ejecutado **&lt;DiskFile Variable&gt;.WriteLine**, la posición actual es set al último byte escrito.
<a name="NOTE0_4"></a>


### Gestión del formato ANSI/UNICODE
<a name="gestion_del_formato_ansiunicode_ELTPARAGRAPHE000422"></a>

La función **&lt;DiskFile Variable&gt;.WriteLine** permite escribir: 
...
| Función **&lt;DiskFile Variable&gt;.WriteLine** | ANSI | No se requiere conversión antes de la operación de escritura | Conversión automatic de la cadena antes de la operación de escritura |
