...
- La función **&lt;Variable Image&gt;.DrawChord** no está disponible en modo antialiasing (para obtener más detalles, consulte la ayuda sobre la función [&lt;Imagen&gt;.ChangeMode](../WDLang1/1000023997.md)).

- La función **&lt;Variable Image&gt;.DrawChord** no está disponible para un dibujo con gestión del canal alfa (para obtener más información, consulte la ayuda de la función [&lt;Imagen&gt;.StartDrawing](../WDLang1/1000024326.md)). Esta función no tiene ningún efecto.
...
La función **&lt;Variable Image&gt;.DrawChord** solo permite dibujar una cuerda: solo el contorno o área de la cuerda. Para dibujar una figura con relleno (sector delimitado por el centro del círculo y los dos puntos en el círculo), utilice la función [&lt;Imagen&gt;.DrawSlice](../WDLang1/1000024011.md).
<a name="NOTE0_4"></a>
<a name="NOTE0_5"></a>
<a name="NOTE0_6"></a>
