...
### Gestión de errores
<a name="gestion_errores_ELTPARAGRAPHE000345"></a>

La función **&lt;DiskFile Variable&gt;.Write** genera un error en los siguientes casos:
...
<a name="modo_funcionamiento_windows_vista_posterior_ELTPARAGRAPHE000367"></a>
...
<a name="retorno_carro_final_line_ELTPARAGRAPHE000390"></a>

[&lt;DiskFile Variable&gt;.WriteLine](../WDLang1/1410089042.md) se utiliza para insertar automáticamente un retorno de carro (CR) al final del Line añadido. Para insertar un Retorno de carro (CR) con **&lt;DiskFile Variable&gt;.Write**, basta con utilizar la constante *CR*.
...
<a name="posicion_fichero_ELTPARAGRAPHE000414"></a>
...
La función **&lt;DiskFile Variable&gt;.Write** escribe los elementos especificados a partir de la posición actual. Una vez ejecutado **&lt;DiskFile Variable&gt;.Write**, la posición actual es set al último byte escrito.

Observación: Para leer siempre el inicio, hay que llamar a [&lt;Variable DiskFile&gt;.Seek](../WDLang1/1410089048.md) y luego a [&lt;DiskFile Variable&gt;.Leer](../WDLang1/1410089044.md).
