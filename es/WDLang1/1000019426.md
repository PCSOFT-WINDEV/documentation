...
La control Planificador debe ser relacionado para una fuente de datos.. En caso contrario (si la control se rellena mediante programación), **Visualización del planificador** no tiene ningún efecto.
