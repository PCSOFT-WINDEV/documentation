...
Observación: Esta función es equivalente a la función [.Delete](../WDLang1/1000024289.md). La única diferencia es la gestión de la animación.<a name="Example1"></a>
...
<a name="eliminacion_registros_una_tabla_control_tabla_treeview_basada_archivo_datos_ELTPARAGRAPHE000275"></a>
...
<a name="integridad_referencial_tabla_treeview_controles_tabla_basado_archivo_datos_ELTPARAGRAPHE000287"></a>

Si la gestión de integridad referencial está habilitada ( [&lt;Variable Connection&gt;.SetIntegrity](../WDLang4/1000023960.md) ), [HErrorIntegrity](../WDLang4/3044086.md) debe estar llamado después de **&lt;Tabla&gt;.DeleteWithAnimation** para comprobar la integridad.
...
<a name="eliminacion_registros_una_control_tabla_basada_archivo_datos_trigger_ELTPARAGRAPHE000309"></a>
...
### Gestión de errores
<a name="gestion_errores_ELTPARAGRAPHE000324"></a>
...
<a name="bloquear_archivo_datos_relacionado_ELTPARAGRAPHE000346"></a>
...
<a name="supresion_registros_una_control_tabla_rellenada_mediante_programacion_con_filtro_contiene_ELTPARAGRAPHE000358"></a>
