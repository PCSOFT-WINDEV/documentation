...
|   |   |
| --- | --- |
| *asBinary* | Búsqueda binaria. <br>Este modo de búsqueda es rápido, pero debe utilizarse en un array ordenado de forma ascendente con el mismo comparison Procedure o con un Procedure equivalente (véase [&lt;Array&gt;.Sort](../WDLang1/1000024318.md)). |
...
Los siguientes parámetros son los valores de búsqueda pasados como el parámetro a la función **&lt;Array&gt;.SeekByProcedure**. 
