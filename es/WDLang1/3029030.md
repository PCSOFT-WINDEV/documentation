...
Voltea la imagen con respecto a un eje vertical (simetría con respecto a un eje vertical). Esta imagen puede corresponder a: 
...
La simetría se realiza con respecto al eje vertical central del control o de la imagen. La imagen se modifica directamente.
...
Si se llama a las funciones [dEndDrawing](../WDLang1/3029019.md) y **dVerticalSymmetry** en el mismo proceso, no se mostrarán los cambios de la imagen.
<a name="NOTE0_2"></a>
<a name="NOTE0_3"></a>
