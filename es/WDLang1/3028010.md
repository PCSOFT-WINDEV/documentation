...
La creación de un enlace "caliente" con un dato significa que el programa recibirá el nuevo valor de los datos de relacionado del servidor (programa conectado) cada vez que se modifiquen los datos de relacionado.. Por lo tanto, debe bifurcarse a un procedimiento en respuesta al DDE Event utilizado para modificar un dato relacionado ([DDEEvent](../WDLang1/3028009.md) con el *DDEtoModify* Event).
<a name="Example1"></a>
...
- Si se especifica &lt;Timeout&gt;, hay un delay de &lt;Timeout&gt; segundos antes de salir de **DDELink**.
