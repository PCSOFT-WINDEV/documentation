...
**Observación**: Esta función es equivalente a la función [ArrayMoveLine](../WDLang1/3075016.md).
...
Índice del primer fila a intercambiar.

**`<Index of 2nd row>: (Integro)`**

Índice del segundo fila para intercambiar.
