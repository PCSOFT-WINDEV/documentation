...
### Esperar a que finalice la ejecución del hilo (utilizar el nombre del hilo)
...
Nombre del hilo que debe llegar al final de su ejecución. Este nombre se asigna al ejecutar el hilo (con la función [ThreadExecute](../WDLang1/3077024.md)). 
