...
- Para añadir elementos al final de una control Tabla, utilice [&lt;Tabla&gt;.AddLine](../WDLang1/1000023404.md) o [&lt;Tabla&gt;.AddLineWithAnimation](../WDLang1/1000023678.md).
...
### Condiciones de uso
<a name="condiciones_uso_ELTPARAGRAPHE000276"></a>

La función **&lt;Tabla&gt;.InsertLineWithAnimation** puede utilizarse en:
...
<a name="caracteristicas_los_elementos_fila_ELTPARAGRAPHE000304"></a>
...
<a name="posicion_fila_insertada_ELTPARAGRAPHE000322"></a>
...
<a name="limitaciones_numero_maximo_filas_mostradas_ELTPARAGRAPHE000344"></a>
...
<a name="control_tabla_tabla_treeview_basado_archivo_datos_modificaciones_archivo_datos_relacionado_ELTPARAGRAPHE000356"></a>
...
<a name="control_tabla_tabla_treeview_basado_archivo_datos_insertar_varias_filas_ELTPARAGRAPHE000380"></a>

Cada vez que se llama a la función **&lt;Tabla&gt;.InsertLineWithAnimation** en un control Tabla o Tabla TreeView basado en un archivo de datos, se crea una fila virtual en el control. La información se guardará en el archivo de datos al llamar a la función [&lt;Tabla&gt;.Save](../WDLang1/1000024249.md).

Si se llama a la función **&lt;Tabla&gt;.InsertLineWithAnimation** sucesivamente en el mismo proceso sin llamar a la función [&lt;Tabla&gt;.Save](../WDLang1/1000024249.md), solo la PRIMERA llamada es efectiva (las siguientes llamadas son ignoradas). Solo se agrega una fila al control Tabla/Tabla TreeView basado en un archivo de datos.
<a name="NOTE0_7"></a>


### Control Tabla/Tabla TreeView en edición
<a name="control_tablatabla_treeview_edicion_ELTPARAGRAPHE000406"></a>

Si se llama a la función **&lt;Tabla&gt;.InsertLineWithAnimation**:
...
<a name="insercion_imagenes_ELTPARAGRAPHE000424"></a>
