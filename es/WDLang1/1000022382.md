...
- al llamar a la función [&lt;Cámara&gt;.Stop](../WDLang1/1000022381.md).
...
### Guardar una foto
<a name="guardar_una_foto_ELTPARAGRAPHE000326"></a>

Solo se guardará en formato BMP la imagen que se muestra al ejecutar la función **&lt;Cámara&gt;Captura**. Para guardar esta imagen, también se puede utilizar:

- la función [&lt;Image&gt;.SaveBMP](../WDLang1/1000024341.md): la foto se guardará como un archivo BMP.

- la función [&lt;Image&gt;.SaveGIF](../WDLang1/1000024342.md): la foto se guardará como un archivo GIF.

- la función [&lt;Image&gt;.SaveJPEG](../WDLang1/1000024344.md): la foto se guardará como un archivo JPEG.
...
### Condiciones de uso: 
<a name="condiciones_uso_ELTPARAGRAPHE000357"></a>
