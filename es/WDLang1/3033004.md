...
Identificador de la moneda o associated constante con la moneda (ver las Notas). Si no se especifica este parámetro, la función devuelve el valor del tipo de cambio de la moneda cuyo identificador es "1" (el franco francés por Default).  
