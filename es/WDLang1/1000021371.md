...
Guarda la configuración de los paneles dinámicos encontrados en un control Pestaña en formato de cadena de caracteres.. Esta configuración puede ser restaurada por [TabLoadConfiguration](../WDLang1/1000021370.md). 
<a name="Example1"></a>
