...
- Si  es mayor que el número de Token s en el control, el Token se añade al final de los Token s existentes ([&lt;Editar&gt;.AddToken](../WDLang1/1000024043.md)).
...
- Para añadir una Token en la posición del cursor, utilice [&lt;Editar&gt;.AddToken](../WDLang1/1000024043.md). 
