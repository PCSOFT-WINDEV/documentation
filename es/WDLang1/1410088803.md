...
srcImg = dCrop(srcImg, SLD_SRC_TL, SLD_SRC_TL, srcImg.Width - SLD_SRC_TL, ...
...
**`<Image>: (Control Imagen, variable de tipo Image o WDPic)`**

Imagen a transformar. Esta imagen puede corresponder a: 

- un control Imagen, 

- una variable de tipo [Image](../WDLang1/1000019650.md), 

- una variable de tipo [picLayer](../WDLang1/1000024604.md), 

- una variable de tipo [WDPic](../WDLang1/1000023503.md). 


Esta imagen contiene el resultado de la transformación.
