...
Para obtener más información sobre este procedimiento, consulte [Parámetros del procedimiento utilizado por la función TreeListItem](../WDLang1/1000024659.md). 
...
<a name="interrupcion_docparampagetitleshort_ELTPARAGRAPHE000092"></a>

La función **TreeListItem** no se puede interrumpir si no se han navegado todos los elementos "hijo".

Para forzar la interrupción de la navegación realizada por **TreeListItem**, utilice la siguiente línea de código en &lt;WLanguage Procedure&gt;:
...
En este caso, la función **TreeListItem** devuelve el número de elementos encontrados hasta que se llame a "RESULT False".
