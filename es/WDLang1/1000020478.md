...
### Función NoLeftCharacter y UNICODE
...
**Observación**: Si el resultado de la función **NoLeftCharacter** de una cadena ANSI se asigna a una cadena UNICODE (y viceversa), la conversión se realizará implícitamente.
