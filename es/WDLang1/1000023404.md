...
- Para añadir una fila en una posición concreta, utilice [&lt;Tabla&gt;.InsertLine](../WDLang1/1000023407.md).

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Para añadir una fila con una animación, utilice [&lt;Tabla&gt;.AddLineWithAnimation](../WDLang1/1000023678.md).
...
- **Si la entrada en cascada no está habilitada**, el archivo de datos relacionado con el control no se modifica. Para escribir el contenido de la nueva fila en el archivo de datos relacionado, utilice la función [&lt;Tabla&gt;.Save](../WDLang1/1000024249.md) después de la función **&lt;Tabla&gt;.AddLine**.
...
Cada vez que se llama a la función **&lt;Tabla&gt;.AddLine** en un control Tabla o Tabla TreeView basado en un archivo de datos, se crea una fila virtual en el control. La información se guardará en el archivo de datos relacionado solo cuando se llame a la función [&lt;Tabla&gt;.Save](../WDLang1/1000024249.md).

Si se llama a la función **&lt;Tabla&gt;.AddLine** sucesivamente en el mismo proceso sin llamar a la función [&lt;Tabla&gt;.Save](../WDLang1/1000024249.md), solo la PRIMERA llamada es efectiva (las siguientes llamadas son ignoradas). Solo se agrega una fila al control Tabla/Tabla TreeView basado en un archivo de datos.
...
Si se llama a la función **&lt;Tabla&gt;.AddLine**:
