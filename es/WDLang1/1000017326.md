...
- Para añadir un elemento al final del cuadro de lista (o Combo Box) control, utilice [&lt;Caja de lista&gt;.add](../WDLang1/1000017319.md).

- La función **&lt;Insertar** puede utilizarse en controles List Box de selección única y múltiple
...
Utilice [&lt;Caja de lista&gt;.add](../WDLang1/1000017319.md) en lugar de **&lt;Insertar** para añadir un elemento a un control List Box ordenado.

<a name="NOTE0_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Código de Usuario (UMC)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 

### Tabulaciones: Multiselección control List Box
<a name="tabulaciones_multiseleccion_control_list_box_ELTPARAGRAPHE000409"></a>Para gestionar las tabulaciones en una control List Box (alineación de columnas), utilice la constante TAB. Por ejemplo:
...
**Observación**: La posición de las tabulaciones se define al llamar a la función **&lt;Insertar** por primera vez. Estas posiciones se tomarán como reference para todos los valores añadidos a partir de entonces. Del mismo modo, si se han tecleado valores introducidos en el editor, las posiciones de estos valores se toman como reference. Durante la primera llamada a **&lt;Insertar**, se aconseja definir el ancho de las columnas con [.completa](../WDLang1/1410089823.md). Por ejemplo, para fijar el ancho de las columnas que se encuentran en "LIST_Customer" a 10 caracteres:
