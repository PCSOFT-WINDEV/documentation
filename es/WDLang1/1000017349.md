...
- de una propiedad array de un tipo de variable bidimensional (([xlsDocument](../WDLang5/1000017464.md) variable por ejemplo).




**Observación**: Esta función es equivalente a la función [ArrayAddLine](../WDLang1/3075013.md).
...
AddLine(MyArray, "A", "B", "C")
AddLine(MyArray, "a", "b", "c")
AddLine(MyArray, "D", "E", "F")
...
### Agregar una fila a un array
<a name="agregar_una_fila_array_ELTPARAGRAPHE000104"></a>

Cuando se llama a la función **AddLine**:

- el número de filas del array incrementa automáticamente para incluir la nueva fila.

- el número de columnas del array no aumenta. En este caso, seleccione una de las siguientes opciones: 
...
- si es necesario, los elementos se convierte en el tipo de los otros elementos del array.
	**Observación**: Cuando se declara un array de N por M elementos, este array contiene N filas vacías. Por ejemplo, el array declarado a continuación contiene 3 filas vacías.
	...
	Las filas añadidas mediante **AddLine** se añaden automáticamente después de las filas existentes en el array
...
<a name="agregar_una_fila_una_propiedad_array_tipo_avanzado_ELTPARAGRAPHE000131"></a>

Cuando se llama a la función **AddLine**:

- se debe crear la propiedad array de la variable de tipo avanzado.

- el tipo avanzado debe tener un enumerador de tipo de colección modificable.

- la propiedad array de tipo avanzado se amplía automáticamente para obtener la nueva fila.
