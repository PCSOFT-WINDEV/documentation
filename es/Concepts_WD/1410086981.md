...
| [Página anterior](../Concepts_WD/1410086980.md) | [Tabla de contenido](../Concepts_WD/1410087098.md) | [Página siguiente](../Concepts_WD/1410086982.md) |
| --- | --- | --- |
...
Para obtener más información sobre cómo crear un modelo UML, consulte [Modelos UML](../Concepts_WD/1410087064.md).
...
La programación se simplifica: por ejemplo, las ventanas, los reportes, los controles Tabla o Combo Box pueden estar basados en las consultas.
...
Para obtener más información sobre cómo crear una ventana, consulte [Ventanas en la práctica](../Concepts_WD/1410086974.md).
...
El editor de ayuda permite crear un conjunto de páginas de ayuda (archivo "CHM") basado en el proyecto.

Una página de ayuda se crea por cada ventana del proyecto. Estas páginas permiten describir las diferentes operaciones que pueden realizar los usuarios.
...
- Compilación de páginas de ayuda y creación de un archivo CHM.
