...
| [Página anterior](../Concepts_WD/1410086987.md) | [Tabla de contenido](../Concepts_WD/1410087098.md) | [Página siguiente](../Concepts_WD/1410086989.md) |
| --- | --- | --- |
...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
El desarrollo de un gran sistema informático requiere la participación de varios desarrolladores. Los desarrolladores deben trabajar en un solo proyecto WINDEV y compartir diferentes recursos (consultas, clases, etc.).
...
<a name="administrador_codigo_fuente_ELTTEXTE000486"></a>


### Presentación
<a name="presentacion_ELTPARAGRAPHE000023"></a>

WINDEV cuenta con características innovadoras para la gestión del trabajo en equipo en el Administrador de Código Fuente (también llamado SCM).
...
<a name="crear_repositorio_para_scm_ELTTEXTE000575"></a>
...
<a name="¿cuando_crear_repositorio_ELTPARAGRAPHE000054"></a>

**El repositorio se debe crear solo una vez**.
WINDEV le permite crear el repositorio en diferentes momentos:
...
Una vez creado el repositorio, se pueden importar en él todos los proyectos WINDEV que se van a compartir.
<a name="NOTE3_3"></a>


### Copias de seguridad
<a name="copias_seguridad_ELTPARAGRAPHE000072"></a>
...
### Compartir recursos
<a name="compartir_recursos_ELTPARAGRAPHE000119"></a>

Ya se ha importado un primer proyecto en el Administrador de Código Fuente. Este proyecto contiene elementos compartidos con otros proyectos (clases, ventanas, procedimientos, hojas de estilo, análisis, etc.).
...
## Trabajar con el SCM
<a name="trabajar_con_scm_ELTTEXTE000671"></a>


### Opciones de proyectos relacionados con el SCM
<a name="opciones_proyectos_relacionados_con_scm_ELTPARAGRAPHE000140"></a>

Existen varias opciones para configurar un proyecto agregado al Administrador de Código Fuente. Estas opciones están disponibles en la pestaña "SCM" de la descripción del proyecto (opción "Descripción" en la pestaña "Proyecto"). Estas opciones están seleccionadas de forma predeterminada.
...
### Extraer un elemento
<a name="extraer_elemento_ELTPARAGRAPHE000193"></a>
...
2. En la pestaña "General", la opción "" permite pasar los siguientes proyectos que serán abiertos al modo automático.
...
<a name="reintegrar_elemento_ELTPARAGRAPHE000242"></a>
...
<a name="modos_gestion_del_proyecto_ELTPARAGRAPHE000261"></a>
...
En este caso, el Administrador de Código Fuente le permite reintegrar todos los elementos del proyecto (incluido el archivo .WDP). 
...
Todos los usuarios del proyecto (maestro o invitados) pueden cambiar las características del proyecto (primera ventana del proyecto, animaciones, estilo de código, etc.). Sin embargo, solo el maestro del proyecto podrá reintegrar estos cambios en el Administrador de Código Fuente.
...
<a name="trabajar_sin_conexion_con_scm_ELTTEXTE000713"></a>
...
<a name="administrador_del_scm_ELTTEXTE000737"></a>
...
- borrar, guardar y restaurar un repositorio, etc.

- agregar diferentes tipos de archivos al repositorio (.doc, .xls, .pdf, etc.).
