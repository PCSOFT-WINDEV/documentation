...
| --- | --- |
| Antes de cerrar un documento | Corre antes de cerrar el Document en el lector de PDF control. Este Event no se ejecuta cuando el control se gestiona a través de las funciones de control de PDF Reader (por ejemplo, al abrir un nuevo Document con [PDFReaderOpen](../WDLang1/1000023452.md)). |
| Después de cargar un Document | Corre después de cargar un Document en el lector de PDF control. Este Event no se ejecuta cuando el control se gestiona a través de las funciones de control de PDF Reader (por ejemplo, al abrir un Document con [PDFReaderOpen](../WDLang1/1000023452.md)). |
| Refrescar la cinta | Ejecutar cuando la cinta debe ser refrescada (para mostrar el número de páginas que se encuentran en el PDF Document por ejemplo). <br><br> |
