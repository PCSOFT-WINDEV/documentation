...
## Eventos associated con un control multimedia
...
|   | Se ejecuta cada vez que se realiza una operación de lectura en el control (mediante el botón de lectura, el botón de pausa o el botón de parada). |
| Fin de la lectura | Corre cuando llegue al final del archivo multimedia. |
...
## Eventos opcionales
<a name="eventos_opcionales_ELTTEXTE000157"></a>
