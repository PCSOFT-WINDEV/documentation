...
## Eventos associated con un editor de imágenes control
...
| --- | --- |
| Antes de cerrar un documento | Corre antes de cerrar la imagen en el Editor de Imágenes control. |
| Después de cargar un Document | Ejecutar una vez que la imagen fue cargada en el Editor de Imágenes control. |
...
### Opcional Event: Después de ejecutar el OCR en la región seleccionada
<a name="opcional_event_despues_ejecutar_ocr_region_seleccionada_ELTPARAGRAPHE000076"></a>

El control del Editor de imágenes incluye una opción específica Event: "Después de ejecutar el OCR en la región seleccionada". Esta Event configura una acción específica que se realiza cuando el usuario selecciona "OCR" en la cinta del editor de Image. Mediante Default, el texto sobre el que se ejecuta el OCR se copia en el portapapeles. Este evento permite realizar una Process específica sobre el texto recuperado, por ejemplo. 
