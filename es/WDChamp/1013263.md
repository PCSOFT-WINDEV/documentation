...
## Columna de contenedores en una control Tabla
...
<a name="¿como_crear_una_columna_contenedor_una_control_tabla_ELTTEXTE000356"></a>


### Etapas a seguir
<a name="etapas_seguir_ELTPARAGRAPHE000085"></a>
...
<a name="control_principal_una_columna_contenedores_ELTPARAGRAPHE000103"></a>
...
- Las adiciones, las modificaciones, ... realizado a través de la programación: el valor de la columna especificada en [TableAddLine](../WDLang1/3074006.md), por ejemplo, se asignará al control principal.
...
<a name="usando_una_columna_contenedores_ELTTEXTE000398"></a>


### control Tabla basada en un archivo de datos o control Tabla basada en Variable
<a name="control_tabla_basada_archivo_datos_control_tabla_basada_variable_ELTPARAGRAPHE000162"></a>
...
<a name="control_tabla_rellenado_mediante_programacion_ELTPARAGRAPHE000182"></a>
...
Por ejemplo, cuando un fila es añadido por [TableAddLine](../WDLang1/3074006.md), sólo el control principal de la columna será asignado con el valor definido por la columna. Si se deben inicializar varios controles en la columna, se debe utilizar la sintaxis descrita en el párrafo siguiente. Por ejemplo:
...
<a name="manejo_los_controles_que_encuentran_columna_contenedor_ELTPARAGRAPHE000202"></a>Los controles que se encuentran en una columna Contenedor pueden manejarse a través de la siguiente sintaxis:
...
<a name="limite_tipos_control_disponibles_ELTTEXTE000434"></a>
