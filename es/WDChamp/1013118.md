...
## Eventos associated con controles de barra de desplazamiento
...
<a name="eventos_utilizados_forma_predeterminada_ELTTEXTE000107"></a>
...
| Siempre que se modifique | Ejecutar siempre que el cursor de la barra de desplazamiento se mueva, independientemente de si este movimiento se realiza con el ratón o mediante los botones de flecha. |
| Fin de modificación | Ejecutar cuando finalice el movimiento del cursor de la barra de desplazamiento. |
...
## Eventos opcionales
<a name="eventos_opcionales_ELTTEXTE000131"></a>
