...
## Manipulación de una control Agenda mediante programación (sintaxis del prefijo)
...
WINDEV y WEBDEV incluyen las funciones [OrganizadorXXX](../WDLang1/1000022884.md) a los controles del organizador manipular. 
...
<a name="manejo_control_agenda_mediante_programacion_ELTTEXTE000171"></a>


### Añadir una Appointment
<a name="anadir_una_appointment_ELTPARAGRAPHE000194"></a>

Puede añadir una Appointment a una control Agenda utilizando [&lt;Organizador&gt;.AddAppointment](../WDLang1/1000022894.md). Esta función acepta dos sintaxis: 
...
<a name="rellenar_control_agenda_con_los_datos_encontrados_archivo_datos_hfsql_ELTPARAGRAPHE000234"></a>

Los registros se almacenan en un archivo de datos HFSQL. El control Agenda se puede rellenar inicialmente recorriendo el el archivo de datos mediante la sintaxis FOR EACH y añadiendo cada Appointment mediante [&lt;Organizador&gt;.AddAppointment](../WDLang1/1000022894.md).
...
<a name="recuperacion_una_lista_citas_ELTPARAGRAPHE000262"></a>

La función [&lt;Organizador&gt;.lista de citas](../WDLang1/1000022886.md) permite obtener: 
...
<a name="visualizacion_control_agenda_partir_una_fecha_especifica_ELTPARAGRAPHE000302"></a>

Para visualizar la control Agenda a partir de una fecha determinada, utilice [&lt;Posición](../WDLang1/1000022897.md).
...
<a name="borrar_una_appointment_ELTPARAGRAPHE000325"></a>

[&lt;Organizador&gt;.DeleteAppointment](../WDLang1/1000022877.md) permite eliminar: 
...
[&lt;Organizador&gt;.DeleteAll](../WDLang1/1000022898.md) borra todas las citas de la control Agenda.


### Modificando la visualización de la control
<a name="modificando_visualizacion_control_ELTPARAGRAPHE000355"></a>

La visualización actual de una control Agenda se puede modificar mediante las siguientes funciones: 

- [&lt;Organizador&gt;.DisplayPeríodo anterior](../WDLang1/1000022878.md) y [&lt;Organizador&gt;.DisplayNextPeriodo](../WDLang1/1000022896.md): Estas dos funciones se utilizan para modificar el período de visualización (igual que el botón de giro que se encuentra en la parte superior de control Agenda).. 

- [&lt;Organizador&gt;.ChangeMode](../WDLang1/1000022879.md): Esta función cambia el modo de visualización del control: día, semana, mes.

- [&lt;TiempoDisplayed](../WDLang1/1000022892.md): Esta función se utiliza para definir el período de tiempo visualizado.
...
<a name="uso_del_menu_contextual_aaf_ELTTEXTE000381"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Posibilidades del menú contextual
<a name="posibilidades_del_menu_contextual_ELTPARAGRAPHE000406"></a>
...
<a name="uso_avanzado_eventos_con_procedimientos_ELTPARAGRAPHE000435"></a>
...
<a name="propiedades_especificas_los_controles_del_organizador_ELTTEXTE000490"></a>
