...
## Eventos associated con controles Control de número
...
| Incremento | Ejecutar cuando se pulsa el botón de incremento de la Control de número (botón derecho para un giro horizontal, botón inferior para un giro vertical) o una de las teclas de flecha del teclado. |
| Disminución | Ejecutar cuando se pulsa el botón de decremento de la Control de número (botón izquierdo para un giro horizontal, botón superior para un giro vertical) o una de las teclas de flecha del teclado. |
