...
## Eventos control Procesador de texto
...
## Eventos de Default
<a name="eventos_default_ELTTEXTE000129"></a>
...
| Siempre que se cambie la selección | Se ejecuta cuando se cambia la selección en la control Procesador de texto. |
| Refrescar la cinta | Ejecutar cuando la cinta debe actualizarse (para mostrar las características del texto seleccionado, por ejemplo).. |
| Después de cargar un Document | Corre después de cargar una Document en la control Procesador de texto. |
| Antes de cerrar un documento | Corre antes de cerrar una Document en la control Procesador de texto. |
| Siempre que se modifique | Ejecutar cada vez que se modifique la control Procesador de texto. |
...
## Eventos opcionales
<a name="eventos_opcionales_ELTTEXTE000153"></a>
