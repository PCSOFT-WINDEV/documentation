...
## Manejar una control Hoja de cálculo a través de la programación (en una ventana) (sintaxis del prefijo)
...
Para manipular a control Hoja de cálculo mediante programación, WINDEV propone el [Funciones Hoja de cálculo](../WDLang1/1000023883.md). 
...
<a name="manejo_control_hoja_calculo_mediante_programacion_ELTTEXTE000150"></a>


### Inicialización de una control Hoja de cálculo
<a name="inicializacion_una_control_hoja_calculo_ELTPARAGRAPHE000173"></a>
...
|   |   |
| --- | --- |
| [Hoja de cálculoAñadir Fórmula](../WDLang1/1000023713.md) | Añade una fórmula de cálculo a un control Hoja de cálculo que se encuentra en una ventana. |
...
- Al cargar un archivo de Excel (en formato XLSX) al inicializar el control ([&lt;Hoja de cálculo&gt;.load](../WDLang1/1000023719.md)). 
...
<a name="manejo_control_hoja_calculo_ELTPARAGRAPHE000223"></a>
...
Se pueden utilizar varios [Funciones de WLanguage](../WDLang1/1000023883.md) y [propiedades](../WDChamp/1000033003.md) para manipular el control Hoja de cálculo.
...
<a name="manejo_las_celdas_una_control_hoja_calculo_mediante_programacion_ELTTEXTE000240"></a>
<a name="NOTE3_3"></a>


### Manipulación de las células de la control Hoja de cálculo
<a name="manipulacion_las_celulas_control_hoja_calculo_ELTPARAGRAPHE000263"></a>**Para manipular una celda de un control Hoja de cálculo mediante la programación** , utilice las siguientes notaciones: 
...
- la función [Hoja de cálculoAddData](../WDLang1/1000023711.md). 
...
<a name="consejo_fusion_celdas_mediante_programacion_ELTPARAGRAPHE000320"></a>
...
```
Observación: [&lt;Hoja de cálculo&gt;.GetMerge](../WDLang1/1000023731.md) se utiliza para averiguar si una celda está fusionada con otras y para recuperar el rango de celdas fusionadas. 
<a name="NOTE2_5"></a>


### Gestionar los nombres de las celdas de un control Hoja de cálculo
<a name="gestionar_los_nombres_las_celdas_control_hoja_calculo_ELTPARAGRAPHE000350"></a>La control Hoja de cálculo propone varias funciones para manejar los nombres de las celdas: 
...
<a name="gestionar_los_comentarios_control_hoja_calculo_ELTPARAGRAPHE000395"></a>
...
<a name="control_hoja_calculo_manejar_archivo_que_contenga_varias_hojas_trabajo_traves_programacion_ELTTEXTE000466"></a>
...
- Tiene la posibilidad de cargar las diferentes hojas de trabajo de un archivo XLSX ([&lt;Hoja de cálculo&gt;.load](../WDLang1/1000023719.md)). 
...
<a name="propiedades_especificas_los_controles_hoja_calculo_ELTTEXTE000596"></a>
