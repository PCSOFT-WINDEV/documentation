...
## Características de las columnas de una control Tabla en una ventana (sintaxis del prefijo)
...
|   |   |
| --- | --- |
| <br><br>- texto<br><br>- Moneda<br><br>- momento<br><br>- [Combo Box](../WDChamp/9500152.md)<br>	<br><br>- Image<br><br>- Barra de progreso<br>	![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) No disponible.<br><br><br> | <br><br>- Numeric<br><br>- salir con<br><br>- Pie de foto<br><br>- Casilla de verificación<br>	<br><br>- Duración<br>	<br><br>- [Contenedor](../WDChamp/1013332.md)<br>	(no disponible en Java y en WINDEV Mobile)<br><br><br> |
...
<a name="imagen_del_titulo_columna_ELTPARAGRAPHE000272"></a>Esta opción permite definir la Image que se utilizará como Image de fondo del título de la columna. 
...
- Puede cambiar el tamaño de las columnas con [&lt;Table&gt;.Adjust](../WDLang1/1000023840.md).
...
|   |   |
| --- | --- |
| [&lt;Tabla de vista de árbol&gt;.SortChild](../WDLang1/1000021939.md) | Permite ordenar una rama de un control Tabla TreeView en una o varias columnas (ordenación lexicográfica). |
| [&lt;Tabla&gt;.ordenación](../WDLang1/1000024293.md) | Se usa para ordenar el contenido de una Tabla o control Tabla TreeView en una o más columnas. |
...
### Columna móvil
<a name="columna_movil_ELTPARAGRAPHE000390"></a>El usuario podrá mover la columna en el control Tabla y cambiar el orden en que se muestran las columnas..

<a name="NOTE2_4"></a>


### Buscar (Buscar Icon / Filtrar)
<a name="buscar_buscar_icon_filtrar_ELTPARAGRAPHE000403"></a>El usuario podrá implementar un filtro "Starts with" en la columna. Sólo se mostrarán los elementos que empiezan con las letras escritas para la columna.. 
...
- al utilizar las funciones de exportación ([&lt;Tabla&gt;.ToExcel](../WDLang1/1410088379.md), [&lt;Tabla&gt;.ToClipboard](../WDLang1/1410088375.md), [&lt;Tabla&gt;.ToText](../WDLang1/1410088376.md), [&lt;Tabla&gt;.ToWord](../WDLang1/1410088377.md) y [&lt;Table&gt;.ToXML](../WDLang1/1410088378.md)).
