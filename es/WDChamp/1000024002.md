...
## Eventos associated con un control Zona multilínea
...
| Selección (clic) de una Line | Ejecutar cuando se seleccione un fila (o se haga clic en él).<br><br>Atención: este Event no se ejecuta en los siguientes casos:<br><br>- si el fila contiene un control que puede ganar el foco.<br><br>- si la gestión de la selección de fila está configurada en "Sin selección" (pestaña "General" en la ventana de control de description).<br><br><br> |
