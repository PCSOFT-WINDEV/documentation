...
Para manipular controles Cuadro de mando mediante programación, WINDEV, WEBDEV y WINDEV Mobile incluyen [funciones específicas de los Cuadros de mando](../WDLang1/1000022537.md). 
...
- la función [&lt;Panel de control&gt;.AddWidget](../WDLang1/1000022502.md) para definir el widget a agregar. 

- la función [&lt;Tablero de control&gt;Configuración inicial](../WDLang1/1000022525.md) para configurar la posición del widget en la configuración inicial. 
...
- Actualizar el widget con la función [.Display](../WDLang1/1000022500.md).
