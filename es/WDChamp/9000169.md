...
2. Insert a Navigation Bar control: on the "Creación" tab, in the "Navegación" group, click "Barra de nav.". Then, click in the middle of the page. The control appears in the editor. This control includes 3 sections: 
...
2. On the "Página" tab, in the "Descripción" group, expand "Modelos" and select "List of templates used". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=RWD%20sur%20page%20existante%203%20-%20HC%20N%B0002.gif)
...
2. On the "Página" tab, in the "Descripción" group, expand "Modelos" and select "List of templates used". 
...
**First step**: Update the page from the template (in order for the page to switch to Responsive Web Design mode): on the "Página" tab, in the "Descripción" group, expand "Modelos" and select "List of templates used". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=RWD%20sur%20page%20existante%205%20-%20HC%20N%B0002.gif)
...
**First step**: Update the page from the template (in order for the page to switch to Responsive Web Design mode): on the "Página" tab, in the "Descripción" group, expand "Modelos" and select "List of templates used". Click the update button on the right (double blue arrow) and validate.
