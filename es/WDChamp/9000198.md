...
- the computer running the application must be running Windows 8 or higher. If the computer uses an earlier version, the controls placed in the title bar will not be displayed.

- in TSE, the workstation must use Windows Server 2016 at least. 
...
2. In the "Style" tab, check "Personalizar barra de título". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=Barre_titre_personnalis%E9e%20-%20HC%20N%B0001.gif&type=thumb)
You can: 
	...
	- **Mostrar título**: If this option is checked, the window title will be displayed in the custom title bar.

	- **Personalizar posición del menú principal**: By default, the main menu is located at a standard position (X and Y values) in the title bar. These values can be modified (title bar height, menu X and Y position) to customize the title bar.
...
### Remarks and tips
<a name="remarks_and_tips_ELTPARAGRAPHE000078"></a>
...
- Depending on the desired UI, you can also hide the icon and system menu via the "Mostrar ícono y menú del sistema" option in the "Style" tab of the window description. 
