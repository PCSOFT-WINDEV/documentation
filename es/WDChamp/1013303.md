...
## Manipular una pestaña dinámica mediante programación
...
WINDEV permite manipular controles Pestaña dinámica mediante programación con las [funciones TabXXX](../WDLang1/1000021391.md) y diferentes propiedades WLanguage. También puede utilizar la control Pestaña Variable directamente en el código. 
...
- mediante programación con la función [TabOpen](../WDLang1/1000021369.md). 
...
2. La ventana interna que se abre con el botón "+" puede ser: 
	...
	- **una ventana interna específica** (por ejemplo, un formulario de cliente). 
			...
			Observación: Si la ventana interna espera parámetros, la pestaña debe abrirse con la función [TabOpen](../WDLang1/1000021369.md). 

	- **ninguna ventana interna**. 
			En este caso, la ventana interna a abrir debe especificarse mediante programación. Para ello, debe utilizar la función [TabOpen](../WDLang1/1000021369.md) en el evento "Creación de una pestaña" del control Pestaña (consulte el párrafo [Abrir una pestaña utilizando la función TabOpen](#NOTE2_3)).  
...
Observación: El botón "+" de la pestaña dinámica llama automáticamente al evento "Creación de una pestaña" del control Pestaña. Si el evento utiliza la función [TabOpen](../WDLang1/1000021369.md), tendrá prioridad sobre la ventana interna especificada en la interfaz.
<a name="NOTE2_3"></a>
...
También puede utilizar la función [TabOpen](../WDLang1/1000021369.md) para abrir una pestaña. 
...
La función [TabOpen](../WDLang1/1000021369.md) permite: 
...
- En el código de clic del botón utilizado para elegir el tipo de pestaña, utilice la función [ChangeSourceWindow](../WDLang1/3038053.md) con la siguiente sintaxis: 
...
- La función [TabStatus](../WDLang1/1000021637.md) obtiene el estado de una pestaña dinámica: activo, flotante, inexistente. 
...
## Obtener el texto de la pestaña dinámica activa
...
## Recuperación del nombre de la ventana interna mostrada en un panel
