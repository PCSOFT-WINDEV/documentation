...
## Eventos associated con controles de Applet Java
...
| Clic (Código navegador) | Corre cuando el usuario de la web haga clic en el control. |
...
## Eventos opcionales
<a name="eventos_opcionales_ELTTEXTE000119"></a>
