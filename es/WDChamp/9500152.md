...
- en el código con la función [&lt;Caja de lista&gt;.add](../WDLang1/1000017319.md), en el evento de inicialización del control Tabla, por ejemplo.
...
Para seleccionar un elemento de la columna Combo Box, simplemente especifique el índice del elemento. Este índice puede ser utilizado por las [funciones de gestión de controles Tabla](../WDLang1/1000024319.md).
...
- modificar la 5ª fila con [&lt;Tabla&gt;.ModifyLine](../WDLang1/1000024275.md): 
