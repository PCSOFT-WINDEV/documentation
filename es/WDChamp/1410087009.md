...
## Eventos associated con una nota reposicionable control
...
## Eventos de Default
<a name="eventos_default_ELTTEXTE000108"></a>
...
| Fin de modificación | Ejecutar al final de la modificación realizada por el usuario (durante la salida de la control). |
