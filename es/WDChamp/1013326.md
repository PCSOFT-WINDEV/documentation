...
## Manejo de una control TreeView mediante programación (sintaxis de prefijo)
...
- Varias funciones de WLanguage son específicas para la gestión de los controles de TreeView. Para obtener más información, consulte [las funciones de gestión de los controles TreeView](../WDLang1/1000023876.md).

- También tiene la posibilidad de manipular un elemento encontrado en una control TreeView a través de la programación. Para obtener más información, consulte [Manipulación de un elemento de una control TreeView mediante programación](../WDChamp/1013327.md).
...
Para inicializar una control TreeView, basta con describir todos los elementos del árbol con [&lt;Vista de árbol&gt;.add](../WDLang1/1000023422.md).
