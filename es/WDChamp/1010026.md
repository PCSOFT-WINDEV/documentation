...
1. Open the window with parameters in the window editor: on the "Inicio" tab, in the "General" group, click "Abrir".

2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=Ico_Go_Fenetre_WD_bl.gif) in the quick access buttons (or press F9). The following window is displayed:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=fen%EAtre_param%E9tr%E9e%20-%20HC%20N%B0001.gif)
