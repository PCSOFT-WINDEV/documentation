...
<a name="modo_funcionamiento_ELTPARAGRAPHE000081"></a>
...
- Si un Control Popup aparece en un control Celda, el Control Popup ya no puede ser utilizado a través de la programación, excepto con [PopupAnimate](../WDLang2/1000020313.md).

- El Control Popup mostrado no se mantiene cuando se vuelve a mostrar la página.. Si se utiliza un control Botón servidor (no AJAX) para actualizar la página, se debe utilizar la función **PopupAnimate** para volver a mostrar el control Popup correcto.
