...
**Observación**: Para mostrar una ventana emergente se puede utilizar Page, **PopupDisplayPage**: 
...
- La Page mostrada puede ocultarse con [PopupClosePage](../WDLang2/1410087259.md).

- Los navegadores no actualización la visualización en medio de un código JavaScript: **PopupDisplayPage** y [PopupClosePage](../WDLang2/1410087259.md) deben utilizarse en diferentes eventos/procesos. Si estas funciones se utilizan en el mismo Event/Process, el Page no se visualiza.

- No es posible abrir dos páginas emergentes al mismo tiempo utilizando **PopupDisplayPage**. 
...
- Los procesos AJAX de la Page mostrada por **PopupDisplayPage** sólo pueden actualizar los controles en esta misma Page. Para actualizar el contenido de los controles en la Page que llama a **PopupDisplayPage**, puede:

	1. crear un navegador Procedure en el Page que llama **PopupDisplayPage**. El Procedure tomará los nuevos datos como parámetros y los asignará a los controles del Page.

	2. llamar a este navegador Procedure en los procesos del Page mostrados por **PopupDisplayPage** pasando los nuevos valores como parámetros.
