...
**UploadCurrentFileSize** sólo puede utilizarse en el navegador Event "Progreso de la transferencia". Este Event es associated: 
...
Al utilizar la función **UploadCurrentFileSize** en otro evento, devolverá 0.
<a name="NOTE0_2"></a>
