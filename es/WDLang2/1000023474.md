...
- Consejo: Para conocer el número de la fila utilizada (clic en un botón de la ventana interna, por ejemplo), cree un atributo en el control Looper y asígnele el resultado de la función **<Looper>.AddIW**. 
