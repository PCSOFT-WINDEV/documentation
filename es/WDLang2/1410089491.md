...
- Si &lt;Index&gt; es mayor que el número de filas, la fila se insertará en la última posición del control Looper. En este caso la función **&lt;Looper&gt;.InsertIP** equivale a la función [&lt;Looper&gt;.AddIP](../WDLang2/1410089490.md).
...
- Consejo: Para obtener el número de una fila determinada (por ejemplo, cuando se hace clic en un botón de la página interna), cree un atributo en el control Looper y asigne el resultado de la función **&lt;Looper&gt;.InsertIP** a este atributo. 
