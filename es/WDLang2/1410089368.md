...
- Consejo: Para obtener el número de una fila determinada (por ejemplo, cuando se hace clic en un botón de la página interna), cree un atributo en el control Looper y asigne el resultado de la función **LooperModifyIP** a este atributo. 
