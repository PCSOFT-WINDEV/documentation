...
- Saisie d'email avec jetons. 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=WB-Champ-Metier-Iframe-PDF%20BIS.gif&type=thumb)
...
Comme il s'agit d'un Champ Métier, le code source est livré et totalement modifiable et paramétrable. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=WB-Champ-Metier-Combo-Quantite-Amazon-Passant-En-Mode-Saisie.gif&type=thumb)
...
Tous les éléments sont paramétrables. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=WB-Champ-Metier-Agenda-Timeline.gif&type=thumb)
...
En version 27, la rotation des champs est visible directement dans l'éditeur de pages. <br>![Les champs inclinés sont visualisés dans l'éditeur de pages](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=WB-Rotation-des-champs-Edition.jpg)
...
Il suffit d'utiliser les propriétés [LargeurRessource](../Proprietes/1000020110.md) et [HauteurRessource](../Proprietes/1000020109.md), LargeurDate et HauteurDate. <br>![Un champ Planning avec WEBDEV 27](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=WB%20-%20Planning%20Hauteur%20ressource%20par%20prog.gif)
...
Ces pages sont proposées à la création de page vierge. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=WB%20-%20Page%20pr%E9d%E9finie.gif)
...
Il est possible d'éditer le champ directement depuis cette liste. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=WB%20-%20RWD%20fen%20toutes%20les%20surcharges.jpg)
...
La notion de Cluster permet d'installer autant de serveurs d'application que désiré, et ainsi de répartir la charge du site entre ces serveurs. 
		...
		L'installation d'un cluster est simple, elle s'effectue en 4 étapes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=Serveur%20Application%20Cluster.gif)
...
<a name="json"></a>
		...
		Les nouvelles fonctions WLangage [JSONVersXML](../WDLang5/1410087330.md) et [XMLVersJSON](../WDLang5/1410087331.md) disponibles en code Serveur permettent de convertir facilement le Json et le XML d'un format à l'autre.
...
| [IADétecte](../WDLang6/1410087942.md) | [IAModèleDétecte](../WDLang6/1410087982.md) | [JSONVersXML](../WDLang5/1410087330.md) |
