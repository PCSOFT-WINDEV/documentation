...
- **SourceToPage** no lee registros en el archivo de datos. El valor de la Record cargado en memoria se utiliza para actualizar los controles. Por lo tanto, un Record debe ser cargado en memoria previamente (con [HRead](../WDLang4/3044047.md), [HReadSeek](../WDLang4/3044050.md), [HReadFirst](../WDLang4/3044051.md), etc.).
...
<a name="vinculacion_elemento_tipos_fijaciones_ELTPARAGRAPHE000108"></a>

Existen dos tipos de vínculos entre una control y un artículo

- *unión directa*: En este caso, **SourceToPage** transfiere el valor de los elementos del Record cargado en la memoria al control enlazado f006c00 , sin leer ningún valor.
...
### Varios
<a name="varios_ELTPARAGRAPHE000122"></a>

- Los caracteres de espacio en los elementos HFSQL se mantienen.

- **SourceToPage** actualiza los controles Image vinculados a elementos de memo Image .

- **SourceToPage** no está disponible en vistas. Los valores de los elementos deben asignarse a cada control.
