...
- **<Window>.ToSource** no se puede usar para escribir en el archivo de datos: las variables del archivo de datos sólo pueden ser actualizadas (es decir, las variables de la Record cargadas en memoria). Para modificar los registros, utilice [&lt;Fuente&gt;.Add](../WDLang4/1000024187.md), [&lt;Fuente&gt;.Modify](../WDLang4/1000025038.md), [&lt;Fuente&gt;.Write](../WDLang4/1000024331.md), etc.
...
- Para asignar automáticamente el valor NULL a un elemento con la función **<Window>.ToSource**:
...
- Los elementos del archivo de datos que no están vinculados a un control no se actualizan con **<Window>.ToSource** .

- Si varios controles en la ventana están vinculados al mismo elemento del archivo de datos, es posible que **<Window>.ToSource** no actualice correctamente el elemento vinculado. ***No se recomienda vincular varios controles de ventana al mismo elemento.***

- **<Window>.ToSource** no actualiza elementos o variables con los valores de los controles Image. Utiliza la función [&lt;Fuente&gt;.LinkMemo](../WDLang4/1000024194.md).

- **<Window>.ToSource** no está disponible en las vistas.
