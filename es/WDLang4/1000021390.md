...
- Los elementos del archivo de datos que no están vinculados a un control no se actualizan con **&lt;Página&gt;.ToFile** .

- Si varios controles en Page están vinculados al mismo elemento del archivo de datos, es posible que **&lt;Página&gt;.ToFile** no actualice correctamente el elemento vinculado. ***No se recomienda vincular varios controles Page al mismo elemento.***

- **&lt;Página&gt;.ToFile** no actualiza los elementos con los valores de los controles Image. Utiliza la función [&lt;Fuente&gt;.LinkMemo](../WDLang4/1000024194.md).

- **&lt;Página&gt;.ToFile** no está disponible en las vistas.
