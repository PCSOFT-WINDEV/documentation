...
<DIV class="specObsolete">
	...
	A partir de la versión <B>26</B>, Esta función se conserva por motivos de compatibilidad con versiones anteriores. Se recomienda utilizar la función [HRecordToString](../WDLang4/1000025983.md).  
</DIV><a name="XUse"></a>
<a name="Use"></a>
...
Nombre del archivo de datos (ver o consultar) utilizado. Si no se especifica este nombre, la función **HRetrieveRecord** utilizará el último archivo de datos utilizado por la última función HFSQL (que empieza por "H").
