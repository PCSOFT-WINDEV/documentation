...
![HFSQL Client/Server](https://doc.pcsoft.fr/ext/images/us/HFCS.png) Si se utiliza la función **HChangeLocation**, &lt;Resultado&gt; = <u><u><u><u>True</u></u></u></u>, pero la función no tiene ningún efecto: los archivos de datos utilizados siempre están en el servidor.
...
Este parámetro también puede corresponder al nombre de un [grupo de archivos (o Carpeta-Perso) definido en el análisis](../Editeurs/2011003.md).
