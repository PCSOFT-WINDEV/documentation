...
<a name="vinculacion_entre_control_wlanguage_variable_entre_control_elemento_archivo_datos_ELTPARAGRAPHE000228"></a>
...
<a name="vinculacion_elemento_tipos_fijaciones_ELTPARAGRAPHE000244"></a>

Existen dos tipos de vínculos entre una control y un artículo

- *unión directa*: En este caso, **<Page>.FromSource** transfiere el valor de los elementos del Record cargado en la memoria al control enlazado f006c00 , sin leer ningún valor.
...
- **<Page>.FromSource** actualiza los controles Image vinculados a elementos de memo Image .

- **<Page>.FromSource** no está disponible en vistas. Los valores de los elementos deben asignarse a cada control.
