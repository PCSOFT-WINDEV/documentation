...
**Observación**: Para combinar varias vistas, utilice la función [&lt;Fuente&gt;.MergeView](../WDLang4/1000024983.md).
...
Nombre del archivo de datos utilizado. Este archivo de datos puede corresponder a un archivo de datos descrito en el análisis o mediante programación (con la función [&lt;Fuente&gt;.DescribeFile](../WDLang4/1000024215.md)). También se puede usar una variable de tipo [origen de los datos](../WDLang4/1514053.md).
...
| *hViewPostponed* | La vista se crea, pero se ejecuta más tarde con la función [&lt;Fuente&gt;.ExecuteView](../WDLang4/1000024949.md). Los datos de la vista serán los datos disponibles al ejecutar la vista. |
