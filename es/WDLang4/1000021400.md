...
- *unión directa*: En este caso, **PageFromSource** transfiere el valor de los elementos del Record cargado en la memoria al control enlazado f006c00 , sin leer ningún valor.
...
- **PageFromSource** no está disponible en vistas. Los valores de los elementos deben asignarse a cada control.
