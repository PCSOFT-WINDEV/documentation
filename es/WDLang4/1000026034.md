...
Nombre del archivo de datos (ver o consultar) utilizado. Si no se especifica este nombre, la función **&lt;Fuente&gt;.RecordToString** utilizará el último archivo de datos utilizado por la última función HFSQL (que empieza por "H").
