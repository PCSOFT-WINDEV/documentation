...
**Observación**: Para conocer los derechos concedidos a un grupo o usuario sobre un fichero de datos HFSQL Client/Server, utilice [HInfoFileRights](../WDLang4/3044321.md). 
