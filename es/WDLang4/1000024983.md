...
|   |   |
| --- | --- |
| *hViewAdd* | Almacena el contenido de la vista la próxima vez que se llame a [&lt;Fuente&gt;.ExecuteView](../WDLang4/1000024949.md). |
...
| *hViewPostponed* | La vista está creada pero será ejecutada posteriormente por [&lt;Fuente&gt;.ExecuteView](../WDLang4/1000024949.md). |
...
Para manipular una base de datos Hyper File 5 con **&lt;Fuente&gt;.MergeView**, debe realizar la fusión con **HCreateView_55**.
