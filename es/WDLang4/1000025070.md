...
En la mayoría de los casos, **&lt;Fuente&gt;.Next** establece la posición en el archivo de datos para recorrer los registros que coinciden con una condición. [&lt;Fuente&gt;.Next](../WDLang4/1000025070.md) se utiliza para posicionarse en el siguiente Record correspondiente a la condición.
...
- Mediante Default, **&lt;Fuente&gt;.Next** se realiza una búsqueda genérica.
...
- el archivo de datos está vacío o ningún registro corresponde al filtro (definido con la función [&lt;Fuente&gt;.Filter](../WDLang4/1000024960.md)): [&lt;Fuente&gt;.Out](../WDLang4/1000024605.md) devuelve <u><u><u>True</u></u></u>
...
![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/us/HF55.png) Las opciones de bloqueo no se tienen en cuenta. Utilice las funciones de bloqueo (función [&lt;Fuente&gt;.LockRecNum](../WDLang4/1000024197.md)) conservadas por motivos de compatibilidad.
...
### Comparación entre &lt;Fuente&gt;.Next y [&lt;Fuente&gt;.ReadNext](../WDLang4/1000025035.md)
<a name="comparacion_entre_docparampagetitleshort_readnextwdlang41000025035md_ELTPARAGRAPHE000550"></a>

La función **&lt;Fuente&gt;.Next** no lee el registro: por lo tanto, la función **&lt;Fuente&gt;.Next** es más rápida que la función [&lt;Fuente&gt;.ReadNext](../WDLang4/1000025035.md).
<a name="NOTE0_3"></a>
