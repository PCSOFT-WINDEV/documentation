...
- Para asignar automáticamente el valor NULL a un elemento con la función **PageToSource**:
...
- Los elementos del archivo de datos que no están vinculados a un control no se actualizan con **PageToSource** .

- Si varios controles en Page están vinculados al mismo elemento del archivo de datos, es posible que **PageToSource** no actualice correctamente el elemento vinculado. ***No se recomienda vincular varios controles Page al mismo elemento*** .

- **PageToSource** no actualiza los elementos con los valores de los controles Image. Utiliza la función [HLinkMemo](../WDLang4/3044173.md).

- **PageToSource** no está disponible en las vistas.
...
La función **PageToSource** no tiene ningún efecto en el contenido de un control Tabla. 
