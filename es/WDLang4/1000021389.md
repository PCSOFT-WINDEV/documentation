...
- *vinculación directa*: En este caso, **&lt;Página&gt;.FromFile** transfiere el valor de los elementos del Record cargado en memoria al control vinculado, sin leer ningún valor.
...
- **&lt;Página&gt;.FromFile** actualiza los controles Image vinculados a los elementos de la memoria Image.

- **&lt;Página&gt;.FromFile** no está disponible en vistas. Los valores de los elementos deben asignarse a cada control.
