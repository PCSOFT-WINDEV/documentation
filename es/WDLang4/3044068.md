...
Anterior modo de gestión de la descripción (antes de utilizar la función **HCheckStructure**).

**`<Data file>: (Cadena de caracteres opcional)`**

Nombre del archivo de datos utilizado.
Si este parámetro no se especifica o si corresponde a "\*", la gestión de las descripciones se tiene en cuenta para todos los ficheros de datos del análisis.
...
### Consejos
<a name="consejos_ELTPARAGRAPHE000139"></a>

**HCheckStructure** debe utilizarse: 
...
<a name="hcompatible_condiciones_para_considerar_que_las_estructuras_son_incompatibles_ELTPARAGRAPHE000153"></a>
...
### Limitación
<a name="limitacion_ELTPARAGRAPHE000215"></a>
