...
### Consejo 
<a name="consejo_ELTPARAGRAPHE000296"></a>
...
<a name="historial_modificaciones_ELTPARAGRAPHE000310"></a>En una ventana de relacionado a un archivo de datos, tiene la capacidad de mostrar automáticamente el historial de las modificaciones realizadas en cada elemento del Record mostrado. Para hacerlo, el archivo de datos debe ser registrado.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=7&name=Historique.gif)
