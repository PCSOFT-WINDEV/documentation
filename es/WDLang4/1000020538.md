...
| *hWriteDefault*<br>(valor predeterminado) | **Efecto al agregar registros en la navegación**: Al agregar registros, no se altera la navegación. <br>Por ejemplo, [HReadNext](../WDLang4/3044037.md) utilizado después de **HDuplicateRecord** posiciones en el Record encontrado después de la actual Record antes de la adición.<br>La constante *hAffectBrowse* tiene prioridad sobre la constante *hWriteDefault*. |
