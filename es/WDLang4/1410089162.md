...
### Propiedades específicas de las variables de tipo mongoOperationDeleteAll:
...
| --- | --- | --- |
| Filter | Tipo del filtro utilizado | Descripción del filtro o de los filtros MongoDB que se aplicarán para seleccionar los documentos a eliminar. Este filtro corresponde a:<br><br>- un documento JSON, en formato de cadena.<br><br>- un documento BSON, en formato buffer.<br><br>- un variant.<br><br><br> |
