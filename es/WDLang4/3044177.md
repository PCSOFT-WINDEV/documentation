...
The data files must be synchronized in the data model editor of WINDEV: on the "Análisis" tab, in the "Análisis" group, expand "Sincronización " and select Synchronize Structure and Deployed Data (SDD, Auto Modif)".
...
Solution: Regenerate the analysis in the data model editor: on the "Análisis" tab, in the "Análisis" group, expand "Generación" and click "Generation".
...
1. On the "Análisis" tab, in the "Elemento actual" group, click "Descripción". 
