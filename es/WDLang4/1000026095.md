...
**`<Query>: (Cadena de caracteres o fuente de datos)`**
...
- una conexión definida en el editor de análisis o mediante programación con el [HDescribeConnection](../WDLang4/3044205.md) o el [HOpenConnection](../WDLang4/3044107.md). 
...
<a name="texto_consulta_sql_ELTPARAGRAPHE000267"></a>
...
<a name="ejecutar_una_consulta_sql_con_parametros_ELTPARAGRAPHE000278"></a>
...
<a name="inyeccion_sql_¿como_prevenirlo_ELTPARAGRAPHE000325"></a>
...
Para evitar la inyección SQL al ejecutar consultas a través de **HExecuteSQLQueryAsynchronous**, debe utilizar consultas con parámetros y no debe concatenar cadenas para construir la consulta. 
...
### Combinaciones
<a name="combinaciones_ELTPARAGRAPHE000349"></a>
...
<a name="uso_constante_hquerywithoutcorrection_ELTPARAGRAPHE000362"></a>
...
| --- | --- |
| La conexión associated con los archivos de datos de la consulta se define automáticamente. | La conexión que se utilizará debe especificarse en la función **HExecuteSQLQueryAsynchronous**. |
...
<a name="condicion_una_clave_compuesta_una_consulta_sql_ELTPARAGRAPHE000415"></a>
