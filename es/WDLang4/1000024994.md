...
Importa un archivo XML en un archivo de datos en formato HFSQL Classic o Cliente/Servidor (archivo de datos descrito en el editor de análisis, o declarado por [&lt;Fuente&gt;.Declare](../WDLang4/1000024213.md), [&lt;Fuente&gt;.DeclareExternal](../WDLang4/1000024214.md) o [&lt;Fuente&gt;.DescribeFile](../WDLang4/1000024215.md)).
...
### Tipo de importación
<a name="tipo_importacion_ELTPARAGRAPHE000283"></a>
...
<a name="campos_tipo_array_ELTPARAGRAPHE000312"></a>
...
<a name="formato_del_xml_esperado_ELTPARAGRAPHE000351"></a>

**&lt;Fuente&gt;.ImportXML** espera un archivo XML con una estructura específica.
...
```
Este formato también lo utiliza [&lt;Fuente&gt;.ExportXML](../WDLang4/1000024956.md).
