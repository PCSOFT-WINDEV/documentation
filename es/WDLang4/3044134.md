...
Si este parámetro es igual a "\*" (sin especificar ningún elemento), el cálculo se realizará sobre todos los archivos de datos descritos en el análisis actual (incluidos los archivos de datos descritos por [HDeclare](../WDLang4/3044203.md), [HDeclareExternal](../WDLang4/3044204.md), [HDescribeFile](../WDLang4/3044206.md)).
...
- Las estadísticas también pueden ser actualizadas por [HIndex](../WDLang4/3044133.md). Las funciones [HIndex](../WDLang4/3044133.md) y **HStatCalculate** son las dos únicas funciones que permiten actualizar las estadísticas del archivo de datos.
