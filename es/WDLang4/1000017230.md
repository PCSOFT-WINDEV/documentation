...
- una copia de seguridad inmediata (realizada por [HBackup](../WDLang4/1000017081.md) o a través de HFSQL control Center).

- una copia de seguridad programada (descrita por [HAddScheduledBackup](../WDLang4/1000018866.md) o a través de HFSQL control Center).
...
**Para restaurar todo el servidor** (o las bases de datos __jnl y __trs), no se debe conectar ninguna otra aplicación al servidor.. La conexión utilizada no debe estar vinculada a una base de datos (al llamar a la función [HOpenConnection](../WDLang4/3044107.md), el parámetro &lt;Base de datos&gt; debe corresponder a una cadena vacía ("")). 
...
## Ejemplo
<a class="notetitle" target="_blank" href="$DOC$=1000020402&name=hrestorebackup_funcion&product=WD">Ver ejemplos adicionales</a>
...
- Identificador de reserva, devuelto por [HBackup](../WDLang4/1000017081.md). Este identificador también puede ser devuelto por [HInfoBackup](../WDLang4/1000017083.md).  
...
<a name="derechos_necesarios_para_restaurar_una_copia_seguridad_ELTPARAGRAPHE000309"></a>
...
<a name="operacion_restauracion_realizada_desde_centro_hfsql_control_ELTPARAGRAPHE000337"></a>
