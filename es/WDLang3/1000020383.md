...
- Para personalizar la Image de los marcadores de itinerario, basta con añadir previamente los marcadores con [MapAddMarker](../WDLang3/1000019794.md) en las mismas posiciones del itinerario.

- Para eliminar un itinerario de un mapa, utilice [MapDeleteItinerary](../WDLang3/1000020384.md).

- Para eliminar todos los itinerarios de un mapa, utilice [MapDeleteAll](../WDLang3/1000019952.md).
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Para gestionar las características específicas de la gestión de los itinerarios, utilice [MapExecuteJS](../WDLang3/1000021615.md). 
