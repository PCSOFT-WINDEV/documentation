...
Para obtener más información sobre este procedimiento, consulte [Parámetros del tratamiento de errores Procedure utilizado por <zipArchive Variable>.ExtractDirectory](../WDLang3/1000025747.md).
...
- el nombre de un WLanguage Procedure. 
	Para obtener más información sobre este procedimiento, consulte [Parámetros de la gestión de la barra de progreso Procedure utilizada por <zipArchive Variable>.ExtractDirectory](../WDLang3/1000025748.md).
...
Si se ha set un filtro en el archivo con [.SelectFile](../WDLang3/1000026294.md), sólo se extraerán los archivos que coincidan con el filtro.<a name="NOTE0_3"></a>


### Archivo extraído
<a name="archivo_extraido_ELTPARAGRAPHE000412"></a>

Los archivos extraídos no se eliminan del archivo. Para eliminar un fichero o todos los ficheros del archivo, utilice [.DeleteFile](../WDLang3/1000019152.md) o [.DeleteAll](../WDLang3/1000019154.md).<a name="NOTE0_4"></a>
