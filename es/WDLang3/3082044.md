...
| *zipHeader64* | Permite crear un archivo de más de 4 GB en el que se puede utilizar [zipChangePath](../WDLang3/3082027.md).<br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Esta constante no está disponible.<br><br>Archivo TAR o TGZ (TAR.GZ): Esta constante no está disponible. |
