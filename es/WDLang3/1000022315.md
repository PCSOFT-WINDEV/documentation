...
Envía una Email usando **Outlook**: la Email se coloca en la bandeja de salida del software de mensajería. El Email se envía realmente desde Outlook. Para más detalles, véase [Acceso a Outlook](../WDLang3/3032137.md).

**Atención**: Antes de enviar el Email, debes hacerlo:

- Iniciar una sesión con [EmailStartOutlookSession](../WDLang3/3032128.md).
...
Identifica la sesión actual de Email. Este parámetro es un número entero devuelto por [EmailStartOutlookSession](../WDLang3/3032128.md).
...
Este parámetro sólo se tiene en cuenta si la sesión de Email fue iniciada por [&lt;emailOutlookSession Variable&gt;.StartSession](../WDLang3/1000022302.md), utilizando la sintaxis de MS Exchange con un nombre de perfil. En los demás casos, no se visualiza la ventana de diálogo.
