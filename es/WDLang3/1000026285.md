...
[AuthToken](../WDLang3/1000022220.md) variable que corresponde al token refrescado.

**`<Token>: (AuthToken Variable)`**

Nombre de la [AuthToken](../WDLang3/1000022220.md) Variable que corresponde al Token a refrescar. Esta Token es devuelta por [AuthIdentify](../WDLang3/1000022219.md), por ejemplo.
...
## Observaciones
Algunas fichas no pueden ser refrescadas. El **Refresh** Property del [AuthToken](../WDLang3/1000022220.md) Variable puede utilizarse para determinar si el Token puede ser refrescado.
