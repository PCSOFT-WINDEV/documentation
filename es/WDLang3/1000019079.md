...
Un archivo autoextraíble de un archivo WINDEV puede abrirse con [Abrir](../WDLang3/1000019097.md) y utilizarse como cualquier otro archivo.
...
- Un archivo autoextraíble en formato ZIP no puede ser abierto por [Abrir](../WDLang3/1000019097.md).
...
Después de utilizar la función **<zipArchive Variable>.CreateExe** en un archivo comprimido, este archivo no se cierra. Debe llamar a [Cerrar](../WDLang3/1000019086.md) para cerrar el archivo fuente.<a name="NOTE0_6"></a>
...
|   |   |
| --- | --- |
| /DIR=&lt;Directorio&gt; | Se utiliza para especificar de dónde se deben extraer los archivos archivados.. Si el &lt;Directorio&gt; contiene caracteres de espacio, la cadena de caracteres debe estar entre comillas.<br><br>Atención: Este parámetro tiene prioridad sobre el parámetro &lt;Directorio de extracción&gt; especificado con la función **<zipArchive Variable>.CreateExe**. |
