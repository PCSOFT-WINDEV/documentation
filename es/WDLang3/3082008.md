...
Para añadir los archivos encontrados en un directorio, utilice [zipAddDirectory](../WDLang3/3082014.md).
...
- un código de error (valor superior a 0) De lo contrario. Para más detalles sobre estos códigos de error, consulte la página web de [observaciones](#NOTE0_2).
...
- el nombre de un WLanguage Procedure. Para obtener más información sobre este procedimiento, consulte [Parámetros del procedimiento utilizado por la función zipAddFile](../WDLang3/1000025730.md). 
...
- **Archivos en formato 7z**: El archivo se comprime completamente cada vez que se llama **zipAddFile**. Esta función se recomienda cuando se agrega un solo archivo. Si hay que añadir varios ficheros en el archivo, utilice [zipAddFileList](../WDLang3/3082038.md) o [zipAddDirectory](../WDLang3/3082014.md). 
...
- el elemento índice (observación: el índice de un elemento es devuelto por [zipFindFile](../WDLang3/3082002.md)).
