...
### Condiciones de uso
<a name="condiciones_uso_ELTPARAGRAPHE000285"></a>
...
### Códigos de error
<a name="codigos_error_ELTPARAGRAPHE000316"></a>
...
### Destino del archivo
<a name="destino_del_archivo_ELTPARAGRAPHE000337"></a>
...
<a name="eliminacion_del_archivo_fuente_ELTPARAGRAPHE000393"></a>
...
### Espacio reservado
<a name="espacio_reservado_ELTPARAGRAPHE000416"></a>
...
### Orden de partición
<a name="orden_particion_ELTPARAGRAPHE000440"></a>
...
### Número de piezas
<a name="numero_piezas_ELTPARAGRAPHE000461"></a>

[&lt;zipArchive Variable&gt;.NbPartNeed](../WDLang3/1000019094.md) se utiliza para determinar el número de partes necesarias para dividir el archivo.
...
### Cierre del archivo
<a name="cierre_del_archivo_ELTPARAGRAPHE000481"></a>

Después de utilizar la función **<zipArchive Variable>.Split** en un archivo comprimido, este archivo no se cierra. Debes consumir:

- [Cerrar](../WDLang3/1000019086.md)para cerrar el archivo de una sola parte.

- [Abrir](../WDLang3/1000019097.md)para abrir el nuevo archivo de varias partes.




**Observación**: Si el valor del parámetro &lt;Eliminar el archivo de origen&gt; es <u><u><u><u>True</u></u></u></u>, el archivo comprimido de origen se cierra automáticamente al realizar la división.<a name="NOTE0_9"></a>


### Acciones que se pueden realizar en un archivo de varias partes
<a name="acciones_que_pueden_realizar_archivo_varias_partes_ELTPARAGRAPHE000512"></a>

Algunas funciones de archivo sólo se pueden utilizar en los archivos de una sola parte (agregar y eliminar archivos, crear un ejecutable autoextraíble, etc.).. Para realizar estas operaciones, basta con fusionar los subarchivos ([&lt;zipArchive Variable&gt;.Merge](../WDLang3/1000019151.md)) en get un archivo de una sola parte.
