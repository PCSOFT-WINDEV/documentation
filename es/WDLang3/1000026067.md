...
- **Esta función es asíncrona**: simplemente solicita la desconexión del cliente. El cliente puede desconectarse realmente más tarde (después de ejecutar **&lt;websocketClient Variable&gt;.Desconectar**). La función **&lt;websocketClient Variable&gt;.Desconectar** nunca devuelve errores (por ejemplo, si el cliente se desconectó).
