...
Devuelve el nombre de la carpeta actual en el software de mensajería (Outlook, software de mensajería que utiliza el protocolo IMAP (INTERNET Message Access Protocol), ...). Esta carpeta se encuentra en la rama "Carpetas personales".
<a name="Example1"></a>
