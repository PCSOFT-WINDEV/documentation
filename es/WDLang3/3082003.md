...
- 0 si la creación se ha realizado. En este caso, el archivo se abre. Para que este archivo pueda ser manejado por el usuario antes de cerrar la aplicación, no olvide cerrar el archivo ([zipClose](../WDLang3/3082005.md)). 
...
| *zipHeader64* | Permite crear un archivo de más de 4 GB en el que se puede utilizar [zipChangePath](../WDLang3/3082027.md).<br><br>Por Default, esta opción no se utiliza.<br>**Archivo en formato TAR o TGZ (TAR.GZ)**: Esta constante no está disponible. <br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Esta constante no está disponible. |
