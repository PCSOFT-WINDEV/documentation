...
**`<Connection>: (Cadena de caracteres o correo electrónicoXXSesión Variable)`**

Conexión al servidor de mensajería.
...
Para no generar bloqueos, los correos electrónicos se recuperan de forma asíncrona con la constante **ertAsynchronous** en un subproceso secundario. El array devuelto por la función **EmailGetAll** debe ser recorrido en su totalidad antes de llamar a cualquier función EmailXXX que necesite un intercambio con el servidor IMAP.
...
De hecho, es necesario gestionar el cambio de estado después de navegar a través de todos los correos electrónicos.. 
