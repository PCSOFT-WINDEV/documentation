...
Elimina una lista de archivos de un archivo comprimido.. Esta función es más rápida que la ejecución de [.DeleteFile](../WDLang3/1000019152.md) para cada archivo.
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Universal Windows 10 App](https://doc.pcsoft.fr/ext/images/us/UNIVERSALAPP.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Sólo están disponibles los archivos ZIP.<a name="NOTE0_2"></a>
