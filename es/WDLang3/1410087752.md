...
- Avec un socket créé par la fonction **WebSocketClientConnectSSL**, la fonction [SocketChangeModeTransmission](../WDLang3/3070005.md) n'aura aucun effet. Le socket fonctionne forcement en mode *SocketSansMarqueurFin*.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) L'adresse peut également correspondre à l'adresse IP obtenue par la fonction [NetAdresseIP](../WDLang3/3056023.md).
...
|   |   |
| --- | --- |
| *ProtocoleSSL2* | Utilisation du protocole SSL2<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Ce protocole n'est pas supporté. |
| *ProtocoleSSL3* | Utilisation du protocole SSL3<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Ce protocole n'est pas supporté. |
...
Pour plus de détails sur cette procédure, consultez [Paramètres de la procédure utilisée par la fonction WebSocketClientConnectSSL](../WDLang3/1410087755.md).
