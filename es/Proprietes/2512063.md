...
El **DescribedPhysicalName** Property se utiliza para gestionar el nombre físico de los archivos de datos HFSQL.
...
Nombre físico del archivo de datos (sin extensión). Este nombre ignora los posibles cambios de nombre ([HChangeName](../WDLang4/3044141.md)).
