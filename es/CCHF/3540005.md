...
- [Solución de posibles problemas señalados por el Centro HFSQL control](#Problem).

- [Gestión de las bases de datos del clúster HFSQL](#AdminData).
...
## Solución de posibles problemas señalados por el Centro HFSQL control
...
| **Resolución** | Elija un nodo reference para la sincronización.<br><br>Consulte Resincronización del cluster. |
