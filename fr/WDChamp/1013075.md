...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Btn_img.gif)
...
- **image du cadre du bouton** : cette image permet de re-définir simplement la forme du bouton. Par exemple : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=BTN_FORME.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=btn_image_creat.gif)


**Remarques** : 

- La bibliothèque l'images livrée avec WINDEV ou WINDEV Mobile permet de choisir les images (cadre et image) associées au champ. Pour ouvrir cette bibliothèque, déroulez le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
 et sélectionnez l'option "Catalogue". 

- Pour éditer les options de l'image (mode d'affichage, symétrie, ...), déroulez le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
 et sélectionnez l'option "Options d'affichage, transparence, symétrie" (voir [Configuration du mode d'affichage (bouton dans une fenêtre)](#NOTE4_1)). 
...
![Bouton au repos, enfoncé, grisé, sélectionné, survolé](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Bleu0208.gif)
...
- l'agrandissement (étirement) de l'image (par exemple si la taille du champ Bouton est supérieure à l'image fournie). Il existe plusieurs possibilités :
	...
	- Etirement en largeur (3 images). La règle de découpage est la suivante :
		...
		- la partie 2 correspond à la zone du milieu. La taille de cette partie est égale à 16 pixels. Cette partie sera répétée autant de fois que nécessaire pour que l'image du bouton soit à la taille voulue. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Onglet_Imagevolet.gif)




- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) un halo autour du champ Bouton.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Btn_Halo.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Nv_Position_btnxx.gif&type=thumb)





![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) L'option "Positionnement Libre" permet de gérer entièrement la position de l'image et du libellé. La flèche à côté de l'option permet d'accéder à la fenêtre de configuration :  
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Positionnement_Libre.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Bouton_rond%20-%20HC%20N%B0001%201.gif&type=thumb)


	- Utilisez le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
 pour configurer le cadre (les options de configuration sont différentes selon le type de cadre choisi). 

- Utilisez l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Bouton_rond%20-%20HC%20N%B0001%202.gif)
...
- L'option "Personnalisé" permet de paramétrer entièrement le cadre utilisé via l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
 : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Bouton_rond%20-%20HC%20N%B0002.gif)
...
2. Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
 situé à côté du chemin de l'image. 
...
5. Pour chaque langue, cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
. Vous pouvez : 
