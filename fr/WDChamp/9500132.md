...
- propose d'imprimer en mode paysage, ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FAA_Imprimer_Table_portrait.gif)


- informe que toutes les colonnes ne pourront pas être imprimées sur une même page. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FAA_Imprimer_Table_grand.gif)
