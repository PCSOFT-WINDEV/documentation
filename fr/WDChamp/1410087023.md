...
<a name="manipuler_selection_ELTPARAGRAPHE000129"></a>Pour manipuler la sélection actuellement réalisée dans un champ Traitement de texte, il est possible de récupérer cette sélection dans une variable de type [docFragment](../WDLang1/1000022482.md). 
...
<a name="ajouter_texte_dans_document_ELTPARAGRAPHE000150"></a>**Pour ajouter du texte dans un document existant**, il existe plusieurs méthodes : 
...
### Gestion des signets
<a name="gestion_des_signets_ELTPARAGRAPHE000238"></a>Il est possible de gérer les signets dans un document de type Traitement de texte. Quelques exemples : 
...
<a name="enchainer_des_etats_des_documents_type_traitement_texte_ELTPARAGRAPHE000265"></a>De la même manière qu'il est possible d'enchaîner des états, il est également possible d'enchaîner des états et des documents de type Traitement de texte. 
...
<a name="proprietes_associees_champ_traitement_texte_ELTPARAGRAPHE000282"></a>Les propriétés suivantes sont spécifiques au champ Traitement de texte. Elles permettent essentiellement de manipuler les caractéristiques du champ : 
