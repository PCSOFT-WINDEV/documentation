...
- Sous l'éditeur : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Etat_composite_Editeur.gif&type=thumb)
...
- Pour visualiser la fenêtre de description de l'état composite, plusieurs possibilités : 
	...
	- Sous le volet "Modification", cliquez sur le bouton de regroupement ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_regroup.gif)
 du groupe "Etat composite". 
...
- Pour visualiser la fenêtre de description du sous-état : 
	...
	2. Sous le volet "Modification", cliquez sur le bouton de regroupement ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_regroup.gif)
 du groupe "Etat". Il est également possible de sélectionner l'option "Description du sous-état" du menu contextuel de l'état.
