...
3. Affichez l'onglet "Contenu" de la fenêtre de description du champ Table hiérarchique. 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TableH_Fichier_Contenu.gif&type=thumb)
...
Un champ Table hiérarchique fichier peut afficher des enregistrements dépendant de l'enregistrement précédent (cas classique d'une liaison récursive permettant par exemple de gérer les parents / enfants)![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TableH_Fichier_Recursive.gif)
