...
| --- | --- |
| Initialisation | Exécuté à l'ouverture de la fenêtre. \*<br><br>**Cas particulier :** Champ Liste image fichier rempli automatiquement :<br>Lors de l'exécution de ce code, le champ Liste image n'est pas encore rempli. Il est possible de forcer le remplissage du champ Liste image dans ce code avec :<br><br>- soit la fonction [ListeAffiche](../WDLang1/3049005.md).<br><br>- soit les propriétés de gestion des champs Liste image fichier : [FichierParcouru](../Proprietes/2510040.md), [RubriqueParcourue](../Proprietes/2510111.md) ou [Filtre](../Proprietes/2510042.md).<br><br><br> |
| Fin d'initialisation | **Code présent uniquement pour les champs Liste image fichier remplie automatiquement :**<br>Exécuté après le remplissage du champ Liste image. Ce code permet par exemple de sélectionner un élément dans le champ Liste image, d'ajouter ou de modifier un élément. |
