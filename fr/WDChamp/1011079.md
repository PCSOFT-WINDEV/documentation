...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Etat_Agenda_Editeur%20-%20HC%20N%B0001.gif&type=thumb)
...
Remarque : Vérifiez que la zone d'affichage des rendez-vous à la journée est correctement dimensionnée sous l'éditeur d'états. Il est possible de la redimensionner si nécessaire. 
	...
	- l'état personnalisé pour afficher les rendez-vous. 
		...
		- Si l'option "Etat prédéfini" est sélectionnée, un état prédéfini est automatiquement ajouté au projet. Par défaut, cet état a pour nom "ETAT_WinDevVueRDV" et est automatiquement utilisé pour l'affichage des rendez-vous.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Etat_WinDevvueRDV.gif)
