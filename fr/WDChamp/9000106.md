...
3. Le carré jaune a été remplacé par un carré bleu, indiquant que ce champ peut être surchargé.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ModeleEtat_IHMNonSurchargee.gif)
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ModeleEtat_IHMSurchargee.gif)


4. Vous pouvez maintenant modifier tous les aspects de l'interface du champ : dimensions, position, style, ...![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ModeleEtat_IHMModifiee.gif)
...
5. Deux sections de code de clic sont présents : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ModeleEtat_CodeNonSurcharge.gif)
