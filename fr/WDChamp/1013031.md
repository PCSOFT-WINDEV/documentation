...
- ** 2ème méthode** :
	...
	3. Cliquez une nouvelle fois sur le champ. Le curseur de la souris se transforme en curseur de saisie.
		...
		- dans une fenêtre :![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LibelleModifDirect.gif)


		- dans un état :![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LibelleModifDirectetat.gif)
...
2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Combo_des_saisie_btn_multilangue.gif)
 située à côté de la combo "Masque de saisie" ou "Masque" (onglet "Général" ou "Détail"). Par défaut, le même masque est associé à toutes les langues gérées par la fenêtre, la page ou l'état.
...
2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
 située à côté de l'option "Image" ou "Image de fond" (onglet "Général" ou "Style"), puis sélectionnez l'option "Multilingue". 
...
, sélectionnez l'option "Parcourir", puis sélectionnez l'image correspondant à la langue. 
