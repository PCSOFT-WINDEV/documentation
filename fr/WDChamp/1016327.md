...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FAA_Menu_Agenda.gif)
...
### Option "Imprimer"
<a name="option_imprimer_ELTPARAGRAPHE000098"></a>L'option "Imprimer" permet d'imprimer le contenu du champ Agenda. Une fenêtre spécifique s'affiche permettant de configurer l'impression de l'agenda. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FAA_Imp_Planning.gif)
