...
1. Si vous possédez une clé Google Maps API, saisissez-la. Dans le cas contraire, cliquez sur "Obtenir une clé". ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Carte1.gif)


2. Pour obtenir la clé, 3 étapes sont nécessaires : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Carte2.gif)
