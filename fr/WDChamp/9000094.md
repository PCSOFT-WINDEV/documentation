...
6. Ajoutez le code du bouton spécifique à la page en cours, avant et/ou après la procédure d'appel au code du modèle. Vous pouvez supprimer la fonction [ExécuteAncêtre](../WDLang1/3013063.md) si vous ne souhaitez pas que le code du modèle soit exécuté. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ModelePage_CodeSurcharge.gif)
...
5. Deux sections de code de clic sont présents : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=heritage_surcharge_proc.gif)
