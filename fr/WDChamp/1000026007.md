...
### Ajouter une piste
<a name="ajouter_une_piste_ELTPARAGRAPHE000163"></a>L'ajout d'une piste dans un champ TimeLine est réalisé grâce à la fonction [&lt;TimeLine&gt;.AjoutePiste](../WDLang1/1000020777.md). 
...
<a name="ajouter_evenement_ELTPARAGRAPHE000193"></a>L'ajout d'un événement dans un champ TimeLine est réalisé grâce à la fonction [&lt;TimeLine&gt;.AjouteEvénement](../WDLang1/1000020776.md). Cette fonction accepte deux syntaxes : 
...
<a name="recuperer_une_liste_evenements_ELTPARAGRAPHE000260"></a>La fonction [&lt;TimeLine&gt;.ListeEvénement](../WDLang1/1000020779.md) permet de récupérer : 
...
<a name="supprimer_evenement_ELTPARAGRAPHE000300"></a>La fonction [&lt;TimeLine&gt;.SupprimeEvénement](../WDLang1/1000020780.md) permet de supprimer : 
...
<a name="modifier_echelle_temporelle_champ_ELTPARAGRAPHE000352"></a>L'affichage courant d'un champ TimeLine peut être modifié via la fonction [&lt;TimeLine&gt;.ChangeMode](../WDLang1/1000020778.md). Cette fonction permet de modifier le mode d'affichage du champ : seconde, milliseconde ou microseconde.
...
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000427"></a>Il est possible de proposer à l'utilisateur de définir plus précisément les caractéristiques de son événement lors d'un ajout ou d'une modification. Il suffit pour cela de créer une fenêtre avec les informations à remplir. 
