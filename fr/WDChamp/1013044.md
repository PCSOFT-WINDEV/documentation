...
6. Testez l'état principal (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_fenetre_WD_bl.GIF)
 parmi les boutons d'accès rapide) pour vérifier l'impression de votre état.
