...
La carte affichée est interactive : il est possible de zoomer, de se déplacer, ... Elle peut être affichée sous forme graphique ou sous forme de vue satellitaire. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ModeCarte.gif)
