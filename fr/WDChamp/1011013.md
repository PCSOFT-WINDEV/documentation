...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png)<br> | Important | Si la requête est créée avec le logiciel Etats & Requêtes, il n'est pas nécessaire d'utiliser la fonction [iInitRequêteEtat](../WDLang5/3046021.md) pour spécifier les paramètres de la requête. En effet, lors de l'exécution d'un état sur une requête paramétrée depuis le logiciel Etats & Requêtes, une fenêtre s'affiche permettant de saisir les paramètres de la requête. |
