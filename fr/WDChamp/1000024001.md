...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_ZM_Exemple.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ_Zml%20-%20HC%20N%B0001.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_ZM_Ligne.gif)
...
**Par exemple**, un champ Zone multiligne statique sera utilisé dans une fiche pour la saisie du nom et du prénom du contact, de son adresse, ... ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_ZM_Statique.gif)
...
Autre exemple : un champ Zone multiligne statique utilisé pour avoir le comportement d'un sélecteur : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_ZM_Selecteur.gif)
...
Par exemple : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_ZM_Dynamique.gif)
