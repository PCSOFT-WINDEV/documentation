...
Exemple :
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=INTERRUPTEUR_CHAMP.GIF)
...
<a name="interrupteur_trois_etats_ELTPARAGRAPHE000175"></a>Sous l'éditeur de fenêtres, il est possible de gérer trois états pour les options des champs Interrupteur.
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Interrupteur_TroisEtat.gif)
