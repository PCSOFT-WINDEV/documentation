...
<a name="ajouter_rendezvous_ELTPARAGRAPHE000194"></a>L'ajout d'un rendez-vous dans un champ Agenda est réalisé grâce à la fonction [&lt;Agenda&gt;.AjouteRendezVous](../WDLang1/1000022894.md). Cette fonction accepte deux syntaxes : 
...
<a name="recuperer_une_liste_rendezvous_ELTPARAGRAPHE000262"></a>La fonction [&lt;Agenda&gt;.ListeRendezVous](../WDLang1/1000022886.md) permet de récupérer : 
...
<a name="afficher_champ_agenda_partir_une_date_specifique_ELTPARAGRAPHE000302"></a>Pour afficher le champ Agenda à partir d'une date spécifique, utilisez la fonction [&lt;Agenda&gt;.Position](../WDLang1/1000022897.md).
...
<a name="modifier_affichage_champ_ELTPARAGRAPHE000357"></a>L'affichage courant d'un champ Agenda peut être modifié via les fonctions suivantes : 
...
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000436"></a>Il est également possible de proposer à l'utilisateur de définir plus précisément les caractéristiques de son rendez-vous lors d'un ajout ou d'une modification. Il suffit pour cela de créer une fenêtre avec les informations à remplir. 
