...
<a name="personnalisation_ligne_calculs_ELTPARAGRAPHE000220"></a>Il est possible de personnaliser (libellé, couleur, police, hauteur, ...) : 
...
<a name="export_via_les_fonctions_wlangage_ELTPARAGRAPHE000394"></a>Diverses fonctions WLangage permettent d'exporter le contenu d'un champ Table dans un format spécifique (Word, Excel, XML, ...). Lors de cet export, par défaut les lignes correspondant à un calcul sont également exportées.
