...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Carte1_Bis.gif&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Google1.gif&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Google2.gif&type=thumb)


3. Dans la fenêtre popup qui s'ouvre, cliquez sur "Android key". ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Google3.gif)


4. Collez l'empreinte SHA-1 du certificat (générée par WINDEV Mobile). ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Google4.gif)


5. Récupérez la clé générée dans la section "Key for Android apps (with certificates)".
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Google5.gif&type=thumb)
