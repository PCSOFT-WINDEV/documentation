...
Le menu contextuel système (appelé également "Menu des FAA") associé par défaut aux champs Table et Tables hiérarchique propose les options suivantes : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ_Table_MenuCtx.gif)
...
3. Choisissez le menu désiré dans la combo "Menu contextuel" :![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Fonctionnalites_auto_Menu2.gif)
