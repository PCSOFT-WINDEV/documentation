...
<a name="methode_desktop_first_ELTPARAGRAPHE000046"></a>Le développeur doit tout d'abord penser à l'interface de son site Web en mode "Bureau". Ensuite, il réalisera la version en mode "Tablette", puis il terminera par la version en mode "Mobile". 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Responsive.gif)
...
<a name="methode_mobile_first_ELTPARAGRAPHE000057"></a>Le développeur doit tout d'abord penser à l'interface de son site Web en mode "Mobile". Ensuite, il réalisera la version en mode "Tablette", puis il terminera par la version en mode "Bureau". 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Responsive-Mobile-First.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=RWD%20Bandeau%20entete%201%20-%20HC%20N%B0001%201.gif&type=thumb)
...
- **Tranches**
	...
	- Définir les points de basculement de tranches : Lors de la diminution ou de l'augmentation de la résolution, la mise en forme de la page peut être modifiée avant la limite de la tranche. Dans ce cas-là, il suffit de modifier le point de rupture de la tranche afin d'obtenir toujours l'interface voulue. 
			En mode **Desktop First** : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Tranches.gif)
