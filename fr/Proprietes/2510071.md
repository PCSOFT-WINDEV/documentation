...
<a name="couleur_champ_saisie_ELTPARAGRAPHE000193"></a>La propriété **Couleur** permet de connaître et de modifier la couleur du texte saisi.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=couleur_ChpSaisie.gif)

<a name="NOTE0_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Universal Windows 10 App](https://doc.pcsoft.fr/ext/images/fr/UNIVERSALAPP.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png) 

### Couleur du texte d'un champ Libellé
<a name="couleur_texte_champ_libelle_ELTPARAGRAPHE000206"></a>La propriété **Couleur** permet de connaître et de modifier la couleur du texte d'un champ Libellé.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Coul_libelle.gif)

<a name="NOTE0_6"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Universal Windows 10 App](https://doc.pcsoft.fr/ext/images/fr/UNIVERSALAPP.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png) 

### Couleur du texte d'un champ Bouton
<a name="couleur_texte_champ_bouton_ELTPARAGRAPHE000219"></a>La propriété **Couleur** permet de connaître et de modifier la couleur du texte d'un champ Bouton.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CouleurBtn.gif)

<a name="NOTE0_7"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Universal Windows 10 App](https://doc.pcsoft.fr/ext/images/fr/UNIVERSALAPP.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png) 

### Couleur du texte d'un champ Sélecteur ou d'un champ Interrupteur
<a name="couleur_texte_champ_selecteur_champ_interrupteur_ELTPARAGRAPHE000232"></a>La propriété **Couleur** permet de connaître et de modifier la couleur du texte de toutes les options d'un champ Sélecteur ou d'un champ Interrupteur.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=couleurSelecteur.gif)
...
**Attention** : Pour les lignes d'un champ Liste, la nouvelle couleur est conservée uniquement pour les lignes visibles. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=couleurListe.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=couleurtable.gif)
