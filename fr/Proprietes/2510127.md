...
- **pour les champs Liste, Liste image et Combo fichier** : à la valeur de la rubrique mémorisée définie sous l'éditeur de fenêtres (onglet "Contenu" de la description du champ) : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=rubriquememorisee.gif)
. 
