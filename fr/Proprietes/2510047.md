...
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=position_sel.gif)<br> | Le curseur de saisie est placé au début de la zone en "inverse vidéo" (position 3 dans cet exemple). La propriété **FinCurseur** permet de connaître et de modifier la fin de la zone sélectionnée. |
|   |   |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=image17.gif)
