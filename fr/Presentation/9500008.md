...
<a name="nouveaux_champs"></a>
		...
		![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-Popup-Android.gif)![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-Popup-iOS.gif)
...
Une utilisation populaire est la mise en place d'une assistance sur un champ de saisie : un menu contextuel personnalisé, l'affichage d'une alerte, l'affichage de légendes ... <br>![Une Popup affichée sur une carte](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Popup%20exemple%20utilisation.gif)
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-Table-Hierarchique.gif)
...
Rappelons qu'une table hiérarchique peut également contenir des colonnes non hiérarchiques. 
		...
		<br>![Le bouton présent en bas de l’écran est épinglé](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-Epingler-Un-Ou-Des-Champs.gif)
...
- Caméra.
		...
		Le Champ Métier "Jeton filtrant" affiche une liste de jetons scrollable horizontalement, et permet la sélection multiple dans cette liste. <br>![Un comportement d'UI standard](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-Champ-Metier-Jeton-Filtre.gif)
...
<br>![Chaque destinataire sélectionné est ajouté aux jetons](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-Champ-Metier-Saisie-Email-Avec-Jetons%20_%20Bords%209.gif)
		...
		<br>![Des UI sophistiquées facilement](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-Champ-Metier-Menu-Vertical-Sur-Bouton-Plus-Flottant.gif)
...
Il n'est plus nécessaire de placer ce code dans l'événement "Fermeture de Fenêtre Fille". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=OuvreAsynchrone.jpg)
...
Pour chaque appli, il devient possible d'indiquer les utilisateurs et les groupes d'utilisateurs qui pourront installer cette application. 
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Texte%20indication.png)
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM%20-%20marges%20chp%20de%20saisie.jpg)
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ombre%20sur%20cadre.png)
...
La version 27 permet ce centrage par le magnétisme intégré à l'éditeur de fenêtres. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM%20magn%E9tisme%20horizontal%20au%20centre.gif)
...
Et en plus des nouveautés communes générales, en plus des nouveautés communes spécifiques aux mobiles, la version 27 propose les nouveautés suivantes pour iOS.
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-iPhone.gif)
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=bouton_ios_partage_position.gif)
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-getPosition-iOS.gif)
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=iOS-Demande-Autorisation.gif)
...
WINDEV Mobile 27 pour Android bénéficie des nouveautés communes générales de la version 27, plus des nouveautés communes aux mobiles, plus des nouveautés spécifiquement destinées à Android. 
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-TelechargementFichier.jpg)
...
En version 27, il est possible d'indiquer quel device utiliser sans que le GO ne repose la question. 
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=shutterstock_1850326291.%20PPpsd%20copie.jpg)
