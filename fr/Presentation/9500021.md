...
<br>![Code proposé par l'IA. L'IA a détecté les rubriques de la requête, a trouvé le champ Table et remplit les colonnes avec les rubriques correspondants.](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IA%201%20integre%20editeur%20testSL.gif)
...
- L'IA a analysé le code, détecté une répétition de code et propose donc la répétition pour les éléments suivants de la structure de départ (JSON). Pour valider la proposition (en jaune pâle), touche TAB. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IA%202%20-%20V2.gif)


- L'IA a détecté dans la fenêtre qu'une procédure calcule une date d'échéance, elle a détecté un champ de saisie avec une date de contrat, et propose le code le plus probable pour continuer la ligne en cours de saisie. Pour valider la proposition (en jaune pâle), touche TAB. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IA%20a%20la%20volee.gif)
...
Dans le code source de l'application, il suffit d'utiliser la fonction WLangage [PaletteChange](../WDLang6/1410090897.md) en indiquant la palette à appliquer.
Le changement est appliqué dynamiquement, par le moteur graphique de WINDEV 2025.
Il n'y a rien d'autre à faire !
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Palettesdecouleurs-Th%E8me%20clair_multi.gif)
Fonction **PaletteChange**<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Palettesdecouleurs-Th%E8me%20sombre.gif)
...
Pour plus de détails, consultez [Gestion des palettes de couleurs](../WDLang6/1410090992.md). 
		...
		La nouvelle fonction WLangage [PaletteChange](../WDLang6/1410090897.md) permet de changer la palette de couleurs utilisée par un gabarit.
...
Pour plus de détails, consultez [Gestion des palettes de couleurs](../WDLang6/1410090992.md). 
		...
		La nouvelle fonction WLangage [PaletteGénère](../WDLang6/1410090825.md) permet de générer une palette de couleurs basée sur la couleur d'accentuation du Windows en cours d'utilisation sur la machine de l'utilisateur final.
Cela permet donc de proposer facilement une UI qui s'accorde avec la couleur dominante du PC en cours d'utilisation.
<br>![Thème Windows](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Windows%2011%20rose.gif)

<br>![Palette générée](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Palettesdecouleurs-Th%E8me%20windows%20rose.gif)
...
En thème sombre par exemple, les couleurs passent en blanc.<br>![A gauche icones originales, à droite passage automatique en blanc pour le mode sombre](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Icones%20th%E8me%20clair%20et%20th%E8me%20sombre%202.gif)
...
La nouvelle fonction WLangage [PaletteGénère](../WDLang6/1410090825.md), permet de créer une palette de couleurs.
...
Il en est de même dans les "7 onglets". <br>![Une utilisation de couleur nommée dans les "7 onglets"](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=editeur_couleur_palette.gif)
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wd-bouton-segmente-1.gif)

<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wd-bouton-segmente-2.gif)

<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wd-bouton-segmente-3.gif)
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champs%20floutes%20avant.gif)<br> | <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champs%20floutes%20apres.gif)<br> |
...
En version 2025 lors de l'export d'un document contenant des liens vers des documents au format PDF (à l'aide de la fonction WLangage [DocVersPDF](../WDLang1/1000022531.md)), ces liens sont conservés avec leur URL cliquable.
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wd-fichiers-pdf-lire-et-ecrire-recadrage.gif)
...
Le type WLangage [PdfPage](../WDLang6/1000024904.md) contient maintenant l'information supplémentaire d'un tableau de champs PDF.
Cela permet des traitements encore plus automatisés.
		...
		La nouvelle fonction WLangage [PDFExtrait](../WDLang6/1410090600.md) permet d'extraire une ou plusieurs pages d'un document PDF, et de créer un nouveau document avec ces pages.
Exemple de code :
...
Ce nouveau graphe représente un graphique qui illustre visuellement des données sous forme de pourcentages, sous une forme illustrative : bouteille, personne, thermomètre, etc.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-pictorial-percentage-chart-Launch.gif)
Cela rend l'information plus facile à comprendre au premier coup d'oeil.

Pour plus de détails, consultez [Graphe de type "Pourcentage imagé"](../WDChamp/1000021044.md). 
...
Cela permet une présentation plus visuelle.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GRAPHE-ICONE.gif)


Pour plus de détails, consultez l'aide de la fonction [grVignetteCatégorie](../WDLang3/1410090677.md). 
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ%20graphe%20bulle%20personnalisable.gif)


Pour plus de détails, consultez [Bulle personnalisée](../WDLang3/3042010.md). 
...
Pour plus de détails, consultez [Champ Editeur d'images : Options du ruban et des volets](../WDChamp/1410087035.md). 
...
Un site d'administration SaaS est livré avec le Serveur d'Application WEBDEV 2025. WINDEV 2025, et la famille de fonctions [SaaS](../WDLang3/1000019027.md) permettent d'utiliser ce site pour administrer les applications que vous désirez distribuer en mode SaaS.
...
<a name="environnement"></a>
		...
		Un nouveau magnifique modifieur fait son apparition en version 2025.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=nouveau-modifieur_etat_zoom-sur-modifieur.gif)
Voir nouveauté 062.
...
<a name="environnement_nouveau_modifieur"></a>
		...
		Le nouveau modifieur est un outil dont vous ne pourrez plus vous passer !<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Nouveau-Modifieur.gif)
...
Le mode Ruban existe toujours.
		...
		La présentation des champs par volet est beaucoup plus claire.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=schema_volet_creation_champ.gif)
...
Le volet est donc disposable à votre choix : haut, bas, 2ème écran, etc.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=schema_volet_creation_champ-Rechercher.gif)
...
Le multicurseur permet d'effectuer une même manipulation simultanément à tous les endroits où les curseurs sont positionnés.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=multicurseur_avant.gif)
...
Un trait fin se charge de cette mission.<br>![Notez les traits fins qui matérialisent les blocs de code](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WX2025_Indentation.gif)
...
Le type de l'élément est indiqué en fin de ligne : champ de saisie, libellé, entier, réel, booléen, etc.<br>![Le code dans la combo utilise la coloration syntaxique](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Combo%20completion.gif)
...
En version 2025, il devient possible de paramétrer l'épaisseur de ce curseur, ainsi que sa vitesse de clignotement.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wx-taille-du-curseur-vitesse-clignotement.gif)
...
<a name="coffre_fort"></a>
		...
		Il arrive souvent que des mots de passe, des clés privées, des tokens soient utilisés en programmation.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code%20MDP.gif)
Par exemple :
...
Tous les développeurs du projet peuvent utiliser cet identifiant.<br>![L’édition sécurisée des chaînes secrètes](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=coffre-fort%20V2%20avec%20mdp%20en%20clair.png)
...
Les fonctions qui permettent de visualiser un contenu (comme la fonction [Info](../WDLang1/3021011.md)) sont sans effet.
...
Cette vérification s'active dans les options de compilation.
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CoffreFort-MDP-WLangage.gif)
...
L'appel des procédures dans les threads a été fortement optimisé.
		...
		La nouvelle fonction WLangage [CertificatExporte](../WDLang1/1410090436.md) permet d'exporter un certificat présent dans le magasin Windows vers un fichier local.
...
Cela est par exemple bien utile pour les utilisateurs de OpenSSL (mais pas que!).
		...
		La fonction WLangage [DriveListeFichier](../WDLang3/1410089380.md) bénéficie d'une nouvelle option permettant de récupérer des informations supplémentaires lorsque l'on liste des fichiers :
...
- La fonction WLangage [AuthIdentifie](../WDLang3/1000022219.md) permet maintenant de réaliser une connexion en passant directement un login et un mot de passe. Cela permet par exemple de créer une fenêtre de login spécifique à l'application.

- La fonction WLangage [AuthDéconnecte](../WDLang3/1410090538.md) permet de se déconnecter du serveur d'authentification.

- La fonction WLangage [AuthRévoqueToken](../WDLang3/1410090634.md) révoque le token OAuth.
...
(définit le traitement des blocs lors du cryptage).
		...
		En version 2025, il devient possible de forcer la conversion d'un type simple vers un autre (par exemple [Entier](../Motscles/1514049.md) vers [Chaîne](../Motscles/1514044.md)) sans utiliser de variable locale.
Exemple de code :
...
```
		...
		La fonction de compression de fichier [ZipAjouteFichier](../WDLang3/3082008.md), qui ajoute des fichiers dans une archive Zip, est jusqu'à 4 fois plus rapide en version 2025.
Plus le nombre de fichiers à compresser est élevé, plus le gain est élevé !
		...
		Lors du parcours sur les emails dans une session IMAP, la fonction WLangage [EmailCherchePremier](../WDLang3/3032131.md) permet maintenant d'indiquer un critère de recherche : nom de l'expéditeur, nom du destinataire, objet, corps du message, etc.
...
Le nouveau type [JsonLecteur](../WDLang1/1410090783.md) et la nouvelle fonction [JsonOuvreLecteur](../WDLang1/1410090784.md) permettent de lire le contenu JSON sans avoir à le charger intégralement en mémoire.
...
- Les fonctions WLangage [TableauCherche](../WDLang1/3075002.md) et [TableauTrie](../WDLang1/3075007.md) fonctionnent sur les types UUID.

- [SocketLit](../WDLang3/3070014.md) : nouveau paramètre pour spécifier le timeout

- La fonction [eMailAppliRécupèreArchitecture](../WDLang3/1410090512.md) indique si le logiciel de messagerie du poste est en 32bits ou en 64bits

- [InitHasard](../WDLang1/3013030.md) renvoie la graine, permet de reproduire un même hasard

- Famille de fonctions [SSH](../WDLang3/1000021159.md) : la fonctionnalité Keep Alive est disponible, pour maintenir la connexion même en cas d'inactivité.
...
La version 2025 permet également de décrire la relation entre le PDF et les pièces jointes (ici en XML).<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Sch%E9ma%20facturation.gif)
...
<a name="yousign"></a>
		...
		La version 2025 de WINDEV propose la solution YouSign.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Yousign-Sch%E9ma.gif)
...
|   |   |
| --- | --- |
| [LiaisonFichier](../Proprietes/2510060.md) | DataBinding |
| [FichierParcouru](../Proprietes/2510040.md) | TableParcourue |
...
- La fonction [hImporteCSV](../WDLang4/1410090596.md) permet l'import d'un fichier CSV (fonction clone de [hImporteTexte](../WDLang4/3044011.md))

- Amélioration de [hTransactionListe](../WDLang4/3044351.md)

- La constante WLangage **hLSTTriée** de [hListeFichier](../WDLang4/3044045.md) est disponible en Client Serveur
...
En cas d'arrêt inopiné, un redémarrage de cluster s'effectue automatiquement.
		...
		La fonction WLangage [hSupprimeFichier](../WDLang4/3044294.md) est maintenant disponible pour le cluster HFSQL.
...
<a name="hfsql_spare"></a>
		...
		La nouvelle fonction WLangage [HRSTransformeSpareEnServeur](../WDLang4/1410091035.md) permet de basculer un serveur Spare (esclave) en serveur Maître.
...
Notez que la fonction WLangage [hListeHistoriquePlanification](../WDLang4/1410090762.md) permet de récupérer ces comptes-rendus par programmation.
...
<a name="iot"></a>
		...
		La nouvelle fonction WLangage [BTLECaractéristiqueChangementValeur](../WDLang3/1000022071.md) active ou active ou désactive la détection des changements de valeur d'une caractéristique Bluetooth Low Energy (LE) : par exemple, lors de l'utilisation d'un capteur de température, être averti ou pas lorsque la température change.
...
<a name="blockchain"></a>
		...
		En version 2025, la nouvelle famille de fonctions [Bitcoin](../WDLang1/1410090347.md) s'enrichit de 4 nouvelles fonctions :
