...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ%20Kanban%20_%20Les%20Cartes.png)![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ%20Kanban%20-%20Les%20Cartes%203.png)<br>![Les cartes Kanban sont totalement personnalisables. Ce sont des Fenêtres ou des Pages internes](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ%20Kanban%20_%20Les%20Cartes%202.png)
...
Ce type de graphe est principalement utilisé pour comparer des objectifs ou des parts de marché, ou illustrer une progression. La valeur n'est pas représentée par la largeur de la part, mais par sa longueur.<br>![Un graphe Aire Polaire](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Graphe%20aire%20polaire.jpg)
...
L'utilisateur final saisit les informations, puis imprime ou sauvegarde le formulaire.<br>![Un formulaire PDF à saisir](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Champ-PDF-Programmation-PDF-Editeur-d-Etat.png)
...
L'OCR s'effectue sur une zone spécifiée par l'utilisateur final.<br>![La fonction OCR automatique permet par exemple de récupérer un IBAN présent sous forme d'image pour le copier/coller.](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=OCR%20PDF%20yacht.jpg)
...
La vitesse de génération est 2 à 25 fois plus rapide en version 28, selon la taille des documents.
		...
		<br>![Selon le niveau de qualité choisi, la taille du fichier PDF varie](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Qualite%20PDF%20parametrable.png)
...
<br>![L'utilisateur final connaît l'état de la signature du PDF](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Signature%20PDF.png)
...
<a name="editeur_d_analyses_schema_des_donnees"></a>
		...
		Dans l'Editeur d'Analyses, la description des propriétés d'un Fichier de Données a été revue et simplifiée : cette description bénéficie maintenant d'une meilleure UX via les 7 onglets.<br>![Un des onglets de la description de Fichier de Données](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WX-Analyse-Edition%20des%20tables.png)
...
Il n'est plus nécessaire de répéter les manipulations sur chaque description.
		...
		Dans l'Editeur d'Analyses, les rubriques sont maintenant précédées d'une icône représentative, et leur graisse indique leur type : clé primaire, unique...<br>![Le choix est plus visuel](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WX-Analyse-Icones%20representatives.png)
...
En version 28, cette recompilation (migration automatique en version 28) s'effectue 2 fois plus rapidement.
		...
		<br>![L'éditeur WDSCRIPT livré en standard permet de saisir, exécuter et sauver du code WLangage](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-console-WL.png)
...
Les scripts permettent de créer facilement des traitements batch.
		...
		<br>![Les nouveaux toasts](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notification%20Automatic%20Update.jpg)
Lorsqu'une nouvelle version de l'environnement est disponible sur le site de PC SOFT, l'environnement lui-même vous prévient et vous propose la mise à jour : un toast s'affiche.
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notifications%20Plus%20Lisibles.jpg)
...
En version 28, l'appui sur la touche 0 du pavé numérique permet de visualiser les règles de magnétisme utilisées.
		...
		<br>![Des poignées faciles à saisir](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Poignes%20Ergonomiques.png)
...
En version 28, l'édition de cette image depuis l'onglet Style est facilitée par la présence d'un bouton d'édition.<br>![Editez directement l'image](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=7%20onglets%20-%20%E9diter%20image%20PP.jpg)
...
En version 28, l'environnement détaille précisément la raison de ce grisage.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD%20-%20Edition%20champ.png)
...
A chaque fois que cela est possible, une image de la base de données est utilisée.<br>![La gestion des images devient plus visuelle dans les 7 onglets](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Aper%E7u%20r%E9el%20modes%20image.png)
...
Les styles sont présentés par ordre d'intérêt.
		...
		En version 28, le catalogue d'images permet de modifier directement une image sélectionnée : recadrer, changer les couleurs, ajouter du texte, etc.<br>![L'image sélectionnée peut être directement modifiée](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Catalogue%20d'images%20-%20Editer%20l'image.jpg)
...
<a name="securite_par_mot_de_passe_groupware_utilisateur"></a>
		...
		<br>![La nouvelle fenêtre de login par défaut](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-LoginGroupware1.png)
...
<a name="debogueur"></a>
		...
		<br>![La barre orange met en évidence un blocage](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Extrait%20thread.png)
...
La fonction renvoie un tableau de polygones de l'ensemble des formes qui ont été détectées dans l'image.<br>![L'IA détecte les contours](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Detection-de-contours-2.jpg)
...
Pour plus de détails, consultez [Analyseur Temps Réel (ATR)](../Editeurs/9500237.md). 
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Extrait%20thread%20en%20temps%20r%E9el.png)
...
Vos fonctions apparaissent dans l'assistance de code du type ciblé.<br>![Votre fonction apparaît (en vert) dans la complétion](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD%20-%20RemplaceTabPar4Espaces.png)
...
Le lecteur d'email du destinataire pourra ainsi proposer d'ajouter ce rendez-vous dans l'agenda du destinataire.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ajout%20RDV.png)
...
La fonction se base sur un algorithme Homéomorphique.<br>![L'image est redressée](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Nouvelle-Fonction-Redresse.png)
...
il est possible de générer une image géométrique dans le champ](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WX-Generation-Image-geometrique.png)
...
Attention : cela ne signifie pas que le compte existe.
		...
		La nouvelle fonction PicCaptureLasso active le lasso sur l'écran, récupère le résultat de la sélection, effectue un OCR sur cette sélection, et renvoie le texte résultant.<br>![Lancez un OCR sur une zone](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=OCR%20PDF.png)
...
La vitesse de traitement augmente !
		...
		La fonction [HSurveille](../WDLang4/1000022407.md) permet à une application d'être avertie lorsqu'une modification effectuée par une autre application se produit sur le fichier de données spécifié.
