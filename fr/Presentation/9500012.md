...
Si des polices ont été oubliées, une erreur d'UI est générée.
		...
		<br>![Le contenu du champ de Recherche est enrichi](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM%20Markdown%202.png)<br>![Libellé du champ de saisie formaté](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM%20Markdown%20lib%20ch%20saisie.png)
...
Sans qu'aucun code ne soit nécessaire, vous incluez dans vos applis la possibilité de modifier photos et images.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM%20Editeur%20d'images2.png)
...
Si nécessaire, le Kanban se repositionne sur la liste (colonne) d'arrivée pour effectuer la manipulation.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Kanban%20Mobile.png)
En mode paysage, plusieurs listes (colonnes) sont affichées.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Kanban%20Mobile%201.png)
...
Le texte complet s'affiche alors.<br>![Le texte est tronqué, et l'appui sur "Voir plus" affiche le texte complet](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM%20-%20Champ%20m%E9tier%20voir%20plus.png)
		...
		Le Champ Métier "Badge" affiche un badge contenant une valeur sur un champ : image, bouton, etc.<br>![Un comportement d'UI standard](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-ChampM%E9tier1%20ROND.png)
...
La présentation est adaptée pour un usage mobile.<br>![Chaque destination sélectionnée est ajoutée aux jetons](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-ChampM%E9tier3.png)
		...
		Le Champ Métier "Complétion d'adresse" (voir Nouveauté 202) est également proposé en mobile : l'affichage est adapté à une utilisation tactile.<br>![Une liste de propositions d'adresses s'affiche](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-ChampM%E9tier2.png)
...
```
<br>![Le clic sur le bouton OUVRIR du site ou du mail lance l'application et ouvre la fiche de l'annonce sélectionnée](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=OUvrir%20une%20appli%20depuis%20un%20lien.png)
