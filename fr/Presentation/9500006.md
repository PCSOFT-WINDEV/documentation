...
Lors de la saisie, une sélection des destinataires en fonction des caractères saisis est effectuée. <br>![Chaque destinataire sélectionné apparait dans un jeton](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Champ-Metier-Saisie-Email-Avec-Jetons.gif)
...
La vitesse d'ouverture de ces fenêtres est augmentée en version 27. 
		...
		Petite nouveauté bien pratique, le champ calendrier de la version 27 peut afficher le numéro de semaine. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD%20Calendrier%20-%20Affichage%20semaine.jpg)
...
Les Zones Répétées sont ainsi plus élégantes et plus lisibles. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Rupture%20hauteur%20variable.png)
...
Par défaut, sous Windows 11, les fenêtres des applications WINDEV affichent un coin arrondi. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Windows11-coins-arrondis.png)
...
Les fenêtres répondent au nouveau menu "snap" et à ses gestures. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD-Windows11-snap.png)
...
Cette FAA est donc maintenant affichée dans le menu contextuel des tables afin d'être présentée aux utilisateurs. <br>![Un menu contextuel propose les FAA les plus utilisées](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD%20-%20FAA%20largeur%20colonne.gif)
...
- EUC-KR (coréen). 
		...
		Une notification est une petite fenêtre qui apparaît en bas à droite de l'écran, et qui reste consultable en permanence, dans la zone des notifications de Windows. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WD%20-%20Notif%20Windows%2011.gif)
