...
Ce token est fourni par un serveur d'authentification, basé sur un protocole OAuth.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WB-Webservice-Securise.gif)
...
Impossible de faire plus simple.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=PP%20WB-SSO.gif)
		...
		La méthode par programmation est destinée aux sites qui n'utilisent pas le GPU.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=SSo%20Perso%20Page%20Login.gif)
...
<a name="nouveaux_champs_metier"></a>
		...
		<br>![Un sélecteur simplifié](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CM%20WB%20S%E9lecteur%20couleur.gif)
...
La modification des propriétés des pages et des champs n'a jamais été aussi efficace !<br>![Le modifieur ouvert sur un champ Flexbox](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wb-modifieur-flexbo%2018%209x.gif)
...
La création et la modification des pages et des champs n'a jamais été aussi efficace !<br>![Le nouveau volet de création des champs](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WB-Volet-Champs.gif)
...
En version 2025 les possibilités de personnalisation en web s'enrichissent.
		...
		<br>![Granularité totalement personnalisable ; ici 10 mn](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Agenda%20granularit%E9.gif)
...
une opération «Porte Ouverte» en cours](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Agenda%20Couleur%20Fond.gif)
...
Un simple clic droit permet de passer d'un mode à l'autre.<br>![Ici, le champ Flexbox a la taille minimale d’exécution](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wb-flexbox-mode-edition-avec-tous-les-champs-visibles1.gif)<br>![Ici, le champ Flexbox affiche l’intégralité de son contenu](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wb-flexbox-mode-edition-avec-tous-les-champs-visibles%202.gif)
...
Bien pensé : la matérialisation des niveaux d'imbrication s'effectue par des couleurs différentes pour chaque niveau. Il est possible de changer le jeu de couleurs à tout moment afin que les couleurs soient visibles quel que soit le fond.<br>![Les fonds de couleur matérialisent l’imbrication](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Flexbox%20Mat%E9rialisation%20visuelle%20bis.gif)
...
<a name="nouveautes_sur_les_champs"></a>
		...
		<br>![Menu d’export disponible par défaut dans vos sites](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wb-faa-export-xlsx-sur-table.gif)
...
<a name="champ_graphe"></a>
		...
		Le nouveau type de graphe Pourcentage Imagé est disponible en WEBDEV.<br>![Un graphe très visuel](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WB_Graphe_pourcentage_imag%E9.gif)
...
<a name="reseaux_sociaux_outils_de_communication"></a>
		...
		<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=bouton_whatsapp2025.gif)
...
La saisie de cette limite s'effectue dans le Centre de Contrôle d'Hébergement.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WB%20Quota%20disque%20CC%20h%E9bergement.gif)
