...
Vous pouvez consulter la valeur des API Windows 32 bits, en cliquant sur : [Constantes API 32 bits](../AppelDLL/6510001.md) ou sur le site de Microsoft (www.microsoft.com) en tapant en constante le mot-clé "API".
...
[Valeur des constantes de l'API Windows 32 bits](../AppelDLL/6510001.md)
