...
<a name="declarer_une_variable_ELTPARAGRAPHE000101"></a>Avant d'utiliser une variable, il faut tout d'abord la déclarer (c'est-à-dire la créer).
...
<a name="affectation_utilisation_ELTPARAGRAPHE000135"></a>Lorsque la variable est déclarée, il est possible de l'affecter (ou lui donner une valeur). L'opérateur **=** permet d'effectuer cette affectation. 
...
1. Lancez le test du projet en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide.
...
### Le type Chaîne
<a name="type_chaine_ELTPARAGRAPHE000324"></a>Nous savons déjà que le type Chaîne permet de stocker et manipuler les caractères et les chaînes de caractères.
...
<a name="construction_une_chaine_ELTPARAGRAPHE000354"></a>Comme nous l'avons vu précédemment, la déclaration et l'affectation d'une chaîne sont très simples. Par exemple : 
...
<a name="operations_sur_une_chaine_ELTPARAGRAPHE000442"></a>Le WLangage propose de nombreux opérateurs et fonctions permettant de gérer les extractions et les manipulations de chaînes. 
...
4. Lancez le test du projet en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide. 
...
3. Lancez le test du projet en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide. 
...
<a name="recherche_une_chaine_ELTPARAGRAPHE000574"></a>Une manipulation courante sur les chaînes de caractères est la recherche. Qui n'a pas voulu savoir si un mot était présent dans une chaîne de caractères, quelle était sa position, etc. En WLangage, rien de plus simple. 
...
<a name="comparer_deux_chaines_ELTPARAGRAPHE000661"></a>Une autre opération courante sur les chaînes de caractères est la comparaison de chaînes : trouver si deux chaînes sont identiques. 
...
6. Lancez le test du projet en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide. 
