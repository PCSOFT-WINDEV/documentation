...
<a name="lecon_1_mise_place_une_base_donnees_clientserveur_ELTTEXTE000314"></a>
...
## Installation d'un serveur HFSQL local
<a name="installation_serveur_hfsql_local_ELTTEXTE000383"></a>
...
<a name="adaptation_une_application_pour_utiliser_une_base_donnees_hfsql_clientserveur_ELTTEXTE000443"></a>
...
<a name="ouverture_projet_exemple_ELTPARAGRAPHE000120"></a>Ce tuto manipule le projet "WD Application Complète". Pour ouvrir cet exemple : 
...
<a name="adaptation_projet_ELTPARAGRAPHE000133"></a>Pour adapter le projet "WD Application Complète" :

1. Chargez l'analyse de votre projet sous l'éditeur d'analyses : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Analyse_GAF.jpg) parmi les boutons d'accès rapide. L'éditeur d'analyses s'affiche.
...
3. Sélectionnez le type de connexion à créer : "HFSQL Client/Serveur". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0001.jpg&type=thumb)


4. Passez à l'étape suivante. 

5. Indiquez dans les étapes suivantes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0002.jpg&type=thumb)
...
6. Passez à l'étape suivante et validez. La connexion à la base de données est automatiquement créée. L'assistant propose d'associer les différents fichiers de données présents dans l'analyse à la connexion qui vient d'être créée. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0003.jpg)


7. Cliquez sur "Oui".

8. Dans l'étape suivante, sélectionnez tous les fichiers de données proposés : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0004.jpg&type=thumb)
Passez à l'étape suivante. 

9. L'assistant propose ensuite de copier les fichiers de données sur le serveur. Validez (option "Copier maintenant"). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0005.jpg)


10. Sélectionnez les fichiers de données de l'analyse à copier sur le serveur : dans notre cas, ce sont tous les fichiers de données du répertoire "EXE\\Exécutable Windows 64 bits". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0006.jpg&type=thumb)


11. Passez à l'étape suivante et validez.

12. Les fichiers de données de l'analyse sont automatiquement transformés en fichiers de données HFSQL Client/Serveur et associés à la connexion choisie. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0007.jpg&type=thumb)
...
## En résumé
<a name="resume_ELTTEXTE000488"></a>
...
<a name="pour_aller_plus_loin_ELTTEXTE000512"></a>
