...
<a name="lecon_3_recherche_multicritere_ELTTEXTE000711"></a>
...
## Présentation
<a name="presentation_ELTTEXTE000747"></a>
...
<a name="creation_requete_pour_rechercher_les_commandes_ELTTEXTE000771"></a>
...
5. Nous allons trier les données par date.
	...
	- Dans la fenêtre qui s'affiche, indiquez un tri croissant sur la rubrique. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0002.jpg&type=thumb)


	- Validez.

6. Une flèche bleue avec le numéro 01 apparaît à droite de la rubrique "Commande.Date". Cette flèche indique qu'un tri croissant est fait sur cette rubrique. Le chiffre "01" indique que ce tri sera réalisé en premier. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0003.jpg)


7. Donnez un nom à la requête : saisissez "REQ_RechercheCommandes" à la place de "REQ_SansNom1" dans la zone "Nom de la requête" : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0004.jpg)
...
10. La représentation graphique de la requête est affichée : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0005.jpg&type=thumb)
...
### Test de la requête
<a name="test_requete_ELTPARAGRAPHE000114"></a>Comme tous les éléments d'un projet WINDEV, il est possible de tester immédiatement la requête que nous venons de créer :

1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fenetre_WD_GAF.jpg).

2. Le résultat s'affiche dans une fenêtre : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0006.jpg&type=thumb)
...
<a name="definition_des_parametres_dans_requete_ELTTEXTE000819"></a>
<a name="NOTE3_3"></a>
...
<a name="premier_parametre_etat_commande_ELTPARAGRAPHE000155"></a>Pour gérer le paramètre "état de la commande" :
...
<a name="second_parametre_mode_reglement_ELTPARAGRAPHE000177"></a>Nous allons maintenant définir une condition sur le mode de règlement. Cette rubrique n'est pas présente dans le résultat de la requête mais nous souhaitons tout de même lui appliquer une condition. Pour cela, nous allons intégrer la rubrique dans le résultat de la requête et la rendre invisible pour qu'elle ne soit pas présente dans le résultat.
...
4. Validez la définition de la condition de sélection. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0009.jpg)
...
<a name="dernier_parametre_date_commande_ELTPARAGRAPHE000201"></a>La dernière condition de sélection à définir concerne la date de la commande. Cette date doit être comprise entre deux dates saisies par l'utilisateur.
...
6. Enregistrez la requête en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Enregistrer_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="test_requete_parametree_ELTPARAGRAPHE000224"></a>Pour tester la requête paramétrée :
...
3. Saisissez les données suivantes :
	...
	- Sélectionnez le paramètre ParamFinPériode. Dans la partie basse de l'écran, saisissez "31/03/2024". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0011.jpg&type=thumb)
...
<a name="modification_interface_pour_ajouter_recherche_multicritere_ELTTEXTE000876"></a>
...
<a name="creation_des_champs_parametrage_des_criteres_affichage_resultat_ELTTEXTE000900"></a>
...
10. Si nécessaire, modifiez la position du champ Table pour qu'il apparaisse entièrement dans le volet d'onglet. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0005.jpg&type=thumb)
...
4. Cliquez sur la colonne "COL_NomComplet". Remplacez le libellé "Nom complet" par "Client". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%203%20Rech%20Multi%20IHM%20Table%20-%20HC%20N%B0002.jpg&type=thumb)


5. Cliquez sur la colonne "COL_Libellé". Remplacez le libellé "Libellé" par "Mode de règlement". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Appli%20compl%E8te%20-%203%20Rech%20Multi%20IHM%20Table%20-%20HC%20N%B0003.jpg&type=thumb)
...
9. Enregistrez la fenêtre en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Enregistrer_GAF.jpg) parmi les boutons d'accès rapide. Nous allons vérifier les tailles des colonnes en exécutant la fenêtre.
...
Pour permettre à l'utilisateur de sélectionner un de ces trois états, nous allons utiliser le champ Sélecteur associé à la rubrique "Etat" du fichier de données "Commande".Les sélecteurs d'options permettent de sélectionner une option et une seule, parmi celles proposées.
...
Nous allons utiliser un champ Combo basé sur ce fichier de données pour permettre à l'utilisateur de sélectionner le mode de règlement voulu.Le champ "Combo" permet d'afficher une liste d'éléments et de sélectionner un élément dans cette liste.
...
1. Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Combo_WD_GAF.jpg).
...
## En résumé
<a name="resume_ELTTEXTE001002"></a>
**Projet corrigé**
