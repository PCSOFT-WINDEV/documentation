...
<a name="identifier_utilisateur_groupware_utilisateur_ELTTEXTE000320"></a>
...
## Intégrer le groupware utilisateur
<a name="integrer_groupware_utilisateur_ELTTEXTE000380"></a>
...
<a name="integration_groupware_utilisateur_ELTPARAGRAPHE000057"></a>L'intégration du groupware utilisateur dans le projet se fait en en quelques clics : 
...
3. Activez le groupware utilisateur en cliquant sur "Actif".  <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0001.jpg&type=thumb)
...
3. Cliquez sur l'onglet "Options". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0003.jpg&type=thumb)
...
5. Sélectionnez l'onglet "Fichiers de données".  <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0004.jpg&type=thumb)
...
6. Sélectionnez l'onglet "OAuth". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0005.jpg&type=thumb)
...
## Configurer le groupware utilisateur
<a name="configurer_groupware_utilisateur_ELTTEXTE000446"></a>
...
1. Lancez le test du projet (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide). Une fenêtre de login apparaît.

2. Connectez-vous en tant que "superviseur". Définissez le mot de passe et donnez sa confirmation. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0006.jpg&type=thumb)


3. Validez.

4. Un nouveau menu apparaît, permettant soit de tester l'application, soit de configurer l'application. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0007.jpg&type=thumb)
...
2. Réalisez un "Glisser - Déposer" (Drag and Drop) de l'utilisateur "Test_1" vers le groupe "Tests". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0011.jpg&type=thumb)
...
<a name="definition_des_droits_des_utilisateurs_des_groupes_ELTPARAGRAPHE000198"></a>Nous allons maintenant définir les droits pour le groupe d'utilisateurs "Tests". Ces droits seront appliqués à tous les utilisateurs du groupe. Dans notre exemple, les utilisateurs du groupe "Tests" ne pourront pas :
...
2. Cliquez sur le bouton "Interdire l'accès". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0012.jpg&type=thumb)
...
4. Passez en "Grisé" les champs "BTN_Modifier" et "BTN_Nouveau" : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0013.jpg&type=thumb)
...
<a name="test_application_ELTPARAGRAPHE000245"></a>Nous allons maintenant tester l'application en utilisant le login "Test_1".
...
4. Sélectionnez si nécessaire l'onglet "Liste des produits". Vous pouvez observer que les boutons "Nouveau" et "Modifier" sont grisés et que l'option de menu "Envoyer un email" est invisible. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9grer%20le%20GPU%20-%20HC%20N%B0015.jpg&type=thumb)
...
<a name="pour_aller_plus_loin_ELTTEXTE000506"></a>
...
## Conclusion
<a name="conclusion_ELTTEXTE000530"></a>
