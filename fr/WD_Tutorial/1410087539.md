...
<a name="lecon_7_envoyer_email_ELTTEXTE000599"></a>
...
<a name="creation_fenetre_ELTPARAGRAPHE000064"></a>Créez une nouvelle fenêtre :
...
<a name="creation_des_champs_parametrage_envoi_ELTPARAGRAPHE000079"></a>Nous allons dans un premier temps créer tous les champs permettant de paramétrer le serveur SMTP utilisé pour l'envoi des messages. Quatre champs de saisie sont nécessaires :
...
<a name="creation_des_champs_permettant_saisir_les_caracteristiques_email_ELTPARAGRAPHE000166"></a>Pour écrire un email, l'utilisateur doit avoir à sa disposition :
...
1. Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Saisie_GAF.jpg). La forme du champ apparaît sous le curseur de la souris.
...
<a name="code_wlangage_permettant_envoyer_email_ELTTEXTE000728"></a>
...
<a name="ameliorations_fenetre_ELTTEXTE000752"></a>
...
<a name="fermeture_fenetre_ELTPARAGRAPHE000406"></a>Pour ajouter un champ Bouton permettant de fermer la fenêtre :
...
### Mise en forme
<a name="mise_forme_ELTPARAGRAPHE000429"></a>Pour définir les ancrages :
...
<a name="ouverture_fenetre_depuis_menu_deroulant_ELTPARAGRAPHE000470"></a>La fenêtre de gestion des emails va être ouverte directement depuis une option du menu déroulant de la fenêtre "FEN_Menu". Nous avons créé le menu déroulant de la fenêtre dans la [leçon 5 de ce tuto](../TutoWD/1410087492.md).
...
## En résumé
<a name="resume_ELTTEXTE000812"></a>
**Projet corrigé**
