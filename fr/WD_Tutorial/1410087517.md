...
<a name="lecon_6_les_procedures_ELTTEXTE000612"></a>
...
Ouvrez si nécessaire le projet "WLangage" que vous avez créé dans la première leçon de ce tuto (consultez le paragraphe [Un projet pour découvrir le WLangage](../TutoWD/1410087578.md) de la leçon 1).
...
<a name="premiere_procedure_ELTTEXTE000672"></a>
...
Arrêtons-nous un instant sur cette fenêtre. Il est possible : 
	...
	- d'indiquer si la procédure doit être un "TOOL IA". Dans ce cas, la procédure WLangage sera utilisable par l'IA conversationnelle du champ Chat IA (dans votre application WINDEV). Pour plus de détails, consultez [Instruction &lt;TOOL IA&gt;](../Motscles/1512012.md). 
...
## Paramètres d'une procédure
<a name="parametres_une_procedure_ELTTEXTE000723"></a>


### Qu'est-ce qu'un paramètre ?
<a name="questce_quun_parametre_ELTPARAGRAPHE000287"></a>Un paramètre est une valeur envoyée à une procédure lors de l'appel de la procédure.
...
<a name="gestion_des_parametres_passage_par_reference_par_valeur_ELTPARAGRAPHE000367"></a>Par défaut, le WLangage utilise le **passage de paramètre par référence** (ou par adresse). Le paramètre dans la procédure représente (référence) directement la variable passée lors de l'appel.
...
### Renvoyer une valeur
<a name="renvoyer_une_valeur_ELTPARAGRAPHE000421"></a>Une procédure peut renvoyer une valeur. Voici quelques exemples : 
...
## En résumé
<a name="resume_ELTTEXTE000783"></a>
