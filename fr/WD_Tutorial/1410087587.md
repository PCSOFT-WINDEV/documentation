...
<a name="lecon_3_dates_tableaux_structures_ELTTEXTE000608"></a>
...
<a name="variables_type_date_heure_duree_ELTTEXTE000668"></a>
Le WLangage propose différents types de variables permettant de gérer les dates, les heures et les durées.


### Le type Date
<a name="type_date_ELTPARAGRAPHE000066"></a>Pour gérer les dates, le WLangage propose le type **Date**. De nombreuses fonctions et propriétés permettent de manipuler les dates.  
...
5. La fonction [&lt;Date&gt;.VersChaîne](../WDLang1/1000023952.md) permet de choisir le format d'affichage d'une date. Il est également possible d'utiliser la fonction [&lt;Date&gt;.VersJourEnLettre](../WDLang1/1000024031.md). Par exemple, saisissez le code suivant : 
...
8. Il est également possible d'utiliser des opérateurs de comparaison entre des dates. Saisissez le code suivant : 
	...
	FIN
	```
Dans ce code, la fonction [DateDuJour](../WDLang1/3027016.md) permet comme son nom l'indique de connaître la date correspondant au jour. 

9. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide. 
...
### Le type Heure
<a name="type_heure_ELTPARAGRAPHE000149"></a>De la même manière, il est possible de manipuler des heures grâce au type **Heure**. 
...
3. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD_GAF.jpg) parmi les boutons d'accès rapide. 
...
### Le type Durée
<a name="type_duree_ELTPARAGRAPHE000184"></a>Pour les durées, le même type de code peut être saisi. 
...
Pour plus de détails sur les variables de type Date, Heure et Durée, consultez [Variable de type Date](../Motscles/1514066.md), [Variable de type Heure](../Motscles/1514068.md), [Variable de type Durée](../Motscles/1514069.md). 
...
<a name="les_variables_type_tableau_ELTTEXTE000719"></a>
...
### Déclaration
<a name="declaration_ELTPARAGRAPHE000241"></a>La déclaration d'une variable de type tableau se fait de la façon suivante : 
...
<a name="remplissage_tableau_acces_aux_elements_ELTPARAGRAPHE000256"></a>Lors de sa déclaration, le tableau est vide. L'ajout d'éléments est réalisé par la fonction [&lt;Tableau&gt;.Ajoute](../WDLang1/1000024299.md) grâce à la syntaxe suivante : 
...
<a name="parcours_tableau_ELTPARAGRAPHE000315"></a>Pour parcourir les éléments d'un tableau, le WLangage propose deux méthodes : 
...
<a name="variables_type_structure_ELTTEXTE000776"></a>


### Le type Structure
<a name="type_structure_ELTPARAGRAPHE000438"></a>Une structure est un type de données personnalisé. Une structure regroupe des variables de types différents.
...
## En résumé
<a name="resume_ELTTEXTE000809"></a>
...
| [Leçon précédente](../TutoWD/1410087514.md) | [Sommaire](../TutoWD/1410087560.md) | [Leçon suivante](../TutoWD/1410087515.md) |
| --- | --- | --- |
