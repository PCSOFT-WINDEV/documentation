...
<a name="borne_minimale_borne_maximale_sur_une_rubrique_cle_type_texte_cle_composee_ELTPARAGRAPHE000285"></a>Si la borne minimale et la borne maximale sont identiques :
...
<a name="filtre_parcours_filtre_ELTPARAGRAPHE000327"></a>Après l'exécution de la fonction **&lt;Source&gt;.Filtre**, le parcours du fichier de données doit obligatoirement être effectué sur la rubrique renvoyée par la fonction **&lt;Source&gt;.Filtre**. Si une autre rubrique est utilisée pour le parcours du fichier de données, le filtre ne sera pas pris en compte.
...
<a name="condition_selection_ELTPARAGRAPHE000380"></a>La syntaxe générale d'une condition a la forme suivante :
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les opérateurs ~~ et ~= ne doivent pas être utilisés. Ces opérateurs sont interdits.
...
<a name="activationdesactivation_filtre_ELTPARAGRAPHE000506"></a>La fonction [&lt;Source&gt;.DésactiveFiltre](../WDLang4/1000024218.md) permet de désactiver un filtre.
...
<a name="filtre_sur_une_cle_composee_ELTPARAGRAPHE000542"></a>Pour construire un filtre sur une clé composée, plusieurs méthodes sont disponibles :
...
<a name="fichiers_donnees_non_hfsql_ELTPARAGRAPHE000599"></a>
