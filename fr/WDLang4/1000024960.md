...
<a name="filtre_parcours_filtre_ELTPARAGRAPHE000344"></a>Après l'exécution de la fonction **&lt;Source&gt;.Filtre**, le parcours du fichier de données doit obligatoirement être effectué sur la rubrique renvoyée par la fonction **&lt;Source&gt;.Filtre**. Si une autre rubrique est utilisée pour le parcours du fichier de données, le filtre ne sera pas pris en compte.
...
<a name="condition_selection_ELTPARAGRAPHE000397"></a>La syntaxe générale d'une condition a la forme suivante :
...
<a name="activationdesactivation_filtre_ELTPARAGRAPHE000514"></a>La fonction [&lt;Source&gt;.DésactiveFiltre](../WDLang4/1000024218.md) permet de désactiver un filtre.
...
<a name="filtre_sur_une_cle_composee_ELTPARAGRAPHE000550"></a>Pour construire un filtre sur une clé composée, plusieurs méthodes sont disponibles :
