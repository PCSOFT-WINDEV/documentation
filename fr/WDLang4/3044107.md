...
- définir et ouvrir une connexion en utilisant une chaîne de connexion. Cette syntaxe peut être utilisée avec certains providers OLE DB ayant des chaînes de connexion ADO spécifique.
	![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette option n'est pas disponible.
...
<a name="syntaxe_1_ouvrir_une_connexion_predefinie_gestion_automatique_des_connexions_ELTPARAGRAPHE000734"></a>
...
<a name="syntaxe_2_utiliser_une_chaine_caracteres_pour_provider_ole_ELTPARAGRAPHE000753"></a>Pour trouver facilement la chaîne de caractères à utiliser pour définir le provider OLE DB, il est conseillé de procéder de la manière suivante :
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=HouvreConnexion%20-%20HC%20N%B0001.gif)

<a name="NOTE0_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png)![OLE DB](https://doc.pcsoft.fr/ext/images/fr/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) 

### Syntaxe 2 et 3 : En cas d'échec, la description de la connexion n'est pas conservée
<a name="syntaxe_2_3_cas_echec_description_connexion_nest_pas_conservee_ELTPARAGRAPHE000770"></a>Si l'ouverture de la connexion échoue, la description de cette connexion n'est pas validée. Il est ainsi possible de redéfinir une connexion du même nom.
...
<a name="pseudoconnexion_une_base_donnees_hfsql_classic_ELTPARAGRAPHE000783"></a>Des fichiers de données OLE DB ou natifs sont décrits sous l'éditeur d'analyses. Pour manipuler ces descriptions avec une base de données HFSQL Classic, il suffit de spécifier la constante ***hAccèsHF7*** comme nom de provider.
...
<a name="fichier_udl_fichier_description_connexion_ole_ELTPARAGRAPHE000829"></a>Pour créer un fichier UDL :
...
<a name="connecteur_natif_oracle_gestion_authentification_externe_ELTPARAGRAPHE000848"></a>Pour se connecter via une authentification externe, il est nécessaire d'utiliser les paramètres de connexion suivants : 
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000862"></a>

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Seule la constante *hAccèsNatifSQLite* est disponible pour Android. 
