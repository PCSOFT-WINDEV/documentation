...
<a name="exporter_contenu_une_requete_ELTPARAGRAPHE000248"></a>Pour exporter le contenu d'une requête, il est nécessaire d'initialiser la requête (fonction [&lt;Source&gt;.ExécuteRequête](../WDLang4/1000024944.md)) avant d'utiliser la fonction **&lt;Source&gt;.ExporteJSON**.
<a name="NOTE0_2"></a>


### Exporter un seul enregistrement
<a name="exporter_seul_enregistrement_ELTPARAGRAPHE000266"></a>Pour exporter un seul enregistrement vers une chaîne JSON, utilisez la fonction [&lt;Source&gt;.EnregistrementVersJSON](../WDLang4/1000024607.md).
<a name="NOTE0_3"></a>


### Rubriques tableau
<a name="rubriques_tableau_ELTPARAGRAPHE000281"></a>Si une des rubriques exportées est une rubrique de type Tableau, chaque élément de la rubrique tableau est exportée dans un nouveau niveau :
