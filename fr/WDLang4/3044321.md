...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003044321&name=hinfodroitfichier_fonction">Voir des exemples supplémentaires</a>
...
## Remarques
Pour modifier les droits sur un fichier de données pour un utilisateur ou un groupe, utilisez la fonction [HModifieDroitFichier](../WDLang4/3044327.md).
