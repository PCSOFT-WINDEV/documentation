...
<a name="lecture_selon_une_cle_ELTPARAGRAPHE000433"></a>La fonction **&lt;Source&gt;.Dernier** positionne sur l'enregistrement pour lequel la valeur de la clé est la plus grande.
...
<a name="verification_mot_passe_ELTPARAGRAPHE000455"></a>Si la fonction **&lt;Source&gt;.Dernier** est la première fonction manipulant le fichier de données spécifié, la vérification du mot de passe est effectuée lors de l'ouverture du fichier de données.
...
### Divers
<a name="divers_ELTPARAGRAPHE000486"></a>
...
<a name="comparaison_litdernierwdlang41000025020md_docparampagetitleshort_ELTPARAGRAPHE000507"></a>La fonction **&lt;Source&gt;.Dernier** ne lit pas l'enregistrement : la fonction **&lt;Source&gt;.Dernier** est donc plus rapide que la fonction [&lt;Source&gt;.LitDernier](../WDLang4/1000025020.md).
<a name="NOTE0_5"></a>
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000537"></a>Par défaut (paramètre &lt;Options&gt; non spécifié), aucun blocage de l'enregistrement n'est réalisé.
