...
<a name="rep_liste_des_fichiers_donnees_ELTTEXTE000304"></a>
...
Le GUID du fichier de données correspond à l'identifiant du fichier de données logique. Cet identifiant peut être connu sous l'éditeur d'analyses, dans la description du fichier de données (onglet "Notes").<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=fichier_Rep.gif)
...
<a name="exemple_mise_jour_une_application_avec_modification_analyse_ELTPARAGRAPHE000042"></a>Lors de la mise à jour d'une application WINDEV, la modification automatique des fichiers de données est automatiquement lancée en cas de modifications sur la structure de la base de données.
...
<a name="gestion_fichier_rep_liste_des_fichiers_donnees_ELTPARAGRAPHE000057"></a>
...
<a name="creation_modification_fichier_rep_liste_des_fichiers_donnees_ELTPARAGRAPHE000071"></a>
...
|   |   |
| --- | --- |
| [HListeREP](../WDLang4/3044229.md) | Liste les différents fichiers de données et leur chemin physique associé présents dans le fichier .REP |
...
<a name="ecriture_dans_fichier_ELTPARAGRAPHE000118"></a>Pour écrire dans le fichier .REP, il suffit d'utiliser les fonctions de gestion de fichiers externes :
...
| [GUIDFichier](../Proprietes/2512099.md) | Renvoie le GUID du fichier de données défini dans l'analyse qui a permis de créer le fichier de données. |
...
### Structure du fichier .REP
<a name="structure_fichier_rep_ELTPARAGRAPHE000197"></a>La structure du fichier .REP est la suivante :
