...
<a name="comment_decrire_fichier_donnees_par_programmation_ELTPARAGRAPHE000147"></a>Pour décrire un fichier de données par programmation, il faut :
...
- **Solution 1 (syntaxe 1) : Description directe**
	...
	5. Fixer la description des index sémantiques avec la fonction [HDécritIndexSémantique](../WDLang4/1410086684.md).

	6. Fixer la description du fichier de données (fonction **HDécritFichier**, syntaxe 1) et des liaisons si nécessaire (fonction [HDécritLiaison](../WDLang4/3044191.md)).
...
- **Solution 2 (syntaxe 2) : Description à l'aide d'une source de données**
	...
	2. Utiliser des variables de type [Description de Fichier](../WDLang4/1514065.md), [Description de Rubrique](../WDLang4/1514071.md), [Description de Liaison](../WDLang4/1514039.md), [Description d'IndexFullText](../WDLang4/1000017461.md) et [Description de IndexSémantique](../WDLang4/1410086697.md) (si nécessaire).
...
<a name="liste_des_proprietes_hfsql_utilisables_pour_decrire_fichier_donnees_par_programmation_ELTPARAGRAPHE000297"></a>Les propriétés suivantes sont disponibles en lecture et écriture.
...
| [GrosFichier](../Proprietes/2512037.md) | La propriété **GrosFichier** permet de paramétrer la taille maximale possible d'un fichier de données. |
| [Journalisation](../Proprietes/2512044.md) | La propriété **Journalisation** permet de :<br><br>- connaître le mode de journalisation utilisé pour un fichier de données (fichier de données défini sous l'éditeur d'analyses ou défini par programmation).<br><br>- définir le mode de journalisation utilisé pour un fichier de données (lors de la description du fichier de données par programmation uniquement).<br><br><br> |
...
<a name="les_types_fichiers_donnees_pouvant_etre_decrits_avec_fonction_docparampagetitleshort_ELTPARAGRAPHE000307"></a>La propriété [Type](../Proprietes/2510131.md) permet de spécifier le type du fichier de données à créer.
...
<a name="NOTE0_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/fr/HF55.png) 

### Syntaxe 2 : Description de fichier de données (compatibilité 5.5)
<a name="syntaxe_2_description_fichier_donnees_compatibilite_55_ELTPARAGRAPHE000361"></a>Cette syntaxe permet de créer des fichiers de données temporaires au format Hyper File 5.5. Cette syntaxe n'est utilisable que dans une application réalisée avec WINDEV 5.5 ou WEBDEV 1.5 et migrée vers WINDEV 7 ou supérieure. Pour utiliser cette fonction, il est nécessaire que :
...
[&lt;Source&gt;.DécritFichier (Fonction)](../WDLang4/1000024215.md)
