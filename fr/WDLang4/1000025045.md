...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce paramètre est ignoré.![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Ce paramètre est ignoré. La précision de calcul est toujours élevée.
...
<a name="position_par_rapport_une_rubrique_cle_non_cle_ELTPARAGRAPHE000248"></a>Pour une rubrique clé, la position retournée est relative à l'ordre de l'enregistrement dans l'index de cette rubrique.

Pour une rubrique non clé, la position retournée est relative au numéro de l'enregistrement dans le fichier de données (voir la fonction [&lt;Source&gt;.NumEnr](../WDLang4/1000025041.md)).
<a name="NOTE0_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/fr/HF55.png)![OLE DB](https://doc.pcsoft.fr/ext/images/fr/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) 

### Position dans un parcours filtré
<a name="position_dans_parcours_filtre_ELTPARAGRAPHE000267"></a>Si un filtre avec bornes est défini (fonction [&lt;Source&gt;.Filtre](../WDLang4/1000024960.md) sans chaîne de condition mais avec les bornes minimales et maximales), la position retournée est relative aux enregistrements sélectionnés par le filtre.
