...
<a name="proprietes_wlangage_utilisables_sur_une_connexion_decrite_par_programmation_ELTPARAGRAPHE000058"></a>Les propriétés spécifiques aux connexions sont détaillées dans le tableau suivant :
...
| [Serveur](../Proprietes/2512105.md) | Permet de gérer le nom du serveur utilisé dans la connexion. Cette propriété est identique à la propriété [Source](../Proprietes/2510147.md). Cette propriété est plutôt utilisée pour les connexions HFSQL Client/Serveur ou les Accès Natifs sur les serveurs. <br>![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Il est possible d'indiquer une adresse IPv6 en écrivant l'adresse IPv6 entre des crochets. Dans ce cas, le numéro de port doit être indiqué après le crochet fermant. Par exemple : [0154:2145:2155::5554]:4900. |
...
<a name="connecteur_natif_oracle_gestion_authentification_externe_ELTPARAGRAPHE000172"></a>Pour se connecter via une authentification externe : 
...
<a name="equivalences_code_description_une_connexion_ELTPARAGRAPHE000184"></a>Code utilisant la fonction [HDécritConnexion](../WDLang4/3044205.md) :
...
<a name="equivalences_code_ouverture_une_connexion_ELTPARAGRAPHE000198"></a>Code utilisant la fonction [HOuvreConnexion](../WDLang4/3044107.md) :
...
<a name="equivalence_code_affecter_une_connexion_ELTPARAGRAPHE000212"></a>Code utilisant la fonction [HChangeConnexion](../WDLang4/3044150.md) :
...
<a name="equivalence_code_modifier_une_connexion_existante_ELTPARAGRAPHE000226"></a>Code utilisant la fonction [HDécritConnexion](../WDLang4/3044205.md) :
