...
<a name="reinitialisation_des_positions_ELTPARAGRAPHE000186"></a>Attention : toutes les fonctions entraînant l'ouverture ou la fermeture d'un fichier de données réinitialisent les numéros de contexte (par exemple [HCréation](../WDLang4/3044255.md), [HFerme](../WDLang4/3044073.md), ...).
...
### Divers
<a name="divers_ELTPARAGRAPHE000232"></a>
...
<a name="principe_repositionnement_pour_les_connecteurs_natifs_egalement_appeles_acces_natifs_ELTPARAGRAPHE000253"></a>L'enregistrement est restauré à partir du cache interne du Connecteur Natif.
