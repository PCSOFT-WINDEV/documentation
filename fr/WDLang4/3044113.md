...
<a name="lecture_selon_une_cle_ELTPARAGRAPHE000292"></a>La fonction **HPremier** positionne sur l'enregistrement pour lequel la valeur de la clé est la plus petite.
...
<a name="verification_mot_passe_ELTPARAGRAPHE000313"></a>Si la fonction **HPremier** est la première fonction manipulant le fichier de données spécifié, la vérification du mot de passe est effectuée lors de l'ouverture du fichier de données.
...
### Divers
<a name="divers_ELTPARAGRAPHE000341"></a>
...
<a name="comparaison_des_fonctions_hlitpremierwdlang43044051md_docparampagetitleshort_ELTPARAGRAPHE000357"></a>La fonction **HPremier** ne lit pas l'enregistrement : la fonction **HPremier** est donc plus rapide que la fonction [HLitPremier](../WDLang4/3044051.md).
<a name="NOTE0_5"></a>
