...
`<Résultat> = <Fichier de données>.JSONVersEnregistrement(<Données JSON> [, <Liste des rubriques à importer> [, <Liste des "items" à importer>]])`
---
...
### Mode d'importation
<a name="mode_importation_ELTPARAGRAPHE000203"></a>Si la liste des items est précisée : l'importation recherchera des "items JSON" ayant le même nom que les rubriques.
...
### Encodage
<a name="encodage_ELTPARAGRAPHE000219"></a>L'encodage utilisé correspond au standard JSON : 
