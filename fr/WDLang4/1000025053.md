...
<a name="recherche_generiquerecherche_identique_ELTPARAGRAPHE000354"></a>Selon &lt;Valeur Recherchée&gt;, la recherche peut être générique ou à l'identique.
...
<a name="espaces_fin_rubrique_ELTPARAGRAPHE000376"></a>Par défaut, lors de la lecture d'un enregistrement, les espaces en fin des rubriques de type texte ne sont pas supprimés dans les variables associées au fichier de données.
...
<a name="recherche_sur_une_cle_composee_ELTPARAGRAPHE000391"></a>Plusieurs méthodes permettent de faire une recherche sur une clé composée :
...
<a name="recherche_sur_une_rubrique_tableau_ELTPARAGRAPHE000423"></a>La recherche se fait uniquement sur le premier élément du tableau (élément d'indice 1). Pour effectuer une recherche sur les autres éléments du tableau, utilisez des filtres ou des requêtes.
<a name="NOTE0_5"></a>


### Recherche et filtre
<a name="recherche_filtre_ELTPARAGRAPHE000433"></a>Si un filtre est actif (fonction [&lt;Source&gt;.Filtre](../WDLang4/1000024960.md)), la recherche tient compte du filtre.
