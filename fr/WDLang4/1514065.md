...
<a name="proprietes_specifiques_description_fichiers_donnees_ELTPARAGRAPHE000077"></a>Les propriétés spécifiques à la description de fichiers de données sont détaillées dans le tableau suivant :
...
| [CxAccès](../Proprietes/2512015.md) | Type d'accès au fichier de données lors de la connexion OLE DB à une table spécifique (en tenant compte des modifications effectuées par la fonction [HConnecte](../WDLang4/3044263.md)). |
| [CxAccèsDécrit](../Proprietes/2512048.md) | Type d'accès au fichier de données lors de la connexion OLE DB à une table spécifique (sans tenir compte des modifications effectuées par la fonction [HConnecte](../WDLang4/3044263.md)). |
...
| [CxMotDePasseDécrit](../Proprietes/2512012.md) | Mot de passe utilisé pour ouvrir le fichier de données lors d'une connexion OLE DB. |
...
| [MotDePasseWDD55](../Proprietes/2512049.md) | Mot de passe à utiliser pour manipuler un fichier de données définit par programmation au format Hyper File 5.5 dans une analyse au format WINDEV. |
| [Nom](../Proprietes/2510082.md) ( \* ) | Nom du fichier de données HFSQL. |
| [Nom55](../Proprietes/2512054.md) | Nom logique du fichier de données au format Hyper File 5.5 présent dans une analyse au format WINDEV. |
...
| [NomPhysiqueDécrit](../Proprietes/2512063.md) | Nom physique des fichiers de données HFSQL (sans tenir compte des changements de nom réalisés grâce à la fonction [HChangeNom](../WDLang4/3044141.md)). |
...
| [Répertoire](../Proprietes/2512078.md) | Répertoire physique des fichiers de données HFSQL (cette propriété tient compte des changements de répertoires réalisés grâce aux fonctions [HChangeRep](../WDLang4/3044168.md) ou [HSubstRep](../WDLang4/3044028.md)). |
| [RépertoireDécrit](../Proprietes/2512074.md) | Répertoire physique des fichiers de données HFSQL (cette propriété ne tient pas compte des changements de répertoires réalisés grâce aux fonctions [HChangeRep](../WDLang4/3044168.md) ou [HSubstRep](../WDLang4/3044028.md)). |
...
<a name="comment_decrire_des_fichiers_donnees_par_programmation_ELTPARAGRAPHE000307"></a>Pour décrire des fichiers de données par programmation, il faut :
...
<a name="manipulation_des_rubriques_fichier_donnees_decrit_par_programmation_ELTPARAGRAPHE000359"></a>Lors de la création d'un fichier de données sous l'éditeur d'analyses, les noms du fichier de données et de ses rubriques sont automatiquement reconnus par le compilateur.
...
### Journalisation
<a name="journalisation_ELTPARAGRAPHE000383"></a>Lors de la description du fichier de données par programmation :
