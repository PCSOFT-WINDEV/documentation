...
<a name="conditions_utilisation_docparampagetitleshort_ELTPARAGRAPHE000109"></a>Cette fonction ne doit être utilisée QUE lorsque vous n'avez plus besoin du fichier de données (ou de la requête) concerné!
...
<a name="fonction_docparampagetitleshort_fermeture_fichier_donnees_ELTPARAGRAPHE000133"></a>Pour utiliser la fonction **HAnnuleDéclaration** sur un fichier de données, ce fichier de données doit être fermé.
