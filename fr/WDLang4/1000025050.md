...
<a name="comment_utiliser_fonction_docparampagetitleshort_ELTPARAGRAPHE000299"></a>Pour préparer et exécuter une requête plusieurs fois, il faut :
...
<a name="condition_sur_une_cle_composee_dans_une_requete_sql_ELTPARAGRAPHE000350"></a>Pour définir une condition sur une clé composée dans une requête SQL, **il faut préciser les conditions de chacune des composantes de la clé**.
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000365"></a>Cette fonction n'est pas disponible lors de l'utilisation d'une base de données via .
