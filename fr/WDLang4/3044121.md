...
<a name="manipulations_enregistrement_raye_ELTPARAGRAPHE000159"></a>
...
<a name="nombre_enregistrements_rayes_ELTPARAGRAPHE000237"></a>La fonction [HNbEnr](../WDLang4/3044006.md) permet de connaître le nombre d'enregistrements rayés dans le fichier de données.
...
<a name="version_fichier_donnees_ELTPARAGRAPHE000251"></a>En cas de succès de la fonction **HRaye**, le numéro de version du fichier de données est modifié. Ce numéro de version est donné par la fonction [HVersion](../WDLang4/3044020.md).
<a name="NOTE0_4"></a>


### Rayer un enregistrement à partir d'une requête
<a name="rayer_enregistrement_partir_une_requete_ELTPARAGRAPHE000266"></a>Il est possible de rayer un enregistrement :
...
### Cas particuliers
<a name="cas_particuliers_ELTPARAGRAPHE000294"></a>
...
<a name="fichiers_donnees_xbase_ELTPARAGRAPHE000335"></a>La fonction [HSupprime](../WDLang4/3044018.md) a le même effet que la fonction **HRaye** : l'enregistrement est rayé et non supprimé. L'enregistrement peut donc être réactivé par la fonction [HModifie](../WDLang4/3044042.md). Dans ce cas, la fonction [HEtat](../WDLang4/3044081.md) renvoie la constante *hEtatRaye* sur un enregistrement supprimé (et non la constante *hEtatSup*).
