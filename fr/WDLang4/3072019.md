...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Seules les requêtes créées et exécutées avec la fonction [SQLExec](../WDLang4/3072007.md) sont disponibles. 
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Les colonnes peuvent être récupérées dans n'importe quel ordre.
...
- Pour lire les colonnes de type mémo, utilisez la fonction [SQLLitMémo](../WDLang4/3072020.md). Pour lire les colonnes de type mémo texte, utilisez la fonction [SQLLitMémoTexte](../WDLang4/3072012.md). 
	![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les fonctions [SQLLitMémo](../WDLang4/3072020.md) et [SQLLitMémoTexte](../WDLang4/3072012.md) sont inutiles.
	![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La lecture des colonnes de type mémo n'est pas disponible.
...
- La même colonne ne peut pas être récupérée plusieurs fois à la suite. En effet, la seconde fois, le résultat récupéré sera une chaîne vide.
	![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La même colonne peut être récupérée plusieurs fois à la suite.
...
<a name="NOTE0_6"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![ODBC](https://doc.pcsoft.fr/ext/images/fr/ODBC.png) 
