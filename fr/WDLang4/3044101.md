...
En général, la fonction **HDernier** permet de se positionner dans le fichier de données pour effectuer une boucle de parcours parmi les enregistrements correspondant à une condition. La fonction [HSuivant](../WDLang4/3044027.md) permet de se positionner sur l'enregistrement suivant correspondant à la condition.
...
<a name="lecture_selon_une_cle_ELTPARAGRAPHE000249"></a>La fonction **HDernier** positionne sur l'enregistrement pour lequel la valeur de la clé est la plus grande.
...
<a name="verification_mot_passe_ELTPARAGRAPHE000270"></a>Si la fonction **HDernier** est la première fonction manipulant le fichier de données spécifié, la vérification du mot de passe est effectuée lors de l'ouverture du fichier de données.
...
### Divers
<a name="divers_ELTPARAGRAPHE000298"></a>
...
<a name="comparaison_hlitdernierwdlang43044140md_docparampagetitleshort_ELTPARAGRAPHE000314"></a>La fonction **HDernier** ne lit pas l'enregistrement : la fonction **HDernier** est donc plus rapide que la fonction [HLitDernier](../WDLang4/3044140.md).
<a name="NOTE0_5"></a>
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000339"></a>Par défaut (paramètre &lt;Options&gt; non spécifié), aucun blocage de l'enregistrement n'est réalisé.
