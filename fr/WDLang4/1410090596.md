...
Importe un fichier CSV dans un fichier de données au format HFSQL Classic ou Client/Serveur (fichier de données décrit sous l'éditeur d'analyses, ou déclaré par les fonctions [HDéclare](../WDLang4/3044203.md), [HDéclareExterne](../WDLang4/3044204.md) ou [HDécritFichier](../WDLang4/3044206.md)).
...
<a name="importation_une_rubrique_type_memo_texte_ELTPARAGRAPHE000200"></a>
...
<a name="importation_une_rubrique_type_memo_binaire_ELTPARAGRAPHE000214"></a>Pour un rubrique de type mémo binaire, 3 colonnes sont associées dans le fichier CSV.
...
<a name="importation_une_rubrique_indicee_ELTPARAGRAPHE000256"></a>La fonction **HImporteCSV** ne permet pas d'importer des rubriques indicées.
<a name="NOTE0_4"></a>


### Importation d'une rubrique de type Heure
<a name="importation_une_rubrique_type_heure_ELTPARAGRAPHE000268"></a>La fonction **HImporteCSV** enregistre des heures non valides si les heures à importer ne sont pas dans un des formats disponibles dans l'analyse.
