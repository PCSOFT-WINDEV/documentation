...
### Bases de données
<a name="bases_donnees_ELTPARAGRAPHE000084"></a>La réplication distingue deux types de bases de données :
...
### Type de réplication
<a name="type_replication_ELTPARAGRAPHE000101"></a>Deux types de réplication peuvent être mises en place :
...
<a name="fichiers_crees_lors_une_replication_ELTPARAGRAPHE000115"></a>Plusieurs types de fichiers spécifiques à la réplication sont gérés lors de la mise en place de la réplication dans une application WINDEV :
