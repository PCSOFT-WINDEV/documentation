...
<a name="fonction_docparampagetitleshort_sur_des_analyses_des_versions_precedentes_ELTPARAGRAPHE000140"></a>Le moteur Hyper File version 4.1 à 5.5 ne pouvant pas travailler sans analyse ouverte (contrairement au moteur HFSQL Classic), l'analyse du premier fichier de données accédé est ouverte dans le moteur Hyper File 5.
