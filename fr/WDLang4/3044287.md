...
<a name="connexion_une_base_donnees_bloquee_ELTPARAGRAPHE000112"></a>Dans certains cas (coupure de courant par exemple), il se peut que les connexions à une base de données soient refusées. Par exemple, si une coupure de courant survient pendant l'exécution de ce code (avant la fonction [HInterditAccèsBaseDeDonnées](../WDLang4/3044286.md)) :
