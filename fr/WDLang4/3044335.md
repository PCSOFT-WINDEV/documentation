...
<a name="questce_quune_transaction_ELTTEXTE000216"></a>
...
<a name="utiliser_les_transactions_selon_ses_besoins_ELTPARAGRAPHE000053"></a>Selon votre situation, voici quelques conseils pour optimiser la gestion des transactions dans vos applications ou sites :
...
- **Panne de courant ou arrêt brusque de l'application** (arrêt de l'application par le gestionnaire de tâches par exemple) : 
	...
	- ![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png) Par l'outil [WDTRANS](../WDTrans/3524005.md) (ou [WDOptimizer](../WDOptimiseur/3519002.md)). 
