...
<a name="droits_necessaires_pour_effectuer_une_sauvegarde_ELTPARAGRAPHE000234"></a>Pour effectuer une sauvegarde, l'utilisateur ou le groupe doit posséder le droit de faire des sauvegardes (constante *hDroitSauvegarde*). Ce droit s'applique aux serveurs et aux bases de données.
...
<a name="caracteristiques_sauvegarde_ELTPARAGRAPHE000266"></a>La sauvegarde effectuée correspondra à l'état de la base de données au début de la sauvegarde.
...
<a name="sauvegarde_effectuee_depuis_centre_controle_hfsql_ELTPARAGRAPHE000280"></a>Il est possible de réaliser une sauvegarde depuis le Centre de Contrôle HFSQL. Cette sauvegarde est disponible dans l'onglet "Sauvegardes" de la description du serveur (bouton "Nouvelle sauvegarde").
...
<a name="sauvegardes_planifiees_ELTPARAGRAPHE000294"></a>Il est possible de planifier les sauvegardes effectuées sur le serveur :
