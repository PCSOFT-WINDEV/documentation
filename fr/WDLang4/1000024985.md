...
<a name="gestion_des_doublons_activee_ELTPARAGRAPHE000264"></a>Si la gestion du test des doublons est branchée sur une clé définie comme étant unique, le test d'unicité est effectué automatiquement lors de chaque ajout ou modification d'un enregistrement du fichier de données.
...
<a name="generalisation_test_des_doublons_ELTPARAGRAPHE000305"></a>Pour généraliser le mode de gestion des doublons à toutes les rubriques d'un fichier de données, utilisez le méta-caractère "\*". 
Par exemple :
