...
<a name="quand_estce_que_modification_droit_est_realisee_ELTPARAGRAPHE000212"></a>La modification du droit est effective dès que la fonction **HModifieDroitServeur** est exécutée pour les utilisateurs connectés et concernés par la modification. Il n'est pas nécessaire de redémarrer le serveur pour prendre en compte les nouveaux droits.
<a name="NOTE0_2"></a>


### Quels sont les droits nécessaires pour ajouter et/ou modifier les utilisateurs ou les groupes ? 
<a name="quels_sont_les_droits_necessaires_pour_ajouter_etou_modifier_les_utilisateurs_les_groupes_ELTPARAGRAPHE000224"></a>Le tableau suivant présente les droits nécessaires pour manipuler les caractéristiques des utilisateurs et ou des groupes :
