...
- La fonction **SourceVersPage** n'effectue aucune lecture du fichier de données. C'est la valeur de l'enregistrement chargé en mémoire qui est utilisée pour initialiser les champs. Il faut donc qu'un enregistrement soit au préalable chargé en mémoire (fonctions [HLit](../WDLang4/3044047.md), [HLitRecherche](../WDLang4/3044050.md), [HLitPremier](../WDLang4/3044051.md), ...).
...
<a name="liaison_avec_une_rubrique_types_liaisons_ELTPARAGRAPHE000108"></a>La liaison d'un champ vers une rubrique peut être de deux types :
