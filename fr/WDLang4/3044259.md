...
<a name="quand_utiliser_fonction_docparampagetitleshort_ELTPARAGRAPHE000080"></a>La fonction **HConstruitValCléANSI** peut et doit être utilisée pour enregistrer la valeur d'une clé composée utilisée comme clé de liaison dans un fichier de données.

Exemple :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=HconstruitValcleANSI.gif)
