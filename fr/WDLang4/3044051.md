...
<a name="parcours_des_requetes_ELTPARAGRAPHE000348"></a>Par défaut, la fonction **HLitPremier** ré-exécute la requête pour rafraîchir le résultat de la requête. Il est conseillé d'utiliser la constante *hSansRafraîchir* pour éviter la ré-exécution de la requête.
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000382"></a>Par défaut (paramètre &lt;Option&gt; non spécifié), aucun blocage de l'enregistrement n'est réalisé.
...
### Mémos
<a name="memos_ELTPARAGRAPHE000397"></a>Les mémos associés à l'enregistrement peuvent être automatiquement lus ou non lors de la lecture de l'enregistrement. La fonction [HGèreMemo](../WDLang4/3044139.md) permet de personnaliser cette lecture automatique.
...
<a name="connecteur_natif_xml_ELTPARAGRAPHE000442"></a>Le comportement de la fonction **HLitPremier** est lié aux fonctions [HActiveFiltreAuto](../WDLang4/3044297.md)/[HDésactiveFiltreAuto](../WDLang4/3044298.md).
...
### Divers
<a name="divers_ELTPARAGRAPHE000485"></a>
...
- Pour optimiser le temps des premiers parcours d'un fichier de données, utilisez la fonction [HOptimise](../WDLang4/3044005.md).
