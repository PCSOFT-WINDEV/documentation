...
<a name="lecture_selon_une_cle_ELTPARAGRAPHE000501"></a>La fonction **&lt;Source&gt;.Premier** positionne sur l'enregistrement pour lequel la valeur de la clé est la plus petite.
...
<a name="verification_mot_passe_ELTPARAGRAPHE000523"></a>Si la fonction **&lt;Source&gt;.Premier** est la première fonction manipulant le fichier de données spécifié, la vérification du mot de passe est effectuée lors de l'ouverture du fichier de données.
...
### Divers
<a name="divers_ELTPARAGRAPHE000554"></a>
...
<a name="comparaison_des_fonctions_litpremierwdlang41000025022md_docparampagetitleshort_ELTPARAGRAPHE000575"></a>La fonction **&lt;Source&gt;.Premier** ne lit pas l'enregistrement : la fonction **&lt;Source&gt;.Premier** est donc plus rapide que la fonction [&lt;Source&gt;.LitPremier](../WDLang4/1000025022.md).
<a name="NOTE0_5"></a>
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000605"></a>Par défaut (paramètre &lt;Option&gt; non spécifié), aucun blocage de l'enregistrement n'est réalisé.
