...
Nom du fichier de données manipulé. Ce fichier de données peut correspondre à un fichier de données décrit dans l'analyse ou décrit par programmation (fonction [&lt;Source&gt;.DécritFichier](../WDLang4/1000024215.md)). Il est également possible d'utiliser une [source de données](../WDLang4/1514053.md).
...
<a name="condition_selection_ELTPARAGRAPHE000298"></a>La syntaxe générale d'une condition a la forme suivante :
...
<a name="creer_une_vue_sur_fichier_donnees_filtre_ELTPARAGRAPHE000407"></a>La fonction **&lt;Source&gt;.CréeVue** tient compte du filtre posé sur le fichier de données source de la vue.
