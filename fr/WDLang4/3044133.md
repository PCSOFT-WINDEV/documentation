...
La ré-indexation d'un fichier de données peut être effectuée même si des applications accèdent à ce fichier de données. Pour plus de détails, consultez [les remarques](#NOTE0_1).

![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Les fichiers de données HFSQL Client/Serveur peuvent être réindexés de manière asynchrone grâce à la fonction [HRéindexeAsynchrone](../WDLang4/1410091053.md). 
...
<a name="conditions_utilisation_ELTPARAGRAPHE000233"></a>
...
<a name="reindexation_automatique_ELTPARAGRAPHE000256"></a>La ré-indexation d'un fichier de données peut être rendue nécessaire par la perte ou l'altération du fichier d'index. Une ré-indexation automatique des fichiers de données peut être mise en place.
...
<a name="reindexation_chaud_ELTPARAGRAPHE000308"></a>La ré-indexation d'un fichier de données peut être effectuée même si des applications accèdent à ce fichier de données.
...
<a name="repertoire_des_fichiers_temporaires_ELTPARAGRAPHE000350"></a>Pendant la ré-indexation, des fichiers temporaires peuvent être créés. Par défaut, ces fichiers sont créés dans le répertoire temporaire de Windows ou dans le répertoire courant si il n'y a pas assez de place.
...
<a name="gestion_des_alphabets_non_latins_ELTPARAGRAPHE000378"></a>Pour modifier l'alphabet utilisé pour les recherches, les tris :
...
<a name="versions_precedentes_ELTPARAGRAPHE000431"></a>Cette fonction remplace la fonction **HRéindexe_55**, conservée par compatibilité avec WINDEV 5.5.
