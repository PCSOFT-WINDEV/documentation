...
**Remarque** : Lors de l'utilisation d'une variable de type **Enregistrement** associée à un fichier de données de l'analyse, l'éditeur de code propose automatiquement les différentes rubriques de l'enregistrement :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Type_Enregistrement%20-%20HC%20N%B0001.gif)

<a name="NOTE0_3"></a>


### Lecture et affectation d'une variable de type Enregistrement
<a name="lecture_affectation_une_variable_type_enregistrement_ELTPARAGRAPHE000071"></a>Une variable de type **Enregistrement** peut être lue ou affectée. La syntaxe est la suivante : 
...
<a name="proprietes_specifiques_description_des_variables_type_enregistrement_ELTPARAGRAPHE000105"></a>Les propriétés suivantes peuvent être utilisées pour connaître les caractéristiques d'une variable de type **Enregistrement** :
...
<a name="fonctions_manipulant_type_enregistrement_ELTPARAGRAPHE000138"></a>Les fonctions suivantes utilisent le type **Enregistrement** : 
