...
![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Permet d'optimiser la réorganisation des index pour des fichiers de données HFSQL Client/Serveur. 
