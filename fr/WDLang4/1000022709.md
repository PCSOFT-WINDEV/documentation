...
**Remarque** : Il est possible de connaître les droits d'un groupe ou d'un utilisateur sur un fichier de données HFSQL Client/Serveur grâce à la fonction [&lt;Variable Connexion&gt;.InfoDroitFichier](../WDLang4/1000022667.md). 
...
<a name="quand_estce_que_modification_droit_est_realisee_ELTPARAGRAPHE000331"></a>La modification du droit est effective dès que la fonction **&lt;Variable Connexion&gt;.ModifieDroitFichier** est exécutée pour les utilisateurs connectés et concernés par la modification. Il n'est pas nécessaire de redémarrer le serveur pour prendre en compte les nouveaux droits.
