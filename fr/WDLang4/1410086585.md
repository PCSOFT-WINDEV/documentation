...
Pour chaque ligne, dans une même famille de colonnes, le nombre et le nom des colonnes est libre.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Table-HBase.gif)
