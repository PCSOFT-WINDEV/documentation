...
<a name="affichage_resultat_dans_champ_liste_champ_combo_ELTPARAGRAPHE000154"></a>&lt;Résultat&gt; peut être directement affecté à un champ Liste ou un champ Combo grâce à la fonction [ListeAjoute](../WDLang1/3049004.md). Chaque ligne contiendra le nom d'un des index full-text trouvés.
<a name="NOTE0_2"></a>


### Extraire une information du résultat
<a name="extraire_une_information_resultat_ELTPARAGRAPHE000166"></a>Pour extraire une information du résultat détaillé, il est conseillé d'utiliser la fonction [ExtraitChaîne](../WDLang1/3024017.md).
