...
![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Il est possible de réaliser le calcul des statistiques en tâche de fond, sans bloquer le fichier de données en écriture. ![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Le calcul des statistiques d'un fichier de données HFSQL Client/Serveur peut être effectuée de manière asynchrone grâce à la fonction [HStatCalculAsynchrone](../WDLang4/1410091224.md). 
...
- La mise à jour des statistiques peut également être réalisée par la fonction [&lt;Source&gt;.Réindexe](../WDLang4/1000025060.md). Les fonctions [&lt;Source&gt;.Réindexe](../WDLang4/1000025060.md) et **&lt;Source&gt;.StatCalcule** sont les deux seules fonctions à mettre à jour les statistiques du fichier de données.
