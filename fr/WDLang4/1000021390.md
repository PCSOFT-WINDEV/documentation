...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000229"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
- Si plusieurs champs de la page sont reliés à une même rubrique du fichier de données, la rubrique reliée peut ne pas être mise à jour correctement par la fonction **&lt;Page&gt;.VersFichier**. ***Il est déconseillé de relier plusieurs champs d'une page à une même rubrique d'un fichier de données.***

- La fonction **&lt;Page&gt;.VersFichier** ne remplit pas les rubriques pour les champs de type Image. Utilisez la fonction [&lt;Source&gt;.AttacheMémo](../WDLang4/1000024194.md).
