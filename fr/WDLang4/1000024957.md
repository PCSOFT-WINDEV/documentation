...
<a name="rubrique_memo_binaire_utilisant_des_vignettes_hfsql_ELTPARAGRAPHE000230"></a>Pour extraire le contenu d'une vignette HFSQL d'une rubrique HFSQL, utilisez la propriété [Vignette](../Proprietes/2512115.md).
