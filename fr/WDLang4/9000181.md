...
<a name="definir_fichier_donnees_inalterable_ELTTEXTE000254"></a>
...
- doit directement dans l'éditeur d'analyses : 
	...
	2. Dans l'onglet "Options", cochez l'option "Fichier de données inaltérable (active automatiquement la sécurité renforcée)". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Fichiers%20de%20donn%E9es%20inalt%E9rables%20-%20HC%20N%B0001.gif&type=thumb)


	3. Validez la description du fichier de données. Dans l'éditeur d'analyses, le fichier de données inaltérable est représenté avec un verrou. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Fichiers%20de%20donn%E9es%20inalt%E9rables%20-%20HC%20N%B0002.gif)
...
<a name="operations_disponibles_non_sur_fichier_donnees_inalterable_ELTTEXTE000278"></a>
