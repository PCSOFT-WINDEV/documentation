...
<Avec index> + TAB + <Compression> + TAB + <Identifiant de la tâche> + EOT
```
où :
...
<Compression> + TAB + <Identifiant de la tâche> + EOT
```
...
### Divers
<a name="divers_ELTPARAGRAPHE000418"></a>
...
### Droits nécessaires
<a name="droits_necessaires_ELTPARAGRAPHE000435"></a>Pour obtenir des informations sur une sauvegarde, l'utilisateur ou le groupe doit posséder : 
