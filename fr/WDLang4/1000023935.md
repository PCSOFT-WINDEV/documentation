...
<a name="exporter_contenu_une_requete_ELTPARAGRAPHE000127"></a>Pour exporter le contenu d'une requête, il est nécessaire d'initialiser la requête (fonction [HExécuteRequête](../WDLang4/3044080.md)) avant d'utiliser la fonction **HExporteCSV**.
<a name="NOTE0_2"></a>


### Type des rubriques exportées : cas particuliers
<a name="type_des_rubriques_exportees_cas_particuliers_ELTPARAGRAPHE000142"></a>
