...
### Ordre des rubriques
<a name="ordre_des_rubriques_ELTPARAGRAPHE000410"></a>Les rubriques listées dans &lt;Résultat&gt; sont triées en fonction de l'ordre physique des rubriques dans le fichier de données (sauf si la constante *hLstTriée* est utilisée).
<a name="NOTE0_2"></a>


### Affichage du résultat dans un champ Liste ou Combo
<a name="affichage_resultat_dans_champ_liste_combo_ELTPARAGRAPHE000420"></a>&lt;Résultat&gt; peut être directement affecté à un champ Liste ou Combo grâce à la fonction [&lt;Liste&gt;.Ajoute](../WDLang1/1000017319.md). Chaque ligne contiendra la description d'une rubrique.
<a name="NOTE0_3"></a>
