...
Permet de savoir si un polygone en 2 dimensions croise une autre géométrie.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FormeCroise.gif)
...
<a name="parcours_des_donnees_spatiales_utilisation_des_index_spatiaux_ELTPARAGRAPHE000355"></a>Il est possible d'effectuer un parcours sur un fichier de données avec un filtre concernant des données spatiales. Par exemple, le filtre utilisé peut être basé sur le résultat de la fonction **&lt;Variable Polygone2D&gt;.Croise**.
