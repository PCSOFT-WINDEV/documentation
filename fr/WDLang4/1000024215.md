...
<a name="comment_decrire_fichier_donnees_par_programmation_ELTPARAGRAPHE000227"></a>Pour décrire un fichier de données par programmation, il faut :
...
3. Décrire les caractéristiques du fichier de données, de ses rubriques, de ses liaisons, de ses index full-text, de ses index sémantiques (si nécessaire) grâce aux propriétés HFSQL.
...
5. Fixer la description des index full-text avec la fonction [HDécritIndexFullText](../WDLang4/1000017407.md).
	...
	1. Fixer la description des index sémantiques avec la fonction [HDécritIndexSémantique](../WDLang4/1410086684.md).
...
<a name="liste_des_proprietes_hfsql_utilisables_pour_decrire_fichier_donnees_par_programmation_ELTPARAGRAPHE000378"></a>Les propriétés suivantes sont disponibles en lecture et écriture.
...
<a name="les_types_fichiers_donnees_pouvant_etre_decrits_avec_fonction_docparampagetitleshort_ELTPARAGRAPHE000561"></a>La propriété [Type](../Proprietes/2510131.md) permet de spécifier le type du fichier de données à créer.
