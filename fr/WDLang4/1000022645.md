...
**Compatibilité version 12** : Pour compatibilité avec la version 12, il est également possible de définir une tâche grâce à la structure [HTâchePlanifiée](../WDLang4/1000017180.md). Cette tâche exécutera la procédure stockée indiquée (ou réalisera une sauvegarde de la base de données).Pour définir un élément planifié (tâche planifiée, sauvegarde, optimisation ou rafraîchissement d'une vue matérialisée, il est conseillé d'utiliser la fonction [&lt;Variable Connexion&gt;.AjoutePlanification](../WDLang4/1000022642.md).
...
### Droits nécessaires
<a name="droits_necessaires_ELTPARAGRAPHE000292"></a>Pour ajouter une tâche, il est nécessaire de posséder :
...
[Fonctions de gestion des tâches planifiées WEBDEV](../WDLang4/1000022790.md)

[WEBDEV : Tâches planifiées et tâches différées](../WDLang4/1000019455.md)

[HAjouteTâche (Fonction)](../WDLang4/1000017091.md)
