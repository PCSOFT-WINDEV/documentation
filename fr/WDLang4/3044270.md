...
<a name="lancement_wdmodfic_ELTTEXTE000403"></a>
...
<a name="fichiers_necessaires_ELTPARAGRAPHE000063"></a>Pour exécuter WDMODFIC sur un poste client, les fichiers suivants sont nécessaires :
...
- wd310trs.dll (nécessaire uniquement si les fichiers de données sont répliqués)
...
<a name="utilisation_wdmodfic_mode_ligne_commande_ELTTEXTE000433"></a>
...
| -noanaguid | Si ce paramètre est précisé, la modification automatique des fichiers de données s'appliquera aux descriptions de fichiers qui n'appartiennent pas à l'analyse en cours (par exemple, cas de la recréation de la description d'un fichier de données, ou de la re-création d'une analyse, ...).<br><br>Pour réaliser la modification automatique, le moteur HFSQL se base alors sur le nom logique du fichier de données. Après la modification automatique des fichiers de données, les fichiers de données deviennent liés à l'analyse. |
...
### Exemples
<a name="exemples_ELTPARAGRAPHE000279"></a>
...
<a name="utilisation_wdmodfic_mode_interactif_ELTTEXTE000463"></a>
