...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000286"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
<a name="liaison_avec_une_rubrique_types_liaison_ELTPARAGRAPHE000302"></a>La liaison d'un champ vers une rubrique peut être de deux types :
