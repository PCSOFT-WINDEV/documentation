...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette fonction est également disponible pour les pages WEBDEV. Elle est équivalente à la fonction [&lt;Page&gt;.DepuisSource](../WDLang4/1000021393.md). 
...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000266"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
<a name="liaison_avec_une_rubrique_types_liaisons_ELTPARAGRAPHE000282"></a>La liaison d'un champ vers une rubrique peut être de deux types :
