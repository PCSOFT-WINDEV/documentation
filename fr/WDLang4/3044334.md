...
<a name="questce_quun_port_ELTTEXTE000157"></a>
...
<a name="hfsql_clientserveur_ports_utilises_ELTTEXTE000181"></a>


### Serveur HFSQL
<a name="serveur_hfsql_ELTPARAGRAPHE000030"></a>**Le serveur HFSQL** utilise par défaut le port 4900 (port TCP).
...
### MantaManager
<a name="mantamanager_ELTPARAGRAPHE000043"></a>**MantaManager** utilise un port fixe 4999 (5002 par compatibilité). Ce service n'est pas nécessaire pour accéder à un serveur HFSQL : il permet de lister les serveurs d'une machine et de démarrer un serveur sur la machine.
...
<a name="referencement_par_iana_des_ports_utilises_par_hfsql_clientserveur_ELTPARAGRAPHE000058"></a>Les numéros de ports utilisés par HFSQL Client/Serveur sont désormais référencés par l'organisme IANA (Internet Assigned Numbers Authority).
...
<a name="utilisation_via_internet_ELTTEXTE000217"></a>
...
<a name="comment_preciser_port_dans_application_cliente_ELTTEXTE000241"></a>
...
<a name="pourquoi_certains_ports_sont_fermes_par_defaut_ELTTEXTE000265"></a>
