...
### Gestion du journal
<a name="gestion_journal_ELTPARAGRAPHE000094"></a>Les opérations réalisées sur le fichier de données après un appel à la fonction **HGèreJournal** (faux) ne seront pas journalées : il ne sera pas possible d'effectuer un "UNDO" sur ces fonctions.
