...
- La fonction **FichierVersEcran** n'effectue aucune lecture du fichier de données. C'est la valeur de l'enregistrement chargé en mémoire qui est utilisée pour initialiser les champs. Il faut donc qu'un enregistrement soit au préalable chargé en mémoire (fonctions [HLit](../WDLang4/3044047.md), [HLitRecherche](../WDLang4/3044050.md), [HLitPremier](../WDLang4/3044051.md), ...).
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) En WEBDEV, vous pouvez également utiliser la fonction [FichierVersPage](../WDLang4/3044148.md).
...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000132"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
<a name="liaison_avec_une_rubrique_types_liaison_ELTPARAGRAPHE000147"></a>La liaison d'un champ vers une rubrique peut être de deux types :
...
- La fonction **FichierVersEcran** gère la valeur NULL. Si le contenu de la rubrique correspond à NULL, une chaîne vide sera affichée dans le champ de saisie associé. Pour modifier ce mode d'affichage, utilisez la fonction [ChampErreur](../WDLang1/3025036.md).
...
[FichierVersPage (Fonction)](../WDLang4/3044148.md)
