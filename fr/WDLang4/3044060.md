...
<a name="affichage_resultat_dans_champ_liste_combo_ELTPARAGRAPHE000216"></a>&lt;Résultat&gt; peut être directement affecté à un champ Liste ou Combo grâce à la fonction [ListeAjoute](../WDLang1/3049004.md). Chaque ligne contiendra le nom d'une des clés trouvées.
<a name="NOTE0_2"></a>


### Extraire une information du résultat
<a name="extraire_une_information_resultat_ELTPARAGRAPHE000228"></a>Pour extraire une information du résultat détaillé, il est conseillé d'utiliser la fonction [ExtraitChaîne](../WDLang1/3024017.md).
