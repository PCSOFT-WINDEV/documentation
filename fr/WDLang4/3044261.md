...
### Les valeurs copiées
<a name="les_valeurs_copiees_ELTPARAGRAPHE000223"></a>Les rubriques dont le nom est commun aux deux enregistrements sont copiées (et converties si nécessaire).
...
<a name="utilisation_des_listes_rubriques_ELTPARAGRAPHE000240"></a>La spécification de deux listes de rubriques permet d'affecter des rubriques de noms différents. Les affectations sont effectuées dans l'ordre d'apparition des rubriques dans les listes.
...
### Rubriques Tableau
<a name="rubriques_tableau_ELTPARAGRAPHE000254"></a>Lors de la manipulation de rubriques tableaux, la fonction **HCopieEnreg** copie le maximum d'éléments en commençant par le premier élément.
...
<a name="erreurs_nentrainant_pas_modification_enregistrement_destination_ELTPARAGRAPHE000274"></a>Les erreurs n'entraînant pas de modification de l'enregistrement destination sont les suivantes :
...
<a name="versions_precedentes_ELTPARAGRAPHE000289"></a>Cette fonction remplace la fonction **HCopieEnreg_55**, conservée par compatibilité avec WINDEV 5.5.
