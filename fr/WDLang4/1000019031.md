...
<a name="configuration_requise_ELTTEXTE000232"></a>
...
<a name="creation_cluster_ELTTEXTE000270"></a>
...
6. Saisissez les paramètres d'installation du coordinateur. Ces paramètres sont :
	...
	- Le mot de passe d'administration du cluster. Ce mot de passe sera utilisé dans le [Centre de Contrôle HFSQL](../CCHF/3540001.md) ou en programmation pour les opérations de maintenance du cluster (ajout de noeuds, arrêt et redémarrage, etc.).
...
9. Indiquez si vous autorisez PC SOFT à collecter des informations relatives à l'utilisation du cluster HFSQL. Cette collecte est facultative et permet l'amélioration des fonctionnalités du cluster HFSQL.
...
- toujours passer par le cluster pour importer les données : 
	...
	- via une application utilisant la fonction [HCopieFichier](../WDLang4/3044282.md).
...
<a name="configuration_dns_pour_acces_cluster_ELTTEXTE000294"></a>
...
<a name="configurer_dns_depuis_centre_controle_hfsql_ELTPARAGRAPHE000134"></a>Pour configurer le DNS depuis le Centre de Contrôle HFSQL :
...
<a name="installation_nouveau_noeud_ELTTEXTE000324"></a>
...
<a name="installer_nouveau_serveur_hfsql_sur_poste_local_comme_noeud_cluster_ELTPARAGRAPHE000159"></a>Pour installer un nouveau serveur HFSQL sur le poste local comme noeud d'un cluster : 
...
## Désinstallation
<a name="desinstallation_ELTTEXTE000354"></a>


### Désinstaller un nœud ou un cluster
<a name="desinstaller_nœud_cluster_ELTPARAGRAPHE000175"></a>Pour désinstaller un noeud d'un cluster ou un cluster en entier :
