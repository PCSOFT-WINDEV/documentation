...
### Hyper File 5.5
<a name="hyper_file_55_ELTPARAGRAPHE000259"></a>Pour manipuler une base de données au format Hyper File 5 avec la fonction **HFusionneVue**, vous devez réaliser la fusion avec la fonction **HCréeVue_55**.
