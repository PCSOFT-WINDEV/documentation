...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003044124&name=hfusionnevue_fonction&product=WD">Voir des exemples supplémentaires</a>
...
### Hyper File 5.5
<a name="hyper_file_55_ELTPARAGRAPHE000274"></a>Pour manipuler une base de données au format Hyper File 5 avec la fonction **HFusionneVue**, vous devez réaliser la fusion avec la fonction **HCréeVue_55**.
