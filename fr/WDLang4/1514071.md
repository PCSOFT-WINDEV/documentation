...
<a name="proprietes_specifiques_description_rubriques_par_programmation_ELTPARAGRAPHE000078"></a>Les propriétés spécifiques à la description de rubriques sont les suivantes :
...
<a name="comment_decrire_des_fichiers_donnees_par_programmation_ELTPARAGRAPHE000353"></a>Pour décrire des fichiers de données par programmation, il faut :
...
<a name="manipulation_des_rubriques_fichier_donnees_decrit_par_programmation_ELTPARAGRAPHE000395"></a>Lors de la création d'un fichier de données sous l'éditeur d'analyses, les noms du fichier de données et de ses rubriques sont automatiquement reconnus par le compilateur.
...
### Journalisation
<a name="journalisation_ELTPARAGRAPHE000420"></a>Lors de la description du fichier de données par programmation :
