...
### Les étapes
<a name="les_etapes_ELTPARAGRAPHE000037"></a>Pour mettre en place la réplication journalée avec WDREPLIC, il faut : 
...
<a name="important_conditions_mise_place_ELTPARAGRAPHE000065"></a>La mise en place de la réplication journalée dans une application n'est pas une opération anodine.
...
### Important : conditions de mise en place
<a name="important_conditions_mise_place_ELTPARAGRAPHE000100"></a>La mise en place de la réplication journalée dans une application n'est pas une opération anodine.
...
<a name="deplacement_manuel_des_fichiers_donnees_ELTPARAGRAPHE000118"></a>Attention : Pour déplacer manuellement des fichiers de données, il est nécessaire de respecter les règles suivantes :
