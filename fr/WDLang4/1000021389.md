...
Remarque : La fonction **&lt;Page&gt;.DepuisFichier** n'effectue aucune lecture du fichier de données. C'est la valeur de l'enregistrement chargé en mémoire qui est utilisée pour initialiser les champs. Il faut donc qu'un enregistrement soit au préalable chargé en mémoire (fonctions [&lt;Source&gt;.Lit](../WDLang4/1000025019.md), [&lt;Source&gt;.LitRecherche](../WDLang4/1000025023.md), [&lt;Source&gt;.LitPremier](../WDLang4/1000025022.md), ...).
<a name="Exemple1"></a>
...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000221"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
<a name="liaison_avec_une_rubrique_types_liaison_ELTPARAGRAPHE000237"></a>La liaison d'un champ vers une rubrique peut être de deux types :
...
### Divers
<a name="divers_ELTPARAGRAPHE000255"></a>

- Les espaces dans les rubriques HFSQL sont conservés.

- La fonction **&lt;Page&gt;.DepuisFichier** initialise les champs Image reliés à des rubriques de type mémo image.

- La fonction **&lt;Page&gt;.DepuisFichier** ne fonctionne pas avec les vues. Il est nécessaire d'initialiser un à un les champs avec le contenu des rubriques.
