...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les fonctions SQL permettent de manipuler des bases de données MySQL et les bases de données accessibles par ODBC (par exemple HFSQL).
...
<a name="NOTE0_2"></a>
![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) 
