...
2. Dans la fenêtre de bienvenue, cliquez sur l'option "Se connecter à un cluster HFSQL". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Administration_cluster%20-%20HC%20N%B0001.gif&type=thumb)
Remarque : Si le Centre de Contrôle HFSQL est déjà lancé, il est possible d'utiliser le menu déroulant accessible via ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CC_HF_Gestion_Fichier_HFCS%20-%20HC%20N%B0003%201.gif)pour se connecter à un cluster HFSQL. 
...
4. Validez. Les caractéristiques du cluster apparaissent dans le Centre de Contrôle HFSQL. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Administration_cluster%20-%20HC%20N%B0003.gif&type=thumb)
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Administration_cluster%20-%20HC%20N%B0004.gif&type=thumb)
...
Remarque : Le menu contextuel du cluster permet également d'effectuer diverses opérations : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Administration_cluster%20-%20HC%20N%B0005.gif)
...
<a name="demarrage_automatique_boot_ELTPARAGRAPHE000099"></a>Le démarrage du cluster HFSQL se fait de façon automatique lors du démarrage (boot) des différents serveurs composant le cluster.
...
<a name="comment_gerer_les_noeuds_ELTPARAGRAPHE000133"></a>Lors de l'affichage des caractéristiques du cluster HFSQL dans le Centre de Contrôle HFSQL, la partie "Administration des noeuds" permet de visualiser les différents noeuds du cluster HFSQL et de voir leur état. 
...
<a name="arret_automatique_extinction_des_serveurs_ELTPARAGRAPHE000156"></a>Lorsqu'un serveur abritant un noeud d'un cluster HFSQL est éteint, le noeud est automatiquement exclu du cluster. Sa base de données sera resynchronisée automatiquement lorsque le serveur sera remis en fonctionnement.

Attention : L'arrêt du service ClusterManager n'arrête pas le cluster.


### Arrêt manuel du cluster
<a name="arret_manuel_cluster_ELTPARAGRAPHE000163"></a>Le cluster peut être arrêté manuellement à l'aide du Centre de Contrôle HFSQL en utilisant le bouton "Arrêter le cluster" présent dans le groupe "Cluster" de l'onglet d'administration du cluster.
