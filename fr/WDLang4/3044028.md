...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Si ce paramètre est égal à "?" ou ".", le répertoire courant de l'application est pris en compte (répertoire retourné par la fonction [fRepEnCours](../WDLang1/3036022.md)).
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Si ce paramètre correspond à :
...
<a name="substitutions_repertoire_multiples_ELTPARAGRAPHE000108"></a>La fonction **HSubstRep** peut être appelée plusieurs fois avec des paramètres différents. Lorsque le répertoire physique est redéfini plusieurs fois pour un même répertoire logique (décrit dans l'analyse), le dernier répertoire physique spécifié remplace tous les autres.
<a name="NOTE0_2"></a>


### Substitution de répertoire
<a name="substitution_repertoire_ELTPARAGRAPHE000118"></a>La fonction [HChangeRep](../WDLang4/3044168.md) permet d'associer un répertoire à un fichier de données. Pour substituer un répertoire par un autre, utilisez la fonction **HSubstRep**.
