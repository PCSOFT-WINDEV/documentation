...
`<Résultat> = <Source>.ImporteJSON(<Chemin du fichier JSON> [, <Liste des rubriques à importer> [, <Liste des "items" à importer> [, <Options> [, <Jauge>]]]])`
---
...
### Mode d'importation
<a name="mode_importation_ELTPARAGRAPHE000282"></a>Si la liste des items est précisée : l'importation recherchera des "items JSON" ayant le même nom que les rubriques.
...
<a name="rubriques_type_tableau_ELTPARAGRAPHE000298"></a>La fonction **&lt;Source&gt;.ImporteJSON** permet également d'importer des rubriques de type tableau.
