...
<a name="equilibrage_dynamique_charge_ELTPARAGRAPHE000723"></a>Les coefficients servent à  faire varier l'importance de chaque compteur dans la formule de calcul de la charge engendrée par un utilisateur sur le serveur.
