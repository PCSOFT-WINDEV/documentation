...
Pour plus de détails sur les chaînes secrètes et l'utilisation du coffre-fort, consultez [Coffre-fort de chaînes secrètes](../Editeurs/1410087353.md). ![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Le mot de passe des fichiers de données HFSQL est insensible à la casse. 
...
<a name="quand_utiliser_fonction_docparampagetitleshort_ELTPARAGRAPHE000291"></a>La fonction **&lt;Source&gt;.MotDePasse** doit être appelée :
...
<a name="definir_mot_passe_sur_fichier_donnees_ELTPARAGRAPHE000354"></a>Un fichier de données sera protégé par mot de passe uniquement si :
...
<a name="supprimer_mot_passe_sur_fichier_donnees_ELTPARAGRAPHE000382"></a>Pour supprimer un mot de passe sur un fichier de données, il est nécessaire de faire une modification automatique des fichiers de données.
...
<a name="gestion_mot_passe_ole_connecteurs_natifs_ELTPARAGRAPHE000400"></a>Le mot de passe doit être précisé dans les paramètres de la connexion.
