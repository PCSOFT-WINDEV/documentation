...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) MySQL et MariaDB : Ce paramètre peut correspondre au nom du poste où la base de données est disponible ou bien à son adresse IP. Par exemple, "Apollon".![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png) La source peut être une base de données HFSQL Classic ou HFSQL Client/Serveur.
...
| ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) "Web SQL database" | **Base disponible via le navigateur** <br>(uniquement disponible sous Chrome et Safari)<br>"" (chaîne vide) | "" (chaîne vide) |

![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png) Les types de base supportés sont : HYPER FILE.
<a name="NOTE0_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/fr/HF55.png)![OLE DB](https://doc.pcsoft.fr/ext/images/fr/OLEDB.png)![ODBC](https://doc.pcsoft.fr/ext/images/fr/ODBC.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) 

### Échec ou succès de la connexion
<a name="echec_succes_connexion_ELTPARAGRAPHE000354"></a>Si la connexion est un succès, l'identifiant de la connexion pourra être utilisé pour changer la connexion (fonction [SQLChangeConnexion](../WDLang4/3072016.md)).
...
<a name="connexion_une_analyse_hfsql_ELTPARAGRAPHE000376"></a>Dans la majorité des plateformes, l'accès aux données HFSQL (Classic ou Client/Serveur) est disponible en natif. Il n'est pas nécessaire d'accéder aux bases par l'intermédiaire d'un proxy Webservice (SOAP). Ainsi, pour accéder à une base HFSQL Client/Serveur, il suffit d'utiliser la fonction [HOuvreConnexion](../WDLang4/3044107.md). 
...
<a name="odbc_ole_imbrication_connexions_ELTPARAGRAPHE000403"></a>Pour ODBC et OLE DB, plusieurs appels à la fonction **SQLConnecteWS** peuvent être imbriqués (attention : cela n'est pas possible avec les bases HFSQL).
...
<a name="connexion_une_base_donnees_par_odbc_ELTPARAGRAPHE000425"></a>Pour se connecter à une base de données par ODBC, les manipulations à faire sont les suivantes :
...
<a name="connecteur_natif_mysql_mariadb_postgresql_ELTPARAGRAPHE000447"></a>Pour ouvrir une connexion à une base de données MySQL, MariaDB ou PostgreSQL par le Connecteur Natif, il est nécessaire de passer en paramètre à la fonction **SQLConnecteWS** :
...
<a name="connexion_une_base_isam_par_intermediaire_access_ELTPARAGRAPHE000465"></a>La syntaxe pour se connecter à une base ISAM est la suivante :
...
<a name="connecteur_natif_oracle_gestion_authentification_externe_ELTPARAGRAPHE000613"></a>Pour se connecter via une authentification externe, il est nécessaire d'utiliser les paramètres de connexion suivants : 
