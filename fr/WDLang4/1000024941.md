...
<a name="conflit_modification_etat_enregistrement_ELTPARAGRAPHE000253"></a>Lors de l'utilisation d'une application en réseau, des conflits peuvent survenir suite à la saisie de données contradictoires par différents utilisateurs. Par exemple :
