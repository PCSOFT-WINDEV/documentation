...
<a name="conseils_utilisation_ELTPARAGRAPHE000140"></a>La fonction **HVérifieStructure** doit être utilisée : 
...
### Limitation
<a name="limitation_ELTPARAGRAPHE000217"></a>Cette fonction n'est pas disponible lors de l'utilisation d'une base de données via  .
