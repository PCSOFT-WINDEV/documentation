...
Selon le mode choisi, une erreur WLangage peut apparaître en cas de structures incompatibles. Il est alors nécessaire d'appliquer la modification automatique des fichiers de données (fonction [HModifieStructure](../WDLang4/1000019439.md)).
...
<a name="conseils_utilisation_ELTPARAGRAPHE000130"></a>La fonction **HVérifieStructure** doit être utilisée : 
