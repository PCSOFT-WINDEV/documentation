...
Le schéma suivant présente le déploiement d'un Cluster HFSQL utilisant 4 machines : un coordinateur et trois noeuds.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cluster-HFSQL.gif)
