...
- la fonction tente de bloquer un enregistrement déjà bloqué en lecture : aucune lecture n'est effectuée, la fonction [HErreurBlocage](../WDLang4/3044099.md) renvoie <u><u><u>Vrai</u></u></u> et la fonction [&lt;Source&gt;.EnDehors](../WDLang4/1000024605.md) renvoie <u><u><u>Vrai</u></u></u>.
	...
	![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les blocages ne sont pas disponibles en PHP.
...
![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Accès par JDBC : Ce paramètre est ignoré.![OLE DB](https://doc.pcsoft.fr/ext/images/fr/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) Si le provider OLE DB ou le Connecteur Natif (également appelé Accès Natif) utilisé ne gère pas les blocages, les options de blocage seront sans effet.![OLE DB](https://doc.pcsoft.fr/ext/images/fr/OLEDB.png) Les options de blocages spécifiées dans la fonction **&lt;Source&gt;.LitSuivant** ne sont pas prises en compte. Le mode de blocage spécifié avec la fonction [&lt;Source&gt;.LitPremier](../WDLang4/1000025022.md) ou [&lt;Source&gt;.LitDernier](../WDLang4/1000025020.md) restera effectif lors des appels aux fonctions **&lt;Source&gt;.LitSuivant** et [&lt;Source&gt;.LitPrécédent](../WDLang4/1000025021.md).
...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Le paramètre &lt;Options&gt; est ignoré.
...
<a name="lecture_selon_une_rubrique_cle_non_ELTPARAGRAPHE000437"></a>Si la rubrique utilisée est une clé, la fonction **&lt;Source&gt;.LitSuivant** lit l'enregistrement pour lequel la valeur de la clé est la plus grande. L'ordre de tri pris en compte est l'ordre de tri spécifié dans l'analyse pour cette clé. 
...
### Mémos
<a name="memos_ELTPARAGRAPHE000480"></a>Les mémos associés à l'enregistrement peuvent être automatiquement lus ou non lors de la lecture de l'enregistrement. La fonction [&lt;Source&gt;.GèreMémo](../WDLang4/1000024987.md) permet de personnaliser cette lecture automatique.
...
<a name="modification_valeur_cle_parcours_ELTPARAGRAPHE000579"></a>Si la valeur de la rubrique de parcours est modifiée avant d'utiliser la fonction **&lt;Source&gt;.LitSuivant**, l'enregistrement en cours pourra être lu à nouveau dans la suite du parcours par la fonction **&lt;Source&gt;.LitSuivant**.
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000604"></a>Par défaut (paramètre &lt;Option&gt; non spécifié), aucun blocage de l'enregistrement n'est réalisé.
...
### Divers
<a name="divers_ELTPARAGRAPHE000620"></a>
