...
<a name="fichier_journaloperationfic_ELTTEXTE000258"></a>
...
<a name="fichier_journalidentificationfic_ELTTEXTE000282"></a>
...
<a name="guid_journalisation_ELTPARAGRAPHE000123"></a>Deux types de GUID de fichiers de données sont gérés par le moteur HFSQL :
...
## Fichier *JNL.Fic
<a name="fichier_jnlfic_ELTTEXTE000312"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png) Le fichier \*JNL.Fic contient :

- toutes les rubriques du fichier de données HFSQL journalé correspondant,
...
| **Numéro_Enregistrement** | Numéro de l'enregistrement dans le fichier de données original journalé. |
