...
### Rubriques tableau
<a name="rubriques_tableau_ELTPARAGRAPHE000284"></a>Si une des rubriques exportées est une rubrique de type tableau, chaque élément de la rubrique tableau est exporté dans un nouveau niveau :
