...
<a name="application_reseau_base_donnees_isam_ELTPARAGRAPHE000325"></a>En réseau, le fichier de transactions peut être créé aussi bien sur un disque local que sur une unité réseau.
...
<a name="blocage_des_enregistrements_ELTPARAGRAPHE000337"></a>Les enregistrements ajoutés, modifiés ou supprimés dans une transaction sont bloqués en écriture.
<a name="NOTE0_3"></a>
...
<a name="transactions_contexte_hfsql_independant_ELTPARAGRAPHE000390"></a>Lors de la copie de contexte, si une transaction est en cours sur le premier contexte, le nouveau contexte n'est pas en transaction. Il faut rappeler la fonction **HTransaction** pour démarrer une transaction dans le nouveau contexte.
<a name="NOTE0_7"></a>
...
<a name="ole_connecteurs_natifs_ELTPARAGRAPHE000404"></a>Seules les syntaxes avec connexion sont prises en compte par les Connecteurs Natifs qui gèrent les transactions. Il est également possible d'utiliser la fonction [SQLTransaction](../WDLang4/3072029.md).
