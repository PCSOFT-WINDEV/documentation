...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette fonction est également disponible pour les pages WEBDEV. Elle est équivalente à la fonction [PageVersFichier](../WDLang4/3044022.md). 
...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000125"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
<a name="mise_jour_des_rubriques_cas_particuliers_ELTPARAGRAPHE000140"></a>
...
- La fonction **EcranVersFichier** n'affecte pas les rubriques pour les champs de type Image. Utilisez la fonction [HAttacheMémo](../WDLang4/3044173.md).
