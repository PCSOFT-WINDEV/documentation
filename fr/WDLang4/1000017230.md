...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000020402&name=hrestauresauvegarde_fonction">Voir des exemples supplémentaires</a>
...
<a name="droits_necessaires_pour_restaurer_une_sauvegarde_ELTPARAGRAPHE000313"></a>Pour restaurer une sauvegarde, l'utilisateur ou le groupe doit posséder :
...
<a name="restauration_effectuee_depuis_centre_controle_hfsql_ELTPARAGRAPHE000341"></a>Il est possible de restaurer une sauvegarde depuis le Centre de Contrôle HFSQL. Cette sauvegarde est disponible dans l'onglet "Sauvegardes" de la description du serveur.
