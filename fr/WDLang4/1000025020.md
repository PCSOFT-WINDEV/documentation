...
- Dans le cas d'une requête : le ORDER BY de la requête si il existe, sinon la dernière rubrique utilisée. 
...
|   |   |
| --- | --- |
| *hBlocageEcriture* | Blocage en écriture : l'enregistrement en cours de lecture pourra être lu par une autre application mais ne pourra pas être modifié par une autre application.<br><br><br>![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Accès par JDBC : Cette constante n'est pas disponible. |
...
| *hBlocageNon* | Aucun blocage : l'enregistrement pourra être lu ou modifié par une autre application pendant la lecture.<br><br><br>![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Accès par JDBC : Cette constante n'est pas disponible. |
...
<a name="lecture_selon_une_rubrique_cle_non_ELTPARAGRAPHE000499"></a>Si la rubrique utilisée est une clé, la fonction **&lt;Source&gt;.LitDernier** lit l'enregistrement pour lequel la valeur de la clé est la plus grande. L'ordre de tri pris en compte est l'ordre de tri spécifié dans l'analyse pour cette clé. En cas de doublons, la fonction **&lt;Source&gt;.LitDernier** lit le dernier enregistrement "doublon" selon l'ordre des numéros d'enregistrement.
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000533"></a>Par défaut (paramètre &lt;Option&gt; non spécifié), aucun blocage de l'enregistrement n'est réalisé.
...
### Mémos
<a name="memos_ELTPARAGRAPHE000549"></a>Les mémos associés à l'enregistrement peuvent être automatiquement lus ou non lors de la lecture de l'enregistrement. La fonction [&lt;Source&gt;.GèreMémo](../WDLang4/1000024987.md) permet de personnaliser cette lecture automatique.
