...
**Remarque** : La fonction [HErreurInfo](../WDLang4/3044071.md) renvoie une information détaillée sur la dernière erreur survenue lors de la gestion des fichiers de données HFSQL.
...
Le fichier spécifié n'existe pas. Il faut créer le fichier avec la fonction [HCréation](../WDLang4/3044255.md) (ou [HCréationSiInexistant](../WDLang4/3044254.md)).
...
La description du fichier physique est différente de la description du fichier dans l'analyse ou décrit dynamiquement (fonction [HDécritFichier](../WDLang4/3044206.md)).
...
Le mot de passe utilisé pour le fichier de données n'est pas le bon. La fonction [HErreurMotDePasse](../WDLang4/3044082.md) n'a pas été testée.
...
- Problème de transfert des enregistrements de la vue vers le fichier d'origine (fonction [HVueVersFichier](../WDLang4/3044021.md) par exemple).
...
Solution : Ré-indexer le fichier de données avec [WDOptimizer](../WDOptimiseur/3519002.md) (ou avec la fonction [HRéindexe](../WDLang4/3044133.md)).
...
La fonction [HErreurBlocage](../WDLang4/3044099.md) renvoie <u><u><u><u>Vrai</u></u></u></u>. Le programme tente d'accéder à un fichier de données ou un enregistrement bloqué par un autre poste ou un autre programme.
...
Le mot de passe utilisé pour ouvrir l'analyse n'est pas le bon (fonction [HOuvreAnalyse](../WDLang4/3044106.md) ou fonction [HInitHF55](../WDLang4/3044010.md)).
...
L'enregistrement spécifié est en dehors du fichier de données. Cette erreur peut survenir lors de l'utilisation des fonctions [HRaye](../WDLang4/3044121.md), [HSupprime](../WDLang4/3044018.md), [HBloqueNumEnr](../WDLang4/3044152.md), [HDébloqueNumEnr](../WDLang4/3044194.md).
...
Vous utilisez une fonction accédant à la DLL Hyper File 5.5. Pour utiliser cette fonction, vous devez attacher une analyse au format WINDEV 5.5 à votre projet. Utilisez la fonction [HInitHF55](../WDLang4/3044010.md).

**70236: PAS D'ANALYSE EN COURS**

Cette opération nécessite une analyse ouverte. Ce n'est pas le cas. Utilisez la fonction [HOuvreAnalyse](../WDLang4/3044106.md) ou attachez une analyse à votre projet : 
...
Vous tentez d'annuler une déclaration dynamique (fonction [HAnnuleDéclaration](../WDLang4/3044174.md)). Le fichier de données correspondant est encore en cours d'utilisation. Fermez le fichier (fonction [HFerme](../WDLang4/3044073.md)) avant d'annuler la déclaration.
...
La fonction [HSupprimeFichier](../WDLang4/3044294.md) tente de supprimer un fichier qui n'existe pas sur le serveur.
