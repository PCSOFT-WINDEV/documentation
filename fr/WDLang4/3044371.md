...
Lors de la sélection d'un type Unicode (chaîne ou mémo texte), l'éditeur d'analyses permet de saisir les caractéristiques de la langue qui sera saisie dans cette rubrique.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Unicode_HFSQL%20-%20HC%20N%B0001.gif)
...
<a name="passer_unicode_ansi_inversement_sous_editeur_analyses_ELTPARAGRAPHE000082"></a>Il est possible de modifier le sous-type d'une rubrique en la passant de ANSI à Unicode (ou inversement). Dans ce cas, une modification automatique des données sera effectuée.
...
## A savoir
<a name="savoir_ELTTEXTE000224"></a>


### Champs liés aux rubriques
<a name="champs_lies_aux_rubriques_ELTPARAGRAPHE000095"></a>Lors de la création des champs (dans une fenêtre ou une page), il est possible de spécifier si le champ est Unicode ou non (case à cocher "Unicode" dans l'onglet "Général" de la fenêtre de description du champ).
