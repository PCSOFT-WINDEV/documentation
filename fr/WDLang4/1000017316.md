...
<a name="exemple_cas_une_gestion_stock_ELTPARAGRAPHE000053"></a>Considérons un fichier de données PRODUIT avec un article Art01 dont la quantité en stock est de 10.
...
### Exemple : Cas d'une gestion de stock
<a name="exemple_cas_une_gestion_stock_ELTPARAGRAPHE000125"></a>Considérons un fichier de données PRODUIT avec un article Art01 dont la quantité en stock est de 10.
...
### Exemple : Cas d'une gestion de stock
<a name="exemple_cas_une_gestion_stock_ELTPARAGRAPHE000200"></a>Considérons un fichier de données PRODUIT avec un article Art01 dont la quantité en stock est de 10.
