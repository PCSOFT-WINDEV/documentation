...
<a name="mise_jour_des_rubriques_cas_particuliers_ELTPARAGRAPHE000114"></a>
...
- Si plusieurs champs de la page sont reliés à une même rubrique du fichier de données, la rubrique reliée peut ne pas être mise à jour correctement par la fonction **SourceDepuisPage**. ***Il est déconseillé de relier plusieurs champs d'une page à une même rubrique d'un fichier de données***.
...
<a name="mise_jour_donnees_contenues_dans_les_champs_table_dans_les_champs_zone_repetee_ELTPARAGRAPHE000151"></a>La fonction **SourceDepuisPage** est sans effet sur le contenu d'un champ Table. 
