...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000101"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
<a name="mise_jour_donnees_contenues_dans_les_champs_table_dans_les_champs_zone_repetee_ELTPARAGRAPHE000168"></a>La fonction **SourceDepuisPage** est sans effet sur le contenu d'un champ Table. 
