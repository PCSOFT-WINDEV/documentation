...
## Gestion des espaces dans les recherches
<a name="gestion_des_espaces_dans_les_recherches_ELTTEXTE000406"></a>
...
|   |   |
| --- | --- |
| <br><br>- sensible à la casse ou non.<br><br>- sensible à l'accentuation ou non.<br><br>- sensible aux espaces et à la ponctuation ou non.<br><br><br> | <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Indexation%20des%20m%E9mos%20-%20HC%20N%B0002.gif)<br><br><br>Option affichée dans la fenêtre "Rubriques du fichier", <br>*onglet "Général" d'une rubrique clé texte.* |
...
- les fichiers au format 5.5 présent dans une analyse WINDEV 2026.

- les fichiers au format 5.5 migrés vers WINDEV 2026.



<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0002%201.gif)
...
<a name="espaces_recherches_dans_des_fichiers_donnees_hfsql_classic_ELTTEXTE000430"></a>
...
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0002%202.gif)<br><br>Ce tableau indique l'effet du mode sélectionné (onglet "Compatibilité" de la description du fichier). | ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Indexation%20des%20m%E9mos%20-%20HC%20N%B0002.gif)<br><br>Ce tableau est valable uniquement si ces 3 cases sont cochées<br>(Fenêtre "Rubriques du fichier", onglet "Général" d'une rubrique clé texte) |
...
<a name="espaces_recherches_migration_hyper_file_55_vers_hfsql_classic_ELTTEXTE000454"></a>
...
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0002%202.gif)<br><br>Ce tableau indique l'effet du mode de stockage des rubriques texte sélectionné (onglet "Compatibilité" de la description du fichier) | ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Indexation%20des%20m%E9mos%20-%20HC%20N%B0002.gif)Ce tableau est valable uniquement si ces 3 cases sont cochées<br>(Fenêtre "Rubriques du fichier", onglet "Général" d'une rubrique clé texte) |
| **fichiers de données HFSQL Classic** | **Fichiers Hyper File 5.5<br>migrés au format HFSQL Classic** | **Fichiers Hyper File 5.5** |
