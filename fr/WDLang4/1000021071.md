...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Ce mode de réplication ne permet pas d'effectuer une réplication entre une base de données SQLite et une base de données HFSQL. 
