...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) le contenu d'une variable de type [Enregistrement](../WDLang4/1000020962.md) dans l'enregistrement en cours d'un fichier de données.
...
### Les valeurs copiées
<a name="les_valeurs_copiees_ELTPARAGRAPHE000366"></a>Les rubriques dont le nom est commun aux deux enregistrements sont copiées (et converties si nécessaire).
...
<a name="utilisation_des_listes_rubriques_ELTPARAGRAPHE000384"></a>La spécification de deux listes de rubriques permet d'affecter des rubriques de noms différents. Les affectations sont effectuées dans l'ordre d'apparition des rubriques dans les listes.
...
### Rubriques Tableau
<a name="rubriques_tableau_ELTPARAGRAPHE000398"></a>Lors de la manipulation de rubriques tableaux, la fonction **&lt;Destination&gt;.CopieEnreg** copie le maximum d'éléments en commençant par le premier élément.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Fonctionnalité non disponible.
<a name="NOTE0_4"></a>


### Erreurs n'entraînant pas de modification de l'enregistrement destination
<a name="erreurs_nentrainant_pas_modification_enregistrement_destination_ELTPARAGRAPHE000419"></a>Les erreurs n'entraînant pas de modification de l'enregistrement destination sont les suivantes :
