...
<a name="exporter_contenu_une_requete_ELTPARAGRAPHE000250"></a>Pour exporter le contenu d'une requête, il est nécessaire d'initialiser la requête (fonction [&lt;Source&gt;.ExécuteRequête](../WDLang4/1000024944.md)) avant d'utiliser la fonction **&lt;Source&gt;.ExporteCSV**.
<a name="NOTE0_2"></a>


### Type des rubriques exportées : cas particuliers
<a name="type_des_rubriques_exportees_cas_particuliers_ELTPARAGRAPHE000268"></a>
