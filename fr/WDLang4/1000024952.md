...
<a name="exporter_contenu_une_requete_ELTPARAGRAPHE000236"></a>Pour exporter le contenu d'une requête, il est nécessaire d'initialiser la requête (fonction [&lt;Source&gt;.ExécuteRequête](../WDLang4/1000024944.md)) avant d'utiliser la fonction **&lt;Source&gt;.ExporteCSV**.
<a name="NOTE0_2"></a>


### Rubriques tableau
<a name="rubriques_tableau_ELTPARAGRAPHE000254"></a>Si une des rubriques exportées est une rubrique de type tableau, chaque élément de la rubrique tableau &lt;RUBTAB&gt; est exportée dans une rubrique &lt;RUBTAB&gt;_&lt;Indice de l'élément&gt;.
