...
![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Le fichier de données HFSQL Client/Serveur vérifié est automatiquement bloqué en écriture pendant la vérification.![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) La vérification des index d'un fichier de données HFSQL Client/Serveur peut être effectuée de manière asynchrone grâce à la fonction [&lt;Connexion HFSQL&gt;.VérifieIndexAsynchrone](../WDLang4/1410091223.md). 
...
### Index corrompu
<a name="index_corrompu_ELTPARAGRAPHE000247"></a>Lorsque la fonction détecte un problème dans le fichier d'index, la variable **H.Commentaire** contient :
