...
- il est conseillé de réaliser une gestion des erreurs :
	...
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Il est conseillé de vérifier qu'aucune erreur n'a été générée : Erreur de doublons, Erreur d'intégrité, Erreur de mot de passe, Erreur de conflit de modification et d'état lors du conflit de modification. Pour plus de détails, consultez [Gestion assistée des erreurs HFSQL](../WDLang4/3044188.md).
...
|   |   |
| --- | --- |
| *hAffecteParcours* | **Influence de la modification sur le parcours** : La modification affecte le parcours. <br>Par exemple, la fonction [&lt;Source&gt;.LitSuivant](../WDLang4/1000025035.md) utilisée après la fonction **&lt;Source&gt;.Modifie** positionne sur l'enregistrement suivant l'enregistrement modifié (en tenant compte de ses nouvelles valeurs).<br><br>ATTENTION : Dans tous les cas (constante *hAffecteParcours* utilisée ou non) : si la fonction **&lt;Source&gt;.Modifie** est utilisée dans un parcours et si la valeur de la rubrique de parcours est modifiée, **l'enregistrement en cours pourra être lu à nouveau dans la suite du parcours**. En effet, la modification de la rubrique de parcours met à jour la clé d'index du fichier de données. Lors de la lecture des enregistrements suivants, cette modification est prise en compte. <br><br>La constante *hAffecteParcours* est prioritaire sur la constante *hEcritureDéfaut*. |
| *hBlocageEcriture* | **Mode de blocage de l'enregistrement modifié** : Blocage en écriture : l'enregistrement modifié sera bloqué en écriture. Cet enregistrement pourra être lu par une autre application mais ne pourra pas être modifié par une autre application. Seule l'application en cours pourra le modifier, ou le débloquer.<br><br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible.<br>![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Accès par JDBC : Cette constante n'est pas disponible. |
| *hBlocageLectureEcriture* | **Mode de blocage de l'enregistrement modifié** : Blocage en lecture/écriture : l'enregistrement modifié sera bloqué en lecture et en écriture. Cet enregistrement ne pourra ni être lu ni être modifié par une autre application. Seule l'application en cours pourra le modifier, le lire ou le débloquer.<br><br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible.<br>![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Accès par JDBC : Cette constante n'est pas disponible. |
| *hBlocageNon*<br> (valeur par défaut) | **Mode de blocage de l'enregistrement modifié** : Aucun blocage : l'enregistrement modifié ne sera pas bloqué.<br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible.<br>![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Accès par JDBC : Cette constante n'est pas disponible. |
...
| *hRecalculeIDAuto* | **Mode de calcul de l'identifiant automatique** : L'identifiant automatique de l'enregistrement sera re-calculé lors de l'écriture. Cette constante est prioritaire sur les constantes *hForceIDAuto* et *hFixeIDAuto*.<br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible. |
...
## Remarques
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Langage Externe](https://doc.pcsoft.fr/ext/images/fr/LE.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png)![Procédures stockées](https://doc.pcsoft.fr/ext/images/fr/PS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/fr/HF55.png) 

### Gestion des Identifiants automatiques
<a name="gestion_des_identifiants_automatiques_ELTPARAGRAPHE000580"></a>Par défaut (sans utilisation des constantes de modification de l'identifiant automatique), la fonction **&lt;Source&gt;.Modifie** utilisée sur un enregistrement actif ou rayé ne modifie pas l'identifiant automatique (même si l'identifiant automatique a été affecté dans le langage) : l'identifiant automatique présent dans le fichier de données est ré-utilisé.
...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png)![OLE DB](https://doc.pcsoft.fr/ext/images/fr/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) 
...
<a name="modification_des_enregistrements_supprimes_rayes_ELTPARAGRAPHE000608"></a>La modification d'un enregistrement rayé ou supprimé réactive l'enregistrement.
<a name="NOTE0_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Langage Externe](https://doc.pcsoft.fr/ext/images/fr/LE.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png)![Procédures stockées](https://doc.pcsoft.fr/ext/images/fr/PS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/fr/HF55.png) 

### Conflit de modification ou de suppression
<a name="conflit_modification_suppression_ELTPARAGRAPHE000620"></a>Les erreurs de conflit de modification ou de conflit de suppression apparaissent uniquement si la fonction **&lt;Source&gt;.Modifie** est utilisée sur l'enregistrement courant. En effet, si un numéro d'enregistrement est précisé, il ne peut y avoir de conflit, car l'enregistrement n'a pas été lu avant la modification.
...
<a name="gestion_des_doublons_integrite_ELTPARAGRAPHE000638"></a>Les contrôles d'intégrité et de doublons s'effectuent uniquement sur les clés pour lesquelles :
...
<a name="NOTE0_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![HFSQL Classic](https://doc.pcsoft.fr/ext/images/fr/HF.png)![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png)![Procédures stockées](https://doc.pcsoft.fr/ext/images/fr/PS.png)![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/fr/HF55.png) 

### Version du fichier de données après une modification
<a name="version_fichier_donnees_apres_une_modification_ELTPARAGRAPHE000664"></a>Si l'enregistrement a été modifié (pas d'erreur de doublons ou d'intégrité), le numéro de version du fichier de données est modifié. Pour connaître le numéro de version, utilisez la fonction [&lt;Source&gt;.Version](../WDLang4/1000025082.md).
<a name="NOTE0_6"></a>
...
<a name="gestion_des_memos_binaires_ELTPARAGRAPHE000681"></a>Lors de la modification d'un enregistrement, les mémos sont modifiés si nécessaire (si la gestion des mémos est activée à l'aide de la fonction [&lt;Source&gt;.GèreMémo](../WDLang4/1000024987.md)). 
...
<a name="modification_enregistrement_selectionne_dans_une_requete_ELTPARAGRAPHE000705"></a>La modification d'un enregistrement dans une requête peut être effectuée :
...
<a name="NOTE0_8"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![Procédures stockées](https://doc.pcsoft.fr/ext/images/fr/PS.png)![OLE DB](https://doc.pcsoft.fr/ext/images/fr/OLEDB.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) 

### Parcours et modification d'un enregistrement
<a name="parcours_modification_enregistrement_ELTPARAGRAPHE000750"></a>Si la modification est réalisée pendant un parcours, l'enregistrement modifié sera visible dans le parcours en cours uniquement. Si d'autres parcours ont été définis sur cette base de données, l'enregistrement modifié ne sera visible qu'après ré-initialisation de ces parcours. 
...
### xBase
<a name="xbase_ELTPARAGRAPHE000769"></a>La fonction [&lt;Source&gt;.Supprime](../WDLang4/1000025071.md) a le même effet que la fonction [&lt;Source&gt;.Raye](../WDLang4/1000025051.md) : l'enregistrement est rayé et non supprimé. L'enregistrement peut donc être réactivé par la fonction **&lt;Source&gt;.Modifie**. Dans ce cas, la fonction [&lt;Source&gt;.Etat](../WDLang4/1000024943.md) renvoie la constante *hEtatRaye* sur un enregistrement supprimé (et non la constante *hEtatSup*).
