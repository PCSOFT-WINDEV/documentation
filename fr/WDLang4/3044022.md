...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000092"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
- La fonction **PageVersFichier** n'affecte pas les rubriques pour les champs de type Image. Utilisez la fonction [HAttacheMémo](../WDLang4/3044173.md).
