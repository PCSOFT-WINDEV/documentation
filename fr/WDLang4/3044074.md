...
<a name="variables_permettant_gerer_les_triggers_ELTPARAGRAPHE000165"></a>Une procédure de type trigger ne reçoit aucun paramètre. Toutefois, un certain nombre de variables d'état HFSQL sont positionnées avant chaque appel :
...
<a name="versions_precedentes_ELTPARAGRAPHE000205"></a>Cette fonction remplace la fonction **DécritTrigger_55**, conservée par compatibilité avec WINDEV 5.5.
