...
![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Il est possible de réaliser le calcul des statistiques en tâche de fond, sans bloquer le fichier de données en écriture. ![HFSQL Client/Serveur](https://doc.pcsoft.fr/ext/images/fr/HFCS.png) Le calcul des statistiques d'un fichier de données HFSQL Client/Serveur peut être effectuée de manière asynchrone grâce à la fonction [HStatCalculAsynchrone](../WDLang4/1410091108.md). 
