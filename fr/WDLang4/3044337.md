...
<a name="fichiers_crees_par_une_transaction_ELTPARAGRAPHE000068"></a>Lors de la mise en place des transactions, plusieurs types de fichiers de données HFSQL sont créés : 
...
<a name="identifiant_poste_realisant_transaction_ELTPARAGRAPHE000112"></a>L'identification du poste réalisant la transaction se fait de la même façon en HFSQL Classic et en HFSQL Client/Serveur : par défaut, le poste est identifié par un numéro unique interne et par le nom du poste (nom défini sous Windows). 
...
<a name="erreurs_specifiques_gestion_des_transactions_mode_hfsql_clientserveur_ELTPARAGRAPHE000138"></a>**74020 : Le mot de passe du fichier de Transaction ne correspond pas au mot de passe du fichier d'origine** 
