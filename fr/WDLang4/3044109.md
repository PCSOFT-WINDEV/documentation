...
<a name="position_par_rapport_une_rubrique_cle_non_cle_ELTPARAGRAPHE000124"></a>Pour une rubrique clé, la position retournée est relative à l'ordre de l'enregistrement dans l'index de cette rubrique.
...
<a name="position_dans_parcours_filtre_ELTPARAGRAPHE000140"></a>Si un filtre avec bornes est défini (fonction [HFiltre](../WDLang4/3044100.md) sans chaîne de condition mais avec les bornes minimales et maximales), la position retournée est relative aux enregistrements sélectionnés par le filtre.
