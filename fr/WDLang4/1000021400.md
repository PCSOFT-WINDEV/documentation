...
- La fonction **PageDepuisSource** n'effectue aucune lecture du fichier de données. C'est la valeur de l'enregistrement chargé en mémoire qui est utilisée pour initialiser les champs. Il faut donc qu'un enregistrement soit au préalable chargé en mémoire (fonctions [HLit](../WDLang4/3044047.md), [HLitRecherche](../WDLang4/3044050.md), [HLitPremier](../WDLang4/3044051.md), etc.).
...
<a name="lien_champ_avec_une_variable_wlangage_avec_une_rubrique_fichier_donnees_ELTPARAGRAPHE000099"></a>La liaison d'un champ avec une variable WLangage ou avec une rubrique d'un fichier de données peut être connue :
...
<a name="liaison_avec_une_rubrique_types_liaisons_ELTPARAGRAPHE000114"></a>La liaison d'un champ vers une rubrique peut être de deux types :
