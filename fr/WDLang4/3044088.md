...
![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce paramètre est ignoré.
...
<a name="numeros_erreur_hfsql_ELTPARAGRAPHE000095"></a>Pour connaître les principaux numéros des erreurs HFSQL, consultez : les [erreurs HFSQL](../WDLang4/3044177.md).
<a name="NOTE0_2"></a>
...
<a name="gestion_des_souserreurs_ELTPARAGRAPHE000107"></a>Diverses fonctions génèrent deux niveaux d'erreur. Ces deux niveaux d'erreur permettent d'affiner la cause de l'erreur, en effectuant par exemple un simple parcours entre les différentes sous-erreurs (voir exemple).
