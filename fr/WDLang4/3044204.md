...
### Utilisation avec des fichiers de données HFSQL Classic (monoposte ou réseau)
...
**`<Chemin complet du fichier de données HFSQL> : (Chaîne de caractères)`**
...
![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Attention : le nom physique des fichiers doit être en minuscules et sans accent.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Seules les connexions à une base de données HFSQL Client/Serveur sont disponibles.
