...
<a name="lecture_selon_une_cle_ELTPARAGRAPHE000241"></a>La fonction **HSuivant** positionne sur l'enregistrement suivant pour lequel la valeur de la clé est la plus grande. L'ordre de tri pris en compte est l'ordre de tri spécifié dans l'analyse pour cette clé.
<a name="NOTE0_2"></a>


### Comparaison des fonctions HSuivant et [HLitSuivant](../WDLang4/3044037.md)
<a name="comparaison_des_fonctions_docparampagetitleshort_hlitsuivantwdlang43044037md_ELTPARAGRAPHE000253"></a>La fonction **HSuivant** ne lit pas l'enregistrement : la fonction **HSuivant** est donc plus rapide que la fonction [HLitSuivant](../WDLang4/3044037.md).
<a name="NOTE0_3"></a>


### Divers
<a name="divers_ELTPARAGRAPHE000276"></a>
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000294"></a>Par défaut (paramètre &lt;Options&gt; non spécifié), aucun blocage de l'enregistrement n'est réalisé.
