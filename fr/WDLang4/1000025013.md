...
<a name="affichage_resultat_dans_champ_liste_champ_combo_ELTPARAGRAPHE000293"></a>&lt;Résultat&gt; peut être directement affecté à un champ Liste ou un champ Combo grâce à la fonction [&lt;Liste&gt;.Ajoute](../WDLang1/1000017319.md). Chaque ligne contiendra le nom d'un des index full-text trouvés.
<a name="NOTE0_2"></a>


### Extraire une information du résultat
<a name="extraire_une_information_resultat_ELTPARAGRAPHE000308"></a>Pour extraire une information du résultat détaillé, il est conseillé d'utiliser la fonction [&lt;Chaîne ANSI&gt;.ExtraitChaîne](../WDLang1/1000024876.md).
