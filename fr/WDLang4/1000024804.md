...
<a name="procedure_wlangage_executee_dans_thread_principal_ELTPARAGRAPHE000077"></a>Cette procédure WLangage est appelée par défaut dans le thread principal de l'application, avec le contexte HFSQL correspondant à la procédure :
...
<a name="procedure_wlangage_executee_dans_thread_secondaire_ELTPARAGRAPHE000238"></a>Si la procédure WLangage est appelée dans un thread secondaire : 
