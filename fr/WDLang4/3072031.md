...
![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Le fetch partiel est automatiquement réalisé par le framework JAVA.![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) La fonction **SQLTable** ne fonctionne pas si la requête contient des mémos binaires. Il est nécessaire de traiter séparément les mémos binaires (par exemple les enregistrer avec [fSauveTexte](../WDLang1/3036046.md)).
<a name="Exemple1"></a>
