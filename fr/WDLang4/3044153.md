...
<a name="modification_type_blocage_sur_fichier_donnees_ELTPARAGRAPHE000141"></a>Pour modifier le type de blocage d'un fichier de données, appelez la fonction **HBloqueFichier** avec le type de blocage souhaité. Il n'est pas nécessaire de débloquer le fichier de données au préalable.
<a name="NOTE0_2"></a>


### Influence du mode de blocage
<a name="influence_mode_blocage_ELTPARAGRAPHE000153"></a>Si le fichier de données est en mode de blocage *hModeMono* (voir la fonction [HMode](../WDLang4/3044039.md)), la fonction **HBloqueFichier** n'a aucun effet.
<a name="NOTE0_3"></a>


### Échec du blocage
<a name="echec_blocage_ELTPARAGRAPHE000168"></a>Si le fichier de données (ou un de ses enregistrements) est déjà bloqué, la demande de blocage est répétée [H.NbEssais](../WDLang4/3044075.md) fois (50 par défaut).
