...
Ces options sont définies sous l'éditeur d'analyses, dans l'onglet "Détail" de la fenêtre de description des fichiers de données. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0001.gif)
...
<a name="fichiers_donnees_plus_2_ELTPARAGRAPHE000185"></a>Si certains fichiers de données risquent d'avoir une taille qui va dépasser 2 Go, le serveur HFSQL doit être installé sur un système d'exploitation et un système de fichiers qui permettent de gérer ce type de fichier (comme NTFS). 

De plus, l'option de gestion des fichiers de données de plus de 2 Go doit être activée dans l'analyse WINDEV/WEBDEV correspondante aux bases de données (onglet "Compatibilité" de la fenêtre de description des fichiers de données) : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0002.gif&type=thumb)
