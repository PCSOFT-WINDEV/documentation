...
- Par défaut, la fonction **&lt;Source&gt;.Suivant** effectue une recherche générique.
...
<a name="lecture_selon_une_cle_ELTPARAGRAPHE000552"></a>La fonction **&lt;Source&gt;.Suivant** positionne sur l'enregistrement suivant pour lequel la valeur de la clé est la plus grande. L'ordre de tri pris en compte est l'ordre de tri spécifié dans l'analyse pour cette clé.
<a name="NOTE0_2"></a>
...
### Blocages
<a name="blocages_ELTPARAGRAPHE000616"></a>Par défaut (paramètre &lt;Options&gt; non spécifié), aucun blocage de l'enregistrement n'est réalisé.
