...
<a name="mise_forme_resultat_ELTPARAGRAPHE000040"></a>Le code SQL de la requête est identique à celui affiché sous l'éditeur de requêtes par l'option "Code SQL" du menu contextuel de la requête : les espaces, tabulations et retours à la ligne sont conservés.
<a name="NOTE0_2"></a>


### Utilisation dans les procédures stockées HFSQL
<a name="utilisation_dans_les_procedures_stockees_hfsql_ELTPARAGRAPHE000047"></a>La propriété **CodeSQL** peut être utilisée dans le code d'une procédure stockée pour connaître le code d'une requête stockée présente sur le serveur.
