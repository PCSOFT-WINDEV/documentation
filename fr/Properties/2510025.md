...
| <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=position_sel.gif)<br> | Le curseur de saisie est placé au début de la zone en en surbrillance (position 3 dans cet exemple). La propriété [FinCurseur](../Proprietes/2510047.md) permet de connaître et de modifier la fin de la zone sélectionnée. |
