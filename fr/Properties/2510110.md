...
### Propriété Valeur
<a name="propriete_valeur_ELTPARAGRAPHE000106"></a>La propriété **RubriqueMémorisée** modifie la valeur retournée par la propriété [Valeur](../Proprietes/2510130.md).
...
<a name="champ_liste_par_programmation_ELTPARAGRAPHE000197"></a>Si un champ Liste par programmation ou un champ Combo par programmation doit afficher des données provenant d'un fichier de données, d'une requête ou d'une vue :
...
<a name="recherche_selection_element_present_dans_champ_liste_dans_champ_combo_lie_fichier_donnees_ELTPARAGRAPHE000223"></a>Pour rechercher et/ou sélectionner un élément présent dans un champ Liste (ou dans un champ Combo) lié à un fichier de données, il est conseillé d'utiliser la syntaxe suivante :
...
### Limites
<a name="limites_ELTPARAGRAPHE000233"></a>La propriété **RubriqueMémorisée** s'applique uniquement aux champs suivants :
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) champ Zone répétée.
