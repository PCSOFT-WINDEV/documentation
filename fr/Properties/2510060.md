...
Un champ peut être lié à une rubrique d'un fichier de données de base, ou à une rubrique d'un fichier de données relié (on parle alors de liaison complexe ou de liaison muti-fichiers de données). Exemple de liaison multi-fichier de données :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonFichier%20-%20HC%20N%B0001.gif)
...
### Champ Liste image
<a name="champ_liste_image_ELTPARAGRAPHE000191"></a>La propriété **LiaisonFichier** permet de connaître et de modifier la liaison des libellés d'un champ Liste image avec une rubrique d'un fichier de données.
<a name="NOTE0_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) 

### Erreur d'affichage
<a name="erreur_affichage_ELTPARAGRAPHE000203"></a>La fonction [ChampErreur](../WDLang1/3025036.md) permet de personnaliser le message d'erreur affiché dans les champs en cas d'impossibilité d'afficher la valeur du champ.
<a name="NOTE0_3"></a>


### Limites
<a name="limites_ELTPARAGRAPHE000213"></a>La propriété **LiaisonFichier** s'applique uniquement aux champs d'une fenêtre ou d'une page.
![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Cette propriété s'applique uniquement aux champs suivants : 
