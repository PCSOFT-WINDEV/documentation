...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette propriété est disponible uniquement en Lecture/Ecriture pour les champs d'un état. Pour les champs d'une page, cette propriété n'est pas disponible. **Remarque** : Le masque de saisie d'un champ est défini sous l'éditeur de fenêtres ou d'états, dans l'onglet "Général" de la description du champ. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MasqueSaisie.gif)
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Sous l'éditeur de fenêtres, pour les champs de saisie et les combos, il est possible d'utiliser une expression régulière pour construire le masque de validation : il suffit d'utiliser la chaîne "regexp:" avant l'expression régulière. Pour plus de détails, consultez [les remarques](#NOTE0_9).
...
|   |   |
| --- | --- |
| *maskBitcoin* | Masque numérique utilisé pour manipuler les Bitcoins. Le sigle correspondant au Bitcoin est affiché. <br><br>![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Cette constante n'est pas disponible. |
...
| *maskScientifique* | Masque numérique permettant d'utiliser la notation scientifique.<br><br>![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Cette constante n'est pas disponible. |
...
| *maskTelBelgique* | Numéro de téléphone au format Belge (avec gestion des indicatifs, des numéros nationaux et internationaux). <br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Cette constante n'est pas disponible. |
| *maskTelCanada* | Numéro de téléphone au format Canadien ou Américain (XXX CCC-CCCC ou +1 XXX CCC-CCCC où XXX correspond au code régional et CCC-CCCC correspond au numéro local). <br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Cette constante n'est pas disponible. |
| *maskTelFrance* | Numéro de téléphone au format Français (10 chiffres, regroupés par 2). Par exemple : "04 67 69 40 23" ou "36 99". |
| *maskTelSuisse* | Numéro de téléphone au format Suisse (0CC CCC CC CC ou +41 CC CCC CC CC).<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Cette constante n'est pas disponible. |
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Dans une fenêtre, la propriété **MasqueSaisie** s'applique uniquement aux :
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette propriété est disponible uniquement en Lecture / Ecriture pour les champs d'un état. Pour les champs d'une page, cette propriété n'est pas disponible. 
