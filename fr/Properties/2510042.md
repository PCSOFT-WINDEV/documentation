...
Ce filtre (s'il existe) peut être défini lors de la description du champ (onglet "Contenu").<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Filtre.gif)
