...
<a name="vue_hfsql_associee_etat_ELTPARAGRAPHE000077"></a>Lorsque l'état est basé sur une vue HFSQL, lors de la description de l'état, seul le nom du fichier de données correspondant à la vue est spécifié. Le nom de la vue utilisée est précisé lors de l'impression de l'état.
...
<a name="zone_memoire_associee_etat_ELTPARAGRAPHE000098"></a>Lorsque l'état est basé sur une zone mémoire, lors de la description de l'état, seul le nom du fichier de données correspondant à la zone mémoire est spécifié. Le nom de la zone mémoire utilisée est précisé lors de l'impression de l'état.
...
<a name="requete_integreerequete_independante_ELTPARAGRAPHE000119"></a>Lors de la création d'un état, deux types de requêtes peuvent être utilisés :
...
### Limites
<a name="limites_ELTPARAGRAPHE000129"></a>
...
[NomZoneMem (Propriété)](../Proprietes/2511029.md)
