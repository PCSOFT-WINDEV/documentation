...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) **Dans une fenêtre**, la propriété **Etat** permet de connaître et de modifier l'état d'affichage :
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) **Dans une page**, la propriété **Etat** permet de connaître et de modifier l'état d'affichage :
...
| *Invisible* | Invisible (il est conseillé d'utiliser la propriété [Visible](../Proprietes/2510138.md)).<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. Utilisez la propriété [Visible](../Proprietes/2510138.md). |
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) La propriété **Etat** utilisée sur une option de menu contextuel permet de rendre cette option invisible.
<a name="NOTE0_9"></a>
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La propriété **Etat** est sans effet sur les éléments suivants : 
