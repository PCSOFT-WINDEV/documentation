...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Cette propriété est disponible uniquement pour les champs Bouton.
...
### Limites
<a name="limites_ELTPARAGRAPHE000102"></a>![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png) La propriété **FocusAuClic** s'applique uniquement aux champs suivants :
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) La propriété **FocusAuClic** s'applique uniquement aux champs Bouton.


## Voir aussi

[EcranPremier (Fonction)](../Proprietes/3025039.md)

[DonneFocus (Fonction)](../Proprietes/3025001.md)

[DonneFocusEtRetourUtilisateur (Fonction)](../Proprietes/1410088107.md)

[NumTAB (Propriété)](../Proprietes/2510098.md)

[Ordre de navigation dans une fenêtre, une page, etc.](../Proprietes/2026006.md)

[Les différents types de boutons dans une fenêtre](../Proprietes/1013093.md)
