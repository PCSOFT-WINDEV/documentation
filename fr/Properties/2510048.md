...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) les colonnes de champ Table affichées par les champs Combo.
...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) La propriété **FormatMémorisé** est disponible uniquement pour les champs Calendrier.


<a name="SYNTAXE2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) aux colonnes de champ Table affichées par les combos.




![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) La propriété **FormatMémorisé** est en lecture uniquement.

![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) La propriété **FormatMémorisé** s'applique uniquement aux champs de saisie.
