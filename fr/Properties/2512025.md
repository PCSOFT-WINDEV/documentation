...
- Définir le nom du provider OLE DB utilisée pour la connexion à une table par OLE DB (lors de la description par programmation du fichier de données uniquement). Cette propriété est équivalente à la propriété [CxProviderOLEDB](../Proprietes/2512033.md). 
