...
### Limites
<a name="limites_ELTPARAGRAPHE000156"></a>![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) La propriété **DndCible** peut être utilisée uniquement avec les champs suivants :
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) La propriété **DndCible** peut être utilisée uniquement avec les champs suivants :
