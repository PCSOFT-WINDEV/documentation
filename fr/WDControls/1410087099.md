...
- Utiliser la fonction [&lt;Lecteur PDF&gt;.Ouvre](../WDLang1/1000023776.md). Par exemple : 
	...
	FIN
	```
 Remarque : La fonction [&lt;Lecteur PDF&gt;.Ouvre](../WDLang1/1000023776.md) offre la possibilité de donner le mot de passe du fichier par programmation.
...
<a name="proprietes_specifiques_champ_lecteur_pdf_ELTPARAGRAPHE000201"></a>Les propriétés suivantes sont spécifiques au champ Lecteur PDF. Elles permettent essentiellement de manipuler les caractéristiques du champ : 
...
[Fonctions de gestion du champ Lecteur PDF (syntaxe préfixée)](../WDChamp/1000023877.md)
