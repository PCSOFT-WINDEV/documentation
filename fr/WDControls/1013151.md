...
![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png) Les champs Interrupteurs avec images ne sont pas disponibles.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Pour les applications iPhone/iPad et pour les applications Android, il est possible de créer : 

- des interrupteurs standard. 

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) des interrupteurs standard avec sous-libellés. 
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Interrupteur_IOS.gif)
...
<a name="interrupteur_trois_etats_ELTPARAGRAPHE000172"></a>Sous l'éditeur de fenêtres, il est possible de gérer trois états pour les options des champs Interrupteur.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Interrupteur_TroisEtat.gif)
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Sous l'éditeur d'états, le champ Interrupteur correspond à une case à cocher :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) 
