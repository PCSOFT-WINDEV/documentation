...
## Présentation
<a name="presentation_ELTTEXTE000601"></a>
...
<a name="etat_sur_requete_independante_ELTTEXTE000625"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000108"></a>La requête doit être créée avant la création de l'état (pour plus de détails, consultez [Créer une requête](../Editeurs/2032059.md)). Lors de la création de l'état, il suffit de spécifier le nom de la requête utilisée.
...
<a name="creer_etat_sur_requete_independante_ELTPARAGRAPHE000120"></a>Pour créer un état sur requête indépendante :
...
<a name="etat_sur_requete_integree_ELTTEXTE000655"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000218"></a>La requête est créée directement lors de la création de l'état. Cette requête sera modifiée directement depuis l'éditeur d'états (option "Éditer la requête" du menu contextuel de l'état). Si des modifications sont réalisées dans la requête, l'éditeur d'états liste les modifications réalisées et les incidences sur l'état.
...
<a name="creer_etat_sur_requete_integree_ELTPARAGRAPHE000248"></a>Pour créer un état sur requête intégrée :
...
<a name="etat_base_sur_une_requete_parametree_ELTTEXTE000691"></a>
...
<a name="imprimer_etat_base_sur_une_requete_ELTTEXTE000724"></a>
...
<a name="imprimer_etat_base_sur_une_requete_sans_parametre_ELTPARAGRAPHE000443"></a>Pour imprimer une requête sans paramètre, il suffit de :
...
1. Paramétrer la destination de l'impression de l'état :
	...
	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) En WEBDEV, grâce à la fonction [iDestination](../WDLang5/3046074.md) (impression dans un fichier HTML, ...).
...
2. Préciser le nom de l'état à imprimer grâce à la fonction [iImprimeEtat](../WDLang5/3046032.md).
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Sous Android et iOS : pour imprimer l'état "ETAT_Requete" :
	...
	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Sous WEBDEV : pour imprimer l'état "ETAT_Requete" au format HTML :
...
<a name="imprimer_etat_base_sur_une_requete_avec_parametres_ELTPARAGRAPHE000497"></a>Pour imprimer une requête avec paramètres, il suffit de :
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Sous Android et iOS : 
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Code WEBDEV :
