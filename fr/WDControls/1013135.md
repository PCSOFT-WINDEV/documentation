...
3. L'enregistrement des informations dans le fichier de données sera effectué automatiquement lors de l'utilisation : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) de la fonction [EcranVersFichier](../WDLang4/3044146.md).

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) de la fonction [PageVersFichier](../WDLang4/3044022.md). 
