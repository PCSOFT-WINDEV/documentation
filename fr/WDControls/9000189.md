...
## Variable Clavier
<a name="variable_clavier_ELTTEXTE000167"></a>
...
<a name="manipuler_les_codes_des_touches_clavier_ELTPARAGRAPHE000059"></a>Pour manipuler facilement les codes des touches clavier : 
...
## Exemple
<a name="exemple_ELTTEXTE000197"></a>


### Effectuer une action dans l'événement Touche enfoncée
<a name="effectuer_une_action_dans_evenement_touche_enfoncee_ELTPARAGRAPHE000090"></a>Le code suivant permet d'effectuer une action dans l'événement "Touche enfoncée" d'un champ de saisie lors d'un coller (Ctrl + V). 
