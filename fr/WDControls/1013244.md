...
- Les **images animées par défaut**. Ces images ont un format d'images animées (GIF animé par exemple). La gestion de ces images animées est automatique. Aucune configuration spécifique n'est nécessaire.
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Les images animées par défaut (par exemple les GIF animés) ne sont pas disponibles.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Remarque : WEBDEV permet également : 
