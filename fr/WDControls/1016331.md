...
L'événement "Réception des fichiers uploadés" peut également permettre de charger les images uploadées dans une rubrique mémo d'un fichier de données HFSQL, via la fonction [HAttacheMémo](../WDLang4/3044173.md).
