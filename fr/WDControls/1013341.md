...
### Mise en place
<a name="mise_place_ELTPARAGRAPHE000133"></a>Pour mettre en place un calcul personnalisé dans une colonne d'un champ Table (ou Table hiérarchique), utilisez la fonction [&lt;Table&gt;.FormuleAjoute](../WDLang1/1000024254.md).
...
- Pour récupérer la valeur du calcul personnalisé d'une colonne, il suffit d'utiliser la syntaxe suivante : 
	...
	```
où &lt;Numéro ligne&gt; correspond à l'indice de ligne renvoyé par la fonction [&lt;Table&gt;.FormuleAjoute](../WDLang1/1000024254.md).
...
<a name="position_ligne_calculs_ELTPARAGRAPHE000195"></a>Pour configurer la position des calculs de colonnes (automatiques ou personnalisés) :
...
<a name="personnalisation_ligne_calculs_ELTPARAGRAPHE000220"></a>Il est possible de personnaliser (libellé, couleur, police, hauteur, etc.) : 
...
- &lt;Numéro ligne&gt; correspond à l'indice de ligne renvoyé par la fonction [&lt;Table&gt;.FormuleAjoute](../WDLang1/1000024254.md). 
...
<a name="suppression_des_lignes_calcul_personnalise_ELTPARAGRAPHE000347"></a>Pour supprimer les lignes de calcul personnalisé, utilisez la fonction [&lt;Table&gt;.FormuleSupprimeTout](../WDLang1/1000024255.md).
...
<a name="exporter_les_resultats_des_calculs_ELTTEXTE000357"></a>


### Export via les FAA (Fonctionnalités Automatiques de vos Applications) du champ Table
<a name="export_via_les_faa_fonctionnalites_automatiques_vos_applications_champ_table_ELTPARAGRAPHE000380"></a>Le menu contextuel des champs Table et Table hiérarchique propose par défaut des options permettant d'exporter le contenu du champ. 
...
<a name="export_via_les_fonctions_wlangage_ELTPARAGRAPHE000394"></a>Diverses fonctions WLangage permettent d'exporter le contenu d'un champ Table dans un format spécifique (Word, Excel, XML, etc.). Lors de cet export, par défaut les lignes correspondant à un calcul sont également exportées.
...
[&lt;Table&gt;.FormuleAjoute (Fonction)](../WDChamp/1000024254.md)

[&lt;Table&gt;.FormuleSupprimeTout (Fonction)](../WDChamp/1000024255.md)
