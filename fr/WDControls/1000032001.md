...
1. Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur "Zone de Texte Riche". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ZTR_Creation.gif)
...
2. Cliquez sur le champ : un bandeau jaune apparaît autour du champ et le champ passe en mode édition. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ZTR_Edition_bandeau_Jaune.gif)
...
3. En mode édition : 
	...
	- le ruban de l'éditeur s'adapte à la saisie dans le champ : toutes les options d'édition disponibles sont affichées : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ZTR_Edition_ruban.gif)
