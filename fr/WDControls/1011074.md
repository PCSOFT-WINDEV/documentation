...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) Lorsqu'un état est affiché dans le visualisateur de rapports, les champs de saisie, les champs Interrupteur et les champs Combo sont actifs.
