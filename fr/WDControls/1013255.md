...
<a name="presentation_champ_fenetre_interne_ELTTEXTE000291"></a>
...
<a name="creer_une_fenetre_interne_associer_champ_ELTTEXTE000315"></a>


### Créer une fenêtre interne
<a name="creer_une_fenetre_interne_ELTPARAGRAPHE000051"></a>Pour créer une fenêtre interne : 
...
<a name="creer_champ_type_fenetre_interne_ELTPARAGRAPHE000087"></a>Pour créer un champ de type "Fenêtre interne" : 
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Il est possible de faire défiler des fenêtres internes dans un champ Fenêtre interne par un simple mouvement de doigt. Pour plus de détails, consultez [Changement du contenu d'une fenêtre interne par gesture](../WDChamp/1013277.md). 
<a name="NOTE2_3"></a>


### Créer une fenêtre interne à partir de champs existants
<a name="creer_une_fenetre_interne_partir_champs_existants_ELTPARAGRAPHE000120"></a>Pour créer une fenêtre interne à partir de champs existants : 
...
<a name="creer_une_fenetre_interne_partir_une_fenetre_inversement_ELTPARAGRAPHE000147"></a>
...
## Remarques
<a name="remarques_ELTTEXTE000357"></a>


### Limitations
<a name="limitations_ELTPARAGRAPHE000181"></a>Des menus principaux peuvent être créés dans des champs fenêtre interne, mais ils seront inactifs.
<a name="NOTE3_3"></a>


### Appliquer un modèle de fenêtre à une fenêtre interne
<a name="appliquer_modele_fenetre_une_fenetre_interne_ELTPARAGRAPHE000190"></a>Pour appliquer un ou plusieurs modèles de fenêtres sur une fenêtre interne : 
...
<a name="afficher_apercu_des_fenetres_internes_100_ELTPARAGRAPHE000218"></a>Par défaut, les fenêtres internes affichées dans les champs de type "Fenêtre interne" sont réduites sous l'éditeur. 
...
[Propriétés WLangage associées aux champs "Fenêtre interne"](../WDChamp/1013256.md)
