...
|   |   |
| --- | --- |
| <br><br>- Texte<br><br>- Monétaire<br><br>- Heure<br><br>- [Combo](../WDChamp/9500152.md)<br>	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Non disponible.<br><br>- Image<br><br>- Jauge<br>	![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Non disponible.<br><br><br> | <br><br>- Numérique<br><br>- Date<br><br>- Libellé<br><br>- Interrupteur<br>	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Non disponible.<br><br>- Durée<br>	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Non disponible.<br><br>- [Conteneur](../WDChamp/1013332.md)<br>	(non disponible en Java et en WINDEV Mobile)<br><br><br> |
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) Les colonnes des champs Table hiérarchique ont les mêmes caractéristiques que les colonnes des champs Table.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Les colonnes du champ Table ne peuvent pas avoir une image dans le titre de la colonne.
<a name="NOTE2_5"></a>
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Les colonnes du champ Table ne peuvent pas être déplacées.
<a name="NOTE2_4"></a>
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) L'utilisateur clique sur l'entête de colonne pour afficher le menu contextuel. 

- Dans le menu contextuel, l'utilisateur sélectionne la loupe : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_ChampTable_Loupe.gif)


- Dans la zone de saisie qui s'affiche en haut du champ Table, l'utilisateur saisit le mot recherché. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_TableSaisieLoupe.gif)
...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Cette fonctionnalité n'est pas disponible en WINDEV Mobile.
<a name="NOTE3_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) 
