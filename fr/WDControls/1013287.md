...
Une rupture dans un champ Zone répétée permet de regrouper des données correspondant à un ou plusieurs arguments.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=RuptureZR.GIF)
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Les champs Zone répétée en mode Classique, Ajax et Navigateur.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Les ruptures dans les champs Zone répétée ne sont pas disponibles dans les champs Zone répétée multicolonne. 
...
. La fenêtre de gestion des ruptures apparaît : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FenRupture.GIF)
...
5. Dans la zone qui s'affiche, saisissez le chemin de l'image du bouton des ruptures. Cette image est une image à 2 états (plus et moins) au format 24 x 12. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Rupture_Perso_Btn.gif&type=thumb)
...
5. Sélectionnez l'élément sur lequel le calcul doit être effectué. Il est possible d'effectuer le calcul sur :
	...
	- Une rubrique du fichier de données (uniquement pour les champs Zone répétée liées aux données).
