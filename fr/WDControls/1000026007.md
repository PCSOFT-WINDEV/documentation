...
<a name="manipuler_champ_timeline_par_programmation_ELTTEXTE000133"></a>


### Ajouter une piste
<a name="ajouter_une_piste_ELTPARAGRAPHE000156"></a>L'ajout d'une piste dans un champ TimeLine est réalisé grâce à la fonction [&lt;TimeLine&gt;.AjoutePiste](../WDLang1/1000020777.md). 
...
**Remarque** : La fonction [&lt;TimeLine&gt;.AjoutePiste](../WDLang1/1000020777.md) permet d'insérer une image de fond dans la piste.


### Ajouter un événement
<a name="ajouter_evenement_ELTPARAGRAPHE000186"></a>L'ajout d'un événement dans un champ TimeLine est réalisé grâce à la fonction [&lt;TimeLine&gt;.AjouteEvénement](../WDLang1/1000020776.md). Cette fonction accepte deux syntaxes : 
...
<a name="remplir_champ_timeline_avec_les_donnees_presentes_dans_fichier_donnees_hfsql_ELTPARAGRAPHE000228"></a>Les enregistrements sont stockés dans un fichier de données HFSQL. Le remplissage initial du champ TimeLine peut être réalisé par un parcours du fichier de données via la syntaxe POUR TOUT et par l'ajout de chaque événement via la fonction [&lt;TimeLine&gt;.AjouteEvénement](../WDLang1/1000020776.md).
...
<a name="recuperer_une_liste_evenements_ELTPARAGRAPHE000253"></a>La fonction [&lt;TimeLine&gt;.ListeEvénement](../WDLang1/1000020779.md) permet de récupérer : 
...
<a name="supprimer_evenement_ELTPARAGRAPHE000293"></a>La fonction [&lt;TimeLine&gt;.SupprimeEvénement](../WDLang1/1000020780.md) permet de supprimer : 
...
### Supprimer une piste
<a name="supprimer_une_piste_ELTPARAGRAPHE000318"></a>La fonction [&lt;TimeLine&gt;.SupprimePiste](../WDLang1/1000020781.md) permet de supprimer une piste du champ TimeLine.
...
FIN
```
La fonction [&lt;TimeLine&gt;.SupprimeTout](../WDLang1/1000020782.md) permet de supprimer tous les événements présents dans le champ TimeLine ainsi que toutes ses pistes.


### Modifier l'échelle temporelle du champ
<a name="modifier_echelle_temporelle_champ_ELTPARAGRAPHE000345"></a>L'affichage courant d'un champ TimeLine peut être modifié via la fonction [&lt;TimeLine&gt;.ChangeMode](../WDLang1/1000020778.md). Cette fonction permet de modifier le mode d'affichage du champ : seconde, milliseconde ou microseconde.



## Utilisation du menu contextuel (FAA)
<a name="utilisation_menu_contextuel_faa_ELTTEXTE000355"></a>
...
<a name="utilisation_avancee_des_evenements_associes_champ_timeline_ELTTEXTE000397"></a>


### Utilisation avancée des événements avec procédure
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000420"></a>Il est possible de proposer à l'utilisateur de définir plus précisément les caractéristiques de son événement lors d'un ajout ou d'une modification. Il suffit pour cela de créer une fenêtre avec les informations à remplir. 
...
<a name="proprietes_specifiques_aux_champs_timeline_ELTTEXTE000436"></a>
...
[Fonctions de gestion des champs TimeLine (syntaxe préfixée)](../WDChamp/1000020783.md)
...
[EvénementTimeline (Type de variable)](../WDChamp/1000020612.md)
