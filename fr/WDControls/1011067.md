...
### Création
<a name="creation_ELTPARAGRAPHE000049"></a>Pour créer un état de type "Formulaire" : 
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Les formats d'image supportés sont : 
...
<a name="informations_specifiques_formulaire_ELTPARAGRAPHE000080"></a>Les informations spécifiques au formulaire sont les suivantes :
...
### Intégrer un formulaire dans un état
<a name="integrer_formulaire_dans_etat_ELTPARAGRAPHE000129"></a>Pour intégrer un formulaire dans un état : 
...
### Image du formulaire
<a name="image_formulaire_ELTPARAGRAPHE000152"></a>L'image du formulaire apparaît en fond de l'état. L'image est affichée en fond de chacun des blocs de l'état.
...
<a name="etat_multipages_base_sur_fichier_pdf_ELTPARAGRAPHE000197"></a>Si vous avez choisi que l'état affiche toutes les pages d'un fichier PDF, si l'état est basé sur un fichier de données ou une requête, les différentes pages seront imprimées pour chaque enregistrement de la source de données utilisée.

**Attention** : Ce type d'état peut consommer beaucoup de ressources mémoire (notamment en aperçu avant impression).

![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Fonctionnalité non disponible.
<a name="NOTE4_3"></a>
