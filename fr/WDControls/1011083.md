...
### Création
<a name="creation_ELTPARAGRAPHE000032"></a>Pour créer un état de type Table hiérarchique depuis l'éditeur d'états : 
...
3. Si vous choisissez "D'un ou plusieurs fichiers de données", l'assistant permet de définir : 
	...
	- les fichiers qui serviront de source à l'état : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Etat_TabH_Assistant.gif&type=thumb)


	- les rubriques à imprimer, leurs libellés et leurs blocs : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Etat_TabH_Assistant_rub.gif&type=thumb)
