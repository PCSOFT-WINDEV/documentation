...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) La fonction [&lt;Liste image&gt;.ProcédureChargeImage](../WDLang1/1410090913.md) permet de définir une procédure WLangage qui sera appelée lors de l'affichage des lignes de la liste. Cette procédure permet d'utiliser des images dynamiques (et non obligatoirement stockées sur le disque).  
...
<a name="selectionner_element_dans_champ_liste_image_ELTTEXTE000213"></a>


### Sélectionner l'élément de la ligne &lt;Indice&gt;
<a name="selectionner_element_ligne_ELTPARAGRAPHE000236"></a>Pour sélectionner l'élément de la ligne &lt;Indice&gt;, utilisez : 
...
<a name="positionner_sur_dernier_element_champ_liste_image_ELTPARAGRAPHE000263"></a>Pour se positionner sur le dernier élément du champ Liste image, utilisez : 
...
<a name="recuperer_element_selectionne_dans_champ_liste_image_ELTTEXTE000304"></a>


### Récupérer l'indice de l'élément sélectionné
<a name="recuperer_indice_element_selectionne_ELTPARAGRAPHE000327"></a>Pour récupérer l'indice de l'élément sélectionné, utilisez : 
...
<a name="recuperer_valeur_element_selectionne_ELTPARAGRAPHE000373"></a>Pour récupérer la valeur de l'élément sélectionné, utilisez une des syntaxes suivants : 
...
<a name="proprietes_specifiques_gestion_des_champs_liste_image_ELTTEXTE000395"></a>
