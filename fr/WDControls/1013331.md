...
<a name="personnalisation_ligne_calculs_ELTPARAGRAPHE000094"></a>Il est possible de personnaliser (libellé, couleur, police, hauteur, etc.) : 
...
<a name="export_via_les_fonctions_wlangage_ELTPARAGRAPHE000145"></a>Diverses fonctions WLangage permettent d'exporter le contenu d'un champ Table dans un format spécifique (Word, Excel, XML, etc.). Lors de cet export, par défaut les lignes correspondant à un calcul sont également exportées.
