...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Les colonnes de type Conteneur sont disponibles également pour les champs Table hiérarchique.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Dans une colonne de type Conteneur, seuls les champs suivants peuvent être utilisés : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Dans une colonne de type Conteneur, les champs suivants ne sont pas supportés : 
