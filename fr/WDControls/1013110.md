...
![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Il est possible de déclarer une procédure dans l'événement "Enroulé,Déroulé d'un noeud".**Exemple** : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ARBRECODE.gif)
