...
1. Sous le volet "Création", dans le groupe "Structure", cliquez sur "Ruptures". La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=EtatRuptureAjout.gif)
...
1. Sous le volet "Création", dans le groupe "Structure", cliquez sur "Ruptures". La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=EtatRuptureAjout2.gif)
