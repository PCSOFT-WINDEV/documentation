...
Pour manipuler un champ Bandeau défilant par programmation, WEBDEV propose les [Fonctions de gestion du champ Bandeau défilant](../WDLang2/1000022617.md).
...
<a name="defilement_automatique_des_plans_dans_champ_bandeau_defilant_ELTPARAGRAPHE000031"></a>Pour utiliser le défilement automatique d'un champ Bandeau défilant, il est possible : 
...
- soit d'utiliser la fonction WLangage [BandeauLanceDéfilement](../WDLang2/1000022511.md). 
...
Pour arrêter le défilement automatique, utilisez la fonction [BandeauArrêteDéfilement](../WDLang2/1000022512.md). 
<a name="NOTE2_2"></a>


### Défilement via les boutons gauche, droit et des puces
<a name="defilement_via_les_boutons_gauche_droit_des_puces_ELTPARAGRAPHE000060"></a>Si vous utilisez les boutons gauche, droit et les puces proposés dans le champ Bandeau défilant, aucune programmation spécifique n'est nécessaire. La gestion du passage d'un plan à un autre est automatiquement gérée. 
...
<a name="personnalisation_passage_plan_autre_ELTPARAGRAPHE000074"></a>Si vous utilisez des champs spécifiques pour passer d'un plan à un autre (par exemple des boutons spécifiques, placés hors du champ), vous pouvez gérer le passage d'un plan à un autre : 
...
<a name="recuperer_plan_cours_ELTPARAGRAPHE000119"></a>Pour récupérer le numéro du plan en cours : 
...
[Fonctions Bandeau défilant](../WDChamp/1000022617.md)

[Fonctions Bandeau défilant (syntaxe préfixée)](../WDChamp/1000022632.md)

[Manipuler un champ Bandeau défilant par programmation (syntaxe préfixée)](../WDChamp/1410087041.md)
