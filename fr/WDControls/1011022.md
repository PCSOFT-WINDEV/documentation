...
Le nom de ces imprimantes peut être utilisé dans la fonction [iConfigure](../WDLang5/3046072.md). Pour utiliser une imprimante générique, remplacez le nom de l'imprimante par une chaîne vide ("").


## Voir aussi

[Caractéristiques d'une impression PCL](../WDChamp/1011017.md)
