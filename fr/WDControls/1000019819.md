...
Remarque : Si le code désactivé contient du code WLangage, ce code est automatiquement supprimé.![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Les événements optionnels associés au champ sont : 
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Les événements optionnels associés au champ sont : 
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) En WEBDEV, cet événement est un événement navigateur uniquement.
