...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Le menu contextuel s'adapte à l'appareil utilisé. 

	- sous iPhone, le menu contextuel s'affiche en bas de l'écran : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-iOS-Menu%20Contextuel-iPhone.jpg)


	- sous iPad, les menus contextuels peuvent être affichés n'importe où : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WM-iOS-Menu%20Contextuel-iPad.jpg)
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Indiquer le libellé du menu contextuel.

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Spécifier si le menu contextuel doit être déplacé dans l'action bar.
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Les menus contextuels ne peuvent avoir qu'un seul niveau de menu. Il n'est pas possible d'utiliser des sous-menus.

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Limites spécifiques : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Limites spécifiques : 
...
3. Le champ "Menu contextuel" permet de paramétrer le menu contextuel :
	...
	- le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) permet de créer un nouveau menu contextuel.
...
- Pour éditer le menu contextuel personnalisé sélectionné, cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) à droite du champ "Menu contextuel" et sélectionnez l'option "Editer ce menu contextuel".
...
- depuis l'onglet "UI" de la description d'une fenêtre ou d'un champ associé à ce menu contextuel :
	...
	- Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) à droite du champ "Menu contextuel" et sélectionnez l'option "Editer ce menu contextuel".
