...
[**Le logiciel Etats & Requêtes**](../Presentation/3088004.md) ne permet pas de créer ou de modifier des états sur variable.
...
<a name="creer_etat_sur_variable_ELTTEXTE000379"></a>
...
2. Dans l'assistant, choisissez la présentation de votre état (tableau, fiche, étiquette, etc.). Pour plus de détails, consultez [Les différents types d'états](../WDChamp/1011054.md).
...
<a name="imprimer_etat_sur_une_variable_ELTTEXTE000403"></a>


### Imprimer un état sur une variable
<a name="imprimer_etat_sur_une_variable_ELTPARAGRAPHE000127"></a>Pour imprimer un état sur une variable, il suffit de :
...
<a name="exemples_windev_windev_mobile_ELTPARAGRAPHE000179"></a>L'état "ETAT_gglEvenement" est un état basé sur la variable MesEvenements de type gglEvénement. Cet état permet d'imprimer la liste des événements d'un agenda Google.
...
### Exemple WEBDEV
<a name="exemple_webdev_ELTPARAGRAPHE000194"></a>L'état "ETAT_gglEvenement" est un état basé sur la variable MesEvenements de type gglEvénement. Cet état permet d'imprimer la liste des événements d'un agenda Google.
...
<a name="imprimer_etat_parametre_base_sur_une_variable_ELTPARAGRAPHE000215"></a>Pour imprimer un état paramétré, il est nécessaire de passer des paramètres. Pour plus de détails, consultez les [Etats paramétrés](../WDChamp/1011008.md).
...
3. Paramétrer la destination de l'impression de l'état :
	...
	- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) En WINDEV Mobile, grâce à la fonction [iConfigure](../WDLang5/3046072.md) ou [iParamètre](../WDLang5/3046008.md). Ces fonctions ouvrent une boîte de dialogue dans laquelle l'utilisateur sélectionne l'imprimante à utiliser par défaut.
			Pour plus de détails, consultez [Modes d'impression d'un état](../WDChamp/1011031.md).
...
<a name="exemple_windev_windev_mobile_ELTPARAGRAPHE000268"></a>Une fenêtre liste les agendas et leurs événements. L'état "ETAT_gglEvenement" s'imprime lors d'un clic sur le champ Bouton "Imprimer les événements de l'agenda". Cet état attend en paramètre l'agenda pour lequel les événements doivent être listés. 
...
### Exemple WEBDEV
<a name="exemple_webdev_ELTPARAGRAPHE000286"></a>L'état "ETAT_gglEvenement" s'affiche dans un fichier PDF lors d'un clic sur le lien "Imprimer les événements de l'agenda". Le fichier PDF est ensuite affiché sur le navigateur. Cet état attend en paramètre l'agenda pour lequel les événements doivent être listés. 
