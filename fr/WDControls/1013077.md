...
<a name="champ_zone_repetee_lie_fichier_donnees_initialise_automatiquement_ELTTEXTE000146"></a>
...
Le contenu du champ est défini lors de sa création et peut être modifié dans sa fenêtre de description (onglet "Contenu").<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ZR_Fichier%20-%20HC%20N%B0001.gif)
...
|   |   |
| --- | --- |
| <br><br>- **Fichier de données parcouru**<br><br><br> | Fichier de données ou requête contenant les données à afficher. |
...
<a name="champ_zone_repetee_lie_fichier_donnees_initialise_par_programmation_ELTTEXTE000170"></a>
