...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) L'enregistrement audio est toujours effectué.

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) L'enregistrement audio peut être paramétré grâce à l'option "Autoriser l'enregistrement audio".
...
| [CaméraArrête](../WDLang1/1410086596.md) | Arrête l'affichage ou l'enregistrement d'une séquence vidéo affichée dans un champ Caméra.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Fonction conservée pour les champs Caméra "Compatibles 26". |
...
| [CaméraEtat](../WDLang1/1000022455.md) | Renvoie l'état d'un champ Caméra.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Fonction conservée pour les champs Caméra "Compatibles 26". |
