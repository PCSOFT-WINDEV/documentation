...
<a name="les_differentes_options_ELTTEXTE000359"></a>
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) non défini : correspond à option "en ligne" par défaut. 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) L'orientation peut être définie par programmation grâce à la propriété [FlexDirection](../Proprietes/1410089741.md). 


### Orientation en ligne
<a name="orientation_ligne_ELTPARAGRAPHE000054"></a>Les caractéristiques pour une **orientation en ligne** sont les suivantes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Flexbox_Detail_ligne%20-%20HC%20N%B0005.gif&type=thumb)
...
Les options possibles sont les suivantes : 
	...
	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) non défini : Valeur par défaut. Correspond à "pas de retour à la ligne".
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) La gestion du retour à la ligne peut être définie par programmation grâce à la propriété [FlexWrap](../Proprietes/1410089742.md).

- **Alignement horizontal (justify-content)** : 
	Définit la position horizontale des champs. Les champs sont positionnés de la gauche vers la droite selon leur ordre d'affichage défini dans les paramètres de l'onglet "Général". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Flexbox_Detail_ligne%20-%20HC%20N%B0002.gif&type=thumb)
Les options possibles sont les suivantes : 

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) non défini : Valeur par défaut. Correspond à "au début". 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) La gestion de l'alignement horizontal peut être définie par programmation grâce à la propriété [FlexJustifyContent](../Proprietes/1410089743.md).

- **Alignement vertical global (align-content)** : 
	Définit la position verticale des champs. Les champs sont positionnés de la gauche vers la droite et du haut vers le bas selon leur ordre d'affichage défini dans les paramètres de l'onglet "Général".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Flexbox_Detail_ligne%20-%20HC%20N%B0003.gif&type=thumb)
Les options possibles sont les suivantes : 

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) non défini : Valeur par défaut. Correspond à "étendre". 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) La gestion de l'alignement vertical peut être définie par programmation grâce à la propriété [FlexAlignContent](../Proprietes/1410089744.md).
...
<a name="orientation_colonne_ELTPARAGRAPHE000152"></a>Les caractéristiques pour une **orientation en colonne** sont les suivantes :
...
- **Alignement vertical (justify-content)**
	Définit la position verticale des champs. Les champs sont positionnés du haut vers le bas selon leur ordre d'affichage défini dans les paramètres de l'onglet "Général".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Flexbox_Detail_colonne%20-%20HC%20N%B0003.gif&type=thumb)
Les options possibles sont les suivantes :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) La gestion de l'alignement vertical peut être définie par programmation grâce à la propriété [FlexJustifyContent](../Proprietes/1410089743.md).
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) La gestion de l'alignement horizontal peut être définie par programmation grâce à la propriété [FlexAlignContent](../Proprietes/1410089744.md).
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) La gestion de l'alignement horizontal dans chaque colonne peut être définie par programmation grâce à la propriété [FlexAlignItems](../Proprietes/1410089745.md).
...
<a name="autres_caracteristiques_ELTPARAGRAPHE000249"></a>Les autres caractéristiques sont les suivantes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Flexbox_Detail_colonne%20-%20HC%20N%B0001%201.gif)


- Espace entre les colonnes (column-gap) : Définit l'espace alloué entre chaque colonne lorsque plusieurs colonnes sont générées.![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) L'espace entre les colonnes peut être défini par programmation grâce à la propriété [FlexColumnGap](../Proprietes/1410089747.md).

- Espace entre les lignes (row-gap) : Définit l'espace alloué entre chaque ligne lorsque plusieurs lignes sont générées.![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) L'espace entre les lignes peut être défini par programmation grâce à la propriété [FlexRowGap](../Proprietes/1410089746.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) CSS complémentaire : Code CSS personnalisé indiquant l'ancrage souhaité. Ce code CSS surcharge les paramètres.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) En cas de débordement : Comportement à adopter en cas de débordement des champs de la flexbox. Il est possible de : 

	- afficher un ascenseur automatique. Dans ce cas, le scroll peut être effectué au doigt si nécessaire. 
			![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png) Dans les applications WINDEV pour Linux, les ascenseurs ne sont pas disponibles.
