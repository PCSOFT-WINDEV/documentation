...
### Option "Imprimer"
<a name="option_imprimer_ELTPARAGRAPHE000098"></a>L'option "Imprimer" permet d'imprimer le contenu du champ Planning. Une fenêtre spécifique s'affiche permettant de configurer l'impression du planning. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FAA_Imp_Planning.gif)
