...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) [lié à un fichier de données](../WDChamp/1000019543.md).

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) [lié à une variable](../WDChamp/1000019543.md).
...
<a name="ajouter_une_ressource_ELTPARAGRAPHE000200"></a>L'ajout d'une ressource dans un champ Planning est réalisé grâce à la fonction [&lt;Planning&gt;.AjouteRessource](../WDLang1/1000022905.md). Cette ressource peut correspondre à une personne, une salle, ...
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Remarque : La fonction [&lt;Planning&gt;.AjouteRessource](../WDLang1/1000022905.md) permet d'insérer une image dans le titre de la ressource.


### Ajouter un rendez-vous
<a name="ajouter_rendezvous_ELTPARAGRAPHE000236"></a>L'ajout d'un rendez-vous dans un champ Planning est réalisé grâce à la fonction [&lt;Planning&gt;.AjouteRendezVous](../WDLang1/1000022904.md). Cette fonction accepte deux syntaxes : 
...
<a name="remplir_champ_planning_avec_les_donnees_presentes_dans_fichier_donnees_hfsql_ELTPARAGRAPHE000281"></a>Les enregistrements sont stockés dans un fichier de données HFSQL. Le remplissage initial du champ Planning peut être réalisé par un parcours du fichier de données via la syntaxe POUR TOUT et par l'ajout de chaque rendez-vous via la fonction [&lt;Planning&gt;.AjouteRendezVous](../WDLang1/1000022904.md).
...
<a name="recuperer_une_liste_rendezvous_ELTPARAGRAPHE000302"></a>La fonction [&lt;Planning&gt;.ListeRendezVous](../WDLang1/1000022909.md) permet de récupérer : 
...
<a name="afficher_planning_partir_une_ressource_specifique_une_date_specifique_ELTPARAGRAPHE000350"></a>Pour afficher le planning à partir : 
...
<a name="supprimer_rendezvous_ELTPARAGRAPHE000391"></a>La fonction [&lt;Planning&gt;.SupprimeRendezVous](../WDLang1/1000022912.md) permet de supprimer : 
...
<a name="supprimer_une_ressource_ELTPARAGRAPHE000416"></a>La fonction [&lt;Planning&gt;.SupprimeRessource](../WDLang1/1000022913.md) permet de supprimer une ressource du champ Planning.
...
<a name="modifier_affichage_champ_ELTPARAGRAPHE000444"></a>L'affichage courant d'un champ Planning peut être modifié via les fonctions suivantes : 
...
<a name="utilisation_avancee_des_evenements_associes_champ_planning_ELTTEXTE000568"></a>


### Utilisation avancée des événements avec procédure
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000591"></a>Il est possible de proposer à l'utilisateur de définir plus précisément les caractéristiques de son rendez-vous lors d'un ajout ou d'une modification. Il suffit pour cela de créer une fenêtre ou une page avec les informations à remplir. 
...
<a name="gestion_des_jours_feries_ELTTEXTE000612"></a>
...
<a name="proprietes_specifiques_aux_champs_planning_ELTTEXTE000650"></a>
