...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) ***une valeur renvoyée spécifique***. Cette valeur renvoyée est spécifiée dans l'onglet "Contenu" de la fenêtre de description du champ.


![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) **Utiliser la numérotation ou les valeurs renvoyées ?**
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) la fonction [FichierVersEcran](../WDLang4/3044210.md). 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) la fonction [EcranVersFichier](../WDLang4/3044146.md).
