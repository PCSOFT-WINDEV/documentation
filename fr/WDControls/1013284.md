...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Un champ Zone répétée doit être manipulé exclusivement par ses attributs.
...
- soit manipulez directement chaque champ de la zone répétée : 
	...
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Un attribut lié au champ spécifié et permettant de modifier la propriété indiquée doit exister.
...
- soit manipulez directement chaque champ du champ Zone répétée :
	...
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Dans ce cas, un attribut lié au champ spécifié et permettant de modifier la propriété indiquée doit exister.
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) chaque attribut séparé par TAB.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) chaque attribut et/ou chaque champ séparé par TAB.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) chaque attribut et/ou chaque champ séparé par TAB.




![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) **Attention** : L'indice doit correspondre à une répétition visible dans la page en cours.
