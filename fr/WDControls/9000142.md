...
3. Selon vos besoins, vous pourrez ensuite :
	...
	- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) imprimer le fichier PDF généré via le système d'impression iOS (fonction [iImprimePDF](../WDLang5/1000020519.md)).
