...
2. Dans l'onglet "Détail" : 
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Dans la zone "Animations", cochez l'option "Activer les animations".

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Dans la zone "Interactivité", cochez l'option "Graphe interactif" si nécessaire puis l'option "Activer les animations".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Graphe_Animation_WB.gif)
**Remarque** : L'option "Graphe interactif" permet d'obtenir des graphes réagissant aux actions de l'internaute. Par exemple, dans un graphe de type Secteur, la part survolée est automatiquement excentrée, la part cliquée est positionnée en bas du graphe, la valeur sélectionnée dans la légende est rendue invisible, ...
			![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Seuls les graphes interactifs sont disponibles.
...
- Cette option est disponible pour les types de graphes suivants : 
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Aire, Bulle, Courbe, Donut, Histogramme, Secteur.

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Aire, Courbe, Histogramme, Histogramme empilé, Secteur, Donut, Hémicycle.
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) La fonction [grDessine](../WDLang3/3042026.md) n'est pas bloquante. Si le graphe est dessiné avec une animation, la fonction rendra la main dès le début de l'animation. Ainsi, si plusieurs graphes sont affichés dans la même fenêtre, il est possible d'animer ces champs simultanément.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Par défaut, les champs Graphe créés à partir de la version 19 sont animés. 
