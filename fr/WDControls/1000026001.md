...
<a name="les_options_champ_ELTPARAGRAPHE000050"></a>Le champ TimeLine peut être paramétré directement sous l'éditeur grâce à la fenêtre de description (onglet "Détail").
...
<a name="menu_contextuel_propose_automatiquement_ELTPARAGRAPHE000165"></a>Le champ TimeLine peut afficher un menu contextuel spécifique proposant des fonctionnalités automatiques à l'utilisateur. Ce menu est proposé par les FAA (Fonctionnalités Automatiques de vos Applications). 
...
Pour plus de détails sur les fonctionnalités de ce menu contextuel, consultez [Fonctionnalités automatiques du champ TimeLine](../WDChamp/1000026006.md). 
<a name="NOTE2_3"></a>


### Personnalisez la zone de l'événement
<a name="personnalisez_zone_evenement_ELTPARAGRAPHE000185"></a>Dans le champ TimeLine, l'événement est affiché dans une zone spécifique. Il est possible de traduire et de personnaliser cette zone : couleur du titre, couleur de fond de l'événement, ...
...
<a name="modes_remplissage_champ_timeline_ELTPARAGRAPHE000209"></a>Un champ TimeLine peut être rempli :

- par programmation à l'aide des différents événements et des fonctions WLangage. Pour plus de détails, consultez [Manipuler un champ TimeLine par programmation](../WDChamp/1000026004.md). 
...
[Menu contextuel des champs TimeLine](../WDChamp/1000026006.md)
