...
| **2.** | ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png) Exécution de l'événement "[Avant réimpression](../WDChamp/1011037.md)" de l'état (cas d'une impression directe ou d'un export depuis le visualisateur de rapports). |
