...
- Ces champs proposent la génération en mode HTML 5 (voir [Caractéristiques du champ](#NOTE1_3)).
...
## Remarques
<a name="remarques_ELTTEXTE000269"></a>
<a name="NOTE2_1"></a>


### Champ upload multifichier en AWP
<a name="champ_upload_multifichier_awp_ELTPARAGRAPHE000128"></a>Un champ Upload multifichier en AWP crée implicitement un contexte AWP sur disque. Ce type de champ est incompatible avec la gestion des contextes à l'aide de cookies. Pour plus de détails sur les contextes AWP, consultez [Gestion des contextes AWP](../WDChamp/3539060.md). 
<a name="NOTE2_2"></a>
...
[Upload de fichiers](../WDChamp/3012024.md)

[Fonctions Upload](../WDChamp/1000018815.md)

[Manipuler un champ Upload par programmation](../WDChamp/1016333.md)

[Propriétés associées au champ Upload](../WDChamp/1016332.md)

[Evénements associés au champ Upload](../WDChamp/1016331.md)
