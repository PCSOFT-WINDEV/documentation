...
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle4.gif) | Le fond du bandeau de sélection peut correspondre à une image. |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle5.gif) | Un ascenseur remplace automatiquement la réglette. |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle6.gif) | Les cellules du champ Table peuvent être en saisie. |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle7.gif) | Les lignes du champ Table sont en multisélection. |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle8.gif) | Les colonnes peuvent être ancrées.<br>Le champ Table peut avoir un ascenseur horizontal. |
...
- Liste de valeurs (combo)
	![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce type de données n'est pas disponible.
...
[AJAX : Présentation](../WDChamp/3055101.md)

[AJAX automatique et immédiat](../WDChamp/3055102.md)

[AJAX Programmé via les fonctions AJAX (par compatibilité)](../WDChamp/3055103.md)

[Fonctions de gestion AJAX](../WDChamp/3055116.md)
