...
3. Affichez l'onglet "Contenu" de la fenêtre de description du champ Table hiérarchique. Sélectionnez le mode de remplissage "Par variable". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TableH_Variable_Contenu.gif&type=thumb)
...
4. Définissez les différentes sources du champ Table hiérarchique. En effet, un champ Table hiérarchique sur variable est lié à différentes sources, permettant d'afficher des enregistrements imbriqués.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WB_Table_Hierachique_Var_as.gif)
