...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les plans sont utilisables sur les pages et les champs conteneurs. Pour plus de détails, consultez [Les plans en WEBDEV](../WDChamp/1013080.md)

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) L'éditeur de fenêtres propose une gestion des plans avancée permettant notamment de nommer les plans. Pour plus de détails, consultez [Edition des plans sous l'éditeur de fenêtres](#NOTE3_1_Nommage).
