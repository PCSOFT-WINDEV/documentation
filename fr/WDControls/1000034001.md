...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Circulaire native.
...
- Image personnalisée. Dans ce cas, il est possible de spécifier sous l'éditeur ou par programmation : 
	...
	- si l'animation doit effectuer un aller-retour. 
			![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Par programmation, cette option correspond à la propriété [AnimationAllerRetour](../Proprietes/1000021231.md). 
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) **Remarque** : Il est possible de modifier la couleur de la jauge native grâce à la propriété [CouleurJauge](../Proprietes/1000018156.md). 
