...
3. Dans la zone "Utiliser", sélectionnez "Image 5 états". Une fenêtre apparaît permettant de sélectionner l'image voulue pour le cadre du curseur. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Interrupteur_bascule_style%20-%20HC%20N%B0001.gif&type=thumb)
...
Il est par exemple possible d'utiliser l'option "Libellé des modes internes", pour modifier la couleur des libellés non actifs (le libellé #B pour la valeur "OFF" et le libellé #A pour la valeur "ON"). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Interrupteur_bascule_style%20-%20HC%20N%B0002.gif&type=thumb)


![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Sous WEBDEV, les options de paramétrage de libellés permettent de personnaliser encore davantage le champ.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Sous WEBDEV, la personnalisation du libellé est effectuée par la propriété [LibelléHTML](../Proprietes/1000020922.md).
