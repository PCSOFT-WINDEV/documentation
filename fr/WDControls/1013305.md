...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) les champs Table en mode Classique, Ajax et Navigateur.
...
2. Dans l'onglet "Contenu", cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_rupture_table.gif). La fenêtre de gestion des ruptures apparaît.
...
| [Hauteur](../Proprietes/2510050.md) | Permet de connaître et de modifier la hauteur d'un haut ou d'un bas de rupture.<br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Non disponible. |
