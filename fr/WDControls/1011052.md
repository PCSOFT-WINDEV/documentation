...
## Présentation
<a name="presentation_ELTTEXTE000615"></a>
...
Les fichiers de données et les rubriques des fichiers de données pouvant être utilisés dans les états créés avec [le logiciel Etats & Requêtes](../Presentation/3088004.md) sont définis par le développeur sous l'éditeur d'analyses de WINDEV. 
...
<a name="creer_etat_sur_fichier_donnees_ELTTEXTE000648"></a>
...
<a name="etat_borne_base_sur_fichier_donnees_ELTTEXTE000672"></a>
...
<a name="definir_etat_borne_ELTPARAGRAPHE000207"></a>Pour définir un état borné :
...
**Remarque** : Lors du test d'un état borné (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_Go_Fenetre_WD_bl.gif) parmi les boutons d'accès rapide), une fenêtre s'affiche permettant de saisir les bornes de l'état.
...
<a name="imprimer_etat_sur_fichier_donnees_ELTTEXTE000702"></a>
Pour imprimer un état sur un fichier de données, il suffit de :

1. Paramétrer la destination de l'impression de l'état :

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) En WINDEV, grâce à la fonction [iDestination](../WDLang5/3046074.md) (visualisateur de rapports, impression dans un fichier HTML, etc.).

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) En WEBDEV, grâce à la fonction [iDestination](../WDLang5/3046074.md) (impression dans un fichier HTML, etc.).

	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Sous Android et iOS, grâce à la fonction [iDestination](../WDLang5/3046074.md) (impression dans un fichier PDF). 
...
- soit en lançant une impression (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_Imprimer.gif)). 

- soit en testant l'état (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_Go_Fenetre_WD_bl.gif)). 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) **Exemples WINDEV et WINDEV Mobile**
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Code Android et iOS :
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) **Exemple WEBDEV**
L'état "ETAT_Client" est un état basé sur le fichier de données "Client". Cet état permet d'imprimer les caractéristiques des clients.
...
<a name="imprimer_etat_borne_base_sur_fichier_donnees_ELTPARAGRAPHE000325"></a>Pour imprimer un état borné basé sur un fichier de données, il suffit de :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) **Exemple WINDEV et WINDEV Mobile**
...
<a name="imprimer_etat_parametre_base_sur_fichier_donnees_ELTPARAGRAPHE000395"></a>Pour imprimer un état paramétré, il est nécessaire de passer des paramètres. Pour plus de détails, consultez les [Etats paramétrés](../WDChamp/1011008.md).
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) **Exemple Android et iOS**
...
<a name="imprimer_etat_parametre_borne_base_sur_fichier_donnees_ELTPARAGRAPHE000489"></a>Pour imprimer un état paramétré et borné basé sur un fichier de données, il suffit de :
