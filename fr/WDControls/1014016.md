...
- les ***masques d'affichage*** qui définissent les caractères pouvant être : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) affichés dans les champs d'une fenêtre.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) le masque d'affichage "Même masque que la saisie" est sélectionné.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) Pour améliorer le contrôle des dates saisies, les dates incorrectes sont automatiquement corrigées (lors de la saisie du mois ou de l'année) : 
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Date (HTML5)

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Date et Heure (HTML5)

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Durée relative (Hier, dans 3 jours, ...).
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Ce masque "Durée relative" n'est pas disponible.



![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) **Masques supplémentaires**
