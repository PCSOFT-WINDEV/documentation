...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) Si la multisélection est activée, l'utilisateur peut sélectionner plusieurs jetons via la touche Ctrl.




![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) **FAA (Fonctionnalités automatiques de vos applications)**
...
L'onglet "Général" de la fenêtre de description du champ propose les options suivantes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ_Jeton%20-%20HC%20N%B0001.gif)
...
L'onglet "Style" de la fenêtre de description du champ permet de définir : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ_Jeton%20-%20HC%20N%B0002.gif)
