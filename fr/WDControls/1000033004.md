...
<a name="initialiser_champ_tableur_ELTPARAGRAPHE000036"></a>Le champ Tableur peut être initialisé avec des valeurs, des formules, ... dès son affichage selon différentes méthodes : 
...
- En chargeant un fichier Excel (au format XLSX) à l'initialisation du champ (fonction [TableurCharge](../WDLang1/1000021340.md)). 
...
<a name="manipuler_champ_tableur_ELTPARAGRAPHE000055"></a>Pour manipuler un champ Tableur par programmation, il suffit de spécifier son nom. 
...
Plusieurs [fonctions WLangage](../WDLang1/1000021433.md) et [propriétés](../WDChamp/1000033003.md) permettent de manipuler le champ Tableur. 
...
- soit la fonction [TableurAjouteDonnée](../WDLang1/1000021365.md). 
...
<a name="astuce_fusionner_des_cellules_par_programmation_ELTPARAGRAPHE000131"></a>L'utilisateur final a la possibilité de fusionner les cellules sélectionnées grâce au ruban (ou à la barre d'outils) du champ Tableur. 
...
```
Remarque : La fonction [TableurRécupèreFusion](../WDLang1/1000021740.md) permet de savoir si une cellule est fusionnée avec d'autres cellules et de récupérer la plage de cellules fusionnées. 
<a name="NOTE2_5"></a>


### Gérer les noms des cellules dans un champ Tableur
<a name="gerer_les_noms_des_cellules_dans_champ_tableur_ELTPARAGRAPHE000159"></a>Le champ Tableur propose différentes fonctions permettant de manipuler les noms des cellules : 
...
- Il est possible de charger les différentes feuilles de calcul d'un fichier XLSX (fonction [TableurCharge](../WDLang1/1000021340.md)). 
...
[Fonctions Tableur](../WDChamp/1000021433.md)

[Propriétés associées au champ Tableur](../WDChamp/1000033003.md)

[Manipuler un champ Tableur par programmation (dans un état)](../WDChamp/1000033010.md)

[Manipuler un champ Tableur par programmation (dans une fenêtre) (syntaxe préfixée)](../WDChamp/1000033012.md)

[Commentaire (Propriété)](../WDChamp/1410090471.md)
