...
- [Associer un champ à une rubrique d'un fichier de données](#NOTE3)

- [Sélectionner un ou plusieurs champs](#NOTE4)
...
- [Déplacer les champs](#NOTE5_5)

- [Verrouiller les champs](#NOTE5_6)

- [Aligner les champs](#NOTE5_7)

- [Utiliser un champ hors état](#NOTE6)


**Remarque** : Les manipulations des champs appartenant à un tableau sont différentes. Pour plus de détails, consultez [Manipuler les cellules d'un tableau d'un état](../WDChamp/1013049.md).
...
<a name="creer_champ_simple_ELTPARAGRAPHE000048"></a>Pour créer un champ dans un état :

1. Sous le volet "Création", cliquez sur le type de champ à créer : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Etat_Ruban_Creation.gif&type=thumb)
...
<a name="creer_champ_partir_champ_dictionnaire_ELTPARAGRAPHE000063"></a>Un champ d'un état peut être créé à partir d'un champ présent dans un dictionnaire. Un dictionnaire permet de conserver des éléments (champs, états, ...) en prévision d'une prochaine ré-utilisation dans de nouveaux projets. Pour plus de détails, consultez le [Dictionnaire](../Editeurs/2023002.md).
...
<a name="creer_champ_avec_contenu_pressepapiers_ELTPARAGRAPHE000087"></a>L'éditeur d'états permet de créer certains types de champs en fonction du contenu du presse-papiers :
...
<a name="creer_champ_image_partir_fichier_image_par_drag_and_drop_ELTPARAGRAPHE000133"></a>L'éditeur d'états permet de créer un champ Image par un simple glisser/déplacer (Drag and Drop) d'un fichier image présent dans l'explorateur Windows vers un état WINDEV.
...
<a name="associer_champ_une_rubrique_fichier_donnees_une_variable_ELTTEXTE000533"></a>
...
<a name="selectionner_supprimer_les_champs_etat_ELTTEXTE000557"></a>


### Sélectionner un ou plusieurs champs dans un état
<a name="selectionner_plusieurs_champs_dans_etat_ELTPARAGRAPHE000176"></a>L'éditeur d'états permet de sélectionner un ou plusieurs champs d'un état à l'aide du clavier ou de la souris. Pour plus de détails, consultez [Sélectionner un ou plusieurs champs](../Editeurs/2026007.md).
<a name="NOTE4_2"></a>


### Supprimer un ou plusieurs champs d'un état
<a name="supprimer_plusieurs_champs_etat_ELTPARAGRAPHE000186"></a>Pour supprimer un ou plusieurs champs d'un état : 
...
<a name="copier_les_champs_etat_ELTTEXTE000587"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000198"></a>Un ou plusieurs champs peuvent être copiés dans un même état ou d'un état vers un autre.
La description et le code du champ copié seront identiques à ceux du champ d'origine.
<a name="NOTE5_2"></a>


### Copier un champ dans un même état
<a name="copier_champ_dans_meme_etat_ELTPARAGRAPHE000206"></a>Pour copier un champ dans un même état : 
...
<a name="copier_champ_etat_dans_autre_etat_ELTPARAGRAPHE000246"></a>Pour copier un champ d'un état dans un autre état : 
...
<a name="copier_style_champ_ELTPARAGRAPHE000294"></a>La copie du style d'un champ consiste à recopier les caractéristiques du style d'un champ sur un autre champ. Seul le style du champ est copié (et non le contenu du champ). 

Pour plus de détails, consultez [Copie du style d'un champ](../Editeurs/2021001.md).
<a name="NOTE5_5"></a>


### Déplacer un ou plusieurs champs d'un état
<a name="deplacer_plusieurs_champs_etat_ELTPARAGRAPHE000306"></a>Pour déplacer un ou plusieurs champs d'un état : 
...
<a name="aligner_les_champs_etat_ELTPARAGRAPHE000336"></a>L'éditeur d'états met à votre disposition plusieurs moyens pour aligner les champs présents dans un état :

- les [options d'alignement](../Editeurs/2022004.md).

- le [correcteur d'interface en temps réel (positionnement automatique)](../Editeurs/2022003.md).

- le [zoom](../Editeurs/2021007.md).

- les [règles et les repères](../Editeurs/2022001.md).

- la [grille magnétique](../Editeurs/2022002.md).
...
<a name="utiliser_champ_hors_etat_ELTTEXTE000647"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000366"></a>Généralement, les champs appartiennent à un état. Ces champs apparaissent donc dans l'état en édition et en exécution.

Il est également possible de positionner un champ dans la fenêtre d'accueil d'un état : le champ est alors "hors état". Ce champ sera visible uniquement en édition. Ce champ ne sera pas imprimé. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=EtatFenAccueil.gif)
...
<a name="creer_champ_hors_etat_ELTPARAGRAPHE000377"></a>Pour créer un champ "hors état" : 
