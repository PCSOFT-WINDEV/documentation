...
- un ensemble de fonctions qui permettent de réaliser toutes les opérations courantes (programmation directe, à l'aide des fonctions WLangage de type DocXXX. Ces fonctions Pour plus de détails, consultez [Fonctions de gestion du champ Traitement de texte](../WDLang1/1000022618.md). 
...
<a name="manipuler_champ_traitement_texte_par_programmation_ELTTEXTE000369"></a>
...
- Le contenu du champ Traitement de texte peut également être : 
	...
	- enregistré au format PDF (fonction [DocVersPDF](../WDLang1/1000022531.md)).




- La fonction [DocVersTexte](../WDLang1/1000022389.md) permet de récupérer le texte du document. 
...
<a name="effectuer_une_recherche_dans_document_une_modification_sur_resultat_recherche_ELTPARAGRAPHE000111"></a>Pour effectuer une recherche dans un document Traitement de texte, il suffit d'utiliser la fonction [DocRecherche](../WDLang1/1000022388.md). 
...
<a name="manipuler_selection_ELTPARAGRAPHE000130"></a>Pour manipuler la sélection actuellement réalisée dans un champ Traitement de texte, il est possible de récupérer cette sélection dans une variable de type [docFragment](../WDLang1/1000022482.md). 
...
<a name="ajouter_texte_dans_document_ELTPARAGRAPHE000151"></a>**Pour ajouter du texte dans un document existant**, il existe plusieurs méthodes : 
...
- Insérer directement un texte à partir d'une position donnée avec la fonction [DocInsère](../WDLang1/1000022732.md). 
...
- Ajouter un texte à la fin du document avec la fonction [DocAjoute](../WDLang1/1000022919.md). 
...
- insérer directement un texte à partir de la position 1 avec la fonction [DocInsère](../WDLang1/1000022732.md). 
...
<a name="ajouter_saut_page_dans_document_ELTPARAGRAPHE000204"></a>Pour ajouter par programmation un saut de page dans un document, il suffit d'utiliser le code suivant : 
...
### Gestion des signets
<a name="gestion_des_signets_ELTPARAGRAPHE000239"></a>Il est possible de gérer les signets dans un document de type Traitement de texte. Quelques exemples : 
...
<a name="enchainer_des_etats_des_documents_type_traitement_texte_ELTPARAGRAPHE000266"></a>De la même manière qu'il est possible d'enchaîner des états, il est également possible d'enchaîner des états et des documents de type Traitement de texte. 
...
<a name="proprietes_associees_champ_traitement_texte_ELTPARAGRAPHE000284"></a>Les propriétés suivantes sont spécifiques au champ Traitement de texte. Elles permettent essentiellement de manipuler les caractéristiques du champ : 
...
[Manipuler un champ Traitement de texte par programmation (syntaxe préfixée)](../WDChamp/1410087198.md)
