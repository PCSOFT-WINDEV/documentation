...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) [lié à un fichier de données](../WDChamp/1016325.md). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) [lié à une variable](../WDChamp/1016325.md). 
...
<a name="ajouter_rendezvous_ELTPARAGRAPHE000186"></a>L'ajout d'un rendez-vous dans un champ Agenda est réalisé grâce à la fonction [&lt;Agenda&gt;.AjouteRendezVous](../WDLang1/1000022894.md). Cette fonction accepte deux syntaxes : 
...
<a name="remplir_champ_agenda_avec_les_donnees_presentes_dans_fichier_donnees_hfsql_ELTPARAGRAPHE000226"></a>Les enregistrements sont stockés dans un fichier de données HFSQL. Le remplissage initial du champ Agenda peut être réalisé par un parcours du fichier de données via la syntaxe POUR TOUT et par l'ajout de chaque rendez-vous via la fonction [&lt;Agenda&gt;.AjouteRendezVous](../WDLang1/1000022894.md).
...
<a name="recuperer_une_liste_rendezvous_ELTPARAGRAPHE000254"></a>La fonction [&lt;Agenda&gt;.ListeRendezVous](../WDLang1/1000022886.md) permet de récupérer : 
...
<a name="afficher_champ_agenda_partir_une_date_specifique_ELTPARAGRAPHE000294"></a>Pour afficher le champ Agenda à partir d'une date spécifique, utilisez la fonction [&lt;Agenda&gt;.Position](../WDLang1/1000022897.md).
...
<a name="supprimer_rendezvous_ELTPARAGRAPHE000317"></a>La fonction [&lt;Agenda&gt;.SupprimeRendezVous](../WDLang1/1000022877.md) permet de supprimer : 
...
<a name="modifier_affichage_champ_ELTPARAGRAPHE000349"></a>L'affichage courant d'un champ Agenda peut être modifié via les fonctions suivantes : 
...
<a name="possibilites_menu_contextuel_ELTPARAGRAPHE000400"></a>Via le menu contextuel du champ Agenda, il est possible de : 
...
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000428"></a>Il est également possible de proposer à l'utilisateur de définir plus précisément les caractéristiques de son rendez-vous lors d'un ajout ou d'une modification. Il suffit pour cela de créer une fenêtre avec les informations à remplir. 
...
<a name="gestion_des_jours_feries_ELTTEXTE000444"></a>
...
<a name="proprietes_specifiques_aux_champs_agenda_ELTTEXTE000482"></a>
