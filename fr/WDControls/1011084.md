...
13. L'état en cours de création s'affiche sous l'éditeur d'états.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Etat_gantt%20-%20HC%20N%B0001.gif&type=thumb)
...
- **L'état personnalisé pour afficher les tâches**. 
	...
	- Si l'option "Etat prédéfini" est sélectionnée, un état prédéfini est automatiquement ajouté au projet. Par défaut, cet état a pour nom "ETAT_WinDevVueTacheGantt" et est automatiquement utilisé pour l'affichage des tâches.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Etat_WinDevvueGantt.gif)
