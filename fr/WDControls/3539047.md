...
```
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) **Code navigateur** : Pour afficher une page AWP paramétrée depuis une page WEBDEV par programmation, utilisez la fonction [FichierAffiche](../WDLang2/3012005.md). Dans ce cas, plusieurs cas sont possibles. 
