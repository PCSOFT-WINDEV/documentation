...
<a name="manipulation_des_hauts_des_bas_ruptures_ELTTEXTE000139"></a>


### Fonctions associées aux hauts/bas de ruptures
<a name="fonctions_associees_aux_hautsbas_ruptures_ELTPARAGRAPHE000027"></a>Les fonctions associées aux hauts/bas de ruptures sont les suivantes :
...
<a name="proprietes_associees_aux_hautsbas_ruptures_ELTPARAGRAPHE000043"></a>Les propriétés associées aux hauts/bas de ruptures sont les suivantes :
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Dans une page (code serveur) : 
...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Dans une page (code navigateur) : 
...
- ![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Dans une page (PHP) : 
