...
2. Dans l'onglet "Général", dans la zone "Type de page" : 
	...
	- Indiquez si nécessaire le nom de la page à utiliser dans l'URI. Ce nom peut être différent du nom de la page sous l'éditeur. 
			Remarque : Si le site est multilingue, ce nom peut être saisi dans les différentes langues du projet. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Page_session_reference%20-%20HC%20N%B0002.gif&type=thumb)





3. Dans l'onglet "Détail", spécifiez les expressions et mots-clés permettant d'optimiser le référencement de la page (bouton "Editer les expressions et les mots-clés"). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Page_session_reference%20-%20HC%20N%B0003.gif&type=thumb)
...
- Une page référençable peut être ouverte : 
	...
	- soit par un champ Lien ou un champ Bouton (solution conseillée). Dans la fenêtre de description du champ utilisé : 
		...
		- sélectionnez le nom de la page à ouvrir. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Page_session_reference%20-%20HC%20N%B0004.gif)


		- cliquez sur "Paramètres" pour spécifier les paramètres à passer à la page. Chaque paramètre peut correspondre à une valeur fixe, un champ ou une variable. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Page_session_reference%20-%20HC%20N%B0005.gif)
