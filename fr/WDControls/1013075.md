...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Dans une fenêtre, il est possible de :  
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Dans une page, l'utilisation d'une image dans le champ peut être liée au style CSS. Il est également possible d'utiliser plusieurs types d'images pour le champ. 
...
- ![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Seule l'image du cadre du bouton peut être paramétrée.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Dans une page, il est possible de définir les images associées à un bouton dans le style du bouton : 
...
2. Sélectionnez l'élément "Bouton (Images)". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Btn_Type_Image.gif&type=thumb)
...
- Des images indépendantes. Dans ce cas, seules l'image de l'état normal et l'image de l'état survolé sont gérées. 
	...
	- **Survol** : cette image sera affichée lorsque l'internaute survolera le bouton avec le curseur de la souris. Si cette image n'est pas spécifiée, aucun effet de survol ne sera observé.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Btn_Fixe_Survol.gif)
