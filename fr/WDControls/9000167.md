...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) sur tous les champs d'une fenêtre. Pour plus de détails, consultez [L'effet parallaxe dans l'éditeur de fenêtres](#NOTE2_1).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) sur les champs conteneur d'une page : Cellule, Zone de mise en page, Zone de texte Riche, champ Modèle de champs. Pour plus de détails, consultez [L'effet parallaxe dans l'éditeur de pages](#NOTE3_1).
...
3. **Pour ajouter un effet parallaxe de champ** : 
	...
	- Dans la fenêtre qui s'affiche, choisissez l'option voulue : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Effet_parallaxe_WB%20-%20HC%20N%B0001.gif)
...
4. **Pour ajouter un effet parallaxe d'image de fond** : 
	...
	- L'effet est ajouté au style. Cliquez sur le bouton "Détail" pour configurer l'effet. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Effet_parallaxe_WB%20-%20HC%20N%B0002.gif)
