...
La fenêtre de description des conditions et des actions est la suivante : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=eyemagnet_fen_edition.gif)
...
3. Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=BtnRupture.gif) pour ouvrir la fenêtre d'édition.
...
3. Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=eyemagnet_btn_supprimer.gif) de l'eYe magnet à supprimer.
