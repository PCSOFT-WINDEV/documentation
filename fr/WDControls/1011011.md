...
9. Sélectionnez le fichier texte contenant les enregistrements.
	...
	- Les libellés des rubriques ne doivent pas être spécifiés dans ce fichier texte. Par exemple :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=EtatFichierTexte3.gif)
...
1. Affichez la fenêtre de description de l'état en utilisant une des méthodes suivantes : 
	...
	- sous le volet "Modification", cliquez sur l'icône de regroupement ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_regroup.gif) du groupe "Etat". 
...
<a name="NOTE5_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) 
...
### Exemple WEBDEV
<a name="exemple_webdev_ELTPARAGRAPHE000467"></a>L'état "ETAT_Client" est un état basé sur un fichier texte "Client.txt". Ce fichier texte contient les caractéristiques des clients. Ce fichier est accessible depuis le serveur.
