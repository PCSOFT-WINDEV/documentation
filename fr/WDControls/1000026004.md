...
<a name="manipuler_champ_timeline_par_programmation_ELTTEXTE000311"></a>


### Ajouter une piste
<a name="ajouter_une_piste_ELTPARAGRAPHE000034"></a>L'ajout d'une piste dans un champ TimeLine est réalisé grâce à la fonction [TimelineAjoutePiste](../WDLang1/1000020405.md). 
...
<a name="ajouter_evenement_ELTPARAGRAPHE000057"></a>L'ajout d'un événement dans un champ TimeLine est réalisé grâce à la fonction [TimelineAjouteEvénement](../WDLang1/1000020400.md). Cette fonction accepte deux syntaxes : 
...
<a name="recuperer_une_liste_evenements_ELTPARAGRAPHE000107"></a>La fonction [TimelineListeEvénement](../WDLang1/1000020401.md) permet de récupérer : 
...
<a name="supprimer_evenement_ELTPARAGRAPHE000142"></a>La fonction [TimelineSupprimeEvénement](../WDLang1/1000020403.md) permet de supprimer : 
...
### Supprimer une piste
<a name="supprimer_une_piste_ELTPARAGRAPHE000162"></a>La fonction [TimelineSupprimePiste](../WDLang1/1000020760.md) permet de supprimer une piste du champ TimeLine.
...
<a name="modifier_echelle_temporelle_champ_ELTPARAGRAPHE000182"></a>L'affichage courant d'un champ TimeLine peut être modifié via la fonction [TimelineChangeMode](../WDLang1/1000020397.md). Cette fonction permet de modifier le mode d'affichage du champ : seconde, milliseconde ou microseconde.  



## Utilisation du menu contextuel (FAA)
<a name="utilisation_menu_contextuel_faa_ELTTEXTE000378"></a>
...
<a name="utilisation_avancee_des_evenements_associes_champ_timeline_ELTTEXTE000402"></a>


### Utilisation avancée des événements avec procédure
<a name="utilisation_avancee_des_evenements_avec_procedure_ELTPARAGRAPHE000215"></a>Il est possible de proposer à l'utilisateur de définir plus précisément les caractéristiques de son événement lors d'un ajout ou d'une modification. Il suffit pour cela de créer une fenêtre avec les informations à remplir. 
...
<a name="proprietes_specifiques_aux_champs_timeline_ELTTEXTE000426"></a>
...
[Manipuler un champ TimeLine par programmation (syntaxe préfixée)](../WDChamp/1000026007.md)
