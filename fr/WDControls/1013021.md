...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Liste2.gif) | <br><pre><code>// Le premier est complété pour réserver la taille<br>ListeAjoute(LISTE_LISTE2, Complète("MALTESE", 8) + TAB + "Corto")<br>ListeAjoute(LISTE_LISTE2, "PICSOU" + TAB + "Jean")<br>ListeAjoute(LISTE_LISTE2, "ANA" + TAB + "Yoko")</code></pre><br> |
...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Liste3.gif) | <br><pre><code>// Le premier est complété pour réserver la taille<br>ListeAjoute(LISTE_LISTE3, EOT + Complète("MALTESE", 8) + ...<br>	TAB + EOT + "Corto")<br>ListeAjoute(LISTE_LISTE3, EOT + "PICSOU" + TAB + EOT + "Jean")<br>ListeAjoute(LISTE_LISTE3, EOT + "ANA" + TAB + EOT + "Yoko")</code></pre><br> |
...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Liste01.gif) | <br><pre><code>ListeAjoute(LISTE_LISTE1, Complète("MALTESE", 8) + "Corto")<br>ListeAjoute(LISTE_LISTE1, Complète("PICSOU", 8) + "Jean")<br>ListeAjoute(LISTE_LISTE1, Complète("ANA", 8) + "Yoko")</code></pre><br> |
...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Liste4.gif) | <br><pre><code>ListeAjoute(LISTE_LISTE4, Complète("FRANCE", 7) + TAB + EOT + ...<br>	"  30" + TAB + ",00")<br>ListeAjoute(LISTE_LISTE4, "CANADA" + TAB + EOT + "10" + TAB + ",00")<br>ListeAjoute(LISTE_LISTE4, "SUISSE" + TAB + EOT + "246")</code></pre><br> |
