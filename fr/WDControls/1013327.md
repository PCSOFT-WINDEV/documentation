...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette version permet uniquement de récupérer l'élément sélectionné dans un champ Arbre.
...
### Fonctions WLangage 
<a name="fonctions_wlangage_ELTPARAGRAPHE000184"></a>Dans les fonctions WLangage de gestion des champs Arbre, l'élément du champ Arbre se manipule grâce à son chemin complet (depuis la racine du champ Arbre). Ce chemin est au format suivant :
...
<a name="NOTE2_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png) 

### Manipulation directe
<a name="manipulation_directe_ELTPARAGRAPHE000198"></a>Pour manipuler directement un élément du champ Arbre (par exemple avec les propriétés WLangage), deux notations sont disponibles :
...
<a name="initialiser_element_ELTPARAGRAPHE000265"></a>Pour initialiser un élément d'un champ Arbre, utilisez la fonction [&lt;Arbre&gt;.Ajoute](../WDLang1/1000023422.md).
...
<a name="associer_une_bulle_aide_element_ELTPARAGRAPHE000291"></a>Pour associer une bulle d'aide à un élément d'un champ Arbre, il est possible d'utiliser :

- soit les fonctions du WLangage permettant d'ajouter ou de modifier un élément d'un champ Arbre ([&lt;Arbre&gt;.Ajoute](../WDLang1/1000023422.md), [&lt;Arbre&gt;.Insère](../WDLang1/1000023761.md), [&lt;Arbre&gt;.Modifie](../WDLang1/1000023763.md)),
...
<a name="selectionner_element_ligne_ELTPARAGRAPHE000349"></a>Pour sélectionner l'élément de la ligne &lt;Indice&gt;, utilisez : 
...
<a name="NOTE4_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png) 

### Se positionner sur le dernier élément du champ Arbre
<a name="positionner_sur_dernier_element_champ_arbre_ELTPARAGRAPHE000380"></a>Pour se positionner sur le dernier élément du champ Arbre, utilisez la propriété [Occurrence](../Proprietes/2510097.md) : 
...
- l'indice de l'élément sélectionné, utilisez la lecture directe de l'élément : 
	...
	Indice = <Champ Arbre>
	```
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette fonctionnalité n'est pas disponible en WEBDEV.

- le chemin complet de l'élément sélectionné, utilisez la fonction [&lt;Arbre&gt;.Select](../WDLang1/1000023767.md) : 
	
	```txt
	<Chemin> = <Champ Arbre>.Select()
	```
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La fonction [&lt;Arbre&gt;.Select](../WDLang1/1000023767.md) est disponible en code Navigateur.

- l'identifiant de l'élément sélectionné, utilisez la fonction [&lt;Arbre&gt;.RécupèreIdentifiant](../WDLang1/1000023766.md). 
	![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La fonction [&lt;Arbre&gt;.RécupèreIdentifiant](../WDLang1/1000023766.md) n'est pas disponible en code Navigateur.
...
<a name="utilisation_des_proprietes_sur_element_champ_arbre_ELTPARAGRAPHE000483"></a>De nombreuses propriétés WLangage peuvent être utilisées sur les éléments d'un champ Arbre.
...
### Exemples
<a name="exemples_ELTPARAGRAPHE000500"></a>Exemple : Comment modifier la couleur d'un élément d'un champ Arbre :
