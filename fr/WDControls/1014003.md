...
- ***personnalisé***. Il suffit de saisir le masque à appliquer. Par exemple, "CCC9 LL 9A" pour un champ de type texte ou "Le JJJ JJ MMMM AAAA" pour un champ de type date. Une expression régulière peut également être donnée avec la propriété [MasqueSaisie](../Proprietes/2510033.md). 
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Attention : en WEBDEV, les masques personnalisés sont gérés uniquement en affichage.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) La propriété [MasqueSaisie](../Proprietes/2510033.md) est utilisable uniquement dans les états.
