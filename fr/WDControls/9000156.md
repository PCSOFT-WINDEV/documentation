...
4. ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Spécifiez si nécessaire la couleur de la jauge utilisée par défaut. Cette couleur est prise en compte lors de l'utilisation de l'affichage par défaut (option "Aucune").
