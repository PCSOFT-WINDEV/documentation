...
| ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Changement d'orientation | Exécuté lorsque l'utilisateur pivote l'écran. Il est par exemple possible de repositionner les champs lors du changement d'orientation de l'écran. |
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Cet événement est automatiquement activé lors de l'utilisation d'une fenêtre en mode "Feuillet". Dans ce mode, un "swipe" vers le bas : 
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Cet événement n'est pas disponible.
<a name="NOTE2_2c"></a>
...
<a name="NOTE2_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) 
