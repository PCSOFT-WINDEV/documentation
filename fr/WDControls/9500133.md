...
Remarque : Lors du passage en version 2026, le menu d'export vers XLSX, DOCX, XML et PDF est automatiquement ajouté sur tous les champs Table présents dans les pages du projet WEBDEV. Cette fonctionnalité peut ensuite être désactivée dans l'onglet "UI" du champ ou pour l'ensemble des champs dans la description du projet (onglet "Avancé").  
...
<a name="etat_initial_champ_table_ELTTEXTE000361"></a>
L'état initial du champ Table peut être :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ_Table_Ini_WB.gif)
...
<a name="detail_des_options_affichage_ELTTEXTE000385"></a>


### Mode de sélection d'une ligne
<a name="mode_selection_une_ligne_ELTPARAGRAPHE000111"></a>Les modes de sélection d'une ligne déterminent comment une ligne du champ Table pourra être sélectionnée, aussi bien par l'utilisateur que par programmation. Ce mode de sélection est défini lors de la création du champ. Il peut être modifié à tout moment dans l'onglet "UI" de la fenêtre de description du champ Table.

Les modes de sélection disponibles sont les suivants : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Champ_Table_ModeSel_WB.gif)
...
<a name="mode_selection_une_cellule_table_par_programmation_ELTPARAGRAPHE000140"></a>Les modes de sélection d'une cellule déterminent comment une cellule du champ Table pourra être sélectionnée. Ce mode de sélection est défini lors de la création du champ. Il peut être modifié à tout moment dans l'onglet "UI" de la fenêtre de description du champ Table.

Les modes de sélection disponibles sont les suivants : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Caracteristiques_des_tables_WB%20-%20HC%20N%B0005.gif)
...
### Options d'affichage
<a name="options_affichage_ELTPARAGRAPHE000169"></a>Les options d'affichage (onglet "Général") permettent de définir :
...
- Si l'option "Avec titres de colonnes" est sélectionné, le bouton **"Editer les sur-entêtes de colonnes"** permet de définir des titres supplémentaires affichés au-dessus du titre d'une ou plusieurs colonnes. Pour définir un sur-entête de colonnes :
	...
	3. Dans la fenêtre qui s'ouvre, les différentes colonnes de la table sont affichées.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TableAjouteSurEntete_Edit.gif&type=thumb)
...
- **Afficher un bouton 'burger' avec le menu contextuel d'export** : un menu contextuel associé au champ (icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Table_menuctx.gif)) est affiché. Ce menu contextuel permettra à l'internaute d'exporter le contenu du champ Table vers un fichier Excel, Word, XML (avec feuille de styles) ou d'imprimer en PDF. Ce fichier sera téléchargé sur le poste de l'internaute.
...
**Exemple** : Champ Table Serveur avec titre des colonnes, gestion d'un bandeau de sélection, un menu contextuel d'export et un bandeau de sélection : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Table_avec-options.gif)
...
<a name="ascenseurs_dans_champ_table_ELTTEXTE000421"></a>
