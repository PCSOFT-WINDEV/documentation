...
L'onglet "Général" permet de définir les différents éléments de l'Action Bar selon la plateforme utilisée. Sur iOS et Android, les éléments sont les mêmes, mais ils ne sont pas disposés de la même façon. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Actionbar19_General.gif)
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) sous Android : Par défaut, l'Action Bar affiche le titre de la fenêtre courante et un bouton. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=actionbar_titre.gif)


- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) sous iOS : Par défaut, l'Action Bar affiche le titre de la fenêtre courante et un bouton. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Actionbar19_IOS.gif)
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Libellé du bouton.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Remarque : Il est possible de modifier ces paramètres par programmation grâce aux propriétés suivantes : 
...
La fenêtre de description de l'Action Bar permet de paramétrer l'action du clic sur le bouton gauche. Il est possible de sélectionner une des options suivantes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ActionBar_clic19.gif)
...
- **Retour : Exécuter le code de retour (ie: fermer la fenêtre)** : Dans ce cas : 
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) L'application exécutera l'événement "Clic sur le bouton de gauche". 
	...
	- Une flèche sera affichée dans le coin supérieur de l'icône pour symboliser la navigation. 
		...
		- Si la fenêtre affichée est la seule fenêtre de l'application, aucune action par défaut ne sera exécutée. 
						![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Seul l'événement "Clic sur le bouton de gauche" sera exécuté.

		- Si la fenêtre courante est fermée, son code de fermeture sera exécuté.

		- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Pour ce type d'action, l'icône spécifiée pour le bouton n'est pas affichée.  

		- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Le bouton "Retour" peut devenir "OK" en exécution dans les cas suivants : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) **Home : Revenir à la première fenêtre de l'application** : Dans ce cas, l'application : 
...
En édition, un bouton avec trois traits est affiché. Ce bouton correspond au menu de l'Action Bar. Il permet d'afficher les différentes options du menu. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=actionbar_menu.gif)
...
Exemple : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ActionBar_outilsIOS.gif)
...
La navigation entre les différentes vues est réalisée grâce à une barre de thèmes présente en bas de la fenêtre : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ActionBar_Volet.gif)


![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Remarque : Si des options de barres d'outils sont positionnées en bas de l'écran, il est déconseillé d'utiliser une navigation par vue.  
...
3. Cliquez sur le bouton "Nouvelle vue". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=actionbar_Editeur_vue19.gif)
...
- **Le paramétrage de la barre système** : 
	...
	- la couleur du texte. 
			![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Remarque : Il est possible de choisir les caractéristiques système pour la barre système : "Texte foncé, fond transparent" ou "Texte clair, fond transparent". 
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ActionBar_Disparition1.gif)![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ActionBar_Disparition2.gif)<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ActionBar_Disparition3.gif)
...
2. Si l'option "Avec historique de recherche" est cochée, l'historique des dernières recherches effectuées sera proposé à l'utilisateur. 
	![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Remarque : L'option "Avec bouton pour vider l'historique" permet de gérer automatiquement la mise à blanc de l'historique. 
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Si l'option "Avec bouton pour vider l'historique" est sélectionnée, l'historique propose un choix pour effacer l'historique à la fin de la liste des propositions.
