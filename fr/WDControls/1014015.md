...
![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Les formats '-', '%','()' et le format personnalisé avancé ne sont pas gérés.![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Les masques de saisie personnalisés sont gérés uniquement en affichage : ils ne sont pas disponibles lors de la saisie dans le champ par l'internaute.![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) **Masque de saisie hexadécimal**
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Le masque de saisie "Monétaire système" correspond au masque monétaire défini dans les préférences du poste serveur.
