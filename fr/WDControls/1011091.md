...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) à partir d'un état créé sous l'éditeur d'états. 

- à partir d'une impression réalisée à l'aide des fonctions WLangage. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png) directement par l'utilisateur final via le visualisateur de rapports.




![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Remarques : 

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Seules les impressions réalisées par programmation et au format PDF sont disponibles. Il n'est pas possible de réaliser une impression via l'éditeur d'états.

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Seules les impressions au format PDF sont disponibles (impression d'états ou impression réalisée par programmation). 
...
2. Dans le traitement d'impression de l'état au format PDF : 
	...
	- Configurez les options d'impression au format PDF grâce à la fonction [iParamètrePDF](../WDLang5/3046007.md). Vous pouvez définir :
		...
		- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) l'utilisation du format PDF/A (la version gérée est PDF/A-1b). 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Il est possible de signer le fichier PDF généré grâce au [champ Signature](../WDChamp/1410087013.md). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Si l'état doit être imprimé au format PDF/A, il est possible d'activer les erreurs d'UI spécifiques à ce format : 
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Si nécessaire, le fichier PDF créé peut être imprimé depuis le matériel grâce à la fonction [iImprimePDF](../WDLang5/1000020519.md). Cette fonction permet d'utiliser la fenêtre native du système pour configurer l'impression du fichier.




- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Il est possible d'ouvrir directement le fichier PDF généré grâce à la fonction [LanceAppliAssociée](../WDLang1/3035007.md). 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Il est possible de signer le fichier PDF généré grâce à la fonction [iImprimeSignature](../WDLang5/1000021690.md). Cette fonction doit être utilisée en même temps que les fonctions d'impression. 

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Si nécessaire, le fichier PDF créé peut être imprimé depuis le matériel grâce à la fonction [iImprimePDF](../WDLang5/1000020519.md). 

	- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Cette fonction permet d'utiliser la fenêtre native du système pour configurer l'impression du fichier.

	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Cette fonction permet d'imprimer le fichier en utilisant le service Cloud Print de Google.




- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Il est possible d'ouvrir directement le fichier PDF généré grâce à la fonction [LanceAppliAssociée](../WDLang1/3035007.md). 

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Les impressions PDF supportent uniquement les polices standards Adobe (non Unicode) : Courrier, Helvetica, Times, Symbol et ZapFDingbats.
...
- ![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ RTF

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ de saisie

- ![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ Signature

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ Agenda

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ Planning

- ![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ Diagramme de Gantt

- ![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ Tableau croisé dynamique

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ Tableur

- ![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Champ HTML
