...
Il est même possible d'utiliser dans les formules des procédures WLangage qui ont été créées dans ce but dans l'application (fonction [TableurAutoriseProcédure](../WDLang1/1000021473.md)). Par exemple, l'application peut proposer la procédure "Frais de port" qui calcule le montant en fonction de paramètres avancés : poids, volume, délai, pays de livraison, ... 
...
<a name="formules_disponibles_standard_ELTTEXTE000809"></a>
...
| DATEDIF | Renvoie la différence de jours entre deux dates. <br><br> |
...
| CELLULE | Renvoie des informations sur la mise en forme, l'emplacement et le contenu d'une cellule. <br>Remarque : Cette fonction n'est pas disponible dans Excel Web App. |
...
| BDNBVAL | Compte les cellules non vides d'une plage de cellules. <br><br> |
| CROISSANCE | Renvoie une valeur par rapport à une tendance exponentielle. <br><br> |
...
[TableurAjouteFormule (Fonction)](../WDChamp/1000021373.md)
