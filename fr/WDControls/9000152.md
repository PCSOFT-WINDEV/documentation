...
<a name="comment_proposer_des_fenetres_coulissantes_sliding_menu_ELTTEXTE000225"></a>
...
3. Définition du mode d'affichage des fenêtres coulissantes : 
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) soit par l'action bar.
...
- Aspect de la fenêtre coulissante : 
	...
	![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) La fenêtre coulissante aura toujours une barre système opaque, même si la fenêtre principale a une barre système transparente. 
...
<a name="ouverture_une_fenetre_coulissante_par_action_bar_ELTPARAGRAPHE000143"></a>Lorsque une fenêtre contient une Action Bar et est associée à des fenêtres coulissantes, le clic sur l'icône de l'Action Bar peut provoquer l'affichage de la fenêtre coulissante gauche. 
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ActionBar_clic.gif&type=thumb)
...
[MaFenêtreCoulissanteDroite (Mot réservé)](../WDChamp/1511023.md)

[MaFenêtreCoulissanteGauche (Mot réservé)](../WDChamp/1511022.md)

[Fenêtre coulissante basse (Bottom sheet)](../WDChamp/9000216.md)
