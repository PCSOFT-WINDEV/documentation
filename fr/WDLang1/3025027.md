...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La fonction **RepriseSaisie** peut être utilisée dans un événement navigateur (onchange, onclick, etc.), mais elle ne peut pas être utilisée dans une procédure locale ou une procédure globale navigateur.
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Nom du champ ou de la page qui doit prendre le focus (voir Remarques). Si ce paramètre n'est pas spécifié, le focus est donné au dernier champ en cours.

![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Nom du champ ou de la fenêtre qui doit prendre le focus (voir Remarques). Si ce paramètre n'est pas spécifié, le focus est donné au champ en cours.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Le code WLangage qui suit l'appel à la fonction **RepriseSaisie** n'est pas exécuté. L'exécution des traitements reprend :
