...
| *plnRdvSurvolé* | Rendez-vous survolé par la souris dans le champ Planning. Si aucun rendez-vous n'est survolé, &lt;Résultat&gt; correspondra à un tableau de 0 élément.<br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Cette constante n'est pas disponible. |
...
[PlanningListeRendezVous (Fonction)](../WDLang1/1000019276.md)
