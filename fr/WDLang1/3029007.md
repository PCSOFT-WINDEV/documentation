...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Seule la première syntaxe peut être utilisée avec le type Image.
<a name="Exemple1"></a>
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La constante *copieEcran* n'est pas disponible. L'image à copier doit obligatoirement être présente dans un champ Image et être de type générée.![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) La constante *copieEcran* n'est pas disponible.![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Ce paramètre peut correspondre : 
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Ce paramètre peut correspondre : 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Le champ Image destination doit contenir une image de type générée.
...
| *copieToutBlanc* | Remplit le champ Image destination de blanc.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
| *copieToutNoir* | Remplit le champ Image destination de noir.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
