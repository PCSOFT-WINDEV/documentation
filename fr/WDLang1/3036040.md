...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Dans cette version, il est possible uniquement de connaître les attributs d'un répertoire.
...
- Une ou plusieurs lettres correspondant aux attributs du répertoire ("AH" par exemple). 
	...
	- **S** : Répertoire système. Le répertoire est un répertoire système de Windows. 
			![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette valeur n'est pas gérée.
...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) L'accès aux lecteurs réseaux dépend des droits définis pour l'utilisateur du serveur Web.
...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Seul l'attribut "R" peut être modifié (lecture seule / lecture - écriture).
