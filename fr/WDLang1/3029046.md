...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) Dans une fenêtre, cette séquence de caractères permet de cadrer un texte ou une image : 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) Rappel : Pour un champ Liste (ou Combo), la hauteur de la ligne du champ est définie dans la fenêtre "Détail" du champ.
<a name="NOTE0_3"></a>
