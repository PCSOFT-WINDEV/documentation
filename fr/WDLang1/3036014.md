...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000198"></a>La fonction **fEcrit** génère une erreur dans les cas suivants :
...
<a name="retour_chariot_fin_une_ligne_ELTPARAGRAPHE000225"></a>La fonction [fEcritLigne](../WDLang1/3036025.md) permet d'insérer automatiquement un retour chariot (RC) à la fin de la ligne ajoutée. Pour insérer un retour chariot (RC) avec **fEcrit**, il suffit d'utiliser la constante *RC*.
...
<a name="position_dans_fichier_ELTPARAGRAPHE000248"></a>A l'ouverture d'un fichier, la position en cours correspond :
