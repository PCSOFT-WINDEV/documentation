...
<a name="proprietes_specifiques_description_des_variables_type_diagpointdattache_ELTPARAGRAPHE000027"></a>Les propriétés suivantes peuvent être utilisées pour manipuler un point d'attache :

| Nom de la propriété | Type manipulé | Effet |
| --- | --- | --- |
| Forme | [diagForme](../WDLang1/1410088082.md) | Forme manipulée qui contient le point d'attache.  |
