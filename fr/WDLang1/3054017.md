...
<a name="definir_alphabet_fichier_donnees_ELTTEXTE000187"></a>


### Définir l'alphabet utilisé par un fichier de données
<a name="definir_alphabet_utilise_par_fichier_donnees_ELTPARAGRAPHE000022"></a>Pour définir l'alphabet utilisé par un fichier de données : 
...
<a name="exemple_creation_fichier_donnees_hebreu_ELTPARAGRAPHE000065"></a>
```wl
...
<a name="changer_alphabet_fichier_donnees_ELTTEXTE000223"></a>
...
<a name="modifier_alphabet_utilise_pour_les_recherches_les_tris_ELTPARAGRAPHE000083"></a>Pour modifier l'alphabet utilisé pour les recherches et les tris : 
...
<a name="connaitre_alphabet_fichier_donnees_ELTTEXTE000253"></a>


### Comment le faire ? 
<a name="comment_faire_ELTPARAGRAPHE000104"></a>Pour connaître l'alphabet utilisé par un fichier de données, utilisez la propriété [Alphabet](../Proprietes/2512008.md) sur le fichier de données HFSQL voulu.
<a name="NOTE4_2"></a>


### Exemple : Changement des polices utilisées selon l'alphabet du fichier de données lu
<a name="exemple_changement_des_polices_utilisees_selon_alphabet_fichier_donnees_ELTPARAGRAPHE000114"></a>
```wl
HOuvre(Client)
