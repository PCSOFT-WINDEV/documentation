...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) **Remarque** : Cette fonction est utilisable uniquement avec les variables de type Tableau et Tableau associatif.
...
<a name="insertion_element_dans_tableau_ELTPARAGRAPHE000516"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Insère** :
...
<a name="ajout_element_dans_une_propriete_tableau_type_avance_ELTPARAGRAPHE000541"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Insère** :
...
<a name="insertion_element_dans_une_liste_ELTPARAGRAPHE000559"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Insère** :
...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette fonctionnalité n'est pas disponible.
<a name="NOTE0_4"></a>


### Insertion d'un tableau
<a name="insertion_tableau_ELTPARAGRAPHE000604"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Insère** :
...
<a name="insertion_une_liste_ELTPARAGRAPHE000622"></a>Lors de l'utilisation de la fonction **&lt;Tableau&gt;.Insère** :
...
<a name="conditions_utilisation_ELTPARAGRAPHE000667"></a>Cette fonction peut être utilisée avec des structures. Dans ce cas, il faut :
...
### Divers
<a name="divers_ELTPARAGRAPHE000689"></a>
...
[&lt;Tableau&gt;.AjouteTrié (Fonction)](../WDLang1/1000024301.md)

[&lt;Tableau&gt;.InsèreLigne (Fonction)](../WDLang1/1000024310.md)

[Fonctions de gestion des tableaux (syntaxe préfixée)](../WDLang1/1000024323.md)

[TableauInsère (Fonction)](../WDLang1/3075009.md)

[&lt;Tableau&gt;.Insère (Fonction)](../WDLang1/1000024296.md)
