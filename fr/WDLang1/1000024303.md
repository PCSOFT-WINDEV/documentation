...
***En anglais : &lt;Array&gt;.SeekByProcedure***
...
|   |   |
| --- | --- |
| *tcDichotomique* | Recherche dichotomique décroissante. <br>Ce mode de recherche est rapide mais il doit être utilisé sur un tableau trié par ordre croissant avec la même procédure de comparaison ou une procédure équivalente (voir fonction [&lt;Tableau&gt;.Trie](../WDLang1/1000024318.md)). |
| *tcDichotomiqueConforme* | Recherche dichotomique croissante. <br>Ce mode de recherche est rapide mais il doit être utilisé sur un tableau trié par ordre croissant avec la même procédure de comparaison ou une procédure équivalente (voir fonction [&lt;Tableau&gt;.Trie](../WDLang1/1000024318.md)). |
...
<a name="procedure_wlangage_comparaison_ELTPARAGRAPHE000283"></a>Cette procédure de comparaison est de la forme : 
...
[ChercheParProcédure (Fonction)](../WDLang1/1000020102.md)
