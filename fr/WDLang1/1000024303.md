...
|   |   |
| --- | --- |
| *tcDichotomique* | Recherche dichotomique. <br>Ce mode de recherche est rapide mais il doit être utilisé sur un tableau trié par ordre croissant avec la même procédure de comparaison ou une procédure équivalente (voir fonction [&lt;Tableau&gt;.Trie](../WDLang1/1000024318.md)). |
...
<a name="procedure_wlangage_comparaison_ELTPARAGRAPHE000273"></a>Cette procédure de comparaison est de la forme : 
