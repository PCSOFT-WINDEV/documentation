...
| [PlanningAffiche](../WDLang1/1000019426.md) | Réinitialise le contenu d'un champ Planning à partir de sa source de données (fichier de données HFSQL par exemple). |
