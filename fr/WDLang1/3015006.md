...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) L'utilisation des procédures automatiques permet d'éviter l'utilisation de la fonction **TimerSys**. Pour plus de détails, consultez les [procédures automatiques](../Editeurs/9000072.md).
