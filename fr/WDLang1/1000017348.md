...
<a name="Exemple3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) 
```wl
...
<a name="ajout_element_dans_tableau_wlangage_ELTPARAGRAPHE000189"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="ajout_element_dans_une_propriete_tableau_type_avance_ELTPARAGRAPHE000213"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="ajout_element_dans_une_liste_ELTPARAGRAPHE000230"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="ajout_tableau_dans_tableau_concatenation_ELTPARAGRAPHE000249"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="ajout_une_liste_dans_une_liste_concatenation_ELTPARAGRAPHE000281"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="conditions_utilisation_ELTPARAGRAPHE000331"></a>Cette fonction peut être utilisée avec des structures. Dans ce cas, il faut :
