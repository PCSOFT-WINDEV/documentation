...
- Cette fonction est identique à la fonction [TableauAjoute](../WDLang1/3075003.md).
...
<a name="Exemple3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png) 
```wl
...
<a name="ajout_element_dans_tableau_wlangage_ELTPARAGRAPHE000272"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="ajout_element_dans_une_propriete_tableau_type_avance_ELTPARAGRAPHE000296"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="ajout_element_dans_une_liste_ELTPARAGRAPHE000313"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="ajout_tableau_dans_tableau_concatenation_ELTPARAGRAPHE000348"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="ajout_une_liste_dans_une_liste_concatenation_ELTPARAGRAPHE000380"></a>Lors de l'utilisation de la fonction **Ajoute** :
...
<a name="conditions_utilisation_ELTPARAGRAPHE000446"></a>Cette fonction peut être utilisée avec des structures. Dans ce cas, il faut :
...
### Divers
<a name="divers_ELTPARAGRAPHE000467"></a>
...
[TableauAjouteLigne (Fonction)](../WDLang1/3075013.md)
