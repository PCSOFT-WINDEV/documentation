...
- Buffer vide en cas d'erreur. Pour plus de détails sur l'erreur, utilisez la fonction [ErreurInfo](../WDLang1/3013008.md).
...
Nom de la variable de type [pdfParamètre](../WDLang6/1410087857.md) décrivant toutes les options du document PDF à générer.
...
[pdfParamètre (Type de variable)](../WDLang1/1410087857.md)

[iParamètrePDF (Fonction)](../WDLang1/3046007.md)
