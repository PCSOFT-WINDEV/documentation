...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Ce paramètre n'est pas disponible. La recherche est effectuée du premier caractère de la chaîne vers le dernier. La recherche est sensible à la casse. La chaîne à rechercher ne correspond pas obligatoirement à un mot complet : cette chaîne peut correspondre à une partie d'un mot.
