...
Contrairement aux fonctions [Crypte](../WDLang1/3024014.md) et [Décrypte](../WDLang1/3024035.md), les fonctions **CrypteStandard** et [DécrypteStandard](../WDLang1/1000021294.md) utilisent des algorithmes de cryptage standard qui permettent d'échanger des messages cryptés entre des plateformes d'exécution différentes (Windows, Linux, Android, Java, iOS, PHP, etc.) et/ou avec des outils tiers.
...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000021306&name=cryptestandard_fonction">Voir des exemples supplémentaires</a>
...
| *crypteAES192* | Advanced Encryption Standard. <br><br>- Taille de la clé : 192 bits. <br><br>- Taille des blocs : 128 bits. <br><br>- Taille du vecteur d'initialisation (IV) : 128 bits.<br><br><br><br><br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible. |
