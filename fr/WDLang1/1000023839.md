...
Ajoute un sur-entête de colonnes dans un champ Table ou dans un champ Table hiérarchique d'une fenêtre. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TableAjouteSurEntete.gif)
