...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Ce paramètre est obligatoire.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce paramètre correspond uniquement à une chaîne de caractères. ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Ce paramètre est obligatoire.
...
**Rappel** : Sous Android, sur l'appareil comme sur l'émulateur, le système de fichiers est en lecture seule. Une application a  uniquement le droit d'écrire dans son répertoire d'installation ou dans un de ses sous-répertoires, ainsi que sur la mémoire externe  (SDCard).![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Nom complet du fichier à lire (avec son extension). Si ce paramètre n'est pas précisé, le fichier considéré est le fichier PHP.INI. Si seul le chemin n'est pas précisé, le fichier indiqué sera recherché dans le répertoire courant.![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png) Nom complet du fichier à lire (avec son extension). Si ce paramètre n'est pas précisé, le fichier considéré est le fichier **.PCS.conf** (ce fichier doit se trouver dans le répertoire home de l'utilisateur). Si seul le chemin n'est pas précisé, le fichier indiqué sera recherché dans le répertoire de home de l'utilisateur.![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Ce paramètre est obligatoire. Ce paramètre peut correspondre à un chemin complet ou relatif par rapport au répertoire en cours (connu avec la fonction [fRepEnCours](../WDLang1/3036022.md)). Ce paramètre est sensible à la casse. 
...
- ![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les fonctions RegistreXXX ne sont pas disponibles.

- ![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Si le fichier INI contient des données contenant des espaces, ces données doivent être entre guillemets. Par exemple : 
