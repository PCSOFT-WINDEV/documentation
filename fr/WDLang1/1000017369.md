...
![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Universal Windows 10 App](https://doc.pcsoft.fr/ext/images/fr/UNIVERSALAPP.png) Ce paramètre n'est pas pris en compte. Il n'est pas possible de jouer une animation lorsque le champ est rendu invisible.
...
<a name="animation_groupe_champs_ELTPARAGRAPHE000131"></a>Si le paramètre &lt;Nom du champ&gt; correspond à un groupe de champs, l'animation se déroule dans le rectangle défini par le champ le plus haut à gauche et le champ le plus bas à droite.
