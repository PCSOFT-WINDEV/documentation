...
| *popDésactiveRepostionnementAuto* | Débranche le repositionnement automatique si la fenêtre popup risque de ne pas être complètement visible à l'écran. <br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Non disponible. |
...
Nom de la procédure WLangage (appelée "callback") appelée après la fermeture de la fenêtre. Pour plus de détails sur cette procédure, consultez [Paramètres de la procédure utilisée par la fonction OuvrePopupAsynchrone](../WDLang1/1410087854.md). 
...
[OuvrePopupPosition (Fonction)](../WDLang1/3038047.md)
