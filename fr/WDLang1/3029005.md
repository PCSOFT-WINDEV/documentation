...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003029005&name=dcercle_fonction&product=WD">Voir des exemples supplémentaires</a>
...
### Coordonnées
<a name="coordonnees_ELTPARAGRAPHE000331"></a>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=rbCercle.gif)
...
<a name="utilisation_des_fonctions_dessin_ELTPARAGRAPHE000489"></a>Les fonctions de dessin peuvent être utilisées selon 2 méthodes :
