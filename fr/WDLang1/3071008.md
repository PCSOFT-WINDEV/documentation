...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Utilisée dans un événement navigateur (d'un champ ou d'une page), renvoie la position verticale (Y) du curseur de la souris selon l'origine spécifiée.
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) La fonction **SourisPosY** retourne la dernière position connue du doigt sur l'écran de l'appareil.
