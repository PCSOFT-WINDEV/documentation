...
### Police
<a name="police_ELTPARAGRAPHE000443"></a>Par défaut :
...
Pour modifier ces paramètres, utilisez la fonction [&lt;Image&gt;.Police](../WDLang1/1000024007.md).
...
### Coordonnées
<a name="coordonnees_ELTPARAGRAPHE000483"></a>Les coordonnées sont indiquées par rapport au coin haut gauche du champ Image (coordonnées (0,0)).
...
### Gestion du '&'
<a name="gestion_ELTPARAGRAPHE000511"></a>Le paramètre &lt;Gestion du & &gt; permet de gérer la présence du caractère '&'. 
Exemple : 
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000615"></a>En mode anti-aliasing (fonction [&lt;Image&gt;.ChangeMode](../WDLang1/1000023997.md)) ou en mode opacité (fonction [&lt;Image&gt;.DébutDessin](../WDLang1/1000024326.md)), la fonction **&lt;Image&gt;.DessineTexte** est disponible uniquement pour les polices TrueType.
