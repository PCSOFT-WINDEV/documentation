...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Si le champ en cours de saisie est un champ différent d'un champ de saisie, &lt;Résultat&gt; vaut chaîne vide (""). 
