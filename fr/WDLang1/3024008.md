...
|   |   |
| --- | --- |
| *MotComplet* | Recherche un mot complet, c'est-à-dire entouré de caractères de ponctuation (caractère différent d'une lettre ou d'un chiffre) ou d'espaces.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
