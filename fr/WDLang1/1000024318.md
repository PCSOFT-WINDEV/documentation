...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Tri d'un tableau d'enregistrements selon 1 ou plusieurs rubriques.
...
- Nom de la variable de type Tableau associatif à manipuler.
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les tableaux associatifs ne peuvent être être triés dans cette version.
...
|   |   |
| --- | --- |
| *tccOrdreLexicographique* | Tableau trié selon l'ordre linguistique.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
| *tccRespecteNumérique* | Tableau trié en respectant l'ordre des valeurs numériques.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
| *tccSansAccent* | Tableau trié sans tenir compte des accents.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
...
| *tccSansPonctuationNiEspace* | Tableau trié sans tenir compte des espaces et des ponctuations.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les constantes permettant de spécifier les options de tri ne sont pas disponibles.
...
- Nom de la variable de type Tableau associatif à manipuler. Ce tableau peut être : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) un tableau associatif d'enregistrements.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) **Tri d'un tableau d'enregistrements** : Nom des rubriques utilisées comme critère de tri. 
...
- Cette fonction est disponible sur les tableaux associatifs.
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette fonctionnalité n'est pas disponible.
