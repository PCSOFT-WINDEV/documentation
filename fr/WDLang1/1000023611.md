...
1. Ajoutez le document texte dans le projet grâce à une des méthodes suivantes : 
	...
	- sous le volet "Projet", dans le groupe "Projet", déroulez "![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_listeprojet.gif) Liste des éléments" et cliquez sur "Liste des éléments du projet". La liste des éléments du projet s'affiche. Cliquez sur le bouton "Ajouter" et sélectionnez le document texte. 
