...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) dans la fenêtre de description du menu.
...
Remarque : Ce nom de menu peut correspondre à un menu contextuel. ![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les menus contextuels ne sont pas disponibles.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette procédure doit être une procédure serveur. Pour utiliser une procédure navigateur, utilisez la fonction [MenuAjouteOptionNavigateur](../WDLang1/1410090920.md). 
