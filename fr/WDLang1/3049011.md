...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Dans cette version, il n'est pas possible d'utiliser la fonction **ListeSelect** sur les champs Liste multisélection.
...
### Équivalence
<a name="equivalence_ELTPARAGRAPHE000115"></a>Les syntaxes suivantes sont équivalentes :
...
<a name="valeur_element_selectionne_ELTPARAGRAPHE000129"></a>Pour récupérer la valeur de l'élément sélectionné, la syntaxe est :
