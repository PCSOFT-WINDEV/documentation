...
<a name="fenetres_des_exceptions_des_erreurs_ELTPARAGRAPHE000201"></a>Les fenêtres des exceptions et des erreurs proposent une option qui permet de sauver un dump de débogage au moment de l'exception ou de l'erreur. Il s'agit du lien :
...
<a name="traitement_des_exceptions_par_programmation_ELTPARAGRAPHE000208"></a>Appelée depuis le code de traitement d'une exception, la fonction **dbgSauveDumpDébogage** sauve le dump de débogage au moment de l'exception et non pas le dump de débogage courant dans le traitement d'exception.
