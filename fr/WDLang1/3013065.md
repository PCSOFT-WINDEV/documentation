...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Seules les variables de type chaîne de caractères sont disponibles.
...
|   |   |
| --- | --- |
| *psdBinaire* | Sérialisation binaire.<br><br>Il est possible de réaliser une sérialisation binaire d'un membre ou d'une variable JSON. <br><br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) La désérialisation binaire n'est pas disponible. |
| *psdBinaireFormat16* | Sérialisation binaire au format compatible avec la version 16.<br><br>Ce format doit être utilisé si une application en version 17 (ou supérieure) doit fournir des données à une application en version 16 ou inférieure. <br>**Ce format ne doit pas être utilisé en mode Unicode.**<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) La désérialisation binaire n'est pas disponible. |
...
| *psdMinifié* | **Attention** : Cette constante doit être combinée à la constante *psdJSON*. Dans les autres cas, elle n'est pas prise en compte. <br><br>L'encodage utilisé correspond au standard JSON. Cette constante permet de générer un JSON en supprimant les espaces inutiles (retours à la ligne, caractères d'espacement, etc.).<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible. <br><br><br> |
| *psdMiseEnForme* | Sérialisation au format JSON ou XML avec retours à la ligne et indentation.<br><br>L'encodage utilisé correspond au standard JSON ou XML. <br><br>Attention : Cette constante doit être combinée avec la constante *psdJSON* ou *psdXML*. <br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) La sérialisation au format JSON avec mise en forme n'est pas disponible. |
| *psdXML* | Sérialisation XML avec référence aux sous-objets. Ce type de sérialisation permet d'utiliser le format XML comme moyen de stockage et d'échange entre des applications écrites en WLangage. <br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La sérialisation au format XML n'est pas disponible. |
| *psdXMLAgrégé* | Sérialisation XML avec agrégation directe des sous-objets. Ce type de sérialisation permet de générer rapidement un fichier XML dans un format classique, utilisé pour des échanges avec d'autres systèmes.  <br><br>Remarque : Une désérialisation en mode *psdXMLAgrégé* est disponible, cependant les éléments WLangage (variants, tableaux, classes dérivées, etc.) ne seront pas les mêmes que ceux d'origine.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce mode de sérialisation n'est pas disponible. |
| *psdXMLTableauÉlémentsRépétés* | Sérialisation XML permettant de gérer les tableaux sous forme répétée. <br><br>Attention : Cette constante doit être combinée avec la constante *psdXMLAgrégé*. Pour plus de détails, consultez les [exemples de sérialisation des tableaux](#NOTE0_6). <br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce mode de sérialisation n'est pas disponible. |
...
### Désérialisation
<a name="deserialisation_ELTPARAGRAPHE000253"></a>La désérialisation d'un tableau, d'une pile, d'une liste ou d'une file supprime le contenu de cet élément.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) La sérialisation/désérialisation XML des variants n'est pas supportée.

![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Les noms des éléments sérialisés suivants ne doivent pas contenir des caractères spéciaux ou des caractères accentués : 
...
### Rapidité
<a name="rapidite_ELTPARAGRAPHE000312"></a>La sérialisation binaire est plus rapide que la sérialisation XML.
<a name="NOTE0_4"></a>


### Sérialisation des membres de classes et de structures
<a name="serialisation_des_membres_classes_structures_ELTPARAGRAPHE000321"></a>Par défaut, tous les membres d'une classe ou d'une structure sont sérialisés. 
...
- en indiquant quel membre sera sérialisé lors de l'appel à la fonction **Sérialise**. 
	...
	![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Fonctionnalité non disponible.
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) L'attribut d'extension "xmlAttribut" n'est pas disponible.
...
<a name="nom_serialisation_des_classes_ELTPARAGRAPHE000375"></a>L'attribut d'extension "Sérialise" est disponible sur les classes pour indiquer le nom de sérialisation. 
...
<a name="options_disponibles_pour_serialisation_des_tableaux_xml_ELTPARAGRAPHE000391"></a>
...
### Limites
<a name="limites_ELTPARAGRAPHE000425"></a>
...
- Piles, files, listes : 
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Il n'est pas possible de sérialiser/désérialiser des variables de type File, Pile ou Liste.
