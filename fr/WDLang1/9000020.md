...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MCU_Projet.gif)
Dans cet écran :
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MCU_Fenetre.GIF)
...
La saisie de nouvelles Macro-Codes Utilisateur dans une application est très simple. Si la fenêtre permet la saisie d'une Macro Code Utilisateur, l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MCU_Icone.gif)
 apparaît à côté de l'icône de réduction de la fenêtre. Lors du clic sur cette icone, un assistant apparaît, et permet à l'utilisateur final de créer et d'utiliser ses Macro-Codes Utilisateur.
...
3. Sélectionnez le ou les Macro-Codes Utilisateur à importer.
	Le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MCU_Import_diff.gif)
 permet de voir les modifications faites par l'utilisateur par rapport au code existant.
