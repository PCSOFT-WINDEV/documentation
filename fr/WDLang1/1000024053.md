...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) grâce à l'icône "Filtre" du menu contextuel de la colonne : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Table_Filtre.gif)
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) grâce au menu ouvert en cliquant sur l'icône "Loupe" présent dans l'entête de la colonne. Les filtres utilisateur font partie des fonctionnalités disponibles sur les champs Table en mode Ajax et sur les champs Table hiérarchique.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette fonction est disponible pour les champs Table en mode Ajax et les champs Table hiérarchique. 
