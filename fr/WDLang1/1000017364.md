...
**Remarque** : Cette fonction est équivalente à la fonction [TableauTrie](../WDLang1/3075007.md).
...
```wl
// Procédure de comparaison
PROCEDURE TrieEvenementContenu(e1 est un gglEvénement, 
...
|   |   |
| --- | --- |
| *tccOrdreLexicographique* | Tableau trié selon l'ordre linguistique.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
| *tccRespecteNumérique* | Tableau trié en respectant l'ordre des valeurs numériques.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
| *tccSansAccent* | Tableau trié sans tenir compte des accents.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
...
| *tccSansPonctuationNiEspace* | Tableau trié sans tenir compte des espaces et des ponctuations.<br>Cette option est utile uniquement sur les tableaux de chaînes de caractères.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ces constantes ne sont pas disponibles.
...
### Divers
<a name="divers_ELTPARAGRAPHE000608"></a>
...
<a name="exemple_procedure_tri_personnalisee_ELTPARAGRAPHE000630"></a>Exemple de procédure pour comparer 2 entiers :
