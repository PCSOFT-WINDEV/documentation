...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) La fonction **ListeAjoute** ne retourne pas de résultat.
...
<a name="visibiliteinvisibilite_des_elements_champ_liste_champ_combo_ELTPARAGRAPHE000224"></a>Pour rendre un élément d'un champ Liste (ou d'un champ Combo) invisible, utilisez la fonction [gValeurMémorisée](../WDLang1/1410088363.md).
<a name="NOTE0_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png) 

### Équivalence
<a name="equivalence_ELTPARAGRAPHE000238"></a>Les deux syntaxes suivantes sont équivalentes :
...
<a name="champ_liste_trieechamp_liste_non_triee_ELTPARAGRAPHE000258"></a>
...
<a name="personnalisation_des_elements_champ_liste_champ_combo_ELTPARAGRAPHE000284"></a>Pour personnaliser les éléments présents dans un champ Liste ou dans un champ Combo (couleur de fond, image, dessin, ...), utilisez les [Fonctions de gestion des chaînes graphiques](../WDLang1/3029028.md).
<a name="NOTE0_6"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png) 

### Tabulations : Champ Liste multi-éléments
<a name="tabulations_champ_liste_multielements_ELTPARAGRAPHE000298"></a>Pour gérer des tabulations dans un champ Liste (alignement de colonnes), utilisez la constante *TAB*. Par exemple :
...
### Divers
<a name="divers_ELTPARAGRAPHE000367"></a>
