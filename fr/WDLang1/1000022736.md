...
L'imbrication des variables à partir d'une variable de type [Document](../WDLang1/1000022461.md) est la suivante : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TT_prog_Document.gif)
...
L'imbrication des variables à partir d'une variable de type [docFragment](../WDLang1/1000022482.md) est la suivante : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TT_prog_Fragment.gif)
