...
### Police
<a name="police_ELTPARAGRAPHE000444"></a>Par défaut :
...
### Coordonnées
<a name="coordonnees_ELTPARAGRAPHE000484"></a>Les coordonnées sont indiquées par rapport au coin haut gauche de l'image (coordonnées (0,0)).
...
### Gestion du '&'
<a name="gestion_ELTPARAGRAPHE000512"></a>Le paramètre &lt;Gestion du & &gt; permet de gérer la présence du caractère '&'. 
Exemple : 
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000616"></a>En mode anti-aliasing (fonction [&lt;Variable Image&gt;.ChangeMode](../WDLang1/1000024039.md)) ou en mode opacité (fonction [&lt;Variable Image&gt;.DébutDessin](../WDLang1/1000024349.md)), la fonction **&lt;Variable Image&gt;.DessineTexte** est disponible uniquement pour les polices TrueType.
