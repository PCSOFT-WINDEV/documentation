...
|   |   |
| --- | --- |
| *AppelsExternesOptimisés* | Optimise la gestion des appels externes de procédures. Ce paramètre est combiné avec une des deux constantes suivantes. <br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette constante n'est pas disponible. |
