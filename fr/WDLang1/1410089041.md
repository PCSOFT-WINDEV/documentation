...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000339"></a>La fonction **&lt;Variable FichierDisque&gt;.Ecrit** génère une erreur dans les cas suivants :
...
<a name="retour_chariot_fin_une_ligne_ELTPARAGRAPHE000385"></a>La fonction [&lt;Variable FichierDisque&gt;.EcritLigne](../WDLang1/1410089042.md) permet d'insérer automatiquement un retour chariot (RC) à la fin de la ligne ajoutée. Pour insérer un retour chariot (RC) avec **&lt;Variable FichierDisque&gt;.Ecrit**, il suffit d'utiliser la constante *RC*.
...
<a name="position_dans_fichier_ELTPARAGRAPHE000411"></a>A l'ouverture d'un fichier, la position en cours correspond :
