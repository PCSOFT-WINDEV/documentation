...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003029008&name=dcorde_fonction&product=WD">Voir des exemples supplémentaires</a>
...
### Coordonnées
<a name="coordonnees_ELTPARAGRAPHE000365"></a>Si ***les points de départ et d'arrivée*** ne sont pas situés sur le bord du cercle (ou de l'ellipse), le point pris en compte est l'intersection du cercle et de la droite joignant le point précisé et le centre du rectangle (c'est-à-dire le centre du cercle).
...
### Figure pleine
<a name="figure_pleine_ELTPARAGRAPHE000376"></a>La fonction **dCorde** permet uniquement de dessiner une corde : contour uniquement ou zone de la corde. Pour dessiner une figure pleine (portion délimitée par le centre du cercle et les deux points sur le cercle), utilisez la fonction [dPortion](../WDLang1/3029021.md).
<a name="NOTE0_4"></a>


### Utilisation des fonctions de dessin
<a name="utilisation_des_fonctions_dessin_ELTPARAGRAPHE000560"></a>Les fonctions de dessin peuvent être utilisées selon 2 méthodes :
