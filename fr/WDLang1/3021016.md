...
- Le gabarit du projet en cours est automatiquement appliqué à la boîte de dialogue. 
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Le gabarit de l'application n'est pas appliqué sur la fenêtre de saisie. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Pour modifier les caractéristiques du champ de saisie (par exemple, modifier le cadrage ou remplacer les caractères saisis dans le champ par des astérisques), affichez l'assistant d'édition de la question (icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IconeSaisie.GIF) dans la syntaxe de la fonction **Saisie**) et cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Saise_Exemple%201.GIF).
...
<a name="NOTE0_6"></a>
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) 
...
- La variable à saisir ne peut pas être initialisée avec des RC. Le champ de saisie restera monoligne.
	![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Il n'est pas possible d'utiliser un champ de saisie multiligne.

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Si la variable saisie est de type Booléen, la saisie sera effectuée dans un champ de saisie (et non dans un interrupteur comme avec WINDEV).

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Le masque de saisie n'est pas géré.
...
<a name="application_arriereplan_specificite_partir_android_10_ELTPARAGRAPHE000586"></a>A partir de Android 10, il n'est plus possible d'ouvrir une fenêtre lorsque l'application est en arrière-plan. 
