...
### Fonctionnement
<a name="fonctionnement_ELTPARAGRAPHE000035"></a>L'exécution de la procédure est effectuée par le thread principal lorsque celui-ci est en attente d'interactions avec l'utilisateur. 
...
<a name="variable_type_structure_classe_passage_parametre_par_reference_ELTPARAGRAPHE000080"></a>Lorsque une variable de type Structure ou Classe est passée en paramètre à la fonction **ExécuteThreadPrincipalAsynchrone**, cette variable est passée par référence.
