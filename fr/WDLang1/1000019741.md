...
| *gpFenêtre* | Position du pointeur par rapport au coin haut gauche de la fenêtre à laquelle appartient le champ sur lequel s'est produit l'événement.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible |
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Dans le simulateur ou l'émulateur Android, la fonction **GestePosX** permet uniquement de récupérer la position du premier pointeur.
