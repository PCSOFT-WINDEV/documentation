...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) **Remarque** : Lorsqu'un filtre utilisateur est défini sur un champ Table ou Table hiérarchique, l'icône suivante est affichée dans l'entête de la colonne :![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TableActiveFiltre_entonnoir.gif)
