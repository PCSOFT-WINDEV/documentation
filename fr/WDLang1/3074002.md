...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003074002&name=construittablefichier_fonction">Voir des exemples supplémentaires</a>
...
- Les propriétés du champ Table et des colonnes sont mises à jour pour permettre le parcours du fichier de données :
	...
	<Nom Colonne>.RubriqueParcourue = <Première clé du fichier de données>
	```
...
<a name="champ_table_par_programmation_ELTPARAGRAPHE000198"></a>Si le paramètre &lt;Champ Table&gt; correspond à un champ Table par programmation, aucune donnée n'est affichée (le champ Table est vide) mais les propriétés du champ Table et des colonnes sont affectées comme pour un champ Table fichier.
...
### Colonnes
<a name="colonnes_ELTPARAGRAPHE000216"></a>Les colonnes créées portent les noms "_COL1", "_COL2", "_COL3", etc. Ces colonnes sont accessibles par programmation via l'opérateur d'indirection { }.
