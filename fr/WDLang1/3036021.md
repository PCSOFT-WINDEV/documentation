...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003036021&name=fdecompacte_fonction">Voir des exemples supplémentaires</a>
...
### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000058"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="fichiers_compresses_avec_des_versions_anterieures_windev_ELTPARAGRAPHE000088"></a>La fonction **fDécompacte** permet de décompresser des fichiers compressés avec des versions précédentes de WINDEV et de WEBDEV.
...
[fStopCompacte (Fonction)](../WDLang1/3036057.md)

[fTailleDécompacté (Fonction)](../WDLang1/3036054.md)
