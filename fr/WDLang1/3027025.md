...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) une date heure en une chaîne au format spécifié.
...
- Mmm représente le mois en lettres sur 3 caractères avec la première lettre forcée en majuscule (par exemple Jan)
	![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette notation n'est pas disponible.
...
| *maskDateInternetUTC* | Le format utilisé correspond au format de date de la norme RFC-3339 utilisé pour les communications internationales.<br>Le résultat est exprimé en temps universel (UTC). <br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Non disponible.<br><br> |
...
<a name="SYNTAXE2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) 
...
| --- | --- |
| *maskDateDuréeRelative* | Le format utilisé permet d'exprimer la durée écoulée (ou à venir) entre la date du jour et la date spécifiée. Ce format est exprimé en langage naturel. Les différentes formulations utilisées sont configurables dans la description du projet pour la langue en cours :<br><br>1. Sous le volet "Projet", dans le groupe "Projet", cliquez sur "Description". <br><br>2. Dans l'onglet "Langues" :<br><br>	- sélectionnez la langue à configurer.<br><br>	- sélectionnez l'onglet "Date".<br><br><br><br><br>3. Cliquez sur le bouton "Dates et Heures en langage naturel". <br><br>4. Définissez les libellés personnalisés à utiliser si nécessaire. Ces libellés seront utilisés :<br><br>	- pour le résultat de la fonction **DateVersChaîne**.<br><br>	- pour les champs utilisant le masque d'affichage "Durée relative".<br><br><br><br><br><br><br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Non disponible. |
| *maskDateEmail* | Le format utilisé correspond au format de date de la norme RFC-5322 utilisé pour l'encryption d'un mail, d'un flux RSS, ...<br>Le résultat est exprimé dans le fuseau horaire local. <br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Non disponible. |
| *maskDateEmailUTC* | Le format utilisé correspond au format de date de la norme RFC-5322 utilisé pour l'encryption d'un mail, d'un flux RSS, ...<br>Le résultat est exprimé en temps universel (UTC). <br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Non disponible. |
| *maskDateInternet* | Le format utilisé correspond au format de date de la norme RFC-3339 utilisé pour les communications internationales.<br>Le résultat est exprimé dans le fuseau horaire local. <br><br> |
| *maskDateInternetUTC* | Le format utilisé correspond au format de date de la norme RFC-3339 utilisé pour les communications internationales.<br>Le résultat est exprimé en temps universel (UTC). <br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Non disponible.<br><br> |
| *maskDateSystème* | Le format utilisé correspond au format défini dans la description du projet pour la langue en cours : <br><br>1. Sous le volet "Projet", dans le groupe "Projet", cliquez sur "Description". <br><br>2. Sélectionnez l'onglet "Langues" puis l'onglet "Date". <br><br>3. Le format utilisé correspond :<br><br>	- soit aux paramètres du système d'exploitation,<br><br>	- soit aux paramètres spécifiés (avec les jours et mois définis).<br><br><br><br><br><br> |
