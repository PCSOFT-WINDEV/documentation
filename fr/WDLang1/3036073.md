...
<a name="norme_programmation_sous_windows_vista_superieur_ELTPARAGRAPHE000032"></a>Pour augmenter la sécurité des postes face aux vers et virus, Windows Vista (et supérieur) a mis en place le [mécanisme de l'UAC](../Editeurs/2025014.md) (le contrôle de compte utilisateur).
...
### Equivalence
<a name="equivalence_ELTPARAGRAPHE000105"></a>La fonction **fRepGlobalUtilisateur** est équivalente à la fonction [SysRep](../WDLang1/3073026.md) utilisée avec la constante *srAppData*.
