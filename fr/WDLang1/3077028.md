...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) La fonction **ThreadMode** est sans effet : le mode de gestion est toujours multi-processeur, avec gestion manuelle des sections critiques.
<a name="XSYNTAXE"></a>
<a name="SYNTAXE1"></a>
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Les constantes correspondant à la répartition des threads sur les processeurs ou les coeurs ne sont pas disponibles.
...
<a name="gestion_des_multiprocesseurs_ELTPARAGRAPHE000136"></a>Cette option n'est à utiliser que dans certains cas avancés.
