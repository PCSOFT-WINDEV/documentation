...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=fRepS%E9lecteur%20-%20HC%20N%B0001.gif)
...
| *frAncienAspect* | Permet d'utiliser l'ancien sélecteur de répertoire (ancien look). ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=SelectRep.gif)<br>![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
