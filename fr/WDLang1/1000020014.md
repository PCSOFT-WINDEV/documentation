...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) La fonction **ReconnaissanceVocaleAjouteCommande** peut être utilisée depuis n'importe quel traitement d'une fenêtre ou de l'un de ses champs.
