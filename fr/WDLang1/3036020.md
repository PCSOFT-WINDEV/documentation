...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003036020&name=fdebloque_fonction&product=WD">Voir des exemples supplémentaires</a>
...
SI PAS ErreurDétectée ALORS
	...
	...
	// Déblocage du fichier externe
	ResDébloque = fDébloque(MonFichier)
FIN
```
...
<a name="deblocage_pas_ete_effectue_ELTPARAGRAPHE000118"></a>La fonction **fDébloque** renvoie <u><u><u><u>Faux</u></u></u></u> si le déblocage n'a pas été effectué. Le déblocage peut être effectué uniquement si :
