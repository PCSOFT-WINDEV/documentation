...
- dans la base de registre ou le fichier équivalent sur la plateforme d'exécution.
	...
	- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png) Sous iOS, les valeurs persistantes sont sauvegardées dans les paramètres de l'application ("NSUserDefault"). 
