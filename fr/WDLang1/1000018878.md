...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) Dans un Webservice, la fonction **ErreurConstruit** permet de définir l'erreur renvoyée par le Webservice. Si plusieurs appels à la fonction **ErreurConstruit** sont effectués, les messages d'erreur sont concaténés.
...
### Pilotage
<a name="pilotage_ELTPARAGRAPHE000166"></a>Il est possible de piloter un message d'erreur à l'aide de la fonction [PiloteErreur](../WDLang1/1000009005.md).
<a name="NOTE0_6"></a>
