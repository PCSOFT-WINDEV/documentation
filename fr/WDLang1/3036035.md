...
|   |   |
| --- | --- |
| *frConfirmer* | Le contenu du répertoire est déplacé après confirmation de l'écrasement du répertoire de même nom.<br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette constante n'est pas disponible. |
| *frJauge* | Une fenêtre de progression est affichée.<br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette constante n'est pas disponible. |
