...
<a name="NOTE2_2"></a>
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les champs pris en compte par le Drag and Drop programmé sont les suivants (source et cible) : 
