...
![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png) Cette fonction est désormais disponible en mode Widget iOS.
<a name="Exemple1"></a>
...
<a name="nom_utilisateur_ELTPARAGRAPHE000055"></a>Le nom unique permet d'identifier l'utilisateur pour toutes les applications : 
