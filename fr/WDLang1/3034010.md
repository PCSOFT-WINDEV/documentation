...
| ***opRelanceProgramme*** | Termine l'application et relance automatiquement l'application.<br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
...
<a name="afficher_erreur_quitter_application_ELTPARAGRAPHE000111"></a>Si cette option est sélectionnée, si une erreur est rencontrée dans l'application la fenêtre suivante s'affiche automatiquement :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Erreur_auto_Fen1.gif)
...
<a name="afficher_erreur_retourner_saisie_dans_fenetre_courante_ELTPARAGRAPHE000128"></a>Si cette option est sélectionnée, si une erreur est rencontrée dans l'application la fenêtre suivante s'affiche automatiquement :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Erreur_auto_Fen2.gif)
Dans cette fenêtre, l'utilisateur peut :
...
<a name="afficher_erreur_laisser_utilisateur_decider_ELTPARAGRAPHE000146"></a>Si cette option est sélectionnée, si une erreur est rencontrée dans l'application la fenêtre suivante s'affiche automatiquement :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Erreur_auto_Fen3.gif)
Dans cette fenêtre, l'utilisateur peut :
