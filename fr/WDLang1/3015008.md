...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Ce paramètre n'est pas disponible. Dans cette version, il n'est pas possible d'imposer un numéro au timer. Si le timer doit être arrêté par programmation avant la fermeture de la page, il est nécessaire de mémoriser le numéro du timer (paramètre &lt;Résultat&gt;) afin de l'utiliser dans la fonction [FinTimer](../WDLang1/3015007.md).  
