...
### Place de gLien
<a name="place_docparampagetitleshort_ELTPARAGRAPHE000117"></a>La fonction **gLien** peut être appelée à n'importe quelle place dans la ligne à ajouter.
...
### Valeur ajoutée
<a name="valeur_ajoutee_ELTPARAGRAPHE000134"></a>Lorsqu'une valeur est ajoutée par la fonction **gLien**, cette valeur n'est prise en compte ni dans le tri, ni pour les lettres d'appel.
...
<a name="sensibilite_casse_ELTPARAGRAPHE000163"></a>La fonction **gLien** n'est pas sensible à la casse (minuscules/majuscules).
...
<a name="combos_autoalimentees_ELTPARAGRAPHE000180"></a>La fonction **gLien** est utilisée pour gérer les champs de type "Combo auto-alimentée".
...
### Élément récupéré
<a name="element_recupere_ELTPARAGRAPHE000192"></a>Lorsqu'un élément est récupéré dans un champ Combo ou Liste, l'ordre de priorité est le suivant :
...
<a name="cas_particulier_champ_combo_combo_dans_champ_table_ELTPARAGRAPHE000237"></a>Si la fonction **gLien** doit retourner une chaîne vide (""), le résultat obtenu est différent si le champ utilisé est un champ Combo ou une colone de type Combo dans une champ Table. 
