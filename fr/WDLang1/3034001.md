...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Remarque : 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) **Par exemple** : Un traitement d'exception générale a été déclaré au niveau de la fenêtre et au niveau du projet. 
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) **Par exemple** : Un traitement d'exception générale a été déclaré au niveau de la page et au niveau du projet. 
...
- Soit d'utiliser la fonction [DonneFocusEtRetourUtilisateur](../WDLang1/1410088107.md) pour rendre la main à l'utilisateur. 
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette fonctionnalité n'est pas disponible.
