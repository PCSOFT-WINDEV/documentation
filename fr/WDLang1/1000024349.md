...
<a name="dessin_avec_gestion_opacite_ELTPARAGRAPHE000606"></a>Créer un dessin avec gestion de l'opacité permet d'enregistrer simplement des images au format PNG avec gestion de la couche Alpha.
...
3. Utilisez la fonction [&lt;Variable Image&gt;.SauvePNG](../WDLang1/1000024369.md) pour sauvegarder votre dessin au format PNG avec gestion de la couche alpha (de l'opacité).




**Limite** : En mode "Gestion de l'opacité", la fonction [&lt;Variable Image&gt;.DessineTexte](../WDLang1/1000024242.md) est limitée à l'usage de polices True Type.
<a name="NOTE0_5"></a>
<a name="NOTE0_6"></a>
