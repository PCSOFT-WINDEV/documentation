...
Affiche un message dans une boîte de dialogue standard proposant les réponses "Oui", "Non", "Annuler" et renvoie la réponse de l'utilisateur. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=fonctions_dialogue%20-%20HC%20N%B0005.gif)
...
- **Cette fenêtre d'avertissement est bloquante**. Pour continuer l'exécution de l'application, l'utilisateur doit valider un des boutons. 
	![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Pour ne pas bloquer l'application, utilisez la fonction [ConfirmerAsynchrone](../WDLang1/1000025305.md).
...
### Pilotage
<a name="pilotage_ELTPARAGRAPHE000255"></a>Il est possible de piloter un message de confirmation à l'aide de la fonction [PiloteConfirmer](../WDLang1/1000009003.md).
<a name="NOTE0_5"></a>
