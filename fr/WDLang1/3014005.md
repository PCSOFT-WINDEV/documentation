...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003014005&name=api_fonction&product=WD">Voir des exemples supplémentaires</a>
...
<a name="procedure_appelee_callback_ELTPARAGRAPHE000299"></a>Certaines fonctions de l'API Windows attendent en paramètre l'adresse d'une procédure "CallBack" : cette procédure sera rappelée par la fonction de l'API.
