...
Renvoie ou modifie la taille d'un fichier multimédia, précédemment ouvert (fonction [MCIOuvre](../WDLang1/3051017.md)). L'unité utilisée est celle précisée avec la fonction [MCIFormatPosition](../WDLang1/3051004.md).
<a name="Exemple1"></a>
...
- Taille du fichier dans le format précisé par la fonction [MCIFormatPosition](../WDLang1/3051004.md). 

- Chaîne vide en cas d'erreur. Pour connaître le numéro de l'erreur, utilisez la fonction [MCIErr](../WDLang1/3051011.md). Pour connaître le libellé de l'erreur, utilisez la fonction [MCIMsgErr](../WDLang1/3051021.md) ou la fonction [ErreurInfo](../WDLang1/3013008.md) avec la constante *errMessage*.
