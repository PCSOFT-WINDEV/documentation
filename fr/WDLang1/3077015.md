...
- Exécuter l'événement "Demande de mise à jour de l'affichage" d'une fenêtre via la fonction [DemandeMiseAJourUI](../WDLang1/1000023899.md),
...
<a name="ouverture_une_fenetre_depuis_thread_secondaire_via_dialogue_par_messages_ELTTEXTE000158"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000048"></a>Pour ouvrir une fenêtre à partir d'un thread secondaire :
...
<a name="methode_decrite_cidessus_est_utilisee_dans_exemple_messagerie_instantanee_ELTPARAGRAPHE000067"></a>Le code d'ouverture de la fenêtre principale permet de :
...
[ExécuteThreadPrincipal (Fonction)](../WDLang1/1000019862.md)
