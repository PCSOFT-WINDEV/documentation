...
***En anglais : &lt;DiskFile variable&gt;.Create***
...
- Pour manipuler des fichiers externes de type binaire, il est conseillé d'utiliser les fonctions **&lt;Variable FichierDisque&gt;.Crée** ou [&lt;Variable FichierDisque&gt;.Ouvre](../WDLang1/1410090197.md). 
...
Remarque : Si le fichier externe existe déjà (même répertoire et même nom), ce fichier est détruit et recréé. Pour éviter de supprimer un fichier existant, utilisez la fonction [&lt;Variable FichierDisque&gt;.Ouvre](../WDLang1/1410090197.md) avec la constante *foCréationSiInexistant*.
...
**Rappel** : Sous Android, une application a uniquement le droit d'écrire dans son répertoire d'installation ou dans un de ses sous-répertoires, ainsi que sur la mémoire externe (SDCard).![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Ce paramètre peut correspondre à un chemin complet ou relatif par rapport au répertoire en cours (connu avec la fonction [fRepEnCours](../WDLang1/3036022.md)). Ce paramètre est sensible à la casse. 
...
| *foSuppressionAutomatique* | Le fichier est bloqué lors de son ouverture et sera automatiquement supprimé à sa fermeture (appel de la fonction [&lt;Variable FichierDisque&gt;.Ferme](../WDLang1/1410089043.md) ou à la fin de l'application).<br>Si ce fichier est ouvert par plusieurs applications, le fichier sera automatiquement supprimé lorsque la dernière application fermera le fichier (appel de la fonction [&lt;Variable FichierDisque&gt;.Ferme](../WDLang1/1410089043.md) ou à la fin de l'application). |


	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Les options de blocage ne sont pas disponibles. Le fichier externe est toujours librement accessible par les autres applications.




- Type du fichier externe à créer. Ce type est utilisé par les fonctions [&lt;Variable FichierDisque&gt;.LitLigne](../WDLang1/1410089045.md) et [&lt;Variable FichierDisque&gt;.EcritLigne](../WDLang1/1410089042.md) pour déterminer le type des informations à lire et écrire dans le fichier externe : 
...
| *foUnicode* | Fichier de type Unicode. Cette constante permet de gérer un fichier Unicode lorsque le mode "Utiliser les chaînes Ansi en exécution" est activé au niveau de la configuration de projet.<br><br>Ce mode est utilisé par défaut dans les projets WINDEV Mobile. |
	...
	![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Le type du fichier à créer n'est pas disponible. Le type du fichier correspond au mode par défaut.
...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000380"></a>La fonction **&lt;Variable FichierDisque&gt;.Crée** génère une erreur dans les cas suivants :
