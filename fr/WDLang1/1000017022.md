...
<a name="effet_fonction_docparampagetitleshort_ELTPARAGRAPHE000131"></a>La fonction **ListeTrie** a un effet ponctuel : les éléments ajoutés dans le champ Liste ou dans le champ Combo après l'utilisation de la fonction **ListeTrie** respecteront les options de tri définies dans la fenêtre de description du champ.
<a name="NOTE0_2"></a>


### Comparaison des numériques
<a name="comparaison_des_numeriques_ELTPARAGRAPHE000148"></a>La constante *ccRespecteNumérique* effectue le tri en tenant compte de la valeur numérique représentée par les chiffres et non pas simplement de l'ordre alphabétique des chiffres.
