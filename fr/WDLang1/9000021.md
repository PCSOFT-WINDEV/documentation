...
<a name="lancer_assistant_gestion_mcu_ELTPARAGRAPHE000021"></a>Si la fenêtre permet la saisie d'un Macro-Code Utilisateur, l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MCU_Icone.gif) apparaît : 
...
1. Lancez l'assistant de gestion du MCU (icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MCU_Icone.gif) par défaut). 
