...
- Cette fonction est identique à la fonction [Supprime](../WDLang1/1000017354.md).
...
<a name="suppression_dernier_element_ELTPARAGRAPHE000214"></a>Si le dernier élément est supprimé, la taille du tableau passe à 0. Le tableau n'est pas libéré : il est possible de faire de nouveaux ajouts sans ré-allouer le tableau.
<a name="NOTE0_2"></a>


### Divers
<a name="divers_ELTPARAGRAPHE000225"></a>Cette fonction ne peut pas être utilisée avec les tableaux fixes.
