...
|   |   |
| --- | --- |
| *viConfigureFormat* | Affichage d'une boîte de dialogue (si elle existe) permettant à l'utilisateur de spécifier la résolution de la caméra, le nombre de couleurs utilisées, ...<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FormatVideo.gif)<br> |
| *viConfigureSource*<br>(valeur par défaut) | Affichage d'une boîte de dialogue (si elle existe) permettant à l'utilisateur de spécifier la caméra à utiliser et les paramètres de cette caméra (saturation par exemple).<br>Cette boîte de dialogue dépend du driver utilisé par le champ Caméra.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=SourceVideo.gif)<br> |
