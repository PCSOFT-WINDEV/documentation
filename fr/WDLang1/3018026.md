...
<a name="detail_des_differents_elements_obtenus_avec_constante_aizone_ELTPARAGRAPHE000152"></a>Le dessin ci-dessous présente les différentes zones pouvant être récupérées avec la constante *aiZone*.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Arbre_InfoXY.gif)
