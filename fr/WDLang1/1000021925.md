...
<a name="les_differents_types_stockage_ELTTEXTE000345"></a>
...
|   |   |
| --- | --- |
| [albumSauve](../WDLang3/1000020191.md) | Permissions nécessaires : <br><br>- READ_MEDIA_VIDEO<br><br>- READ_MEDIA_IMAGES<br><br><br> |
| [albumSélecteur](../WDLang3/1000020186.md) | Permissions nécessaires : <br><br>- READ_MEDIA_VIDEO<br><br>- READ_MEDIA_IMAGES<br><br><br> |
| [PhotoLanceAppli](../WDLang3/1000021601.md) | Permissions nécessaires : <br><br>- READ_MEDIA_VIDEO<br><br>- READ_MEDIA_IMAGES<br><br><br> |
| [sysCacheStockageExterne](../WDLang1/1000021815.md) | Permissions nécessaires : <br><br>- READ_MEDIA_VIDEO<br><br>- READ_MEDIA_IMAGES<br><br>- READ_MEDIA_AUDIO<br><br><br> |
| [sysRepCarteStockage](../WDLang1/3073034.md) | Permissions nécessaires : <br><br>- READ_MEDIA_VIDEO<br><br>- READ_MEDIA_IMAGES<br><br>- READ_MEDIA_AUDIO<br><br><br> |
| [sysRepStockageExterne](../WDLang1/1000021793.md) | Permissions nécessaires : <br><br>- READ_MEDIA_VIDEO<br><br>- READ_MEDIA_IMAGES<br><br>- READ_MEDIA_AUDIO<br><br><br> |
| [VidéoLanceAppli](../WDLang1/1000019368.md) | Permissions nécessaires : <br><br>- READ_MEDIA_VIDEO<br><br>- READ_MEDIA_IMAGES<br><br><br> |
...
**A partir de la version 2025 Update 1**, si ces permissions sont nécessaire dans votre application, un pictogramme est présent dans l'étape des permissions dans l'assistant de génération de l'application. Ce picto indique que des justifications devront être faites en cas de publication sur le store. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=G%E9n%E9ration_media%20-%20HC%20N%B0002.gif&type=thumb)
Vous avez la possibilité de retirer ces permissions depuis l'assistant de génération (bouton "Supprimer") afin qu'elles ne soient plus demandées à l'exécution en cas d'utilisation d'une des fonctions citées ci-dessus et qu'il n'y ait plus d'avertissement sur le store. Si ces permissions ne sont pas présentes, l'application ne pourra accéder aux fichiers média qui ne lui appartiennent pas sur le stockage externe uniquement via la fonction [uriSélecteur](../WDLang3/1000024026.md). 
...
<a name="fonctions_wlangage_disponibles_pour_gerer_les_differentes_zones_stockage_ELTTEXTE000397"></a>
...
[SysCacheStockageExterne (Fonction)](../WDLang1/1000021815.md)

[SysEspace (Fonction)](../WDLang1/3073002.md)
...
[SysNbStockageExterne (Fonction)](../WDLang1/1000021816.md)

[SysRepCarteStockage (Fonction)](../WDLang1/3073034.md)

[SysRepStockageExterne (Fonction)](../WDLang1/1000021793.md)

[SysStockageExterneAmovible (Fonction)](../WDLang1/1000021818.md)
