...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Le traitement automatique d'exception permet de gérer les erreurs du WLangage. Les erreurs présentes dans les fichiers Javascript externes ne sont pas gérées.
...
| ***opRelanceProgramme*** | Termine l'application et relance automatiquement l'application.<br><br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
