...
**Remarque** : Ce répertoire ne correspond pas obligatoirement au répertoire réel des fichiers de données en exécution (qui peut avoir été modifié par les fonctions [HSubstRep](../WDLang4/3044028.md), [HChangeRep](../WDLang4/3044168.md), etc.). 

![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Sous Android, renvoie le chemin complet du répertoire par défaut contenant la ou les base(s) de données de l'application. Ce répertoire n'est pas configurable. 
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Chemin complet du répertoire par défaut contenant la ou les base(s) de données de l'application dans la zone de stockage interne. Ce répertoire correspond au répertoire "Databases" de l'application. Ce répertoire n'est pas configurable. 

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Chemin complet du répertoire contenant la ou les base(s) de données de l'application. Ce répertoire correspond au répertoire "Documents" de l'application. Ce répertoire n'est pas configurable. 
...
<a name="repertoire_des_donnees_peut_etre_specifie_lors_installation_ELTPARAGRAPHE000102"></a>
...
### Remarque
<a name="remarque_ELTPARAGRAPHE000112"></a>La fonction **fRepDonnées** renvoie la même valeur que [fRepExe](../WDLang1/3036049.md).
<a name="NOTE0_5"></a>
![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) 

### Dossiers des données sous Android
<a name="dossiers_des_donnees_sous_android_ELTPARAGRAPHE000127"></a>Sous Android, les dossiers correspondant aux données ne sont pas simplement identifiés. 
