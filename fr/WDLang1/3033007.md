...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Seules la devise mémorisée et la devise de saisie sont disponibles dans cette version.
...
- COL_PUHT : nom de la colonne liée à une rubrique d'un fichier de données HFSQL, affichant la valeur en Francs.
