...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Nom du champ, du groupe de champs, du champ Onglet, du champ Table fichier, de la colonne de champ Table ou de la page à manipuler. Les liaisons fichier de l'ensemble des champs contenus dans le groupe, le champ Onglet, le champ Table fichier, la colonne du champ Table ou la page seront modifiées.
...
Cette description correspond à : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonFichier%20-%20HC%20N%B0001.gif)
...
[LiaisonFichier (Propriété)](../WDLang1/2510060.md)
