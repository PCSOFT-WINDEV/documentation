...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette fonction est désormais disponible sur les listes WLangage.
	

- ![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette fonction est utilisable uniquement avec les variables de type Tableau.
