...
<a name="exemple_accelerer_les_traitements_ELTTEXTE000587"></a>
...
<a name="exemple_ameliorer_reactivite_application_ELTTEXTE000611"></a>
...
Plus simple encore, il est possible d'indiquer à la procédure **AfficheImage** qu'elle s'exécutera toujours dans le thread principal. Il suffit de cliquer sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Proc_auto_Ico.gif) dans le bandeau de l'éditeur de code et de cocher "Exécuter dans le thread principal". 
