...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Dans cette version, il n'est pas possible de connaître ou de modifier l'heure de création d'un fichier ou d'un répertoire.
...
|   |   |
| --- | --- |
| *fAccès* | Heure du dernier accès au fichier/au répertoire.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
...
- ![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Il n'est pas possible de connaître ou de modifier l'heure de création d'un fichier ou d'un répertoire.
