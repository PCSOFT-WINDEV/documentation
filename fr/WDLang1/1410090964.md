...
Le type **sysNotificationJauge** est utilisé par les variables de type [sysNotification](../WDLang1/1410087893.md). 
...
<a name="proprietes_specifiques_description_des_variables_type_sysnotificationjauge_ELTPARAGRAPHE000036"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une jauge dans une notification :
...
**Remarque** : La mise à jour de la jauge affichée dans une notification interactive est effectuée grâce à la fonction [SysNotificationJaugeMaj](../WDLang1/1410091055.md).
