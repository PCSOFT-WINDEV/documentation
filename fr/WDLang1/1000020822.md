...
- définir les langues gérées dans la description du projet (pour plus de détails, consultez [Description du projet : Onglet Langues](../Editeurs/9500219.md)).
...
- dans la fenêtre de description de l'élément (champ, fenêtre, état, page, etc.). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Projet_multilangue%20-%20HC%20N%B0002.gif&type=thumb)


- lors de l'édition directe du libellé d'un champ : il suffit de passer en édition (via la touche Espace) puis d'utiliser le raccourci clavier Ctrl + T. La fenêtre de saisie des différentes langues du libellé apparaît : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Projet_multilangue%20-%20HC%20N%B0003.gif)





Chaque langue définie dans le projet est identifiée par son drapeau, son nom et son numéro. Il suffit de saisir la traduction dans la langue voulue. Un menu spécifique (affiché via l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Projet_multilangue%20-%20HC%20N%B0003%201.gif)) permet de simplifier les opérations de traduction. 
...
<a name="menu_pour_simplifier_les_operations_traduction_ELTTEXTE000142"></a><br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Projet_multilangue%20-%20HC%20N%B0004.gif)
...
- **Traductions**
	...
	- Configurer le moteur de traduction : Ouvre la fenêtre de configuration du moteur de traduction. Pour plus de détails, consultez [Options de traduction dans les éditeurs](../Editeurs/2036001.md).
...
[Saisie de l'interface dans les différentes langues](../WDLang1/3054009.md)

[Multilingue dans les champs (fenêtre, page, état)](../WDLang1/1013031.md)
