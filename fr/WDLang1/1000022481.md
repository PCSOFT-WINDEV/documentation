...
<a name="types_export_pris_compte_ELTPARAGRAPHE000122"></a>Cette fonction s'applique : 
...
### Sécurités multiples
<a name="securites_multiples_ELTPARAGRAPHE000144"></a>Si plusieurs sécurités sont appliquées à un élément, les sécurités sont prises en compte selon l'ordre suivant : 
...
<a name="gestion_mot_passe_ELTPARAGRAPHE000156"></a>
...
<a name="cas_particulier_champ_activex_ELTPARAGRAPHE000178"></a>L'interdiction de copier l'écran peut limiter les possibilités d'affichage de certains ActiveX. Dans ce cas, si l'ActiveX dans sa version la plus récente ne parvient pas à s'afficher, il faut autoriser la copie d'écran dans la fenêtre concernée avec la constante *faaExportMdpCopieEcranLibre*.
...
[FAA : Export de données (champ Table, Table hiérarchique, Zone répétée, Arbre, ...)](../WDLang1/9500142.md)
