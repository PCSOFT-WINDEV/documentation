...
Si les ressources du planning ont été créées avec la fonction [&lt;Planning&gt;.AjouteRessource](../WDLang1/1000022905.md) en utilisant la fonction [gValeurMémorisée](../WDLang1/1410088363.md), ce paramètre doit correspondre à la valeur précisée dans la fonction [gValeurMémorisée](../WDLang1/1410088363.md) pour cette ressource.
...
<a name="associer_rendezvous_plusieurs_ressources_ELTPARAGRAPHE000283"></a>La fonction **&lt;Planning&gt;.AjouteRendezVous** permet d'associer un rendez-vous à une seule ressource. Pour associer le même rendez-vous à plusieurs ressources, la fonction **&lt;Planning&gt;.AjouteRendezVous** doit être appelée pour chaque ressource.
