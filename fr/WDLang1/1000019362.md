...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Ce paramètre n'est pas pris en compte. La fréquence est identique, quelle que soit la constante spécifiée. 
...
Le capteur de mouvement considère l'appareil comme étant au repos lorsqu'il est à plat, l'écran orienté vers le ciel et en mode portrait.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Acceleration_Origine.gif)
