...
3. Si un outil de traduction est précisé, un bouton "Traduire" (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=BtnTraduire.GIF)
) sera affiché dans chaque élément contenant des informations à traduire. Ce bouton permettra de traduire le texte sélectionné en utilisant l'outil de traduction spécifié.
...
- saisie du libellé d'un champ de saisie : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=AlphabetLangue.gif)


- saisie d'un message multilingue sous l'éditeur de code : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=AlphabetMessCode.gif)
