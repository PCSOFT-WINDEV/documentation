...
<a name="mode_traduction_choisi_ELTTEXTE000307"></a>
...
<a name="traduction_automatique_des_interfaces_ELTPARAGRAPHE000042"></a>Pour chaque élément, différentes zones multilingues sont affichées dans sa fenêtre de description. Ces zones multilingues permettent de saisir les informations dans les différentes langues gérées par le projet.
...
<a name="langues_utilisant_alphabet_specifique_ELTTEXTE000343"></a>
...
<a name="traductions_des_fenetres_des_pages_specifiques_ELTTEXTE000367"></a>
...
<a name="gestion_des_erreurs_hfsql_ELTPARAGRAPHE000140"></a>Par défaut, les fenêtres / pages de gestion des erreurs HFSQL sont fournies en anglais et en français. Pour les traduire dans une autre langue, il est nécessaire de :

1. Intégrer les fenêtres / pages d'erreur par défaut dans votre projet.

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Ces fenêtres sont fournies (avec leur code WLangage) à titre d'exemple, dans le répertoire "\\Programs\\Data\\Preset Windows\\FR\\HyperFileSQL - Fenetres assistance automatique".

	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Ces pages sont fournies (avec leur code WLangage) à titre d'exemple, dans le répertoire "\\Programs\\Data\\Preset Pages\\FR\\HyperFileSQL - Pages assistance automatique".
...
<a name="gestion_automatique_des_erreurs_ELTPARAGRAPHE000163"></a>Par défaut, les fenêtres de gestion automatique des erreurs sont fournies en anglais et en français. Pour les traduire dans une autre langue, il est nécessaire de :
...
<a name="groupware_utilisateur_ELTPARAGRAPHE000179"></a>Par défaut, le groupware utilisateur est livré en anglais et en français.
...
<a name="visualisateur_rapports_ELTPARAGRAPHE000213"></a>Par défaut, la fenêtre du visualisateur de rapports est disponible en anglais et français.

Pour traduire le visualisateur de rapports, il est nécessaire d'intégrer les fenêtres correspondantes dans votre application. Ces fenêtres sont fournies (avec leur code WLangage), dans le répertoire "\\Programs\\Data\\Preset Windows\\FR\\Visualisateur de rapports". Pour plus de détails, consultez [Personnaliser le visualisateur de rapports](../WDChamp/2024002.md).
...
<a name="menus_systeme_menu_contextuel_des_faa_ELTPARAGRAPHE000229"></a>Pour certains champs, WINDEV propose un menu contextuel par défaut. Ce menu permet à l'utilisateur de réaliser simplement diverses opérations.
...
[Saisie de textes multilingues](../WDLang1/1000020822.md)

[Traduction des messages de programmation](../WDLang1/2013004.md)
