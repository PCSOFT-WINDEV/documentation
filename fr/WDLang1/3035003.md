...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette fonction permet de savoir si un exécutable est lancé sur le serveur. **Attention** : les droits pour manipuler cet exécutable seront ceux de l'utilisateur Internet en cours. 
<a name="Exemple1"></a>
