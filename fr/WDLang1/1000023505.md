...
<a name="conditions_utilisation_ELTPARAGRAPHE000355"></a>La fonction **&lt;Table&gt;.Affiche** peut être utilisée indifféremment sur :
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) La page contenant le champ est réactualisée.![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) **Rappel** : La multisélection n'est pas disponible sur les champs Table "classique".
<a name="NOTE0_2"></a>
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) La fonction **&lt;Table&gt;.Affiche** est sans effet si le paramètre &lt;Position&gt; est un entier et si cet entier est invalide.
<a name="NOTE0_3"></a>


### Astuce pour les champs Table et Table hiérarchique fichier
<a name="astuce_pour_les_champs_table_table_hierarchique_fichier_ELTPARAGRAPHE000407"></a>Pour afficher un calcul dans une colonne calculée ou pour mettre en forme une cellule (par exemple "fond rouge si valeur supérieure à 50"), utilisez l'événement "Affichage de ligne" du champ.
<a name="NOTE0_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png)![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) 

### Connecteur Natif SQL Server
<a name="connecteur_natif_sql_server_ELTPARAGRAPHE000419"></a>Si la fonction **&lt;Table&gt;.Affiche** manipule un champ lié à un fichier de données accédé par le Connecteur Natif SQL Server, il est conseillé d'utiliser les constantes *taCourantPremier* et *taDébut*.
<a name="NOTE0_5"></a>
...
### Divers
<a name="divers_ELTPARAGRAPHE000434"></a>La constante ***taDepuisFichier*** est identique à la constante ***taCourantPremier***. Cette constante est conservée par compatibilité avec les versions précédentes et apparaît en orange sous l'éditeur de code.
