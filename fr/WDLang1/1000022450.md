...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Pour capturer directement une photo ou une vidéo en utilisant l'application caméra native de l'appareil, utilisez la fonction [CaméraLanceAppli](../WDLang1/1000022470.md).
...
ELTSPECIAL000264 ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)
...
|   |   |
| --- | --- |
| *viCaptureImage* | ![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) Capture d'une image sous forme d'un fichier BMP.<br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) La capture est réalisée sous forme de fichier JPEG. |
| *viCaptureVidéo*<br>(Valeur par défaut) | ![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) Capture d'une séquence vidéo sous forme d'un fichier AVI.<br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Si la séquence vidéo est capturée sous forme d'une vidéo, le format ainsi que la qualité de la vidéo capturée dépend du paramétrage par défaut de l'appareil et peut être différent d'un appareil à l'autre. |
