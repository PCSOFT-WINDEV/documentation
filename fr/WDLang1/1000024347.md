...
### Zoom sur une image
<a name="zoom_sur_une_image_ELTPARAGRAPHE000372"></a>Lors d'une copie, il est possible d'agrandir ou de réduire une partie de l'image source en la copiant vers l'image destination. Pour cela :
