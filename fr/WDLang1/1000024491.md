...
Nom d'une variable de type [picCalque](../WDLang1/1000024604.md) dans laquelle la fusion doit être effectuée. Lors de la fusion, cette image sera considérée comme l'image d'arrière-plan.
