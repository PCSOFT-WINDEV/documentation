...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Ce répertoire correspond au répertoire "/Library/" de l'application. Pour plus de détails sur ce répertoire, consultez la documentation du développement iOS Apple.  
