...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce paramètre n'est pas disponible. Cette fonction ne retourne pas de résultat.
...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Code source en PHP de la procédure à compiler dynamiquement. Si ce code contient des guillemets, il est nécessaire de les doubler.
