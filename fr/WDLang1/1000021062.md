...
- Les liens ajoutés avec la fonction **RTFAjouteLien** ne sont pas conservés : 
	...
	- lors d'un appel à la fonction [EcranVersFichier](../WDLang4/3044146.md). Dans ce cas, seul le RTF est copié dans le buffer HFSQL.
...
- Il est possible de paramétrer la couleur des liens des champs avec la fonction [LienCouleur](../WDLang1/1000022354.md).

- Il est possible de paramétrer la couleur des liens ajoutés via la fonction **RTFAjouteLien** avec la fonction [LienCouleurRTF](../WDLang1/1410087292.md).
