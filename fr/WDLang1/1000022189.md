...
Sauve le résultat du calcul d'un champ Tableau croisé dynamique (dans un fichier ou en mémoire). Cette sauvegarde pourra être rechargée dans un champ Tableau croisé dynamique grâce à la fonction [&lt;Tableau croisé dynamique&gt;.Charge](../WDLang1/1000022181.md). 
...
Mot de passe de la sauvegarde. Si la sauvegarde est protégée par un mot de passe, ce mot de passe devra être indiqué lors du chargement de la sauvegarde avec la fonction [&lt;Tableau croisé dynamique&gt;.Charge](../WDLang1/1000022181.md).
...
<a name="sauvegarde_chargement_champ_tableau_croise_dynamique_ELTPARAGRAPHE000313"></a>Lorsque le contenu d'un champ Tableau croisé dynamique est calculé avec la fonction [&lt;Tableau croisé dynamique&gt;.CalculeTout](../WDLang1/1000022180.md), le résultat peut être sauvé avec la fonction **&lt;Tableau croisé dynamique&gt;.Sauve**. Il est ensuite possible de le recharger avec la fonction [&lt;Tableau croisé dynamique&gt;.Charge](../WDLang1/1000022181.md) : dans ce cas, le contenu du champ Tableau croisé dynamique n'est pas recalculé.
