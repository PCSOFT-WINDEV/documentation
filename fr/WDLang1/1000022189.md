...
`<Résultat> = <Champ Tableau croisé dynamique>.Sauve(<Support de sauvegarde> [, <Mode de sauvegarde> [, <Mot de passe>]])`
---
...
`<Résultat> = <Champ Tableau croisé dynamique>.Sauve(<Support de sauvegarde> [, <Mot de passe>])`
---
