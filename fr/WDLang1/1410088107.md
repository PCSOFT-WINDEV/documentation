...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La fonction **DonneFocusEtRetourUtilisateur** peut être utilisée dans un événement navigateur (onchange, onclick, etc.), mais elle ne peut pas être utilisée dans une procédure locale ou une procédure globale navigateur.
...
<a name="NOTE0_7"></a>
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png) 
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Le code WLangage qui suit l'appel à la fonction **DonneFocusEtRetourUtilisateur** n'est pas exécuté. L'exécution des traitements reprend :
