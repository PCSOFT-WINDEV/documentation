...
1. Dans le ruban : 
	...
	- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Sous le volet "Projet", dans le groupe "Projet", déroulez "Importer" et sélectionnez "Des éléments WINDEV Mobile et leurs dépendances".
