...
<a name="comment_utiliser_alphabet_specifique_ELTPARAGRAPHE000358"></a>Pour utiliser un alphabet spécifique (différent du français), vous devez :
...
<a name="changement_alphabet_utilise_par_les_polices_ELTPARAGRAPHE000373"></a>La fonction **ChangeAlphabet** modifie l'alphabet utilisé par toutes les polices. Les polices utilisant l'alphabet demandé doivent être installées sur le poste en cours. 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Pour appliquer ce changement à la fenêtre en cours, il est conseillé d'utiliser la fonction [Utilise](../WDLang1/3038044.md) pour forcer la ré-ouverture de la fenêtre en cours. ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Pour appliquer ce changement à la page en cours, il est conseillé d'utiliser la fonction [PageUtilise](../WDLang2/3058016.md) ou [FramesetUtilise](../WDLang2/3058012.md) pour réafficher la page en cours.
...
<a name="changement_alphabet_utilise_par_les_operations_sur_les_chaines_caracteres_ELTPARAGRAPHE000411"></a>La fonction **ChangeAlphabet** modifie l'alphabet utilisé par les opérations sur les chaînes de caractères. Ce nouvel alphabet sera pris en compte :
...
Pour plus de détails sur la gestion des alphabets spécifiques dans les fichiers de données HFSQL, consultez [Gérer des alphabets spécifiques dans des fichiers de données HFSQL](../WDLang1/3054017.md).
...
<a name="changement_alphabet_champ_par_champ_ELTPARAGRAPHE000465"></a>Il est également possible de modifier l'alphabet utilisé champ par champ grâce à la propriété [PoliceAlphabet](../Proprietes/2510089.md).
...
<a name="utilisation_alphabet_alphabetutf8_ELTPARAGRAPHE000477"></a>La constante *alphabetUTF8*permet de gérer les pays pouvant utiliser deux alphabets (Hong Kong) et les pays n'ayant pas d'alphabet défini dans Windows.
