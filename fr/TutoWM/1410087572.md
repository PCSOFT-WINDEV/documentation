...
- Nous allons effectuer un premier test dans le simulateur Android pour visualiser le résultat. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide (ou utilisez la touche F9).<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD_Go%20-%20HC%20N%B0001.jpg&type=thumb)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Lorsqu'un projet est associé à plusieurs plateformes, le test de la fenêtre en cours est réalisé avec la plateforme en cours. La coque utilisée pour le simulateur est également adaptée à la plateforme en cours.<br><br>Pour réaliser le test sur une autre plateforme (par exemple sur iOS), il suffit d'activer cette plateforme en double-cliquant sur son nom dans le volet "Explorateur de projet". <br><br>Remarque : Dans cette partie, les images représentant les tests correspondent à une coque Android. |
...
- Pour créer les différents champs de saisie affichant les informations sur le produit :
	...
	3. Effectuez un "Drag and Drop" (glisser/déplacer) de ces rubriques vers la fenêtre que vous venez de créer.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%202%20-%20HC%20N%B0001.jpg&type=thumb)


	4. Modifiez la taille des champs ("Libellé", "Code-b.", "Réappro.", "Description") afin qu'ils soient visibles dans la fenêtre.

5. Réorganisez les champs dans la fenêtre. Respectez l'ordre suivant : "Photo", "Libellé", "Descr.", "Prix", "Réf", "Code-b.", "Quantité", "Réappro.".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%20-%20HC%20N%B0001.jpg&type=thumb)




- Testez la fenêtre "FEN_Fiche_du_produit" (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide). 
...
- Testez à nouveau la fenêtre "FEN_Liste_des_produits" sous le simulateur (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide).
...
- Pour ajouter une option de validation dans l'Action Bar de la fenêtre :
	...
	2. Affichez la fenêtre de description de l'Action Bar : clic droit et sélectionnez l'option "Description" du menu contextuel. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0002.jpg&type=thumb)
...
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | La fenêtre de description de l'Action Bar s'adapte aux plateformes utilisées dans le projet. En effet, l'Action Bar d'une application Android et celle d'une application iOS ne sont pas identiques.<br><br>**Notre projet utilise à la fois une configuration Android et iOS** : la fenêtre affiche un aperçu de l'Action Bar pour les deux plateformes.<br>Dans le cas d'un projet utilisant uniquement une configuration de projet Android (ou iOS), seules les options correspondant à l'Action Bar pour Android (respectivement iOS) sont affichées. <br><br>Des numéros permettent d'accéder aux options à configurer.<br><br>Nous présentons ici uniquement les options nécessaires à notre exemple.<br>Pour plus de détails, consultez [Description du champ Action Bar](../WDChamp/1000025005.md). |
	...
	5. Modifiez les caractéristiques de cette option : 
		...
		- Dans la zone "Libellé de l'option", saisissez "Valider". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0003.jpg&type=thumb)
						...
						|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | En exécution, le libellé de l'option apparaît dans l'Action Bar :<br><br>			- Si aucune image n'est associée à l'option.<br><br>			- Si l'option est transférée dans le menu du bas.<br><br><br> |
		...
		- Validez la fenêtre de description.
						|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Pour revenir à l'interface générale de description de l'Action Bar, il suffit de cliquer sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Nv_Produit%20-%20HC%20N%B0002%201.jpg). |
...
6. Le code WLangage de cette option va permettre d'enregistrer les modifications effectuées dans la fenêtre "FEN_Fiche_du_produit". Pour saisir ce code :
	...
	- Un menu déroulant avec l'option "Valider" apparaît. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0006.jpg)
						...
						|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Ce menu déroulant est visible uniquement en édition pour saisir le code WLangage associé à l'option. En exécution, ce menu déroulant ne sera pas affiché. |
...
- Lors de la fermeture de la fiche du produit, il est nécessaire de rafraîchir le contenu de la liste des produits présente dans la fenêtre "FEN_Liste_des_produits" pour prendre en compte les modifications réalisées dans la fiche. Il suffit pour cela d'utiliser l'événement "Fermeture d'une fenêtre fille" de la fenêtre "FEN_Liste_des_produits".
	...
	2. Faites un clic droit sur le fond de la fenêtre et dans le menu qui s'affiche, sélectionnez l'option "Code". Dans l'événement "Fermeture d'une fenêtre fille", le code WLangage suivant est automatiquement affiché :
		...
		```
			...
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Ce code généré n'utilise pas la syntaxe préfixée mais la syntaxe "classique" du WLangage. En syntaxe préfixée, ce code devient : <br><br><pre><code>ZR_Produit.Affiche(taCourantBandeau)</code></pre><br> |
...
- Lancez le test de la fenêtre "FEN_Liste_des_produits" sous le simulateur (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide).
...
- Affichez la fenêtre "FEN_Liste_des_produits" sous l'éditeur de fenêtres et lancez son test sous le simulateur (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide).
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Notre projet utilise plusieurs plateformes : nous vous conseillons de faire un GO sous chacune des plateformes. Vous verrez ainsi sous le simulateur les différences d'affichage et de fonctionnement. |
...
- Nous allons modifier le champ Bouton pour lui associer une image représentant un appareil photo :
	...
	3. Dans l'onglet "Général", cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) à droite du champ "Image". Dans le menu contextuel qui s'affiche, sélectionnez l'option "Catalogue". 
	...
	5. Dans la zone de recherche en haut, saisissez "photo" et validez. Plusieurs images apparaissent : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0001.jpg&type=thumb)


	6. Sélectionnez par exemple l'image <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0001%201.jpg)
...
- Ce champ Bouton utilise le style par défaut du gabarit "Phoenix" associé au projet : le fond du champ est bleu. Dans notre cas, le fond bleu n'est pas nécessaire. Nous allons modifier le style associé au champ : 
	...
	3. La fenêtre qui s'affiche liste tous les styles utilisables pour les champs Bouton présents dans le gabarit Phoenix. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20S%E9lection%20du%20style%20-%20HC%20N%B0001.jpg&type=thumb)
...
- Comme pour le champ Bouton permettant de prendre une photographie, nous allons modifier le style associé au champ : 
	...
	3. Dans la fenêtre listant les styles disponibles, cliquez sur la loupe et indiquez "BTN_Vierge". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20S%E9lection%20du%20style%20-%20HC%20N%B0002.jpg)
...
3. Sélectionnez l'option "Centré horizontalement" (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0002%203.jpg)). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0004.jpg)
...
- Pour créer la fenêtre :
	...
	1. Créez une nouvelle fenêtre vierge. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Nv_WM_GAF.jpg) parmi les boutons d'accès rapide. La fenêtre de création d'un élément s'affiche : cliquez sur "Fenêtre" puis sur "Fenêtre". Dans l'assistant, choisissez "Vierge" et validez.
...
- Lancez le test de la fenêtre "FEN_Carte_des_magasins" sous le simulateur (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide). Fermez ensuite le simulateur.
...
- Pour modifier l'image de la première ligne du champ Zone multiligne :
	...
	3. Dans la fenêtre de description :
		...
		- Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif). Dans le menu contextuel qui s'affiche, sélectionnez l'option "Catalogue" afin de choisir une image représentant l'action.
		...
		- Dans la fenêtre de paramétrage de l'image générée, sélectionnez une taille (par exemple, L (Largeur) = 80 et H (Hauteur) = 80), donnez un nom à l'image (par exemple "ListeDesProduits") et validez.
						|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Par défaut, l'image utilisée dans un champ Zone multiligne est en mode "Homothétique étendu centré". L'image sera automatiquement "retaillée" aux bonnes dimensions. |
