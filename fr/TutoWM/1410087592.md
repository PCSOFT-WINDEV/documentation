...
1. Dans le volet "Code" du ruban, dans le groupe "Procédures", déroulez "Nouveau" et sélectionnez "Nouvelle procédure globale". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_WM_WLangage%20-%20HC%20N%B0002.jpg)


2. Dans la fenêtre de sauvegarde de l'élément qui s'affiche, un nom est proposé par défaut pour la collection de procédures globales. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_WM_WLangage%20-%20HC%20N%B0003.jpg)
Conservez ce nom et validez (bouton "OK"). 

3. Une nouvelle fenêtre s'affiche permettant de saisir le nom de la procédure et ses caractéristiques : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_WM_WLangage%20-%20HC%20N%B0004.jpg)
...
Cette procédure est composée : 
	...
	- du code : 
		...
		```
			...
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Avertissement.png) | A retenir | Les éléments clé d'un procédure sont le mot-clé PROCEDURE suivi du nom de la procédure et de parenthèses. |
