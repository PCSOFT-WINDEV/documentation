...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | La description des fichiers de données dans l'analyse n'entraîne pas leur création. Les fichiers de données sont créés physiquement uniquement à l'exécution de l'application. |



Un ou plusieurs projets WINDEV Mobile peuvent être liés à la même analyse. Dans ce cas, on parle d'analyse partagée. Par exemple, une application de gestion commerciale peut être séparée en plusieurs modules. Chaque module utilise la même analyse (et en exécution, chaque application peut également utiliser les mêmes fichiers de données). 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P9-Projet-et-Analyse.png)
