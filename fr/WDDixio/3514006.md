...
2. WDDIXIO est automatiquement icônisé dans la barre des tâches de Windows :![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WDDixioBarreTaches.gif)
...
2. Cliquez sur le bouton "Traduire" ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Combo_des_saisie_btn_multilangue.GIF)
 (disponible par exemple dans la fenêtre de description d'un champ).
...
3. Si le texte à traduire :
	...
	- n'est pas strictement identique à une expression traduite, WDDIXIO s'ouvre et propose automatiquement les différentes traductions possibles. Les traductions sont listées selon leur pertinence. L'icône présente devant chaque traduction indique le degré de pertinence de la traduction. 
		...
		- Sous WDDIXIO : sélectionnez si nécessaire la traduction voulue et utilisez le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WDDixio%20-%20HC%20N%B0001%201.gif)
 pour copier la traduction.  
...
7. Sélectionnez l'expression voulue dans la langue de traduction. Cliquez sur le bouton "Copier" (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WDDixio%20-%20HC%20N%B0001%201.gif)
...
### Options de WDDIXIO
<a name="options_wddixio_ELTPARAGRAPHE000129"></a>Le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Trad_param.gif)
 permet de configurer les options de WDDIXIO. Ces options sont partagées avec WDTRAD. Les options non disponibles dans WDDIXIO sont grisées. 
...
<a name="parametrage_des_langues_ELTPARAGRAPHE000173"></a>Pour chaque langue utilisée dans WDDIXIO, le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WDDixio%20-%20HC%20N%B0001%202.gif)
 permet de paramétrer les options de la langue : 
...
Pour ajouter une nouvelle langue, cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WDDixio%20-%20HC%20N%B0001%204.gif)
. Pour supprimer une langue, cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WDDixio%20-%20HC%20N%B0001%203.gif)
. 
