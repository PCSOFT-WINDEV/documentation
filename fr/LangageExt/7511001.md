...
Ce mode est illustré dans le projet Ville.cbl (au format Cobol) fourni dans le sous-répertoire "LangagesExternes\\Cobol" du répertoire d'installation de WINDEV.
...
<a name="inclusion_des_fichiers_interface_cobol_windev_ELTPARAGRAPHE000023"></a>Voici une liste des fichiers à inclure dans un projet Cobol pour faire appel à l'interface Cobol de WINDEV :
