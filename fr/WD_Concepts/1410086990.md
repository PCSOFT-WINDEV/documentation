...
1. Dans le volet "Explorateur de projet", affichez le menu contextuel du "P" puis sélectionnez "Nouveau .. Nouveau composant interne". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Menu_projet%20-%20HC%20N%B0002.gif)
...
<a name="composant_interne_analyse_cas_autonomie_totale_ELTPARAGRAPHE000071"></a>Un composant interne peut être lié à sa propre analyse. Dans ce cas, le projet accueillant le composant interne peut avoir plusieurs analyses :
