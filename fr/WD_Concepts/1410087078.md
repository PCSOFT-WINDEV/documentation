...
2. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fenetre_WD_bl.gif) parmi les boutons d'accès rapide (ou F9). L'éditeur est automatiquement réduit en icône et la fenêtre s'exécute.
