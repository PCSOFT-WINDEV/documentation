...
<a name="importance_des_sessions_prelancees_ELTTEXTE000311"></a>


### Principe d'une requête d'affichage d'une page AWP
<a name="principe_une_requete_affichage_une_page_awp_ELTPARAGRAPHE000034"></a>Pour comprendre l'importance des sessions prélancées (notamment pour les pages AWP), revenons un instant sur le principe des pages AWP.
...
<a name="interet_des_sessions_prelancees_ELTPARAGRAPHE000051"></a>Lors de l'affichage d'une page AWP, chaque appel au Serveur d'application WEBDEV est totalement indépendant. 
...
## Mise en place
<a name="mise_place_ELTTEXTE000341"></a>


### Les différentes étapes
<a name="les_differentes_etapes_ELTPARAGRAPHE000084"></a>Pour mettre en place les sessions pré-lancées dans un projet WEBDEV ou WINDEV : 
...
<a name="activer_gestion_des_sessions_prelancees_ELTPARAGRAPHE000106"></a>Pour activer la gestion des sessions prélancées : 
...
<a name="corriger_les_erreurs_specifiques_aux_sessions_prelancees_ELTPARAGRAPHE000162"></a>Les erreurs des sessions prélancées indiquent les fonctions WLangage interdites dans l'événement "Initialisation" du projet.
...
<a name="webservices_evenement_recyclage_une_session_prelancee_ELTPARAGRAPHE000178"></a>Dans l'événement "Recyclage d'une session prélancée", il est indispensable de réinitialiser toutes les variables globales qui ont été initialisées dans l'événement "Initialisation lors d'une connexion à une session prélancée".
...
<a name="activer_les_sessions_prelancees_sur_serveur_ELTPARAGRAPHE000201"></a>Pour activer les sessions prélancées pour un site ou un Webservice : 
