...
**Remarque** : Ces fonctions sont également disponibles en syntaxe préfixée ([Fonctions de gestion des pages (syntaxe préfixée)](../WDLang2/1000021657.md)).
...
| [PageEcritCodeHTTP](../WDLang2/1410090194.md) | Renseigne le code HTTP qui sera retourné au client à la fin de l'exécution du code serveur de la page. |
| [PageEcritCodeHTTPPersonnalisé](../WDLang2/1410090195.md) | Renseigne le code HTTP personnalisé qui sera retourné au client à la fin de l'exécution du code serveur de la page. |
