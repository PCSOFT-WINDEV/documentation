...
3. Vous pouvez renseigner les caractéristiques du compte Google Analytics : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Google_ana_2.gif)
...
8. Le flux Web est créé et vous obtenez un ID de mesure (ou Identifiant de suivi). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Google_ana_3.gif)
...
2. Dans l'onglet "Général" : 
	...
	- Copiez l'identifiant de suivi correspondant à votre site : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Google_Analytics%20-%20HC%20N%B0001.gif&type=thumb)
