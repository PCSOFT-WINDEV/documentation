...
### Affichage obtenu
<a name="affichage_obtenu_ELTPARAGRAPHE000105"></a>L'affichage obtenu est le suivant : la page affichée par la fonction **PageAfficheDialogue** est affichée en premier plan.
...
En arrière-plan se trouve la page qui a utilisé la fonction **PageAfficheDialogue**. Cette page est grisée par le GFI (Grisage des pages inaccessibles). Ce grisage peut être configuré grâce aux fonctions [PageActiveGFI](../WDLang2/1000017087.md) et [PageTauxGFI](../WDLang2/1000017086.md).
...
[PageFermeDialogue (Fonction)](../WDLang2/1000017166.md)

[PageActiveGFI (Fonction)](../WDLang2/1000017087.md)

[PageTauxGFI (Fonction)](../WDLang2/1000017086.md)

[Dialoguer avec l'internaute](../WDLang2/1012026.md)

[&lt;Page&gt;.AfficheDialogue (Fonction)](../WDLang2/1000021663.md)
