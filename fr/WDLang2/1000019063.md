...
```
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Si cette fonction est utilisée dans un site PHP, il n'est pas possible de spécifier les paramètres à passer à l'événement serveur "Réception des fichiers uploadés". Cette fonctionnalité n'est pas supportée en PHP. 
