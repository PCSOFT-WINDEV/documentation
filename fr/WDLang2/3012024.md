...
<a name="elements_mis_disposition_ELTTEXTE000206"></a>
Pour gérer l'upload de fichiers, WEBDEV met à votre disposition :

- **un champ Upload (monofichier ou multifichier)** : Plusieurs champs sont automatiquement insérés dans l'éditeur, avec le code WLangage permettant de les utiliser immédiatement. Ce champ peut être généré pour une exécution basée sur HTML5. Pour plus de détails, consultez [Champ Upload](../WDChamp/1016330.md).
...
- **un champ de saisie de type UPLOAD** : Dans le navigateur, un bouton "PARCOURIR" est automatiquement ajouté à droite du champ de saisie de type Upload. Ce bouton permet à l'internaute de sélectionner le fichier à "uploader". 
	...
	**Attention** : 
	...
	- Pour obtenir le nom du fichier uploadé, il est nécessaire d'utiliser la fonction [UploadNomFichier](../WDLang2/3012022.md).


Le fonctionnement de l'upload avec ce type de champ est présenté dans le paragraphe [Upload via un champ de saisie](#NOTE3_1). 
...
## Remarque
<a name="remarque_ELTTEXTE000272"></a>


### Taille maximale des fichiers à uploader
<a name="taille_maximale_des_fichiers_uploader_ELTPARAGRAPHE000077"></a>**Par défaut**, la taille des fichiers à uploader est illimitée dans le moteur WEBDEV. Cette taille peut être limitée : 
...
1. Sélectionnez la clé de registre suivante : 
	...
	- Sur un poste 64 bits : HKEY_LOCAL_MACHINE\\SOFTWARE\\WOW6432Node\\PC SOFT\\WEBDEV\\31.0

	- Sur un poste 32 bits : HKEY_LOCAL_MACHINE\\SOFTWARE\\PC SOFT\\WEBDEV\\31.0
...
<a name="upload_via_champ_saisie_type_upload_conserve_pour_compatibilite_ELTTEXTE000332"></a>


### Uploader un fichier dans une page
<a name="uploader_fichier_dans_une_page_ELTPARAGRAPHE000092"></a>Pour uploader un fichier dans une page :
