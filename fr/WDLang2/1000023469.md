...
**Remarque** : Il est conseillé d'utiliser la fonction [&lt;Zone répétée&gt;.AjouteLigne](../WDLang2/1000023475.md). En effet, la fonction [&lt;Zone répétée&gt;.AjouteLigne](../WDLang2/1000023475.md) permet d'ajouter :
...
<a name="conditions_utilisation_ELTPARAGRAPHE000306"></a>La fonction **&lt;Zone répétée&gt;.Ajoute** peut être utilisée indifféremment sur : 
...
### Ajout d'une répétition vide
<a name="ajout_une_repetition_vide_ELTPARAGRAPHE000337"></a>Après l'ajout d'une répétition vide, il est nécessaire d'initialiser chaque attribut ou chaque champ un à un.
...
<a name="caracteristiques_repetition_ELTPARAGRAPHE000366"></a>Si une valeur correspond au résultat d'un calcul, mettez l'expression numérique entre parenthèses. Par exemple :
...
<a name="position_repetition_ajoutee_ELTPARAGRAPHE000382"></a>Par défaut, la répétition est ajoutée à la fin du champ Zone répétée.
...
<a name="manipulation_memo_binaire_ELTPARAGRAPHE000399"></a>Pour ajouter un mémo binaire dans un champ Zone répétée, utilisez la fonction [&lt;Zone répétée&gt;.AjouteLigne](../WDLang2/1000023475.md).
