...
**Remarque** : Il est conseillé d'utiliser la fonction [ZoneRépétéeAjouteLigne](../WDLang2/3083004.md). En effet, la fonction [ZoneRépétéeAjouteLigne](../WDLang2/3083004.md) permet d'ajouter :
...
<a name="conditions_utilisation_ELTPARAGRAPHE000157"></a>La fonction **ZoneRépétéeAjoute** peut être utilisée indifféremment sur : 
...
### Ajout d'une répétition vide
<a name="ajout_une_repetition_vide_ELTPARAGRAPHE000187"></a>Après l'ajout d'une répétition vide, il est nécessaire d'initialiser chaque attribut ou chaque champ un à un.
...
<a name="caracteristiques_repetition_ELTPARAGRAPHE000215"></a>Si une valeur correspond au résultat d'un calcul, mettez l'expression numérique entre parenthèses. Par exemple :
...
<a name="position_repetition_ajoutee_ELTPARAGRAPHE000230"></a>Par défaut, la répétition est ajoutée à la fin du champ Zone répétée.
...
<a name="manipulation_memo_binaire_ELTPARAGRAPHE000244"></a>Pour ajouter un mémo binaire dans un champ Zone répétée, utilisez la fonction [ZoneRépétéeAjouteLigne](../WDLang2/3083004.md).
