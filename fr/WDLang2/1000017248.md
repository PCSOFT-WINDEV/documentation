...
<a name="conditions_utilisation_ELTPARAGRAPHE000210"></a>La fonction **ZoneRépétéeDéplaceLigne** peut être utilisée indifféremment sur : 
...
<a name="zone_repetee_multiselection_ELTPARAGRAPHE000234"></a>Si la fonction **ZoneRépétéeDéplaceLigne** est utilisée sur un champ Zone répétée multisélection :
...
### Gestion des erreurs
<a name="gestion_des_erreurs_ELTPARAGRAPHE000250"></a>**Attention** : La fonction **ZoneRépétéeDéplaceLigne** ne retourne pas de code d'erreur. Pour savoir si cette fonction a généré une erreur, utilisez la fonction [ErreurInfo](../WDLang1/3013008.md) avec la constante *errMessage*.
...
[&lt;Zone répétée&gt;.DéplaceLigne (Fonction)](../WDLang2/1000023488.md)
