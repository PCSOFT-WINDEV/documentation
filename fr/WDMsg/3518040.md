...
<a name="package_installation_ELTPARAGRAPHE000106"></a>Le package d'installation de WDMSG 2026 permet d'installer les éléments suivants : 
...
- Le fichier d'extraction au format fichier de données HFSQL ou au format WDMSG créé avec WDMSG 2026 peut être traduit uniquement à l'aide de [WDTRAD 2026](../WDTRAD/3518010.md), outil d'aide à la saisie des traductions livré avec WDMSG 2026. Les messages traduits par [WDTRAD 2026](../WDTRAD/3518010.md) sont contenus dans le même fichier. 
