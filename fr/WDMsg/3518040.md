...
- Le programme d'installation de WDMSG 28 est disponible en téléchargement. Le lien de téléchargement vous a été fourni par email et/ou avec le produit reçu. 

- Vous devez installer WDMSG 28 dans le répertoire d'installation de WINDEV 28, de WEBDEV 28 ou de WINDEV Mobile 28.
...
- Vous devez utiliser la clé électronique livrée avec WDMSG 28.

- Seuls les projets au format WINDEV 28, WEBDEV 28 ou WINDEV Mobile 28 pourront être manipulés avec WDMSG 28.
...
<a name="package_installation_ELTPARAGRAPHE000121"></a>Le package d'installation de WDMSG 28 permet d'installer les éléments suivants : 

- WDMSG 28 et WDTRAD 28 : outils d'extraction et de traduction des libellés pour les projets WINDEV 28, WEBDEV 28 et WINDEV Mobile 28. 

- WDINT 28 : outil d'extraction des messages affichés par les  frameworks WINDEV, WINDEV Mobile ou WEBDEV (fichiers ".DLL") et affichés par les Fonctionnalités Automatiques de vos Applications (FAA). 
...
- Le fichier d'extraction au format texte créé avec WDMSG 28 peut être traduit par un logiciel de traduction spécifique ou à l'aide de [WDTRAD 28](../WDTrad/3518010.md), outil d'aide à la saisie des traductions livré avec WDMSG 28. [WDTRAD 28](../WDTrad/3518010.md) crée alors un nouveau fichier texte contenant les messages traduits. 

- Le fichier d'extraction au format fichier de données HFSQL ou au format WDMSG créé avec WDMSG 28 peut être traduit uniquement à l'aide de [WDTRAD 28](../WDTrad/3518010.md), outil d'aide à la saisie des traductions livré avec WDMSG 28. Les messages traduits par [WDTRAD 28](../WDTrad/3518010.md) sont contenus dans le même fichier. 
