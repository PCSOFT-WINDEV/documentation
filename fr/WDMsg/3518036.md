...
### Extraire les messages d'un projet
<a name="extraire_les_messages_projet_ELTPARAGRAPHE000045"></a>Pour extraire les messages de votre projet :
...
7. Sélectionnez les différents éléments (fenêtres, pages, états, etc.) dont les messages (libellé, message de code, etc.) doivent être extraits. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0002.gif&type=thumb)
Remarques : 
...
<a name="parametres_extraction_ELTPARAGRAPHE000163"></a>Les paramètres d'extraction communs à tous les types de fichiers d'extraction sont les suivants :
...
<a name="parametre_extraction_pour_logiciel_traduction_ELTPARAGRAPHE000177"></a>Si vous utilisez [WDTRAD](../WDTRAD/3518010.md) pour traduire les messages de votre projet, les paramètres suivants ne sont pas nécessaires.
...
<a name="format_fichier_texte_des_messages_ELTPARAGRAPHE000204"></a>Le fichier texte d'extraction créé par WDMSG utilise un format spécifique. Pour plus de détails, consultez le [format des fichiers texte des messages](../WDMsg/3518030.md).
<a name="NOTE3_2"></a>


### Projet multiproduit
<a name="projet_multiproduit_ELTPARAGRAPHE000214"></a>Si le projet en cours est un projet multiproduit (WINDEV, WEBDEV et/ou WINDEV Mobile) :
...
<a name="copies_ecran_associees_aux_chaines_caracteres_ELTPARAGRAPHE000228"></a>Lors de l'extraction des chaînes de caractères présentes dans des fenêtres ou des champs, une image de la fenêtre ou du champ correspondant est réalisée.
