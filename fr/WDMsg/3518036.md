...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0001.gif&type=thumb)
...
7. Sélectionnez les différents éléments (fenêtres, pages, états, ...) dont les messages (libellé, message de code, etc.) doivent être extraits. 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0002.gif&type=thumb)
Remarques : 
...
11. Sélectionnez les paramètres du fichier résultat, créé par l'extraction (voir [Détail des paramètres](#NOTE2_2)). Indiquez le nom et le répertoire du fichier d'extraction (par défaut, le fichier d'extraction est créé dans le répertoire du projet en cours). 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0004.gif&type=thumb)
