...
Le fichier de comparaison est créé dans la langue de référence. Ce fichier de comparaison a le même format que le fichier d'extraction (fichier WDMSG, fichier de données HFSQL ou fichier texte). Pour plus de détails sur le format du fichier texte de comparaison, consultez le [format des fichiers texte des messages](../WDMsg/3518030.md)
...
### Comparer les messages d'un projet
<a name="comparer_les_messages_projet_ELTPARAGRAPHE000043"></a>Pour comparer les messages de votre projet : 
...
3. Choisissez la langue de référence. Les différents messages seront affichés dans cette langue de référence. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0007.gif&type=thumb)
Remarque : Le nom des langues personnalisées est également proposé. 

4. Passez à l'étape suivante de l'assistant.

5. Choisissez la langue à comparer. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0008.gif&type=thumb)
Remarque : Le nom des langues personnalisées est également proposé.
...
7. Sélectionnez les différents éléments (fenêtres, pages, états, etc.) dont les messages (libellé, message de code, etc.) doivent être comparés. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0009.gif&type=thumb)
...
11. Sélectionnez les différents paramètres du fichier de comparaison (ces paramètres sont détaillés ci-dessous). Ces paramètres sont les mêmes que lors d'une extraction simple. Votre fichier pourra être réintégré après correction.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0010.gif&type=thumb)
...
<a name="parametres_comparaison_ELTPARAGRAPHE000116"></a>Les paramètres d'extraction communs à tous les types de fichiers d'extraction sont les suivants :
...
<a name="parametre_comparaison_pour_logiciel_traduction_ELTPARAGRAPHE000130"></a>Si vous utilisez [WDTRAD](../WDTRAD/3518010.md) pour traduire les messages de votre projet, les paramètres suivants ne sont pas nécessaires.
