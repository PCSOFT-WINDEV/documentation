...
7. Sélectionnez les différents éléments (fenêtres, pages, états, ...) dont les messages (libellé, message de code, ...) doivent être comparés. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0009.gif&type=thumb)
...
<a name="parametres_comparaison_ELTPARAGRAPHE000120"></a>Les paramètres d'extraction communs à tous les types de fichiers d'extraction sont les suivants :
...
<a name="parametre_comparaison_pour_logiciel_traduction_ELTPARAGRAPHE000136"></a>Si vous utilisez [WDTRAD](../WDTrad/3518010.md) pour traduire les messages de votre projet, les paramètres suivants ne sont pas nécessaires.
