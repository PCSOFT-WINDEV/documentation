...
7. Sélectionnez les différents éléments (fenêtres, pages, états, ...) dont les messages (libellé, message de code, ...) doivent être extraits.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0012.gif&type=thumb)
