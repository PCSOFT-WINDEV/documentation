...
3. Sélectionnez les langues des messages à extraire. Ces langues correspondent aux langues déjà disponibles dans le projet, à traduire vers d'autres langues.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0011.gif&type=thumb)
...
7. Sélectionnez les différents éléments (fenêtres, pages, états, etc.) dont les messages (libellé, message de code, etc.) doivent être extraits.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0012.gif&type=thumb)
...
11. Sélectionnez les paramètres du fichier résultat, créé par l'extraction (voir [Détail des paramètres](#NOTE2_2)).<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0013.gif&type=thumb)


12. Passez à l'étape suivante.

13. Sélectionnez l'option "Extraire uniquement les messages modifiés ou ajoutés".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Assistant%20WDMSG%20-%20HC%20N%B0014.gif&type=thumb)
