...
<a name="lecon_2_developpement_application_ELTTEXTE001287"></a>
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=dur%E9e.png) 1h
...
## Présentation
<a name="presentation_ELTTEXTE001323"></a>
...
<a name="afficher_liste_des_produits_ELTTEXTE001347"></a>
...
<a name="creation_fenetre_ELTPARAGRAPHE000050"></a>Pour créer une nouvelle fenêtre :

1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Nv_WM_GAF.jpg) parmi les boutons d'accès rapide (ou utilisez le raccourci Ctrl + N). 
...
6. Comme notre projet contient plusieurs plateformes (iOS et Android), l'assistant propose de sélectionner la plateforme à utiliser pour la création de la fenêtre. Il est conseillé de choisir la plateforme ayant la plus petite résolution (ici, "iPhone générique"). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0002.jpg&type=thumb)
...
7. L'assistant propose de choisir la source des données associée à la fenêtre. Dans notre cas, il s'agit du fichier de données "Produit" :
	...
	- Sélectionnez le fichier de données Produit.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0004.jpg&type=thumb)
...
9. Sélectionnez le style du champ Zone répétée : "Image + Titre + Libellé dessous". Ce modèle permet d'obtenir une interface contenant l'image du produit, son nom et sa description.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0005.jpg&type=thumb)


10. Passez à l'étape suivante.

11. L'assistant propose automatiquement les rubriques du fichier de données correspondant aux différents champs de la zone répétée générée.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0006.jpg&type=thumb)
...
14. L'assistant propose plusieurs options pour la génération de la fenêtre de type Zone répétée : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0008.jpg&type=thumb)
...
16. Donnez un titre et un nom à la fenêtre générée. Saisissez le titre de la fenêtre : "Liste des produits". Le nom de la fenêtre est automatiquement renseigné.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0009.jpg&type=thumb)


17. Terminez l'assistant. La fenêtre est automatiquement créée, affichée sous l'éditeur et enregistrée. Si votre projet utilise les configurations de projet iOS et Android, la fenêtre est affichée dans la configuration iOS (la zone de la barre d'accueil est affichée). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0010.jpg)
...
### Test de la fenêtre
<a name="test_fenetre_ELTPARAGRAPHE000129"></a>Nous allons effectuer un premier test dans le simulateur Android pour visualiser le résultat : 

1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide (ou utilisez la touche F9).<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Liste_produit_RAD_Go%20-%20HC%20N%B0001.jpg&type=thumb)
...
<a name="creation_fenetre_fiche_ELTTEXTE001419"></a>
...
### Création de la fenêtre
<a name="creation_fenetre_ELTPARAGRAPHE000150"></a>Pour créer la fenêtre fiche :

1. Créez une nouvelle fenêtre vierge.

	- Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Nv_WM_GAF.jpg) parmi les boutons d'accès rapide.
...
2. La fenêtre de sauvegarde de l'élément créé apparaît. Indiquez le titre de la fenêtre : "Fiche du produit". Son nom est automatiquement proposé : "FEN_Fiche_du_produit". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%20Enregistrement%20-%20HC%20N%B0001.jpg)
Validez. 

3. La fenêtre est ajoutée au projet, pour toutes les configurations par défaut. 

<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%20Enregistrement%20-%20HC%20N%B0002.jpg)
...
### Création des champs
<a name="creation_des_champs_ELTPARAGRAPHE000173"></a>La fenêtre que nous créons doit contenir les différents champs correspondant à la description du produit. Ces champs doivent être liés aux rubriques présentes dans le fichier de données Produit. 

Pour créer les différents champs de saisie, nous allons utiliser directement les rubriques du fichier de données Produit :

1. Dans le volet "Explorateur de projet", déroulez la catégorie "Analyse" via l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0001%201.jpg). Les différents fichiers de données décrits dans l'analyse liée au projet sont affichés.
...
4. Effectuez un "Drag and Drop" (glisser/déplacer) de ces rubriques vers la fenêtre que vous venez de créer (par exemple, en haut à gauche).<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%202%20-%20HC%20N%B0002.jpg&type=thumb)
...
<a name="amelioration_ELTPARAGRAPHE000192"></a>Nous allons réorganiser les champs dans la fenêtre et modifier la taille de certains champs. 
...
2. Affichez les options d'alignement (volet "Alignement" du ruban de WINDEV Mobile). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%202%20-%20HC%20N%B0001.jpg)
...
Vous obtenez le résultat suivant. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%20-%20HC%20N%B0001.jpg&type=thumb)
...
1. Lancez le test de la fenêtre (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide). 
...
<a name="afficher_les_donnees_enregistrement_cours_dans_fiche_ELTPARAGRAPHE000276"></a>Pour afficher les données présentes dans l'enregistrement en cours dans le fichier de données, il est nécessaire de faire un peu de programmation (très simple). 
...
1. Affichez les événements WLangage associés à la fenêtre FEN_Fiche_du_produit :
	...
	- Dans le menu contextuel qui s'affiche, sélectionnez "Code de l'élément". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%20-%20HC%20N%B0002.jpg)
...
<a name="affichage_fiche_depuis_liste_des_produits_ELTPARAGRAPHE000302"></a>Pour afficher la fiche du produit sélectionné dans la liste des produits, nous allons effectuer les opérations suivantes : 

1. Placez-vous sur la fenêtre "Liste des produits" : cliquez sur le bouton "FEN_Liste_des_produits" dans la barre des documents ouverts (sous le ruban du menu de WINDEV Mobile) : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%20-%20HC%20N%B0001%201.jpg)
...
1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="ajouter_une_option_validation_dans_action_bar_ELTPARAGRAPHE000352"></a>Pour ajouter une option de validation dans l'Action Bar de la fenêtre "FEN_Fiche_du_produit" :
...
3. Affichez la fenêtre de description de l'Action Bar (option "Description" du menu contextuel du champ). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0002.jpg&type=thumb)
...
6. Modifiez les caractéristiques de cette option : 
	...
	- Dans la zone "Libellé de l'option", saisissez "Valider". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0003.jpg&type=thumb)
	...
	- Dans la zone "Image prédéfinie", déroulez la liste et sélectionnez "Valider". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0005.jpg&type=thumb)
...
7. Le code WLangage de cette option va permettre d'enregistrer les modifications effectuées dans la fenêtre "FEN_Fiche_du_produit". Pour saisir ce code :
	...
	- Un menu déroulant avec l'option "Valider" apparaît. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0006.jpg)
...
8. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WM_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="mise_jour_liste_des_produits_ELTPARAGRAPHE000431"></a>Lors de la fermeture de la fiche du produit, il est nécessaire de rafraîchir le contenu de la liste des produits présente dans la fenêtre "FEN_Liste_des_produits" pour prendre en compte les modifications réalisées dans la fiche. Il suffit pour cela d'utiliser l'événement "Fermeture d'une fenêtre fille" de la fenêtre "FEN_Liste_des_produits".

1. Cliquez sur le bouton "FEN_Liste_des_produits" dans la barre des documents ouverts : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fiche%20produit%20-%20HC%20N%B0001%201.jpg)
...
### Test de la fenêtre
<a name="test_fenetre_ELTPARAGRAPHE000462"></a>Lancez le test de la fenêtre "FEN_Liste_des_produits" sous le simulateur (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide).
...
<a name="gestion_ajout_produit_ELTTEXTE001605"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000480"></a>Le principe de la création d'un produit va être le suivant :
...
<a name="ouverture_fiche_produit_depuis_action_bar_ELTPARAGRAPHE000488"></a>Pour ajouter une option dans l'Action Bar de la fenêtre :
...
3. Affichez la fenêtre de description de l'Action Bar : clic droit et sélectionnez l'option "Description" du menu contextuel. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Nv_Produit%20-%20HC%20N%B0001.jpg&type=thumb)
...
5. Cliquez sur le bouton "+" pour ajouter une option (bouton présent sous la zone "En haut à droite"). Une nouvelle option par défaut est créée en haut à droite. Modifiez les caractéristiques de cette option : 
	...
	- Dans la zone "Libellé de l'option", saisissez "Nouveau produit". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Nv_Produit%20-%20HC%20N%B0002.jpg&type=thumb)


	- Dans la zone "Image prédéfinie", déroulez la liste et sélectionnez "Ajouter". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Nv_Produit%20-%20HC%20N%B0003.jpg&type=thumb)
...
6. Le code WLangage associé à cette option va permettre d'ouvrir la fenêtre "Fiche du produit", en mettant ses champs à vide. Pour saisir ce code WLangage :
	...
	- Un menu déroulant avec l'option "Nouveau produit" apparaît. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Nv_Produit%20-%20HC%20N%B0005.jpg)
...
- Dans l'événement "Sélection du menu", saisissez le code WLangage suivant :
		...
		```
			...
			La fonction [&lt;Fichier de données&gt;.RAZ](../WDLang4/1000025052.md) initialise les variables des rubriques du fichier de données "Produit" avec les valeurs par défaut pour gérer un nouvel enregistrement.

7. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WM_GAF.jpg) parmi les boutons d'accès rapide.
...
### Gestion de l'ajout d'un produit
<a name="gestion_ajout_produit_ELTPARAGRAPHE000531"></a>Maintenant, vérifions la gestion de l'ajout d'un nouvel enregistrement dans la fenêtre de la fiche du produit.
...
### Test de la fenêtre
<a name="test_fenetre_ELTPARAGRAPHE000572"></a>Affichez la fenêtre "FEN_Liste_des_produits" sous l'éditeur de fenêtres et lancez son test sous le simulateur (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide).
...
<a name="utilisation_appareil_photo_affichage_une_image_ELTTEXTE001656"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000591"></a>Nous allons gérer la photo du produit en utilisant l'appareil photo du matériel.
...
<a name="creation_bouton_prise_photo_ELTPARAGRAPHE000614"></a>Pour créer le champ Bouton permettant la prise de la photo :
...
4. Ajoutez un champ Bouton dans la fenêtre :
	...
	- Sous le volet "Création", dans le groupe "Champs usuels", cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Bouton_WM_GAF.jpg) : la forme du champ apparaît sous la souris.
...
3. Dans l'onglet "Général", cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0001.jpg) à droite du champ "Image". Dans le menu contextuel qui s'affiche, sélectionnez l'option "Catalogue". 
...
5. Dans la zone de recherche en haut, saisissez "photo" et validez. Plusieurs images apparaissent : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0002.jpg&type=thumb)


6. Sélectionnez par exemple l'image ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0002%201.jpg) en double-cliquant dessus.
...
3. La fenêtre qui s'affiche liste tous les styles utilisables pour les champs Bouton présents dans le gabarit "Material 3". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20S%E9lection%20du%20style%20-%20HC%20N%B0001.jpg&type=thumb)


4. Cliquez sur la loupe et indiquez "BTN_Vierge". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20S%E9lection%20du%20style%20-%20HC%20N%B0002.jpg)
...
### Prise de photo
<a name="prise_photo_ELTPARAGRAPHE000674"></a>Nous allons saisir maintenant le code WLangage permettant de prendre une photo et de l'afficher dans le champ Image de la fiche produit.
...
3. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WM_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="bouton_pour_selectionner_une_photo_dans_album_photos_ELTPARAGRAPHE000696"></a>Nous allons ajouter un champ Bouton pour sélectionner une des photos existantes dans l'album de l'appareil et l'associer au produit.
...
<a name="gestion_codebarres_produit_ELTTEXTE001704"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000740"></a>Le fichier de données "Produit" contient une rubrique "Code_Barres". Cette rubrique permet de stocker la valeur d'un code-barres. Certains matériels (notamment ceux qui possèdent un appareil photo) peuvent scanner un code-barres pour récupérer sa valeur.
...
### Mise en place
<a name="mise_place_ELTPARAGRAPHE000760"></a>Tout d'abord nous allons créer un champ Bouton. 
...
<a name="gestion_des_ancrages_dans_fiche_produit_ELTTEXTE001734"></a>
...
3. Sélectionnez l'option "Centré horizontalement" (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0002%203.jpg)). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0004.jpg&type=thumb)
...
Tous les ancrages ont été définis dans la fenêtre. Les flèches rouges indiquant l'orientation des ancrages sont affichées : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0001.jpg&type=thumb)
...
<a name="utilisation_champ_carte_ELTTEXTE001758"></a>
...
### Création de la fenêtre
<a name="creation_fenetre_ELTPARAGRAPHE000871"></a>Tout d'abord, nous allons créer une nouvelle fenêtre et lui ajouter un champ de type Carte.
...
<a name="creation_champ_carte_ELTPARAGRAPHE000886"></a>Pour créer le champ Carte dans la fenêtre :
...
<a name="affichage_des_magasins_sur_champ_carte_ELTPARAGRAPHE000911"></a>Nous allons maintenant ajouter le code qui permet d'afficher sur une carte tous les magasins présents dans le fichier de données "Magasin".
...
<a name="code_wlangage_associe_fenetre_ELTPARAGRAPHE000929"></a>Nous allons saisir le code WLangage permettant d'afficher les magasins directement dans le code d'initialisation de la fenêtre (la fenêtre contenant uniquement le champ Carte). 
...
Lancez le test de la fenêtre "FEN_Carte_des_magasins" sous le simulateur (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide). 
...
<a name="utilisation_champ_zone_multiligne_ELTTEXTE001806"></a>
...
La fenêtre que nous allons réaliser est la suivante : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Menu%20ZML%20-%20HC%20N%B0001%201.jpg)



### Création de la fenêtre
<a name="creation_fenetre_ELTPARAGRAPHE000977"></a>Tout d'abord, nous allons créer une fenêtre et lui ajouter un champ de type Zone multiligne.
...
<a name="creation_champ_zone_multiligne_ELTPARAGRAPHE000992"></a>Pour créer le champ Zone multiligne :
...
<a name="modification_champ_zone_multiligne_ELTPARAGRAPHE001022"></a>Pour modifier le champ Zone multiligne :
...
3. Sélectionnez le modèle "Ligne simple avec picto" et validez. Répétez cette opération 2 fois.
	...
	- 3 lignes de type "simple avec picto". <br>![Champ Zone multiligne](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Menu%20ZML%20-%20HC%20N%B0002.jpg&type=thumb)
...
3. Dans la fenêtre de description :
	...
	- Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0001.jpg). Dans le menu contextuel qui s'affiche, sélectionnez l'option "Catalogue" afin de choisir une image représentant l'action.
...
4. Validez la fenêtre de description.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Menu%20ZML%20-%20HC%20N%B0003.jpg)
...
<a name="programmation_menu_ELTPARAGRAPHE001155"></a>Pour terminer, nous allons écrire le code WLangage nécessaire pour effectuer chaque action du menu :
...
<a name="test_application_ELTTEXTE001863"></a>
...
Jusqu'à présent, vous testiez les fenêtres de façon individuelle en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide. Nous allons maintenant lancer le test du projet complet. 
...
## En résumé
<a name="resume_ELTTEXTE001887"></a>
**Projet corrigé**
