...
<a name="lecon_4_fenetre_avec_recherche_ELTTEXTE000606"></a>
...
## Présentation
<a name="presentation_ELTTEXTE000642"></a>
...
## Principe
<a name="principe_ELTTEXTE000666"></a>
L'interface de la fenêtre que nous allons créer sera la suivante : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche_Fin%20-%20HC%20N%B0002.jpg&type=thumb)
...
<a name="creation_requete_pour_rechercher_les_produits_ELTTEXTE000699"></a>


### Création de la requête
<a name="creation_requete_ELTPARAGRAPHE000070"></a>Pour créer une requête, nous allons utiliser l'éditeur de requêtes.

1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Nv_WM_GAF.jpg) parmi les boutons d'accès rapide. La fenêtre de création d'un nouvel élément s'affiche : cliquez sur "Requête­". L'assistant de création de requêtes se lance.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0001.jpg)
...
2. Cliquez sur la flèche devant le nom du fichier de données "Produit" : La liste des différentes rubriques du fichier de données s'affiche. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0002%201.jpg)


3. Sélectionnez la rubrique "IDProduit" puis cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0002.jpg). La rubrique apparaît dans la liste des éléments de la requête. 

4. Répétez cette dernière opération pour les rubriques "Libellé", "Description" et "Photo". 

5. La fenêtre de description de la requête est la suivante : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0003.jpg&type=thumb)
...
### Test de la requête
<a name="test_requete_ELTPARAGRAPHE000101"></a>Comme tous les éléments d'un projet WINDEV Mobile, il est possible de tester immédiatement la requête que nous venons de créer :

1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg).
...
<a name="ajout_une_condition_selection_ELTPARAGRAPHE000116"></a>Dans notre exemple, l'utilisateur va pouvoir sélectionner une valeur pour le libellé du produit. Nous devons modifier la requête afin que ce critère de recherche corresponde à un paramètre de la requête.
...
4. Validez la fenêtre de description de la condition. Le chiffre "1" apparaît à droite de la rubrique "Produit.Libellé", indiquant qu'une condition de sélection a été définie. <br>![Condition dans la fenêtre de description de la requête](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0007.jpg)


5. Validez la fenêtre de description de la requête. 

6. Le graphe de la requête est modifié pour prendre en compte la condition de sélection que nous avons définie. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0008.jpg)


7. Enregistrez la requête en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WM_GAF.jpg) parmi les boutons d'accès rapide.
...
<a name="test_requete_parametree_ELTPARAGRAPHE000149"></a>Pour tester la requête paramétrée :
...
4. Validez la fenêtre. Le résultat de la requête correspondant aux paramètres spécifiés s'affiche.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0010.jpg)
...
<a name="creation_interface_ELTTEXTE000741"></a>
...
<a name="creation_fenetre_ELTPARAGRAPHE000178"></a>Pour créer la fenêtre de recherche :
...
5. L'assistant propose de choisir la source des données associée à la fenêtre. Dans notre cas, il s'agit d'une requête :
	...
	- Sélectionnez la requête que nous venons de créer : "REQ_Produits". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0011.jpg&type=thumb)
...
12. Terminez l'assistant. La fenêtre est automatiquement créée, affichée sous l'éditeur et enregistrée. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0012.jpg)
...
<a name="affichage_fiche_produit_ELTPARAGRAPHE000206"></a>Nous allons maintenant modifier la fenêtre "FEN_Avancé_LISTE_Produits" pour afficher la fiche Produit que nous avons créée dans la leçon 2 de ce tuto.
...
### Test de la fenêtre
<a name="test_fenetre_ELTPARAGRAPHE000238"></a>Nous allons tester cette fenêtre sous le simulateur : 

1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Fen_RAD_Recherche_Go%20-%20HC%20N%B0001.jpg&type=thumb)
...
<a name="gestion_recherche_ELTTEXTE000792"></a>
...
10. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WM_GAF.jpg) parmi les boutons d'accès rapide.
...
13. Testez la fenêtre que nous venons de créer sous le simulateur (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide).
	...
	- Seule la liste des produits contenant "Polo" s'affiche. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20FEn_RAD_Recherche_Fin%20-%20HC%20N%B0002.jpg&type=thumb)
...
<a name="ameliorations_fenetre_ELTTEXTE000816"></a>
...
### Gestion du "Pull to refresh"
<a name="gestion_pull_refresh_ELTPARAGRAPHE000337"></a>Nous allons ajouter une nouvelle fonctionnalité à notre fenêtre : la gestion du "Pull to refresh". 
...
9. Enregistrez la fenêtre en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WM_GAF.jpg) parmi les boutons d'accès rapide.
...
## En résumé
<a name="resume_ELTTEXTE000879"></a>
**Projet corrigé**
