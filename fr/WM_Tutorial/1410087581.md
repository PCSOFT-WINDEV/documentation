...
<a name="lecon_6_imprimer_catalogue_produit_ELTTEXTE000482"></a>
...
## Présentation
<a name="presentation_ELTTEXTE000518"></a>
...
## Création de l'état
<a name="creation_etat_ELTTEXTE000551"></a>
...
5. Affichez les fichiers de données et sélectionnez le fichier de données "Produit". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0003.jpg&type=thumb)
Passez à l'étape suivante.
...
Pour plus de détails, consultez [Rupture dans un état](../WDChamp/1011028.md). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0006.jpg&type=thumb)
...
- Pour chaque rubrique, sélectionnez la ligne correspondante et utilisez les boutons fléchés à droite de la liste pour modifier sa position dans la liste. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0007.jpg&type=thumb)

11. Passez à l'étape suivante.

12. L'état affichant des rubriques de type numérique, cette étape permet de définir si des calculs doivent être effectués dans l'état. Dans notre exemple, aucun calcul ne doit être réalisé. Cliquez sur le bouton "Aucun calcul". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0008.jpg&type=thumb)
Passez à l'étape suivante. 

13. Cette étape permet de définir la mise en page de l'état. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0009.jpg&type=thumb)
...
15. Cette étape permet de sélectionner le gabarit utilisé pour l'état. Il est conseillé d'utiliser le même gabarit que pour les fenêtres. Dans notre cas, sélectionnez par exemple le gabarit "Material 3". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0010.jpg&type=thumb)
Passez à l'étape suivante.
...
18. L'état apparaît sous l'éditeur d'états.
	<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0012.jpg&type=thumb)
...
## Test de l'état
<a name="test_etat_ELTTEXTE000593"></a>
...
2. Dans la fenêtre de choix du mode d'impression, sélectionnez "Visualisateur de rapports". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0013.jpg)


3. Validez. L'état s'exécute et s'affiche à l'écran en mode "Aperçu". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0014.jpg&type=thumb)
...
<a name="modifications_etat_ELTTEXTE000626"></a>
...
<a name="suppression_des_libelles_ELTPARAGRAPHE000177"></a>Dans un état, le libellé d'un champ et son contenu sont indépendants. Par exemple, les informations correspondant à la description du produit sont affichées dans l'état par deux champs : 
...
<a name="modification_libelle_produit_ELTPARAGRAPHE000187"></a>Nous allons afficher le libellé du produit en police Arial 20.
...
<a name="photo_reference_description_produit_ELTPARAGRAPHE000202"></a>Sélectionnez les différents champs présents dans la page (Description, code-barres, prix, référence et date de réappro) et déplacez-les vers la moitié droite de l'état.
...
<a name="codebarres_produit_ELTPARAGRAPHE000213"></a>Le code-barres du produit apparaît dans l'état sous la forme d'un libellé. Nous allons le remplacer par un champ Code-barres. 
...
### Prix du produit
<a name="prix_produit_ELTPARAGRAPHE000229"></a>Pour le prix du produit, nous allons modifier le style de ce champ afin que le prix soit visible dans le catalogue : 
...
<a name="date_reapprovisionnement_produit_ELTPARAGRAPHE000244"></a>Modifiez le libellé du champ "Réappro." : 
...
### Test de l'état
<a name="test_etat_ELTPARAGRAPHE000266"></a>Vous obtenez l'état suivant sous l'éditeur :  <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_MP%20-%20Modification%20%E9tat%20-%20HC%20N%B0001.jpg&type=thumb)
Enregistrez l'état (Ctrl + S). 

L'état est terminé. Nous allons immédiatement le tester pour voir le résultat.

Exécutez cet état en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fen_WM_GAF.jpg) parmi les boutons d'accès rapide. 
...
<a name="lancement_impression_etat_par_programmation_ELTTEXTE000692"></a>
...
<a name="ajouter_une_option_dans_champ_zone_multiligne_ELTPARAGRAPHE000295"></a>Pour insérer une nouvelle option dans la fenêtre "FEN_Menu" :
...
<a name="parametrer_option_ajoutee_ELTPARAGRAPHE000315"></a>Pour modifier l'image de la troisième ligne du champ Zone multiligne :
...
3. Dans la fenêtre de description :
	...
	- Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Menu_Image_Editeur_noir.jpg) à droite du champ "Image". Dans le menu contextuel qui s'affiche, sélectionnez l'option "Catalogue" afin de choisir une image représentant l'action. 
...
<a name="programmation_impression_ELTPARAGRAPHE000354"></a>Nous allons changer le code WLangage utilisé pour la sélection du champ Zone multiligne. 
...
## En résumé
<a name="resume_ELTTEXTE000743"></a>
**Projet corrigé**
