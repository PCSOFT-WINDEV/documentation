...
<a name="lecon_3_dates_tableaux_structures_ELTTEXTE000176"></a>
...
Ouvrez si nécessaire le projet "WLangage" que vous avez créé dans la première leçon de ce tuto (consultez le paragraphe [Un projet pour découvrir le WLangage](../TutoWM/1410087570.md) de la leçon 1).
...
<a name="variables_type_date_heure_duree_ELTTEXTE000266"></a>
Le WLangage propose différents types de variables permettant de gérer les dates, les heures et les durées.


### Le type Date
<a name="type_date_ELTPARAGRAPHE000034"></a>Pour gérer les dates, le WLangage propose le type **Date**. De nombreuses fonctions et propriétés permettent de manipuler les dates.  
...
9. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Simu_PRJ_WM_GAF.jpg) parmi les boutons d'accès rapide. 
...
### Le type Heure
<a name="type_heure_ELTPARAGRAPHE000039"></a>De la même manière, il est possible de manipuler des heures grâce au type **Heure**. 
...
3. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Simu_PRJ_WM_GAF.jpg) parmi les boutons d'accès rapide. 
...
### Le type Durée
<a name="type_duree_ELTPARAGRAPHE000044"></a>Pour les durées, le même type de code peut être saisi. 
...
<a name="les_variables_type_tableau_ELTTEXTE000464"></a>
...
### Déclaration
<a name="declaration_ELTPARAGRAPHE000058"></a>La déclaration d'une variable de type tableau se fait de la façon suivante : 
...
<a name="remplissage_tableau_acces_aux_elements_ELTPARAGRAPHE000065"></a>Lors de sa déclaration, le tableau est vide. L'ajout d'éléments est réalisé par la fonction [&lt;Tableau&gt;.Ajoute](../WDLang1/1000024299.md) grâce à la syntaxe suivante : 
...
<a name="parcours_tableau_ELTPARAGRAPHE000072"></a>Pour parcourir les éléments d'un tableau, le WLangage propose deux méthodes : 
...
2. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Simu_PRJ_WM_GAF.jpg) parmi les boutons d'accès rapide.  
...
<a name="variables_type_structure_ELTTEXTE000694"></a>


### Le type Structure
<a name="type_structure_ELTPARAGRAPHE000088"></a>Une structure est un type de données personnalisé. Une structure regroupe des variables de types différents.
...
5. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Simu_PRJ_WM_GAF.jpg) parmi les boutons d'accès rapide.  
...
## En résumé
<a name="resume_ELTTEXTE000802"></a>
...
| [Leçon précédente](../TutoWM/1410087588.md) | [Sommaire](../TutoWM/1410087586.md) | [Leçon suivante](../TutoWM/1410087590.md) |
| --- | --- | --- |
