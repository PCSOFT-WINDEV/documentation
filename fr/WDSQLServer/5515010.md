...
## Programmation
<a name="programmation_ELTTEXTE000179"></a>


### 1. Ouverture de la connexion
<a name="1_ouverture_connexion_ELTPARAGRAPHE000017"></a>La fonction [SQLConnecte](../WDLang4/3072005.md) permet d'ouvrir une connexion à une base de données SQL Server par le Connecteur Natif. Il est nécessaire de passer en paramètre à la fonction [SQLConnecte](../WDLang4/3072005.md) le type de la base utilisée, ici SQL SERVER.
...
<a name="2_execution_requetes_ELTPARAGRAPHE000054"></a>L'exécution de requêtes est réalisée grâce à la fonction [SQLExec](../WDLang4/3072007.md). La fonction [SQLExec](../WDLang4/3072007.md) attend en paramètres le texte de la requête SQL et le nom qui sera donné à cette requête.
...
<a name="3_recuperation_resultat_ELTPARAGRAPHE000069"></a>Plusieurs modes de récupération du résultat sont disponibles :
...
<a name="4_fermeture_connexion_ELTPARAGRAPHE000089"></a>La fonction [SQLFerme](../WDLang4/3072015.md) permet de fermer la connexion à la base de données lorsque toutes les requêtes nécessaires ont été réalisées.
...
### SQL Azure
<a name="sql_azure_ELTPARAGRAPHE000102"></a>SQL Azure nécessite la présence d'un "clustered index" dans les fichiers de données.
