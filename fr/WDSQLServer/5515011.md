...
<a name="importation_structure_des_fichiers_ELTTEXTE000288"></a>
...
## Programmation
<a name="programmation_ELTTEXTE000318"></a>
...
<a name="2_execution_requetes_ELTPARAGRAPHE000144"></a>Les fonctions [HExécuteRequête](../WDLang4/3044080.md) et [HExécuteRequêteSQL](../WDLang4/3044084.md) permettent d'exécuter des requêtes sur la base de données en cours.
...
<a name="3_recuperation_resultat_ELTPARAGRAPHE000162"></a>Le parcours du résultat est réalisé avec toutes les fonctions de lecture classiques : [HLitPremier](../WDLang4/3044051.md), [HLitSuivant](../WDLang4/3044037.md), [HLitRecherche](../WDLang4/3044050.md), ...
...
<a name="4_fermeture_connexion_ELTPARAGRAPHE000180"></a>La fonction [HFermeConnexion](../WDLang4/3044095.md) permet de fermer la connexion à la base de données lorsque toutes les requêtes nécessaires ont été réalisées.
<a name="NOTE3_5"></a>


### Optimisation
<a name="optimisation_ELTPARAGRAPHE000190"></a>
...
### SQL Azure
<a name="sql_azure_ELTPARAGRAPHE000210"></a>SQL Azure nécessite la présence d'un "clustered index" dans les fichiers de données.
