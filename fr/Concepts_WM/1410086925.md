...
Les enregistrements du fichier de données étant chargés en mémoire, ce type de champ Table est conseillé pour les fichiers de données de moins de 100 000 enregistrements (pour éviter une saturation mémoire).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P66-Les%20champs%20Table%20Zone%20R%E9p%E9t%E9e-3.gif)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=logo_Windows_10.gif)<br> |  | Dans les applications Universal Windows 10 apps, le champ Table n'est pas disponible. Seul le champ Zone répétée peut être utilisé. |
