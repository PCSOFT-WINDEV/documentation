...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=exemple-WD.png)<br> | Exemple | WINDEV est livré en standard avec plusieurs exemples unitaires permettant de comprendre l'intérêt et l'utilisation des threads :<br><br>- Les threads (Pool),<br><br>- Les threads.<br><br><br> |
