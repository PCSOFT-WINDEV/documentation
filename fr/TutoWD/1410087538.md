...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Au fur et à mesure de la création de la requête, l'éditeur de requêtes de WINDEV crée les requêtes en langage naturel (et également en SQL). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Application%20compl%E8te%20-%20Graphe%20-%20HC%20N%B0002.jpg)<br>Vous pouvez ainsi vérifier que vous ne vous êtes pas trompé par rapport à l'objectif de votre requête. |
