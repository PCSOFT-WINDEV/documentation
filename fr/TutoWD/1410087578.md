...
<a name="que_vous_allez_apprendre_dans_cette_lecon_ELTTEXTE000225"></a>
...
| [Leçon précédente](../TutoWD/1410087513.md) | [Sommaire](../TutoWD/1410087560.md) | [Leçon suivante](../TutoWD/1410087514.md) |
| --- | --- | --- |
...
<a name="projet_pour_decouvrir_wlangage_ELTTEXTE000296"></a>
Dans la partie précédente, nous avons créé une petite application qui nous a permis de manipuler l'UI et le code. 
...
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=astuce.png) | Astuce | Pour créer un projet, vous pouvez également :<br><br>		1. Cliquer sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Cr%E9er1_GAF.jpg) parmi les boutons d'accès rapide.<br><br>		2. La fenêtre de création d'un nouvel élément s'affiche : cliquer sur "Projet".<br><br><br> |
	...
	8. Par défaut, WINDEV propose de créer ce projet dans le répertoire "\\Mes projets\\WLangage". Vous pouvez conserver cet emplacement ou le modifier grâce au bouton [...]. 
