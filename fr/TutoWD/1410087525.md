...
Un composant externe WINDEV est une brique applicative qui peut être réutilisée dans un nombre illimité de projets (et donc d'exécutables). ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Composant_PresentationGAF.gif)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | Pour partager du "code", il y a cinq méthodes principales avec WINDEV :<br><br>1. Les collections de procédures.<br><br>2. Les classes.<br><br>3. Les superchamps (à travers l'utilisation d'un dictionnaire).<br><br>4. Les composants externes.<br><br>5. Les composants internes.<br><br><br> |
...
- Nous allons maintenant créer notre composant. Pour cela, nous devons créer une configuration de projet.
	|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | Les configurations de projet permettent de créer à partir d'un même projet plusieurs "cibles" différentes :<br><br>	- Une application 32 bits,<br><br>	- Une application 64 bits,<br><br>	- Un composant,<br><br>	- ...<br><br><br>À tout moment, vous pouvez choisir la configuration sur laquelle vous travaillez et générer en une seule opération tous les éléments pour toutes les configurations d'un projet. |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0001.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0003.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0004.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0007.jpg&type=thumb)
...
- Testez la fenêtre : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Fenetre_WD_GAF.jpg)
 parmi les boutons d'accès rapide. Dans le champ de saisie, saisissez "Paris" (en respectant la casse) puis cliquez sur le bouton "Rechercher". La liste des clients s'affiche. 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0010.jpg)
