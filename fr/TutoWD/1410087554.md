...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=exemple-WD.png) | Exemple | WINDEV est livré en standard avec un exemple didactique permettant de comprendre l'utilisation des sockets : "WD Utilisation des sockets". Cet exemple est accessible depuis la page d'accueil de WINDEV (Ctrl + &lt;). |
