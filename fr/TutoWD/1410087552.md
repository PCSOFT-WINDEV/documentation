...
2. Cliquez sur le lien "Ajouter d'autres événements ..." : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Exemple%20Ev%E9nement%20-%20HC%20N%B0001%201.jpg)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Pour utiliser la fonction [Evénement](../WDLang1/3015011.md), il faut maîtriser la programmation Windows et notamment les événements Windows. |
...
- Lancez le test de la fenêtre "FEN_Fonction_Evénement". Cette fenêtre détecte si le champ Liste est manipulé avec la souris ou avec le clavier.
	...
	3. Un message s'affiche indiquant si la souris ou le clavier a été utilisé. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Exemple%20Ev%E9nement%20-%20HC%20N%B0002.jpg)
