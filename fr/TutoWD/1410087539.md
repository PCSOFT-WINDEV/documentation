...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0004.jpg&type=thumb)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=exemple-WD.png)<br> | Exemple | Pour plus de détails sur la gestion des emails, consultez l'exemple "WD Mail" (exemple complet), livré en standard avec WINDEV. Cet exemple est accessible depuis la page d'accueil de WINDEV (Ctrl + &lt;). |
...
- Pour créer le champ de saisie correspondant au mot de passe de l'utilisateur :
	...
	4. Cliquez sous le champ "Utilisateur" : le champ de saisie est automatiquement créé.
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=astuce.png)<br> | Astuce | Le champ de saisie "Mot de passe" apparaît sous l'éditeur avec une puce et un oeil.<br><br>En exécution, lorsque l'utilisateur saisira son mot de passe, les caractères seront remplacés par des puces. Un clic sur l'oeil permettra de voir le mot de passe saisi en clair : l'utilisateur pourra ainsi vérifier son mot de passe.<br><br> |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0001.jpg)


	3. Enregistrez la fenêtre (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Enregistrer_GAF.jpg)
 ou Ctrl + S).
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0002.jpg&type=thumb)
...
- Enregistrez la fenêtre et son code (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Enregistrer_GAF.jpg)
 ou Ctrl + S).
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0003.jpg&type=thumb)


	4. Appuyez à nouveau sur la touche F5 pour faire disparaître les numéros.

5. Enregistrez la fenêtre (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Enregistrer_GAF.jpg)
 ou Ctrl + S).
...
- Lancez le test du projet (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD_GAF.jpg)
 parmi les boutons d'accès rapide) et l'ouverture de la fenêtre d'envoi d'emails via l'option "Menu .. Envoyer un email". 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0004.jpg&type=thumb)
