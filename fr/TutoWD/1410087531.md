...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=vierge.png)<br> | Express | Le Gestionnaire de Sources n'est pas disponible dans la version Express. |
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=exemple-WD.png)<br> | Corrigé | **Un projet corrigé est disponible. Ce projet permet d'effectuer les différentes manipulations de cette leçon.** Pour ouvrir le projet corrigé, dans la page d'accueil, cliquez sur "Tutoriel" puis dans la zone "Partie 4 - Application complète avec données", double-cliquez sur "Application complète - Corrigé". |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0001.jpg&type=thumb)
Nous n'avons pas précédemment créé de base de sources. Nous allons donc en créer une.
			...
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | L'utilisation d'une base de sources au format HFSQL Client/Serveur permet d'utiliser cette base de sources à distance. |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0002.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0003.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0004.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0005.jpg&type=thumb)


3. Dans l'écran qui s'affiche, indiquer si nécessaire la connexion et le répertoire local : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0006.jpg&type=thumb)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | Les prochaines ouvertures d'un projet géré par le GDS sont identiques aux ouvertures d'un projet non géré par le GDS : il suffit d'ouvrir le projet (fichier ".WDP") correspondant à la copie locale. |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0007.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0008.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0009.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0010.jpg&type=thumb)
...
<a name="synchronisation_projet_ELTPARAGRAPHE000444"></a>Plusieurs options permettent de configurer un projet manipulé avec le GDS. Ces options sont regroupées dans l'onglet "GDS" de la description du projet (affichée par un clic sur "Description" sous le volet "Projet"). 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0011.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0012.jpg&type=thumb)
