...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=vierge.png)<br> | Express | Le logiciel "Etats et Requêtes" n'est pas disponible dans la version Express. |
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | Le logiciel "Etats et Requêtes" est gratuit et librement redistribuable avec vos applications créées avec WINDEV. Consultez la licence pour plus de détails sur les conditions de redistribution. |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Diffuser%20EtatsRequetes%20-%20HC%20N%B0001%201.jpg&type=thumb)
...
- Ouvrez l'analyse de votre projet : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Analyse_GAF.jpg)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | A partir du logiciel "Etats et Requêtes", l'utilisateur ne peut pas ajouter, modifier ou supprimer des enregistrements (les fonctions [HAjoute](../WDLang4/3044147.md), [HModifie](../WDLang4/3044042.md) et [HSupprime](../WDLang4/3044018.md) sont interdites). Il n'est également pas possible de créer ou de re-créer des fichiers de données (les fonctions [HCréation](../WDLang4/3044255.md) et [HCréationSiInexistant](../WDLang4/3044254.md) sont interdites). |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Diffuser%20EtatsRequetes%20-%20HC%20N%B0002.jpg&type=thumb)
...
- Pour créer le programme d'installation de votre application WD Application Complète :
	...
	2. Sélectionnez "Créer l'exécutable maintenant". La création de l'exécutable est réalisée.
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | Si l'assistant propose la création du fichier d'aide, validez les différents messages. |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Diffuser%20EtatsRequetes%20-%20HC%20N%B0004.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Diffuser%20EtatsRequetes%20-%20HC%20N%B0005.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Diffuser%20EtatsRequetes%20-%20HC%20N%B0006.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Diffuser%20EtatsRequetes%20-%20HC%20N%B0007.jpg&type=thumb)
