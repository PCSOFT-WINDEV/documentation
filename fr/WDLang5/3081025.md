...
|   |   |
| --- | --- |
| *XMLAvecNamespace* | Recherche sur les éléments contenant un namespace.<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
...
<a name="recherche_parcours_document_xml_ELTPARAGRAPHE000141"></a>La fonction **XMLRecherche** débute la recherche à partir de la position courante dans le document XML. Pour effectuer une recherche dans tout le document, il est conseillé d'utiliser la fonction [XMLRacine](../WDLang5/3081019.md) avant d'utiliser la fonction **XMLRecherche**.
...
<a name="fonctions_xml_threads_ELTPARAGRAPHE000332"></a>Si votre application utilise des threads, le document XML est partagé entre tous ces threads. Pour plus de détails sur la gestion des threads, consultez [Gestion des threads](../WDLang1/3077026.md).
...
<a name="suppression_lors_une_recherche_ELTPARAGRAPHE000195"></a>La fonction [XMLSupprime](../WDLang5/3081036.md) utilisée lors d'une recherche annule la recherche. 
...
[XMLAnnuleRecherche (Fonction)](../WDLang5/3081001.md)
