...
<a name="lecture_nom_element_courant_ELTPARAGRAPHE000076"></a>Pour lire le nom de l'élément courant, utilisez la fonction [XMLNomElément](../WDLang5/3081026.md).
<a name="NOTE0_2"></a>


### Enregistrer les modifications dans le fichier XML
<a name="enregistrer_les_modifications_dans_fichier_xml_ELTPARAGRAPHE000086"></a>Pour enregistrer les modifications effectuées dans un fichier XML, vous devez :
