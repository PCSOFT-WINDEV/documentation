...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) **dans le visualisateur de rapports** ([syntaxe 2](#SYNTAXE7)). L'utilisateur peut ainsi visualiser le résultat de l'impression à l'écran, page par page. Dans ce visualisateur, il est possible de :
...
- **directement dans un fichier** texte, HTM, RTF, PDF, PRN ou XML ([syntaxe 3](#SYNTAXE3)).
	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Pour obtenir une impression identique lors du développement et sur le site déployé, il est conseillé de réaliser des impressions génériques (par exemple avec les constantes *iPDFGénérique*, ...).
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Dans cette version, l'impression se fait uniquement dans un fichier PDF.
...
| *iXLS* | Impression directe dans un fichier XLS. Le fichier a pour nom &lt;Nom de l'état&gt;.XLS (où &lt;Nom de l'état&gt; correspond au nom de l'état défini sous l'éditeur d'états). Ce fichier est créé dans le répertoire de l'application. <br>Si le paramètre &lt;Nom du fichier à créer&gt; est précisé, le nom du fichier sera &lt;Nom du fichier à créer&gt;.XLS. Aucun aperçu ne sera affiché.<br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Si le répertoire du fichier n'est pas précisé, le fichier est généré dans le répertoire des données du site. Ce répertoire est paramétrable grâce à l'outil WDCOMPTE. Ce répertoire peut être connu grâce à la fonction [fRepDonnées](../WDLang1/3036001.md). Il est conseillé d'utiliser la fonction [iDernierFichier](../WDLang5/3046068.md) pour ouvrir le dernier fichier généré.<br><br>![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
...
| *iXML* | Impression directe dans un fichier XML. Le fichier a pour nom &lt;Nom de l'état&gt;.XML (où &lt;Nom de l'état&gt; correspond au nom de l'état défini sous l'éditeur d'états). Ce fichier est créé dans le répertoire de l'application. <br>Si le paramètre &lt;Nom du fichier à créer&gt; est précisé, le nom du fichier sera &lt;Nom du fichier à créer&gt;.XML. Aucun aperçu ne sera affiché.<br><br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Si le répertoire du fichier n'est pas précisé, le fichier est généré dans le répertoire des données du site. Ce répertoire est paramétrable grâce à l'outil WDCOMPTE. Ce répertoire peut être connu grâce à la fonction [fRepDonnées](../WDLang1/3036001.md). Il est conseillé d'utiliser la fonction [iDernierFichier](../WDLang5/3046068.md) pour ouvrir le dernier fichier généré.<br><br>![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
...
<a name="SYNTAXE8"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Etats et Requêtes](https://doc.pcsoft.fr/ext/images/fr/ER.png) 
...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Si aucune imprimante n'est connectée au serveur, une imprimante fictive est utilisée.
...
<a name="NOTE0_8"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Code Utilisateur (MCU)](https://doc.pcsoft.fr/ext/images/fr/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/fr/AJAX.png) 
