...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003081036&name=xmlsupprime_fonction">Voir des exemples supplémentaires</a>
...
### Position courante
<a name="position_courante_ELTPARAGRAPHE000079"></a>Après la suppression, la position courante est déplacée vers le parent de l'élément supprimé.
<a name="NOTE0_2"></a>


### Suppression lors d'une recherche
<a name="suppression_lors_une_recherche_ELTPARAGRAPHE000086"></a>La fonction **XMLSupprime** utilisée lors d'une recherche annule la recherche. Exemple à ne pas faire (ce code ne fonctionne pas) :
