...
<a name="gerer_les_contacts_google_ELTPARAGRAPHE000041"></a>Pour gérer les contacts Google : 
...
<a name="creer_contact_google_ELTPARAGRAPHE000061"></a>Un contact Google peut être créé soit par l'interface de Google, soit par programmation à l'aide des fonctions WLangage.
...
3. Validez la création du contact grâce à la fonction [GglEcrit](../WDLang5/1000017401.md).
...
### Remarque
<a name="remarque_ELTPARAGRAPHE000085"></a>Si vous utilisez un proxy pour accéder à Internet, il est nécessaire de configurer le proxy (fonction [Proxy](../WDLang3/3043002.md)) pour utiliser les fonctions Google.
...
2. Utilisez la fonction [GglListeContact](../WDLang5/1000017344.md). Cette fonction permet de lister les contacts. Les contacts trouvés sont affectés au tableau de variables de type gglContact.
...
### Principe
<a name="principe_ELTPARAGRAPHE000125"></a>Le principe est simple : Il est nécessaire de rechercher et de se positionner sur le contact à modifier ou à supprimer avant de réaliser l'opération voulue.
<a name="NOTE4_2"></a>
...
3. Supprimez le contact grâce à la fonction [GglSupprime](../WDLang5/1000017402.md).
...
[Gestion des contacts Google (syntaxe préfixée)](../WDLang5/1000017761.md)
