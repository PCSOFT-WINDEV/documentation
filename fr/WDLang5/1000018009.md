...
<a name="proprietes_specifiques_description_des_variables_type_gglconnexion_ELTPARAGRAPHE000027"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une connexion Google :
...
<a name="prerequis_pour_authentification_oauth_20_ELTPARAGRAPHE000208"></a>Pour se connecter avec l'authentification OAuth 2.0, il est nécessaire de déclarer l'application sur votre console développeur Google : [https://developers.google.com/console](https://developers.google.com/console). 
Dans la console : 
...
<a name="fonctions_utilisant_une_variable_type_gglconnexion_ELTPARAGRAPHE000078"></a>Toutes les fonctions de communication avec les services Google prennent en paramètre une variable de type **gglConnexion**.
...
<a name="fonctions_syntaxe_prefixee_manipulant_des_variables_type_gglconnexion_ELTPARAGRAPHE000086"></a>
