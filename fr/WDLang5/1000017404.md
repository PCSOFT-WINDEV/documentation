...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000017572&name=gglrecuperecarte_fonction">Voir des exemples supplémentaires</a>
...
<a name="enregistrement_carte_google_ELTPARAGRAPHE000240"></a>Pour enregistrer la carte Google dans un fichier, il est possible de :
...
<a name="cle_pour_google_static_map_ELTPARAGRAPHE000267"></a>
...
<a name="cas_erreurs_possibles_ELTPARAGRAPHE000286"></a>Il est possible que le service de cartographie Google Maps ne puisse renvoyer une image valide selon la localisation ou le zoom demandé.
