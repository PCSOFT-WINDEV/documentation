...
- l'affichage ou non des volets (et des boutons présents) du ruban. Pour plus de détails, consultez [Visualisateur de rapports](../WDChamp/1011085.md).
...
- Si l'application autorise le lancement du logiciel "Etats & Requêtes" livré avec WINDEV, 2 boutons supplémentaires peuvent apparaître dans le visualisateur de rapports. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Apercu_impression%20-%20HC%20N%B0002%201.gif)
