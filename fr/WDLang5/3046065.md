...
**Remarque** : Ces fonctions sont également disponibles en syntaxe préfixée ([Fonctions d'impression (syntaxe préfixée)](../WDLang5/1410090033.md)).

<a name="NOTE1"></a>
<a name="NOTE1_1"></a>


![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Attention : Seule l'impression au format PDF est disponible. 
