...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) La liste des attributs est triée par ordre alphabétique. Cet attribut est donc ajouté selon l'ordre alphabétique.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Attention : Il n'est pas possible de créer des éléments (balise ou attribut) avec des caractères accentués. 
