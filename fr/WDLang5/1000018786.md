...
| Nom | Chaîne de caractères Unicode | Nom du noeud.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Attention : Il n'est pas possible de créer des éléments (balise ou attribut) avec des caractères accentués. |
