...
- La position verticale en cours lors de l'impression d'une chaîne de caractères pointe sur le haut de la chaîne. La position basse dépend de la hauteur des polices utilisées dans la ligne à imprimer.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=iImprime.gif)
