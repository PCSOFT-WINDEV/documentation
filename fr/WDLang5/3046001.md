...
- l'affichage ou non des volets (et des boutons présents) du ruban. Pour plus de détails, consultez [Aperçu avant impression](../WDChamp/1011085.md).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Apercu_Volet_Apercu.gif)
...
- Si l'application autorise le lancement du logiciel "Etats & Requêtes" livré avec WINDEV, 2 boutons supplémentaires peuvent apparaître dans l'aperçu avant impression. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=icone_Apercu_EtatRequete.gif)
