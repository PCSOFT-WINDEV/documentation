...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png)<br> | Important | Si la requête est créée avec l'éditeur d'états utilisateur, il n'est pas nécessaire d'utiliser la fonction **&lt;Etat&gt;.InitRequêteConnexion** pour  spécifier les paramètres de la requête. En effet, lors de l'exécution d'un état sur une requête paramétrée depuis l'éditeur d'états utilisateur, une fenêtre s'affiche permettant de saisir les paramètres de la requête. |
