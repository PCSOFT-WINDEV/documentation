...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png) Le service Google Maps permet également d'obtenir les coordonnées d'une adresse. Vous pouvez utiliser cette fonctionnalité grâce à la fonction WLangage [GglAdresseVersCoordonnées](../WDLang5/1000017568.md).
