...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Le type **CodeBarres** est utilisé principalement : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Le type **CodeBarres** est utilisé principalement : 
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Le type **CodeBarres** est utilisé principalement : 
...
<a name="proprietes_specifiques_description_des_variables_type_codebarres_ELTPARAGRAPHE000093"></a>Les propriétés suivantes peuvent être utilisées pour manipuler un code-barres :
