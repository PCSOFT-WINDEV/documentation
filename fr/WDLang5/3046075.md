...
<a name="gestion_parametre_ELTPARAGRAPHE000101"></a>Lorsque le paramètre &lt;Position Verticale&gt; est précisé dans la fonction **iPosY**, la fonction effectue deux actions en même temps :
...
<a name="combinaison_positions_ELTPARAGRAPHE000130"></a>Lors de la combinaison de positions, des effets inattendus peuvent être observés. Par exemple, le code :
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=PosY_1.GIF)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=PosY_2.GIF)
...
### Divers
<a name="divers_ELTPARAGRAPHE000199"></a>La fonction **iPosY** ne doit pas être utilisée dans un paramètre de la fonction [iImprimeMot](../WDLang5/3046034.md).
