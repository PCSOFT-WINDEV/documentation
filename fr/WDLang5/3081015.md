...
- dans un document XML.
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Non disponible.
...
## Syntaxe
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Syntaxe non disponible en PHP et en code navigateur
...
<a name="SYNTAXE2"></a>
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Syntaxe non disponible en Android et Android Widget
...
<a name="syntaxe_2_executer_une_requete_xpath_sur_document_xml_lecture_resultat_requete_ELTPARAGRAPHE000179"></a>Si la fonction **XMLExécuteXPath** renvoie <u><u><u><u>Vrai</u></u></u></u>, la requête a été correctement exécutée. Le résultat de la requête peut être lu de la manière suivante :
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000282"></a>
...
<a name="fonctions_xml_threads_ELTPARAGRAPHE000470"></a>Si votre application utilise des threads, le document XML est partagé entre tous ces threads. Pour plus de détails sur la gestion des threads, consultez [Gestion des threads](../WDLang1/3077026.md).
...
[&lt;Variable xmlDocument&gt;.ExécuteXPath (Fonction)](../WDLang5/1000023893.md)
