...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png) | Important | Avec le logiciel Etats & Requêtes, il est possible d'imprimer un état via une des solutions suivantes :<br><br>- en lançant une impression (icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_Imprimer.gif)).<br><br>- en testant l'état (icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_Go_Fenetre_WD_bl.gif)).<br><br><br>Il n'est donc pas nécessaire de programmer l'impression de l'état.<br><br>Pour que l'impression d'états réalisés avec le logiciel Etats & Requêtes soit possible directement à partir d'une application WINDEV, le fournisseur de l'application WINDEV doit prévoir cette fonctionnalité dans son application.<br><br>Le fournisseur peut par exemple intégrer une fenêtre permettant à l'utilisateur final de :<br><br>- sélectionner un état réalisé avec le logiciel Etats & Requêtes.<br><br>- lancer l'exécution de cet état.<br><br><br> |
...
<a name="principe_impression_etat_ELTPARAGRAPHE000382"></a>La fonction **&lt;Etat&gt;.Imprime** lit la source de données de l'état (fichiers de données, requête, champ Table, ...). Pour chaque enregistrement, la fonction **&lt;Etat&gt;.Imprime** imprime le bloc *Corps*. Les autres blocs sont imprimés uniquement lorsque nécessaire :
...
<a name="etat_avec_borne_minimale_maximale_ELTPARAGRAPHE000404"></a>Si l'état a été créé sous l'éditeur d'états en spécifiant des bornes minimales et maximales, les deux premiers paramètres passés à l'état grâce à la fonction **&lt;Etat&gt;.Imprime** doivent correspondre respectivement à la borne minimale et à la borne maximale.
...
<a name="destination_impression_ELTPARAGRAPHE000447"></a>Il est possible de choisir la destination de l'impression de l'état grâce à la fonction [iDestination](../WDLang5/3046074.md).
...
<a name="passage_parametres_ELTPARAGRAPHE000472"></a>Les paramètres indiqués par la fonction **&lt;Etat&gt;.Imprime** correspondent aux paramètres définis dans le code d'ouverture de l'état à l'aide de la syntaxe suivante :
...
<a name="imprimer_etat_composant_ELTPARAGRAPHE000497"></a>Pour imprimer un état d'un composant, il suffit d'utiliser directement le nom de l'état du composant (le composant étant intégré dans le projet). Par exemple :
...
### Etats imbriqués
<a name="etats_imbriques_ELTPARAGRAPHE000529"></a>Il est possible d'appeler la fonction **&lt;Etat&gt;.Imprime** au sein même d'un état. Pour plus de détails, consultez l'aide sur les [Etats imbriqués](../WDChamp/1011001.md).
