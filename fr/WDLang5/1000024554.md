...
<a name="principe_impression_etat_ELTPARAGRAPHE000345"></a>La fonction **&lt;Etat&gt;.Imprime** lit la source de données de l'état (fichiers de données, requête, champ Table, etc.). Pour chaque enregistrement, la fonction **&lt;Etat&gt;.Imprime** imprime le bloc *Corps*. Les autres blocs sont imprimés uniquement lorsque nécessaire :
...
<a name="etat_avec_borne_minimale_maximale_ELTPARAGRAPHE000367"></a>Si l'état a été créé sous l'éditeur d'états en spécifiant des bornes minimales et maximales, les deux premiers paramètres passés à l'état grâce à la fonction **&lt;Etat&gt;.Imprime** doivent correspondre respectivement à la borne minimale et à la borne maximale.
...
<a name="execution_une_requete_etat_base_sur_cette_requete_ELTPARAGRAPHE000390"></a>Lors de l'impression d'un état basé sur une requête, si la requête a déjà été exécutée, elle n'est pas ré-exécutée. Pour forcer la ré-exécution de la requête (ajout d'enregistrements par exemple), il suffit d'utiliser les fonctions [&lt;Source&gt;.ExécuteRequête](../WDLang4/1000024944.md) ou [&lt;Etat&gt;.InitRequête](../WDLang5/1000025143.md).
<a name="NOTE0_4"></a>


### Destination de l'impression
<a name="destination_impression_ELTPARAGRAPHE000410"></a>Il est possible de choisir la destination de l'impression de l'état grâce à la fonction [iDestination](../WDLang5/3046074.md).
...
<a name="passage_parametres_ELTPARAGRAPHE000435"></a>Les paramètres indiqués par la fonction **&lt;Etat&gt;.Imprime** correspondent aux paramètres définis dans le code d'ouverture de l'état à l'aide de la syntaxe suivante :
...
<a name="imprimer_etat_composant_ELTPARAGRAPHE000461"></a>Pour imprimer un état d'un composant, il suffit d'utiliser directement le nom de l'état du composant (le composant étant intégré dans le projet). Par exemple :
...
### Etats imbriqués
<a name="etats_imbriques_ELTPARAGRAPHE000493"></a>Il est possible d'appeler la fonction **&lt;Etat&gt;.Imprime** au sein même d'un état. Pour plus de détails, consultez l'aide sur les [Etats imbriqués](../WDChamp/1011001.md).
