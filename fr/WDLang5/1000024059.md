...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Cette fonction ne peut pas être utilisée pour un état programmé (créé avec les fonctions d'impression iXXX). 
<a name="Exemple1"></a>
