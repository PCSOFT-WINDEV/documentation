...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) à l'aide de l'appareil photo d'un téléphone Android et récupérées dans une application Android.

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) à l'aide de l'appareil photo d'un iPhone ou iPad et récupérées dans une application iOS. Pour les codes-barres de type QR Code, il est également possible de lire un code-barres présent dans une image.
