...
- ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WDFactur-X.gif) ***Exemples didactiques (WINDEV)*** : **WD Factur-X** <br>Cet exemple didactique présente la construction d'une facture au format PDF compatible avec la norme Factur-X incluant un fichier XML en pièce jointe.
