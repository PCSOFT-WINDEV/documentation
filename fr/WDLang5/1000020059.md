...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Ce paramètre peut correspondre uniquement au nom logique de l'état.
...
<a name="initialisation_des_sources_donnees_des_etats_enchaines_ELTPARAGRAPHE000069"></a>Les états ne sont pas exécutés au moment de l'exécution de la fonction **iEnchaînementAjoute** : seul leur nom et leurs paramètres sont mémorisés. 
...
<a name="gestion_des_numeros_pages_ELTPARAGRAPHE000090"></a>Si les états présents dans l'enchaînement affichent le numéro de page, les numéros de page se suivront pour les différents états enchaînés. 
...
<a name="utilisation_variables_globales_ELTPARAGRAPHE000102"></a>Les états enchaînées peuvent manipuler des variables globales dans les différents événements WLangage associés à l'état. Dans ce cas, la valeur de la variable globale prise en compte est celle correspondant à l'impression ou à la prévisualisation effective. 
