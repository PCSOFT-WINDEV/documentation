...
Lors du déploiement, il faut **exclure** du déploiement les fichiers de données HFSQL "Transaction" qui contiennent les transactions de tests effectuées en local : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CLF_Paiement_securise_Ato2.gif)
