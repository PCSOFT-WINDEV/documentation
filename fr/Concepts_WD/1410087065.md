...
Par exemple, un diagramme peut représenter la gestion des stocks.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_UML_Diagramme_de_classe%20-%20HC%20N%B0001.gif)
...
- **Relation** : décrit le comportement des classes entre elles. Trois types de relations existent :
	...
	- *Généralisation* : Relation entre une classe générale (parent) et une classe spécifique (enfant) qui en dérive. Par exemple, les classes Bateau à voile et Bateau à moteur sont dérivées de la classe Bateau.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_UML_Diagramme_de_classe2%20-%20HC%20N%B0001.gif)
...
Par exemple, le diagramme suivant représente le début d'une communication téléphonique :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_UML_Diagramme_sequence%20-%20HC%20N%B0001.gif)
