...
<a name="test_projet_java_sous_editeur_ELTPARAGRAPHE000100"></a>Lors du test d'un projet Java (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_GO_Projet_WB_bl.gif)), le projet est compilé et lancé sous Windows. Le projet n'est pas compilé en Java.
