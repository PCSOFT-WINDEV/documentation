...
Ce code reprend toutes les possibilités que nous avons vu pour les dates, et les applique aux heures. 
	...
	3. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WB_GAF.jpg)
 parmi les boutons d'accès rapide.  
...
- Dans le cas d'une boucle classique de type POUR .. A .., il est nécessaire de donner la valeur de l'indice de départ (1) et de l'indice d'arrivée. 
	...
	2. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WB_GAF.jpg)
 parmi les boutons d'accès rapide.  
