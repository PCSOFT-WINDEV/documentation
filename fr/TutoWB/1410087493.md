...
- Pour créer une page listant les nouveaux produits :
	...
	1. Créez une nouvelle page :
		...
		- Dans l'assistant de création d'une nouvelle page, cliquez sur la page prédéfinie "Simple". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%201%20-%20HC%20N%B0001.jpg&type=thumb)
...
- Cette page doit pouvoir être référencée. Pour cela, elle doit être générée en mode AWP :
	...
	2. Dans l'onglet "Général", dans la zone "Type de page", pour l'option "Mode", sélectionnez "AWP". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%201%20-%20HC%20N%B0002.jpg&type=thumb)


	3. Validez.

4. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg) parmi les boutons d'accès rapide.
...
- Pour créer le champ Zone répétée :
	...
	3. Dans l'assistant, sélectionnez l'option "Remplir le champ Zone répétée par programmation". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%201%20-%20HC%20N%B0003.jpg&type=thumb)
Passez à l'étape suivante. 
	...
	4. Dans l'étape suivante, nous allons sélectionner des paramètres supplémentaires pour la création du champ Zone répétée :
		...
		- Le champ Zone répétée utilise un nombre de répétitions infini. En effet, tous les produits doivent être accessibles directement dans la page. La page va s'agrandir afin d'afficher tous les produits.
						Sélectionnez "Pas de limite" dans la zone "Nombre maximum de répétitions par page". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%201%20-%20HC%20N%B0004.jpg&type=thumb)
...
- Réduisez à l'aide des poignées la largeur de la cellule principale afin que les 5 cellules rentrent en largeur dans la page. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%202%20-%20HC%20N%B0007.jpg&type=thumb)
...
- Pour créer le champ Image :
	...
	3. Cliquez en haut à gauche de la première répétition du champ Zone répétée. Le champ Image est créé. A l'aide des poignées de sélection, agrandissez la taille du champ. Vous obtenez la page suivante : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%202%20-%20HC%20N%B0006.jpg&type=thumb)
...
- Pour créer le champ Lien :
	...
	2. Cliquez dans le champ Zone répétée, en dessous du champ Image pour créer le champ Lien. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%202%20-%20HC%20N%B0005.jpg&type=thumb)
...
- Pour créer le champ Libellé contenant l'identifiant du produit :
	...
	2. Cliquez dans le champ Zone répétée, à droite du champ Image pour créer le champ Libellé. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%202%20-%20HC%20N%B0004.jpg&type=thumb)
...
- Pour créer des attributs :
	...
	3. Créez un nouvel attribut en cliquant sur le bouton "Nouveau" :
		...
		- Sélectionnez la propriété "Valeur". En effet, la valeur de l'image sera modifiée à chaque répétition. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%202%20-%20HC%20N%B0003.jpg&type=thumb)
...
- Nous allons tout de suite tester la page que nous venons de créer.
	...
	2. La page apparaît automatiquement dans le navigateur. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20Nouveaut%E9s%20-%202%20-%20HC%20N%B0001.jpg&type=thumb)
...
- Comme pour la page de la liste des nouveautés, cette page doit être générée en mode AWP :
	...
	2. Dans la zone "Type de page", sélectionnez le mode "AWP". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20D%E9tails%20-%20HC%20N%B0010.jpg&type=thumb)
...
- Pour créer le champ Image :
	...
	2. Cliquez dans la page (par exemple en haut à gauche). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20D%E9tails%20-%20HC%20N%B0009.jpg&type=thumb)
...
- Pour créer le champ Libellé simple permettant d'afficher le libellé du produit :
	...
	2. Cliquez dans la page (par exemple à droite de l'image). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20D%E9tails%20-%20HC%20N%B0008.jpg&type=thumb)

			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Pour simplifier le positionnement des champs, appuyez sur la touche F7. Un appui sur cette touche permet de voir la zone occupée par le champ, un second appui sur cette touche permet d'afficher un liseré autour du champ (uniquement en édition).<br><br>Il est ainsi possible de visualiser le cadre du champ et ainsi de positionner simplement les champs les uns par rapport aux autres.<br><br>Cette fonctionnalité est très utile pour les champs qui n'ont pas de bordure. |
...
- Nous allons afficher la description du produit dans un champ Libellé riche (appelé Zone de Texte Riche). Pour créer ce champ :
	...
	2. Cliquez dans la page (par exemple à droite de l'image, en dessous du champ LIB_Titre). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20D%E9tails%20-%20HC%20N%B0007.jpg&type=thumb)
...
- Pour créer un champ d'affichage formaté :
	...
	1. Sous le volet "Création", dans le groupe "Champs usuels", déroulez "Texte" et sélectionnez "Champ d'affichage formaté". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Affichage%20format%E9%20-%20HC%20N%B0001.jpg)
...
- Nous allons modifier les caractéristiques de ce champ :
	...
	2. Dans l'onglet "Général" :
		...
		- Modifiez le type du champ : sélectionnez "Monétaire". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Affichage%20format%E9%20-%20HC%20N%B0002.jpg&type=thumb)
...
- Pour lier le champ "IMG_Image_Produit" à la rubrique correspondante :
	...
	5. Sélectionnez la rubrique "Visuel" du fichier de données "Produit". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20D%E9tails%20-%20HC%20N%B0005.jpg&type=thumb)
...
- Nous allons tout d'abord modifier la page "PAGE_Liste_des_nouveautes" afin que le champ Lien ouvre la page de description du produit.
	...
	3. Dans l'onglet "Général" de la fenêtre de description, dans la zone "Action du lien" : 
		...
		- Sélectionnez la page "PAGE_Details_du_produit". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20D%E9tails%20-%20HC%20N%B0002.jpg&type=thumb)
...
5. Déroulez la valeur correspondant au paramètre "NumProduitAAfficher" et sélectionnez "ATT_ID" : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20D%E9tails%20-%20HC%20N%B0003.jpg&type=thumb)
...
- Nous allons réaliser un test pour vérifier que tout fonctionne.
	...
	4. Cliquez sur le lien pour afficher le détail d'un produit. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20D%E9tails%20-%20HC%20N%B0004.jpg&type=thumb)
...
- Pour importer la feuille de styles CSS dans le projet :
	...
	2. L'assistant d'importation se lance et propose deux options : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Import%20CSS%20-%20HC%20N%B0001.jpg&type=thumb)
...
4. Sélectionnez le fichier "stylesperso.css". Ce fichier est disponible dans le répertoire "\\Tutoriel\\WB\\Exercices\\Site_WEBDEV_Complet". Les différents styles contenus dans la feuille de styles sont affichés. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Import%20CSS%20-%20HC%20N%B0002.jpg&type=thumb)
...
3. Dans l'onglet "Style" :
	...
	- Sélectionnez le style "class-styleprix" dans la liste "Style CSS" : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Import%20CSS%20-%20HC%20N%B0003.jpg&type=thumb)
...
6. Enregistrez les modifications (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg) ou Ctrl + S).
...
- Nous allons réaliser un test pour vérifier que tout fonctionne.
	...
	4. Cliquez sur le lien pour afficher le détail d'un produit. Le prix est désormais affiché en rouge.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Import%20CSS%20-%20HC%20N%B0004.jpg&type=thumb)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=exemple-WB.png) | Attention ! | Les manipulations suivantes peuvent être réalisées uniquement si vous avez suivi la partie 3 de ce tutoriel concernant la création des pages Intranet. |
...
- Pour créer un lien "Administration" :
	...
	4. Modifiez le libellé du champ : Administration.
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=astuce.png) | Astuce | Dans vos développements, nous vous conseillons de toujours bien nommer vos éléments (par exemple ici, nommez le champ Lien “LIEN_Administration”). Le code est ainsi plus lisible. |
	...
	6. Validez.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Liaison%20site%20dynamique%20-%20HC%20N%B0001.jpg&type=thumb)
...
- Nous allons maintenant saisir le code WLangage associé à ce champ Lien :
	...
	5. Dans le bandeau du modèle, cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Ico_Rafrachir_Mod%E8le.jpg) pour propager les modifications du modèle à toutes les pages utilisant ce modèle.
...
- Nous allons maintenant modifier la page "PAGE_Liste_des_produits" pour qu'elle puisse être ouverte par la fonction [SiteDynamiqueAffiche](../WDLang2/3058024.md) :
	...
	3. Dans l'onglet "Général", cochez l'option "Accessible par la fonction SiteDynamiqueAffiche".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Liaison%20site%20dynamique%20-%20HC%20N%B0002.jpg)
...
- Nous allons maintenant lancer le test du projet via les pages AWP.
	...
	3. La page apparaît automatiquement dans le navigateur.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Liaison%20site%20dynamique%20-%20HC%20N%B0004.jpg&type=thumb)


	4. Cliquez sur le lien "Administration". La page de gestion des produits apparaît.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Liaison%20site%20dynamique%20-%20HC%20N%B0003.jpg&type=thumb)
...
- Maintenant, nous allons afficher les conditions générales de ventes dans le champ. Nous avons préparé le fichier contenant le texte.
	...
	5. Effectuez quelques modifications dans le texte :
		...
		- Passez en gras les titres des différents points.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Site%20Internet%20-%20Page%20CGV%20-%20HC%20N%B0001.jpg&type=thumb)
