...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=exemple-WB.png)<br> | Corrigé | Un projet corrigé est disponible. Ce projet contient déjà le résultat des différentes manipulations effectuées dans cette leçon. Pour ouvrir le projet corrigé, dans la page d'accueil, cliquez sur "Tutoriel" puis dans la zone "Partie 3 à 6", double-cliquez sur "Site WEBDEV Complet - Corrigé". |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0001.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0002.jpg&type=thumb)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | Dans les options linguistiques, il est possible de choisir le sens d'écriture de la langue (onglet "Divers", option "Sens d'écriture"). Il est ainsi possible de créer des interfaces avec une langue s'écrivant de droite à gauche. |
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | Des erreurs d'UI sont susceptibles d'apparaître. Nous allons les ignorer pour le moment. Ces erreurs seront traitées plus loin dans ce cours. |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0003.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0005.jpg)
...
4. Dans l'onglet "Général", à droite de la zone "Image", cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0004%201.jpg)
. Dans le menu qui s'affiche, sélectionnez l'option "Multilingue". 

5. La fenêtre de gestion des images multilingues s'affiche.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0004.jpg)
...
- Pour traduire l'option "Ajouter un produit" :
	...
	8. Enregistrez le modèle de pages (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg)
 ou Ctrl + S).
	...
	10. Mettez à jour les pages utilisant le modèle de pages en cliquant sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20WebDev%20-%20Liste%20produits%20-%20HC%20N%B0011%201.jpg)
 dans le bandeau du modèle. Validez la fenêtre de mise à jour.
...
- Pour traduire le lien "Modifier" dans la page "PAGE_Liste_des_produits" :
	...
	5. Enregistrez la page (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg)
 ou Ctrl + S).
...
5. Dans la zone "Anglais", saisissez "List of products" et validez.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0007.jpg)


6. L'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B000%208%202.jpg)
 apparaît sous l'éditeur de code. Cette icône indique que le message multilingue existe dans plusieurs langues. Un survol de cette icône permet de visualiser rapidement les différentes traductions.
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0009.jpg&type=thumb)
...
4. Lorsque les paramètres de traductions sont définis, il est possible d'utiliser le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0006%201.jpg)
 présent dans les différentes fenêtres de description des éléments du projet : ce bouton permettra d'utiliser le logiciel défini pour la traduction.
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0011.jpg&type=thumb)
...
10. Enregistrez le modèle de pages (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg)
 ou Ctrl + S).

11. Mettez à jour les pages utilisant le modèle de pages en cliquant sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20WebDev%20-%20Liste%20produits%20-%20HC%20N%B0011%201.jpg)
 dans le bandeau du modèle. Validez la fenêtre de mise à jour.
...
- Pour tester le site :
 ...
 parmi les boutons d'accès rapide). La page apparaît en mode test en français.

	2. Sélectionnez l'option "LANGUES .. ENGLISH".

	3. Les différents éléments que nous avons traduits apparaissent en anglais : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0010.jpg&type=thumb)
