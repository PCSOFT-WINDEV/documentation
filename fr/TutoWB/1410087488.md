...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | **Référencement**<br><br>Dans un site WEBDEV en mode Session, seule la page d'accueil du site peut être référencée.<br><br>Le référencement d'un site WEBDEV est présenté dans ["Leçon 5.6. Le référencement"](../TutoWB/1410087499.md). |
