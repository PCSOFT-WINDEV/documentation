...
| [Leçon précédente](../TutoWB/1410087211.md) | [Sommaire](../TutoWB/1410087510.md) | [Leçon suivante](../TutoWB/1410087218.md) |
| --- | --- | --- |
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=avertissement.png) | Attention ! | Les droits des utilisateurs spécifiés dans le Centre de Contrôle HFSQL sont des droits de base de données et pas des droits d'accès au site.<br><br>Il ne faut pas confondre la gestion des droits des bases de données Client/Serveur avec le groupware utilisateur que nous avons vu dans une leçon précédente. |
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | La gestion des utilisateurs et de leurs droits peut également être effectuée par programmation grâce aux fonctions WLangage. <br>Pour plus de détails, consultez [Fonctions de gestion de HFSQL Client/Serveur](../WDLang4/3044316.md). |
...
3. Dans le menu, dans le groupe "Sauvegardes", déroulez "Nouvelle sauvegarde" et sélectionnez "Nouvelle sauvegarde à chaud".
	...
	- sur l'onglet correspondant à la base de données. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0018.jpg&type=thumb)
