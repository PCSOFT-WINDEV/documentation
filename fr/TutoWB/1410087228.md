...
- Ouvrez si nécessaire le projet "WLangage" que vous avez créé dans la leçon précédente (consultez le paragraphe [Un projet pour découvrir le WLangage](../TutoWB/1410087226.md) de la leçon Annexe 2).
...
- un type : Nature de la donnée stockée dans la variable (voir [Les types de variables](../TutoWB/1410087228.md)).

- une valeur : Information stockée dans la variable.

- une portée : Limite d'utilisation de la variable dans le programme (voir [La portée des variables](../TutoWB/1410087228.md)). La portée est définie principalement par l'endroit où la variable est déclarée. 
...
- Testons notre code : 
	...
	3. Le volet "Trace du débogueur" contient nos exemples de concaténation :
		...
		ChaîneConstruit : Mon outil de développement, c'est WEBDEV !
