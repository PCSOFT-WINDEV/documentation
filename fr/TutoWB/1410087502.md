...
- Considérons par exemple le champ de saisie. Ce champ est composé de trois éléments :
	...
	- une zone supplémentaire contenant le libellé et la zone de saisie. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0006%201.jpg&type=thumb)
...
- Pour découvrir les styles dans WEBDEV, nous vous avons préparé un exemple simple :
	...
	6. La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0001.jpg&type=thumb)
...
- Pour sélectionner les styles CSS d'un champ :
	...
	1. Dans l'onglet "Style" de la fenêtre de description du champ, dans la combo "Elément", choisissez l'élément de style voulu.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0002.jpg)
...
- Pour créer ou éditer un style CSS :
	...
	1. Dans l'onglet "Style" de la fenêtre de description du champ, cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0001%204.jpg) à côté de la combo "Style CSS". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0001%203.jpg)


	2. Dans le menu contextuel qui s'ouvre, sélectionnez l'option "Editer". 

3. La fenêtre d'édition des styles CSS s'ouvre. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0003.jpg&type=thumb)
...
- L'onglet "Style" de la fenêtre de description du champ apparaît à nouveau. Dans la partie basse de la fenêtre, vous avez un accès rapide aux éléments de style les plus fréquemment modifiés : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0001%201.jpg)
...
- Pour gérer les styles WEBDEV, il suffit d'utiliser le panneau affiché à droite de l'onglet "Style" du champ : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0001%202.jpg)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Pour voir les éléments surchargés, il suffit de cliquer en haut du panneau de gestion des styles WEBDEV sur le lien qui indique le nombre de surcharges effectuées pour le champ. |
...
- Trois méthodes permettent de sélectionner le style WEBDEV d'un champ :
	...
	- Soit via le volet "Modification" du ruban : un aperçu des différents styles WEBDEV disponibles pour le champ est affiché. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0004%201.jpg&type=thumb)
...
- Nous allons maintenant modifier le style de la zone de saisie du champ :
	...
	4. Sélectionnez l'état “Sélectionné (focus)”.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0003%201.jpg&type=thumb)
...
- Nous allons maintenant modifier le style CSS de la zone de saisie pour changer la couleur du texte saisi. Cette modification va être réalisée pour tous les champs de saisie de la page. 
	...
	3. Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0001%204.jpg) à droite du nom du style CSS. Dans le menu qui s'ouvre, sélectionnez "Editer". La fenêtre d'édition du style CSS s'affiche.
...
- Dans notre exemple :
	...
	3. Le texte du libellé passe en édition. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Styles%20-%20HC%20N%B0005.jpg)
