...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=exemple-WB.png) | Corrigé | Un projet corrigé est disponible. Ce projet contient la correction des différentes manipulations effectuées dans cette leçon. Pour ouvrir le projet corrigé, dans la page d'accueil, cliquez sur "Tutoriel" puis dans la zone "Partie 8 - Agencements", double-cliquez sur "Agencements (Corrigés)". |
...
- Pour comprendre la gestion de l'ordre des champs, ouvrez la page PAGE_OrdreChamp présente dans le projet WW_Agencement. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P8_Agencement_simple_1%20-%20HC%20N%B0001.jpg&type=thumb)
Cette page comporte : 
...
- Nous allons tout d'abord créer un nouvel agencement mobile : 
	...
	1. Sous le volet "Page", dans le groupe "Agencements", déroulez "Agencements" et sélectionnez "Ajouter un agencement à partir de la vue active". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P8_Agencement_simple_1%20-%20HC%20N%B0004.jpg&type=thumb)
...
- Testez la page (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Go_Page_WB_GAF.jpg) parmi les boutons d'accès rapide).
	...
	- Réduisez la taille de votre navigateur pour visualiser le comportement en mobile. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P8_agencement_adaptation%20-%20HC%20N%B0003.jpg)
...
- Nous allons tout d'abord créer un nouvel agencement mobile : 
	...
	1. Sous le volet "Page", dans le groupe "Agencements", déroulez "Agencements" et sélectionnez "Ajouter un agencement à partir de la vue active". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P8_agencement_adaptation%20-%20HC%20N%B0004.jpg&type=thumb)
...
- Nous allons ensuite déplacer les différents champs pour les positionner dans la page : 
	...
	4. Positionnez en dernier le champ Zone répétée. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P8_agencement_adaptation%20-%20HC%20N%B0012.jpg&type=thumb)
...
- Pour dissocier le nombre de colonnes affichées par le champ Zone répétée : 
	...
	2. Affichez la fenêtre de description du champ. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P8_agencement_adaptation%20-%20HC%20N%B0013.jpg&type=thumb)
