...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png)<br> | Note | Les cookies sont stockés de manière non cryptée : il est recommandé de ne pas les utiliser pour stocker des informations sensibles. |
