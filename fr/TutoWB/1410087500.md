...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Cette partie présente le déploiement sur un serveur Windows. Si vous voulez utiliser un serveur Linux, reportez-vous à la documentation du serveur d'application WEBDEV pour Linux. |
...
4. Sélectionnez le chemin d'installation du serveur d'application (par défaut "C:\\WEBDEV 28").<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P6_Install%20Serveur%2010%20Connexions%20-%20HC%20N%B0002.jpg)
...
6. L'étape suivante permet d'indiquer les paramètres avancés du Serveur d'application WEBDEV. Conservez l'option "Utiliser les paramètres par défaut".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P6_Install%20Serveur%2010%20Connexions%20-%20HC%20N%B0003.jpg)
