...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | **Référencement**<br><br>Dans un site WEBDEV en mode AWP, toutes les pages du site peuvent être référencées. |
...
Lorsque la page en mode AWP a été envoyée à l'internaute, ces éléments sont détruits. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=mode%20AWP%20WebDev-2.gif)
