...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=dur%E9e.png)<br> | <br>Durée estimée : 1h30 mn |
...
L'UI de la page "PAGE_Recherche_multicritere" sera la suivante : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0001.jpg&type=thumb)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | **Qu'est-ce qu'une requête de sélection ?**<br><br>Une requête de sélection est une requête qui va "ressortir" uniquement les enregistrements correspondant aux critères spécifiés.<br><br>Ce type de requête s'appelle une requête de sélection car en langage SQL l'ordre SELECT est utilisé. |
...
- Pour créer une requête, nous allons utiliser l'éditeur de requêtes.
	...
	1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Cr%E9er_WB_GAF.jpg) parmi les boutons d'accès rapide. La fenêtre de création d'un nouvel élément s'affiche : cliquez sur "Requête­". L'assistant de création d'une requête se lance.
	...
	3. La fenêtre de description de la requête apparaît.
			Arrêtons-nous un instant sur l'UI de l'éditeur de requêtes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0002.jpg&type=thumb)
...
- Nous allons construire la requête en sélectionnant les éléments que nous voulons dans le résultat.
 ...
 La fenêtre de description de la requête est la suivante : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0003.jpg&type=thumb)
...
2. Le résultat s'affiche dans une fenêtre : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0007.jpg)
...
- Pour gérer le paramètre "Nom du client" :
	...
	3. Dans la fenêtre qui s'affiche, nous allons indiquer que la condition de sélection correspond à un paramètre : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0008.jpg)
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0009.jpg)
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | La description de la requête en langage naturel (en bas de l'éditeur de requêtes) est automatiquement mise à jour en fonction de la condition ajoutée. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0009%201.jpg&type=thumb)<br> |
...
- Passons au second paramètre : l'état de la commande :
	...
	3. Dans la fenêtre qui s'affiche, nous allons indiquer que la condition de sélection est égale à un paramètre : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0010.jpg)
...
- Nous allons maintenant définir une condition sur le mode de règlement. La rubrique "ModeRèglement.IDModeRèglement" ne doit pas être affichée dans le résultat de la requête mais nous souhaitons tout de même lui appliquer une condition. Pour cela, nous allons la rendre invisible.
	...
	1. Pour ne pas afficher la rubrique "ModeRèglement.IDModeRèglement" dans le résultat :
		...
		- Cliquez sur l'oeil (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0011%201.jpg)) correspondant à la rubrique "ModeRèglement.IDModeRèglement" dans la liste des éléments de la requête (au centre de l'écran).
...
- Pour créer le champ Table affichant le résultat de la recherche :
	...
	4. Sélectionnez la requête qui sera la source de données du champ Table :
		...
		- Sélectionnez la requête "REQ_RechercheCommandes".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Interface%20-%20HC%20N%B0001.jpg&type=thumb)


		- Passez à l'étape suivante de l'assistant. 

- Sélectionnez toutes les rubriques proposées : elles seront toutes affichées dans le champ Table. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Interface%20-%20HC%20N%B0002.jpg&type=thumb)
Passez à l'étape suivante de l'assistant. 
...
7. Si nécessaire, modifiez la position du champ Table pour qu'il apparaisse entièrement dans la page. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Interface%20-%20HC%20N%B0003.jpg&type=thumb)
...
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | La fenêtre de description d'un champ Table est composée de deux zones :<br><br>		- la zone supérieure présentant le nom du champ, des colonnes et leur type.<br><br>		- la zone inférieure composée des différents onglets de description. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Interface%20-%20HC%20N%B0004.jpg&type=thumb)<br><br><br><br>Si le nom du champ Table est sélectionné, la partie inférieure présente les caractéristiques du champ Table.<br><br>Si une colonne est sélectionnée, la partie inférieure présente les caractéristiques des colonnes. |
	...
	2. Cliquez sur le nom du champ Table. Dans la partie basse, le libellé du champ Table est affiché. Nous allons modifier ce libellé. Remplacez le libellé proposé par "Résultats de la recherche". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Interface%20-%20HC%20N%B0005.jpg&type=thumb)


	3. Cliquez sur la colonne "COL_IDCommande". Le titre de la colonne apparaît dans la partie basse de l'écran. Remplacez le libellé "Identifiant de la commande" par "ID". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Interface%20-%20HC%20N%B0006.jpg&type=thumb)
...
- Nous allons faire un premier test de cette page :
	...
	2. Seules les commandes réglées en espèces et dont le prix est compris entre 150 et 300 euros s'affichent, comme lors du dernier test de la requête réalisé sous l'éditeur, lorsque nous avions spécifié les paramètres dans la fenêtre de test de la requête. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Interface%20-%20HC%20N%B0008.jpg&type=thumb)
...
- Pour créer le champ de saisie :
	...
	2. Cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0003%202.jpg) à gauche du fichier de données "Client" : les rubriques du fichier de données sont listées.
	...
	4. Le champ de saisie est automatiquement créé. Positionnez ce champ au-dessus du champ Table. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%202%20-%20HC%20N%B0001.jpg&type=thumb)
...
3. Modifiez le style du champ :
	...
	- Dans la fenêtre qui s'affiche, sélectionnez "Détails (Avec fond)". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%202%20-%20HC%20N%B0002.jpg&type=thumb)
...
- Nous allons tester le passage du premier paramètre :
	...
	1. Enregistrez la page en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg) parmi les boutons d'accès rapide.

	2. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Go_Page_WB_GAF.jpg) parmi les boutons d'accès rapide.

	3. Dans la page qui s'affiche, saisissez le nom du client "GUENOT" puis cliquez sur le bouton "RECHERCHER". Le contenu du champ Table est modifié : toutes les commandes du client "GUENOT" sont affichées. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%202%20-%20HC%20N%B0003.jpg&type=thumb)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Les sélecteurs d'options sont également appelés "cases d'options". Ils permettent de sélectionner une option et une seule, parmi celles proposées.<br><br>**Comment différencier le sélecteur et l'interrupteur ?**<br><br>- Le sélecteur permet de sélectionner une seule option.<br><br>- L'interrupteur permet de sélectionner plusieurs options.<br><br><br> |
...
- Pour créer le champ Sélecteur :
	...
	1. Dans le volet "Analyse", cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0003%202.jpg) à gauche du fichier de données "Commande" : les rubriques du fichier de données sont listées.
	...
	3. Le champ Sélecteur est automatiquement créé. Positionnez ce champ au-dessus du champ Table. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%203%20-%20HC%20N%B0001.jpg&type=thumb)
...
- Nous allons tester le passage des deux premiers paramètres :
	...
	3. Cliquez sur le bouton "RECHERCHER" : seules les commandes de GUENOT en attente de paiement sont listées. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%203%20-%20HC%20N%B0002.jpg&type=thumb)
...
- Pour ajouter une option dans le champ Sélecteur :
	...
	3. Dans l'onglet "Contenu", dans la liste des options, insérez l'option "Toutes les commandes" en haut de la liste :
		...
		- Utilisez la flèche vers le haut (à droite) pour remonter l'option. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%203%20-%20HC%20N%B0003.jpg&type=thumb)
...
- Nous allons tester immédiatement notre page.
	...
	4. Cliquez sur le bouton "RECHERCHER" : toutes les commandes de GUENOT quel que soit leur état sont listées. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%203%20-%20HC%20N%B0005.jpg&type=thumb)
...
- Pour créer un champ Combo :
	...
	4. Sélectionnez l'option "Afficher des données d'un fichier ou d'une requête existante" et passez à l'étape suivante.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-Crit%E8res%20-%20Interface%204%20-%20HC%20N%B0001.jpg&type=thumb)


	5. Sélectionnez le fichier de données "ModeRèglement" et passez à l'étape suivante.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-Crit%E8res%20-%20Interface%204%20-%20HC%20N%B0002.jpg&type=thumb)




- Modifiez le libellé du champ Combo (utilisez la touche Entrée du clavier). Le nouveau libellé est "Mode de règlement". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%204%20-%20HC%20N%B0006.jpg&type=thumb)
...
par :
	...
	4. Enregistrez la page (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg) ou Ctrl + S).
...
- Nous allons à nouveau tester le passage des paramètres :
	...
	3. Changez l'état des commandes grâce au sélecteur et modifiez le mode de règlement grâce au champ Combo, puis cliquez sur le bouton "RECHERCHER". Le contenu du champ Table est modifié. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%204%20-%20HC%20N%B0007.jpg&type=thumb)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=note.png) | Note | Un champ Potentiomètre d'intervalle est un champ graphique, facilement intégrable dans un site WEBDEV qui permet de sélectionner de manière simple les bornes d'un intervalle (valeur de début et valeur de fin). |
...
- Pour gérer le prix du produit :
	...
	1. Sous le volet "Création", dans le groupe "Champs graphiques", déroulez "Potentiomètre" et sélectionnez le potentiomètre "Fourchette de prix". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%205%20-%20HC%20N%B0001.jpg&type=thumb)


	2. Cliquez dans la page, entre le champ "Mode de règlement" et le bouton "RECHERCHER". Le potentiomètre d'intervalle est automatiquement créé. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%205%20-%20HC%20N%B0002.jpg&type=thumb)
...
3. Cliquez sur le bouton "RECHERCHER". Le contenu du champ Table est modifié. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20multi-crit%E8res%20-%20Interface%205%20-%20HC%20N%B0003.jpg&type=thumb)
...
- Pour mettre en place le mode Ajax sur le bouton "Rechercher" :
	...
	2. Dans l'événement "Clic xxx (serveur)" du bouton, le lien AJAX apparaît barré dans le bandeau du code. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Ajax%20-%20HC%20N%B0002.jpg)


	3. Cliquez sur le lien AJAX : le lien "AJAX activé" apparaît, indiquant que l'événement est automatiquement transformé en un événement Ajax. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Recherche%20-%20Ajax%20-%20HC%20N%B0001.jpg)
