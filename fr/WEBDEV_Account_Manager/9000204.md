...
<a name="gerer_les_comptes_deploiement_ELTTEXTE000511"></a>
...
<a name="creer_compte_deploiement_webdev_ELTPARAGRAPHE000173"></a>Pour créer un nouveau compte de déploiement WEBDEV à l'aide d'une ligne de commande et d'un fichier de paramètres : 
...
<a name="modifier_compte_deploiement_webdev_ELTPARAGRAPHE000191"></a>Pour modifier un compte de déploiement WEBDEV à l'aide d'une ligne de commande et d'un fichier de paramètres : 
...
<a name="supprimer_compte_deploiement_ELTPARAGRAPHE000208"></a>Pour supprimer un compte à l'aide d'une ligne de commande, utilisez la syntaxe suivante : 
...
<a name="lire_les_informations_concernant_compte_deploiement_ELTPARAGRAPHE000218"></a>Pour lire les informations concernant un compte à l'aide d'une ligne de commande, utilisez la syntaxe suivante : 
...
<a name="obtenir_liste_des_comptes_deploiement_ELTPARAGRAPHE000230"></a>Pour lire les informations concernant les différents comptes de déploiement à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
<a name="gestion_des_applications_ELTTEXTE000565"></a>


### Supprimer une application
<a name="supprimer_une_application_ELTPARAGRAPHE000244"></a>Pour supprimer une application ou un site WEBDEV à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
<a name="attribution_une_application_compte_deploiement_webdev_ELTPARAGRAPHE000254"></a>Pour attribuer une application ou un site WEBDEV à un compte de déploiement WEBDEV à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
<a name="liste_des_applications_compte_deploiement_ELTPARAGRAPHE000263"></a>Pour lister les applications d'un compte de déploiement à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
<a name="liste_des_applications_webdev_non_attribuees_ELTPARAGRAPHE000275"></a>Pour obtenir la liste des applications non attribuées à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
<a name="gestion_des_webservices_soap_rest_des_serveurs_websockets_ELTTEXTE000607"></a>


### Supprimer un Webservice (SOAP ou REST) ou un serveur de Websocket
<a name="supprimer_webservice_soap_rest_serveur_websocket_ELTPARAGRAPHE000289"></a>
...
<a name="attribution_webservice_soap_rest_serveur_websocket_compte_deploiement_webdev_ELTPARAGRAPHE000304"></a>
...
<a name="liste_des_webservices_soap_rest_les_serveurs_websocket_compte_ELTPARAGRAPHE000319"></a>
...
<a name="liste_des_webservices_soap_rest_les_serveurs_websocket_non_attribues_ELTPARAGRAPHE000337"></a>
...
<a name="migrer_les_comptes_les_sites_les_webservices_ELTTEXTE000649"></a>


### Migrer un compte utilisateur
<a name="migrer_compte_utilisateur_ELTPARAGRAPHE000358"></a>Pour migrer un compte utilisateur à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
<a name="migrer_site_webdev_ELTPARAGRAPHE000376"></a>Pour migrer un site WEBDEV à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
<a name="migrer_webservice_soap_rest_ELTPARAGRAPHE000391"></a>Pour migrer un Webservice à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
<a name="migrer_serveur_websocket_ELTPARAGRAPHE000409"></a>Pour migrer un serveur de Websocket à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
...
### Migrer tout
<a name="migrer_tout_ELTPARAGRAPHE000425"></a>Pour migrer les utilisateurs, les sites et les Webservices à l'aide d'une ligne de commande, utilisez la syntaxe suivante :
