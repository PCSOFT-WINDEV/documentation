...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Le chemin du répertoire est relatif au serveur Web.
...
|   |   |
| --- | --- |
| *graveurAjoutInterruptible* | Le parcours peut être interrompu en utilisant la touche ECHAP.<br>![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette constante n'a aucun effet. |
