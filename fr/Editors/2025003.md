...
- soit d'utiliser le **Framework WINDEV commun** : Si vous sélectionnez cette option, vous avez la possibilité de paramétrer les différents messages qui peuvent apparaître à l'utilisateur final : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Exe_Framework_telech.gif)
**Remarques** : 
...
- **Intégrer une partie du Framework dans l'exécutable** (extraction des DLL au lancement)
	...
	Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Framework_select.gif) et sélectionnez les DLL WINDEV à intégrer.
