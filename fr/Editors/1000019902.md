...
Pour lancer la génération de l'application dans WINDEV Mobile, cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Generation_iOS_WM_bl.gif) parmi les boutons d'accès rapide.

Sur l'écran ci-dessous, insérez l'App Id fourni par Apple : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Applestore_dep1.gif&type=thumb)
...
Une fois connecté, cliquez sur l'option "Certificates, Identifiers & Profiles".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=23_IOS_Deploiement1.gif)
...
- Le profile est généré et peut être téléchargé. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=23_IOS_Deploiement7.gif)
...
- Ajoutez votre application grâce au bouton "Nouvelle app". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=itunes_connect2.gif)


- Renseignez les différentes informations demandées : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=itunes_connect3.gif)
...
- Une fois l'application compilée, il est nécessaire de construire une archive par le menu "Product .. Archive". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=XCode_archive1.gif)
...
- Créez si nécessaire une version de l'application. Le numéro de version de l'application doit correspondre au numéro de version précisé lors de la création de la génération de l'application sous WINDEV Mobile (ou au moins le numéro de version WINDEV Mobile doit commencer par le même numéro). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=itunes_connect4.gif)
