...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Indentation_du_code.gif)
...
<a name="indenter_code_existant_ELTPARAGRAPHE000030"></a>Plusieurs options permettent d'indenter un code existant ou en cours de saisie :
...
<a name="parametrer_reindentation_automatique_code_colle_ELTPARAGRAPHE000126"></a>Pour ré-identer automatiquement le code lors d'un copier - coller :
...
2. Dans l'onglet "Code", cochez l'option "Indentation (le code collé est mis en forme et réindenté pour s'adapter à la mise en page)".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Coller-Code.gif)
...
[Marque de positionnement dans le code ](../Editeurs/2013008.md)
