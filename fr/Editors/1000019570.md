...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000387"></a>
...
<a name="caracteristiques_des_actions_ELTTEXTE000441"></a>


### Action paramétrée
<a name="action_parametree_ELTPARAGRAPHE000204"></a>Une action peut avoir besoin de paramètres. Par exemple, l'action "Ouverture d'un projet depuis le GDS" nécessite le nom du projet à ouvrir. 
...
<a name="gestion_des_echecs_des_erreurs_ELTPARAGRAPHE000222"></a>Point important du plan d'action : définir le comportement à adopter en cas d'échec de l'action. Exemple simple : que faire lors de la mise à jour d'une fenêtre qui est extraite en exclusif chez un développeur. 
...
<a name="action_specifique_lancement_windev_webdev_windev_mobile_ELTPARAGRAPHE000257"></a>L'action permettant le lancement du produit via un plan d'action pour la fabrique logicielle contient plusieurs paramètres dans l'onglet "Général" de la fenêtre de description : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Plan_Lancement_produit%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="action_specifique_execution_plan_action_ELTPARAGRAPHE000278"></a>Il est possible d'exécuter un plan d'action depuis un autre plan d'action. 
...
<a name="evenements_wlangage_associes_plan_action_ELTPARAGRAPHE000297"></a>Deux événements sont associés à un plan d'action : 
...
<a name="tester_plan_action_ELTTEXTE000489"></a>
