...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Le RAD MVP n'est pas disponible. Un exemple utilisant les différentes classes permettant de réaliser une application MVP est disponible. 
...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000363"></a>


### Les étapes de la génération de la fenêtre
<a name="les_etapes_generation_fenetre_ELTPARAGRAPHE000044"></a>Pour générer une fenêtre en mode "RAD MVP" : 
...
<a name="les_elements_generes_par_rad_ELTPARAGRAPHE000076"></a>Lors d'une génération d'une fenêtre Fiche et d'une fenêtre Table sur un fichier de données "MonFichierExemple", le RAD MVP génère 6 classes et 2 fenêtres.
...
<a name="wlangage_specificites_permettant_simplifier_architecture_mvp_ELTTEXTE000399"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000110"></a>Afin de simplifier la mise en oeuvre d'une architecture MVP, il est important de connaître et de comprendre les éléments spécifiques du WLangage :
...
### Attribut "mapping"
<a name="attribut_mapping_ELTPARAGRAPHE000143"></a>L'attribut **mapping** permet de réaliser une "liaison directe" entre la classe et le fichier de données.
...
### Attribut "associé"
<a name="attribut_associe_ELTPARAGRAPHE000205"></a>L'attribut **associé** permet d'accéder aux membres, aux méthodes et aux propriétés d'une classe Modèle depuis sa classe Présentation, sans avoir à effectuer de "rebonds".
Exemple : 
...
<a name="attribut_presentation_gestion_actualisation_des_vues_ELTPARAGRAPHE000227"></a>L'attribut **présentation** est utilisé lors de la déclaration globale des fenêtres générées. Il permet d'associer une classe de la couche présentation à une vue (fenêtre ou état). 
