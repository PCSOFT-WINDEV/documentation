...
Pour plus de détails sur ces fichiers de données (noms, rubriques, ...), consultez [Les fichiers de données du groupware utilisateur](../Editeurs/2018002.md).
