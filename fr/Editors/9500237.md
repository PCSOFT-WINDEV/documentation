...
<a name="lancer_analyseur_temps_reel_atr_ELTTEXTE000206"></a>
...
- **en s'attachant à un exécutable ou un site en cours d'exécution** : 
	...
	3. Attachez-vous à l'exécutable : sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez l'option voulue : 
		...
		- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Sur un site ou une connexion existante. 
...
<a name="lire_resultat_analyseur_temps_reel_ELTTEXTE000230"></a>
...
- ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Analyseur_temps_r%E9el%20-%20HC%20N%B0001%203.gif) Loupe : Permet de visualiser les valeurs passées en paramètre à la fonction lors de son exécution. 

- ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Analyseur_temps_r%E9el%20-%20HC%20N%B0001%202.gif) Code : Permet de visualiser dans l'éditeur de code le traitement qui a été exécuté (par exemple, permet d'afficher le code de la procédure locale contenant la fonction exécutée). 

- ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Analyseur_temps_r%E9el%20-%20HC%20N%B0001%201.gif) Position : Permet de se positionner sur la ligne de code d'appel de la fonction sélectionnée. 
