...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) La génération d'exécutable n'est pas disponible.
...
<a name="creer_automatiquement_bibliotheque_principale_application_ELTPARAGRAPHE000073"></a>Pour créer automatiquement la bibliothèque principale de l'application :
...
<a name="generer_automatiquement_composant_partir_projet_ELTPARAGRAPHE000095"></a>Pour générer automatiquement un composant à partir d'un projet :
...
[Traitements multi-projets : utilisation de batchs](../Editeurs/2020013.md)
