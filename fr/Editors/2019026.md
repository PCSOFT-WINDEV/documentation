...
<a name="creer_test_automatique_sur_une_fenetre_ELTPARAGRAPHE000018"></a>Pour créer un test automatique sur une fenêtre : 
...
- Si votre application utilise le groupware utilisateur :
	...
	- en mode manuel : si la fonction [gpwOuvre](../WDLang6/3041002.md) est utilisée, il est nécessaire de remplacer cette fonction par la fonction [gpwLogin](../WDLang6/3041001.md) dans le code du test.
