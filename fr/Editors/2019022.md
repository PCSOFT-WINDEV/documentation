...
<a name="tester_une_connexion_hfsql_clientserveur_ELTPARAGRAPHE000026"></a>Pour tester une connexion HFSQL Client/Serveur :

1. Ouvrez le projet voulu sous l'éditeur.

2. Affichez l'analyse liée au projet : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_Analyse.gif) parmi les boutons d'accès rapide.
...
<a name="mode_1_lancement_projet_debogage_des_prochaines_connexions_base_donnees_ELTPARAGRAPHE000061"></a>Cette option permet de :
...
<a name="mode_3_debogage_une_connexion_existante_ELTPARAGRAPHE000125"></a>Cette option permet de déboguer les procédures stockées et les triggers utilisés depuis une connexion déjà établie. Les éléments déployés sur le serveur sont exécutés.
...
[Procédures et requêtes stockées (HFSQL Client/Serveur)](../Editeurs/3044360.md)
