...
<a name="creer_une_requete_code_sql_ELTPARAGRAPHE000038"></a>Pour créer une requête en code SQL : 
...
<a name="retroanalyse_requete_code_sql_ELTPARAGRAPHE000078"></a>La rétro-analyse de la requête en code SQL permet de représenter graphiquement la requête à partir des fichiers de données présents dans le code SQL et dans l'analyse du projet.
