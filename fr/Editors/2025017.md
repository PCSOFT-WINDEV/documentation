...
- **Si une application doit créer ou modifier des fichiers de données HFSQL**, ces fichiers de données doivent être localisés par exemple dans le répertoire correspondant à l'application (connu avec la fonction [SysRep](../WDLang1/3073026.md) et la constante *srAppDataCommun*).
