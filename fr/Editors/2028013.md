...
1. Sélectionnez l'option "Paramètres de l'installation .. Fin de l'installation".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Options%20install_WDINST%20-%20HC%20N%B0005%204.gif&type=thumb)
...
<a name="pas_proposer_lancement_execution_application_fin_installation_ELTPARAGRAPHE000106"></a>Pour ne pas proposer le lancement de l'exécution de l'application à la fin de l'installation : 
...
Il est possible d'inclure le désinstalleur avec lors de l'installation de l'application. Ainsi, l'application pourra être désinstallée par les options de Windows. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Options%20install_WDINST%20-%20HC%20N%B0005%202.gif&type=thumb)
...
<a name="modifier_identifiant_utilise_pour_application_dans_base_registre_ELTPARAGRAPHE000133"></a>Pour modifier l'identifiant utilisé pour la désinstallation de l'application : 
...
### Modifier ou créer le fichier "AutoExec.BAT"
<a name="modifier_creer_fichier_autoexecbat_ELTPARAGRAPHE000164"></a>Pour modifier ou créer le fichier "AutoExec.BAT" : 

1. Sélectionnez l'option "Paramètres de l'installation .. Configuration du système".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Options%20install_WDINST%20-%20HC%20N%B0006%201.gif&type=thumb)
...
<a name="modifier_creer_des_fichiers_ini_lors_installation_ELTPARAGRAPHE000227"></a>Pour modifier ou créer des fichiers ".INI" lors de l'installation : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Options%20install_WDINST%20-%20HC%20N%B0006%202.gif&type=thumb)
...
### Présentation
<a name="presentation_ELTPARAGRAPHE000261"></a>Lors de l'installation d'une application WINDEV, il est possible de modifier ou de créer des entrées dans la base de registre.
...
<a name="modifier_creer_des_entrees_dans_base_registre_lors_installation_ELTPARAGRAPHE000295"></a>Pour modifier ou créer des entrées dans la base de registre lors de l'installation : 

1. Sélectionnez l'option "Paramètres de l'installation .. Configuration du système".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Options%20install_WDINST%20-%20HC%20N%B0006%203.gif&type=thumb)
...
[WDInst : paramétrer le répertoire des fichiers de données et des fichiers du groupware utilisateur ](../Editeurs/2028017.md)
