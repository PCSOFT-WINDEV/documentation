...
![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png) **Application associée à une application Apple Watch** : Deux identifiants supplémentaires doivent être créés : 

- "&lt;Identifiant de l'application iOS&gt;.watchkitapp".

- "&lt;Identifiant de l'application iOS&gt;.watchkitapp.watchkitextension".




Par exemple, si l'identifiant de l'application iOS est fr.pcsoft.MonAppli, créez les identifiants : 

- fr.pcsoft.MonAppli.watchkitapp

- fr.pcsoft.MonAppli.watchkitapp.watchkitextension.
...
![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png) **Application associée à une application Apple Watch** : Créez également un profil pour les deux identifiants supplémentaires "&lt;Identifiant de l'application iOS&gt;.watchkitapp" et "&lt;Identifiant de l'application iOS&gt;.watchkitapp.watchkitextension" créés lors de l'étape précédente.
...
![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png) **Application associée à une application Apple Watch** : Répétez ces opérations pour les deux profils supplémentaires créés pour l'application Apple Watch.Note : Sur la machine compilation MAC, n'oubliez pas d'installer la clé privée générée lors de l'achat de la licence developpeur.
<a name="NOTE2_4"></a>
...
- Faites glisser par Drag and Drop le certificat de "provisioning" téléchargé précédemment dans l'environnement Xcode. Il sera installé automatiquement.
	![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png) **Application associée à une application Apple Watch** : Répétez cette opération pour les deux certificats de "Provisioning" supplémentaires créés pour l'application Apple Watch.
