...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Spécificités Android : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Les classes Java utilisées dans le code Java natif doivent être spécifiées dans l'assistant de génération de l'application Android : 
