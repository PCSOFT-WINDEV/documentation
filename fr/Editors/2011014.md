...
Pour plus de clarté, ces deux questions peuvent être décomposées en quatre questions. Par exemple, pour décrire une liaison entre le fichier "Club" et le fichier "Personne" : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=cardinaliteFenDescription.gif&type=thumb)
...
<a name="exemple_cardinalites_ELTPARAGRAPHE000059"></a>Cet exemple présente deux cardinalités différentes :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=cardinaliteMLD.gif)
...
<a name="exemple_cardinalites_avancees_ELTPARAGRAPHE000099"></a>Cet exemple présente deux cardinalités différentes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=cardinaliteAvMLD.gif)
