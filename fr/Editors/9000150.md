...
- **Dans** (2) : 
	Le texte recherché peut correspondre aussi bien à du code, au nom d'un élément ou à un mot dans le libellé d'un champ. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Rechercher_dans.gif)
...
- **Pour** (3) : 
	Cette option permet d'indiquer la cible de la recherche, c'est-à-dire les éléments pris en compte dans la recherche. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Rechercher_pour.gif)
La cible peut être : 
...
- Mot se termine par : l'expression recherchée se termine par l'expression saisie.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Rechercher_avec.gif)
...
3. Sélectionnez le type d'élément concerné par la recherche : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Recherche_dans_les_editeurs_2%20-%20HC%20N%B0002.gif)


4. Construisez le critère de recherche. Indiquez par exemple le type d'élément à prendre en compte, le critère à prendre en compte et sa valeur. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Recherche_dans_les_editeurs_2%20-%20HC%20N%B0003.gif&type=thumb)
...
Pour regrouper les occurrences d'une même ligne, cliquez sur les boutons ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Recherche_Occurrence1.gif) et ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Recherche_Occurrence2.gif). Si le terme recherché apparaît plus d'une fois dans une ligne de code donnée, il n'est pas forcément utile d'afficher plus d'une fois cette ligne dans le résultat. 
<a name="NOTE5_2"></a>


### Filtrage des résultats à l'affichage (recherche texte uniquement)
<a name="filtrage_des_resultats_affichage_recherche_texte_uniquement_ELTPARAGRAPHE000281"></a>Une fois les résultats affichés, il est possible d'appliquer un filtre pour ne visualiser que certains types de réponses. Il est possible d'afficher uniquement des réponses provenant du code et/ou de l'UI et ceci avec des niveaux plus fins.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Rechercher_filtre.gif)
...
Vous avez aussi la possibilité d'épingler une recherche afin de la conserver comme un favori pour la trouver plus rapidement plus tard.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Recherche_historique.gif)
