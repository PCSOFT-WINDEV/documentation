...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Lors de la création du programme d'installation d'un site dynamique, la bibliothèque du site est créée. Pour plus de détails, consultez [Déploiement d'un site](../Editeurs/2028039.md). 
