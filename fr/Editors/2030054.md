...
Une fenêtre de configuration offre une vue globale de toutes les règles de rewriting du projet. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=URLRewriting_fenppale.gif)
...
- WEBDEV génère une URL de rewriting par défaut. Pour paramétrer les règles d'une page en particulier, cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Btn_Parcourir.gif) (2) à droite de la table.
...
<a name="parametrage_des_regles_reecriture_une_page_ELTPARAGRAPHE000069"></a>Pour chaque page dont l'URL doit être réécrite, la fenêtre d'options propose les informations suivantes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=URLRewriting_page.gif)
...
- La colonne "Type" (1) permet de choisir si l'élément de l'URL est une composante fixe ou un paramètre :
	...
	- Une composante fixe est une portion invariable de l'URL. Les composantes fixes peuvent être multilingues (il suffit de cliquer dans la colonne ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=URLRewriting_multilangue.gif) pour saisir les valeurs dans les autres langues du projet).
