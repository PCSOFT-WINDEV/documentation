...
## Présentation
<a name="presentation_ELTTEXTE001203"></a>
...
## SELECT
<a name="select_ELTTEXTE001236"></a>


### SELECT
<a name="select_ELTPARAGRAPHE000109"></a>L'instruction **SELECT** permet de rechercher des enregistrements dans un ou plusieurs fichiers. 
...
<a name="cas_particulier_select_multifichiers_ELTPARAGRAPHE000160"></a>L'instruction SELECT permet également de sélectionner dans une requête multifichier toutes les colonnes d'un fichier de données grâce à la syntaxe suivante : 
...
<a name="cas_particuliers_select_sans_from_select_utilisant_une_table_virtuelle_ELTPARAGRAPHE000171"></a>L'instruction SELECT permet également d'exécuter des requêtes ne portant pas sur des tables : 
...
<a name="executer_une_procedure_stockee_ELTPARAGRAPHE000187"></a>L'instruction SELECT permet également d'exécuter directement des procédures stockées. 
...
## INSERT
<a name="insert_ELTTEXTE001278"></a>


### INSERT
<a name="insert_ELTPARAGRAPHE000210"></a>L'instruction **INSERT** permet d'ajouter  : 
...
- Pour connaître la valeur de l'identifiant automatique lors d'une requête de type INSERT sur des fichiers de données HFSQL (requête exécutée par la fonction [HExécuteRequêteSQL](../WDLang4/3044084.md), [HExécuteRequête](../WDLang4/3044080.md) ou [SQLExec](../WDLang4/3072007.md)), utilisez la variable SQL.IDAuto.
...
<a name="insert_avec_selection_ELTPARAGRAPHE000271"></a>L'instruction **INSERT** peut également être utilisée pour insérer une sélection d'enregistrements réalisée par une requête SELECT. Son format d'utilisation devient :
...
## UPDATE
<a name="update_ELTTEXTE001308"></a>
...
## DELETE
<a name="delete_ELTTEXTE001332"></a>
...
## CREATE TABLE
<a name="create_table_ELTTEXTE001356"></a>
...
### Types disponibles
<a name="types_disponibles_ELTPARAGRAPHE000405"></a>Les types disponibles sont :
...
## CREATE TABLE AS
<a name="create_table_ELTTEXTE001386"></a>
...
## DROP TABLE
<a name="drop_table_ELTTEXTE001410"></a>
...
## ALTER TABLE
<a name="alter_table_ELTTEXTE001434"></a>
...
## CREATE INDEX
<a name="create_index_ELTTEXTE001458"></a>
...
## DROP INDEX
<a name="drop_index_ELTTEXTE001482"></a>
...
## REVOKE
<a name="revoke_ELTTEXTE001530"></a>
...
## CREATE VIEW
<a name="create_view_ELTTEXTE001554"></a>
...
## DROP VIEW
<a name="drop_view_ELTTEXTE001578"></a>
...
<a name="create_materialized_view_ELTTEXTE001602"></a>
...
<a name="drop_materialized_view_ELTTEXTE001626"></a>
...
<a name="refresh_materialized_view_ELTTEXTE001650"></a>
...
## OPTIMIZE TABLE
<a name="optimize_table_ELTTEXTE001674"></a>
