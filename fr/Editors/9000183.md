...
3. Dans le menu contextuel (clic droit), sélectionnez l'option "Importer des fichiers texte". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Import_classe_txt%20-%20HC%20N%B0001.gif)
...
3. Dans le menu contextuel (clic droit), sélectionnez l'option "Importer des fichiers texte". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Import_classe_txt%20-%20HC%20N%B0002.gif)

	![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Sous WEBDEV, il est possible d'importer des collections de procédures serveur ou navigateur : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Import_classe_WB_txt%20-%20HC%20N%B0001.gif)
...
[Collection de procédures](../Editeurs/1513003.md)

[Classes, membres, méthodes et propriétés](../Editeurs/6010006.md)
