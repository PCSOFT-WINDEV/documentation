...
Une règle métier peut être simple ou élaborée.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=RegleMetier.GIF)
...
Ce paramétrage s'effectue grâce au bouton "Filtre" :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FiltreMetier.GIF)
...
1. Cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_NewRegle.GIF) dans le [volet "Règles métier"](../Editeurs/2027024.md). La fenêtre d'édition de la règle métier s'ouvre.
...
3. Pour associer à la règle métier :
	...
	- une partie de l'image de l'écran, cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_ImgRegleLasso.GIF) et sélectionnez la partie de l'image voulue.

	- un fichier image, cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_ImgRegleFic.GIF) et sélectionnez le fichier image voulu.
...
- L'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IcoSelectManu.GIF) indique les éléments sélectionnés manuellement et l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IcoSelectAuto.GIF) indique les éléments sélectionnés automatiquement.
...
<a name="modifier_une_regle_metier_ELTPARAGRAPHE000128"></a>Pour modifier une règle métier, cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_ModifRegle.GIF) dans le [volet "Règles métier"](../Editeurs/2027024.md) et effectuez les modifications voulues.
...
Pour valider une règle métier, cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_ModifRegle.GIF) dans le [volet "Règles métier"](../Editeurs/2027024.md) et définissez l'état de chaque élément lié à la règle métier. Cet état peut correspondre à :
...
<a name="rendre_une_regle_metier_obsolete_ELTPARAGRAPHE000165"></a>Pour rendre une règle métier obsolète, cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_RegleObsolete.GIF) dans le [volet "Règles métier"](../Editeurs/2027024.md).
...
- toutes les règles métier du projet en imprimant le dossier du projet : sous le volet "Accueil", dans le groupe "Général", déroulez ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_imprimer.gif) et sélectionnez "Imprimer le dossier du projet".
...
La fenêtre d'administration des règles métier (icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ico_regle_admin.GIF)) permet de :
...
<a name="afficher_volet_regles_metier_des_regles_metier_sont_associees_ELTPARAGRAPHE000348"></a>L'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IcoPunaiseRegle.GIF) permet d'afficher constamment le volet "Règles métier" s'il y a au moins une règle métier associée à l'élément en cours.
<a name="NOTE4_2"></a>
