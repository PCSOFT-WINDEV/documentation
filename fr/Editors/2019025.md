...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) [WDTestSite](../WDTestSite/3538003.md) qui permet de réaliser différents tests sur un site WEBDEV.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Avec WINDEV et WINDEV Mobile, il est possible de réaliser des tests automatiques sur :
...
<a name="NOTE2_2"></a>
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Avec WEBDEV, il est possible de réaliser des tests automatiques sur :
...
[Test automatique créé par l'utilisateur](../Editeurs/2019031.md)
