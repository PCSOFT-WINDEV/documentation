...
Pour plus de détails sur les manipulations possibles sur les diagrammes de classes, consultez [Manipulations sur un diagramme de classes](../Editeurs/2035016.md) et [Génération d'un diagramme de classes](../Editeurs/2035003.md).
