...
1. Créez l'exécutable de l'application (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Generation_Exe.gif) parmi les icônes d'accès rapide). 

2. Lancez la création de la procédure d'installation : 

	- ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Generation_Exe.gif) parmi les icônes d'accès rapide. 
...
1. Lancez le programme d'installation précédemment créé. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Installation_a_2_niveaux%20-%20HC%20N%B0001.gif&type=thumb)
