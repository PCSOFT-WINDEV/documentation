...
<a name="traduire_automatiquement_code_wlangage_anglais_ELTPARAGRAPHE000024"></a>Pour traduire automatiquement le code WLangage en anglais :
...
<a name="traduire_code_lors_copier_coller_ELTPARAGRAPHE000079"></a>Pour traduire un code WLangage lors d'un copier coller (par exemple entre deux projets WINDEV utilisant des langues différentes) :
...
2. Dans l'onglet "Code", cochez l'option "Conversion du code en" et sélectionnez la langue de traduction.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Coller-Code.gif)
