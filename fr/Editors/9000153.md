...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) [Comment créer un agencement pour une fenêtre WINDEV Mobile](#NOTE2_1). 
...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) L'agencement est automatiquement modifié lorsque l'appareil passe du mode portrait au mode paysage.
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Attention, l'indication Téléphone / Tablette est uniquement prise en compte pour la taille de la fenêtre sous l'éditeur. Cette information n'est pas prise en compte en exécution. 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Système d'exploitation. Si "Multi OS" est sélectionné, l'agencement pourra être lancé sur tous les OS. Il est possible de sélectionner des systèmes spécifiques (les systèmes proposés correspondent aux plateformes définies pour le projet).

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Orientation de la fenêtre. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Plateforme d'édition.




![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Selon le type de la fenêtre exécutée, l'ordre des paramètres pris en compte varient. Ainsi : 
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) L'indication de la taille de la plateforme n'est pas prise en compte en exécution (tablette/téléphone). L'agencement le plus grand est choisi. 
