...
4. Sélectionnez l'option voulue. Vous pouvez :
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) **Tester le composant depuis le projet** (par défaut) :
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) **Tester le composant en exécutant un autre projet** : 
	...
	- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) **Tester le composant depuis un site** (WEBDEV uniquement) : 
