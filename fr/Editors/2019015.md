...
<a name="tester_etat_cours_ELTPARAGRAPHE000051"></a>Pour tester l'état en cours : 
...
<a name="arreter_test_etat_ELTPARAGRAPHE000103"></a>Pour arrêter le test, plusieurs méthodes sont possibles :
...
<a name="repertoire_des_fichiers_donnees_utiliser_test_ELTPARAGRAPHE000118"></a>Pour indiquer les fichiers de données utilisés lors du test de l'application sous l'éditeur :
...
<a name="gestion_des_mots_passe_analyse_fichier_donnees_ELTPARAGRAPHE000147"></a>Lors du test d'un état lié à un fichier de données protégé par mot de passe, aucun mot de passe n'est demandé.
