...
- Activer l'affichage des erreurs concernant les messages partagés au niveau du projet : 
	...
	2. Dans l'onglet "Compilation", cochez l'option "Signaler les messages multilingues partagés" : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Traduction_messages_hc1_a.gif)
...
3. L'assistant vérifie ensuite si un même message multilingue est utilisé plusieurs fois dans le projet. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Traduction_messages_hc1_b.gif&type=thumb)
