...
Si votre poste de développement est en 64 bits, il est possible de tester immédiatement l'application en mode 64 bits grâce à l'option "GO" 64 bits. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GO_64bits_Menu_18.gif)
