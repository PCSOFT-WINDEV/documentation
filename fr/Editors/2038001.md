...
<a name="principe_utilisation_ELTTEXTE000204"></a>


### Installation 
<a name="installation_ELTPARAGRAPHE000049"></a><br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GestionnaireDeSources1.gif)
...
### Utilisation
<a name="utilisation_ELTPARAGRAPHE000064"></a>Pour travailler sur un élément du projet (fenêtre, page, etc.), le développeur doit extraire l'élément de la base de sources, le modifier, puis le réintégrer.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GestionnaireDeSources_synch.gif)
...
### Conseils
<a name="conseils_ELTPARAGRAPHE000080"></a>Les sources de vos applications sont primordiales.
