...
<a name="audit_statique_projet_ELTTEXTE000455"></a>
...
** **Problèmes dans l'analyse du projet détectés par l'audit statique** **

|   |
| --- |
| Un connecteur natif est utilisé par le projet mais n'est pas installé sur le poste. |
| Conseil : L'analyse du projet ne possède aucune liaison. <br>Il est conseillé de créer des liaisons afin d'assurer la cohésion des données.<br><br>L'absence de définition des liaisons ne permet pas la gestion automatique de l'intégrité référentielle, ce qui est un risque pour la qualité de l'application. |
...
| Conseil : il est conseillé de convertir l'analyse du projet au nouveau format. Pour plus de détails, consultez [Nouveau format de l'analyse du projet](../Editeurs/2011011.md). |
| Conseil : La base de sources utilisée peut être mise à jour. <br>Pour profiter des dernières fonctionnalités et optimisations, il est conseillé de mettre à jour la base de sources. Pour plus de détails, consultez [GDS : Versions de la base de sources](../Editeurs/2038018.md). <br> |
...
| Des chaînes multilingues dans l'ancien format ont été détectées. <br>Les chaînes multilingues dans l'ancien format ne profitent pas des évolutions, sont sources d'erreurs d'utilisation et peuvent augmenter inutilement la taille des éléments du projet.<br> |
...
<a name="audit_contenu_bibliotheque_application_ELTTEXTE000503"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000293"></a>L'audit du contenu de la bibliothèque de l'application affiche la taille des différents éléments du projet inclus dans la bibliothèque de l'application. Ces informations sont affichées dans une table et dans un Treemap : il est ainsi possible de voir l'importance de la taille des éléments les uns par rapport aux autres. 
...
<a name="interpretation_des_resultats_audit_contenu_bibliotheque_ELTPARAGRAPHE000327"></a>L'audit du contenu de la bibliothèque permet de détecter les problèmes suivants :
...
<a name="audit_contenu_installation_ELTTEXTE000533"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) 

### Présentation
<a name="presentation_ELTPARAGRAPHE000342"></a>L'audit du contenu de l'installation de l'application affiche la taille des différents éléments inclus dans l'installation de l'application. Ces informations sont affichées dans une table et dans un Treemap : il est ainsi possible de voir l'importance de la taille des éléments les uns par rapport aux autres. 
...
<a name="interpretation_des_resultats_audit_contenu_installation_ELTPARAGRAPHE000378"></a>L'audit du contenu de l'installation permet de détecter les problèmes suivants :
...
[Anomalies du projet : code mort et éléments orphelins](../Editeurs/9000075.md)

[Analyseur de performances](../Editeurs/2030035.md)

[Nettoyage de projet](../Editeurs/9000068.md)

[Tableau de bord du projet](../Editeurs/9500221.md)

[Audit d'UI : Détectez les technologies obsolètes](../Editeurs/9000207.md)
