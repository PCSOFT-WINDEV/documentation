...
### Norme à suivre
<a name="norme_suivre_ELTPARAGRAPHE000060"></a>Cette page d'aide présente différentes règles applicables à la conception des pages du Pattern RAD. Ces règles ont été utilisées pour concevoir les différents Patterns livrés avec WEBDEV 2026.
...
Exemple : Page Table sur le fichier RADFichierA du pattern Modèle Simple : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Pattern_RAD_WWTable.gif)
