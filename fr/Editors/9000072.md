...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Ce mécanisme permet également d'exécuter des tâches planifiées et des tâches différées sur le Serveur d'Application WEBDEV. Pour plus de détails, consultez [Tâches planifiées et tâches différées](../WDLang2/1000019455.md).
...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000431"></a>
...
2. Affichez la fenêtre de description des automatismes de la procédure :
	...
	- Cliquez sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_procauto.gif) présente dans le bandeau de la procédure.
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) [Tâches WEBDEV](../WDLang2/1000019455.md).

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) [Exécution périodique lorsque l'application est en arrière-plan](../WDLang3/1000023473.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) [Exécution asynchone](../WDLang2/3055119.md).
...
<a name="cas_des_timers_procedures_differees_ELTPARAGRAPHE000096"></a>Les options sont les suivantes : 
...
<a name="cas_des_threads_thread_pour_compatibilite_thread_securise_ELTPARAGRAPHE000148"></a>Cette option permet de spécifier si la procédure doit s'exécuter en tâche de fond (dans un thread). 
...
## Remarques
<a name="remarques_ELTTEXTE000473"></a>
<a name="NOTE3_2"></a>


### Tableau récapitulatif
<a name="tableau_recapitulatif_ELTPARAGRAPHE000229"></a>Le tableau suivant permet de visualiser les différents cas d'exécution des procédures selon les options d'automatisme choisies :
...
<a name="arreter_une_procedure_automatique_ELTPARAGRAPHE000315"></a>Pour arrêter une procédure automatique, il suffit d'utiliser la fonction [FinAutomatismeProcédure](../WDLang1/3013034.md).
<a name="NOTE3_5"></a>


### Procédure avec lancement automatique de threads
<a name="procedure_avec_lancement_automatique_threads_ELTPARAGRAPHE000325"></a>Rappel : En WLangage, par défaut, chaque procédure fait une section critique automatique. Deux threads ne peuvent donc pas exécuter en même temps la même procédure.
...
<a name="programmation_orientee_objet_poo_ELTPARAGRAPHE000340"></a>Lorsqu'un automatisme de procédure est défini sur une méthode de classe pour une exécution infinie par timer, un seul appel pour toutes les instances pourra être fait :
...
### Limitation WEBDEV
<a name="limitation_webdev_ELTPARAGRAPHE000354"></a>En WEBDEV, les timers ne sont pas disponibles. Les automatismes de répétition et d'exécution différée ne sont pas disponibles.
