...
1. Sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez "Déboguer le projet" (Ctrl + F9). Il est également possible d'utiliser ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WD.gif) parmi les boutons d'accès rapide.
...
- **Lancement du débogueur par l'éditeur**. Dans ce cas, effectuez les manipulations suivantes :
	...
	- Dans le volet "Débogueur", dans le groupe "Déboguer", cliquez sur l'icône suivante ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=main_debog.gif).  
