...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) [Configuration de l'application (définition des utilisateurs, des groupes, etc.)](../Editeurs/1000021154.md).

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) [Configuration du site (définition des utilisateurs, des groupes, etc.)](../Editeurs/1000021180.md).
...
- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) [Personnaliser le groupware utilisateur](../Editeurs/1000021181.md).
