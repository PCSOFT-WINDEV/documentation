...
### LIKE
<a name="like_ELTPARAGRAPHE000288"></a>L'opérateur **LIKE** permet de sélectionner des enregistrements dont la valeur d'une rubrique correspond à une valeur constante spécifiée (avec des caractères génériques).
