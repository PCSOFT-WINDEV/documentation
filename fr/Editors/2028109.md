...
<DIV class="specObsolete">
	...
	A partir de la version <B>29</B>,  cette fonctionnalité n'est plus disponible. Pour personnaliser le programme d'installation, il est nécessaire de modifier l'exemple WDSetup. Cet exemple est fourni avec les exemples du produit. Pour plus de détails, consultez [WDSetup&nbsp;: Gérer des langues supplémentaires](../Editeurs/2028037.md).  
</DIV><a name="NOTE1"></a>
<a name="NOTE1_1"></a>
...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000380"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000034"></a>
...
<a name="1_ouverture_projet_plugin_wdsetup_ELTPARAGRAPHE000057"></a>
...
<a name="2_adaptation_projet_plugin_wdsetup_ELTPARAGRAPHE000078"></a>Pour réaliser un plug-in, le projet doit contenir : 
...
<a name="3_generation_bibliotheque_projet_plugin_wdsetup_ELTPARAGRAPHE000135"></a>Pour générer la bibliothèque du projet, sous le volet "Projet", dans le groupe "Génération", cliquez sur "Générer". L'assistant de création de la bibliothèque se lance. Suivez les différentes étapes de l'assistant. La bibliothèque est générée dans le répertoire Exe du projet. 
<a name="NOTE2_5"></a>


### 4. Modification du programme d'installation
<a name="4_modification_programme_installation_ELTPARAGRAPHE000154"></a>Pour intégrer le plug-in : 
...
<a name="interactions_avec_plugin_selon_les_types_installation_ELTTEXTE000428"></a>
...
### Installation simple
<a name="installation_simple_ELTPARAGRAPHE000198"></a>Les étapes de la création puis de l'installation d'une application avec installation simple sont les suivantes : 
...
<a name="installation_avec_mise_jour_automatique_reseau_local_ELTPARAGRAPHE000230"></a>Les étapes de la création puis de l'installation d'une application avec mise à jour automatique en réseau local sont les suivantes : 
...
<a name="installation_avec_mise_jour_automatique_par_http_ELTPARAGRAPHE000265"></a>Les étapes de la création puis de l'installation d'une application avec mise à jour automatique par HTTP sont les suivantes : 
...
<a name="installation_avec_mise_jour_automatique_2_niveaux_http_puis_lan_ELTPARAGRAPHE000288"></a>Les étapes de la création puis de l'installation d'une application avec mise à jour automatique à 2 niveaux (HTTP puis LAN) sont les suivantes : 
