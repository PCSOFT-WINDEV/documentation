...
<a name="mettre_place_groupware_utilisateur_sur_une_application_mobile_ELTTEXTE000359"></a>
...
<a name="etape_3_parametrez_les_utilisateurs_les_droits_ELTPARAGRAPHE000187"></a>Pour paramétrer les utilisateurs et les droits : 
...
<a name="etape_4_testez_application_ELTPARAGRAPHE000215"></a>Pour tester l'application : 
...
<a name="configuration_necessaire_pour_connecter_groupware_avec_identification_google_ELTTEXTE000407"></a>


### Configuration plateforme Google
<a name="configuration_plateforme_google_ELTPARAGRAPHE000247"></a>Pour mettre en place une connexion au groupware avec identification Google, les manipulations suivantes sont nécessaires dans la plateforme Google : 
...
<a name="configuration_application_android_sous_windev_mobile_ELTPARAGRAPHE000266"></a>Une configuration spécifique est nécessaire lors de la génération de l'application : 
...
<a name="configuration_application_android_dans_site_administration_ELTPARAGRAPHE000275"></a>Une configuration spécifique est également nécessaire dans le site d'administration (de test ou de production). 
