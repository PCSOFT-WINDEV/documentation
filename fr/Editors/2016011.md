...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Seuls les gabarits sur les états sont disponibles. Pour définir l'interface des pages d'un site, utilisez :
