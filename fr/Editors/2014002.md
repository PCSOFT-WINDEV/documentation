...
## Présentation
<a name="presentation_ELTTEXTE000626"></a>
...
<a name="creation_composant_externe_ELTTEXTE000650"></a>
...
1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_nouveau.gif) parmi les boutons d'accès rapide. Dans la fenêtre qui s'affiche, cliquez sur "Projet". L'assistant de création d'un projet s'affiche.
...
<a name="developper_composant_externe_ELTTEXTE000674"></a>
...
### Remarque
<a name="remarque_ELTPARAGRAPHE000152"></a>Un composant externe peut comporter des classes dans son interface. Il est possible de dériver ces classes dans le projet hôte, de surcharger les méthodes virtuelles, de faire du polymorphisme. L'héritage entre plusieurs niveaux de composants externes est disponible.
...
<a name="options_composant_externe_ELTTEXTE000704"></a>
Différentes options peuvent influer sur le comportement du composant externe : 

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Activation de la génération de classes Tailwind CSS.

- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Activation de la Content Security Policy (CSP).
...
<a name="definir_modifier_les_options_composant_ELTPARAGRAPHE000181"></a>Pour modifier les options du composant : 
...
2. Dans l'onglet "Général" : 
	...
	- Si le composant est disponible en WEBDEV, vous pouvez : 
		...
		- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Activer la génération de classes Tailwind CSS. 
						Pour plus de détails, consultez [WEBDEV et Tailwind CSS](../Editeurs/1410086657.md). 
						

		- ![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Activer la Content Security Policy (CSP).
...
- Accédez aux options avancées en cliquant sur "Options du composant". Vous pouvez alors définir : 
	...
	- [Le mode de gestion des gabarits sur les éléments du composant](#NOTE4_4).
...
<a name="droits_acces_composant_sur_projet_client_ELTPARAGRAPHE000225"></a>Trois possibilités :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Creer_un_composant_et_le_distribuer%20-%20HC%20N%B0002.gif)
...
<a name="style_mode_gestion_des_gabarits_sur_les_elements_composant_ELTPARAGRAPHE000280"></a>Par défaut, il est possible d'appliquer le gabarit du projet hôte sur les différents éléments du composant externe. Pour plus de détails sur les gabarits, consultez [Gabarits](../Editeurs/2016011.md).
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Creer_un_composant_et_le_distribuer%20-%20HC%20N%B0003.gif)
...
<a name="generer_composant_externe_ELTTEXTE000764"></a>
...
- dans les boutons d'accès rapide, cliquez sur l'icône de génération du composant : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_generation_Composant.gif)
...
### Générer un composant externe
<a name="generer_composant_externe_ELTPARAGRAPHE000336"></a>Pour générer un composant externe : 
...
<a name="generer_composant_externe_pour_android_ELTPARAGRAPHE000460"></a>Si le composant généré peut être utilisé par une plateforme Android, l'assistant propose les étapes supplémentaires suivantes : 
...
<a name="generer_composant_externe_pour_ios_ELTPARAGRAPHE000550"></a>Si le composant généré peut être utilisé par une plateforme iOS, l'assistant propose les étapes supplémentaires suivantes : 
