...
## Présentation
<a name="presentation_ELTTEXTE003199"></a>
...
| <br><br>- gestion des dates<br><br><br> | <br><br>- [ADD_MONTHS](#SQL_ADD_MONTHS)<br><br>- [LAST_DAY](#SQL_LAST_DAY)<br><br>- [MONTHS_BETWEEN](#SQL_MONTHS_BETWEEN)<br><br>- [NEXT_DAY](#SQL_NEXT_DAY)<br><br>- [ROUND](#SQL_ROUND)<br><br>- [SYSDATE](#SQL_SYSDATE)<br><br>- [TRUNC](#SQL_TRUNC)<br><br>- [DAY](#SQL_DAY)<br><br>- [DAYOFMONTH](#SQL_DAYOFMONTH)<br><br>- [DAYOFWEEK](#SQL_DAYOFWEEK)<br><br>- [DAYOFYEAR](#SQL_DAYOFYEAR)<br><br>- [GETDATE](#SQL_GETDATE)<br><br>- [GETUTCDATE](#SQL_GETUTCDATE)<br><br>- [ISDATE](#SQL_ISDATE)<br><br>- [EOMONTH](#SQL_EOMONTH)<br><br>- [DATEADD](#SQL_DATEADD)<br><br>- [ADDDATE](#SQL_ADDDATE)<br><br>- [SUBDATE](#SQL_SUBDATE)<br><br>- [DATEDIFF](#SQL_DATEDIFF), [DATEDIFF_BIG](#SQL_DATEDIFF)<br><br>- [DATETIMEFROMPARTS](#SQL_DATETIMEFROMPARTS), [DATEFROMPARTS](#SQL_DATEFROMPARTS), [DATEPART](#SQL_DATEPART)<br><br>- [CURRENT_DATE](#SQL_CURRENT_DATE)<br>	<br><br>- [CURDATE](#SQL_CURRENT_DATE)<br>	<br><br>- [MONTH](#SQL_YEAR_MONTH), [YEAR](#SQL_YEAR_MONTH)<br><br>- [NOW](#SQL_NOW)<br>	<br><br><br> |
| <br><br>- gestion des heures<br><br><br> | <br><br>- [NEW_TIME](#SQL_NEW_TIME)<br><br>- [CURRENT_TIMESTAMP](#SQL_CURRENT_TIMESTAMP)<br><br>- [CURRENT_TIME](#SQL_CURRENT_TIME)<br>	<br><br>- [CURTIME](#SQL_CURRENT_TIME)<br>	<br><br>- [LOCALTIME](#SQL_LOCALTIME)<br>	<br><br>- [LOCALTIMESTAMP](#SQL_LOCALTIME)<br>	<br><br>- [HOUR](#SQL_HOUR)<br>	<br><br>- [MINUTE](#SQL_MINUTE)<br>	<br><br>- [SEC_TO_TIME](#SQL_SECTOTIME)<br>	<br><br><br> |
...
## Fonctions SQL
<a name="fonctions_sql_ELTTEXTE003313"></a>


### Expression scalaire
<a name="expression_scalaire_ELTPARAGRAPHE000533"></a>Chaque paramètre passé à ces fonctions SQL correspond à une expression (appelée "Expression scalaire").
...
### LEFT
<a name="left_ELTPARAGRAPHE000579"></a>La fonction **LEFT** extrait la partie gauche (c'est-à-dire les premiers caractères) d'une expression.
...
### RIGHT
<a name="right_ELTPARAGRAPHE000595"></a>La fonction **RIGHT** extrait la partie droite (c'est-à-dire les derniers caractères) d'une expression.
...
<a name="mid_substr_substring_ELTPARAGRAPHE000608"></a>Les fonctions **MID, SUBSTR et SUBSTRING** permettent d'extraire une sous-chaîne du contenu d'une expression à partir d'une position donnée.
...
### MID
<a name="mid_ELTPARAGRAPHE000628"></a>La fonction **MID** peut être utilisée uniquement sur une source de données de type Access.
...
### SUBSTR
<a name="substr_ELTPARAGRAPHE000641"></a>La fonction **SUBSTR** peut être utilisée uniquement sur une source de données de type Oracle, HFSQL Classic ou HFSQL Client/Serveur.
...
### BTRIM
<a name="btrim_ELTPARAGRAPHE000671"></a>La fonction **BTRIM** supprime une séquence de caractères en début ou en fin de chaîne. 
...
### LTRIM
<a name="ltrim_ELTPARAGRAPHE000685"></a>La fonction **LTRIM** renvoie une chaîne de caractères :
...
### RTRIM
<a name="rtrim_ELTPARAGRAPHE000727"></a>La fonction **RTRIM** renvoie une chaîne de caractères :
...
### TRIM
<a name="trim_ELTPARAGRAPHE000773"></a>La fonction **TRIM** renvoie une chaîne de caractères :
...
### OVERLAY
<a name="overlay_ELTPARAGRAPHE000792"></a>La fonction **OVERLAY** permet de remplacer une chaîne de caractères dans une autre. 
...
### REPLACE
<a name="replace_ELTPARAGRAPHE000805"></a>La fonction **REPLACE** renvoie une chaîne de caractères :
...
### TRANSLATE
<a name="translate_ELTPARAGRAPHE000832"></a>La fonction **TRANSLATE** renvoie une chaîne de caractères en remplaçant tous les caractères indiqués par d'autres caractères. Si un caractère à remplacer n'a pas sa correspondance, ce caractère est supprimé.
...
### CONCAT
<a name="concat_ELTPARAGRAPHE000853"></a>La fonction **CONCAT** concatène plusieurs chaînes entre elles.
...
### GROUP_CONCAT
<a name="groupconcat_ELTPARAGRAPHE000870"></a>La clause **GROUP_CONCAT** permet de regrouper dans une même chaîne de caractères les différentes valeurs non nulles d'une rubrique issue d'une série d'enregistrements.
...
### STRING_AGG
<a name="stringagg_ELTPARAGRAPHE000938"></a>La fonction **STRING_AGG** permet de concaténer des chaînes non nulles d'une liste de valeurs.
...
### LPAD
<a name="lpad_ELTPARAGRAPHE000961"></a>La fonction **LPAD** renvoie une chaîne de taille déterminée. Pour atteindre la taille requise, cette chaîne est complétée à gauche :
...
### RPAD
<a name="rpad_ELTPARAGRAPHE000992"></a>La fonction **RPAD** renvoie une chaîne de taille déterminée. Pour atteindre la taille requise, cette chaîne est complétée à droite :
...
### LOWER
<a name="lower_ELTPARAGRAPHE001347"></a>La fonction **LOWER** convertit une expression en minuscules.
...
### UPPER
<a name="upper_ELTPARAGRAPHE001362"></a>La fonction **UPPER** convertit une expression en majuscules.
...
### LEN / LENGTH
<a name="len_length_ELTPARAGRAPHE001407"></a>Les fonctions **LEN et LENGTH** renvoient la taille (le nombre de caractères) d'une expression.
...
### LEN
<a name="len_ELTPARAGRAPHE001416"></a>La fonction **LEN** peut être utilisée sur tous les types de source de données, sauf les sources de données de type Oracle. Pour les sources de données de type Oracle, utilisez la fonction **LENGTH**.
...
### LENGTH
<a name="length_ELTPARAGRAPHE001429"></a>La fonction **LENGTH** peut être utilisée uniquement sur une source de données de type Oracle.
...
### INSTR
<a name="instr_ELTPARAGRAPHE001442"></a>La fonction **INSTR** renvoie la position d'une chaîne de caractères dans une expression.
...
### PATINDEX
<a name="patindex_ELTPARAGRAPHE001491"></a>La fonction **PATINDEX** renvoie la position de la première occurrence d'une chaîne de caractères correspondant à une valeur spécifiée (avec des caractères génériques).
...
### POSITION
<a name="position_ELTPARAGRAPHE001599"></a>La fonction **POSITION** renvoie la position d'une chaîne de caractères dans une expression.
...
### COUNT
<a name="count_ELTPARAGRAPHE001612"></a>La fonction **COUNT** renvoie :
...
### AVG
<a name="avg_ELTPARAGRAPHE001638"></a>La fonction **AVG** calcule :
...
### MAX
<a name="max_ELTPARAGRAPHE001660"></a>La fonction **MAX** renvoie la plus grande valeur des valeurs présentes dans une rubrique pour tous les enregistrements sélectionnés dans le fichier.
...
### MIN
<a name="min_ELTPARAGRAPHE001679"></a>La fonction **MIN** renvoie la plus petite valeur des valeurs non nulles présentes dans une rubrique pour tous les enregistrements sélectionnés dans le fichier.
...
### SUM
<a name="sum_ELTPARAGRAPHE001692"></a>La fonction **SUM** renvoie :
...
### EVERY
<a name="every_ELTPARAGRAPHE001724"></a>La fonction **EVERY** est une fonction d'agrégation (comme l'ordre SUM par exemple), c'est-à-dire que la fonction agit sur un groupe de données et renvoie une valeur.
...
### TOP
<a name="top_ELTPARAGRAPHE001749"></a>La fonction **TOP** renvoie uniquement les n premiers enregistrements du résultat d'une requête.
...
### BOTTOM
<a name="bottom_ELTPARAGRAPHE001779"></a>La fonction **BOTTOM** renvoie uniquement les n derniers enregistrements du résultat d'une requête.
...
### LIMIT
<a name="limit_ELTPARAGRAPHE001807"></a>La fonction **LIMIT** renvoie uniquement les n premiers enregistrements du résultat d'une requête.
...
### ASCII
<a name="ascii_ELTPARAGRAPHE001835"></a>La fonction **ASCII** renvoie le code ASCII :
...
### UNICODE
<a name="unicode_ELTPARAGRAPHE001850"></a>La fonction **UNICODE** renvoie la valeur entière définie par la norme Unicode :
...
### CURRENT_USER
<a name="currentuser_ELTPARAGRAPHE001865"></a>La fonction **CURRENT_USER** renvoie le nom de l'utilisateur de la connexion en cours.
...
### SYSTEM_USER
<a name="systemuser_ELTPARAGRAPHE001880"></a>La fonction **SYSTEM_USER** renvoie le nom de l'utilisateur de la connexion en cours.
...
### USER_NAME
<a name="username_ELTPARAGRAPHE001895"></a>La fonction **USER_NAME** renvoie le nom de l'utilisateur de la connexion en cours.
...
### SOUNDEX, SOUND LIKE
<a name="soundex_sound_like_ELTPARAGRAPHE001908"></a>Les fonctions **SOUNDEX** et **SOUND LIKE** renvoient la représentation phonétique d'une chaîne de caractères (basé sur un algorithme anglo-saxon).
...
<a name="soundex2_sound2_like_ELTPARAGRAPHE001931"></a>Les fonctions **SOUNDEX2** et **SOUND2 LIKE** renvoient la représentation phonétique d'une chaîne de caractères (basé sur un algorithme proche du français).
...
### ADD_MONTHS
<a name="addmonths_ELTPARAGRAPHE001951"></a>La fonction **ADD_MONTHS** permet d'ajouter plusieurs mois à une date spécifiée.
...
### LAST_DAY
<a name="lastday_ELTPARAGRAPHE001968"></a>La fonction **LAST_DAY** permet d'obtenir la date du dernier jour du mois spécifié.
...
### DAY
<a name="day_ELTPARAGRAPHE001987"></a>La fonction **DAY** renvoie le jour du mois, c'est-à-dire un nombre compris entre 1 et 31.
...
### DAYOFMONTH
<a name="dayofmonth_ELTPARAGRAPHE001999"></a>La fonction **DAYOFMONTH** renvoie le jour dans le mois (compris entre 1 et 31).
...
### DAYOFWEEK
<a name="dayofweek_ELTPARAGRAPHE002011"></a>La fonction **DAYOFWEEK** renvoie le jour dans la semaine (1 pour Dimanche, 2 pour Lundi, etc.). 
...
### DAYOFYEAR
<a name="dayofyear_ELTPARAGRAPHE002023"></a>La fonction **DAYOFYEAR** renvoie le jour dans l'année (compris entre 1 et 366). 
...
### EOMONTH
<a name="eomonth_ELTPARAGRAPHE002035"></a>La fonction **EOMONTH** renvoie le dernier jour du mois contenant la date spécifiée. 
...
### YEAR et MONTH
<a name="year_month_ELTPARAGRAPHE002051"></a>Les fonctions **YEAR** et **MONTH** permettent d'obtenir respectivement l'année et le mois d'une date. 
...
### CURRENT_TIMESTAMP
<a name="currenttimestamp_ELTPARAGRAPHE002077"></a>La fonction **CURRENT_TIMESTAMP** renvoie l'heure locale du serveur (au format date-heure). 
...
<a name="currenttime_curtime_ELTPARAGRAPHE002089"></a>Les fonctions **CURRENT_TIME** et **CURTIME** renvoient l'heure courante du serveur. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) Les fonctions CURRENT_TIME et CURTIME sont gérées par MySQL. La fonction CURRENTIME est également gérée par PostgreSQL.  
<a name="SQL_HOUR"></a>


### HOUR
<a name="hour_ELTPARAGRAPHE002106"></a>La fonction **HOUR** extrait le nombre d'heures d'une heure ou d'une date-heure. 
...
### MINUTE
<a name="minute_ELTPARAGRAPHE002120"></a>La fonction **MINUTE** extrait le nombre de minutes d'une heure ou d'une date-heure. 
...
### SECONDE
<a name="seconde_ELTPARAGRAPHE002134"></a>La fonction **SECONDE** extrait le nombre de secondes d'une heure.  
...
### SEC_TO_TIME
<a name="sectotime_ELTPARAGRAPHE002148"></a>La fonction **SEC_TO_TIME** convertit un nombre de secondes en durée.  
...
### NOW
<a name="now_ELTPARAGRAPHE002162"></a>La fonction **NOW** renvoie l'heure locale du serveur (au format date-heure). 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) La fonction NOW est gérée par MySQL. 
<a name="SQL_LOCALTIME"></a>


### LOCALTIME, LOCALTIMESTAMP
<a name="localtime_localtimestamp_ELTPARAGRAPHE002179"></a>Les fonctions **LOCALTIME** et **LOCALTIMESTAMP** renvoient l'heure locale du serveur (au format date-heure). 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) Ces fonctions sont gérées par MySQL et PostgreSQL. 
<a name="SQL_CURRENT_DATE"></a>


### CURRENT_DATE, CURDATE
<a name="currentdate_curdate_ELTPARAGRAPHE002196"></a>Les fonctions **CURRENT_DATE** et **CURDATE** renvoient la date courante du serveur : 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) Les fonctions CURRENT_DATE et CURDATE sont gérées par MySQL.  
...
### GETDATE
<a name="getdate_ELTPARAGRAPHE002217"></a>La fonction **GETDATE** renvoie l'heure locale du serveur (au format date-heure). 
...
### GETUTCDATE
<a name="getutcdate_ELTPARAGRAPHE002229"></a>La fonction **GETUTCDATE** renvoie l'heure UTC du serveur (au format date-heure). 
...
### DATEADD
<a name="dateadd_ELTPARAGRAPHE002241"></a>La fonction **DATEADD** ajoute une valeur à la date de départ et renvoie la nouvelle date correspondante.  
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) DATEADD est géré par SQL Server. 
<a name="SQL_ADDDATE"></a>


### ADDDATE
<a name="adddate_ELTPARAGRAPHE002319"></a>La fonction **ADDDATE** ajoute une valeur (année, mois, etc.) à une date heure de départ. La nouvelle date heure est retournée par la fonction. Si la valeur indiquée est négative, cette valeur sera retranchée à la date de départ sinon elle sera ajoutée.
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) ADDDATE est géré par MySQL. 
...
![Connecteurs Natifs (Accès Natifs)](https://doc.pcsoft.fr/ext/images/fr/AN.png) SUBDATE est géré par MySQL. 
<a name="SQL_DATEDIFF"></a>


### DATEDIFF et DATEDIFF_BIG
<a name="datediff_datediffbig_ELTPARAGRAPHE002406"></a>La fonction **DATEDIFF** calcule la différence entre deux dates dans l'unité spécifiée. La valeur de retour est un entier signé. 
...
### DATEPART
<a name="datepart_ELTPARAGRAPHE002483"></a>La fonction **DATEPART** renvoie l'entier correspondant à la partie demandée de la date-heure spécifiée.  
...
### DATETIMEFROMPARTS
<a name="datetimefromparts_ELTPARAGRAPHE002557"></a>La fonction **DATETIMEFROMPARTS** renvoie une date-heure correspondant aux éléments spécifiés. 
...
### DATEFROMPARTS
<a name="datefromparts_ELTPARAGRAPHE002569"></a>La fonction **DATEFROMPARTS** renvoie une date correspondant aux éléments spécifiés. 
...
### MONTHS_BETWEEN
<a name="monthsbetween_ELTPARAGRAPHE002579"></a>La fonction **MONTHS_BETWEEN** permet d'obtenir le nombre de mois entre deux dates spécifiées.
...
### NEW_TIME
<a name="newtime_ELTPARAGRAPHE002599"></a>La fonction **NEW_TIME** permet d'obtenir une date après conversion de fuseau horaire.
...
### NEXT_DAY
<a name="nextday_ELTPARAGRAPHE002618"></a>La fonction **NEXT_DAY** permet d'obtenir le premier jour de la semaine suivant la date spécifiée ou le jour spécifié.
...
### ROUND
<a name="round_ELTPARAGRAPHE002636"></a>La fonction **ROUND** permet d'arrondir la date au format spécifié.
...
### SYSDATE
<a name="sysdate_ELTPARAGRAPHE002657"></a>La fonction **SYSDATE** permet d'obtenir la date et l'heure courante.
...
### TRUNC
<a name="trunc_ELTPARAGRAPHE002674"></a>La fonction **TRUNC** permet de tronquer la date au format spécifié.
...
### ISDATE
<a name="isdate_ELTPARAGRAPHE002705"></a>La fonction **ISDATE** permet de savoir si une expression correspond à une date. Cette fonction renvoie : 
...
### COALESCE
<a name="coalesce_ELTPARAGRAPHE002721"></a>La fonction **COALESCE** permet de trouver la première expression non nulle parmi ses arguments. 
...
### NVL, IFNULL, ISNULL
<a name="nvl_ifnull_isnull_ELTPARAGRAPHE002762"></a>La fonction **NVL** permet de remplacer les valeurs nulles d'une colonne par une valeur de substitution. Les fonctions ISNULL et IFNULL sont identiques.
...
### NULLIF
<a name="nullif_ELTPARAGRAPHE002777"></a>La fonction **NULLIF** renvoie une valeur NULL si les deux expressions spécifiées sont égales.
...
### DECODE
<a name="decode_ELTPARAGRAPHE002787"></a>La fonction **DECODE** permet d'obtenir le fonctionnement d'une instruction SI .. ALORS .. SINON.
...
### CASE
<a name="case_ELTPARAGRAPHE002804"></a>La fonction **CASE** permet d'obtenir le fonctionnement d'une instruction SI .. ALORS .. SINON.
...
### MATCH AGAINST
<a name="match_against_ELTPARAGRAPHE002821"></a>La fonction **MATCH AGAINST** permet d'obtenir l'indice de pertinence de l'enregistrement lors d'une recherche full-text.
...
<a name="operateurs_fonctions_sur_les_bits_ELTPARAGRAPHE002964"></a>Les opérateurs permettant de manipuler les bits sont les suivants : 
...
### IS JSON XXX
<a name="json_xxx_ELTPARAGRAPHE002991"></a>
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Ces commandes ne sont pas disponibles.
<a name="SQL_JSONVALUE"></a>


### JSON_VALUE
<a name="jsonvalue_ELTPARAGRAPHE003016"></a>La commande SQL "JSON_VALUE" permet de récupérer la valeur d'un élément contenu dans la rubrique JSON.
**Format d'utilisation** :
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Cette commande n'est pas disponible.
<a name="SQL_JSONQUERY"></a>


### JSON_QUERY
<a name="jsonquery_ELTPARAGRAPHE003040"></a>La commande SQL "JSON_QUERY" permet de récupérer un objet ou un tableau au format JSON.
**Format d'utilisation** :
...
### JSON_EXISTS
<a name="jsonexists_ELTPARAGRAPHE003063"></a>La commande SQL "JSON_EXISTS" permet de récupérer les enregistrements dont la rubrique JSON contient une donnée. 
...
### JSON_OBJECT
<a name="jsonobject_ELTPARAGRAPHE003087"></a>La commande SQL "JSON_OBJECT" permet de récupérer un objet JSON à partir de n'importe quelle rubrique. Le contenu JSON récupéré correspond à un objet. 
...
### JSON_OBJECTAGG
<a name="jsonobjectagg_ELTPARAGRAPHE003104"></a>La commande SQL "JSON_OBJECTAGG" permet de récupérer un objet JSON contenant une paire "clé:valeur" pour chaque clé et valeur spécifiques dans un ensemble de valeurs SQL.
...
### JSON_ARRAY
<a name="jsonarray_ELTPARAGRAPHE003120"></a>La commande SQL "JSON_ARRAY" permet de récupérer un tableau JSON à partir de n'importe quelle rubrique. Le contenu JSON récupéré correspond à un tableau ( [ xxx,...] ). 
...
### JSON_ARRAYAGG
<a name="jsonarrayagg_ELTPARAGRAPHE003139"></a>La commande SQL "JSON_ARRAYAGG" permet de récupérer un tableau JSON contenant une paire "clé:valeur" pour chaque clé et valeur spécifiques dans un ensemble de valeurs SQL. Le contenu JSON récupéré correspond à un tableau ( [ xxx,...] ). 
...
[Surcharger une fonction WLangage ou utiliser une fonction WLangage dans une requête SQL](../Editeurs/1513004.md)
