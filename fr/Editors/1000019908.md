...
1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Generation_iOS_WM_bl.gif) parmi les boutons d'accès rapide. L'assistant de génération se lance. 
...
24. ![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png) Si votre application IOS est liée à une application Apple Watch, indiquez le chemin des différentes icônes de l'application Apple Watch : 
...
<a name="contenu_repertoire_generation_nomduprojetxcodegen_ELTPARAGRAPHE000252"></a>Le répertoire de génération contient les éléments suivants : 
