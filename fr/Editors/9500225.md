...
<a name="conseils_prerequis_ELTPARAGRAPHE000022"></a>La webisation d'une application WINDEV peut être réalisée uniquement : 
...
<a name="suivre_les_conseils_audit_webisation_ELTPARAGRAPHE000134"></a>L'audit de webisation est automatiquement lancé à la fin de l'assistant de webisation et peut être lancé à tout moment via le menu de WINDEV : sous le volet "Projet", dans le groupe "Webisation", déroulez "Webiser" et sélectionnez l'option "Audit de webisation".
...
### Finir la webisation
<a name="finir_webisation_ELTPARAGRAPHE000164"></a>Lorsque toutes les erreurs de compilation et les erreurs de l'audit de webisation sont corrigées, les adaptations de gestion réalisées, la webisation est terminée. 
...
[Passer un projet WINDEV en Mobile : un audit détaillé](../Editeurs/9500228.md)
