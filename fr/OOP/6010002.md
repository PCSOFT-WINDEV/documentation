...
<a name="presentation_objet_ELTTEXTE000224"></a>
...
<a name="syntaxe_declaration_instanciation_objet_ELTTEXTE000248"></a>


### Déclaration/instanciation d'un objet
<a name="declarationinstanciation_objet_ELTPARAGRAPHE000054"></a>
```txt
...
<a name="declaration_instanciation_objet_null_ELTPARAGRAPHE000079"></a>
```txt
...
<a name="remarque_objet_cours_ELTPARAGRAPHE000094"></a>Le mot-clé **Objet** peut également être utilisé pour désigner l'objet en cours.
...
### Membres et méthodes
<a name="membres_methodes_ELTPARAGRAPHE000106"></a>Pour plus de détails sur les membres et les méthodes, consultez [Utilisation d'un objet](../POO/6010010.md).
...
<a name="duree_vie_objet_ELTTEXTE000290"></a>


### Référence sur un objet local
<a name="reference_sur_objet_local_ELTPARAGRAPHE000119"></a>L'objet est créé lors de sa déclaration. Par défaut, l'objet est local.
...
### Renvoyer un objet
<a name="renvoyer_objet_ELTPARAGRAPHE000135"></a>Il est possible de renvoyer un objet manipulé par une variable locale dynamique ou non dynamique.
...
<a name="objets_dans_les_boucles_ELTPARAGRAPHE000145"></a>Dans une boucle, il est possible de manipuler des objets par des variables locales non dynamiques et sans allocation explicite.
...
### Libération d'objet
<a name="liberation_objet_ELTPARAGRAPHE000162"></a>Les objets manipulés par des variables locales non dynamiques peuvent être détruits explicitement avec le mot-clé [LIBERER](../Motscles/1511012.md) pour anticiper la destruction automatique.
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) **Cas particulier en Java/Android**
