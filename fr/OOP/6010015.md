...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000235"></a>
...
<a name="manipulations_grace_executetraitement_aux_operateurs_indirection_ELTTEXTE000259"></a>


### Utilisation de la fonction ExécuteTraitement
<a name="utilisation_fonction_executetraitement_ELTPARAGRAPHE000109"></a>La fonction [ExécuteTraitement](../WDLang1/3013031.md) permet d'appeler le code d'un événement associé à un objet.
...
<a name="utilisation_des_operateurs_indirection_ELTPARAGRAPHE000130"></a>Les opérateurs { } d'indirection permettent de manipuler le contenu d'une variable par un adressage indirect : le nom de l'objet à adresser est contenu dans une variable. 
...
## Exemple
<a name="exemple_ELTTEXTE000289"></a>
...
[Définition (Type de variable)](../POO/1000019540.md)

[Description de Propriété (Type de variable)](../POO/1000019324.md)

[Description de Variable (Type de variable)](../POO/1000019560.md)

[ExécuteTraitement (Fonction)](../POO/3013031.md)
