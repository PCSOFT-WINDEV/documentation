...
<a name="presentation_une_classe_ELTTEXTE000782"></a>
...
## Exemple de classe
<a name="exemple_classe_ELTTEXTE000806"></a>
...
<a name="creation_declaration_une_classe_ELTTEXTE000830"></a>


### Création d'une classe
<a name="creation_une_classe_ELTPARAGRAPHE000057"></a>Pour créer une classe :
...
<a name="syntaxe_declaration_classe_ses_elements_ELTPARAGRAPHE000081"></a>
```txt
...
<a name="declaration_une_classe_ELTTEXTE000860"></a>


### Syntaxe
<a name="syntaxe_ELTPARAGRAPHE000091"></a>
```txt
...
Permet d'indiquer que tous les membres de la classe sont immuables. Dans ce cas, la valeur des membres immuables est définie soit lors de la déclaration du membre, soit dans le constructeur de la classe.<a name="NOTE3_4"></a>


### Exemple
<a name="exemple_ELTPARAGRAPHE000124"></a>
```wl
...
<a name="declaration_des_membres_une_classe_ELTTEXTE000890"></a>


### Syntaxe
<a name="syntaxe_ELTPARAGRAPHE000133"></a>
```txt
[GLOBAL] [<Mode d'accès>]
...
<a name="cas_particulier_declaration_des_membres_type_tableau_ELTPARAGRAPHE000178"></a>Pour déclarer un tableau dans une classe, il suffit d'utiliser la syntaxe suivante :
...
<a name="serialisation_des_membres_une_classe_ELTPARAGRAPHE000224"></a>Par défaut, tous les membres d'une classe sont sérialisés. 
...
<a name="immuabilite_des_membres_une_classe_ELTPARAGRAPHE000260"></a>Un membre de classe peut être immuable. Dans ce cas, lorsque sa valeur est définie, elle ne pourra pas changer. La valeur des membres immuables est définie soit lors de la déclaration du membre, soit dans le constructeur de la classe.
...
### Data binding
<a name="data_binding_ELTPARAGRAPHE000281"></a>Le Data binding est disponible sur les membres de la classe. 
...
<a name="declaration_des_constantes_classe_ELTTEXTE000938"></a>


### Syntaxe
<a name="syntaxe_ELTPARAGRAPHE000290"></a>
```txt
...
<a name="detail_syntaxe_ELTPARAGRAPHE000297"></a>**&lt;Nom de la constante&gt;**
...
### Exemple
<a name="exemple_ELTPARAGRAPHE000312"></a>
```wl
CONSTANT K=5
CONSTANT 
	K=5
...
<a name="creation_declaration_singleton_ELTTEXTE000974"></a>
...
<a name="creation_declaration_des_methodes_classes_ELTTEXTE000998"></a>


### Création d'une méthode de classe
<a name="creation_une_methode_classe_ELTPARAGRAPHE000337"></a>Pour créer une méthode de classe :
...
<a name="syntaxe_declaration_une_methode_ELTPARAGRAPHE000385"></a>
```txt
...
### Détail de la syntaxe
<a name="detail_syntaxe_ELTPARAGRAPHE000392"></a>**&lt;Accès&gt; : Optionnel**
...
<a name="suppression_une_methode_ELTPARAGRAPHE000479"></a>Une méthode peut être supprimée : 
...
<a name="creation_declaration_des_proprietes_ELTTEXTE001046"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000493"></a>Une propriété est un élément de code possédant deux événements : 
...
<a name="creation_une_propriete_classe_ELTPARAGRAPHE000508"></a>Pour créer une propriété de classe :
...
### Data binding
<a name="data_binding_ELTPARAGRAPHE000541"></a>Le Data binding est disponible sur les propriétés des classes et des membres de classes.
<a name="NOTE7_4"></a>


### Droits d'accès à une propriété
<a name="droits_acces_une_propriete_ELTPARAGRAPHE000548"></a>Si l'événement de récupération est vide, la lecture de la propriété est interdite. Une erreur de compilation apparaîtra sous l'éditeur et une erreur se produira également en exécution.
...
<a name="membres_proprietes_ELTPARAGRAPHE000564"></a>Une propriété peut avoir le même nom qu'un membre déjà existant. Dans ce cas, les ordres de priorité sont les suivants :
...
### Héritage
<a name="heritage_ELTPARAGRAPHE000578"></a>Les propriétés des classes de base sont héritées dans les classes dérivées.
...
<a name="passage_proprietes_parametre_une_fonction_procedure_wlangage_ELTPARAGRAPHE000592"></a>**Si le paramètre est passé par référence (cas par défaut) et non typé** : 
...
<a name="instances_classe_contexte_hfsql_independant_ELTTEXTE001106"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000630"></a>Il est possible d'associer une copie du contexte HFSQL à une instance de classe. Tous les accès à HFSQL effectués depuis les méthodes et les propriétés de la classe (appels de fonctions ou accès aux enregistrements) opèrent sur la copie du contexte de l'instance de la classe.
...
### Syntaxe
<a name="syntaxe_ELTPARAGRAPHE000641"></a>La syntaxe à utiliser est la suivante :
...
### Utilisation
<a name="utilisation_ELTPARAGRAPHE000664"></a>Le contexte HFSQL de l'instance est créé par copie du contexte courant lors de l'exécution du constructeur.
...
## Notes
<a name="notes_ELTTEXTE001142"></a>


### Légende des icônes utilisées
<a name="legende_des_icones_utilisees_ELTPARAGRAPHE000681"></a>Les différentes icônes utilisées sont les suivantes :
...
<a name="nouveautes_depuis_version_9_ELTPARAGRAPHE000729"></a>Une classe contenant un membre de type caractère n'a pas le même comportement que dans les versions précédentes. En effet, les caractères occupaient 1 octet dans les versions précédentes et 2 octets à partir de la version 9.
...
[Constructeur et destructeur](../POO/6010001.md)

[Affectation multiple des tableaux, structures et classes](../POO/1514031.md)

[Héritage de classe](../POO/6010007.md)

[Interface](../POO/6010017.md)

[Utilisation des objets](../POO/6010010.md)

[Documentation automatique des procédures et méthodes](../POO/1513006.md)

[Importer des classes et des collections de procédures (fichier texte)](../POO/9000183.md)
