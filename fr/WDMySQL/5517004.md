...
## Programmation
<a name="programmation_ELTTEXTE000158"></a>


### 1. Ouverture de la connexion
<a name="1_ouverture_connexion_ELTPARAGRAPHE000022"></a>La fonction [SQLConnecte](../WDLang4/3072005.md) permet d'ouvrir une connexion à une base de données MySQL par le Connecteur Natif. Il est nécessaire de passer en paramètre à la fonction **SQLConnecte**le type de la base utilisée, ici MySQL.
...
<a name="2_execution_requetes_ELTPARAGRAPHE000036"></a>L'exécution de requêtes est réalisée grâce à la fonction [SQLExec](../WDLang4/3072007.md). La fonction **SQLExec** attend en paramètres le texte de la requête SQL et le nom qui sera donné à cette requête.
...
<a name="3_recuperation_resultat_ELTPARAGRAPHE000048"></a>Plusieurs modes de récupération du résultat sont disponibles :
...
<a name="4_fermeture_connexion_ELTPARAGRAPHE000076"></a>La fonction [SQLFerme](../WDLang4/3072015.md) permet de fermer la connexion à la base de données lorsque toutes les requêtes nécessaires ont été réalisées.
