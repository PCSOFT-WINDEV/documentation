...
<a name="editeur_projets_ELTPARAGRAPHE000038"></a>L'éditeur de projet permet de gérer le projet à l'aide d'un tableau de bord complet.
...
### Editeur d'analyses
<a name="editeur_analyses_ELTPARAGRAPHE000047"></a>L'éditeur d'analyses permet de décrire les caractéristiques et la structure des fichiers de données.
...
### Editeur de requêtes
<a name="editeur_requetes_ELTPARAGRAPHE000065"></a>L'éditeur de requêtes permet de créer automatiquement des requêtes sur les fichiers de données. 
...
### Editeurs de pages
<a name="editeurs_pages_ELTPARAGRAPHE000074"></a>L'éditeur de pages permet de décrire les caractéristiques de l'interface utilisateur de votre projet.
...
### Editeur d'états
<a name="editeur_etats_ELTPARAGRAPHE000098"></a>L'éditeur d'états permet de créer très simplement des états à imprimer.
...
### Editeur de code
<a name="editeur_code_ELTPARAGRAPHE000107"></a>L'éditeur de code permet de saisir tous les traitements/événements en WLangage (le langage de programmation intégré à WINDEV, WEBDEV et WINDEV Mobile). Il permet par exemple de saisir le code source des éléments suivants :
...
### Editeur d'images
<a name="editeur_images_ELTPARAGRAPHE000116"></a>L'éditeur d'images permet d'éditer les images et icônes du projet et de ses éléments. 
