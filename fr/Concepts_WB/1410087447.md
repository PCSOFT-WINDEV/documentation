...
<a name="principe_utilisation_ELTPARAGRAPHE000063"></a>**Installation**![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GestionnaireDeSources1.gif)
...
Pour profiter des modifications effectuées, les autres développeurs doivent synchroniser leur projet local avec le projet de référence (présent dans la base de sources).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GestionnaireDeSources_synch.gif)
