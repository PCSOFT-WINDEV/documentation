...
1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_ICO_Cr%E9er_cpt.gif)
 parmi les boutons d'accès rapide. La fenêtre de création d'un nouvel élément s'affiche : cliquez sur "Données" puis sur "Analyse". L'assistant de création de l'analyse est lancé.
...
Par exemple : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_BaseDonn%E9esExterne1.gif&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Base%20Oracle%20WB%20-%20HC%20N%B0001.gif&type=thumb)
...
**Remarque** : il est également possible de créer une rubrique à partir des méta-types proposés par WINDEV. Pour cela, il suffit de cliquer sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MLD_Metatype_ico.gif)
. La liste des méta-types disponibles apparaît.
<a name="NOTE2_5"></a>
...
La représentation d'une telle liaison est la suivante :![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonPartagee_1N11.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CardinaliteFenDescriptionWB.gif)
...
Dans le cas d'une liaison parallèle, ***chaque enregistrement*** d'un fichier de données (Produit) est relié à ***un enregistrement*** dans un autre fichier de données (Information), et ***réciproquement***.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonParallele.gif)
...
- ***Chaque enregistrement*** de l'autre fichier de données (Groupe) ***n'a aucun enregistrement ou un seul enregistrement*** associé dans le premier fichier de données (Catégorie).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonFacultative.gif)
...
- ***Chaque enregistrement*** de l'autre fichier de données (Détail) a ***nécessairement un enregistrement*** associé dans le premier fichier de données (Produit).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Liaisoncomplement.gif)
...
**Liaison partagée de cardinalité 0,N - 0,1**![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonPartagee_0N01.gif)
...
**Liaison partagée de cardinalité 0,N - 1,1**![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonPartagee_0N11.gif)
Avec ce type de liaison :
...
- un membre peut ne pas avoir de propriétaire (un produit peut avoir aucun fournisseur).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonPartagee_1N01.gif)
...
- chaque membre a un seul propriétaire (chaque produit a un seul fournisseur).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonPartagee_1N11.gif)
...
Les liaisons entre les fichiers de données sont les suivantes :![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=LiaisonPartagee_1N1N.gif)
