...
3. Dans la fenêtre qui s'affiche, choisissez le type d'ancrage à utiliser. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ancrage_WebDev.gif&type=thumb)

	Trois types d'ancrages sont à définir :

	- ancrage en position : permet de définir la position du champ lors du redimensionnement du navigateur.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Ancrage_Position_WB.gif)
