...
1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Cr%E9er_cpt.gif)
 parmi les boutons d'accès rapide du ruban de WEBDEV. La fenêtre de création d'un nouvel élément s'affiche : cliquez sur "Projet". L'assistant de création d'un projet se lance.
...
. La documentation technique est alors constituée uniquement des caractéristiques de l'élément (page, état, requête, ...) en cours.
