...
3. Saisissez la traduction et validez. La ligne de code apparaît sous l'éditeur de code : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=code-drapeau.gif)


	- L'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=code-drapeau%201.gif)
 indique que des traductions existent pour cette chaîne de caractères. Pour afficher la fenêtre de traduction, il suffit de cliquer sur cette icône.
