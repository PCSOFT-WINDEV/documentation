...
<a name="passer_une_base_hfsql_classic_une_base_hfsql_clientserveur_ELTTEXTE000275"></a>
...
- soit dans les paramètres du Centre de Gestion de Projets :  déroulez ![Menu Centre de Gestion de Projets](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) puis sélectionnez "Options".
...
### Etape 2 : Astuce
<a name="etape_2_astuce_ELTPARAGRAPHE000096"></a>Pour simplifier la configuration des différents postes utilisant les Centres de Contrôle, il est possible de créer un fichier .reg que chaque utilisateur pourra exécuter sur son poste.
...
<a name="utilisation_des_centres_controle_mode_clientserveur_ELTTEXTE000335"></a>


### Spécificités Client/Serveur
<a name="specificites_clientserveur_ELTPARAGRAPHE000110"></a>En mode Client/Serveur :
...
<a name="gestion_des_intervenants_ELTPARAGRAPHE000122"></a>Deux groupes sont automatiquement créés sur le serveur HFSQL Client/Serveur :
...
<a name="utiliser_composant_feedback_avec_les_centres_controle_mode_clientserveur_ELTTEXTE000365"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) 

### Présentation
<a name="presentation_ELTPARAGRAPHE000153"></a>Le composant Feedback intégré à vos applications permet aux utilisateurs d'envoyer simplement des remarques, des suggestions sur votre application. Ces envois peuvent être fait :
...
Dans ce code :
	...
	- &lt;base de données&gt; : Nom de la base de données HFSQL Client/Serveur correspondant aux fichiers de données des Centres de Contrôle.
