...
<a name="visualiser_les_taches_ELTTEXTE000387"></a>
Les tâches d'un intervenant sont visualisées dans un onglet de type Tâche. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P2_Suivi%20de%20projet%20-%20HC%20N%B0001.gif)
...
## Gestion des tâches
<a name="gestion_des_taches_ELTTEXTE000420"></a>


### Ajouter une nouvelle tâche standard
<a name="ajouter_une_nouvelle_tache_standard_ELTPARAGRAPHE000059"></a>L'ajout de tâches peut être effectué par un administrateur ou par l'intervenant lui-même.
...
3. Indiquez les caractéristiques de la tâche dans les différents onglets :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CC_Suivi_Tache%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="ajouter_une_nouvelle_tache_interruption_ELTPARAGRAPHE000128"></a>L'ajout de tâches d'interruption peut être effectué par l'intervenant lui-même. Pour plus de détails sur le fonctionnement des tâches d'interruption, consultez [Aide à la gestion du temps](../CCSuivi/3540711.md).
...
<a name="definir_tache_cours_ELTPARAGRAPHE000149"></a>Pour définir la tâche "En cours" :
...
### Modifier une tâche
<a name="modifier_une_tache_ELTPARAGRAPHE000183"></a>La modification de la tâche peut être effectuée :
...
### Annuler une tâche
<a name="annuler_une_tache_ELTPARAGRAPHE000196"></a>Pour annuler une tâche :
...
### Supprimer une tâche
<a name="supprimer_une_tache_ELTPARAGRAPHE000208"></a>Pour supprimer une tâche :
...
<a name="transferer_une_tache_autre_intervenant_ELTPARAGRAPHE000221"></a>Pour transférer une tâche à un autre intervenant :
...
<a name="liaison_entre_les_taches_ELTTEXTE000480"></a>


### Présentation
<a name="presentation_ELTPARAGRAPHE000237"></a>Dans l'onglet de type "Tâches", il est possible de définir un ordre de réalisation des tâches (à l'aide des boutons fléchés situés à droite de la liste). 
...
<a name="comment_creer_une_liaison_entre_les_taches_ELTPARAGRAPHE000249"></a>Pour réaliser une liaison entre plusieurs tâches : 
...
<a name="coefficient_multiplicatif_ELTTEXTE000510"></a>
...
## Imprimer les tâches
<a name="imprimer_les_taches_ELTTEXTE000534"></a>
