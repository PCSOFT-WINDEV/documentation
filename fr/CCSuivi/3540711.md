...
La gestion du temps est automatiquement lancée à l'ouverture de WINDEV, WEBDEV et WINDEV Mobile ou du Centre de Suivi de Projets. Une icône est affichée dans la barre des tâches de Windows (à côté de l'horloge) lorsque la gestion du temps est lancée.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Systray.gif)
