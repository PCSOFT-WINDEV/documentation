...
Pour plus de détails sur la gestion des plannings et des tâches, consultez [Utiliser la gestion des tâches](../CCSuivi/3540713.md).
...
La gestion du temps est automatiquement lancée à l'ouverture de WINDEV, WEBDEV et WINDEV Mobile ou du Centre de Gestion de Projets. Une icône est affichée dans la barre des tâches de Windows (à côté de l'horloge) lorsque la gestion du temps est lancée.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Systray.gif)

<a name="NOTE2_2"></a>


### Activation / Désactivation de la gestion du temps
<a name="activation_desactivation_gestion_temps_ELTPARAGRAPHE000035"></a>Il est possible d'activer / désactiver la gestion du temps dans la fenêtre de paramétrage de la gestion du temps. Cette fenêtre peut être affichée :

- dans le Centre de Gestion de Projets : déroulez ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif), sélectionnez "Options" puis cliquez sur "Aide à la gestion du temps". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Aide_%E0_la_gestion_du_temps%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="calcul_temps_passe_sur_une_tache_avec_gestion_temps_ELTPARAGRAPHE000063"></a>Si la gestion du temps est activée, le mode de calcul du temps passé sur une tâche est différent.
...
6. Permet d'afficher [la fenêtre de configuration de l'aide à la gestion du temps](../CCSuivi/3540710.md).
...
<a name="les_taches_interruption_ELTPARAGRAPHE000128"></a>Les tâches d'interruption sont des tâches temporaires et non planifiées. Ces tâches correspondent aux différents événements pouvant survenir au cours d'une journée de travail et interrompre la tâche en cours.
