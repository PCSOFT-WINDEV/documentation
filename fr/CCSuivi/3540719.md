...
**Astuce** : Il est possible d'automatiser l'import des retours client afin de réaliser cette manipulation automatiquement tous les jours, toutes les semaines, tous les mois, ... Cette option est paramétrable dans les options du Centre de Gestion de Projets : déroulez ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) puis sélectionnez "Options". Cliquez sur "Options personnelles" et configurez les retours client.
