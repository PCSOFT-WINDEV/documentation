...
## Comment le faire ?
<a name="comment_faire_ELTTEXTE000250"></a>


### Effectuer une sauvegarde immédiate
<a name="effectuer_une_sauvegarde_immediate_ELTPARAGRAPHE000025"></a>**Attention** : Une sauvegarde immédiate est nécessairement complète. 
...
<a name="effectuer_une_sauvegarde_planifiee_ELTPARAGRAPHE000074"></a>Pour effectuer une sauvegarde planifiée : 
...
<a name="manipulations_sur_les_sauvegardes_ELTPARAGRAPHE000128"></a>Le Centre de Contrôle HFSQL permet de manipuler les sauvegardes via 2 onglets : l'onglet "Eléments planifiés" et l'onglet "Sauvegardes". 
...
## Remarques
<a name="remarques_ELTTEXTE000342"></a>


### Caractéristiques de la sauvegarde
<a name="caracteristiques_sauvegarde_ELTPARAGRAPHE000304"></a>La sauvegarde effectuée correspondra à l'état de la base de données au début de la sauvegarde.
...
<a name="gestion_une_procedure_avant_etou_apres_ELTPARAGRAPHE000317"></a>Il est possible d'appeler une procédure stockée avant ou après la sauvegarde. Ces procédures peuvent prendre des paramètres. 
...
<a name="gestion_une_webhook_ELTPARAGRAPHE000335"></a>Une webhook permet de déclencher un traitement automatiquement via un service REST. Il suffit de renseigner l'URL du service REST.  
