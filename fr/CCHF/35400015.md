...
<a name="detail_des_caracteristiques_une_base_donnees_hfsql_clientserveur_ELTTEXTE000410"></a>
<a name="NOTE2_1B"></a>


### Onglet "Général"
<a name="onglet_general_ELTPARAGRAPHE000039"></a>Cet onglet permet d'obtenir des informations générales sur les fichiers de la base de données : nom, taille, nombre d'enregistrements.
...
- Accéder aux données : Cette option permet d'ouvrir un nouvel onglet affichant les caractéristiques du fichier sélectionné. 
...
### Onglet "Connexions"
<a name="onglet_connexions_ELTPARAGRAPHE000076"></a>Cet onglet liste les différents utilisateurs connectés sur la base de données.
...
<a name="onglet_elements_planifies_ELTPARAGRAPHE000116"></a>Cet onglet permet de créer, modifier et supprimer des planifications pour la base de données : 
...
### Onglet "Sauvegardes"
<a name="onglet_sauvegardes_ELTPARAGRAPHE000147"></a>Cet onglet permet de réaliser et de restaurer des sauvegardes des bases de données. Cet onglet liste les sauvegardes de la base de données : 
...
### Onglet "Liaisons"
<a name="onglet_liaisons_ELTPARAGRAPHE000169"></a>Cet onglet présente toutes les informations concernant les liaisons entre les fichiers de données présents dans la base de données HFSQL Client/Serveur.
...
<a name="onglet_procedures_stockees_ELTPARAGRAPHE000188"></a>Cet onglet liste les différentes collections de procédures stockées et les procédures stockées de la base de données courante.
...
### Onglet "Triggers"
<a name="onglet_triggers_ELTPARAGRAPHE000205"></a>Cet onglet liste les différents triggers de la base de données courante. Il est possible de connaître :
...
<a name="onglet_requetes_stockees_ELTPARAGRAPHE000231"></a>Cet onglet liste les différentes requêtes stockées et les procédures stockées de la base de données courante.
...
### Onglet "Paramètres"
<a name="onglet_parametres_ELTPARAGRAPHE000245"></a>Cet onglet liste les différents paramètres de la base de données courante.
...
### Onglet "Blocages"
<a name="onglet_blocages_ELTPARAGRAPHE000281"></a>Cet onglet permet de gérer les blocages pour l'ensemble des fichiers de données de la base de données courante. 
...
## Options du ruban
<a name="options_ruban_ELTTEXTE000488"></a>
Pour la base de données HFSQL Client/Serveur sélectionnée, le ruban propose les actions suivantes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CC_HF_Gestion_Serveur%20-%20HC%20N%B0001%201.gif)
...
- Dans le groupe "Fichiers", l'option "Optimiser et réparer" permet d'optimiser un ou plusieurs fichiers de données. Pour plus de détails, consultez [Optimiser et réparer des fichiers de données](../CCHF/3540007.md). 
