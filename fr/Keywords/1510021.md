...
<SINON>
... // code compilé si la configuration en cours n'utilise pas des chaînes ANSI (ou des chaînes UNICODE)
<FIN>`
---
...
`<COMPILE SI <Elément> EXISTE>
... // code compilé si l'élément spécifié existe dans la configuration courante
<SINON>
...
<FIN>`
---
...
`<COMPILE SI <Condition>>
PROCEDURE <Nom procédure>([<Paramètre 1>, ..., <Paramètre N>)
... // Code de la procédure
<FIN> 
`
---
...
### Paramètre Condition
<a name="parametre_condition_ELTPARAGRAPHE000073"></a>La condition doit être évaluable à la compilation : elle peut donc contenir uniquement des éléments littéraux (nombres, chaînes, Vrai, Faux, etc.) ou des constantes.
...
<a name="motcle_configuration_ELTPARAGRAPHE000086"></a>Le mot-clé **Configuration** renvoie le nom de la configuration en cours. Il est donc possible d'écrire : 
...
<a name="motcle_typeconfiguration_ELTPARAGRAPHE000096"></a>Le mot-clé **TypeConfiguration** renvoie le type de la configuration en cours. Il est donc possible d'écrire : 
...
<a name="compilations_selon_type_des_chaines_utilisees_unicode_ansi_ELTPARAGRAPHE000137"></a>La syntaxe utilisant les mots-clés **ConfigurationANSI** et **ConfigurationUNICODE** permet de compiler un code en fonction du type de chaînes utilisé. 
...
<a name="compilations_selon_existence_element_ELTPARAGRAPHE000149"></a>La syntaxe COMPILE SI XXX EXISTE permet de compiler un code en fonction de la présence d'un élément du projet dans la configuration courante.
...
<a name="avantages_limitations_ELTPARAGRAPHE000174"></a>Si les conditions précisées dans &lt;COMPILE SI&gt; ne sont pas remplies, le code WLangage n'est pas compilé. Le code non compilé est affiché en gris sous l'éditeur de code, avec une mise en forme minimale. 
...
[Code-cible conditionnel](../Motscles/9000033.md)

[Configuration de projet](../Motscles/9000030.md)

[Instruction de compilation : SI CibleExécution](../Motscles/1510028.md)

[Editeur de code : Manipulations diverses](../Motscles/2010031.md)
