...
## Variables simples
<a name="variables_simples_ELTTEXTE000253"></a>
...
## Notes
<a name="notes_ELTTEXTE000277"></a>


### Valeurs limites des types de données
<a name="valeurs_limites_des_types_donnees_ELTPARAGRAPHE000166"></a>
...
- Pour simplifier vos tests, les valeurs limites des différents types de données ont été associées à des constantes dans le fichier "Limites.WL". Pour intégrer ces constantes dans votre application, utilisez la ligne de code suivante dans le code d'initialisation de votre projet :
	...
	Le fichier "Limites.WL" sera automatiquement recherché dans le sous-répertoire "Personal\\External" de WINDEV, WEBDEV, WINDEV Mobile. Il n'est pas nécessaire de copier le fichier "Limites.WL" dans le répertoire du projet. Pour plus de détails, consultez l'aide du mot-clé [Externe](../Motscles/1511013.md).
