...
Le type **Durée** permet de manipuler simplement des intervalles de dates et d'heures. Le type **Durée** peut être utilisé par exemple pour réaliser des calculs (différence, addition, etc.). Pour plus de détails, consultez le chapitre [Opérations disponibles sur le type Durée](../Motscles/1514040.md).
...
Le type Durée est un type nullable. Pour plus de détails, consultez [Activation des types nullables](../Motscles/1511031.md). 
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Il est désormais possible d'utiliser l'indication directe de la durée.
<a name="NOTE0_2"></a>
...
[MasqueAffichage (Propriété)](../Motscles/1000020008.md)
