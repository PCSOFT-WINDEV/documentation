...
| *ccSansAccent* | Si le type de clé est une chaîne (par défaut), l'indexation ne tient pas compte des accents.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
...
| *ccSansPonctuationNiEspace* | Si le type de clé est une chaîne (par défaut), l'indexation ne tient pas compte de la ponctuation et des espaces.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
...
<a name="acces_aux_tableaux_associatifs_ELTPARAGRAPHE000200"></a>Pour manipuler un tableau associatif, il est possible d'utiliser les propriétés suivantes :
...
<a name="acces_aux_elements_des_tableaux_associatifs_ELTPARAGRAPHE000223"></a>L'accès aux éléments des tableaux associatifs peut être différent si le tableau associatif est avec ou sans doublons.


|   |   |
| --- | --- |
| **Tableau associatif sans doublons** |   |
| Propriété [Existe](../Proprietes/1000022167.md) | <br><pre><code>MonTableau[MaClé]..Existe</code></pre><br><br>Renvoie <u><u><u><u>Vrai</u></u></u></u> si l'élément MaClé existe, <u><u><u><u>Faux</u></u></u></u> sinon.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Propriété non disponible. |
...
| Adresse d'un élément | <br><pre><code>&MonTableau[MaClé]</code></pre><br><br>Si l'élément MaClé n'existe pas, affichage d'une erreur WLangage.<br>Si l'élément MaClé existe, renvoie l'adresse de l'élément.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette syntaxe n'est pas disponible. |
|   | <br><pre><code>&MonTableau[MaClé, Indice]</code></pre><br><br>Si Indice est différent de 1, une erreur WLangage est affichée.<br>Si l'élément MaClé n'existe pas, une erreur WLangage est affichée.<br>Si l'élément MaClé existe, renvoie l'adresse de l'élément.  <br><br>Syntaxe compatible avec tableaux associatifs avec doublons.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette syntaxe n'est pas disponible. |
...
| Propriété [Existe](../Proprietes/1000022167.md) | <br><pre><code>MonTableau[MaClé]..Existe</code></pre><br><br>Renvoie <u><u><u><u>Vrai</u></u></u></u> si au moins un élément MaClé existe, <u><u><u><u>Faux</u></u></u></u> si l'élément MaClé n'existe pas.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Propriété non disponible. |
...
|   | <br><pre><code>&MonTableau[MaClé, Indice]</code></pre><br><br>Si Indice est supérieur au nombre d'éléments existants, une erreur WLangage est affichée.<br>Si l'élément MaClé n'existe pas, une erreur WLangage est affichée.<br>Si l'élément MaClé existe, renvoie l'adresse de l'élément identifié par son indice.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette syntaxe n'est pas disponible. |
...
<a name="comment_initialiser_tableau_associatif_des_declaration_ELTPARAGRAPHE000451"></a>Pour initialiser un tableau associatif dès sa déclaration, il suffit d'ajouter directement les couples "clé / valeur" en utilisant
...
<a name="parcours_des_tableaux_associatifs_ELTPARAGRAPHE000468"></a>Le parcours des différents éléments d'un tableau associatif peut être réalisé en utilisant [la syntaxe POUR TOUT spécifique aux tableaux associatifs](../Motscles/1510019.md).
...
<a name="fonctions_wlangage_tableaux_ELTPARAGRAPHE000479"></a>Plusieurs fonctions WLangage permettent de manipuler des tableaux associatifs. Pour plus de détails, consultez [Fonctions de gestion des tableaux](../WDLang1/3075006.md).
...
<a name="parametres_type_tableau_associatif_ELTPARAGRAPHE000501"></a>
...
<a name="tableau_associatif_classes_structures_ELTPARAGRAPHE000517"></a>Si vous utilisez un tableau associatif de classes ou de structures, les différentes instances sont automatiquement recopiées lors des ajouts. 
...
<a name="tableau_associatif_tableau_file_pile_liste_ELTPARAGRAPHE000545"></a>Les syntaxes suivantes sont supportées : 
...
[Tableau (Type de variable)](../Motscles/1514030.md)

[Affectation multiple des tableaux, structures et classes](../Motscles/1514031.md)
