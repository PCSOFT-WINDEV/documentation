...
## Utilisation
<a name="utilisation_ELTTEXTE000397"></a>
...
## Opérateurs binaires
<a name="operateurs_binaires_ELTTEXTE000421"></a>


### ET, OU et OU exclusif binaires
<a name="exclusif_binaires_ELTPARAGRAPHE000055"></a>Les syntaxes suivantes peuvent être utilisée :
...
### NON binaire
<a name="non_binaire_ELTPARAGRAPHE000112"></a>La syntaxe est la suivante : ** ~**&lt;Valeur&gt;
...
<a name="operateurs_decalage_ELTTEXTE000451"></a>


### Syntaxes
<a name="syntaxes_ELTPARAGRAPHE000141"></a>
...
### Notes
<a name="notes_ELTPARAGRAPHE000153"></a>
...
| Autre | Entier sur 8 |
	...
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) L'opérateur de décalage binaire à gauche réinjectera par la droite les bits qui dépassent la taille de l'opérande. L'opérateur de décalage binaire à droite réinjectera par la gauche les bits qui dépassent la taille de l'opérande. Par exemple :
...
<a name="operateur_acces_direct_aux_bits_ELTTEXTE000481"></a>


### Accès à un bit
<a name="acces_bit_ELTPARAGRAPHE000204"></a>
...
<a name="acces_entier_sur_1_2_4_octets_ELTPARAGRAPHE000240"></a>
...
<a name="acces_valeur_plusieurs_bits_ELTPARAGRAPHE000309"></a>
...
[Fonctions de gestion des valeurs binaires](../Motscles/3050012.md)
