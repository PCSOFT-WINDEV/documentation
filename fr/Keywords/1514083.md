...
Le type UUID est un type nullable. Pour plus de détails, consultez [Activation des types nullables](../Motscles/1511031.md). 
...
### UUID vide
<a name="uuid_vide_ELTPARAGRAPHE000066"></a>Par défaut, lors de la création d'une variable de type UUID, cette variable est vide. Sa valeur correspond : 
...
### Format des UUID
<a name="format_des_uuid_ELTPARAGRAPHE000074"></a>Les UUID reconnus par le WLangage sont : 
...
<a name="operations_disponibles_ELTPARAGRAPHE000106"></a>Le but principal des opérations est de permettre un débogage facile tout en détectant les opérations n'ayant pas de sens. La concaténation avec une chaîne est donc autorisée mais aucune opération arithmétique n'est autorisée.
...
### Comparaison
<a name="comparaison_ELTPARAGRAPHE000116"></a>Les UUID sont comparables afin de permettre le tri et la recherche dichotomique dans un tableau.
...
<a name="generation_uuid_ELTPARAGRAPHE000127"></a>Un UUID 128 peut être généré : 
...
### Rubriques HFSQL
<a name="rubriques_hfsql_ELTPARAGRAPHE000163"></a>
...
<a name="gestion_des_types_uuid_dans_les_champs_ELTPARAGRAPHE000181"></a>Des masques de saisie et d'affichage de type "UUID" et "UUID 256" sont disponibles pour les différents champs permettant de manipuler ces types. 
...
### Interface COM
<a name="interface_com_ELTPARAGRAPHE000191"></a>Un UUID 128 peut être utilisé pour stocker les CLSID et les IID des objets et des interfaces COM. Il peut donc être utilisé dans les fonctions [COMCréeInstance](../WDLang1/1000018831.md) et [COMRécupèreInterface](../WDLang1/1000019784.md).
<a name="NOTE0_8"></a>


### Sérialisation
<a name="serialisation_ELTPARAGRAPHE000204"></a>Les UUID sont sérialisables (fonction [Sérialise](../WDLang1/3013065.md)) : 
...
[DonneGUID (Fonction)](../Motscles/1000018857.md)

[DonneUUID (Fonction)](../Motscles/1000023915.md)

[DonneUUID256 (Fonction)](../Motscles/1000023916.md)

[Editeur d'analyses : les différents types de rubriques](../Motscles/2011026.md)
