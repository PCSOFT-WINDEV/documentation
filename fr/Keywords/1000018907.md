...
<a name="affectation_une_variable_type_procedure_ELTPARAGRAPHE000076"></a>Une variable de type **Procédure** peut être affectée avec : 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) **une procédure compilée dynamiquement avec la fonction [Compile](../WDLang1/3013015.md)**. 
	La syntaxe à utiliser est la suivante : 
...
<a name="affectation_multiple_une_variable_type_procedure_ELTPARAGRAPHE000164"></a>Il est possible d'affecter plusieurs procédures ou méthodes à une variable de type **Procédure** grâce à l'opérateur "+=". Les différentes procédures seront appelées les unes à la suite des autres. 
...
<a name="ordre_execution_des_procedures_ELTPARAGRAPHE000185"></a>
...
<a name="passage_parametres_type_procedure_par_reference_par_valeur_ELTPARAGRAPHE000203"></a>
...
[ExécuteTraitement (Fonction)](../Motscles/3013031.md)

[Avant (Propriété)](../Motscles/1000020916.md)

[Après (Propriété)](../Motscles/1000020917.md)

[Compile (Fonction)](../Motscles/3013015.md)
