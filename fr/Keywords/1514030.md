...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette fonctionnalité n'est pas gérée.Remarque : Pour agrandir un tableau à plusieurs dimensions, utilisez la fonction [Dimension](../WDLang1/3013022.md). 
...
Type des éléments constituant le tableau. Voir [Les différents types du WLangage](../Motscles/1514013.md). 
...
<a name="autres_types_tableaux_ELTPARAGRAPHE000175"></a>Le mot-clé **Tableau** permet de définir un tableau. D'autres types de tableaux "avancés" sont disponibles :
...
<a name="procedure_declarer_parametre_type_tableau_ELTPARAGRAPHE000192"></a>Un tableau peut être passé en paramètre à une procédure. Par exemple :
...
<a name="passer_tableau_parametre_une_procedure_ELTPARAGRAPHE000210"></a>Un tableau peut être passé en paramètre à une procédure. Pour cela, utilisez la syntaxe suivante :
...
<a name="fonctions_wlangage_tableaux_ELTPARAGRAPHE000221"></a>Plusieurs fonctions WLangage permettent de manipuler des tableaux. Il est possible d'effectuer des tris, des recherches, etc. Pour plus de détails, consultez [Fonctions de gestion des tableaux](../WDLang1/3075006.md).
<a name="NOTE0_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) 

### Tableau de tableau, tableau associatif, file, pile, liste
<a name="tableau_tableau_tableau_associatif_file_pile_liste_ELTPARAGRAPHE000235"></a>Les syntaxes suivantes sont supportées : 
...
<a name="limites_elements_tableau_ELTPARAGRAPHE000243"></a>
...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Un tableau ne peut pas être constitué de tableaux.
...
<a name="tableaux_dans_les_classes_ELTPARAGRAPHE000257"></a>Lors de copies d'instances de classes, tous les membres de la classe sont recopiés dans la nouvelle instance, sauf les tableaux. Ainsi, si la valeur d'un membre de type tableau est modifiée, cette valeur est modifiée dans toutes les instances.
...
<a name="ajouter_contenu_une_structure_dans_tableau_structures_sans_passer_par_une_variable_cette_structure_ELTPARAGRAPHE000456"></a>Si vous utilisez un tableau de structures avec peu de membres, il peut être plus simple d'ajouter directement une structure en utilisant l'opérateur [ ] (crochet). 
...
[Fonctions de gestion des tableaux](../Motscles/3075006.md)
