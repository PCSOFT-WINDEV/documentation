...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) pour réaliser un appel asynchrone d'une procédure serveur en code navigateur.
...
### Appel asynchrone d'une procédure serveur en code navigateur

`APRES <Résultat> = NomProcédure() FAIRE
	<Code exécuté si réponse>
FIN
...
Résultat de l'exécution de la procédure serveur. 

**`<NomProcédure()> : ()`**

Nom de la procédure serveur appelée depuis le code navigateur.  
...
### Champ Page WEBDEV : Appel d'une procédure de la fenêtre (avec une valeur de retour) depuis une page 
...
<a name="webservice_comment_obtenir_reponse_webservice_ELTPARAGRAPHE000123"></a>La réponse du Webservice peut être obtenue dans &lt;Code exécuté si réponse&gt;. Plusieurs syntaxes sont possibles : 
...
<a name="syntaxe_concernant_les_webservices_soap_ELTPARAGRAPHE000138"></a>
...
[Webservices SOAP : Importation et consommation](../Motscles/3086001.md)

[AJAX : Appel direct de procédures](../Motscles/3055119.md)

[Page (Propriété)](../Motscles/1410089371.md)

[MonChampHôte (Mot réservé)](../Motscles/1511028.md)

[Intégrer un site WEBDEV dans une application WINDEV](../Motscles/1410086640.md)
