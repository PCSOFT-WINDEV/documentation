...
<a name="type_variant_null_ELTPARAGRAPHE000078"></a>Pour spécifier qu'une variable de type Variant ne contient pas de valeur, il suffit d'utiliser la constante NULL.
...
### Type d'un variant
<a name="type_variant_ELTPARAGRAPHE000098"></a>Il est possible de connaître le type d'un variant grâce à la propriété [Type](../Proprietes/2510131.md). La propriété [Type](../Proprietes/2510131.md) permet de connaître le type de la valeur stockée dans la variable.
...
<a name="propriete_classe_sur_les_variants_ELTPARAGRAPHE000125"></a>La propriété [Classe](../Proprietes/2514004.md) sur les variables de type Variant permet d'obtenir le nom de la classe utilisée si le variant correspond à une classe.
...
<a name="souselements_nommes_ELTPARAGRAPHE000138"></a>Il est possible d'utiliser directement et sans déclaration des membres sur une variable de type Variant.
...
<a name="souselements_indices_ELTPARAGRAPHE000225"></a>Il est possible d'utiliser directement la variable de type variant comme un tableau de variants. L'utilisation de l'opérateur [ ] crée automatiquement le tableau.
...
<a name="imbrications_des_souselements_nommes_indices_ELTPARAGRAPHE000250"></a>Les sous-éléments nommés et les sous-éléments indicés étant eux-mêmes de type Variant, il est possible de les imbriquer récursivement.
...
[VariantConvertit (Fonction)](../Motscles/3013054.md)

[VariantVersJSON (Fonction)](../Motscles/1000021051.md)

[JSONVersVariant (Fonction)](../Motscles/1000021052.md)

[Membre (Propriété)](../Motscles/1000021078.md)
