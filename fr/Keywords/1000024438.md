...
<a name="affectation_lecture_ELTPARAGRAPHE000108"></a>**Affectation d'une variable YAML**
...
<a name="gestion_des_references_ELTPARAGRAPHE000138"></a>Pour référencer un membre d'un YAML existant depuis un autre membre de l'objet, il faut utiliser l'opérateur '&lt;-'.
...
<a name="proprietes_specifiques_description_des_variables_type_yaml_ELTPARAGRAPHE000147"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une variable de type YAML :
...
| Type | Entier | Type de l'élément. <br><br>**Cette propriété est disponible en lecture seulement**. |
...
[JSON (Type de variable)](../Motscles/1000023611.md)

[Fonctions de manipulation des variables JSON](../Motscles/1410091296.md)
