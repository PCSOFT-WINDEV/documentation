...
<a name="comment_declarer_une_variable_ELTTEXTE000467"></a>
...
### Exemples 
<a name="exemples_ELTPARAGRAPHE000109"></a>
...
### Attribut "couleur"
<a name="attribut_couleur_ELTPARAGRAPHE000213"></a>L'attribut "couleur" peut être utilisé lors de la déclaration d'une variable pour définir la couleur de cette variable sous l'éditeur de code. La syntaxe à utiliser est la suivante : 
...
- un mot-clé correspondant à la coloration d'un élément définie dans les thèmes de l'éditeur de code (voir [Thèmes de l'éditeur de code](../Editeurs/9000141.md). Ces mots-clés sont les suivants : 
...
<a name="attribut_section_critique_ELTPARAGRAPHE000262"></a>Lors de la déclaration d'une variable, il est possible d'associer cette variable à une section critique en utilisant l'attribut **section critique**. 
...
<a name="comment_acceder_aux_proprietes_une_variable_ELTTEXTE000603"></a>


### Syntaxes
<a name="syntaxes_ELTPARAGRAPHE000278"></a>Si le type de variable possède des propriétés, il est possible d'utiliser les syntaxes suivantes : 
...
### Exemple
<a name="exemple_ELTPARAGRAPHE000292"></a>Utilisation de propriétés sur un type [Cadre](../Motscles/15140100.md) : 
...
<a name="regle_portee_des_variables_ELTTEXTE000633"></a>


### Règle
<a name="regle_ELTPARAGRAPHE000305"></a>La règle de portée des variables est la suivante :
...
### Exception
<a name="exception_ELTPARAGRAPHE000366"></a>La règle de portée des variables ne s'applique ni sur les [constantes](../Motscles/1514012.md) ni sur les [variables de type source de données](../WDLang4/1514053.md).
<a name="NOTE4_3"></a>


### Cas particulier : Logiciel Etats & Requêtes
<a name="cas_particulier_logiciel_etats_requetes_ELTPARAGRAPHE000379"></a>
...
<a name="conflit_nom_utilisation_ambigue_type_ELTPARAGRAPHE000391"></a>Un type du WLangage peut avoir le même nom qu'un autre type ajouté au projet par un élément importé (classes d'assemblages .NET, types structurés de Webservices, etc.). Dans ce cas, pour forcer l'utilisation du type WLangage lors de la déclaration d'une variable, il faut préfixer le type avec *WL*. 
Exemple :
...
[Portée des variables](../Motscles/1514088.md)

[Alias de type](../Motscles/1514089.md)

[Coloration du code WLangage](../Motscles/9000141.md)
