...
<a name="declaration_constantes_ELTPARAGRAPHE000072"></a>Les constantes doivent être déclarées dans :
...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) **Le code de chargement d'une page** pour être utilisable dans tous les traitements navigateur de la page.
...
![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Remarque : Une constante déclarée en code serveur peut être utilisée en code navigateur. 
<a name="NOTE0_2"></a>
...
<a name="limites_declarer_membre_type_constante_ELTPARAGRAPHE000107"></a>Il n'est pas possible de déclarer un membre de type constante dans :
...
<a name="limites_declarer_des_constantes_meme_nom_ELTPARAGRAPHE000119"></a>
