...
<a name="syntaxe_declaration_remarques_ELTPARAGRAPHE000061"></a>
...
### Code SQL de la requête
<a name="code_sql_requete_ELTPARAGRAPHE000100"></a>
...
- De la même manière que dans une requête SQL saisie sous l'éditeur de requêtes, il est possible de : 
	...
	- saisir des fonctions WLangage. Il suffit de préfixer les fonctions WLangage utilisées par les lettres "WL.". La saisie assistée est disponible. 
			![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Il n'est pas possible d'exécuter des requêtes SQL contenant des fonctions WLangage. 
...
<a name="utilisation_dans_les_requetes_sql_ELTPARAGRAPHE000127"></a>Les requêtes SQL acceptent la nouvelle syntaxe : 
...
### Contexte HFSQL
<a name="contexte_hfsql_ELTPARAGRAPHE000161"></a>
...
[Création d'une requête en code SQL](../Motscles/2032060.md)

[Commandes SQL disponibles dans une requête SQL ](../Motscles/2034006.md)

[Conditions de sélection SQL ](../Motscles/2034008.md)

[Fonctions SQL utilisables dans les requêtes SQL](../Motscles/2034005.md)

[HExécuteRequête (Fonction)](../Motscles/3044080.md)

[HExécuteRequêteSQL (Fonction)](../Motscles/3044084.md)

[Instructions SQL ](../Motscles/2034001.md)
