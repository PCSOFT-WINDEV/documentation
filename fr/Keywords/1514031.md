...
<a name="affectation_multiple_des_tableaux_ELTTEXTE000250"></a>


### Syntaxe
<a name="syntaxe_ELTPARAGRAPHE000050"></a>
...
### Tableau de valeurs
<a name="tableau_valeurs_ELTPARAGRAPHE000067"></a>Chaque série de valeurs représente une dimension du tableau de valeurs. Il est possible d'imbriquer des séries de valeurs pour créer un tableau de valeurs à plusieurs dimensions.
...
### Exemples
<a name="exemples_ELTPARAGRAPHE000089"></a>
```wl
...
<a name="affectation_multiple_des_tableaux_associatifs_ELTTEXTE000286"></a>


### Syntaxe
<a name="syntaxe_ELTPARAGRAPHE000100"></a>
```txt
...
<a name="affectation_multiple_des_structures_classes_ELTTEXTE000316"></a>
...
### Remarques
<a name="remarques_ELTPARAGRAPHE000146"></a>
...
### Exemple
<a name="exemple_ELTPARAGRAPHE000155"></a>
```wl
...
## Imbrication
<a name="imbrication_ELTTEXTE000352"></a>
...
## Césure
<a name="cesure_ELTTEXTE000376"></a>
...
[Tableau associatif (Type de variable)](../Motscles/1514058.md)
