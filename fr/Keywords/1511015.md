...
<a name="null_les_requetes_ELTTEXTE000310"></a>




### Ignorer des paramètres : Null dans la fonction HExécuteRequête
<a name="ignorer_des_parametres_null_dans_fonction_hexecuterequete_ELTPARAGRAPHE000064"></a>Lors de l'exécution d'une requête paramétrée avec la fonction [HExécuteRequête](../WDLang4/3044080.md), tous les paramètres de la requête ne doivent pas obligatoirement être précisés. Les conditions de la requête utilisant des paramètres non précisés ou ayant pour valeur Null seront ignorés.
...
<a name="parametres_une_requete_provenant_champ_saisie_null_vide_ELTPARAGRAPHE000107"></a>Pour que votre requête s'exécute même si aucune valeur n'est saisie par l'utilisateur, cochez l'option ***"NULL si vide"*** des champs de saisie (onglet "Détail" de la description du champ).
...
<a name="null_les_variants_ELTTEXTE000340"></a>
...
<a name="null_les_valeurs_numeriques_ELTTEXTE000364"></a>
...
<a name="null_les_fonctions_wlangage_ELTTEXTE000388"></a>
...
<a name="null_les_objets_dynamiques_ELTTEXTE000412"></a>
...
[Conditions de sélection SQL ](../Motscles/2034008.md)

[Null (Propriété)](../Motscles/2512064.md)

[NullSupporté (Propriété)](../Motscles/2512061.md)
