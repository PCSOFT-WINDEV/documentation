...
<a name="declaration_structures_ELTPARAGRAPHE000103"></a>Si une structure &lt;Nom de la structure&gt; est déclarée :
...
![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) La structure doit être déclarée dans un traitement de déclaration des globales (d'une fenêtre, d'une page ou d'une collection de procédures).
...
<a name="type_des_membres_une_structure_ELTPARAGRAPHE000131"></a>Les membres d'une structure peuvent être de type :
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Une structure déclarée en code navigateur doit être composée de type simples : chaîne, entier, réel, booléen, date et heure. 
...
<a name="declarer_membre_type_tableau_dans_une_structure_ELTPARAGRAPHE000192"></a>
...
<a name="copie_homonymique_une_structure_ELTPARAGRAPHE000211"></a>L'opérateur **=>** permet de réaliser une copie homonymique d'une variable de type structure. 
...
<a name="serialisation_des_membres_une_structure_ELTPARAGRAPHE000231"></a>Par défaut, tous les membres d'une structure sont sérialisés. 
...
<a name="quels_types_avances_peuvent_etre_membre_ELTPARAGRAPHE000267"></a>Une variable "avancée" peut être membre d'une variable "avancée". Le tableau ci-dessous présente les différentes combinaisons :

| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Fleche_1.gif) | Variable composée | Structure | Classe | Tableau |
| --- | --- | --- | --- | --- |
...
<a name="passer_une_structure_parametre_une_procedure_ELTPARAGRAPHE000327"></a>Une variable de type "structure" peut être passée en paramètre à une procédure. Pour cela, utilisez la syntaxe suivante : 
...
<a name="ajouter_contenu_une_structure_dans_tableau_structures_sans_passer_par_une_variable_cette_structure_ELTPARAGRAPHE000342"></a>Si vous utilisez un tableau de structures avec peu de membres, il peut être plus simple d'ajouter directement une structure en utilisant l'opérateur [ ] (crochet). 
...
<a name="limites_une_structure_ELTPARAGRAPHE000378"></a>
...
<a name="differences_entre_version_8_version_9_ELTPARAGRAPHE000388"></a>Une structure contenant un membre de type caractère n'a pas le même comportement que dans les versions précédentes. En effet, les caractères occupaient 1 octet en version 8 et 2 octets en version 9.
...
[Comment créer et manipuler une structure ?](../Motscles/20049.md)

[Comment manipuler un tableau de structures ?](../Motscles/20030.md)
