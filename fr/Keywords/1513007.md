...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Si les paramètres à passer à la procédure sont stockés dans un tableau, il est possible d'utiliser la fonction [TableauVersParamètres](../WDLang1/1410089937.md) pour obtenir les paramètres au format attendu par la procédure. 

![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Il est possible d'utiliser des paramètres nommés. Pour plus de détails, consultez le paragraphe "[Paramètres nommés](#NOTE0_2)". 
...
### Paramètres nommés
<a name="parametres_nommes_ELTPARAGRAPHE000162"></a>Si une procédure possède des paramètres avec des valeurs par défaut, il est possible d'appeler la procédure en nommant ses paramètres. Deux syntaxes sont possibles : 
...
<a name="appel_procedure_globale_wlangage_navigateur_depuis_une_procedure_globale_javascript_presente_dans_meme_collection_procedures_ELTPARAGRAPHE000249"></a>Pour appeler une procédure WLangage navigateur depuis une procédure Javascript, il est nécessaire de préfixer le nom de la procédure WLangage par le nom de la collection de procédures. Le nom de la procédure et le nom de la fonction doivent être séparés par un tiret bas (_) et non par un point. 

Le nom de la collection de procédures utilisé dans la procédure Javascript : 

- ne doit comporter aucun accent, 
...
Par exemple : Pour appeler la procédure WLangage "MaCollection à tester.TestUnitaire", il faut écrire dans la procédure Javascript "MACOLLECTIONATESTER_TestUnitaire".
