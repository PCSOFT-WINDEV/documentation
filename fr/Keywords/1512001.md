...
## Utilisation
<a name="utilisation_ELTTEXTE000536"></a>
...
- " **[% %]**" : Construction dynamique de chaînes. Pour plus de détails, consultez [Interpolation de chaînes](../Motscles/1512011.md).
...
## Notes
<a name="notes_ELTTEXTE000560"></a>


### L'opérateur [ et ]
<a name="operateur_ELTPARAGRAPHE000089"></a>L'opérateur [ et ] permet de concaténer optionnellement des chaînes. Le séparateur n'est pas concaténé si la chaîne d'origine est une chaîne vide ("") ou si la chaîne d'origine se termine par le séparateur.
...
### L'opérateur [[ et ]]
<a name="operateur_ELTPARAGRAPHE000167"></a>L'opérateur [[ et ]] permet d'extraire et de remplacer une sous-chaîne.

![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) L'opérateur [[ et ]] permet uniquement d'extraire une sous-chaîne.
...
- CHAINEAEXTRAIRE[[&lt;Position&gt;]] = &lt;Nouvelle chaîne&gt; : Remplace le caractère de la chaîne par la nouvelle chaîne. 
	![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) La syntaxe ci-dessus n'est pas disponible dans cette version.
...
<a name="egalite_souple_egalite_tres_souple_ELTPARAGRAPHE000327"></a>L'égalité souple (~=) et l'égalité très souple (~~) agissent uniquement sur les chaînes de caractères (sauf les chaînes fixes). Ces opérateurs permettent de :
...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) L'opérateur "Égalité très souple" n'est pas disponible en code Navigateur.
...
<a name="operateurs_sur_les_chaines_caracteres_unicode_ELTPARAGRAPHE000347"></a>Les opérateurs disponibles sont :
...
<a name="position_dans_une_chaine_caracteres_ELTPARAGRAPHE000451"></a>
...
<a name="fonctions_wlangage_ELTPARAGRAPHE000462"></a>Les chaînes de caractères peuvent également être manipulées grâce aux fonctions :
...
[Chaîne de caractères : Comment extraire, supprimer, remplacer des mots ?](../Motscles/20001.md)

[Fonctions de gestion des chaînes de caractères](../Motscles/3024015.md)

[ChaîneVersUTF8 (Fonction)](../Motscles/3024042.md)

[UTF8VersChaîne (Fonction)](../Motscles/3024043.md)

[UTF8VersUnicode (Fonction)](../Motscles/1000020481.md)

[AnsiVersUnicode (Fonction)](../Motscles/3024002.md)

[UTFConvertit (Fonction)](../Motscles/1410088734.md)

[UTF8Valide (Fonction)](../Motscles/1410089619.md)

[AnsiVersOem (Fonction)](../Motscles/3024007.md)

[UnicodeVersAnsi (Fonction)](../Motscles/3024025.md)

[OemVersAnsi (Fonction)](../Motscles/3024021.md)
