...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Les indirections ne sont pas gérées sur les variables locales. **Les indirections sont gérées uniquement sur les variables globales**. Une indirection sur une variable locale d'un traitement provoquera l'erreur "élément inconnu".
...
| *indEtat* | Élément recherché parmi les états.<br><br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible en PHP. |
| *indFenêtre* | Élément recherché parmi les fenêtres.<br><br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible en PHP. |
| *indFichier* | Élément recherché parmi les fichiers de données. |
| *indGPW* | Élément recherché parmi les éléments du groupware utilisateur (permet de récupérer l'état initial des champs).<br><br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible en PHP. |
| *indLiaison* | Élément recherché parmi les liaisons.<br><br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cette constante n'est pas disponible en PHP. |
| *indParamètreRequête* | Élément recherché parmi les paramètres des requêtes. |
| *indRubrique* | Élément recherché parmi les rubriques. |
| *indVariable* | Élément recherché parmi les variables.<br><br>![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) L'élément est recherché uniquement parmi les variables globales. |
| *indPage* | Élément recherché parmi les pages.<br><br>![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Seule la page courante est accessible. |
...
<a name="quand_utiliser_indirection_ELTPARAGRAPHE000219"></a>L'indirection peut être utilisée par exemple :
...
<a name="designer_objet_cours_ELTPARAGRAPHE000242"></a>Pour désigner l'objet en cours, utilisez les mots-clés suivants :
...
- [MaPage](../Motscles/1511017.md) : la page en cours
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Ce mot-clé n'est pas disponible.

- [MonEtat](../Motscles/1511010.md) : l'état en cours
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Ce mot-clé n'est pas disponible.

- [MaSource](../Motscles/1511001.md) : la source de données courante.

- [MonFichier](../Motscles/1511019.md) : le fichier de données qui a déclenché le trigger en cours.
...
<a name="indirection_sur_une_structure_ELTPARAGRAPHE000278"></a>Une indirection ne peut pas contenir un accès à une structure ou à une instance de classe. Cependant, il est possible d'utiliser la syntaxe suivante :
...
<a name="utiliser_indirection_sur_les_chemins_dans_document_xml_ELTPARAGRAPHE000289"></a>Il est possible d'utiliser les opérateurs d'indirection pour construire le chemin d'un élément dans un document XML. 
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000298"></a>L'opérateur d'indirection permet de retrouver un élément par son nom.
...
<a name="indirections_java_ELTPARAGRAPHE000366"></a>Les indirections ne sont pas gérées sur les variables locales.
...
[Eléments d'une classe : Enumérer et manipuler par programmation](../Motscles/6010015.md)

[Comment manipuler les opérateurs d'indirection ?](../Motscles/20031.md)
