...
- [l'affectation par défaut](#NOTE2_1) : ' = '
...
<a name="affectation_par_defaut_ELTTEXTE000308"></a>
...
Il est possible de forcer la conversion en utilisant l'opérateur de conversion explicite (cast). Pour plus de détails, consultez [Opérateur de conversion explicite sur les types simples](../Motscles/1515004.md). 


### Affectation de types complexes
<a name="affectation_types_complexes_ELTPARAGRAPHE000067"></a>Le fonctionnement de l'affectation dépend du type de variable utilisé :   
...
<a name="affectation_multiple_ELTPARAGRAPHE000077"></a>L'opérateur **'=**' peut être utilisé pour affecter plusieurs variables en une seule ligne de code.
...
<a name="affectation_par_copie_ELTTEXTE000421"></a>
...
<a name="affectation_par_copie_sur_les_tableaux_ELTPARAGRAPHE000124"></a>Il est possible d'utiliser l'opérateur &lt;= sur les tableaux.
...
### Copie homonymique
<a name="copie_homonymique_ELTPARAGRAPHE000138"></a>Le mécanisme de la copie homonymique utilise l'opérateur *&lt;=* pour transférer des données depuis un élément structuré vers un autre élément structuré. 
...
- Pour les structures et les classes, chaque membre peut être suivi d'un attribut "Mapping". Cet attribut permet de spécifier le nom du membre à "mapper" au membre de la structure ou de la classe. 
	![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Cet attribut d'extension n'est pas disponible.
	Exemple :  
...
<a name="affectation_par_prise_reference_ELTTEXTE000457"></a>
...
## Remarques
<a name="remarques_ELTTEXTE000481"></a>
...
[Copie et clonage](../Motscles/6010018.md)

[Clone (Fonction)](../Motscles/1000024843.md)

[Opérateur de conversion explicite sur les types simples](../Motscles/1515004.md)
