...
## Détail
<a name="detail_ELTTEXTE000324"></a>


### Les parenthèses
<a name="les_parentheses_ELTPARAGRAPHE000086"></a>Les parenthèses permettent :
...
### Les crochets
<a name="les_crochets_ELTPARAGRAPHE000101"></a>Les crochets sont des opérateurs d'indexation. Ils permettent de désigner facilement des objets indexés.
...
### La virgule
<a name="virgule_ELTPARAGRAPHE000125"></a>La virgule permet de séparer :
...
### Le point virgule
<a name="point_virgule_ELTPARAGRAPHE000140"></a>Le point virgule permet de séparer différentes instructions écrites sur la même ligne. Par exemple :
...
### Les deux points
<a name="les_deux_points_ELTPARAGRAPHE000150"></a>Les deux points permettent d'accéder aux membres et aux méthodes des objets.
...
### Le point
<a name="point_ELTPARAGRAPHE000160"></a>Le point permet d'accéder à un sous-élément. Quelques exemples :
...
### Le double point
<a name="double_point_ELTPARAGRAPHE000176"></a>Le double point permet d'accéder à une propriété d'un champ, d'une fenêtre, d'un état, d'un fichier, d'une rubrique, d'une variable. Quelques exemples : 
...
### Le triple point
<a name="triple_point_ELTPARAGRAPHE000187"></a>L'opérateur "..." (triple point) permet de continuer une ligne logique sur la ligne physique suivante. Par exemple : 
...
### La double barre
<a name="double_barre_ELTPARAGRAPHE000218"></a>La double barre permet de mettre en commentaire le texte suivant ce signe. Ce texte ne sera pas pris en compte lors de la compilation du code et lors de l'exécution du projet. Par exemple :
