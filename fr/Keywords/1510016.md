...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/fr/APPLEWATCH.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Condition à indiquer pour filtrer le parcours. Seuls les éléments du tableau correspondant au filtre seront parcourus.
...
<a name="syntaxe_1_parcours_des_elements_tableau_ELTPARAGRAPHE000133"></a>A chaque itération, la variable &lt;Variable&gt; fait directement référence à l'élément courant dans le tableau. Si la valeur de &lt;Variable&gt; est modifiée, l'élément courant dans le tableau est modifié.
...
<a name="syntaxe_2_parcours_des_valeurs_des_elements_tableau_ELTPARAGRAPHE000150"></a>A chaque itération, la variable &lt;Valeur&gt; est affectée avec la valeur de l'élément parcouru. Si la valeur de &lt;Valeur&gt; est modifiée, l'élément courant dans le tableau n'est pas modifié.
