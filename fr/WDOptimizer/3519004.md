...
<a name="wdoptimizer_propose_plusieurs_modes_optimisation_des_index_ELTPARAGRAPHE000011"></a>***1. Vérifier les index*** : Vérifie la cohérence entre l'index et les fichiers de données.
...
<a name="optimiser_les_index_fichier_donnees_ELTPARAGRAPHE000043"></a>Pour optimiser les index d'un fichier de données :
...
### Présentation
<a name="presentation_ELTPARAGRAPHE000087"></a>Les options de ré-indexation apparaissent dans la partie basse de l'écran :<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WDOptimiseur_Index%20-%20HC%20N%B0001.gif)

<a name="NOTE3_2"></a>


### Mode avancé réindexation
<a name="mode_avance_reindexation_ELTPARAGRAPHE000095"></a>Ces options sont prises en compte pour les ré-indexation de type 1 à 4 :
...
<a name="options_compression_des_memos_ELTPARAGRAPHE000148"></a>Ces options sont prises en compte lors de la révision avec compression des index et des mémos (option 5) :
...
### Options
<a name="options_ELTPARAGRAPHE000172"></a>Ces options permettent de simplifier la gestion de la liste de fichiers de données à ré-indexer :
...
<a name="droits_acces_fichier_donnees_ELTPARAGRAPHE000196"></a>L'optimisation provoque la recréation du fichier de données sur disque. 
