...
<a name="ouverture_projet_exemple_ELTPARAGRAPHE000047"></a>Ce tuto manipule le projet "Site_WEBDEV_Complet". Ce projet comprend une partie Front office et une partie Back Office. Nous allons configurer le site pour limiter les accès à la page d'ajout des produits dans la partie Back Office. L'identification via le groupware sera automatiquement effectuée via un lien de connexion.
...
<a name="integration_groupware_utilisateur_dans_projet_ELTPARAGRAPHE000057"></a>Tout d'abord, pour utiliser le groupware utilisateur dans un site, il faut intégrer la fonctionnalité dans le projet. Les différentes étapes sont les suivantes :
...
3. Activez le groupware utilisateur en cliquant sur "Actif". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0001.jpg&type=thumb)
...
<a name="integration_authentification_des_utilisateurs_dans_site_ELTPARAGRAPHE000109"></a>Notre projet gère le groupware utilisateur mais il faut que l'utilisateur puisse s'identifier. Dans cet exemple, nous allons intégrer le lien de connexion dans la page "PAGE_Liste_des_produits".
...
4. Sélectionnez le modèle de champs "MDLC_GPU_WB_Connexion" et réalisez un "Drag and Drop" vers la page "PAGE_Liste_des_produits". Déposez le modèle de champs à droite du logo "Company".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0003.jpg&type=thumb)
...
6. Dans la page qui s'affiche, choisissez "Configurer le groupware".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Groupware%20utilisateur%20-%20HC%20N%B0002%20B.jpg)


7. La page de configuration du groupware apparaît.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0003%20B.jpg&type=thumb)
...
<a name="creation_des_utilisateurs_des_groupes_ELTPARAGRAPHE000179"></a>Pour configurer le groupware utilisateur, nous allons tout d'abord créer un groupe "Gestion Produits". Ce groupe regroupera les utilisateurs autorisés à modifier et à ajouter des produits dans le site.
...
<a name="definition_des_droits_ELTPARAGRAPHE000278"></a>Nous allons maintenant définir les droits d'accès au menu d'ajout d'un produit.
...
3. Pour l'option "Option de menu OPT_AjouterProduit", sélectionnez dans la combo "Etat" l'option "Grisé".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0008.jpg&type=thumb)
...
<a name="test_page_avec_utilisateur_specifique_ELTPARAGRAPHE000316"></a>Nous allons maintenant tester la page.
...
2. Par défaut, l'option "Fiche produit" est grisée. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0009.jpg&type=thumb)


3. Cliquez sur "Connexion" et utilisez le login "Alice" (et son mot de passe "Alice"). Validez.

4. L'option "Fiche produit" n'est plus grisée.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B00010.jpg&type=thumb)
