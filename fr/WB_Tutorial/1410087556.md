...
<a name="lecon_3_modifier_les_produits_ELTTEXTE000417"></a>
...
## Présentation
<a name="presentation_ELTTEXTE000453"></a>
...
<a name="une_nouvelle_page_pour_modifier_les_produits_ELTTEXTE000477"></a>
...
### Création de la page
<a name="creation_page_ELTPARAGRAPHE000045"></a>La méthode de création d'une nouvelle page est toujours la même : 
...
<a name="creation_des_champs_saisie_ELTPARAGRAPHE000087"></a>Nous allons maintenant créer les différents champs de saisie permettant de visualiser dans la page les différentes informations concernant le produit sélectionné.
...
2. Cliquez sur la flèche à gauche du fichier de données "Produit" : les rubriques du fichier de données sont listées. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0001.jpg)
...
4. Effectuez un "Drag and Drop" (glisser/déplacer) de ces rubriques vers la page que vous venez de créer. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0002.jpg&type=thumb)
...
5. Différents champs sont automatiquement créés dans la page. Ces champs sont liés à la rubrique correspondante dans le fichier de données. Pour le vérifier :
	...
	- Affichez l'onglet "Liaison" de la fenêtre de description : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0003.jpg&type=thumb)
...
Repositionnez les champs dans la page afin d'obtenir l'UI suivante : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0004.jpg&type=thumb)
...
<a name="affichage_des_donnees_dans_page_ELTPARAGRAPHE000123"></a>La page "Fiche" doit afficher le produit sélectionné dans le champ Zone répétée. Dans les événements WLangage associés à la page, nous allons maintenant saisir le code permettant de :
...
<a name="validation_page_ELTPARAGRAPHE000164"></a>La page "PAGE_Fiche_du_produit" va permettre tout d'abord de modifier un produit présent dans la liste des produits.
...
3. Modifiez le libellé du champ : le nouveau libellé est "Valider". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0005.jpg&type=thumb)
...
4. Cliquez ensuite dans le champ Zone répétée pour créer le champ Lien à côté du champ Référence. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0006.jpg&type=thumb)
...
<a name="test_modification_produit_ELTTEXTE000631"></a>
...
1. L'éditeur demande la première page du mode Session. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0007.jpg)
...
3. Dans la liste des produits :
	...
	- La page de détail du produit s'affiche. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0008.jpg&type=thumb)
...
## En résumé
<a name="resume_ELTTEXTE000664"></a>
