...
<a name="les_secrets_mise_page_ELTTEXTE000406"></a>
...
## Un exemple pratique
<a name="exemple_pratique_ELTTEXTE000466"></a>


### Création du projet exemple
<a name="creation_projet_exemple_ELTPARAGRAPHE000044"></a>Pour créer un projet sous WEBDEV :
...
### Création d'une page
<a name="creation_une_page_ELTPARAGRAPHE000056"></a>Pour créer une page permettant de mettre en pratique la gestion des ancrages :
...
### Création de zones
<a name="creation_zones_ELTPARAGRAPHE000074"></a>Nous allons maintenant diviser notre page en 3 zones :
...
1. Lancez le test de la page (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Go_Page_WB_GAF.jpg) parmi les boutons d'accès rapide). La page s'affiche sous le navigateur. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Ancrages%20-%20HC%20N%B0003.jpg&type=thumb)
...
<a name="mettre_place_ancrage_ELTTEXTE000508"></a>
...
### Ancrage de la page
<a name="ancrage_page_ELTPARAGRAPHE000188"></a>Pour mettre en place l'ancrage de la page :
...
### Ancrage des zones
<a name="ancrage_des_zones_ELTPARAGRAPHE000204"></a>Pour mettre en place l'ancrage des zones :
...
6. La zone doit s'agrandir en hauteur. Sélectionnez : 
	...
	- Position : Le champ conserve sa position (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Ancrages%20-%20HC%20N%B0005%201.jpg)).
...
8. Sélectionnez la zone orange et affichez la fenêtre de gestion des ancrages. La zone doit s'agrandir en largeur et hauteur. Sélectionnez : 
	...
	- Ancrage en hauteur : Agrandir ou réduire comme le navigateur (ou son conteneur). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Ancrages%20-%20HC%20N%B0007.jpg&type=thumb)
...
### Ancrage des champs
<a name="ancrage_des_champs_ELTPARAGRAPHE000237"></a>Pour mettre en place l'ancrage des champs :
...
### Tester la page
<a name="tester_page_ELTPARAGRAPHE000257"></a>Lancez le test de la page (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Go_Page_WB_GAF.jpg) parmi les boutons d'accès rapide).
...
## Mettre en place les agencements
<a name="mettre_place_les_agencements_ELTTEXTE000556"></a>
...
<a name="creation_agencement_mobile_ELTPARAGRAPHE000300"></a>Pour créer un nouvel agencement mobile :

1. Sous le volet "Page", dans le groupe "Agencements", déroulez "Agencements" et sélectionnez "Ajouter un agencement". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Ancrage%20-%20Agencement%20-%20HC%20N%B0001.jpg&type=thumb)
...
<a name="modification_agencement_mobile_ELTPARAGRAPHE000325"></a>Affichez l'agencement "Mobile" : 
...
### Test de la page
<a name="test_page_ELTPARAGRAPHE000347"></a>Lancez le test de la page (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Go_Page_WB_GAF.jpg) parmi les boutons d'accès rapide).
...
2. Une fenêtre s'affiche, proposant un QR code à flasher avec votre mobile. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P7_Ancrage%20-%20Agencement%20-%20HC%20N%B0009.jpg)
...
## En résumé
<a name="resume_ELTTEXTE000616"></a>
