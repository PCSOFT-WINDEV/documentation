...
<a name="etape_2_choix_des_langues_dans_analyse_ELTTEXTE000667"></a>
...
<a name="ajout_langues_dans_analyse_ELTPARAGRAPHE000127"></a>Pour gérer plusieurs langues dans l'analyse du projet "Site_WEBDEV_Complet" :

1. Affichez l'éditeur d'analyses : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Analyse_GAF.jpg) parmi les boutons d'accès rapide du menu de WEBDEV. 
...
4. La nouvelle langue apparaît dans la liste. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Multilangue%20-%20HC%20N%B0003.jpg&type=thumb)
...
<a name="informations_partagees_multilingues_ELTPARAGRAPHE000149"></a>Pour saisir les informations partagées dans plusieurs langues, examinons un cas simple : la saisie de libellé du champ lié à la rubrique "Adresse" du fichier de données "Client" :
...
4. Dans l'onglet "Général", dans la zone "Libellé', saisissez le libellé pour la langue anglaise "Address". 
	<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Multilangue%20-%20HC%20N%B0004.jpg&type=thumb)
...
<a name="prise_compte_des_modifications_ELTPARAGRAPHE000171"></a>Pour prendre en compte les modifications réalisées dans l'analyse, il est nécessaire de générer l'analyse : sous le volet "Analyse" du ruban, dans le groupe "Analyse", cliquez sur "Génération".
...
<a name="prise_compte_langue_dans_page_ELTPARAGRAPHE000209"></a>Vérifions tout d'abord que la page PAGE_Liste_des_produits est bien associée aux différentes langues définies dans le projet :
...
4. Traduisons le titre de la page : remplacez le texte présent dans la zone anglaise par "List of products". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0005.jpg&type=thumb)
...
<a name="traduire_les_options_menu_ELTPARAGRAPHE000227"></a>La traduction des options d'un menu peut être réalisée comme pour les autres champs via la fenêtre de description de l'option, ou directement à partir de l'éditeur de pages.
...
1. Le menu est contenu dans le modèle associé à la page. Il est donc nécessaire d'ouvrir le modèle de pages associé :
	...
	- Sélectionnez l'option "Ouvrir le modèle".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0006.jpg)
...
<a name="traduire_les_champs_site_ELTPARAGRAPHE000293"></a>Un champ peut afficher de nombreuses informations à l'utilisateur :
...
<a name="traduction_des_messages_programmation_ELTPARAGRAPHE000315"></a>Tous les messages de votre programme peuvent également être saisis dans plusieurs langues.
...
6. L'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_Multilangue%20-%20HC%20N%B0007%201.jpg) apparaît sous l'éditeur de code. Cette icône indique que le message multilingue existe dans plusieurs langues. Un survol de cette icône permet de visualiser rapidement les différentes traductions.
...
<a name="boutons_changement_langue_ELTPARAGRAPHE000369"></a>Les boutons de changement de langue sont présents dans le modèle de la page PAGE_Liste_des_produits. 
...
2. Enregistrez le modèle de pages (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg) ou Ctrl + S).

3. Mettez à jour les pages utilisant le modèle de pages en cliquant sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20WebDev%20-%20Liste%20produits%20-%20HC%20N%B0011%201.jpg) dans le bandeau du modèle. Validez la fenêtre de mise à jour.
...
### Test de la page
<a name="test_page_ELTPARAGRAPHE000415"></a>Nous avons traduit quelques éléments de l'application, nous allons maintenant tester le changement de langue.

Pour tester le changement de langue dans la page PAGE_Liste_des_produits :

1. Lancez le test de la page (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Go_Page_WB_GAF.jpg) parmi les boutons d'accès rapide). La page apparaît en mode test en français. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0010.jpg&type=thumb)


2. Cliquez sur le drapeau Américain en bas de la page.

3. Les différents éléments que nous avons traduits apparaissent en anglais : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0011.jpg&type=thumb)
...
<a name="saisie_directe_des_traductions_avec_logiciel_traduction_ELTPARAGRAPHE000445"></a>Les traductions sont directement saisies dans l'interface du produit : c'est la méthode que nous avons utilisée jusqu'à présent.
...
2. Affichez l'onglet "Traduction".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P5_MultiLangue%20-%20HC%20N%B0008.jpg&type=thumb)
...
<a name="traduction_avec_wdmsg_wdtrad_ELTPARAGRAPHE000488"></a>Il existe également un outil optionnel **WDMSG** qui permet :
