...
<a name="quel_est_but_cette_lecon_ELTPARAGRAPHE000032"></a>Nous avons créé un formulaire dans la leçon précédente. Lors de la création d'un formulaire, la première chose que l'on souhaite, c'est bien entendu, sauvegarder les données saisies. Ces données peuvent être enregistrées par exemple dans un fichier texte, un fichier XML ou encore une base de données.
...
<a name="creation_fichier_donnees_ELTTEXTE000644"></a>
...
3. Un nouvel éditeur apparaît : l'éditeur d'analyses. 
	Sous WEBDEV, la description de la base de données se fait sous un éditeur spécifique, l'éditeur d'analyses. L'éditeur d'analyses contient la description de tous les fichiers de données qui seront manipulés par le projet. Nous verrons cet éditeur en détail dans le tuto [Créer un projet et son analyse](../TutoWB/1410087411.md).


4. L'assistant de génération d'un fichier de données se lance. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes%20Premi%E8res%20pages%20-%20Analyse%20-%20HC%20N%B0001.jpg&type=thumb)
...
7. Choisissez les champs à récupérer. Dans notre cas, tous les champs de la page correspondent à une rubrique.  <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes%20Premi%E8res%20pages%20-%20Analyse%20-%20HC%20N%B0003.jpg&type=thumb)
...
9. Cette étape permet de définir les clés (également appelées index).
 ...
 Dans cet exemple, la rubrique "Nom" sera une clé avec doublons et la rubrique "Login" sera une clé unique. Le fichier de données pourra donc contenir deux personnes inscrites avec le même nom mais pas avec le même login. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes%20Premi%E8res%20pages%20-%20Analyse%20-%20HC%20N%B0004.jpg&type=thumb)
...
12. Enregistrez l'analyse : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg) parmi les boutons d'accès rapide (ou utilisez le raccourci Ctrl + S).
...
Enregistrez la page (Ctrl + S). Un pictogramme s'affiche à droite du champ. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0001.jpg)
Ce pictogramme permet d'indiquer qu'une erreur ou un conseil concernant l'UI a été détecté. Le survol du pictogramme permet d'obtenir plus de détails.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0002.jpg)

Dans notre cas, aucun raccourci clavier n'est associé au champ Bouton. Ce problème peut être corrigé automatiquement : 

- Cliquez sur le picto ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0001%201.jpg). 

- Dans la fenêtre qui s'affiche, cliquez sur "Corriger". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0003.jpg)
...
<a name="code_wlangage_champ_bouton_ELTPARAGRAPHE000156"></a>Nous allons maintenant définir les actions à effectuer lors du clic sur le champ Bouton en utilisant du code WLangage.
...
- La fonction [&lt;Page&gt;.VersFichier](../WDLang4/1000021390.md) permet de récupérer le contenu des champs de saisie de la page PAGE_Formulaire pour le transférer vers le fichier de données Inscription.

- La fonction [&lt;Fichier de données&gt;.Ajoute](../WDLang4/1000024187.md) permet d'écrire dans le fichier de données Inscription les données transférées.
...
### Test de la page
<a name="test_page_ELTPARAGRAPHE000194"></a>Nous allons tester immédiatement la page et l'enregistrement des données saisies : 
...
2. Sélectionnez le fichier de données "Inscription". Le contenu du fichier de données s'affiche. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_WDMap%20-%20HC%20N%B0001.jpg&type=thumb)
...
### Saisie obligatoire
<a name="saisie_obligatoire_ELTPARAGRAPHE000257"></a>Pour rendre obligatoire la saisie dans le champ "Nom" :
...
3. Une boîte d'information est automatiquement affichée pour indiquer que des champs obligatoires n'ont pas été remplis. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes%20Premi%E8res%20Pages%20-%20Partie%203%20-%20HC%20N%B0001.jpg&type=thumb)
...
<a name="verification_mot_passe_ELTPARAGRAPHE000288"></a>Pour vérifier le mot de passe, nous allons : 
...
### Création de la page
<a name="creation_page_ELTPARAGRAPHE000351"></a>Pour créer la page :

1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Cr%E9er_WB_GAF.jpg) parmi les boutons d'accès rapide. La fenêtre de création d'un nouvel élément s'affiche.
...
### Création des champs
<a name="creation_des_champs_ELTPARAGRAPHE000367"></a>La page de login va contenir les champs suivants :
...
Comme pour la page précédente, un pictogramme s'affiche en haut à droite du champ Bouton "SE CONNECTER" : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0001%201.jpg)Là encore, il s'agit d'un problème de raccourci clavier manquant. 
...
3. Dans l'onglet "Général", dans la zone "Action du bouton", nous allons indiquer l'action à effectuer. Dans notre cas, nous allons ouvrir la page d'inscription : 
	...
	- Dans la zone "Page", sélectionnez "PAGE_Formulaire". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P1_Mes%20Premi%E8res%20pages%20-%20Partie%203%20-%20HC%20N%B0003.jpg&type=thumb)
...
### Test de la page
<a name="test_page_ELTPARAGRAPHE000484"></a>Lancez le test de cette page :
...
### Pensez mobilité
<a name="pensez_mobilite_ELTPARAGRAPHE000521"></a>Un site doit fonctionner aussi bien sur PC que sur Mobile : c'est une réalité actuelle. Le site doit être pensé dès sa conception pour une utilisation mobile. 
