...
<a name="lecon_4_ajouter_produit_ELTTEXTE000391"></a>
...
<a name="ajout_nouveau_produit_via_page_fiche_produit_ELTTEXTE000451"></a>
...
<a name="gestion_ajout_dans_menu_page_ELTPARAGRAPHE000110"></a>Nous allons maintenant modifier le menu de la page pour permettre à l'utilisateur d'ajouter un nouveau produit.
...
6. Dans l'onglet "Général", dans la zone "Action de l'option" : 
	...
	- sélectionnez la page "PAGE_Fiche_du_produit".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0001.jpg)
...
8. Dans le bandeau du modèle, cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%205%20Gestion%20des%20menus%20-%20HC%20N%B0002%201.jpg) pour propager les modifications du modèle à toutes les pages utilisant le modèle.
...
<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0002.jpg)
...
<a name="gestion_image_produit_ELTPARAGRAPHE000149"></a>Dans le fichier de données Produit, une rubrique permet de stocker l'image associée au produit.
...
Pour cela, nous allons permettre à l'utilisateur d'uploader un fichier image présent sur son poste pour ensuite l'associer à la rubrique présente dans le fichier de données. Nous allons utiliser un champ Upload.L'upload consiste à copier un fichier du poste client vers le serveur.
...
3. Cliquez dans la page à la position où le champ doit être créé (par exemple en dessous du champ Image). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0003.jpg&type=thumb)
...
7. Enregistrez les modifications en cliquant sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Sauver_WB_GAF.jpg) parmi les boutons d'accès rapide. Les erreurs de compilation disparaissent.
...
2. Dans l'événement "Clic xxx (serveur)" du champ Bouton, saisissez le code suivant APRES l'appel de la fonction [&lt;Fichier de données&gt;.DepuisPage](../WDLang4/1000021405.md) :
...
<a name="test_ajout_produit_ELTPARAGRAPHE000287"></a>Toutes les modifications nécessaires à l'ajout d'un produit on été effectuées. Maintenant, il ne reste plus qu'à tester. 

Pour tester l'ajout d'un produit :

1. Lancez le test du projet (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Go_Projet_WB_GAF.jpg) parmi les boutons d'accès rapide). La page listant les produits s'affiche. 
...
## En résumé
<a name="resume_ELTTEXTE000671"></a>
