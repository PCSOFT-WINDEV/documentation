...
### Le type Date
<a name="type_date_ELTPARAGRAPHE000033"></a>Pour gérer les dates, le WLangage propose le type **Date**. De nombreuses fonctions et propriétés permettent de manipuler les dates.  
...
9. Testons immédiatement ce code : cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_GO_Projet_WB_GAF.jpg) parmi les boutons d'accès rapide.  
...
### Le type Heure
<a name="type_heure_ELTPARAGRAPHE000038"></a>De la même manière, il est possible de manipuler des heures grâce au type **Heure**. 
...
### Le type Durée
<a name="type_duree_ELTPARAGRAPHE000043"></a>Pour les durées, le même type de code peut être saisi. 
...
### Déclaration
<a name="declaration_ELTPARAGRAPHE000057"></a>La déclaration d'une variable de type tableau se fait de la façon suivante : 
...
<a name="remplissage_tableau_acces_aux_elements_ELTPARAGRAPHE000064"></a>Lors de sa déclaration, le tableau est vide. L'ajout d'éléments est réalisé par la fonction [&lt;Tableau&gt;.Ajoute](../WDLang1/1000024299.md) grâce à la syntaxe suivante : 
...
<a name="parcours_tableau_ELTPARAGRAPHE000071"></a>Pour parcourir les éléments d'un tableau, le WLangage propose deux méthodes : 
...
### Le type Structure
<a name="type_structure_ELTPARAGRAPHE000087"></a>Une structure est un type de données personnalisé. Une structure regroupe des variables de types différents.
