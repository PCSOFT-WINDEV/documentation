...
<a name="partagez_vos_sources_grace_gds_ELTTEXTE000472"></a>
...
<a name="principe_gds_gestionnaire_sources_ELTTEXTE000532"></a>
...
L'environnement permet de sauver les projets, les fenêtres, les pages, les états, les classes, les collections de procédures et le code dans une base de sources Git. Pour plus de détails, consultez [Partagez vos projets via Git](../Editeurs/9500230.md). 
...
## La base de sources
<a name="base_sources_ELTTEXTE000565"></a>
...
<a name="integration_projet_existant_dans_gds_ELTTEXTE000598"></a>
...
1. Sous le volet "GDS", dans le groupe "Ajouter le projet", cliquez sur "Ajouter le projet dans le GDS". L'assistant d'ajout d'un projet dans le GDS se lance : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0001.jpg&type=thumb)
Nous n'avons pas précédemment créé de base de sources. Nous allons donc en créer une.
	Nous allons créer une base de sources "Client/Serveur" sur le serveur installé lors du tuto [Administrer une base HFSQL Client/Serveur](../TutoWB/1410087211.md). Si vous n'avez pas suivi ce tuto, il est nécessaire de suivre la leçon concernant l'installation du serveur HFSQL. 
...
7. Passez à l'étape suivante. L'utilisateur en cours n'est pas autorisé à accéder au serveur HFSQL. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0003.jpg&type=thumb)
...
<a name="ouverture_projet_depuis_gds_ELTPARAGRAPHE000199"></a>Dans notre exemple, le projet est intégré au GDS et vous pouvez le manipuler directement.
...
<a name="manipulation_projet_via_gds_ELTTEXTE000673"></a>
...
<a name="modification_parametre_projet_ELTPARAGRAPHE000250"></a>Nous allons modifier le projet en demandant à afficher l'ambiance sur les boîtes de dialogue :
...
1. Tout d'abord la fenêtre d'extraction automatique du projet s'affiche. En effet, nous modifions une caractéristique du projet, il est nécessaire d'extraire le projet. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0008.jpg&type=thumb)
...
WEBDEV propose plusieurs modes d'extraction. Pour plus de détails, consultez [Les modes de gestion du projet](../Editeurs/2038004.md). 
...
<a name="modification_une_page_projet_ELTPARAGRAPHE000302"></a>Nous allons maintenant modifier la page "PAGE_Fiche_du_produit". Nous allons déplacer le bouton "Valider".

Pour modifier un élément du projet, il est nécessaire de l'extraire.La modification d'un élément extrait (UI, code, etc.) s'effectue comme sur un projet non géré par le GDS. 
...
1. Sélectionnez la page "PAGE_Fiche_du_produit" dans le volet "Explorateur du projet" et double-cliquez sur l'élément pour l'ouvrir sous l'éditeur de pages. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0011.jpg&type=thumb)


2. L'extraction automatique est activée à la première modification : il suffit de déplacer un champ pour extraire l'élément. Il est également possible d'utiliser l'icône "Extraire" présente dans le ruban du volet GDS (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0010%201.jpg)). 

3. La fenêtre d'extraction apparaît : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0012.jpg&type=thumb)
...
2. Testez la page (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ICO_Go_Page_WB_GAF.jpg) parmi les boutons d'accès rapide). 
...
<a name="reintegration_element_extrait_ELTPARAGRAPHE000357"></a>Maintenant que les modifications sont terminées et testées, nous allons réintégrer la page "PAGE_Fiche_du_produit" dans la base de sources. Vos modifications seront alors accessibles aux autres développeurs.
...
2. Sous le volet "GDS", dans le groupe "Elément en cours", cliquez sur le bouton "Réintégrer". La fenêtre suivante s'affiche : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P12_Int%E9gration%20dans%20le%20GDS%20WB%20-%20HC%20N%B0013.jpg&type=thumb)
...
<a name="pour_aller_plus_loin_ELTTEXTE000751"></a>
...
- [Les options du projet spécifiques au GDS](../Editeurs/9500239.md). 

- [Le travail en mode nomade](../Editeurs/2038013.md). 

- [L'administrateur du GDS](../Editeurs/2038008.md). 
...
Pour obtenir l'aide globale sur le GDS, consultez [Le gestionnaire de sources](../Editeurs/2038001.md). 
