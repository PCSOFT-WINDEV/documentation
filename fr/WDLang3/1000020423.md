...
- **Le mode émulation de carte** :
	...
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Ce mode n'étant actuellement pas supporté sur les périphériques Android.
...
<a name="conditions_necessaires_ELTPARAGRAPHE000089"></a>L'utilisation des fonctions NFC entraîne la modification des AppID de l'application dans le compte développeur Apple. Il est nécessaire d'activer l'App ID "NFC Tag Reading".<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Apple_APPID_NFC.gif&type=thumb)
