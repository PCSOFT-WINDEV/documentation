...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notif_FireBase1.gif&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notif_FireBase2.gif&type=thumb)


- Renseignez le nom de package de l'application avec celui saisi dans l'assistant de génération Android. 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notif_FireBase3.gif)


- Cliquez sur le bouton "Enregistrer l'application". 

- L'étape suivante permet de télécharger le fichier "google-services.json".  
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notif_FireBase4.gif&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notif_FireBase5.gif&type=thumb)


- Dans la partie concernant l'application Android, téléchargez le fichier "google-services.json". 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notif_FireBase5B.gif&type=thumb)



Ce fichier doit être fourni dans l'assistant de génération de l'application : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Push_Android_firebase%20-%20HC%20N%B0001.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notif_FireBase6.gif&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Notif_FireBase7.gif&type=thumb)
