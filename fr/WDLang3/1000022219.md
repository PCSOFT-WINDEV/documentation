...
- soit un token JWT.
	![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Cette syntaxe est désormais disponible en Android, à partir de la version 2025 Update 1.
...
## Syntaxe
<a name="SYNTAXE1"></a>
![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Cette syntaxe n'est pas disponible pour les applications en mode Widget iOS ou en mode Catalyst
...
<a name="SYNTAXE2"></a>
![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) 
