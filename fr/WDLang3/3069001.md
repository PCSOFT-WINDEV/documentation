...
<a name="SYNTAXE3"></a>
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Non disponible pour les applications Android
### Ajouter un noeud dans un entête d'un webservice SOAP spécifique
...
Nom de la variable [wsRequête](../WDLang3/1000020577.md) correspondant à la méthode du webservice à manipuler. 

**`<Noeud> : (Variable de type xmlNoeud)`**

Nom de la variable [xmlNoeud](../WDLang5/1000018786.md) correspondant au noeud à ajouter dans l'entête du webservice SOAP. 


<a name="SYNTAXE4"></a>
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Non disponible pour les applications Android
### Ajouter un entête (syntaxe conservée par compatibilité)
...
- <u><u><u><u>Vrai</u></u></u></u> : la procédure ne doit pas s'exécuter si le serveur SOAP ne peut pas traiter l'entête (entête obligatoire).
...
<a name="execution_procedure_syntaxe_4_conservee_par_compatibilite_ELTPARAGRAPHE000140"></a>Il est possible d'exécuter ou non la prochaine procédure SOAP grâce à l'ajout d'un entête. Pour cela, le paramètre &lt;Exécution de la procédure&gt; doit être initialisé à <u><u><u><u>Vrai</u></u></u></u>.
