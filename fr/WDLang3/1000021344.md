...
<a name="comment_programmer_des_graphes_ELTTEXTE000332"></a>


### Créer des graphes par programmation
<a name="creer_des_graphes_par_programmation_ELTPARAGRAPHE000054"></a>Pour manipuler des graphes, WINDEV, WEBDEV et WINDEV Mobile disposent d'une cinquantaine de fonctions. Ces fonctions permettent de créer les graphes, de les modifier, de changer des options d'affichage ...
...
2. Initialisez les données du graphe avec les fonctions :
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) [grHMAjouteDonnée](../WDLang3/1000021628.md) pour les graphes de type Heatmap.
...
De nombreuses fonctions permettent de paramétrer et de modifier l'apparence du graphe. Il est ainsi possible d'afficher une légende, le titre des axes, etc. Pour plus de détails, consultez la liste des [fonctions de gestion des graphes](../WDLang3/3042003.md).
...
### Graphes et threads
<a name="graphes_threads_ELTPARAGRAPHE000141"></a>Un seul graphe peut être manipulé dans un thread.
...
<a name="valeurs_par_defaut_graphe_dans_une_fenetre_dans_une_page_ELTPARAGRAPHE000160"></a>Les valeurs par défaut d'un graphe sont les suivantes :
...
[Programmation des graphes (syntaxe préfixée)](../WDLang3/1000024322.md)
