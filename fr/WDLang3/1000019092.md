...
### Rappel
<a name="rappel_ELTPARAGRAPHE000398"></a>
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000413"></a>Lors de l'ajout d'un fichier dans une archive, un indice est automatiquement attribué au fichier. Cet indice correspond à l'ordre d'intégration des fichiers dans l'archive. Pour sélectionner un fichier de l'archive, il est possible d'utiliser :
...
### Chemin mémorisé
<a name="chemin_memorise_ELTPARAGRAPHE000431"></a>Le tableau ci-dessous présente les chemins mémorisés dans l'archive en fonction :
...
<a name="cryptage_fichier_dans_une_archive_ELTPARAGRAPHE000501"></a>Un fichier peut être crypté dans une archive grâce à la fonction [zipMotDePasse](../WDLang3/3082053.md).
