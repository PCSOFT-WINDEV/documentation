...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_notif1.gif)


Il est possible de les dérouler pour en visualiser le détail. 

![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_notif2.gif)
...
L'utilisateur final a la possibilité de modifier localement les paramètres des catégories de notification d'une application : activer/désactiver l'affichage des notifications de la catégorie, modifier la priorité des notifications, associer un son particulier, etc. Ces modifications s'effectuent depuis l'écran de paramétrage des notifications de l'application : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Categorie_notification.gif)
