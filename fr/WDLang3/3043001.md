...
|   |   |
| --- | --- |
| *httpCookie* | Bloc des cookies (extrait à partir des entêtes HTTP).<br><br>![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Cette constante n'est pas disponible. |
