...
<a name="proprietes_specifiques_description_des_variables_type_oauth2parametres_ELTPARAGRAPHE000046"></a>Les propriétés suivantes peuvent être utilisées pour manipuler les informations nécessaires à la demande d'authentification :
...
| URLAuth | Chaîne de caractères | URL d'autorisation à utiliser (première URL du standard OAuth 2.0). <br><br> |
...
- Si le serveur ne gère pas l'entête HTTP "**Authorization**" pour la transmission du token d'accès, cette transmission doit être faite par le développeur selon le format attendu par le service demandé. 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Exemple de code pour Facebook
	...
	- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Exemple de code pour Facebook : 
...
<a name="authentification_pkce_ELTPARAGRAPHE000314"></a>Exemple d'authentification PKCE : 
...
<a name="authentification_via_client_secret_basic_ELTPARAGRAPHE000324"></a>Exemple d'authentification par "Client Secret Basic" : 
