...
<a name="recreation_socket_ELTPARAGRAPHE000149"></a>Si un socket n'est pas fermé correctement par la fonction [SocketFerme](../WDLang3/3070015.md) (redémarrage du poste par exemple), la recréation du socket peut être relativement longue. Il est en effet nécessaire d'attendre que le système libère le socket.
<a name="NOTE0_2"></a>


### Réutilisation d'une adresse déjà utilisée
<a name="reutilisation_une_adresse_deja_utilisee_ELTPARAGRAPHE000159"></a>Par défaut, la fonction **SocketCréeSSL** permet de réutiliser une adresse déjà utilisée (par l'application elle-même ou par une autre application). Pour ne pas autoriser ce fonctionnement, il suffit de saisir le code suivant :
...
[Création d'un certificat SSL utilisable avec SocketCréeSSL](../WDLang3/3070021.md)
