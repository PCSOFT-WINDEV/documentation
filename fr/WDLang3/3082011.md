...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003082011&name=zipextraittout_fonction&product=WD">Voir des exemples supplémentaires</a>
...
### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000284"></a>Les codes d'erreur retournés sont les suivants :
...
### Fichier extrait
<a name="fichier_extrait_ELTPARAGRAPHE000314"></a>Les fichiers extraits ne sont pas effacés de l'archive. Pour effacer un ou tous les fichiers de l'archive, utilisez la fonction [zipSupprimeFichier](../WDLang3/3082041.md) ou [zipSupprimeTout](../WDLang3/3082051.md).
