...
1. Connexion à un serveur FTP (fonction [FTPConnecte](../WDLang3/3040016.md)).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FTP_Connexion.gif)


2. Transmission et récupération des fichiers (selon le mode de connexion établi). ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FTP_Communication.gif)
...
3. Fermeture de la connexion avec le serveur (fonction [FTPDéconnecte](../WDLang3/3040011.md)).![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FTP_Deconnexion.gif)
