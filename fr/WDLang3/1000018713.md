...
| Source | Chaîne de caractères | Contient la source du message reçu (sujet, expéditeur, destinataire, contenu, ...).<br><br><br><br>![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Cette propriété n'est pas gérée par Outlook sous Windows. |
