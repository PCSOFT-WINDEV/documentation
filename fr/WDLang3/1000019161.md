...
***En anglais : &lt;zipArchive variable&gt;.Split***
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Nom d'un champ Jauge présent dans une fenêtre. Cette jauge affichera la progression du découpage.  
...
<a name="conditions_utilisation_ELTPARAGRAPHE000297"></a>Le découpage d'une archive ne peut être réalisé que si :
...
### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000327"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="destination_archive_ELTPARAGRAPHE000348"></a>&lt;Destination&gt; doit correspondre à un support accessible en lecture et en écriture. Ce support peut être :
...
<a name="suppression_archive_originale_ELTPARAGRAPHE000405"></a>Lorsque le paramètre &lt;Suppression de l'archive originale&gt; a pour valeur <u><u><u><u>Vrai</u></u></u></u>, le découpage entraîne la fermeture de l'archive originale ainsi que sa destruction au fur et à mesure du découpage.
...
### Espace réservé
<a name="espace_reserve_ELTPARAGRAPHE000428"></a>La taille de la première sous-archive peut être plus petite que la taille des autres sous-archives. Il suffit d'indiquer la taille en octets à diminuer de la première sous-archive dans le paramètre &lt;Espace réservé&gt;.
...
### Ordre de découpage
<a name="ordre_decoupage_ELTPARAGRAPHE000452"></a>Lors du découpage d'une archive, l'ordre de découpage est le suivant :
...
### Nombre de parties
<a name="nombre_parties_ELTPARAGRAPHE000473"></a>La fonction [&lt;Variable zipArchive&gt;.NbPartieNécessaire](../WDLang3/1000019094.md) permet de connaître le nombre de parties nécessaires au découpage de l'archive.
...
<a name="fermeture_archive_ELTPARAGRAPHE000495"></a>Après utilisation de la fonction **&lt;Variable zipArchive&gt;.Découpe** sur une archive, cette archive ne se ferme pas. Il est nécessaire d'utiliser les fonctions :

- [&lt;Variable zipArchive&gt;.Ferme](../WDLang3/1000019086.md) pour fermer l'archive mono-partie.

- [&lt;Variable zipArchive&gt;.Ouvre](../WDLang3/1000019097.md) pour ouvrir la nouvelle archive multi-parties.
...
<a name="actions_realisables_sur_une_archive_multiparties_ELTPARAGRAPHE000525"></a>Certaines fonctions d'archivage sont utilisables uniquement sur des archives mono-partie (ajout et suppression de fichiers, création d'un exécutable auto-extractible, ...). Pour effectuer ces opérations, il suffit de regrouper les sous-archives (fonction [&lt;Variable zipArchive&gt;.Regroupe](../WDLang3/1000019151.md)) pour obtenir une archive mono-partie.
...
[&lt;Variable zipArchive&gt;.Regroupe (Fonction)](../WDLang3/1000019151.md)
