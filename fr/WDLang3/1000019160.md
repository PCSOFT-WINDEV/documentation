...
### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000414"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="condition_utilisation_ELTPARAGRAPHE000432"></a>Le nombre maximum de fichiers pouvant être intégrés :
