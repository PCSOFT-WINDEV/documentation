...
<a name="condition_utilisation_ELTPARAGRAPHE000663"></a>L'ajout de fichiers dans une archive ne peut être réalisé que si :
...
### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000762"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000799"></a>Lors de l'ajout d'un fichier dans une archive, un indice est automatiquement attribué au fichier. Cet indice correspond à l'ordre d'intégration des fichiers dans l'archive. Pour sélectionner un fichier de l'archive, il est possible d'utiliser :
...
<a name="chemin_conserve_archives_format_wdz_zip_ELTPARAGRAPHE000817"></a>Le tableau ci-dessous présente les chemins conservés dans l'archive en fonction :
