...
- Pour ajouter les fichiers d'un répertoire, utilisez la fonction [&lt;Variable zipArchive&gt;.AjouteRépertoire](../WDLang3/1000019078.md).

- Pour optimiser l'ajout de fichiers dans une archive au format ZIP, WDZ et 7Z, l'ajout de fichiers doit être effectué entre les fonctions [&lt;Variable zipArchive&gt;.DébutAjoutFichier](../WDLang3/1410091280.md) et [&lt;Variable zipArchive&gt;.FinAjoutFichier](../WDLang3/1410091281.md). 
...
Nom d'une variable de type [zipArchive](../WDLang3/1000018679.md) correspondant à l'archive dans laquelle le fichier doit être ajouté.
...
- au nom d'une procédure WLangage. Pour plus de détails sur cette procédure, consultez [Paramètres de la procédure utilisée par la fonction &lt;Variable zipArchive&gt;.AjouteFichier](../WDLang3/1000025730.md). 
...
<a name="condition_utilisation_ELTPARAGRAPHE000635"></a>L'ajout de fichiers dans une archive ne peut être réalisé que si :
...
- ![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Seules les archives au format ZIP, TAR, gzip ou TGZ (TAR.GZ) sont disponibles.
...
<a name="niveau_compression_des_archives_zip_7z_ELTPARAGRAPHE000721"></a>Par défaut, les fichiers ajoutés dans une archive au format ZIP ou 7z sont compressés. Il est possible de modifier le niveau de compression des fichiers ajoutés dans une archive grâce à la fonction [zipNiveauCompression](../WDLang3/3082054.md).
<a name="NOTE0_3"></a>


### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000734"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000771"></a>Lors de l'ajout d'un fichier dans une archive, un indice est automatiquement attribué au fichier. Cet indice correspond à l'ordre d'intégration des fichiers dans l'archive. Pour sélectionner un fichier de l'archive, il est possible d'utiliser :
...
<a name="chemin_conserve_archives_format_wdz_zip_ELTPARAGRAPHE000789"></a>Le tableau ci-dessous présente les chemins conservés dans l'archive en fonction :
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) Le répertoire en cours est : "C:\\Temp" :
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Le disque n'est pas conservé dans le chemin de l'archive.
...
[&lt;Variable zipArchive&gt;.DébutAjoutFichier (Fonction)](../WDLang3/1410091280.md)

[&lt;Variable zipArchive&gt;.FinAjoutFichier (Fonction)](../WDLang3/1410091281.md)
