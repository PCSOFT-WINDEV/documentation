...
<a name="procedure_manipulant_chaque_fichier_liste_ELTPARAGRAPHE000167"></a>Pour plus de détails sur les paramètres de la procédure &lt;Procédure WLangage&gt;, consultez [Paramètres de la procédure utilisée par la fonction FTPListeFichier](../WDLang3/1000025351.md). 
...
### Délai
<a name="delai_ELTPARAGRAPHE000367"></a>Par défaut, toutes les fonctions FTP échouent si aucune réponse du serveur FTP n'est reçue après 20 secondes. Ce délai peut être modifié : 
...
<a name="permissions_requises_ELTPARAGRAPHE000406"></a>L'utilisation de cette fonction entraîne la modification des permissions requises par l'application. 
