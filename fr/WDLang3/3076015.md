...
| **telOptionMoniteur** | Détecte les appels (par exemple pour réaliser des statistiques), même s'ils sont gérés par une autre application. Aucune manipulation de l'appel ne sera possible. | [telDémarreDétectionAppel](../WDLang3/3076029.md) |
