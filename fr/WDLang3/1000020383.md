...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Cette fonction est asynchrone : il n'est pas possible de savoir si la fonction a renvoyé une erreur. 
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Ce tableau doit comporter deux éléments (position de départ et position d'arrivée). Il n'est pas possible de spécifier les différentes étapes de l'itinéraire.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) Pour gérer des fonctionnalités spécifiques concernant la gestion des itinéraires, utilisez la fonction [CarteExécuteJS](../WDLang3/1000021615.md). 
