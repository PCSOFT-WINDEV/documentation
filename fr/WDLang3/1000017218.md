...
**Remarque** : Pour éditer les événements spécifiques d'un projet : sous le volet "Accueil", dans le groupe "Général", déroulez ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_code.gif)
 et sélectionnez "Code du projet".
