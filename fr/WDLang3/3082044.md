...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003082044&name=zipouvre_fonction&product=WD">Voir des exemples supplémentaires</a>
...
### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000219"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="cas_particulier_extension_ELTPARAGRAPHE000245"></a>Ne pas confondre les fichiers '.tar.gz' générés par GitHub, et les fichiers '.gz' compressés au format gzip.
