...
<a name="proprietes_specifiques_description_des_variables_type_emailsessionimap_ELTPARAGRAPHE000044"></a>Les propriétés suivantes peuvent être utilisées pour manipuler une variable de type **emailSessionIMAP** :
...
| Option | Constante de type entier | Les valeurs possibles sont :<br><br>- *emailOptionDéfaut* (valeur par défaut) : Connexion en utilisant le protocole IMAP.<br><br>- *optionTLS* : Connexion utilisant le protocole IMAP à l'intérieur d'un tunnel TLS. Cette option garantit la confidentialité de l'échange mais elle doit être supportée par le serveur. <br>	Avant la version 28 Update 4, cette constante avait pour nom *optionSSL*.<br><br><br> |
...
<a name="fonctions_utilisant_les_variables_type_emailsessionimap_ELTPARAGRAPHE000138"></a>
