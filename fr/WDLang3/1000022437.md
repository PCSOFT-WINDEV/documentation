...
<a name="fonctionnalite_application_requise_ELTPARAGRAPHE000200"></a>L'utilisation de cette fonction entraîne la déclaration d'une fonctionnalité d'application dans l'assistant de génération de l'application.
