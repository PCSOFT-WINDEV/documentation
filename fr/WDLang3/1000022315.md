...
Envoie un email par l'intermédiaire du logiciel **Outlook** : l'email est placé dans la boîte d'envoi du logiciel de messagerie. L'envoi effectif de l'email est réalisé à partir de Outlook. Pour plus de détails, consultez [Accéder à Outlook](../WDLang3/3032137.md).

**Attention** : Avant d'envoyer l'email, il est nécessaire de :

- Ouvrir une session avec la fonction [EmailOuvreSessionOutlook](../WDLang3/3032128.md).
...
Identifie la session email en cours. Ce paramètre est un entier renvoyé par la fonction suivante [EmailOuvreSessionOutlook](../WDLang3/3032128.md).
