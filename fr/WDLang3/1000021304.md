...
| Icone | Chaîne de caractères | Chemin de l'icône représentant l'action. <br><br>A partir d'Android 7.0, cette propriété n'est plus utilisée : les icônes des actions des notifications ne sont plus affichées. |
...
### Divers
<a name="divers_ELTPARAGRAPHE000133"></a>Pour réinitialiser le contenu d'une variable de type **notificationAction**, il est possible d'utiliser la fonction [VariableRAZ](../WDLang1/3013069.md).
