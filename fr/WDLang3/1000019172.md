...
<a name="connexion_fournisseur_acces_ELTPARAGRAPHE000103"></a>![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) Avant de pouvoir gérer les emails, il est nécessaire d'ouvrir une connexion Internet. Plusieurs cas peuvent se présenter :
...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Pour se connecter au fournisseur d'accès, aucune opération spécifique ne doit être effectuée.
