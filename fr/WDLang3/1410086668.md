...
- Les options générales du Store Privé, accessibles via un menu en haut de la page. Les options générales sont disponibles via différents onglets : 
	...
	- [Utilisateurs et groupes](#NOTE3_1),

	- [Serveur OAuth 2.0](#NOTE4_1),

	- [Paramétrage SMTP](#NOTE5_1),
...
## Applications
<a name="applications_ELTTEXTE000271"></a>
...
- Les applications WINDEV peuvent être installées dans le Store Privé via le programme d'installation. 
	Pour plus de détails, consultez [Store Privé des applications WINDEV](../Editeurs/9000203.md). 

- Les sites Web peuvent être ajoutés au portail via le bouton placé à côté de "Applications" : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Baas_admin_btn.gif). Sélectionnez l'option "Nouveau lien vers un site Web". 

- Les applications mobiles peuvent être ajoutées au Store Privé via le bouton placé à côté de "Applications"  ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Baas_admin_btn.gif). Sélectionnez l'option "Nouvelle application mobile". 
...
<a name="applications_utilisant_groupware_utilisateur_ELTPARAGRAPHE000101"></a>Si l'application utilise le Groupware utilisateur via les services BaaS, de nouveaux onglets sont disponibles : 
...
<a name="utilisateurs_groupes_ELTTEXTE000301"></a>
...
Il est également possible de gérer les utilisateurs par programmation via les [fonctions d'administration du WLangage](../WDLang3/1410091358.md). Le lien "Activer les fonctions d'administration WLangage" affiche la page de mise en place des fonctions WLangage. 
...
## Serveur OAuth 2.0
<a name="serveur_oauth_20_ELTTEXTE000334"></a>
...
<a name="creation_identifiant_oauth_20_ELTPARAGRAPHE000358"></a>Pour créer un identifiant OAuth 2.0 : 
...
<a name="creation_des_apis_pour_webservice_ELTPARAGRAPHE000385"></a>Il est possible d'associer un identifiant OAuth à une API REST. L'accès à une API REST sera autorisé en indiquant un token. Seul un token valide permettra d'accéder à l'API.
...
Il suffit de fournir à l’application cliente les identifiants (ClientID et Client Secret) pour accéder à l’API via la fonction WLangage [AuthIdentifie](../WDLang3/1000022219.md).
...
## Paramétrage SMTP
<a name="parametrage_smtp_ELTTEXTE000465"></a>
...
## Options
<a name="options_ELTTEXTE000489"></a>
