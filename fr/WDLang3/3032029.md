...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/fr/WM.png) Remarque : La structure Email est utilisée par les fonctions [EmailLanceAppli](../WDLang3/1000019564.md) / [EmailOuvreMessagerie](../WDLang2/3032021.md) pour initialiser : 

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) l'application native d'envoi d'emails de l'appareil Android. 

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png) l'application native d'envoi d'emails de l'iPhone ou de l'iPad. 
...
| **Email.NbAttache** | Entier indiquant le nombre de fichiers attachés au message. Le nombre de fichiers attachés est illimité.<br><br>![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png) Non disponible. |
...
| **Email.Source** | Chaîne de caractères contenant la source du message reçu (sujet, expéditeur, destinataire, contenu, ...).<br><br>Ce membre n'est pas géré par Outlook sous Windows.<br><br>![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Non disponible. |
