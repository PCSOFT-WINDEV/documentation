...
- en cas d'erreur : 
	...
	- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) demande d'activation refusée par l'utilisateur.

	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) erreur d'accès aux Google Play Services.
