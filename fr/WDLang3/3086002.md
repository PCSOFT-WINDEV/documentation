...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_Creation_prj.gif&type=thumb)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_Creation_Coll.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_Ico_generation.gif)
...
6. Sélectionnez les éléments à intégrer dans le Webservice. Ces éléments correspondent à tout sauf ce qui correspond à l'interface (fenêtre, page, état, ...). 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_Elements_integrer.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_element_accessibles.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_dep_local.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_test_webservice.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_saisie_parametres.gif)
La page de résultat générée sera : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_test_reponse.gif)
