...
<a name="comment_mettre_disposition_webservice_soap_ELTTEXTE000348"></a>
...
<a name="creation_webservice_soap_ELTTEXTE000372"></a>
...
<a name="utilisation_une_base_donnees_hfsql_ELTPARAGRAPHE000144"></a>Une webservice SOAP peut être lié à une analyse et manipuler des fichiers de données, par exemple via des requêtes. 
...
- Pour copier simplement un enregistrement d'un fichier de données HFSQL dans une structure ou un objet, utilisez la fonction [FichierVersMémoire](../WDLang1/3013071.md). 

- Pour copier simplement le contenu d'un fichier de données HFSQL dans une structure ou un objet, utilisez la fonction [FichierVersTableau](../WDLang1/1000018833.md). 
...
<a name="generation_webservice_soap_ELTTEXTE000408"></a>
...
6. Sélectionnez les éléments à intégrer dans le Webservice. Ces éléments correspondent à tout sauf ce qui correspond à l'interface (fenêtre, page, état, etc.). <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WS_Elements_integrer.gif)
...
<a name="deployer_tester_webservice_ELTTEXTE000432"></a>


### Déployer un Webservice
<a name="deployer_webservice_ELTPARAGRAPHE000231"></a>Pour être utilisable, un Webservice doit être déployé sur un Serveur d'Application WEBDEV.
