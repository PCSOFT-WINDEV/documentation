...
### Messagerie Outlook
<a name="messagerie_outlook_ELTPARAGRAPHE000358"></a>Les fonctions WLangage **EmailLitxxx** fonctionnent uniquement avec le fichier de données Outlook (.pst) par défaut. Les autres fichiers de données ne sont pas gérés.
