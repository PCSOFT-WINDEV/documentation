...
`<Résultat> = FTPFichierExiste(<Identifiant de la connexion> , <Nom du fichier>)`
---
...
### Cas particulier
<a name="cas_particulier_ELTPARAGRAPHE000063"></a>L'élément courant n'est pas modifié.
<a name="NOTE0_2"></a>


### Délai
<a name="delai_ELTPARAGRAPHE000070"></a>Par défaut, toutes les fonctions FTP échouent si aucune réponse du serveur FTP n'est reçue après 20 secondes. Ce délai peut être modifié lors de la connexion au serveur FTP avec la fonction [FTPConnecte](../WDLang3/3040016.md).
<a name="NOTE0_3"></a>
...
<a name="chemin_relatif_absolu_ELTPARAGRAPHE000089"></a>Les notions de chemin relatif et de chemin absolu sont très importantes dans une application FTP.
