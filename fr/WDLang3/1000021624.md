...
Nom de la procédure WLangage appelée lors de la réponse du serveur HTTP. Pour plus de détails, consultez [Paramètres de la procédure utilisée par la fonction &lt;Variable httpRequête&gt;.Envoie](../WDLang3/1000025791.md).
...
### Notes
<a name="notes_ELTPARAGRAPHE000203"></a>
...
<a name="erreur_securite_dans_une_transaction_securisee_ELTPARAGRAPHE000253"></a>Lors d'une transaction sécurisée, certaines erreurs de sécurité peuvent faire échouer la requête :
...
<a name="permissions_requises_ELTPARAGRAPHE000387"></a>L'utilisation de cette fonction entraîne la modification des permissions requises par l'application.
