...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Si la fonction est exécutée par le thread principal de l'application, un sablier (jauge infinie) sera affiché durant la détection des point d'accès. Pour spécifier le message à afficher dans le sablier, utilisez la fonction [TitreSuivant](../WDLang1/3038043.md) juste avant l'appel à la fonction **WiFiDétectePointAccès**.
