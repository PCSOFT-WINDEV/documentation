...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) soit par l'intermédiaire du client **MS Exchange** : l'email est placé dans la boîte d'envoi de MS Exchange. Pour envoyer réellement l'email, utilisez la fonction [EmailMiseAJour](../WDLang3/3032036.md). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) soit par l'intermédiaire du logiciel **Lotus Notes** : l'email est placé dans la boîte d'envoi du logiciel de messagerie. L'email est automatiquement envoyé par le spooler de Domino. 
	Attention : Lotus Notes doit être installé en mode connecté et non en mode local.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) soit par l'intermédiaire du logiciel **Outlook** : l'email est placé dans la boîte d'envoi du logiciel de messagerie. L'envoi effectif de l'email est réalisé à partir de Outlook. Pour plus de détails, consultez [Accéder à Outlook](../WDLang3/3032137.md).
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Dans cette version, il est possible d'envoyer un email uniquement en utilisant le protocole SMTP.![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Dans cette version, il est possible d'envoyer un email uniquement en utilisant le protocole SMTP. Avant d'envoyer cet email, il n'est pas nécessaire d'ouvrir une session avec la fonction [EmailOuvreSession](../WDLang3/3032028.md). Pour que l'envoi de l'email soit effectif, il faut que le serveur SMTP à utiliser soit fourni au moteur PHP. Il faut l'indiquer dans l'entrée "SMTP =" du fichier PHP.INI.
...
```
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) **Envoi d'un message depuis un site WEBDEV PHP**
