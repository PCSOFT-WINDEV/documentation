...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) emails gérés par l'intermédiaire du client MS Exchange (Outlook) : la fonction **EmailFermeSession** permet de fermer la session MS Exchange. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png) emails gérés avec Lotus Notes : la fonction **EmailFermeSession** permet de fermer une session avec le logiciel de messagerie Lotus Notes. 
...
![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Seules les sessions POP3/SMTP sont gérées.
