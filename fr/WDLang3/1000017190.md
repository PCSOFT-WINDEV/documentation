...
FIN
```
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Les erreurs concernant la sécurité des transactions ne sont pas retournées par la fonction [ErreurInfo](../WDLang1/3013008.md) (la connexion est simplement refusée). Ces erreurs ne peuvent pas être ignorées. La variable HTTP.IgnoreErreur n'est pas disponible.
<a name="NOTE0_2"></a>
