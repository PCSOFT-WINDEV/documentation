...
## Exemple
<a class="notetitle" target="_blank" href="$DOC$=1000003040010&name=ftpsupprimefichier_fonction&product=WD">Voir des exemples supplémentaires</a>
...
`<Résultat> = FTPSupprimeFichier(<Identifiant de la connexion> , <Fichier à supprimer>)`
---
...
### Délai
<a name="delai_ELTPARAGRAPHE000077"></a>Par défaut, toutes les fonctions FTP échouent si aucune réponse du serveur FTP n'est reçue après 20 secondes. Ce délai peut être modifié lors de la connexion au serveur FTP avec la fonction [FTPConnecte](../WDLang3/3040016.md).
...
<a name="droits_des_utilisateurs_ELTPARAGRAPHE000108"></a>La manipulation des fichiers ou répertoires présents sur un serveur FTP n'est possible que pour un utilisateur ayant les droits en écriture sur le serveur FTP. En règle générale, les utilisateurs "anonymes" n'ont pas les droits en écriture.
...
<a name="chemin_relatif_absolu_ELTPARAGRAPHE000117"></a>Les notions de chemin relatif et de chemin absolu sont très importantes dans une application FTP.
