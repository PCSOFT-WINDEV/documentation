...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce paramètre est de type Variant et correspond à l'identifiant de la connexion ou -1 en cas d'erreur.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Ce paramètre permet de définir le protocole utilisé : 
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) pour une connexion sécurisée en mode FTPS, ce port est le port 990. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) pour une connexion sécurisée en mode FTPES, ce port est le port 21.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) pour une connexion sécurisée en mode SFTP, ce port est le port 22.
...
![PHP](https://doc.pcsoft.fr/ext/images/fr/PHP.png) Ce paramètre correspond à un entier.

**`<Clé privée> : (Chaîne de caractères optionnelle)`**

![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Nom et chemin du fichier correspondant à la clé privée utilisée lors d'une connexion en mode SFTP. Ce fichier doit avoir été généré au format OpenSSH. 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Mot de passe du fichier contenant la clé privé utilisée lors d'une connexion en mode SFTP.
...
## Remarques
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![WEBDEV - Code Serveur](https://doc.pcsoft.fr/ext/images/fr/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png) 

### Erreur de sécurité dans une connexion sécurisée de type FTPS (syntaxe 2)
<a name="erreur_securite_dans_une_connexion_securisee_type_ftps_syntaxe_2_ELTPARAGRAPHE000304"></a>Lors d'une connexion sécurisée, certaines erreurs de sécurité peuvent faire échouer la fonction :
...
<a name="permissions_requises_ELTPARAGRAPHE000559"></a>L'utilisation de cette fonction entraîne la modification des permissions requises par l'application. 
...
<a name="configuration_necessaire_ELTPARAGRAPHE000359"></a>En PHP, il est nécessaire d'activer le module ftp. 
