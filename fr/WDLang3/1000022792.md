...
<a name="creation_projet_type_webservice_rest_ELTPARAGRAPHE000097"></a>Pour créer un projet de type Webservice REST :
...
<a name="creation_une_configuration_projet_type_webservice_rest_ELTPARAGRAPHE000112"></a>Pour créer une configuration de projet de type Webservice REST :
...
L'assistant de création d'un point d'entrée propose de sélectionner la méthode de création des points d'entrée : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WebService_Rest_fichier%20-%20HC%20N%B0001.gif)


- [Méthode 1 : Création manuelle des points d'entrée](../WDLang3/1410091004.md). 

- [Méthode 2 : Création automatique des points d'entrée à partir de la description d'un fichier de données (présent dans l'analyse)](../WDLang3/1410091004.md).
