...
![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Récupère uniquement l'état d'activation du fournisseur de géolocalisation.
<a name="Exemple1"></a>
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Pour ne plus recevoir de notification de changement d'état, utilisez la fonction **GPSEtat** en lui passant une chaîne vide ("") en paramètre ou utilisez la fonction [GPSTermine](../WDLang3/1000019210.md).
