...
![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/fr/CATALYST.png) Ce paramètre n'est pas pris en compte.

**`<Options> : (Combinaison optionnelle de constantes de type Entier)`**

Critères de sélection du fournisseur de localisation. 

![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Ce paramètre est utilisé si le paramètre &lt;Fournisseur recherché&gt; correspond à la constante *gpsAuto*. Dans les autres cas, le paramètre &lt;Options&gt; est ignoré.
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Il est possible de connaître l'état de disponibilité de fournisseur de géolocalisation grâce à la fonction [GPSEtat](../WDLang3/1000019207.md).

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Pour connaître les caractéristiques du fournisseur de localisation initialisé par la fonction **GPSInitParamètre**, utilisez la fonction [GPSInfo](../WDLang3/1000019208.md).
