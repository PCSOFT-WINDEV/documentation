...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) &lt;Reçu&gt; n'est pas disponible. Pour valider un achat, il faut utiliser la fonction [inAppListeAchat](../WDLang3/1000020888.md) et vérifier que l'achat se trouve bien dans la liste.

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) &lt;Reçu&gt; est une chaîne de caractères correspondant à l'identifiant de l'achat. Cet identifiant peut ensuite être utilisé pour la consommation du produit acheté (fonction [inAppConsommeProduit](../WDLang3/1000020880.md)).
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Dans le cas d'un abonnement, ce paramètre vaut toujours 1.

- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Ce paramètre vaut toujours 1.
