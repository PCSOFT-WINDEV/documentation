...
<a name="communication_avec_des_automates_des_applications_non_windev_ELTPARAGRAPHE000170"></a>Pour simplifier les échanges des données par socket, un mode de transmission est initialisé par défaut. 
