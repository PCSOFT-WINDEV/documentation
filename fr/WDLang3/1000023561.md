...
<a name="proprietes_specifiques_description_des_variables_type_openidparametres_ELTPARAGRAPHE000036"></a>Les propriétés suivantes peuvent être utilisées pour manipuler les paramètres d'une authentification pour OpenID :
...
<a name="propriete_urlconfiguration_ELTPARAGRAPHE000186"></a>La propriété **URLConfiguration** correspond à une URL contenant la description du service OpenID. Cette description est de la forme (par exemple pour Google) : 
