...
## Mise en place
<a name="mise_place_ELTTEXTE000154"></a>
Le WLangage propose une famille de fonctions et 2 types spécifiques pour gérer les balises Beacon. 

![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) Attention : La gestion des balises Beacon utilise sous Android le module Android Beacon Library, soumis à licence. Veuillez vous conformer à cette licence, disponible dans la licence de WINDEV Mobile.  
