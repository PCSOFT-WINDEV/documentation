...
| Altitude | Entier | Altitude de l'image par rapport aux autres formes présentes dans le champ Carte. Permet de gérer les superpositions. <br><br>Une forme avec une altitude élevée sera dessiné par-dessus une forme avec une altitude inférieure. <br><br>Par défaut, cette propriété vaut 0. <br><br>![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Cette propriété n'est pas disponible. |
