...
Une assertion JWT est constitué de trois parties séparées par des points (.).
...
Nom de la variable [Certificat](../WDLang1/1000019287.md) à utiliser pour la signature de l'assertion JWT. Ce certificat est utilisé notamment pour le cryptage de type RS256.
...
Pour utiliser l'assertion JWT créée, il faut spécifier les éléments suivants dans la variable de type [OAuth2Paramètres](../WDLang3/1000022212.md) : 
...
Remarque : Selon les informations attendues par le serveur d'authentification, les propriétés **ClientSercret** et **ClientID** de la variable de type [OAuth2Paramètres](../WDLang3/1000022212.md) doivent être précisés même en utilisant un assertion JWT. 
...
[gpwOAuthParamètres (Type de variable)](../WDLang3/1000024751.md)
