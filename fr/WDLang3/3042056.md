...
### Affichage du titre
<a name="affichage_titre_ELTPARAGRAPHE000167"></a>Les modifications réalisées avec la fonction **grTitre** seront prises en compte lors du prochain appel à la fonction [grDessine](../WDLang3/3042026.md).
<a name="NOTE0_2"></a>


### Positionnement manuel du titre : grTitre sans effet
<a name="positionnement_manuel_titre_docparampagetitleshort_sans_effet_ELTPARAGRAPHE000182"></a>Si le titre du graphe est positionné manuellement (option "Positionnement manuel" dans la fenêtre du titre du graphe), la fonction **grTitre** n'a plus d'effet.
<a name="NOTE0_3"></a>


### Langues utilisant un alphabet non latin
<a name="langues_utilisant_alphabet_non_latin_ELTPARAGRAPHE000201"></a>La fonction **grTitre** utilisera l'alphabet non latin sélectionné uniquement si la configuration du projet associée utilise des chaînes UNICODE en exécution.
