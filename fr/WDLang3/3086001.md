...
- [Comment importer un Webservice SOAP dans un projet](#NOTE2_1). 

- [Comment mettre à jour la description d'un Webservice SOAP dans un projet](#NOTE3_1). 

- [Comment utiliser un Webservice SOAP dans un projet](#NOTE4_1). 

- [Comment distribuer une application WINDEV qui utilise un Webservice SOAP](#NOTE5_1).
...
<a name="importer_webservice_soap_dans_projet_ELTTEXTE000547"></a>


### Importation
<a name="importation_ELTPARAGRAPHE000059"></a>Pour importer un Webservice SOAP :

1. Sous le volet "Projet", dans le groupe "Projet", déroulez "Importer" et sélectionnez "Un Webservice". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Importer_un_service_Web_XML%20-%20HC%20N%B0001.gif&type=thumb)
...
3. Indiquez la localisation du WSDL (prononcer wizdeul). Ce fichier correspond à la description du webservice. Il contient la description de chaque fonction contenue dans le Webservice ainsi que leurs paramètres. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Importer_un_service_Web_XML%20-%20HC%20N%B0002.gif)
...
4. Terminez l'assistant. Un message apparaît indiquant que l'importation est terminée. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Importer_un_service_Web_XML%20-%20HC%20N%B0003.gif&type=thumb)
...
<a name="volet_explorateur_projet_visualiser_webservice_ELTPARAGRAPHE000099"></a>Le Webservice importé est présent dans le volet "Explorateur de projet", dossier "Webservices importés" : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Importer_un_service_Web_XML%20-%20HC%20N%B0004.gif)
...
<a name="description_proprietes_webservice_soap_ELTTEXTE000586"></a>


### Mettre à jour la description d'un Webservice
<a name="mettre_jour_description_webservice_ELTPARAGRAPHE000122"></a>Lorsqu'un Webservice évolue (corrections, nouvelles versions, etc.), sa description peut également être amenée à évoluer.
...
<a name="proprietes_webservice_modifiables_dans_editeur_ELTPARAGRAPHE000136"></a>Pour modifier les propriétés d'un Webservice dans l'éditeur :
...
<a name="utilisation_webservice_soap_ELTTEXTE000616"></a>


### Principe
<a name="principe_ELTPARAGRAPHE000152"></a>Pour utiliser un Webservice, il faut : 
...
**Remarque** : Du côté serveur, il est possible de récupérer l'entête utilisant la fonction [WebserviceLitEntêteHTTP](../WDLang3/1000022787.md). 
...
<a name="appel_asynchrone_webservice_soap_ELTPARAGRAPHE000199"></a>Dans certains cas, le temps d'exécution de la demande au Webservice peut être long et bloquant. Il peut être nécessaire de faire un appel asynchrone au Webservice, en utilisant la syntaxe suivante : 
...
<a name="proprietes_associees_webservice_soap_ELTPARAGRAPHE000220"></a>Pour manipuler un Webservice SOAP par programmation, il suffit d'utiliser le nom du Webservice (présent dans le volet "Explorateur de projet"). 
...
<a name="proprietes_disponibles_sur_les_types_variables_ELTPARAGRAPHE000357"></a>Les types de variables déclarés automatiquement lors de l'importation du WSDL offrent un certain nombre de propriétés :
...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/fr/JAVA.png) Il n'est pas possible d'utiliser une méthode gérant un contexte partagé.
<a name="NOTE4_4"></a>


### Manipulation avancée du flux XML du Webservice
<a name="manipulation_avancee_flux_xml_webservice_ELTPARAGRAPHE000417"></a>Dans certains cas, il est nécessaire de manipuler précisément le flux de données XML échangé avec le Webservice. Certains Webservices demandent par exemple d'ajouter des entêtes dans leur flux XML pour permettre l'authentification ou retournent des meta informations dans les entêtes de la réponse.
...
<a name="cas_particulier_webservice_renvoie_resultat_dans_type_non_reconnu_par_windev_webdev_windev_mobile_ELTPARAGRAPHE000447"></a>Les types de variables disponibles dans WINDEV et ceux disponibles dans un Webservice de type SOAP peuvent être différents.
...
<a name="distribuer_une_application_windev_qui_utilise_webservice_soap_ELTTEXTE000696"></a>
