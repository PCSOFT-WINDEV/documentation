...
<a name="structure_email_les_variables_type_email_ELTPARAGRAPHE000224"></a>Deux méthodes de manipulation des emails sont disponibles :
...
### Messagerie Outlook
<a name="messagerie_outlook_ELTPARAGRAPHE000365"></a>Les fonctions WLangage **EmailLitxxx** fonctionnent uniquement avec le fichier de données Outlook (.pst) par défaut. Les autres fichiers de données ne sont pas gérés.
