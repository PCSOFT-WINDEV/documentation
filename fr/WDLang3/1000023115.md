...
<a name="bluetooth_low_energy_ELTPARAGRAPHE000101"></a>L'appareil doit supporter la technologie Bluetooth Low Energy (Bluetooth LE).
<a name="NOTE0_4"></a>
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) 

### Permissions requises
<a name="permissions_requises_ELTPARAGRAPHE000110"></a>L'utilisation de cette fonction entraîne la modification des permissions requises par l'application.
