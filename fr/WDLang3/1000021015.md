...
![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) **Notifications push Android sur un sujet spécifique (via abonnement)** : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Une configuration spécifique doit être réalisée via la console Firebase. Pour plus de détails, consultez [Configuration Android (Firebase)](../WDLang3/1000022215.md). 

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Une configuration spécifique doit être réalisée. Pour plus de détails, consultez [Configuration iOS](../WDLang3/1000021032.md).  
...
2. **Si l'application est déjà lancée** :
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png) Si un message ou un titre est spécifié dans la notification, le système affiche la notification dans la barre de notification. Si l'utilisateur clique sur la notification, la procédure spécifiée dans la fonction [NotifPushProcédure](../WDLang3/1000020818.md) est alors appelée (si elle n'est pas spécifiée, rien ne se passe). 
	...
	- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png) Deux cas peuvent se présenter : 
...
- ![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png) via la fonction [NotifPushEnvoieAbonné](../WDLang3/1410089872.md). Les notifications sont envoyées à tous les téléphones abonnés à un sujet donné. 
