...
<a name="condition_utilisation_ELTPARAGRAPHE000446"></a>L'ajout de fichiers dans une archive ne peut être réalisé que si :
...
<a name="niveau_compression_des_archives_zip_7z_ELTPARAGRAPHE000525"></a>Par défaut, les fichiers ajoutés dans une archive au format ZIP ou 7z sont compressés. Il est possible de modifier le niveau de compression des fichiers ajoutés dans une archive grâce à la fonction [zipNiveauCompression](../WDLang3/3082054.md).
<a name="NOTE0_3"></a>


### Codes d'erreur
<a name="codes_erreur_ELTPARAGRAPHE000537"></a>Les codes d'erreur retournés sont les suivants :
...
<a name="indice_des_fichiers_dans_archive_ELTPARAGRAPHE000572"></a>Lors de l'ajout d'un fichier dans une archive, un indice est automatiquement attribué au fichier. Cet indice correspond à l'ordre d'intégration des fichiers dans l'archive. Pour sélectionner un fichier de l'archive, il est possible d'utiliser :
...
<a name="chemin_conserve_archives_format_wdz_zip_ELTPARAGRAPHE000587"></a>Le tableau ci-dessous présente les chemins conservés dans l'archive en fonction :
