...
- le nom d'utilisateur passé à l'une des fonctions suivantes : 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) [EmailOuvreSessionOutlook](../WDLang3/3032128.md),

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) [EmailOuvreSessionNotes](../WDLang3/1000018768.md).
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/fr/WD.png) une variable de type [emailSessionNotes](../WDLang3/1000018768.md).
...
<a name="recuperation_des_messages_ELTPARAGRAPHE000187"></a>Pour récupérer la totalité des messages ainsi que leurs pièces jointes, il est préférable d'employer la constante *ertComplet* pour minimiser le nombre d'appels au serveur.
...
<a name="consommation_memoire_ELTPARAGRAPHE000234"></a>La récupération des emails est faite en mémoire. Si la boite de réception contient de nombreux messages ou des pièces jointes de taille importante, la lecture peut consommer une grande quantité de mémoire.
...
### Gestion de la jauge
<a name="gestion_jauge_ELTPARAGRAPHE000243"></a>Pour connaître l'état d'avancement de la récupération, il est nécessaire de fixer une jauge ou une procédure à l'aide de la fonction [EmailJauge](../WDLang3/3032017.md).
