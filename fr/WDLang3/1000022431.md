...
- ![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette fonction ne doit pas être appelée dans le même traitement que celui utilisé pour l'affichage de l'itinéraire. En effet, le calcul est asynchrone. Cette fonction doit être appelée lorsque l'itinéraire est affiché (par exemple dans le code d'un bouton de calcul). 
