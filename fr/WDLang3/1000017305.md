...
| *emailAdresseRefusée* | L'adresse a été refusée par le serveur de mails. La fonction [ErreurInfo](../WDLang1/3013008.md) permet d'obtenir la cause du refus.<br><br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png) Cette constante n'est pas disponible. |
...
|   |   |
| --- | --- |
| *emailValideParServeur* | Vérifie que le serveur d'emails SMTP du domaine auquel appartient l'adresse accepte l'adresse en entrée. La vérification de la syntaxe de l'adresse email est automatiquement effectuée (constante *emailValideSyntaxe*).<br>![WEBDEV - Code Navigateur](https://doc.pcsoft.fr/ext/images/fr/WBN.png)![Linux](https://doc.pcsoft.fr/ext/images/fr/LX.png)![Android](https://doc.pcsoft.fr/ext/images/fr/ANDROID.png)![Widget Android](https://doc.pcsoft.fr/ext/images/fr/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/fr/IPHONE.png)![Widget IOS](https://doc.pcsoft.fr/ext/images/fr/WIDGETIOS.png) Cette constante n'est pas disponible. |
