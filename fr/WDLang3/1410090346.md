...
- [Configuration Google Drive](#NOTE2_1).

- [Configuration Dropbox](#NOTE3_1).
...
<a name="configuration_google_drive_ELTTEXTE000220"></a>
...
<a name="configuration_dropbox_ELTTEXTE000244"></a>
...
6. Conservez l'ID d'application (client). Cet identifiant sera utilisé lors de la connexion au drive (propriété **ClientID** de la variable [OAuth2Paramètres](../WDLang3/1000022212.md)).  
...
10. Copiez la valeur et l'ID de secret (Attention : ces informations ne peuvent être copiées qu'une seule fois).
	Cet identifiant sera utilisé lors de la connexion au drive (propriété **ClientSecret** de la variable [OAuth2Paramètres](../WDLang3/1000022212.md)).
