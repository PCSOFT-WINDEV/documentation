...
<a name="utilisation_wdtestrest_ELTTEXTE000194"></a>
...
### Historique
<a name="historique_ELTPARAGRAPHE000118"></a>À chaque envoi d'une requête HTTP, WDTestRest mémorise le paramétrage complet (URL, paramètres, entêtes, contenu, etc.) dans un historique.
