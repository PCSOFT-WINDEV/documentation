...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=BriqueCode_Menu.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=BriqueCode_Description.gif)
...
- Lors de la saisie du raccourci correspondant à une brique de code, la saisie assistée propose la brique de code correspondante. Il suffit de la sélectionner et de valider pour l'intégrer au code en cours. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=BriqueCode_Code.gif)
