...
<a name="parametrage_des_regles_reecriture_une_page_ELTPARAGRAPHE000070"></a>Pour chaque page dont l'URL doit être réécrite, la fenêtre d'options propose les informations suivantes : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=URLRewriting_page.gif)
