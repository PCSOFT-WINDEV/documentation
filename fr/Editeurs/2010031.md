...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code_Surbrillance_Element.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code_Surbrillance_bloc.gif)


Remarque : Le survol des mots-clés secondaires (SINON, FIN, ...) affiche la condition associée dans une bulle. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code_BulleSi.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code_surlignage_ligne.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code_Recherche_Selection.gif)
Les touches F3 et Shift F3 permettent de naviguer d'occurrence en occurrence directement par le clavier.  
...
1. Sous le volet "Code", dans le groupe "Navigation", saisissez les lettres permettant de retrouver l'événement voulu. 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code_Recherche_Traitement.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code_Selection_rectangle.gif)
**Remarque** : Lorsque la zone est collée vers une zone rectangulaire, le texte copié s'insère également en rectangle. 

![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Code_Selection_rectangle_2.gif)
