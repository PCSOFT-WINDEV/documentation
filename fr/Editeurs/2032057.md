...
Par exemple, la cliente N° 45762 s'est mariée. Sa civilité et son nom de famille ont été modifiés. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Requete_RequeteModification.gif)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png) | Important | [Le logiciel Etats & Requêtes](../Presentation/3088004.md) ne permet pas de créer des requêtes de modification. |
