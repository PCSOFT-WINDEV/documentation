...
2. Préparation des pages WEBDEV à afficher dans l'application WINDEV : création d'un agencement spécifique. 
	...
	- Sous le volet "Page", dans le groupe "Agencements", déroulez "Agencements" et sélectionnez "Ajouter un agencement pour intégration dans WINDEV". <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WB_dans_WD%20-%20HC%20N%B0002.gif&type=thumb)
...
- Dans le site WW_IntégrationWBdansWD_AvecInterface, la page PAGE_CarnetEntretien contient un agencement WINDEV. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WB_dans_WD%20-%20HC%20N%B0001.gif&type=thumb)
...
- En exécution, l'agencement pour WINDEV de la page WEBDEV est affiché dans l'application WINDEV. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=WB_dans_WD%20-%20HC%20N%B0003.gif&type=thumb)
