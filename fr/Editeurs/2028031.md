...
<a name="fichiers_installer_ELTTEXTE000297"></a>
...
## Framework WINDEV
<a name="framework_windev_ELTTEXTE000333"></a>
...
<a name="telechargement_framework_ELTPARAGRAPHE000085"></a>L'option "Télécharger le Framework WINDEV sur le site de PC SOFT" permet de créer une installation de taille réduite.
...
Le programme d'installation utilisera la connexion Internet du poste en cours et la fenêtre suivante sera affichée : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Install_Framework.gif)


A chaque lancement de l'exécutable, tous les fichiers du framework WINDEV seront alors automatiquement chargés sur le site PC SOFT. La version du framework téléchargé correspondra à la version de WINDEV avec laquelle l'exécutable a été créé.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Install_Framework2.gif)
...
<a name="emplacement_framework_ELTPARAGRAPHE000102"></a>Par défaut, le Framework commun est installé dans le répertoire "&lt;Répertoire d'installation des éléments communs à plusieurs applications&gt;\\PC SOFT\\&lt;Version de WINDEV&gt;\\Framework",
...
<a name="proprietes_des_fichiers_installer_ELTTEXTE000369"></a>


### Onglet "Chemin"
<a name="onglet_chemin_ELTPARAGRAPHE000123"></a>Cet onglet permet de spécifier :
...
### Onglet "Raccourcis"
<a name="onglet_raccourcis_ELTPARAGRAPHE000142"></a>Cet onglet permet de créer pour le fichier sélectionné :
...
### Onglet "Version"
<a name="onglet_version_ELTPARAGRAPHE000176"></a>Par défaut, lors de la mise à jour d'une application, si des fichiers de même nom existent déjà dans le répertoire d'installation, ces fichiers sont remplacés (même si les fichiers remplacés sont plus récents que les fichiers installés). Aucune fenêtre d'avertissement ne s'affiche pour confirmer ces remplacements.
...
### Onglet "Options"
<a name="onglet_options_ELTPARAGRAPHE000190"></a>Cet onglet permet de définir les options d'installation et de compactage des fichiers ainsi que le groupe auquel le fichier est associé.
...
<a name="onglet_hfsql_uniquement_pour_les_executables_les_fichiers_donnees_ELTPARAGRAPHE000206"></a>Cet onglet permet de :
...
<a name="onglet_framework_uniquement_pour_les_executables_ELTPARAGRAPHE000218"></a>Cet onglet permet de préciser le mode d'utilisation du framework. Les informations affichées dans cet onglet ne sont pas modifiables et dépendent des informations indiquées dans l'écran de l'assistant. Les différentes possibilités sont les suivantes :
