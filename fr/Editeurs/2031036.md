...
Exemple de fenêtre Fiche pour le Pattern RAD Simple : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Pattern_RAD_WMFiche.gif)
...
Exemple de fenêtre Fiche pour le Pattern RAD Simple Smartphone : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Pattern_RAD_WMFiche_smart.gif)
...
8. Les options de menu doivent porter des noms spécifiques :![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Pattern_RAD_MenuFiche_smart.gif)
