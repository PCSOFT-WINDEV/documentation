...
**Exemple** : Fenêtre de relation dans le pattern RAD Simple : <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Pattern_RAD_WMRelation.gif)
...
1. Modifiez le menu présent dans la fenêtre :
	...
	- une option de menu doit permettre de fermer la fenêtre. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Pattern_RAD_WMRelation_Smar.gif)
