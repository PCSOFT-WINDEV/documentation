...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Proc_Auto%20-%20HC%20N%B0001.gif)
...
- Nombre de fois : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Timer_Comment.gif)
...
- Quand : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Timer_Quand.gif&type=thumb)
La procédure peut être exécutée :
...
- Nombre de fois : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Thread_Comment.gif)
La procédure peut :
...
- Quand : 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Thread_Quand.gif&type=thumb)
La procédure peut être exécutée :
...
<a name="cas_thread_principal_ELTPARAGRAPHE000195"></a>Cette option permet d'appeler une procédure dans le thread principal à partir d'un thread secondaire. Cette option est notamment utilisée pour accéder à l'UI. 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Proc_Auto%20-%20HC%20N%B0004.gif&type=thumb)
