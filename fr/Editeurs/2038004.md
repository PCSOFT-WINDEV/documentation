...
2. Déroulez ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_ouvrir.gif) parmi les boutons d'accès rapide et sélectionnez "Ouvrir un projet depuis le GDS". 
...
- **Extraire/Réintégrer automatiquement le projet** :
	...
	- Le fichier projet est extrait uniquement si l'action réalisée le nécessite. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Int%E9gration%20dans%20le%20GDS%20-%20HC%20N%B0007.gif)
