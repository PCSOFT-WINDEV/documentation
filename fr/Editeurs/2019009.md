...
1. Sous le volet "Projet", dans le groupe "Mode test", déroulez "Mode test" et sélectionnez "Déboguer le projet". 
	Vous pouvez également cliquer sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_GO_Projet_WB_bl.gif)
 parmi les boutons d'accès rapide ou utiliser le raccourci Ctrl + F9.
...
<a name="arreter_test_projet_ELTPARAGRAPHE000084"></a>Pour arrêter le test, plusieurs méthodes sont possibles :
...
<a name="les_differents_modules_lances_automatiquement_lors_test_site_webdev_mode_sessionawp_ELTPARAGRAPHE000096"></a>Les modules suivants sont automatiquement lancés lors d'un test :
...
### Navigateur de test
<a name="navigateur_test_ELTPARAGRAPHE000120"></a>Pour sélectionner le navigateur de test : 
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GO_Projet_WB_deroule.gif)

<a name="NOTE3_2b"></a>


### Tester un site depuis un téléphone
<a name="tester_site_depuis_telephone_ELTPARAGRAPHE000167"></a>Un site WEBDEV peut être testé directement sur un téléphone. Il est ainsi possible de tester le comportement du site selon la taille de l'écran. 
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P8_Agencement_simple_1%20-%20HC%20N%B0016.jpg)
...
<a name="repertoire_des_fichiers_donnees_utiliser_test_ELTPARAGRAPHE000210"></a>Pour paramétrer les fichiers de données utilisés lors du test du site sous l'éditeur :
...
<a name="verification_environnement_execution_avant_test_ELTPARAGRAPHE000237"></a>Avant de lancer un test de projet, WEBDEV vérifie que l'environnement de test est correctement configuré.

Si un problème est détecté, WEBDEV propose d'afficher la fenêtre de diagnostic : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wb_verifconfig.gif)
...
La fenêtre de diagnostic détaillé se présente de la façon suivante : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=wb_verifconfig_detail.gif)
