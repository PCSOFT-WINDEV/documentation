...
- ![Windows](https://doc.pcsoft.fr/ext/images/fr/WINDOWS.png) le type d'exécutable à générer : exécutable avec fenêtres ou exécutable console. 
...
- la création d'un projet de type Windows ou Linux, le projet créé par défaut est un projet 64 bits qui utilise des chaines Unicode. Pour changer ces options, ou pour proposer une application 32 bits, modifiez la configuration de projet créée ou créez une nouvelle configuration de projet. Un même projet peut être associé à plusieurs configurations de projet. Pour plus de détails, consultez [Configuration de projet](../Editeurs/9000030.md).  
...
<a name="fichier_projet_ELTPARAGRAPHE000112"></a>Le projet correspond à un fichier ".WDP" en WINDEV. Ce fichier contient :
...
<a name="creer_projet_base_sur_exemple_ELTPARAGRAPHE000134"></a>La création d'un projet à partir d'un exemple permet de créer un nouveau projet en ayant déjà toutes les fenêtres, états, codes de l'exemple de base. Il suffit juste de personnaliser l'exemple selon vos besoins. 
