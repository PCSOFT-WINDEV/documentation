...
2. Utilisez le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_synchro_explorateur.gif)
 pour afficher dans le volet "Explorateur de projet" l'élément actuellement affiché sous l'éditeur. Le détail des variables disponibles à partir de la fenêtre ou de la page est affiché dans le volet "Explorateur de projet".
