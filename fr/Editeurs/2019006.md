...
<a name="tester_page_statique_cours_ELTPARAGRAPHE000020"></a>Pour tester la page statique en cours depuis l'éditeur, cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_Go_Page_bl.gif)
 parmi les boutons d'accès rapide (ou F9). L'éditeur est automatiquement réduit en icône et la page s'affiche dans le navigateur par défaut.
