...
### Installation 
<a name="installation_ELTPARAGRAPHE000046"></a>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GestionnaireDeSources1.gif)
...
### Utilisation
<a name="utilisation_ELTPARAGRAPHE000056"></a>Pour travailler sur un élément du projet (fenêtre, page, ...), le développeur doit extraire l'élément de la base de sources, le modifier, puis le réintégrer.
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=GestionnaireDeSources_synch.gif)
