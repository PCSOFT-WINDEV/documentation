...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png) | Important | Rappel : Le logiciel Etats & Requêtes ne permet pas de créer : des requêtes d'insertion, des requêtes de modification, des requêtes de suppression. |
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png) | Important | Les requêtes créées avec le logiciel Etats & Requêtes pourront être exécutés depuis une application WINDEV uniquement si cette application gère les requêtes créées avec le logiciel Etats & Requêtes. |
