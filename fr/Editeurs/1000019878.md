...
3. Ouvrez le dossier sur le MAC et ouvrez le fichier nommé "Nom_du_projet.xcodeproj".![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_selection_projet_xCode1.gif)
...
Il est possible de choisir le mode de signature "manuel" en décochant l'option "Automatically manage signing". ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=XCode_signature2.gif)
...
1. Dans la liste déroulante en haut à gauche, sélectionnez les options de compilation. Sélectionnez le scheme correspondant à votre application puis la cible de compilation (appareil actuellement connecté ou un simulateur). 
	...
	![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_Choix_cible1.gif)
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_selection_cible1.gif)


2. Pour lancer la compilation, cliquez sur l'option de menu "Product .. Clean" puis sur l'option de menu "Product .. Build". ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_compilation_build.gif)


3. Un compte-rendu de compilation apparaît en haut ("Succeeded" ou sinon le nombre de warnings et d'erreurs). Vous pouvez cliquer sur ces symboles pour voir la liste des erreurs/warnings.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_resultat_Compilation.gif)


4. Une fois le programme compilé sans erreurs, vous pouvez lancer la simulation (Option "Product .. Run"). La fenêtre de simulation apparaît avec l'application.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IOS_simulation_iPhone.gif)
