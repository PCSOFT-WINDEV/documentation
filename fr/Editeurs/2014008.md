...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=versionning_1.gif&type=thumb)
...
- ***Premier cas*** : Les applications en clientèle utilisent le composant (fichier .WDK) dans une version inférieure à 1.00C. Une erreur surviendra au chargement de ces applications.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=AppC_CompoA_MarchePascopier.jpg)
