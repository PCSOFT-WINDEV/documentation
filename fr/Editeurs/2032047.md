...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Requete_RequeteSuppression.gif)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png)<br> | Important | [Le logiciel Etats & Requêtes](../Presentation/3088004.md) ne permet pas de créer des requêtes de suppression. |
