...
- ***si la mise à jour est obligatoire*** : Les utilisateurs devront installer cette mise à jour. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FenMiseAJourOblig.gif)


- ***si la mise à jour n'est pas obligatoire*** : Les utilisateurs pourront au choix installer la mise à jour ou lancer directement l'application. Cette mise à jour leur sera proposée aux prochains lancements de l'application.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=FenMiseAJour.gif)
...
- les utilisateurs utilisant la version 1.01A devront obligatoirement se mettre à jour.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MAJAppliOblig.gif)


- les utilisateurs utilisant la version 1.01B pourront au choix installer la mise à jour ou lancer directement l'application.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=MAJAppliNonOblig.gif)
