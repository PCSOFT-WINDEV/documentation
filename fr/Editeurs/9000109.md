...
1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_generation_Android.gif)
 parmi les boutons d'accès rapide. L'assistant de génération de l'application Android s'ouvre.
...
7. Indiquez l'adresse email à utiliser par défaut pour envoyer le rapport d'erreur lors d'une erreur fatale. 
	Lorsque l'application rencontre une erreur fatale, une fenêtre spécifique est affichée : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_Erreur.gif)
L'utilisateur peut : 
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_generation_Fic.gif)
...
32. L'application est compilée et générée en tâche de fond. Vous pouvez utiliser l'éditeur pendant la génération de l'application. 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=D%E9ploiement%20android%20fin%20-%20HC%20N%B0002.gif)
...
- en déroulant l'icône de génération Android (![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_generation_Android.gif)
) parmi les boutons d'accès rapide et en sélectionnant l'option "Déployer la dernière application générée sur l'appareil mobile".
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Android_vi_Mini.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Version_sdk_optim.gif&type=thumb)
