...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TDB_Wid_perf.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Analyseur%20performances%20-%20HC%20N%B0004%201.gif)



|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle1.gif)<br> | Parent | Elément ou traitement qui a appelé la fonction. |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle2.gif)<br> | Fonction | Fonction, traitement, événement ou procédure exécutée. |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle3.gif)<br> | Temps Total | Temps d'exécution de la fonction. |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle4.gif)<br> | Nb appels | Nombre d'appels effectués à la fonction (procédure, événement ou traitement). |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle5.gif)<br> | Temps 1 appel | Temps d'exécution d'un appel à la fonction (procédure, événement ou traitement) |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Cercle6.gif)<br> | % code | Pourcentage du temps passé dans le traitement de la fonction ou de la procédure (code du développeur pouvant être optimisé). |
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=P4_Analyseur%20performances%20-%20HC%20N%B0004.gif&type=thumb)
...
- Pour visualiser rapidement le traitement en cours, il suffit de cliquer sur l'icône ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Detail_Description_FEN_btnCode%20-%20HC%20N%B0001%201.GIF)
