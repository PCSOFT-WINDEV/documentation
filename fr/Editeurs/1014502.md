...
Lors de chaque GO (de fenêtre ou de projet), par défaut, un audit dynamique s'effectue en arrière-plan, sans ralentir l'exécution. A la fermeture du test, le nombre de problèmes rencontrés est affiché dans le widget "Audit dynamique" du [Tableau de bord du projet](../Editeurs/9500221.md). 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=TDB_Wid_audit_dyn.gif)
...
<a name="fenetre_analyse_audit_dynamique_ELTPARAGRAPHE000232"></a>Lors du chargement d'un audit dynamique, la fenêtre suivante est affichée :
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=audit_dyn_fen.gif)
