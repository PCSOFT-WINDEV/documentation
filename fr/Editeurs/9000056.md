...
Cette liste évolue très rapidement. Il est conseillé de consulter la documentation de chaque fonction. Le sigle ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=menu_btn_java_1.gif)
 indique si la fonction est disponible en Java et ses limitations.

Le filtre de l'aide en ligne ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=menu_btn_WD.gif)
 +  ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=menu_btn_java_1.gif)
 permet de visualiser les fonctions disponibles en Java.
