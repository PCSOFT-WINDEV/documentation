...
WEBDEV permet de créer des pages statiques et des pages dynamiques. Deux sortes d'actions peuvent être programmées dans un site WEBDEV : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Deux_types_de_code.gif)
