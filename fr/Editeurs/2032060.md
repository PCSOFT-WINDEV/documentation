...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png) | Important | [Le logiciel Etats & Requêtes](../Presentation/3088004.md) ne permet pas de créer des requêtes en code SQL utilisant les ordres [INSERT](../Editeurs/2034001.md), [UPDATE](../Editeurs/2034001.md) ou [DELETE](../Editeurs/2034001.md). |
