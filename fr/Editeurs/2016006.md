...
3. Dans la fenêtre "Tiroir", sélectionnez l'option "Ajouter ce style au projet" et indiquez le nom du nouveau style. Le bouton "Ajouter" permet de créer le style dans la feuille de style.<br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Stylle_surcharge%201.gif&type=thumb)
