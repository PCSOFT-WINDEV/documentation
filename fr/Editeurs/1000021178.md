...
4. Une fenêtre s'affiche permettant de réaliser l'importation de tous les utilisateurs.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=gpu_ldap.gif)
