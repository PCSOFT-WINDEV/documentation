...
1. Selon la configuration de projet en cours : 
	...
	- Si la configuration de projet en cours ne correspond pas à l'archive Java, utilisez les boutons d'accès rapide : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_generation_java.gif)
