...
1. Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ico_generer_exenet.gif)
 parmi les boutons d'accès rapide. L'assistant de génération d'une application .NET se lance. 
	...
	- Créer une nouvelle configuration pour votre projet. Cette configuration est automatiquement proposée en déroulant l'icône de génération et en sélectionnant l'option "Autres générations .. Générer une application .NET". ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Generation_Exenet.gif)
...
- les icônes doivent avoir été créées par un outil classant les icônes par taille croissante et par résolution de couleurs croissante. ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=icoxp.gif)
