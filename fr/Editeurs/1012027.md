...
3. Dans la zone "Ressources externes", il est possible d'ajouter des ressources Javascript : 
	...
	- Cliquez sur ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IconeAjouterPropriete.gif)
 et sélectionnez le chemin du fichier Javascript.
...
4. Cliquez sur le bouton ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=IconeAjouterPropriete.gif)
 et sélectionnez le chemin du fichier Javascript.
