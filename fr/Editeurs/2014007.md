...
Le répertoire de génération correspond au répertoire associé à la configuration de projet de type "Composant externe".![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Composant_MemePoste.gif)
...
Lors de l'importation du composant externe dans un projet, il suffit de sélectionner le fichier WDI correspondant au composant dans le répertoire de distribution.![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=composant-reseau.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=composant-instal.gif)
