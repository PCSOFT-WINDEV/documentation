...
3. Dans l'entête de la procédure, cliquez sur le logo "WL" pour changer le type de code. <br>![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=CSHARP_Code_WL.gif)
