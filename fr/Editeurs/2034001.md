...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=ER.png)<br> | Important | **[L'éditeur de requêtes Utilisateur](../Presentation/3088004.md)** ne permet pas de créer des requêtes en code SQL utilisant les ordres INSERT, UPDATE ou DELETE. |
