...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Config_Projet_explo.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Config_Projet_explo_2.gif)
...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Config_projet_liste_explo.gif)
...
Remarque :  Lors de l'enregistrement d'un nouvel élément, la fenêtre suivante s'affiche :
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Config_Ajout.GIF)
...
2. Affichez le menu contextuel de la description et sélectionnez l'option "Dupliquer". 
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Config_Projet_explo_2.gif)
...
- Pour ouvrir directement le répertoire de génération d'une configuration : 
	...
	- Sous le volet "Accueil", dans le groupe "Général", déroulez ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Rep_Projet.gif)
