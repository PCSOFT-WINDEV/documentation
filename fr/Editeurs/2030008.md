...
<a name="traduction_interface_autoextraction_ELTPARAGRAPHE000145"></a>L'interface de l'auto-extracteur peut utiliser une langue différente de la langue par défaut (le français).
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Zipcreeexe.gif)
