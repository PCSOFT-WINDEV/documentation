...
**Équivalence HFSQL** : Pour retrouver l'équivalence à l'égalité très souple lors d'une recherche sur une clé texte dans un fichier HFSQL, il est nécessaire de configurer les options suivantes lors de la description de la rubrique dans l'analyse :
