...
![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Requ%EAteSQL_WL%20-%20HC%20N%B0001.gif)
...
- Complétion : La complétion est disponible : 
	...
	- sur les rubriques de sortie de la requête. ![La saisie SQL assistée](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=151-sql_completion_rubriques.jpg)





- Erreurs de compilation : En cas d'erreur dans le code SQL de la requête, une erreur de compilation est générée (comme pour du code WLangage). ![Erreur de code SQL détectée en saisie](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=152-sql_code_erreur.jpg)
