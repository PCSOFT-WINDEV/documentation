...
- La procédure zombie apparaît grisée et barrée dans le volet "Explorateur de projet" (dès que l'élément est recompilé). ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=proc_zombie_3.gif)


- Lors de la saisie de l'appel à la fonction, une icône spécifique sera affichée pendant 10 secondes  : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Proc_zombie_1.gif)
 et une erreur de compilation contenant le commentaire sera affichée : ![](https://doc.pcsoft.fr/fr-FR/images/image.awp?langid=5&name=Proc_zombie_2.gif)
