...
2. Select an ActiveX in the "ActiveX" combo box. This combo box lists all the ActiveX controls found on the computer. 
	**Note**: The search icon (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=recherche.jpg)) allows you to select the ActiveX object using keywords.
	The information about the ActiveX is displayed.

3. Choose the element whose description you want to get. This element can correspond to:
...
- select "Run" in the context menu of the method or event.
...
- select "Modify" in the context menu of the property.
...
[WDXView: Overview](../WDXView/3526002.md)
