...
2. Click the icon to the left of the "Product" data file to view all its items. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0001.jpg)


3. Select all the items of the "Product" data file except "ProductID". You can select multiple elements by holding the Ctrl key down.

4. Drag the items and drop them onto the previously created page. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0002.jpg&type=thumb)
...
5. Different controls are automatically created in the page. These controls are bound to the corresponding item in the data file. To check this:
	...
	- Go to the "Link" tab of the description window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0003.jpg&type=thumb)
...
Move the controls in the page to get the following UI: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0004.jpg&type=thumb)
...
3. Enable the text edit mode and and type "OK". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0005.jpg&type=thumb)
...
5. Let's take a look at this WLanguage code:
	...
	- [&lt;Data file&gt;.FromPage](../WDLang4/1000021405.md) updates the items of the current record with the data from the bound controls. This function is equivalent to the following lines of code:
...
1. In the open documents bar, click "PAGE_List_of_products": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0006%201.jpg)
...
4. Then, click next to the reference in the Looper control to create the Link control. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0006.jpg&type=thumb)
...
1. The editor prompts you to select the first page of the Session mode. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0007.jpg)
...
3. In the list of products:
	...
	- The page with the product details opens. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%206%20Fiche%20Produit%20-%20HC%20N%B0008.jpg&type=thumb)
