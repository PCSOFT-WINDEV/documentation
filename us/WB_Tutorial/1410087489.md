...
6. On the "General" tab, in "Option action": 
	...
	- select the "PAGE_Product_form" page.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0001.jpg)
...
8. In the template bar, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%205%20Gestion%20des%20menus%20-%20HC%20N%B0002%201.jpg) to apply the changes made to the template to all the pages that use it.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0002.jpg)
...
Users will be able to upload an image from their computer and it will be bound to an item in the data file. We will use an Upload control.Uploading consists in copying a file from the client computer to the server.
...
3. Click at the desired location to create the control in the page (below the Image control, for example). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20Complet%20-%207%20Fiche%20Produit%20Cr%E9ation%20-%20HC%20N%B0003.jpg&type=thumb)
...
7. Save changes by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WB_GAF.jpg) in the quick access buttons. The compilation errors disappear.
...
2. In the "Click xxx (server)" event of the Button control, enter the following code AFTER the call to [&lt;Data file&gt;.FromPage](../WDLang4/1000021405.md):
...
1. Test the project (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Go_Projet_WB_GAF.jpg) in the quick access buttons). The page containing the list of products appears. 
