...
1. Load the analysis of your project in the data model editor. To do so, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Analyse_WM_GAF.jpg) in the quick access buttons of the WEBDEV menu. The data model editor is displayed.
...
7. In the next step, select all the data files: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0004.jpg&type=thumb)
Go to the next step.

8. A dialog box prompts you to copy the data files to the server. Validate ("Copy now").<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0005.jpg)


9. Select the analysis data files to be copied to the server. In our case, all data files in the EXE directory.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0006.jpg&type=thumb)


10. Go to the next step and validate.

11. The data files in the analysis are automatically changed into HFSQL Client/Server data files and associated with the selected connection.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P11_Passage%20analyse%20en%20CS%20WB%20-%20HC%20N%B0007.jpg&type=thumb)


12. **Generate the analysis**: In the data model editor, on the "Analysis" tab, in the "Analysis" group, click "Generation". An automatic modification of the data files is automatically proposed. If all the data files are up to date, the automatic modification of the data files can be canceled.
