...
3. Enable the User Groupware by selecting "Enabled". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0001.jpg&type=thumb)
...
7. First, update the skins used in the project. To do so, go to the "Project" tab, "Project" group, expand "Recompile and synchronize" and select "Update skins". 
...
4. Select the TPLC_GPU_WB_Login control template and drop it onto PAGE_List_of_products. Drop the control to the right of the Company logo.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0003.jpg&type=thumb)
...
6. On the page that appears, select "Configure groupware".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Groupware%20utilisateur%20-%20HC%20N%B0002%20B.jpg)


7. The User Groupware configuration page appears.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0003%20B.jpg&type=thumb)
...
3. For "Menu option OPT_AddProduct", select "Grayed out" in the "State" combo box.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0008.jpg&type=thumb)
...
2. By default, the "Product form" option is grayed out. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B0009.jpg&type=thumb)


3. Click "Log in" and enter "Alison" in the username and password fields. Validate.

4. The "Product form" option is no longer grayed out.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Groupware%20Utilisateur%20-%20HC%20N%B00010.jpg&type=thumb)
