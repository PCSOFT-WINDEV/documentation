...
<a name="step_2_choosing_the_languages_the_analysis_ELTTEXTE000665"></a>
...
<a name="adding_languages_the_analysis_ELTPARAGRAPHE000127"></a>

To use multiple languages in the "Full_WEBDEV_Site" project:

1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Analyse_GAF.jpg) in the quick access buttons of the WEBDEV menu to open the data model editor. 
...
4. The new language appears in the list. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Multilangue%20-%20HC%20N%B0003.jpg&type=thumb)
...
4. On the "General" tab, in the French caption, enter "Adresse". 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Multilangue%20-%20HC%20N%B0004.jpg&type=thumb)
...
4. Let's translate the page title. Replace the text under French with "Liste des produits". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0005.jpg&type=thumb)
...
1. The menu is contained in the template associated with the page. Open the page template:
	...
	- Select "Open template".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0006.jpg)
...
6. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Multilangue%20-%20HC%20N%B0007%201.jpg) icon appears in the code editor. This icon indicates that the multilingual message exists in multiple languages. You can quickly view the different translations by hovering over the icon.
...
2. Save the page template (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WB_GAF.jpg) or Ctrl + S).

3. Update the pages that use the page template by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20WebDev%20-%20Liste%20produits%20-%20HC%20N%B0011%201.jpg) icon in the header of the template. Validate the update window.
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Go_Page_WB_GAF.jpg) in the quick access buttons. The page is displayed in test mode in English. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0010.jpg&type=thumb)


2. Click the French flag at the bottom of the page.

3. The elements that have been translated are displayed in French: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0011.jpg&type=thumb)
...
2. Go to the "Translation" tab.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0008.jpg&type=thumb)
...
4. Once the translation settings are defined, you can click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0007%201.jpg) button in the different description windows of the project elements. This button will open the desired translation program.
