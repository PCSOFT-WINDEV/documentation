...
<a name="creating_the_data_file_ELTTEXTE000638"></a>
...
3. A new editor appears: the data model editor. 
	In WEBDEV, the database is defined in a specific editor, the data model editor. The data model editor contains the description of all the data files that will be used in the project. We will take a closer look at this editor in [Creating a project and its analysis](../TutoWB/1410087411.md).


4. The data file generation wizard opens. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes%20Premi%E8res%20pages%20-%20Analyse%20-%20HC%20N%B0001.jpg&type=thumb)
...
7. Choose the desired controls. In our case, all the controls in the page correspond to an item.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes%20Premi%E8res%20pages%20-%20Analyse%20-%20HC%20N%B0003.jpg&type=thumb)
...
12. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WB_GAF.jpg) in the quick access buttons or press Ctrl + S to save the analysis.
...
Save the page (Ctrl + S). An icon appears on the right of the control. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0001.jpg)
This icon indicates that there is a UI error or a potential improvement. Hover over the icon for more details.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0002.jpg)

In our case, no keyboard shortcut is associated with the Button control. This problem can be fixed automatically: 

- Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0001%201.jpg) icon. 

- In the window that appears, click "Fix". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0003.jpg)
...
The events associated with the control are displayed in the code editor. You will see the headers of the events executed on the server and on the browser. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0004.jpg)
...
- [&lt;Page&gt;.ToFile](../WDLang4/1000021390.md) retrieves the data from the Edit controls in PAGE_Form and transfers it to the Registration data file.

- [&lt;Data file&gt;.Add](../WDLang4/1000024187.md) writes the data to the Registration data file.
...
WEBDEV includes **WDMap**, an easy-to-use tool for viewing the contents of data files. We are going to use it in order to check whether the information typed was saved.WDMap allows you to view the contents of data files during the development stage (for example, if the pages used to view the data have not yet been created). This tool is not redistributable and can only be used on the development computer. 
...
3. An information box is automatically displayed to indicate that required fields have not been filled. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes%20Premi%E8res%20Pages%20-%20Partie%203%20-%20HC%20N%B0001.jpg&type=thumb)
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Cr%E9er_WB_GAF.jpg) in the quick access buttons. The new element window appears.
...
As on the previous page, an icon appears in the upper-right corner of the "LOG IN" button. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Mes_Premi%E8res_Pages%20-%20Bouton_Enregistrer%20-%20HC%20N%B0001%201.jpg)Here again, there is a missing keyboard shortcut. 
