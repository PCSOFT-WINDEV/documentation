...
For example: 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_BaseDonn%E9esExterne1.gif&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Base%20Oracle%20WB%20-%20HC%20N%B0001.gif&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CardinaliteFenDescriptionWB.gif)
...
In a parallel link, ***each record*** found in a data file (Product) is linked to ***a record*** in another data file (Info), and ***conversely***.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=LiaisonParallele.gif)
