...
For more details, see "**Microsoft Windows Programmer's Reference**" (not provided with WINDEV). 
To see the values of 32-bit Windows APIs, see the following page: [32-bit API constants](../AppelDLL/6510001.md).

**Note**: The **API** and **CallDLL32** functions are equivalent.
...
[Value of constants for the Windows 32-bit API](../AppelDLL/6510001.md)
