...
<a name="caption_tab_control_ELTPARAGRAPHE000363"></a>The caption of a Tab control corresponds to the text of the button that is used to select the tab pane.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Onglet_prop_Libelle.gif)
