...
## Remarks
The [CtDescribedOLEDBProvider](../Proprietes/2512025.md) property gets and sets the type of access specified for the OLE DB connection when describing the data file.
