...
- **For a field** (except Button control fields): the help message appears in the status Bar when the field takes focus.

- **For a Button control** The help message appears in the status Bar as soon as the left mouse button is pressed.

- **For a menu item** the help message appears in the status Bar when the option is hovered over.
