...
The **Hint** property gets and sets the hint text displayed when the Edit control is empty.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Indication%20-%20HC%20N%B0001.gif)
