...
|   |   |
| --- | --- |
| *useModeMovement* | The control is in move mode: <br><br>- the left mouse button allows you to move within the document. <br><br>- the mouse cursor turns into a hand. <br><br>- if the ribbon is displayed, the "Move" option is selected ("Display" pane, "Mode" group). <br><br><br><br><br>Until version 27, this constant was named *modeUseMovement*. |
