...
Reminder: The add cross allows the end user to open a new tab. 
<a name="Exemple1"></a>
...
- The "Create a tab" event is executed when the user clicks the "+" button. By default, a new tabs is created. However, you can prevent new tabs from being created using the "RETURN False" statement or [SetFocusAndReturnToUserInput](../WDLang1/1410088107.md) in the "Create a tab" event.  
