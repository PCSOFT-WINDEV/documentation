...
**Example** The "Monday" cell is colored light green with the "Tube" style.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=StyleFond.gif)
...
**Using hatching** The hatch color is set by the [Color](../Proprietes/2510071.md) property. By default, the color of the hatches corresponds to the color of the text. To use a different color for the text, use [gPen](../WDLang1/3029039.md).
