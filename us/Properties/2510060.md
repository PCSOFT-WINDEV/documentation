...
A control can be bound to an item from a base data file, or to an item from a linked data file. This is referred to as complex binding. Example of complex binding:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=LiaisonFichier%20-%20HC%20N%B0001.gif)
