...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) In a window, the **Note** property cannot be used on:
...
![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) The **Note** property can only be used with the following elements:
...
[NoteTitle (Property)](../Proprietes/2510121.md)

[Print technical documentation](../Proprietes/2015001.md)
