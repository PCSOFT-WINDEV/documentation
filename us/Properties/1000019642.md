...
**Note** To find out and modify the size of the grid used for the duration, use the [GranularityDuration](../Proprietes/1000019643.md) property. 
...
### Moving elements: Change grid size
