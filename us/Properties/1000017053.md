...
Trace("Language used in the data file: ") + Client.Name.Language
```
...
`<Paramètres de la langue> = <Fichier de données>.<Rubrique>.language`
---
...
[Using Unicode in HFSQL data files](../Proprietes/3044371.md)
