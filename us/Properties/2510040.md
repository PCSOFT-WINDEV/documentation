...
The **BrowsedFile** property gets and sets the data source used to display records in controls based on a data file or variable. Some of these controls are:
...
- ***Automatic iteration:*** WINDEV, WEBDEV and WINDEV Mobile automatically manage data file iteration and data display in the control. No specific programming is required.
...
- ***Programmed iteration***: The developer must program the iteration over the data file and the way in which data is displayed in the control.
