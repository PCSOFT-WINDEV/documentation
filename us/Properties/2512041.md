...
**Important** This property can currently only be used with AS/400 data files (and fields) and HFSQL Client/Server connections. On HFSQL Client/Server connections, only the encryption can be managed by the **ExtendedInfo** property. 
