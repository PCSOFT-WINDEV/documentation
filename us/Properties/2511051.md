...
**Warning** It is only possible to modify the bottom margin of a report in the "Open report" event.

**Note** The different margins of a report are defined in the page format ("Page setup" option in the report context menu).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=MargeBasse%20-%20HC%20N%B0001.GIF)
