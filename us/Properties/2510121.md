...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) The **NoteTitle** property applies only to Combo Box controls in this version. ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) In a page, the **NoteTitle** property cannot be used on:
