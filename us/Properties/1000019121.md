...
|   |   |
| --- | --- |
| *secHtmlMaxi* (or <u><u><u><u>True</u></u></u></u>)<br>(Default value) | No script is run (javascript, vbscript, etc.). No ActiveX control or plugin is displayed or run. |
| *secHtmlNone* (or <u><u><u><u>False</u></u></u></u>) | The scripts are run. The ActiveX controls or plugins are displayed and run. <br><br>**Note** Scripts will not run in the field if the field's [State](../Proprietes/2510039.md) property is set to *Inactive* or *Grayed*. |
