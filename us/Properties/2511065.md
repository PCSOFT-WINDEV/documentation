...
The **VSpace** property gets and sets the vertical spacing between the labels in a report. This spacing was defined when creating the Label report.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=EspaceV.gif)
