...
**Note**: Label width was defined when the report was created in label format.. This option can be obtained and changed in the report editor, via "Format of labels" in the context menu of the report.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Largeuretiquette.gif)
...
// Is equivalent to: ETAT_EtiqClient.LabelWidth += 35
```
...
### "Label" report
<a name="label_report_ELTPARAGRAPHE000054"></a>
...
[NbLabel (Property)](../Proprietes/2511050.md)

[Properties associated with reports and controls](../Proprietes/2515010.md)

[Label report](../Proprietes/1011050.md)
