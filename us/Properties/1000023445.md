...
Note: This property is equivalent to the "With search" option available in the "Detail" tab of the Combo Box control description window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RechercheFAA%20-%20HC%20N%B0001.gif)
A search field is then displayed when the combo is unrolled. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RechercheFAA%20-%20HC%20N%B0002.gif)
