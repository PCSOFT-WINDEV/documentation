...
**Note** If a data file supports the NULL value and the field allows NULL (property [NullAllowed](../Proprietes/1000019492.md)), it will be possible to use property [Null](../Proprietes/2512064.md) to assign NULL to the field for the current record, for example.
