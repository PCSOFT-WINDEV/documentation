...
The **TotalRange** property gets and sets the total range of data represented by the Range Slider control. For example, if the total range is 100, the Range Slider control represents data from 1 to 100. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RangeSlider_Etendue.gif)
