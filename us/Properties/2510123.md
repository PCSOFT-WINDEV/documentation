...
- Name of item displayed by the specified control. This item belongs to the data file the control is based on (returned or modified with the [BrowsedFile](../Proprietes/2510040.md) property).
...
- Name of item that will be displayed in the specified control. This item belongs to the data file the control is based on (returned or modified with the [BrowsedFile](../Proprietes/2510040.md) property).
...
- a heading belonging to the report source data file (known or modified using the [SourceName](../Proprietes/2511035.md) property).
...
<a name="modifying_the_item_displayed_table_controls_populated_programmatically_based_data_file_and_based_variable_ELTPARAGRAPHE000222"></a>
