...
Note: This property is equivalent to the "Synchronize display" option in the "Contents" tab of the Table control window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Table_Fichier_Synchro%20-%20HC%20N%B0001.gif)
...
### Learn how to refresh a Table control linked to an HFSQL Client/Server data file
...
### Modify the refresh mode of a Table control linked to an HFSQL Client/Server data file
...
| *syncAddition* | Synchronization when adding a record into the data file. |
| *syncNone* | No synchronization is performed. |
| *syncModification* | Synchronization when modifying a record in the data file<br><br>Please note: Only lines displayed by the Table control (i.e. visible) can be modified automatically when editing the linked HFSQL data file. |
| *syncDeletion* | Synchronization when deleting a record from the data file |
...
- This property is ignored for: 
	...
	- Table controls manipulating data files via a Native Access connector,
