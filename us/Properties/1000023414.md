...
| *lldAutomatic* | The links defined in the analysis are used to find the data from the linked data files to be displayed. <br>If several data files are bound in the analysis, the user will be able to choose the file to display in the details via a context menu. |
...
[Table field linked to a data file (Table file)](../Proprietes/1013177.md)
