...
The **VisibleRange** property gets and sets the width of the Range Slider control track. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RangeSlider_Etendue.gif)
