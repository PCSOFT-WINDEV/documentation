...
### Number of records
<a name="number_records_ELTPARAGRAPHE000053"></a>
...
- In the case of a file report, the [NbRecRead](../Proprietes/2511041.md) and [NbPrintedRec](../Proprietes/2511058.md) properties return the same value: the number of records in the file AND selected by the filter code (if any).
...
### Type of report
<a name="type_report_ELTPARAGRAPHE000080"></a>

If the report is linked to:

- ***an HFSQL data file***, the records to print are selected in the beginning of the data file.
...
### Limit
<a name="limit_ELTPARAGRAPHE000094"></a>
