...
- a list of values if the data source is defined programmatically.

- the name of an item (in &lt;File name&gt;.&lt;Item name&gt; format) if the data source is a data file item.
