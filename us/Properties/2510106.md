...
Note: To find out and modify the page number displayed in a Word Processing control or a PDF Reader control, use the [NumberDisplayedPage](../Proprietes/1000023479.md) property. 
...
**Attention** The property **PageNumber** property only applies to the image file currently associated with the Image control field.
<a name="NOTE0_2"></a>
