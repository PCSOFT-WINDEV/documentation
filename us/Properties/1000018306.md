...
- project language options: in the "Project" pane, in the "Project" group, click on "Description".. In the "Languages" tab, choose the "Various" linguistic options and configure the "Text direction" option.
