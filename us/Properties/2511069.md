...
**Note** The height of the labels was defined when the "Label" report was created. This option can be known and/or modified in the format of the page ("Format of labels" from the popup menu of the report).
...
// Is equivalent to: ETAT_EtiqClient.HauteurEtiquette += 35
```
