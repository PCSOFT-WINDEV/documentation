...
<a name="multilingual_websites_ELTPARAGRAPHE000087"></a>
...
Note: If **PageUse** is used in the code of a Button control, the page will be opened in the target defined for this Button control ("General" tab of the control description or [ChangeTarget](../WDLang2/3058005.md)).
<a name="NOTE0_4"></a>
