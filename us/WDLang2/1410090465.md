...
***In french: &lt;Variable adminWBAuth&gt;.SupprimeApplication***
...
Applications = AdminAccount.ListApplication()
FOR i = 1 _TO_ Applications.Count  
    	IF Applications[i].Type = WBAdminTypeSite THEN
		// Deletes a site
		AdminAccount.DeleteApplication(Applications[i].OwnerAccount, Applications[i].Name, WBAdminTypeSite)
	END
END
```
...
`<Result> = <WEBDEV Application Server>.DeleteApplication(<Owner account> , <Application name> , <Application type>)`
---
...
<a name="twofactor_authentication_ELTPARAGRAPHE000206"></a>
