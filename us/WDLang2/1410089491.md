...
- Tip: To get the number of a given row (for example, when a button in the internal page is clicked), create an attribute in the Looper control and assign the result of **&lt;Looper&gt;.InsertIP** to this attribute. 
