...
Refreshes the display of a RepeatString data file field from a given position: changes made to the linked data file are reflected in the RepeatString field.
...
|   |   |
| --- | --- |
| *taCurrentFirst* | <br><br>	- Refreshes the Looper control from the current record in the data file.<br><br>	- The first row of the Looper control is selected. This row corresponds to the current record of the Looper control.<br><br><br>![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) This constant is not available. |
| *taCurrentSelection* | <br><br>	- Refreshes the Looper control from the position of selection bar in the Looper control.<br><br>	- The position of selection bar is not modified. The current record in the data file will correspond to the record selected in the Looper control (after **&lt;Looper&gt;.Display** is called).<br><br><br> |
