...
**Remark**: These functions are also available in prefix syntax ([Functions for managing pages (prefix syntax)](../WDLang2/1000021657.md)).
...
| [PageWriteCustomHTTPCode](../WDLang2/1410090195.md) | Specifies the custom HTTP code that will be returned to the client after the server code of the page is executed. |
...
| [PageWriteHTTPCode](../WDLang2/1410090194.md) | Specifies the HTTP code that will be returned to the client after the Server code of the page is executed. |
