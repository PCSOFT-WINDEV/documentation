...
***In french: &lt;Upload&gt;.TailleEnvoyée***
...
```wl
UPL_Upload is Control
STC_MultiUpload_Global is Control
// -- Event "Progress of transfer"
// Displays the number of bytes sent according to the total size to send
STC_MultiUpload_Global = Round(UPL_Upload.SizeSent() / UPL_Upload.Size() * 100) + "%"
```
...
<a name="which_event_should_use_this_function_ELTPARAGRAPHE000185"></a>

**&lt;Upload&gt;.SizeSent** can only be used in the browser event "Progress of transfer". This event is associated: 
...
Used in another event, **&lt;Upload&gt;.SizeSent** will return 0.
<a name="NOTE0_2"></a>
