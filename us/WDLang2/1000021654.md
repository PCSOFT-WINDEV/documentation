...
**Remark**: To display a Popup control, the function **&lt;Popup&gt;.Display** can be used: 
...
`<Popup>.Display(<Name of base control> [, <Display options> [, <X> [, <Y>]]])`
---
...
**`<Name of base control>: (Control name)`**
...
- Browsers don't refresh the display in the middle of Javascript code: the functions **&lt;Popup&gt;.Display** and [&lt;Popup&gt;.Close](../WDLang2/1000021656.md) functions must be used in different events/processes. If these functions are used in the same event/process, the Popup control is not displayed.
