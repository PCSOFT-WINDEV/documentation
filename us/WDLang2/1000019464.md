...
- shared by all windows and tabs of the same computer browser: they can be restored once the browser is closed then re-opened or in another browser window. **In this case, the local storage is persistent.** 
...
[LocalStorageAdd (Function)](../WDLang2/1000019382.md)

[InStoredProcedureMode (Function)](../WDLang2/3014029.md)

[LocalStorageValueName (Function)](../WDLang2/1000019388.md)

[LocalStorageOccurrence (Function)](../WDLang2/1000019387.md)

[LocalStorageGet (Function)](../WDLang2/1000019384.md)

[LocalStorageDelete (Function)](../WDLang2/1000019385.md)

[LocalStorageDeleteAll (Function)](../WDLang2/1000019386.md)
