...
The display is as follows: the page displayed by **&lt;Page&gt;.DisplayDialog** is displayed in the foreground.
...
The page that used **&lt;Page&gt;.DisplayDialog** is in the background. This page is grayed by DDW (Dim Disabled Pages). The DDW feature can be configured by [PageActivateDDW](../WDLang2/1000017087.md) and [PageRateDDW](../WDLang2/1000017086.md).
