...
The &lt;Page&gt; parameter can correspond to any page of the site. For this page, the option "Accessible via the DynamicSiteDisplay function" must be checked in the "General" tab of the page description.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=SiteDynamiqueAffiche%20prob.gif)
