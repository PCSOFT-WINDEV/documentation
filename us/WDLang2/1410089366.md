...
- Tip: To find out the number of the repeat used (for example, when clicking on an internal page button), create an attribute in the Repeated zone field and assign it with the result of the function **LooperAddIP**. 
