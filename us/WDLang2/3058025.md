...
- **PageInitialization** must not be called in the "Open" event of a page.

- Do not confuse **PageInitialization** with [Reset](../WDLang1/3025026.md), which resets all the page controls (without running the "Initialization" event of the controls).
...
[Reset (Function)](../WDLang2/3025026.md)
