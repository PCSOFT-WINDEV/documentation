...
### Adding an approval signature to a PDF file
...
### Adding an approval signature to a PDF document
...
- **PDFSign** cannot be used to sign a PDF file with a certificate-based signature. You need to use [iPrintSignature](../WDLang5/1000021690.md), which allows both methods.
...
[&lt;pdfDocument variable&gt;.Sign (Function)](../WDLang6/1410090339.md)
