...
If this parameter is not specified or is an empty string (""), the user will have to enter the full name of the Bitmap file in a file picker.
...
- the document in the scanner when **TwainToBMP** is called. In this case, the parameters specified in [TwainScanArea](../WDLang6/3078014.md) are taken into account.
