...
If this parameter is not specified or if it corresponds to an empty string (""), the user will have to enter the full name of TIFF file in a file picker.
...
- the document in the scanner when **TwainToTIFF** is called. In this case, the parameters specified in [TwainScanZone](../WDLang6/3078014.md) are taken into account.
