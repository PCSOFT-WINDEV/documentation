...
Several WLanguage functions are used to burn the CDs or DVDs. It is possible to create: 
...
**Note**: It is only possible to burn files to CD or DVD.. You cannot copy a CD or DVD directly.
...
2. Open (if necessary) the door of the current burner ([BurnerEject](../WDLang6/3061014.md)).
	**Remark**: It is possible to find out whether the recorder contains a medium using the [BurnerMediaFound](../WDLang6/1000019910.md) function.. 
