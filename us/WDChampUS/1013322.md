...
WINDEV allows you to programmatically handle Dynamic Tab controls with the [TabXXX functions](../WDLang1/1000021709.md) and multiple WLanguage properties. You can also use the Tab control variable directly in the code. 
...
2. The internal window opened by the "+" button can be: 
	...
	- **a specific internal window** (e.g. a customer form). 
			...
			Remark: If the internal window expects parameters, the tab pane must be opened with [&lt;Tab&gt;.Open](../WDLang1/1000021704.md). 
...
Remark: The "+" button of the dynamic tab automatically calls the "Create a tab" event of the Tab control. If this event uses [&lt;Tab&gt;.Open](../WDLang1/1000021704.md), this event will take priority over the internal window specified in the interface.
<a name="NOTE2_3"></a>
...
<a name="tip_creating_menu_tab_allow_the_user_choose_the_type_tab_pane_create_ELTPARAGRAPHE000286"></a>
...
- [&lt;Tab&gt;.Status](../WDLang1/1000021700.md) gets the status of a dynamic tab pane: active, floating, not found. 
...
<a name="changing_the_active_dynamic_tab_pane_ELTTEXTE000381"></a>
...
<a name="finding_out_the_caption_active_dynamic_tab_pane_ELTTEXTE000421"></a>
...
<a name="retrieving_the_internal_window_displayed_pane_ELTTEXTE000463"></a>
...
<a name="properties_specific_tab_controls_ELTTEXTE000523"></a>
