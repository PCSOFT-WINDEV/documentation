...
A Bar Code control can be handled by the WLanguage properties: 
...
## Properties for a Bar Code control found in a window
<a name="properties_for_bar_code_control_found_window_ELTTEXTE000161"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Universal Windows 10 App](https://doc.pcsoft.fr/ext/images/us/UNIVERSALAPP.png) The following properties are associated with Bar Code controls:
...
## Properties for a Bar Code control in a page
<a name="properties_for_bar_code_control_page_ELTTEXTE000773"></a>
<a name="NOTE4"></a>
<a name="NOTE4_1"></a>


## Properties for a Bar Code control in a report
<a name="properties_for_bar_code_control_report_ELTTEXTE001421"></a>
![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Universal Windows 10 App](https://doc.pcsoft.fr/ext/images/us/UNIVERSALAPP.png) The following properties can be used with the "Bar code" controls:
