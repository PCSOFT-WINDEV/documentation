...
<a name="image_selection_bar_and_image_hover_bar_ELTPARAGRAPHE000059"></a>An image can be used to easily view the selected row and the hovered row.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=BandeauTable.gif)
...
5. Select the image to use by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
 button: 
...
5. Select the images to use by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif)
 button: 
...
6. These images must respect the following format:
	...
	- Vertical scrollbar: Size of image: 60 x 128 pixels. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ascenseur_V_Table.gif)


	- Horizontal Scrollbar: Size of image: 384 x 47 pixels. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ascenseur_H_Table.gif)
