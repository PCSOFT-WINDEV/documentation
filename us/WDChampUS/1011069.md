...
- ***the user version of the report editor*** (also called ***Reports & Queries***). This editor is provided with WINDEV only. 
	...
	The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=er.png)
 icon indicates the differences between the user version of the report editor and the standard report editor.
