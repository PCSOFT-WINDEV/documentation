...
<a name="properties_available_the_window_ELTPARAGRAPHE000031"></a>The following properties can be used with the "Table" controls:
...
| [RowDetailsBinding](../Proprietes/1000023414.md) | The **RowDetailsBinding** property allows you to identify and modify the data binding used to display the details of a row in a browsing Table control. |
...
| [SynchroHFSQL](../Proprietes/1000023408.md) | The **SynchroHFSQL** property is used to: <br><br>- get the refresh mode of a Table control based on a data file linked to an HFSQL Client/Server data file. <br><br>- specify the refresh mode of a Table control based on a data file linked to an HFSQL Client/Server data file.<br><br><br> |
...
**Remark**: You also have the ability to directly use the properties on the columns of the Table controls. For more details, see [Properties available for the columns of Table controls](../WDChamp/1013247.md).



## Properties available in a page
<a name="properties_available_page_ELTTEXTE001136"></a>
<a name="NOTE2_2"></a>
<a name="NOTE2_3"></a>
<a name="NOTE2_4"></a>
**Remark**: You also have the ability to directly use the properties on the columns of the Table controls. For more details, see [Properties available for the columns of Table controls](../WDChamp/1013247.md).
