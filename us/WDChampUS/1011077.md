...
- In the editor: 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Etat_composite_Editeur.gif&type=thumb)
...
- Several methods can be used to view the description window of the composite report: 
	...
	- On the "Modification" tab, click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_regroup.gif)
 dialog box launcher of the "Composite report" group. 
...
- To view the description window of the sub-report: 
	...
	2. On the "Modification" tab, click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_regroup.gif)
 dialog box launcher of the "Report" group. You also have the ability to select "Sub-report description" from the popup menu of the report.
