...
Example:
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=INTERRUPTEUR_CHAMP.GIF)
...
<a name="threestate_check_box_ELTPARAGRAPHE000175"></a>In the window editor, you can enable three-state options for Check Box controls.
