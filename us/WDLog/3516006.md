...
<a name="saving_the_hfsql_data_files_associated_with_analysis_ELTPARAGRAPHE000030"></a>
...
6. Specify the following elements in the backup window:
	...
	- Specify the backup options:
		...
		- ***Do not save indexes (.NDX)*** Reduce backup size. If this option is checked, the files must be reindexed once they have been restored. 
						Reminder: WINDEV offers various solutions for reindexing data files: WDTool (not redistributable), WDOptimizer, WDMAP (not redistributable), or by programming with the WLanguage function **HReindex**.
...
<a name="saving_all_the_data_files_found_wdd_file_rep_file_ELTPARAGRAPHE000085"></a>
...
<a name="saving_all_the_data_files_found_hfsql_clientserver_database_ELTPARAGRAPHE000164"></a>
...
| /MULTI=&lt;True/False&gt; | The backup archive will be divided into files (1.4 MB) if this option is set to "True". There is no need to specify the compression option if this option is used.<br>Otherwise, the archive will not be divided.<br>This option is set to "False" by default. |
| /SANSSOUSREP=&lt;True/False&gt; | The backup subdirectory will not be created if this option is set to "True". The backup will be performed in the &lt;BackupDir&gt; directory.<br>Otherwise, a backup subdirectory will be created.<br>This option is set to "False" by default. |
| /LISTE = &lt;FileName&gt; | Full name of the file containing the list of data files to save. This text file contains one file name per line. It can be created by WDLog ("Save" button).<br>Example: <br><br><pre><code>E:\WD Stock Chart\Exe\Action.FIC <br>E:\WD Stock Chart\Exe\Share2000.FIC<br>E:\WD Stock Chart\Exe\Rate.FIC</code></pre><br> |
...
<a name="saving_all_the_data_files_found_list_ELTPARAGRAPHE000249"></a>
...
| Parameter | Meaning |
| --- | --- |
| /LISTE = &lt;FileName&gt; | Name of the file containing the list of data files to save. This text file contains one file name per line. It can be created by WDLog ("Save" button).<br>Example:<br><br><pre><code>E:\WD Stock Chart\Exe\Action.FIC<br>E:\WD Stock Chart\Exe\Share2000.FIC<br>E:\WD Stock Chart\Exe\Rate.FIC</code></pre><br> |
| /REP=&lt;BackupDir&gt; | Path where the files will be saved |
...
**Example** The following command line saves the data files in the "C:\\MyList.LST" list in the "D:\\Backup" directory. The files currently used will not be saved.
