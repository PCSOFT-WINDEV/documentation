...
All the features in WEBDEV Account Manager can be used via command line. You can:

- [Manage deployment accounts](#NOTE2_1).

- [Manage WEBDEV websites](#NOTE3_1).

- [Manage SOAP and REST web services and WebSocket servers](#NOTE4_1).

- [Migrate accounts, sites and web services](#NOTE5_1).
...
<a name="manage_deployment_accounts_ELTTEXTE000495"></a>
...
<a name="creating_webdev_deployment_account_ELTPARAGRAPHE000172"></a>
...
<a name="modifying_webdev_deployment_account_ELTPARAGRAPHE000190"></a>
...
2. Start WEBDEV Account Manager using the following command line: 
...
<a name="deleting_deployment_account_ELTPARAGRAPHE000206"></a>

To delete an account via a command line, use the following syntax: 
...
<a name="reading_the_information_about_deployment_account_ELTPARAGRAPHE000215"></a>

To read the information regarding an account via a command line, use the following syntax: 
...
<a name="getting_the_list_deployment_accounts_ELTPARAGRAPHE000226"></a>
...
<a name="managing_applications_ELTTEXTE000549"></a>


### Deleting an application
<a name="deleting_application_ELTPARAGRAPHE000239"></a>

To delete an application or a WEBDEV website via a command line, use following syntax:
...
<a name="associating_application_with_webdev_deployment_account_ELTPARAGRAPHE000248"></a>

To assign an application or a WEBDEV website to a WEBDEV deployment account via a command line, use the following syntax:
...
<a name="list_applications_deployment_account_ELTPARAGRAPHE000257"></a>
...
<a name="listing_the_unassigned_applications_ELTPARAGRAPHE000268"></a>
...
<a name="managing_soaprest_web_services_and_websocket_servers_ELTTEXTE000591"></a>


### Deleting a SOAP/REST web service or a WebSocket server
<a name="deleting_soaprest_web_service_websocket_server_ELTPARAGRAPHE000281"></a>
...
<a name="assigning_soaprest_web_service_websocket_server_webdev_deployment_account_ELTPARAGRAPHE000296"></a>
...
<a name="list_soaprest_web_services_websocket_servers_account_ELTPARAGRAPHE000311"></a>
...
<a name="list_unassigned_soaprest_web_services_websocket_servers_ELTPARAGRAPHE000328"></a>
...
<a name="migrating_accounts_sites_and_web_services_ELTTEXTE000633"></a>


### Migrating a user account
<a name="migrating_user_account_ELTPARAGRAPHE000348"></a>
...
### Migrating a WEBDEV website
<a name="migrating_webdev_website_ELTPARAGRAPHE000365"></a>

To migrate a WEBDEV website via a command line, use the following syntax:
...
<a name="migrating_soap_and_rest_web_service_ELTPARAGRAPHE000380"></a>
...
If this parameter corresponds to \*, all the previous versions will be migrated, from the most recent version to the older one. If the web service already exists, it is not replaced.
If this parameter is not specified, only the version before the latest version is migrated.
<a name="NOTE5_3B"></a>


### Migrating a WebSocket server
<a name="migrating_websocket_server_ELTPARAGRAPHE000397"></a>
...
<a name="migrating_everything_ELTPARAGRAPHE000412"></a>
