...
Before starting to import the log files, you must configure the information about the site for which to get the statistics.
...
1. Start WDStatistics (double-click "WDStatistics.EXE"). 
...
7. WDStatistics displays the statistics regarding the imported log files.
