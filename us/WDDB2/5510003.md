...
To use a DB2 database with the Native Access Connector, it is necessary to **import the DB2 table structure into WINDEV or WEBDEV analysis**. 
...
**Note** If you try to read the file directly (function **HReadFirst**function, etc.), the connection associated with the file description in the analysis will be opened automatically.
<a name="NOTE4_2"></a>
