...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003040008&name=ftpremovedir_function&product=WD">See additional examples</a>
...
Name and full (or relative) path of directory to delete. The different path sections are separated by "slashes" ("/").  
...
### Rights of users
<a name="rights_users_ELTPARAGRAPHE000105"></a>
...
<a name="relative_and_absolute_path_ELTPARAGRAPHE000113"></a>
