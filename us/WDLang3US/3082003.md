...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003082003&name=zipcreate_function&product=WD">See additional examples</a>
...
| *zipHeader64* | Allows you to create an archive larger than 4 GB on which [zipChangePath](../WDLang3/3082027.md) can be used.<br><br>By default, this option is not used.<br>**TAR or TGZ (TAR.GZ) archive**: This constant is not available. <br><br>![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This constant is not available. |
...
### Compression level
<a name="compression_level_ELTPARAGRAPHE000258"></a>
...
### Error codes
<a name="error_codes_ELTPARAGRAPHE000270"></a>
...
### Use condition
<a name="use_condition_ELTPARAGRAPHE000287"></a>
