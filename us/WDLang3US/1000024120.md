...
### Chart title
<a name="chart_title_ELTPARAGRAPHE000288"></a>The title of chart axes can be displayed for the different axes.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Titre.gif)
The title of the chart axes is defined by [&lt;Chart&gt;.AxisTitle](../WDLang3/1000024153.md). This function can also be used to set the position of the title.
...
### Initializing fonts
<a name="initializing_fonts_ELTPARAGRAPHE000309"></a>
