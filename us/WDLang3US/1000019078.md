...
Name of an Variable of type [zipArchive](../WDLang3/1000018679.md) corresponding to the archive in which the contents of the directory must be added.
...
### Use conditions
<a name="use_conditions_ELTPARAGRAPHE000528"></a>
...
- **Archives in 7z format**: The archive is entirely compressed whenever **&lt;zipArchive variable&gt;.AddDirectory** is called.
...
**Remark**: If the *zipHeader64* constant is used when creating the archive ([&lt;zipArchive variable&gt;.Create](../WDLang3/1000019160.md)), you will have the ability to create archives exceeding 4 GB.
Reminder: 
...
### Compression level
<a name="compression_level_ELTPARAGRAPHE000577"></a>
...
### Error codes
<a name="error_codes_ELTPARAGRAPHE000590"></a>
...
<a name="adding_file_that_already_found_the_archive_ELTPARAGRAPHE000613"></a>
...
<a name="index_files_the_archive_ELTPARAGRAPHE000623"></a>
...
- The index of the element. (Remark: the index of an element is returned by [SearchFile](../WDLang3/1000026330.md))
