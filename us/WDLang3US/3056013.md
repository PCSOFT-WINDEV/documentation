...
|   |   |
| --- | --- |
| *FTPServer* | A WINDEV FTP server is used. The functions for file management are allowed ([NetSendFile](../WDLang3/3056005.md) and [NetGetFile](../WDLang3/3056025.md) for example). |
...
### Server parameters
<a name="server_parameters_ELTPARAGRAPHE000094"></a>
...
<a name="username_and_password_ELTPARAGRAPHE000123"></a>The &lt;UserName&gt; and &lt;Password&gt; parameters allow the server to check whether the user is authorized or not. The list of authorizations and passwords for the users is available in the WDRPCSRV.INI file found in the directory of the server project. Example of file content:
...
### Receiving messages
<a name="receiving_messages_ELTPARAGRAPHE000133"></a>
