...
`<Result> = HelpFile(<Window name> [, <Name of help file>])`
---
...
- On the file for context-sensitive help defined: 
	...
	- in the window editor ("Help" tab in the description window of window). ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=fichierAide%20-%20HC%20N%B0001.gif)


	- by **HelpFile**. 

- On the help number defined in the control description.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=fichierAide%20-%20HC%20N%B0002.gif)
