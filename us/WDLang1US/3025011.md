...
| *tMultiline* | Height of the text while taking the CR characters into account (automatic or forced by a "Carriage Return"). | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TexteHauteur_multi.gif)<br> |
| *tSingleLine* | Height of a line while only taking the "Carriage Returns" into account. | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TexteHauteur_mono.gif)<br> |
