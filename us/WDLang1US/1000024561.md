...
Draws a section of a circle or an ellipse in a variable of type [picLayer](../WDLang1/1000024604.md).![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) **Caution**: A specific configuration is required to use this function in Linux. For more details, see [The drawings](../WDLang1/3029035.md). 
<a name="Example1"></a>
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RbPortion.gif)
...
For a drawing with opacity ([&lt;picLayer variable&gt;.StartDrawing](../WDLang1/1000024470.md) with the *dWithOpacity* constant) or anti-aliasing ([&lt;picLayer variable&gt;.ChangeMode](../WDLang1/1000024432.md) with the *drawAntiAliasing* constant), the outline is drawn inside the section: therefore, the line is partly combined with the inside of the section. If the line is very thick, it will be displayed in two colors.
<a name="NOTE0_4"></a>
<a name="NOTE0_5"></a>
<a name="NOTE0_6"></a>
