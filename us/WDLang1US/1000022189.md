...
Saves the result of the calculation performed in a Pivot Table control (in a file or in memory). This backup can be reloaded in a Pivot Table control by [&lt;Pivot table&gt;.Load](../WDLang1/1000022181.md).
<a name="Example1"></a>
...
Backup password. If the backup is password protected, this password will have to be specified when the backup is loaded by [&lt;Pivot table&gt;.Load](../WDLang1/1000022181.md). 
...
<a name="saving_and_loading_pivot_table_control_ELTPARAGRAPHE000273"></a>
