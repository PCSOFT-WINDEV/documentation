...
<a name="details_about_the_elements_returned_the_treezone_constant_ELTPARAGRAPHE000150"></a>The following illustration presents the different areas that can be retrieved by the *treeZone* constant.
