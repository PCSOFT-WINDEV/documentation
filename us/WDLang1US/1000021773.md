...
- Color: if the property corresponds to the *ColorUndefined* constant, the color specified during the last call to [dPen](../WDLang1/3029029.md) is used. If this function has not been used, the background color of the rectangle will be used. 

- Thickness: if the property corresponds to the *ThicknessUndefined* constant, the thickness specified during the last call to [dPen](../WDLang1/3029029.md) is used. If this function has not been used, the thickness will be set to 1. 

- Line: if the property corresponds to the *LineUndefined* constant, the type of line specified during the last call to [dPen](../WDLang1/3029029.md) is used. If this function has not been used, the line will be solid.  
