...
- **&lt;Image variable&gt;.DrawChord** is not available in anti-aliasing mode (for more details, see the help about [&lt;Image&gt;.ChangeMode](../WDLang1/1000023997.md)).

- **&lt;Image variable&gt;.DrawChord** is not available for a drawing with management of alpha channel (for more details, see the help about [&lt;Image&gt;.StartDrawing](../WDLang1/1000024326.md)). This function has no effect.
...
**&lt;Image variable&gt;.DrawChord** can only be used to draw a chord: outline only or chord area. To draw a solid figure (portion defined by the center of the circle and the two points on the circle), use [&lt;Image&gt;.DrawSlice](../WDLang1/1000024011.md).
<a name="NOTE0_4"></a>
<a name="NOTE0_5"></a>
<a name="NOTE0_6"></a>
