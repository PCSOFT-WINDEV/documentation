...
**Differences from HFSQL** programming: Using SQL functions to manipulate MariaDB data does not imply importing the file structure into the analysis.. However, the data must be handled by queries only. The content of MariaDB files cannot be read directly.
