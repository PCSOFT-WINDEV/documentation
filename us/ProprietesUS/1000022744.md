...
Number of title-header row to use. The row 1 corresponds to the first row of column title starting from the bottom. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Surentete_ligne.gif)
