...
**Note** It is possible to dynamically instantiate an object in a. The implementation of polymorphism requires the dynamic instantiation. For more details, see [Dynamic instantiation](../POO/6010003.md).

Example object: "FileSource" is an object of the "File" class. For this object, you have the ability to handle the members named "Name", "Extension", etc.
...
**Note** In previous versions, it was only possible to return an object manipulated by a dynamic local variable.
<a name="NOTE3_3"></a>
...
**Note** This is an advanced syntax to be used only in very specific cases. In most cases, the destroy operation is automatic.
