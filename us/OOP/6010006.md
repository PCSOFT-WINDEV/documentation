...
The following information is displayed in the "Project explorer" pane:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Classe_POO%20-%20HC%20N%B0001.gif)
...
- The "full" keyword triggers the immediate copy of HFSQL context.
	Recommended, for example, if the thread needs to take account of current positions in the calling context's data files and queries.
...
It is not recommended to use instances of HFSQL context-independent classes to simulate an alias on a single HFSQL data file, or on a particular record in an HFSQL data file. Copying the HFSQL context involves all the elements (data files, views, queries, connections, etc.) of the context, and can therefore be very time-consuming.
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ProcedurePublique.gif)<br> | Public procedure |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ProcedureProtegee.gif)<br> | Protected procedure |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ProcedurePrivee.gif)<br> | Private procedure |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=MethVirtPublique.gif)<br> | Public virtual method |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=MethVirtProtegee.gif)<br> | Protected virtual method |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=MethVirtPrivee.gif)<br> | Private virtual method |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=MethStatPublique.gif)<br> | Public global method |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=MethStatProtegee.gif)<br> | Protected global method |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=MethStatPrivee.gif)<br> | Global private method |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Constante.gif)<br> | Constant |
