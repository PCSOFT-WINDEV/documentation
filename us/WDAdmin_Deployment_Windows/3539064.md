...
4. If you are creating a Windows account, enter the username and password (you can also generate the password. In this case, don't forget to write it down!).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P6_Configuration%20CCH%E9bergement%20-%20HC%20N%B0005.jpg&type=thumb)
...
| FICHIER | Data file directory for the applications and WEBDEV websites associated with this account. |
