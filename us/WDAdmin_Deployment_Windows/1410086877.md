...
2. Select "Roles" and "Web server (IIS)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Deploie_Win_IIS2008.gif&type=thumb)
...
3. Scroll the displayed characteristics until you reach the roles and features. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Deploie_win_Windows2012.gif&type=thumb)
