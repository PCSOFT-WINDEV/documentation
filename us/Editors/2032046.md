...
- or the order in which items are displayed in the query result: icon ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=OrdreAffichage.gif) (selected by default).

- or the sorting sequence in the query result: icon ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=OrdreTri.gif).
