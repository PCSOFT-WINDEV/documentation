...
**Reminder**: A button with a countdown timer can also be automatically included in the application. For more details, see [Automatic validation](../WDChamp/1013072.md).
...
**Note**: If the text in the system window and the text displayed when defining the countdown timer do not match, the timer will not be displayed.
