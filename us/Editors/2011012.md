...
**Note**: You also launch an **advanced generation of the analysis**. On the "Analysis" tab, in the "Analysis" group, expand "Generation" and select "Advanced generation". This advanced generation is used to define specific parameters:
