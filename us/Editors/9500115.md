...
**In the code**: [AAFDisable](../WDLang1/1000022018.md) (or [DisableAAF](../WDLang1/3013061.md)) with the *aafSaveValue* constant deletes the "Remember value" option from the context menu of the specified List Box or Combo Box control.

**Note**: You can also save the value via the "Remember value" option in the control description window ("Details" tab). This option is used to save the value even if the menu option was not enabled by the user. The menu option has priority if it was enabled by the user. 
...
**In the code**: [AAFDisable](../WDLang1/1000022018.md) with the *aafFindInCombo* constant disables the search for the specified Combo Box control.

**Note**: It is also possible to offer a search box by default in the list of a Combo Box control via the "With search" option, in the control description window ("Details" tab). This option can also be enabled by the [SearchAAF](../Proprietes/1000023445.md) property. 

<a name="NOTE4"></a>
<a name="NOTE4_1"></a>


## Copying a row or all rows
<a name="copying_row_all_rows_ELTTEXTE000356"></a>
