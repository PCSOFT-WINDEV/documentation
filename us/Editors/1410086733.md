...
Therefore, it is essential to precisely identify the actions of users regarding personal data: the simple access (if allowed), the reason and the creation of a history.
