...
**Note**: The "System transparency in Vista (Aero)" option lets the system handle transparency if the display mode used is "Aero". We recommend that you use this option if you are using the ActivVista and ActivVista Lite skin templates. This option is not recommended if you are using other skin templates.
<a name="NOTE2_2"></a>
