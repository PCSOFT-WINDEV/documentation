...
4. Click the "Modify" button. The style description window appears.
	**Note** The "Modify" button is grayed out if the selected style belongs to a non-modifiable style sheet (e.g. a skin template style sheet).
...
4. Click the "Delete" button and confirm the style deletion.
	**Note** The "Delete" button is grayed out if the selected style belongs to a non-modifiable style sheet (e.g. a skin template style sheet).
