...
2. In the window that appears, press the desired keys. The selected keys appear: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Choix%20d'un%20raccourci.jpg)
