...
2. Start the file description generation wizard: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) On the "Window" tab, in the "Edit" group, expand "Other actions" and select "Generate a data file description". You can also select "Generate a file description" in the context menu of the window. 

	- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) On the "Page" tab, in the "Edit" group, expand "Other actions" and select "Generate a file description". You can also select "Generate data file description" in the context menu of the page.
...
3. Specify:
	...
	- the caption of the data file that briefly describes the subject. By default, this caption corresponds to the title of the window or page.
...
7. The wizard presents the description of the data file to be generated. Validate.
...
All controls in the window or page that can be bound to an item (Edit, Radio Button, Table control etc.) can become items in the generated data file description.
