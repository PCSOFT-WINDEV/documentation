...
- Word ends with: the expression searched for ends with the expression entered.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Rechercher_avec.gif)
...
- on the UI: it is possible to take into account or ignore: 
	...
	- Data files and fields: this option corresponds to the data files described in the analysis, the description of each data file and the description of the fields. 
...
- all classes that use the "Client" HFSQL data file, 
...
3. Select the item type you want to search for: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Recherche_dans_les_editeurs_2%20-%20HC%20N%B0002.gif)
...
To store the current search, click the lock found in the upper-right corner of the search window: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Recherche_verrouillage.gif)
<a name="NOTE5_4"></a>
