...
## Reminder
<a name="reminder_ELTTEXTE000286"></a>
...
<a name="configuring_the_setup_program_ELTTEXTE000310"></a>
...
<a name="setting_was_performed_ELTPARAGRAPHE000078"></a>
...
<a name="the_setup_program_was_already_configured_ELTPARAGRAPHE000103"></a>
...
<a name="customizing_the_default_setup_program_the_steps_ELTTEXTE000346"></a>
...
- **Step 4**: [Customize the interface of the setup program](../Editeurs/2028030.md).
...
- **Step 9**: [Configure the automatic data file modification](../Editeurs/2028018.md).
...
- **Step 14**: [Configure the directory of data files and the directory of data files for the User Groupware](../Editeurs/2028017.md).

- **Step 15**: [Configuring Reports & Queries](../Editeurs/2028088.md). 

- **Step 16**: [Translating the uninstaller](../Editeurs/2028087.md).

- **Step 17**: [Uninstall patches](../Editeurs/2028102.md).
...
**Note**: The order of the above steps is not mandatory. All the steps (except for the generation of the setup program) are optional.
