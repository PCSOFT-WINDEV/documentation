...
3. Double-click the style (or select "Skin-template description" in the context menu).
...
**Warning** When WINDEV is updated, changes made to skin template style sheets may be overwritten. If modifications are performed in the style sheets of skin templates, we advise you to make a backup copy of the modified files.
<a name="NOTE3_2"></a>
...
**Warning** When WINDEV is updated, style imports into skin template style sheets may be overwritten. If modifications are performed in the style sheets of skin templates, we advise you to make a backup copy of the modified files.
...
Note: If your project is associated with several skin templates, the default style will be selected in the following order:
