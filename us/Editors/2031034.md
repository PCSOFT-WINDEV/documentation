...
3. Menu items used for specific RAD options must have a specific name: "MENUFIC_XXX" (e.g. MENUFIC_RADFileA). The menu options with this name will be duplicated for each file of the analysis.
