...
- Copy the name of data file into a Static Text control.
...
- **Analysis file or item** One or more data files or analysis items have been placed on the clipboard. If this option is selected, one or more controls will be created in the current window. 
