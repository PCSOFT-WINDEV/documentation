...
<a name="different_types_setup_for_windev_application_ELTTEXTE000271"></a>
Several types of setup are available:

- **Setup from a Private Store**: 
...
<a name="how_create_setup_program_ELTTEXTE000295"></a>
To create a setup program allowing you to:

- ***deploy a WINDEV application***, you can:

	- or use [the setup program creation wizard](../Editeurs/2028062.md) directly from WINDEV: in the "Project" pane, in the "Generation" group, pull down "Setup procedure" and select "Create installation procedure".. This wizard allows you to easily create the three types of setup programs.

	- or use [the setup editor (WDInst)](../Editeurs/2028042.md): under "Tools", in the "Utilities" group, click on "WDInst".. This editor is used to customize the setup program.
...
<a name="how_install_windev_application_ELTTEXTE000319"></a>


### Principle for the standard or compact setup
<a name="principle_for_the_standard_compact_setup_ELTPARAGRAPHE000133"></a>
...
<a name="principle_for_the_network_setup_ELTPARAGRAPHE000153"></a>
...
### Silent installation
<a name="silent_installation_ELTPARAGRAPHE000188"></a>
