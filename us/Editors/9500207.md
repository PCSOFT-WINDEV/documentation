...
In any case, simply describe the database structure in the analysis.

The connections are used to link the description of a data file with the real data. For example, when importing a data file from an external database into the data model editor, a connection is automatically created.

Connections are created:

- when importing a data file that belongs to an existing database. For more details, see [Using an external database](../Editeurs/2011025.md).

- from the data model editor. In this case, go to the "Analysis" tab, "Connection" group, and click "Connections".
...
[Importing data files into the analysis (external database, etc.)](../Editeurs/2011025.md)
