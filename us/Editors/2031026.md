...
- A table: This table is a data-bound table, with file loaded in memory.
...
Example: Table window on RADFileA of the simple RAD pattern: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Pattern_RAD_WDTable.gif)
