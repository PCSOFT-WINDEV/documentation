...
An external component can be reused at any time in any application: all you need to know is the external component's file directory.

This help page explains how to:

- [Include an external component in an application](#NOTE2_1).

- [Handle the elements of an external component programmatically](#NOTE3_1).
...
## Handle the component elements programmatically
<a name="handle_the_component_elements_programmatically_ELTTEXTE000345"></a>
...
<a name="note_the_technical_documentation_for_the_ELTPARAGRAPHE000137"></a>
...
**Please note** if a project element and a component element have the same name, to use the component element, you must prefix the element with the component name.
...
2. The full name must be used to identify the procedure and this name must be followed by brackets to indicate that a procedure must be used (instead of a global variable): 
	...
	**Note**: You can also use the [Execute](../WDLang1/3013041.md) function:
...
- ** When a new version of a component is available**, all you have to do is install the new files of this update in the installation directory of the component (according to the setup mode used). For more details on the different modes to install a component, see [Distributing a component](../Editeurs/2014007.md).
