...
If no web server is detected when installing WEBDEV 2026, the IIS Express version 10 web server is automatically installed and configured for WEBDEV on the current computer. 
...
- The port used for the dedicated Web server is 80xx, where xx is the major version of WEBDEV.. For example, with WEBDEV 2026, the port used is 8031.
