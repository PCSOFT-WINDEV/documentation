...
2. In the SCM administrator, on the "Tools" tab, in the "Mobility" group, click "Rename or change computer".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GDS_Admin%20-%20HC%20N%B0009.gif)
