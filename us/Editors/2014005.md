...
**Note**: When an external component is distributed via the installation program, the WDO file is automatically created. For more details, see [Distributing an external component with a WDO file](#NOTE3_1).
