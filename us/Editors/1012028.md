...
The use of external JavaScript objects does not necessarily require the use of the JavaScript language: programming can be done in WLanguage
...
1. Include the programming interface of Google calendar in the page.
	...
	- Go to the "Advanced" tab of the page description.

	- On the "HTML" tab, add the following line of code into the HTML code of the page header: 
...
This code is supplied in the Google documentation. 
	...
	- On the "JavaScript" tab, click the "Add a Web resource" button. Enter the address used to include the calendar service: 
