...
- the installation directory of the file. The following shortcuts can be used:
	...
	- **&lt;RepWin&gt;**: Windows directory on user workstations.

	- **&lt;FicInst&gt;**: directory for data file installation. The setup program creation wizard allows you to configure this directory. For more details, see [Configuring the data file directory](../Editeurs/2028086.md).
...
<a name="hfsql_tab_for_the_executables_and_the_data_files_only_ELTPARAGRAPHE000211"></a>
...
- **Uses the common WINDEV framework**. Use the common framework installed on the user computer. If this common framework is not installed, it will be downloaded by the user.
