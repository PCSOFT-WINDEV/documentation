...
The "Project Explorer" pane displays all existing automation tests on the various project elements ("Tests" folder).  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Gestionnaire%20de%20tests%201%20-%20HC%20N%B0001.gif)
...
<a name="element_test_list_management_window_ELTPARAGRAPHE000054"></a>Below is the window for managing the automated tests of an element:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Gestionnaire%20de%20tests%201%20-%20HC%20N%B0001%201.gif)
...
- "Details": Allows you to specify (in the case of a window): <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Gestionnaire%20de%20tests%202%20-%20HC%20N%B0002.gif&type=thumb)
