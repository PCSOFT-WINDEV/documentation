...
- [opening **a full help**](#NOTE2_1): used to open the help file (displays the summary). 
	In most cases, this is done through a menu option (e.g. "? .. Help").
...
**Note:** To automatically create a help button that displays the page corresponding to a window, drag the help page and drop it onto the desired window.
