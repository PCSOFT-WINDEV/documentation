...
2. Go to the "Version" tab of the "File description" window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Parametrer_caract_installation_fichier%20-%20HC%20N%B0003.gif)
