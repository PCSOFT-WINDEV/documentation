...
- **How to create it**: Help editor: Click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_nouveau.gif) among the quick access buttons. The window for creating a new element appears: click on "Architecture", then on "Help".
