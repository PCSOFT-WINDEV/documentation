...
**Note** If the parameterized query is used in a report, the way parameters are passed varies. For more details, see [How to use a query with parameters in a report](../Editeurs/2032032.md).
...
<a name="using_the_notation_ELTTEXTE000194"></a>


### Syntax to use
<a name="syntax_use_ELTPARAGRAPHE000035"></a>
...
- The parameters are reinitialized (reset to 0) whenever the query is run by [HExecuteQuery](../WDLang4/3044080.md).
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) All the expected parameters must necessarily be entered.

<a name="NOTE2"></a>
<a name="NOTE2_1"></a>


## Use HExecuteQuery to pass parameters to a query
<a name="use_hexecutequery_pass_parameters_query_ELTTEXTE000218"></a>


### Syntax to use
<a name="syntax_use_ELTPARAGRAPHE000073"></a>
...
- To specify the query parameters, you must specify the initialization mode of query.
...
<a name="avoid_specifying_all_the_parameters_ELTTEXTE000242"></a>


### Unspecified query parameters
<a name="unspecified_query_parameters_ELTPARAGRAPHE000094"></a>
...
Example: The query "REQ_Clients_name_firstname" has the following SQL code:
...
[Query with parameters ](../Editeurs/2032045.md)
