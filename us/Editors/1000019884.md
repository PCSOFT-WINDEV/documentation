...
![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png) **Application associated with an Apple Watch application** Two additional identifiers must be created: 
...
For example, if the identifier of the iOS application is com.pcsoft.MyApp, create the identifiers: 

- com.pcsoft.MyApp.watchkitapp

- com.pcsoft.MyApp.watchkitapp.watchkitextension.
...
![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png) **App associated with an Apple Watch app**: Also create a profile for the two additional identifiers "&lt;iOS app identifier&gt;.watchkitapp" and "&lt;iOS app identifier&gt;.watchkitapp.watchkitextension" created in the previous step.
...
![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png) **Application associated with an Apple Watch application** RepeatString for the two additional profiles created for the Apple Watch application.Note: On the MAC compilation machine, don't forget to install the private key generated when you purchased the developer license.
<a name="NOTE2_4"></a>
