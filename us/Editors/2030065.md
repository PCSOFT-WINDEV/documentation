...
1. Generate the executable and the 32-bit setup procedure. 
	...
	- Generate the executable and the 32-bit installation procedure: click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=generation_32%20-%20HC%20N%B0001.gif) among the quick access buttons. 
...
2. Generate the executable and the 64-bit setup procedure. 
	...
	- Generate the 64-bit executable and installation procedure: click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_generation_exe64.gif) among the quick access buttons. 




3. Generate the combined installation: under the "Project" pane, in the "Generation" group, click on "Setup procedure" and select "Generate a 32/64-bit combined installation".. The following window appears:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Install_combinee.gif&type=thumb)
