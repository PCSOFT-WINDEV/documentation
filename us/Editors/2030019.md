...
All the elements of a project (windows, reports, classes, sets of procedures, queries, etc.) can be transferred from one project to another. The export enables you to copy the elements of the current project into another directory (and therefore into another project).
