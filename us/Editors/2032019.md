...
4. Choose the selection criteria (equal to, greater than, ...) of the condition. This condition can relate to a given value, a parameter, the records selected by another query, etc. In the case of a date-type field, the selection condition can relate to a predefined date (current year, current month, today).
	**Note** You can select a given value using the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=OrdreAffichage.gif) icon. The following menu is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Requete_MenuVisuValeur.gif)
You can:
...
To add, modify or delete a selection condition in a select query, click the condition column of query items and select the operation to perform in the following menu: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Requete_MenuconditionSelect.gif)
