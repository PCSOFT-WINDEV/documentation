...
WEBDEV and WINDEV allow you to print to PDF in Linux using WLanguage functions. You can do: 
...
- **QT library (Core and GUI), minimum version 5.**
...
- **the LibFreeType.so library (32 or 64-bit), version 6 or later.**
	**Attention** The PC SOFT framework is looking for the libfreetype.so library. If only the libfreetype.so.6 file exists, you must create a symbolic link via the following command:
...
**Note** It is possible to install Microsoft fonts under Linux, to obtain subreports more faithful to their Windows counterparts. Under Ubuntu, these fonts can be added by following the procedure below: [http://doc.ubuntu-fr.org/msttcorefonts](http://doc.ubuntu-fr.org/msttcorefonts).

**Note** Supported Linux distributions include:
...
<a name="limitations_report_fields_supported_linux_ELTPARAGRAPHE000102"></a>
...
- **[Step 1 (optional)](#NOTE3_2)**: Configuration of printing parameters.

- **[Step 2 (optional)](#NOTE3_3)**: Creation of print font(s) (optional).

- **[Step 3](#NOTE3_4)**: Print characters, lines or images and end printing.

- **[Step 4](#NOTE3_5)**: Start printing.
...
**Warning** The sequence of operations described above must be followed. If a print is in progress, [iParameter](../WDLang5/3046008.md) cancels the current print.
<a name="NOTE3_3"></a>
...
<a name="step_3_printing_characters_and_images_ELTPARAGRAPHE000214"></a>
...
**Note** Image printing: In Linux, images in JPEG, BMP, PNG and GIF formats can be printed.
<a name="NOTE3_5"></a>


### Step 4: Start printing
<a name="step_4_start_printing_ELTPARAGRAPHE000237"></a>
...
| [iConfigureReport](../WDLang5/3046076.md) | Configure the printer by opening the configuration window directly (WINDEV and WINDEV Mobile). |
...
| [iSkipPage](../WDLang5/3046073.md) | Forces a page skip: the corresponding code is sent to the printer spooler. |
...
**Note** Functions of type **iImprimexxx** functions only work with the latest Linux distributions. 


## Voir aussi

[Printing in WLanguage](../Editeurs/3046012.md)

[How do I develop a site for Linux? ](../Editeurs/9000055.md)

[Printing to PDF](../Editeurs/1011091.md)

[Printing a report in WEBDEV](../Editeurs/1011073.md)

[Printing a report in WINDEV](../Editeurs/1011072.md)
