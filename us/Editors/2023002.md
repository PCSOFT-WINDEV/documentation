...
The dictionary is a file that can contain elements of the project: descriptions of data files, controls, windows, etc. The dictionary is a convenient way to store the created elements so that they can be re-used in new projects.
...
You can associate a dictionary with a user. It is referred to as a **user dictionary**. In this case, it can be permanently displayed in the "Dictionary" pane. 

**A dictionary can also be used to simplify teamwork.** A dictionary shared between several developers can contain preset procedures, buttons, etc. These objects are shared and they can be accessed by all the developers.
...
The dictionary is a file containing a set of elements such as procedures, windows, controls, etc. A dictionary can be manipulated from the "Dictionary" pane.
...
- Recreate the dictionary in WINDEV 2026.
...
[Handling a dictionary ](../Editeurs/2023003.md)

[Subscribing an element to the dictionary ](../Editeurs/2023001.md)
