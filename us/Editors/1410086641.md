...
- **Legacy Responsive Web Design**, which allows you to divide pages into resolution ranges or "slices" to adapt to mobile devices. 
	...
	From version <B><B><B><B>28</B></B></B></B>, this mode is not recommended and is kept for compatibility purposes only.
...
<a name="the_different_methods_detail_ELTTEXTE000206"></a>
...
<a name="new_edit_mode_for_mobilefriendly_websites_version_28_ELTPARAGRAPHE000097"></a>
...
**Due to its numerous advantages, "Responsive (zoning and layouts)" is the recommended mode from WEBDEV 28 onwards**. It is possible to convert an existing page in "Responsive Web Design: page layout by slice" mode, into a "Responsive (zoning and layouts)" page: under the "Page" pane, in the "Layouts" group, pull down "Layouts" and select the "Convert slices to layouts" option.
...
[Creating a Responsive Web Design page](../Editeurs/9000168.md)
