...
- **Tooltip with the description of the parameter being hovered over**. This tooltip appears: 
	...
	- if Alt + F1 is used on a parameter that is already typed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=saisie_assist.gif)
...
- **Tooltip with the description of the result**. This tooltip appears: 
	...
	- if Alt + F1 is pressed on the name of a function that is already typed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=saisie_assist_result.gif)
