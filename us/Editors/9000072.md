...
2. Open the description window of the procedure automations:
	...
	- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_procauto.gif) in the procedure bar.
...
The procedure can:
	...
	- **use HFSQL or not** This option allows you to specify whether the thread should access HFSQL data files. 
