...
2. Display the analysis linked to the project: click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ico_Analyse.gif) among the quick access buttons.
