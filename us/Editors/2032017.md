...
After its execution in test mode (see [Query test](../Editeurs/2019011.md)), the result of the query can be: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Requete_ResultatTestRequete.gif)
...
<a name="exporting_the_result_hfsql_data_file_ELTTEXTE000242"></a>
For the next operation, we consider that the query result is displayed.
