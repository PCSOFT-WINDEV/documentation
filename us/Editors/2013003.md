...
2. On the "Code" tab, check "Convert the code to" and select the translation language.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Coller-Code.gif)
