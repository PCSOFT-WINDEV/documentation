...
3. In "Platform description", add "iPhone14" and delete "Generic iPhone" if necessary. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Dynamic_Island%20-%20HC%20N%B0001.gif)


4. Confirm the 2 windows. 

5. The window editor now shows a Dynamic Island-like notch.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Dynamic_Island%20-%20HC%20N%B0002.gif)
