...
When a WINDEV, WEBDEV or WINDEV Mobile element (analysis, query, etc.) cannot be entirely displayed in the workspace, the "Browser" pane allows you to easily move within this element.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FenNavigateur.gif&type=thumb)
