...
### Use
<a name="use_ELTPARAGRAPHE000063"></a>To work on a project element (window, page, etc.), the developer must check out the element from the repository, modify it and check the element back in.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GestionnaireDeSources_synch.gif)
