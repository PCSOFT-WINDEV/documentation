...
The configuration diagnostics displays the following error: "Application: Version of files in virtual directory"..<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WebDev_Virtuel.gif)
