...
- External components. 
	 **Note** Internal components are available for Android development. However, if the internal component includes an analysis, this analysis will be ignored during the execution.
...
- SQLite database: If your Android project shares its analysis with another (non-Android) project, you can use the [HChangeConnection](../WDLang4/3044150.md) function to associate the application's data files with an SQLite connection. For more details, see [Android application: Using and sharing data](../Editeurs/9000123.md). 
