...
The principle behind JITc (Just In Time Compilation) technology is very simple: WINDEV's L5G code is transformed on the runtime machine into "native assembly code" as it is executed.. For more details, see [JITc](../Editeurs/2020009.md). 
...
- PathDLL: path to wd310test.dll library. This DLL is required to create the scenario.
...
It is possible to audit an application in its production environment without modifying the executable: simply create a file in the same directory as the executable, with the same name and ".WX" extension.
...
- **Active**: This parameter must be 0 to disable the log and 1 to enable it.
...
<a name="disabling_the_telemetry_application_ELTTEXTE000524"></a>
...
[Runtime log](../Editeurs/2019030.md)

[Automated test created by the user](../Editeurs/2019031.md)

[Dynamic audit](../Editeurs/1014502.md)

[JITc](../Editeurs/2020009.md)
