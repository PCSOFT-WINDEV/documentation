...
- You can enter a keyword directly in the pane: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=VoletCatalogueimage%203.gif). 
	You can select a theme via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=VoletCatalogueimage%201.gif) button. The search starts automatically when you press Enter.
