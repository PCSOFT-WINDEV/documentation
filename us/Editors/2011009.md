...
2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Manipulations_rubriques%20-%20HC%20N%B0001%2013.gif). The item is automatically duplicated. Its name is the name of the original item suffixed with a number.
...
- The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Manipulations_rubriques%20-%20HC%20N%B0001%2012.gif) button or the "Cut" option in the field's context menu can also be used to delete the field. 
...
<a name="sorting_the_items_displayed_the_data_file_description_ELTTEXTE000316"></a>
...
3. Use the funnel in the "Name" column (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Manipulations_rubriques%20-%20HC%20N%B0001%206.gif)) to perform a search: simply click on the funnel and enter the letters of the heading you're looking for. All matching items will be displayed.  
