...
- [a context menu proposing the "Calculator" option](#NOTE2_1). 
...
**Note**: [AAFDisable](../WDLang1/1000022018.md) with the *aafModifyInputValueWithWheel* constant deletes the AAF for the specified Edit control or for all Edit controls.
...
[CalculatorButton (Property)](../Editeurs/1000020009.md)
