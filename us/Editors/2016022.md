...
4. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Police_perso_WB_6%203.gif) to create a new font set. 

5. In the wizard that starts, you must select the different fonts that make up the font set. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Police_perso_WB_3.gif)
You can: 
