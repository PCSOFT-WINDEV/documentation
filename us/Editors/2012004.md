...
**Reminder** By default, the installation program automatically selects all files in a project's "EXE" sub-directory, with the exception of data files (".FIC", ".NDX", ".MMO"). For more details, see [Setup program](../Editeurs/2028001.md).
