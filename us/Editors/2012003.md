...
4. Copy the generated assembly into the directory of shared assemblies of Windows:
	...
	- Copy the wd310net.dll library to "c:\\Windows\\Assembly" (otherwise, the instantiation of the COM object will fail and will throw the "file not found at the specified location" error).

	- Make sure the wd310vm.dll file is in a directory specified in PATH.
