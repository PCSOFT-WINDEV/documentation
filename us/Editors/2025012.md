...
- Library contained in the executable file. This the most common option. The WDP file corresponding to the library is included in the executable. 

- Library used externally. In this case, the library file is a WDL file generated outside the executable. 
...
## Generating the library and selecting the library elements
<a name="generating_the_library_and_selecting_the_library_elements_ELTTEXTE000133"></a>
The library and the current project will have the same name. You can:

- **Change the library name**. Simply edit the name directly. 
