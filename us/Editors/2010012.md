...
- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Helpfortheuser.gif) ***Unit examples (WINDEV)*** : **Help for the user** <br>Using messages and tooltips to simplify the work of the application users.
