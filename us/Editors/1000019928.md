...
3. On the "General" tab, check "Allow the application to run on macOS Catalina or later (Mac Catalyst)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=catalyst%20-%20HC%20N%B0001.gif)
