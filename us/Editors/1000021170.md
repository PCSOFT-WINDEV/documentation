...
When a project uses the user groupware with a custom login interface, an internal component named "WDGPU_WD" is automatically integrated into the project.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GPU_Personnaliser_WD_Connexion%20-%20HC%20N%B0001.gif)
...
When a project uses the user groupware with full customization, an internal component named "WDGPU" is automatically integrated into the project.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GPU_Personnaliser_WD_Complet%20-%20HC%20N%B0001.gif)
