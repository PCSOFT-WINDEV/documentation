...
The CustomMenu allows you to create a custom menu in the menu bar of WINDEV, WEBDEV and WINDEV Mobile. This lets you add shortcuts to your favorite applications (Calculator, etc.), open different files (Charter, etc.) and more..<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=PersoMenu18.gif)
