...
The ribbon includes several areas: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Environnement%20WD%20-%20HC%20N%B0003.jpg)
...
The quick-access buttons let you perform some of the most common operations to all editors: save, open, create, etc.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Environnement%20WD%20-%20HC%20N%B0003%201.jpg)
...
2. Select "Customize quick access buttons". The following window appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ruban_personnaliser.gif&type=thumb)
In this screen: 
...
The different ribbon tabs allow you to access the options of the editors. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Environnement%20WD%20-%20HC%20N%B0003%202.jpg)
...
2. As soon as a word is typed, the editor automatically proposes the possible options associated with this word. In the example below, the sought word is "table": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ruban_recherche_option.gif)
...
The options are grouped by tabs in groups of options.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Environnement%20WD%20-%20HC%20N%B0003%203.jpg)
