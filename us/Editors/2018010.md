...
- **default integration** all User Groupware programming is automatically integrated into your application.
...
- **customizable integration** all User Groupware programming is automatically integrated into your application. 
...
<a name="the_different_pages_user_groupware_ELTPARAGRAPHE000129"></a>
...
**Note**: the operation of these pages is described in detail in paragraph [Configuring the User Groupware](../Editeurs/2018006.md).
...
**Important** If your site is a **WEBDEV Linux**site, you need to integrate the User Groupware pages into your site (customizable integration).
