...
6. If the control templates or the page templates are already found in the project, these elements are automatically reused by the imported template. 
...
7. If the control templates or the pages templates are not found in the project: 
	...
	- If library and template sources are unavailable, or if import has been refused, the page is reverse-analyzed: the necessary page and field templates are automatically created and associated with the page.
...
2. On the "Project" tab, in the "Project" group, expand "Import" and select "An HTML page".
	**Remark**: It's also possible to drag and drop the page directly into WEBDEV's page editor.
...
6. If the control templates or the page templates are already found in the project, these elements are automatically reused by the imported page. 

7. If the control templates or the pages templates are not found in the project: 

	- If the source of the libraries and templates is available, the import of these elements is automatically proposed.

	- If the source libraries and templates are unavailable, or if the import has been refused, the page is reverse-analyzed: the necessary page and field templates are automatically created and associated with the page.
