...
4. The "Enable password encryption" button is displayed in the management window (upper-right corner). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GPU_Cryptage.gif)
