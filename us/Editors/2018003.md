...
- configure the rights required by the user of your application before creating the installation program. then, all you have to do is add the groupware files when creating the setup procedure of the application
