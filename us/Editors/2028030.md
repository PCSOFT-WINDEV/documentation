...
**Note** Customization of decor, skin template and slide selection may differ depending on the language in which the installation program is run.
...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CERCLE2.GIF)<br> | Enter the **title of the background window**. This title will be displayed in the title bar of the window.<br>For example, enter the application role: "Stock management". |
...
<a name="customize_the_skin_template_the_wizard_ELTTEXTE000265"></a>
