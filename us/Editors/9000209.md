...
**Note**: To switch back to WLanguage code, simply click "Kotlin" in the procedure header and select "WLanguage".
<a name="NOTE2_2"></a>
...
- Note: You need to import the classes used in the native Kotlin code with the "Import" keyword. It is recommended to import these elements before declaring the method. 
