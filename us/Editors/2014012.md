...
3. To configure the debug mode of the current component, go to the "Project" tab, "Test mode" group, expand "Test mode" and select "Test mode settings".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Composant_debog.gif)
...
**Note**: You can choose whether or not to use the runtime context of the "client" project in the component options:

1. Open the "Component" configuration description window. In the "Project explorer" pane, open the context menu of the component configuration and select "Description". 
