...
**Note** To return to WLanguage code, simply click on "Java" in the procedure banner and select "WLanguage".
<a name="NOTE2_2"></a>
...
- The parameters of procedures written in Java must be of a primitive type (integer, real, string, etc.). 
	Note: The float type is not supported, it can be replaced with the double type.
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Specific features for Android: 
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) The Java classes used in the native Java code must be specified in the Android application generation wizard: 
	...
	- "Integrate Maven dependencies" step for Maven dependencies. 
			 Note: These classes cannot be tested via the GO option. The application must be generated and launched. 
...
- **Automatic recognition of external classes** Java classes are automatically taken into account when the application is generated: 
...
[Android and Java: Calling WLanguage procedures](../Editeurs/9000199.md)
