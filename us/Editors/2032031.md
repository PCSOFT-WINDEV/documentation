...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Cercle1.GIF) | List of select queries that can be used in the combining query.<br>**Note**: To select multiple queries, hold down the Ctrl key. |
...
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Cercle6.GIF) | List of result items for the combining query.<br>**Reminder**: These items correspond to the items in the first query run. |
