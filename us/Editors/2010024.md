...
To create a page header, simply check the "This page contains a header" box and specify its height (in pixels).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=zoneEntete_description.gif)
