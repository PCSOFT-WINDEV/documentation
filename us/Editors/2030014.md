...
1. On the "Project" tab, in the "Other actions" group, expand "More actions" and select "Make a project backup". The archiving wizard starts.
...
4. Finish the wizard. The archive file (or the copy of the project) is created in the specified directory.
...
To restore a backup or backup file, on the "Project" tab, in the "Other actions" group, expand "More actions" and select "Restore a project". For more details, see [Restoring a project](../Editeurs/2030038.md).
