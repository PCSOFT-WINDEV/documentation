...
- if a comment is required, a toast is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GDS_NonRespect.gif)


- if one of the other conditions is not met, the following window appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GDS_Politique%20-%20HC%20N%B0003.gif)
