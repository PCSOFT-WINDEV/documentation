...
**Note**: In the case of windows and reports, it is necessary to create stand-alone windows and reports. This means you need integrate the compiled code into the window or report file).
...
**Note**: If the report is modified, you must create the executable again to reflect changes.
