...
**Note**: When the executable file is run, the libraries (".DLL" files) are automatically extracted and replace the existing files. These replacements may trigger problems if several WINDEV applications are installed on the same computer.
