...
4. If a page or a state is authorized for the group or for the user, it is then possible to define the state of each field, button, menu, menu option, etc. Simply click on the page line. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Groupware%20utilisateur%20-%20HC%20N%B0008.jpg&type=thumb)
