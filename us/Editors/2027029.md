...
The "Project Explorer" pane also lists the project's global variables and the data files and fields in the analysis.
<a name="NOTE2_3"></a>
...
<a name="managing_the_analysis_ELTPARAGRAPHE000098"></a>
...
Data files (HFSQL data files, images, sounds, etc.) can be included directly in the generated executable or archive. This allows you to use resources that must not be visible on the disk of the end user. 
