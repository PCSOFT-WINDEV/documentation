...
Note: palette colors are accessible via programming (function [ColorPalette](../WDLang2/1000019905.md)). This allows you to create a generic code, independent of the skin and palette used.
