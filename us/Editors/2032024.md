...
1. On the "Display" tab, in the "Editing help" group, check "Print areas". A series of borders that represent the printable areas in the technical documentation will appear in the query editor.

2. Reduce the display of graphic representation: on the "Display" tab, in the "Editing help" group, modify the "Zoom" value (or use Ctrl + Mouse wheel) to see the entire query.
