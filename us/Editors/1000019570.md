...
Here is a preview of the action plan editor:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Plan_Action_Description.gif&type=thumb)
...
The action for launching an IDE via an action plan offers multiple settings in the "General" tab of the description window:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Plan_Lancement_produit%20-%20HC%20N%B0001.gif&type=thumb)
