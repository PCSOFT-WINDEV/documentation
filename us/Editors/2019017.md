...
To configure the test mode, go to the "Project" tab, "Test mode" group, expand "Test mode" and select "Test mode settings".

For more details on the different options, see [Test mode options](../Editeurs/2019020.md).
