...
<a name="configuring_the_automatic_data_file_modification_wdinst_ELTTEXTE000216"></a>
...
<a name="running_the_automatic_modification_windev_data_files_ELTPARAGRAPHE000037"></a>
...
6. In the "List of setup files" window, select the executable file (".EXE") on which the automatic data file modification must be performed. On the "HFSQL" tab, check "Manage automatic data modification". 
...
**Note** If automation is to be performed on data files used by several ".EXE" files, repeat the operations for all ".EXE" files concerned.
<a name="NOTE2_3"></a>


### Running the automatic modification of Hyper File 5.5 data files or migrating from Hyper File 5.5 to HFSQL Classic
<a name="running_the_automatic_modification_hyper_file_55_data_files_migrating_from_hyper_file_55_hfsql_classic_ELTPARAGRAPHE000075"></a>
...
<a name="updating_application_with_automatic_data_file_modification_ELTTEXTE000252"></a>
When installing an update with automatic modification of data files, the user can configure automatic modification: an "Advanced options" button is displayed in the foreground of the installation program.. The following window is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Param%E9trer_modif_auto_des_fichiers%20-%20HC%20N%B0001.gif&type=thumb)
...
**Remark**: When updating, the data files automatically found are:
...
<a name="making_the_advanced_button_invisible_ELTPARAGRAPHE000136"></a>
