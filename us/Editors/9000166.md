...
- **Show a UI compilation error when the window skin template is not up to date**: Used to display (or not) a specific UI error if the skin template is not udpated. 
