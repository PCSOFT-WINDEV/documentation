...
- how the groups of data files are manipulated programmatically. 
	For example, you can change the connection for all the data files in a Custom-Folder with [HChangeConnection](../WDLang4/3044150.md). To do so, simply specify the name of the Custom-Folder to be manipulated directly in the WLanguage function (see the list of available functions below). 
	This feature is available for HFSQL Classic, HFSQL Client/Server data files and data files manipulated by Native Connectors. 




These groups are defined in the ["Analysis" pane](../Editeurs/2027012.md) or in the analysis graph. These Custom-Folders are not physically created.
...
## Handling Custom-Folders in the analysis
<a name="handling_customfolders_the_analysis_ELTTEXTE000212"></a>
...
- associate a data file description with a Custom-Folder.

- disassociate a data file description from a Custom-Folder.
...
To associate a data file description with a Custom-Folder:

1. Select the description of the data file you want to associate with the Custom-Folder.
...
To dissociate a data file description from a Custom-Folder:

1. In the "Analysis" pane, select the description of the data file you want to dissociate.

2. Right-click to open the context menu and select "Remove from Custom-Folder". 

3. The data file description is automatically dissociated from the Custom-Folder.
