...
2. Open the context menu of the arrow in the procedure banner (right-click) and select "Create an associated test".. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Test_auto_proc%20-%20HC%20N%B0005.gif)
