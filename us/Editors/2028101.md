...
<DIV class="specObsolete">
	...
	From version <B>30.2 (2018)</B>, this feature is no longer available.
</DIV><a name="NOTE1"></a>
<a name="NOTE1_1"></a>
...
PC SOFT can host your test sites. The setup is very easy and can be started directly from the environment. 

Once the site is developed, you can test it directly. 
...
- You have the ability to deploy web services. 
...
**Limit** 100 simultaneous connections are allocated per developer account. The distribution of the number of connections per site must not exceed this limit.
...
## Steps to follow
<a name="steps_follow_ELTTEXTE000240"></a>
The different steps for installing a dynamic WEBDEV website on the test hosting server of PC SOFT are as follows:
...
8. When the setup is completed, the wizard provides the command line used to start the site. This line can be copied (if necessary) to the clipboard via the context menu.
...
<a name="creating_developer_account_ELTTEXTE000264"></a>


### Developer account
<a name="developer_account_ELTPARAGRAPHE000069"></a>
...
If you already have a developer account, this account can be reused to install your sites.


### Necessary elements
<a name="necessary_elements_ELTPARAGRAPHE000080"></a>

**The following elements are required to create the developer account**:

1. A valid email address. 
	**Attention** When creating a developer account, the email address provided can only be used once. The same email address cannot be used to create several developer accounts.
...
<a name="creating_test_hosting_account_ELTTEXTE000294"></a>


### Test hosting account
<a name="test_hosting_account_ELTPARAGRAPHE000096"></a>

A test hosting account can be created to deploy a site on the test hosting server of PC SOFT. 

If you already have a test hosting account, this account can be reused to deploy your sites.


### Necessary elements
<a name="necessary_elements_ELTPARAGRAPHE000103"></a>
...
2. A domain name. This domain name will be unique. It corresponds to the root of all the sites that will be deployed.
	...
	**Attention**: The domain name must be at least 5 characters long.
...
<a name="resources_associated_with_hosting_account_ELTPARAGRAPHE000118"></a>
...
## Site parameters
<a name="site_parameters_ELTTEXTE000330"></a>
