...
- UI audit errors concerning windows or pages are also displayed when running the static audit on the project. You can also fix the detected problems from the static audit window.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=audit_ui_bis%20-%20HC%20N%B0001.gif)
