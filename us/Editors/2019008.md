...
- in the WEBDEV editor. For more details, see [Test a dynamic project](../Editeurs/2019009.md).
...
- When the test is run from the test page, the rights used correspond to the rights of the user configured on the Web server. These rights can be more restrictive: some actions may not be allowed (deleting files from the server for example). 
...
- When the test is run from the test page of the administrator, the programming errors are displayed in a browser page. This error page contains the message "The application has generated the following message: ...". 
