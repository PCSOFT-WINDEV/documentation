...
2. Specify the relevant ".INI" file. This file will be created if necessary. You can specify:
	...
	- The name and full path of the file.
		...
		- **&lt;FicInst&gt;**: directory for data file installation. WDInst is used to configure this directory. For more details, see [Configuring the data file directory](../Editeurs/2028017.md).
...
5. Specify the value of the parameter.
	To retrieve the number of the installation program’s runtime language, use the **&lt;Language&gt;** keyword.
...
[WDInst: set directory for data files and User Groupware files ](../Editeurs/2028017.md)
