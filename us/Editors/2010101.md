...
- Start (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modelisation_Commencement_i.gif)): Displays the start of flexible modeling.

- Termination (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modelisation_Termine_ico.gif)): Displays the end of flexible modeling.

- Decision/Choice (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modelisation_Choix_ico.gif)): Allows simple visualization of a choice in flexible modeling.

- Treatment (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modelisation_Trait_Ico.gif)): Allows you to simply view a treatment.

- Application (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modelisation_Appli_ico.gif)): Allows you to simply view an application.

- Data file (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modelisation_HF_ico.gif)): Allows simple viewing of a data file.

- Image (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modelisation_Image_ico.gif)): Simply include an image (from the image catalog or a personal image) in flexible modeling. This image has the same characteristics as a process.

- Title block (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modelisation_Cart_ico.gif)): Enables you to include a title block in flexible modeling. Used to give a title to a flexible modeling or to a sub-model for example.
