...
- [HFSQL functions](#NOTE2) which can be used to manipulate data files directly (HFSQL databases, MySQL or SQL Server databases accessed via JDBC).

- [SQL functions](#NOTE5) which can be used to manipulate data files directly (HFSQL databases or MySQL, SQL Server, Oracle, DB2, and other databases accessed via JDBC)..  

- [The Java RAD tool](#NOTE8) which allows you to quickly develop windows that manipulate data files.
...
<a name="accessing_data_files_with_hfsql_functions_ELTTEXTE000338"></a>
...
<a name="access_hfsql_data_files_ELTPARAGRAPHE000050"></a>
...
**Note** By default, data files are installed with the Java archive. However, the data files can be installed in another directory. In this case, you must specify the new path in the application with [HChangeDir](../WDLang4/3044168.md).
...
To handle the data files defined in the analysis of a Java project, you must:
...
2. Associate this connection with the various data files described in the analysis, using the [HChangeConnection](../WDLang4/3044150.md) function.
...
<a name="accessing_the_data_files_with_the_sql_functions_ELTTEXTE000398"></a>
...
### Access HFSQL data files
<a name="access_hfsql_data_files_ELTPARAGRAPHE000131"></a>
...
**Note** By default, the Simple RAD pattern manipulates HFSQL data files. If you want to use a connection by JDBC, you must adapt the generated code. To do so, describe the connection to use ([HDescribeConnection](../WDLang4/3044205.md) or [HOpenConnection](../WDLang4/3044107.md)) by specifying the JDBC driver to use. This connection is then associated with the various data files described in the analysis using the [HChangeConnection](../WDLang4/3044150.md) function.
