...
To generate the application in WINDEV Mobile, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Generation_iOS_WM_bl.gif) in the quick access buttons.
