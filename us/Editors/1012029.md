...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) To simplify the mashup in the sites developed in WEBDEV, you must be able to interface with the different services proposed by the sites on the Web.
...
[Handling external JavaScript objects from WLanguage](../Editeurs/1012028.md)
