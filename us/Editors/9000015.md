...
For example, creating a control with the same name as another element in the project: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=AnalyseImpactNom.GIF)
...
3. Click "Find". The list of uses for the selected element is displayed:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=AnalyseImpactRech.GIF&type=thumb)
...
- To view all the references that will be modified, select "Renaming impact analysis" in the context menu of the error:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=AnalyseImpact.GIF&type=thumb)


- You can also start the renaming operation when the new name is validated, by displaying the context menu of the error:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Refactoring_Menu.gif&type=thumb)
