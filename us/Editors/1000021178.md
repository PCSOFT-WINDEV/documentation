...
4. A window allows you to import all the users.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=gpu_ldap.gif)
...
LDAP server characteristics must be entered in the "Data files" tab of the User Groupware settings window.
