...
**Caution**: Depending on how the project elements are declared (classes, sets of procedures, etc.), the elements that are accessible may change. The table below presents the different methods for accessing an element according to its declaration mode.
...
| Project (WDP, WWP or WPP file) | The project can be included (or not) in the component. No visibility option can be defined. The project will always be invisible.<br><br>If the project is included in the component, the project initialization code and the project closing code will be automatically run when loading/unloading the component.<br><br>Note: If the analysis included in the component is password-protected, it is necessary to integrate the project into the component to specify the password. |
...
**Note**: By default, the elements of a component use an [independent HFSQL context](../WDChamp/1010029.md).
<a name="NOTE2_2"></a>
