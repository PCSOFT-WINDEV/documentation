...
- File language: By default, the data files used by the Private Store are in French, but it is possible to use English-language data files.
...
5. Display this file in the file explorer: under the "Home" pane, in the "General" group, pull down the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Rep_Projet.gif) option and select "Explore generation directory". 
