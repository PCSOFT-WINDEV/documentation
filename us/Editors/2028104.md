...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Reseau_Mise_a_jour_automatiques%20-%20HC%20N%B0006.gif)
...
- If there is no network connection when opening the application, a warning message is displayed by default. 
	This message can be useless for an application used on a mobile device, connected intermittently. In this case, simply select "Silent check: Don't inform user". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Reseau_Mise_a_jour_automatiques%20-%20HC%20N%B0006%201.gif)
