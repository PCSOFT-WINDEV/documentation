...
| [WDLog](../WDJournal/3516012.md) | Saves and restores the data files in HFSQL format and manages the logs.<br><br> |
| [WDOptimizer](../WDOptimiseur/3519002.md) | Optimizes access to HFSQL data files (reindexing, memo corrections, etc.).<br><br> |
...
**Special case** If the application creates data files in a specific directory (a directory other than the application's sub-directories), these data files are not automatically deleted when the application is uninstalled.
