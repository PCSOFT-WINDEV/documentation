...
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CERCLE7.GIF) | Modifies the values displayed in the query result. You can display:<br><br>- the year from a date item.<br><br>- the month from a date item.<br><br><br> |
