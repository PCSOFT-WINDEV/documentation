...
This information will be included in all modules, for each action. This simplifies processes such as the analysis definition, RAD generation, automatic control creation, etc.
...
1. In the data model editor, select "Analysis .. Import a user metatype".
	Note: To access this option, use the main menu accessible via the version logo:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ruban_logo_menu17.gif)
