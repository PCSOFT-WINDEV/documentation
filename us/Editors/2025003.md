...
- or to use the common **WINDEV Framework**: If you select this option, you can set the various messages that may appear to the end user: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Exe_Framework_telech.gif)
**Remarks**: 
