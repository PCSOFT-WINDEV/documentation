...
| ***GPWElementConfiguration*** | Status of each application element for each configuration. For example, allows you to store whether the "Statistics menu" must be grayed for the "Assistant" user. |
...
### Data file password
<a name="data_file_password_ELTPARAGRAPHE000134"></a>
...
**Warning** If the groupware files already exist, their passwords are not modified. This modification can only be performed before the data files are created.
