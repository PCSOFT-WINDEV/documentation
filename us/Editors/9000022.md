...
The Automatic Application Features (AAF) allow you to add features to your application without having to write a single line of code. Simply check the corresponding options to enable these features.

Some examples of AAF:

- [Provide users with an automatic menu in Table controls](../Editeurs/9500102.md).

- [Generate help text for your application](../Editeurs/2010030.md).
...
## AAF menu settings
<a name="aaf_menu_settings_ELTTEXTE000151"></a>
...
For more details, see [Configuring the AAF menus (Automatic Application Features)](../Editeurs/2010040.md).
...
## Programming
<a name="programming_ELTTEXTE000183"></a>


### Functions for managing Automatic Features
<a name="functions_for_managing_automatic_features_ELTPARAGRAPHE000076"></a>
...
[AAF: Manipulating columns in a Table field](../Editeurs/9500109.md)

[Creating an automatic help](../Editeurs/2010030.md)

[Translucent effect of windows](../Editeurs/9500103.md)

[Automatic menu of tables (AAF)](../Editeurs/9500102.md)

[Countdown timer on a button (AAF)](../Editeurs/9500100.md)
...
[Discovering AAFs (Automatic Application Features)](../Editeurs/1410087246.md)
