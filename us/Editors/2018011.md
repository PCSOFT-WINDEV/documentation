...
<DIV class="specObsolete">
	...
	From version <B>18</B>, the User Groupware evolves. This help page corresponds to the User Groupware kept for backward compatibility. To learn more about the new version of the User Groupware, see [User Groupware and Client/Server data files](../Editeurs/1000021177.md).
</DIV><a name="NOTE1"></a>
<a name="NOTE1_1"></a>
