...
**Remark**: To create the executable, pull down the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_generation_exe.gif) icon and select "Generate Windows 32-bit executable (.exe)" or "Generate Windows 64-bit executable (.exe)".
