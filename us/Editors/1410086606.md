...
The image editor includes several features. These features can be accessed via the specific editor ribbon ("Image" pane).  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0001%201.gif&type=thumb)
...
- **To print the image displayed in the editor**: 
	...
	1. Use: 
		...
		- the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Imprimer.gif) button in the "Home" pane. 
...
The image editor includes several selection tools: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0001%205.gif)
...
The options in the "General" group allow you to handle the image displayed in the editor: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0001%204.gif)
You can: 
...
- **Resize the image**: In the window that appears, specify the new size or the percentage to enlarge or reduce the image. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0002.gif)
...
- **Modify the work area**: When this option is selected, two actions are possible: 
	...
	- Resizing window: In the window that appears, specify: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0003.gif)
...
- **Rotation**: Rotates the current layer (preset or custom rotation). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0004.gif)


- **Symmetry**: Defines the symmetry of the current layer (horizontal and/or vertical). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0005.gif)
...
The "Display" group options allow you to manage the Image display in the editor.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0001%206.gif)
You can: 

- zoom in on Image: pull down the "Zoom" option and select the desired option: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_image_ruban%20-%20HC%20N%B0006.gif)
...
- **Text**: Used to define a text area on the image. The text area is defined by the left mouse click. 
	Font, size, Alignment, Color, text attributes can be defined in the "Text" pane of the editor ribbon.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_img_calque%20-%20HC%20N%B0001.gif)
...
The following operations can be performed in the "Layers" section of the "Images" pane: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_img_calque%20-%20HC%20N%B0002.gif)
