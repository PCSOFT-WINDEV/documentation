...
| .LST | File containing the names of the various HFSQL data files to be saved (created by [WDLog](../WDJournal/3516006.md)) | Tools |   |
...
| .MDF | Internal file of the analysis | Analysis | X |
...
| .SEM | Internal file of the analysis. | Analysis | X |
...
| .VER | Internal file of the analysis. | Analysis | X |
...
| .WDA | Description of [analysis](../Editeurs/2011022.md) and HFSQL data files (in edit) for data model editor | Editors | X |
...
| .WDD | Description of [analysis](../Editeurs/2011022.md) and HFSQL data files (running) | Editors | X |
...
| .WDR | [Query](../Editeurs/2032052.md)<br>Note: In WINDEV 5.5, this extension corresponded to the "include" module for data files | Editors | X |
...
| .XDD | Internal file of the analysis | Analysis | X |
