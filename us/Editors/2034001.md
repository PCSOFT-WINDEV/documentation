...
- To find out the value of the automatic identifier for an INSERT query on HFSQL data files (query executed by the [HExecuteSQLQuery](../WDLang4/3044084.md), [HExecuteQuery](../WDLang4/3044080.md) or [SQLExec](../WDLang4/3072007.md) function), use the SQL.IDAuto variable.

- The INSERT statement cannot be used to copy data from one HFSQL data file to another HFSQL data file.
...
The **OPTIMIZE TABLE** command reorganizes and reindexes a data file, and rebuilds the indexes of that file. This operation improves performance.
...
- This function is blocking: the data file is not accessible during execution of the function. Make sure the file is not in use when the function is called.
