...
- Code difference: the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=OrdreAffichage.gif) icon simultaneously displays the code of the two elements being compared. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Comparateur_prj%20-%20HC%20N%B0002.gif&type=thumb)


- Different properties: the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=OrdreAffichage.gif) icon displays different characteristics. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Comparateur_prj%20-%20HC%20N%B0003.gif&type=thumb)
