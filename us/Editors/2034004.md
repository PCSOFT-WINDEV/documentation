...
**Example** Create a query containing customers whose names begin with the letter 'A' and prospects living in London. To create this query, the two following queries must be combined:
...
**Warning** When combining parameterized requests, a [specific management of parameters](#NOTE2_3) is required. 
<a name="NOTE2_1bis"></a>
...
**Example** The following SQL code is used to select the names of customers whose names begin with the letter 'A' and the names of prospects living in London. The people who are both customer and prospect, whose name starts with the letter 'A' and who live in London will only appear once in the result of the query.
...
**Example** The following SQL code is used to select the names of customers whose names begin with the letter 'A' and the names of prospects living in London. The people who are both customer and prospect, whose name starts with the letter 'A' and who live in London will appear twice in the result of the query.
...
### Union of parameterized queries: parameter management
<a name="union_parameterized_queries_parameter_management_ELTPARAGRAPHE000103"></a>
...
### Union of parameterized queries: parameter management
<a name="union_parameterized_queries_parameter_management_ELTPARAGRAPHE000168"></a>
