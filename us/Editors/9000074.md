...
**Remark**: You can also find out the type of an element using the tooltip displayed when you hover over the element: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=PrefAutoType.GIF)
