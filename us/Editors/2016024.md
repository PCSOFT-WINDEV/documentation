...
- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) [Customizing a WINDEV Mobile skin template](../Editeurs/2016026.md).
...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) The "Action Bar" step is used to select the colors used by the Action Bar control. 
...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) You have the ability to specify the colors for the system bar with transparent background (iOS 7).
...
- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) In WINDEV Mobile: in the "Personal\\Templates\\WM" subdirectory.
...
[WINDEV skin template generator: Customize elements](../Editeurs/2016025.md)
