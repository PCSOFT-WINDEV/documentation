...
WEBDEV allows you to create static pages and dynamic pages. Two types of actions can be programmed in a WEBDEV website: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Deux_types_de_code.gif)
...
- The processes of controls and pages must not contain prototypes. Simply write the desired JavaScript code directly
