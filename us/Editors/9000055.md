...
2. Click on the "Options" tab and check the "Enable compiler errors for Linux compatibility" option.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Site_linux%20-%20HC%20N%B0001.gif)
...
| End\* | Frameset\* | Managing HFSQL data files | User Groupware (GPW\*) |
| Image\* | Ini\* | Java\* | List\* |
