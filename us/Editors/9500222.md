...
Note: If you have defined an Enumeration variable in the code editor and want to use it in an item of the analysis, you need to create the enumeration again in the data model editor.
<a name="NOTE2_2"></a>
...
Note: If you have defined a Combination variable in the code editor and want to use it in an item of the analysis, you need to create the combination again in the data model editor.
...
2. Modify the physical data files. This modification can be done:
	...
	- programmatically using [HModifyStructure](../WDLang4/1000019439.md). Use this solution if you cannot access the data files (deployed applications for example).
...
[Analysis editor: the different types of sections](../Editeurs/2011026.md)
