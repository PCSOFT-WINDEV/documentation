...
- To avoid starting the user groupware when running the application tests, uncheck "Workshop .. Configure the user groupware". If you re-enable the User Groupware again, the data files previously used by the User Groupware will not be deleted.
...
<a name="create_the_executable_ELTTEXTE000157"></a>
