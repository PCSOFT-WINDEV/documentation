...
**In the code**: [AAFDisable](../WDLang1/1000022018.md) with the *aafSaveValue* constant is used to delete the "Remember value" option from the context menu of the specified Check Box control.
