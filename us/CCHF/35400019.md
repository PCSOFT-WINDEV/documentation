...
2. A new tab corresponding to the new query is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CC_HF_Requ%EAtes%20-%20HC%20N%B0001.gif)
...
The query ribbon includes the following options: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CC_HF_Requ%EAtes%20-%20HC%20N%B0001%201.gif)
