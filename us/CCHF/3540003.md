...
- by starting the HFSQL Control Center from a project: 
	...
	3. The home window of HFSQL Control Center is displayed. The "Open an analysis" option is selected and the path of the current analysis appears in the input field. 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Passage%20analyse%20en%20CS%20-%20HC%20N%B0008.gif&type=thumb)
