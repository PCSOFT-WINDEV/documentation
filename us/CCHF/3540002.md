...
4. Select the elements to replicate. You can replicate:
	...
	- a selection of databases or data files. 


 Remarks: 

- You can exclude certain data files from replication. If this option has been selected, the next step of the wizard allows you to select the elements to exclude. 
