...
**Differences from SQL programming**: To manipulate MySQL data, queries are not mandatory. In fact, you can directly use HFSQL functions to read your data, perform searches, filters, etc. However, you will need to import the MySQL file structure into your WINDEV or WEBDEV analysis.
...
<a name="importing_the_structure_data_files_ELTTEXTE000272"></a>
...
3. The wizard starts.  A connection to the MySQL database is automatically established and associated with the data files imported into the analysis. This connection will have to be used to handle the MySQL data file programmatically.
