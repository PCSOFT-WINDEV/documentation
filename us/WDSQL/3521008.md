...
- To view and/or use existing fields in the current database, click on the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDSQL%20-%20HC%20N%B0006%204.gif) icon.. For more details, see [Database structure](../WDSQL/3521012.md).

- To view and/or use the various SQL keywords, click on the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDSQL%20-%20HC%20N%B0006%208.gif) icon.
...
5. Sort the records according to one or more items:
	...
	- ***In ascending order***: click in the "Sort" column corresponding to the sort item(s).. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TriCroissant.gif) icon appears.

	- ***In descending order***: click in the "Sort" column corresponding to the sort item(s).. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TriDecroissant.gif) icon appears.
