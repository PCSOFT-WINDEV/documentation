...
- To view the different types of variables recognized by the current database, click on the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDSQL%20-%20HC%20N%B0007%201.gif) icon.
