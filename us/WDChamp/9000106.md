...
3. The yellow square was replaced with a blue square, indicating that this control can be overridden.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ModeleEtat_IHMNonSurchargee.gif)
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ModeleEtat_IHMSurchargee.gif)


4. You can change all the aspects of the control interface: dimensions, position, style, etc.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ModeleEtat_IHMModifiee.gif)
...
5. Two sections of click code are found: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ModeleEtat_CodeNonSurcharge.gif)
