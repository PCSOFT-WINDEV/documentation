...
In a page or a report, the HTML control can be manipulated by the WLanguage properties.
...
<a name="properties_available_report_ELTTEXTE001101"></a>
<a name="NOTE4_1"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 

### Static control (HTML) in a report
<a name="static_control_html_report_ELTPARAGRAPHE000061"></a>The following properties can be used with HTML Static controls:
