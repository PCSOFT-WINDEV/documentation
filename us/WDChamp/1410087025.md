...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001.gif&type=thumb)
This tab contains the following groups: 

- **Document**: Used to open, create and save a docx document. 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%201.gif)
You can: 
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%202.gif)
You can: 
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%205.gif)


- **Font**: Used to manage the font of current text. 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%206.gif)
You can: 
...
- **Paragraph**: Used to manage the characteristics of current paragraph: background color, spacing, alignment, display of non-printable characters or not, ...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0003.gif)


- **Style**: Used to manage the styles.  The list of styles is displayed (with the preview corresponding to the style). 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Styles%20-%20HC%20N%B0001.gif)
Clicking on the double arrow displays the list of available styles in a popup. 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Styles%20-%20HC%20N%B0003.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0002.gif)
...
4. The list of results is displayed in the search window. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TT_Rechercher%20-%20HC%20N%B0001.gif)
...
4. The list of results is displayed in the search window. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TT_Rechercher%20-%20HC%20N%B0002.gif)
...
2. On the "Home" tab, in the "Paragraph" group, click the icon for configuring bullets (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0001.gif)
). The window presenting the library of available bullets is displayed. 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0002.gif)
...
2. On the "Home" tab, in the "Paragraph" group, click the icon for managing numbered lists (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0001%201.gif)
). The window presenting the library of available numbering is displayed. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0003.gif)

	Remark: Hovering a type of numbering is used to display a list preview. 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0004.gif)
...
The "Insert" pane is used to insert elements into the current document (page, page break, page header and footer, table, image, preset controls, etc.). 

![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0004.gif&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Entete%20-%20HC%20N%B0001.gif&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Entete%20-%20HC%20N%B0001%201.gif&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Volet_Tableau%20-%20HC%20N%B0001.gif)
...
2. In the window that appears, select the desired formula and its options: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ChampTT_Formule%20-%20HC%20N%B0001.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ChampTT_Formule%20-%20HC%20N%B0002.gif)
...
2. In the window that appears, enter and confirm the password. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ChampTT_mdp%20-%20HC%20N%B0001.gif)
...
Remark: When opening the docx file, the password will be automatically requested before the file displayed. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ChampTT_mdp%20-%20HC%20N%B0002.gif)
...
!["Layout" tab](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0005.gif)
This tab contains the following groups: 
...
!["Table" pane](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Volet_Tableau%20-%20HC%20N%B0002.gif)
...
!["Images" pane](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_VoletImage%20-%20HC%20N%B0001.gif)
...
!["Text area" pane](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_ZoneTexte%20-%20HC%20N%B0001.gif)
...
!["View" tab](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ%20TT_Affichage%20-%20HC%20N%B0001.gif)
**"Zoom" group**: 
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0001.gif)
...
- Left tab (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0003.gif)
): the text is aligned to the right of tab stop. 

- Center tab (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0004.gif)
): the text is centered during the input. 

- Right tab (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0005.gif)
): the text is aligned to right and it extends to the left. 

- Decimal tab (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0006.gif)
): the number are aligned to the left of decimal separator. 

- Tabulation bar: inserts a vertical bar at tab stop location. 

- First line indent (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0002%201.gif)
): the first line indent is used to indent the text of first paragraph line. To perform a first line indent, all you have to do is move the rectangle symbolizing the first line. 

- Negative indent (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0002%201.gif)
): the negative indent is used to indent the text of second paragraph line as well as the text of all following paragraph lines. To perform a negative indent, all you have to do is move the triangle symbolizing the paragraph lines. 
...
2. In the context menu that is displayed, select the type of tabulation to create. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0002.gif)
...
2. In the context menu that is displayed, select "Delete the tabulation". ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0008.gif)
...
![Read-only](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Lecture_Seule%20-%20HC%20N%B0001.gif)
