...
| --- | --- | --- |
| **Edit control** | All the style characteristics except for:<br><br>- the input border.<br><br>- the scrollbar.<br><br><br> | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ChampSaisieLookXP.gif)<br> |
| **Button** | All the style characteristics except for the color of the caption.<br><br>If the button uses a background image or a border image, this image is kept. Otherwise, the XP theme is applied. | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=BoutonLookXP.gif)<br> |
| **Radio Button** | All the style characteristics except for:<br><br>- the checkmark.<br><br>- the background color of the inside border.<br><br><br> | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=SelecteurLookXP.gif)<br> |
| **Check Box** | All the style characteristics except for:<br><br>- the checkmark.<br><br>- the background color of the inside border.<br><br><br> | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=InterrupteurLookXP.gif)<br> |
| **List Box** | All the style characteristics except for:<br><br>- the scrollbar.<br><br>- the background color of the inside border.<br><br><br> | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ListeLookXP.gif)<br> |
| **Combo Box** | All the style characteristics except for:<br><br>- the arrow button.<br><br>- the scrollbar (of the expanded area).<br><br>- the input border.<br><br><br> | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ComboLookXP.gif)<br> |
| **Table** | All the style characteristics except for:<br><br>- the scrollbar.<br><br>- the background color of the inside border.<br><br><br> | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TableLookXP.gif)<br> |
...
| **Scrollbar** | No characteristic. | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=AscenseurLookXP.gif)<br> |
| **Slider** | No characteristic. | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=PotentiometreLookXP.gif)<br> |
| **Spin** | No characteristic. | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=SpinLookXP.gif)<br> |
...
|   |   |
| --- | --- |
| <br><br>- Popup menu:<br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=LookXPMenuCtx.gif)<br> | <br><br>- Main menu:<br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=MenuPrincipalLookXP.gif)<br> |
