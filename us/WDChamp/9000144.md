...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WB_ZoneFixe.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WB_ZoneEpingle_modes.gif&type=thumb)
...
4. Click on "Settings" to choose the pin management mode. Three modes are available: 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WB_CelluleEpingle_modes.gif&type=thumb)
