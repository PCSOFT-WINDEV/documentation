...
<a name="events_managed_default_ELTTEXTE000152"></a>
...
| Whenever modiying | Run whenever the content of the control is modified (selecting or deselecting an option for example). |
