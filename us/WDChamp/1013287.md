...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RuptureZR.GIF)
...
2. In the "Content" tab, click 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=BtnRupture.GIF)
. The window for break management is displayed: 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FenRupture.GIF)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Rupture_Perso_Btn.gif&type=thumb)
