...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) A procedure can be declared in the event "Collapsing/Expanding a node"**Example**: 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ARBRECODE.gif)
