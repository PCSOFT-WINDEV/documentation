...
<a name="available_properties_ELTTEXTE000094"></a>
The following properties can be used with the Camera controls:
...
Remarks: Depending on the platform used, some properties may not be available. For more details, see the property's help page. 
