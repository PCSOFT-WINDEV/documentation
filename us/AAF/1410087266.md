...
The context menu of rows and columns includes the following options: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%2012.jpg)
...
A cell-specific context menu includes the following options: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%202.jpg)
...
When this option is selected, the pivot table becomes editable. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%203.jpg)
...
- invert dimensions. Simply drag and drop the header onto the desired position. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%204.jpg)
...
<a name="transpose_rows_and_columns_ELTPARAGRAPHE000162"></a>This option rearranges the data of the pivot table. Columns switch to rows and vice versa. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%205.jpg)
...
- A window appears, allowing you to enter the characteristics of the comparison: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%206.jpg)
...
- When this window is validated, the data is recalculated to show only the data in the comparison. For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%207.jpg)
...
- When saving the file, simply check "Encrypt with password" when typing the name of the backup file. In this case, a new window will prompt you to enter the password to be used: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%208.jpg)
...
Users can easily change the color of a cell in a pivot table via the context menu. This makes it easier to identify important elements in the pivot table. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%209.jpg)


Tip: The last color used is automatically proposed in the cell's context menu.. This feature is useful to apply the same color to multiple cells. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableau%20crois%E9%20dynamique%2010.jpg)
