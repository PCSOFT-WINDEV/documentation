...
**Note** The list of Windows APIs supplied with WDAPI is NOT exhaustive.

**Reminder** WDAPI can be launched from WDOutil: in the "Tools" pane, in the "Utilities" group, click on "WDTool".
...
- an Internet address (e.g. http://www.myfavoritesite.com).

- a full path to a document (e.g. C:\\My Documents\\APIInfo.doc).

- an application (e.g. \\\\APIComputer\\Tools\\ApiPlus.exe). 
