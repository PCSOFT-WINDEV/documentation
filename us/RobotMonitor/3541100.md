...
2. [Install the Robot controller if necessary](../RobotMonitor/3541102.md). The Robot controller is an additional security tool. It is used to check whether the monitoring robot operates properly.
