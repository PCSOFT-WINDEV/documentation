...
<a name="parameters_specific_the_check_regarding_the_http_connectivity_ELTTEXTE000131"></a>
...
- the HTTP method to be used to check that the server is responding: GET, POST, PUT, DELETE, HEAD or PATCH. 
...
### Additional headers
<a name="additional_headers_ELTPARAGRAPHE000056"></a>

You can add additional headers that will be passed to the request. Example: 
