...
2. The window that is displayed is used to: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Robot_Utilisateur%20-%20HC%20N%B0001.gif)
...
- **user options**: 
	These options are used to define: 
