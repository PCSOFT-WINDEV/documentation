...
- To find out whether a function can be used in a stored procedure, see the help about this function: if the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=proc_stock.gif)
