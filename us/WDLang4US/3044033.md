...
Name of the logged data file for which the log must be re-created. If this parameter corresponds to "\*", the log is re-created for all the data files found in the analysis.
