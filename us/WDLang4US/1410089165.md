...
| --- | --- | --- |
| Filter | Type corresponding to the filter used | Description of the MongoDB filter(s) that will be applied to select the document to update. This filter corresponds to:<br><br>- a JSON document, in string format.<br><br>- a BSON document, in buffer format.<br><br>- a variant.<br><br><br> |
