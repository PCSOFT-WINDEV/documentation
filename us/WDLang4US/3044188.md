...
- **Default assisted management available in WINDEV, WINDEV Mobile and WEBDEV**
	If a duplicate error is detected, a window or a page is displayed, asking the user to modify the value of the record that caused the error. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_Doublons.gif)
...
- **Default assisted management available in WINDEV, WINDEV Mobile and WEBDEV**
	When a password error occurs, a window or a page is displayed, allowing the user to type the file password. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_MotPasse.gif)
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_Motdepasse_WB.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_Conflit.gif&type=thumb)
...
- **Default assisted management available in WINDEV, WINDEV Mobile and WEBDEV**
	...
	A window or a page is displayed, indicating that the record or file is locked and allowing the user to retry or cancel the operation. In case of cancelation, the application continues to run as usual. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_Blocage.gif)

![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_Blocage_WB.gif&type=thumb)
...
- **Default assisted management available in WINDEV, WINDEV Mobile and WEBDEV**
	...
	A window is displayed, indicating that the item must be filled and allowing the user to type the item value. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_FenetreSaisieObligatoire.gif)
...
- **Default assisted management available in WINDEV, WINDEV Mobile and WEBDEV**
	A window is displayed, indicating that the file is currently reindexed (also called reorganization). This window is displayed during the entire reindex operation and it cannot be closed. A progress bar indicates the status of re-index operation. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_Reindexation.gif)

![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HF_Reindexation_WB.gif&type=thumb)
