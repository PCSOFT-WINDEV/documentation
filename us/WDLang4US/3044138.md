...
<a name="displaying_the_result_list_box_combo_box_control_ELTPARAGRAPHE000238"></a>

&lt;Result&gt; can be directly assigned to a List Box or Combo Box control by [ListAdd](../WDLang1/3049004.md). Each row will contain the full name of one of the links found.
<a name="NOTE0_2"></a>


### Deletion and modification rule
<a name="deletion_and_modification_rule_ELTPARAGRAPHE000250"></a>
