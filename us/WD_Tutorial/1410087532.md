...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Cr%E9er1_GAF.jpg) in the quick access buttons (or press Ctrl + N).
...
5. In the window that appears, specify the title of the window: "Menu". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0001.jpg)
...
We will use a Table control to create the list of products. This control will display data from the "Product" data file.**What is a Table control?**
...
3. This Table control will display the records from the "Product" data file. 
	In the wizard, select "Display data from a data file or existing query". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0002.jpg&type=thumb)
...
4. The wizard lists the various data files and queries present in the current project. 
	Expand "Analysis" if necessary and select the "Product" data file. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0003.jpg&type=thumb)
Go to the next step.
...
6. Then, the wizard proposes to select the sort item. This item will be used to sort the data displayed in the Table control. The items displayed in the wizard are the ones defined as key items in the analysis. We will set the order of the items based on their caption. 
	Click the "Caption" row.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0005.jpg&type=thumb)
...
Let's see how the Table control works at runtime, from the perspective of an end user. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0008.jpg&type=thumb)
Remarks:
...
For example, click the "Caption" column twice. The data is displayed in a different order. An arrow on the left of the column indicates that it is sorted and shows the sort direction.
	...
	- the search icon indicates that a search can be performed in the column. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Liste%20des%20produits%20-%20HC%20N%B0008%202.jpg)
...
To create the different Edit controls, we will use the items of the Product data file directly:
...
2. Click the icon to the left of the "Product" data file to view all its items. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0001.jpg)
...
4. Drag the items and drop them onto the previously created window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0002.jpg&type=thumb)
...
5. Different controls are automatically created in the window. These controls are bound to the corresponding item in the data file. To check this:
	...
	- Go to the "Link" tab of the description window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0003.jpg&type=thumb)
...
Move the controls and resize the window to get the following UI: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0004.jpg&type=thumb)
...
3. Then click below the "OK" Button control to create the control. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0005.jpg&type=thumb)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0007.jpg&type=thumb)
...
- Small red arrows appear in the editor, indicating that the controls are anchored to the right.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0010.jpg)
...
7. We will test the behavior of this window in the preview:
	...
	- Enlarge the window. The controls adapt horizontally and vertically. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0011.jpg&type=thumb)
...
Click "WIN_Menu" in the open document tabs: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0012.jpg)
...
Click "WIN_Product_form" in the open document tabs to open the window in the editor. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0012%201.jpg)
...
2. Test the window (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fenetre_WD_GAF.jpg) in the quick access buttons).
...
3. If necessary, resize the Button control (using the handles) so that it has the same width as the Image control.
	When resizing the control, an automatic magnetism effect simplifies the alignment of the Button control with the Image control.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0001.jpg&type=thumb)
...
2. Write the following code in the "Click" WLanguage event:
	...
	- [&lt;Data file&gt;.FromWindow](../WDLang4/1000021403.md) updates the items of the current record with the data from the bound controls. This function is equivalent to the following lines of code:
...
2. Position the "New" button above the "Modify" button (move the latter if necessary). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0003.jpg&type=thumb)
...
<a name="adding_new_record_the_data_file_ELTPARAGRAPHE000795"></a>
...
Let's take a look at this WLanguage code:
		...
		- If [&lt;Data file&gt;.Reset](../WDLang4/1000025052.md) has been called previously, the property returns <u><u><u><u>True</u></u></u></u> (when "New" is clicked) and the record is created with [&lt;Data file&gt;.Add](../WDLang4/1000024187.md).
...
3. Enter a new product with the following characteristics:
	...
	- Price: 150 <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0004.jpg&type=thumb)
...
7. Confirm. A specific window is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%203%20-%20Cr%E9ation%20Modif%20-%20HC%20N%B0005.jpg&type=thumb)
