...
3. Confirm. The HFSQL Control Center is displayed. This start mode allows you to see the different data files linked to the analysis of the current project.
...
- in the right section, a new tab appears and shows the characteristics of the HFSQL server. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0013.jpg&type=thumb)
...
1. On the right section of the screen, select the "Users" tab. This tab is used to manage the users of the server.
	Only the "Admin" user exists at this point. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0014.jpg&type=thumb)


2. In the menu, in the "Users" group, click "New". The window used to define the user characteristics is displayed. 

3. Enter the following information: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Passage%20analyse%20en%20CS%20-%20HC%20N%B0015.jpg&type=thumb)
