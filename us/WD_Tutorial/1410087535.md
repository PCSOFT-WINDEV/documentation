...
8. Choose to print the content of the Table control in "Landscape" mode. The report corresponding to the control is displayed in the report viewer.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Imprimer%20contenu%20Table%20-%20HC%20N%B0003.jpg&type=thumb)
...
12. Save the window by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Enregistrer_GAF.jpg) in the quick access buttons.

13. Test the window by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fenetre_WD_GAF.jpg) in the quick access buttons.
...
2. The new element window appears. Click "Report", and then "Report". The report creation wizard opens. The report creation wizard offers several types of reports: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%20Imprimer%20liste%20clients%20-%20HC%20N%B0001.jpg&type=thumb)
...
10. Change the order of the sort items. The customers must be sorted by country, by state, then in alphabetical order.
	...
	- The "Customer.StateProvinceRegion" item appears as the third sort item. Select this item and move it to the second position using the "Move up" button. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%20Imprimer%20liste%20clients%20-%20HC%20N%B0005.jpg&type=thumb)
Go to the next step.
...
This break is used to group a set of records according to the same criterion. In our example, the break is set on the country and it is used to group all the customers living in the same country.
	...
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%20Imprimer%20liste%20clients%20-%20HC%20N%B0006.jpg&type=thumb)
...
13. Specify the sort item on which the break must be set. In this case, we will use several breaks:
 ...
 Uncheck the "Customer.FullName" item. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%20Imprimer%20liste%20clients%20-%20HC%20N%B0007.jpg&type=thumb)
...
15. You are going to specify the order in which the items will be printed and how they will be distributed in the different blocks. In our example:
 ...
 Uncheck the CustomerID, Complement, Phone, Cell and Email items. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%20Imprimer%20liste%20clients%20-%20HC%20N%B0008.jpg&type=thumb)
Go to the next step.

16. This step is used to define the report layout. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%20Imprimer%20liste%20clients%20-%20HC%20N%B0009.jpg&type=thumb)
...
22. Accept to reduce the report by validating. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%20Imprimer%20liste%20clients%20-%20HC%20N%B0010.jpg&type=thumb)
