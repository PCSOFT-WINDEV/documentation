...
1. Click the icon in the dashboard widget. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0003%201.jpg)


2. The template update window appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0003.jpg)
...
<a name="step_2_choosing_the_languages_the_analysis_ELTTEXTE000686"></a>
By default, an analysis is created in a specific language and cannot be translated.

However, some information can be written in several languages (notes in the documentation, shared information, etc.). If your application uses Reports and Queries, the names of the data files and items can also be translated. These elements can be translated in the "Reports and Queries" tab.
...
<a name="adding_languages_the_analysis_ELTPARAGRAPHE000140"></a>

To use multiple languages in the WD Full Application analysis:

1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Analyse_GAF.jpg) in the quick access buttons of the WINDEV menu to open the data model editor. 
...
3. The list of languages supported by the analysis is displayed. Since French is not supported, we need to add it:
	...
	- Validate the language selection window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0004.jpg&type=thumb)
...
Let's see a simple example of how to enter shared information in multiple languages. We will define the text of a control bound to the "Address" item in the "Customer" data file:
...
4. On the "General" tab, in the French caption, enter "Adresse". 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0005.jpg&type=thumb)
...
To apply changes, you need to generate the analysis. To do so, go to the "Analysis" tab, "Analysis" group, and click "Generation".
...
3. Select the "Language" tab. The two languages selected in the project are displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0006.jpg&type=thumb)
...
2. The image of the banner is used in the template associated with the window. Therefore, the associated window template must be opened:
	...
	- Select "Open template". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0014.jpg)
...
4. In the "Image" section, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0007%201.jpg). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0007.jpg)


5. In the context menu that appears, select "Multilingual". 

6. The multilingual image management window opens. A different image can be used for each language. This feature is very useful if you use images that contain text. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0008.jpg)


7. For our example, in the "French" area, select the "header-fr.png" file: 

	- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0007%201.jpg). 
...
10. Save the window template (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Enregistrer_GAF.jpg) or Ctrl + S).

11. Update the windows that use the window template by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ico_Rafrachir_Mod%E8le.gif) icon in the orange bar. Validate the update window.
...
1. Open the code of the menu option:
	...
	- Right-click to open the context menu and select "Code". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0009.jpg)
...
3. Press Ctrl + T. The following window is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0010.jpg)
...
In the code editor, the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0011%201.jpg) icon appears next to the string.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0011.jpg)
...
3. The elements that we modified in our application are displayed in French: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0015.jpg&type=thumb)
...
2. Go to the "Translation" tab. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0012.jpg&type=thumb)
...
5. Once the translation settings are defined, you can click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0005%201.jpg) button in the different description windows of the project elements. This button will open the desired translation program.
...
- include the file in the "Languages" tab of the project description. Simply select the desired language and go to the "Miscellaneous" tab. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0013.jpg&type=thumb)
