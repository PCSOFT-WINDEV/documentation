...
3. Create a Tab control in the window:
	...
	- On the "Creation" tab, in the "Containers" group, expand "Tab and similar" and select "Tab".
...
2. Click "Tab 1". Once the tab switches to edit mode, enter "List of products". Press Enter to confirm. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0003.jpg)
...
4. We will associate an image to the tab using WINDEV's image catalog.
	If an image can be displayed in a control or window, WINDEV proposes to use the image catalog. This image catalog can be opened via the "Catalog" option (available by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0014%201.jpg) button). The catalog contains hundreds of images, cliparts and more.


5. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0014%201.jpg) on the right of "Image". Select "Catalog" in the context menu that appears. The image catalog window appears.

6. Type "Product" in the search area. Click the search icon to start the search. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0005.jpg&type=thumb)


7. Select ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_ICO_Liste.jpg) and validate ("OK").
...
11. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0014%201.jpg) on the right of "Image". Select "Catalog" in the context menu that appears. The image catalog window appears.

12. Type "Person" in the search area. Click the search icon to start the search.

13. Select, among the proposed images, the icon representing two persons (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_ICO_Personne.jpg)) and validate.
...
3. In the anchor settings window, select ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0002%202.jpg) and confirm.
...
To create Edit controls, we will simply drag and drop elements from the "Analysis" pane, just like we did for the product form window.
...
2. In the "Project explorer" pane, expand "Analysis" by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0001%201.jpg) icon. The data files defined in the project analysis are displayed.

3. Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0001%201.jpg) icon to the left of the "Customer" data file to see its items.

4. Select the items of the Customer data file. You can select multiple elements by holding the Ctrl key down.
...
Test the window (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fenetre_WD_GAF.Jpg) in the quick access buttons). Click the "Find customers" tab. The window is displayed with empty controls. Close the test window to go back to the editor.
<a name="NOTE4_3"></a>
...
4. Select "Display data from a data file or existing query". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0009.jpg&type=thumb)
...
8. The "FullName" item will also be used to sort the list of customers displayed in the Combo Box control. Select the "FullName" item. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0011.jpg&type=thumb)


9. Go to the next step.

10. The value returned by the Combo Box control will be the "CustomerID". This is the value that will be searched in the Customer data file. Select the "CustomerID" item. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0012.jpg&type=thumb)
Go to the next step. 
...
15. Select and resize the Combo Box control so that the entire customer name is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0013.jpg&type=thumb)
...
7. Let's take a look at this WLanguage code:
	...
	- is used to perform an exact-match search. In this example, the search is performed on the Customer data file and on the CustomerID item. The search value is the last parameter of the function. Here, the search value corresponds to the value selected in the Combo Box. This value is obtained by using the name of the Combo Box control (COMBO_Customer).

	- is used to check the search result. If  returns <u><u><u><u>True</u></u></u></u>, a value was found; if  returns <u><u><u><u>False</u></u></u></u>, no value was found. Any record found is read and it becomes the current record in the data file.

	- In this code, if the record was found, it is displayed by .
			[&lt;Data file&gt;.ToWindow](../WDLang4/1000021397.md) gets the data from the data file items and displays it in the corresponding controls. [&lt;Window&gt;.ToFile](../WDLang4/1000021385.md), on the other hand, gets the data from the controls and updates the data file.
...
2. Create an Edit control. Go to the "Creation" tab, "Usual controls" group, and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Saisie_GAF.jpg).
...
1. Create a Button control. Go to the "Creation" tab, "Usual controls" group, and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Bouton_GAF.jpg).
...
We will add four Button controls to iterate over the different records of the "Customer" data file. These controls are in a "Navigation" layout. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0017%201.jpg)
...
3. All the button styles are displayed in the window that appears. Under "Other styles", select "BTN_First". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0016.jpg&type=thumb)
...
- [&lt;Data file&gt;.Out](../WDLang4/1000024605.md) is used to find out whether the data file is empty.

- [&lt;Data file&gt;.ToWindow](../WDLang4/1000021397.md) is used to display the record on the screen.


The code in the "Next" and "Previous" Button controls contains additional lines of code to: 

- Check whether a search has already been started in the Customer data file (check the result of [&lt;Data file&gt;RecNum](../WDLang4/1000025041.md) to find out if a read operation has already been started).
...
3. Find a customer (enter "BEEF" and start a generic search, for example). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%204%20-%20Aper%E7u%20-%20HC%20N%B0001.jpg)
