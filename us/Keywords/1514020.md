...
| byte, uint8 | 1 byte | 1-byte unsigned int |
| short, int16 | 2 bytes | 2-byte integer |
| word, uint16 | 2 bytes | 2-byte unsigned int |
| long, int 32, int (in 32 bits) | 4 bytes | [4-byte] integer |
| dword, uint32 | 4 bytes | 4-byte unsigned int |
| longlong, int64 | 8 bytes | 8-byte integer |
| ulonglong, dwordlong, uint64 | 8 bytes | 8-byte unsigned int |
...
| wchar\*\* | array of Unicode strings + know size &lt;N&gt; moreover | system integer | you must use [StringRetrieve](../WDLang1/3024005.md)(system integer, *srUnicodeAddress*) for each array cell |
