...
Note: You can use nested loops on the XML reader. 
...
Marks the beginning of the statement block.
Goes deep in the XML tree. Iterates over the child, grandchild, then the child of the grandchild until a leaf is reached. 
...
<a name="syntax_2_looping_through_level_with_copy_ELTPARAGRAPHE000101"></a>
...
Note: It is possible to iterate only once on the &lt;Element&gt; variable.
<a name="NOTE0_3"></a>
...
This syntax goes deep in the XML tree, i.e., iterates over the child, grandchild, then the child of the grandchild until a leaf is reached. When the leaf is reached, the loop goes to the next child. 
<a name="NOTE0_4"></a>
...
If the XML file is handled via a variable of type [XMLDocument](../WDLang5/1000018782.md), you can loop through the data file directly.  
...
[xmlReader (Variable type)](../Motscles/1000023392.md)

[XMLOpenReader (Function)](../Motscles/1000023396.md)

[XML functions](../Motscles/3081005.md)

[XML: Handling large (multi-gigabyte) files](../Motscles/1000023442.md)
