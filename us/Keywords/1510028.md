...
**Behavior change** From version 28 Update 1 onwards, when GOing Linux applications, the runtime target taken into account will be "Linux" (and not "Windows" as in previous versions).  
