...
- ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ExtensionProcedures.gif) ***Training*** : **ExtensionProcedures** <br>This example illustrates the use of the  attribute, to add functionalities to WLanguage types.
