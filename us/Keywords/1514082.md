...
- Compilation errors: In the event of an error in the query's SQL code, a compilation error is generated (as with WLanguage code). <br>![Error of SQL code detected in input](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=152-sql_code_erreur.jpg)
