...
- A ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_PointArret.gif) breakpoint in the Code Editor: under the "Code" pane, in the "Breakpoints" group, pull down "Breakpoint" and select "Add a breakpoint" (or keyboard shortcuts Ctrl + B in the Code Editor).
