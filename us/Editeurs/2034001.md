...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ER.png)<br> | Important | **[The query editor](../Presentation/3088004.md)** cannot be used to create queries in SQL using the INSERT, UPDATE or DELETE commands. |
