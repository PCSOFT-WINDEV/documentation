...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_generer_exenet.gif)
 in the quick access buttons. The wizard for generating a .NET application starts. 
	...
	- Create a new configuration for your project. This configuration is automatically proposed by expanding the generation icon and by selecting "Other generations .. Generate a .NET application". ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Generation_Exenet.gif)
...
- the icons must have been created by a tool that organizes the icons by increasing size and by increasing color resolution. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=icoxp.gif)
