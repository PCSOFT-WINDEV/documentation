...
To generate the application in WINDEV Mobile, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_generation_IOS.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=23_IOS_Deploiement1.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=23_IOS_Deploiement2.gif)


- The wizard for creating a new profile starts. Select: 

	- the type: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=23_IOS_Deploiement3.gif)


	- the identifier: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=23_IOS_Deploiement4.gif)

- Specify the profile name: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=23_IOS_Deploiement6.gif)


- The profile is generated and it can be downloaded. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=23_IOS_Deploiement7.gif)
...
- Click "My apps". ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=itunes_connect1.gif)


- Add your application via the "New app" button. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=itunes_connect2.gif)


- Fill the requested information: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=itunes_connect3.gif)
...
- When the application is compiled, an archive must be built via "Product .. Archive". ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=XCode_archive1.gif)

	Remark: If the "Archive" option is grayed out, deselect the specified target device and select "None/Any". 

- The organizer is automatically started on the "Archive" tab. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=xcode_archive2.gif)
