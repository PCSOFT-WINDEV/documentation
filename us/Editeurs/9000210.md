...
| PC SOFT logo:<br>![alt](logo.gif)<br><br>PC SOFT logo with tooltip:<br>![alt](logo.gif "title")<br> | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=logo-pcsoft.gif)<br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=logo-pcsoft.gif)<br> |
| **Special characters** |   |
