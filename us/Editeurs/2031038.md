...
**Example**: Relation window in the simple RAD pattern: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Pattern_RAD_WMRelation.gif)
...
1. Modify the menu found in the window:
	...
	- a menu option must allow you to close the window. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Pattern_RAD_WMRelation_Smar.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=pattern_RAD_WMFichierD.gif)
