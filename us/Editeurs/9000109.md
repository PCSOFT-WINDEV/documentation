...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_generation_Android.gif)
 in the quick access buttons. The Android application generation wizard starts.
...
7. Specify the email address that will be used by default to send the error report during a fatal error. 
	A specific window is displayed when a fatal error occurs in the application: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Android_Erreur.gif)
The user can: 
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Android_generation_Fic.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=D%E9ploiement%20android%20fin%20-%20HC%20N%B0002.gif)
...
- by expanding the icon for Android generation (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_generation_Android.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Android_vi_Mini.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Version_sdk_optim.gif&type=thumb)
