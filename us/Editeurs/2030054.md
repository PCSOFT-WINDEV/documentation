...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=URLRewriting_fenppale.gif)
...
- WEBDEV generates a rewriting URL by default. To configure the rules for a specific page, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Btn_Parcourir.gif)
 (2) on the right of the table.
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=URLRewriting_page.gif)
...
- The "Type" column (1) is used to choose whether the element of the URL is a fixed component or a parameter:
	...
	- A fixed component is an unchanging section of the URL. Fixed components can be multilingual (click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=URLRewriting_multilangue.gif)
 column to enter the values in the other languages of the project).
