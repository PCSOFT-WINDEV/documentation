...
[EmailOpenMail](../WDLang2/3032021.md) opens the user's email program. Some parameters can be populated by default: recipient's email address, etc. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4-Envoyer%20des%20emails.gif)
