...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_ICO_Cr%E9er_cpt.gif) in the quick access buttons of WEBDEV. In the window that appears, click "Page" then "Page". The page creation wizard opens. 
...
- the "RAD" tab is used to create RAD pages that allow data display and input. This type of page can be bound to a data file, query, etc.
...
1. On the "Project" tab, in the "Generation" group, click "Full Application RAD".
	**Caution**: To use this option, the project must be associated with an analysis generated at least once.
