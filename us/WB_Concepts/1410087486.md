...
| Directory defined by the hosting provider.<br><br>A subdirectory will be created in this directory for each site of user N. | Directory defined by the hosting provider.<br><br>A subdirectory will be created in this directory for the data files of each site of user N. |
