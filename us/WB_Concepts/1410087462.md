...
**Note**: All user information and rights are stored in HFSQL data files. 
...
- **Standard User Groupware**: The User Groupware will be associated only to your site, and the rights will be defined from the site. 
	...
	- the "Data files" tab, which allows you to specify the type of database and authentication used. 
...
- User Groupware data files have a specific password. This password is: "PCSGPW2001".
	...
	Note: This password is used when reindexing or opening data files with WDMAP for example.
...
If you use the standard User Groupware, the "Data files" tab allows you to configure: 
...
A window from the standard mode lets you configure the location of User Groupware data files.
...
In version 19, some important changes were made to the User Groupware. The data files used by the User Groupware have changed.
