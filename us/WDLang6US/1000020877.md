...
If this parameter is not specified or if it corresponds to an empty string (""), the user will have to enter the full name of the PDF file in a file picker.
...
Remark: Without a feeder, to scan multiple pages to a single PDF file, you must scan each page to a PDF file, and then use [PDFMerge](../WDLang6/1000019712.md).
