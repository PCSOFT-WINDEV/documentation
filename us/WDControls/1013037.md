...
- expand or collapse all the elements of the current branch. 
...
The checkmarks found in the TreeView control are available from version 16.![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Example of TreeView control displayed in a WEBDEV page.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_Arbre_WB%20-%20HC%20N%B0001.gif)
...
- In WEBDEV, you have the ability to configure the position of the caption for a branch without image ("Details" tab of the description window of the control): <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_Arbre_WB%20-%20HC%20N%B0002.gif)
...
| Node | Intermediate level, can have higher levels (also called "Parent" levels) and lower levels (also called "Child" levels). <br>**Note**: The root and leaves are specific nodes. |
...
- programmatically via different events and [TreeView control functions](../WDLang1/3018025.md). 
...
[Associating an identifier with an element in a TreeView control](../WDChamp/1013033.md)

[Properties associated with the rows of a TreeView control](../WDChamp/1013016.md)

[TreeView control linked to a data file](../WDChamp/1013126.md)
