...
WINDEV, WEBDEV and WINDEV Mobile allow you to programmatically manipulate Kanban controls. To do so, use the variable of the Kanban control in the code. 
...
This help page explains how to programmatically manipulate Kanban controls. 
...
Example of a procedure that shows the details of the selected Kanban card: 
...
The following properties are used to manipulate Kanban controls and Kanban lists: 
...
For a complete list of WLanguage properties that can be used with Kanban controls, see [Kanban control properties](../WDChamp/1410087207.md).
