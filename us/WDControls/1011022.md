...
The print commands can also be directly sent to your printer (develop your own driver). In this case, you don't need to use the WLanguage print functions or reports: to print, you'll need to use the functions you've written.
...
The name of these printers can be used in [iConfigure](../WDLang5/3046072.md). To use a generic printer, the name of the printer must be replaced with an empty string ("").


## Voir aussi

[Characteristics of a PCL print](../WDChamp/1011017.md)
