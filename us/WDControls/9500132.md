...
**Differences between run and test mode** In test mode, the "Print" option lets you print directly or create a report on a table. This report will automatically be linked to Table control and will be proposed by default to the user.
...
- suggests printing in landscape mode, <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FAA_Imprimer_Table_portrait.gif)
...
- Counters, totals, etc. defined for the Table control are not printed. Only a row counter can be printed below the Table control. The caption corresponds to the caption defined for the counter in the window editor.
...
<a name="printing_from_reports_queries_ELTPARAGRAPHE000090"></a>
