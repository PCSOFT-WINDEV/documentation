...
**Note** If the Edit control is associated with an item in a data file, the value entered is automatically retrieved using: 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) the [ScreenToFile](../WDLang4/3044146.md) function.
