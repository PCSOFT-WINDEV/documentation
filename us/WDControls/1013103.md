...
```
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) In Android, negative or null values cannot be assigned to a Combo Box control. If the Combo Box control is not empty, an element has to be selected. An error will occur if a negative or null value is assigned to a Combo Box control.
<a name="NOTE2_2"></a>
...
- Syntax 3: Editable or non-editable Combo Box controls: [DisplayedValue](../Proprietes/2510129.md) property 
	![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Server code only
...
<a name="properties_specific_combo_box_controls_ELTTEXTE000473"></a>
...
For a complete list of WLanguage properties that can be used with Combo Box controls, see [Combo Box control properties](../WDChamp/1013014.md).
