...
WINDEV allows you manipulate a TreeMap control programmatically. To do so, use the variable of the TreeMap control in the code. 
...
**Note**: It is also possible to programmatically manipulate an element of a TreeMap control..
...
**Remark**: It is possible to populate a TreeMap control programmatically with: 
...
- select in the TreeMap control the element selected in the Table control and vice versa. 
...
**Example**: This code can be entered directly in the selection code of a TreeMap control element: 
