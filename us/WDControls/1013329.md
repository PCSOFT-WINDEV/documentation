...
For more details, see [Table control functions](../WDLang1/1000024319.md).
...
- [&lt;Table&gt;.Add](../WDLang1/1000023600.md) or [&lt;Table&gt;.AddLine](../WDLang1/1000023404.md): adds a line at the end of the Table control. 

- [&lt;Table&gt;.Insert](../WDLang1/1000024260.md) or [&lt;Table&gt;.InsertLine](../WDLang1/1000023407.md): adds a line to the specified or current index. 
...
<a name="adding_rows_table_control_populated_programmatically_ELTTEXTE000253"></a>
You can add rows to a Table control:

- or with functions [&lt;Table&gt;.AddLine](../WDLang1/1000023404.md) and [&lt;Table&gt;.InsertLine](../WDLang1/1000023407.md): in each row, the value of each column is separated by commas.

- or with functions [&lt;Table&gt;.Add](../WDLang1/1000023600.md) and [&lt;Table&gt;.Insert](../WDLang1/1000024260.md): in a row, each column value is separated by TAB.


![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) If a new row was added to the Table control with [&lt;Table&gt;.Add](../WDLang1/1000023600.md), [&lt;Table&gt;.Insert](../WDLang1/1000024260.md), [&lt;Table&gt;.AddLine](../WDLang1/1000023404.md) or [&lt;Table&gt;.InsertLine](../WDLang1/1000023407.md), [New](../Proprietes/2510073.md) is set to <u><u><u><u>True</u></u></u></u> (otherwise, it is set to <u><u><u><u>False</u></u></u></u>).
...
// COL_PUHT and COL_QTE: columns populated programmatically
...
- programmatically:
	...
	- with [&lt;Table&gt;.Modify](../WDLang1/1000024273.md) to change the content of the current row or the content of a given row.
		...
		```
			...
			**Note** It is also possible to use the Table control name directly: 
...
<a name="NOTE5_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![User code (UMC)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 
...
<a name="operations_rows_and_cells_ELTTEXTE000486"></a>
...
<a name="value_the_cell_the_current_row_ELTPARAGRAPHE000576"></a>To retrieve the value of a column (or cell) for the current row, the syntax is the same as for a simple Edit control.
...
<a name="value_cell_for_specific_row_ELTPARAGRAPHE000591"></a>To retrieve the value of a column that is not in the current row, you must specify the index of the row.
...
**Remark**: The current line index can be known by the [&lt;Table&gt;.Select](../WDLang1/1000024284.md) function.. 
For example:
...
[How to manage a multi-selection in a Table control?](../WDChamp/20013.md)
