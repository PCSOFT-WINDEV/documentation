...
1. Display the page description window: under the "Page" pane, in the "Description" group, click on "Description" (or select "Description" from the page context menu).
