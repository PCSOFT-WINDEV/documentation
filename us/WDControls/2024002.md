...
**Note** If you only wish to customize a few windows (e.g. the report viewer only), simply delete the unnecessary windows from your project. The standard print windows will be used.
<a name="NOTE4_2"></a>
