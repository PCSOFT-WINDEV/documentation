...
## Test a page with parameters
<a name="test_page_with_parameters_ELTTEXTE000156"></a>
...
2. This variable is passed in parameter to PAGE_CALENDAR. The parameter *sDateSel* parameter contains the value of the *MyDate*.

3. The value of the *sDateSel* parameter is modified in the PAGE_CALENDAR page (for example: sDateSel = "20020701")
