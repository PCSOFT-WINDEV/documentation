...
- the **table of parameters**. This table groups all the parameters required to run the applet. The list of parameters is provided by the Applet distributor. 
	***To add a parameter***, click "Add", then specify the parameter name and its value. 
...
**Example**: If the parameter is a file located in the "&lt;ProjectName&gt;_WEB" directory, the value of the parameter corresponds to "../&lt;File name&gt;".


## Voir aussi

[Applet control properties](../WDChamp/1013032.md)

[Java Applet control events](../WDChamp/1013045.md)
