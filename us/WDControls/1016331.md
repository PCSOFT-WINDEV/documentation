...
The "IncomingData" event can also be used to load uploaded images into a memo section of an HFSQL data file, via the [HLinkMemo](../WDLang4/3044173.md) function.
