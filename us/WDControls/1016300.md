...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) **Conditions of use**: To use a Calendar control in Android, the "Android Support Library V4" extension is required on the development workstation, when generating the Android application.. The setup procedure of this extension is available at the following address: 
...
<a name="creating_calendar_control_ELTPARAGRAPHE000043"></a>

To create a Calendar control: 

1. On the "Creation" tab, in the "Graphic controls" group:

	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) expand "Time" and select "Calendar".

	- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) click "Calendar".
...
<a name="describing_the_calendar_control_ELTTEXTE000263"></a>
...
- define a background image: 
	...
	- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) "Style" tab of the description window, "Background image" element.
...
- define the characteristics of the calendar ("Details" tab of the description window): 
	...
	- week number display (8601-compliant numbering possible).
...
<a name="translating_the_elements_calendar_control_ELTTEXTE000287"></a>


### Translating the "Today"/"Preset period" button
<a name="translating_the_todaypreset_period_button_ELTPARAGRAPHE000104"></a>
...
<a name="translating_days_and_months_the_calendar_control_ELTPARAGRAPHE000111"></a>
...
2. On the "Languages" tab, select the desired language.
...
<a name="translate_the_context_menu_the_calendar_control_ELTPARAGRAPHE000138"></a>
...
2. On the "UI" tab, click the button to the right of "Context menu". Select "Edit this context menu".
...
[Calendar control properties](../WDChamp/1016302.md)
...
[Automatic calendar for the Date edit controls (AAF)](../WDChamp/9500124.md)
