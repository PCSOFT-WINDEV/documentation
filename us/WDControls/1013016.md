...
**Note**: To manipulate the rows of a TreeView control using WLanguage properties, use:

- &lt;TreeView control name&gt;[&lt;Element index&gt;&gt;]..&lt;Property&gt;.

- &lt;TreeView control name&gt;[&lt;Element path&gt;&gt;]..&lt;Property&gt;.
...
| [CheckmarkVisible](../Proprietes/1000019549.md) | The **CheckmarkVisible** property is used to: <br><br>- Determine whether a checkmark is displayed to the left of a row in a TreeView control. <br><br>- Show or hide a checkmark to the left of a row in a TreeView control. <br><br><br> |
...
<a name="properties_available_page_server_code_ELTPARAGRAPHE000047"></a>The following properties can be used with the rows of a TreeView control: 
