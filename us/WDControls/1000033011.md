...
- **Document** Allows you to open, create, save or print an ".xlsx" file.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0001%201.gif)
It is possible to:
...
- **Clipboard**: Contains the common clipboard actions.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0001%202.gif)


- **Font**: Contains the font formatting options for the current text. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0001%203.gif)
It is possible to:
...
- **Alignment** Allows you to manage the alignment of different elements: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0001%204.gif)
...
- **Number**: Used to manage selection characteristics: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0003.gif)
...
- **Styles** format as table: format as table a range of cells. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0004.gif)


- **Cells**: Insert, delete or erase cells. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0005.gif)
It is possible to: 
...
- **Edit** Allows you to search, replace and sort data. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0009.gif)
...
### Find/Replace
<a name="findreplace_ELTPARAGRAPHE000085"></a>

**To search in a spreadsheet**: 

1. On the "Home" tab, in the "Editing" group, click "Find" (or press Ctrl + F). 

2. In the window that appears, indicate: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban_Rech%20-%20HC%20N%B0001.gif)
...
2. In the window that appears, indicate: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban_Rech%20-%20HC%20N%B0002.gif)
...
4. Click "Replace" to replace only the selected occurrence. 

5. Click "Replace all" to replace all occurrences. 
...
3. In the window that appears, indicate: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Tableur_Ruban%20-%20HC%20N%B0018.gif)
...
Note: When the xlsx file is opened, the password is automatically requested before it is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ChampTT_mdp%20-%20HC%20N%B0002.gif)
