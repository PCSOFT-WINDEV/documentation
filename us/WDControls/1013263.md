...
- Programmed additions or modifications: the value of the column indicated in function [TableAddLine](../WDLang1/3074006.md), for example, will be assigned to the main field.

- Exports from the Table control (to Excel, Open Office, Word, etc.) will use the value of the column's main field.
...
- **solution 1** Maintain the link between the main field and the item in the data file. The Container column is linked to no item.
...
**Note** For a data-bound Table control, it is advisable to manipulate the fields of a Container column in the "Display a line" event.
