...
To display the table description, select "Table description" in the context menu of a table element (cell belonging to the header, to the data or to the total of table). The following window is displayed:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=EtatDescriptionTableau.gif&type=thumb)
...
- The ***item associated with the column***. The corresponding control will be displayed in the data row of the table. This control can be associated with no item in order to be populated programmatically for example. The type is automatically updated according to the selected item.
...
- **Tab "Column": Column Settings**
	The "Column" tab lets you set all column display characteristics: type, display mask, etc.

- **Tab "Link": Configuration of the column link**
...
[The tables in a report](../WDChamp/1013050.md)
