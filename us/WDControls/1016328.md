...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [linked to a data file](../WDChamp/1016325.md). 
...
<a name="filling_organizer_control_with_the_data_found_hfsql_data_file_ELTPARAGRAPHE000226"></a>
...
END
```
**Reminder** It is also possible to use an Organizer control linked to a data file. For more details, see [Organizer control linked to a data file](../WDChamp/1016325.md).
