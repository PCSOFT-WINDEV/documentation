...
Note: The recovered image contains only the modifications validated by the user.. Any ongoing changes that have not yet been validated will be ignored in the returned [Image](../WDLang1/1000019650.md) variable. 
