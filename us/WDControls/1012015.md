...
3. Create all the necessary controls. These controls will be in all the pages that use the page template.
...
2. Keep the controls required by the template. These controls will be in all the pages that use the page template.
...
**Note** The properties of the page managed by the template are as follows: Image, Fixed background image, Background color, Text color, Link color, Visited link color, Active link color, Underline link, Center page, Set fields on page, Title, Field for displaying gauge, Ajax indicator position.
