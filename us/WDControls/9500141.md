...
3. Select "Automatic calculation (sum, average, ...)" then select the requested calculation type: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FAA_Calculs_automatiques%20-%20HC%20N%B0001%201.gif)
...
4. The calculation is automatically performed and it is added below the table. It is always visible. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FAA_Calculs_automatiques%20-%20HC%20N%B0002.gif)
