...
**The principle is simple** When a report is edited (a report created in the report editor or by programming), its exact copy can be generated in a file in ".dpl" format, and can then be stored in a database. 
...
- is named: Dupli_AAAAMMJJ_HHMMSS.dpl.
...
[iParameterDuplicate](../WDLang5/1000018845.md) can be used to: 
...
**Remark**: The list of duplicates created during the last printing can be known thanks to the [iLastFile](../WDLang5/3046068.md) function.. 
<a name="NOTE2_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png) 
...
<a name="creating_duplicate_copy_programmatically_ELTTEXTE000340"></a>
<a name="NOTE3_1"></a>
...
**Remark**: If the report includes a Signature field (linked to a certificate) or if the [iPrintSignature](../WDLang5/1000021690.md) function is used, the duplicate will be automatically signed when it is created.. 
...
When displaying a duplicate file in the report viewer, various banners may appear at the bottom of the viewer to inform the user of the duplicate file being handled: ![centeralt=Colored bars](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Duplicata_couleurs.gif)![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Viewer of duplicate copies**
These color bars are also available in the viewer of duplicate copies. 


## Voir aussi

[iParameterDuplicate (Function)](../WDChamp/1000018845.md)

[iDestination (Function)](../WDChamp/3046074.md)

[iPrintDuplicate (Function)](../WDChamp/1000018842.md)
