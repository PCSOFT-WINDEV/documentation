...
- **Create a new sub-report**.
	...
	1. Select: 
		...
		- subreport data source (data file, query, etc.). For more details, see [Report data source](../WDChamp/1011055.md).
...
- To view the description window of the sub-report: 
	...
	2. On the "Modification" tab, click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_regroup.gif) dialog box launcher of the "Report" group. You also have the ability to select "Sub-report description" in the context menu of the report.
