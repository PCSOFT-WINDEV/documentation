...
| File description, copied from the data model editor or from the ["Analysis" pane](../Editeurs/2027012.md). | Data-bound Table |
...
<a name="binding_control_data_file_item_ELTTEXTE000717"></a>
...
- an edit control from a data file item:
...
- a Table control from a data file:
	...
	2. Drag and drop the item onto the position where you want to create the bound Table control. The Table control creation wizard opens automatically.
...
Copying the style of a control consists in copying the characteristics of a control style to another control. Only the control style is copied (not its content). For more details, see [Copying the style of a control](../Editeurs/2021001.md).
