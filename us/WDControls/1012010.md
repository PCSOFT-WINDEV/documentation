...
1. [Default synchronization](#NOTE2),

2. [Manage synchronization programmatically, in the page synchronization code](#NOTE3).
...
1. Open the project description window. To do so, go to the "Project" tab, "Project" group, and select "Description". On the "Advanced" tab, in "Default option for the browser "Back" button", select "Allowed (runs the synchronization code)".
...
<a name="enabling_synchronization_programmatically_ELTTEXTE000233"></a>
