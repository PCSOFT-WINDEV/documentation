...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) In the "Interactivity" zone, check the "Interactive chart" option if necessary, then the "Enable animations" option.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Graphe_Animation_WB.gif)
