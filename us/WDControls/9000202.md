...
3. Pin the control: 
	...
	- In the "UI" tabs, click on the "Parallax / Pinned: None" button.. 
...
**Note**: Unlike standard anchoring, where container dimensions never go below those defined in editing, with a Pinned control, the anchoring reference frame is most of the time smaller than the container in which the field is located.. This can lead to overlapping controls or to a control being hidden (outside the container) if its anchors are not adapted to its initial position.


## Voir aussi

[Pinned (Property)](../WDChamp/1410087943.md)

[HideWhileScrolling (Property)](../WDChamp/1410087944.md)
