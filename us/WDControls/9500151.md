...
### WLanguage functions
<a name="wlanguage_functions_ELTPARAGRAPHE000246"></a>Several WLanguage functions are used to handle images in an automatic sequence. These functions are as follows:
