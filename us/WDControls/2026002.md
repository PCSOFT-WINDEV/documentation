...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=A_Hauteur.gif)<br> | Height | The control stretches downward when the window is vertically enlarged. Set the "height" anchor rate to define how much a control stretches relative to the window |
...
4. **If the anchors are set to "Height"**: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage_Editeur_au_contenu%20-%20HC%20N%B0002.gif)
...
5. **If the anchors are set to "Width"**: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage_Editeur_au_contenu%20-%20HC%20N%B0003.gif)
