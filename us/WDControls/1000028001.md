...
1. On the "Creation" tab, in the "Integration" group, expand "Social networks" and select the desired social network. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_R%E9seau_social%20-%20HC%20N%B0001.gif)
...
- The **type** of link to display. One or more types of buttons can be displayed for each social network: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_R%E9seau_social%20-%20HC%20N%B0002.gif&type=thumb)
...
- **Use the native button recommended by the social network**. In this case, some options can be configured: 
	...
	- **Show number of shares in a tooltip**: If this option is checked, the number of shares will be displayed in a balloon next to the Social Network control field.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_Lien_Social_Bulle.gif)
