...
1. Create a unique name for the HTML file to be generated. The creation directory of this file must be accessible in read/write (the directory of the data files or the "&lt;MyProject&gt;_WEB" directory of the site for example). 
...
**Caution**: Do not delete the status immediately after the [FileDisplay](../WDLang2/3012005.md) or [PageDisplay](../WDLang2/3058008.md) function.. The generated HTML file must exist in order to be viewed on the browser of the Web user.
...
**Remark**: The HTML file can be opened directly from a button or link.. Simply change the control action with the [URL](../Proprietes/2510132.md) property:
...
[Printing reports from a WEBDEV website](../WDChamp/1011021.md)
