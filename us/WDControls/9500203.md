...
- ***Linear Looper control by programming***.
...
**Remark**: The Linear RepeatString field shares many features with the RepeatString field.. It is specifically intended to display a small number of elements in order to propose a nice viewing.
...
To find out or modify the characteristics of a field (its value, color, etc.), simply manipulate the field or the corresponding attribute programmatically.
...
[Manipulating Linear Looper controls programmatically](../WDChamp/9500204.md)

[Linear Looper control properties](../WDChamp/9500208.md)
