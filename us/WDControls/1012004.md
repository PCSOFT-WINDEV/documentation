...
<a name="remember_the_synchronization_code_triggered_when_the_following_three_conditions_are_met_ELTPARAGRAPHE000030"></a>
...
- "Call page synchronization process if the user pressed the Back button" has not been unchecked in the "Advanced" tab of the control description.
...
1. Check whether the mechanism for synchronization management is enabled.
	...
	- at each button to manage the Table control or perform an action on the record selected in the control (option "Call page synchronization process if the user pressed the Back button" not unchecked in the "Advanced" tab of the control description).
...
[Configuring the browser "Back" button](../WDChamp/1012001.md)
