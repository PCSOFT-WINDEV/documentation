...
2. On the "UI" tab, select "Widget (Android/iOS14+)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0001.gif)
...
<a name="updating_the_content_ELTPARAGRAPHE000079"></a>
...
This description can be entered in several languages. If there are multiple windows for one widget, the description of the smallest window is used. 
