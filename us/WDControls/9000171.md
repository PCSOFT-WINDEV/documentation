...
Note: additional overrides are available for the Image control and Menu fields. This allows you to use smaller images for the mobile devices or to change the menu orientation. For more details, see [Additional overrides](#NOTE3_3).
...
These options are also available in the "Slices" tab of WEBDEV. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RWD%20-%20Ancrages%20-%20HC%20N%B0003.gif&type=thumb)
...
- in the list of control overrides for the current slice. To display this list, select the "Tranches . List overrides for selected fields".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RWD%20tranches%20-%20HC%20N%B0004.gif&type=thumb)
...
### Additional overrides: Image control and Menu field
<a name="additional_overrides_image_control_and_menu_field_ELTPARAGRAPHE000161"></a>
...
2. Select "Slices", then, in "Visibility by slice", select the slice in which the control must be hidden. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RWD%20tranches%20-%20HC%20N%B0004%201.gif&type=thumb)
