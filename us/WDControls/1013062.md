...
**Remark**: From version 20, conference control fields are supported under Windows Vista and higher.. If you want to use the Conference control with an earlier Windows version: 
...
Note: It is also possible to set up conference controls in a different private network via the Internet.. This type of dialog uses WebRTC technology. This technology requires the use of a STUN server and a TURN server. For more details, see [WINDEV and the streams](../WDLang3/3039001.md). 
...
[Conference control events](../WDChamp/1013095.md)

[WINDEV and the communication streams (audio, sound)](../WDChamp/3039001.md)

[WINDEV and the streams - Use example](../WDChamp/3039011.md)

[Conference control properties](../WDChamp/1013041.md)

[Stream functions (video and sound)](../WDChamp/3039004.md)
