...
The custom synchronization method for RepeatString Page controls relies on information hidden in the page: the identifier of the selected repeat.
...
To customize synchronization management for Looper control RepeatString files:
