...
The "Home" tab allows you to perform the most common operations on a ".docx" document. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001.gif&type=thumb)
This tab contains the following groups: 

- **Document**: Open, create and save docx documents. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%201.gif)
You can: 
...
- **Export**: Contains the document export options. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%202.gif)
You can: 
...
- **Clipboard**: Contains the common clipboard actions. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%205.gif)
You can: 
	...
	- Copy the formatting of the selected paragraph or section of text. To do so, simply: 
		...
		- Click the format painter icon ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%203.gif). 
...
- **Font**: Contains the font formatting options for the current text. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0001%206.gif)
You can: 
...
- **Paragraph**: Contains the paragraph formatting options, including background color, spacing, alignment, non-printable characters, etc.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0003.gif)

	If the current keyboard uses a right-to-left language, two additional icons are displayed to manage the writing direction. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TT%20arabe%20-%20HC%20N%B0001.gif)


- **Style**: Allows you to manage styles. The list of styles is displayed (with the style preview). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Styles%20-%20HC%20N%B0001.gif)
Click the double arrow icon to open a list with all the available styles. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Styles%20-%20HC%20N%B0003.gif)
...
- **Editing**: Allows you to find, replace and check the spelling of text. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0002.gif)
...
2. On the "Home" tab, in the "Paragraph" group, click the bulleted list icon (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0001.gif)). The window containing the bullet library opens. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0002.gif)
...
2. On the "Home" tab, in the "Paragraph" group, click the numbered list icon (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0001%201.gif)). The window containing the numbering library opens. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0003.gif)

	Note: Hovering over an option opens a list preview. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Puces%20-%20HC%20N%B0004.gif)
...
The "Insert" tab lets you insert elements into the current document (page, page break, header and footer, table, image, preset controls, etc.). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0004.gif&type=thumb)
...
2. The header (or footer) switches to edit mode. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Entete%20-%20HC%20N%B0001.gif&type=thumb)
The cursor is positioned in the header (or footer). 

3. The "Insert" tab of the Word Processing control includes the header and footer options. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Entete%20-%20HC%20N%B0001%201.gif&type=thumb)
...
2. In the window that appears, select the dimensions of the table to be created: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Volet_Tableau%20-%20HC%20N%B0001.gif)
...
3. Confirm. The formula is inserted and calculated. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ChampTT_Formule%20-%20HC%20N%B0002.gif)
...
Note: When opening the docx file, the password will be automatically requested before the file is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ChampTT_mdp%20-%20HC%20N%B0002.gif)
...
The "Layout" tab allows you to set the layout of the document and its paragraphs. <br>!["Layout" tab](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0005.gif)
This tab contains the following groups: 
...
<br>!["Table" tab](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Volet_Tableau%20-%20HC%20N%B0002.gif)
...
The "Image" tab is displayed when an image is selected in the document. <br>!["Images" tab](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_VoletImage%20-%20HC%20N%B0001.gif)
...
The "Text area" tab is displayed when a text area is selected in the document. <br>!["Text area" tab](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_ZoneTexte%20-%20HC%20N%B0001.gif)
...
The "View" tab allows you to set the document display options.<br>!["View" tab](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Ruban%20-%20HC%20N%B0006.gif)
**"Zoom" group**: 
...
- Left tab stop (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0003.gif)): Text is aligned to the right of the tab stop. 

- Center tab stop (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0004.gif)): Text is centered as the user types. 

- Right tab stop (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0005.gif)): Text is aligned to the right and extends to the left. 

- Decimal tab stop (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0006.gif)): Numbers are aligned to the left of the decimal separator. 

- Bar tab stop: Inserts a vertical bar at the tab stop position. 

- First-line indent (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0002%201.gif)): Indents the text on the first line of a paragraph. To indent the first line, simply move the rectangle that represents the first line. 

- Hanging indent (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0002%201.gif)): Indents the text of the second line and all subsequent lines of the paragraph. To set a hanging indent, simply move the triangle that represents the paragraph lines. 
...
2. In the context menu that appears, select "Delete tab". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Tabulation%20-%20HC%20N%B0008.gif)
...
When a document is open in read-only mode, a "Read-only" banner is displayed instead of the undo/redo icons. <br>![Read-only](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_TT_Lecture_Seule%20-%20HC%20N%B0001.gif)
