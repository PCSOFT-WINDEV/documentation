...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) At runtime, a context menu allows the end user to modify the chart presentation. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Graphe_MenuCtx.gif)
...
At runtime, a context menu allows end users to modify the chart presentation. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Menu_ctx_WB%20-%20HC%20N%B0001.gif)
