...
<a name="table_control_linked_data_file_with_automatic_browsing_ELTTEXTE000233"></a>
...
In this window, you can define whether the Table control is based on a data file or is populated programmatically. For a data-bound Table control, you can define how to loop through the data source:



|   |   |
| --- | --- |
| <br><br>- **Data file**<br><br><br> | File or query containing the data to display.<br>If the Table control is based on an embedded query, the name of the browsed file has the following format: &lt;Window Name&gt;_&lt;Number&gt;$Query. In this case, all the options of the "Embedded query" button are available. |
...
| ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) **Use HFilter to loop through the data file** | Allows you to filter the records displayed in the Table control and the base data file of the control. For more details on this option, see [Filter in data-bound Table controls](../WDChamp/1013202.md).<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Filter options are not available for Table controls with direct access to the data source. |
| ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Synchronize display (HFSQL C/S)** | This option automatically refreshes the data-bound Table control as soon as the associated Client/Server HFSQL data file is modified. <br><br>For more details, see [Table file field: Automatic synchronization (HFSQL Client/Server data)](../WDChamp/1013177.md). |
| ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Display a [ + ] to see the details of a row** | This option allows you to expand a row in the Table control to see records from other data files that are bound to the selected row.  <br><br>For more details, see [Table file field: automatic display of linked records](../WDChamp/1013177.md). |
