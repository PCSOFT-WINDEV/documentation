...
The menu allows you to: 
	...
	- open an image from disk: simply specify the file path in the window that appears (or drop the desired file). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_images_WB%20-%20HC%20N%B0003.gif)
...
The Image Editor control allows you to draw freely on the displayed image, using the pencil, marker or highlighter tool. <br>![Add a drawing](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_images_WB%20-%20HC%20N%B0005.gif)
...
### Insert a shape in the image
<a name="insert_shape_the_image_ELTPARAGRAPHE000043"></a>

The Image Editor control allows you to add: 
...
<a name="insert_text_into_the_image_ELTPARAGRAPHE000057"></a>

The Image Editor control allows you to insert text into an image. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_images_WB%20-%20HC%20N%B0008.gif)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_images_WB%20-%20HC%20N%B0010.gif)
...
You can save the image at any time by downloading it via the <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Editeur_images_WB%20-%20HC%20N%B0010%201.gif)
