...
When describing a Button control, Link control or Image control, it is possible to directly define the action performed, and the destination of this action.

To display a "xxx" page directly from a Button control, Link control, Image control, etc.:
