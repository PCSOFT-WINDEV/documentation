...
- a **Scheduler control file**: the Scheduler control will be linked to a data file or a query. In this case, the data file contains the characteristics of the appointments. 
...
- use the Scheduler control creation wizard. Simply select the option "Display data from an existing data file or query". Answer the questions in the wizard and validate. 
...
### Scheduler control file field
<a name="scheduler_control_file_field_ELTPARAGRAPHE000059"></a>
...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) If the user adds, deletes, or moves appointments with the mouse, the associated data file is automatically updated with the changes made in the control.
