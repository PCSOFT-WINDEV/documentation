...
**Note** In a report, the Spreadsheet control is handled in a different way. For more details, see [Manipulating Spreadsheet controls programmatically (in a report)](../WDChamp/1000033010.md).
...
To manipulate a Spreadsheet control programmatically, all you have to do is specify its name. 
...
<a name="handling_the_cells_the_spreadsheet_control_ELTPARAGRAPHE000265"></a>**To manipulate a cell of a Spreadsheet control through programming** , use the following notations: 
...
- the [&lt;Spreadsheet&gt;.AddData](../WDLang1/1000023711.md) function. 
	Example: Adding a value to cell "A2": 
...
To programmatically merge the selected cells, simply use [ExecuteAAF](../WDLang1/3013060.md) with the *aafSpreadsheetMerge* constant: 
...
- Programmatically, use the [MultiWorksheet](../Proprietes/1000021639.md) property. 
...
- Several functions are used to handle different worksheets: 
