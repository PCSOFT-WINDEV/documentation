...
In the Table controls, the user can resize the height of rows, in read-only or in edit.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FAA_Redim-hauteur-ligne.gif)
