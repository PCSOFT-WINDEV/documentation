...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) the [FileToPage](../WDLang4/3044148.md) function.For more details, see [Linking a Check Box control to an item](../WDChamp/1013152.md).
...
**Note** If the field is associated with an item in a data file, the value entered is automatically retrieved using the [ScreenToFile](../WDLang4/3044146.md) function. For more details, see [Linking a Check Box control to an item](../WDChamp/1013152.md).
<a name="NOTE3_2"></a>
...
**Note** If the field is associated with an item in a data file, the value entered is automatically retrieved using the [PageToFile](../WDLang4/3044022.md) function. For more details, see [Linking a Check Box control to an item](../WDChamp/1013152.md).
...
[Handling a Check Box control through programming (prefix syntax)](../WDChamp/1013320.md)
