...
**Note** When a field is associated with a Combo Box control, the content of the combo is the same for all records in the data file. For example, if the Combo Box item contains the options "Paid", "In progress", and "Pending", this content will be the same for all records. 
