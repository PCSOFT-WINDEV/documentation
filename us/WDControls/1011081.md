...
[**Reports & Queries**](../Presentation/3088004.md) cannot be used to create reports on an Organizer control. However, you have the ability to customize the reports on Organizer control created in the standard report editor (color, fonts, size, ...).
**Note**: Only an Organizer control can be used to create an Organizer status. 
...
<a name="characteristics_the_report_based_organizer_control_ELTTEXTE000271"></a>
...
It is possible to create a state based on an Organizer control from the state editor: simply select an Organizer state based on an Organizer control. 
...
**Warning** It is not possible to test a report on an Organizer control directly from the report editor, as the window or page containing the Organizer control must be open. To run the test of a report based on an Organizer control, you must:
...
- create (if necessary) a button in the window or in the page of the Organizer control. This button can be used to print the report with the data from the Organizer control ([iPrintReport](../WDLang5/3046032.md)). 
	Internal windows or pages: If the Organizer control is present in an internal window or page, it is advisable to create the button in the internal window/page and not in the host window/page.
...
<a name="creating_report_based_organizer_control_from_the_report_editor_ELTTEXTE000295"></a>
...
<a name="printing_report_based_organizer_control_ELTTEXTE000325"></a>


### Printing a report based on an Organizer control
<a name="printing_report_based_organizer_control_ELTPARAGRAPHE000115"></a>
...
### WINDEV example
<a name="windev_example_ELTPARAGRAPHE000183"></a>
