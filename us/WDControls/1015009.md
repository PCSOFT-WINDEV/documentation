...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Note** To optimize the filling of a TreeView Table control, you can use the [AddChildDelayed](../Proprietes/1000020927.md) property on the rows of the TreeView Table control. 
...
- When the user clicks the element on the first level to expand it, the procedure defined by the [AddChildDelayed](../Proprietes/1000020927.md) property is executed. This procedure fills the level to expand. Child nodes are only retrieved on demand.
...
- programmatically:
	...
	- with [&lt;Table&gt;.Modify](../WDLang1/1000024273.md) or [&lt;Table&gt;.ModifyLine](../WDLang1/1000024275.md) to modify the contents of the current row or a specific row.
		...
		```
			...
			**Note** You can also use the name of the TreeView Table control directly: 
...
<a name="value_cell_for_specific_row_ELTPARAGRAPHE000672"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Note: If the TreeView Table control uses dynamic population filling of sub-levels via the [AddChildDelayed](../Proprietes/1000020927.md) property, the sub-level filling procedure will be executed for each new element unrolled. 
<a name="NOTE5_3"></a>
...
You can define the state of the next row that will be added to a TreeView Table control (collapsed or expanded). To do so, use the  property.
...
<a name="getting_and_setting_the_images_the_rows_ELTPARAGRAPHE000820"></a>
...
<a name="treeview_column_with_check_box_ELTPARAGRAPHE000841"></a>
...
<a name="getting_the_parent_children_element_ELTPARAGRAPHE000860"></a>
...
<a name="properties_specific_treeview_table_controls_ELTTEXTE000874"></a>
