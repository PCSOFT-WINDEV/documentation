...
2. Click where the control will be created in the window or page. The control appears in the editor.
	Note: The dimensions of the control are optimized to take up the available space at the specified position. If necessary, resize the control using the handles. 
...
For more details, see [Display different content on each row](../WDChamp/1013289.md). 
...
- **Layout** Allows you to specify whether the Layout control manages the layout of fields vertically or horizontally. 
...
- **Fix cells** Allows you to specify the alignment of cells in the field according to the chosen layout. 
...
- **Management of overflow**: 
	...
	- **Enlarge field, expand surrounding fields** the field is enlarged to display all cells. 
...
- **Display scrollbars automatically** Scrollbar control: the client area of the field is enlarged and scrollbars are displayed for scrolling within the field. 
...
Example 1: Option **Enlarge field expands surrounding fields**
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Example 4: Option **Enlarge field expands surrounding fields** with programmable window reduction management
