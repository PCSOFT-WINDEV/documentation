...
- **linear potentiometer**: Consisting of a ruler and a cursor, this field is very useful for prompting the user to enter a value within a given range.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Potentio_Lin_WB.gif)
...
1. In the "Creation" pane, in the "Graphic controls" group, scroll down to "Slider" and select the type of slider to be created: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Potentio_Creation_WB.gif)
