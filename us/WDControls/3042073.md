...
<a name="characteristics_radar_chart_ELTTEXTE000179"></a><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GenRadar.gif&type=thumb)
In this chart:
...
**8. Mark**. 
Intervals are automatically calculated. Therefore, [grOrigin](../WDLang3/3042039.md) will have no effect on this type of chart.

Note: Zooming is not supported on a Radar chart.
