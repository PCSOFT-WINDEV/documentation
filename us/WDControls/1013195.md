...
- Tab image: This image lets you redefine the shape and color of the tab.. Example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=OngletVolet.gif)
...
4. In the "Image" field, select the image to be embedded next to the label using the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button: 
...
3. In the "Tab icon" field, select the image to be embedded next to the label using the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button next to the field: 
...
**3-frame automation stretching**: 
In this case, the shutter image is automatically split into 3 images by WINDEV/WEBDEV.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Onglet3Images.gif)
...
- section 2 corresponds to the middle area. The size of this section is 16 pixels. If the tab is proportional to the text, this section will be repeated as many times as necessary to fit the text.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Onglet_Imagevolet.gif)
