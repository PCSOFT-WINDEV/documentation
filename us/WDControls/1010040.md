...
2. On the "Image" tab, select "Use 9-slice scaling" and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=btnrupture.gif) to configure this mode.
...
2. On the "General" tab, select "Use 9-slice scaling" and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=btnrupture.gif) to configure this mode.
...
2. In the "General" tab, select "Stretch: Custom 9-slice scaling" and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=btnrupture.gif) to configure this mode.
