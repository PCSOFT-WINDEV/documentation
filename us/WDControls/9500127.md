...
4. In the "Zoom on hover" section, specify: 
	...
	- Display mode: "Zoom in a customized popup".. Specify the cell and the image to use (WEBDEV proposes the elements found in the page). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WB_Zoom_Cellule.gif)
