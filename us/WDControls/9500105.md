...
A context menu is available for Image controls. This menu allows you to: 
...
- "Simple menu (copy, save as, etc.)". The context menu allows you to copy, save and display the selected image in high quality.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FAA_MenuContextuelImage%20-%20HC%20N%B0002.gif)
...
3. Choose the desired menu in the "Context menu" combo box. It is possible to: 
	...
	- "Display the AAF menu (System)": In this case, the context menu displayed will be the Image control automation menu. For more details on how to configure this menu, see [AAF menu settings](../Editeurs/2010040.md).
...
The Image control offers export options: "Copy", "Save as", "Open with default program", ...
