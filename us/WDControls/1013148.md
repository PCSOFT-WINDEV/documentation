...
For more details, see [Table control functions](../WDLang1/3074009.md).
...
- [TableAdd](../WDLang1/3074017.md) or [TableAddLine](../WDLang1/3074006.md): adds a line at the end of the Table control. 

- [TableInsert](../WDLang1/3074025.md) or [TableInsertLine](../WDLang1/3074026.md): adds a line to the specified or current index. 
...
- or with functions [TableAddLine](../WDLang1/3074006.md) and [TableInsertLine](../WDLang1/3074026.md): in each row, the value of each column is separated by commas.

- or with functions [TableAdd](../WDLang1/3074017.md) and [TableInsert](../WDLang1/3074025.md): in a row, each column value is separated by TAB.
...
<a name="value_the_cell_the_current_row_ELTPARAGRAPHE000312"></a>To retrieve the value of a column (or cell) for the current row, the syntax is the same as for a simple Edit control.
...
<a name="value_cell_for_specific_row_ELTPARAGRAPHE000326"></a>To retrieve the value of a column that is not in the current row, you must specify the index of the row.
...
**Remark**: The current line index can be known by the [TableSelect](../WDLang1/3074020.md) function.. 
For example:
...
[Table populated programmatically: WLanguage manipulation (prefix syntax)](../WDChamp/1013329.md)
