...
In WINDEV, you can use [TimeLine functions](../WDLang1/1000020783.md) to manipulate TimeLine controls programmatically. 
...
<a name="manipulating_timeline_controls_programmatically_ELTTEXTE000133"></a>


### Adding a track
<a name="adding_track_ELTPARAGRAPHE000156"></a>
...
**Remark**: The [&lt;TimeLine&gt;.AddTrack](../WDLang1/1000020777.md) function inserts a background image into the track.


### Adding an event
<a name="adding_event_ELTPARAGRAPHE000186"></a>
...
<a name="populating_timeline_control_with_the_data_from_hfsql_data_file_ELTPARAGRAPHE000228"></a>
...
<a name="retrieving_list_events_ELTPARAGRAPHE000253"></a>

[TimelineListEvent](../WDLang1/1000020779.md) is used to retrieve: 
...
### Deleting an event
<a name="deleting_event_ELTPARAGRAPHE000290"></a>
...
### Deleting a track
<a name="deleting_track_ELTPARAGRAPHE000314"></a>
...
<a name="changing_the_time_scale_the_control_ELTPARAGRAPHE000340"></a>

You can change the time scale of a TimeLine control with [&lt;TimeLine&gt;.ChangeMode](../WDLang1/1000020778.md). This function can be used to change the field display mode: second, millisecond or microsecond..



## Using the context menu (AAF)
<a name="using_the_context_menu_aaf_ELTTEXTE000350"></a>
...
<a name="advanced_use_the_events_associated_with_the_timeline_control_ELTTEXTE000393"></a>


### Advanced use of events with procedures
<a name="advanced_use_events_with_procedures_ELTPARAGRAPHE000416"></a>
...
<a name="properties_specific_timeline_controls_ELTTEXTE000433"></a>
