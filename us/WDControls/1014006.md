...
| Description of a data file, copied from the data model editor of WEBDEV or from the ["Analysis" pane](../Editeurs/2027012.md). | Data-bound Table |
...
<a name="binding_control_data_file_item_ELTTEXTE000646"></a>
...
The following controls cannot be bound to a data file item:
...
### Selecting one or more controls in a page
<a name="selecting_one_more_controls_page_ELTPARAGRAPHE000228"></a>
