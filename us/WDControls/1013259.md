...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Several functions are also available to make the internal windows scroll in an Internal Window control via a simple finger gesture. For more details, see [Changing the content of an internal window with a touch gesture](../WDChamp/1013277.md).
<a name="NOTE2_2"></a>
...
```
**Note** The [ChangeSourceWindow](../WDLang1/3038053.md) function can be used to dynamically change the internal window displayed in an internal window field. During this modification, you have the ability to pass parameters to the internal window.
<a name="NOTE2_3"></a>
