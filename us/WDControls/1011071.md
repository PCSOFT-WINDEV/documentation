...
- modify the data source of report ("Data" tab of report description):<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Manipuler_un_%E9tat%20-%20HC%20N%B0001.gif)


	- by changing the type of data source for the report (switching from a report based on a query to a data-bound report or on a memory area for example).
...
The display options in the report viewer are defined in the "UI" tab of the report description. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Manipuler_un_%E9tat%20-%20HC%20N%B0002.gif)
You can:
...
The "Format" tab of the description window of report is used to configure: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Manipuler_un_%E9tat%20-%20HC%20N%B0004.gif)
...
The "Options" tab found in the description window of report is used to configure: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Manipuler_un_%E9tat%20-%20HC%20N%B0005.gif)
...
Most types of reports can be created from a form. The "Background" tab allows you to define the image used as form in the report. This image can be printed (or not) with the report. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Manipuler_un_%E9tat%20-%20HC%20N%B0006.gif)
