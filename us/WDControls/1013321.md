...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) the [&lt;Window&gt;.ToFile](../WDLang4/1000021385.md) function.
...
- Code for a picker field returning an integer: entering "SELON SEL_Civilité" in the code editor displays: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Selon_auto_Selecteur2.gif)


- Code for a picker field returning a value: entering "SELON SEL_PlatDuJour" in the code editor displays: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Selon_auto_Selecteur1.gif)
