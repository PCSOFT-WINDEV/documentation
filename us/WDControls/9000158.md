...
2. Press the Alt key on the keyboard. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Style_Cadre.gif) icon appears in the upper-right corner of the control. 

3. Hold the Alt key down and click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Style_Cadre.gif) icon. The configuration options are displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Style_Cadre_Etat_bl.gif&type=thumb)
