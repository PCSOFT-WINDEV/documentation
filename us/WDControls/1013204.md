...
| [SynchroHFSQL](../Proprietes/1000023408.md) | The **SynchroHFSQL** property is used to: <br><br>- know how to refresh a Table control linked to an HFSQL Client/Server data file. <br><br>- specify the refresh mode of a Table control bound to an HFSQL Client/Server data file.<br><br><br> |
