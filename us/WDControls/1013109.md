...
**Tip** It's also possible to create a "pre-formatted" Bar Code control by selecting the "StrikeOut" option. A preview of the available bar codes appears. This preview uses the project skin template. Simply click the control you want to create in the editor. 
...
|   |   |
| --- | --- |
| A Bar Code control includes:<br><br>- the caption of the bar code.<br><br>- the image of the bar code.<br><br>- the value of the bar code (that corresponds to an alphanumeric string).<br><br><br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=codeBarre_Detail.gif)<br> |
