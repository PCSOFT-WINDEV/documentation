...
2. On the "General" tab, specify: 
	...
	- the programming format if necessary ("Returned value"). The programming format allows you to define the format used by the program (for example, the format of the items displayed in the control).
...
### Tip: Display the site update date
<a name="tip_display_the_site_update_date_ELTPARAGRAPHE000108"></a>
...
[Formatted Display control events](../WDChamp/1013055.md)
