...
3. To customize:
	...
	- the ***menu background color*** Select "Option background" in the "Element" combo and select the option background color.

	- the ***menu option font*** Select "Option text" in the "Item" combo and select font characteristics (attributes, size, color, etc.)

	- the ***hover option background color*** Select "Option background (hover)" in the "Element" combo and select the background color of the hovered option.
...
Example: The "main" options in the following menu are "Files" and "Prints".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=OptionPrincipale.gif)
To make this main menu invisible, enter the following line of code:
...
**Example** The operations required to display a context menu with a left-click are illustrated in the following example: The "MyMenu" context menu is only displayed when you left-click on the "SAI_MyChamp" Edit control.

1. Open the code of "EDT_MyControl" ("Code" in the context menu of the control).

2. Click the link "Add other events to xxx" at the bottom of the window code, after the last event.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Traitements_optionnels_WD_OK%20-%20HC%20N%B0001.gif)
In the list of optional events, select the "Left button pressed" event and confirm.
...
**Example** The operations required to retrieve the number of the row and column selected by a right-click are illustrated by the following example: The "MyMenu" context menu is associated with the Table control "TABLE_MaTable". This menu is used to handle the content of the cell from which the context menu is opened.
...
2. Click the link "Add other events to xxx" at the bottom of the window code, after the last event.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Traitements_optionnels_WD_OK%20-%20HC%20N%B0001.gif)
In the list of optional events, select the "Right button pressed" event and confirm.
...
**Example** The operations required to dynamically change a context menu when right-clicking on an item in a TreeView control are illustrated in the following example: 
...
- ***ctxGroup*** allows you to manipulate the user groups listed in the TreeView control. 
