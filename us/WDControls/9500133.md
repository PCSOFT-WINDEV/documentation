...
- **For Table controls in Browser or Ajax mode**mode, the following options are also available: 
...
- If the "With column titles" option is selected, the **"Edit column title-headers" BUTTON** allows you to define additional titles displayed above the title of one or more columns. To define a column title-header:
	...
	3. The different table columns are displayed in the window that opens.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TableAjouteSurEntete_Edit.gif&type=thumb)
...
**Example** Table control: Server table field with column titles, selector banner, export context menu and selector banner: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Table_avec-options.gif)
