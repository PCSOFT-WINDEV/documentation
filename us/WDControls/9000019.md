...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Data persistence is only achieved programmatically. The information is stored in a browser cookie. 
...
## How to?
<a name="how_ELTTEXTE000325"></a>


### Enabling or disabling the persistence of a control in a window
<a name="enabling_disabling_the_persistence_control_window_ELTPARAGRAPHE000058"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remark**: This mechanism can be set up by the user using the ["Store" in the context menu of the controls (AAF)](../WDChamp/9500128.md) option.. 
...
## Operating mode
<a name="operating_mode_ELTTEXTE000349"></a>
...
### Setting
<a name="setting_ELTPARAGRAPHE000118"></a>
...
<a name="advanced_operating_mode_ELTTEXTE000379"></a>


### Storing the global variables of a project
<a name="storing_the_global_variables_project_ELTPARAGRAPHE000145"></a>
...
### Implementation
<a name="implementation_ELTPARAGRAPHE000154"></a>
...
```
There's no need to manage the parameter type: the parameter type is entirely managed by the persistence mechanism (no need, for example, to use the [Val](../WDLang1/3024037.md) function to retrieve a numerical value).
...
## Optimization
<a name="optimization_ELTTEXTE000409"></a>


### Storing the global variables of a project
<a name="storing_the_global_variables_project_ELTPARAGRAPHE000203"></a>
...
**Example: A multi-criteria search window using the persistence mechanism**
...
### Optimization
<a name="optimization_ELTPARAGRAPHE000217"></a>
...
<a name="managing_the_persistence_data_with_the_wlanguage_functions_ELTTEXTE000439"></a>
...
[InitParameter (Function)](../WDChamp/3025044.md)

[SaveParameter (Function)](../WDChamp/3025046.md)

[LoadParameter (Function)](../WDChamp/3025047.md)

[Saving entered data (AAF)](../WDChamp/9500128.md)
