...
**Note** You can also use another type of window as a popup window. In this case:
...
<a name="opening_programmatically_ELTPARAGRAPHE000061"></a>The following functions are used to open a popup window:
