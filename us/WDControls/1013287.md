...
2. On the "Content" tab, click <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=BtnRupture.GIF)
. The window for managing breaks is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FenRupture.GIF)
...
5. Select the element on which the calculation must be performed. The calculation can be performed on:
	...
	- A field in the data file (only for data-related RepeatString fields).
