...
<a name="event_handled_default_ELTTEXTE000144"></a>
...
**Note**: In a static page, only Browser codes are available. The control is associated with no browser code. 


## Voir aussi

[Line control properties](../WDChamp/1013173.md)
