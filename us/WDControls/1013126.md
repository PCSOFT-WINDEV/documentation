...
You can create a **TreeView control File**: the TreeView control will be linked to a data file or a query. 

TreeView control programming is greatly simplified: you no longer need to use the Arbrexxx. 
...
<a name="create_treeview_control_linked_data_file_ELTPARAGRAPHE000019"></a>
...
3. In the "Content" tab, select "Data file/Survey". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Arbre_Contenu.gif&type=thumb)
...
7. Define as many sources as necessary. 
	**Special case: TreeView control linked to a recursive data file**
	A TreeView control linked to a data file can display records dependent on the previous record (the classic case of a recursive link to manage/child parents, for example). 
