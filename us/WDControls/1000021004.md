...
**Remark**: Switching from one pane to another (when the user clicks on the pane label) is automatically managed.. 
...
For a complete list of WLanguage properties that can be used with Ribbon controls, see [Ribbon control properties](../WDChamp/1000021003.md).
