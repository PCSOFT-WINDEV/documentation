...
- in the status with [mechanism for "control override"](../WDChamp/9000106.md): the modification will be effective for the status only. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Modeles%20d'etats%20-%20HC%20N%B0002.gif&type=thumb)
