...
- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) **Panorama mode**: Images appear as if they were displayed on a curved screen. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Listeimage_panorama.gif)
...
**Remark**: ListView controls support drag-and-drop actions. For more details, see [Drag and Drop](../WDLang1/3030007.md).
...
<a name="specific_features_the_panorama_mode_ELTPARAGRAPHE000064"></a>
...
- Some features, such as scrollbars, are not available.
...
[ListView control linked to a data file (or to a query)](../WDChamp/1013174.md)
