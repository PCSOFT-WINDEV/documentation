...
4. Create all the necessary controls. These controls will be in all the windows that use the template.
...
2. Keep the controls required by the template. These controls will be in all the windows that use the window template.
...
4. Give your window a name ("General" tab in the description window of the window).
