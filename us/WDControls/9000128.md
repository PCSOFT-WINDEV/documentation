...
If the sequence is not known in advance and if it must be programmed, the sequence of reports can be used programmatically.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Enchainement_Etats.gif&type=thumb)
