...
1. Under the "Creation" pane, in the "Usual controls" group, click on "Rich Text Area". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ZTR_Creation.gif)
...
2. Click on the field: a yellow banner appears around the field and the field switches to edit mode. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ZTR_Edition_bandeau_Jaune.gif)
...
3. In edit mode: 
	...
	- the editor ribbon adapts to the input field: all available editing options are displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ZTR_Edition_ruban.gif)
These edit options are grouped in 4 categories: 

		- Font: allows you to specify font attributes for the selected text. 

		- Paragraph: allows you to specify paragraph attributes (indents, bullets, lists, centering and justification)
