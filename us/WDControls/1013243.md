...
- [column titles (images, sorting icons, magnifier, filter, etc.)](../WDChamp/1013330.md)
...
**Note** Customization of these elements can be used, for example, to obtain a "Vista" style on workstations not using Windows Vista. The skin templates supplied with WINDEV contain examples of reusable and modifiable images.
...
2. Select the "Even row colors" or "Odd row colors" element.
...
6. These images must respect the following format:
	...
	- Vertical elevator: Image size: 60 x 128 pixels. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ascenseur_V_Table.gif)


	- Horizontal elevator: Image size: 384 x 47 pixels. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ascenseur_H_Table.gif)
