...
Note: The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Bouton_rond%20-%20HC%20N%B0001%202.gif) icon (to the right of the "Frame" option) lets you configure the shadow of the field's frame.. If a shadow is used, you can choose: 
