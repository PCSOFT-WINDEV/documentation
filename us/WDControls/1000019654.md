...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [linked to a data file](../WDChamp/1000019543.md).
...
<a name="populating_scheduler_control_with_the_data_from_hfsql_data_file_ELTPARAGRAPHE000281"></a>

The records are stored in an HFSQL data file. The initial fill of the Scheduler control can be done by browsing the data file via the FOR EACH syntax and by adding each appointment via [&lt;Scheduler&gt;.AddAppointment](../WDLang1/1000022904.md).
...
**Example**: To store an appointment added by the user via the context menu in an APT data file, simply write the following in the "Enter input mode in an appointment" event:
