...
## Attribute column: associate an attribute with a field (container column)
<a name="attribute_column_associate_attribute_with_field_container_column_ELTTEXTE000189"></a>
...
3. In the "General" tab of the column description window: 
	...
	- Select the field property associated with the Attribute column: the contents of the column will correspond to the value of this property.. 
