...
<a name="characteristics_bubble_chart_ELTTEXTE000204"></a><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=gen_Bulle.gif)
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The "Bubble" charts can be displayed with an animation. To animate this type of chart, simply check "Enable animations" in the "Details" tab of the control description. 
