...
## Operating mode
<a name="operating_mode_ELTTEXTE000138"></a>
...
- Counters, totals, etc. defined for the Table control field are not printed. Only a row counter is printed below the TreeView Table control. The caption corresponds to the caption defined for the counter in the window editor.
...
- The document is printed using the writing direction specified with the  property at window and/or TreeView Table control level.
