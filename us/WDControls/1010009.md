...
- directly in the window being edited:
	...
	3. Modify the caption in the input area.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Caract%E9ristiques_des_options_de_menu%20-%20HC%20N%B0001.gif)
...
<a name="image_associated_with_menu_option_ELTPARAGRAPHE000220"></a>An image can be shown next to "Standard" and "Break" menu options.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Caract%E9ristiques_des_options_de_menu%20-%20HC%20N%B0003.gif)
...
3. On the "General" tab, select the keys that make up the shortcut for the menu option.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Caract%E9ristiques_des_options_de_menu%20-%20HC%20N%B0004.gif)


4. Validate the description window. The selected keyboard shortcut will be displayed after the caption of menu option:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Caract%E9ristiques_des_options_de_menu%20-%20HC%20N%B0005.gif)
