...
<a name="populating_scheduler_control_with_the_data_from_hfsql_data_file_ELTPARAGRAPHE000121"></a>

The records are stored in an HFSQL data file. The initial fill of the Scheduler control can be done by browsing the data file via the FOR EACH syntax and by adding each appointment via [SchedulerAddAppointment](../WDLang1/1000019273.md).
