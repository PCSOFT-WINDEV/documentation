...
- In the same way, you can change the column label of a Table control.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Lib_table_modifdirect.gif)
