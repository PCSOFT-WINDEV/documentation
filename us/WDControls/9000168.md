...
7. Configure the responsive editing mode:
	...
	- **Desktop First - Min size edition** The page is defined in its widest version **Desktop** which serves as a reference, and then decreases towards the lower slices. **Tablet** and **Mobile**. Each slice will be edited in its minimum size. Thus, when the Tablet slice is selected, the editing area will be the Mobile slice, which is the smallest size in the Tablet slice.

	- **Desktop First - Max size edition** The page is defined in its widest version **Desktop** which serves as a reference, and then decreases towards the lower slices. **Tablet** and **Mobile**. Each slice will be edited in its maximum size. Thus, when the Tablet slice is selected, the editing area will be the Tablet slice, which is the largest size in the Tablet slice. Overrides are propagated 

	- **Mobile First** The page is defined in its smallest version **Mobile** version, which serves as a reference, and then increases towards the higher ranges **Tablet** and **Desktop**.
...
**Note** Pages using the "Responsive Web Design" mode are in HTML 5. 
...
- Some controls are adapted to the legacy responsive mode: 
	...
	- Table control: adaptation of table columns (masked or not) according to the slice.
...
3. **Title anchor**: 
	...
	- X anchor becomes "Centered": the field remains centered on the page regardless of page width. 
...
- Desktop blade: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RWD%20-%20Exemple%20Ancrage%20bis%20-%20HC%20N%B0001.gif&type=thumb)
...
**Advanced mode: Override example** In Mobile mode, it is also possible to override the position of the Chart control and Static Text control fields: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=RWD%20-%20Exemple%20Ancrage%20-%20HC%20N%B0007.gif&type=thumb)
