...
**Note** Many WLanguage functions are specific to Map control management. For more details, see [Map control functions](../WDLang3/1000019955.md).
...
When a window containing a Map control is opened, a world map is automatically displayed: the map is centered on Europe, with a minimal zoom level.
