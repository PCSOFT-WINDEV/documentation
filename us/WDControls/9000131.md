...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage8_WB.gif)<br> | Right and Bottom | The field moves to the right and downwards as the size of the browser (or of the container element: cell, RepeatString, etc.) enlarges. |
...
- **Width anchoring**: defines the width behavior of the field when the reference field is resized.. The overlaid control can:
	...
	- track browser behavior.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage_Largeur_WB.gif)
...
- **Height anchor**: defines the height behavior of the field when the reference field is resized.. The overlaid control can:
	...
	- track browser behavior.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage_Hauteur_WB.gif)
...
In this example, the anchor has been set on the RepeatString Looper control (red arrows). The Button control next to the Looper control was automatically anchored by WEBDEV (blue arrows). 
...
- Static Text control not anchored: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage_WB_Ex1.gif)


- Static Text control anchored in width: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage_WB_Ex2.gif)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage_WB_Ex3.gif)


- Static Text control field anchored in width and adapted to content: whatever the browser size and if no other HTML constraints exist, the label is adapted to the content.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Ancrage_WB_Ex4.gif)
