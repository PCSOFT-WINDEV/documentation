...
<a name="selection_mode_tab_the_description_window_ELTTEXTE000458"></a>
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Android/iOS selection mode** This option hides the selection banner after the selection. The banner appears only when the line is pressed. Then, the row selection code is executed.  
...
<a name="display_mode_details_tab_the_description_window_ELTTEXTE000482"></a>
...
### Standard vertical or column gallery mode: Anchoring columns
<a name="standard_vertical_column_gallery_mode_anchoring_columns_ELTPARAGRAPHE000130"></a>
...
- **Variable number of columns (left)** If the width of the RepeatString area allows an additional column to be displayed, it is added.  Before adding the column, the columns are aligned on the left and an empty area may appear on the right. 
...
- **Fixed width and number of columns (centered)** The number of columns and column widths remain unchanged. The columns are centered.



<a name="NOTE3_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Standard horizontal mode: Line anchoring**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_ZR_NbColWD_H.GIF)
...
- **Height and number of fixed lines (top)** Simply specify the number of lines to be displayed and the line height. 
...
<a name="resizing_the_cells_looper_control_ELTPARAGRAPHE000185"></a>
...
<a name="other_settings_the_details_tab_ELTTEXTE000524"></a>
<a name="NOTE4_1_Saisie"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Input settings
<a name="input_settings_ELTPARAGRAPHE000203"></a>

Input settings define the behavior of Looper controls based on a data file in edit mode. The possible options are as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_ZR_NbColWD%202.gif)


- **Cascading input** Pressing the Enter key in an Edit control automatically enters a new row. 

- **Record at line output** or **Save as column output** The record currently being modified or created will be automatically saved in the corresponding data file as soon as the row is no longer selected. If this option is not selected, the record must be saved programmatically with [LooperSave](../WDLang2/3083028.md). 
...
### Scrollbar
<a name="scrollbar_ELTPARAGRAPHE000220"></a>
...
<a name="movements_and_gestures_ELTPARAGRAPHE000234"></a>
...
### Search control
<a name="search_control_ELTPARAGRAPHE000263"></a>

The Looper control allows searching in the data displayed. The available options are: 

- **Using the FAA menu.** The search will be carried out via the "Search" option in the AAF menu (your application's automation features). 

- **Always visible** A search field will always be displayed above the RepeatString field. 

- **Never**: No search can be performed in the RepeatString field. 
...
<a name="when_looper_control_populated_programmatically_ELTPARAGRAPHE000279"></a>
...
<a name="different_content_each_row_content_tab_ELTTEXTE000572"></a>
The RepeatString Looper control fields let you fully customize the appearance of repeats: layout, content, etc.. This makes it possible to place Looper controls within other Looper controls. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=278-WM-ZR%20Variable.jpg)
...
### Implementation
<a name="implementation_ELTPARAGRAPHE000336"></a>
...
- **When the line is no longer visible** (selected by default): Internal windows are loaded when the associated row is visible in the. The unload is performed when the row is not visible anymore. This mode is recommended for the non-editable Looper controls. Indeed, if an internal window allows the input, the content typed by the user is lost when this internal window is no longer visible. 
						Advantage: Low memory consumption. 
						Disadvantage: Loss of information entered by the user. 

- **Line not visible + IF containing only display fields** Internal windows are loaded when the associated row is visible in the field. The unload is performed according to the type of row: 
...
<a name="characteristics_internal_windows_ELTPARAGRAPHE000372"></a>
