...
- a **Organizer control linked to a data file**: the Organizer control will be linked to a data file or a query. In this case, the data file contains the characteristics of the appointments. 
...
<a name="create_organizer_control_linked_data_file_ELTPARAGRAPHE000034"></a>
...
2. In the "Content" tab, select the "Data File/Query" option and select the data source used. This data source can be: 
...
3. Bind the different items of the data source to the characteristics of the appointment. The elements preceded by a star are mandatory. 
	**Note**: If the associated data file does not directly contain the corresponding item, a multi-file binding can be set up. 
...
<a name="handling_organizer_control_linked_data_file_variable_ELTTEXTE000206"></a>
