...
- In the context menu, the user selects the search icon: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Android_ChampTable_Loupe.gif)


- In the input area that is displayed at the top of the Table control, the user types the sought word. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Android_TableSaisieLoupe.gif)
