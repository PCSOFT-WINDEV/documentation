...
| **2.** | ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png) Running the [Before re-printing](../WDChamp/1011037.md) event of the report (case of direct printing or export from the report viewer). |
