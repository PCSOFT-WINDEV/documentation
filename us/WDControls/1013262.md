...
**Example**: The Day column is of type List of values. This column contains the following values:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ_table_ColContenu.gif)
