...
| /MODE=[HF5 \ EXTERN \ XML \ TEXT] Type of source files | Defines the format of the files to import:<br><br>- HF5: Hyper File 5.5 data files<br><br>- EXTERN: external files/tables (e.g. C/S database)<br><br>- XML: XML files<br><br>- TEXT: text files<br><br><br> |
...
The following command line is used to convert the "DEMO.CUSTOMER" table via the Native Oracle Connector. The logical name of this table is "CUSTOMER" on the "MARS" server. The HFSQL Classic data file will be created in the "c:\\data" directory.
