...
[#Other links: where to put the code that registers the payment?](#other_links_where_put_the_code_that_registers_the_payment_ELTPARAGRAPHE000213)
...
[#After deployment, a message appears: "Order to be put on hold with human intervention required"](#after_deployment_message_appears_order_put_hold_with_human_intervention_required_ELTPARAGRAPHE000302)
...
4. Recompile the project to take these pages into account: under the "Project" pane, in the "Project" group, pull down "Recompile and synchronize" and select "Recompile the project and generate HTML pages". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CLF_Paiement_securise%20-%20HC%20N%B0005.gif&type=thumb)
...
4. In the "General" tab, modify the internal page linked to the field: replace "PI_Payback" with "SecuredPayment.PI_Payback". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CLF_Paiement_securise%20-%20HC%20N%B0006.gif&type=thumb)


5. Save the page (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Enregistrer.gif)). 

6. Save a copy of this page with a custom name: under the "Home" pane, in the "General" group, pull down "Save" and select "Save as". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CLF_Paiement_securise%20-%20HC%20N%B0007.gif)
...
8. Make sure that this page is not referenced: 
	...
	- On the "Details" tab, check "Do not allow SEO". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CLF_Paiement_securise%20-%20HC%20N%B0009.gif&type=thumb)
...
4. Adjust the page type according to the type of page you want in your project: Session, AWP, Zoning mode, Responsive mode, ...<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CLF_Paiement_securise%20-%20HC%20N%B0010.gif&type=thumb)
...
<a name="other_links_where_put_the_code_that_registers_the_payment_ELTPARAGRAPHE000213"></a>
...
- The "Server to Server Return" link (also known as "IPN": Instant Payment Notification)
	...
	**Attention** This code is executed via a direct call to the bank's server, i.e. without any context, cookies, session, etc., on the part of the Internet user.
...
During deployment, you must **exclude** from deployment the HFSQL "Transaction" data files containing test transactions carried out locally: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CLF_Paiement_securise_Ato2.gif)
...
2. **The test of this URL must display OK**
	...
	- **If the test displays another page**you're probably in case 1: you need to check the project code and make sure that no page display is forced (function [PageDisplay](../WDLang2/3058008.md)). And for example, don't perform this action in AWP mode ([InAWPMode](../WDLang1/3014031.md)). 
...
<a name="after_deployment_message_appears_order_put_hold_with_human_intervention_required_ELTPARAGRAPHE000302"></a>
