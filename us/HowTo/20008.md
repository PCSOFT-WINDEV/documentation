...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
Sometimes, it is not easy for users to locate the text cursor ("caret") on screen and determine which control has focus.

**Highlighting the control that has focus**
...
One disadvantage of this operation is that it must be performed "manually" on each control. This method is convenient if a small number of controls must be modified. 
...
[Event (Function)](../CommentLeFaire/3015011.md)

[Color (Property)](../CommentLeFaire/2510071.md)

[BackgroundColor (Property)](../CommentLeFaire/2510022.md)
