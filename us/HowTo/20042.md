...
- [Method 1: a SQL query created using the query editor](#NOTE2_1). 

- [Method 2: a programmed query](#NOTE4_1).
...
<a name="sql_count_query_the_entire_data_file_ELTTEXTE000200"></a>
...
7. In the right section of the editor, click the "Count" button. In the menu that is displayed, select "Count on the selected item": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CLF_Requete_Comptage%20-%20HC%20N%B0004.gif)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CLF_Requete_Comptage%20-%20HC%20N%B0005.gif&type=thumb)
...
<a name="sql_count_query_grouping_programmatically_ELTTEXTE000248"></a>
...
[Environment of the query editor ](../CommentLeFaire/2029003.md)

[HExecuteQuery (Function)](../CommentLeFaire/3044080.md)

[Query editor](../CommentLeFaire/2032063.md)

[Creating a select query ](../CommentLeFaire/2032062.md)

[Operations in a Select query ](../CommentLeFaire/2032020.md)
