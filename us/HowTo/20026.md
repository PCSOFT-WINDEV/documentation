...
- [Method 1](#NOTE2_1): Cloning or duplicating an existing column using the [ControlClone](../WDLang1/3025017.md) function. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) [Method 2](#NOTE3_1): Creating the new column directly using the [ControlCreate](../WDLang1/1000020876.md) function. 
...
[ControlClone](../WDLang1/3025017.md) is used to clone (duplicate) an existing control in order to create a copy. This function can also be used on a column found in a Table control. The new column is automatically added at the end of the existing columns.
...
<a name="method_2_creating_columns_ELTTEXTE000208"></a>
[ControlCreate](../WDLang1/1000020876.md) allows you to create a control without having to use a template. This function can also be used on a column found in a Table control. The new column is automatically added at the end of the existing columns.
...
[ControlClone (Function)](../CommentLeFaire/3025017.md)

[ControlCreate (Function)](../CommentLeFaire/1000020876.md)
