...
- If [ListSelect](../WDLang1/3049011.md) returns -1: there is no element selected.

- If [ListSelect](../WDLang1/3049011.md) returns a value greater than 0: this value represents the position of the item selected in the List Box control.
...
Note: You can find out the number of items selected using the [ListSelectCount](../WDLang1/3049010.md) function. This allows you to perform a loop with a [FOR](../Motscles/1510001.md) statement instead of a [WHILE](../Motscles/1510010.md) statement.
...
[ListSelect (Function)](../CommentLeFaire/3049011.md)

[ListSelectCount (Function)](../CommentLeFaire/3049010.md)

[FOR EACH/FOR ALL statement (loop through controls)](../CommentLeFaire/1510017.md)

[Handling List Box controls programmatically](../CommentLeFaire/1013176.md)
