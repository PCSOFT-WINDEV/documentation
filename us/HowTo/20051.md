...
- [Method 1: Populating the control using the position of the parent row](#NOTE2_1). 

- [Method 2: Populating the control using the path of the parent element](#NOTE3_1). 
...
<a name="method_1_populating_the_control_using_the_position_the_parent_row_ELTTEXTE000123"></a>
...
<a name="method_2_populating_the_control_using_the_path_the_parent_element_ELTTEXTE000147"></a>
...
[The TreeView Table control](../CommentLeFaire/1015001.md)

[TableAddChild (Function)](../CommentLeFaire/1000010004.md)

[TreeView Table control functions](../CommentLeFaire/1000010002.md)

[Manipulating TreeView Table controls programmatically](../CommentLeFaire/1015004.md)
