...
4. Perform a loop to read the emails from the beginning from the end by using [EmailReadFirst](../WDLang3/3032014.md) and [EmailReadNext](../WDLang3/3032004.md). The **Email.Out** variable is set to: 
	...
	- <u><u><u><u>True</u></u></u></u> if there are no more messages to read.
...
[IMAP protocol](../CommentLeFaire/1000019172.md)

[Reading an email](../CommentLeFaire/3032037.md)

[Email functions](../CommentLeFaire/3032034.md)

[Email (Variable type)](../CommentLeFaire/1000018713.md)

[emailIMAPSession (Variable type)](../CommentLeFaire/1000018957.md)

[EmailCloseSession (Function)](../CommentLeFaire/3032006.md)

[EmailStartIMAPSession (Function)](../CommentLeFaire/1000019189.md)
