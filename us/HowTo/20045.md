...
## SQL query with "TOP n" programmatically
<a name="sql_query_with_top_programmatically_ELTTEXTE000194"></a>
...
[Select query: Displaying the first/last n records](../CommentLeFaire/2032022.md)
