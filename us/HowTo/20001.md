...
First syntax (recommended): Use [operators for handling strings](../Motscles/1512001.md). 
...
// sResultString is: "Hello,_this_is_a_test"
```
...
First syntax: if you need to retrieve the substring position, use the [Position](../WDLang1/3024027.md) function.
...
Second syntax: if you just want to know if the substring is present, use the [comparison operator](../Motscles/1512006.md) [=] (recommended) or the [Contains](../WDLang1/1000019893.md) function.
