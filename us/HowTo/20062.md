...
- [Method 2: a query created programmatically](#NOTE3_1). 
...
## SQL query with calculation programmatically
<a name="sql_query_with_calculation_programmatically_ELTTEXTE000182"></a>
...
[Items used in a select query ](../CommentLeFaire/2032004.md)
