...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) [Drop-down menu](#NOTE1_1), [Buttons](#NOTE4_1), [Links](#NOTE5_1)

- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) [Drop-down menu](#NOTE1_1), [Buttons](#NOTE4_1), [Action bar](#NOTE6_1)
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Drop-down menus exist since the early versions of Windows. It's an easy method to implement in an application. This type of menu is almost always present on the first window of the program.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) You have the ability to create menus with simple buttons. 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) The links are kind of restyled buttons. This type of control is mainly used in a Web site but you also have the ability to create links in a WINDEV application. 
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) An Action Bar is actually the result of the transformation of a drop-down menu. When a drop-down menu is created, it is positioned at the bottom of the mobile window. 
...
[Menu functions](../CommentLeFaire/3038016.md)

[Manipulating menu options via the context menu](../CommentLeFaire/1010008.md)

[Manipulating menu options programmatically](../CommentLeFaire/1010007.md)
