...
- [a query created programmatically](#NOTE3_1). 
...
<a name="sql_query_with_external_join_programmatically_ELTTEXTE000187"></a>
...
[Joins between the data files of a select query ](../CommentLeFaire/2032018.md)
