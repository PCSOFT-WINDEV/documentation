...
However, the structure of the Table control (format and order of the columns) must correspond to the format of the file or SQL query. Item 1 in the file or SQL query will be associated with column 1, item 2 will be associated with column 2, etc.
...
[TableAdd (Function)](../CommentLeFaire/3074017.md)

[TableAddLine (Function)](../CommentLeFaire/3074006.md)

[FileToMemoryTable (Function)](../CommentLeFaire/3074005.md)
