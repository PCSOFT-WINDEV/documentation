...
- [Method: Retrieving the list of directories directly](#NOTE2_1).

- [Method 2: Using a procedure to process each directory separately](#NOTE3_1).
...
<a name="method_retrieving_the_list_directories_directly_ELTTEXTE000131"></a>
...
<a name="method_2_using_procedure_process_each_directory_separately_ELTTEXTE000155"></a>
...
[fListDirectory (Function)](../CommentLeFaire/3036062.md)

[fListFile (Function)](../CommentLeFaire/3036058.md)

[How to loop through the files of a directory?](../CommentLeFaire/20057.md)
