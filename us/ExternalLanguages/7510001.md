...
Note: If quotation marks or apostrophes are present in the string, they must be doubled.
<a name="NOTE3"></a>
<a name="NOTE3_1"></a>
...
|   |   |
| --- | --- |
| [Beep](../LangageExt/7513023.md) | Emits a beep sound form the computer speaker. |
| [Close](../LangageExt/75130273.md) | Closes the current window and restores the context that existed before the window was opened. |
...
| [Error](../LangageExt/75130269.md) | Displays a dialog box containing an error logo and the message passed as parameter. |
...
| [HsMenu,Name](../LangageExt/75130278.md) | Adds a menu into the window that opens. The menu is the menu of another window. |
...
| [LCommand](../LangageExt/75130282.md) | Returns the command line passed as parameter to the executable program. WdString contains the command line passed as parameter to the executable program (without the name of the executable itself). |
...
| [List,Delete](../LangageExt/75130293.md) | Deletes an element from a drop-down list or from an expanded list. The elements below move up one row. |
...
| [Screen,ScreenToFile](../LangageExt/75130260.md) | Initializes file fields with the value of the window fields linked to these fields. |
...
| [WDEnd](../LangageExt/75130323.md) | Ends a program that uses WINDEV. |
