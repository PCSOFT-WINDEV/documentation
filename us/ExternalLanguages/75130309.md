...
**Note**: To add an element at a specific position, use the [Table,Insert](../LangageExt/75130313.md) function.
<a name="Exemple1"></a>
...
After function **Table,Add**, the Table field is not in edit: to enter in the Table field, call function [Screen,Input](../LangageExt/75130265.md).
<a name="NOTE0_2"></a>
...
The file is not modified: you need to execute function [Table,Save](../LangageExt/75130312.md) to modify the file.

After function **Table,Add**, the Table field is not in input mode: to enter in the Table field, call [Screen,Input](../LangageExt/75130265.md).
