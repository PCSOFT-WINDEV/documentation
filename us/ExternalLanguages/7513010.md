...
The functions for accessing data files can be used by calling nWDExecute (see the definition of this function). However, the C++ language interface provides an HFSQL data file management class named CVHFContext.
