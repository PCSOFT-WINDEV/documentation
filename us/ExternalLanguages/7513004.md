...
| WDERROR_INITPROJECT | 13 | The project initialization code was already run |
...
| [nWDGetHFContext](../LangageExt/7513019.md) | Gets the HFSQL context (applies to C, Pascal and Visual Basic only) |
| [nWDGetLastError](../LangageExt/7513018.md) | Error code of the last error |
| [nWDInit](../LangageExt/7513016.md) | Initialize the external language |
| [nWDInitProject](../LangageExt/7513014.md) | Run the project initialization code |
| [nWDOpenWDL](../LangageExt/7513013.md) | Opens a WINDEV library (containing windows, reports, etc.) |
...
[External language: Programming in C](../LangageExt/7513001.md)
