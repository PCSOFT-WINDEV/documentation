...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche_Fin%20-%20HC%20N%B0002.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0003%201.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0002%201.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0004.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0005.jpg)


	3. In the window that appears, we will specify that the selection condition corresponds to a parameter:  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0006.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0009.jpg)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | The window creation wizard includes different preset windows. These windows have modern UIs for your applications.<br><br>Most of these windows can be generated from your data. |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche%20-%20HC%20N%B0014.jpg&type=thumb)
...
7. Test the window you have just created in the simulator (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fen_WM_GAF.jpg)
 in the quick access buttons).
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fen_RAD_Recherche_Go%20-%20HC%20N%B0001.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20FEn_RAD_Recherche_Fin%20-%20HC%20N%B0001.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Pull%20to%20Refresh%20-%20HC%20N%B0001.jpg)

			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | A specific internal window can be used to manage the "Pull-to-refresh" gesture. We will use the default window in this example. <br> |
...
- Test the window in the simulator (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fen_WM_GAF.jpg)
 in the quick access buttons).

	1. Click and drag the top of the looper down.

	2. Release the mouse. The looper is refreshed.  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Pull%20to%20refresh%20Go%20-%20HC%20N%B0001.jpg&type=thumb)
...
- To create a sliding menu, we will:
	...
	- Modify the "WIN_Advanced_LIST_Products" window to display the menu.
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | An internal window is a simple window with no Action Bar and no toolbar. An internal window is used to easily include a set of controls in another window. |
...
- To create the internal window containing the menu:
	...
	1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Nv_WM_GAF.jpg)
 in the quick access buttons. The new element window appears: click "Window" then "Internal window".

	2. The internal window is automatically opened in the editor. 

	3. The save window appears. Name the internal window: "IW_MLZ_Options".  ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fen%EAtre%20coulissante%201%20-%20HC%20N%B0003.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fen%EAtre%20coulissante%201%20-%20HC%20N%B0002.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fen%EAtre%20coulissante%201%20-%20HC%20N%B0001.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fen%EAtre%20coulissante%201%20-%20HC%20N%B0004.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fen%EAtre%20coulissante%202%20-%20HC%20N%B0001.jpg&type=thumb)
...
2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_simu_PRJ_WM_GAF.jpg)
 in the quick access buttons.
