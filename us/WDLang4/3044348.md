...
- [when the automatic data file modification is performed](../WDLang4/3044195.md).
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) The thumbnails are available in HFSQL Client/Server on the data file items.
<a name="NOTE4_2"></a>
