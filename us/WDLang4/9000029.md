...
<a name="generate_the_analysis_ELTPARAGRAPHE000057"></a>

To create windows or pages manipulating the XML document described in the analysis, the analysis must be generated: under the "Analysis" pane, in the "Analysis" group, click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_Generation_analyse.gif).
