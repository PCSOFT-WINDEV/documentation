...
This path is used during the automatic data file modification to archive the logs. [HHistoryModification](../WDLang4/3044344.md) will also search for change history in these files.
...
1. Location specified when creating the log data file (function [HCreation](../WDLang4/3044255.md)).
...
If the log file already exists when the function is called **HChangeLogDir**function, this log file is no longer used: a log file is created at the specified location and associated with the logged HFSQL data file.

**Using the [HDeclareExternal](../WDLang4/3044204.md) function with a journaled data file** If an application uses the [HDeclareExternal](../WDLang4/3044204.md) function on a logged data file, changes made by this application are recorded in the log files specified in the header of the logged HFSQL data file.
<a name="NOTE0_3"></a>
