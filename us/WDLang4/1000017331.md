...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This function is available for the data files or queries linked to an HFSQL connection (Classic or Client/Server). 
<a name="Exemple1"></a>
...
```wl
// Clear data file without recreating it
HDeleteAll(Customer)
```
