...
**Tip** To find out whether REPEATABLE READ mode is activated on a data file, use the [RepeatableReadSupported](../Proprietes/1000020959.md) property. 
