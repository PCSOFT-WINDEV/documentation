...
| *hTempDirectory* | &lt;TmpPath&gt; parameter of HFConf.Ini file.<br>Path of temporary directory. This directory is used to create the temporary files if necessary (temporary files created when reindexing large data files for example). |
...
- either to the connection name defined in the data model editor, or using [HDescribeConnection](../WDLang4/3044205.md) or [HOpenConnection](../WDLang4/3044107.md).
...
| *hTempDirectory* | &lt;TmpPath&gt; parameter of HFConf.Ini file.<br>Path of temporary directory. This directory is used to create the temporary files if necessary (temporary files created when reindexing large data files for example).<br>The path is created on the server if it does not exist. |
...
|   |   |
| --- | --- |
| *hlbActive* | &lt;LoadEnable&gt; parameter of HFConf.Ini file.<br>Indicates whether load balancing is enabled or not.<br><br>	- <u><u><u><u>True</u></u></u></u> if load balancing is to be enabled,<br><br>	- <u><u><u><u>False</u></u></u></u> otherwise.<br><br><br> |
