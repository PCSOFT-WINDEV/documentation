...
<a name="binding_between_control_and_wlanguage_variable_between_control_and_item_data_file_ELTPARAGRAPHE000285"></a>
...
<a name="binding_item_types_bindings_ELTPARAGRAPHE000301"></a>
...
- **Auto-filled Combo Box control bound to an HFSQL data file**: **&lt;Window&gt;.FromFile** must not be in the window "Global declarations" event. The function must be in the "Initialization" event of the window.
