...
<a name="binding_between_control_and_wlanguage_variable_between_control_and_data_file_item_ELTPARAGRAPHE000131"></a>
...
- **Auto-filled Combo Box control bound to an HFSQL data file**: **FileToScreen** must not be in the "Global declarations" event of the window. The function must be in the "Initialization" event of the window.
