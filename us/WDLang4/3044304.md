...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ClientServeur_XManta03.gif)


In WEBDEV:

![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WB_ClientServeur_XManta03.gif)
...
- on the development computer:![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ClientServeur_XManta02.gif)


- on the server: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ClientServeur_XManta.gif)
