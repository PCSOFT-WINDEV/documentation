...
In WEBDEV:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WB_ClientServeur_XManta03.gif)
...
| **6** | **Data files of DataApplicationA**<br>All the data files used by "ApplicationA".<br>As explained in #7, these files can also be present in several subdirectories.<br>**Note**: The same application can use data files from several databases. |
| **7** | **Data files of DataApplicationB**<br>All the data files used by "ApplicationB", present in several subdirectories.<br>**Note**: The same application can use data files from several databases. |
