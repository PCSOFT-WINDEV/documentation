...
Depending on the selected mode, a WLanguage error may occur if incompatible structures are found. In this case, you need to run an automatic data file modification ([HModifyStructure](../WDLang4/1000019439.md)).
...
If this parameter is not specified or corresponds to "\*", descriptions are taken into account for all the data files in the analysis.
