...
**Attention** The function **SQLExecWDR** function does not start the memory result retrieval process. The result is retrieved on the first call to one of the following functions: [SQLFirst](../WDLang4/3072017.md), [SQLTable](../WDLang4/3072031.md) or [SQLFetch](../WDLang4/3072011.md).

![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) The query is run on a MySQL database.
<a name="Exemple1"></a>
...
### Running the query
<a name="running_the_query_ELTPARAGRAPHE000090"></a>
...
<a name="retrieving_the_query_result_ELTPARAGRAPHE000105"></a>
