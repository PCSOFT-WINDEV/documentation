...
**Remark**: You can find out the properties of a database using the [&lt;Connection variable&gt;.InfoDatabaseProperty](../WDLang4/1000022673.md) function.
...
ModificationResult = MyConnection.ModifyDatabaseProperty(hOwner, "Flora", "MyDatabase")
...
<a name="changing_the_owner_database_ELTPARAGRAPHE000249"></a>
...
To determine if the user has the appropriate rights, use [&lt;Connection variable&gt;.InfoDatabaseProperty](../WDLang4/1000022673.md).
