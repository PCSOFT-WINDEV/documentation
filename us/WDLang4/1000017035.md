...
### Disable a server trigger on logical HFSQL data files
...
**`<HFSQL Client/Server logical data files>: (Character string)`**
...
### Disable a server trigger on physical HFSQL data files on a server
