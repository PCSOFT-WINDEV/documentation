...
- the data file is empty or no record matches the condition. The read operation cannot continue and [&lt;Source&gt;.Out](../WDLang4/1000024605.md) returns <u><u><u>True</u></u></u>.
...
- <u><u><u><u>False</u></u></u></u> if a problem occurs. This problem can be caused by:
	...
	- a positioning problem (empty data file, etc.). In this case, [&lt;Source&gt;.Found](../WDLang4/1000025076.md) returns <u><u><u><u>False</u></u></u></u> and [HError](../WDLang4/3044088.md) returns 0.
...
| *hKeepFilter* | The filter set by [&lt;Source&gt;.Filter](../WDLang4/1000024960.md) will be taken into account, even if the search key is not optimized for the filter. Reminder: [&lt;Source&gt;.Filter](../WDLang4/1000024960.md) returns the optimized search key for the filter.<br>**Caution**: In this case, performance issues may occur on large data files.<br>![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/us/HF55.png) This variable cannot be used.By default, the iteration performed after **&lt;Source&gt;.ReadSeekLast** ignores the filter. |
...
| Bernard |   | The record was not found (no move). | False | True | Bernard does not exist.<br>Sets the position to the first lower value (this value does not exist). The beginning of the data file is reached. |
