...
**Remark**: It is possible to find out the rights of a group or user on a Client/Server HFSQL data file using the [HInfoFileRights](../WDLang4/3044321.md) function.. 
