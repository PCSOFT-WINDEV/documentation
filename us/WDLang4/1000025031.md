...
| [&lt;Connection variable&gt;.Backup](../WDLang4/1000022752.md) | Backs up the contents of an HFSQL server: all server databases, one or more databases, one or more data files. |
...
| [&lt;Connection variable&gt;.ConnectionQuality](../WDLang4/1000022748.md) | Returns the connection quality index. The higher the index, the faster the connection. |
| [&lt;Connection variable&gt;.CopyFile](../WDLang4/1000022650.md) | Copies an HFSQL data file (.fic, .ndx, .ftx, .sdx and .mmo files, if any):<br><br>- from the HFSQL server to the server (to perform a backup for example). <br><br>- from the HFSQL server to the client (to perform a local backup for example). <br><br>- from the client to the HFSQL server (to update the data files for example). <br><br>- from an HFSQL server to antoher HFSQL server.<br><br><br> |
...
| [&lt;Connection variable&gt;.DeleteFile](../WDLang4/1000022757.md) | Deletes HFSQL data files (.fic, .ndx, .ftx, .sdx and .mmo files, if any) from the server. |
...
| [&lt;Connection variable&gt;.InfoFileProperty](../WDLang4/1000022674.md) | Gets the properties of a data file located in an HFSQL server. |
| [&lt;Connection variable&gt;.InfoFileRights](../WDLang4/1000022667.md) | Gets the rights granted to a user or group on an HFSQL Client/Server data file. |
...
| [&lt;Connection variable&gt;.InfoLock](../WDLang4/1000022774.md) | Returns information about the lock set on a data file, on one or all the records in a data file. |
...
| [&lt;Connection variable&gt;.ListWatchedFiles](../WDLang4/1410090429.md) | Returns the list of data files watched by [&lt;Source&gt;.Watch](../WDLang4/1000025029.md). |
...
| [&lt;Connection variable&gt;.ModifyFileRights](../WDLang4/1000022709.md) | Sets the rights granted to a user or group on an HFSQL Client/Server data file. |
...
| [&lt;Connection variable&gt;.ModifyItemRights](../WDLang4/1410090544.md) | Modifies the rights granted to a user or group on an item of an HFSQL Client/Server data file. |
...
| [&lt;Source&gt;.Watch](../WDLang4/1000025029.md) | Trigger monitoring of write actions (add, modify or delete) performed on a data file present on an HFSQL server. In case of modification, a specific procedure can be triggered. |
| [&lt;Source&gt;.WatchStop](../WDLang4/1000025030.md) | Stops watching a data file on an HFSQL server. |
