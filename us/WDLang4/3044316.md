...
| [HCopyFile](../WDLang4/3044282.md) | Copies an HFSQL data file (.fic, .ndx, .ftx, .sdx and .mmo files, if any):<br><br>- from the HFSQL server to the server (to perform a backup for example). <br><br>- from the HFSQL server to the client (to perform a local backup for example). <br><br>- from the client to the HFSQL server (to update the data files for example). <br><br>- from an HFSQL server to antoher HFSQL server.<br><br><br> |
...
| [HDeleteFile](../WDLang4/3044294.md) | Deletes HFSQL data files (.fic, .ndx, .ftx, .sdx and .mmo files, if any) from the server. |
...
| [HInfoFileRights](../WDLang4/3044321.md) | Gets the rights granted to a user or group on an HFSQL Client/Server data file. |
...
| [HListConnectedUser](../WDLang4/3044291.md) | Lists the users currently connected to one or more data files handled by a Client/Server connection. |
...
| [HListWatchedFiles](../WDLang4/1410089900.md) | Returns the list of data files watched by [HWatch](../WDLang4/1000022407.md). |
...
| [HModifyFileProperty](../WDLang4/3044330.md) | Modifies the properties of an HFSQL data file located on a server. |
| [HModifyFileRights](../WDLang4/3044327.md) | Sets the rights granted to a user or group on an HFSQL Client/Server data file. |
...
| [HWatch](../WDLang4/1000022407.md) | Trigger monitoring of write actions (add, modify or delete) performed on a data file present on an HFSQL server. In case of modification, a specific procedure can be triggered. |
| [HWatchStop](../WDLang4/1000022430.md) | Stops watching a data file on an HFSQL server. |
