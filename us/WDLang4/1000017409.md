...
- To check the existence of a task, use the [HListTask](../WDLang4/1000017092.md) function: simply check whether the task identifier is present among the tasks returned by the [HListTask](../WDLang4/1000017092.md) function. 
...
[&lt;Connection variable&gt;.InfoTask (Function)](../WDLang4/1000022686.md)
