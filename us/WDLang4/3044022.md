...
- **PageToFile** cannot be used to write to the data file. Only the variables of the data file items can be updated (i.e variables of the record loaded in memory). To modify the records, use [HAdd](../WDLang4/3044147.md), [HModify](../WDLang4/3044042.md), [HWrite](../WDLang4/3044092.md), etc.
...
<a name="binding_between_control_and_wlanguage_variable_between_control_and_data_file_item_ELTPARAGRAPHE000090"></a>
...
- The items of the data file that are not bound to a control are not updated by **PageToFile**.

- If multiple controls in the window or page are bound to the same data file item, **PageToFile** may not update the bound item properly. ***It is not recommended to bind multiple controls of a window or page to the same item***.
