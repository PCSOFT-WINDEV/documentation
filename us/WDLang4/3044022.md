...
- **PageToFile** cannot be used to write to the data file: the variables of the data file items can only be updated (i.e variables of the record loaded in memory). To modify the records, use [HAdd](../WDLang4/3044147.md), [HModify](../WDLang4/3044042.md), [HWrite](../WDLang4/3044092.md), etc.
...
<a name="updating_the_items_special_cases_ELTPARAGRAPHE000108"></a>
...
- If multiple controls in the page are bound to the same data file item, **PageToFile** may not update the bound item properly. ***It is not recommended to bind multiple page controls to the same item.***
