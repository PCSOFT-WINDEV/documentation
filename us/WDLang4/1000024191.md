...
**Reminder** An alias allows you to work on different physical data files with the same logical description. For a data file for example, the file description is performed in the analysis and **&lt;Source&gt;.Alias** is used to create the file alias.**Note** This help page describes how to create an alias using the function **&lt;Source&gt;.Alias**. From version 27 onwards, we recommend using a [Alias](../WDLang4/1000021446.md) variable. This type of variable makes it easier to create and handle aliases. 
...
<a name="physical_data_file_associated_with_alias_ELTPARAGRAPHE000292"></a>
...
<a name="canceling_the_aliases_one_more_data_files_ELTPARAGRAPHE000319"></a>
...
- By default, the **password of an alias file** is identical to the password of the initial data file. This password can be changed using [&lt;Source&gt;.Password](../WDLang4/1000025044.md). The name of the data file used in this function corresponds to the name of the alias.
