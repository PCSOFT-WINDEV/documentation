...
- Enter the keys manually: 
	...
	- For an ISAM connection: 
		...
		- Analysis: WDD path. This parameter is optional
...
- For a Client/Server connection: 
	...
	- Analysis: WDD path. This parameter is optional. <br>![Example for an ISAM connection](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=iodbc3.gif)
