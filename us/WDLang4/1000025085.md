...
| [&lt;Connection variable&gt;.TransactionCancel](../WDLang4/1000023966.md) | If a transaction is in progress, rolls back all operations performed on data files in transactions since the start of the transaction. |
...
| [&lt;Source&gt;.Add](../WDLang4/1000024187.md) | Adds: <br><br>- the record found in memory into the data file (query or view). <br><br>- the record found in a [Record](../WDLang4/1000020962.md) variable into the data file (query or view).<br><br><br> |
...
| [&lt;Source&gt;.CheckUnaltered](../WDLang4/1000025077.md) | Checks that one or all records in an unalterable data file have not been modified (e.g. with a hexadecimal editor). |
| [&lt;Source&gt;.Close](../WDLang4/1000024958.md) | Closes either a data file or all data files opened by the current user: all corresponding physical data files are closed for the current user. |
...
| [&lt;Source&gt;.CreateIfNotFound](../WDLang4/1000024208.md) | Performs the following operations: <br><br>- If the data file doesn't exist, create an empty data file (file with ".FIC" extension) with the index file, the full-text index file and the memo file if necessary. The function is equivalent to [&lt;Source&gt;.Creation](../WDLang4/1000024207.md).<br><br>- If the data file exists, opens the data file.<br><br><br> |
| [&lt;Source&gt;.CreateView](../WDLang4/1000024209.md) | Creates an HFSQL view. <br>This function uses the former view mechanism. |
| [&lt;Source&gt;.Creation](../WDLang4/1000024207.md) | Creates an empty data file (extension ".FIC") with index file, full-text index file, spatial index file and memo file if required. |
...
| [&lt;Source&gt;.Declare](../WDLang4/1000024213.md) | Declares a data file description (found in an analysis) in the current project. |
...
| [&lt;Source&gt;.DescribeFile](../WDLang4/1000024215.md) | Describes a data file programmatically. |
| [&lt;Source&gt;.DescribeTrigger](../WDLang4/1000024216.md) | Adds or modifies a trigger on an HFSQL data file. |
| [&lt;Source&gt;.DuplicateRecord](../WDLang4/1000024222.md) | Duplicates the record read in a data file. The record in memory is added to the data file (query or view). |
...
| [&lt;Source&gt;.ExtractMemo](../WDLang4/1000024957.md) | Extracts the contents of a binary memo item from an HFSQL data file, query or view into a physical file (on disk). |
...
| [&lt;Source&gt;.ImportCSV](../WDLang4/1410090623.md) | Imports a CSV file into an HFSQL Classic or Client/Server data file. This data file must have been defined in the data model editor, or declared with [&lt;Source&gt;.Declare](../WDLang4/1000024213.md), [&lt;Source&gt;.DeclareExternal](../WDLang4/1000024214.md) or [&lt;Source&gt;.DescribeFile](../WDLang4/1000024215.md)). |
| [&lt;Source&gt;.ImportHF55](../WDLang4/1000024990.md) | Imports a Hyper File 5.5 file into an HFSQL Classic file. |
| [&lt;Source&gt;.ImportJSON](../WDLang4/1000024991.md) | Imports a JSON file into an HFSQL Classic data file. This data file must have been defined in the data model editor, or declared with [&lt;Source&gt;.Declare](../WDLang4/1000024213.md), [&lt;Source&gt;.DeclareExternal](../WDLang4/1000024214.md) or [&lt;Source&gt;.DescribeFile](../WDLang4/1000024215.md)). |
| [&lt;Source&gt;.ImportText](../WDLang4/1000024992.md) | Imports a Text file into an HFSQL Classic or Client/Server data file. This data file must have been defined in the data model editor, or declared with [&lt;Source&gt;.Declare](../WDLang4/1000024213.md), [&lt;Source&gt;.DeclareExternal](../WDLang4/1000024214.md) or [&lt;Source&gt;.DescribeFile](../WDLang4/1000024215.md)). |
| [&lt;Source&gt;.ImportXLS](../WDLang4/1000024993.md) | Imports an XLS file into an HFSQL Classic or Client/Server data file. This data file must have been defined in the data model editor, or declared with [&lt;Source&gt;.Declare](../WDLang4/1000024213.md), [&lt;Source&gt;.DeclareExternal](../WDLang4/1000024214.md) or [HDescribeFile](../ErrCompil/1000001036.md)). |
| [&lt;Source&gt;.ImportXML](../WDLang4/1000024994.md) | Imports an XML file into an HFSQL Classic or Client/Server data file. This data file must have been defined in the data model editor, or declared with [&lt;Source&gt;.Declare](../WDLang4/1000024213.md), [&lt;Source&gt;.DeclareExternal](../WDLang4/1000024214.md) or [&lt;Source&gt;.DescribeFile](../WDLang4/1000024215.md)). |
...
| [&lt;Source&gt;.ListKey](../WDLang4/1000025012.md) | Returns the list of keys in a data file (query or view) recognized by the HFSQL engine. |
| [&lt;Source&gt;.ListLink](../WDLang4/1000025014.md) | Returns the list of links (Merise) in the current analysis or in a specific analysis. |
| [&lt;Source&gt;.ListQueryParameter](../WDLang4/1000025016.md) | Returns the list of parameters for a query created in the query editor. |
| [&lt;Source&gt;.ListSpatialKeys](../WDLang4/1410090489.md) | Returns the spatial keys of a data file (used in a query or view) recognized by the HFSQL engine. |
...
| [&lt;Source&gt;.Previous](../WDLang4/1000025047.md) | Sets the position on the previous record of the data file according to a browse item. |
...
| [&lt;Source&gt;.RecordDate](../WDLang4/1000024210.md) | Returns the date and time of last write operation performed on a record in an HFSQL data file (Classic or Client/Server). |
...
| [&lt;Source&gt;.SavePosition](../WDLang4/1000025062.md) | Stores the current context of a data file: current record, filter, read pointers. |
| [&lt;Source&gt;.Security](../WDLang4/1000025063.md) | Enables or disables the automatic security mechanism on one or more data files. |
| [&lt;Source&gt;.Seek](../WDLang4/1000025053.md) | Positions on the first record of the data file whose value for a specific item is greater than or equal to a search value (generic search by default). |
...
| [&lt;Source&gt;.StatCalculate](../WDLang4/1000025064.md) | Collects statistics on data file keys. |
...
| [&lt;Source&gt;.ToFile](../WDLang4/1000025081.md) | Copies a data source (file, query, view, ...) to a physical HFSQL data file with the same description. This file is neither encrypted nor password protected. |
