...
**Remark**: To find out the rights granted to a group or to a user on an SQL view or on a materialized view, use [HInfoViewRights](../WDLang4/1000021475.md).
...
<a name="when_are_rights_changed_ELTPARAGRAPHE000181"></a>

The change is effective as soon as **HModifyViewRights** is run. There is no need to restart the server to take the new rights into account.
