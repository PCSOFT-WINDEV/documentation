...
Note: The **FileToPage** function does not read the data file. The value of the record loaded in memory is used to update the controls. Therefore, a record must be loaded in memory previously (with [HRead](../WDLang4/3044047.md), [HReadSeek](../WDLang4/3044050.md), [HReadFirst](../WDLang4/3044051.md), etc.).
<a name="Exemple1"></a>
...
<a name="binding_between_control_and_wlanguage_variable_between_control_and_data_file_item_ELTPARAGRAPHE000085"></a>
