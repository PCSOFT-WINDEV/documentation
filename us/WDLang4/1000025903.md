...
|   |   |
| --- | --- |
| *hSKSimplified* not specified<br>(Default value) | &lt;Result&gt; is a readable message for the developer, containing the list of keys to be added to the data files in order to optimize the queries. This text uses RTF. |
