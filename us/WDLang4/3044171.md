...
Ends the description of the structure of an xBase data file programmatically. The data file that was just described is created on disk in the path specified in [HDBDescribeFile](../WDLang4/3044172.md). The data, memo and index files are created on disk.
<a name="Exemple1"></a>
