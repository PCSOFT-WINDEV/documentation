...
**Warning** For programming errors (called "Serious Errors"), the H.ErrIgnore variable has no effect. These errors must not be ignored because the execution of the program would come to nothing. These errors are presented in [HFSQL errors](../WDLang4/3044177.md).
<a name="NOTE0"></a>
<a name="NOTE0_1"></a>
...
<a name="value_herrignore_ELTPARAGRAPHE000025"></a>
...
### Example 
<a name="example_ELTPARAGRAPHE000048"></a>The following example is used to check the existence of a data file. If the data file does not exist, it is created ; if it exists, the program continues to run.
