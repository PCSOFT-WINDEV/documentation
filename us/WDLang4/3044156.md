...
| [HBuildKeyValueANSI](../WDLang4/3044259.md) | Whatever the platform used, the data stored in HFSQL data files is in ANSI format. |
...
| [HCheckUnaltered](../WDLang4/1000023377.md) | Checks that one or all records in an unalterable data file have not been modified (e.g. with a hexadecimal editor). |
| [HClose](../WDLang4/3044073.md) | Closes either a data file or all data files opened by the current user: all corresponding physical data files are closed for the current user. |
| [HCloseAnalysis](../WDLang4/3044054.md) | Closes the current analysis (or all current analyses in the case of a project with multiple analyses). |
...
| [HCreation](../WDLang4/3044255.md) | Creates an empty data file (file extension ".FIC") with index file, full-text index file and memo file if required. |
| [HCreationIfNotFound](../WDLang4/3044254.md) | Performs the following operations: <br><br>- If the data file doesn't exist, create an empty data file (file with ".FIC" extension) with the index file, the full-text index file and the memo file if necessary. The function is equivalent to [HCreation](../WDLang4/3044255.md).<br><br>- If the data file exists, opens the data file.<br><br><br> |
...
| [HDBCreation](../WDLang4/3044171.md) | Ends the description of the structure of an xBase data file programmatically. |
...
| [HDescribeFile](../WDLang4/3044206.md) | Describes a data file programmatically. |
| [HDescribeFullTextIndex](../WDLang4/1000017407.md) | Describes a full-text index of data file created programmatically. |
| [HDescribeItem](../WDLang4/3044233.md) | Describes a file item programmatically. |
| [HDescribeLink](../WDLang4/3044191.md) | Describes a link between two data files programmatically. |
...
| [HImportJSON](../WDLang4/1000021965.md) | Imports a JSON file into an HFSQL Classic data file. This data file must have been defined in the data model editor, or declared with [HDeclare](../WDLang4/3044203.md), [HDeclareExternal](../WDLang4/3044204.md) or [HDescribeFile](../WDLang4/3044206.md)). |
| [HImportText](../WDLang4/3044011.md) | Imports a Text file into an HFSQL Classic or Client/Server data file. This data file must have been defined in the data model editor, or declared with [HDeclare](../WDLang4/3044203.md), [HDeclareExternal](../WDLang4/3044204.md) or [HDescribeFile](../WDLang4/3044206.md)). |
...
| [HImportXML](../WDLang4/3044007.md) | Imports an XML file into an HFSQL Classic or Client/Server data file. This data file must have been defined in the data model editor, or declared with [HDeclare](../WDLang4/3044203.md), [HDeclareExternal](../WDLang4/3044204.md) or [HDescribeFile](../WDLang4/3044206.md)). |
...
| [HListConnection](../WDLang4/3044046.md) | Returns the list of connections currently described in the application: <br><br>- connections described in the data model editor (for the main analysis and, if necessary, additional analyses).<br><br>- connections described by programming (with functions [HDescribeConnection](../WDLang4/3044205.md) or [HOpenConnection](../WDLang4/3044107.md)).<br><br><br> |
| [HListCustomFolder](../WDLang4/1000019775.md) | Returns a list of defined Custom-Folders (also called groups): <br><br>- in the current analysis, <br><br>- in ongoing analyses (projects with multiple analyses).<br><br>- in the specified analysis.<br><br><br> |
...
| [HListKey](../WDLang4/3044060.md) | Returns the list of keys in a data file (query or view) recognized by the HFSQL engine. |
| [HListLink](../WDLang4/3044138.md) | Returns the list of data file bindings (Merise type) present:<br><br>- in the current analysis, <br><br>- in ongoing analyses (projects with multiple analyses).<br><br>- in a specific analysis.<br><br><br> |
...
| [HListSpatialKeys](../WDLang4/1410090426.md) | Returns the spatial keys of a data file (used in a query or view) recognized by the HFSQL engine. |
...
| [HPrevious](../WDLang4/3044112.md) | Sets the position on the previous record of the data file according to a browse item. |
...
| [HRecordDate](../WDLang4/3044338.md) | Returns the date and time of last write operation performed on a record in an HFSQL data file (Classic or Client/Server). |
...
| [HReindexingInProgress](../WDLang4/3044131.md) | Indicates that a reindex operation is currently performed on an HFSQL data file and returns the percentage of reindexing already performed. |
...
| [HSeek](../WDLang4/3044130.md) | Positions on the first record of the data file whose value for a specific item is greater than or equal to a search value (generic search by default). |
...
| [HStatCalculate](../WDLang4/3044134.md) | Collects statistics on data file keys. |
...
| [HToFile](../WDLang4/3044347.md) | Copies a data source (file, query, view, ...) to a physical HFSQL data file with the same description. This file is neither encrypted nor password protected. |
...
| [HTransactionCancel](../WDLang4/3044001.md) | If a transaction is in progress, rolls back all operations performed on data files in transactions since the start of the transaction. |
