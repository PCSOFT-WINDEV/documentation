...
If this parameter corresponds to the constant *hAccessHF7*the transaction is rolled back on HFSQL Classic (ISAM) data files.
...
<a name="location_and_access_data_files_ELTPARAGRAPHE000356"></a>
