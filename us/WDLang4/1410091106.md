...
WLanguage procedure ("callback") called by [HCheckMemoAsynchronous](../WDLang4/1410091107.md) for each HFSQL Client/Server data file checked.
...
`HCheckMemoAsynchronous_Callback(<Data file> , <Result>)`
---
