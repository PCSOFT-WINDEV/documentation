...
- the data file is empty or no record matches the condition. The read operation cannot continue and [HOut](../WDLang4/3044094.md) returns <u><u><u>True</u></u></u>.
...
- <u><u><u><u>False</u></u></u></u> if a problem occurs. This problem can be caused by:
	...
	- a positioning problem (empty data file, etc.). In this case, [HFound](../WDLang4/3044104.md) returns <u><u><u><u>False</u></u></u></u> and [HError](../WDLang4/3044088.md) returns 0.
...
| *hKeepFilter* | The filter set by [HFilter](../WDLang4/3044100.md) will be taken into account, even if the search key is not optimized for the filter. Reminder: [HFilter](../WDLang4/3044100.md) returns the optimized search key for the filter.<br>**Caution**: In this case, performance issues may occur on large data files.<br>![Hyper File 5.5](https://doc.pcsoft.fr/ext/images/us/HF55.png) This variable cannot be used.By default, the iteration performed after **HReadSeekLast** ignores the filter. |
