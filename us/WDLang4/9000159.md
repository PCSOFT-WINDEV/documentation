...
5. Generate the analysis to use the view materialized in the application code: under the "Analysis" pane, in the "Analysis" group, pull down "Generation" and select "Generation". 
...
**Warning** The SQL code used to create the materialized view must refer only to the fields and data files defined in the analysis. For example, references to stored queries cannot be used in this code.  
