...
Converts a numeric value into a binary string in order to perform a search on a numeric key. It builds a composite key from one or more numeric items.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=HConvertX%20-%20HC%20N%B0001.gif)
