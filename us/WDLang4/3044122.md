...
|   |
| --- |
| **Attention** The function **HRegenerateFile** function is used to recreate a data file from the log file description. <br><br>**This function is an advanced function.** Used wrongly, this function can destroy or corrupt the data. |
...
- <u><u><u><u>True</u></u></u></u> if the data file has been regenerated,
...
| *hStructure* | A new empty data file is created from the description of the data file in the log file. If the data file already exists, it is deleted then recreated. |
...
| --- | --- |
| *hData* | All the operations stored in the log file are applied to the existing data file. The file data is updated from the data found in the log. |
| *hStructure* | A new empty data file is created from the file description found in the log file. If the data file already exists, it is deleted then recreated. |
