...
- **Auto-filled Combo Box control bound to an HFSQL data file**: **SourceToScreen** must not be in the "Global declarations" event of the window. The function must be in the "Initialization" event of the window.
