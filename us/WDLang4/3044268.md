...
- By default, the setup of WINDEV and WEBDEV proposes to install MDAC 2.7.
	It can also be downloaded from the following download site: [http://www.microsoft.com/downloads](http://www.microsoft.com/downloads).




**Remark**: At the time of writing, this module was freely available.. The module to download and install is called MDAC_TYP.EXE.
<a name="NOTE2_3"></a>
