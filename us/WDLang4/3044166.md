...
**Note** The data file and index files described will be created using the [HDBCreation](../WDLang4/3044171.md) function (dBase 3 format only). Therefore, the indexes with a format other than NDX cannot be created by **HDBDescribeIndex**.
<a name="Exemple1"></a>
