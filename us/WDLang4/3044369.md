...
<a name="creating_server_triggers_the_analysis_ELTTEXTE000302"></a>
...
- directly in the analysis graph: if a server trigger is associated with a data file, a specific icon appears: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Triggers_Serveur%20-%20HC%20N%B0001.gif).
...
In fact, when a stored procedure is launched from the HFSQL Control Center, for example, there is no analysis in progress: HFSQL Client/Server data is not immediately accessible. 
