...
For each user and for each group, the HFSQL Control Center is used to grant read rights, write rights, creation rights, deletion rights, ... ("Managing rights" option found in the "Rights" group of tabs corresponding to the server, to the database and to the database files). 
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0002.gif&type=thumb)
...
3. Click "System": 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CC_HF_Gestion_Serveur%20-%20HC%20N%B0011%201.gif&type=thumb)
...
2. In the "Logging" tab, choose the type of log you want to use: 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0003.gif)
...
To enable this option in the HFSQL Control Center, select the "Configuration" tab of the server description: 
