...
A data file can be reindexed even when it is accessed by one or more applications. For more details, see [remarks](#NOTE0_1).

![HFSQL Client/Server](https://doc.pcsoft.fr/ext/images/us/HFCS.png) Client/Server HFSQL data files can be reindexed asynchronously using [HReindexAsynchronous](../WDLang4/1410091053.md). 
...
Statistics help optimize queries and filters in the data file. Only active records are taken into account for calculating statistics. [HStatCalculate](../WDLang4/3044134.md) also returns the results of this calculation.
...
<a name="access_rights_the_data_file_ELTPARAGRAPHE000400"></a>
...
<a name="special_case_data_files_corrupted_after_reboot_fatal_error_ELTPARAGRAPHE000411"></a>
