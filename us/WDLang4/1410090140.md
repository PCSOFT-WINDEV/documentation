...
Determines if geometry A covers geometry B. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FormeCouvre.gif)
Remarks: 
...
In a data file, you can apply a filter on spatial data and loop through the data file. For example, the filter can be based on the result of **GeometryCover**.
