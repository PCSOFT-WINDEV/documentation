...
- the filter is created: the **&lt;Source&gt;.FilterStartsWith** function returns the optimal route key to be used to route the data file, view or query.
...
<a name="nonhfsql_data_files_ELTPARAGRAPHE000394"></a>
