...
| [SourceFromWindow](../WDLang4/1000021402.md) | Automatically initializes: <br><br>- the values of a data file's items in memory with the values from the controls in the window.<br><br>- the value of the WLanguage variables with the value of the window controls.<br><br><br>This function is also available for WEBDEV pages. |
