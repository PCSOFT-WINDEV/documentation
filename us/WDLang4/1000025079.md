...
![HFSQL Client/Server](https://doc.pcsoft.fr/ext/images/us/HFCS.png) The structural integrity of memos in an HFSQL Client/Server data file can be checked asynchronously using [&lt;HFSQL connection&gt;.CheckMemoAsynchronous](../WDLang4/1410091222.md). 
<a name="Exemple1"></a>
