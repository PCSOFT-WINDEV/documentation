...
For each row, in the same family of columns, the number and the name of columns is free.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Table-HBase.gif)
