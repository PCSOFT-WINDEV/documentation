...
### Encrypted data file
<a name="encrypted_data_file_ELTPARAGRAPHE000291"></a>

If the data file in HFSQL Classic format to be imported is encrypted, it is necessary to specify the password before using the function **HImportHF55** Use the [HPass](../WDLang4/3044108.md) function.
<a name="NOTE0_2"></a>
