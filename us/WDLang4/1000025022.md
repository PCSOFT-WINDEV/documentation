...
Positions on the first file record according to a browse item. The record is read and the HFSQL variables (e.g. Customer.Name, i.e. the field *Name* field of the data file *Client*data file) are updated.
...
- the data file is empty or there is no record corresponding to the filter (defined by [&lt;Source&gt;.Filter](../WDLang4/1000024960.md)): no reading is performed and function [&lt;Source&gt;.Out](../WDLang4/1000024605.md) returns <u><u><u>True</u></u></u>.
...
- To optimize the time taken for the first few runs of a data file, use function [&lt;Source&gt;.Optimize](../WDLang4/1000025042.md).
...
[How do I run through a data file?](../WDLang4/20010.md)
