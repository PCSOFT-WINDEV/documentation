...
Notification history is recorded in an HFSQL data file in the server's system database: "Alert.fic". 

This data file can be handled through programming as follows: 
