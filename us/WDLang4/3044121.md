...
<a name="version_data_file_ELTPARAGRAPHE000248"></a>
...
- or directly in the data files manipulated by the query (constant *HModifiesFile*used in functions [HExecuteQuery](../WDLang4/3044080.md) or [HExecuteSQLQuery](../WDLang4/3044084.md)). In this case, the *hWithFilter* constant is automatically selected.
...
### xBase data files
<a name="xbase_data_files_ELTPARAGRAPHE000327"></a>
