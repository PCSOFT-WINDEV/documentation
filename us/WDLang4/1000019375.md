...
**Attention** The function **HAccelerateSpeed** function locks the data file for writing while statistics are being calculated (the data file is scanned for each key in the data file).
...
**Caution**: This data file must not be blocked by an application.
...
![HFSQL Client/Server](https://doc.pcsoft.fr/ext/images/us/HFCS.png) Optimizes index reorganization for HFSQL Client/Server data files. 
