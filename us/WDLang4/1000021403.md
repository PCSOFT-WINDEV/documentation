...
- The function **&lt;Source&gt;.FromWindow FUNCTION** function does not write to the data file: only the variables of the data file fields are assigned (i.e., the variables of the record loaded into memory). To modify the records, use [&lt;Source&gt;.Add](../WDLang4/1000024187.md), [&lt;Source&gt;.Modify](../WDLang4/1000025038.md), [&lt;Source&gt;.Write](../WDLang4/1000024331.md), etc.
...
<a name="binding_between_control_and_wlanguage_variable_between_control_and_data_file_item_ELTPARAGRAPHE000235"></a>
...
- If multiple controls in the window or page are bound to the same data file item, **&lt;Source&gt;.FromWindow** may not update the bound item properly. ***It is not recommended to bind multiple controls of a window or page to the same item***.
