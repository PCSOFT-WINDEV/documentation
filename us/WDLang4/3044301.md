...
To identify them, an indication "HFSQL/CS" appears at the bottom of the graphic description of these data files. Furthermore, the color associated with this area becomes orange: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=PictoHFSQLCS.gif)
