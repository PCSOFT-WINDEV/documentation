...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003044320&name=hinfodatabaserights_function&product=WD">See additional examples</a>
...
## Remarks
To modify the rights of a user or group of users on a database, use [HModifyDatabaseRights](../WDLang4/3044326.md).
