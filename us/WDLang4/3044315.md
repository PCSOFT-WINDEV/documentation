...
<a name="variables_for_managing_users_ELTTEXTE000367"></a>


### Which variables?
<a name="which_variables_ELTPARAGRAPHE000042"></a>
...
| HUser.Email | Character string. <br><br>User's email address. |
...
| HUser.FullName | Character string. <br><br>Full name of the user. |
...
| HUser.Login | Character string<br><br>User login (254 characters maximum).<br>The user login is not case sensitive. |
...
<a name="when_should_use_these_variables_ELTPARAGRAPHE000181"></a>
...
### Default user
<a name="default_user_ELTPARAGRAPHE000205"></a>
...
<a name="variables_for_managing_groups_ELTTEXTE000403"></a>
The following variables are used to manage groups of users:


|   |   |
| --- | --- |
| HGroup.ActiveDirectory | Boolean (False by default).<br><br>If this variable is set to True, the group uses an authentication via Active Directory. |
...
| HGroup.Name | Character string. <br><br>Group name (254 characters maximum). |
| HGroup.Users | Character string. <br><br>List of users associated with the group. User names are separated by Carriage Returns. |
...
### When should I use these variables?
<a name="when_should_use_these_variables_ELTPARAGRAPHE000277"></a>
...
[HResetGroup (Function)](../WDLang4/3044292.md)

[HResetUser (Function)](../WDLang4/3044293.md)

[HFSQL Client/Server functions](../WDLang4/3044316.md)

[HFSQL Client/Server: Port management](../WDLang4/3044334.md)

[Authentication via Active Directory](../WDLang4/9000182.md)
