...
Logical name of the query to be initialized. If a query with the same name is already declared, it is replaced with the new query.
...
[HPrepareQuery (Function)](../WDLang4/1000019028.md)
