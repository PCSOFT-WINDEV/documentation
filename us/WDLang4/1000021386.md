...
- **&lt;Window&gt;.ToSource** cannot be used to write to the data file: the variables of the data file items can only be updated (i.e variables of the record loaded in memory). To modify the records, use [&lt;Source&gt;.Add](../WDLang4/1000024187.md), [&lt;Source&gt;.Modify](../WDLang4/1000025038.md), [&lt;Source&gt;.Write](../WDLang4/1000024331.md), etc.
...
<a name="binding_between_control_and_wlanguage_variable_between_control_and_item_data_file_ELTPARAGRAPHE000270"></a>
...
<a name="updating_the_items_special_cases_ELTPARAGRAPHE000286"></a>
...
- If multiple controls in the window are bound to the same data file item, **&lt;Window&gt;.ToSource** may not update the bound item properly. ***It is not recommended to bind multiple window controls to the same item.***

- **&lt;Window&gt;.ToSource** does not update items or variables with the values from Image controls. Use the [&lt;Source&gt;.LinkMemo](../WDLang4/1000024194.md) function.
