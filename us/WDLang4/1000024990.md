...
### Encrypted data file
<a name="encrypted_data_file_ELTPARAGRAPHE000427"></a>

If the data file in HFSQL Classic format into which the import must be performed is encrypted, the password must be specified before using **&lt;Source&gt;.ImportHF55**: use the [&lt;Source&gt;.Password](../WDLang4/1000025044.md) function.
<a name="NOTE0_2"></a>
