...
<a name="defining_unalterable_data_file_ELTTEXTE000247"></a>
...
- in the data model editor: 
	...
	2. On the "Options" tab, check "Unalterable data file (automatically enables enhanced security)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Fichiers%20de%20donn%E9es%20inalt%E9rables%20-%20HC%20N%B0001.gif&type=thumb)
...
- programmatically, by defining a data file dynamically: 
...
<a name="operations_that_can_performed_not_unalterable_data_file_ELTTEXTE000271"></a>
...
Note: The [HCheckUnaltered](../WDLang4/1000023377.md) function can be used to check that one or all records in an unalterable data file have not been modified (e.g. with a hexadecimal editor). Warning: A corrupted record can be read (if the header is not corrupted). 
