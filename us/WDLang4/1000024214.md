...
Temporarily imports into the current analysis the description of a data file from an existing HFSQL data file. This data file is opened. To no longer use this File Description, call [&lt;Source&gt;.CancelDeclaration](../WDLang4/1000024192.md).
...
If the data file is password protected, this password must be specified with [&lt;Source&gt;.Password](../WDLang4/1000025044.md) before using **&lt;Source&gt;.DeclareExternal**.
