...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) The SQL functions are used to handle MySQL and MariaDB databases and the databases accessible by ODBC (HFSQL for example).
...
<a name="connection_hfsql_analysis_ELTPARAGRAPHE000477"></a>To connect to an HFSQL analysis, use the following syntax:
...
- If the HFSQL data files are not found in the current program directory or in the directory defined in the analysis, the directory must be modified by [HChangeDir](../WDLang4/3044168.md).
