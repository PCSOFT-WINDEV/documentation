...
- Integrity management and secure password: For integrity management on files with passwords to be taken into account by replication, all data files contributing to the integrity constraint must have the same password. Otherwise, the replication will not work. 
