...
<a name="when_use_docparampagetitleshort_ELTPARAGRAPHE000109"></a>
...
2. Prepare the query to be executed (**HPrepareSQLQuery**) as well as the different variables to be modified. Then, execute the query as many times as necessary with [HExecuteSQLQuery](../WDLang4/3044084.md). This solution is much faster and optimizes the time it takes to loop through the result of a query (Select query).


![Native Connectors (Native Accesses)](https://doc.pcsoft.fr/ext/images/us/AN.png) **SQL Server: Limit**: **HPrepareSQLQuery** cannot be used to prepare a stored procedure that returns records. You must use [HExecuteSQLQuery](../WDLang4/3044084.md).
<a name="NOTE0_2"></a>


### How to use HPrepareSQLQuery?
<a name="how_use_docparampagetitleshort_ELTPARAGRAPHE000142"></a>
...
<a name="condition_composite_key_sql_query_ELTPARAGRAPHE000187"></a>
