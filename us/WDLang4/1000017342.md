...
- **ScreenToSource** cannot be used to write to the data file. Only the variables of the data file items can be updated (i.e variables of the record loaded in memory). To modify the records, use [HAdd](../WDLang4/3044147.md), [HModify](../WDLang4/3044042.md), [HWrite](../WDLang4/3044092.md), etc.
...
<a name="binding_between_control_and_wlanguage_variable_between_control_and_data_file_item_ELTPARAGRAPHE000128"></a>
