...
<a name="queries_hfsql_data_files_ELTPARAGRAPHE000717"></a>
...
- If the data files used by the query are not found in the analysis, these files must be dynamically declared by [HDeclareExternal](../WDLang4/3044204.md). Otherwise, an error such as **Unable to initialize the query. Unknown FILENAME** will occur. 
	Example:
