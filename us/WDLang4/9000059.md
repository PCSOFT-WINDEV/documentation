...
<a name="using_the_analysis_connection_hfsql_classic_database_ELTPARAGRAPHE000266"></a>
...
- Connection to an HFQL Client/Server database with password-protected files that use the Russian character set:
	...
	**Note** In this example, all database files are protected by the password "secret1", except for the data file "File2", which is protected by the password "secret2".
