...
To add the description of this index into the description of a data file, use [HDescribeFullTextIndex](../WDLang4/1000017407.md). The "FullTextIndex Description" variable is reinitialized and it can be used to describe another full-text index programmatically.
...
<a name="how_describe_data_files_programmatically_ELTPARAGRAPHE000177"></a>
