...
Describes a data file in dBase3 format (most common format) programmatically. This function is used to specify the name, abbreviation and access path of xBase file.
<a name="Exemple1"></a>
