...
Compares two geometries and determines if their intersection spatially crosses. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FormeCroise.gif)
...
In a data file, you can apply a filter on spatial data and loop through the data file. For example, the filter can be based on the result of **GeometryCross**.
