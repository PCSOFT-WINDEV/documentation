...
- the data file is empty or there is no record corresponding to the filter (defined by function [&lt;Source&gt;.Filter](../WDLang4/1000024960.md)): no read is performed and function [&lt;Source&gt;.Out](../WDLang4/1000024605.md) returns <u><u><u>True</u></u></u>.
...
If the item is a key, **&lt;Source&gt;.ReadLast** reads the record with the greatest key value. The sort order taken into account is the one specified in the analysis for this key. If duplicates are found, **&lt;Source&gt;.ReadLast** reads the last "duplicate" record according to the sequence of record numbers.
