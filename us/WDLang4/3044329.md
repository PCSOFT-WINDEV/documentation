...
**Remark**: You can find out the properties of a database using the [HInfoDatabaseProperty](../WDLang4/3044323.md) function.
...
ModificationResult = HModifyDatabaseProperty("MyConnection", hOwner, "Flora", "MyDatabase")
...
<a name="changing_the_owner_database_ELTPARAGRAPHE000128"></a>
...
[&lt;Connection variable&gt;.ModifyDatabaseProperty (Function)](../WDLang4/1000022717.md)
