...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) It is possible to manage full-text indexes in data files described programmatically: simply use a variable of type [FullTextIndex Description](../WDLang4/1000017461.md) to describe the index, then the [HDescribeFullTextIndex](../WDLang4/1000017407.md) function to validate index creation.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Creating a full-text index in a data file created through programming can be done via a [FullTextIndex Description](../WDLang4/1000017461.md) variable.
