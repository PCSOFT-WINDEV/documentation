...
**Remark**: It is possible to find out the rights of a group or user on a Client/Server HFSQL data file using the [&lt;Connection variable&gt;.InfoFileRights](../WDLang4/1000022667.md) function.. 
...
`<Result> = <Authentication>.ModifyFileRights(<User/Group> , <Rights to modify> , <New values> , <Database> , <Data file>)`
---
