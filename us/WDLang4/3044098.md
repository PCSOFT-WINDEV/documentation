...
- the filter is created: the **HFilterStartsWith** function returns the optimal route key to be used to route the data file, view or query.
...
<a name="nonhfsql_data_files_ELTPARAGRAPHE000249"></a>
