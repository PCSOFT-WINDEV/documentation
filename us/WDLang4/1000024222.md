...
|   |   |
| --- | --- |
| *hAffectBrowse* | **Effect of addition on the browse**: The addition affects the browse. <br>For example, [&lt;Source&gt;.ReadNext](../WDLang4/1000025035.md) used after **&lt;Source&gt;.DuplicateRecord** positions on the record found after the added record.<br>The *hAffectBrowse* constant has priority over the *hWriteDefault* constant. |
