...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
The following functions are specific to Android and iOS phones, among others.
...
| [ScanFromCameraToImage](../WDLang3/1410090763.md) | Opens a specific window for scanning one or more documents using the phone or tablet camera. |
| [ScanFromCameraToPDF](../WDLang3/1410090790.md) | Opens a specific window for scanning one or more documents using the phone or tablet camera. |
...
| [SMSDetectOneTimeCode](../WDLang3/1410090437.md) | Automatically populates an Edit control with a one-time code received by SMS. |
