...
.|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=logo_Android.gif) | Android | **Note**: Data binding between controls and variables is not available for Android applications. |
