...
3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IconeAjouterPropriete.gif)
 and select "New list of requirements". 

4. In the window that appears, you can specify the characteristics of the list in the "General" tab:
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Exigence_Creation%20-%20HC%20N%B0002.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Creation_Exigence_simple26%20-%20HC%20N%B0001.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Creation_Exigence_simple26%20-%20HC%20N%B0002.gif&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Creation_Exigence_simple26%20-%20HC%20N%B0003.gif&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Exigence_Creation_Simple%20-%20HC%20N%B0001.gif&type=thumb)
...
- from the requirement management window: in the "Requirements" pane, in the "Management" group, click "List of requirements". In the window that is displayed, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IconeAjouterPropriete.gif)
, "New requirement" option.
...
3. In the window, click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Import_Exigence.gif)
 button. 
