...
| Element | Role |
| --- | --- |
| *LastName* | Name of the client account. This name will be used to identify the client account in the functions for SaaS management and on the invoicing reports.<br>**This information is mandatory.** |
