...
**Note**: Subscriptions can only be managed with the "admin" account. Nevertheless, the users with the "Administrator" rights can change the distribution of licenses for the sites to which they subscribe.
...
4. A dialog box appears. Select the client account and click "OK".
