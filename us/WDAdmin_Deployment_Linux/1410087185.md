...
- **GPUPATH_R**:
	Location of data files of the User Groupware rights (HFSQL Classic) for the site or web service (full path).

- **HFPATH**:
	Location of data files (HFSQL Classic) of WEBDEV website/web service (full path).
