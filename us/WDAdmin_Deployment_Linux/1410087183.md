...
```
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Netstat_num%E9ric.gif)
**Searching for the Apache configuration file**
...
1. Return the list of programs corresponding to the services used:
	...
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Netstat_Nomfic.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Info_Apache.gif)
...
```
If port 80 is displayed in the result, then a Web server is installed.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Netstat_num%E9ric.gif)
**Installing an Apache server**
The following command line allows you to install an Apache server:
...
You will get the following information:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Info_Apache.gif)
The two key points are:
