...
- perform a simple search: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CurseurLoupe.gif)
 in the column header and type the beginning of the message you are searching for.
