...
**Note**: All user information and rights are stored in HFSQL data files (Classic or Client/Server).
...
For more details on these data files and their configuration (installation directory, etc.), see the online help.
...
In version 18, some important changes were made to the User Groupware. The data files used by the User Groupware have changed.
...
- configure the rights required by the user of your application before creating the setup procedure. Simply add the groupware data files when you create the application setup.
