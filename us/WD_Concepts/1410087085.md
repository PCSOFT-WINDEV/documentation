...
## Different modes
<a name="different_modes_ELTTEXTE000170"></a>
...
<a name="how_client_application_works_ELTTEXTE000194"></a>
A client application of a socket server connects to a standard server to exchange information via a socket.

A WINDEV client application can connect to a standard news server on the Internet**.
...
**Note**: The SocketXXX functions can also be used to manage sockets secured using SSL. To do so, use [SocketCreateSSL](../WDLang3/1000017041.md) and [SocketConnectSSL](../WDLang3/1000017042.md).
