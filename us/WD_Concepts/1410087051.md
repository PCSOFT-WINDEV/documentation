...
<a name="creating_analysis_ldm_ELTTEXTE000763"></a>
In WINDEV, the terms "LDM" and "Analysis" are used interchangeably to define the structure of the database associated with a project.
<a name="NOTE2_2"></a>


### Creating an analysis (or LDM)
<a name="creating_analysis_ldm_ELTPARAGRAPHE000042"></a>
...
<a name="adding_data_file_analysis_ELTPARAGRAPHE000075"></a>
...
For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_BaseDonn%E9esExterne1.gif)
 This is an Oracle database on the server. SImply drag the name of the database and drop it onto the data model editor to transfer its description. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Base%20Oracle%20-%20HC%20N%B0001.gif)
...
<a name="characteristics_the_links_defined_analysis_ELTTEXTE000811"></a>


### Owner data file and member data file
<a name="owner_data_file_and_member_data_file_ELTPARAGRAPHE000256"></a>
...
To put it simply, these two questions can be broken down into four questions. For example, to describe a link between the Club and Member data files: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CardinaliteFenDescription.gif)
...
<a name="possible_operations_analysis_ELTTEXTE000859"></a>
WINDEV allows you to perform the following operations on an analysis (LDM):
...
WINDEV allows you to perform the following operations on a data file item in the data model editor:
...
<a name="generating_the_analysis_ELTTEXTE000883"></a>
...
<a name="managing_the_analysis_versions_ELTTEXTE000907"></a>
...
### Restoring an analysis
<a name="restoring_analysis_ELTPARAGRAPHE000623"></a>
