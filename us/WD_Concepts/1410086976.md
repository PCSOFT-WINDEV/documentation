...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Fen_Detail_Champ_Saisie%20-%20HC%20N%B0001.gif)
...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=SansAncrage.gif) | **No anchor**: The control is not resized when the window is resized. No anchoring option is selected. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=A_Largeur.gif) | **Width**: The control stretches to the right as the window is enlarged. Set the "width" anchor percentage to define how much a control stretches relative to the window. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=A_Droite.gif) | **Right**: The control moves to the right as the window is enlarged. Set the "right" anchor percentage to define how much the control moves. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=centre_Largeur.gif) | **Horizontally centered**: The control remains centered horizontally regardless of the window width. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=A_Hauteur.gif) | **Height**: The control stretches to the bottom as the window is enlarged vertically. Set the "height" anchor percentage to define how much a control stretches relative to the window. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=A_Largeur_Hauteur.gif) | **Width and height**: The control stretches to the right and to the bottom as the window is enlarged. Set the "width" and "height" anchor percentages to define how much a control stretches relative to the window. |
...
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Repart_Verticale.gif) | **Vertical distribution**: This option is only available when multiple controls are selected. The selected controls stretch downward and are distributed proportionally when the window is enlarged vertically. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=A_Bas.gif) | **Bottom**: The control moves to the bottom as the window is enlarged to the bottom. Set the "bottom" anchor percentage to define how much the control moves. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=A_Largeur_Bas.gif) | **Width and bottom**: The control stretches to the right and moves to the bottom as the window is enlarged. <br>Set the "bottom" anchor percentage to define how much the control moves. <br>Set the "width" anchor percentage to define how much a control stretches relative to the window. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=A_Droite_Bas.gif) | **Right and bottom**: The control moves to the right and to the bottom as the window is enlarged. Set the "bottom" and "right" anchor percentages to define how much the control moves. |
...
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=centre_Hauteur.gif) | **Vertically centered**: The control remains centered vertically regardless of the window height. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Repart_Horizontale.gif) | **Horizontal distribution**: This option is only available when multiple controls are selected. The selected controls stretch to the right and are distributed horizontally when the window is enlarged. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=centre_Vertical_Droite.gif) | **Vertically centered to right**: The control remains vertically centered regardless of the window height. <br><br>However, the control is anchored to the right and moves right when the window is enlarged. <br>Set the "right" anchor percentage to define how much the control moves. |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=centre_Hauteur_Largeur.gif) | **Centered**: The control remains centered vertically and horizontally regardless of the window size. |
...
3. Select the 3 Button controls. These controls must stretch to the right proportionally (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Repart_Horizontale.gif)).
