...
In this case, the code executed comes from the libraries (and not from the code in the elements on the computer). Therefore, the code of the current project and the code of the executable file can become out of sync. The out-of-sync code is highlighted in pink during debugging.
...
Each test is associated with a test scenario. This scenario can be viewed in the code editor. The code of the tests can be modified.
