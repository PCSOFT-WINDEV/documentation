...
| --- | --- |
|   |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Audit%20statique%20-%20HC%20N%B0003.gif&type=thumb)<br> | Audit report, analysis of the library (to detect large files) and analysis of the installation package. <br><br>To start the static audit, go to the "Project" tab, "Audit and performance" group, expand "Static audit" and select "Start static audit". |
