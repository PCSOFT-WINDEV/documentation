...
|   |   |
| --- | --- |
| **1. Creating an internal window**.<br><br>To create an internal window:<br><br>- Click ![Create an element](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Nouveau.gif) in the quick access buttons. <br><br>- In the window that appears, click "Window", then "Internal window".<br><br><br> |
