...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%204%20-%20Aper%E7u%20-%20HC%20N%B0001.jpg&type=thumb)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=exemple-WD.png)<br> | Answer | A completed project is available. This project contains the different windows that will be created in this lesson. To open the completed project, go to the home page and click "Tutorial", then in "Part 4 - Full application with data", double-click "Full application - Answers". |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0001.jpg&type=thumb)


|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | **Handling controls in a Tab control**<br><br>- To check whether all the controls are associated with the current tab, click another tab: all controls associated with the tab disappear. <br><br>- To resize the Tab control without taking into account the anchors defined on the controls of the tab pane, hold down the Shift key while you resize the control.<br><br><br> |




![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0002.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0003.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0004.jpg&type=thumb)


	3. The tab characteristics are displayed.  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0004%201.jpg&type=thumb)
...
- We have just created a new control: we must define its anchors in the window. When the window is enlarged, the Tab control must also be enlarged in order to occupy the entire available space. Therefore, the control must stretch to the right and to the bottom.
	...
	3. In the window for defining the anchor, select ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0002%202.jpg)
 and validate.
...
- To create the controls that will display the customer data:
	...
	3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0001%201.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0006.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0007.jpg&type=thumb)
...
- Test the window (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fenetre_WD_GAF.Jpg)
 in the quick access buttons). Click the "Find customers" tab. The window is displayed with empty controls.
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0008.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0009.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0010.jpg&type=thumb)
...
.
	...
	6. Let's take a look at this WLanguage code:
		...
		- In this code, if the record was found, it is displayed by [&lt;Data file&gt;.ToWindow](../WDLang4/1000021397.md).
						|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | [&lt;Data file&gt;.ToWindow](../WDLang4/1000021397.md) and [ScreenToFile](../WDLang4/3044146.md) perform the reverse operation: the data in the items of the data file is displayed in the corresponding controls. |
...
- Let's run a window test:
	...
	1. Test the window (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fenetre_WD_GAF.jpg)
 in the quick access buttons).

	2. Click the "Find customers" tab if necessary.

	3. Select a value in the Combo Box control and click "Exact-match search".  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0014.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0017.jpg&type=thumb)
...
5. Write the following WLanguage code in the "Click" event of the button:
		...
		```
			...
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | To perform an exact-match search, call [&lt;Data file&gt;.ReadSeek](../WDLang4/1000025023.md): to do so, the **hIdentical** constant must be used. |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0015.jpg&type=thumb)
...
We will add four Button controls to browse through the different records of the "Customer" data file. These controls are in a "Navigation" layout. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0017%201.jpg)
...
- Skin templates are used to standardize the windows in a project. They define the style of all controls in the windows. A specific style is defined for each navigation button. To apply this style:
	...
	3. All the button styles are displayed in the window that appears. 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Rech%20-%20HC%20N%B0016.jpg&type=thumb)
Select "BTN_First".
...
- Save the window by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Enregistrer_GAF.jpg)
 in the quick access buttons.
