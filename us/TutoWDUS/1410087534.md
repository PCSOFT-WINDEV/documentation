...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%20Recherhe%20Aper%E7u%20-%20HC%20N%B0001.jpg&type=thumb)
This UI includes:
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | **What is a select query?**<br><br>A select query is a query that will "choose" the records corresponding to the specified criteria.<br><br>This type of query is called "select query" because of the SQL SELECT command. |
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=exemple-WD.png)<br> | Answers | A completed project is available. This project contains the windows and queries created in this lesson. To open the completed project, go to the home page and click "Tutorial", then in "Part 4 - Full application with data", double-click "Full application - Answers". |
...
- The query editor will be used to create the query.
 ...
 in the quick access buttons. The new element window appears: click "Query­". The query creation wizard starts.
	...
	4. Double-click the items in the analysis, to the left of the description window. The items taken into account are displayed in the middle of the screen. 
			Remark: To display the items of the different data files, simply click the arrow ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg)
 to the left of the data file name.
			We want to display:

		- the order information. Expand the "Order" data file (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg)
) and double-click the items: OrderID, Date, Status and TotalBT.

		- information regarding the customer who placed the order. Expand the "Customer" data file (click the arrow ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg)
) and double-click the "FullName" item.

		- the payment method. Expand the "PaymentMode" data file (click the arrow ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg)
) and double-click the "Caption" item.


 The query description window is as follows:  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0006.jpg)
The result lists ALL orders.
	...
	|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | When you right-click the query result, a context menu appears. The result can be exported to:<br><br>	- an XLSX file (Excel).<br><br>	- a Word or OpenOffice file. <br><br>	- an XML file (eXtensible Markup Language).<br><br>	- an HFSQL file.<br><br><br> |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0007.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0008.jpg)
...
- We will define a condition on the payment method. This item does not appear in the query result but we will still define a condition. To do so, we will add it to the query result, but we will make it invisible so it does not appear in the result.
	...
	2. To avoid displaying this item in the result:
		...
		- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0009%201.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0010.jpg&type=thumb)
...
.
	...
	3. Define the following data:
		...
		- Select the ParamEndOfPeriod parameter. In the bottom section of the window, enter "03/31/2022".  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0011.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0001.jpg&type=thumb)


	7. We will associate an image to the tab via the WINDEV image catalog. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Multilingue%20-%20HC%20N%B0014%201.jpg)
 on the right of "Image". Select "Catalog" in the context menu that appears. The image catalog window appears.

8. In the search area, specify "Search". Click the search icon to start the search.

9. Among the proposed images, select the icon representing the binoculars (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0002%201.jpg)
) and validate.

10. Keep the default options in the image settings and validate.

11. Validate the Tab control description window.  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0002.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0003.jpg&type=thumb)


		- Go to the next step of the wizard.

6. Select all suggested items if necessary.  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0004.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%203%20Rech%20Multi%20IHM%20Table%20-%20HC%20N%B0001.jpg&type=thumb)


	3. Click the "COL_FullName" column. Replace "Full name" by "Customer".  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%203%20Rech%20Multi%20IHM%20Table%20-%20HC%20N%B0002.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0006.jpg&type=thumb)
...
- To create the Radio Button control:
	...
	2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0007.jpg&type=thumb)
...
- We will test the first parameter:
	...
	1. Save the window by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Enregistrer_GAF.jpg)
 in the quick access buttons.
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0008.jpg&type=thumb)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | The Combo Box control displays a list of elements and allows users to select an element from the list.<br><br>Unlike a List Box, a Combo Box control is not expanded: the Combo Box control expands on request or when the cursor is positioned on the control input area.<br><br>The elements displayed in a Combo Box control can be defined when creating the control in the editor. These elements:<br><br>- are defined programmatically.<br><br>- come from a data file or query.<br><br><br> |
...
4. Save the window by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Enregistrer_GAF.jpg)
 in the quick access buttons.
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0009.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0010.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0011.jpg&type=thumb)
