...
- This number must be specified in the wizard for generating the Android application. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Push_Android_firebase%20-%20HC%20N%B0001%201.gif)
