...
**Remark**: To edit project-specific events: in the "Home" pane, in the "General" group, pull down ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ico_code.gif) and select "Project code".
