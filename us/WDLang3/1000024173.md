...
<a name="NOTE1_2"></a>
The following functions are used to manage charts (prefix syntax):
...
| [&lt;Chart&gt;.ColumnBarType](../WDLang3/1410090316.md) | Defines the type of bar used in a column chart. |
...
| [&lt;Chart&gt;.Interval](../WDLang3/1000024076.md) | Indicates the interval between values on the vertical and horizontal axis of a chart. |
...
| [&lt;Chart&gt;.PieStartAngle](../WDLang3/1000024129.md) | Indicates the starting angle of the first slice in a Sector, Hemicycle or Donut graph. |
...
| [&lt;Chart&gt;.SunburstSectionColor](../WDLang3/1000024134.md) | Changes the color of a portion of a Sunburst chart. |
...
| [&lt;Chart&gt;.WaffleSize](../WDLang3/1410090314.md) | Defines the number of rows and columns in a Waffle chart. |
| [&lt;Chart&gt;.WaffleTypeCell](../WDLang3/1410090315.md) | Defines the shape of cells in a Waffle chart. |
