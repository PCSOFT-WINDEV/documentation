...
### Chart title
<a name="chart_title_ELTPARAGRAPHE000149"></a>The chart title can be displayed above or below the chart.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Titre.gif)
