...
- [The Bluetooth functions](../WDLang3/1000017173.md) (BTxxx): These functions can be used to manage Bluetooth devices. You can for example list the services found on a device, and enable or disable them. You can also authenticate toward a Bluetooth device and get various information about the device.
