...
<DIV class="specObsolete">
	<IMG style="float:left;margin-right:10px;" src="$IMGLOCAL$=warning_big.png"><B>Warning</B><BR>
	 SOAP functions are reserved for advanced users, to handle special cases. In most cases, we recommend importing the wsdl file of the SOAP web service. For more details, see [Importing/Consuming web services](../WDLang3/3086001.md). 
</DIV><a name="NOTE1"></a>
<a name="NOTE1_1"></a>
