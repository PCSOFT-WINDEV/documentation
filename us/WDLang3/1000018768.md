...
<a name="properties_specific_emailnotessession_variables_ELTPARAGRAPHE000025"></a>

The following properties can be used to define the characteristics of **emailNotesSession** variables:
...
| Password | Character string or Secret string | User password. This password is given by the service provider or by the network administrator.<br>**Secret strings**: If you use the secret string vault, the type of secret string used for this parameter must be "ANSI or Unicode string".<br>To learn more about secret strings and how to use the vault, see [Secret string vault](../Editeurs/1410087353.md). |
...
<a name="functions_that_use_emailnotessession_variables_ELTPARAGRAPHE000075"></a>
