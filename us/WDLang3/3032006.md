...
- Email managed by the SMTP/POP3/IMAP protocol: the function **EmailCloseSession** closes the SMTP/POP3/IMAP session. If a POP3 session, an SMTP session and an IMAP session were started, all the sessions are closed.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Email managed via MS Exchange client (Outlook): the function **EmailCloseSession** function closes the MS Exchange session. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Email managed with Lotus Notes: the function **EmailCloseSession** function is used to close a session with the Lotus Notes messaging software. 
...
### Close an Email session using POP3, SMTP or IMAP protocol
...
[&lt;emailSMTPSession variable&gt;.CloseSession (Function)](../WDLang3/1000022286.md)
