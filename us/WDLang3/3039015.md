...
Note: The [SNMPLoadMIB](../WDLang3/1000017074.md) function is used to load information from a MIB into memory, so that the OID's string identifier is used instead of its Numerical identifier.
