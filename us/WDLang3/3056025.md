...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003056025&name=netgetfile_function&product=WD">See additional examples</a>
...
**NetGetFile** sends the specified message to follow the progress of transfer. This message must be intercepted by [Event](../WDLang1/3015011.md). The message contains two parameters:
