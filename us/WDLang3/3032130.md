...
- SSL-secured LDAP: The LDAPSession structure can also be used to manage an SSL-secured connection via the LDAPSession.Option variable. For more details, see [LDAPSession structure](../WDLang3/3032101.md). 
...
[User Groupware and LDAP](../WDLang3/2018013.md)
