...
### Handling legends
<a name="handling_legends_ELTPARAGRAPHE000149"></a>The set of series labels correspond to the chart legend.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=EtiquetteSerie.gif)
