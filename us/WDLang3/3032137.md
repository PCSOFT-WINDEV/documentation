...
- the emails via the [Email functions](../WDLang3/3032034.md). 
	Warning: If an Outlook user has several e-mail accounts and several data files (pst file) in his profile, only e-mails from the pst file linked to the server (default pst file) will be read. 
