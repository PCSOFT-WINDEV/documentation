...
### Title of axes
<a name="title_axes_ELTPARAGRAPHE000231"></a>The title of chart axes can be displayed for the different axes.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Titre.gif)
