...
**Note**: These functions are also available in prefix syntax ([Functions for managing emails (prefix syntax)](../WDLang3/1000022311.md)).
...
## Email functions
<a name="email_functions_ELTTEXTE000095"></a>
...
| [EmailConfigure](../WDLang3/1000022269.md) | Used to configure WLanguage email management functions. |
...
<a name="types_variables_associated_with_the_management_emails_ELTTEXTE000560"></a>
