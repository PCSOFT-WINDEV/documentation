...
- the view "B" contains the columns 1, 2 and 3. Columns 1 and 3 can be sorted. A search can be performed on column 1 or on columns 1 and 3. No search can be performed on columns 1 and 2, on columns 1, 2 and 3, on column 2 or on column 3.
