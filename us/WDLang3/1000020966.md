...
**Note**: These functions are also available in prefix syntax ([DLNA / UPnP functions (prefix syntax)](../WDLang3/1000021000.md)).

<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
The following WLanguage functions are used to handle the UPnP devices: 
