...
**Note**: These functions are also available in prefix syntax ([Archiving functions (ZIP, WDZ, CAB, RAR, 7z, TAR, gzip and TGZ (TAR.GZ)) (prefix syntax)](../WDLang3/1000019157.md)).
