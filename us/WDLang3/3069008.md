...
1. Initialize the structure of parameters for the procedure to run (see [structure of a SOAP procedure](../WDLang3/3069009.md)).
	Note: To perform additional checks on the SOAP server, add a procedure header (function [SOAPAddHeader](../WDLang3/3069001.md)).
...
- if the result is an empty string (""), the procedure was not run and/or an error was returned. To get the procedure error, use [SOAPError](../WDLang3/3069005.md).
