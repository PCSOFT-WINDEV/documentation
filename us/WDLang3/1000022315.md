...
Sends an email using **Outlook**: the email is placed in the outbox of the messaging software. The email is actually sent from Outlook. For more details, see [Accessing Outlook](../WDLang3/3032137.md).

**Caution**: Before sending the email, you must:

- Start a session with [EmailStartOutlookSession](../WDLang3/3032128.md).
...
Identifies the current email session. This parameter is an integer returned by [EmailStartOutlookSession](../WDLang3/3032128.md).
