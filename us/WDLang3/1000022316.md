...
Send an Email via the **Lotus Notes** The Email is placed in the mailbox of the messaging software. The email is automatically sent by the spooler of Domino. 
...
If the session was started in asynchronous mode ([&lt;EmailNotesSession variable&gt;.StartSession](../WDLang3/1000022303.md) and [EmailStartSMTPSession](../WDLang3/3032025.md)), **&lt;emailNotesSession variable&gt;.SendMessage** creates an identifier for each email sent.
...
Line error handling in asynchronous mode: The function **&lt;emailNotesSession variable&gt;.SendMessage** function returns <u><u><u><u>True</u></u></u></u> if the Email is placed in the Email spooler, <u><u><u><u>False</u></u></u></u> if it is not possible to contact the spooler. To determine if the email was sent, use [EmailStatus](../WDLang3/3032009.md).
<a name="NOTE0_3"></a>
