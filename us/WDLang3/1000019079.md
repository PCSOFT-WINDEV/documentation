...
### Error codes
<a name="error_codes_ELTPARAGRAPHE000317"></a>
...
<a name="stored_path_archive_files_ELTPARAGRAPHE000336"></a>
...
<a name="selfextracting_archive_ELTPARAGRAPHE000346"></a>
...
- A self-extracting archive in ZIP format cannot be opened by [&lt;zipArchive variable&gt;.Open](../WDLang3/1000019097.md).
...
### Closing the archive
<a name="closing_the_archive_ELTPARAGRAPHE000375"></a>
...
<a name="translating_the_interface_the_selfextracting_program_parameter_ELTPARAGRAPHE000392"></a>
...
<a name="the_executable_found_media_from_which_the_archive_files_cannot_extracted_ELTPARAGRAPHE000419"></a>The executable may be found on a media (CD for example) from which the archived files cannot be extracted. In this case, run the executable and specify in the command line:
...
<a name="the_selfextracting_archive_contains_executable_files_ELTPARAGRAPHE000434"></a>
...
<a name="command_line_parameters_selfextracting_archive_ELTPARAGRAPHE000444"></a>
...
|   |   |
| --- | --- |
| /DIR=&lt;Directory&gt; | Used to specify where the archived files should be extracted from. If the &lt;Directory&gt; contains space characters, the character string must be enclosed in quotes.<br><br>Caution: This parameter has priority over the parameter &lt;Extraction directory&gt; specified with **&lt;zipArchive variable&gt;.CreateExe**. |
