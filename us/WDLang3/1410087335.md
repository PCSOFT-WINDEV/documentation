...
1. Define a download request with a variable of type [DownloadParameter](../WDLang3/1410087293.md). This variable contains several properties, but only one is really necessary: the **Source** property, which corresponds to the URI of the file to be downloaded. 
...
**Note: End of download procedure**
...
To follow the download proposed by your Android application, retrieve the download information via the [DownloadGetInfo](../WDLang3/1410087320.md) function, specifying the download identifier provided by the [DownloadAdd](../WDLang3/1410087319.md) function.. This information is stored in a variable of type [DownloadInfo](../WDLang3/1410087306.md).
