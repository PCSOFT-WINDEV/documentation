...
In this case, the connection will not be closed by [NetCloseRemoteAccess](../WDLang3/3056021.md) (without parameter). To close this connection, the access name must be passed as parameter.
