...
**Remark**: On a cell phone, you can specify a directory in the Bluetooth settings.. This directory corresponds to the root of the OBEX tree structure (which means the "\\" directory given by [OBEXListFile](../WDLang3/1000017148.md)).
