...
**Note** The function **&lt;Chart&gt;.Origin** function allows you to view only part of the graph, by reducing the values displayed on one of the axes.
...
### Marks on axes
<a name="marks_axes_ELTPARAGRAPHE000299"></a>
...
### Types of charts
<a name="types_charts_ELTPARAGRAPHE000327"></a>
...
<a name="restoring_the_default_values_ELTPARAGRAPHE000337"></a>To restore the display of the chart before the origin was modified, the minimum and maximum values of axes must be saved. These values can be known via the following properties: 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![IOS Widget](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) Note: the [&lt;Chart&gt;.Zoom](../WDLang3/1000024169.md) function can also be used to display part of the graph. However, the final user can restore the initial configuration via the context menu of the chart ("Initial zoom"). 
