...
Builds the HTTP request to call a function of a web service. This request can be modified to adapt it to the expectations of the web service, if necessary. It can then be sent using [HTTPSend](../WDLang3/1000021183.md). 
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000024437&name=soaptohttp_function">See additional examples</a>
