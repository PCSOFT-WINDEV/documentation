...
***In french: &lt;Variable Notification&gt;.EnvoiePushAbonné***
...
SendResult is boolean = myNotification.SendPushSubscriber("myTopic", myJSON_FireBase)
...
`<Result> = <Notification>.SendPushSubscriber(<Topic> , <Authentication>)`
---
