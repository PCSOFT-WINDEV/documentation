...
## Email functions
<a name="email_functions_ELTTEXTE000062"></a>
...
| [&lt;Email variable&gt;.ExportHTML](../WDLang3/1000026178.md) | Retrieves the HTML code of an email to display it in an HTML control (HTML control, HTML Display control, etc.). |
...
| [&lt;emailAttach variable&gt;.SaveAttachment](../WDLang3/1000022289.md) | Copies the current email attachment to the user's computer. |
...
<a name="types_variables_associated_with_the_management_emails_ELTTEXTE000329"></a>
