...
Name and full path of the EMF file to create. The file extension is mandatory. This EMF file is created when **&lt;Chart&gt;.SaveEMF** is called. The file is overwritten and recreated if it already existed.
...
[grSaveEMF (Function)](../WDLang3/3042049.md)
