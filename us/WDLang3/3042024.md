...
### Series labels
<a name="series_labels_ELTPARAGRAPHE000132"></a>The set of series labels correspond to the chart legend.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=EtiquetteSerie.gif)
