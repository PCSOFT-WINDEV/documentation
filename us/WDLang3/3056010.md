...
<a name="step_1_establishing_connection_with_windev_rpc_ftp_server_ELTPARAGRAPHE000036"></a>
...
To create a WINDEV RPC or FTP server, you must create an application that uses [NetStartServer](../WDLang3/3056013.md) to start the server. [NetEndServer](../WDLang3/3056024.md) is used to stop this server.
...
In the following example, a file is transmitted to the WINDEV FTP server ([NetSendFile](../WDLang3/3056005.md)). A progress bar is used to track the progress of the transfer.
...
```wl
// -- ProgressBar_Tansfer procedure: managing the current transfer
...
**Remark**: it is possible to easily find out the list of directories and files on a WINDEV FTP server.. An example is available in the description of [NetDirList](../WDLang3/3056016.md).
...
<a name="step_4_closing_connection_with_windev_rpc_ftp_server_ELTPARAGRAPHE000108"></a>
