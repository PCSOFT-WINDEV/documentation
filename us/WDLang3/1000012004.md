...
Reads the task found before the current task in the task list of a Lotus Notes or Outlook messaging. This task becomes the current task.
...
**Caution**: This function **cannot be used** to read the task found before the current task in the task list of an Outlook Express messaging.
<a name="Example1"></a>
