...
**Reminder**: By default, charts have no data.
...
`<Chart control>.ScatterAddDataXY(<Series number> [, <Index>] , <X value> , <Y value>)`
---
...
<a name="adding_data_into_scatter_chart_ELTPARAGRAPHE000270"></a>

The data defined by **&lt;Chart&gt;.ScatterAddDataXY** will be taken into account in the next call to [&lt;Chart&gt;.Draw](../WDLang3/1000024062.md).
<a name="NOTE0_2"></a>


### Adding data into a chart
<a name="adding_data_into_chart_ELTPARAGRAPHE000287"></a>
...
### Equivalence
<a name="equivalence_ELTPARAGRAPHE000341"></a>
