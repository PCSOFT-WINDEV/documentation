...
Remark: This function can be used with [grTimeLevelMax](../WDLang3/1000023016.md), which defines the number of levels to be displayed in the time scale of a chart. 
<a name="Example1"></a>
