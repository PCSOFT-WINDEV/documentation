...
### Chart legend
<a name="chart_legend_ELTPARAGRAPHE000146"></a>The set of series labels correspond to the chart legend.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=EtiquetteSerie.gif)
