...
A "Messages" tab allows you to manage the different messages. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Messagerie_Message%20-%20HC%20N%B0003.gif&type=thumb)
This tab includes: 
...
- reply to the message. There are several options: 
	...
	- Forward: A new message is created, taking over the existing one. This new message has no default recipient. New recipients must be added. 
...
The "Save as incident" option saves the message as an incident in the Project Management Hub. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Messagerie_Ecrire%20-%20HC%20N%B0003%206.gif&type=thumb)
