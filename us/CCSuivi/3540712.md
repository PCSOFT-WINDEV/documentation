...
- or in the Project Management Hub parameters: pull down ![Project Management Hub menu](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) then select "Options".
...
In this code:
	...
	- &lt;base de données&gt; HFSQL Client/Server database name corresponding to Control Center data files.
