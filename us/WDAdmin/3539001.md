...
3. To customize ***the error message and/or the error page***:
	...
	- Choose the error identifier: the default caption is displayed. 
			For more details, see [Error messages that can be displayed in the browser](../WDAdmin/3539002.md).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDADMIN_Onglets%20-%20HC%20N%B0007%201.gif&type=thumb)
