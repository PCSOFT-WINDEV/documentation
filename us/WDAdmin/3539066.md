...
The "Advanced" tab enables you to configure advanced options of the server:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDADMIN_Onglets%20-%20HC%20N%B0006.gif)
...
The "Server" button allows you to choose one of the web servers installed on the current computer to run WEBDEV websites. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDADMIN_Onglets%20-%20HC%20N%B0006%201.gif)
...
The "Diagnostic" button allows you to check the configuration of the current computer or the specified computer. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDADMIN_Onglets%20-%20HC%20N%B0006%201.gif)
...
The WEBDEV administrator allows you to specify a name or IP address to identify a specific computer.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDADMIN_Onglets%20-%20HC%20N%B0006%201.gif)
...
The "Errors" button shows the different error messages that can be displayed in the user's browser. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WDADMIN_Onglets%20-%20HC%20N%B0007.gif)
