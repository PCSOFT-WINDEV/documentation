...
### Limits
<a name="limits_ELTPARAGRAPHE000175"></a>

The properties that define character stretch options (**Condensed**, [Extended](../Proprietes/2513002.md) and [Large](../Proprietes/2513012.md) properties) are supported only if the specified [Font](../Motscles/1514045.md) variable is used for printing (print font or font of controls in a report).
