...
## Remarks
The [CtDescribedDatabase](../Proprietes/2512016.md) property is used to get and change the data source specified for the OLE DB connection when describing the data file.
