...
**Note**: These functions are also available in prefix syntax ([HTML document functions (prefix syntax)](../WDLang5/1000026324.md)).
...
| [HTMLEnableDebugger](../WDLang1/1410087849.md) | Enables the HTML/JavaScript debugger on CEF-based HTML controls: HTML Display or HTML Editor control. |
...
[HTML Editor control functions](../WDLang5/1000026295.md)
