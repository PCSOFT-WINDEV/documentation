...
|   |   |
| --- | --- |
| Case 1: nested report printed on a single page:<br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Imbrique_HautPage1.gif)<br> | Case 2: The nested report is printed on several pages<br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Imbrique_HautPage2.gif)<br> |
