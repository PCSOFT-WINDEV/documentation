...
- The characteristics of a document found on the Google server are managed via the [gglDocument](../WDLang5/1000018001.md) variables. To find out the characteristics of all the documents found on a Google server, use [&lt;gglConnection variable&gt;.ListDocument](../WDLang5/1000020436.md): this function fills an array of gglDocument variables.
