...
<a name="how_manage_google_calendar_ELTTEXTE000331"></a>
...
<a name="how_retrieve_google_calendar_and_its_elements_ELTTEXTE000367"></a>


### 1st method: retrieving the list of calendars then their events
<a name="1st_method_retrieving_the_list_calendars_then_their_events_ELTPARAGRAPHE000100"></a>
...
3. Use [GglFillCalendar](../WDLang5/1000017337.md) to retrieve the events. The events can be retrieved from a single calendar or from several calendars. The events to retrieve can be filtered (between two dates for instance).
...
<a name="how_add_modify_delete_events_google_calendar_ELTTEXTE000397"></a>
...
<a name="modifying_the_events_calendar_ELTPARAGRAPHE000205"></a>
...
**Note**: You can make several changes before using the [GglWrite](../WDLang5/1000017401.md) function.
...
<a name="deleting_event_from_calendar_ELTPARAGRAPHE000235"></a>
...
**Note**: It is possible to make several deletions before using the [GglWrite](../WDLang5/1000017401.md) function.
...
[Organizer control functions](../WDLang5/1000019021.md)
