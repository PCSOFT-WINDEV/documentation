...
SWITCH XMLElementType("XMLDoc")
	CASE XMLBalise: Info(XMLElementName("DocXML") + " is of type XMLBalise")
	CASE XMLAttribut: Info(XMLElementName("DocXML") + " is of type XMLAttribut")
END
```
...
<a name="characteristics_current_element_ELTPARAGRAPHE000088"></a>
