...
- display or hide the ribbon tabs and buttons. For more details, see [Print preview](../WDChamp/1011085.md).![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Apercu_Volet_Apercu.gif)
...
- Two additional buttons may appear in the print preview if the application allows "Reports & Queries" (provided with WINDEV) to be run. ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=icone_Apercu_EtatRequete.gif)
