...
The **gglConnection** type is used to describe a connection to the Google services and to manage the authentication to different services. You can define and change the characteristics of this connection using different WLanguage properties.
...
<a name="properties_specific_gglconnection_variables_ELTPARAGRAPHE000027"></a>
...
| ClientSecret | Character string or Secret string | Secret code of the client given when declaring the application in the Google console.<br>**Secret strings**: If you use the secret string vault, the type of secret string used for this parameter must be "ANSI or Unicode string".<br>To learn more about secret strings and how to use the vault, see [Secret string vault](../Editeurs/1410087353.md). |
| Email | Character string | Email of final client. This property is optional. This property is used to pre-fill the login window of the client to his Google account. <br><br>Warning: This property does not allow you to retrieve the email address of the authenticated account. |
...
<a name="prerequisites_for_oauth_20_authentication_ELTPARAGRAPHE000208"></a>
...
<a name="connection_persistence_ELTPARAGRAPHE000287"></a>
...
<a name="functions_that_use_gglconnection_variable_ELTPARAGRAPHE000078"></a>All the functions for communicating with the Google services take a **gglConnection** variable as parameter.
...
<a name="functions_prefix_syntax_that_handle_gglconnection_variables_ELTPARAGRAPHE000086"></a>
