...
<a name="properties_specific_gglcontactgroup_variables_ELTPARAGRAPHE000041"></a>

The following properties can be used to define the characteristics of **gglContactGroup** variables:

| Name | Type used | Effect |
| --- | --- | --- |
| UpdateDate | DateTime | Date of the last update. This information is read-only.<br>**Note**: The date is UTC (Universal Time Coordinated). |
...
<a name="functions_that_use_gglcontactgroup_variables_ELTPARAGRAPHE000078"></a>
