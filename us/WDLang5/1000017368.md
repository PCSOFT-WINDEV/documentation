...
- The characteristics of a document found on the Google server are managed via the [gglDocument](../WDLang5/1000018001.md) variables. To obtain the characteristics of all documents on a Google server, use function [GglListDocument](../WDLang5/1000017367.md): this function fills an array with variables of type gglDocument.
...
[&lt;gglConnection variable&gt;.UploadDocument (Function)](../WDLang5/1000020424.md)
