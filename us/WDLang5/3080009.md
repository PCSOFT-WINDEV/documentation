...
**Note**: These functions are also available in prefix syntax ([XLS file functions (prefix syntax)](../WDLang5/1000021513.md)).

<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
XLS file functions are as follows:
...
| [AAFExecute](../WDLang1/1000022099.md) | Exports the contents of the Table control or the selection of content in the control to Excel or OpenOffice Calc (depending on the software installed in the user's computer). |
...
| [LooperToExcel](../WDLang2/3083030.md) | Creates an Excel file with data from a Looper control (data-bound or populated programmatically). |
| [TableToExcel](../WDLang1/3074033.md) | Creates an Excel file with the data from a Table or TreeView Table control (data-bound or populated programmatically). |
