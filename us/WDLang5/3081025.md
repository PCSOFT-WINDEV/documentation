...
Note: To perform an XPath query, use the [XMLExecuteXPath](../WDLang5/3081015.md) function. 
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003081025&name=xmlfind_function">See additional examples</a>
...
**`<Search value>: (String (with quotation mark) or NULL keyword)`**
...
| *XMLWithNamespace* | Search performed on the elements containing a namespace.<br>![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) This constant is not available. |
...
<a name="searching_and_browsing_xml_documents_ELTPARAGRAPHE000141"></a>
...
<a name="xml_functions_and_threads_ELTPARAGRAPHE000330"></a>
...
<a name="deleting_element_during_search_ELTPARAGRAPHE000192"></a>
...
[XMLCancelSearch (Function)](../WDLang5/3081001.md)
