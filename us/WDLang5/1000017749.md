...
Fills a calendar that was retrieved beforehand: the events corresponding to the calendar are retrieved (some criteria may be specified). This function must be used after the call to [&lt;gglConnection variable&gt;.ListCalendar](../WDLang5/1000017747.md).
<a name="Example1"></a>
