...
<a name="1st_method_retrieving_the_list_calendars_then_their_events_ELTPARAGRAPHE000259"></a>
...
3. Use [&lt;gglConnection variable&gt;.FillCalendar](../WDLang5/1000017749.md) to retrieve the events. The events can be retrieved from a single calendar or from several calendars. The events to retrieve can be filtered (between two dates for instance).
...
<a name="modifying_the_events_calendar_ELTPARAGRAPHE000392"></a>
...
**Note**: You can make several changes before using the [&lt;gglConnection variable&gt;.Write](../WDLang5/1000021460.md) function.
...
<a name="deleting_event_from_calendar_ELTPARAGRAPHE000427"></a>
...
**Note**: It is possible to make several deletions before using the [&lt;gglConnection variable&gt;.Write](../WDLang5/1000021460.md) function.
...
[Functions for managing Organizer controls (prefix syntax)](../WDLang5/1000022884.md)
