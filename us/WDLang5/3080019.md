...
|   |   |
| --- | --- |
| *False* | All empty columns are taken into account |
| *True*<br>(by default) | All empty columns are ignored |
...
<a name="type_data_entered_column_empty_columns_ELTPARAGRAPHE000200"></a>You can choose whether or not to take empty columns into account. For example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=xlsTypeColonne.gif)
...
### Handling errors
<a name="handling_errors_ELTPARAGRAPHE000209"></a>
