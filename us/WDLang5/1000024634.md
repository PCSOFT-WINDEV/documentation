...
- display or hide the ribbon tabs and buttons. For more details, see [Report viewer](../WDChamp/1011085.md).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Apercu_Volet_Apercu.gif&type=thumb)
...
- Two additional buttons may appear in the report viewer if the application allows running "Reports & Queries" (provided with WINDEV). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Apercu_impression%20-%20HC%20N%B0002%201.gif)
