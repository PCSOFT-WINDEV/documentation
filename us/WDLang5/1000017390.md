...
1. Declare a variable of type [rssStream](../WDLang5/1000017795.md). This variable will contain the information regarding the RSS feed to handle.

2. Load the RSS feed with [rssInitialize](../WDLang5/1000017388.md). The RSS Stream variable is initialized with the specified stream.
...
4. The content of the RSS feed can be displayed in a table linked by databinding to the [rssChannel](../WDLang5/1000017769.md) variable containing the entries of the stream (in our example, MyChannel.Entry).  
...
- manual loops using the **Count** property (can be used on the [rssChannel](../WDLang5/1000017769.md) type to get the number of channels and on the [rssEntry](../WDLang5/1000017792.md) type to get the number of entries).
...
<a name="databinding_and_rss_feed_ELTPARAGRAPHE000064"></a>
