...
**1. Setting the document print options** ([iParameter](../WDLang5/3046008.md)). You can:
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) [iParameter](../WDLang5/3046008.md) is not available.
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) [iConfigure](../WDLang5/3046072.md) is not available.
...
**Warning** The sequence of operations described above must be followed. If a print job is in progress, [iParameter](../WDLang5/3046008.md) and [iConfigure](../WDLang5/3046072.md) cancel the current print job.

![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Reminder: To print directly to a printer connected to the server, a specific configuration is required. For more details, see [Configuring the server to perform a print job](../WDChamp/1011002.md).
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The document can only be printed to PDF.
