...
## Replication vocabulary
<a name="replication_vocabulary_ELTTEXTE000120"></a>
...
- **The replication scenario**
	...
	- the mode for conflict management during the replication (if two records have been modified on two computers, which modification is taken into account).
