...
2. The new element window appears. Click "Report", and then "Report". The report creation wizard opens. The report creation wizard offers several types of reports: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0001.jpg&type=thumb)
...
5. In the list of data files, select "Product". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0003.jpg&type=thumb)
Go to the next step.
...
For more details, see [Break in a report](../WDChamp/1011028.md). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0006.jpg&type=thumb)
...
- For each item, select the corresponding row and use the arrow buttons to the right to move it up or down in the list. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0007.jpg&type=thumb)

11. Go to the next step.

12. As the report displays numeric items, this step allows you to define if calculations should be performed in the report. In our example, no calculations need to be performed. Click the "No calculation" button. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0008.jpg&type=thumb)
Go to the next step. 

13. This step is used to define the report layout. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0009.jpg&type=thumb)
...
15. This step allows you to select the report skin template. It is recommended to use the same skin template as for the windows. In our case, select "Material 3". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0010.jpg&type=thumb)
Go to the next step.
...
18. The report is displayed in the report editor.
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0012.jpg&type=thumb)
...
2. In the print mode selection window, select "Report viewer". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0013.jpg)


3. Confirm. The report is run and displayed in the report viewer. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20%E9tat%20-%20HC%20N%B0014.jpg&type=thumb)
...
2. On the "Binding" tab, select "Bar_Code" in the Product data file. 
...
Run the report by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fen_WM_GAF.jpg) in the quick access buttons. 
...
3. In the description window:
	...
	- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Menu_Image_Editeur_noir.jpg) on the right of "Image". Select "Catalog" in the context menu that appears to select an image representing the action. 
...
Test the window and its menu options by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fen_WM_GAF.jpg) in the quick access buttons. In the simulator, the PDF file of the product catalog is generated and opened in the PDF reader installed in the current computer.  Since the menu is also displayed as a sliding window in our example, the product catalog print option can also be added in the IW_MLZ_Options window.
