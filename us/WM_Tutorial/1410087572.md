...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=dur%E9e.png) 1h
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Nv_WM_GAF.jpg) in the quick access buttons (or press Ctrl + N). 
...
9. Select the style of the Looper control: "Image + Title + Text below". This template provides an interface containing the product image, name and description.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0005.jpg&type=thumb)


10. Go to the next step.

11. The wizard automatically shows the data file items that correspond to the different controls of the generated looper.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0006.jpg&type=thumb)
...
14. The wizard shows multiple options for generating the Looper window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0008.jpg&type=thumb)
...
16. Define a title and a name for the window. Enter "List of products" for the window title. The window name is automatically filled in.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Liste_produit_RAD%20-%20HC%20N%B0009.jpg&type=thumb)
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fen_WM_GAF.jpg) in the quick access buttons (or press F9).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Liste_produit_RAD_Go%20-%20HC%20N%B0001.jpg&type=thumb)
...
2. The save window appears. Enter "Product form" for the window title. The name is automatically filled in ("WIN_Product_form"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20produit%20Enregistrement%20-%20HC%20N%B0001.jpg)
Confirm. 

3. The window is added to the project, for all configurations. 

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20produit%20Enregistrement%20-%20HC%20N%B0002.jpg)
...
1. In the "Project explorer" pane, expand "Analysis" by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_Application%20compl%E8te%20-%202%20-%20Fiche%20produit%20-%20HC%20N%B0001%201.jpg) icon. The data files defined in the project analysis are displayed.

2. Click the icon to the left of the "Product" data file to view all its items.

3. Select the items of the "Product" data file displayed in the pane (except for the "ProductID" item).

4. Drag the items and drop them onto the window (for example, on the upper-left area).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20produit%202%20-%20HC%20N%B0002.jpg&type=thumb)
...
2. Go to the alignment options ("Alignment" tab of the WINDEV Mobile ribbon). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20produit%202%20-%20HC%20N%B0001.jpg)
...
You will get the following result. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20produit%20-%20HC%20N%B0001.jpg&type=thumb)
...
1. Test the window (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fen_WM_GAF.jpg) in the quick access buttons). 
...
1. Open the WLanguage events of the WIN_Product_form window:
	...
	- In the context menu that appears, select "Element code". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20produit%20-%20HC%20N%B0002.jpg)
...
2. Enter the following WLanguage code in the "End of initialization of WIN_Product_form" event:
	...
	[&lt;Data file&gt;.ToWindow](../WDLang4/1000021397.md) gets the data from the current record in the data file and displays it in the window controls. In our case, the current record is the record selected in the Looper control of "WIN_List_of_products". This Looper control is linked to the Product data file. 
...
1. Click "WIN_List_of_products" in the open document tabs (under the WINDEV Mobile ribbon): <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20produit%20-%20HC%20N%B0001%201.jpg)
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fen_WM_GAF.jpg) in the quick access buttons.
...
3. Open the Action Bar description window (select "Description" in the context menu). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0002.jpg&type=thumb)
...
7. The WLanguage code of this option will be used to save the changes in the "WIN_Product_form" window. To write this code:
	...
	- A drop-down menu with the "Done" option appears. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Cr%E9ation%20modif%20produit%20-%20HC%20N%B0006.jpg)
...
8. Save changes by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WM_GAF.jpg) in the quick access buttons.
...
3. Right-click the Action Bar to open the context menu and select "Description". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Nv_Produit%20-%20HC%20N%B0001.jpg&type=thumb)
...
5. Click "+" (below the "Top right" area) to add an option. A new option is created at the top right. Change the option characteristics: 
	...
	- In the "Preset image" area, expand the list and select "Add". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Nv_Produit%20-%20HC%20N%B0003.jpg&type=thumb)
...
6. The WLanguage code of this option will open the "Product form" window and reset its controls. To enter this WLanguage code:
	...
	- A drop-down menu with the "New product" option is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Nv_Produit%20-%20HC%20N%B0005.jpg)
...
- Write the following WLanguage code in the "Select a menu" event:
		...
		```
			...
			[&lt;Data file&gt;.Reset](../WDLang4/1000025052.md) resets the item variables in the "Product" data file to the default values to handle the new record.

7. Save changes by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WM_GAF.jpg) in the quick access buttons.
...
2. Open the code of the validation option in the Action Bar:
	...
	- The WLanguage code of the "Click" event does not change:
		...
		- By default, [&lt;Data file&gt;.Save](../WDLang4/1000024606.md) and [&lt;Data file&gt;.Modify](../WDLang4/1000025038.md) have the same effect. In both cases, the current record in the data file is modified. 
...
4. Add a Button control in the window:
	...
	- Go to the "Creation" tab, "Usual controls" group, and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Bouton_WM_GAF.jpg). A ghost image of the control appears under the mouse pointer.
...
3. On the "General" tab, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0001.jpg) to the right of "Image". Select "Catalog" in the context menu that appears. 
...
5. Enter "photo" in the search box at the top and confirm. Several images are displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0002.jpg&type=thumb)


6. Double-click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0002%201.jpg) image to select it.
...
3. The window that appears shows all the styles that can be used for the Button controls in the "Material 3" skin template. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20S%E9lection%20du%20style%20-%20HC%20N%B0001.jpg&type=thumb)


4. Click the search bar and enter "BTN_Blank". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20S%E9lection%20du%20style%20-%20HC%20N%B0002.jpg)
...
3. Select "Horizontally centered" (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0002%203.jpg)). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0004.jpg&type=thumb)
...
All anchors have been defined in the window. The red arrows indicate the orientation of the anchors: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0001.jpg&type=thumb)
...
Test the "WIN_Map_of_stores" window in the simulator (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Fen_WM_GAF.jpg) in the quick access buttons). 
...
3. In the description window:
	...
	- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Appareil%20photo%20-%20HC%20N%B0001.jpg). Select "Catalog" in the context menu that appears to select an image representing the action.
...
4. Confirm changes in the description window.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Menu%20ZML%20-%20HC%20N%B0003.jpg)
