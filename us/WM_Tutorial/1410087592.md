...
1. On the "Code" tab, in the "Procedures" group, expand "New" and select "New global procedure". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_WM_WLangage%20-%20HC%20N%B0003.jpg)


2. In the window that appears, a default name is displayed for the set of global procedures. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_WM_WLangage%20-%20HC%20N%B0004.jpg)
Keep this name and click "OK" to confirm. 

3. A new window is displayed, allowing you to enter the name of the procedure and its characteristics: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_WM_WLangage%20-%20HC%20N%B0005.jpg)
...
7. Let's test this code. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_simu_PRJ_WM_GAF.jpg) in the quick access buttons. 
...
4. Let's test this code. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_simu_PRJ_WM_GAF.jpg) in the quick access buttons. 
