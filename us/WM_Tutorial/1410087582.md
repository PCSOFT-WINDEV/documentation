...
3. Specify the address into which the web service WSDL description must be imported: 
	...
	Reminder: This web service sends a request to a database to check the availability of a product using its reference. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Consommation%20WS%20-%20HC%20N%B0001.jpg&type=thumb)


4. Go to the next step. The web service is imported. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Consommation%20WS%20-%20HC%20N%B0002.jpg&type=thumb)
...
8. Close the code editor and save the window (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WM_GAF.jpg) or Ctrl + S).
