...
4. Right-click the control to open the context menu, select "Anchor" and set the anchors to "Width and height" (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Ancrage%20fiche%20-%20HC%20N%B0002%202.jpg)).
...
3. On the "General" tab, select the internal window that was just created ("IW_Product").<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20avec%20balayage%20-%20HC%20N%B0001.jpg&type=thumb)
...
5. On the "Content" tab, we will set how the internal window will be populated. This window will display the data of the Product data file:

	- Click "Data file/Query".

	- In the source, for the "Browsed file" option, select the "Product" data file. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P4_MP%20-%20Fiche%20avec%20balayage%20-%20HC%20N%B0003.jpg&type=thumb)
