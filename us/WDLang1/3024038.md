...
- an option to define the string format at runtime in the project configuration description.
	...
	2. In the window that appears, select the "Unicode" tab and choose the desired mode: "Use ANSI strings at runtime" or "Use UNICODE strings at runtime". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Gestion_Unicode%20-%20HC%20N%B0001.gif)
