...
**Note**: These functions are also available in prefix syntax ([Functions for managing TreeView Table controls (prefix syntax)](../WDLang1/1000021941.md)).
...
| [TableGiveChild](../WDLang1/1000010009.md) | Returns the "children" of an element (next level down) in a TreeView Table control. |
| [TableGiveParent](../WDLang1/1000010011.md) | Returns the "parent" of an element (next level up) in a TreeView Table control. |
...
| [TableItemStatus](../WDLang1/1000010012.md) | Returns the state of a node in a TreeView Table control: rolled up, unrolled or non-existent. |
