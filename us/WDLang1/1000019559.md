...
<a name="retrieving_definition_ELTPARAGRAPHE000059"></a>
...
If the element has not been created, **GetTypeDefinition** returns a Null definition with a non-fatal error ("The element has not been created").
