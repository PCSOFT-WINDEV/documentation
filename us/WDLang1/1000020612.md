...
| Importance | Integer | Importance of the event. <br><br>If this property is equal to or greater than 1, an icon (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=agRendezVous_IconeImportant.gif)<br>) will be displayed in the TimeLine control to indicate an important event. <br><br>If this property is not specified, its value is set to 0. |
