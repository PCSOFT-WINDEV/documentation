...
| Importance | Integer | Importance of appointment. <br><br>If this property is greater than or equal to 1, an icon (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=agRendezVous_IconeImportant.gif)<br>) will be displayed in the Organizer or Scheduler control to indicate an important event. <br><br>If this property is not specified, its value is set to 0.<br><br> |
