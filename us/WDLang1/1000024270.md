...
- value between 0 and 100. For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=DocPositionne_Hauteur2.gif)
...
- value between 0 and 100. For example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=DocPositionne_Largeur2.gif)
...
- value between 0 and 100.: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=DocPositionne_Largeur2.gif)
