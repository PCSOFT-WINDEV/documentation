...
Height of an image found in the image set.

**`<Border>: (Optional character)`**

"C" if no border must be displayed around each drawing. By default, a 1-pixel border is displayed around each drawing found in the image set.
