...
By default, the search is case sensitive: the searched string must have the same case as the string to be found in the string. To be case-insensitive, use the constant *CaseFree*.
<a name="NOTE0_2"></a>
