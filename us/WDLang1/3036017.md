...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003036017&name=fcreate_function">See additional examples</a>
...
Note: If the external file already exists (same directory and same name), this file is deleted and recreated. To avoid deleting an existing file, use [fOpen](../WDLang1/3036036.md) associated with the *foCreateIfNotFound* constant.
...
`<Result> = fCreate(<DiskFile> , <File path> [, <Creation options>])`
---
...
### Handling errors
<a name="handling_errors_ELTPARAGRAPHE000316"></a>
...
<a name="operating_mode_windows_vista_and_later_ELTPARAGRAPHE000551"></a>
