...
The **diagPath** type is used to define all the advanced characteristics of a Path shape (equivalent to a polygon that can include rounded lines). The characteristics of this shape can be defined and changed using different WLanguage properties.
...
Remark: The **diagPath** type inherits from the [diagShape](../WDLang1/1410088082.md) type. This means all the properties of the [diagShape](../WDLang1/1410088082.md) type are available for the **diagPath** type. These properties appear in italics in the list below.
