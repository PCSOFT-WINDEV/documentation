...
The **diagPath** type is used to define all the advanced characteristics of a Path shape (equivalent to a polygon that can include rounded lines). You can define and change the characteristics of this shape using different WLanguage properties.
...
### Properties specific to **diagPath** variables
<a name="properties_specific_docparampagetitleshort_variables_ELTPARAGRAPHE000021"></a>

Note: The type **diagPath** type inherits from the [diagShape](../WDLang1/1410088082.md) type, all the properties of the [diagShape](../WDLang1/1410088082.md) type are available for the **diagPath**. These properties appear in italics in the list below.

The following properties can be used to handle a shape of type Path:
