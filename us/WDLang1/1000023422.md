...
### Branch of the leaf
<a name="branch_the_leaf_ELTPARAGRAPHE000299"></a>
...
<a name="priority_order_for_the_sort_ELTPARAGRAPHE000315"></a>
...
### Duplicates
<a name="duplicates_ELTPARAGRAPHE000331"></a>
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TVDoub.gif)
If an element that already exists is added into a level, **&lt;TreeView&gt;.Add** returns <u><u><u><u>False</u></u></u></u> if the mode to define the element was not defined with the *tvAcceptDuplicate* constant. The element is not added.
<a name="NOTE0_4"></a>


### Format of collapsed/expanded images
<a name="format_collapsedexpanded_images_ELTPARAGRAPHE000360"></a>
...
<a name="type_collapsedexpanded_images_ELTPARAGRAPHE000406"></a>
...
<a name="tip_branch_images_ELTPARAGRAPHE000432"></a>

Caution: If the image name does not change between two calls to **&lt;TreeView&gt;.Add**, the image is not reloaded in memory (even if its content changed).

**Example**: The following code creates an image with the same name and with a different content, and it is using this image for each call to **&lt;TreeView&gt;.Add**: in this case, the same image will always be used.
