...
For example: If there are two "Level 2s", which one should you add "Level 3" to? Impossible to find which "Level 2" to manipulate. By default, the add operation will be performed in the first element found.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TVDoub.gif)
