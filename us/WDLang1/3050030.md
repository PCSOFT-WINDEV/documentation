...
**Remark**: **StatVarianceP** assumes that the arguments represent the entire population. To calculate the variance for a sample of population, use [StatVariance](../WDLang1/3050033.md). With large-size samples, **StatVarianceP** and [StatVariance](../WDLang1/3050033.md) approximatively return the same value.
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003050030&name=statvariancep_function&product=WD">See additional examples</a>
...
<a name="number_elements_found_matrix_row_matrix_column_ELTPARAGRAPHE000103"></a>
...
### Managing errors
<a name="managing_errors_ELTPARAGRAPHE000122"></a>
