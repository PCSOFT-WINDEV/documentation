...
Adds a system tray icon (in the lower-right corner of the screen).![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=SysIconeAjoute%20-%20HC%20N%B0001.gif)
