...
**Note**: The first valid image (not PNG) of the icon file is used and adapted to the 16x16 format. If the icon file contains in first position an image in 16x16 / 32 bpp, the quality of the icon will be very high. If the icon file contains in first position an image in 48x48 / 32 bpp, the quality of the icon will be very poor.
...
**Note**: This parameter can correspond to a variable of type [Procedure](../Motscles/1000018907.md).
