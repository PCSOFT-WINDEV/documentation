...
|   |   |
| --- | --- |
| *fLinkPhysical* | Create a physical link. <br>A physical link is a file that can be accessed via several paths. The file deletion can be performed only when all physical links have been deleted.<br>**Warning**: The &lt;Pointed File&gt; and the &lt;Link Destination&gt; must be on the same disk. |
| *fLinkSymbolic* | Create a symbolic link. <br>A symbolic link is a "pointer" to a file. The deletion of the symbolic link does not affect the pointed file. The deletion of the pointed file makes the symbolic link invalid.<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Only the owner of the file can create a symbolic link.<br><br>![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) To create a symbolic link, Windows Vista or later must be used. <br><br>![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) In Windows 10, to create a symbolic link, the user must have administrator privileges on the computer. |
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) This parameter is not available.
...
- ![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) For **fCreateLink** to have an effect, you must run the PHP site in IIS with elevated rights

- ![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) If the system used corresponds to Windows Vista or later, you must use a PHP server later than version 5.3.
...
[CreateShortcut (Function)](../WDLang1/3014008.md)
