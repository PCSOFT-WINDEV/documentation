...
| *WholeWord* | Searches for a whole word, i.e., enclosed in punctuation characters or spaces.<br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) This option has no effect. |

![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) This parameter is not available. The search is performed from the first to the last character of the string. The search is case sensitive. The search string doesn't have to be a complete word: it can be part of a word.
...
<a name="finding_character_string_ELTPARAGRAPHE000172"></a>

By default, the search is case sensitive: the searched string must have the same case as the string to be found in the string. To perform a case-sensitive search, use the parameter *CaseSensitive*.
...
### Unicode/Ansi
<a name="unicodeansi_ELTPARAGRAPHE000192"></a>
...
<a name="characters_taken_into_account_for_punctuation_and_spaces_ELTPARAGRAPHE000356"></a>The characters taken into account for punctuation and spaces are provided by the system. To get the list of these characters, write the following WLanguage code:
