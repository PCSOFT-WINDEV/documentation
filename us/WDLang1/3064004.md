...
|   |   |
| --- | --- |
| *piAnalysis* | Physical name without extension of the .WDD file used by the project or by the component. A short name is returned.<br>Projects with multiple analyses: Only the name of the main analysis is returned.<br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This constant is ignored in this version. |
...
[Project with multiple analyses](../WDLang1/1410087296.md)
