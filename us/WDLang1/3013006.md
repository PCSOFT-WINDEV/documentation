...
- **Normal application operation**: the application can be used normally.

- **Prohibit any new connection to the application** Each time the application is launched again, a message appears. The application cannot be started.

- **Warning of impending application shutdown** This message appears to all connected users at regular intervals.

- **Stop application immediately**: a message appears and the application is closed.
...
[WDADMINEXE: Remote application control](../WDLang1/2028026.md)
