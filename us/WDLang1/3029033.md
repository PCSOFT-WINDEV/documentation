...
**Note**: These functions are also available in prefix syntax ([Image drawing and processing functions (prefix syntax)](../WDLang1/1000024243.md)).
...
| [BitmapInfo](../WDLang1/3029015.md) | Retrieves the characteristics of an image file or the characteristics of a PDF file: <br><br>- format.<br><br>- width and height.<br><br>- number of bits per pixel.<br><br>- area of transparency.<br><br>- alpha channel.<br><br><br> |
