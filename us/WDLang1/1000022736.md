...
The nesting of variables starting from a variable of type [docFragment](../WDLang1/1000022482.md) is as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TT_prog_Fragment.gif)
