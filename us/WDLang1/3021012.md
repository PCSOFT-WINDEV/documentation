...
- **directive questions**.
	 Directive questioning consists in guiding the user in entering his answer, to avoid any ambiguity: the user answers a question using buttons containing the text of the action to be taken. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=fonctions_dialogue%20-%20HC%20N%B0009.gif)
