...
**Caution**: Widgets added programmatically are not automatically displayed. You must use [&lt;Dashboard&gt;.InitialConfiguration](../WDLang1/1000022525.md) before the Dashboard control is displayed for the first time.
