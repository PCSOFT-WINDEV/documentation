...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=STATcORReLATION1.gif) StatCorrelation("MyMatrix", 1, 3, False) returns 0,997054.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=STATcORReLATION2.gif) StatCorrelation("MyMatrix", 1, 3, False) returns 1.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Statcorrelation3.gif) StatCorrelation("MyMatrix", 1, 3, False) returns 0.
<a name="NOTE0_2"></a>
