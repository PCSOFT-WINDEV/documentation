...
- In test mode, you can specify the command line in the editor (on the "Project" tab, in the "Test mode" group, expand "Test mode" and select "Test mode settings").
...
[PageParameter (Function)](../WDLang1/3058026.md)
