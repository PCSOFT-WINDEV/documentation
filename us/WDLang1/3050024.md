...
**Note** The mean deviation gives the dispersion within a set of values.
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003050024&name=stataveragedeviation_function">See additional examples</a>
...
<a name="number_elements_found_matrix_row_matrix_column_ELTPARAGRAPHE000079"></a>
...
### Error management
<a name="error_management_ELTPARAGRAPHE000098"></a>
