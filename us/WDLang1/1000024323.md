...
| [&lt;Array&gt;.Add](../WDLang1/1000024299.md) | Adds an element in last position:<br><br>- of a one-dimensional WLanguage array.<br><br>- of an array property of an advanced variable type (array of events of a gglCalendar variable, etc.).<br><br>- from a WLanguage list.<br><br><br> |
...
| [&lt;Array&gt;.DeleteAll](../WDLang1/1000024317.md) | Deletes all elements:<br><br>- from a one-dimensional or two-dimensional WLanguage array.<br><br>- from an associative array.<br><br>- from an array property of an advanced variable type (array of events of a gglCalendar variable, etc.).<br><br>- from a WLanguage queue.<br><br>- from a WLanguage stack.  <br><br>- from a WLanguage list.<br><br><br> |
...
| [&lt;Array&gt;.Info](../WDLang1/1000024308.md) | Returns the details of an array: type of elements, number of dimensions, etc. |
