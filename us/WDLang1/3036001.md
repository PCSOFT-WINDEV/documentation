...
**Note** This directory does not necessarily correspond to the actual directory of the data files being executed (which may have been modified by functions [HSubstDir](../WDLang4/3044028.md), [HChangeDir](../WDLang4/3044168.md), etc.). 
