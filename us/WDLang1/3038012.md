...
| [WinInWidth](../WDLang1/3038031.md) | Returns the interior width of a window (without borders). |
| [WinInXPos](../WDLang1/3038017.md) | Returns the horizontal position of the upper-left corner of the client area of a window (without border and title bar), in relation to the upper-left corner of the screen. |
| [WinInYPos](../WDLang1/3038011.md) | Returns the vertical position of the upper-left corner of the client area of a window (without border and title bar), in relation to the upper-left corner of the screen. |
...
| [WinOutWidth](../WDLang1/3038029.md) | Returns the outer width of a window. |
