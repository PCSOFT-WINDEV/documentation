...
|   |   |
| --- | --- |
| *maskDateEmail* | The format used corresponds to the date time format of the RFC-5322 standard used to encrypt emails, RSS feeds, etc, ...<br>The result is expressed in the local time zone. <br><br>![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Not available. |
| *maskDateEmailUTC* | The format used corresponds to the date time format of the RFC-5322 standard used to encrypt emails, RSS feeds, etc, ...<br>The result is expressed in universal time (UTC). <br><br>![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Not available. |
...
[StringToTime (Function)](../WDLang1/1000021339.md)
