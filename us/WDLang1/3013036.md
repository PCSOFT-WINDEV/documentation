...
| [Compile](../WDLang1/3013015.md) | Dynamically compile a Procedure whose source code is supplied (dynamic compilation). |
...
| [Execute](../WDLang1/3013041.md) | Starts the execution of a process programmatically. |
...
| [InApplicationTestMode](../WDLang1/1410090514.md) | Determines if there is an application test in progress. |
| [InAutomaticTestMode](../WDLang1/3014027.md) | Allows you to find out whether an automated test is currently run or not. |
...
| [InUnitTestMode](../WDLang1/1410090513.md) | Determines if there is a unit test in progress. |
...
| [InWebserviceMode](../WDLang1/1000019405.md) | Determines if the code is being executed in the AWWS engine. |
...
| [OpenDocument](../WDLang1/1000023709.md) | Opens a document in a new modeless window using the appropriate WINDEV editor. <br><br> |
| [OpenDocumentAsynchronous](../WDLang1/1410088182.md) | Opens a document in a new modeless window using the appropriate WINDEV editor.<br>The result can be retrieved via a WLanguage procedure ("callback") when the document editing window is closed.<br><br> |
...
| [TypeIsNullable](../WDLang1/1410090370.md) | Determines whether an element is nullable. |
...
| [WHelp](../WDLang1/3013053.md) | Displays a file or help page in CHM format. |
