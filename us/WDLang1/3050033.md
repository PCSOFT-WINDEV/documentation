...
**Note** This calculation is based on a sample of values. To calculate the variance for a full series of values, use [StatVarianceP](../WDLang1/3050030.md).
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003050033&name=statvariance_function">See additional examples</a>
...
<a name="number_elements_found_matrix_row_matrix_column_ELTPARAGRAPHE000081"></a>
...
[StatVarianceP (Function)](../WDLang1/3050030.md)
