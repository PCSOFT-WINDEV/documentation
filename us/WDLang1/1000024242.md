...
### Font
<a name="font_ELTPARAGRAPHE000443"></a>
...
To modify these parameters, use [&lt;Image&gt;.Font](../WDLang1/1000024007.md).
...
### Coordinates
<a name="coordinates_ELTPARAGRAPHE000483"></a>
...
### Management of '&'
<a name="management_ELTPARAGRAPHE000511"></a>The parameter &lt;Management of & &gt; makes it possible to manage the use of the '&' character. 
Example: 
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000615"></a>

In anti-aliasing mode ([&lt;Image&gt;.ChangeMode](../WDLang1/1000023997.md)) or in opacity mode ([&lt;Image&gt;.StartDrawing](../WDLang1/1000024326.md)), **&lt;Image variable&gt;.DrawText** is available for the TrueType fonts only.
