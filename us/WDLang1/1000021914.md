...
|   |   |
| --- | --- |
| *sysAllUsers*<br>(Default value) | The association will be deleted for all the users of the current computer. <br><br>Note: This operation requires Administrator privileges. |
