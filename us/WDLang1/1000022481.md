...
- the password input is performed in a specific window. This window: 
	...
	- uses the theme of skin template defined for the application if the option "Apply theme of skin template to the components included in the project and to AAF windows" is checked ("Style" tab in the project description window). 
