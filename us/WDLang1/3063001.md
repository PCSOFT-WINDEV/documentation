...
|   |   |
| --- | --- |
| [TableToClipboard](../WDLang1/1000017062.md) | Copies the content of a Table or TreeView Table control (based on a data file or populated programmatically) to the clipboard. The content of the field is copied in text format: the content is converted into a character string and copied to the clipboard. |
