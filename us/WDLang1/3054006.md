...
<a name="executable_creation_languages_taken_into_account_ELTTEXTE000140"></a>
...
**Note**: Project configurations can also be used to manage project languages. You can for example create a specific configuration to generate a FR + US library for a project containing 5 languages, among which 3 are not translated. For more details, see [Project configuration](../Editeurs/9000030.md).
