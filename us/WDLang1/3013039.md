...
Text to write for the keyword and the specified section. The keyword will be deleted if this parameter is an empty string ("") or if it corresponds to NULL.
