...
Hashing is used to summarize a file or a character string. This summary is called Hash. A single "hash" can be associated with a plain text: any change to the original text results in a change to the corresponding hash.
