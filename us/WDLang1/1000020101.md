...
`<Result> = ArraySeekByProcedure(<WLanguage array> , <WLanguage procedure> , <Type of search> [, <Start index> [, <Search value 1> [... [, <Search value N>]]]])`
---
...
| *asLinear* | Linear search. The search starts:<br><br>- from the first element if &lt;Start index&gt; is set to 0,<br><br>- from &lt;Start index&gt;.<br><br><br>The search stops at the first element found. |
