...
**TablePosition** does not work with Table controls based on a data file in "manual" mode that use a bouncing scrollbar ("Proportional scrollbar" not checked in the "Details" tab of the control description).
