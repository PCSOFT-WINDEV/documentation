...
### How do I specify the keystrokes or the mouse actions to perform? 
...
To use one of these characters, the character must be enclosed in braces. For example, to use the plus sign (+), type {+}. To use braces, use the {{} and {}} characters.
