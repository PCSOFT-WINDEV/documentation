...
The **Image** type is used to define the advanced characteristics of an image. You can define and change the characteristics of this image using different WLanguage properties. 
...
<a name="properties_specific_image_variables_ELTPARAGRAPHE000039"></a>
...
| Height | Integer | Image height in pixels. <br><br>If this property is modified, the image is not distorted, but additional pixels are added. The color of these pixels is defined with the **FillColor** property. |
| Image | All types | Used to load an image from a buffer, a file or a memo. This property is equivalent to the [dLoadImage](../WDLang1/1000019656.md) function. <br><br>Remarks: <br><br>- In read mode, this property returns a buffer containing the image in PNG format. <br><br>- The images in SVG or PDF format are not supported. To manage these formats, you must use [dLoadImage](../WDLang1/1000019656.md). <br><br>- The animated images are not supported. <br><br>- A single page of multi-page images (TIF, ICO) can be loaded. Only the first page is loaded. <br><br>- You have the ability to draw a chart in an Image variable via [grDestinationImage](../WDLang3/1000020952.md).<br><br><br>![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![IOS Widget](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) The ICO format is not supported by iOS. |
| Pixel[x,y] | Array of [Color](../WDLang1/1000019661.md) | Used to handle the pixels of the image. |
| Valid | Boolean | Returns the validity of the image:  <br><br>- <u><u><u>True</u></u></u> if the image is valid. This means it was correctly loaded or created.<br><br>- <u><u><u>False</u></u></u> otherwise. <br><br><br>**This property is read-only**. |
| Width | Integer | Image width in pixels. <br><br>If this property is modified, the image is not distorted, but additional pixels are added. The color of these pixels is defined with the **FillColor** property. |
| WithAlpha | Boolean | Determines whether the image contains an alpha channel:<br><br>- <u><u><u>True</u></u></u> if the image contains an alpha channel, <br><br>- <u><u><u>False</u></u></u> otherwise. <br><br><br>**This property is read-only**. |
...
<a name="accessing_the_pixels_ELTPARAGRAPHE000231"></a>To access the pixels of the image, you have the ability to use the following syntax:
...
<a name="managing_the_alpha_channel_ELTPARAGRAPHE000252"></a>
...
<a name="image_variable_and_image_control_ELTPARAGRAPHE000264"></a>
...
<a name="image_variable_and_debugger_ELTPARAGRAPHE000276"></a>
...
<a name="creating_image_with_specific_size_ELTPARAGRAPHE000283"></a>
...
### Available EXIF tags
<a name="available_exif_tags_ELTPARAGRAPHE000306"></a>The table below lists the Exif tag values and the corresponding constants: 
...
<a name="functions_that_use_image_variables_ELTPARAGRAPHE000314"></a>
...
| [dCopyControlImage](../WDLang1/1410089473.md) | Copies the image of a control in a WINDEV window to a variable of type [Image](../WDLang1/1000019650.md). |
...
| [dCopyScreenImage](../WDLang1/1000019911.md) | Copies the screen contents to an [Image](../WDLang1/1000019650.md) variable or to an Image control. |
...
| [dCrop](../WDLang1/1000019670.md) | Returns the cropped part of an image. This image is in an [Image](../WDLang1/1000019650.md) variable. |
...
| [dInvertColor](../WDLang1/3029001.md) | Reverses the colors: <br><br>- in an Image control, <br><br>- in an [Image](../WDLang1/1000019650.md) variable, <br><br>- in a [WDPic](../WDLang1/1000023503.md) variable (on the background layer),<br><br>- in a [picLayer](../WDLang1/1000024604.md) variable. <br><br><br> |
...
| [dModifyHue](../WDLang1/3029054.md) | Modifies the hue of an image found: <br><br>- in an Image control, <br><br>- in an [Image](../WDLang1/1000019650.md) variable.<br><br><br> |
...
| [dPen](../WDLang1/3029029.md) | Declares the default color and style for lines, rectangles, circles, etc. contained in: <br><br>- in an Image control, <br><br>- in an [Image](../WDLang1/1000019650.md) variable, <br><br>- in a [WDPic](../WDLang1/1000023503.md) variable (on the background layer),<br><br>- in a [picLayer](../WDLang1/1000024604.md) variable. <br><br><br> |
...
| [dResize](../WDLang1/3029011.md) | Resizes an image found: <br><br>- in an Image control.<br><br>- in an [Image](../WDLang1/1000019650.md) variable.<br><br>- in a [picLayer](../WDLang1/1000024604.md) variable.<br><br><br> |
...
<a name="functions_prefix_syntax_that_handle_image_variables_ELTPARAGRAPHE000321"></a>
...
|   |   |
| --- | --- |
| [&lt;Image variable&gt;.Background](../WDLang1/1000024056.md) | Declares the default background color for rectangles, circles, ... used in a variable of type [Image](../WDLang1/1000019650.md). |
...
| [&lt;Image variable&gt;.Crop](../WDLang1/1000024350.md) | Returns the cropped part of an image. This image is in an [Image](../WDLang1/1000019650.md) variable. |
...
| [&lt;Image variable&gt;.Font](../WDLang1/1000024232.md) | Declares the font to be used by the [dText](../WDLang1/3029032.md) function in a [Image](../WDLang1/1000019650.md) type variable. |
...
| [&lt;Image variable&gt;.Pen](../WDLang1/1000024240.md) | Declares the default color and style for lines, rectangles, circles, etc. contained in a variable of type [Image](../WDLang1/1000019650.md). |
...
[dLoadImage (Function)](../WDLang1/1000019656.md)

[dTransferToImage (Function)](../WDLang1/1000020210.md)
