...
**Note**: These functions are also available in prefix syntax ([Functions for managing TimeLine controls (prefix syntax)](../WDLang1/1000020783.md)).The following functions are used to manage TimeLine controls:
...
| [TimelineListEvent](../WDLang1/1000020401.md) | Returns: <br><br>- the list of events found between two given times in a TimeLine control, <br><br>- all events of a TimeLine control,<br><br>- a specific event (selected or hovered over). <br><br><br> |
