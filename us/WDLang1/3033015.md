...
|   | **Conversion rate<br>(1EURO = ... x UMN)** | **Smallest unit of national currency** | **Conversion: <br>NCU - EURO - UNC<br>expressed in NCU** | **Conversion: <br>EURO - NCU - EURO<br>expressed in EURO** |
