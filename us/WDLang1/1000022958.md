...
Language and sub-language for which the dictionary is to be used (example: "fr-fr"). 
...
- The [CheckSpell](../Proprietes/2510153.md) property is used to enable or disable the spelling checker in a Word Processing control. 
