...
**&lt;Image&gt;.DrawChord** can only be used to draw a chord: outline only or chord area. To draw a solid figure (portion defined by the center of the circle and the two points on the circle), use [&lt;Image&gt;.DrawSlice](../WDLang1/1000024011.md).
<a name="NOTE0_4"></a>
<a name="NOTE0_5"></a>
<a name="NOTE0_6"></a>
