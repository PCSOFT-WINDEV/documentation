...
The **sysNotificationInput** type is used to define all the advanced features of an input control, such as a text input or combo box control, in an interactive notification. You can define and change the characteristics of this control using different WLanguage properties. 
...
<a name="properties_specific_sysnotificationinput_variables_ELTPARAGRAPHE000030"></a>
...
| Type | Integer constant | Type of control for user interaction:<br><br>- *sysNotifInputCombo*: Combo Box control.<br><br>- *sysNotifInputText*: Edit control.<br><br><br> |
