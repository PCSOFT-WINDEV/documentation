...
The **diagSelection** type is used to define all the advanced characteristics of a selection made in a diagram. You can define and change the characteristics of this selection using different WLanguage properties.
