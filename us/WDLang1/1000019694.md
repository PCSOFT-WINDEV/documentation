...
| *vipCamera* | Subscript of the camera to use.<br><br>Caution: the change of camera reinitializes the parameters previously defined by **VideoParameter**. |
