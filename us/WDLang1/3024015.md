...
**Note**: These functions are also available in prefix syntax ([String functions (prefix syntax)](../WDLang1/1410089916.md)).
...
| [NoSpace](../WDLang1/3024034.md) | Returns a character string without the space characters: <br><br>- from the left and right side of the initial string.<br><br>- within the string.<br><br><br> |
...
| [StringEndsWith](../WDLang1/1000018828.md) | Checks whether a character string ends with: <br><br>- a specific string.<br><br>- one of the strings in an array.<br><br><br> |
...
| [StringStartsWith](../WDLang1/1000018827.md) | Checks whether a character string starts: <br><br>- a specific string. <br><br>- one of the strings in an array.<br><br><br> |
...
| [TextToHTML](../WDLang1/3025050.md) | Converts a text string into an HTML string (carriage returns are replaced by &lt;BR&gt;accents are replaced by their HTML equivalent, ...). |
...
| [URLExtractPath](../WDLang1/1000020965.md) | Returns the various elements of a URL: protocol, user, password, domain, port, resource path, resource name, resource extension, request and fragment. |
| [UTF8ToAnsi](../WDLang1/1000020525.md) | Converts a UTF-8 string to ANSI. |
| [UTF8ToString](../WDLang1/3024043.md) | Converts a string in UTF8 format into an ANSI or Unicode string. |
...
| [Deserialize](../WDLang1/3013066.md) | Deserializes a buffer or string containing the data of a class, structure or array and their subelements. |
