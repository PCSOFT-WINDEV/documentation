...
***In french: &lt;Variable picCalque&gt;.DessineTexteRTF***
...
Draws RTF text in a variable of type [picLayer](../WDLang1/1000024604.md).
<a name="Exemple1"></a>
...
`<picLayer image>.DrawTextRTF(<Rectangle> , <RTF text>)`
---
