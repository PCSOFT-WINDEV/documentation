...
**Note**: **SysWinShow** displays a window that has not been created in WINDEV. The handle number of this window is returned by [SysWinHandle](../WDLang1/3073007.md).
<a name="Exemple1"></a>
...
It is not recommended to use **SysWinShow** on WINDEV windows. Instead, it is advisable to use the following specific functions: [Restore](../WDLang1/3038042.md), [Maximize](../WDLang1/3038001.md), [WinStatus](../WDLang1/3038030.md), [Iconize](../WDLang1/3038015.md), etc.
