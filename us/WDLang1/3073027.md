...
**Note**: The behavior of the icon (context menu, procedure call) remains unchanged.
<a name="Exemple1"></a>
...
- A single icon can be added to an application. It is not possible to add more than one.
