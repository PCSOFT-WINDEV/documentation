...
Note: Use [&lt;Organizer&gt;.ChangeMode](../WDLang1/1000022879.md) to change the display mode of the Organizer control. 
...
|   |   |
| --- | --- |
| *orgzCustomNbDay* | Displays the Organizer control over a number of days specified by [&lt;Organizer&gt;.ChangeMode](../WDLang1/1000022879.md).<br><br>![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) This constant is not available. |
...
### Equivalences
<a name="equivalences_ELTPARAGRAPHE000250"></a>The following lines of code are equivalent: 
...
[OrganizerMode (Function)](../WDLang1/1000019545.md)
