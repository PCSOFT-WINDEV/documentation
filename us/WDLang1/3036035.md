...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003036035&name=fmovedir_function">See additional examples</a>
...
|   |   |
| --- | --- |
| *frConfirm* | The content of the directory is moved once the overwriting of the directory with the same name is confirmed.<br>![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) This constant is not available. |
| *frProgress* | A progress window is displayed.<br>![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) This constant is not available. |
