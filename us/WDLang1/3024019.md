...
<a name="docparampagetitleshort_and_unicode_ELTPARAGRAPHE000141"></a>
...
**Note** If the result of the **StringFormat** function used on an ANSI string is assigned to a Unicode string (and vice versa), ANSI/Unicode conversion will be implicitly performed.
...
[&lt;ANSI string&gt;.Format (Function)](../WDLang1/1000024877.md)
