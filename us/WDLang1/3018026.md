...
<a name="details_about_the_elements_returned_the_treezone_constant_ELTPARAGRAPHE000150"></a>The following illustration presents the different areas that can be retrieved by the *treeZone* constant.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Arbre_InfoXY.gif)
