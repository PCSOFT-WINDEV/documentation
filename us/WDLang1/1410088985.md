...
| --- | --- | --- |
| NewString | Character string | String containing the correction. <br><br>Note: The **NewString** property takes precedence over the **NewFormattedString** property (if it exists). |
| NewFormattedString | [Document](../WDLang1/1000022461.md) | New string, as a document that can contain formatting.<br><br>Note: The value of this property can also be a variable of type [docParagraph](../WDLang1/1000022483.md), [docElement](../WDLang1/1000022484.md), etc. |
