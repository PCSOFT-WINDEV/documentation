...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) The new characteristics or changes will be taken into account for the entire project (until next time **eInitCurrency** is called).

![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) The new characteristics or changes will be taken into account for the current page. To use the same characteristics in the rest of the site, **eInitCurrency** must be called again in the loading code ("OnLoad") of all the pages that use currency conversion functions.
<a name="Exemple1"></a>
...
### Exchange table
<a name="exchange_table_ELTPARAGRAPHE000056"></a>
...
**Please note** Currencies with an exchange rate of zero will not appear in the context menu of the "Monetary + Euro" field.
<a name="NOTE0_2"></a>
...
<a name="redefining_currencies_ELTPARAGRAPHE000356"></a>
...
Therefore, if currency #3 (corresponding to the Belgium Franc) is redefined through programming to correspond to the Peseta, the window/page editor will still display the Belgium Franc in third position for currencies. However, at runtime, the third currency will be the Peseta.
<a name="NOTE0_3"></a>
...
<a name="initializing_the_reference_currency_ELTPARAGRAPHE000366"></a>
...
### New currencies
<a name="new_currencies_ELTPARAGRAPHE000376"></a>
...
[eDefaultViewCurrency (Function)](../WDLang1/3033009.md)
