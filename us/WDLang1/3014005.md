...
**`<Result>: (4-byte integer in 32-bit, 8-byte integer in 64-bit)`**
...
- **** is protected against "General Protection Faults" in the function called. Nevertheless, a WLanguage error is triggered if this type of error occurs.
...
### Error handling
<a name="error_handling_ELTPARAGRAPHE000162"></a>
...
<a name="loading_and_unloading_the_dll_ELTPARAGRAPHE000173"></a>

**** automatically loads the DLL if necessary, then it unloads it (if it was loaded). This mechanism can be quite slow, except for the system DLLs (KERNEL, USER, GDI).
...
<a name="parameters_that_will_passed_the_function_dll_ELTPARAGRAPHE000189"></a>
...
<a name="passing_string_api_retrieving_string_from_api_ELTPARAGRAPHE000216"></a>
...
<a name="passing_structure_api_ELTPARAGRAPHE000251"></a>
...
<a name="passing_structure_containing_string_api_ELTPARAGRAPHE000261"></a>
...
<a name="procedure_called_callback_ELTPARAGRAPHE000282"></a>
