...
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) This parameter is not supported. The text generated is different each time the function is called.
...
[GenerateGeometricImage (Function)](../WDLang1/1410088705.md)
