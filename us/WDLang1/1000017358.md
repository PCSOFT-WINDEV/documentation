...
**Remark**: This function is equivalent to [ArrayMove](../WDLang1/3075011.md).
...
Subscript of the element to move.

**`<End subscript>: (Integer)`**

New index of the element that was moved.

**`<amMove>: (Optional constant)`**

*amMove*: Constant used to move an element in a WLanguage array.  
...
*amSwap*: Constant used to swap two elements in a WLanguage array.  
