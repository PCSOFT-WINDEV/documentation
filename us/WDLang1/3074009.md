...
| [TableDisplay](../WDLang1/3074003.md) | Refreshes a Table or TeeeView Table control from a given position:<br><br>- for a field linked to a file: changes made to the linked data file are reflected in the field..<br><br>- for a programmatically manipulated field: calculated columns are re-calculated.<br><br><br> |
...
| [TableSelectToFile](../WDLang1/3074038.md) | Positions on the data file record corresponding to a row selected in the multi-selection data-bound Table control. |
