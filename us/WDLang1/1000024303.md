...
***In french: &lt;Tableau&gt;.ChercheParProcédure***
...
|   |   |
| --- | --- |
| *asBinary* | Descending binary search. <br>This search mode is fast but it must be used on an array sorted in ascending order with the same comparison procedure or with an equivalent procedure (see [&lt;Array&gt;.Sort](../WDLang1/1000024318.md)). |
| *asBinaryCompliant* | Ascending binary search. <br>This search mode is fast but it must be used on an array sorted in ascending order with the same comparison procedure or with an equivalent procedure (see [&lt;Array&gt;.Sort](../WDLang1/1000024318.md)). |
...
<a name="wlanguage_comparison_procedure_ELTPARAGRAPHE000283"></a>This comparison procedure has the following format: 
