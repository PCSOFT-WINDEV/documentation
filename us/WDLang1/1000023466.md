...
**Note**: These functions are also available in prefix syntax ([PDF Reader control functions (prefix syntax)](../WDLang1/1000023877.md)).
...
Note: [iPrintPDF](../WDLang5/1000020519.md) can be used to print the content of a PDF Reader control. 

![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Starting with version 28, the [pdfDocument](../WDLang6/1000024909.md) type and the PDF Reader control functions are not supported by 32-bit ARM processors. The new PDF features in version 28 require a 64-bit execution mode. If an application is intended for devices with 32-bit processors, it must be generated with WINDEV Mobile 27. 


## Voir aussi

[PDF file functions](../WDLang1/1000015007.md)

[The PDF Reader control](../WDLang1/1410087036.md)

[iPrintPDF (Function)](../WDLang1/1000020519.md)
