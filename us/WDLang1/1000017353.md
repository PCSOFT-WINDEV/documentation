...
<a name="inserting_column_into_advanced_array_property_ELTPARAGRAPHE000062"></a>
...
- the rows are initialized with the values passed as parameter. If no value is passed as parameter, the rows are initialized with the default value of the type of the array elements.
