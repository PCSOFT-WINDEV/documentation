...
Load a file into a Spreadsheet control in a window. The supported formats are: 
...
Name and full path of the file to be loaded. The supported formats are: 
...
Warning: It is not possible to load an XLSX file containing more than 2 million cells.
...
[&lt;Spreadsheet&gt;.Close (Function)](../WDLang1/1000023722.md)
