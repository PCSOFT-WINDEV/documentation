...
- The caption associated with the tab pane can be modified with the [Caption](../Proprietes/2510053.md) property. For example: 
	...
	```wl
	ONG_Onglet[NomAlias].Libellé = "Customer xxxx *"
	```
...
- You have the ability to handle a control found in an internal window of a pane as soon as the pane is opened. 
	...
	x.FI_Internal.SAI_SansNom1.Width = 500
	```
...
[WithNewButton (Property)](../WDLang1/1000021377.md)

[WindowIfNew (Property)](../WDLang1/1000021381.md)

[CaptionIfNew (Property)](../WDLang1/1000021380.md)

[MaxButtonWidth (Property)](../WDLang1/1000022169.md)
