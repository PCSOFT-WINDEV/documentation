...
**Note**: These functions are also available in prefix syntax ([Kanban control functions (prefix syntax)](../WDLang1/1410089740.md)).

<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
The following functions are used to manipulate Kanban controls:
