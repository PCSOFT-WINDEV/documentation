...
**For a one-dimensional array**, the array elements are converted into character string and added into the string while being separated by carriage returns.

**For a two-dimensional array**, the array elements are converted into character string and added into the string. The rows are separated by carriage returns and the columns are separated by &lt;Column separator&gt;.
...
[CSVToArray (Function)](../WDLang1/1000017097.md)
