...
Allows you to find out whether the checkmark ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Marque.gif) is displayed in front of a menu option (context menu or drop-down menu).
