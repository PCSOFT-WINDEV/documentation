...
- DNS address of the computer (www.windev.com for example).
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) **Ping** cannot be used on an emulator that does not support the ICMP protocol.
