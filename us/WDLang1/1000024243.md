...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
Note: To see the requirements for drawing on different platforms, see [Drawing in WINDEV, WEBDEV and WINDEV Mobile](../WDLang1/3029035.md).  

The following are drawing functions in prefix syntax:
...
| [&lt;Image variable&gt;.Clear](../WDLang1/1410090484.md) | Clears the content of an Image variable and fills it with the specified color. |
...
| [&lt;Image variable&gt;.Font](../WDLang1/1000024232.md) | Declares the font to be used by the [&lt;Image&gt;.DrawText](../WDLang1/1000024017.md) function in a [Image](../WDLang1/1000019650.md) type variable. |
...
| [&lt;Image variable&gt;.ModifyContrast](../WDLang1/1410089004.md) | Changes the contrast of an image in an [Image](../WDLang1/1000019650.md) variable. |
...
| [&lt;Image&gt;.Background](../WDLang1/1000023999.md) | Declares the default background color for rectangles, circles, etc. used in an Image control. |
...
| [&lt;Image&gt;.Clear](../WDLang1/1410090483.md) | Clears the content of an Image control and fills it with the specified color. |
...
| [&lt;Image&gt;.Font](../WDLang1/1000024007.md) | Declares the font to be used by the [&lt;Image&gt;.DrawText](../WDLang1/1000024017.md) function in an Image control. |
...
| [&lt;Image&gt;.Pen](../WDLang1/1000024016.md) | Declares the default color and style for lines, rectangles, circles, etc. contained in an Image control. |
...
| [&lt;picLayer variable&gt;.Background](../WDLang1/1000024480.md) | Declares the default background color for rectangles, circles, ... used in a variable of type [picLayer](../WDLang1/1000024604.md). |
...
| [&lt;picLayer variable&gt;.Font](../WDLang1/1000024503.md) | Declares the font to be used by the [&lt;Image&gt;.DrawText](../WDLang1/1000024017.md) function in a [picLayer](../WDLang1/1000024604.md) type variable. |
...
| [&lt;picLayer variable&gt;.Pen](../WDLang1/1000024637.md) | Declares the default color and style for lines, rectangles, circles, etc. contained in a variable of type [picLayer](../WDLang1/1000024604.md). |
...
| [&lt;WDPic variable&gt;.Background](../WDLang1/1000024481.md) | Declares the default background color for rectangles, circles, ... used in a variable of type [WDPic](../WDLang1/1000023503.md). |
...
| [&lt;WDPic variable&gt;.Font](../WDLang1/1000024502.md) | Declares the font to be used by the [&lt;Image&gt;.DrawText](../WDLang1/1000024017.md) function in a [WDPic](../WDLang1/1000023503.md) type variable. |
...
| [&lt;WDPic variable&gt;.Pen](../WDLang1/1000024636.md) | Declares the default color and style for lines, rectangles, circles, etc. contained in a variable of type [WDPic](../WDLang1/1000023503.md). |
