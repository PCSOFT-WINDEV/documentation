...
CustomMask.FormatOnEntry = FormatOnEntry
...
INTERNAL PROCEDURE ValidateDuringInput(sText is string): boolean
	RETURN RegexMatch(sText, "[0-9 ]*")
END
INTERNAL PROCEDURE VerifyIfEntryValid(sText is a string): Boolean
...
<a name="properties_specific_inputmask_variables_ELTPARAGRAPHE000042"></a>
...
### Use
<a name="use_ELTPARAGRAPHE000182"></a>
...
[MaskFormat (Function)](../WDLang1/1000024738.md)
