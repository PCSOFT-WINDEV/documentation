...
**Note** It is preferable to use a variable of type **AutomaticEvent** or [ManualEvent](../WDLang1/1000021275.md) variable to create a signal, rather than naming it using a character string. Indeed, using a variable allows you to: 
