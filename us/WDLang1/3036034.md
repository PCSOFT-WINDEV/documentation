...
| [fDataDirCommon](../WDLang1/3036070.md) | Returns a directory path for the data shared: <br><br>- between all the users of the computer<br><br>- between all the TSE users<br><br><br>This directory can be used without restriction in Windows XP, Vista, and so on. This directory is used to store:  <br><br>- the files for the general configuration of the application (.INI files, .XML files, etc.). <br><br>- data files common to all users (HFSQL data files .fic, .ndx, .mmo).<br><br><br> |
