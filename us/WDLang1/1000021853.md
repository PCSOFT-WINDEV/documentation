...
- **Customize interface** (window context menu option): Allows the end user to customize the window interface (see below). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IMH_Modifiable_1%20-%20HC%20N%B0001.gif)


- **Repositionable notes** (window context menu option): Enables the end user to add repositionable notes to the window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IMH_Modifiable_1%20-%20HC%20N%B0002.gif)
...
- in the project. The options will be taken into account for all the project windows. 
	...
	2. On the "Advanced" tab, check "Allow end users to modify the UI". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IMH_Modifiable_2%20-%20HC%20N%B0001.gif&type=thumb)
...
- for each window. The options will be taken into account for the selected window only. 
	...
	2. On the "Details" tab, check "Allow end users to modify the UI". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IMH_Modifiable_2%20-%20HC%20N%B0002.gif)
