...
***In french: &lt;Variable File&gt;.Défile***
...
**`<Wait>: (Optional integer or optional Duration)`**
...
<a name="operating_mode_for_multithread_management_ELTPARAGRAPHE000277"></a>

If an element is in the queue, it is removed from the queue and returned by the &lt;Element&gt; parameter by reference.

If the queue is empty, **&lt;Queue variable&gt;.Dequeue** waits for an element to be added to the queue. The maximum timeout can be specified by the &lt;Timeout&gt; parameter.
...
The assignment of [AdditionCompleted](../Proprietes/1000018388.md) to <u><u><u><u>True</u></u></u></u> provokes the end of the timeout for all the pending threads. In this case, **&lt;Queue variable&gt;.Dequeue** returns <u><u><u><u>False</u></u></u></u>.
...
[Dequeue (Function)](../WDLang1/1000018322.md)
