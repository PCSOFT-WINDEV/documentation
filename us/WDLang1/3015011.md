...
Intercepts a Windows event on a control, a group of controls or a WINDEV or WINDEV Mobile window. A specific WLanguage procedure is automatically run when the event is triggered on the specified object. To end the management of event, all you have to do is use [EndEvent](../WDLang1/3015010.md).
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003015011&name=event_function">See additional examples</a>
...
Number or name of Windows message to manage. See the [list of Windows events](../AppelDLL/6510001.md). Note: Windows constants can be integrated directly into your WLanguage code using the [EXTERN](../Motscles/1511013.md) keyword.. 
...
[Highlighting a control that has focus](../WDLang1/20008.md)
