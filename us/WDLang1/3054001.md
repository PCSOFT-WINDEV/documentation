...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003054001&name=changecharset_function">See additional examples</a>
...
// Sublanguage: Macau (5)
// Sorting mode: traditional bopomofo (3)
...
<a name="how_use_specific_character_set_ELTPARAGRAPHE000358"></a>
...
<a name="changing_the_character_set_used_the_fonts_ELTPARAGRAPHE000371"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) To apply this change to the current window, it is recommended to use [Use](../WDLang1/3038044.md) to force the window to reopen. ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) To apply this change to the current window, it is recommended to use [PageUse](../WDLang2/3058016.md) or [FramesetUse](../WDLang2/3058012.md) to display the current window again.
...
<a name="changing_the_character_set_used_the_operations_performed_the_character_strings_ELTPARAGRAPHE000406"></a>
...
For details of how to manage specific character sets in HFSQL data files, see [Defining specific character sets in HFSQL data files](../WDLang1/3054017.md).
<a name="NOTE0_4"></a>
...
<a name="changing_the_character_set_control_control_ELTPARAGRAPHE000457"></a>
...
<a name="using_the_charsetutf8_constant_ELTPARAGRAPHE000468"></a>
