...
|   | Line.Type | Integer constant | Type of line: <br><br>- *LineNone*: No line.<br><br>- *LineSolid*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=traitcontinu.gif)<br><br><br>- *LineSolidThick*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitContinuEpais.gif)<br><br><br>- *LineSolidMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitContinuMoyen.gif)<br><br><br>- *LineDouble*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitDouble.gif)<br><br><br>- *LineDotAndDash*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitMixte.gif)<br><br><br>- *LineDotAndDashMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitMixteMoyen.gif)<br><br><br>- *LineDotAndDashDoubleDash*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=traitMixteTiretDouble.gif)<br><br><br>- *LineDotAndDashDoubleDashMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitMixteTiretDoubleMoyen.gif)<br><br><br>- *LineDotted*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitPointille.gif)<br><br><br>- *LineDottedMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitPointilleMoyen.gif)<br><br><br>- *LineDash*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitTiret.gif)<br><br><br>- *LineDashMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=TraitTiretMoyen.gif)<br><br><br><br> |
