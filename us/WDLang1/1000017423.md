...
- The function **&lt;Input&gt;.CalendarOpen FUNCTION** function can be used on columns in Date-type Table fields: both the Table field and the column must be editable. Otherwise, the **** function has no effect. 
