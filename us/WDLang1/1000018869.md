...
|   |   |
| --- | --- |
| *fUnicodePath* | &lt;Result&gt; will be a Unicode string.<br><br>WARNING: If this option is not specified, document paths containing strings that cannot be converted to ANSI will be replaced with the corresponding short path. |
