...
**Note**: This resizing is performed automatically if the "Adapt the size according to the content" option is checked in the "UI" tab of the window description.
<a name="Exemple1"></a>
...
[LayoutAdaptSize (Function)](../WDLang1/1000023548.md)
