...
In anti-aliasing mode ([&lt;Image variable&gt;.ChangeMode](../WDLang1/1000024039.md)) or in opacity mode ([&lt;picLayer variable&gt;.StartDrawing](../WDLang1/1000024470.md)), **&lt;Image&gt;.DrawTextMarkdown** is available for the TrueType fonts only.
