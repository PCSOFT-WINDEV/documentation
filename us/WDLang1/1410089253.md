...
***In french: &lt;Image&gt;.DessineTexteMarkdown***
...
IMG_MyImage.Font("Arial", 16)
IMG_MyImage.Pen(LightGreen) // light green text
IMG_MyImage.DrawTextMarkdown(8, 10, s, IMG_MyImage.Width-16)
```
...
In anti-aliasing mode ([&lt;Image&gt;.ChangeMode](../WDLang1/1000023997.md)) or in opacity mode ([&lt;Image&gt;.StartDrawing](../WDLang1/1000024326.md)), **&lt;Image&gt;.DrawTextMarkdown** is available for the TrueType fonts only.
