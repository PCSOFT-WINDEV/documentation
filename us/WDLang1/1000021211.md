...
| --- | --- | --- |
| **Full copy** | Copies: <br><br>	- the extensive connection parameters (connections, physical paths, ...).<br><br>	- positions, filters, etc. defined on data files.<br><br>	- the queries. <br><br><br> | Memory consumption (on the client and on the server). |
