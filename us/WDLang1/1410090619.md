...
***In french: &lt;Chaîne Unicode&gt;.RegexCherche***
...
nFound = sString.RegexSearch("([0-9]{1,2})/([0-9]{1,2})/([0-9]{4})", tabDate, tabDays, tabMonths, tabYears)
...
**`<Source string>: (Unicode string variable)`**
...
[&lt;ANSI string&gt;.RegexReplace (Function)](../WDLang1/1410090617.md)
