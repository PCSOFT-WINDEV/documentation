...
**For a one-dimensional array**, the string will be cut according to the carriage returns.

**For a two-dimensional array**, the string will be cut according to the carriage returns, then according to the separator of columns. The elements will be added row by row. There will be as many rows as the number of carriage returns found. Columns will be added if the maximum number of &lt;Column separator&gt; exceeds the number of columns in the array. 
...
[ArrayToCSV (Function)](../WDLang1/1000017096.md)
