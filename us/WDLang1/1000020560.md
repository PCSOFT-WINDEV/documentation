...
| *certSHA256* | Algorithm also known as SHA2. <br><br>Note: This algorithm is not recognized under Windows Vista.. The UAC does not display any information and the executable can be run.   |
