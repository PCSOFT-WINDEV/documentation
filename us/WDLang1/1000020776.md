...
**Note**: You can manipulate the new event directly using its index, via the following syntax: &lt;TimeLine control&gt;[&lt;Index&gt;]. You can modify the properties of this element.
...
Note: Display resolution can be modified: 
