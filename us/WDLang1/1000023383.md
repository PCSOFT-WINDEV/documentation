...
**Note**: These functions are also available in prefix syntax ([Functions for managing Image Editor controls and WDPic variables (prefix syntax)](../WDLang1/1000023434.md)).
