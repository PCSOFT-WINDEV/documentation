...
- [Automatic Drag and Drop](../WDLang1/3030012.md) in edit controls, lists (including image lists), trees, tables and hierarchical tables.
...
<a name="special_case_sql_server_native_connector_and_drag_and_drop_ELTPARAGRAPHE000058"></a>
...
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) WEBDEV supports Drag and Drop via HTML 5. You have the ability to implement: 

- [Automatic Drag and Drop](../WDLang1/3030012.md) in the edit controls, the list boxes, ...
...
[Automatic Drag and Drop ](../WDLang1/3030012.md)
