...
**Warning** The key must exist in order to write a value to it. To create a key, use [RegistryCreateKey](../WDLang1/3065002.md). 
<a name="Exemple1"></a>
<a name="sample_code"></a>

## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003065006&name=registrysetvalue_function">See additional examples</a>
...
**RegistrySetValue** has no effect on "(default)" entries. These are specific entries. To reach these entries, the name of the key must be replaced with an empty string.
