...
Flips an image contained in a variable of type [picLayer](../WDLang1/1000024604.md) with respect to a horizontal axis (symmetry with respect to a horizontal axis).![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=dSymetrieHorizontale.gif)
