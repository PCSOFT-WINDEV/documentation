...
**Note**: This function is equivalent to [ArraySeekByProcedure](../WDLang1/1000020101.md). 
...
nIndex is int
nIndex = ArraySeekByProcedure(arrReference, ProcCompareShortReference, asLinear, 0, "123456")
...
WLanguage comparison procedure. For more details, see [remarks](#NOTE0_1). 
...
| *asLinear* | Linear search. The search starts:<br><br>- from the first element if &lt;Start index&gt; is set to 0,<br><br>- from the value of the parameter &lt;Start index&gt;.<br><br><br>The search stops as soon as an element is found. |
...
| *asLinearPrevious* | Linear search for the previous element. This search is performed from the current position or from the position specified by &lt;Start index&gt;. |
...
<a name="wlanguage_comparison_procedure_ELTPARAGRAPHE000252"></a>This comparison procedure has the following format: 
...
The other parameters are the search values passed as parameter to **SeekByProcedure**. 
