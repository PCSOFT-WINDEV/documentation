...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003050035&name=statsum_function">See additional examples</a>
...
Sum of the values found in the series.
...
<a name="number_elements_found_matrix_row_matrix_column_ELTPARAGRAPHE000076"></a>
...
### Error management
<a name="error_management_ELTPARAGRAPHE000095"></a>

**Caution**: **StatSum** returns no error code. To determine if this function has generated errors, use [StatError](../WDLang1/3050019.md). To get more details on the error, use [ErrorInfo](../WDLang1/3013008.md) with the *errMessage* constant.
