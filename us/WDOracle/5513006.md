...
**Differences from SQL programming**: To manipulate Oracle data, queries are not mandatory. In fact, you can use HFSQL functions directly to read your data, perform searches, filters, etc. However, you will need to import the structure of your Oracle data files into WINDEV or WEBDEV.
...
<a name="importing_the_structure_data_files_ELTTEXTE000253"></a>
...
3. The wizard starts. A connection to the Oracle database is automatically established and it is associated with the data files imported into the analysis. This connection will have to be used to handle the Oracle database programmatically.
