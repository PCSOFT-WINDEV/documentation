...
2. In the window that opens (used to list the existing connections), click the "Add" button to create a new connection. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Parametrage.gif)
