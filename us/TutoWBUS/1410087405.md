...
Why this distinction between server/browser? For performance reasons. The Internet connection stands between the browser and the server, which implies response times, latency, etc. Some simple operations can be performed directly on the browser, without returning to the server.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Navigation_internet.gif)
...
- Open the "PAGE_Registration" page in the editor: double-click its name in the "Project explorer" pane.
	|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | The "Project explorer" pane in the environment shows a list of all the elements in the project. These elements are grouped by theme: Pages, Procedures, etc.<br><br>To open the "Project explorer" pane:<br><br>	1. On the "Home" tab, in the "Environment" group, expand "Panes".<br><br>	2. In the list of panes that is displayed, select "Project explorer".<br><br><br> |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Concepts%20WB%20-%20HC%20N%B0001.jpg&type=thumb)
...
![Button control events](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Concepts%20WB%20-%20HC%20N%B0002.jpg&type=thumb)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | WEBDEV also includes a Session mode to create SEO-ready pages, each with its own URL. There are many advantages of having an SEO-ready page:<br><br>- The page can be ranked among Google search results, <br><br>- This page has a fixed URL, which can be copied, emailed and set as a bookmark,<br><br>- There is no timeout to access this page,<br><br><br>For more details, see [SEO-ready page in session mode](../WDChamp/2030055.md). |
...
- First, we will see how an Internet page works:
	...
	1. In the "WEBDEV_Concepts" project (that was opened at the beginning of this lesson), open the "PAGE_Internet" page in the editor: double-click its name in the "Project explorer" pane.
			|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=astuce.png)<br> | Tip | To quickly find a page in the current project, press Ctrl + E. A window is displayed, allowing you to perform a search on all pages containing the set of letters typed in the search area. Simply select the desired page and validate to open it in the editor. |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Concepts%20WB%20-%20HC%20N%B0003.jpg&type=thumb)


		- Validate the page description window.

3. Test this page: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Go_Page_WB_GAF.jpg)
 in the quick access buttons.

4. The page is displayed in your default browser.

5. Notice the address displayed in the browser: the page has a fixed address. If you copy and paste the address in a new browser, the same page will be displayed!
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Concepts%20WB%20-%20HC%20N%B0004.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P1_Concepts%20WB%20-%20HC%20N%B0005.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Creer-un-site-WebDev.gif)
