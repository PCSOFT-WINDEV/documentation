...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0006%201.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0001.jpg&type=thumb)
...
- To select the CSS styles of a control:
	...
	1. In the "Style" tab of the control description window, in the "Element" combo box, select an element and set the desired style.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0002.jpg)
...
- To create or edit a CSS style:
	...
	1. In the "Style" tab of the control description window, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0001%204.jpg)
 next to the "CSS Style" combo box.  ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0001%203.jpg)


	2. In the context menu that appears, select "Edit". 

3. The CSS style edit window opens.  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0003.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0001%201.jpg)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=avertissement.png)<br> | Caution | These options are used to quickly override the CSS style of the current control. In this case, changing these options will not affect the other controls that use the CSS style.<br><br>You can override all the other properties of the CSS style via "+ overrides". |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0001%202.jpg)
...
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | To see the overridden elements, simply click the link that indicates the number of overrides applied to the control, at the top of the WEBDEV style panel. |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0004%201.jpg&type=thumb)


	- By selecting "Choose a WEBDEV style" in the context menu of the control.  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0004.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0003%201.jpg&type=thumb)
...
- We are now going to modify the CSS style of the input area in order to change the text color. We will make these changes for all the Edit controls of the page. 
	...
	3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0001%204.jpg)
 to the right of the CSS style name. In the context menu that appears, select "Edit". The CSS style description window opens.
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0005.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P7_Styles%20-%20HC%20N%B0006.jpg)
