...
|   |   |
| --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=dur%E9e.png)<br> | <br>Estimated time: 45 mn |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Requ%EAte%20-%20HC%20N%B0001.jpg&type=thumb)
...
- To build the query, we are going to select the elements that will be displayed in the result. The query will contain the data from the Order, OrderLine and Customer data files.
	...
	1. In the left section of the screen, select the Order data file and click the arrow (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Recherche%20multi-crit%E8res%20-%20HC%20N%B0003%201.jpg)
): the items of the Order data file are displayed in the middle of the screen.
...
The query description window is as follows: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Requ%EAte%20-%20HC%20N%B0004.jpg)
...
- To reorganize the items:
	...
	2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Requ%EAte%20-%20HC%20N%B0004%201.jpg)
 on the right of the list of items. The item moves up. 
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Requ%EAte%20-%20HC%20N%B0003.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Cr%E9ation%20Etat%20-%20HC%20N%B0001.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Cr%E9ation%20Etat%20-%20HC%20N%B0002.jpg&type=thumb)




- Run the report by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Go_Page_WB_GAF.jpg)
 in the quick access buttons.
	...
	1. The report editor asks for the print destination. The print destination can be:
		...
		- Report viewer: the report is displayed on the screen in a specific window.
						|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | The report viewer is only available when developing the site.<br><br>At runtime, the user will not be able to use the report viewer. The preview of the generated file will be the displayed in the browser. |
		...
		- Specific file: the report is printed to a file in the selected format.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Cr%E9ation%20Etat%20-%20HC%20N%B0011.jpg)



 Select "Report viewer" and validate.

2. The report editor prompts you to enter the parameters of the query used by the report. Previously, we used a parameter to specify the number of the order to be printed. For the example, type the test value "5". ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Cr%E9ation%20Etat%20-%20HC%20N%B0012.jpg)
Validate.

3. The report is displayed on the screen.  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Cr%E9ation%20Etat%20-%20HC%20N%B0013.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Modification%20Etat%20-%20HC%20N%B0001.jpg&type=thumb)
...
- To configure the borders:
	...
	2. Press R and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Modification%20Etat%20-%20HC%20N%B0003%201.jpg)
 in the upper-right corner of the control. 

	3. Select "Edit borders". The configuration options are displayed:  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Modification%20Etat%20-%20HC%20N%B0004.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Modification%20Etat%20-%20HC%20N%B0005.jpg&type=thumb)


	4. Our "Invoice" report is created. Save the report by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WB_GAF.jpg)
 in the quick access buttons.

5. Check the changes made by running the report in "Report Viewer" mode (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Go%20Page.gif)
 in the quick access buttons).
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Modification%20Etat%20-%20HC%20N%B0006.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Modification%20Etat%20-%20HC%20N%B0007.jpg&type=thumb)
...
8. Save the page (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WB_GAF.jpg)
 or Ctrl + S).
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Modification%20Etat%20-%20HC%20N%B0008.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_Impression%20-%20Modification%20Etat%20-%20HC%20N%B0009.jpg&type=thumb)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | **New tab or new window?**<br><br>Neither the user nor the site developer can choose if the print preview will be opened in a new tab or in a new window. It is the browser that determines which of the two options is used. This behavior may vary depending on the browser used! |
