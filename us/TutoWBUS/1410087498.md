...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=exemple-WB.png)<br> | Answers | A completed project is available. This project contains the results of the different operations performed in this lesson. To open the completed project, go to the home page and click "Tutorial", then in "Parts 3 to 6", double-click "Full WEBDEV Site - Answers". |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0001.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0002.jpg&type=thumb)
...
|   |   |   |
| --- | --- | --- |
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=note.png)<br> | Note | UI errors may occur. We will ignore them for now. We will see how to handle these errors later in this tutorial. |
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0003.jpg&type=thumb)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0005.jpg)
...
4. In the "General" tab, next to the "Image" field, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0004%201.jpg)
. In the menu that appears, select "Multilingual". 

5. The multilingual image management window opens.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0004.jpg)
...
- To translate the "Add a product" option:
	...
	8. Save the page template (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WB_GAF.jpg)
 or Ctrl + S).
	...
	10. Update the pages that use the page template by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20WebDev%20-%20Liste%20produits%20-%20HC%20N%B0011%201.jpg)
 icon in the header of the template. Validate the update window.
...
- To translate the "Modify" link of "PAGE_List_of_products":
	...
	5. Save the page (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WB_GAF.jpg)
 or Ctrl + S).
...
5. In "French", enter "Liste des produits" and validate.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0007.jpg)


6. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B000%208%202.jpg)
 icon appears in the code editor. This icon indicates that the multilingual message exists in multiple languages. You can quickly view the different translations by hovering over the icon.
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0009.jpg&type=thumb)
...
4. Once the translation settings are defined, you can use the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0006%201.jpg)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0011.jpg&type=thumb)
...
10. Save the page template (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_Sauver_WB_GAF.jpg)
 or Ctrl + S).

11. Update the pages that use the page template by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P3_Site%20WebDev%20-%20Liste%20produits%20-%20HC%20N%B0011%201.jpg)
 icon in the header of the template. Validate the update window.
...
- To test the site:
 ...
 in the quick access buttons). The page is displayed in test mode in English.

	2. Select "LANGUAGES .. FRANÇAIS".

	3. The elements that have been translated are displayed in French:  
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=P5_MultiLangue%20-%20HC%20N%B0010.jpg&type=thumb)
