...
<br>![Code proposed by the AI. AI detected the query items, found the Table control and populated the columns with the corresponding items.](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IA%201%20integre%20editeur%20testSL.gif)
...
- AI analyzed the code, detected a pattern and therefore suggest a block of code for the following elements of the source JSON structure. To accept the suggestion, press TAB. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IA%202%20-%20V2.gif)


- AI analyzed the window and detected that a procedure is calculating a due date. It detected an Edit control with a contract date, and suggests the most probable code to continue the current line. To accept the suggestion, press TAB. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=IA%20a%20la%20volee.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-Palettesdecouleurs-Th%E8me%20clair_multi.gif)
Function **PaletteChange**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-Palettesdecouleurs-Th%E8me%20sombre.gif)
...
Each color is intended for a specific use in the skin template: background, text, mesh, etc.
...
For more details, see [Managing color palettes](../WDLang6/1410090992.md). 
		...
		The new WLanguage function [PaletteChange](../WDLang6/1410090897.md) can be used to change the color palette used by a skin template.
...
Practical: the skin templates supplied from version 23 onwards are in 2025 format, and can therefore be changed to a different palette: useful for your existing applications!
...
<br>![Windows theme](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Windows%2011%20rose.gif)

<br>![Generated palette](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-Palettesdecouleurs-Th%E8me%20windows%20rose.gif)
...
In a dark theme, for example, the colors change to white.<br>![Left: original icons, right: automatic changeover to white for dark mode](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Icones%20th%E8me%20clair%20et%20th%E8me%20sombre%202.gif)
...
The same applies to the "7 tabs". <br>![Use of color named in the "7 tabs"](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=editeur_couleur_palette.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=wd-bouton-segmente-1.gif)

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=wd-bouton-segmente-2.gif)

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=wd-bouton-segmente-3.gif)
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champs%20floutes%20avant.gif)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champs%20floutes%20apres.gif)<br> |
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=wd-fichiers-pdf-lire-et-ecrire-recadrage.gif)
...
This new graph represents a chart that visually illustrates data in the form of percentages, in an illustrative form: bottle, person, thermometer, and so on.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-pictorial-percentage-chart-Launch.gif)
...
This makes for a more visual presentation.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=GRAPHE-ICONE.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Champ%20graphe%20bulle%20personnalisable.gif)
...
The Analysis Editor (the Database Schema Editor) in version 2025 offers a new feature that warns you when a structural change has an impact on existing applications, even for applications you haven't written yourself.
...
<a name="environnement"></a>
		...
		A magnificent new modifier makes its appearance in version 2025.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=nouveau-modifieur_etat_zoom-sur-modifieur.gif)
See new feature 062.
...
<a name="environnement_nouveau_modifieur"></a>
		...
		The new modifier will instantly become an essential tool in your workflow.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-Nouveau-Modifieur.gif)
...
Of course, the ribbon is still available.
		...
		The presentation of fields by section is much clearer.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=schema_volet_creation_champ.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=schema_volet_creation_champ-Rechercher.gif)
...
Multicursor allows you to perform the same operation simultaneously at all cursor positions.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=multicurseur_avant.gif)
...
A fine line takes care of this mission.<br>![Note the thin lines marking the code blocks](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WX2025_Indentation.gif)
...
The type of element is indicated at the end of the line: input field, label, integer, real, Boolean, etc.<br>![The code in the combo uses syntax highlighting](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Combo%20completion.gif)
...
In version 2025, it is now possible to set the thickness of this cursor, as well as its flashing speed.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=wx-taille-du-curseur-vitesse-clignotement.gif)
...
<a name="coffre_fort"></a>
		...
		Passwords, private keys and tokens are often used in programming.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Code%20MDP.gif)
For example:
...
All project developers can use this identifier.<br>![Secure editing of secret strings](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=coffre-fort%20V2%20avec%20mdp%20en%20clair.png)
...
This check is activated in the compilation options.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=CoffreFort-MDP-WLangage.gif)
...
Version 2025 also allows you to describe the relationship between PDF and attachments (here in XML).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Sch%E9ma%20facturation.gif)
...
<a name="yousign"></a>
		...
		WINDEV version 2025 includes the YouSign solution.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Yousign-Sch%E9ma.gif)
...
<a name="base_de_donnees_hfsql"></a>
		...
		When an HFSQL server is under heavy load, a new way of managing caches improves the opening speed of data files (tables).
...
- Change the order of unique keys in the data structure.
		...
		HFSQL lets you automatically implement and manage the anonymization and pseudonymization of your data files (tables).
...
In the event of an unexpected shutdown, the cluster is automatically restarted.
		...
		Version 2025 makes it possible to copy a database or data file (table) directly into a cluster from the HFSQL Control Center.
