...
The small icon that displays the number can be positioned on any type of control: Button, Static, Image...<br>![Here, the badge (red circle with the number) appears on a Button control](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-ChampM%E9tier1.png)
...
<a name="table_control_new_features"></a>
		...
		In version 28, Image columns look better than ever: by default, a margin appears around the image, which improves the overall layout of the table.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Table%20avec%20images%20-%20marge.jpg)
...
<br>![A clean Combo Box...](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD%20-%20Combo%20a%E9r%E9e%20Windows%2011.png)
		...
		Static controls can now be rotated. This rotation is specified in the "Style" tab of the 7-tab window.<br>![Rotated text (in red)](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD%20-%20Champ%20libell%E9%20avec%20une%20rotation%203.png)
