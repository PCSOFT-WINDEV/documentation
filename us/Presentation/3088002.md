...
<a name="step_2_analysis_setup_data_files_and_visible_fields_ELTPARAGRAPHE000099"></a>
...
Note: Reports and queries created directly from WINDEV and based on invisible data files and/or fields can be run and/or modified from within Reports & Queries.
...
**Please note** To take into account changes made in the WINDEV analysis, it is of course necessary to generate the WINDEV analysis: in the "Analysis" pane, in the "Analysis" group, pull down "Generation" and select "Generate".
<a name="NOTE3_3"></a>


### Step 2a: Analysis setup: Translation of data file and item names
<a name="step_2a_analysis_setup_translation_data_file_and_item_names_ELTPARAGRAPHE000154"></a>
...
3. On the "Reports and Queries" tab, specify the name of data file and its caption in the different languages supported by the analysis.
	**Note** The name used must not correspond to an existing data file name in the analysis.
...
4. On the "Reports and Queries" tab, type the name of item and its caption in the different languages supported by the analysis.
...
**Please note** To take into account changes made in the WINDEV analysis, it is of course necessary to generate the WINDEV analysis: in the "Analysis" pane, in the "Analysis" group, scroll down to "Generation" and click on "Generate".
<a name="NOTE3_4"></a>
...
<a name="multilingual_heading_and_data_file_names_ELTPARAGRAPHE000456"></a>

You have defined multilingual names and labels for your data files and fields: when a report is modified or created, the user will have access to the names and labels corresponding to the current language.
...
**Note** If the report is included in the executable, the labels and names of the fields and data files will be displayed in the original language.
...
### Multilingual heading and data file names
<a name="multilingual_heading_and_data_file_names_ELTPARAGRAPHE000505"></a>

You have defined multilingual names and labels for your data files and fields: when a query is created, the user will have access to the names and labels corresponding to the current language.
