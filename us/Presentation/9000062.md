...
|   |   |
| --- | --- |
| [HAdd](../WDLang4/3044147.md) | Adds the record found in memory to the data file (query or view). |
...
| [HChangeLogDir](../WDLang4/3044164.md) | Modifies the location of log files corresponding to an HFSQL data file. (\*JNL file and JournalOperation and JournalIdentification files if they exist). |
| [HCopyFile](../WDLang4/3044282.md) | Copy an HFSQL data file from the client to the server and vice versa |
...
| [HDeleteFile](../WDLang4/3044294.md) | Deletes HFSQL data files (.fic, .ndx and .mmo files if available) on the server. |
