...
Remember: Smart controls are delivered with their source code, so they can be fully modified and customized.
		...
		The "Multi-selection with tokens" Smart control allows you to select one or more tokens from the list.<br>![Multiple selection with tokens](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-ChampM%E9tier3.png)
...
The chip displaying the number can be positioned on any type of field: button, label, image, etc....<br>![Here, the badge (red circle with the number) appears on a Button control](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-ChampM%E9tier1.png)
...
Please bear in mind that this control is based on a Google API. Google may require you to pay a subscription fee, depending on the number of requests.<br>![Several address suggestions appear when the end user starts typing](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD-ChampM%E9tier2.png)
...
<a name="nouveautes_sur_le_champ_table"></a>
		...
		The presentation of Image columns has been improved in version 28: by default, a margin is present around the image, making the table more harmonious..<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Table%20avec%20images%20-%20marge.jpg)
...
<a name="nouveautes_sur_les_champs"></a>
		...
		<br>![You can now format all the text in your applications](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Markdown%20Interrupteur2.png)
...
<br>![Easy formatting with Markdown](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Markdown%20Menu2.png)
...
The layout improves automatically.<br>![In edit mode, you can see the margins that have been applied around the icons](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Picto%20Libell%E9%20Onglet%20marges.png)
...
In version 28, you can define the border settings for each state in the "Style" tab of the 7-tab window.<br>![Easily select the type of border for each state](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Cadre%20btn.jpg)
...
In version 28, this separator can contain a text.<br>![The menu separator can now include text](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=Menu%20Libell%E9%20avec%20s%E9parateur.png)
		...
		You can define "5-state" icons (e.g. buttons) in the menu options via the-7 tab window or programmatically.<br>![5-state icon](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD%20-%20Menu%20contextuel%20option%20dynamique.png)
...
<br>![A clean Combo Box...](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD%20-%20Combo%20a%E9r%E9e%20Windows%2011.png)
		...
		Static Text controls can now be rotated. This rotation is specified in the "Style" tab of the 7-tab window.<br>![Rotated text (in red)](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD%20-%20Champ%20libell%E9%20avec%20une%20rotation%203.png)
...
<a name="installs_creees_avec_windev"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD%20-%20Installe%20relook%E9e.png)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD%20-%20Agrandissement%20des%20polices.png)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=WD%20-%20Espacement%20des%20champ.png)
...
<a name="faa_les_fonctionnalites_automatiques_de_vos_applications"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=FAA%20Tous%20Aucun2.jpg)
