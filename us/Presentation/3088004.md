...
The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=er.png) icon indicates the differences between the user version of report editor and the standard report editor.
