...
This code takes all the possibilities presented on dates, and applies them to times. 
	...
	3. Let's test this code: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Simu_PRJ_WM_GAF.jpg)
 in the quick access buttons.  
...
- In a standard FOR .. TO .. loop, both the values of the start index (1) and end index must be specified. 
	...
	2. Let's test this code: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=3&name=ICO_GO_Simu_PRJ_WM_GAF.jpg)
 in the quick access buttons.  
