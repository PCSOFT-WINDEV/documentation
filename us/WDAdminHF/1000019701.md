...
When creating/modifying a user, the user can be a superuser: users designated as "superuser" are authorized to perform all actions on the server, databases and all data files.
