...
1. Launch WDSQL: a wizard will help you define the connection parameters. 
	If WDSQL is already started, select "File .. Connection" (or click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDSQL%20-%20HC%20N%B0001%201.gif)). The current connection is automatically closed. 
...
3. Specify the data source of connection. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDSQL%20-%20HC%20N%B0002.gif&type=thumb)
...
6. Go to the next step. The list of the different files (or tables) found in the database is displayed.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDSQL%20-%20HC%20N%B0003.gif&type=thumb)
...
1. Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDSQL%20-%20HC%20N%B0002%201.gif) button found on the right of "Connection by" list. The window for custom connections is displayed.
