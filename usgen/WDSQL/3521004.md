...
**Note**: For the following operations, we assume that the query result is displayed in WDSQL.
...
3. Choose the type of separator used between the different items of each record ("Type" option):
	...
	- ***Separator: Tab***: Headings will be separated by tabs.

	- ***Separator: Semicolon***: Headings are separated by semicolons.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ExporterFichierTexte.gif)
...
2. Select the desired export mode: Word, Excel or XML.
...
3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDSQL%20-%20HC%20N%B0006%202.gif) to print the query result.
