...
- perform SOAP requests (to access SOAP, J2EE or .Net web services),
...
The communication over WiFi can be used to transfer files via FTP, for example. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CommFTP.gif)
