...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Mod%E8le%20fen%EAtre%201.gif&type=thumb)
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Mod%E8le%20fen%EAtre%202.gif&type=thumb)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Mod%E8le%20fen%EAtre%203.gif&type=thumb)<br> |
...
- via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_ICO_Cr%E9er_cpt.gif) icon in the quick access buttons. In the "New" window, click "Window", and then "Window template".
...
The characteristics of the elements can be dissociated from the template. For example, dissociating the control from the template so it can be freely positioned while keeping changes (code, style,  etc.). This is referred to as **control inheritance**. In this case, the elements are identified by a blue square.
