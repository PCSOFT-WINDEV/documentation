...
|   |   |
| --- | --- |
| To use an internal window, you must:<br><br>- create an Internal Window control.<br><br>- in the control description, select the internal window to use and validate.<br><br><br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Fen%EAtre%20interne%202.gif&type=thumb)<br> |
