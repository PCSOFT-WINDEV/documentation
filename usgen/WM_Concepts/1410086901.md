...
Report templates are used to easily standardize report layouts.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Modele%20etat%201.gif&type=thumb)
View of a report template in the report editor.


|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Modele%20etat%202.gif&type=thumb)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Modele%20etat%203.gif&type=thumb)<br> |
