...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Modele%20champ%201.gif&type=thumb)
View of a control template.
An orange outline appears around the template.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Modele%20champ%202.gif&type=thumb)
...
- via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_ICO_Cr%E9er_cpt.gif) icon in the quick access buttons. In the "New" window, click "Window" then "Control template".
