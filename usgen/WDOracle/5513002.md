...
**Differences from HFSQL** programming: Using SQL functions to manipulate Oracle data does not imply importing the table structure into the database schema.. However, the data must be handled by queries only. The content of the Oracle files cannot be read directly.
...
## Programming
<a name="programming_ELTTEXTE000163"></a>


### 1. Opening the connection
<a name="1_opening_the_connection_ELTPARAGRAPHE000020"></a>
...
Note: External authentication of the connection is also possible.. For more details, see the help about [SQLConnect](../WDLang4/3072005.md).
<a name="NOTE2_2"></a>


### 2. Running the queries
<a name="2_running_the_queries_ELTPARAGRAPHE000046"></a>
...
<a name="3_retrieving_the_result_ELTPARAGRAPHE000061"></a>
...
<a name="4_closing_the_connection_ELTPARAGRAPHE000088"></a>
