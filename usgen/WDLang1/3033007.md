...
- [columns of Table controls](../WDChamp/1013245.md) (Table controls populated programmatically or based on a table),
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=type_monetaire_euro%20-%20HC%20N%B0001.gif&type=thumb)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=type_monetaire_euro%20-%20HC%20N%B0002%201.gif)
...
If the displayed currency differs from the stored currency, the conversion is automatically performed between the display currency and the stored currency. Using a different display currency and stored currency means that only one currency is stored in the table: the stored value can be displayed in any currency.
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=type_monetaire_euro%20-%20HC%20N%B0002%202.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=type_monetaire_euro%20-%20HC%20N%B0002%203.gif)


Example:
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Eurobulle.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=type_monetaire_euro%20-%20HC%20N%B0002%204.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EuroDoubleaffichage2.gif)
...
In this example, the prices will be saved in Francs in the HFSQL table.
<a name="NOTE5_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 
...
**Special case** Conversion is not performed if the Tracker control is linked to a field in an HFSQL table.
<a name="NOTE5_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 
...
For a data-bound Table control, the column that allows for dual display must be initialized in the display code of a table row. The code used can be for example:
...
- COL_PUHT: name of the column linked to a field in an HFSQL table, displaying the value in francs.
...
**Reminder** The functions for reading a table or displaying a table in the data-bound Table control have no effect on a calculated column.
<a name="NOTE5_4"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 
