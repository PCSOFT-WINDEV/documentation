...
***In french: &lt;Variable WDPic&gt;.DessineCercle***
...
Draws a circle or an ellipse in a variable of type [WDPic](../WDLang1/1000023503.md).![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) **Caution**: In Linux, this function requires a specific configuration. For more details, see [Drawing in WINDEV, WEBDEV and WINDEV Mobile](../WDLang1/3029035.md). 
<a name="Exemple1"></a>
...
If this parameter is specified, the characteristics defined with [&lt;WDPic variable&gt;.Pen](../WDLang1/1000024636.md) are ignored. The line thickness will be set to 1. 
