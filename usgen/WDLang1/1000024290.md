...
Note: This function is equivalent to [&lt;Table&gt;.Delete](../WDLang1/1000024289.md). The only difference is the management of animation.
<a name="Exemple1"></a>
...
<a name="deleting_records_table_treeview_databound_table_control_based_table_ELTPARAGRAPHE000274"></a>

**&lt;Table&gt;.DeleteWithAnimation** deletes the corresponding record from the table associated with the control. If items are linked to other tables, no modification is automatically performed on these linked tables.
<a name="NOTE0_3"></a>


### Referential integrity and Table or TreeView data-bound Table controls
<a name="referential_integrity_and_table_treeview_databound_table_controls_ELTPARAGRAPHE000286"></a>
...
<a name="deleting_records_databound_table_control_and_trigger_ELTPARAGRAPHE000308"></a>
...
<a name="locking_the_linked_table_ELTPARAGRAPHE000345"></a>

If the table is locked in the current process, **&lt;Table&gt;.DeleteWithAnimation** deletes the specified row and unlocks the table.
<a name="NOTE0_7"></a>
