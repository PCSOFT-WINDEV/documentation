...
**Note**: These functions are also available in prefix syntax ([Spreadsheet functions (prefix syntax)](../WDLang1/1000023883.md)).
...
| [SpreadsheetAddLink](../WDLang1/1410090390.md) | Creates a link in a Spreadsheet control cell. The text in the cell becomes the link. |
...
| [SpreadsheetEndModification](../WDLang1/1000023461.md) | Indicates the end of a series of actions performed in a Spreadsheet control in a single event ("undo/redo"). |
...
| [SpreadsheetMergeCell](../WDLang1/1000026181.md) | Merges specified or selected cells in a Spreadsheet control. |
...
| [SpreadsheetStartModification](../WDLang1/1000023460.md) | Indicates the start of a series of actions performed in a Spreadsheet control in a single event ("undo/redo"). |
