...
// Allow to retrieve the value defined by gLink.
gLinkActivate(COMBO_Civility, True)
```
...
<a name="activationdeactivation_ELTPARAGRAPHE000101"></a>
...
- If the retrieval of the values defined by [gLink](../WDLang1/3029043.md) is disabled on the COMBO_COMBO1 control (&lt;Active&gt; = False): 
	COMBO_COMBO1.Value returns the order number in the COMBO_COMBO1 control.
...
### ListSeek function
<a name="listseek_function_ELTPARAGRAPHE000163"></a>

- If **gLinkActivate**()=True, [ListSeek](../WDLang1/3049003.md) takes the values added by [gLink](../WDLang1/3029043.md) into account.

- If **gLinkActivate**()=False, [ListSeek](../WDLang1/3049003.md) ignores the values added by [gLink](../WDLang1/3029043.md). The search is performed using the displayed value. 
...
<a name="combo_box_controls_bound_items_ELTPARAGRAPHE000186"></a>

**gLinkActivate** can be used to manipulate Combo controls bound to table items (this binding is defined in the "File-to-screen binding" step of the control creation wizard or in the "Binding" tab of the control description window.
