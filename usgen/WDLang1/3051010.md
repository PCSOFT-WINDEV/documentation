...
| [MCIMsgErr](../WDLang1/3051021.md) | Returns the text of last error caused by a MCI function (Media Control Interface). |
...
[Playing a video with the MCI functions](../WDLang1/3051024.md)
