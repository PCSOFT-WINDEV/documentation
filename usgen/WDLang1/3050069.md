...
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) In Internet Explorer, unit names should not contain accents.
...
<a name="calculation_the_angles_ELTPARAGRAPHE000087"></a>
...
|   |   |   |   |   |   |
| --- | --- | --- | --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | degree | minute | second | grad | radian |
| degree | X | X | X |   | X |
| minute |   |   | X |   |   |
| second |   |   | X |   |   |
| grad | X |   |   |   |   |
...
<a name="calculation_the_masses_ELTPARAGRAPHE000163"></a>
...
|   |   |   |   |   |   |
| --- | --- | --- | --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | Kilogram | ounce | grain | pennyweight | troy ounce |
| milligram | X |   |   |   |   |
| gram | X |   |   |   |   |
| kilogram | X | X |   |   |   |
| ton | X |   |   |   |   |
...
<a name="calculation_the_temperatures_ELTPARAGRAPHE000293"></a>
...
|   |   |   |   |   |   |
| --- | --- | --- | --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | kelvin | degree Fahrenheit | degree Celsius | degree Rankine | degree centigrade |
| kelvin | X | X | X | X | X |
...
<a name="calculation_the_energy_ELTPARAGRAPHE000375"></a>
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | joule |
| joule | X |
| calorie | X |
| calorieth | X |
| electronvolt | X |
...
<a name="calculation_the_force_ELTPARAGRAPHE000445"></a>
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | newton |
| newton | X |
| dyne | X |
| kilogram-force | X |
| kilopound | X |
...
<a name="calculation_the_length_ELTPARAGRAPHE000507"></a>
...
|   |   |   |   |   |   |   |   |   |   |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | meter | US foot | US mile | pica | point | foot | rod | inch | mil |
| kilometer | X |   |   |   |   |   |   |   |   |
| meter | X | X | X | X |   |   |   |   |   |
| decimeter | X |   |   |   |   |   |   |   |   |
| centimeter | X |   |   |   |   |   |   |   |   |
...
<a name="calculation_the_speed_ELTPARAGRAPHE000743"></a>
...
|   |   |   |   |
| --- | --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | kilometer per hour | meter per second | node |
...
<a name="calculation_the_areas_ELTPARAGRAPHE000837"></a>
...
|   |   |   |
| --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | square meter | acre |
| square kilometer | X |   |
| square meter | X | X |
| square decimeter | X |   |
| square centimeter | X |   |
...
<a name="calculation_the_volumes_ELTPARAGRAPHE000975"></a>
...
|   |   |   |   |
| --- | --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | cubic meter | US gallon | cubic foot |
| cubic kilometer | X |   |   |
| cubic meter | X |   |   |
| cubic decimeter | X |   |   |
| cubic centimeter | X |   |   |
...
<a name="calculation_the_consumption_ELTPARAGRAPHE001201"></a>
...
|   |   |   |
| --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | liter per 100 kilometer | mile per gallon |
...
<a name="calculation_the_pressures_ELTPARAGRAPHE001243"></a>
...
|   |   |   |   |
| --- | --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | pascal | millimeter of mercury | millimeter of water |
| pascal | X |   |   |
| atmosphere | X |   |   |
| bar | X |   |   |
| millibar | X |   |   |
...
<a name="calculation_the_power_ELTPARAGRAPHE001413"></a>
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | watt |
| watt | X |
| horsepower | X |
...
<a name="calculation_the_magnetism_ELTPARAGRAPHE001451"></a>
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif)<br> | tesla |
| tesla | X |
| gauss | X |
