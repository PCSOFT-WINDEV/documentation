...
Displays a message allowing the user to enter data.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fonctions_dialogue%20-%20HC%20N%B0008.gif)
...
1. Typing the question in the editor: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie_Exemple.gif&type=thumb)
