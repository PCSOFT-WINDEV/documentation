...
| [&lt;Word Processing&gt;.Add](../WDLang1/1000024032.md) | Adds an element, document, paragraph, text, image or fragment to the end of a Word Processing control. |
...
| [&lt;Word Processing&gt;.GoIntoEdit](../WDLang1/1000024263.md) | Enters Word Processing control in a specific part of the document: body, header or footer. |
| [&lt;Word Processing&gt;.InfoXY](../WDLang1/1000025346.md) | For a given position (coordinates of a point) in a Word Processing control, returns one of the following:<br><br>- the number of the corresponding page, <br><br>- the corresponding X-position (in mm), <br><br>- the corresponding Y-position (in mm).<br><br><br> |
