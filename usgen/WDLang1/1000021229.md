...
You also have the ability to indicate to the **DisplayImage** procedure that it will always be run in the main thread. All you have to do is click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Proc_auto_Ico.gif) button in the bar of the code editor and check "Run in the main thread". 
