...
This directory can be used without restriction in Windows XP, Vista, and so on. This directory is automatically created if it does not exist.
<a name="Exemple1"></a>
...
<a name="programming_standard_windows_vista_and_later_ELTPARAGRAPHE000032"></a>
