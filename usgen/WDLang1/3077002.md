...
| **thpCamera** | Use case: background camera access. | [ThreadPersistent](../WDLang1/1000020584.md) |
| **thpLocation** | Use cases: Operations requiring location access, such as navigation and location sharing. | [ThreadPersistent](../WDLang1/1000020584.md) |
| **thpMediaPlayback** | Use: Continuous playback of music or video in the background. | [ThreadPersistent](../WDLang1/1000020584.md) |
| **thpMicrophone** | Use: Background audio recording. | [ThreadPersistent](../WDLang1/1000020584.md) |
| **thpHealth** | Use case: physical activity monitoring. | [ThreadPersistent](../WDLang1/1000020584.md) |
| **thpShortService** | Use case: Critical operation that must be completed without interruption. | [ThreadPersistent](../WDLang1/1000020584.md) |
| **thpDataSync** | Use case: Data synchronization. | [ThreadPersistent](../WDLang1/1000020584.md) |
| **thpSpecialUse** | Use case: an operation whose use case does not correspond to any of the predefined cases. | [ThreadPersistent](../WDLang1/1000020584.md) |
| **threadStopRequested** | Thread status: Stop has been requested for this thread. | [ThreadState](../WDLang1/3077016.md), <br>[Thread](../WDLang1/1000024879.md) type |
...
| **threadGlobalContext** | Thread launch mode: forces use of global project context if thread is run from a window. <br>The context of the window is used by default. | [ThreadExecute](../WDLang1/3077024.md), <br>[Thread](../WDLang1/1000024879.md) type |
