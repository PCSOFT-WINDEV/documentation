...
### Managing assertions
<a name="managing_assertions_ELTPARAGRAPHE000073"></a>

The messages of **TestCheckNotNull** will be written into the ADB log (at "Assert" level). For more details, see [Managing ADB logs](../Editeurs/9000108.md).
