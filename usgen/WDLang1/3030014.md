...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=drag_drop_explorateur.gif)
...
**In the procedure called each time files are "dropped" onto the window, you can get information and process the relevant files.**
