...
The nesting of variables from a [Document](../WDLang1/1000022461.md) variable is as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TT_prog_Document.gif)
...
The nesting of variables starting from a variable of type [docFragment](../WDLang1/1000022482.md) is as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TT_prog_Fragment.gif)
...
[docTabulation (Variable type)](../WDLang1/1000022573.md)

[docNumberingLevel (Variable type)](../WDLang1/1000022799.md)
