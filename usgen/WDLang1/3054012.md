...
3. **If your application manages languages using specific character sets (Greek, Korean, etc.)**change by programming:
	...
	- the character set used ([ChangeCharset](../WDLang1/3054001.md)). This character set can also be used for the data saved in the HFSQL tables. For more details, see [Managing specific character sets in the tables](../WDLang1/3054017.md).
