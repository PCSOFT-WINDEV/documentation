...
The **diagPolygon** type is used to define all the advanced characteristics of a shape of type Polygon. You can define and change the characteristics of this shape using different WLanguage properties. 
...
Note: The type **diagPolygon** type inherits from the [diagShape](../WDLang1/1410088082.md) type, all the properties of the [diagShape](../WDLang1/1410088082.md) type are available for the **diagPolygon**. These properties appear in italics in the list below.
