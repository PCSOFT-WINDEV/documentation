...
**Note**: These functions are also available in prefix syntax ([Functions for managing menus (prefix syntax)](../WDLang1/1000020631.md)).

<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
The following functions are used to manage menus: 
...
[Managing main window menus](../WDLang1/1010010.md)

[Managing context menus in a WINDEV or WINDEV Mobile application](../WDLang1/1010011.md)

[Page menu](../WDLang1/1010041.md)
