...
3. If a translation tool is specified, a "Translate" button (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=BtnTraduire.GIF)) will be displayed in each element containing information to translate. This button is used to translate the selected text via the specified translation tool.
