...
**Note**: The **TableModifyColumn** function can be used on both:
...
<a name="table_file_changes_the_linked_table_ELTPARAGRAPHE000101"></a>
...
If the cascading input is not enabled, the table linked to the data-bound Table control is not modified. To write the record into the table, [TableSave](../WDLang1/3074008.md) must be run after **TableModifyColumn**.
...
<a name="modifications_performed_databound_table_control_based_table_ELTPARAGRAPHE000122"></a>
...
[&lt;Table&gt;.ModifyColumn (Function)](../WDLang1/1000024274.md)
