...
For more details, see [Handling an element of a TreeView control programmatically](../WDChamp/1013327.md).
<a name="NOTE0_2"></a>


### Details about the elements returned by the treeZone constant
<a name="details_about_the_elements_returned_the_treezone_constant_ELTPARAGRAPHE000280"></a>The following illustration presents the different areas that can be retrieved by the *treeZone* constant.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Arbre_InfoXY.gif)
