...
- **This information window blocks the application until the time limit has elapsed**. To continue running the application, the user must click "OK". 
	![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) To avoid blocking the application, use [InfoWithTimeoutAsynchronous](../WDLang1/1000025271.md).
...
- Equivalence: The **InfoWithTimeout** is equivalent to function [Info](../WDLang1/3021011.md) used with function [DelayBeforeClosing](../WDLang1/3038040.md): 
	The following code: 
