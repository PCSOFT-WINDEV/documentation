...
A procedure for processing the notifications of modifications can be passed as parameter to [fMemOpen](../WDLang1/1000018917.md). If this procedure was specified, it will be automatically called whenever the content of the shared memory area is modified.
