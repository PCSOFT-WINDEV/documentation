...
| **wlAnsiString** | ANSI string variable | [TypeVar](../WDLang1/3013056.md) |
...
| **wlDataFile** | Parameter corresponding to a table (only used when a parameter is defined using the **Type** property of a variable of type [Definition](../WDLang1/1000019540.md)). | [TypeVar](../WDLang1/3013056.md) |
