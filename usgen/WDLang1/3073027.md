...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Icone.gif) or ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconePPC.gif)

**Remark**: Icon operation (context menu, procedure call) remains unchanged.
<a name="Exemple1"></a>
