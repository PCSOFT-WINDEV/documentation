...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=drectangledegrade.gif)


The angle is used to define the orientation of the gradient.
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=angle_degrade.gif)
