...
**Note** The currency label is displayed in "Monétaire + Euro" type fields if the edit control allows (the $ sign is shown).
<a name="Exemple1"></a>
...
### Exchange table
<a name="exchange_table_ELTPARAGRAPHE000036"></a>
