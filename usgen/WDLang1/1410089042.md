...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Only the ANSI format is supported.
...
### Writing a line to an external file
...
- <u><u><u><u>True</u></u></u></u> if the write operation was performed to the specified file, 
...
### Writing a fixed-length line to an external file (speeds up the write operation)
...
**Attention** The function **&lt;DiskFile variable&gt;.WriteLine** function can only be used on text files. This function does not support the binary 0 (the write operation is stopped).
<a name="NOTE0_2"></a>
...
<a name="operating_mode_windows_vista_and_later_ELTPARAGRAPHE000371"></a>
...
<a name="position_the_file_ELTPARAGRAPHE000394"></a>
...
<a name="ansi_unicode_management_ELTPARAGRAPHE000420"></a>
