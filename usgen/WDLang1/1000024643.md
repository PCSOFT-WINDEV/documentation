...
Note: Properties **Title**, **Text** and **Button** of variable type [Toast](../WDLang1/1000024638.md) are not taken into account.  
...
Please note: In order to change the background color of the internal window, it is necessary to use the "Transparent" background color in the editor.
