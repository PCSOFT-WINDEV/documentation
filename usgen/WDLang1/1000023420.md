...
The **docElementTextArea** type is used to define the advanced characteristics of a text area found in a [docElement](../WDLang1/1000022484.md) variable. The characteristics of this text area can be defined and modified using various WLanguage properties. 
...
<a name="properties_specific_docelementtextarea_variables_ELTPARAGRAPHE000028"></a>
...
|   | Line.Type | Integer constant | Type of line: <br><br>- *FeatureNo*: No Line.<br><br>- *LineSolid*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=traitcontinu.gif)<br><br>- *LineSolidThick*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitContinuEpais.gif)<br><br>- *LineSolidMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitContinuMoyen.gif)<br><br>- *LineDouble*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitDouble.gif)<br><br>- *LineDotAndDash*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitMixte.gif)<br><br>- *LineDotAndDashMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitMixteMoyen.gif)<br><br>- *LineDotAndDashDoubleDash*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=traitMixteTiretDouble.gif)<br><br>- *LineDotAndDashDoubleDashMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitMixteTiretDoubleMoyen.gif)<br><br>- *LineDotted*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitPointille.gif)<br><br>- *LineDottedMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitPointilleMoyen.gif)<br><br>- *LineDash*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitTiret.gif)<br><br>- *LineDashMedium*: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TraitTiretMoyen.gif)<br><br><br> |
|   | Line.Color | Integer or Integer constant | Line color: This color can correspond either to an RGB color (obtained with the [RGB](../WDLang1/3029012.md) function), or to [a preset color](../WDLang5/3010002.md). |
...
| PresetShape | Character string | Name of preset shape used for the area border. This property can correspond to: <br><br>- Empty string: Shape corresponds to a square but has no outline. <br><br>- "&lt;nom de la forme&gt;": Customized shape, displayed in the field but not managed by programming.. For more details, see [Preset shapes](#NOTE0_2). <br><br><br> |
| Width | Real | Width of text area in millimeters. |
| Wrapping | Integer constant | Type of wrapping for the text area: <br><br>- *docHabillageAlignedOnText* The text area is inserted on the line and is linked to the text location where it was inserted. It is processed like any character. It moves with the text. <br><br>- *docTrimAbove*: Allows you to customize the trim.. <br><br>- *docWatermarkBehindText* Watermark the text area behind the text.<br><br>- *docFrameOverText* Display text area on top of text. <br><br>- *docHabillageEncadré* Wraps the text around the text area border (recommended for square text areas).  <br><br>- *docTopBottomTrim* The text area remains on its line, between two text sections at the top and bottom.<br><br>- *docApproachTrim* Dress the text area according to its contours (recommended for round or irregularly shaped text areas). <br><br><br> |
...
<a name="available_preset_shapes_ELTPARAGRAPHE000207"></a>
