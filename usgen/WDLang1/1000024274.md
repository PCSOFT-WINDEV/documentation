...
**Note**: The **&lt;Table&gt;.ModifyColumn** function can be used on both:

- a horizontal data-bound Table control or populated programmatically.
...
### Table file: Changes to the linked table
<a name="table_file_changes_the_linked_table_ELTPARAGRAPHE000218"></a>
...
If the cascading input is not enabled, the table linked to the data-bound Table control is not modified. To write the record into the table, [&lt;Table&gt;.Save](../WDLang1/1000024249.md) must be run after **&lt;Table&gt;.ModifyColumn**.
...
### Modifications performed in a data-bound Table control based on a table
<a name="modifications_performed_databound_table_control_based_table_ELTPARAGRAPHE000242"></a>

To modify a column in a data-bound Table control based on a table, we advise you to:
...
[TableModifyColumn (Function)](../WDLang1/1000017179.md)
