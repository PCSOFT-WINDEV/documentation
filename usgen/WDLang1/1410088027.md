...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Notif%20Windows%2011.gif)
...
2. Create a variable of type [sysNotification](../WDLang1/1410087893.md). This variable contains the full description of the notification. 
	...
	- To add buttons to the notification, create one or more variables of type [sysNotificationButton](../WDLang1/1410087947.md). 

		- The **Type** property of this type of variable determines the type and position of the button to be created.

		- The **AssociatedTextInputName** property is used to position the button next to a text area. 
						

		- The **Style** property is used to apply a style and a color to the button. 
						




- To add progress bars, create one or more [sysNotificationProgressBar](../WDLang1/1410090964.md) variables. 
...
<a name="click_notification_button_notification_ELTPARAGRAPHE000085"></a>
...
Note: The procedures and the optional event are executed in the main thread of the application (direct access to the controls).
...
<a name="functions_and_types_variables_associated_with_interactive_notifications_ELTTEXTE000232"></a>
