...
Name of the cloned menu or menu option. This name will be used to handle the cloned element programmatically.
...
- to an integer: in this case, the cloned menu or menu option will be inserted before the indicated position.
...
Name of the cloned menu or menu option. This name will be used to handle the element programmatically. A fatal error occurs if this name corresponds to an existing element.
...
<a name="characteristics_the_cloned_element_ELTPARAGRAPHE000108"></a>
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) You cannot clone a menu option created programmatically.
...
[&lt;Menu&gt;.Clone (Function)](../WDLang1/1000020604.md)
