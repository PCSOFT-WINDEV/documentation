...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) via the "Filter" icon of the context menu of column: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Android_Table_Filtre.gif)
