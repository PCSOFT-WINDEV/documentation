...
## Principle
<a name="principle_ELTTEXTE000226"></a>
The semaphore was created by [SemaphoreCreate](../WDLang1/3077012.md).

1. Thread n°1 executes function [SemaphoreStart](../WDLang1/3077008.md): no thread is currently present in the semaphore.

2. Thread #1 runs the code section protected by the semaphore.

3. While thread #1 executes the semaphore-protected code, thread #2 executes the [SemaphoreStart](../WDLang1/3077008.md) function: since the semaphore-protected code is already being executed by thread #1, thread #2 waits for the semaphore to be released.

4. Thread n°1 executes function [SemaphoreEnd](../WDLang1/3077010.md): no more threads execute semaphore code.

5. Thread #2 can run the code protected by the semaphore.

6. Thread n°2 executes function [SemaphoreEnd](../WDLang1/3077010.md): no more threads execute semaphore code.



<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=semaphore.gif)
...
<a name="how_implement_semaphore_ELTTEXTE000250"></a>


### Steps:
<a name="steps_ELTPARAGRAPHE000091"></a>
...
### Remarks
<a name="remarks_ELTPARAGRAPHE000118"></a>
...
<a name="functions_for_managing_semaphores_ELTPARAGRAPHE000145"></a>The following WLanguage functions are used to manage semaphores:
