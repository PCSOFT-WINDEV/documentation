...
`<WDPic image>.DrawChord(<Rectangle> , <X3> , <Y3> , <X4> , <Y4> [, <Background color> [, <Line color>]])`
---
...
### Limitations
<a name="limitations_ELTPARAGRAPHE000660"></a>
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) **Limitation for function &lt;WDPic variable&gt;.DrawChord**: Opacity defined with function [&lt;WDPic variable&gt;.Background](../WDLang1/1000024481.md) is not taken into account.
<a name="NOTE0_6"></a>
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) 

### Drawing in Browser code
<a name="drawing_browser_code_ELTPARAGRAPHE000817"></a>
