...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003036053&name=fselect_function">See additional examples</a>
...
- The operating system may not use this directory, especially if it has saved a more convenient location based on the user's previous choices. 
...
| *fselExist* | If this constant is combined:<br><br>- with *fselCrée*: Returns the name of the selected file. If the file already exists, a dialog box displays and allows the user to overwrite the former file.<br><br>- with *fselOuvre* Returns the name of the selected file only if it exists.<br><br><br> |
...
| *fUnicodePath* | &lt;Result&gt; will be a Unicode string. <br><br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) This constant is ignored. |
...
<a name="default_extension_when_creating_file_with_the_fselcreate_constant_ELTPARAGRAPHE000244"></a>
...
<a name="default_extension_when_opening_file_ELTPARAGRAPHE000335"></a>
...
<a name="clicking_file_found_the_file_picker_ELTPARAGRAPHE000342"></a>
...
<a name="selecting_directories_ELTPARAGRAPHE000358"></a>
...
<a name="network_drives_manifest_and_uac_ELTPARAGRAPHE000372"></a>
...
<a name="examples_file_pickers_ELTPARAGRAPHE000389"></a>

![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) The Windows file picker is as follows:
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=SelecteurFichiers.gif)


**Note**: Under Windows Vista (and higher), the Windows Vista file picker is open.



![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) The Linux file picker is as follows: 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=SelecteurFichiers_LX.gif)
...
[fImageSelect (Function)](../WDLang1/3036037.md)
...
[URISelect (Function)](../WDLang1/1000024026.md)

[AlbumPicker (Function)](../WDLang1/1000020186.md)
