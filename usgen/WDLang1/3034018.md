...
| --- | --- | --- |
| **edEndProgram** | User manipulation of the standard exception window: The user has not checked the "Relaunch application" option. | [ExceptionDisplay](../WDLang1/1000019408.md) |
| **edRelaunchProgram** | User manipulation of the standard exception window: The user has checked the "Relaunch application" option. | [ExceptionDisplay](../WDLang1/1000019408.md) |
...
| **epCode** | Current mode: the error is processed by programming (function return value test, use of [ErrorOccurred](../WDLang1/3087001.md), etc.)<br>Standard operating mode of exceptions. | [ErrorChangeParameter](../WDLang1/3034009.md),<br>[ExceptionChangeParameter](../WDLang1/3034007.md) |
| **epExecuteProcedure** | Runs the procedure specified as parameter. | [ErrorChangeParameter](../WDLang1/3034009.md),<br>[ExceptionChangeParameter](../WDLang1/3034007.md) |
...
| **epGotoCaseError** | Executes the code defined by the label: CASE ERROR: | [ErrorChangeParameter](../WDLang1/3034009.md) |
| **epGotoCaseException** | Executes the code defined by the label: CASE EXCEPTION: | [ExceptionChangeParameter](../WDLang1/3034007.md) |
...
| **errFIC** | Full name of the table (.FIC) associated with the error | [ErrorInfo](../WDLang1/3013008.md), [ExceptionInfo](../WDLang1/3034006.md) |
...
| **errLink** | Name of the link associated with the error | [ErrorInfo](../WDLang1/3013008.md), [ExceptionInfo](../WDLang1/3034006.md) |
...
| **errFullComponentName** | Name of the component currently run:<br><br>- "" no component.<br><br>- "Component1": "Component1" component used directly in the project.<br><br>- "Component1.Component2": "Component2" component used from "Component1".<br><br><br> | [ErrorInfo](../WDLang1/3013008.md), [ExceptionInfo](../WDLang1/3034006.md) |
| **errRecNum** | Number of the record associated with the error | [ErrorInfo](../WDLang1/3013008.md), [ExceptionInfo](../WDLang1/3034006.md) |
| **errOrigin** | HFSQL Client/Server: provides direct access to the first error triggered on the HFSQL server. | [ExceptionInfo](../WDLang1/3034006.md) |
...
| **exceptionWarning** | Error level to be triggered: warning exception | [ExceptionThrow](../WDLang1/3034005.md) |
| **exceptionError** | Error level to be triggered: error exception | [ExceptionThrow](../WDLang1/3034005.md) |
| **exceptionInformation** | Error level to be triggered: information exception | [ExceptionThrow](../WDLang1/3034005.md) |
