...
- &lt;DisplayMode&gt; = False: The greyed-out buttons are drawn like this:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=StyleDessin_stylePictoGrise11_2.GIF)
 **Warning** If the button doesn't contain any black pixels, the grayed-out version won't draw anything.

- &lt;DisplayMode&gt; = True: The buttons are drawn in grayscale:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=StyleDessin_stylePictoGrise11_1.GIF)
