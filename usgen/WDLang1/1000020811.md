...
The **Icon** type is used to define the advanced characteristics of an icon. You can define and change the characteristics of this icon using different WLanguage properties.
...
<a name="properties_specific_icon_variables_ELTPARAGRAPHE000025"></a>
...
<a name="functions_that_use_icon_variables_ELTPARAGRAPHE000093"></a>
