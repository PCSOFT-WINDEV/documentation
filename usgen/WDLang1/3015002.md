...
|   |   |
| --- | --- |
| [EndEvent](../WDLang1/3015010.md) | Cancels the interception of a Windows event on a WINDEV field or window (set up using the [Event](../WDLang1/3015011.md) function). |
