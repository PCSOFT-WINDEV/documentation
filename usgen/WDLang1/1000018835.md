...
<a name="operating_mode_dynamic_audit_ELTPARAGRAPHE000261"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Note** Dynamic auditing can also be started using the ".wx" file next to the. For more details, see [Dynamic audit](../Editeurs/1014502.md).


### Miscellaneous
<a name="miscellaneous_ELTPARAGRAPHE000283"></a>
