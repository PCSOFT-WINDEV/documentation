...
Position of the row to move. This position must be included between 1 and the number of rows found in the List Box or Combo Box control (returned by [ListCount](../WDLang1/3049014.md) or [Occurrence](../Proprietes/2510097.md) for example).

To move the row that is currently selected, use the *rowSelected* constant.

**`<Destination row index>: (entier)`**

New row position. This position must be between 1 and the number of rows in the List Box or Combo Box control (returned by [ListCount](../WDLang1/3049014.md) or [Occurrence](../Proprietes/2510097.md), for example). A fatal error occurs if this parameter is not valid.
...
Position of the row to move. This position must be included between 1 and the number of rows in the List Box control (returned by [ListCount](../WDLang1/3049014.md) or [Occurrence](../Proprietes/2510097.md) for example).
...
<a name="operating_mode_combo_box_control_ELTPARAGRAPHE000239"></a>
...
<a name="multiselection_list_box_control_ELTPARAGRAPHE000250"></a>
...
### Error management
<a name="error_management_ELTPARAGRAPHE000265"></a>
...
[&lt;List Box&gt;.MoveLine (Function)](../WDLang1/1000017322.md)
