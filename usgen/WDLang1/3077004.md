...
| *&lt;light HFSQL context&gt;* | Triggers the immediate copy of a part of the current HFSQL context. <br>Only the directories containing the tables in HFSQL Classic mode and/or the connections in HFSQL Client/Server mode are stored.<br><br>This extension attribute must be used with **&lt;thread&gt;**. |
