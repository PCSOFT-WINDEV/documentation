...
**Note**: These functions are also available in prefix syntax ([Window functions (prefix syntax)](../WDLang1/1410088865.md)).
...
- on how to handle menus programmatically, see [Menu functions](../WDLang1/3038016.md)
...
| [ChangeSkinTemplate](../WDLang1/3013026.md) | Dynamically changes the theme: <br><br>- of all windows found in the current application, <br><br>- of the windows found in the WINDEV components used by the application,<br><br>- of a specific window found in the project.<br><br><br> |
...
| [Use](../WDLang1/3038044.md) | Opens a WINDEV window and closes all other previously open windows. |
| [WaitWindowEnd](../WDLang1/1000023417.md) | Closes the waiting window of the application opened with [WaitWindowStart](../WDLang1/1000023416.md). |
| [WaitWindowStart](../WDLang1/1000023416.md) | Opens the loading window of application. |
...
| [WinCopyForm](../WDLang1/1000018992.md) | Copies the content of a form to the clipboard. |
...
| [WinInHeight](../WDLang1/3038037.md) | Returns the interior height of a window (without title bar and border). |
...
| [WinInWidth](../WDLang1/3038031.md) | Returns the interior width of a window (without border). |
| [WinInXPos](../WDLang1/3038017.md) | Returns the horizontal position of the upper-left corner of the internal area (without border and title bar) of a window in relation to the upper-left corner of the screen. |
| [WinInYPos](../WDLang1/3038011.md) | Returns the vertical position of the upper-left corner of the internal area (without border and title bar) of a window in relation to the upper-left corner of the screen. |
...
| [WinOutHeight](../WDLang1/3038032.md) | Returns the outer height of a window. |
| [WinOutWidth](../WDLang1/3038029.md) | Returns the full width of a window. |
...
| [WinStatus](../WDLang1/3038030.md) | Gets or sets the window state. |
