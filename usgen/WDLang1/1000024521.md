...
Draws a polygon in an [WDPic](../WDLang1/1000023503.md) variable.![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) **Caution**: In Linux, this function requires a specific configuration. For more details, see [Drawing in WINDEV, WEBDEV and WINDEV Mobile](../WDLang1/3029035.md). 
<a name="Exemple1"></a>
...
### Coordinates
<a name="coordinates_ELTPARAGRAPHE000794"></a>Drawing a polygon:
...
<a name="drawing_browser_code_ELTPARAGRAPHE000942"></a>
