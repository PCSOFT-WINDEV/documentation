...
<a name="table_fieldhierarchical_file_table_changes_the_linked_table_ELTPARAGRAPHE000356"></a>
...
- **If the cascading input is not enabled**, the content of table linked to the control is not modified. To write the content of inserted row into the linked table, [&lt;Table&gt;.Save](../WDLang1/1000024249.md) must be called after **&lt;Table&gt;.InsertLineWithAnimation**. 
...
A virtual row is created each time **&lt;Table&gt;.InsertLineWithAnimation** is called in a Table or TreeView data-bound Table control. The information will be saved in the table during the call to [&lt;Table&gt;.Save](../WDLang1/1000024249.md).
