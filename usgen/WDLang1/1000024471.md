...
**Remark**: Function **&lt;WDPic variable&gt;.StartDrawing** initializes all parameters required to create (or continue) a drawing for a given element.
...
1. Start the drawing with **&lt;WDPic variable&gt;.StartDrawing** using the *dDisplayManual* constant. 
...
| [&lt;WDPic variable&gt;.Pen](../WDLang1/1000024636.md) | Declares the color of the lines and their opacity for the next drawings. |
	...
	**Remark**: The [&lt;WDPic variable&gt;.PixelOpacity](../WDLang1/1000024498.md) function is used to determine the opacity of a point.
...
**Limit** In "Opacity management" mode, the [&lt;WDPic variable&gt;.DrawText](../WDLang1/1000024676.md) function is limited to the use of TrueType fonts.
<a name="NOTE0_5"></a>
<a name="NOTE0_6"></a>
