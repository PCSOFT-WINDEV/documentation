...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) &lt;X&gt; and &lt;Y&gt; parameters are optional. If these parameters are not specified, the mouse event to simulate is run in the middle of the window or control.![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This parameter must be specified.
