...
### Where to use gLink
<a name="where_use_docparampagetitleshort_ELTPARAGRAPHE000107"></a>
...
```wl
ListAdd(COMBO_COMBO1, gLink("1") + "Monsieur")
// or
...
### Added value
<a name="added_value_ELTPARAGRAPHE000121"></a>
...
### Case sensitivity
<a name="case_sensitivity_ELTPARAGRAPHE000145"></a>
...
<a name="autofilled_combo_boxes_ELTPARAGRAPHE000162"></a>
...
### Retrieved element
<a name="retrieved_element_ELTPARAGRAPHE000172"></a>
...
### Scheduler control
<a name="scheduler_control_ELTPARAGRAPHE000193"></a>
...
// Meeting is the table that describes the available meeting rooms
...
<a name="special_case_combo_box_control_combo_table_control_field_ELTPARAGRAPHE000214"></a>
...
[gLinkActivate (Function)](../WDLang1/3029036.md)
