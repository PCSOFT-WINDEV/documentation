...
| **acpDirection** | Scroll direction. "Scrolling" animation only.<br>These parameters can be combined.<br>1 (default): left to right.<br>2: right to left.<br>4: from bottom to top.<br>8: top to bottom.<br>Example of combination:<br>3 (2+1): left right: gradual widening from the center.<br>5 (4+1) from bottom to top and from right to left. | [AnimationSetParameter](../WDLang1/3017002.md)<br>[AnimationGetParameter](../WDLang1/3017003.md) |
...
| **acpDuration** | Amount of time for displaying each drawing of the animation in milliseconds (300 ms by default). | [AnimationSetParameter](../WDLang1/3017002.md)<br>[AnimationGetParameter](../WDLang1/3017003.md) |
| **acpLoop** | <br><br>- Image animation: Continuous playback of image drawings from the first to the last (this parameter is <u><u><u><u>True</u></u></u></u> by default).<br><br>- Label animation: Text dequeues in a loop. <br>	<br><br><br> | [AnimationSetParameter](../WDLang1/3017002.md)<br>[AnimationGetParameter](../WDLang1/3017003.md) |
| **acpNbBoucleMax** | Maximum number of loops when dequeueing a label. <br>"Scrolling" animation only.<br><br> | [AnimationSetParameter](../WDLang1/3017002.md)<br>[AnimationGetParameter](../WDLang1/3017003.md) |
