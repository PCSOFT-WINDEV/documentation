...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) TreeView Table control: 
...
```wl
// Expands or collapses the first row of "TVT_Schedule"
...
### Hierarchical table: Wrap or unwrap a branch by specifying the line number
...
### Hierarchical table: Wrap or unwrap a branch by specifying its name
...
### Table with breaks: Winding or unwinding a break
...
This function cannot be used on the data-bound Table controls (direct access).
<a name="NOTE0_2"></a>
