...
`<picLayer image>.DrawChord(<Rectangle> , <X3> , <Y3> , <X4> , <Y4> [, <Background color> [, <Line color>]])`
---
...
The **&lt;picLayer variable&gt;.DrawChord** function can only be used to draw a chord: contour only or chord area.. To draw a solid figure (portion defined by the center of the circle and the two points on the circle), use [&lt;picLayer variable&gt;.DrawSlice](../WDLang1/1000024561.md).
<a name="NOTE0_4"></a>
<a name="NOTE0_5"></a>
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) **Limitation for function &lt;picLayer variable&gt;.DrawChord**: Opacity defined with function [&lt;picLayer variable&gt;.Background](../WDLang1/1000024480.md) is not taken into account.
<a name="NOTE0_6"></a>
