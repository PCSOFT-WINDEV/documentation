...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) No animation can be played when the controls are grayed.
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) This parameter is ignored. No animation can be played when the controls are grayed.
...
<a name="animating_group_controls_ELTPARAGRAPHE000116"></a>
