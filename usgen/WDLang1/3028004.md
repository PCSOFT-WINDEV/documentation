...
- in C: APPELDDE("Send,Recipient,subject,info")

- in Turbo Pascal Windows: APPELDDE('Send,Recipient,subject, info')

- in Visual Basic Windows: call APPELDDE("Send,Recipient,subject, info")
