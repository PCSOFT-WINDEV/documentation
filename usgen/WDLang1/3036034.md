...
**Note**: These functions are also available in prefix syntax ([Functions for handling directories and external files (prefix syntax)](../WDLang1/1410089370.md)).
...
| [fDataDir](../WDLang1/3036001.md) | Returns the full path of the directory of HFSQL tables specified by the user when installing the application. |
| [fDataDirCommon](../WDLang1/3036070.md) | Returns a directory path for the data shared: <br><br>- between all the users of the computer<br><br>- between all the TSE users<br><br><br>This directory can be used without restriction in Windows XP, Vista, and so on. This directory is used to store:  <br><br>- the files for the general configuration of the application (.INI files, .XML files, etc.). <br><br>- tables common to all users (HFSQL tables .fic, .ndx, .mmo).<br><br><br> |
...
| [fExtractPath](../WDLang1/3036026.md) | Returns the different elements of a path: drive, directories, name and extension of the file. |
...
| [fIsImage](../WDLang1/1000019411.md) | Determines whether a file on disk or in a buffer corresponds to an image format recognized by WINDEV or WEBDEV. |
...
| [fLoadText](../WDLang1/3036006.md) | Loads the contents of a text file into any text field or variable (string variable, window edit control, report label field, etc.). |
...
| [fSaveText](../WDLang1/3036046.md) | Creates and fills a text file with the content of a text control or text variable (string variable, edit control in a window, Static Text control in a report, ...). |
...
| [fWatchDirectory](../WDLang1/1000020523.md) | Detects changes made to the contents of a directory. |
| [fWatchFile](../WDLang1/1000020522.md) | Starts watching a file. |
| [fWatchStop](../WDLang1/1000020575.md) | Stops watching a file or directory. |
| [fWatchStopAll](../WDLang1/1000020576.md) | Stops all current watch tasks of files and directories. |
