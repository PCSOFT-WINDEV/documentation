...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![IOS Widget](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) a date time to a string in the specified format
...
<a name="SYNTAXE2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![IOS Widget](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) 
...
Format of the converted date and time. This parameter can contain a word, a phrase, ... The specific characters representing the various elements of the date and time will be automatically replaced by their value identified in the string &lt;Date et heure&gt;. In this string:
...
|   |   |
| --- | --- |
| *maskDateEmail* | The format used corresponds to the date format of the RFC-5322 standard used to encrypt an email, an RSS feed, etc, ...<br>The result is expressed in the local time zone. <br><br>![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Not available. |
| *maskDateEmailUTC* | The format used corresponds to the date format of the RFC-5322 standard used to encrypt an email, an RSS feed, etc, ...<br>The result is expressed in universal time (UTC). <br><br>![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) Not available. |
| *maskDateInternet* | The format used corresponds to the date format of the RFC-3339 standard used for international communications.<br>The result is expressed in the local time zone. |
| *maskDateInternetUTC* | The format used corresponds to the date format of the RFC-3339 standard used for international communications.<br>The result is expressed in universal time (UTC). <br><br>![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) Not available. |
| *maskDateRelativeDuration* | This format expresses the time elapsed (or to elapse) between today's date and the specified date. This format is expressed in natural language. The different formulations used can be configured in the project description for the current language:<br><br>1. On the "Project" tab, in the "Project" group, click "Description". <br><br>2. In the "Languages" tab:<br><br>	- select the language to configure.<br><br>	- select the "Date" tab.<br><br><br><br><br>3. Click the "Dates and Times in natural language" button. <br><br>4. Define (if necessary) the custom captions to use. These captions will be used:<br><br>	- for the result of **DateToString**.<br><br>	- for the controls that use the "Relative duration" display mask.<br><br><br><br><br><br><br><br>![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) Not available. |
| *maskDateSystem* | The format used corresponds to the format defined in the project description for the current language: <br><br>1. On the "Project" tab, in the "Project" group, click "Description". <br><br>2. Select the "Languages" tab then the "Date" tab. <br><br>3. The format used corresponds to:<br><br>	- the settings of the operating system, <br><br>	- the specified parameters (with the defined days and months).<br><br><br><br><br><br> |
...
<a name="validity_the_date_ELTPARAGRAPHE000500"></a>
...
### Date format
<a name="date_format_ELTPARAGRAPHE000513"></a>
...
<a name="special_case_parameter_parameter_not_specified_ELTPARAGRAPHE000541"></a>
...
[DateTimeToString (Function)](../WDLang1/1000025516.md)
