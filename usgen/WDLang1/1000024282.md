...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) In WINDEV: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TableSaisieLoupe1.gif)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TableSaisieLoupe2.gif)

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) In Android: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Android_TableSaisieLoupe.gif)
...
**Note** This function is ignored if the specified Table control uses a non-proportional scrollbar ("Proportional scrollbar" option unchecked in the "Detail" tab of the control description window). For more details on the magnifier, see [Characteristics of columns in a Table control](../WDChamp/1013333.md).
...
[TableInputSearch (Function)](../WDLang1/3074024.md)
