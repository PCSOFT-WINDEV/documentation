...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) This parameter is not available. The search is case sensitive. The search string doesn't have to be a complete word: it can be part of a word. 
