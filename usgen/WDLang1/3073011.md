...
| *scBtnFace* | Border of the button. |
...
| *scScrollBar* | Scrollbar. |
| *scWindow* | Background of window. |
| *scWindowFrame* | Border of the window. |
...
### Color
<a name="color_ELTPARAGRAPHE000232"></a>
...
[SysWindowsAccentColor (Function)](../WDLang1/1410090893.md)
