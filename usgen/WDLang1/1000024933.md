...
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) This parameter is mandatory. If the continent caption is specified, it must be in the language of the framework. 
