...
The **diagImage** type is used to define all the advanced characteristics of a diagram shape created from an image. You can define and change the characteristics of this shape using different WLanguage properties.
...
Note: The type **diagImage** type inherits from the [diagShape](../WDLang1/1410088082.md) type, all the properties of the [diagShape](../WDLang1/1410088082.md) type are available for the **diagImage**. These properties appear in italics in the list below.
