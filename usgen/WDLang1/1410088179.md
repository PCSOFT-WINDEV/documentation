...
**CAUTION: This type must not be used directly. It must be used only via the [diagShape](../WDLang1/1410088082.md) type (or one of its derived types).**
<a name="Exemple1"></a>
