...
- 3 "source" fields: these are the 3 fields displaying the extinguisher images. In the initialization code of these controls (server code), the [DndSource](../Proprietes/2510014.md) property specifies that these controls are the source controls for a programmed Drag and Drop. 
...
- 1 "destination" control: the image of the plan. The [DndTarget](../Proprietes/2510016.md) property is used in the initialization code of this control (server code). 
