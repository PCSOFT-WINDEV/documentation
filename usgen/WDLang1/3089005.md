...
| *scheduledTaskComplete* | Ends the execution of the task if the status of the task is set to *scheduledTaskExecution*. <br>Note: This action is asynchronous: the task will probably not have been completed by the end of the call to the **SchedulerTaskStatus**. |
| *scheduledTaskDisable* | Disables the specified task. |
| *scheduledTaskExecute* | Runs the task immediately regardless of its schedule. <br>Note: This action is asynchronous: the task will probably not yet be running at the end of the call to the **SchedulerTaskStatus**. |
