...
|   |   |
| --- | --- |
| *apArrayBaseIndex* | Sets the start index of arrays sent to ActiveX or Automation objects. <br>Possible values for &lt;Nouvelle valeur&gt;: 0 or 1<br><br> |
...
When using WLanguage arrays with ActiveX or Automation objects, WLanguage generates Automation arrays with indexes starting at 0.

Some ActiveX or Automation objects require arrays with indexes starting at 1.
...
[AutomationEvent (Function)](../WDLang1/3013059.md)
