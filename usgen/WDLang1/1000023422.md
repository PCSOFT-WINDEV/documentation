...
Identifier associated with a specific element of the TreeView control. This parameter corresponds to an empty string ("") by default. To associate an identifier with an element that is already created, use [&lt;TreeView&gt;.Modify](../WDLang1/1000023763.md).
...
### Branch of the leaf
<a name="branch_the_leaf_ELTPARAGRAPHE000302"></a>
...
<a name="priority_order_for_the_sort_ELTPARAGRAPHE000318"></a>
...
### Duplicates
<a name="duplicates_ELTPARAGRAPHE000334"></a>

Accepting duplicates must be done with great care (<em><em><em><em>tvAcceptDuplicate</em></em></em></em> constant. Indeed, a specific identifier must be managed to identify the level where the addition must be performed. For more details, see [Managing duplicates in the TreeView controls](../WDChamp/1013325.md).
...
When adding an existing element to a level, the function **&lt;TreeView&gt;.Add** returns <u><u><u><u>False</u></u></u></u> if the addition mode has not been defined with the constant *aAcceptDoublon*. The element is not added.
<a name="NOTE0_4"></a>


### Format of collapsed/expanded images
<a name="format_collapsedexpanded_images_ELTPARAGRAPHE000363"></a>
...
<a name="type_collapsedexpanded_images_ELTPARAGRAPHE000412"></a>
...
<a name="tip_branch_images_ELTPARAGRAPHE000438"></a>

Warning: If the image name does not change between two calls to the **&lt;TreeView&gt;.Add**function, the image is not reloaded into memory (even if its content has changed).
