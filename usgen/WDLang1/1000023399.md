...
### Managing assertions
<a name="managing_assertions_ELTPARAGRAPHE000077"></a>

The messages of **TestCheckFalse** will be written into the ADB log (at "Assert" level). For more details, see [Managing ADB logs](../Editeurs/9000108.md).
