...
Warning: This function can only be used with camera fields in compatible mode (option "Use older 'Video for Windows' APIs (compatibility)" checked in the field description). 

Note: This function is equivalent to [CameraConfigure](../WDLang1/1000022452.md).
<a name="Exemple1"></a>
