...
<a name="Exemple2"></a>
![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![User code (UMC)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 
```wl
...
### Conversion result
<a name="conversion_result_ELTPARAGRAPHE000313"></a>

The result of the conversion is a string or buffer in Unicode format. This string (or buffer) can therefore only be manipulated by variables and functions that handle the Unicode format.
...
### Conversion in PHP
<a name="conversion_php_ELTPARAGRAPHE000389"></a>
...
[&lt;Buffer&gt;.AnsiToUnicode (Function)](../WDLang1/1000026033.md)
