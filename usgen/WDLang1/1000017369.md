...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) No animation can be played when the controls are made invisible.
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) This parameter is ignored. No animation can be played when the control is made invisible.
