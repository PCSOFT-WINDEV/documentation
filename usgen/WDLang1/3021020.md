...
When typing a new message intended to the end user, WINDEV or WINDEV Mobile automatically displays the following window.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Assistant_question.gif)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Assistant_Saisie.gif)
...
When a question is typed, the following code is automatically generated:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Code_Question.gif)
...
When a question is typed, the following code is automatically generated:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=saisie_Code.gif)
...
3. Select the message to delete and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeSupprimerPropriete.gif).
