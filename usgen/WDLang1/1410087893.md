...
The **sysNotification** type is used to define all the advanced characteristics of an interactive system notification. You can define and change the characteristics of this notification using different WLanguage properties. 
...
Here is an example of a notification: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=NOTIF_FR.gif)
...
Note: Simple buttons always appear at the bottom of the notification. However, Edit and Combo Box controls appear in the order they have been defined.
<a name="NOTE0_2"></a>


### Properties specific to sysNotification variables
<a name="properties_specific_sysnotification_variables_ELTPARAGRAPHE000059"></a>
...
| ExpireOnReboot | Boolean | <br><br>- <u><u><u><u>True</u></u></u></u>: Discards the notification when the computer is rebooted. <br><br>- <u><u><u><u>False</u></u></u></u> (Default): Preserves the notification when the computer is rebooted. <br><br><br><br><br> |
...
| Inputs | Array of [sysNotificationInput](../WDLang1/1410088024.md) | "User input" controls of the notification. These can be either "text input" or "combo box" controls. <br><br>The controls appear from top to bottom in the order they were added to the array.<br><br>Note: There can be no more than 4 input controls in a notification. Additional controls will replace the previous ones. |
| LogoImageCrop | Integer constant | Cropping to be applied to the logo: <br><br>- *sysNotifNoCrop* (default value): Aucun contour, image carrée. <br><br>- *sysNotifCircleCrop*: Circle-cropped image.<br><br><br> |
