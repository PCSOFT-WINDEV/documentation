...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1001000017101&name=servicewaitstatus_function">See additional examples</a>
...
IF Res = -1 THEN
	Error(ErrorInfo())
ELSE
	Info("Status at end of timeout: " + TextStatus(Res))
END
```
