...
- **TableRestorePositionAndSelection** does not work on data-bound Table controls with ongoing movement (i.e. data-bound Table controls without proportional scrollbar).
