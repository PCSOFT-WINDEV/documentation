...
Identifies the opacity of a pixel in an image (in a variable of type [Image](../WDLang1/1000019650.md)) with an Alpha channel.
...
To specify that the drawing in the image supports opacity (Alpha channel), use [&lt;Image variable&gt;.StartDrawing](../WDLang1/1000024349.md) and the ***dWithOpacity*** constant.
<a name="NOTE0_4"></a>
