...
**Note**: When a field is sorted using the **&lt;Table&gt;.Sort**function, the images used to identify the sorting direction are not displayed in the columns..
...
<a name="sorting_table_treeview_databound_table_control_ELTPARAGRAPHE000350"></a>
...
Reminder: The [&lt;Table&gt;.SortedColumn](../WDLang1/1000024054.md) function is used to obtain a list of sorted columns.
<a name="NOTE0_4"></a>
