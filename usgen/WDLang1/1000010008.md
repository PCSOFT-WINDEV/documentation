...
// Equivalent to: TableCollapseAll(TABLEH_Planning)
```
...
`TableCollapse(<Table control> [, <Row number> [, <Break name>]])`
---
...
**Note for hierarchical table fields**: If the &lt;Line number&gt; or &lt;Branch name&gt; parameter corresponds to the branch contained in the first line, the entire hierarchy of the hierarchical table field is collapsed (equivalent to the [TableCollapseAll](../WDLang1/1000010003.md) function).
<a name="NOTE0_3"></a>
