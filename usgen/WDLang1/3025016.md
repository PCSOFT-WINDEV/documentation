...
**ControlAlias** does not change the contents of the control, it only changes the data binding. To update the controls with the values of the new data binding, use [FileToScreen](../WDLang4/3044210.md), [TableDisplay](../WDLang1/3074003.md), etc.
	...
	From version <B><B><B>17</B></B></B>, ***FieldAlias*** is kept for backward compatibility. This function has been replaced with ***ControlAlias***.

** function is retained for compatibility: this function does not manage data binding.. It is recommended to use the [DataBinding](../Proprietes/2510060.md) property.

## Voir aussi

[DataBinding (Property)](../WDLang1/2510060.md)
...
Name of the control, group of controls, Tab control, data-bound Table control, Table columns or window to be used. The data bindings of all the controls in the group, Tab control, data-bound Table control, Table columns or window will be modified.

![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Name of the control, group of controls, Tab control, data-bound Table control, table columns or page to be used. The data bindings of all the controls in the group, Tab control, data-bound Table control, Table columns or page will be modified.
...
Name of the control, group of controls, Tab control, data-bound Table control, Table columns or window to be used. The data bindings of all the controls in the group, Tab control, data-bound Table control, Table columns or window will be restored.

![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Name of the control, group of controls, Tab control, data-bound Table control, table columns or page to be used. The data bindings of all the controls in the group, Tab control, data-bound Table control, table columns or page will be restored.
...
will rename the CUSTOMER file as CUSTOMER2001 for the controls whose base file is "CUSTOMER". The controls with a binding to another table will not be modified.
<a name="NOTE0_2"></a>
...
This description corresponds to: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=LiaisonFichier%20-%20HC%20N%B0001.gif)
...
- 18: Prohibited data bindings on a table file
...
<a name="databound_table_control_ELTPARAGRAPHE000194"></a>

- On a data-bound Table control, only the bindings to the following elements are allowed:
...
- **ControlAlias** only changes the binding of the internal table to a data-bound Table control.
...
- It may happen that no browse is currently performed on the HyperFileSQL tables when an alias or a search key is modified. Once the data bindings have been changed by**ControlAlias**, it is recommended to call:

	- [HReadFirst](../WDLang4/3044051.md) or [HReadSeek](../WDLang4/3044050.md) before [FileToScreen](../WDLang4/3044210.md), 

	- [TableDisplay](../WDLang1/3074003.md) for a data-bound Table control based on a table.
