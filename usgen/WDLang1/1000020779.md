...
|   |   |
| --- | --- |
| *tlEveHovered* | Event hovered by the mouse in the TimeLine control. If no event is hovered over, &lt;Résultat&gt; will correspond to an array of 0 elements. |
| *tlEveSelected* | Event currently selected in the TimeLine control. If no event is selected, &lt;Résultat&gt; will correspond to an array of 0 elements. |
