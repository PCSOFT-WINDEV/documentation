...
2. In the code header, clck "If Error: by program".
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Erreur_auto1.gif&type=thumb)


3. The window that is displayed allows you to specify the type of automatic process to perform:
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Erreur_auto2.gif&type=thumb)
...
| ***opRelaunchProgram*** | Ends the application and automatically restarts the application.<br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This constant is not available. |
...
<a name="show_error_and_exit_application_ELTPARAGRAPHE000110"></a>If this option is selected, the following window will be automatically displayed if an error occurs in the application:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Erreur_auto_Fen1.gif)
...
<a name="show_error_and_resume_input_the_current_window_ELTPARAGRAPHE000127"></a>If this option is selected, the following window will be automatically displayed if an error occurs in the application:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Erreur_auto_Fen2.gif)
This window allows the user to:
...
<a name="display_the_error_and_let_the_user_decide_ELTPARAGRAPHE000145"></a>If this option is selected, the following window will be automatically displayed if an error occurs in the application:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Erreur_auto_Fen3.gif)
This window allows the user to:
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Remark**: if the "Feedback" component is included in the application (directly or via the "?" menu), the error report can be sent to the application provider. ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This option and "Display the error and resume the input in the current window" have the same operating mode.
<a name="NOTE2_7"></a>
