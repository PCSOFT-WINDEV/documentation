...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003050022&name=statcorrelation_function">See additional examples</a>
...
<a name="calculating_the_coefficient_correlation_ELTPARAGRAPHE000079"></a>

![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=STATcORReLATION1.gif) StatCorrelation("MyMatrix", 1, 3, False) returns 0,997054.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=STATcORReLATION2.gif) StatCorrelation("MyMatrix", 1, 3, False) returns 1.
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Statcorrelation3.gif) StatCorrelation("MyMatrix", 1, 3, False) returns 0.
<a name="NOTE0_2"></a>
...
<a name="number_elements_found_the_matrix_ELTPARAGRAPHE000094"></a>
...
### Error management
<a name="error_management_ELTPARAGRAPHE000113"></a>
...
[StatCovariance (Function)](../WDLang1/3050020.md)
