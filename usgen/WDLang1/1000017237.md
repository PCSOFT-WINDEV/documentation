...
- The total number of pages is not calculated in the following cases:
	...
	- if the calculation of the total number of pages exceeds 4 seconds for a data-bound Table control based on an HFSQL Client/Server table.
...
- The print characteristics are as follows:
	...
	- To ensure that the printout respects the background colors used for the different cells in the Table control, use the [AAFConfigure](../WDLang1/1000022108.md) function with the constant *faaImprimeEtatSurTable* as follows: 
...
[Print functions ](../WDLang1/3046065.md)

[Table control functions](../WDLang1/3074009.md)

[&lt;Table&gt;.Print (Function)](../WDLang1/1000024256.md)
