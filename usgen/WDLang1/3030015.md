...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003030015&name=exploreraccept_function">See additional examples</a>
...
- <u><u><u><u>Vrai</u></u></u></u> (valeur par défaut) pour accepter le "Drag and Drop" depuis l'explorateur, 
...
- **Si le paramètre &lt;Procédure WLangage&gt; n'est pas utilisé** : Après avoir exécuté la fonction **ExplorerAccept**, l'explorateur envoie l'événement WM_DROPFILES à la fenêtre ou au champ désigné. Il est alors possible de récupérer les informations provenant de l'explorateur avec la fonction [ExplorerRécupère](../WDLang1/3030009.md). 
...
<a name="windows_vista_superieur_ELTPARAGRAPHE000072"></a>Sous Windows Vista (et supérieur) avec le mécanisme de l'[UAC](../Editeurs/2025014.md) (contrôle des comptes utilisateurs) activé, le "Drag & Drop" n'est pas toléré par le système dans les cas suivants :
...
[ExplorerRetrieve (Function)](../WDLang1/3030009.md)
