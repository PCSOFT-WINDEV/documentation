...
| [ControlFindTextFirst](../WDLang1/1000020763.md) | Searches for and selects the first element corresponding to the text searched for in a window or field. |
| [ControlFindTextNext](../WDLang1/1000020764.md) | Finds and selects the next instance of the search text in a window or control. |
| [ControlFindTextPrevious](../WDLang1/1000020765.md) | Searches for and selects the previous element corresponding to the text searched for in a window or field. |
