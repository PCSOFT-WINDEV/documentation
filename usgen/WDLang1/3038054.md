...
2. In the window that appears, check "Enable animation" and select the animation parameters: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Anim_Fenetre2.gif)
...
4. In the window that appears, check "Enable animation" and select the animation parameters: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Anim_Fenetre2.gif)
