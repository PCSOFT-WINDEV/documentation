...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Remark: 

- The mechanism of general exceptions is not available.. Only the specific exceptions (WHEN EXCEPTION IN) are available. For more details, see [Management of specific exceptions](../WDLang1/3034003.md).

- You can also use [ExceptionChangeParameter](../WDLang1/3034007.md) with the *epExecuteProcedureOverall* constant in the project "Initialization" event.
...
<a name="declaring_several_processes_general_exceptions_ELTTEXTE000263"></a>


### Declaring the processes of general exceptions in the same process
<a name="declaring_the_processes_general_exceptions_the_same_process_ELTPARAGRAPHE000039"></a>
...
<a name="declaring_the_exception_processes_different_processes_ELTPARAGRAPHE000054"></a>
...
<a name="nesting_exception_processes_different_processes_managing_the_exception_via_higher_level_ELTPARAGRAPHE000068"></a>
...
## Main remarks
<a name="main_remarks_ELTTEXTE000299"></a>


### An exception process can only be used once
<a name="exception_process_can_only_used_once_ELTPARAGRAPHE000085"></a>
...
To re-enable an exception process once it has been used, call [ExceptionEnable](../WDLang1/3034002.md). **Caution**: this function must be handled with care.

![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) **For example** A general exception has been declared at both window and project level. 
...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) **For example** A general exception has been declared at page and project level. 
...
<a name="quality_wlanguage_code_for_processing_the_exception_ELTPARAGRAPHE000113"></a>
...
<a name="quality_the_code_following_exception_process_ELTPARAGRAPHE000120"></a>
...
- Use [SetFocusAndReturnToUserInput](../WDLang1/1410088107.md) to give control back to the user. 
	![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) This feature is not available.
...
## Special case
<a name="special_case_ELTTEXTE000335"></a>
...
<a name="exception_process_and_component_ELTPARAGRAPHE000164"></a>
...
<a name="exception_process_and_threads_ELTPARAGRAPHE000171"></a>
...
<a name="functions_for_managing_general_exceptions_ELTTEXTE000371"></a>
...
[Mechanism of specific exceptions](../WDLang1/3034003.md)
