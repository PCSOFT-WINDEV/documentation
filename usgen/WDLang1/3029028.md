...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
The graphic string management functions are mainly used to display graphic strings in: 

- rows in List Box or Combo Box controls, 
...
| [gLink](../WDLang1/3029043.md) | Adds an "invisible" value to an element of a List or Combo Box control.<br><br>Function kept for compatibility. It is recommended to use [gStoredValue](../WDLang1/1410088363.md). |
