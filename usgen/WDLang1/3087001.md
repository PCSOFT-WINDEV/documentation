...
- Fatal errors that are not processed cause the application to stop immediately. An error message is automatically displayed.
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) This message can be configured when creating the executable.

	- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Error messages can be customized when the site is deployed on the Web server. For more details, see [Customizing the errors](../WDAdmin/3539001.md).
