...
**Please note** In a WINDEV application, these particular DLLs **cannot be** functions [API](../WDLang1/3014005.md) or [CallDLL32](../WDLang1/3014003.md). Indeed, these DLLs do not comply with the WINAPI standard of Windows. These DLLs are used in the WINDEV projects as automation objects. For more details, see [Automation objects](../Motscles/1514014.md).
