...
|   |   |
| --- | --- |
| [FileToMemoryList](../WDLang1/3049007.md) | Populates a List Box or Combo Box control programmatically with the records from a table or query. |
...
| [ListDisplay](../WDLang1/3049005.md) | Refreshes a List Box, ListView or Combo Box control based on a table |
