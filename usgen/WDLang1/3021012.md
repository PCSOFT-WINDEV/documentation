...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **[Advanced dialog boxes](#NOTE3_1)**. 
...
- Information or error dialog boxes. For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fonctions_dialogue%20-%20HC%20N%B0004.gif)


- Question dialog boxes. For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fonctions_dialogue%20-%20HC%20N%B0007.gif)


- Confirmation dialog boxes. For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fonctions_dialogue%20-%20HC%20N%B0005.gif)
...
- ![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) **direct input**.
	This feature avoids creating a new window to allow the user to enter only one piece of information. You can use a simple dialog box and the [Input](../WDLang1/3021016.md) function to enable input (edit control or check box). The user can validate or cancel the input.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fonctions_dialogue%20-%20HC%20N%B0008.gif)


- **directive questions**.
	 Directive questioning consists in guiding the user in entering his answer, to avoid any ambiguity: the user answers a question using buttons containing the text of the action to be taken. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fonctions_dialogue%20-%20HC%20N%B0009.gif)
The [Dialog](../WDLang1/3021015.md) function proposes a wizard:
...
**Note: Message base for**directive query 
WINDEV proposes a list of messages. These messages cannot be deleted. They constitute the message database. 
All new messages are automatically added to the message database. By default, the message database is located in the WINDEV "Personal\\Message" directory. 
...
3. Select the message to delete and click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeSupprimeFavoris.gif).
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) include AAFs (Automatic Application Features). For example, the user will be able to associate a keyboard shortcut with each button, or to set the automatic execution of a button. 
	Note: From version 28 U1 onwards (version 280075), this feature is available by default for new projects.

- be fully customized. This allows you to automatically apply the theme of the current application or to use multilingual dialog boxes. 
...
**These functions are required to compile a Catalyst application**. They can also be very useful in your Windows applications. They allow for non-blocking dialog with the user. The application can give the user information or ask a question, but the code continues to run, even if the user is not in front of the screen or needs time to answer: program execution is not blocked. 
...
[DelayBeforeClosing (Function)](../WDLang1/3038040.md)
