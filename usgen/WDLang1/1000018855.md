...
If the condition fails, a dialog box containing the check details is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Erreur_Assertion.gif)
...
1. In the ribbon: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) On the "Project" tab, in the "Project" group, expand "Import" and select "WINDEV elements and their dependencies".

	- ![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) On the "Project" tab, in the "Project" group, expand "Import" and select "WINDEV Mobile elements and their dependencies".
...
[Debugger: Step-by-step project execution](../WDLang1/2019001.md)
