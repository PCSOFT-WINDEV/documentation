...
***In french: &lt;Variable WDPic&gt;.DessineRectangleDégradé***
...
// via yellow
MyWDPicImage.DrawRectangleGradient(10, 20, 100, 150, LightRed, LightBlue, 0, LightYellow, 30)
...
`<WDPic image>.DrawRectangleGradient(<X1> , <Y1> , <X2> , <Y2> , <Start color> , <End color> [, <Angle> [, <Color 3> [, <Distance color 3> [, <Color 4> [, <Distance color 4>]]]]])`
---
...
`<WDPic image>.DrawRectangleGradient(<X1> , <Y1> , <X2> , <Y2> , <Gradient>)`
---
...
`<WDPic image>.DrawRectangleGradient(<Rectangle> , <Start color> , <End color> [, <Angle> [, <Color 3> [, <Distance color 3> [, <Color 4> [, <Distance color 4>]]]]])`
---
...
`<WDPic image>.DrawRectangleGradient(<Rectangle> , <Gradient>)`
---
