...
- in the table linked to the control.
...
Name of the Table or TreeView data-bound Table control to be used. The current row of this Table control will be saved.
...
- a data-bound Table control or a TreeView data-bound Table control. 
...
### Updating the table linked to the Table or TreeView table control
<a name="updating_the_table_linked_the_table_treeview_table_control_ELTPARAGRAPHE000127"></a>

**TableSave** saves the current control row in the table linked to the control. The items are automatically assigned with the values of associated columns in the current row.
...
- **TableSave** only manages the table associated with the control. If some columns are linked to items found in other tables, these tables are not automatically managed.
...
- In the Check Box columns, the call to **TableSave** is implicit and it cannot be disabled. In any case, the modification of the value of the check box will be applied to the table.
...
### Cascading input and update of linked table
<a name="cascading_input_and_update_linked_table_ELTPARAGRAPHE000157"></a>

- **If the cascading input is enabled**, the table linked to the Table or TreeView Table control is automatically modified when the user goes to the next row (use of [TableAdd](../WDLang1/3074017.md), [TableAddLine](../WDLang1/3074006.md), [TableInsert](../WDLang1/3074025.md), [TableInsertLine](../WDLang1/3074026.md), [TableModify](../WDLang1/3074019.md) and [TableModifyLine](../WDLang1/3074028.md)). **TableSave** is useless.

- **If the cascading input is not enabled**, the table linked to the Table or TreeView data-bound Table control is not modified. To write the added or modified row into the linked table, [TableSave](../WDLang1/3074008.md) must be used after the addition or modification function.
...
### Locking and updating the table
<a name="locking_and_updating_the_table_ELTPARAGRAPHE000233"></a>

If the table is locked in the current process, **TableSave** saves the current row and unlocks the table.
<a name="NOTE0_6"></a>
...
[HAdd (Function)](../WDLang1/3044147.md)
