...
<a name="limits_maximum_number_columns_displayed_ELTPARAGRAPHE000100"></a>
...
<a name="databound_table_control_changes_the_linked_table_ELTPARAGRAPHE000111"></a>
...
If the cascading input is not enabled, the table linked to the data-bound Table control is not modified. To write the added column into the linked table,  [TableSave](../WDLang1/3074008.md) must be used after **TableAddColumn**.
...
<a name="databound_table_control_add_multiple_columns_ELTPARAGRAPHE000136"></a>

A virtual column is created each time **TableAddColumn** is called in a data-bound Table control based on a table. The information will be saved in the table during the call to [TableSave](../WDLang1/3074008.md).

If **TableAddColumn** is successively called in the same process without being followed by [TableSave](../WDLang1/3074008.md), only the FIRST call is effective (the following calls are ignored). Only one column is added to the data-bound Table control based on a table.
<a name="NOTE0_6"></a>


### Adding records to a data-bound Table control and Trigger
<a name="adding_records_databound_table_control_and_trigger_ELTPARAGRAPHE000157"></a>
...
[&lt;Table&gt;.AddColumn (Function)](../WDLang1/1000023607.md)
