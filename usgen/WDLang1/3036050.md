...
The directory picker is as follows (the appearance may change according to the system used)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fRepS%E9lecteur%20-%20HC%20N%B0001.gif)
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003036050&name=fselectdir_function">See additional examples</a>
...
| *fdFormerAspect* | Allows you to use the former directory picker (old style). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=SelectRep.gif)<br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This constant is not available. |
| *fUnicodePath* | &lt;Result&gt; will be a Unicode string.<br>![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) This constant is not available. |
...
To force the use of the Java directory picker, use the System property &lt;wd.prop.sel_rep_defaut&gt; property at application launch, passing it one of the following values: yes/o/yes/y/true/true. 
...
To force the display of a Java window that simulates the appearance and operation of the native Windows directory picker, use the system property &lt;wd.prop.sel_rep_windows&gt; property at application launch, passing it one of the following values: yes/o/yes/y/true/true. 
