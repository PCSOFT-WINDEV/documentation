...
**Note**: These functions are also available in prefix syntax ([Functions for managing Table controls (prefix syntax)](../WDLang1/1000024319.md)).
...
|   |   |
| --- | --- |
| [BuildBrowsingTable](../WDLang1/3074002.md) | Creates a Table control from the items of a table (view or query). |
| [FileToMemoryTable](../WDLang1/3074005.md) | Populates a Table control programmatically with the records from a table, HFSQL view or query (query created in the query editor or with [HExecuteSQLQuery](../WDLang4/3044084.md)). |
| [JSONToTable](../WDLang1/1410090328.md) | Populates a Table or TreeView Table control with the contents of a JSON string or variable. |
...
| [TableDeleteAll](../WDLang1/3074034.md) | Deletes all rows from: <br><br>- a Table control populated programmatically, <br><br>- a TreeView Table control populated programmatically, <br><br>- tables displayed in a Combo Box control.<br><br><br> |
...
| [TableDisplay](../WDLang1/3074003.md) | Refreshes a Table or TeeeView Table control from a given position:<br><br>- for a field linked to a file: changes made to the linked table are reflected in the field..<br><br>- for a programmatically manipulated field: calculated columns are re-calculated.<br><br><br> |
| [TableEnableFilter](../WDLang1/1000017149.md) | Implements a user filter on a column found in a Table or TreeView Table control. |
| [TableEnd](../WDLang1/3074013.md) | Stops the manual iteration of table linked to a data-bound Table control. |
...
| [TableInputInProgress](../WDLang1/3074023.md) | Indicates whether or not a Table or TreeView Table control is in edit mode. |
| [TableInputSearch](../WDLang1/3074024.md) | Enables input in the search area in the column title of the Table or Treeview Table control. |
| [TableInsert](../WDLang1/3074025.md) | Inserts a row into: <br><br>- a Table control, <br><br>- a TreeView Table control,<br><br>- tables displayed in a Combo Box control.<br><br><br> |
...
| [TableModify](../WDLang1/3074019.md) | Modifies a row in: <br><br>- a Table control, <br><br>- a TreeView Table control, <br><br>- tables displayed in a Combo Box control.<br><br><br> |
...
| [TableRecNum](../WDLang1/3074027.md) | Returns the number of the current record in a data-bound Table control based on a table. |
...
| [TableSearch](../WDLang1/3074015.md) | Performs a search in: <br><br>- a Table control, <br><br>- a TreeView Table control, <br><br>- tables displayed in a Combo Box control.<br><br><br> |
...
| [TableSelectToFile](../WDLang1/3074038.md) | Positions on the table record corresponding to a row selected in the multi-selection data-bound Table control. |
| [TableSetFocus](../WDLang1/1000022319.md) | Gives focus to a line in a Table or hierarchical Table field: the field switches to input for the specified line and column. |
...
| [TableToJSON](../WDLang1/1410090327.md) | Converts the contents of a Table or TreeView Table control to a JSON string. |
