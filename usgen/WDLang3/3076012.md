...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **PABX application** In a PABX application, each line appears as a device. Therefore, to dial on a phone line, you must:
...
SWITCH ValueLineStatus 
	CAS telLigneOccupée: Message("Line is busy") 
	CAS telLigneDecrochée: Message("OK, connected") 
	CAS telLineNumber: Message("Dialing in progress") 
	CAS telLineTone: Message("Tone") 
	CAS telLigneRaccrochée: Message("The correspondent has hung up") 
	CAS telLigneAttendRéponse: Message("Search for correspondent") 
	CAS telLigneSonnerie: Message("Ringing at correspondent's home") 
END
```
...
Reminder: The list of telephony devices is known using the [tapiDeviceList](../WDLang3/3076024.md) function.
