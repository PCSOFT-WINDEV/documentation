...
- This function thoroughly studies Bluetooth emissions around the device to detect Beacons and to estimate how far they are. This database schema is energy-intensive: we therefore recommend calling this function only if at least one tag in the group is nearby. 
