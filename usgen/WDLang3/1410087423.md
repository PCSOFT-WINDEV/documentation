...
|   |   |
| --- | --- |
| *permBackgroundLocation* | Permission to access the device's location when the application is running in the background.<br><br>Warning: this permission must be requested alone, and after accepting the permissions corresponding to the constants *permLocation constants* or *permLocalisationPrecise constants*. |
