...
3. In this window:
	...
	- Set the characteristics of the conference control(s): type of data sent and received, display of video sent or received, etc, ...
			**Note**: These features can also be programmed (properties [Display](../Proprietes/2510010.md), [OutgoingData](../Proprietes/2510037.md), [Identifier](../Proprietes/2510036.md) and [IncomingData](../Proprietes/2510117.md)).
