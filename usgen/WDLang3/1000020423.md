...
Calling NFC functions modifies the AppIDs of the application in the Apple developer account. It is necessary to activate the "NFC Tag Reading" App ID.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Apple_APPID_NFC.gif&type=thumb)
