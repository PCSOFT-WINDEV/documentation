...
<DIV class="specObsolete">
	<IMG style="float:left;margin-right:10px;" src="$IMGLOCAL$=warning_big.png"><B>Warning</B><BR>
	 The FTP/RPC server is kept for compatibility.  It is recommended to use a standard FTP, SSH or SCP server. For more details, see [Communicating with an FTP server](../WDLang3/3040009.md). 
</DIV><a name="NOTE1"></a>
<a name="NOTE1_1"></a>
...
<a name="uploading_and_downloading_files_via_windev_ftp_rpc_the_rules_follow_ELTTEXTE000136"></a>
...
[Detailed use of WINDEV FTP/RPC](../WDLang3/3056010.md)
