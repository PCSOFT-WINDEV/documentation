...
| [SaaSAdminConnect](../WDLang3/1000019098.md) | Connects and authenticates the administrator of the SaaS web service. |
...
| [SaaSAdminListClient](../WDLang3/1000019116.md) | Lists the client accounts of SaaS web service database. |
...
| [SaaSAdminListSite](../WDLang3/1000019106.md) | Lists the SaaS sites declared in the database of a WEBDEV SaaS web service. |
...
| [SaaSSendSecurityCode](../WDLang3/1000022528.md) | Sends the security code to the users so that they can change their passwords. |
