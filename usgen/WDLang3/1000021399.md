...
- A WINDEV application or a WEBDEV website by [NotifPushSend](../WDLang3/1000020819.md).
...
WARNING: As of WINDEV Mobile 22 update 1, new projects must use Firebase to send push notifications. 
<a name="NOTE2_3"></a>
...
Note: The current version of the exchange format is "1.0".
<a name="NOTE2_5"></a>


### Notification format description: Correspondence between WLanguage properties of the Notification type
<a name="notification_format_description_correspondence_between_wlanguage_properties_the_notification_type_ELTPARAGRAPHE000112"></a>
...
| Format | WX_PROP_FORMAT | Character string in JSON format (see array below) |
...
### Description of the notification format: Correspondence between WLanguage properties of the notificationFormat type
<a name="description_the_notification_format_correspondence_between_wlanguage_properties_the_notificationformat_type_ELTPARAGRAPHE000231"></a>
...
**ATTENTION: this format is subject to change WITHOUT notice.**
