...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Android_notif1.gif)


They ca be expanded to show their details. 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Android_notif2.gif)
...
**Notification behavior change: use of notification categories**:
...
The end user can locally modify the parameters of an application's notification categories: activate/deactivate the display of category notifications, modify the priority of notifications, associate a particular sound, etc. These modifications are made from the application's notification settings screen: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Categorie_notification.gif)
...
A Toast is a furtive message that appears in the middle or at the bottom of the screen to inform the user. The user does not need to validate the message: it is displayed for a varying period of time.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ToastAffiche.gif)
