...
- Visit **URL** (Uniform Resource Locator): identify a resource through its means of access and location. 
	Examples: 
...
Example of URI: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=URI.gif)
...
<a name="properties_specific_uri_variables_ELTPARAGRAPHE000078"></a>

The following properties can be used to define the characteristics of URI variables:
...
| Diagram | Character string | Scheme found in the URI.<br><br>If changes are made, this property is mandatory and cannot be empty.<br><br>This property is available in read and write mode. |
...
| Host | Character string | <br><br>- Host of the URI,<br><br>- Empty string if not specified.<br><br><br>This property is available in read and write mode.<br><br>Warning: If the **Host** property is modified: <br><br>- properties **User** and **Password** properties are reset: these two properties must then be set to. <br><br>- the **Port** property is reset: the **Port** property must also be set. <br><br><br> |
...
| UserPassword | Character string | <br><br>- User password, <br><br>- Empty string if not specified.<br><br><br><br><br>**Secret strings**: If you use the secret string vault, the type of secret string used for this parameter must be "ANSI or Unicode string".<br>To learn more about secret strings and how to use the vault, see [Secret string vault](../Editeurs/1410087353.md). ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Secret strings are not available for this parameter in Android/Android widget applications.<br><br>This property is available in read and write mode. |
...
<a name="functions_that_use_uri_variables_ELTPARAGRAPHE000323"></a>The following functions handle URI variables: 
