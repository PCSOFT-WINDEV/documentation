...
| **snmpAccessUnknown** | Error: use [ErrorInfo](../WDLang1/3013008.md) to find out more about the problem. | [SNMPOIDAccess](../WDLang3/1000017077.md) |
...
| **snmpStatusDeprecated** | The OID is old: it has been replaced by one or more other OIDs, but its value is still filled in. | [SNMPOIDStatus](../WDLang3/1000017078.md) |
| **snmpStatusUnknown** | Error: use [ErrorInfo](../WDLang1/3013008.md) to find out more about the problem. | [SNMPOIDStatus](../WDLang3/1000017078.md) |
...
| **snmpTypeUnknown** | Error: use [ErrorInfo](../WDLang1/3013008.md) to find out more about the problem. | [SNMPOIDType](../WDLang3/1000017080.md) |
