...
1. Connect to an FTP server ([FTPConnect](../WDLang3/3040016.md)).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FTP_Connexion.gif)


2. Send and retrieve files (according to the connection mode). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FTP_Communication.gif)
...
3. Disconnect from the FTP server ([FTPDisconnect](../WDLang3/3040011.md)).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FTP_Deconnexion.gif)
