...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000019245&name=httpsendform_function">See additional examples</a>
...
This parameter can contain the port number for connecting to the server. The default value is 80 (corresponds to a server of Web pages). To specify a port number, use the following format: "&lt;Server URL&gt;**:**&lt;Port number&gt;". 
For example: http://www.windev.com:80.
...
- Additional HTTP header that will be added to the HTTP message. Caution: This string must end with a Carriage Return (CR).. 
...
|   |   |
| --- | --- |
| *mimeTypeMultiPartForm* | The message type corresponds to: "multipart/form-data" (mainly used for file transfer). |
| *mimeTypeSimpleForm*<br>(Default value) | The message type corresponds to: "application/x-www-form-urlencoded". |
...
<a name="SYNTAXE2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![IOS Widget](https://doc.pcsoft.fr/ext/images/us/WIDGETIOS.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 
...
Name of the [httpResponse](../WDLang3/1000021165.md) variable containing the response from the request.
...
Name of the [httpRequest](../WDLang3/1000021158.md) variable containing the parameters required to send the form.
...
<a name="security_error_secure_transaction_ELTPARAGRAPHE000209"></a>
...
- Syntax 1: **HTTP.IgnoreError** variable (see paragraph below). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) Syntax 2: **IgnoreError** property of the [httpRequest](../WDLang3/1000021158.md) variable.
...
END
```
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) The errors regarding the security of transactions are not returned by [ErrorInfo](../WDLang1/3013008.md) (the connection is refused). These errors cannot be ignored. The HTTP.IgnoreError variable is not available.
<a name="NOTE0_2"></a>


### Retrieval
<a name="retrieval_ELTPARAGRAPHE000305"></a>
...
<a name="accessing_passwordprotected_url_ELTPARAGRAPHE000314"></a>
...
### Using a proxy
<a name="using_proxy_ELTPARAGRAPHE000330"></a>
...
<a name="authentication_headers_ELTPARAGRAPHE000342"></a>
