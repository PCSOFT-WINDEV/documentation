...
## Principle
<a name="principle_ELTTEXTE000128"></a>
...
## Implementation
<a name="implementation_ELTTEXTE000152"></a>
Several WLanguage functions and 2 specific types can be used to manage Beacons. 

![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Please note: Beacon management on Android uses the Android Beacon Library module, which is subject to licensing. You must comply with this license, available from the WINDEV Mobile license.  
...
### Necessary version
<a name="necessary_version_ELTPARAGRAPHE000180"></a>
