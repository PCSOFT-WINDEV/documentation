...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003082014&name=zipadddirectory_function">See additional examples</a>
...
**Remark**: If the constant *zipEntête64* is used when creating the archive (function [zipCreate](../WDLang3/3082003.md)), it will be possible to create archives larger than 4 gigas..
Reminder: 
...
### Compression level
<a name="compression_level_ELTPARAGRAPHE000394"></a>
...
### Error codes
<a name="error_codes_ELTPARAGRAPHE000406"></a>
...
<a name="adding_file_that_already_found_the_archive_ELTPARAGRAPHE000428"></a>
...
<a name="index_files_the_archive_ELTPARAGRAPHE000437"></a>
...
- The index of the element. (Note: the index of an element can be known using the [zipFindFile](../WDLang3/3082002.md) function)
