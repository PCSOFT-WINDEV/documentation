...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003082027&name=zipchangepath_function">See additional examples</a>
...
- **Archives in 7z** format: The archive is fully compressed each time the **function is called zipChangePath**.
...
[&lt;zipArchive variable&gt;.ChangePath (Function)](../WDLang3/1000026329.md)
