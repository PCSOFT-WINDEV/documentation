...
Indicates whether the points found in a series of a 3D Scatter chart must be be projected on a given plane. In this case, a straight line will link the point to its projection on the corresponding plan.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=grSurfaceQuadrillage.gif)
