...
The **upnpDevice** type is used to define the advanced characteristics of a UPnP device. You can define and change the characteristics of the uPnP device using different WLanguage properties. 
...
<a name="wlanguage_functions_that_use_variables_type_docparampagetitleshort_ELTPARAGRAPHE000138"></a>
...
| [&lt;upnpDevice variable&gt;.ModifySharpness](../WDLang3/1000020992.md) | Changes the sharpness of a UPnP device. |
| [&lt;upnpDevice variable&gt;.ModifyVolume](../WDLang3/1000020993.md) | Change the volume of a UPnP device. |
...
[upnpImage (Variable type)](../WDLang3/1000020905.md)
