...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) MS Exchange client: the Email is deleted from the message box.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Lotus Notes or Outlook email: the email is deleted from the message box.
...
**Reminder** Before manipulating an Email (e.g. reading or deleting an Email), it is necessary to open a session with the [EmailStartSession](../WDLang3/3032028.md) function (for the POP3 protocol, MS Exchange), with the [EmailStartNotesSession](../WDLang3/3032121.md) function (for the Lotus Notes messaging software) or with the [EmailStartOutlookSession](../WDLang3/3032128.md) or [OutlookStartSession](../WDLang3/3032123.md) function (for the Outlook messaging software).
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003032027&name=emaildeletemessage_function">See additional examples</a>
...
<a name="using_the_pop3_protocol_ELTPARAGRAPHE000182"></a>
...
<a name="deleting_messages_and_number_incoming_messages_pop3_protocol_ELTPARAGRAPHE000206"></a>
...
**Warning: Gmail via a POP3 session** session: when using the **EmailDeleteMessage**function, the Email is marked as deleted but is not deleted. It is the standard operating mode of Gmail via POP3.
<a name="NOTE0_3"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![User code (UMC)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![Ajax](https://doc.pcsoft.fr/ext/images/us/AJAX.png) 

### Using MS Exchange Client, Lotus Notes or Outlook
<a name="using_exchange_client_lotus_notes_outlook_ELTPARAGRAPHE000238"></a>

The last message read is deleted from the incoming messages. This message will not be displayed anymore when the messages are browsed by [EmailReadFirst](../WDLang3/3032014.md) and [EmailReadNext](../WDLang3/3032004.md).
...
[EmailExpunge (Function)](../WDLang3/1000021553.md)
