...
To do so, connect to the portal and click "+" at the top right: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Push_IOS_1.gif)


The portal proposes to create a certificate: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Push_IOS_2.gif)
...
- Double-click the file name. The certificate is automatically added into the keychain access: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Push_IOS_3.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Push_IOS_4.gif)
