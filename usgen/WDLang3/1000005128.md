...
For DateTime columns, if the searched value corresponds to a character string, this string must use the format "YYYYMMDD", "YYYYMMDDHHMMSS" or "YYYYMMDDHHMMSSccc".
