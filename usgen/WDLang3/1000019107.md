...
Name of the [saasService](../WDLang3/1000019096.md) variable containing the description of service to add.

**`<SaaS site>: (saasSite variable)`**

Name of the [saasSite](../WDLang3/1000019068.md) variable corresponding to the SaaS site that receives the new service.
