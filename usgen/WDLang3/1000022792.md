...
1. In the "Project explorer" pane, right-click "REST web services descriptions" and select "New REST web service description". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Webservice_REST%20-%20HC%20N%B0001.gif)
...
The entry point creation wizard lets you select the creation method: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WebService_Rest_fichier%20-%20HC%20N%B0001.gif)


- [Method 1: Manual creation of entry points](../WDLang3/1410091004.md). 

- [Method 2: Automatic creation of entry points from the description of a table (present in the database schema)](../WDLang3/1410091004.md).
