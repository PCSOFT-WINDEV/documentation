...
3. Expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Projet_WD.gif) in the quick access buttons and select "Debug web service". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Test_WebService_Rest_Generer%20-%20HC%20N%B0001.gif)
The project is compiled. The following window appears. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Test_Webservice_Rest_Generer%20-%20HC%20N%B0002.gif&type=thumb)
...
WINDEV and WEBDEV include WDTestRest, a web service testing tool. This tool lists all the entry points of the web service to be tested. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=test%20Webservice_Rest_Generer%20-%20HC%20N%B0003.gif&type=thumb)
...
2. Generate the REST web service:  
	...
	- Method 2: Click the generation icon in the quick access buttons. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Webservice_Rest_Generer%20-%20HC%20N%B0001.gif)
