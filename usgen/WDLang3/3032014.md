...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) or via the MS Exchange client: the email received is stored on the local workstation in the MS Exchange inbox.
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003032014&name=emailreadfirst_function">See additional examples</a>
...
### The attached files
<a name="the_attached_files_ELTPARAGRAPHE000249"></a>
...
### Using MS Exchange
<a name="using_exchange_ELTPARAGRAPHE000267"></a>
...
### Progress Bar
<a name="progress_bar_ELTPARAGRAPHE000284"></a>
...
### Outlook messaging
<a name="outlook_messaging_ELTPARAGRAPHE000434"></a>
