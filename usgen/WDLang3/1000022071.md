...
Name of the WLanguage procedure (called "callback") called when a characteristic changes on the device. For more details on this procedure, see [Parameters of the procedure used by BTLECharacteristicChangeOfValue](../WDLang3/1000024784.md).
