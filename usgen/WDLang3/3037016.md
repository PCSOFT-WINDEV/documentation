...
**Note** The fax server may be a different extension from the current one. In this case, the fax server must be installed on a "Server 2003" computer and shared.
...
6. In the "General" tab, enable fax sending to send faxes from a WINDEV application or WEBDEV site.

7. Validate.


Note: To create a cover file (.Cov), use the "Cover page" tab.. 
<a name="NOTE2_3"></a>
...
Note: To create a cover file (.Cov), use the "Tool . Personal cover page".
<a name="NOTE2_4"></a>
...
<a name="configuring_the_fax_server_programmatically_ELTTEXTE000353"></a>
