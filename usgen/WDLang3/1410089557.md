...
Note: the JSON description of a token returned by a Web service contains the token's validity period. To determine the token's expiration date and time, you need to specify the date and time the token description was retrieved from the web service.
