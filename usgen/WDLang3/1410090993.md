...
10. The next step allows you to manage the hosting of SaaS websites. The SaaS activation automatically installs a website and a web service to manage your SaaS websites. For more details, see [SaaS](../WDLang3/9500213.md). Validate this step.
...
13. Specify the characteristics of the HFSQL server used for the BaaS service. 
	Note: This HFSQL server must have been previously installed (see prerequisites). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Install_serveur_store%20-%20HC%20N%B0003.gif)
...
16. Specify the password for the WDBaaS tables (existing or to be created).
