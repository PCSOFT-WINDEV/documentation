...
5. Select "Internal" or "External" as required, then click "CREATE". Different steps appear: 
	...
	- Step 1: OAuth consent screen: 
			Fill in the required fields: these fields relate to your application and/or company.
...
5. In the application dashboard: 
	...
	- For "OAuth 2", in the "Redirect URIs" option, specify: "http://localhost:29000" then click on "Add"..  
...
6. In the "Settings" tab, copy and save the following information: "App key" and "App secret".. 
...
10. Copy the secret value and ID (Warning: this information can only be copied once).
	This ID will be used to log in to the drive (**ClientSecret** property of the [OAuth2Parameters](../WDLang3/1000022212.md) variable).




Note: For iOS applications, use the redirect URL provided by Microsoft when adding a new platform.. 
