...
***In french: EmailLitEntêteDernier***
...
The variables of the [Email](../WDLang3/3032029.md) structure (or the properties of a variable of type [Email](../WDLang3/1000018713.md)) corresponding to the message header are specified.
...
### Reading the header of last email managed by the POP3 or IMAP protocol
...
### Reading the header of the last email managed via Lotus Notes or Outlook
...
<a name="the_email_structure_and_email_variables_ELTPARAGRAPHE000226"></a>
