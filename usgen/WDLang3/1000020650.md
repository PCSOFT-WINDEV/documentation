...
2. In your Android project, you create Widget windows. These windows contain all the features required by your widget. 
	...
	- Only 3 field types are available in Widget windows: [Button controls](../WDChamp/1013076.md), [Static Text controls](../WDChamp/1013179.md) and [Image controls](../WDChamp/1013218.md).
...
The user has the ability to add on the home screen as many instances of the same widget as necessary. Each of these instances will correspond to the same window instance: modifications made to the window will automatically be reflected in all instances displayed by the corresponding Widget.
...
Most of the functions available for Android applications are also available in widget mode. To easily identify these functions, the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=androidwidget.gif) icon appears in the bar of function platforms. 
...
[Developing an iOS 13 widget](../WDLang3/1000019925.md)
