...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) via the MS Exchange client: incoming emails are stored in the MS Exchange inbox. The next email is sought in the in-box and on the server.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) via Lotus Notes or Outlook e-mail software: incoming e-mails are stored in the Lotus Notes or Outlook inbox. The next email is sought in the in-box.
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003032004&name=emailreadnext_function">See additional examples</a>
...
### No next email
<a name="next_email_ELTPARAGRAPHE000248"></a>
...
<a name="initializing_the_reading_emails_ELTPARAGRAPHE000264"></a>
...
<a name="using_the_pop3_protocol_ELTPARAGRAPHE000276"></a>
...
### Using MS Exchange
<a name="using_exchange_ELTPARAGRAPHE000293"></a>
...
### Outlook messaging
<a name="outlook_messaging_ELTPARAGRAPHE000453"></a>
