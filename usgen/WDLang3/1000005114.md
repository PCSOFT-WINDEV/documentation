...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1001000005114&name=notesitem_function">See additional examples</a>
...
Name of the Lotus Notes item whose value you want to get.
...
Index of Lotus Notes item whose value you want to get. If this parameter is not specified, &lt;Result&gt; will contain all the values of the Lotus Notes item separated by CR characters.  
