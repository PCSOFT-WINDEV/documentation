...
Name and full path of BMP file to create. The file extension is mandatory. This BMP file is created during the call to **grSaveBMP**. The file is overwritten and recreated if it already existed.  
...
[&lt;Chart&gt;.SaveBMP (Function)](../WDLang3/1000024125.md)
