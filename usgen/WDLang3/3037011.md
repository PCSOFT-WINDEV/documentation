...
| **FaxCompleteStatus.InError** | Boolean<br><br>True: Indicates whether the fax has been abandoned for any reason (even by the user) |
| **FaxCompleteStatus.SentByCurrentConnection** | Boolean<br><br>True: Indicates whether a fax is sent via the connection specified in the [FaxStatus](../WDLang3/3037001.md) function by the &lt;Identifiant Connexion&gt; parameter. |
