...
OPC is a standard implementation based on OLE/COM for managing physical devices (automaton, alarms, captors, ...).
...
Note: In the remainder of this document, Automation objects and ActiveX will be referred to generically as "Automation objects".
...
**1. Indexes of arrays start from 1**
The source index of the arrays must be forced at the beginning of the initialization code of the project by the following line of code:
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OPC.gif)


If several values are found, it means that several OPC Automation objects are installed on the computer:

- the TypeLib subkey has a "(default)" value such as: {01704EB3-44B5-11D3-9C09-00105A3DD3AC}, which corresponds to the Automation object identifier
...
3. Seek the required OPC client: for example, "Siemens OPC DAAutomation 2.0" or "Matrikon OPC Automation 2.0".

4. Double-click on the tree line to display the description: a new window opens with a tree on the left and text on the right.
...
[AutomationParameter (Function)](../WDLang3/3013014.md)

[AutomationEvent (Function)](../WDLang3/3013059.md)
