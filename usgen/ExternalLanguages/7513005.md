...
This mode remains available with minor modifications for backward compatibility only. For more details, see [I used external languages in WINDEV 5.5. How to proceed with WINDEV 2026?](../LangageExt/7513006.md)
