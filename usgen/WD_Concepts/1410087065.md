...
For example, a diagram can represent a stock management system.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_UML_Diagramme_de_classe%20-%20HC%20N%B0001.gif)
...
For example, the behavior of a cell phone can be described via a use case diagram.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=UML_Cas_utilisation%20-%20HC%20N%B0001.gif)
...
- **Relationship**: describes the behavior of an actor with a use case. Three types of relationships are available:
	...
	- **Dependency**: Indicates that one element uses or depends on another element. For example, a bank customer may get cash from an ATM. In this case, the Get Cash action depends on the Customer.
			To withdraw money, the Customer must enter a PIN number. In this case, the Get Cash action depends on the Password Input.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=UML_Cas_utilisation2%20-%20HC%20N%B0001.gif)
	...
	- **Generalization**: Relationship in which elements are organized based on a hierarchy.
			...
			- there are two ways to verify the user's identity: a password or a fingerprint. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=UML_Cas_utilisation3%20-%20HC%20N%B0001.gif)
...
For example, the diagram below presents a section of the general structure of motorcycles:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_UML_Diagramme_Objets%20-%20HC%20N%B0001.gif)
...
For example, the diagram below presents the steps of a program that allows users to log in in text mode in Unix. The "login" program uses the data from the "etc/passwd" file and a library:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_UML_Diagramme_composants%20-%20HC%20N%B0001.gif)
...
For example, the following diagram presents the flow of a dam:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_UML_Diagramme_activite%20-%20HC%20N%B0001.gif)
...
For example, the following diagram represents the beginning of a phone call:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_UML_Diagramme_sequence%20-%20HC%20N%B0001.gif)
...
For example, the diagram below presents the process of a person using an elevator:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=UML_Diagramme_collaboration%20-%20HC%20N%B0001.gif)
...
For example, the diagram below presents the different steps for a car wash:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_UML_Diagramme_etat_transition%20-%20HC%20N%B0001.gif)
...
For example, the diagram below shows the different hardware components used in a company:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_UML_Diagramme_deploiement%20-%20HC%20N%B0001.gif)
