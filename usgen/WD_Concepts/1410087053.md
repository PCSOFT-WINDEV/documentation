...
- All processes (requests, read from and write records to a data file, etc.) are performed on each client computer.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P3-HFSQL%20Classic.gif)
