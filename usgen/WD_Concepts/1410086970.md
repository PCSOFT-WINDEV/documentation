...
- anchors to make the UI fit a given screen size, 

- a UI compilation system with error detection (empty titles, untranslated text, overlaps, etc.), 

- etc.

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_IHM%20Les%20fen%EAtres%20-%20HC%20N%B0001.gif&type=thumb)
