...
**Note**: Analyses are presented in detail in [Database schema: database structure](../Concepts_WD/1410087050.md).
...
<a name="creating_the_project_ELTTEXTE000340"></a>
**To create a project**:

1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Cr%E9er_cpt.gif) in the WINDEV quick access buttons. In the window that appears, click "Project". The project creation wizard opens. 
...
5. Specify the project name and location. These options cannot be modified. In WINDEV, the project corresponds to a ".WDP" file. This file can be opened by WEBDEV and WINDEV Mobile. For more details, see [Common project](../Editeurs/2030049.md).
...
<a name="dashboard_and_project_elements_ELTTEXTE000391"></a>


### Dashboard
<a name="dashboard_ELTPARAGRAPHE000069"></a>
...
2. Select "Display dashboard". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Tableau%20de%20bord%20-%20Afficher%20depuis%20menu%20ctx%20-%20HC%20N%B0001.gif)
...
### Project elements
<a name="project_elements_ELTPARAGRAPHE000099"></a>
...
<a name="operations_performed_project_ELTTEXTE000421"></a>
...
<a name="technical_documentation_the_project_ELTTEXTE000445"></a>
WINDEV allows you to print different technical documentations describing all the elements of the project (windows, reports, tables, items, etc.). To print the technical documentation:

- on the "Home" tab, in the "General" group, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Imprimer_cpt.gif) and select "Print project technical documentation". The technical documentation can contain all the characteristics of the project.

- on the "Home" tab, in the "General" group, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Imprimer_cpt.gif). In this case, the technical documentation will contain only the details of the current element (window, report, query, etc.).
...
<a name="type_technical_documentation_ELTPARAGRAPHE000188"></a>
...
### Print areas
<a name="print_areas_ELTPARAGRAPHE000219"></a>
