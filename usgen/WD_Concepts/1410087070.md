...
| --- | --- |
|   |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Audit%20statique%20-%20HC%20N%B0003.gif&type=thumb)<br> | Audit report, database schema of the library (to detect large files) and database schema of the installation package. <br><br>To start the static audit, go to the "Project" tab, "Audit and performance" group, expand "Static audit" and select "Start static audit". |
...
| --- | --- |
|   |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Audit%20dynamique%20-%20HC%20N%B0002.gif&type=thumb)<br> | Analyzes the performance of the application during a test and shows processes containing exceptions and errors that are not properly handled. <br><br>To start the dynamic audit, on the "Project" tab, expand "Test mode" and select "Debug and audit project". |
