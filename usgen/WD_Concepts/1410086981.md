...
## Types of editors
<a name="types_editors_ELTTEXTE000392"></a>
...
The data model editor allows you to describe the characteristics and structure of the tables.
...
- direct description of the database schema linked to the project (also called Logical Data Model (LDM)).

- description of the Conceptual Data Model (CDM) and automatic generation of the database schema.
...
- WYSIWYG editor ("What You See Is What You Get"). You can directly view all the tables and links of your project.

- Creation and description of the tables and their items.

- Automatic formatting of the database schema links.
...
- Independent table descriptions.

- Encryption of tables.

- Automatic modification of the tables when the structure of the tables changes.
...
- Insertion of comments in the graph of the database schema.

- Relation between the different panes and elements of the database schema.
...
The query editor allows you to automatically create queries based on tables. 
This simplifies programming and allows you to displayed data in windows, reports, Table or Combo Box controls based on queries.

Simply choose the items to include and enter the selection conditions in the query creation wizard. The query is automatically generated (in optimized SQL code) and can be tested immediately.
...
Multiple themes (style sheets associated with the window) and types of windows are available. They help you make your windows and applications more user friendly.
...
- Window themes and preset control styles.
...
- Report themes and preset control styles.
...
For more details on the report editor, see the online help.
<a name="NOTE2_7"></a>
...
For more details on the code editor, see the online help.
<a name="NOTE2_8"></a>
...
The help editor allows you to create a set of help pages (CHM or PDF file) based on your project.
...
- Compilation of help pages and creation of CHM or PDF files.
...
For more details on the help editor, see the online help.
<a name="NOTE2_9"></a>


### Image editor
<a name="image_editor_ELTPARAGRAPHE000281"></a>
...
For more details on the Image editor, see the online help.
