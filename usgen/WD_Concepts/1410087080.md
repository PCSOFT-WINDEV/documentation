...
- tables in HFSQL Classic format installed on the user computer,

- tables in HFSQL Classic format installed on a network and accessible from the user computer,

- tables in HFSQL Client/Server format installed on a server.
...
A network installation consists in creating a setup program that will be installed on a Server.

The network administrator installs the application from the server on the client computers using WDxxxAdminExe. 
