...
Multiple WLanguage functions are available to the users. However, the developer can set certain restrictions. For example, do not allow the use of file functions. To maintain data integrity, the commands to update or add records are not available to the users.
