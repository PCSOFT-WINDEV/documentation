...
- the report can be represented on the screen, as a file (HTML, RTF, etc.) or sent to a printer.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1-Edition-Les-Etats.gif)
