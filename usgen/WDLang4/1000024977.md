...
- the filter cannot be created: the function **&lt;Source&gt;.FilterIncludedBetween FUNCTION** function returns an empty string (""). [HError](../WDLang4/3044088.md) returns the error identifier.

- the filter is created: the **&lt;Source&gt;.FilterIncludedBetween** function returns the optimal route key to be used to route the table, view or query.
...
<a name="automatic_management_composite_keys_ELTPARAGRAPHE000264"></a>
...
<a name="filter_and_filtered_iteration_ELTPARAGRAPHE000303"></a>

After the call to **&lt;Source&gt;.FilterIncludedBetween**, the iteration must be performed on the item returned by **&lt;Source&gt;.FilterIncludedBetween**. The filter will be ignored if another item is used to loop through the table.
...
<a name="enablingdisabling_filter_ELTPARAGRAPHE000383"></a>
...
### Non-HFSQL tables
<a name="nonhfsql_tables_ELTPARAGRAPHE000413"></a>
