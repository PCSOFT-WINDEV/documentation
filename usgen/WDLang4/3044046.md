...
- connections described in the data model editor (for the main database schema and additional database schemas if required).
...
List of connections defined in the current database schema and/or by programming. 

**Projects with multiple database schemas** If several database schemas are in progress, all connections for all database schemas in progress are listed (without duplicates).
...
|   |   |
| --- | --- |
| *hLstAll* | Lists all the connections (connections of database schemas and connections defined dynamically by [HDescribeConnection](../WDLang4/3044205.md) or [HOpenConnection](../WDLang4/3044107.md)). |
