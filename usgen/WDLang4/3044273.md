...
### Setup
<a name="setup_ELTPARAGRAPHE000020"></a>
...
<a name="use_the_odbc_driver_hfsql_configure_the_odbc_driver_ELTPARAGRAPHE000031"></a>
...
8. Click "Browse" to select the WDD file corresponding to the database schema.

9. In the list of database schemas, select the requested database schema and the directory of the tables ("Browse" button). All the HFSQL tables corresponding to the selected database schema are grouped in this directory.
...
## Use
<a name="use_ELTTEXTE000173"></a>


### Using the ODBC driver on HFSQL from your Java program
<a name="using_the_odbc_driver_hfsql_from_your_java_program_ELTPARAGRAPHE000053"></a>
...
## Known problems
<a name="known_problems_ELTTEXTE000197"></a>
