...
`<Result> = HListConnectedUser(<Connection name> [, <Database> [, <Table physical name>]])`
---
...
**`<Table physical name>: (Optional character string)`**

Name of the table for which to get the current users. 
