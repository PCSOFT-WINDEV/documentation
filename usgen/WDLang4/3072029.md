...
**Note: This is the only SQL function that can be used with HFSQL functions (e.g. to perform transactions on an external database manipulated with HFSQL functions).**
...
| *sqlRollBack* | Rolls back the transaction. |
...
### Syntax 2: Executing a transaction on a connection
<a name="syntax_2_executing_transaction_connection_ELTPARAGRAPHE000121"></a>

To execute a transaction on a connection, you must:
