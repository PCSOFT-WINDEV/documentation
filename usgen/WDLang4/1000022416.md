...
The **mongoGridFS** type is used to define the advanced characteristics of a file system for a MongoDB database. The characteristics of this file system can be defined and modified using various WLanguage properties. 
...
<a name="properties_specific_mongogridfs_variables_ELTPARAGRAPHE000047"></a>
...
| Prefix | Character string | Prefix of collection. <br><br>Files will be stored in the collections as **&lt;prefix&gt;.files** and **&lt;prefix&gt;.chunck**. |
...
<a name="functions_that_use_the_mongogridfs_type_ELTPARAGRAPHE000080"></a>The following functions use the mongoGridFS type: 
...
**Remark**: These functions can also handle a MongoDB database.. In this case, the prefix corresponds to the default value "fs". 
