...
Restores the previously saved context of a table (function [HSavePosition](../WDLang4/3044136.md)): record in progress, filter, read pointers.
...
Name of the table whose context is to be restored. If this name is not specified, **HRestorePosition** will use the last table used by the last HFSQL function (function starting with "H").
...
- You can nest [HSavePosition](../WDLang4/3044136.md) and **HRestorePosition** for the same table.
