...
`<Result> = HInfoFileRights(<Authentication> , <User/Group> , <Rights> , <Database> , <Table> [, <Display mode>])`
---
...
## Remarks
To change the rights granted to a user or group on a table, use [HModifyFileRights](../WDLang4/3044327.md).
