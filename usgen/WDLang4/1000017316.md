...
<a name="read_uncommitted_isolation_level_ELTTEXTE000338"></a>
...
Let's consider a PRODUCT table with an item Art01 with a stock quantity of 10.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Isolation_ReadUncommitted.gif)
...
<a name="implementing_the_read_uncommitted_isolation_level_ELTPARAGRAPHE000087"></a>

To implement the READ UNCOMMITTED isolation level, you must: 

- Using HFSQL tables in Client/Server mode. 
...
- Use syntaxes that handle connections in transaction functions ([HTransactionStart](../WDLang4/3044002.md), [HTransaction](../WDLang4/1000023384.md), [HTransactionEnd](../WDLang4/3044032.md) and [HTransactionCancel](../WDLang4/3044001.md)). 
...
<a name="read_committed_isolation_level_ELTTEXTE000380"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Isolation_ReadCommitted.gif)
...
<a name="implementing_the_read_committed_isolation_level_ELTPARAGRAPHE000159"></a>
...
<a name="repeatable_read_isolation_level_ELTTEXTE000422"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Isolation_RepeatableRead.gif)
...
<a name="implementing_the_repeatable_read_isolation_level_ELTPARAGRAPHE000238"></a>
...
- Activate REPEATABLE READ mode in each transaction database schema table. This option is available in the "Details" tab of the table description window. An automatic modification of the tables is required to take this parameter into account. Warning: if this option is enabled, the table is incompatible with versions 18 and earlier.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RepeatableReadSupport%E9%20-%20HC%20N%B0001.gif)
...
**Tip** To find out whether REPEATABLE READ mode is activated on a table, use the [RepeatableReadSupported](../Proprietes/1000020959.md) property. 
