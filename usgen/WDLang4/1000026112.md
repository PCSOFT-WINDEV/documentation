...
| --- | --- |
| The connection associated with the tables in the query is defined automatically. | The connection to use must be specified in **&lt;Source&gt;.ExecuteSQLQueryAsynchronous**. |
