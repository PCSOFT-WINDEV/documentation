...
`<Result> = HInfoItemRights(<Connection> , <User/Group> , <Rights> , <Database> , <Table> , <Item> [, <Display mode>])`
---
...
## Remarks
To change the rights granted to a user or group on an item, use [HModifyItemRights](../WDLang4/1410089918.md).
