...
- The item can be handled like any database schema item.
...
`<Result> = HDescribeFullTextIndex(<Table> , <Full-text index>)`
---
...
Name of HFSQL table (described by [HDescribeFile](../WDLang4/3044206.md)).
...
2. Describe the characteristics of the table, its fields, links and full-text indexes using HFSQL properties.
...
5. Define the description of the table ([HDescribeFile](../WDLang4/3044206.md)) and the links ([HDescribeLink](../WDLang4/3044191.md)).
