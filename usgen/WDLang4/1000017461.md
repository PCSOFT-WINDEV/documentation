...
A **FullTextIndex description** variable is used to describe one or more full-text indexes programmatically. The characteristics of these indexes can be defined using different [WLanguage properties](#NOTE0_1)

To add the description of this index into the description of a table, use [HDescribeFullTextIndex](../WDLang4/1000017407.md). The "FullTextIndex Description" variable is reinitialized and it can be used to describe another full-text index programmatically.
...
HDescribeFile(AFile)
// Create the table named Customer (recognized because declared as data source)
HCreation(CUSTOMER)
// Create a record
...
<a name="properties_specific_the_description_fulltext_indexes_ELTPARAGRAPHE000074"></a>
...
<a name="how_describe_tables_programmatically_ELTPARAGRAPHE000177"></a>
