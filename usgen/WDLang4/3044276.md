...
- The Native SQL Server Connector via OLE DB corresponds to: 
	...
	- the wd310sqlserver.dll library (in 32-bit mode),

	- the wd310sqlserver64.dll library (in 64-bit mode).
...
- the wd310sqlserver2.dll library (in 32-bit mode), 

- the wd310sqlserver2_64.dll library (in 64-bit mode).
