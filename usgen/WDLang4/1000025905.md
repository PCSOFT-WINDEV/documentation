...
From this function, the queries executed on the connection passed as a parameter are part of a database schema to propose a set of keys to be added to your tables and improve the performance of your queries.

To obtain the result of the database schema, [HSuggestKeyEnd](../WDLang4/1000025906.md) must be executed. 
<a name="Exemple1"></a>
