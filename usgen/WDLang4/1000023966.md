...
<a name="location_and_access_tables_ELTPARAGRAPHE000402"></a>

Before calling **&lt;Connection variable&gt;.TransactionCancel**, the tables handled by the canceled transaction must be:
...
- cancel all the operations performed on the tables since the call to [&lt;Connection variable&gt;.TransactionStart](../WDLang4/1000023967.md) (or [&lt;Connection variable&gt;.Transaction](../WDLang4/1000023965.md)).
