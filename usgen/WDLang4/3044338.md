...
The date and time (with one-second accuracy) are taken from the moment [HAdd](../WDLang4/3044147.md), [HModify](../WDLang4/3044042.md), [HCross](../WDLang4/3044121.md), [HDelete](../WDLang4/3044018.md) or any functionality wrote to the tables (automatic modification of tables, import functions, reindexing, implementation of integrity rules, etc.).
