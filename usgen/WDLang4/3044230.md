...
- found in a table ( a query or a view) known to the HFSQL engine. The tables defined by [HDeclare](../WDLang4/3044203.md), [HDeclareExternal](../WDLang4/3044204.md) and [HDescribeFile](../WDLang4/3044206.md) are taken into account.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) found in a Record variable. 
...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003044230&name=hlistitem_function">See additional examples</a>

```wl
// Retrieve items of a table from current database schema
ItemList is string
...
### Listing the table items

`<Result> = HListItem(<Table> [, <Path of the WDD file> [, <Password of the WDD file> [, <Options>]]])`
---

**`<Result>: (Character string)`**

List of items found in the specified table. The descriptions of each item are separated by carriage returns. The result is more or less detailed depending on the constant used:
...
Name of the table (query or view) whose items will be listed.

If a query name is specified, the query must be running ([HExecuteQuery](../WDLang4/3044080.md) or [HExecuteSQLQuery](../WDLang4/3044084.md)) to use **HListItem**. Otherwise, a WLanguage error occurs.
...
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This parameter is ignored. The table is sought in the current database schema. 
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Secret strings are not available for this parameter in Android/Android widget applications.
...
List of items found in the specified [Record](../WDLang4/1000020962.md) variable . The descriptions of each item are separated by carriage returns. The result is more or less detailed depending on the constant used:
...
### Order of items
<a name="order_items_ELTPARAGRAPHE000392"></a>
...
<a name="displaying_the_result_list_box_combo_box_control_ELTPARAGRAPHE000401"></a>
...
### HFSQL type
<a name="hfsql_type_ELTPARAGRAPHE000413"></a>
