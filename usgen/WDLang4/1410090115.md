...
Checks whether the intersection of two geometries does not result in an empty set. 

**Remarks**: 

- To get the geometry corresponding to the intersection, use [GeometryIntersection](../WDLang4/1410090153.md). 

- Since **GeometryIntersect** does not return a result geometry, it is much faster than [GeometryIntersection](../WDLang4/1410090153.md). 
...
In a table, you can apply a filter on spatial data and loop through the table. For example, the filter can be based on the result of **GeometryIntersect**.
...
[&lt;PolygonGeo variable&gt;.Intersect (Function)](../WDLang4/1410090577.md)
