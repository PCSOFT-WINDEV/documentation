...
The ODBC driver for HFSQL Classic and HFSQL Client/Server is an ODBC driver of level 3. For more details, see a specific documentation.
...
## Setup
<a name="setup_ELTTEXTE000192"></a>


### Prerequisite: iODBC manager installation
<a name="prerequisite_iodbc_manager_installation_ELTPARAGRAPHE000030"></a>
...
The ODBC driver for Linux is supplied in 64-bit version in the "INSTALL\\ODBC" directory of the WINDEV, WEBDEV or WINDEV Mobile installation folder: wxpackodbclinux64.zip
...
Note: This script records the driver with iODBC. For more details, use: 
...
<a name="configuring_the_database_ELTTEXTE000222"></a>
...
<a name="configuring_data_source_via_the_graphic_tool_iodbc_ELTPARAGRAPHE000078"></a>

- Start the "iodbcadm-gtk" tool. 

- The following window appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iodbc1.gif)


- Click "Add". 

- In the list that is displayed, select the HFSQL driver and click "Finish". The following window appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iodbc2.gif)
...
- Enter the keys manually: 
	...
	- For an ISAM connection: 
		...
		- RepFic: .FIC file directory

		- Database schema: WDD path. This parameter is optional
...
- For a Client/Server connection: 
	...
	- Database schema: WDD path. This parameter is optional. <br>![Example for an ISAM connection](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iodbc3.gif)
...
<a name="manual_configuration_ELTPARAGRAPHE000111"></a>
...
- For each source, add the following lines into this file: 
	...
	- ISAM HFSQL source:
		...
		<Source Name> = HFSQL 
		[<Source Name>] 
		Driver = /path/vers/WD300hfo64.so 
