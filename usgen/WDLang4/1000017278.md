...
<a name="reconnection_the_server_ELTPARAGRAPHE000065"></a>
...
- The application has locked the entire table.

- The application has performed a "read/write" lock on a table.

- The application has performed a lock in "write mode" on a table and another application has modified this record while the application was not connected.
