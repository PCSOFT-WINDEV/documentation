...
- Changes the name of database associated with a table. In this case, the database name specified in the connection properties of table (in the data model editor) is ignored.
	To modify the connection parameters of a table not in HFSQL format, we recommend that you use [HDescribeConnection](../WDLang4/3044205.md) and [&lt;Source&gt;.ChangeConnection](../WDLang4/1000024199.md).
...
<a name="changing_the_name_table_ELTPARAGRAPHE000382"></a>

**&lt;Source&gt;.ChangeDir** can only be used to change the access path to the physical table. To change the physical name of the table, use [&lt;Source&gt;.ChangeName](../WDLang4/1000024201.md).
<a name="NOTE0_3"></a>
...
**&lt;Source&gt;.ChangeDir** is used to associate a directory with a table. To replace a directory with another one, use [HSubstDir](../WDLang4/3044028.md).
