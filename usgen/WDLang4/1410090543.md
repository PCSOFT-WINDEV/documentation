...
`<Result> = <Connection>.InfoItemRights(<User/Group> , <Rights> , <Database> , <Table> , <Item> [, <Display mode>])`
---
...
Name of the database containing the table item for which to get the rights. 
...
Name of the HFSQL table containing the item for which to get the rights. The extension of the table must be specified.
