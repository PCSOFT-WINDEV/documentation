...
Two types of search can be performed in the HFSQL tables:
...
|   |   |
| --- | --- |
| <br><br>- sensitive to the case or not.<br><br>- sensitive to accented characters or not.<br><br>- sensitive to space characters and to the punctuation or not.<br><br><br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Indexation%20des%20m%E9mos%20-%20HC%20N%B0002.gif)<br><br><br>Option displayed in the "File item" window, <br>*"General" tab of a text key item.* |

**For backward compatibility with WINDEV 5.5**, the data model editor includes the "5.5-compatible mode" (available in the "Compatibility" tab of the table description). This mode is automatically selected for:

- the files in 5.5 format found in a WINDEV 2026 database schema.

- the files in 5.5 format migrated to WINDEV 2026.



<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0002%201.gif)
...
## Spaces and searches in HFSQL Classic tables
<a name="spaces_and_searches_hfsql_classic_tables_ELTTEXTE000416"></a>
...
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0002%202.gif)<br><br>This table explains the effect of the selected mode ("Compatibility" tab of the table description). | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Indexation%20des%20m%E9mos%20-%20HC%20N%B0002.gif)<br><br>This table is correct only if these 3 boxes are checked<br>("File item" window, "General" tab in a text key item) |
...
| Remark | When switching from the "5.5-compatible mode" to the "Classic Mode", an automatic modification of the tables is generated.<br>For each record, the space characters found at the end of "text string" items are deleted. |
...
- the type of HFSQL table used: Hyper File 5.5 format table, Hyper File 5.5 format table migrated to HFSQL Classic, HFSQL Classic format table.
...
| ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Base_HFSQLCS_Securite%20-%20HC%20N%B0002%202.gif)<br><br>This table presents how the selected text items are stored ("Compatibility" tab of the table description) | ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Indexation%20des%20m%E9mos%20-%20HC%20N%B0002.gif)This table is correct only if these 3 boxes are checked<br>("File item" window, "General" tab in a text key item) |
| **HFSQL Classic tables** | **Hyper File 5.5 files<br>migrated to HFSQL Classic** | **Hyper File 5.5 files** |
...
| Remarks | When switching from the "5.5-compatible mode" to the "Classic Mode", an automatic modification of the tables is generated. For each record, the space characters found at the end of "text string" items are deleted. | When switching from the "5.5-compatible mode" to the "Classic Mode", an automatic modification of the tables is generated. For each record, the space characters found at the end of "text string" items are deleted. |   |
