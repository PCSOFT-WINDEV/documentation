...
- work on different physical tables with the same logical description. 

- multiple pointers to the same table for nested traversals. 


For example, for a table:

- the table is described in the database schema. 

- the table alias is created using a variable of type **Alias**.
...
// It behaves like the "Order" table described in the database schema.
// -------------------
...
<a name="physical_table_associated_with_alias_ELTPARAGRAPHE000045"></a>
...
To associate the alias with a physical table that has a different name, use [HChangeName](../WDLang4/3044141.md). If necessary: 

- [HChangeConnection](../WDLang4/3044150.md) redefines the connection related to the table. 

- [HChangeDir](../WDLang4/3044168.md) redefines the table directory.
...
[Aliases on tables: HAlias function](../WDLang4/3044180.md)
