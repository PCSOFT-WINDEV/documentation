...
<DIV class="specObsolete">
	...
	From version <B>27</B>, it is no longer possible to import XML files into the database schema. To handle XML files, it is recommended to use variables of type [xmlDocument](../WDLang5/1000018782.md). For more details, see [Management of XML](../WDLang5/3081018.md).
</DIV><a name="NOTE1"></a>
<a name="NOTE1_1"></a>
...
The method for handling the XML files is the same as the method for handling the standard HFSQL tables.
...
<a name="operations_the_data_model_editor_ELTTEXTE000217"></a>


### Importing an XML document
<a name="importing_xml_document_ELTPARAGRAPHE000029"></a>
...
<a name="generate_the_database_schema_ELTPARAGRAPHE000057"></a>

To create windows or pages manipulating the XML document described in the database schema, the database schema must be generated: under the "Database schema" pane, in the "Database schema" group, click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Generation_analyse.gif).
...
<a name="use_programmatically_ELTTEXTE000247"></a>


### Browsing the different files of XML document
<a name="browsing_the_different_files_xml_document_ELTPARAGRAPHE000076"></a>
...
## Limitations
<a name="limitations_ELTTEXTE000271"></a>


### Queries
<a name="queries_ELTPARAGRAPHE000110"></a>
...
### Creating files
<a name="creating_files_ELTPARAGRAPHE000117"></a>
...
### Filter
<a name="filter_ELTPARAGRAPHE000130"></a>
...
### Reading XML files
<a name="reading_xml_files_ELTPARAGRAPHE000142"></a>
...
[Management of XML](../WDLang4/3081018.md)
