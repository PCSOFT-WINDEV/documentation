...
**Note** It is advisable to use the same type of replication as that defined on the server.
...
<a name="replication_and_withspace_function_ELTPARAGRAPHE000121"></a>
...
<a name="replication_via_replication_server_ELTPARAGRAPHE000137"></a>
