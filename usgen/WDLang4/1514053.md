...
2. Initialize the data source ([HExecuteSQLQuery](../WDLang4/3044084.md) or [HCreateView](../WDLang4/3044159.md)).
	...
	**Note**: The data source can also be initialized with the [HDeclareExternal](../WDLang4/3044204.md) function.. In this case, the data source is used to manipulate a table via its description, independently of the database schema. 
...
### Declaring a data source by associating it with a table or with a query
...
Name of table or query whose description must be associated with the data source. If this parameter is specified, the completion will propose the different items of the associated data source. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=SourceDeDonnees_Description.gif)
...
- [HDeclareExternal](../WDLang4/3044204.md) if the variable is to be associated with a physical file, by importing the description of the corresponding table.
...
Example of code to be used in the case where the description of the external file is that of one of the database schema tables: 
...
The following properties are associated with Data Source variables. These properties are identical to the ones that apply to a table:
...
| [Extension](../Proprietes/2512030.md) | Allows you to find out and modify the extension of a table. |
| [LogFile](../Proprietes/2512032.md) | Allows you to find out whether a table is a log file. |
| [TransactionFile](../Proprietes/2512036.md) | Allows you to find out whether a table is a transaction file. |
...
| [Format](../Proprietes/2512045.md) | Configures the format of data found in the table (ANSI or Unicode). |
...
| [GUIDFile](../Proprietes/2512099.md) | Returns the GUID of the table defined in the database schema that was used to create the table. |
...
| [ExtendedInfo](../Proprietes/2512041.md) | Returns and changes the additional information of a table or item accessed via a Native Connector. |
| [LogMethod](../Proprietes/2512044.md) | Returns the method for logging a table. |
...
| [Name55](../Proprietes/2512054.md) | Manages the logical name of a table in Hyper File 5.5 format found in a database schema in HFSQL Classic format. |
| [DescribedName](../Proprietes/2512066.md) | Manages the logical name of a table. |
| [PhysicalName](../Proprietes/2512059.md) | Manages the physical name of tables. |
| [DescribedPhysicalName](../Proprietes/2512063.md) | Manages the physical name of HFSQL tables (regardless of name changes made using [HChangeName](../WDLang4/3044141.md)). |
| [NullSupported](../Proprietes/2512061.md) | Used to manage the NULL value in an HFSQL table. |
...
| [Directory](../Proprietes/2512078.md) | Manages the physical directory of HFSQL tables. This property takes into account directory changes made using [HChangeDir](../WDLang4/3044168.md) or [HSubstDir](../WDLang4/3044028.md). |
| [DescribedDirectory](../Proprietes/2512074.md) | Manages the physical directory of HFSQL tables. This property ignores directory changes made using [HChangeDir](../WDLang4/3044168.md) or [HSubstDir](../WDLang4/3044028.md). |
| [LogDirectory](../Proprietes/2512075.md) | Manages the directory of log file described in the database schema. |
...
| [Replication](../Proprietes/2512073.md) | Enables you to identify the replication mode used for a table (table defined in the data model editor or programmatically defined). For the files defined through programming, you can specify whether this file is in logged replication mode or not. |
| [FilteredItem](../Proprietes/2512086.md) | Allows you to find out the item on which a filter was implemented by [HFilter](../WDLang4/3044100.md) on a table, an HFSQL view or a query. |
| [TextItemCompleted](../Proprietes/2512080.md) | Parameters for managing text fields in an HFSQL table. The text items can be automatically filled with space characters (operating mode identical to the one of WINDEV 5.5) or not. |
