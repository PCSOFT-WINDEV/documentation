...
LOOP
	...
	// Displays value of table record item
...
`<Result> = HErrorModification(<Table> , <Item> [, <Item index>] , <Record to read>)`
---
...
|   |   |
| --- | --- |
| *hRecFile* | Value of the item currently saved in the table. |
