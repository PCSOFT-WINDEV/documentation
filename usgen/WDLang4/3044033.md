...
`<Result> = HLogRecreate(<Table> [, <Creation options>])`
---
...
Name of the logged table for which the log must be recreated. If this parameter corresponds to "\*", the log is recreated for all the tables found in the database schema.
