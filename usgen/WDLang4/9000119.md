...
2. Use [SQLExec](../WDLang4/3072007.md) to run queries on the local database. 
	**Please note** SQL queries are executed asynchronously. Therefore, the syntax of [SQLExec](../WDLang4/3072007.md) uses a specific procedure. This procedure is started at the end of real query execution (regardless of the query result). This browser procedure is used to:  
...
- Click on the "Add more events to xxx" link at the end of the code window, after the last event.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Traitements_optionnels_WD_OK%20-%20HC%20N%B0001.gif)
...
[Native SQLite Connector](../WDLang4/1000019599.md)

[SQL functions for accessing the external databases](../WDLang4/3072002.md)

[Using offline sites](../WDLang4/2030060.md)
