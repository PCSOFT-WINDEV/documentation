...
<a name="describing_connection_the_data_model_editor_ELTTEXTE000192"></a>


### To describe a connection in the data model editor: 
<a name="describe_connection_the_data_model_editor_ELTPARAGRAPHE000039"></a>

1. Open the data model editor.

2. On the "Database schema" tab, in the "Connection" group, click "Connections".
...
4. If a connection was already described in the database schema, the list of connections as well as their characteristics displays (this list can be modified and tested).
...
<a name="describing_connection_with_hdescribeconnection_ELTTEXTE000216"></a>
Functions [HDescribeConnection](../WDLang4/3044205.md), [HChangeConnection](../WDLang4/3044150.md), ... are used to describe a connection and use it. Here's how it works:
...
- With [HDescribeConnection](../WDLang4/3044205.md), an Oracle table description imported into the database schema can be directly used by HFSQL Classic tables. Simply describe a temporary connection to an HFSQL Classic database and associate it with the table description from in the database schema.
...
<a name="describing_connection_via_the_connection_type_and_via_its_properties_ELTTEXTE000240"></a>
