...
### SQL query text
<a name="sql_query_text_ELTPARAGRAPHE000267"></a>
...
<a name="sql_injection_how_protect_yourself_ELTPARAGRAPHE000325"></a>
...
| --- | --- |
| The connection associated with the tables in the query is defined automatically. | The connection to use must be specified in **HExecuteSQLQueryAsynchronous**. |
