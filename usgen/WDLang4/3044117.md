...
`<Result> = HStatDate([<Table> [, <Key item>]])`
---
...
Name of the table used. If this name is not specified, **HStatDate** uses the last table used by the last HFSQL management function (function starting with "H").
