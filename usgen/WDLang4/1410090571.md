...
***In french: &lt;Variable Polygone2D&gt;.EstContenu***
...
## Remarks
**&lt;Polygon2D variable&gt;.Within** is similar to [&lt;Polygon2D variable&gt;.CoveredBy](../WDLang4/1410090572.md). However, [&lt;Polygon2D variable&gt;.CoveredBy](../WDLang4/1410090572.md) does not require the interiors of both geometries to have a point in common. A polygon covers its own boundary, but it does not contain it.


### Accessing spatial data using spatial indexes
<a name="accessing_spatial_data_using_spatial_indexes_ELTPARAGRAPHE000337"></a>

In a table, you can apply a filter on spatial data and loop through the table. For example, the filter can be based on the result of **&lt;Polygon2D variable&gt;.Within**.
