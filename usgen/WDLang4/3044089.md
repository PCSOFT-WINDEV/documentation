...
END
...
// Disables the trigger for all the tables
...
`<Result> = HDeactivateTrigger([<List of tables> [, <List of functions>]] [, <Type>])`
---
...
Logical name of one or more tables. 
...
By default, all the tables are taken into account.
