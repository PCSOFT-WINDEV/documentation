...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Vueensem.gif)
...
| *hViewDistinct* | Create view without duplicates with respect to the sort key. |
| *hViewExclusive* | Optimizes the creation time of view by locking the entire source table. |
...
<a name="influence_sort_items_ELTPARAGRAPHE000304"></a>
...
<a name="handling_the_view_items_after_join_ELTPARAGRAPHE000314"></a>
...
- View1 named "CustomerView" contains the following fields: CustomerID, OrderID, Name.
...
<a name="joins_differences_the_search_results_according_the_sequence_the_views_the_join_ELTPARAGRAPHE000382"></a>
...
- Characteristics of *MaRubrique* key field in View1: Case-insensitive searches.
...
- HMergeView(View3, View1, View2): view2 is searched: 15 records are found.

- HMergeView(View3, View2, View1): view1 is searched: 63 records are found.
...
### Hyper File 5.5
<a name="hyper_file_55_ELTPARAGRAPHE000404"></a>
...
[HMergeView (Function)](../WDLang4/3044124.md)
