...
### Using H.NumRec
<a name="using_hnumrec_ELTPARAGRAPHE000028"></a>
...
In these last two cases, the **H.NumRec** variable corresponds to the record number of the table associated with the view or with the query.
