...
```wl
// Assigns "Smith" to the second item of the Customer table
...
`HToItem(<Table> , <Item order> [, <Index>] , <Value>)`
---
...
Physical order number of the item in the table.
...
`HToItem(<Table> , <Item order> [, <Array separator>] , <Value>)`
---
...
<a name="order_items_the_table_ELTPARAGRAPHE000114"></a>

The order of the items in the table starts from 1. The order of an item is returned by the [Index](../Proprietes/2512040.md) property.
<a name="NOTE0_2"></a>
