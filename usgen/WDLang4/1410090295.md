...
Trace(GeometryEqual(o2DPolygon_1, o2DPolygon_2)) // True
```
...
<a name="accessing_spatial_data_using_spatial_indexes_ELTPARAGRAPHE000322"></a>

In a table, you can apply a filter on spatial data and loop through the table. For example, the filter can be based on the result of **GeometryEqual**.
...
- WLanguage_function corresponds to **GeometryEqual**. 
...
[&lt;PolygonGeo variable&gt;.Equal (Function)](../WDLang4/1410090568.md)
