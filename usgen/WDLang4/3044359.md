...
**Remark**: Server management rights are required to use this function.. These rights correspond to the *hRightsManageServer* constant used in [HInfoServerRights](../WDLang4/3044322.md) and [HModifyServerRights](../WDLang4/3044328.md).
...
- List of options for a standard use: 
	**Remark**: Modifying these options with the **HSetServer** function takes effect without having to restart the server..
...
- List of options for an advanced use:
	**Remark**: Modifying these options using the **HSetServer** function will take effect the next time the server is restarted..
...
<a name="dynamic_load_balancing_ELTPARAGRAPHE000770"></a>
...
### Log management
<a name="log_management_ELTPARAGRAPHE000783"></a>
...
[&lt;Connection variable&gt;.SetServer (Function)](../WDLang4/1000022664.md)
