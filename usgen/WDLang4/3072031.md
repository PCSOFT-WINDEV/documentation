...
**Note** This function must be used when browsing the result of a query of type SQLFetch/ SQLGetCol. A fatal error occurs if this function is used in an SQLFirst/SQLCol browse. For more details, see [Types of SQL browse](../WDLang4/3072025.md).

![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) The partial fetch is automatically performed by the Java framework.![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) **SQLTable** does not work if the query contains binary memos. The binary memos must be processed separately (they must be saved by [fSaveText](../WDLang1/3036046.md) for example).
<a name="Exemple1"></a>
...
<a name="characteristics_the_table_control_populated_programmatically_ELTPARAGRAPHE000103"></a>
...
### Closing a query
<a name="closing_query_ELTPARAGRAPHE000110"></a>
...
<a name="using_the_partial_fetch_ELTPARAGRAPHE000124"></a>
...
<a name="the_different_types_queries_ELTPARAGRAPHE000138"></a>
...
<a name="retrieving_float_items_oracle_via_odbc_ELTPARAGRAPHE000160"></a>
...
### Unicode management
<a name="unicode_management_ELTPARAGRAPHE000174"></a>
