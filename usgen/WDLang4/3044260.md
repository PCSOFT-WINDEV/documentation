...
Converts a numeric value into a binary string in order to perform a search on a numeric key. It builds a composite key from one or more numeric items.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=HConvertX%20-%20HC%20N%B0001.gif)


[HBuildKeyValue](../WDLang4/3044258.md) must be used to perform searches on the composite keys for tables that use "Mode 7" to manage spaces in text items. For more details, see [Composite keys](../WDLang4/3044178.md).
...
<a name="syntaxes_according_the_values_convert_ELTPARAGRAPHE000056"></a>
...
**Tip** If you wish to use the **HConvertX**function, we advise you to use the [Convert](../WDLang4/3044244.md) function, which is easier to handle.


### Using HConvertX (method kept for backward compatibility with WINDEV 5.5)
<a name="using_docparampagetitleshort_method_kept_for_backward_compatibility_with_windev_55_ELTPARAGRAPHE000096"></a>
