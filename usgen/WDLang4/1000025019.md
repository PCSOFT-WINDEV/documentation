...
Reads a record in a table according to a given record number. This read mode is called "Direct access". The record read is loaded in memory. [&lt;Source&gt;.State](../WDLang4/1000024943.md) is used to find out the record status (active, crossed or deleted).

In most cases, **&lt;Source&gt;.Read** is used to position in the table in order to perform a read loop by specifying the record number.
...
- the table is empty: function [&lt;Source&gt;.Out](../WDLang4/1000024605.md) returns <u><u><u>True</u></u></u>.
...
<a name="looping_through_table_ELTPARAGRAPHE000367"></a>
...
- [&lt;Source&gt;.RecNum](../WDLang4/1000025041.md) returns the current record number. The first record found in the table is record #1.
