...
`<Result> = HRecordToString([<Table> [, <Item separator> [, <Array separator> [, <Format>]]]])`
---
...
Name of the table (view or query) used. If this name is not specified, **HRecordToString** will use the last table used by the last HFSQL function (function starting with "H").
...
[&lt;Source&gt;.RecordToString (Function)](../WDLang4/1000026034.md)
