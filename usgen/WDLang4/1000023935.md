...
`<Result> = HExportCSV(<Table> [, <CSV file> [, <Items to export> [, <Separator>]]] [, <Options> [, <Progress Bar>]])`
---
...
Name of the table, view or query used. If this name is not specified, **HExportCSV** will use the last table used by the last HFSQL function (function starting with "H").
