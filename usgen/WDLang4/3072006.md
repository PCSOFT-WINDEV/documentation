...
- by the database accessed by a specific connection (described in the database schema, or described by [HDescribeConnection](../WDLang4/3044205.md) or [HOpenConnection](../WDLang4/3044107.md)).
...
This list is in the form: &lt;SQL column type&gt; + TAB + &lt;WINDEV/WEBDEV type&gt; + CR. For more details, see [remarks](#NOTE0_1).

**`<Connection name>: (Optional character string)`**

If this parameter is specified, it is used to specify the connection for which the format of columns must be returned. This name corresponds to a connection described in the database schema, or to a connection described by [HDescribeConnection](../WDLang4/3044205.md) or [HOpenConnection](../WDLang4/3044107.md).
...
### List of supported types
<a name="list_supported_types_ELTPARAGRAPHE000089"></a>
