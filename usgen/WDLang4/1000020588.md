...
### The structure of tables was modified in the database schema (addition, modification or deletion of items). How to apply the modifications to the files found on HFSQL servers with a server replication?
<a name="the_structure_tables_was_modified_the_database_schema_addition_modification_deletion_items_how_apply_the_modifications_the_files_found_hfsql_servers_with_server_replication_ELTPARAGRAPHE000093"></a>
