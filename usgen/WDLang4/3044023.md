...
### Example 
<a name="example_ELTPARAGRAPHE000048"></a>The following example is used to check the existence of a table. If the table does not exist, it is created; if it exists, the program continues to run.
