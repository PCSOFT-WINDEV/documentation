...
- The function **SourceFromPage FUNCTION** function does not write to the table: only variables in table fields are assigned (i.e. variables in the record loaded into memory). To modify the records, use [HAdd](../WDLang4/3044147.md), [HModify](../WDLang4/3044042.md), [HWrite](../WDLang4/3044092.md), etc.
...
<a name="binding_between_control_and_wlanguage_variable_between_control_and_table_item_ELTPARAGRAPHE000100"></a>
...
<a name="section_updates_special_cases_ELTPARAGRAPHE000115"></a>
...
- The items of the table that are not bound to a control are not updated by **SourceFromPage**.

- If multiple controls in the window or page are bound to the same table item, **SourceFromPage** may not update the bound item properly. ***It is not recommended to bind multiple controls of a window or page to the same item***.
...
<a name="updating_data_the_table_control_looper_controls_ELTPARAGRAPHE000162"></a>
...
[&lt;Source&gt;.FromPage (Function)](../WDLang4/1000021405.md)
