...
| [&lt;Connection variable&gt;.AddScheduledOptimization](../WDLang4/1000022641.md) | Adds an optimization task of HFSQL Client/Server tables. |
| [&lt;Connection variable&gt;.AddScheduling](../WDLang4/1000022642.md) | Adds a scheduled operation on an HFSQL server. This operation can be a scheduled task (stored procedure), backup, optimization or a materialized view refresh. |
...
| [&lt;Connection variable&gt;.Backup](../WDLang4/1000022752.md) | Backs up the contents of an HFSQL server: all server databases, one or more databases, one or more tables. |
...
| [&lt;Connection variable&gt;.ConnectionQuality](../WDLang4/1000022748.md) | Returns the quality level of the connection: the higher the level is, the faster the connection is. |
| [&lt;Connection variable&gt;.CopyFile](../WDLang4/1000022650.md) | Copies an HFSQL table (.fic, .ndx, .ftx, .sdx and .mmo files, if any):<br><br>- from the HFSQL server to the server (to perform a backup for example). <br><br>- from the HFSQL server to the client (to perform a local backup for example). <br><br>- from the client to the HFSQL server (to update the tables for example). <br><br>- from an HFSQL server to antoher HFSQL server.<br><br><br> |
| [&lt;Connection variable&gt;.DeactivateServerTrigger](../WDLang4/1000022654.md) | Disables an HFSQL Client/Server server trigger on a server. |
...
| [&lt;Connection variable&gt;.DeleteFile](../WDLang4/1000022757.md) | Deletes HFSQL tables (.fic, .ndx, .ftx, .sdx and .mmo files, if any) from the server. |
...
| [&lt;Connection variable&gt;.DeleteLink](../WDLang4/1000022759.md) | Deletes an integrity rule between two tables on the server. |
...
| [&lt;Connection variable&gt;.DeleteScheduledOptimization](../WDLang4/1000022760.md) | Deletes a scheduled optimization task from HFSQL Client/Server tables. |
| [&lt;Connection variable&gt;.DeleteScheduling](../WDLang4/1000022762.md) | Delete a scheduled item on an HFSQL server: scheduled task (stored procedure), backup, optimization, refresh of a materialized view. |
...
| [&lt;Connection variable&gt;.DropView](../WDLang4/1410088611.md) | Deletes a materialized view from the HFSQL server. |
...
| [&lt;Connection variable&gt;.ExecuteScheduling](../WDLang4/1000022658.md) | Immediately executes a scheduled item regardless of its scheduling: scheduled task (stored procedure), backup, optimization, refresh of a materialized view. |
...
| [&lt;Connection variable&gt;.InfoDatabaseRights](../WDLang4/1000022666.md) | Gets the rights granted to a user or group on a database. |
| [&lt;Connection variable&gt;.InfoFileProperty](../WDLang4/1000022674.md) | Gets the properties of a table located in an HFSQL server. |
| [&lt;Connection variable&gt;.InfoFileRights](../WDLang4/1000022667.md) | Gets the rights granted to a user or group on an HFSQL Client/Server table. |
| [&lt;Connection variable&gt;.InfoGroup](../WDLang4/1000022670.md) | Returns information about the specified group of users. |
| [&lt;Connection variable&gt;.InfoItemRights](../WDLang4/1410090543.md) | Gets the rights granted to a user or group on an item. |
| [&lt;Connection variable&gt;.InfoLock](../WDLang4/1000022774.md) | Returns information about the lock set on a table, on one or all the records in a table. |
...
| [&lt;Connection variable&gt;.InfoServerRights](../WDLang4/1000022668.md) | Gets the rights granted to a user or group of users on a server. |
...
| [&lt;Connection variable&gt;.InfoViewRights](../WDLang4/1000022669.md) | Gets the rights granted to a user or group on an SQL view or on a materialized view. |
...
| [&lt;Connection variable&gt;.ListScheduledOptimization](../WDLang4/1000022695.md) | Lists the scheduled optimization tasks of HFSQL Client/Server tables for a connection. |
| [&lt;Connection variable&gt;.ListScheduling](../WDLang4/1000022698.md) | Lists scheduled elements defined on an HFSQL server: scheduled tasks (stored procedure), backup, optimization, refresh of a materialized view. |
...
| [&lt;Connection variable&gt;.ListWatchedFiles](../WDLang4/1410090429.md) | Returns the list of tables watched by [&lt;Source&gt;.Watch](../WDLang4/1000025029.md). |
...
| [&lt;Connection variable&gt;.ModifyDatabaseRights](../WDLang4/1000022707.md) | Sets the rights granted to a user or group for an HFSQL Client/Server database. |
| [&lt;Connection variable&gt;.ModifyFileProperty](../WDLang4/1000022718.md) | Modifies the properties of an HFSQL table located on a server. |
| [&lt;Connection variable&gt;.ModifyFileRights](../WDLang4/1000022709.md) | Sets the rights granted to a user or group on an HFSQL Client/Server table. |
...
| [&lt;Connection variable&gt;.ModifyItemRights](../WDLang4/1410090544.md) | Modifies the rights granted to a user or group on an item of an HFSQL Client/Server table. |
...
| [&lt;Connection variable&gt;.ModifyScheduling](../WDLang4/1000022716.md) | Modify a scheduled item on an HFSQL server: scheduled task (stored procedure), backup, optimization, refresh of a materialized view. |
| [&lt;Connection variable&gt;.ModifyServerProperty](../WDLang4/1000022720.md) | Modifies the properties of an HFSQL server. |
| [&lt;Connection variable&gt;.ModifyServerRights](../WDLang4/1000022710.md) | Sets the rights granted to a user or group on an HFSQL server. |
...
| [&lt;Connection variable&gt;.ModifyViewRights](../WDLang4/1000022711.md) | Sets the rights granted to a user or group on an SQL view or on a materialized view. |
...
| [&lt;Connection variable&gt;.TransactionIsolation](../WDLang4/1000022770.md) | Configures the isolation level of transactions for a connection to an HFSQL server. |
...
| [&lt;Connection variable&gt;.TransactionRollbackToSavepoint](../WDLang4/1410087877.md) | Rolls the transaction back to the savepoint. |
| [&lt;Connection variable&gt;.TransactionSavepoint](../WDLang4/1410087876.md) | Declares a transaction savepoint. |
...
| [&lt;Source&gt;.ChangePassword](../WDLang4/1000024591.md) | Changes the password of an HFSQL Classic or HFSQL Client/Server table. |
| [&lt;Source&gt;.InfoLock](../WDLang4/1000024995.md) | Returns information about the lock set on a table, on one or all the records in a table. |
| [&lt;Source&gt;.UpdateLink](../WDLang4/1000025025.md) | Updates on the server all the links of an HFSQL Client/Server table.<br><br> |
| [&lt;Source&gt;.Watch](../WDLang4/1000025029.md) | Trigger monitoring of write actions (add, modify or delete) performed on a table present on an HFSQL server. In case of modification, a specific procedure can be triggered. |
| [&lt;Source&gt;.WatchStop](../WDLang4/1000025030.md) | Stops watching a table on an HFSQL server. |
