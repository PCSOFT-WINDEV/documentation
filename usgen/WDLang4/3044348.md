...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Note** We recommend displaying thumbnails in a Thumbnail control (not in an Image control). 
...
<a name="managing_hfsql_thumbnails_ELTPARAGRAPHE000043"></a>

To manage the HFSQL thumbnails: 

1. In the data model editor, select the table containing the HFSQL binary memo item.

2. Double-click the table to display the description of items.

3. Select the desired item.

4. Check "Automatic management of thumbnails" and click "Edit".
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Vignettes%20HFSQL%20-%20HC%20N%B0001.GIF)
...
- [when the automatic table modification is performed](../WDLang4/3044195.md).
...
<a name="wlanguage_properties_associated_with_the_hfsql_thumbnails_ELTPARAGRAPHE000080"></a>The following WLanguage properties are used to manage HFSQL thumbnails:
...
## Notes
<a name="notes_ELTTEXTE000297"></a>


### Size of control displaying the image and size of thumbnail
<a name="size_control_displaying_the_image_and_size_thumbnail_ELTPARAGRAPHE000090"></a>
...
<a name="number_thumbnails_ELTPARAGRAPHE000099"></a>
...
## Limitations
<a name="limitations_ELTTEXTE000327"></a>
...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) The thumbnails are available in HFSQL Client/Server on the table items.
<a name="NOTE4_2"></a>


### Version 9 and earlier
<a name="version_9_and_earlier_ELTPARAGRAPHE000122"></a>
...
The table below presents the use of binary memos and thumbnails in an application in version 9 (or earlier) and in an application in version 19 that uses the same tables:


|   |   |   |
| --- | --- | --- |
|   | **Application (or site) in version 9 and earlier** | **Application (or site) in version 19** |
| New record written by an HFSQL engine version 9 or earlier | Image displayed: Binary memo | Image displayed: Binary memo |
| New record written by an HFSQL engine version 10 and later | Image displayed: Binary memo | Displayed image: Thumbnail |
| Record written by an HFSQL engine version 9 (or earlier) and modified in version 19 (the value of the binary memo item is modified) | Image displayed: Binary memo | Displayed image: Thumbnail |
