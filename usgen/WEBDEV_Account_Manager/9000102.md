...
WEBDEV Account Manager allows you to create a deployment account. This account can be used to deploy WEBDEV websites from WEBDEV.
...
To edit a deployment account in WEBDEV Account Manager:
