...
The use of SQL functions to handle SQLite data does not require importing the table structure into the database schema. However, the data must be handled by queries only. The content of SQLite files cannot be read directly.

**Remark**: Don't forget to check the limitations concerning the use of the SQLite Native Connector.
