...
2. Select the server on which the replication will be deployed: 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ReplicEdit_Publier.gif)
...
4. Specify: 
	...
	- the name of the replication (name of WER file). 
			...
			<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ReplicEdit_Publier_Serveur.gif)
...
5. In the next step, specify the periodicity for preparing the data to replicate: 
	...
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ReplicEdit_Publier_Period.gif)
...
6. Validate. The wizard proposes the WLanguage code that must be included in the application to synchronize the data. 
	...
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ReplicEdit_Publier_Code.gif)
