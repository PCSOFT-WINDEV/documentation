...
3. The interface of "Automatic update" appears. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Automatique_update%20-%20HC%20N%B0001.gif)





Note: Depending on the configuration of Automatic Update, it is possible to launch this application at the start of the Windows session. 
...
1. In the Automatic Update title bar, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Automatique_update%20-%20HC%20N%B0001%201.gif). 

2. In the menu that appears, select "Add a product to Automatic Update". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Automatique_update%20-%20HC%20N%B0002.gif&type=thumb)
...
1. Once in Automatic Update, expand the context menu of the "Start" button of the product to be ignored. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Automatique_update%20-%20HC%20N%B0004.gif)


2. You can: 

	- Select "No longer update". In this case, a lock appears in the product characteristics, indicating that updates will no longer be automatically checked for this product. Updates can be checked manually. 

	- Select "Hide from Automatic Update". This means the product will no longer appear in Automatic Update. 


 Caution: 

- If the options "No longer update" and "Hide from Automatic Update" are enabled, the product will no longer appear in Automatic Update, and no automatic update search will be performed. 
...
Note: You can view hidden products at any time by selecting "Show hidden products" in the menu opened with 
the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Automatique_update%20-%20HC%20N%B0001%201.gif) icon.
<a name="NOTE3_2_24"></a>
...
- For all listed products: 
	...
	2. In the menu that appears, select "Check for updates". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Automatique_update%20-%20HC%20N%B0002.gif&type=thumb)
...
[Configuring Automatic Update](../AutomaticUpdate/3541002.md)

[Frequently asked questions about Automatic Update](../AutomaticUpdate/3541003.md)
