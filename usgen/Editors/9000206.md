...
- Enable errors for shared messages at the project level: 
	...
	2. In the "Compilation" tab, check "Indicate shared multilingual messages": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Traduction_messages_hc1_a.gif)
...
3. The wizard then checks if the same multilingual message is used multiple times in the project. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Traduction_messages_hc1_b.gif&type=thumb)
