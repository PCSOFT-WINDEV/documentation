...
3. Right-click and select "Import text files" in the context menu. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Import_classe_txt%20-%20HC%20N%B0001.gif)
...
- An ellipsis ('...') that indicates that a line of code continues over the next line is not supported. A text file containing these symbols will not be imported.. 
...
3. Right-click and select "Import text files" in the context menu. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Import_classe_txt%20-%20HC%20N%B0002.gif)

	![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) In WEBDEV, you have the ability to import sets of server or browser procedures: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Import_classe_WB_txt%20-%20HC%20N%B0001.gif)
...
[Set of procedures](../Editeurs/1513003.md)

[Classes, members, methods and properties](../Editeurs/6010006.md)
