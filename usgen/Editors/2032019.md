...
4. Choose the selection criteria (equal to, greater than, ...) of the condition. This condition can relate to a given value, a parameter, the records selected by another query, etc. In the case of a date-type field, the selection condition can relate to a predefined date (current year, current month, today).
	**Note** You can select a given value using the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OrdreAffichage.gif) icon. The following menu is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requete_MenuVisuValeur.gif)
You can:

	- select one of the possible values among the ones found in the table.

	- view the entire table.
			**Attention** This option is only available if Live Data is enabled. For more details, see [Live Data](../Editeurs/2021005.md).
...
To add, modify or delete a selection condition in a select query, click the condition column of query items and select the operation to perform in the following menu: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requete_MenuconditionSelect.gif)
...
[Modifying the values displayed in the result of a select query ](../Editeurs/2032016.md)

[Query: Displaying the records corresponding to a given period ](../Editeurs/2032029.md)

[How to create an SQL query to filter records?](../Editeurs/20043.md)
