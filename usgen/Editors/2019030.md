...
3. Select the data you want to see. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Log_ex%E9cution%20-%20HC%20N%B0001.gif&type=thumb)
...
- **Call log**: Used to see all the calls to the WLanguage procedures and functions. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Log_ex%E9cution%20-%20HC%20N%B0003.gif&type=thumb)
Additional information can be displayed at the bottom of the screen: parameters of the procedure, result, ...
	The "Show the process code" button shows the corresponding WLanguage code in the code editor. Please note that the log window is always in the foreground.

- **Threads**: Allows you to select the thread you want to analyze and shows sequence of calls for that thread.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Log_ex%E9cution%20-%20HC%20N%B0006.gif&type=thumb)
...
[Debugging functions](../Editeurs/3014025.md)

[WX file](../Editeurs/9000125.md)

[Real-Time Performance Profiler (RTPP)](../Editeurs/9500237.md)
