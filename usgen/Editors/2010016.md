...
On the "General" tab, you have the ability to define:
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=proprieteAide_1.gif)
...
**Reminder**: By default, the help system supports the same languages as the project. To add or remove languages:
...
[Help editor options](../Editeurs/2010020.md)
