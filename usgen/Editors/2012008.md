...
4. In the list that opens, select "C#". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CSHARP_Code_WL.gif)


5. The header becomes light blue and "C#" appears to the left of the procedure name. The existing code is commented out. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CSHARP_Code.gif)
...
Note: "using" declarations before the prototypes of C# procedures are taken into account for the entire set of procedures. 
...
[C#: Calling a WLanguage procedure](../Editeurs/2012009.md)
