...
- edit the keyword text ("General" tab).
...
**To display the keyword properties**: 
...
**Reminder**: You can also edit the keyword text in the help editor. To do so:

1. Open the help in the desired language. Go to the "Modification" tab, "Translate" group, expand "Language displayed" and select the desired language.

2. Click on the keyword to enable edit mode.
...
[Automatic index generation](../Editeurs/2010007.md)
