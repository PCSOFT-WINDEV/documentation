...
<a name="developing_linux_site_ELTTEXTE000376"></a>
The method for developing a site for Linux is identical to the method for developing a site for Windows.

To indicate that your site will be deployed on Linux: 

1. Display the description window for the current configuration: in the "Project Explorer" pane, open the context menu for the "Configurations" option and select "Description".

2. Click on the "Options" tab and check the "Enable compiler errors for Linux compatibility" option.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Site_linux%20-%20HC%20N%B0001.gif)
...
## Available features
<a name="available_features_ELTTEXTE000400"></a>


### The following features are available in Linux
<a name="the_following_features_are_available_linux_ELTPARAGRAPHE000091"></a>
...
| End\* | Frameset\* | Managing HFSQL tables | User Groupware (GPW\*) |
| Image\* | Ini\* | Java\* | List\* |
...
This list evolves very quickly. It is recommended to check the documentation for each function. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=menu_btn_linux_1.gif) logo indicates whether the function is available in Linux as well as its limitations.
...
<a name="unavailable_features_ELTTEXTE000424"></a>


### The following features are not available in Linux
<a name="the_following_features_are_not_available_linux_ELTPARAGRAPHE000215"></a>
...
This list evolves very quickly. It is recommended to check the documentation for each function. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=menu_btn_linux_2.gif) logo indicates that the function is not available in Linux.  
