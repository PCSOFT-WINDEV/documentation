...
To open a file explorer on this directory, on the "General" tab, in the "Home" group, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Rep_Projet.gif) and select "Open generation directory". 
...
The corresponding file was created in a subdirectory corresponding to the Java project configuration (subdirectory of EXE directory of project).
To open a file explorer on this directory, on the "Home" tab, in the "General" group, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Rep_Projet.gif) and select "Open generation directory". 
