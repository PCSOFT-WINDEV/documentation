...
2. On the "Window" tab, in the "Style and skin templates" group, click "Copy style" (Ctrl + Shift + C).
	The mouse cursor turns into brush: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeCopieStyleCurseur.gif)
...
2. On the "Modification" tab, in the "Quick edit" group, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_pinceau_Etat.gif), Ctrl + Shift + C).
	The mouse cursor turns into brush: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeCopieStyleCurseur.gif)
