...
2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Erreur_IHM.gif).
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Checking the existence of the internal windows used by the Internal Window controls.

- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Checking the existence of the internal pages used by the Internal Page controls.
...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Checking the invalid superposition areas.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Checking the tooltips in a window. Error if several controls have the same tooltip.

- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Errors specific to Responsive Web Design: overlapping blocks, display order errors, etc. For more details, see [Responsive Web Design: Specific UI errors](../WDChamp/9000178.md).
...
- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) Verification of fonts used. If the fonts used are non-native and not integrated into the project, an error is displayed.
