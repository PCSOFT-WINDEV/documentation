...
- **Go to the next mark**: on the "Code" tab, in the "Marks" group, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_suivante.gif) or press F7. 

- **Go to the previous mark**: on the "Code" tab, in the "Marks" group, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_precedente.gif), or press Shift + F7. 
...
5. Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_rech_marq.gif) icon to mark all search results.
