...
1. Click the 31 icon at the top of the editor. 

2. Select "Welcome to XXX" in the context menu. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bienvenue_WD_Afficher.gif)
...
### Create a project
<a name="create_project_ELTPARAGRAPHE000071"></a>

The home page allows you to quickly create a project for a specific platform. To do so: 

1. Go to the home page. 

2. Click "Create a project". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bienvenue_WD_creer.gif&type=thumb)
...
### Open a project
<a name="open_project_ELTPARAGRAPHE000086"></a>
...
4. You can: 
	...
	- open a project from SCMDrive. Simply click "SCMDrive" and specify your SCMDrive login credentials: email address, password and team. For more details on SCMDrive, go to [SCMDrive](https://pcscloud-drive.net/UK/SCMDrive/index.awp).
...
- The list specifies the when each project was last opened. For example, "last week" or "3 days ago". 
...
### Open an example
<a name="open_example_ELTPARAGRAPHE000125"></a>

The home page allows you to quickly open an example installed with the product used. To do so: 

1. Go to the home page. 

2. Click "Open an example". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bienvenue_WD_Exemple%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="opening_example_from_the_tutorial_ELTPARAGRAPHE000158"></a>
...
2. Click "Tutorial". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bienvenue_WD_GAF.gif&type=thumb)
...
[Creating a service with WINDEV](../Editeurs/1000017114.md)

[Managing pinned projects](../Editeurs/9500217.md)

[Project portfolio](../Editeurs/9500231.md)
