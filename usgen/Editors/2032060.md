...
8. Save the SQL code (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Enregistrer.gif)).
...
Retroanalysis of the query in SQL code allows the query to be graphically represented from the tables found in the SQL code and in the project database schema.
