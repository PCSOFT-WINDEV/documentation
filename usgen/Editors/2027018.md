...
The "Quality Control Center" pane displays the incidents associated with the selected project.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=VoletCCQualite.gif)
The context menu (right click) of the "Quality Control Center" pane allows you to:
...
For more details, see [Project Management Hub: Managing incidents](../CCSuivi/3540723.md).
