...
2. Right-click the control and select "Add to my Preset controls". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champs_favoris%20-%20HC%20N%B0001.gif)


3. In the window that appears, specify the characteristics of the preset control:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champs_favoris%20-%20HC%20N%B0002.gif)
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) Indicate whether the theme of the destination window should be applied when the control is dropped. In this case, the style of the control will match the theme of the host window.
			![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Indicate whether the theme of the destination page should be applied when the control is dropped. In this case, the style of the control will match the theme of the host page.
...
- "My Preset controls" on the "Creation" tab:
	...
	1. On the "Creation" tab, in the "Preset  Smart" group, expand "My Preset controls". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champs_favoris%20-%20HC%20N%B0004.gif)
...
- Preset controls associated with a type of control:
	...
	1. On the "Creation" tab, expand the type of control you want to create. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champs_favoris%20-%20HC%20N%B0005.gif)
