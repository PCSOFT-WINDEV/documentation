...
- or the order in which items are displayed in the query result: icon ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OrdreAffichage.gif) (selected by default).

- or the sorting sequence in the query result: icon ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OrdreTri.gif).




**Note**: To change the display/sort order of the various items in the query result, use the arrow buttons to the right of the item list.
<a name="NOTE2_3"></a>
...
- the state from an item containing a postal code.
...
1. Select a date item or an item containing a postal code.
