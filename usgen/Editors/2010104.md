...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modelisation1.gif)

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modelisation2.gif)


The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=modelisation_sous_model.gif) symbol is used to find out whether a sub-modeling can be created (the icon is grayed) or whether a sub-modeling is available.
...
5. The element appears with the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=modelisation_sous_vide.gif) symbol.
...
[Properties of the modeling](../Editeurs/2010103.md)
