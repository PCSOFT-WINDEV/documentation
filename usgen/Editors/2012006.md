...
1. If necessary, copy the "WDxxNET.DLL" library (from the "\\Programs" subdirectory of the installation directory):
	...
	- to the "Assembly" subdirectory of the Windows installation directory.
		...
		- For .NET 2.0, copy wd310net2.dll.

		- For .NET 2.0 (64 bit), copy wd310net2_64.dll.

		- For .NET 4.0, copy wd310net4.dll.

		- For .NET 4.0 (64 bit), copy wd310net4_64.dll.

		- For .NET 5.0, copy wd310net5.dll.

		- For .NET 5.0 (64 bit), copy wd310net5_64.dll.
