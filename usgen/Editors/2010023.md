...
For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=PageAide_Lien.gif)
...
Once created, the link is used to open the help page specified in the current help window. The new help page replaces the current page.
