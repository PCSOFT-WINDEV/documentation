...
For example, if a project was handled by WINDEV and WEBDEV, the following elements will be displayed: "Windows", "Pages", "Window templates", "Page templates", ...<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Format_compatible%20WB%20-%20HC%20N%B0001.gif)
