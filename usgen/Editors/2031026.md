...
Example: Table window on RADFileA of the simple RAD pattern: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Pattern_RAD_WDTable.gif)
...
2. In the description window, enter the following information:
	...
	- The window title. If the title must display the name of the file, use the name of the "RADFileXX" file ("RADFileA: Viewing table" for example).
