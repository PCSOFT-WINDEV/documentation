...
For example a "Fax" metatype will contain the type and length of the item, the input mask, the alignment, etc.

This information will be included in all modules, for each action. This simplifies processes such as the database schema definition, RAD generation, automatic control creation, etc.
...
1. In the data model editor, display the description of the desired table items (double-click on the table).

2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MLD_Metatype_ico.gif).

3. The following window appears:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MLD_Metatype.gif&type=thumb)
...
Note: When creating the item, you can also select &lt;Metatype&gt; in the list of available item names
<a name="NOTE2_2"></a>
...
1. In the data model editor, select "Database schema .. Import a user metatype".
	Note: To access this option, use the main menu accessible via the version logo:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ruban_logo_menu17.gif)
