...
**Note**: It's possible to install Microsoft fonts under Linux, to obtain states more faithful to their preview under Windows.. Under Ubuntu, these fonts can be added by following the procedure below: [http://doc.ubuntu-fr.org/msttcorefonts](http://doc.ubuntu-fr.org/msttcorefonts).
...
**Caution**: The sequence of operations described above must be followed.. If a print is in progress, [iParameter](../WDLang5/3046008.md) cancels the current print.
<a name="NOTE3_3"></a>
