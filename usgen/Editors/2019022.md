...
- test a stored procedure: only from the editor (see [Stored procedure](../WDLang4/3044360.md)).
...
<a name="testing_hfsql_clientserver_connection_ELTPARAGRAPHE000026"></a>

To test an HFSQL Client/Server connection:

1. Open the desired project in the editor.

2. Display the database schema linked to the project: click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_Analyse.gif) among the quick access buttons.
...
<a name="mode_1_launch_project_and_debug_next_database_connections_ELTPARAGRAPHE000061"></a>
...
<a name="mode_2_debugging_future_database_connections_from_specific_user_for_specific_application_ELTPARAGRAPHE000097"></a>
...
**Note** The [InTestMode](../WDLang1/3013011.md) function returns <u><u><u><u>False</u></u></u></u>.
<a name="NOTE2_4"></a>


### Mode 3: Debugging an existing connection
<a name="mode_3_debugging_existing_connection_ELTPARAGRAPHE000124"></a>
...
[Stored procedures and queries (HFSQL Client/Server)](../Editeurs/3044360.md)
