...
- open the setup editor. To do so, go to the "Tools" tab, "Utilities" group and click "WDInst". In the WDInst editor, select "File .. New".
...
## Steps to follow
<a name="steps_follow_ELTTEXTE000246"></a>
...
2. Creating the executable file. For more details, see [Creating an executable file](../Editeurs/2025002.md). If you have just created the executable, click "2. Setup" in the setup program creation wizard. If necessary, click "Access setup options" in the window that appears. 
...
7. Installation of [optional elements for the database](../Editeurs/2028086.md). Depending on the selected elements, you will have to perform the following operations in the following steps of the wizard:
	...
	- Configure the automatic modification of tables.

	- Re-index HFSQL tables during installation.

	- [Include the setup of an HFSQL server](../Editeurs/2028081.md).

	- Deploy HFSQL Client/Server tables.

	- Customize the path of tables during setup.
...
9. [Selection of the installer theme](../Editeurs/2028103.md). 
