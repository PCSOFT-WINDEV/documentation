...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=PageAide_General.gif&type=thumb)
...
- the page's **help number**: This number uniquely identifies the help page.. This allows you to open the help on a specific page ([WHelp](../WDLang1/3013053.md)). For more details, see [Opening the help](../Editeurs/2010017.md).
...
- the **page visibility in the table of contents**: 
 ...
 Note: this option is only taken into account when generating in chm format.. 
...
For details of how to manage multilingual help, see: [How to create a multilingual help system](../Editeurs/2010025.md).
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=PageAide_Index.gif&type=thumb)
...
The "Appearance" tab lets you associate the current help page with a help window description: simply select the desired description. To create a new description, click "Definitions". For more details, see [Defining a window template](../Editeurs/2010006.md).

To create a page header, simply check the "This page contains a header" box and specify its height (in pixels).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=zoneEntete_description.gif)
