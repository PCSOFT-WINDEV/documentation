...
The "Favorites" pane gives direct access to the favorites of your project.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=VoletFavoris.gif)
...
3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeAjoutFavoris.GIF).
...
2. To view:
	...
	- your own favorites: select "My favorites". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ListeFavoris.GIF)
...
3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeAccesFavoris.GIF).
...
3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeSupprimeFavoris.GIF).
