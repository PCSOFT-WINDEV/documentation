...
For example, customer #45762 has got married. Her title and her last name have been modified. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requete_RequeteModification.gif)
...
[Reports & Queries](../Presentation/3088004.md) cannot be used to create update queries.
...
## Notes
<a name="notes_ELTTEXTE000226"></a>


- All the characteristics of a query can be modified: on the "Query" tab, in the "Edit" group, click "Description". For more details, see [Description of a query](../Editeurs/2032038.md).
