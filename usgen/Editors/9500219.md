...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Projet_multilangue%20-%20HC%20N%B0001.gif&type=thumb)
...
2. In the window that is displayed, select the different languages supported by the project.
	Remarks: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ProjetMultilangue2%20-%20HC%20N%B0001.gif&type=thumb)
...
2. Select the tab corresponding to the item to be set (number, currency, etc.).. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Projet_multilangue%20-%20HC%20N%B0001%201.gif)
