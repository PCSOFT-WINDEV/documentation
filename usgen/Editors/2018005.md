...
<DIV class="specObsolete">
	...
	From version <B>18</B>, the User Groupware evolves. This help page corresponds to the User Groupware kept for backward compatibility. To learn more about the new version of the User Groupware, see [User Groupware](../Editeurs/1000021152.md). 
</DIV>
...
## User Groupware database schema
<a name="user_groupware_database_schema_ELTTEXTE000530"></a>
The database schema of the User Groupware is as follows:
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=AnalyseGPW.gif)




**Tables used to identify users**: These tables can be common to several applications:
...
| ***GPWUser*** | Users file. Contains all the characteristics of the users (login, last name, first name, password, ...) |
...
**Tables used to manage rights**: These tables are specific to the application. They cannot be shared with another application.
...
- Search options include Case-sensitive, Accent-sensitive, Space and punctuation sensitive.
...
| Status | Element state (grayed out, inactive, etc.) | Radio Button | 1-byte unsigned integer | With duplicates |
...
<a name="NOTE7_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) **Remark**
For all the keys and for all the components of composite keys:
