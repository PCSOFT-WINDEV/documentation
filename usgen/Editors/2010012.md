...
- [help in HLP or CHM format](#NOTE5_1).
...
- The tooltip automatically applies a margin around the text, making the tooltip more readable.
...
In WINDEV, you can create CHM help files: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Aide_CHM.gif)
...
- context help: The help file is opened on a specific page corresponding to the current window or control.
...
For more details on the different ways to open a CHM file, see [Open the help](../Editeurs/2010017.md).
...
[Control tooltips (AAF)](../Editeurs/1000021821.md)

[Custom tooltips](../Editeurs/9500233.md)
