...
- In the case of a help system generated as a PDF document, the summary is used to create bookmarks in the PDF file. 
...
1. Open the summary ("Table of contents" tab ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Aide_Ico_sommaire.gif)).

2. Select "New .. New book" in the context menu. 
	Alternatively, you can go to the "Modification" tab, "Table of contents" group, expand "New" and select "New book".
