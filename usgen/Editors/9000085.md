...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_ExempleGeneral.gif)
...
In the graph, a group of processes can be detailed or not. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_AugmenteDetails.gif)  icon is used to expand a group of processes and ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_DiminueDetails.gif) is used to collapse a group of processes.
...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_ExempleSansDetail.gif)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_ExempleAvecDetail.gif)<br> |



**To increase the level of details**: 

- of a process: double-click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_AugmenteDetails.gif) in the process displayed in the modelling.

- of all processes in the graph: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_AugmenteDetailsTout.gif) in the toolbar.
...
- of a process: double-click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_DiminueDetails.gif) icon in the process.

- of all processes in the graph: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_DiminueDetailsTout.gif) in the toolbar.
...
- double-click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_BoutonCode.gif) in the process.
...
[Reverse modeling of inheritances](../Editeurs/2010106.md)

[Cross-references in the code editor](../Editeurs/9000090.md)
