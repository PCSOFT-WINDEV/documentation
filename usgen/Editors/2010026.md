...
In addition to simple images, you can insert clickable images in help pages. When the user clicks on the image (or part of the image), a specific help page can be displayed (as a page or popup).
...
5. The image description window appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Aide_image.gif&type=thumb)
...
Note: You can also select "Insert an image" in the context menu of the help page. 
...
3. In the window that appears, select the video you want to insert into the help page and confirm. 
	Note: The video file path can correspond to a video accessible from the current computer (mp4 or WebM file) or to the address of a video (YouTube or other). 
...
[Image properties (help system)](../Editeurs/2010027.md)

[Inserting a diagram in a help page](../Editeurs/2010033.md)
