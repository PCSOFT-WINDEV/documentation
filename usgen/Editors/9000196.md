...
<a name="simple_yet_powerful_code_ELTTEXTE000324"></a>
...
For more details, see [The different types of variables](../Motscles/1514013.md). 
...
<a name="powerful_programming_ELTTEXTE000354"></a>
...
For example, variable declarations in "FOR i" loops are implicit, SWITCH statements can use the entire range of WLanguage comparisons, etc.
...
### FOR EACH
<a name="for_each_ELTPARAGRAPHE000063"></a>FOR EACH loops traverse through all the elements of a set, e.g. all the records in a data file, all the elements in an array, all the selected controls in a list, all the substrings in a string, etc.
...
<a name="procedural_programming_ELTTEXTE000384"></a>
...
<a name="objectoriented_programming_ELTTEXTE000408"></a>
...
<a name="embedded_database_access_ELTTEXTE000432"></a>
...
<a name="handling_via_programming_ELTTEXTE000456"></a>
...
<a name="and_even_more_features_ELTTEXTE000480"></a>
...
<a name="defensive_programming_ELTPARAGRAPHE000181"></a>
...
WLanguage offers powerful debugging functions, such as [dbgAssert](../WDLang1/3014022.md), [dbgCheckEqual](../WDLang1/1000019776.md), [dbgCheckDifferent](../WDLang1/1000019777.md), [dbgCheckTrue](../WDLang1/1000019780.md), [dbgCheckFalse](../WDLang1/1000019781.md), etc.
The creation of unit tests makes it possible to test an application at any time.


### Multithreading and parallel tasks
<a name="multithreading_and_parallel_tasks_ELTPARAGRAPHE000204"></a>
...
### Cross-platform
<a name="crossplatform_ELTPARAGRAPHE000217"></a>
...
### Execution security
<a name="execution_security_ELTPARAGRAPHE000234"></a>
...
### Secure memory area
<a name="secure_memory_area_ELTPARAGRAPHE000239"></a>

Access to memory areas is controlled, which limits the risks of buffer overflow.


### External languages
<a name="external_languages_ELTPARAGRAPHE000244"></a>

You can call code written in an external language from WINDEV or vice versa: Java, C++, C#, Fortran, VB, etc.


### Openness
<a name="openness_ELTPARAGRAPHE000249"></a>

You have access to all features and standards: API, DLL calls, COM, ActiveX, .NET, J2EE, events, etc.
...
[WLanguage types](../Editeurs/1514013.md)
