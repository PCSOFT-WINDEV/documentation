...
3. In the configuration creation wizard:
	...
	- In the "Configuration compatibility" step, specify: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Composant_factory%20-%20HC%20N%B0001.gif&type=thumb)
