...
The query editor allows you to test the query result (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_Go_Fenetre_WD_bl.gif) or "Test query" in the context menu of the query).

During the test of the query, the initialization code of the project is run.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requete_ResultatTestRequete.gif)
**Remarks**:
...
- During the test of a [query with parameters](../Editeurs/2032045.md), a window allows you to specify the different parameters. 
	In this window, you have the ability to select an existing value via ![Existing value](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OrdreAffichage.gif). The following menu is displayed:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requete_MenuVisuValeur.gif)
You can:

	- select one of the possible values among the ones found in the table,
...
- The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeCalculette.gif) button is used to automatically display the mean, the total, the minimum and maximum values for the numeric result items.
...
- The result of an *insert query* corresponds to the record that will be inserted. During the test, the record is inserted directly into the table.
...
- The result of an *update query* corresponds to the records that will be modified. During the test, you can:
	...
	- or directly modify records in the table.
...
- The result of a *delete query* corresponds to the records that will be deleted. During the test, you can:
	...
	- or delete records directly from the table.
...
### Managing the passwords of tables
<a name="managing_the_passwords_tables_ELTPARAGRAPHE000113"></a>

If one of the tables taking part in the query is password protected, during the test of the query:
