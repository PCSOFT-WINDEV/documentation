...
2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeGenerationclasse.gif). The UML generation window opens.
...
1. Select "Generate UML model" in the context menu of the editor (or click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=UML_Ico_generer.gif)). The UML generation window opens. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GenerationDiagrammeclasse.gif)
...
[Generation of a class diagram using reverse engineering ](../Editeurs/2035009.md)
