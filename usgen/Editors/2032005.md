...
To add, modify or delete a sort, click the column used to sort the query items and select the operation to perform in the following menu: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requete_MenuTri.gif)
...
When several sort items are defined, the sorts are nested. To find out the sequence of the different items, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OrdreTri.gif) found in the middle section. The sort starts from the first item found in the table of sorted items. 
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnchainementTri.gif)
