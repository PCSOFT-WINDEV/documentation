...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Info_affiches_install%20-%20HC%20N%B0001%203.gif)<br> | <br><br>- ***Complete, minimal and customized***: all three installation models are available.<br><br>- ***Complete and minimal***: only a complete or minimal installation will be offered.<br><br>- ***Do not propose different models***: all application files will be automatically installed.<br><br><br> |
...
[WDInst: Additional options (summary, license, etc.)](../Editeurs/2028053.md)
