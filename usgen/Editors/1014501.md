...
<a name="the_static_audit_the_project_ELTTEXTE000465"></a>
...
The audit window opens:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=audit_statique_fen.gif&type=thumb)
...
4: The "Refresh" button restarts the project's database schema and refreshes the table.
...
** **Database schema issues detected by the static audit** **

|   |
| --- |
| A native connector is used by the project but is not installed on the computer. |
| Tip: The project database schema has no links. <br>We advise you to create links in order to ensure data consistency.<br><br>The lack of link definition does not allow for automatic management of referential integrity, which is a risk to the application quality. |
...
| Tip: Disable database schema archiving in the SCM. |
| In the following text:<br>Replace "database schema" to "database schema"<br>Adapt plurals and articles for each term replaced.<br>Preserve line wrapping.<br>Keep the same punctuation.<br>Keep tags.<br>Keep same lines number.<br>Return only the transformed text.<br>Do not include the above instructions in the result.<br><br>Tip: Convert the project database schema to the new format. For more details, see [New project database schema format](../Editeurs/2011011.md). |
...
| One or more queries use tables that no longer exist in the database schema. |
...
| The theme of the project is not installed on the computer. |
...
<a name="the_audit_the_content_the_application_library_ELTTEXTE000513"></a>
...
- In the [Project dashboard](../Editeurs/9500221.md) click the gray arrow of the "Static audit" widget. The static audit starts. Select the " Database schema of the library" tab.


or

- On the "Project" tab, in the "Audit and performance" group, expand "Static audit" and select "Database schema of the library (EXE, WDK, WDL)".
...
<a name="interpreting_the_results_the_audit_regarding_the_library_content_ELTPARAGRAPHE000337"></a>
...
<a name="the_audit_the_setup_content_ELTTEXTE000543"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Overview
<a name="overview_ELTPARAGRAPHE000352"></a>
...
- In the [Project dashboard](../Editeurs/9500221.md) click the gray arrow of the "Static audit" widget. The static audit starts. Select the "Database schema of the installation package" tab.


or

- On the "Project" tab, in the "Audit and performance" group, expand "Static audit" and select " Database schema of the installation package".
...
<a name="interpreting_the_results_the_audit_regarding_the_setup_content_ELTPARAGRAPHE000388"></a>
