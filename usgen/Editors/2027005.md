...
When a WINDEV, WEBDEV or WINDEV Mobile element (analysis, query, etc.) cannot be entirely displayed in the workspace, the "Browser" pane allows you to easily move within this element.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FenNavigateur.gif&type=thumb)
The context menu (right click) of the "Browser" pane allows you to:
...
- Save the image displayed in the "Browser" pane in EMF format ("Windows Enhanced Meta File"). This vector image can then be used in a presentation (Word, PowerPoint, etc.).
