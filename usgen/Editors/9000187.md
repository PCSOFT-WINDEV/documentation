...
2. On the "Compilation" tab, in "Programming standard", check the desired options: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Compilation_Norme%20-%20HC%20N%B0001.gif)
...
2. On the "Details" tab, click "Programming standard". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Compilation_Norme%20-%20HC%20N%B0003.gif&type=thumb)


3. In the window that appears, select the behavior for each option: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Compilation_Norme%20-%20HC%20N%B0004.gif)
