...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Dynamic%20serving.jpg)
...
3. The window that is displayed includes three sections: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Dynamic%20serving%20-%20HC%20N%B0001.gif&type=thumb)
...
4. To perform page associations:
	...
	- Drag and Drop the page to the "Computer version" section or click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Dynamic%20serving%20-%20HC%20N%B0001%201.gif). 
	...
	- Drag and Drop the page to the "Mobile version" section or click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Dynamic%20serving%20-%20HC%20N%B0001%202.gif).
...
1. In the quick access buttons, expand the Combo Box found beside the requested "GO" icon (page test or project test): ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Dynamic_serving_1%20-%20HC%20N%B0003.gif)

2. Select "Debug the mobile version (Dynamic Serving)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Dynamic_serving_1%20-%20HC%20N%B0002.gif)
