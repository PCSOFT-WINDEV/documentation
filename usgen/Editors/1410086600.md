...
- Display in "Mini-bar" mode: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Messagerie_Presentation%20-%20HC%20N%B0001%202.gif). 

- Display in "full" mode: on the "Home" tab, in the "Message" group, click "New". 

- Display in the Project Management Hub: on the "Messages" tab, in the "Messages" group, click "New". 
...
### Typing the message
<a name="typing_the_message_ELTPARAGRAPHE000113"></a>The message can be typed in the middle section of the window. A toolbar is used to format the message. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Messagerie_Ecrire%20-%20HC%20N%B0003%207.gif)
...
[WDBal messaging: Overview](../Editeurs/1410086599.md)
