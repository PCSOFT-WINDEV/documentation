...
This flexible model allows you to describe an existing or a forthcoming project, and to get a model that "evolves" with your application.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modelisation1.gif)
...
Diagrams are organized in a tree-like structure: From general to specific, with as as many levels as required.
...
- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_nouveau.gif) in the quick access buttons. 
	...
	- The [modeling creation wizard](../Editeurs/2010101.md) starts.




- Select "New flexible modeling" in the context menu of "Project explorer" pane. The [modeling creation wizard](../Editeurs/2010101.md) starts.
...
- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_ouvrir.gif) in the quick access buttons and select the requested "Templates (\*.wem)" file.
