...
<a name="using_hexecutequery_pass_parameters_query_ELTTEXTE000218"></a>
...
Example: Let's consider the "QRY_Customer_LastName_FirstName" query whose SQL code is as follows:
