...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Indentation_du_code.gif)
...
2. On the "Code" tab, check "Indent (pasted code is edited and indented to fit layout)".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Coller-Code.gif)
