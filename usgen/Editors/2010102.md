...
Path of the file linked to the element. The linked file can be an element of current project or another file.
...
1. Check whether the "Project explorer" pane is displayed in your environment: on the "Home" tab, in the "Environment" group, expand "Panes", select "Panes", and then select "Project explorer".

2. Open the description of the modeling element.

3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modelisation_Cible.gif) and keep the left mouse button down.
...
**If the modeling element is linked to a project element**, the modeling element contains the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=modelisation_liaison.gif) icon. This down arrow indicates that a link was established: double-clicking the element directly opens the linked object. You can also select "Opens the linked element" in the context menu of the element.

In the different editors, you can identify the elements in a modeling. A specific button is displayed in the description of the project element when this element is linked to a modeling.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modelisation_lien_fen.gif)
...
[Creating a flexible modeling](../Editeurs/2010101.md)

[Flexible modeling editor](../Editeurs/2010100.md)

[Modeling editor: Managing the styles](../Editeurs/2010105.md)
