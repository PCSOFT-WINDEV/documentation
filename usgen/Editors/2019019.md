...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_GO_Projet_WB_bl.GIF) in the quick access buttons (or press Ctrl + F9).
...
1. Expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_GO_Projet_WB_bl.GIF) in the quick access buttons: "Test project (xxx emulator)". 
...
<a name="directory_the_tables_used_for_testing_ELTPARAGRAPHE000304"></a>

To configure the tables used when testing the site in the editor:
...
Reminder: When testing the application, the tables used are those located on the development computer. The file system also corresponds to the Windows system for PC. To avoid any problems when the application is used in a real-case scenario, use [InTestMode](../WDLang1/3013011.md) to differentiate between the access to the tables in test mode and at runtime. 
