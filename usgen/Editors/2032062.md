...
7. In [the left section](../Editeurs/2032011.md), select the different items used by the query.
	...
	For more details on the items of a query, see [Items included in a query](../Editeurs/2032004.md).

8. In [the middle section](../Editeurs/2032011.md), select the item on which you want to perform an action (selection condition, sorting, etc.).
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_nouveau.gif) in the quick access buttons.  In the window that appears, click "Query". The query creation wizard starts.
...
[Selection query description window: Use ](../Editeurs/2032046.md)

[Example for creating a select query](../Editeurs/2032034.md)

[How to create an SQL query to get a sum?](../Editeurs/20060.md)

[How to create an SQL query to count?](../Editeurs/20042.md)

[How to create an SQL query with a calculation formula?](../Editeurs/20062.md)

[How to sort the result of a query?](../Editeurs/20061.md)
