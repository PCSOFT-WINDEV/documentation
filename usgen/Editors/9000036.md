...
The AAD proposes to select the column to anchor.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=AAD_TABLE.gif)
...
The AAD explains the problem and applies the best possible anchors whenever possible. If the AAD cannot define the best anchoring, different solutions are proposed.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=AAD_Ancrage.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Aide_au_developpement1%20-%20HC%20N%B0001.gif)
