...
The compilation process creates the final help file using all available elements, such as images, keywords, help pages, etc.
...
**Note**: Before compiling the help, make sure that the compilers provided with WINDEV, WEBDEV and WINDEV Mobile are referenced in the [options of the help editor](../Editeurs/2010020.md).
...
1. Open the help system options. To do so, go to the "Modification" tab, "Help system" group and click "Description".

2. On the "General" tab, select the default page.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=aide_compilation%20-%20HC%20N%B0001.gif)
...
1. On the "Modification" tab, in the "General" group, click "Options".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=aide_compilation%20-%20HC%20N%B0004%201.gif)


2. Select the type of help to generate and specify the generation options if necessary. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=aide_compilation%20-%20HC%20N%B0004.gif)
...
1. On the "Modification" tab, in the "General" group, click "Compile". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=aide_compilation%20-%20HC%20N%B0004%202.gif)
Compilation starts.
...
2. Once the compilation is completed:
	...
	- If the compiler detects errors, the status report of the compilation is displayed. This status report shows:
		...
		- warnings: These warnings indicate non-existing links in the help file, for example.

		- operations performed by the compiler, as well as the errors and problems encountered. The "Print" button is used to print the status report.
