...
- All the available themes can be used with an Android application.

- All the themes apply the holographic theme from Android 5. 
...
### Database schema of an Android project
<a name="database_schema_android_project_ELTPARAGRAPHE000115"></a>

When creating a database schema for an Android project, you have the ability to use: 
...
- In an SQLite database, each table should contain an automatic identifier (strongly recommended).
