...
2. Click the first empty row in the table of properties or click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeAjouterPropriete.gif)
...
2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeSupprimerPropriete.gif). The property is automatically deleted from the entity or from the association.
