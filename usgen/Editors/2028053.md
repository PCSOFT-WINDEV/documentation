...
- [perform a silent setup](#NOTE4_1_Silencieux). 
...
### Overview
<a name="overview_ELTPARAGRAPHE000060"></a>When installing an application update, you have the ability to save the existing application files. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Info_affiches_install%20-%20HC%20N%B0003.gif&type=thumb)
...
2. Check "Display the summary page before starting setup". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Info_affiches_install%20-%20HC%20N%B0001.gif&type=thumb)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Info_affiches_install%20-%20HC%20N%B0004.gif&type=thumb)
...
- quick installation (also known as "direct installation"): If the user chooses this option, the application is automatically installed with the default options. 

- customized installation: the user can configure the various installation options. 

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Info_affiches_install%20-%20HC%20N%B0002.gif&type=thumb)


Note: the default setting is for quick installation. 
<a name="NOTE4_2"></a>
...
Note: If this option is unchecked, the wizard will not display the step proposing one-click installation. 
...
2. Check the option: 
	...
	- **Silent client setup** end-user application installation will not require any action on the part of the user. 

	- **Silent deployment of reference version** (only available for network installations with automatic updates): installation of the network installation's reference version will be performed without user intervention.. 
...
Note: If these options are unchecked, the wizard will display all the options required to install the application. 
...
The setup of your application can start with the validation of a license agreement. The user must accept the terms of this license to continue the installation.
...
To display a license agreement at the beginning of setup: 

1. Select "Setup settings .. Wizard".

2. Select a license file for each language supported by the setup program ("Select" button). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Info_affiches_install%20-%20HC%20N%B0001%201.gif&type=thumb)
...
2. Select a "Readme" file for each language supported by the setup program ("Select" button). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Options%20install_WDInst%20-%20HC%20N%B0005%201.gif&type=thumb)
...
[WDInst: Set automatic modification of tables](../Editeurs/2028018.md)
