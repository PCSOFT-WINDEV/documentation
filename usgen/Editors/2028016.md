...
- [the setup program creation wizard](../Editeurs/2028062.md): This wizard allows you to quickly configure the setup program.
	...
	- In WINDEV, go to the "Project" tab, "Generation" group, expand "Setup procedure" and select "Create setup procedure"

	- In WDInst, select "File .. New". 
...
## Configuring the setup program
<a name="configuring_the_setup_program_ELTTEXTE000379"></a>
...
| Managing a tree structure of subdirectories in the installation directory |   | [X](../Editeurs/2028033.md) | Files installed in the installation directory chosen by the user. |
...
| Configuring the management of file collisions (application update) |   | [X](../Editeurs/2028033.md) | Automatic replacement of existing files in the installation directory. |
...
| Configuring the automatic data modification (application update) | [X](../Editeurs/2028043.md) | [X](../Editeurs/2028018.md) | Automatic modification of tables performed if necessary. |
| Selecting additional programs and external tools (MDAC, WDLog, etc.) | [X](../Editeurs/2028045.md) | [X](../Editeurs/2028024.md) | HFSQL optimizer installed if the application is associated with an HFSQL database. |
...
| Customizing the path of tables during setup | [X](../Editeurs/2028045.md) | [X](../Editeurs/2028017.md) | Setup path not modifiable. |
