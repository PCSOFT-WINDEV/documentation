...
**Example** Relationship page in the RAD Simple pattern: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Pattern_RAD_WWRelation.gif)
...
1. Create a supercontrol on the page: under the "Creation" pane, in the "Containers" group, click on "Supercontrol".. This supercontrol will display the controls found in the form. Position this control in the page and define its size. Scrollbars will be automatically displayed if some of the controls cannot fit in the specified size.
...
1. Create a Table control on the page: under "Creation", in the "Data" group, pull down "Table" and select "Table".
...
5. Enter the declaration code of the global variables of the page. Example:
	...
	GR_PartieFiche..Etat = DisplayOnly
	```
