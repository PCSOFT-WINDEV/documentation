...
Reminder: The keyboard shortcuts for a button are defined in the "UI" tab of the Button description window ("Keyboard shortcuts" option).
...
2. In the window that appears, press the desired keys. The selected keys appear: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Choix%20d'un%20raccourci.jpg)
Validate this window. 

3. Each time the window and the button are used, the shortcut indicated will be available.
...
<a name="changing_custom_keyboard_shortcut_ELTPARAGRAPHE000050"></a>
...
Note: If the shortcut "&lt;Aucun&gt;"is selected, the button will revert to its default behavior, as intended by the developer.
<a name="NOTE2_3"></a>
...
4. Confirm the import. The window is included in your project and it can be translated or modified. 
