...
<a name="what_are_the_files_created_and_supported_windev_webdev_and_windev_mobile_ELTTEXTE001338"></a>
...
| .AWWS | Library containing all the procedures of a web service. These procedures can be used by any application that uses your web service. For more details, see [Generate a web service](../WDLang3/3086002.md). | Execution |   |
...
| .FIC | HFSQL table | HFSQL | X |
| .FTX | [full-text index](../WDLang4/3044375.md) file. | HFSQL | X |
| .GAB | Theme of WINDEV/WEBDEV | Editors | X |
| .HSP | [HFSQL stored procedure](../WDLang4/3044360.md) | HFSQL | X |
| .HTM | Static HTML page | Execution | X |
| .LST | File containing the names of the various HFSQL tables to be saved (created by [WDLog](../WDJournal/3516006.md)) | Tools |   |
| .MCD | Description of the [Conceptual Data Model](../Editeurs/2011019.md) (CDM) | Database schema | X |
| .MDE | Procedures of [RAD patterns](../NonDocumente/2031001.md) | RAD | X |
| .MDF | Internal table of the database schema | Database schema | X |
| .MDL | Description file of [RAD patterns](../NonDocumente/2031001.md) | RAD | X |
| .MGR | Graphic section of database schema | Database schema | X |
| .MLD | Description of the [Logical Data Model](../Editeurs/2011011.md) (LDM) | Database schema | X |
...
| .PATTERN | [RAD pattern](../Editeurs/2031023.md) file. | Editors | X |
| .RAD | RAD information about the database schema | Database schema | X |
...
| .SDX | Spatial index file | HFSQL | X |
| .SEM | Internal file of the database schema. | Database schema | X |
...
| .VER | Internal file of the database schema. | Database schema | X |
| .WAMB | [WEBDEV theme](../Editeurs/2016020.md) | Editors | X |
| .WBC | List of identifiers of [classes](../Proprietes/2514004.md)<br>Note: In WINDEV 5.5, this extension corresponded to class compilation information. | Compilation |   |
| .WBE | List of identifiers of [reports](../WDChamp/1011023.md)<br>Note: In WINDEV 5.5, this extension corresponded to the compilation information for a report. | Compilation |   |
...
| .WBP | List of identifiers of a [project](../Editeurs/2030033.md)<br>Note: In WINDEV 5.5, this extension corresponded to project compilation information. | Compilation |   |
| .WBR | List of identifiers of a [query](../Editeurs/2032052.md). | Compilation |   |
| .WBW | List of identifiers of [windows](../WDChamp/1010025.md)<br>Note: In WINDEV 5.5, this extension corresponded to the compilation information for a window. | Compilation |   |
| .WCC | Information for compiling a [class](../Proprietes/2514004.md) (recreated after each compilation) | Compilation |   |
| .WCE | Information for compiling a [report](../WDChamp/1011023.md) (recreated after each compilation) | Compilation |   |
| .WCG | Information for compiling a [set of procedures](../Motscles/1513003.md) (recreated after each compilation) | Compilation |   |
| .WCI | List of elements in the [internal component](../Editeurs/2014100.md). | Editors |   |
| .WCP | Information for compiling a [project](../Editeurs/2030033.md) (recreated after each compilation) | Compilation |   |
| .WCW | Information for compiling a [window](../WDChamp/1010025.md) (recreated after each compilation) | Compilation |   |
| .WDA | Description of [database schema](../Editeurs/2011022.md) and HFSQL tables (in edit) for data model editor | Editors | X |
| .WDAP | Backup of the WDA table for the last generated database schema | Editors |   |
| .WDAUDIT | [dynamic audit](../Editeurs/1014502.md) file | Editors |   |
...
| .WDD | Description of [database schema](../Editeurs/2011022.md) and HFSQL tables (running) | Editors | X |
...
| .WDG | [Set of procedures](../Motscles/1513003.md)<br>Warning: In WINDEV 5.5, this extension corresponded to the file containing the list of files used by [WDInst](../Editeurs/2028042.md). | Editors | X |
...
| .WDIT | Translation file for an external component | External component | X |
| .WDK | File containing all the elements of a [external component](../Editeurs/2014002.md) | External component | X |
...
| .WDO | List of different elements provided with an [external component](../Editeurs/2014005.md) (tables, .INI files, etc.). | External component | X |
| .WDP | [WINDEV project](../Editeurs/2030033.md) | Editors | X |
| .WDR | [Query](../Editeurs/2032052.md)<br>Note: In WINDEV 5.5, this extension corresponded to the "include" module for tables | Editors | X |
...
| .WDY | Theme file at runtime. This file is required to apply a theme dynamically ([ChangeSkinTemplate](../WDLang1/3013026.md)).<br>If the project is associated with a theme, the WDY file corresponding to the theme is automatically included in the WDL (library). | Editors | X |
...
| .WL | WLanguage code that can be included in an application or in a site (by the [EXTERN](../Motscles/1511013.md) keyword)<br>Four files are provided with WINDEV (\\Personal\\Extern directory):<br><br>- "WinConst.wl": Standard Windows constants.<br><br>- "Limites.wl": Constants corresponding to WINDEV data type limits.<br><br>- "ListeDéfinitionHF.wl": HFSQL constants used for the [log process](../WDLang4/3044184.md).<br><br>- "EXCEPT.wl": most common exception codes (retrieved with [ExceptionInfo](../WDLang1/3034006.md)(*errCode*).<br><br>- "KeyConst.wl": standard Windows constants used for keyboard keys. These constants can be used by [KeyPressed](../WDLang1/3014007.md) in the optional WINDEV events "Key Down" or "Key up" by using the variable _EVE.wParam.<br><br><br> | Editors | X |
...
| .WSDL | [Description file of web services](../WDLang3/3086002.md) | Editors | X |
...
| .XDD | Internal table of the database schema | Database schema | X |
...
[WINDEV, WEBDEV and WINDEV Mobile tools](../Editeurs/3084011.md)
