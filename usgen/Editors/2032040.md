...
3. Select "Embedded query .. Open the associated query" in the context menu of the control. 
	Caution: the window or the page must have been saved at least once.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requete_menuIntegre.gif)
...
[Table, List Box and Combo Box controls bound to queries](../Editeurs/1013203.md)
