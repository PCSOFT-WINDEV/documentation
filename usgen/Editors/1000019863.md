...
**Why a PC?**
WINDEV Mobile 2026 is a Windows-only application. 
The iOS application will be created, developed and optimized on the PC. 
**Tip**: A PC is not mandatory. You can install a virtualization software such as "Parallels Desktop" on a Mac to run Windows on Mac. In this case, WINDEV Mobile can be run on Mac. 
...
Note: It's also possible to register with Apple on the **iOS and Mac Developer Program** as a developer of applications for the Mac, iPhone and iPad.. You must subscribe to deploy your applications. This allows you to download a version of Xcode. Xcode is free to download (at the time of writing this document).
...
**Note**: The minimum system requirements are as follows: 

- Hardware: iPhone 6, iPad Air,

- System: iOS version 11 or higher
