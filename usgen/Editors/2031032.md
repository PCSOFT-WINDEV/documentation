...
This help page presents the rules that apply when creating the pages of the RAD Pattern. These rules have been used to create the different patterns provided with WEBDEV 2026.
...
Example: Table page on the RADFileA file of the Simple Template pattern: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Pattern_RAD_WWTable.gif)
...
4. Create a Table control on the page: under "Creation", in the "Data" group, pull down "Table and List Box" and select "Table".
