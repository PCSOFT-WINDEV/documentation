...
**Note**: The template style sheets are located in the "Personal\\Templates\\WD\\&lt;Template&gt;" folder within the WINDEV installation directory.
...
3. Double-click the style (or select "Theme description" in the context menu).

4. Make the desired changes and apply them.

5. Save the style sheet (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Enregistrer.gif)).
...
- If a project was open when the style sheet was modified (".STY" file), go to the "Project" tab, "Project" group, expand "Recompile and synchronize" and select "Refresh style and theme" to take into account the changes made in the current project.




**Warning** When WINDEV is updated, changes made to theme style sheets may be overwritten. If modifications are performed in the style sheets of themes, we advise you to make a backup copy of the modified files.
<a name="NOTE3_2"></a>
...
3. Select "Delete" in the context menu (or press the Del key).

4. Save the style sheet (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Enregistrer.gif)).
...
- If a project was opened when a style was deleted from a style sheet: 
	...
	- close this project: under the "Home" pane, in the "General" group, pull down "Close" and select "Close project".

	- re-open this project to take account of the style's deletion in the current project: under the "Home" pane, in the "General" group, pull down "Open" and select "Open a project".
...
6. Save the style sheet (".STY" file) into which the style was imported (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Enregistrer.gif)). The imported style is now available in both style sheets.
	Note: If the imported style uses specific files (e.g. the image file displayed in the field background), these files are copied to the import style sheet directory.




**Warning** When WINDEV is updated, style imports into theme style sheets may be overwritten. If modifications are performed in the style sheets of themes, we advise you to make a backup copy of the modified files.
...
To define the default style for a type of control in the current project: 
...
3. Double-click the style (or select "Theme description" in the context menu). The style description window appears.

4. Go to the "Details" tab.

5. Check "By default" and validate.

6. Save the style sheet (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Enregistrer.gif)).




Note: If your project is associated with several themes, the default style will be selected in the following order:

- the style defined by default in the custom style sheet.

- the style defined by default in the style sheet of the theme associated with the current window.
