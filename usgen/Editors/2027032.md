...
The "Code snippets" pane lists the code snippets currently available.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=BriqueCode_Gestionnaire16.gif)
It is used to:
