...
1. On the "Home" tab, in the "General" group, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_imprimer.gif) and select "Print".
...
- a specific layout. To define this layout, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_imprimer.gif) and select "Documentation layout".
