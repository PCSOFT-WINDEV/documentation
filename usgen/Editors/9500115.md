...
## Combo Box control and List Box control: automation features (FAA)
...
- The List Box or Combo Box control must be populated programmatically or by a file loaded in memory.
...
To use the automatic feature for sorting a List Box or Combo Box control, select "Sort" in the context menu of the control.
...
**In** programming: the [AAFDisable](../WDLang1/1000022018.md) (or [DisableAAF](../WDLang1/3013061.md)) function used with the *faaSauveValue* constant removes the "Memorize value" option from the context menu of the specified List or Combo Box control.

**Remark**: It is also possible to memorize the value using the "Memorize value" option in the Tab Control description window ("Detail" tab).. This option is used to save the value even if the menu option was not enabled by the user. The menu option has priority if it was enabled by the user. 
...
**In** programming: function [AAFDisable](../WDLang1/1000022018.md) used with constant *faaSearchInCombo* disables search for the specified Combo Box control.

**Remark**: It is also possible to propose a default search field in the list of a Combo Box control using the "With search" option in the field description window ("Detail" tab).. This option can also be enabled by the [SearchAAF](../Proprietes/1000023445.md) property. 
...
[DisableAAF (Function)](../Editeurs/3013061.md)

[ExecuteAAF (Function)](../Editeurs/3013060.md)

[ConfigureAAF (Function)](../Editeurs/3014032.md)
