...
To simplify the reading of windows, the end user can zoom the content of a window with the mouse.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Zoom%20Fenetre-6.jpg)
**To zoom a window**, the user must use the Ctrl key and the mouse wheel.

**To reset the zoom level**, simply select "Cancel zoom" in the context menu of the window (or press Ctrl + 0).  

Note: If necessary, scrollbars may appear when zooming.. 
...
[AAF: Zoom the contents of a field (Table, Spreadsheet, List, Pivot Table, ...)](../Editeurs/9500135.md)

[Automatic feature for copying forms](../Editeurs/9500116.md)

[Translucent effect of windows](../Editeurs/9500103.md)

[AAFChangeCaption (Function)](../Editeurs/1000022100.md)

[AAFDisable (Function)](../Editeurs/1000022018.md)

[AAFExecute (Function)](../Editeurs/1000022099.md)
