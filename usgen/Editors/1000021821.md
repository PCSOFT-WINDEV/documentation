...
Reminder: The tooltip for a button is defined in the "Help" pane of the control description window ("Tooltip" option).. 
...
- Select "Edit the tooltip" in the context menu of the control.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Bulle%20d_aide%20-%20HC%20N%B0001.gif)
The tooltip text is displayed in modification. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Bulle%20d_aide%20-%20HC%20N%B0002.gif)


- Use the interface customization: 

	- Change to edit mode ("Customize interface .. Change to edit mode" in the context menu of the window). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Bulle%20d_aide_2%20-%20HC%20N%B0001.gif)


	- Right-click the control to open the context menu and select "Edit tooltip". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Bulle%20d_aide_2%20-%20HC%20N%B0002.gif)
...
- For some field types, tooltip customization is not taken into account: Map, HTML, ActiveX, Cube, ...
...
2. The "Options" button is used to specify the authorized options. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IMH_Modifiable_2%20-%20HC%20N%B0003.gif)
...
<a name="retrieving_the_modifications_ELTTEXTE000264"></a>
...
- or by using the "Open" option: In the "Home" pane, in the "General" group, pull down "Open", select "Open" and then the file to be opened.. 




The window that is displayed lists the different modified windows as well as the modification performed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IMH_Modifiable_3%20-%20HC%20N%B0001.gif)
