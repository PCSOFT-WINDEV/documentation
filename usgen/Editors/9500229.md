...
- directly from the WINDEV, WEBDEV or WINDEV Mobile menu: under "Project", in the "Project" group, click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0002%204.gif). 

- from the description window of an element, via the image selection context menu: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0002%201.gif)
...
- List and view the images located in the folders of the current project.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Galerie_projet%20-%20HC%20N%B0001.gif&type=thumb)
You can select only the desired folder, search for an image or sort the images that are displayed. You can also view images in a list with thumbnails or in a detailed list using the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Galerie_projet%20-%20HC%20N%B0001%201.gif) icons. 
...
- Edit image. This option is used to edit the selected image in the image editor of the product used. 
	Warning: This option closes the project image gallery. 
...
- The "Unused" option is used to list only images that are not used by the project. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Galerie_projet%20-%20HC%20N%B0004.gif&type=thumb)


- The "Duplicate" option is used to list potentially duplicate images stored in the different project directories. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Galerie_projet%20-%20HC%20N%B0003.gif&type=thumb)
