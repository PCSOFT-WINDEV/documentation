...
You can use a context menu to configure and customize your project dashboard (right click in an empty dashboard area). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TDB_Prj_MenuCtx.gif)
...
- [Project database schema](#NOTE3_3). 
...
The arrow button at the top right of widget is used to open a drop-down menu with the main project options: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TDB_Wid_Prj.gif)

<a name="NOTE3_3"></a>


### Project database schema
<a name="project_database_schema_ELTPARAGRAPHE000130"></a>

This widget allows you to find out whether the project is associated with a database schema. 

If the project is associated with a database schema, the name of the database schema and the number of tables found in the database schema are displayed. The arrow button is used to open the database schema in the editor. 

If the project is not linked to a database schema, the "Create a database schema" link allows starting the database schema creation wizard. 
<a name="NOTE3_4"></a>
