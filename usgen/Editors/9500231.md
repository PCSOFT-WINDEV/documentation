...
These projects often have functional links: they share components, classes, procedure collections, etc.
...
4. In the window that appears, enter: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Portefeuille%20-%20HC%20N%B0001.gif)


	- The name of the project portfolio. 

- The icon associated with the project portfolio. This icon is 32 x 32 in size. This icon can be selected via ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Portefeuille%20-%20HC%20N%B0001%201.gif) in the image catalog, in a directory or via the project gallery. 
...
Note: A project portfolio can also be created and manipulated via the "Recent and pinned projects" pane.. 
...
- To create a project portfolio, you can use: 
	...
	- the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Portefeuille%20-%20HC%20N%B0002%201.gif) icon. 
...
4. Validate. The selected project is added to the selected portfolio. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Portefeuille%20-%20HC%20N%B0002.gif)
...
- Only the path of the project is referenced. If the project is moved, it can no longer be manipulated by the Project portfolio: it will be necessary to remove the project from the portfolio and then add it again.. 

- A project can also be added to the portfolio by a simple drag and drop. 

- A project present in the GDS can be integrated into a Project portfolio: simply select the local directory of the corresponding project.. 
...
- on a project in a project portfolio. These actions are available in the context menu of the project: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Portefeuille%20-%20HC%20N%B0003.gif)


	- Open project: Opens the project directly.. 

- Remove project from portfolio: Removes project from project portfolio. 

- Open project directory: Opens the file explorer in the project directory.. 

- Copy project path: copies the project path to the clipboard. 

- Open project in another editor: when using a WINDEV product with integrated WEBDEV and/or WINDEV Mobile, selects the product to be used for the project.. 

- [Add a project to the portfolio](#NOTE3_2): Adds a new project to the project portfolio. 

- on all the projects in the project portfolio. These actions are available in the context menu of the project portfolio: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Portefeuille%20-%20HC%20N%B0004.gif)


	- [Create a branch for all projects](#NOTE4_2). 

- [Recompile projects in version 2026](#NOTE4_3). 
...
Warning: To use this option, at least one of the projects in the Project portfolio must be present in a GDS.. 
