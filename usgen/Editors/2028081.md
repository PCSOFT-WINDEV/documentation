...
- use the connection parameters defined in the database schema or programmatically. In this case, no additional information is requested.
...
- define the connection parameters when installing the application. The setup wizard proposes several options:
	...
	- configuration of connection to HFSQL Client/Server tables.

	- install the HFSQL Client/Server tables.
...
<a name="installing_server_and_choosing_type_server_ELTTEXTE000181"></a>
...
<a name="configuring_the_connection_ELTTEXTE000205"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Option_WDInst_HFSQL%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="installing_the_tables_ELTTEXTE000235"></a>
...
### Setting
<a name="setting_ELTPARAGRAPHE000089"></a>
...
<a name="installing_the_application_ELTTEXTE000265"></a>
...
[Selecting the application or the files to install ](../Editeurs/2028041.md)
