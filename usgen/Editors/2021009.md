...
5. Start the search (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_rech.gif)). If elements are found, the reference of these elements is displayed in the "Find - Replace" pane.
