...
If, when creating the executable, you select the "Yes: Run project backup wizard" option, the wizard will be automatically launched at the end of executable creation.
