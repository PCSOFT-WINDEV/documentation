...
The list of existing automated tests can be viewed in the "Tests" folder of the "Project explorer" pane. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Gestionnaire%20de%20tests%201%20-%20HC%20N%B0001.gif)
