...
2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_synchro_explorateur.gif) to select in the "Project explorer" pane the element that is currently displayed in the editor. The details of the variables available from the window or page are displayed in the "Project explorer" pane.
...
[Binding controls to data](../Editeurs/2022051.md)

[ScreenToSource (Function)](../Editeurs/1000017342.md)

[SourceToScreen (Function)](../Editeurs/1000017341.md)
