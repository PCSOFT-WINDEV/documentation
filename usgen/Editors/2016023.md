...
This help page describes the steps to follow. 
...
2. In the Windows file explorer, copy the directory containing the base skin template to use and rename this directory. The templates are located in the "\\Personal\\Templates\\WD" subdirectory of the WINDEV installation directory. 
	For example, copy the "190 Gensteel" directory and rename it to "Custom Gensteel". 
	**Caution**: the directory name must not contain a digit in front of the name.. This notation is reserved to the PC SOFT skin templates.
