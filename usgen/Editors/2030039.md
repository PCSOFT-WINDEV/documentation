...
You were used to using functions such as [HReadSeek](../WDLang4/3044050.md), [HReadNext](../WDLang4/3044037.md) to search your tables, to carry out complex processing, ... The processing required to search and display the search result could easily take dozens of lines of code.
