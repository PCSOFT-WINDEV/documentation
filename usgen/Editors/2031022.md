...
| <br><br>	- [Form window](../NonDocumente/2031036.md) (with link options if necessary)<br><br>	- [Table window](../NonDocumente/2031037.md) (with link options if necessary)<br><br>	- [Relation window](../NonDocumente/2031038.md) (with link options if necessary)<br><br>	- [Vision Plus buttons and window](../NonDocumente/2031040.md)<br><br>	- [Menu](../NonDocumente/2031041.md)<br><br><br> |
...
To find out all the elements that must be created to build a RAD Pattern for a full project, you must start from the database schema of the project:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RAD_Pattern.gif)


1. Let's hide the junction table named RADFileD. The following windows or pages must be created:
...
2. Now, let's hide RADFileA. The following windows or pages must be created:
	...
	- A form for RADFileC (this element has already been mentioned).
...
The different pages regarding the windows and the pages of the RAD patterns present different rules that can be applied when creating the pages and windows of the RAD pattern. These rules have been used to create the different patterns provided with WINDEV, WEBDEV or WINDEV Mobile 16.
