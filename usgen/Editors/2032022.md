...
3. In the window that appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=NPremierNDernier20.gif)
...
[How to create an SQL query to get a TOP 10?](../Editeurs/20045.md)
