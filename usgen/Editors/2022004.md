...
- Position: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Alignement_Position.gif)


- Inside and outside alignment: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Alignement_Int_Ext.gif)


- Size: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Alignement_Taille.gif)


- Centering and distribution: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Alignement_Centrage.gif)


- Other: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Alignement_Autres.gif)
...
**Note**: **Alignment visualization before application**
...
- **Example 1**: Exchanging two fields: Simply select 2 fields and their positions will be exchanged.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Echange_Champ.gif)


- **Example 2**: Cyclic position exchange: To position the control "SMTP Server" after the control "Address Email", simply select the control "SMTP Server" first, then "Password" and "Password confirmation".. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Echange_Champ_2.gif&type=thumb)
...
- Position fields as far to the left as possible, then as high as possible: The field(s) are moved as far to the left as possible (within the limits of the existing fields), then as high as possible (within the limits of the existing fields).. 
...
- Horizontal or vertical Alignment: fields can be aligned to the left or to the right according to the start of the field or the start of the edit zone.. They can also be aligned by the center.
