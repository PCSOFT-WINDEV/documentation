...
The current visible area is shaded in the scrollbar. And the movement of the small preview window is synchronized with the content of the code editor.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ascenseur_visuel_code%20-%20HC%20N%B0002.gif&type=thumb)
...
2. In the window that is displayed, select the "Code" tab. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ascenseur_visuel_code%20-%20HC%20N%B0001.gif&type=thumb)
