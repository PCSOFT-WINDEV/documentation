...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) [WDTestSite](../WDTestSite/3538003.md) that allows you to run different tests on a WEBDEV site.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) WINDEV and WINDEV Mobile allow you to run automated tests on:
...
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) WEBDEV allows you to run automated tests on:
