...
For example, delete the orders placed before January 1st 2010:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requete_RequeteSuppression.gif)
...
[Reports & Queries](../Presentation/3088004.md) cannot be used to create delete queries.
...
- To modify all the characteristics of a query: on the "Query" tab, in the "Edit" group, click "Description". For more details, see [Description of a query](../Editeurs/2032038.md).
...
[Description window of query (insert, update or delete) or description window of a query in SQL code ](../Editeurs/2032036.md)
