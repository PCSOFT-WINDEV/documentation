...
The principle of arrow windows is simple: when the user clicks on a button, the window is displayed against the calling button, with a directional arrow between the button and the window.. 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iPad_Fen_fleche.gif)
...
- The window with arrow uses the system look: the window frame and arrow design are provided by the iOS system.. 
...
2. On the "Style" tab, check "With title bar". 
...
**Remark**: Programming title change (property [Title](../Proprietes/2510090.md)) is only possible in the "Global declarations" event of the. 
<a name="NOTE2_3"></a>
...
- In the editor, use the "Open" quick action associated with the button. 
	...
	- On the "General" tab, in the "Action" area, select the window with arrow to open. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iPad_Fen_fleche_ouvrir.gif)
...
- Through programming, use [OpenChild](../WDLang1/3038021.md) in the click code of the button. 
	 Note: The [OpenChild](../WDLang1/3038021.md) function cannot be used several times in succession from the master window.. On the contrary, a parent window can open a child window that can open another child window.  
...
- The window with arrow can return a value that will be retrieved in the main window (in the "Close a child window" event). For more details, see the help about [Close](../WDLang1/3038018.md).  
...
[Events associated with windows](../Editeurs/1010021.md)
