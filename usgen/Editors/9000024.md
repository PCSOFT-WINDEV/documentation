...
<a name="creating_php_project_ELTPARAGRAPHE000096"></a>



To create a PHP WEBDEV project:

1. Create a WEBDEV project (for more details, see [Creating a WEBDEV project](../Editeurs/2030042.md)). By default, new WEBDEV projects use "Session" mode. 

2. Set the new project to PHP:  

	- Open the project description window. To do so, go to the "Project" tab, "Project" group, and click "Description". 

	- Change the type of site to PHP: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ProjetPHP.gif&type=thumb)


	- Confirm. You WEBDEV project for PHP has been created. You can now develop in WLanguage as for any other WEBDEV website.
...
Once the project is set to PHP, all the tools available in WEBDEV are automatically configured for PHP:

- The RAD model used to create pages or full applications is specific to a database manipulated by a PHP site.
...
**Note**: It is recommended to create a new PHP project to develop a PHP site rather than converting a WEBDEV website to PHP.
<a name="NOTE2_2"></a>


### The PHP RAD
<a name="the_php_rad_ELTPARAGRAPHE000163"></a>
...
You can create pages with preset forms, tables, etc. The PHP RAD takes into account all the specific features of the PHP generation (controls, events and functions that can be used in a WEBDEV website generated in PHP).
...
### Typing code in PHP
<a name="typing_code_php_ELTPARAGRAPHE000177"></a>

The codes run on the server side are represented by a Yellow or Pink header in the code editor.
...
<a name="testing_php_project_ELTPARAGRAPHE000189"></a>
...
<a name="deploying_php_site_ELTPARAGRAPHE000196"></a>
...
<a name="php_pages_with_without_context_ELTTEXTE000414"></a>
...
<a name="special_case_for_php_pages_without_context_ELTPARAGRAPHE000232"></a>
...
- In a new PHP WEBDEV project (starting with version 15), new pages have a context. 
...
## Limitations
<a name="limitations_ELTTEXTE000444"></a>
...
Only ISO-8859-1 (Latin alphabet no. 1) is supported. This character encoding scheme is used for the following languages: Albanian, Basque, Catalan, Danish, Dutch, English, Finnish (except Š and š), French (except Ÿ, œ and Œ), German, Icelandic (except „ and "), Italian, Norwegian, Portuguese, Rhaeto-Romanic, Scottish Gaelic, Spanish and Swedish. The Afrikaans and the Swahili are also supported.
