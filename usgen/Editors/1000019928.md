...
<a name="creating_project_for_catalyst_with_windev_mobile_ELTTEXTE000207"></a>
...
2. Display the description window for the current configuration: in the "Project Explorer" pane, display the "Configurations" context menu and select the "Description" option.  

3. On the "General" tab, check "Allow the application to run on macOS Catalina or later (Mac Catalyst)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=catalyst%20-%20HC%20N%B0001.gif)
...
<a name="developing_application_for_catalyst_with_windev_mobile_ELTTEXTE000231"></a>
...
<a name="specific_functions_for_asynchronous_mode_ELTPARAGRAPHE000063"></a>WLanguage offers specific functions to show information to the user:
...
As their name suggests, these functions are asynchronous: they don't block the code. The code after these functions is therefore run directly, even if the user has not validated the information box.
...
<a name="example_simple_code_adaptation_asynchronous_mode_ELTPARAGRAPHE000090"></a>
...
Note: for more concise code, it's perfectly possible to use lambda procedures instead of internal procedures.
...
<a name="example_complex_code_adaptation_asynchronous_mode_ELTPARAGRAPHE000105"></a>
...
3. Validate. The following events are automatically associated with the field: "Before automatic deletion", "After automatic deletion", "Line scan".
...
// Cancel deletion: deletion will only take place if the user clicks on "Yes".
RETURN False
...
[WarningAsynchronous (Function)](../Editeurs/1000025270.md)

[ConfirmAsynchronous (Function)](../Editeurs/1000025305.md)

[DialogAsynchronous (Function)](../Editeurs/1000025310.md)

[ErrorAsynchronous (Function)](../Editeurs/1000025306.md)

[ErrorWithTimeoutAsynchronous (Function)](../Editeurs/1000025428.md)

[InfoAsynchronous (Function)](../Editeurs/1000025269.md)

[InfoWithTimeoutAsynchronous (Function)](../Editeurs/1000025271.md)

[OKCancelAsynchronous (Function)](../Editeurs/1000025308.md)

[YesNoAsynchronous (Function)](../Editeurs/1000025272.md)
