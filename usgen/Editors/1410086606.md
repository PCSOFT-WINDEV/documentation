...
## Overview
<a name="overview_ELTTEXTE000352"></a>
The image editor includes several features. These features can be accessed via the specific editor ribbon ("Image" pane).  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0001%201.gif&type=thumb)
...
- **To print the image displayed in the editor**: 
	...
	1. Use: 
		...
		- the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Imprimer.gif) button in the "Home" pane. 
...
<a name="features_the_selection_group_ELTTEXTE000376"></a>
The image editor includes several selection tools: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0001%205.gif)
...
- **Wand**: Used to select a colored area without having to draw its outline. All you have to do is specify the tolerance for the selections performed with this tool. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_Image_baguette%20-%20HC%20N%B0001.gif)
...
<a name="features_the_general_group_ELTTEXTE000400"></a>
The options in the "General" group allow you to handle the image displayed in the editor: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0001%204.gif)
You can: 
...
- **Resize the image**: In the window that appears, specify the new size or the percentage to enlarge or reduce the image. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0002.gif)
...
- **Modify the work area**: When this option is selected, two actions are possible: 
	...
	- Resizing window: In the window that appears, specify: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0003.gif)
...
- **Rotation**: Rotates the current layer (preset or custom rotation). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0004.gif)


- **Symmetry**: Defines the symmetry of the current layer (horizontal and/or vertical). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0005.gif)
...
<a name="functions_the_display_group_ELTTEXTE000424"></a>
The "Display" group options allow you to manage the Image display in the editor.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0001%206.gif)
You can: 

- zoom in on Image: pull down the "Zoom" option and select the desired option: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0006.gif)
 You can also use the shortcut Ctrl++ to zoom in and Ctrl-- to zoom out.. 
	The "Images" pane can also be used to perform a zoom via the setting slider.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0002%201.gif)
...
<a name="features_the_tools_group_ELTTEXTE000448"></a>
The image editor proposes several tools for handling the image. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0001%203.gif)
...
- **Text**: Used to define a text area on the image. The text area is defined by the left mouse click. 
	Font, size, Alignment, Color, text attributes can be defined in the "Text" pane of the editor ribbon.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_img_calque%20-%20HC%20N%B0001.gif)


- **Watermark**: Allows you to add a watermark to the image. The watermark area is defined with the left mouse button. A window appears, allowing you to define the different watermark settings: font, color, alignment, angle, text, ... <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Editeur_img_Filigrane%20-%20HC%20N%B0001.gif)
...
<a name="features_the_transformation_group_ELTTEXTE000472"></a>
The image editor allows you to perform several transformations on the current image: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_Image_baguette%20-%20HC%20N%B0003.gif)
...
<a name="features_the_miscellaneous_group_ELTTEXTE000496"></a>
The image editor includes advanced features: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_image_ruban%20-%20HC%20N%B0001%202.gif)
...
<a name="effects_and_settings_ELTTEXTE000520"></a>
The image editor allows you to define several settings on the current image via the options in the "Effects and settings" group: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_Image_baguette%20-%20HC%20N%B0004.gif)
...
## Layers
<a name="layers_ELTTEXTE000544"></a>
...
In the ribbon, the options are as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_Image_baguette%20-%20HC%20N%B0005.gif)
...
The following operations can be performed in the "Layers" section of the "Images" pane: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_img_calque%20-%20HC%20N%B0002.gif)
...
[Image editor](../Editeurs/1410086603.md)
