...
## Additional modules
<a name="additional_modules_ELTTEXTE000317"></a>
<a name="NOTE2_2"></a>


### Including the setup of Reports & Queries
<a name="including_the_setup_reports_queries_ELTPARAGRAPHE000063"></a>

This option is used to include the setup of Reports & Queries in the setup of your application. 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Inst_EtatsRequete.gif)
...
<a name="displaying_license_agreement_ELTPARAGRAPHE000093"></a>

If "Display a license agreement during the setup" is checked, you will have to specify the file containing the license agreement in the rest of wizard. This file can be in text format (".TXT") or in RTF (".RTF" or ".WRI" for example).

If the setup program is multilingual, you must select a license for each supported language.

The license agreement will be displayed at the beginning of the setup. The user must accept the terms of this license to continue the installation.
<a name="NOTE2_4"></a>


### Displaying a "Readme" file
<a name="displaying_readme_file_ELTPARAGRAPHE000104"></a>
...
<a name="choose_the_optional_tools_that_will_included_the_setup_ELTPARAGRAPHE000121"></a>
...
| [WDLog](../WDJournal/3516012.md) | Saves and restores the tables in HFSQL format and manages the logs. |
| [WDOptimizer](../WDOptimiseur/3519002.md) | Optimizes access to HFSQL tables (reindexing, memo corrections, etc.). |
...
To avoid installing too many applications on the client computer, the files required by these tools will be installed in "\\Program Files\\Common files\\PC SOFT\\31.0". The path of the optional tools directory is returned by [SysDir](../WDLang1/3073026.md). For example: 


```wl
SysRep(srCommonProgramFiles) + "\PC SOFT\30.0"
```
...
<a name="include_the_uninstaller_ELTPARAGRAPHE000206"></a>
...
Note: The "uninst.INF" file will be created in the application installation directory.. This file lists all the application files installed on the user computers.
...
**Remark**: In order to uninstall the application, the uninstaller uses an entry in the registry. The setup program creation wizard allows you to modify this identifier. For more details, see [Modifying the identifier used to uninstall the application](../Editeurs/2028062.md).
<a name="NOTE2_7"></a>


### Install character fonts
<a name="install_character_fonts_ELTPARAGRAPHE000240"></a>
...
Note: Please check that you have the right to distribute these fonts.
...
[Languages supported by the setup ](../Editeurs/2028036.md)
