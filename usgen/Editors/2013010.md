...
2. On the "Code" tab, check "Save history of code changes". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Historique_code%20-%20HC%20N%B0001.gif&type=thumb)
...
2. On the "Code" tab, in the "Other actions" group, expand "History" and select "Show history of modifications". The history window appears.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Historique_code%20-%20HC%20N%B0004.gif)
...
3. Click the versions to the left of the window to scroll through the changes made on the current process. This window allows you to:
	...
	- view the differences between the selected element and the current version (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Historique_code%20-%20HC%20N%B0004%201.gif)).

	- print the version shown (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Historique_code%20-%20HC%20N%B0004%202.gif)).
...
**Note** The code history window can also be used to delete the current modification (button ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeSupprime.gif)).
<a name="NOTE2_5"></a>
...
When a project is in the SCM, the code editor proposes an advanced history of the line of code. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Historique_Code_GDS.gif)
...
- Option "Date and Author" enabled: Under the panel "Display", in the group "Help for edit", check the option "Show date and author" (F6 key). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Historique_code%20-%20HC%20N%B0002.gif)
