...
A possible problem that may occur in Windows Vista (or later) was detected. You have the ability to click the [Debug] button to correct this problem. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Erreur_Vista.gif)
...
Attempt to write into a directory where you do not have sufficient rights (with the fxxx or INIxxx functions for instance).
