...
### A function is not available on Linux: how can I adapt my existing code?
<a name="function_not_available_linux_how_can_adapt_existing_code_ELTPARAGRAPHE000020"></a>
...
Note: A wide range of execution targets Exist. You can combine them in the same statement. 
...
Some fields are not yet available in the Linux framework, such as TreeView control, Table control, Bar Code control and Shape control.. 
