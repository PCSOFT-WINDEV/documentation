...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Volet_modifieur%20-%20HC%20N%B0001.gif)
...
<a name="displaying_the_modifier_pane_ELTTEXTE000204"></a>
...
For more details on how to manage panes, see [Handling dockable shutters](../Editeurs/2027001.md).
...
<a name="viewing_andor_modifying_the_characteristics_ELTTEXTE000228"></a>
...
<a name="viewing_andor_changing_the_characteristics_one_more_controls_with_the_modifier_ELTPARAGRAPHE000074"></a>
...
2. Make the desired changes. These modifications are performed on all the selected controls. You can:
	...
	- select the new value in a screen (modification of a color for example).
...
**Note** To ensure that the characteristics displayed in the modifier correspond to the element selected in the modifier drop-down list (and not to the element currently selected in WINDEV, WEBDEV or WINDEV Mobile):

1. On the "Display" tab, in the "Options" group, click the dialog box launcher (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_regroup.gif)). 
...
<a name="viewing_andor_modifying_the_characteristics_window_page_report_with_the_modifier_ELTPARAGRAPHE000117"></a>

To view and/or modify the characteristics of a window, page or report with the modifier:

1. If necessary, open the window/page (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_ouvrir.gif) in the quick access buttons).
