...
2. Create an iOS 13 widget configuration:
	...
	- In the "General information" step of the wizard, select "iOS widget".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Cr%E9erAppliWidgetIOS13%20-%20HC%20N%B0001.gif&type=thumb)


	- In the "Associated iOS application" step of the wizard, select the iOS configuration of the project associated with the iOS widget configuration.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Cr%E9erAppliWidgetIOS13%20-%20HC%20N%B0002.gif&type=thumb)
