...
For applications using local HFSQL tables, it is now necessary to use the Windows directory provided for this purpose. For Vista/7/8, it is "C:\\ProgramData".
