...
The menu of your site can be a horizontal or a vertical drop-down menu.
...
2. Create the menu: under the "Creation" pane, in the "Navigation" group, click on "Menu".

3. Menu items used for specific RAD options must have a specific name: "MENUFIC_XXX" (e.g. MENUFIC_RADFileA). The menu options with this name will be duplicated for each table of the database schema.
...
Example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=pattern_Page_Menu.gif)
