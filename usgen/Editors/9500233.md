...
- Standard tooltips: 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bulles_aide_personnalisees%20-%20HC%20N%B0001.gif)


- Theme tooltips: 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bulles_aide_personnalisees%20-%20HC%20N%B0003.gif)
...
2. On the "Style" tab, specify the type of tooltip to be used in the project: 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bulles_aide_personnalisees%20-%20HC%20N%B0002.gif&type=thumb)


	- Standard: Standard tooltips with a yellow background. 

- Defined by the theme: Tooltips from the project's theme. 

- Custom: Opens the tooltip style editor opens with various customization options: 
			<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bulles_aide_personnalisees%20-%20HC%20N%B0004.gif)
You can customize: 
