...
<a name="creating_project_for_linux_with_windev_ELTTEXTE000372"></a>
...
1. In the project explorer, select the "Windows 64-bit executable" configuration. 
...
<a name="creating_project_configuration_for_linux_ELTTEXTE000396"></a>
...
1. In the "Project" pane, in the "Project configuration" group, click on "New configuration" and select "64-bit Linux executable".. Project configuration wizard. Go to the next step.

2. Enter configuration name and description.

3. Finish the wizard. The project configuration is created and automatically selected..  




**Remark**: You can include or exclude project elements in the project configuration at any time using the "Project Explorer" pane (option "Include in current configuration" or option "Exclude from current configuration").. For more details, see [Project configuration](../Editeurs/9000030.md). 
...
<a name="testing_linux_windev_project_ELTTEXTE000420"></a>
...
<a name="creating_the_linux_executable_ELTTEXTE000444"></a>
To create the Linux executable: 

1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_Generer_exelx.gif) in the quick access buttons (this icon appears if the current configuration is a Linux configuration). 
...
Note: To open a file explorer on the application's generation directory, under the "Home" pane, in the "General" group, pull down the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Rep_Projet.gif) option and select "Open generation directory".. 
...
<a name="distributing_the_linux_executable_ELTTEXTE000468"></a>
...
<a name="using_linux_executable_ELTPARAGRAPHE000291"></a>
...
[How to develop a site for Linux? ](../Editeurs/9000055.md)
