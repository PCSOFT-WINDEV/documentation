...
5. On the "tables" tab, select "HFSQL Client/Server".
...
7. If there are tables specific to the User Groupware, copy them to the server.
...
3. On the "General" tab, select "Manual start (programmatically)". 
...
6. If there are tables specific to the User Groupware, copy them to the server.
