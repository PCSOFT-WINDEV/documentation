...
On an Application Server, we advise you to use WEBDEV Account Manager of WEBDEV to automatically create the accounts and directories and to automatically apply the necessary permissions to the directories.
