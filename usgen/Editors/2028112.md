...
1. Create the application executable by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_generation_exe.gif) in the quick access buttons.
...
The diagram below presents the setup mode of an application that uses a local HFSQL Classic database, with a network update. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P3-Installation%20avec%20mise%20%E0%20jour%20r%E9seau-En%20Ligne.gif&type=thumb)
