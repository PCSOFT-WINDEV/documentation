...
The following diagram shows a summary of the bindings between controls and data:  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=3tiers_databinding.gif)
...
[Data Binding: Creating controls from the "Project explorer" pane](../Editeurs/2022050.md)

[Table control based on a variable](../Editeurs/1013306.md)
