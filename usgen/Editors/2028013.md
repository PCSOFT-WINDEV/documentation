...
**Note** To ask the user to confirm the various changes made to the system during installation of the:

1. Start WDInst if you haven't already: under the "Tools" pane, in the "Utilities" group, click on "WDInst".
...
By default, the installation program offers to launch the application executable at the end of the installation. The option "Start the program" is checked. The executable is automatically run when clicking the "Done" button.
...
**Note** If changes are made to the "AutoExec.BAT" file, it is advisable not to run any program at the end of the installation. Indeed, the modifications performed in this file will be taken into account when the computer is restarted.
<a name="NOTE2_2"></a>
...
1. Select "Setup settings .. End of setup".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Options%20install_WDINST%20-%20HC%20N%B0005%204.gif&type=thumb)
...
2. Enter the executable that must be run at the end of the application setup ("Command line" option).
	...
	- The name and full path of the executable file. The following keywords can be used:
		...
		- **- &lt;FicInst&gt;**: directory for installing data files. WDInst is used to configure this directory. 
						For more details, see [Configuring the table directory](../Editeurs/2028017.md).

		- **- &lt;RepWin&gt;**: Windows directory of user workstations.
...
The uninstaller can be included with the application setup. This makes it possible to uninstall the application via the Windows options. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Options%20install_WDINST%20-%20HC%20N%B0005%202.gif&type=thumb)
...
2. Select the new identifier of the application.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Options%20install_WDINST%20-%20HC%20N%B0005%203.gif&type=thumb)





**Note**: This identifier may or may not contain spaces.
...
1. Select "Setup parameters.. System configuration".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Options%20install_WDINST%20-%20HC%20N%B0006%201.gif&type=thumb)
...
**Note**: To add the application installation directory directly to the PATH, use the buttons:
...
To modify or create ".INI" files during the setup: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Options%20install_WDINST%20-%20HC%20N%B0006%202.gif&type=thumb)
...
2. Specify the relevant ".INI" file. This file will be created if necessary. You can specify:
	...
	- The name and full path of the file.
		...
		- **&lt;FicInst&gt;**: directory for data file installation. WDInst is used to configure this directory. For more details, see [Configuring the table directory](../Editeurs/2028017.md).

		- **&lt;RepWin&gt;**: directory of Windows for user stations.
						For example: "&lt;RepInst&gt;\\MyDirectory\\MyFile.INI".
...
1. Select "Setup parameters.. System configuration".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Options%20install_WDINST%20-%20HC%20N%B0006%203.gif&type=thumb)
...
[WDInst: set the directory for tables and User Groupware files ](../Editeurs/2028017.md)
