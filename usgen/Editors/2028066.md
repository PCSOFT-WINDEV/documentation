...
The WDInst installation editor offers advanced management of the files to be installed, compared with the wizard used to create the installation program.
...
The files to install can be viewed in the "List of setup files" window of WDInst.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Parametrer_caract_installation_fichier%20-%20HC%20N%B0001%201.gif&type=thumb)
...
For example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TypeFichier.gif)
To view the files associated with a [group of files](../Editeurs/2028010.md), select the requested group in the "Displayed group" combo box.
<a name="NOTE2_3"></a>
...
3. To filter the files displayed according to a search criterion, enter the search criterion in the "Filter" option ("\*.DLL" or "\*customer\*" for example) and click the "Filter" button. 
	**Note**: Wildcard characters (\*,?) are allowed.
...
[WDInst: Grouping the files to install ](../Editeurs/2028010.md)
