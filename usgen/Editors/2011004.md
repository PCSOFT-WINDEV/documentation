...
2. Specify:
	...
	- the **name of the association**. When the LDM is generated from the CDM, this name will be the logical name of the created table if this association contains at least one property or belongs to a complex link.
