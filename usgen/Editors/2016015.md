...
2. Display the window for editing the style sheets ("Choose a style" in the context menu of the control).
...
Note: It is also possible to create a new style from the control description window:
...
2. Display the window for editing the style sheets ("Choose a style" in the context menu).

3. Select the style to modify.

4. Click the "Modify" button. The style description window appears.
	**Note** The "Modify" button is grayed out if the selected style belongs to a non-modifiable style sheet (e.g. a theme style sheet).
...
- To apply the changes made on all the controls that use this style in the current project, go to the "Project" tab, "Project" group, expand "Recompile and synchronize" and select "Refresh style and theme".
...
4. Click the "Delete" button and confirm the style deletion.
	**Note** The "Delete" button is grayed out if the selected style belongs to a non-modifiable style sheet (e.g. a theme style sheet).
