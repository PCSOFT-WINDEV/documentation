...
- ***multi-instance***. A multi-instance program can be launched several times from the same workstation: several instances of the program will be open simultaneously.
