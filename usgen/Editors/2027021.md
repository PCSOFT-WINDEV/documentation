...
The "Messaging" pane is used to exchange messages between the employees of a company.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=VoletMessagerie.gif)
