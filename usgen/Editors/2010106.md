...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RetroModel_Heritage.gif)
...
- of a template: double-click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_AugmenteDetails.gif) icon in the modeling.

- of all templates in the graph: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_AugmenteDetailsTout.gif) in the toolbar.
...
- of a template: double-click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_DiminueDetails.gif) icon in the process.

- of all templates in the graph: click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Retro_DiminueDetailsTout.gif) in the toolbar.
...
[Control template](../Editeurs/9000095.md)
