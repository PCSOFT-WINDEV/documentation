...
To perform a multiple installation of the same WEBDEV dynamic site on the same server, simply launch the site installation wizard: in the "Project" pane, in the "Generation" group, pull down "Deploy site" and select "Generate and deploy site".
