...
2. Right-click to open the context menu and select "Image properties".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Aide_image.gif&type=thumb)
...
This image can be modified via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button: 
...
3. Define the click area with the mouse or adjust the values under" Clickable area parameters ".
	Note: To make the clickable area cover the entire image, click "Entire image". 
