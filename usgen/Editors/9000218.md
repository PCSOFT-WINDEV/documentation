...
- **Highlight the declaration and uses of the current variable**: 
	Each time the cursor is positioned on an identifier (variable, procedure, table, etc.), all occurrences of this identifier are highlighted in the current code. For more details, see [Code editor: Various operations](../Editeurs/2010031.md). 
...
- Cursor thickness: This value ranges from 1 to 8. If the "Block" option is selected, the cursor will be as wide as a character. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wx-taille-du-curseur-vitesse-clignotement.gif)
...
- using the legacy format, i.e. comments preceded by "//". For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CommentaireResume.gif)
