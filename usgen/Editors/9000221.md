...
- **Generation of code based on existing code**:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IA%201%20integre%20editeur%20testSL.gif)
AI detected the query items, found the Table control and populated the columns with the corresponding items.




- **Generation of an iterative operation**:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IA%202%20-%20V2.gif)
...
- **On-the-fly code generation**:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IA%20a%20la%20volee.gif)
