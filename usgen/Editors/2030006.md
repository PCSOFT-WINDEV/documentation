...
All the elements of a project (windows, reports, classes, sets of procedures, queries, etc.) can be transferred from one project to another within the same IDE. Importing elements is used to add elements coming from another project into the current project. 
