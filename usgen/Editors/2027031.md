...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=VoletErreur_nb.gif)
...
- The "Compilation errors" pane can display the errors in a list box or in a TreeView Table. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_erreur_table.gif) button is used to modify the display mode. 
