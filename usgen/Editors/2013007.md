...
1. In the code window, enter one of the glossary abbreviations.
	...
	- if the assisted code entry is enabled: the name of the corresponding function automatically appears in the list under the typed characters.

	- if assisted entry is not enabled, press F5: the name of the corresponding function automatically appears in the list below the characters entered.
