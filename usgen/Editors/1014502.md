...
2. Use one of the following methods: 
	...
	- On the "Project" tab, in the "Test mode" group, expand "Test mode" and select "Debug project while the audit is enabled". 
			![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Not available.
...
When loading a dynamic audit, the following window is displayed:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=audit_dyn_fen.gif)
...
[dbgEnableAudit (Function)](../Editeurs/1000018835.md)

[dbgWriteCommentAudit (Function)](../Editeurs/1000018839.md)

[dbgWriteWarningAudit (Function)](../Editeurs/1000018838.md)

[dbgAuditStatus (Function)](../Editeurs/1000018836.md)

[dbgAuditOption (Function)](../Editeurs/1000018837.md)
