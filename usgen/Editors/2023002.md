...
The dictionary is a file that can contain elements of the project: descriptions of tables, controls, windows, etc. The dictionary is a convenient way to store the created elements so that they can be re-used in new projects.
