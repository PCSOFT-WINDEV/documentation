...
The languages supported by the setup program will be proposed to the user when installing the application.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Info_affiches_install%20-%20HC%20N%B0002.gif)
...
[Configure the setup program interface ](../Editeurs/2028061.md)
