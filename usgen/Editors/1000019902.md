...
## Caution
<a name="caution_ELTTEXTE000252"></a>
...
<a name="generating_the_application_ELTTEXTE000276"></a>
...
To generate the application in WINDEV Mobile, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Generation_iOS_WM_bl.gif) in the quick access buttons.

On the screen below, insert the App Id supplied by Apple: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Applestore_dep1.gif&type=thumb)
...
Once connected, click the "Certificates, Identifiers & Profiles" option.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=23_IOS_Deploiement1.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=23_IOS_Deploiement2.gif)


- The wizard for creating a new profile starts. Select: 

	- the type: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=23_IOS_Deploiement3.gif)


	- the identifier: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=23_IOS_Deploiement4.gif)

- Specify the profile name: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=23_IOS_Deploiement6.gif)


- The profile is generated and it can be downloaded. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=23_IOS_Deploiement7.gif)
...
<a name="preparing_the_application_for_deployment_the_app_store_ELTTEXTE000300"></a>


### Necessary images
<a name="necessary_images_ELTPARAGRAPHE000109"></a>
...
### iTunes Connect
<a name="itunes_connect_ELTPARAGRAPHE000121"></a>
...
- Click "My apps". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=itunes_connect1.gif)


- Add your application via the "New app" button. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=itunes_connect2.gif)


- Fill the requested information: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=itunes_connect3.gif)
...
<a name="deploying_the_app_store_ELTTEXTE000330"></a>


### Compilation on Mac
<a name="compilation_mac_ELTPARAGRAPHE000148"></a>
...
- When the application is compiled, an archive must be built via "Product .. Archive". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=XCode_archive1.gif)

	Remark: If the "Archive" option is grayed out, deselect the specified target device and select "None/Any". 

- The organizer is automatically started on the "Archive" tab.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=xcode_archive2.gif)
