...
<a name="generating_php_site_with_webdev_ELTPARAGRAPHE000011"></a>
...
A syntax and lexical database schema is now available for PHP and JavaScript code.
...
<a name="the_properties_available_php_ELTTEXTE000151"></a>
...
| [Description](../Proprietes/1000017164.md) | The **Description** property gets and sets the page description. |
...
| [HTMLEndPage](../Proprietes/1000020177.md) | The **HTMLEndPage** property gets and sets the HTML code inserted at the end of the page. |
