...
2. In the description window of the current project configuration, in the "User Groupware: Inactive" area, click on the "Modify" button.. 
...
6. In the initialization code of the project, use [gpwOpenConnection](../WDLang6/3041007.md) to define the connection to the database handled by a Native Connector.  
	**Caution**: User Groupware data file passwords are not taken into account.
