...
<a name="how_manage_styles_ELTTEXTE000116"></a>
...
- apply a style to a paragraph.
	...
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Combo_style.gif)


- dissociate a style. To do so, go to the "Modification" tab, "Styles" group, and select "Dissociate styles".
