...
3. In "External resources", you can add JavaScript resources: 
	...
	- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeAjouterPropriete.gif) and select the JavaScript file path.
...
4. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeAjouterPropriete.gif) and select the JavaScript file path.
