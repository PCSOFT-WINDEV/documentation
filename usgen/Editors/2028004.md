...
2. Go to the "Shortcut" tab of the "File description" window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Parametrer_caract_installation_fichier%20-%20HC%20N%B0002.gif)
...
2. Go to the "Version" tab of the "File description" window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Parametrer_caract_installation_fichier%20-%20HC%20N%B0003.gif)
...
2. Check "Propose to save the elements replaced with the setup program". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Info_affiches_install%20-%20HC%20N%B0001.gif)
