...
3. In the header of the procedure, click "WL" to change the type of code. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=saisir_code_kotlin%20-%20HC%20N%B0001.gif)


4. In the list that opens, select "Kotlin". 

5. The header becomes purple and "Kotlin" appears to the left of the procedure name. The existing code is commented out. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=saisir_code_kotlin%20-%20HC%20N%B0002.gif)


6. Write the Kotlin code directly in the code editor in WINDEV Mobile.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=saisir_code_kotlin%20-%20HC%20N%B0003.gif&type=thumb)





**Remark**: To return to WLanguage code, simply click on "Kotlin" in the procedure banner and select "WLanguage".
<a name="NOTE2_2"></a>
...
- Please note: you must add the imports corresponding to the Kotlin classes used in the native Kotlin code entered (using the "Import" keyword).. It is recommended to import these elements before declaring the method. 

- Kotlin is case-sensitive: please ensure that function names are case-sensitive.
