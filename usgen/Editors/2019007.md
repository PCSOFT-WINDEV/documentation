...
**Remark**: WEBDEV administrator only allows you to test dynamic sites or the dynamic part of "static + dynamic" sites.
...
1. Display the WEBDEV administrator (to do so, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_WWAdmin.gif) found in the task bar).
