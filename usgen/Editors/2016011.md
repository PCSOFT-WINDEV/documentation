...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Only the skin templates on reports are available. To define the interface of the pages found in a site, use:

- a [page template](../WDChamp/1012015.md).

- a [skin](../Editeurs/2016020.md). 


**Remarks: Skin templates and templates**: 
...
- A skin template can also be associated with a project ("Project theme" in the "Style" tab of the project description). The selected skin template will be proposed by default when creating a window or report.
...
<a name="create_report_skin_template_ELTPARAGRAPHE000200"></a>
...
2. On the "Style" tab, choose the "None" skin template. 
...
3. For each window in the project: 
	...
	- On the "Style" tab, select the "None" skin template.
...
### Required files
<a name="required_files_ELTPARAGRAPHE000321"></a>
...
[Creating a window skin template](../Editeurs/2016009.md)

[Creating the skin template of a report](../Editeurs/2016005.md)

[Page templates](../Editeurs/1012015.md)

[Window templates](../Editeurs/9000086.md)
