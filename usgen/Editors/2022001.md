...
These rulers have snap-on guides: any control that comes close to a guide is automatically "snapped" by it. This feature allows you to easily position, align or resize the controls found in the window, page or report.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Regles.gif)
1: Markers
