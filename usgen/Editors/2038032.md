...
Example: 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Branche-Fusion-et-reintegration-de-modification-01.gif)


In this example, there is a main branch (named "My Version") from which a "Version 1" branch has been created. The origin is the state of the project at the time the branch was created. This origin is registered in the branch, and will be used later for an automatic merge.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Branche-Fusion-et-reintegration-de-modification-02.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Branche-Fusion-et-reintegration-de-modification-03.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Branche-Fusion-et-reintegration-de-modification-04.gif)
...
For each case, you can choose the elements to be taken into account in the merge. Simply click the table cells that correspond to the version you want to keep. 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GDS_R%E9cup%E9rer_fusion%20-%20HC%20N%B0004.gif&type=thumb)


Note: The "Complete view (show all the differences with origin)" option also displays differences with the original version, i.e. when the branch was created.  
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GDS_R%E9cup%E9rer_fusion%20-%20HC%20N%B0005.gif&type=thumb)


This window is divided into three parts: 

- the "Current project" column, which shows the code in the project currently open in the editor. 

- the "Result" column, which corresponds to the merged code that will be used. 

- the "Changes to propagate" column, which shows the code used in the branch. 
...
Note: The "View original version" option adds a fourth column with the code of the original version. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GDS_R%E9cup%E9rer_fusion%20-%20HC%20N%B0006.gif&type=thumb)
