...
A context menu is automatically proposed for the edit controls used to enter a file name and path. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=faa_Chemin_de_fichier%20-%20HC%20N%B0002.gif)
...
Therefore, the user can check whether the proper image or document was selected. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=faa_Chemin_de_fichier%20-%20HC%20N%B0001.gif)
