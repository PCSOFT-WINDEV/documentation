...
**Note**: By default, when you add an element to the local project, the Source Code Manager automatically prompts you to add it to the SCM repository when the element is saved.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ajout_element_base%20-%20HC%20N%B0001.gif&type=thumb)
...
2. Select "Add to Source Code Manager" in the context menu.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ajout_element_base%20-%20HC%20N%B0002.gif)
...
### Add element window
<a name="add_element_window_ELTPARAGRAPHE000044"></a>When you add an element to the SCM, the following window appears:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ajout_element_base%20-%20HC%20N%B0003.gif&type=thumb)
You can:
