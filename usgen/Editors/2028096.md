...
1. Open this project in WINDEV: click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_ouvrir.gif) among the quick access buttons and select "Open a project".. 
...
5. Create a new executable: click on ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_generer.gif) among the quick access buttons and select "Generate 32-bit Windows executable".. In the wizard, don't forget to include the new languages in the executable. 
