...
## Common shortcuts
<a name="common_shortcuts_ELTTEXTE001562"></a>
...
| Ctrl + S | Save the element being edited |
...
| Shift + Resize | Resizes all controls in the selection proportionally.  |
...
| Space + Move | Move the view in the editor if the element is larger than the editor. |
...
| --- | --- |
| **Search shortcuts** |
| Ctrl + E | Quick search for a project element<br>This search also includes procedures, methods, controls, etc. |
| Ctrl + F | Find |
| Ctrl + H | Find/Replace |
...
| Ctrl + J | Open the time management window |
...
| Note: + means that the keys <br>must be pressed simultaneously. |
...
<a name="code_editor_shortcuts_ELTTEXTE001586"></a>
...
| Ctrl + Alt + Up arrow | Selection of lines of code by blocks: Select the block above the selection. |
| Ctrl + Alt + Down arrow | Selection of lines of code by blocks: Select the block below the selection. |
...
| Alt + Down Arrow | Move a line of code to the bottom. |
| Mouse wheel | Scroll through lines of code vertically. |
| Alt + Mouse wheel | Quickly scroll through lines of code vertically.<br><br> |
| Shift + Mouse wheel | Scroll through lines of code horizontally. |
| Alt + Shift + Mouse wheel | Quickly scroll through lines of code horizontally.<br><br> |
...
| Alt + F3 | Perform a quick search. |
| Ctrl + F3 | Find occurrences of the word on which the cursor is positioned. All occurrences found are highlighted in the code. |
...
<a name="window_editor_shortcut_ELTTEXTE001628"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) The following shortcuts are available in the window editor: 
...
| Shift + Alt + D | Enable 3D mode for the window and start the animation <br>(Back to 2D mode: Esc) |
...
| Move control + Alt | Move a control in an orthonormal basis. <br><br>This legacy shortcut can be replaced with the more common Move + Ctrl. For more details, see [Customizing keyboard shortcuts](../Editeurs/3085003.md). |
| Move control + Ctrl | Duplicate the selected control at the new position. <br><br>This legacy shortcut can be replaced with the more common Move + Alt. For more details, see [Customizing keyboard shortcuts](../Editeurs/3085003.md). |
...
| Alt + G | Select the theme of window |
| Note: + means that the keys<br>must be pressed simultaneously. |
|   |   |
...
<a name="page_editor_shortcuts_ELTTEXTE001652"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) The shortcuts of page editor are as follows: 
...
| F5 | Display the tab order |
| F7 | Show/Hide the space occupied by the controls and by the control borders |
| F12 | Modify the edit options, display the list of controls found in the current page, ... |
| Alt + C | Show/Hide the selection |
| Alt + E | Show/Hide the selection border |
| Ctrl + I | Display the expandable areas |
| Ctrl + Q | Hide the panes anchored to the bottom |
| Alt + R | Show/Hide the grid |
| Ctrl + R | Show/Hide rulers |
| Ctrl + U | Display the positioning tables |
| Ctrl + Alt + 0 | Zoom at 100 % |
| Ctrl + Numeric Keypad +/- or Ctrl + mouse wheel | Zoom +/- |
| **Edit shortcuts** |
| Entry | Edit the caption of selected control |
| Alt + V | Lock\\Unlock the selection |
| Ctrl + D | Duplicate the selection |
| Ctrl + Shift + G | Dissociate the selection |
| Ctrl + 0 | Adapt the control size to its content |
| Alt + Right or left arrow | Modify the control size. |
| Ctrl + G | Group selection |
| Ctrl + Shift + P | Open a file picker and associate the image with the control. |
| Control move + P | Lock the association to a parent control (pane tab example) when moving a control. |
| Control move + Tab | Show/Hide the tooltip when moving a control. |
...
| Shift + F5 | Stop the test mode (during the project or page test) |
| **Style shortcuts** |
| Shift + Enter | Display the window for selecting the style of selected control |
| Ctrl + Shift + C | Copy the style of selected element |
| Note: + means <br>that the keys must be<br> pressed simultaneously. |
...
<a name="shortcuts_for_the_data_model_editor_ELTTEXTE001676"></a>
...
| Ctrl + Q | Hide the panes anchored to the bottom |
| Alt + R | Show/Hide the grid |
| Note: + means that the<br> keys must be pressed<br> simultaneously. |
|   |   |
...
<a name="project_editor_shortcuts_ELTTEXTE001700"></a>
...
| Shift + F5 | Stop the test mode (during the project or window test) |
| Ctrl + P | Print the documentation of the current project |
| Ctrl + mouse wheel | Zoom +/- in the graphic representations. |
| Note: + means that the <br>keys must be <br>pressed simultaneously. |
...
<a name="help_editor_shortcuts_ELTTEXTE001724"></a>
...
| Note: + means that the keys must be pressed simultaneously. |
...
<a name="shortcuts_for_the_report_editor_ELTTEXTE001748"></a>
...
| --- | --- |
| **Display shortcuts** |
| Alt + Enter | Open the description window of the selected control or table cell |
| R | Quick edit. |
...
| F2 | Edit the selection code |
| Ctrl + Shift + F2 | Edit the code associated with the selected element in the "Context-sensitive code view" pane |
| Note: + means that <br>the keys must be <br>pressed simultaneously. |
...
<a name="uml_editor_shortcuts_ELTTEXTE001772"></a>
...
<a name="shortcuts_the_environment_panes_ELTTEXTE001796"></a>
...
| **Code pane: editing the procedure and the classes** |
...
| Note: + means that the keys must be pressed simultaneously<br><br>**Code pane: Debugger mode** |
...
| Ctrl + B | Remove/Add a breakpoint |
| Note: + means that the keys must be pressed simultaneously.<br><br>**Task List pane** |
| F2 | Edit the code of the selected task |
| F9 | Add a new task |
| Ctrl + Enter | Edit the selected task |
| Note: + means that the keys must be pressed simultaneously.<br><br>**Code pane: compilation error mode** |
...
## WINDEV application
<a name="windev_application_ELTTEXTE001820"></a>
...
[Keyboard shortcut on a button (AAF)](../Editeurs/9500108.md)

[Customizing keyboard shortcuts](../Editeurs/3085003.md)
