...
WEBDEV allows you to easily define the site icon (also called Favicon). This icon is displayed in shortcut on the desktop, in the lists of browser favorites, in header of address bar, ...<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Favicone.gif)
...
2. On the "Project" tab, the "Site icon" control is used to enter the image used as favicon. 

3. Expand the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) icon: 
