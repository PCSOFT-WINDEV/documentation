...
Note: palette colors are accessible via programming (function [ColorPalette](../WDLang2/1000019905.md)). This allows you to create a generic code, independent of the theme and palette used.
...
**Note** The color palette used by a project (new or modified palette) is copied to the project directory. When the project is used in SCM, the color palette is also included in the elements managed by the SCM.
...
To handle the palettes: 

- select "Create a new palette" in the "Themes" tab of the project description (to open the project description, go to the "Project" tab, "Project" group, and click "Description"). 

- on the "Page" tab, in the "Theme and styles" group, expand "Palette" and click "Create a new palette".




The palette editor appears. This editor allows you to: 
...
5. The characteristics of the different colors found in the palette are displayed. It is possible to: 
...
2. Select the palette to modify. If this palette is one supplied with WEBDEV, it is automatically duplicated: just enter the new name. 

3. Validate. 

4. The characteristics of the different colors found in the palette are displayed. It is possible to: 
...
[ColorPalette (Function)](../Editeurs/1000019905.md)
