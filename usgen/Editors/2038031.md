...
To open the branch management window, on the "SCM" tab, in the "Project" group, expand "Branches" and select "Manage branches".. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GDS_Visu_Branche%20-%20HC%20N%B0001.gif)
...
<a name="options_available_from_the_branch_management_window_ELTPARAGRAPHE000041"></a>The context menu of the circle in the "Branch" column allows several operations on the selected branch. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GDS_Visu_Branche%20-%20HC%20N%B0002.gif)
You can: 
