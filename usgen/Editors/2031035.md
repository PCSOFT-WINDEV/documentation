...
2. In the combo box creation wizard, select the following options:
	...
	- Table: RADFichierA for a table on RADFichierB, RADFichierB for a table on RADFichierC.
...
1. On the "Creation" tab, in the "Usual controls" group, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_bouton.gif) and click the page.
