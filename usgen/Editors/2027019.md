...
When editing a control that requires an image (Image control, Button control, ...), the context-sensitive image catalog automatically finds the images that can be used (based on the control caption, for example).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=voletCatalogueimage.gif)
...
- You can enter a keyword directly in the pane: ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=VoletCatalogueimage%203.gif). 
	You can select a theme via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=VoletCatalogueimage%201.gif) button. The search starts automatically when you press Enter.
...
[Image catalog](../Editeurs/2020005.md)
