...
- **a theme style sheet** if the project is associated with a theme.
	This style sheet contains the styles proposed by the theme of the project for all types of controls. 
	**Note** The template style sheet associated with the project depends on the project template. If the theme of the project is modified, the theme style sheet associated with the project will be changed. To change the theme of the project, you can use one of the following methods:

	- in the "Style" tab of the project description, in "Project theme", select the desired theme. 

	- on the "Project" tab, in the "Other actions" group, "Apply a skin template to the project". Select the desired theme. 


 For more details on themes, see [Theme](../Editeurs/2016011.md).
...
For an advanced management of style sheets (customizing the theme style sheets for example), WINDEV allows you to handle the ".STY" file in the window editor.
