...
Example of unrolled code: the chevron ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Deroule%201.gif) indicates that the code is unrolled: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Deroule.gif)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Enroule.gif)
...
A code that can be rolled up is preceded by ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Deroule%201.gif).

To collapse an existing code, you can:

- or click on the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Deroule%201.gif) sign in front of the start of the instruction. Only the comment line preceding the statement will remain visible.

- or display the context menu for the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Deroule%201.gif) sign and select the "Fold" option.
...
A code that can be unrolled is preceded by ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Enroule%201.gif).

To expand a code, you can:

- or click on the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Enroule%201.gif) sign in front of the code to be unrolled.

- or display the context menu for the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Enroule%201.gif) sign and select the "Unfold" option.
...
The code is then immediately folded and the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnrouleCode_Enroule%201.gif) sign is displayed in front of the code.
...
Example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EnroulerCode_Bloc.gif)
