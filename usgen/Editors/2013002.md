...
WEBDEV allows you to create static pages and dynamic pages. Two types of actions can be programmed in a WEBDEV website: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Deux_types_de_code.gif)
...
## Browser code: WLanguage or Javascript/Typescript?
<a name="browser_code_wlanguage_javascripttypescript_ELTTEXTE000143"></a>
In the code editor, the code executed in the user's browser is represented by a green or blue header.


|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Page2_bis.gif&type=thumb)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Page2_1.gif&type=thumb)<br> |



- Green bar = WLanguage: the code header is preceded by the WL symbol.

- Blue header = JavaScript / TypeScript: 

	- Javascript code: the acronym JS precedes the code title.

	- Typescript code: the abbreviation TS precedes the code name.
...
**Reminder** Browser code is available for both dynamic and static pages.
...
- Field and page treatments do not need to contain prototypes: simply enter the required Javascript code directly.
...
[JSMethod (Function)](../Editeurs/3012002.md)

[JSProperty (Function)](../Editeurs/3012019.md)

[JSEvent (Function)](../Editeurs/1000018924.md)

[JSEndEvent (Function)](../Editeurs/1000018925.md)

[JSInfoEvent (Function)](../Editeurs/3036067.md)

[JSInterruptEvent (Function)](../Editeurs/1000019185.md)
