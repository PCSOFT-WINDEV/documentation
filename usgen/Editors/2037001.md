...
The Windows account corresponds to the username used to start an anonymous session ("Modify" button).
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iis5_compte_awp.gif)
...
3. Select "Authentication" in the list that is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iis7_Authentification.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IIS7_Authentification2.gif)
