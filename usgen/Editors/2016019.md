...
- a page template that corresponds to the selected template and that uses the project theme and color palette.
...
- You can add the same preset theme to a project multiple times to use it with different themes or color palettes.
