...
- use the control description window: In the "General" tab, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) on the right of the image path and select "Edit image".
...
- use the window for creating new elements: 
	...
	3. A window used to define the image to create is displayed. You can create: 
		...
		- a blank image or choose an image from the image catalog. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_img_nouveau%20-%20HC%20N%B0001.gif)


		- a blank icon or choose an icon from the image catalog. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_img_nouveau%20-%20HC%20N%B0002.gif)
...
An image edited in the image editor can be saved via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer.gif) icon of the ribbon. 
...
- If the image has at least one layer, it can be saved in different formats: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur_img_sauver%20-%20HC%20N%B0001.gif)
...
If you created an image or icon in the image editor, you can save it by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer.gif) in the ribbon. The save window appears and prompts you to save: 
...
[The "Images" pane](../Editeurs/2027036.md)

[Image editor: Features](../Editeurs/1410086606.md)
