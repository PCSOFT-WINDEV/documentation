...
A business rule can be simple or complex.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RegleMetier.GIF)
...
These settings are defined via the "Filter" button:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FiltreMetier.GIF)
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_NewRegle.GIF) in the ["Business rules" pane](../Editeurs/2027024.md). The window for editing the business rule is opened.
...
3. To associate the business rule with:
	...
	- the image in the clipboard, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_ImgRegle.GIF).

	- an image section on the screen, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_ImgRegleLasso.GIF) and select the desired image section.

	- an image file, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_ImgRegleFic.GIF) and select the desired image file.

	- the document in the scanner of the current computer, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_ImgRegleScan.GIF).
...
- The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IcoSelectManu.GIF) icon identifies manually selected elements, while ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IcoSelectAuto.GIF) identifies automatically selected elements.
...
To modify a business rule, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_ModifRegle.GIF) in the ["Business rules" pane](../Editeurs/2027024.md) and make the desired changes.
...
To validate a business rule, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_ModifRegle.GIF) in the ["Business rules" pane](../Editeurs/2027024.md) and define the status of each element linked to the business rule. This status can correspond to:
...
To make a business rule obsolete, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_RegleObsolete.GIF) in the ["Business rules" pane](../Editeurs/2027024.md).
...
- all business rules of project by printing the project documentation: on the "Home" tab, in the "General" group, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_imprimer.gif) and select "Print project documentation".
...
The business rules management window (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_regle_admin.GIF)) allows you to:
...
1. Display the window for managing the business rules (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_regle_admin.GIF)).
...
The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IcoPunaiseRegle.GIF) icon is used to permanently display the "Business rules" pane if at least one business rule is associated with the current element.
<a name="NOTE4_2"></a>
...
[The "Business rules" pane](../Editeurs/2027024.md)
