...
- Installing the 64-bit WEBDEV Application Server for Linux.
...
<a name="installing_the_webdev_application_server_for_linux_ELTTEXTE000404"></a>
...
1. Select the installation language. By default, the window is displayed in the language of the computer. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB01_bis.gif)


2. Accept the license agreement: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB1.gif)

	To validate this screen, you must scroll through the entire license agreement with the up/down arrows.

3. Check the requirements: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB1bis1.gif)


4. Specify whether the replication server is to be installed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB1bis2.gif)


5. Enter the activation key.
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB2.gif)


6. Select the installation directory:
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB3.gif)

	We advise you to keep the suggested directory.

7. Specify the parameters to install the WEBDEV Application Server for Linux:
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB4.gif)
...
8. Specify the name of the Unix group corresponding to the administrator group of WEBDEV Application Server. The group proposed by default is webdevadmin.
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB5.gif)
...
10. Validate the setup of the application server.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB6.gif)


11. The setup is completed. The setup report is displayed.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wb7.gif)
...
The following formula returns the number of semaphores required to manage n sessions: **s = 4 +4 \* n**
