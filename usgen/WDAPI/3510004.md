...
**Example**: In the "Functions" pane, entering the word "Move" will position the list on functions whose name begins with "Move"..<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDAPI%20-%20HC%20N%B0001.gif)
...
Example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDAPI%20-%20HC%20N%B0002.gif)
