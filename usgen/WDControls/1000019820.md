...
1. If you own a Google Maps API key, type it. Otherwise, click "Get a key". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Android_Carte1.gif)


2. Three steps are required to get the key: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Android_Carte2.gif)
