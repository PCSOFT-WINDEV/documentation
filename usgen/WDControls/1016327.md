...
The "Print" option is used to print the content of the Organizer control. A specific window is displayed, allowing you to configure the print. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Imp_Planning.gif)
