...
The Ribbon control proposes an additional feature regarding the menus found in your applications. It allows you to display a large number of logically arranged fields in a small area, enabling you to make the right choices.. 

For example, the different menus of the "Sales Management" application presented in ribbon: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Ruban1.gif)
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Ruban2.gif)
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Ruban3.gif)

In this example, the different elements of the Ribbon control are buttons but any type of control can be used. 

At runtime, more or less elements of the ribbon are displayed according to the size of the window. If some elements cannot be displayed, a little arrow is used to "expand the ribbon" and to display all the elements in a popup window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Ruban4.gif)
**Remarks**: 
...
1. On the "Creation" tab, in the "Containers" group, expand "Tab and associated" and click "Ribbon".
	Alternatively: In the "Window" pane, in the "Bars and menus" group, pull down "Other bars" and select "Ribbon".
...
To convert the drop-down menu of a window into a Ribbon control: 
...
Warning: To use this option, the Ribbon control must not exist in the window.. 
...
Each tab contains icons and option titles. 

Each pane contains one or more groups separated by a vertical line. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ruban_Volet_regroupement.gif)
...
- define the different groupings displayed by each pane ("General" tab). For each grouping, you have the ability to define: 
	...
	- the caption of the grouping. This caption will be displayed at the bottom of the grouping when it is opened. 
	...
	- whether the pane displays a specific button ("With button (click process)"). 
			...
			This allows you to display a context menu or a specific window for example, ...
...
**Remark**: [buttons with arrow](../WDChamp/1013163.md) can be used in a Ribbon control, for example, to prioritize the actions to be performed.. 
...
[Manipulating Ribbon controls programmatically](../WDChamp/1000021004.md)

[Ribbon control properties](../WDChamp/1000021003.md)

[Ribbon control events](../WDChamp/1000021002.md)

[Drop-down button](../WDChamp/1013163.md)

[Ribbon control functions](../WDChamp/1000020137.md)
