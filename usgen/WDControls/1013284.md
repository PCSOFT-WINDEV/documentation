...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) A Looper control must be exclusively handled via its attributes.
...
- handle each control found in the looper: 
	...
	![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) An attribute linked to the specified control and used to modify the specified property must exist.
...
- handle each control found in the Looper control:
	...
	![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) In this case, an attribute linked to the specified control and used to modify the specified property must exist.
...
<a name="content_the_current_row_ELTPARAGRAPHE000138"></a>
...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) each attribute separated by TAB.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) each attribute and/or each control separated by TAB.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) each attribute and/or each control separated by TAB.




![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Attention**: The index must correspond to a visible row in the current page.
