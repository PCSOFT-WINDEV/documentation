...
|   |   |   |
| --- | --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=LignePersonnalise.gif)<br>control Text list | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=liste_graphique2.gif)<br>control List combining images and Text. | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Liste_graphique.gif)<br>Graphic multi-column List Box control for easy Colorselection |

![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) **In WEBDEV**, List Box controls are in the following format:: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ChampListe.gif)
...
[List Box control linked to a table or to a query](../WDChamp/1013180.md)
