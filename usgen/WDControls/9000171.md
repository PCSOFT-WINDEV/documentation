...
Note: Additional overrides are available for the Image and Menu fields.. This allows you to use smaller images for the mobile devices or to change the menu orientation. For more details, see [Additional overrides](#NOTE3_3).
...
2. Specify the name of the slice and its size, then validate. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20-%20Ancrages%20-%20HC%20N%B0005.gif)
...
3. In the window that appears, you can set: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20-%20Ancrages%20-%20HC%20N%B0004.gif)


	- The name of the slice. This name is displayed in the slice header. Note: This name is purely internal to WEBDEV: it is not used in the generated HTML code.
...
These options are also available in the "Slices" tab of WEBDEV. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20-%20Ancrages%20-%20HC%20N%B0003.gif&type=thumb)
...
- This override can be viewed: 
	...
	- in the list of slice overrides: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20tranches%20-%20HC%20N%B0003.gif&type=thumb)


		- via "Slices .. List of overrides for the controls" of the control context menu.

- via "List of overrides" from the slice header context menu. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20tranches%20-%20HC%20N%B0002.gif)

- in the list of control overrides for the current slice. To view this list, select "Slices .. List of overrides for the selected controls".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20tranches%20-%20HC%20N%B0004.gif&type=thumb)
...
2. Make the desired change: move, resize, modify CSS properties, etc.
...
Note: Some position overrides are not possible.. For example, you cannot swap the position of controls in a slice. In this case, a UI error occurs. See [Why overriding the position and size of controls causes an overlap in the browser?](../WDChamp/9000173.md). 
<a name="NOTE3_2"></a>


### Additional overrides: Image field and Menu field
<a name="additional_overrides_image_field_and_menu_field_ELTPARAGRAPHE000161"></a>
...
2. Select "Slices", then, in "Visibility by slice", select the slice in which the control must be hidden. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20tranches%20-%20HC%20N%B0004%201.gif&type=thumb)





Warning: A hidden field is no longer selectable in the editor for the slice in which it was hidden.. It remains present in the page (therefore, it can be handled programmatically). However, it cannot be made visible programmatically. 

Note: To make a hidden field visible in the editor, under the "Display" pane, in the "Show (all controls)" group, check the "Hidden controls" option.. 
<a name="NOTE3_4"></a>
