...
- **Series label**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EtiquetteSerie.gif)
The set of series labels correspond to the **chart legend**.  

- *Category label*<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EtiquetteCat.gif)


- **Chart caption**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Libelle_Graphe.gif)
...
- **Chart title**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Titre.gif)


- **Title of axes**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Titreaxe.gif)
...
<a name="how_use_the_different_types_legends_ELTTEXTE000263"></a>


### Handling the category labels
<a name="handling_the_category_labels_ELTPARAGRAPHE000035"></a>
...
**Special case: Date or date-time category labels**
...
<br>![The display and presentation of year, months and days is automatic](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=073-abscisses_temporelles.jpg)
...
- The maximum level is defined by using two parameters:
	...
	- The maximum level allowed for display (year by default).
...
<a name="handling_the_series_labels_ELTPARAGRAPHE000099"></a>

The set of series labels correspond to the chart legend. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EtiquetteSerie.gif)
...
**Note**: To define series labels in "Scatter" charts, we recommend that you use [grScatterSeriesLabel](../WDLang3/3042038.md).
<a name="NOTE2_3"></a>


### Handling the chart caption
<a name="handling_the_chart_caption_ELTPARAGRAPHE000128"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Libelle_Graphe.gif)
...
<a name="handling_the_chart_title_ELTPARAGRAPHE000161"></a>

The chart title can be displayed above or below the chart. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Titre.gif)
...
<a name="handling_the_title_chart_axes_ELTPARAGRAPHE000179"></a>

The title of chart axes can be displayed for the different axes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Titreaxe.gif)
...
[grTimeLevelMask (Function)](../WDChamp/1000023017.md)

[grTimeLevelMax (Function)](../WDChamp/1000023016.md)
