...
Can your application print a large number of reports? The end-user can add annotations from the report viewer: freehand drawing, arrow, formatted text, etc.
...
To insert annotations, go to the "Annotate" pane of the report viewer: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Volet_Apercu_Annoter.gif)
You can:
...
- Insert a watermark. 
	...
	- In the window that appears, you can specify: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fen_Filigrane.gif&type=thumb)
...
[Printing a watermark text](../WDChamp/9000129.md)
