...
This type of report is convenient when the information to print is found in a text file (data imported from Excel for example).

**Characteristics of a report on a text file** Each line in the text file must correspond to a record. Each line contains various information, called items. The items are separated by a separator.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EtatFichierTexte.gif)
...
To create a report on a text file with automatic reading of records: 
...
9. Select the text file containing the records.
	...
	- The captions of the items must not be specified in this text file. For example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EtatFichierTexte3.gif)
...
9. Select the theme template of the report if necessary.
...
When the report based on a text file is created, you can at any time modify the method used for reading records (automatic or programmed read operations).
...
1. Open the report description window using one of the following methods: 
	...
	- on the "Modification" tab, click the dialog box launcher ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_regroup.gif) of the "Report" group. 
