...
| [Autofill](../Proprietes/1410090515.md) | The **Autofill** property indicates the type of information to be automatically entered in an Edit control. |
...
| [CaptionWidth](../Proprietes/1000020951.md) | The **CaptionWidth** property gets and sets the width reserved for the text area in an Edit or Combo Box control. |
...
| [DeleteButton](../Proprietes/1000021924.md) | The **DeleteButton** property allows you to determine if there is an automatic delete button in a Text Edit control, and to change its position. |
...
| [HintTextColor](../Proprietes/1000022643.md) | The **HintTextColor** property gets and sets the hint text color of an Edit control. |
...
| [StoreTheValue](../Proprietes/1000021106.md) | The **StoreTheValue** property is used to:<br><br>- Determine if the value of a control is persistent, i.e. is preserved when an application is closed and reopened. <br><br>- Enable or disable data persistence for a control. <br><br><br> |
...
| [TopIndent](../Proprietes/1000022890.md) | The **TopIndent** property gets and sets the space at the top of the text (top margin) in a control. |
...
<a name="properties_available_page_ELTTEXTE001482"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in a page (Server code)
<a name="properties_available_page_server_code_ELTPARAGRAPHE000033"></a>The following properties are associated with Edit controls:
...
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000043"></a>The following properties are associated with Edit controls:
...
<a name="properties_available_php_ELTPARAGRAPHE000053"></a>The following properties are associated with Edit controls:
...
<a name="properties_available_report_ELTTEXTE003032"></a>
