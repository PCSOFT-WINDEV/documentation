...
Example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Etat_gantt%20-%20HC%20N%B0002.gif&type=thumb)
...
13. The report currently created is displayed in the report editor.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Etat_gantt%20-%20HC%20N%B0001.gif&type=thumb)
...
[**Reports & Queries**](../Presentation/3088004.md) cannot be used to create Gantt Chart reports. However, it is possible to customize Gantt chart reports created in the built-in report editor (color, fonts, size, etc.).
...
- **The custom report to display the tasks**. 
	...
	- If "Preset report" is selected, a preset report is automatically added to the project. This report is named "RPT_WinDevViewGanttTask" by default and it is automatically used to display the tasks.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Etat_WinDevvueGantt.gif)
