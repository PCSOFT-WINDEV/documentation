...
To programmatically manipulate PDF Reader controls, you can use the [PDF Reader control functions](../WDLang1/1000023877.md). 
...
<a name="manipulating_pdf_reader_controls_programmatically_ELTTEXTE000119"></a>
...
- Assign the PDF file to the PDF Reader control. For example: 
 ...
 If passwords are used: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) If the file is password-protected, a window will appear to enter the password. 

	- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) It is not possible to open a protected PDF file.
...
- Use the [&lt;PDF Reader&gt;.Open](../WDLang1/1000023776.md) function. For example: 
	...
	END
	```
 Note: You can use [&lt;PDF Reader&gt;.Open](../WDLang1/1000023776.md) to set the file password.
...
<a name="pdf_reader_control_properties_ELTPARAGRAPHE000200"></a>The following properties are specific to PDF Reader controls. They are mainly used to handle the control characteristics: 
...
[PDF Reader control functions (prefix syntax)](../WDChamp/1000023877.md)
