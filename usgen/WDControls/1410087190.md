...
You can manipulate Switch controls in a window or page using the following WLanguage properties.
...
<a name="properties_available_window_ELTTEXTE000128"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Properties available in a window**

The following properties are associated with Switch controls:
...
<a name="properties_that_can_used_the_page_controls_ELTTEXTE000897"></a>
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties that can be used on a Switch control in a page (Server code)
<a name="properties_that_can_used_switch_control_page_server_code_ELTPARAGRAPHE000034"></a>The different properties of the Switch controls are:
...
### Properties that can be used on a Switch control in a page (Browser code)
<a name="properties_that_can_used_switch_control_page_browser_code_ELTPARAGRAPHE000044"></a>The different properties of the Switch controls are:
...
### Properties that can be used on a Switch control in PHP
<a name="properties_that_can_used_switch_control_php_ELTPARAGRAPHE000054"></a>The different properties of the Switch controls are:
...
[Properties associated with the options of a Switch control](../WDChamp/1410087194.md)
