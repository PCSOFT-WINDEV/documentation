...
To manipulate cells of a Table control programmatically, use the following syntax:
...
**Note**: If the cell is a check box, the option number is not required.
...
<a name="table_cell_properties_ELTTEXTE000178"></a>
...
<a name="properties_available_window_ELTPARAGRAPHE000050"></a>The following properties are available for table cells in a window:
...
<a name="properties_available_page_server_code_ELTPARAGRAPHE000060"></a>The following properties are available for table cells in a page:
...
Note: **FontXXX** properties are only available in read mode. You cannot modify the characteristics of a font in a table cell. 


![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) 

### Properties available in a page (Browser code)
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000071"></a>The following properties are available for table cells in a page:
...
<a name="properties_available_page_php_ELTPARAGRAPHE000080"></a>The following properties are available for table cells in a page:
