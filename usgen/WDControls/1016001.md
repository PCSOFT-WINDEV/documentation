...
The Carousel control is used to display an animated menu made of images.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CHP_Carroussel.gif)
...
2. On the "Details" tab, you can configure the ListView control used via "ListView control settings".
...
[Manipulating Carousel controls programmatically](../WDChamp/1016002.md)

[Carousel control properties](../WDChamp/1016003.md)

[Events associated with Carousel controls](../WDChamp/1016004.md)
