...
For example, description window of a button: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FenDescriptionChamp.gif)
...
| **UI** | Used to define:<br><br>- the initial state of the control when the window is opened.<br><br>- the various field parameters (accessible via Tab, etc.).<br><br>- the right-click action on the control.<br><br>- the cursor appearance when hovering over the control.<br><br>- the context menu associated with the control. For more details, see [Context menu](../WDChamp/1010011.md).<br><br>- the control keyboard shortcut.<br><br>- the control size.<br><br>- the position of the control in the window.<br><br>- the control anchors. For more details, see [Anchor](../Proprietes/2510001.md).<br><br>- the window plane to which the control belongs. For more details, see [Window plane](../WDChamp/1013078.md).<br><br>- the group of controls to which the control belongs. For more details, see [Group of controls](../WDChamp/1010016.md).<br><br><br> |
...
| **Binding** | Allows you to select the item (from a table or query) to which the control is bound. Depending on the current record, the content of the bound item will be displayed in the control. |
...
To modify the caption of a control in the window currently created: 

1. Select the control to modify.

2. Click the control again or press the Enter key. The mouse cursor turns into an input cursor. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=LibelleModifDirect.gif)
...
- You can also change the text of a column in a Table control.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Lib_table_modifdirect.gif)
...
2. Type the new control name in the status bar. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=NomChamp.gif)
...
2. Enter the new values of the size and position in the status bar. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=PositionDimensionChamp.gif)
