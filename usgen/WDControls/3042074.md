...
<a name="characteristics_area_chart_ELTTEXTE000208"></a><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GenAire.gif&type=thumb)
In this chart:
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The "Area" charts can be displayed with an animation. To animate this type of chart, simply check "Enable animations" in the "Details" tab of the control description. 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) "Area" charts can be displayed in real time. For more details, see [Real-time chart](../WDChamp/1000021037.md).
