...
<a name="characteristics_pyramid_chart_ELTTEXTE000161"></a><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Graphe_pyramide%20-%20HC%20N%B0001.gif&type=thumb)
...
- **Size of sections**. The "General" tab in the control description window (or [grParameter](../WDLang3/1000018337.md)) is used to choose the size of the sections: 
	...
	- Proportional to area: The value is symbolized by the area of the portion of the pyramid.

	- Proportional to height: The value is symbolized by the height of the portion of the pyramid.. 




- The graph can be oriented: simply define the angle of rotation along the various axes in the "General" tab of the control description window.. A chart can also be oriented programmatically with [grOrientation](../WDLang3/3042043.md). 
