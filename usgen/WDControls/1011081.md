...
[**Reports & Queries**](../Presentation/3088004.md) cannot be used to create reports on an Organizer control. However, it is possible to customize reports on an Organizer control created in the built-in report editor (color, font, size, etc.).
**Remark**: Only an Organizer control state can be created.. 
...
<a name="characteristics_the_report_based_organizer_control_ELTTEXTE000274"></a>
...
**Caution**: It is not possible to test a report on an Organizer control directly from the report editor, as the window or page containing the Organizer control must be open.. To run the test of a report based on an Organizer control, you must:
...
<a name="creating_report_based_organizer_control_from_the_report_editor_ELTTEXTE000298"></a>
...
<a name="printing_report_based_organizer_control_ELTTEXTE000328"></a>
