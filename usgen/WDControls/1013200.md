...
The initial state of a Table control can be:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Table_Ini_WD.gif)
...
The available selection modes are as follows:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Table_ModeSel_WD16.gif)
...
By default, scrollbars in Table control fields (linked to a table, programmatically or based on a variable) are proportional. The size of the scrollbar varies based on the number of elements to be displayed.
...
The scrollbar options are grouped in the "Details" tab of the Table control description:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Table_Ascenseur.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_table_TitreCol19.gif)
