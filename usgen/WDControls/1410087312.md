...
A CSS Grid control is made up of cells. You can manipulate each cell of a CSS Grid control using the following WLanguage properties.
...
<a name="available_properties_ELTTEXTE000101"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in Server code
<a name="properties_available_server_code_ELTPARAGRAPHE000017"></a>The following properties are associated with Cell controls within CSS Grid controls:
...
<a name="properties_available_browser_code_ELTPARAGRAPHE000027"></a>The following properties are associated with Cell controls within CSS Grid controls:
