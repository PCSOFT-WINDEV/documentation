...
- an HTML page coming from a site other than the current WEBDEV website.
...
1. Display the IFrame field description window (select "Description" from the field context menu).

2. On the "General" tab, select the page displayed in the control:
...
- Type: "Display a page of the website". All you have to do is select the page to display.
...
[Manipulating iFrame controls programmatically](../WDChamp/1013272.md)
