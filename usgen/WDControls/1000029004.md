...
To manipulate a Pivot Table control programmatically, WINDEV proposes the [PVT functions](../WDLang1/1000020704.md). 
...
## Manipulating Pivot Table controls programmatically
<a name="manipulating_pivot_table_controls_programmatically_ELTTEXTE000221"></a>
...
Programmatically, you have the ability to access the values in order to modify their style (text or background color, ...). To do so, modify the properties of values in the "Cell display" event. 
...
Note: You can customize the style of each cell element, including color, font, background color, etc., using a number of properties. For more details, see [Properties associated with the values of a Pivot Table control](../WDChamp/1000029003.md). 
...
- Pivot Table not displaying a title: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=tcd_sanstitre.gif)


- Pivot Table with a title: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=tcd_avectitre.gif)
...
### Getting and setting the mask used to display values
<a name="getting_and_setting_the_mask_used_display_values_ELTPARAGRAPHE000083"></a>
...
You can change the axes or swap rows and columns with [PVTAxisXY](../WDLang1/1000021113.md). 
...
- If the Pivot Table control is bound to a table, the new source table must have the same structure as the table used when creating the control. 
...
<a name="calculation_progress_ELTPARAGRAPHE000280"></a>
...
<a name="properties_specific_pivot_table_controls_ELTPARAGRAPHE000142"></a>The following properties are used to manage Pivot Table controls: 
...
For a complete list of WLanguage properties that can be used with Pivot Table controls, see [Pivot Table control properties](../WDChamp/1000029003.md).
...
[pvtPosition (Variable type)](../WDChamp/1000020726.md)
