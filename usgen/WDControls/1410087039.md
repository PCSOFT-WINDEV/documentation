...
To programmatically manipulate PDF Reader controls, you can use the [PDF Reader control functions](../WDLang1/1000023466.md). 
...
## Manipulating PDF Reader controls programmatically
<a name="manipulating_pdf_reader_controls_programmatically_ELTTEXTE000171"></a>
...
- Use the [PDFReaderOpen](../WDLang1/1000023452.md) function. For example: 
	...
	END
	```
 Note: You can use [PDFReaderOpen](../WDLang1/1000023452.md) to set the file password.
...
<a name="pdf_reader_control_properties_ELTPARAGRAPHE000092"></a>The following properties are specific to PDF Reader controls. They are mainly used to handle the control characteristics: 
...
[PDF Reader control functions](../WDChamp/1000023466.md)
