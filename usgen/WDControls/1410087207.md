...
- a [Kanban control](#NOTE2_1), 

- a [Kanban List control](#NOTE3_1). 
...
## Kanban control properties
<a name="kanban_control_properties_ELTTEXTE000167"></a>
...
<a name="properties_available_window_ELTPARAGRAPHE000036"></a>The following properties are associated with Kanban controls:
...
<a name="properties_available_page_server_code_ELTPARAGRAPHE000048"></a>The following properties are associated with Kanban controls:
...
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000058"></a>The following properties are associated with Kanban controls:
...
## Kanban List control properties
<a name="kanban_list_control_properties_ELTTEXTE001416"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) 

### Properties available in a window
<a name="properties_available_window_ELTPARAGRAPHE000071"></a>The following properties are associated with Kanban List controls:
...
| [Accessibility](../Proprietes/1410090235.md) | The **Accessibility** property gets and sets the accessibility properties of a control. |
| [BackgroundColor](../Proprietes/2510022.md) | The **BackgroundColor** property is used to set the background color of a control, window, page or block of a report. |
| [Card](../Proprietes/1410089204.md) | The **Card** property handles the different cards associated with a Kanban list. You can add, modify or delete cards from a Kanban list, or navigate between them. |
...
### Properties available in a page (Server code)
<a name="properties_available_page_server_code_ELTPARAGRAPHE000083"></a>The following properties are associated with Kanban List controls:
...
### Properties available in a page (Browser code)
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000093"></a>The following properties are associated with Kanban List controls:
