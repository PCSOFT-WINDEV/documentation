...
<DIV class="specObsolete">
	...
	From version <B>24</B>, ***Scrolling Banner*</**>** is kept for backward compatibility. This function has been replaced with ***The Sliding Banner control*</**>**.
</DIV><a name="NOTE1"></a>
<a name="NOTE1_1"></a>
...
Example: 
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Champ-Carrousel.jpg)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Champ-Carrousel-2eme-Bandeau.jpg)
...
- **Define the style for the Sliding Banner control** ("Style" tab): You can define: 
	...
	- the slider bullets (indicators): 
		...
		- Bottom margin: distance of bullets in relation to the bottom border of the Sliding Banner control. 
...
[Sliding Banner control properties](../WDChamp/1410087018.md)

[Events associated with a Sliding Banner control](../WDChamp/1410087017.md)
