...
By default, the "Export" pane of the report viewer offers the "Duplicate" option to create a duplicate of the report being displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Apercu_Volet_Exporter.gif)
