...
The following properties are associated with Organization Chart controls:
...
| [ElementOrientation](../Proprietes/1000020055.md) | The **ElementOrientation** property gets and sets the orientation of an Organization Chart control. |
...
| [MaxLeafPerRow](../Proprietes/1000020103.md) | The **MaxLeafPerRow** property gets and sets the maximum number of elements in a row in an Organization Chart control. |
