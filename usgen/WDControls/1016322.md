...
Several WLanguage properties can be used on an Organizer control:
...
<a name="properties_available_window_ELTTEXTE000160"></a>
...
### Properties available in a window
<a name="properties_available_window_ELTPARAGRAPHE000037"></a>

The following properties are associated with Organizer controls:
...
<a name="properties_available_page_ELTTEXTE001105"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) **Properties available in a page (Server code)**
The following properties are associated with Organizer controls:
...
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) **Properties available in a page (Browser code)**
The following properties are associated with Organizer controls:
...
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) **Properties available in a page**
The following properties are associated with Organizer controls:
...
<a name="properties_available_report_ELTTEXTE002018"></a>


### Properties available in a report
<a name="properties_available_report_ELTPARAGRAPHE000086"></a>The following properties are associated with Organizer controls:
