...
- the **table of parameters**. This table groups all the parameters required to run the applet. The list of parameters is supplied by the distributor of Applet. 
	***To add an***parameter, click on the "Add" button: Specify the parameter name ("Parameter Name" column) and its value ("Value" column). 
...
[Events associated with Java Applet controls](../WDChamp/1013045.md)
