...
<a name="overview_the_internal_report_control_ELTTEXTE000253"></a>
...
<a name="benefits_internal_reports_compared_the_nested_reports_ELTTEXTE000277"></a>
...
## How to?
<a name="how_ELTTEXTE000301"></a>


### Creating a main report made of several secondary reports
<a name="creating_main_report_made_several_secondary_reports_ELTPARAGRAPHE000054"></a>
...
2. Create the main report: 
	...
	- The window for creating a new element is displayed: click "Report" then "Report". The report creation wizard starts.
...
3. In the main report, create as many "Internal report" controls as the number of secondary reports to print. 
	...
	**Note**: The main report can contain all other types of controls.
...
6. Test the main report (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_fenetre_WD_bl.GIF) in the quick access buttons) to check the print of your report.
...
<a name="main_report_not_blank_ELTPARAGRAPHE000092"></a>
...
2. On the "Data" tab, check "The report execution does not affect iterations (independent HFSQL context)".
...
### Secondary report
<a name="secondary_report_ELTPARAGRAPHE000111"></a>
...
<a name="secondary_report_based_query_with_parameters_ELTPARAGRAPHE000118"></a>
...
<a name="secondary_report_based_query_that_uses_specific_connection_ELTPARAGRAPHE000128"></a>
...
<a name="secondary_report_based_hfsql_view_ELTPARAGRAPHE000138"></a>
...
2. Associate the view with the secondary report (with [ViewName](../Proprietes/2511030.md)) in the opening code of the secondary report:
	...
	```txt
	<SecondaryReportName>.ViewName = <GlobalVariableName>
	```
...
<a name="passing_parameters_internal_report_ELTPARAGRAPHE000153"></a>
...
## Notes
<a name="notes_ELTTEXTE000361"></a>


### Dimension of secondary reports
<a name="dimension_secondary_reports_ELTPARAGRAPHE000169"></a>
...
<a name="reducing_the_width_secondary_report_ELTPARAGRAPHE000182"></a>

To reduce the width of a secondary report:

1. Go to the "Format" tab in the description of the secondary report ("Report description" in the context menu).
...
<a name="page_break_the_secondary_report_ELTPARAGRAPHE000193"></a>
...
<a name="opening_the_internal_report_ELTPARAGRAPHE000202"></a>

The context menu of the "Internal Report" control in the editor is used to directly open the internal report via "Open the internal report". 
...
[Internal Report control properties](../WDChamp/1013061.md)
