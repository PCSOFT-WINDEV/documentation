...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [linked to a table](../WDChamp/1016325.md). 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [bound to a variable](../WDChamp/1016325.md). 




WINDEV and WEBDEV include the [OrganizerXXX](../WDLang1/1000022884.md) functions to manipulate Organizer controls. 
...
<a name="manipulating_organizer_controls_programmatically_ELTTEXTE000163"></a>


### Adding an appointment
<a name="adding_appointment_ELTPARAGRAPHE000186"></a>
...
### Filling an Organizer control with the data found in an HFSQL table
<a name="filling_organizer_control_with_the_data_found_hfsql_table_ELTPARAGRAPHE000226"></a>

The records are stored in an HFSQL table. The Organizer control can be initially filled by browsing the table via the FOR EACH syntax and by adding each appointment via [&lt;Organizer&gt;.AddAppointment](../WDLang1/1000022894.md).
...
END
```
**Reminder** It is also possible to use an Organizer control linked to a table. For more details, see [Organizer control linked to a table](../WDChamp/1016325.md).


### Retrieving a list of appointments
<a name="retrieving_list_appointments_ELTPARAGRAPHE000254"></a>

[OrganizerListAppointment](../WDLang1/1000022886.md) is used to retrieve: 
...
<a name="displaying_organizer_control_from_specific_date_ELTPARAGRAPHE000291"></a>
...
<a name="delete_appointment_ELTPARAGRAPHE000314"></a>
...
<a name="modifying_the_control_display_options_ELTPARAGRAPHE000344"></a>

The current display of an Organizer control can be modified by the following functions: 

- [&lt;Organizer&gt;.DisplayPreviousPeriod](../WDLang1/1000022878.md) and [&lt;Organizer&gt;.DisplayNextPeriod](../WDLang1/1000022896.md): These two functions modify the display period (identical to the use of the spin button at the top of the Organizer control). 

- [&lt;Organizer&gt;.ChangeMode](../WDLang1/1000022879.md): Use this function to change the field display mode: day, week, month.
...
<a name="using_the_context_menu_aaf_ELTTEXTE000370"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Possibilities of the context menu
<a name="possibilities_the_context_menu_ELTPARAGRAPHE000395"></a>
...
<a name="advanced_use_events_with_procedures_ELTPARAGRAPHE000424"></a>
...
<a name="properties_specific_organizer_controls_ELTTEXTE000479"></a>
...
For a complete list of WLanguage properties that can be used with Organizer controls, see [Organizer control properties](../WDChamp/1016322.md).
...
[Appointment (Variable type)](../WDChamp/1000019244.md)
