...
**1st case: window, page or report fields are bound to fields in a table** (Binding)
All the items in the table (or a related file) that are bound to a control in the window, page or report will be updated by [ScreenToFile](../WDLang4/3044146.md).

**2nd case: window, status or page fields are not associated with items in a table.**
