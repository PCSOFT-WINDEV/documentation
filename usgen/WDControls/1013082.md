...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) WINDEV and WINDEV Mobile manage the following events by default (order of appearance in the code editor):
...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) WEBDEV manages the following events by default (order of appearance in the code editor):
