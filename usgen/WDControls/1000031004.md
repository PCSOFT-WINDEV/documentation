...
![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) Note: The Dashboard control is only available in Linux for WEBDEV Linux sites. Dashboard controls are not available in WINDEV applications for Linux.
...
## Manipulating Dashboard controls programmatically
<a name="manipulating_dashboard_controls_programmatically_ELTTEXTE000298"></a>
