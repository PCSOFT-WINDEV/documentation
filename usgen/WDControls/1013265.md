...
2. Click where you want to create the control in the page. The control is automatically created. In the editor, the Breadcrumb control appears in the following format: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Chemin_Navig_Editeur.gif)
