...
<br>![The bottom line is wider than the control, and scrolls automatically so it can be read](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wm-defilement-automatique-si-texte-deborde-du-champ.gif)
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Btn_libell%E9_d%E9filant%20-%20HC%20N%B0001.gif)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Btn_libell%E9_d%E9filant%20-%20HC%20N%B0003.gif)<br> |



3. By default, the text will be animated using a marquee-like effect. If necessary, validate the information message. 

4. In the window that opens, define the animation settings:  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Btn_libell%E9_d%E9filant%20-%20HC%20N%B0002.gif)
