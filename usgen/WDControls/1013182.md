...
### Properties available in a window
<a name="properties_available_window_ELTPARAGRAPHE000020"></a>The following properties can be used with List Box controls:
...
<a name="properties_available_page_ELTTEXTE001224"></a>
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in a page (Server code)
<a name="properties_available_page_server_code_ELTPARAGRAPHE000033"></a>The following properties can be used with List Box controls:
...
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000043"></a>The following properties can be used with List Box controls:
...
<a name="properties_available_php_ELTPARAGRAPHE000052"></a>The following properties can be used with List Box controls:
