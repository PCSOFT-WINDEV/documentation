...
Each TreeView control in a window offers the user a context menu by default.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Arbre.gif)
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) export to Word, Excel, XML: This option exports the contents of the TreeView control to a file in the selected format.. 
...
3. Choose the desired menu in the "Context menu" combo box. It is possible to: 
	...
	- "Display the AAF menu (System)": In this case, the context menu displayed will be the TreeView control automation menu.. For more details on how to configure this menu, see [Configuring the AAF menu](../Editeurs/2010040.md).
...
[FAA: Unfold or fold a tree structure (TreeView control or Hierarchical Table)](../WDChamp/1013279.md)
