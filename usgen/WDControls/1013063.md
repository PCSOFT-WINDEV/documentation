...
The Scrollbar control is used to scroll objects (text, captions, etc.). The scroll of the object is performed programmatically. A horizontal scrollbar is used to scroll objects horizontally and a vertical scrollbar is used to scroll objects vertically.

A scrollbar contains the following elements:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_ASCENSEUR.gif)
...
1. In the "Creation" pane, in the "Adjust" group, scroll down to "Scrollbar" and click on "Elevator".
...
6. The popup that appears allows you to choose the two images to use (horizontal and vertical scrollbar) via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button: 
...
[Manipulating Scrollbar controls programmatically](../WDChamp/1013117.md)

[Binding a Scrollbar control to an item](../WDChamp/1013116.md)

[Events associated with Scrollbar controls](../WDChamp/1013118.md)

[Scrollbar control properties](../WDChamp/1013112.md)
