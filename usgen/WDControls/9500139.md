...
2. Select "Background color" in the context menu of element and select the requested color in the list. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Couleur_Table.gif)
