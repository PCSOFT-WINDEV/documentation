...
Until version 27, Session mode didn't allow you to search Engine Optimization the different pages of your site: only the home page was searchable.. The only way to obtain SEO-ready pages was to use AWP. 
...
Note: This help page explains how to transform Session Mode pages into searchable Session Mode pages.. To change a site from AWP mode to SEO-ready Session mode, see [Changing sites from AWP to SEO-ready session mode](../WDChamp/2030030.md). 
<a name="NOTE1_2"></a>
...
**Remark**: When the session is created, all calls to the server benefit from the open session and are therefore much faster.. The other pages in this session are displayed as usual.

**Attention**: not every page on a WEBDEV site should automatically become a searchable page.. Some pages (especially those that require authentication) do not need to be indexed in search engines. 
...
2. Go to "General", "Type of page": 
	...
	- If necessary, specify the name to be used in the URI. This name can be different from the name of the page in the editor. 
			Note: If the site is multilingual, this name can be entered in the different languages of the project.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Page_session_reference%20-%20HC%20N%B0002.gif&type=thumb)





3. On the "Details" tab, specify the expressions and keywords that will make the page better for SEO purposes ("Edit expressions and keywords"). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Page_session_reference%20-%20HC%20N%B0003.gif&type=thumb)
...
Note: Switching pages to searchable session mode changes the file extension in the URL. The pages will become '.wb' files. '.wb' files do not physically exist. 
...
- An SEO-ready page can be opened: 
	...
	- by a Link or Button control (recommended). In the description window of the control:: 
		...
		- select the name of the page to open. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Page_session_reference%20-%20HC%20N%B0004.gif)


		- click "Parameters..." to specify the parameters to be passed to the page. Each parameter can be a fixed value, a control or a variable. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Page_session_reference%20-%20HC%20N%B0005.gif)
...
[Changing sites from AWP to SEO-ready session mode](../WDChamp/2030030.md)
