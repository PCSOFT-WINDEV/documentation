...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Etat3D.gif)
...
| Reinitializing the display | 0 key on the numeric keypad: full reinitialization<br>5 key on the numeric keypad: Reinitialization while keeping the spacing between controls. |
...
[Viewing a window in 3 dimensions ](../WDChamp/2026005.md)
