...
An infinite Progress Bar control can be used in this case. This type of progress bar displays an endless animation. <br>![Examples of "infinite" progress bars](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Jauge-Infinie%20-04.jpg)
...
1. On the "Creation" tab, in the "Graphic controls" group, expand "Progress bar" and select an infinite progress bar. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Jauge20.gif)
...
<a name="characteristics_infinite_progress_bar_controls_ELTTEXTE000205"></a>
You can define the type of infinite progress bar in the "General" tab of the description window: 

- Native linear.

- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Native circular.
...
- Custom image. In this case, you can specify the following elements in the editor or programmatically: 
	...
	- if the animation must play forwards first, then backwards. 
			![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Through programming, this option corresponds to the [AnimationDirectionAlernate](../Proprietes/1000021231.md) property. 
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Remarque**: You can change the color of the native ProgressBar using the [ProgressBarColor](../Proprietes/1000018156.md) property.. 
...
[Properties associated with infinite Progress Bar controls](../WDChamp/1000034003.md)

[Infinite Progress Bar control events](../WDChamp/1000034002.md)
