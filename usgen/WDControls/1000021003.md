...
- [a Ribbon control found in a window](#NOTE2_1).

- [a pane of a Ribbon control](#NOTE3_1).  

- [a group in a Ribbon control](#NOTE4_1). 
...
## Properties available for a Ribbon control
<a name="properties_available_for_ribbon_control_ELTTEXTE000114"></a>
The following properties are associated with Ribbon controls:
...
## Properties available for a pane of a Ribbon control
<a name="properties_available_for_pane_ribbon_control_ELTTEXTE000860"></a>
The following properties are associated with the panes of a Ribbon control:
...
## Properties available for a group in a Ribbon control
<a name="properties_available_for_group_ribbon_control_ELTTEXTE001060"></a>
The following properties are associated with the groupings in a Ribbon control:
