...
5. On the home page, click "Monetize" or the "Monetize a new application" button. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Admob_1.gif)


6. Select or create the application to monetize. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=admob_2.gif)
You can: 
...
8. An ad can be created once your application is validated. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=admob_3.gif)


9. The identifier of the ad block is supplied once the ad group is validated. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=admob_4.gif)
