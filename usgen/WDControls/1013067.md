...
A ListView control can be bound to an item in a table, query, etc. 
...
All the controls bound to an item in the table (or a related file) will be updated by [FileToScreen](../WDLang4/3044210.md).
