...
The "Export" pane in the report viewer allows you to perform the following operations: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Apercu_Volet_Exporter.gif)
...
- On the user computers, this file is created in the installation directory of the application.
...
- Problems may occur when printing in PDF. For more details, see [Printing to PDF: Known problems](../WDChamp/1011016.md).
...
- By default, the created HTML file uses the style sheets (CSS). In order for the created HTML file to use no style sheet, the print must be started programmatically.
...
Note: XML file viewing software must be installed on the current workstation to view the generated file.
<a name="NOTE2_5"></a>
...
- If the default mailbox is Eudora: the report is generated in Text format and included in the email.

- If the default mailbox is Outlook: the report is generated in RTF format and included in the email.
...
[iParameterPreview (Function)](../WDChamp/3046001.md)

[iParameterExport (Function)](../WDChamp/1000017026.md)

[iParameterPDF (Function)](../WDChamp/3046007.md)

[iParameterXLS (Function)](../WDChamp/1000017224.md)
