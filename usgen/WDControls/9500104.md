...
2. On the "General" tab, indicate if the control uses an RTF toolbar: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RTF_ConfigBarre.gif)
...
**Attention**: This command will also disable [formatting toolbar of HTML controls](../WDChamp/9500113.md).
...
Here is the RTF formatting bar: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RTF_Barre.gif)
