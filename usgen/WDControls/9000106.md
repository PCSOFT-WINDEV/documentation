...
3. The yellow square was replaced with a blue square, indicating that this control can be overridden.![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modele_Etat_surcharge%20-%20HC%20N%B0001.gif)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modele_Etat_surcharge%20-%20HC%20N%B0002.gif)

4. You can change all the aspects of the control interface: dimensions, position, style, etc.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modele_Etat_surcharge%20-%20HC%20N%B0003.gif)
...
5. Two sections of click code are found: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modele_Etat_surcharge%20-%20HC%20N%B0004.gif)
