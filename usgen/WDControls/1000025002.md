...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) An optional event is proposed for the Action Bar control: "Touch / Left button pressed".

To manage this optional event, simply select it in the icon bar of the code window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Traitements_Opt_Action_Bar.gif)
