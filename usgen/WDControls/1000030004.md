...
## Overview
<a name="overview_ELTTEXTE000393"></a>
To manipulate a Gantt Chart control through programming, WINDEV proposes: 

- the [GanttXXX functions](../WDLang1/1000020914.md). 
...
This help page explains how to programmatically manipulate Gantt Chart controls: 
...
- [Using the FAA context menu](#NOTE3_1). 
...
## Manipulating Gantt Chart controls programmatically
<a name="manipulating_gantt_chart_controls_programmatically_ELTTEXTE000417"></a>




### Adding a task
<a name="adding_task_ELTPARAGRAPHE000065"></a>
...
**Tip**: If the tasks are stored in a data file, name the fields with the same names as the members of the [GanttTask](../WDLang1/1000020881.md) variable.. Then, you will have the ability to use [FileToMemory](../WDLang1/3013071.md) to fill the variable in a single line of code: 
...
### Adding a link
<a name="adding_link_ELTPARAGRAPHE000096"></a>
...
Note: By default, the link created is of type "End to Start".. The type of created link can be configured in the [GanttLink](../WDLang1/1000021076.md) variable or in [GanttAddLink](../WDLang1/1000021075.md). The available links are: 

- Link type "Start to Start": The successor task cannot start before the predecessor task has started.
...
<a name="organizing_the_tasks_ELTPARAGRAPHE000133"></a>

By default, Gantt chart columns are set up to automatically reorganize tasks according to their links: if the user moves a task in time, all tasks dependent on it are automatically moved.. 

To disable this parameter and to freely organize the tasks: 

1. Open the control description window. 

2. On the "Details" tab, uncheck "Reorganize other tasks when the user makes changes". 
...
<a name="filling_gantt_chart_column_with_the_data_found_hfsql_data_file_ELTPARAGRAPHE000153"></a>
...
<a name="retrieving_list_tasks_ELTPARAGRAPHE000165"></a>

[GanttListTask](../WDLang1/1000021073.md) is used to retrieve: 
...
<a name="displaying_the_gantt_chart_from_specific_date_ELTPARAGRAPHE000184"></a>

To display the Gantt chart from a specific date and time, use [GanttPositionDateTime](../WDLang1/1000021036.md). 
...
### Deleting a task
<a name="deleting_task_ELTPARAGRAPHE000196"></a>
...
### Deleting a link
<a name="deleting_link_ELTPARAGRAPHE000209"></a>
...
<a name="using_the_context_menu_aaf_ELTTEXTE000483"></a>
The Gantt Chart Column control is associated with a context menu (AAF). The context menu allows you to: 
...
**Example**: To save a task added by the user via the context menu in a "Task" data file, simply enter in the "Task entry" event: 
...
<a name="advanced_use_events_associated_with_gantt_chart_column_ELTTEXTE000507"></a>


### Advanced use of events with procedures
<a name="advanced_use_events_with_procedures_ELTPARAGRAPHE000258"></a>
...
<a name="managing_the_bank_holidays_the_holidays_and_the_working_hours_ELTTEXTE000531"></a>


### Management of public holidays
<a name="management_public_holidays_ELTPARAGRAPHE000281"></a>
...
<a name="managing_the_holidays_ELTPARAGRAPHE000297"></a>
...
<a name="managing_the_working_hours_ELTPARAGRAPHE000312"></a>
...
<a name="properties_specific_the_gantt_chart_columns_ELTTEXTE000569"></a>
The following properties are specific to programmed Gantt chart management.
...
For a complete list of WLanguage properties that can be used with a Gantt Chart column, see [Properties associated with Gantt Chart columns](../WDChamp/1000030003.md).
