...
3. Click the "Internal window" tab and select "Blank" (select the associated theme template if necessary). Validate to create the window.
...
- In the "UI" tab of the description window, you can specify whether the internal window should use the theme of the host window. To do so, simply check the option "Apply the theme of the host window".
...
1. On the "Display" tab, click the dialog box launcher (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_regroup.gif)) of the "Options" group.
