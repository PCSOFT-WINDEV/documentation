...
<br>![Examples of Switch controls in both possible positions](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WX-Champ-interrupteur-a-curseur%20copie.jpg)
...
2. The list of available controls is displayed with the project theme:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Interupteur_a_bascule%20-%20HC%20N%B0001.gif)
...
- **Display mode: ** Allows you to choose the presence and position of the options label to be displayed in the field. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Interupteur_a_bascule%20-%20HC%20N%B0002.gif)
...
- **Caption alignment: ** Allows you to frame option labels. This option depends on the display mode chosen. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Interupteur_a_bascule%20-%20HC%20N%B0003.gif)
