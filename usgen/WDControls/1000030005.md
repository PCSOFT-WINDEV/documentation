...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Gantt.gif)
...
4. Choose the desired menu in the "Context menu" combo box. It is possible to: 

	- "Display the AAF menu (System)": In this case, the context menu displayed will be the automation menu for the Gantt Chart control field.. For more details on how to configure this menu, see [Configuring the AAF menu](../Editeurs/2010040.md).
...
- [AAFDisable](../WDLang1/1000022018.md) is used to remove some options from the context menu of the AAFs specific to Gantt Chart controls. Different constants can be used according to the option to disable: 
	...
	- *faaGanttAjouteDépendance*: deactivates: 
...
- *faaGanttAddTask*: to disable the addition of a task. 

- *faaGanttEditTask*: disables editing of a task. 

- *faaGanttDeleteTask*: to disable task deletion. 

- *faaImprimeEtatSurTable*: disables printing of Gantt chart. 
...
[Gantt Chart report](../WDChamp/1011084.md)
