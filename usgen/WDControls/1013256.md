...
## Properties available for Internal Window controls
<a name="properties_available_for_internal_window_controls_ELTTEXTE000130"></a>
 
 
The following properties can be used with "Internal window" controls:
...
| [VerticalSwipe](../Proprietes/1000022460.md) | The **VerticalSwipe** property gets and changes the swipe direction in an internal window with swipe gesture support. |
...
## Properties associated with internal windows and Internal Window controls
<a name="properties_associated_with_internal_windows_and_internal_window_controls_ELTTEXTE000815"></a>
All WLanguage properties available for windows can be used on an internal window.

When the internal window is assigned to an Internal Window control, the properties of the internal window are automatically copied into the properties of the "Internal window" control except for the following properties that are specific to the control:
...
Only these properties can be modified when editing the "Internal window" control.
...
## Special case
<a name="special_case_ELTTEXTE000839"></a>


### Plane property
<a name="plane_property_ELTPARAGRAPHE000078"></a>

Unlike the other controls, the [Plane](../Proprietes/2510094.md) property does not apply to the "Internal window" control but to its content. Therefore, this property is used to modify the visible plane of the internal window.
