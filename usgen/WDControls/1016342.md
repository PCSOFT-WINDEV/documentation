...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
The following properties can be used with Range Slider controls: 
...
| [TotalRange](../Proprietes/1000019066.md) | The **TotalRange** property gets and sets the total range of data represented by the Range Slider control. |
...
| [VisibleRange](../Proprietes/1000019067.md) | The **VisibleRange** property gets and sets the width of the Range Slider control track. |
...
[The Range Slider control](../WDChamp/1016340.md)

[Handling a Range Slider programmatically](../WDChamp/1016341.md)

[Range Slider control events](../WDChamp/1016343.md)
