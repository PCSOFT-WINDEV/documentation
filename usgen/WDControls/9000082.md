...
The window for describing the conditions and actions is as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=eyemagnet_fen_edition.gif)


- The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=eyemagnet_btn_plus.gif) and ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=eyemagnet_btn_supprimer.gif) buttons are used to add or delete conditions or actions.
...
3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=BtnRupture.gif) to open the edit window.
...
3. Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=eyemagnet_btn_supprimer.gif) button of the eYe magnet to delete.
