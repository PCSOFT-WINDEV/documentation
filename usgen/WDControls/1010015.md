...
- [Managing the context menus in a WINDEV application](../WDChamp/1010011.md).
...
5. Associate the option with the group (check the corresponding box). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GroupeOption.gif)
...
3. Type the name of group to associate in the "MDI group" option.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OptionGroupeMDI.gif)
...
For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FenFilleMDIOuvertepsd.gif)
...
3. Check "MDI menu".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OptionMenuMDI.gif)
