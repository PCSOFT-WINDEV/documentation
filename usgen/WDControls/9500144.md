...
You can use different properties with break headers and footers in a Table control. These properties can be used in a window or in a page. 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Several WLanguage functions can be used to create breaks programmatically: 
...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) In a page (Server code): 
...
- ![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) In a page (Browser code): 
...
- ![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) In a page (PHP): 
