...
You can manipulate a Diagram Editor control in a window or page using the following WLanguage properties.
...
| [EditMode](../Proprietes/1410089005.md) | The **ModeEdition** property lets you know and modify the editing mode of the Diagram Editor control: selection or freehand drawing. |
...
<a name="properties_available_page_ELTTEXTE000989"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in Server code
<a name="properties_available_server_code_ELTPARAGRAPHE000027"></a>The following properties are associated with Diagram Editor controls:
...
<a name="properties_available_browser_code_ELTPARAGRAPHE000037"></a>The following properties are associated with Diagram Editor controls: 
...
<a name="properties_available_php_ELTPARAGRAPHE000047"></a>The following properties are associated with Diagram Editor controls:
