...
- A Flexbox control in a window. 

- Controls in a Flexbox control. These specific properties can be used to define the behavior of the Flexbox control at runtime. 
...
## Flexbox control properties available in a window
<a name="flexbox_control_properties_available_window_ELTTEXTE000100"></a>
The following properties are associated with Flexbox controls:
...
| [FlexAlignContent](../Proprietes/1410089744.md) | The **FlexAlignContent** property gets and sets the alignment of the lines within the Flexbox control along the cross axis (corresponding CSS property: "align-content"). |
| [FlexAlignItems](../Proprietes/1410089745.md) | The **FlexAlignItems** property gets and sets the alignment of the items in a line of a Flexbox control along the cross axis (corresponding CSS property: "align-items"). |
...
| [FlexColumnGap](../Proprietes/1410089747.md) | The **FlexColumnGap** property gets and sets the size of the gutter that separates the columns of a Flexbox control. |
| [FlexDirection](../Proprietes/1410089741.md) | The **FlexDirection** property gets and sets the direction of the main axis of a Flexbox control (corresponding CSS property: "flex-direction"). |
...
| [FlexJustifyContent](../Proprietes/1410089743.md) | The **FlexJustifyContent** property gets and sets the alignment of items in the Flexbox control along the main axis (corresponding CSS property: "justify-content"). |
| [FlexRowGap](../Proprietes/1410089746.md) | The **FlexRowGap** property gets and sets the size of the gutter that separates the rows of a Flexbox control. |
...
| [FlexWrap](../Proprietes/1410089742.md) | The **FlexWrap** property determines whether items are laid out in one line, or can wrap onto multiple lines (corresponding CSS property: "flex-wrap"). |
...
## Properties specific to controls within a Flexbox control
<a name="properties_specific_controls_within_flexbox_control_ELTTEXTE000986"></a>
Controls within a Flexbox control have specific properties linked to the flexbox container: 
