...
If the window is minimized, the other windows are not minimized. The icon used is the one from the window (or project, if the window does not have an associated icon).
