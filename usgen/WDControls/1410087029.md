...
The HTML code editor proposes the different available procedures and actions: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CompoWeb_code.gif)
...
## Manipulating Web Component controls programmatically
<a name="manipulating_web_component_controls_programmatically_ELTTEXTE000157"></a>
...
For a complete list of WLanguage properties that can be used with Web Component controls, see [Web Component control properties](../WDChamp/1410087028.md).
