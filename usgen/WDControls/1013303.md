...
WINDEV allows you to programmatically manipulate Dynamic Tab controls with the [TabXXX functions](../WDLang1/1000021391.md) and multiple WLanguage properties. You can also use the Tab control variable directly in the code. 
...
<a name="opening_dynamic_tab_pane_ELTTEXTE000366"></a>
...
2. The internal window opened by the "+" button can be: 
	...
	- **a specific internal window** (e.g. a customer form). 
			...
			Note: If the internal window is expecting parameters, it is necessary to open the tab pane by programming with the [TabOpen](../WDLang1/1000021369.md) function.. 
...
Note: The "+" button on the dynamic tab automatically calls the "Pane creation" event in the Tab Control. If this event uses [TabOpen](../WDLang1/1000021369.md), this event will take priority over the internal window specified in the interface.
<a name="NOTE2_3"></a>
...
<a name="tip_offer_menu_pane_allowing_the_user_choose_the_type_pane_created_ELTPARAGRAPHE000120"></a>
...
<a name="handling_dynamic_tab_pane_ELTTEXTE000408"></a>
...
- The [TabStatus](../WDLang1/1000021637.md) function can be used to determine the status of a dynamic tab pane: active, floating, non-existent, etc. 
...
<a name="changing_the_active_dynamic_tab_pane_ELTTEXTE000432"></a>
...
<a name="getting_the_text_the_active_dynamic_tab_pane_ELTTEXTE000456"></a>
...
<a name="retrieving_the_name_the_internal_window_displayed_pane_ELTTEXTE000480"></a>
...
<a name="properties_specific_tab_controls_ELTTEXTE000528"></a>
