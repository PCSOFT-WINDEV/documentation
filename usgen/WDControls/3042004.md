...
- **candlestick**: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=chandelier.gif)


- **barcharts**: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=barcharts.gif)


- **minmax**: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=mini_maxi.gif)
