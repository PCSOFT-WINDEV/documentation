...
## Properties available for Map controls in a window
<a name="properties_available_for_map_controls_window_ELTTEXTE000150"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The following properties can be used with Map controls in a window:
...
| [Compass](../Proprietes/1000025607.md) | The **Compass** property is used to: <br><br>- show or hide the compass on a Map control, <br><br>- determine whether the compass is displayed on a Map control.<br><br><br> |
...
## Properties available for the Map controls found in a page
<a name="properties_available_for_the_map_controls_found_page_ELTTEXTE000800"></a>
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) The following properties are available in Server code: 
...
| [InitialState](../Proprietes/2510063.md) | The **InitialState** property gets the initial state of a control. |
| [InitialVisible](../Proprietes/2510070.md) | The **InitialVisible** property is used to determine if:<br><br>- a control was visible during the first display of the associated window or page.<br><br>- a window was visible during its first display.<br><br><br> |
| [InternalPagePopup](../Proprietes/1000026257.md) | The **InternalPagePopup** property is used to get and modify the name of the internal page used to customize the content of marker popups in a Map control. |
| [MapMode](../Proprietes/1000019956.md) | The **MapMode** property determines and changes how the map is displayed in the Map control. |
| [Name](../Proprietes/2510082.md) | The **Name** property is used to get:<br><br>- the name of the font associated with a Font variable.<br><br>- the name of a control, report or report block.<br><br>- the name of a control, group of controls or window.<br><br>- the name of a control, group of controls or page.<br><br><br> |
| [Note](../Proprietes/2510085.md) | The **Note** property is used to:<br><br>- Find out the notes associated with a control, a window, a page or a report.<br><br>- Modify the notes associated with a control, a window a page or a report.<br><br><br> |
| [NoteTitle](../Proprietes/2510121.md) | The **NoteTitle** property is used to:<br><br>- Get the title of the notes used in the technical documentation of a control, window, page or report. <br><br>- Change the title of the notes used in the technical documentation of a control, window, page or report.<br><br><br> |
...
<a name="NOTE2_3"></a>
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) The following properties are available in Browser code: 
...
<a name="NOTE2_4"></a>
![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) The following properties are associated with the Map control in a page: 
