...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) The planes can be used on the pages and on the container controls. For more details, see [The planes in WEBDEV](../WDChamp/1013080.md)

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) The window editor proposes an advanced plane management allowing you to name the planes. For more details, see [Editing planes in the window editor](#NOTE3_1_Naming).
...
- **In the window editor**: on the "Window" tab, in the "Associate" group, expand "Planes". In the window that is opened, simply choose the plane to display in the "Navigation" section. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=plan18.gif&type=thumb)
...
- Type the number of the plane to display in the status bar of window or report editor. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=PlanFenetre.gif)
...
1. On the "Window" tab, in the "Associate" group, expand "Planes" and select "Edit planes" (or press Alt + Page Down). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Les_plans-nommage%20-%20HC%20N%B0001.gif)


2. The displayed window presents a thumbnail of all window planes. These thumbnails are classiffied according to their order number. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Les_plans-nommage%20-%20HC%20N%B0002.gif&type=thumb)
...
2. Click the "Pen" icon: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Les_plans-nommage%20-%20HC%20N%B0002%201.gif)


3. Type the plane name in the area that is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Les_plans-nommage%20-%20HC%20N%B0003.gif)
...
2. Right-click to open the context menu of the selection and select "Insert a blank plane". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Les_plans-nommage%20-%20HC%20N%B0005.gif)
...
2. Right-click to open the context menu of the selection and select "Start from plane". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Les_plans-nommage%20-%20HC%20N%B0005%201.gif)
