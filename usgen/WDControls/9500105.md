...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_MenuContextuelImage%20-%20HC%20N%B0003.gif)
...
3. In the "Image options (for the user)" option, select the type of context menu to be displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_MenuContextuelImage%20-%20HC%20N%B0001.gif&type=thumb)


	- "No menu": No context menu will be displayed for the field.. 

- "Simple menu (copy, save as, etc.)". The context menu allows you to copy, save and display the selected image in high quality.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_MenuContextuelImage%20-%20HC%20N%B0002.gif)
...
3. Choose the desired menu in the "Context menu" combo box. It is possible to: 
	...
	- "Display the AAF menu (System)": In this case, the context menu displayed will be the automation menu for the Image field.. For more details on how to configure this menu, see [Configuring the AAF menu](../Editeurs/2010040.md).
...
[FAA: Edit control fields for file paths](../WDChamp/9500123.md)
