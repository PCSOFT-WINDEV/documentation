...
**To precisely select the points of the area**, you have the ability to zoom the page in the page editor. To do so, select the zoom percentage in the status bar of WEBDEV. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Zoom.gif)
...
[ImageArea (Function)](../WDChamp/3045002.md)
