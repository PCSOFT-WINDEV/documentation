...
- **the total row** used to calculate the totals on the table columns. 
	In most cases, these rows are displayed in the *Break footer* block or in the *Page footer* block.
	**Note** The different totals cells are not necessarily placed on the same line.




For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EtatPartieTableau.gif)
...
## Advantage
<a name="advantage_ELTTEXTE000137"></a>
...
At runtime, if a value cannot be entirely displayed in a cell of an auto-sizable table, all the cells found on the row will take the same height in order for the value to be entirely displayed.
...
## Examples
<a name="examples_ELTTEXTE000161"></a>
Some examples of reports with table:

- Order form (simple table):
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Etat_overview1.gif&type=thumb)


- List of products (simple table): 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EtatListe2.gif&type=thumb)


- Sales per year and per customer (crosstab): 
	<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=EtatTableaucroise2.gif&type=thumb)
...
[Creating a table in a report](../WDChamp/1013052.md)
