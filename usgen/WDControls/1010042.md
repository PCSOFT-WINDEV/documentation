...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) a context menu.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Creation_Option_WB%20-%20HC%20N%B0001.gif)
...
<a name="the_different_operations_ELTTEXTE000290"></a>
...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) Submenus in context menus: You can define the orientation of the submenus in the description window of the context menu: 
...
<a name="configuring_the_options_popup_menu_dropdown_menus_only_ELTTEXTE000338"></a>


### Overview
<a name="overview_ELTPARAGRAPHE000152"></a>In a "Popup" menu, hovering over an option in the menu bar opens an entirely customizable Popup page. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_popup_WB.gif)
...
<a name="creating_the_options_popup_menu_ELTPARAGRAPHE000161"></a>
