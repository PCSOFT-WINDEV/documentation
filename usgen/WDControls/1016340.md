...
A Range Slider control includes the following elements: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RangeSlider_voc.gif)
...
When the control is created, it can be used to manage the selection of interval or zoom programmatically. 
