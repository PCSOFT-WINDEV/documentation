...
### Properties available in a window
<a name="properties_available_window_ELTPARAGRAPHE000020"></a>The following WLanguage properties are associated with a dynamic or static Tab control:
...
| [AutomaticTextColor](../Proprietes/1000022074.md) | The **AutomaticTextColor** property gets and sets the color to be used for the text of the elements that use the "Automatic" color. |
...
| [TabOffset](../Proprietes/1000023492.md) | The **TabOffset** property gets and sets the offset between the border of a Tab or Ribbon control and the tab buttons. |
...
<a name="properties_available_page_ELTTEXTE000915"></a>
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in a page (Server code)
<a name="properties_available_page_server_code_ELTPARAGRAPHE000032"></a>The following WLanguage properties are associated with a Tab control:
...
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000042"></a>The following WLanguage properties are associated with a Tab control:
...
<a name="properties_available_php_ELTPARAGRAPHE000052"></a>The following WLanguage properties are associated with a Tab control:
