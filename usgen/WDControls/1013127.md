...
You can manipulate Button controls in a window or page using different WLanguage properties. 
...
<a name="properties_available_window_ELTTEXTE000127"></a>
...
### Properties available in a window
<a name="properties_available_window_ELTPARAGRAPHE000020"></a>The following WLanguage properties are associated with Button controls:
...
| [ButtonType](../Proprietes/1000021108.md) | The **TypeButton** property is used to identify and modify the type of a button field: Cancel, Interrupt, Validate, ... |
...
<a name="properties_available_page_ELTTEXTE000997"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in a page (Server code)
<a name="properties_available_page_server_code_ELTPARAGRAPHE000033"></a>The following WLanguage properties are associated with Button controls:
...
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000043"></a>The following WLanguage properties are associated with Button controls:
...
<a name="properties_available_php_ELTPARAGRAPHE000053"></a>The following WLanguage properties are associated with Button controls:
