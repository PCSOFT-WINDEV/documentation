...
<a name="overview_control_ELTTEXTE000168"></a>
...
**Attention**: Use of the Ad control field is subject to specific conditions of use.. For more details, see [Conditions for using the Ad control](../WDChamp/1000023005.md). 
...
<a name="creating_control_ELTTEXTE000192"></a>
...
### Size of ads
<a name="size_ads_ELTPARAGRAPHE000045"></a>The context menu found on the right of the icon for control creation proposes four possible sizes: 
...
<a name="operating_mode_controls_ELTTEXTE000222"></a>
...
- At runtime in the simulator, the Ad control will display a fixed image whose size is identical to the size of the ad banner.
...
We recommend that you use the events "Loading an ad" and "Error while loading an ad" to check the display of ads in the control. For more details, see [Ad control events](../WDChamp/1000023002.md). 

**Remark**: It is possible to know if an ad is displayed in the field thanks to the [AdLoaded](../Proprietes/1000020180.md) property.
...
<a name="modifying_the_permissions_ELTTEXTE000258"></a>
...
[Conditions for using the Ad control](../WDChamp/1000023005.md)
