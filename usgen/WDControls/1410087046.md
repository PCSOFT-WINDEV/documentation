...
<a name="layout_control_overview_ELTTEXTE000295"></a>
The Layout control simplifies the implementation of dynamic UIs where controls are displayed and/or hidden programmatically. When a control is hidden (e.g. via the [Visible](../Proprietes/2510138.md) property), the Layout control automatically repositions all the other controls to keep a neat interface and avoid "spaces".
...
To handle the Layout control, see [Manipulating Layout controls programmatically](../WDChamp/1410087049.md). 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) In a window, a Layout control can be used in a Looper control: 
...
For more details, see [Display different content for each row](../WDChamp/1013289.md). 

![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) In a page, the Layout control can be used in a control inside a Looper control. For example, if you want to create a Looper control to optimize an interface: 
...
<a name="characteristics_layout_controls_ELTTEXTE000355"></a>
...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) The CSS style of the current cell can also be configured in the "General" tab.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The **"Reduce the parent"** option allows you to reduce the parent if necessary. If the window is the parent, it will be reduced next time it is opened.
...
- **Margin between cells**: Spacing between Layout control cells. This spacing is expressed in pixels. It can be changed programmatically with the [MarginInterCell](../Proprietes/1000023413.md) property.  




![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Remarks: 
...
**Example**: A Layout control is created in the window editor. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_disposition_auto%20-%20HC%20N%B0001.gif)
...
- During a test (Go), the window displays all controls. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_disposition_auto%20-%20HC%20N%B0002.gif)


- When the phone number and email address are deleted, the Layout control is reduced but the window stays the same size.

- When the phone number, email address and comment are added, the Layout control is enlarged, as well as the window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_disposition_auto%20-%20HC%20N%B0004.gif)
...
- When a comment is added, a scrollbar automatically appears in the Layout control in order to scroll through the different elements. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=champ_disposition_Ascenseur%20-%20HC%20N%B0001.gif)
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Example 4: **option Enlarge the field Push the fields around** with programmable window reduction management

- During a test (Go), the window displays all controls. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_disposition_auto%20-%20HC%20N%B0002.gif)


- When the phone number and email address are deleted, the Layout controls is reduced, as well as the window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_disposition_auto%20-%20HC%20N%B0003.gif)
...
<a name="layout_control_and_responsive_mode_zoning_and_layouts_ELTTEXTE000397"></a>
...
[Manipulating Layout controls programmatically](../WDChamp/1410087049.md)

[Layout control properties](../WDChamp/1410087048.md)

[Layout control events](../WDChamp/1410087047.md)

[Anchoring in a page](../WDChamp/9000131.md)

[Anchoring applied to window controls](../WDChamp/2026002.md)

[LayoutAdaptSize (Function)](../WDChamp/1000023548.md)
