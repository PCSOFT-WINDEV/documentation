...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
**Note**: The Xaml control available until WINDEV 15 is now called the .NET 3.0, 4.0 control (WPF). In this documentation, we will be using the term of ".Net control (WPF)".

The following properties can be used with .Net controls (WPF):
...
[The .NET field 3.0, 4.0, ... (WPF)](../WDChamp/1017001.md)
