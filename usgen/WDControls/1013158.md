...
You can define the click actions of an Image control ("General" tab of the control description window) to make it Clickable Image control.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=image_clic_modeFoctionnemen.gif)
...
For more details, see [Retrieving the click coordinates](../WDChamp/1013130.md).
