...
The context menu for the entire field is displayed via the "arrow" icon (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Table_MenuCtx%201.gif)) at the top right of the field (above the scrollbar). 
...
<br>![Example of a text column context menu](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Table_MenuCtx.gif)
...
3. Choose the desired menu in the "Context menu" combo box:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fonctionnalites_auto_Menu2.gif)
...
3. Check or uncheck "'Select columns...' menu".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fonctionnalites_auto_Menu3.gif)
...
[FAA: Sort/Search/Filter on Table Columns](../WDChamp/9500125.md)
