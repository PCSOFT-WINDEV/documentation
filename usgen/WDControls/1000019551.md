...
A Web Camera control in a page can be manipulated using the following WLanguage properties.
...
<a name="properties_available_page_php_ELTPARAGRAPHE000040"></a>The following properties are associated with Web Camera controls:
