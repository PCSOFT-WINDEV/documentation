...
2. On the "General" tab, indicate whether the control uses an HTML toolbar: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=HTML_ConfigBarreWB%20-%20HC%20N%B0002.gif)
...
Below is the default HTML bar: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=HTML_Barre_WB%20-%20HC%20N%B0003.gif)
...
- insert arrays: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=HTML_Barre_Tableau%20-%20HC%20N%B0004.gif)


- choose the style of the inserted table. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=HTML_Barre_Tableau%20-%20HC%20N%B0006.gif&type=thumb)


- view the HTML source code (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=HTML_Barre_WB%20-%20HC%20N%B0003%201.gif)).  




**Remark**: 
The colors available by default are the ones defined by the skin of the site. Simply click the desired color. This allows you to use consistent colors in the site.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=HTML_Barre_WBCouleur%20-%20HC%20N%B0004.gif)
