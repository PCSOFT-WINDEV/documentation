...
WINDEV, WEBDEV and WINDEV Mobile allow you to programmatically manipulate Radio Button controls. To do so, use the variable of Radio Button control in the code.

Regardless of the type of picker, each option can be associated with:

- ***an integer***. This integer can take a value from 1 to N, N being the total number of options found in the radio button. The first option is the option #1, the second option is the option #2, ... The options are numbered from top to bottom and left to right.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) ***a specific returned value***. This returned value is specified in the "Content" tab of the control description window.


![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Using the numbering or the returned values?**
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) the [&lt;Window&gt;.FromFile](../WDLang4/1000021387.md) function. 

- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) the [&lt;Page&gt;.FromFile](../WDLang4/1000021389.md) function.
...
**Remark**: By default, a Radio Button control with no default value is inaccessible via TAB.
...
**Note**: If the field is associated with an item in a data file, the value entered is automatically retrieved using: 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) the [ScreenToFile](../WDLang4/1000021385.md) function.

- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) the [&lt;Page&gt;.ToFile](../WDLang4/1000021390.md) function. 
...
<a name="for_radio_button_control_that_returns_value_ELTPARAGRAPHE000311"></a>
...
**Remark**: The [ReturnedValue](../Proprietes/2510134.md) property can also be used to find out and modify the value returned by each Radio Button control option.
...
<a name="prefilled_switch_the_radio_button_controls_ELTPARAGRAPHE000361"></a>
...
- Code for a picker field returning an integer: entering "SELON SEL_Civilité" in the code editor displays: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Selon_auto_Selecteur2.gif)


- Code for a picker field returning a value: entering "SELON SEL_PlatDuJour" in the code editor displays: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Selon_auto_Selecteur1.gif)
...
<a name="modifying_the_caption_radio_button_control_ELTTEXTE000375"></a>
...
<a name="case_radio_button_controls_with_subcaptions_ELTPARAGRAPHE000425"></a>

The [SubCaption](../Proprietes/1000017232.md) property gets and sets the sub-captions of options in a Radio Button control.
...
<a name="changing_the_colors_captions_for_the_options_radio_button_control_ELTTEXTE000435"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) To modify the colors of captions for the options found in a Radio Button control, you have the ability to use the following syntax: 
...
<a name="properties_specific_radio_button_controls_ELTTEXTE000478"></a>
...
| [ReturnedValue](../Proprietes/2510134.md) | Enables you to find out and modify the value returned by an option in a Radio Button control. |
...
For a complete list of WLanguage properties that can be used with Radio Button controls, see [Radio Button control properties](../WDChamp/1013253.md).
