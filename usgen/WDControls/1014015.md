...
- the '![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=SigleEuro.gif)' symbol if the current currency is the Euro.
...
For example: the mask '$999.99' will display '250.25 ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=SigleEuro.gif)' if the current currency is the Euro and '250.25 GBP' if the current currency is the Pound Sterling.
