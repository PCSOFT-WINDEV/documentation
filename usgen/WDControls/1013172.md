...
## Properties that can be used on the window controls
<a name="properties_that_can_used_the_window_controls_ELTTEXTE000136"></a>
...
### Properties that can be used on the Check Box control in a window
<a name="properties_that_can_used_the_check_box_control_window_ELTPARAGRAPHE000020"></a>The following properties are associated with Check Box controls:
...
<a name="properties_that_can_used_the_page_controls_ELTTEXTE001036"></a>
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties that can be used on a Check Box control found in a page (Server code)
<a name="properties_that_can_used_check_box_control_found_page_server_code_ELTPARAGRAPHE000033"></a>The following properties are associated with Check Box controls:
...
### Properties that can be used on a Check Box control found in a page (Browser code)
<a name="properties_that_can_used_check_box_control_found_page_browser_code_ELTPARAGRAPHE000043"></a>The following properties are associated with Check Box controls:
...
### Properties that can be used on a Check Box control in PHP
<a name="properties_that_can_used_check_box_control_php_ELTPARAGRAPHE000052"></a>The following properties are associated with Check Box controls:
...
## Properties that can be used on the report controls
<a name="properties_that_can_used_the_report_controls_ELTTEXTE002233"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The following properties are associated with Check Box controls:
