...
<a name="displaying_bar_code_bar_code_control_ELTTEXTE000249"></a>


### Displaying a bar code in a Bar Code control
<a name="displaying_bar_code_bar_code_control_ELTPARAGRAPHE000057"></a>
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) For example: 
...
END
```
**Remark**: In a window or page, if the field is associated with a data file item, the value entered is automatically retrieved using the [ScreenToFile](../WDLang4/3044146.md) or [PageToFile](../WDLang4/3044022.md) function.. For more details, see [Binding Bar Code controls to items](../WDChamp/1013010.md).
<a name="NOTE2_2"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Retrieving in a Bar Code control the value read by a specific device
<a name="retrieving_bar_code_control_the_value_read_specific_device_ELTPARAGRAPHE000100"></a>
...
2. Read the bar code value using the following serial port functions: 
...
<a name="retrieving_the_value_the_bar_code_displayed_the_bar_code_control_ELTTEXTE000299"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) To retrieve the bar code value:
...
**Remark**: If the field is associated with an item in a data file, the value entered is automatically retrieved using the [ScreenToFile](../WDLang4/3044146.md) function.. For more details, see [Binding Bar Code controls to items](../WDChamp/1013010.md).
...
<a name="properties_specific_bar_code_controls_ELTTEXTE000323"></a>
