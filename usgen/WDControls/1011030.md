...
- from the window for managing the edit options of report editor. To open this window, go to the "Display" tab and click the dialog box launcher (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_regroup.gif)) of the "Options" group.
...
During the report test, the report editor proposes several print modes: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GO_Etat_choix.gif)
...
For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=NOMCHAMPETAT.GIF)
...
|   |   |
| --- | --- |
| <br><br>- visible.<br><br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MARGEETATAFFICHE.GIF)<br> | <br><br>- invisible.<br><br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MARGEETATNONAFFICHE.GIF)<br> |
...
|   |   |
| --- | --- |
| <br><br>- in full.<br><br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=NOMBLOCCOMPLET.GIF)<br> | <br><br>- in short.<br><br><br><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=NOMBLOcABReGe.GIF)<br> |
...
By default, only the names of the fonts installed on the development computer are displayed in the "Font" combo box.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Police_Langues%20-%20HC%20N%B0001.gif)
...
1. In the report editor, go to the "Display" tab and click the dialog box launcher (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_regroup.gif)) of the "Options" group.

2. Open the "Preferences" tab if necessary. 

3. Check "Display all available languages".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Police_Langues%20-%20HC%20N%B0003.gif)





In the "Style" tab of a given control, the list of fonts will be as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Police_Langues%20-%20HC%20N%B0004.GIF)
...
1. On the "Modification" tab, click the dialog box launcher (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_regroup.gif)) of the "Options" group.
