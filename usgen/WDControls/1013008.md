...
## Properties available for Chart controls in a window
<a name="properties_available_for_chart_controls_window_ELTTEXTE000146"></a>
The following properties can be used with Chart controls in a window:
...
<a name="properties_available_for_the_chart_controls_found_page_ELTTEXTE001014"></a>
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties associated with Chart controls in a page (Server code)
<a name="properties_associated_with_chart_controls_page_server_code_ELTPARAGRAPHE000043"></a>The following properties can be used with Chart controls in a page, in Server code:
...
### Properties associated with Chart controls in a page (Browser code)
<a name="properties_associated_with_chart_controls_page_browser_code_ELTPARAGRAPHE000053"></a>The following properties can be used with Chart controls in a page, in Browser code:
...
### Properties associated with Chart controls in a page (PHP)
<a name="properties_associated_with_chart_controls_page_php_ELTPARAGRAPHE000063"></a>The following properties can be used with Chart controls in PHP pages:
...
## Properties available for Chart controls in a report
<a name="properties_available_for_chart_controls_report_ELTTEXTE002000"></a>
<a name="NOTE3_1"></a>


### Properties associated with Chart controls in a report
<a name="properties_associated_with_chart_controls_report_ELTPARAGRAPHE000072"></a>The following properties can be used with Chart controls in a report:
