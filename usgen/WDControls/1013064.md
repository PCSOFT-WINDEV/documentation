...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Btn_Style_1.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bleu0208.gif)
...
- **image of the control border**: this image is used to define the shape of the Button control. It can contain up to 5 drawings, corresponding to the different states of the control.
	![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Only the image of the Button control border can be configured.
