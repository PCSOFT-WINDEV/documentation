...
2. On the "UI" tab, select "Fixed". Three modes are available: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB_ZoneEpingle_modes.gif&type=thumb)
...
4. Click "Parameters" to manage how the control is fixed. Three modes are available: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB_CelluleEpingle_modes.gif&type=thumb)
