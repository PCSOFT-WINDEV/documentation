...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) by pressing the right mouse button.

- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) by a long press on the control. 
...
- **System context menus** (Android, Windows, etc.). These context menus are displayed on some types of controls (ActiveX, etc.). 
	...
	![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) System context menus are not available.




Example of a custom context menu: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MenuContextuel.gif)


Note: In a WEBDEV page, it is also possible to manage context menus using the [Context menu](../WDChamp/1410087217.md) field. 
