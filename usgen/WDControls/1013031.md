...
- ** 2nd method**:
	...
	3. Click the control again. The mouse cursor turns into an input cursor.
		...
		- in a window:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=LibelleModifDirect.gif)


		- in a report:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=LibelleModifDirectetat.gif)
...
2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Combo_des_saisie_btn_multilangue.gif) found beside the "Input mask" or "Mask" combo box ("General" or "Details" tab). By default, the same mask is associated with all the languages supported by the window, the page or the report.
...
2. Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) icon next the "Image" or "Background image" option ("General" or "Style" tab), then select "Multilingual". 
	By default, the same file is associated with all languages supported by the window, page or report.

3. For each language, click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button, "Browse" option, and select the image corresponding to the language. 
...
![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) The help windows are not available.
<a name="NOTE5_2"></a>
...
[Developing multilingual applications](../WDChamp/3054008.md)
