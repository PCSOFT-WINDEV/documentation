...
<a name="creating_custom_property_ELTTEXTE000214"></a>
...
3. Select the desired element. Open the context menu of the element and select "New property".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Propri%E9t%E9_personnalis%E9e%20-%20HC%20N%B0002.gif)


4. In the window that appears, enter the name of the property and validate.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Propri%E9t%E9_personnalis%E9e%20-%20HC%20N%B0003.gif)


5. The code editor shows the events related to the property: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Propri%E9t%E9_personnalis%E9e%20-%20HC%20N%B0004.gif)
...
2. This property of the template will be called in the code of the window:
	...
	```wl
	Info("The number of days selected is: " + CMOD_Duration.Duration)
	```
...
**Example**: Assigning the [ToolTip](../Proprietes/2510005.md) property: 

```wl
PROCEDURE ToolTip(Value)

Myself.Bubble = "Number of days: " + Value
```
...
<a name="access_rights_custom_property_ELTTEXTE000250"></a>
Caution: The custom property can be read and/or written depending on the associated events that have been defined: 
...
<a name="passing_custom_properties_parameter_wlanguage_function_procedure_ELTTEXTE000274"></a>
