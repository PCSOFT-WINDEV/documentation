...
Several WLanguage properties can be used on a Radio Button control found in a window, in a page or in a report. 
...
<a name="properties_that_can_used_window_ELTTEXTE000162"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![User code (UMC)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 

### Properties that can be used on the Radio Button control
<a name="properties_that_can_used_the_radio_button_control_ELTPARAGRAPHE000020"></a>The following WLanguage properties are associated with a Radio Button control:
...
| [CompactOption](../Proprietes/1000020608.md) | The **CompactOption** property is used to:<br><br>- determine whether the options of a Check Box, Radio Button or Dashboard control are compacted.<br><br>- define whether the options of a Check Box, Radio Button or Dashboard control should be compacted.<br><br><br> |
...
### Properties that can be used on the options of a Radio Button control
<a name="properties_that_can_used_the_options_radio_button_control_ELTPARAGRAPHE000032"></a>The following WLanguage properties are associated with the options found in a Radio Button control:
...
<a name="properties_that_can_used_page_ELTTEXTE001226"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties that can be used on the Radio Button control (Server code)
<a name="properties_that_can_used_the_radio_button_control_server_code_ELTPARAGRAPHE000044"></a>The following WLanguage properties are associated with a Radio Button control:
...
### Properties that can be used on the Radio Button control (Brower code)
<a name="properties_that_can_used_the_radio_button_control_brower_code_ELTPARAGRAPHE000054"></a>The following WLanguage properties are associated with a Radio Button control:
...
### Properties that can be used on the options of a Radio Button control
<a name="properties_that_can_used_the_options_radio_button_control_ELTPARAGRAPHE000064"></a>

The following WLanguage properties are associated with an option found in a Radio Button control:
...
<a name="properties_that_can_used_php_ELTPARAGRAPHE000078"></a>The following WLanguage properties are associated with a Radio Button control:
...
### Properties that can be used in PHP on the options of a Radio Button control
<a name="properties_that_can_used_php_the_options_radio_button_control_ELTPARAGRAPHE000088"></a>The following WLanguage properties are associated with an option found in a Radio Button control:
