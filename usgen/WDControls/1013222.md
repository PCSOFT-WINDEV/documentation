...
To create a Combo Box column, simply select "Combo Box" in the column type:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_Table_Combo.gif&type=thumb)
...
[Combo Box columns in Table controls (prefix syntax)](../WDChamp/9500152.md)
