...
To manipulate a Scheduler control through programming, WINDEV and WEBDEV propose the [SchedulerXXX functions](../WDLang1/1000019435.md). 
...
## Manipulating Scheduler controls programmatically
<a name="manipulating_scheduler_controls_programmatically_ELTTEXTE000463"></a>


### Adding a resource
<a name="adding_resource_ELTPARAGRAPHE000052"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Note: Use [SchedulerAddResource](../WDLang1/1000019279.md) to insert an image in the resource title.


### Adding an appointment
<a name="adding_appointment_ELTPARAGRAPHE000081"></a>
...
<a name="populating_scheduler_control_with_the_data_from_hfsql_table_ELTPARAGRAPHE000121"></a>

The records are stored in an HFSQL table. The initial fill of the Scheduler control can be done by browsing the table via the FOR EACH syntax and by adding each appointment via [SchedulerAddAppointment](../WDLang1/1000019273.md).
...
<a name="retrieving_list_appointments_ELTPARAGRAPHE000137"></a>

[SchedulerListAppointment](../WDLang1/1000019276.md) is used to retrieve: 
...
<a name="displaying_the_schedule_from_specific_resource_from_specific_date_ELTPARAGRAPHE000179"></a>
...
<a name="deleting_appointment_ELTPARAGRAPHE000213"></a>
...
### Deleting a resource
<a name="deleting_resource_ELTPARAGRAPHE000232"></a>
...
<a name="modifying_the_control_display_options_ELTPARAGRAPHE000251"></a>

The current display of a Scheduler control can be modified via the following functions: 

- [SchedulerDisplayPreviousPeriod](../WDLang1/1000019495.md) and [SchedulerDisplayNextPeriod](../WDLang1/1000019496.md): These two functions modify the display period (identical to the use of the spin button at the top of the Scheduler control). 

- [SchedulerChangeMode](../WDLang1/1000019440.md): Use this function to change the field display mode: day, week, month.  
...
<a name="handling_appointment_programmatically_ELTTEXTE000529"></a>
...
<a name="using_the_context_menu_aaf_ELTTEXTE000553"></a>
...
<a name="advanced_use_events_associated_with_the_scheduler_control_ELTTEXTE000577"></a>


### Advanced use of events with procedures
<a name="advanced_use_events_with_procedures_ELTPARAGRAPHE000338"></a>
...
<a name="management_public_holidays_ELTTEXTE000601"></a>
...
<a name="properties_specific_scheduler_controls_ELTTEXTE000625"></a>
...
[Manipulating Scheduler controls programmatically (prefix syntax)](../WDChamp/1000019654.md)
