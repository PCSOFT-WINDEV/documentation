...
In the report viewer, the clickable areas can be easily identified by the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Etat_ChampClicablesEtoile.gif) symbol. Furthermore, these areas are colored in yellow when they are hovered by the mouse cursor.
...
3. Write the following code in the "Click xxx" event: 
	...
	- pass the identifier of the customer as parameter to the window (this identifier is found in the embedded query). The [MySource](../Motscles/1511001.md) keyword allows managing the source of the report.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Etat_Clicable.gif&type=thumb)
