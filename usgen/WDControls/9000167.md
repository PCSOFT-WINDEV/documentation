...
- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) on page container fields: Cell, Layout area, Rich Text area, Template field. For more details, see [The parallax effect in the page editor](#NOTE3_1).
...
2. On the "UI" tab, expand the "Parallax" option. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Effet_de_parallaxe%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="defining_the_parallax_programmatically_ELTPARAGRAPHE000088"></a>The following properties are used to define the parallax of a control through programming: 
...
3. **To add a parallax effect of control**: 
	...
	- In the window that is displayed, choose the requested option: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Effet_parallaxe_WB%20-%20HC%20N%B0001.gif)
...
4. **To add a parallax effect of background image**: 
	...
	- The effect is added to the style. Click the "Details" button to configure the effect. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Effet_parallaxe_WB%20-%20HC%20N%B0002.gif)
