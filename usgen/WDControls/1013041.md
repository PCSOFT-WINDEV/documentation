...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
The following properties are associated with the Conference control:
...
| [Identifier](../Proprietes/2510036.md) | The **Identifier** property gets and sets the name of the current computer shown to the participants who receive the audio or video stream. This name can be a number, for example. |
| [IncomingData](../Proprietes/2510117.md) | The **Receive** property is used to identify and modify the type of incoming data transferred by the stream. |
...
| [OutgoingData](../Proprietes/2510037.md) | The **OutgoingData** property gets and sets the type of outgoing data transferred by the stream. |
...
| [Timeout](../Proprietes/2510052.md) | The **Timeout** property gets and sets the time after which the connection is considered to have "failed". |
