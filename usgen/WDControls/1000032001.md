...
<a name="overview_rich_text_area_control_ELTTEXTE000210"></a>
...
<a name="creating_rich_text_area_control_ELTTEXTE000234"></a>
...
1. Under the "Creation" pane, in the "Usual controls" group, click on "Rich Text Area".. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ZTR_Creation.gif)
...
<a name="typing_text_the_rich_text_area_control_ELTPARAGRAPHE000050"></a>

To type a text in the Rich Text Area control: 

1. Select the control. 

2. Click on the field: a yellow banner appears around the field and the field switches to edit mode.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ZTR_Edition_bandeau_Jaune.gif)
...
3. In edit mode: 
	...
	- the editor ribbon adapts to the input field: all available editing options are displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ZTR_Edition_ruban.gif)
These edit options are grouped in 4 categories: 
...
<a name="inserting_link_into_the_rich_text_area_control_ELTPARAGRAPHE000079"></a>
...
<a name="inserting_image_into_the_rich_text_area_control_ELTPARAGRAPHE000106"></a>
...
<a name="inserting_font_icon_into_the_rich_text_area_control_ELTPARAGRAPHE000137"></a>

To add an icon into an HTML caption: 

1. Position the cursor in the HTML text you want to modify.

2. Click the **Font icons** button ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Gestion_des_polices_icones%20-%20HC%20N%B0001%201.gif). 

3. The following window appears. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Gestion_des_polices_icones%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="characteristics_rich_text_area_control_ELTTEXTE000295"></a>
...
- On a Static Text control found in a Rich Text Area control, you can define an anchor via the Static Text control description window ("General" tab, "Define as anchor"). 
...
[Handling a Rich Text Area control through programming](../WDChamp/1000032004.md)

[Rich Text Area control properties](../WDChamp/1000032003.md)

[Rich Text Area control events](../WDChamp/1000032002.md)
