...
- Use Active WEBDEV Pages in your WEBDEV websites. 
...
### WEBDEV website in Session mode with Active WEBDEV Pages
<a name="webdev_website_session_mode_with_active_webdev_pages_ELTPARAGRAPHE000053"></a>

A WEBDEV website in Session mode can contain one or more Active WEBDEV Pages. Each one of these pages can be accessed directly and independently (without going through the first page in Session mode in the project).
...
### CAUTION: The AWP mode is reserved for developers who are familiar with WEBDEV.
<a name="caution_the_awp_mode_reserved_for_developers_who_are_familiar_with_webdev_ELTPARAGRAPHE000067"></a>
