...
| Event entry | Run:<br><br>- when "New event" is selected in the context menu of TimeLine control.<br><br>- during the direct input of a new event via the keyboard.<br><br><br>This event is run immediately after the "Before creating the event" event. |
