...
- [Testing a window with parameters.](#NOTE4)
...
### Parameter passing: general case
<a name="parameter_passing_general_case_ELTPARAGRAPHE000038"></a>
...
1. Declare a procedure in the "Global declarations" event of the window. The name of this procedure is the same as the window name. The parameters of this procedure correspond to the parameters that must be passed to the window.
	**Warning**: The procedure declaration (PROCEDURE keyword) must correspond to the first line of the "Global declarations" event..
...
2. This variable is passed as a parameter to WIN_Calendar. The parameter *sDateSel* parameter contains the value of the *MyDate*.

3. The value of the *sDateSel* parameter is modified in the FEN_Calendar window (for example: sDateSel = "20020701").
...
Note: Named parameters can be used, for example, to change the order of expected parameters. For example, you can write: 
```wl
...
1. Use [ReturnedValue](../Proprietes/2510134.md) in the processes that call [Close](../WDLang1/3038018.md).
	...
	You can also use the [ReturnedValue](../Proprietes/2510134.md) property in the "Close" event of the window:
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Special case: Value returned by a child window in a WINDEV Mobile application**
...
1. Open the parameterized window in the window editor: in the "Home" pane, in the "General" group, click on "Open".

2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_Go_Fenetre_WD_bl.gif) in the quick access buttons (or press F9). The following window is displayed:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fen%EAtre_param%E9tr%E9e%20-%20HC%20N%B0001.gif)
...
[Open (Function)](../WDChamp/3038035.md)

[OpenChild (Function)](../WDChamp/3038021.md)

[OpenSibling (Function)](../WDChamp/3038045.md)

[OpenMobileWindow (Function)](../WDChamp/1000021018.md)

[OpenPopup (Function)](../WDChamp/3038046.md)

[OpenPopupPosition (Function)](../WDChamp/3038047.md)

[ChangeSourceWindow (Function)](../WDChamp/3038053.md)

[IWListAdd (Function)](../WDChamp/1000020558.md)

[IWListInsert (Function)](../WDChamp/1000020945.md)

[PanelCreate (Function)](../WDChamp/1000023989.md)
