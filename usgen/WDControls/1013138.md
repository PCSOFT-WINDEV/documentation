...
<a name="properties_the_windows_ELTTEXTE000137"></a>
...
<a name="properties_the_image_controls_the_windows_ELTPARAGRAPHE000020"></a>The following properties are associated with Image controls:
...
| [XImage](../Proprietes/2510139.md) | The **XImage** property gets and sets the initial X-coordinate of the image section that will be displayed in an Image control or in the background of a Chart control. |
...
| [YImage](../Proprietes/2510046.md) | The **YImage** property gets and sets the initial Y-coordinate of the image section that will be displayed in an Image control or in the background of a Chart control. |
...
<a name="properties_the_pages_ELTTEXTE000961"></a>
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties of Image controls in pages (Server code)
<a name="properties_image_controls_pages_server_code_ELTPARAGRAPHE000033"></a>The following properties are associated with Image controls:
...
<a name="properties_image_controls_pages_browser_code_ELTPARAGRAPHE000043"></a>

The following properties are associated with Image controls:
...
<a name="properties_image_controls_php_pages_ELTPARAGRAPHE000054"></a>
...
<a name="properties_reports_ELTTEXTE002013"></a>
The following properties can be used with Image controls:
