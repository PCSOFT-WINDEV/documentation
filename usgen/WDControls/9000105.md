...
5. Save the report template (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Enregistrer.gif) or Ctrl + S). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modeles%20d'etats%20-%20HC%20N%B0001.gif&type=thumb)
...
- in the status with [mechanism for "control override"](../WDChamp/9000106.md): the modification will be effective for the status only. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Modeles%20d'etats%20-%20HC%20N%B0002.gif&type=thumb)
...
1. List the models associated with the report: under the "Modification" pane, in the "Templates and skin template" group, pull down "Templates" and select "List of models used".
...
- from the template: in the "Modification" pane, in the "Templates and skin template" group, scroll down to "Templates" and select "Update associated reports".
...
2. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Ico_Go_Fenetre_WD_bl.gif).
...
[Report templates and inheritance](../WDChamp/9000106.md)
