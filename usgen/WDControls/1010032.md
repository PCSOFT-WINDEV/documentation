...
This allows you to create outstanding interfaces.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fenetredetouree.gif)
...
2. In the description of the window:
	...
	- specify the transparency options corresponding to the background image used (use magenta as transparency color for example).
			**Note**: You can also configure window transparency options. For more details, see [Translucent effect of windows](../Editeurs/9500103.md).
...
The image that defines the shape of the window is created via a drawing or image editing tool. The various zones making up the shape of the window must be connected: there must be no "holes".. 
...
**Caution**: Borders must be as clean as possible (no gradients, ...) to avoid display effects when previewing or opening the cropped window.. Indeed, a single color is used to define the transparency for the entire image.
...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=bon-detoure1.gif)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=bon-detoure.gif)<br> |
| <br><br><br>- An image whose borders are smoothed will produce a window that will not be perfectly clipped:<br><br><br> |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=mauvais-detoure1.gif)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=mauvais-detoure.gif)<br> |
