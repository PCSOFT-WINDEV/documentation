...
During the test of a report ("Go" button from the report editor), several print options are proposed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GO_Etat_choix.gif)
