...
<a name="overview_the_html_editor_control_ELTTEXTE000259"></a>
...
![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Mac Catalyst](https://doc.pcsoft.fr/ext/images/us/CATALYST.png) The HTML Editor control is only available from iOS 13 onwards. 
...
<a name="creating_html_editor_control_ELTTEXTE000283"></a>
...
<a name="html_editor_control_features_ELTTEXTE000311"></a>
...
- When using the ribbon, the option "Apply project skin template to ribbon" makes it possible to automatically use the project theme on the selected ribbon. 

- **Adapt control to write emails** If this option is checked, the HTML Editor field is adapted to email input. 
...
- **Enable HTML source code editing** If this option is checked, the Ribbon control will display a "View" pane, allowing you to view and modify the HTML source code. 
...
<a name="location_images_inserted_into_the_html_editor_control_ELTPARAGRAPHE000138"></a>
...
- If the image is inserted using the "Image" button in the "Insert" tab of the ribbon, there are two possible cases: 
	...
	- The "Embed image in page" option is unchecked: the HTML code generated memorizes the image name and will be in the form:
...
### Character encoding
<a name="character_encoding_ELTPARAGRAPHE000190"></a>
...
If the HTML code in the control is retrieved with [HTMLEditorGet](../WDLang1/1000025981.md) and then exchanged with a third-party application (by inserting data in a database, calling a SOAP web service or a REST API, etc.), you can do one of the following: 
...
[HTML Editor control properties](../WDChamp/1410087154.md)

[HTML Editor control events](../WDChamp/1410087152.md)
