...
In the following example, there are 4 input areas (Edit controls) inside a Looper control.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Flexbox_Exemple2%20-%20HC%20N%B0005.gif&type=thumb)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Flexbox_Exemple2%20-%20HC%20N%B0004.gif&type=thumb)
...
1. Create a Flexbox control. This Flexbox control should be inside a row of the Looper control and contain the different Edit controls. In our example, there are 4 Edit controls. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Flexbox_Exemple2%20-%20HC%20N%B0001.gif&type=thumb)
...
2. The different controls are listed in the "General" tab of the Flexbox control description. To get the desired resize behavior, simply specify a flex-grow value for the third and fourth controls. In this case, there are four Edit controls. The following options must be modified: 
	...
	- set the flex-grow value of the third Edit control to 20. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Flexbox_Exemple2%20-%20HC%20N%B0003.gif&type=thumb)
