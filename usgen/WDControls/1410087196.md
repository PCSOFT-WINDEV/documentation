...
3. In the "Use" area, select "5-state image". A window is displayed to select the desired image for the cursor border. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Interrupteur_bascule_style%20-%20HC%20N%B0001.gif&type=thumb)
...
For example, you can use the option "Caption of internal modes" to modify color of inactive captions (caption #B for the "OFF" value and caption #A for the "ON" value). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Interrupteur_bascule_style%20-%20HC%20N%B0002.gif&type=thumb)
