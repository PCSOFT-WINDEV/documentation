...
The different operating modes are: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Caract_ZR_WB_Zoninig%20-%20HC%20N%B0001.gif)
...
- If the number of rows in a new Looper control based on a table is greater than the maximum number specified, a pager is automatically associated with the control. The pager makes it possible to view all the records in the Looper control.
...
- **In Zoning mode**: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Caract_ZR_WB_Zoninig%20-%20HC%20N%B0002.gif)
...
- **In Responsive Web Design mode**: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Caract_ZR_WB_RWD%20-%20HC%20N%B0001.gif)
...
- ***Fixed width of columns***. 
			The number of columns depends on the page width. The number of columns increases or decreases when the user changes the page width.
			The minimum number of columns must be specified. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Caract_ZR_WB_RWD%20-%20HC%20N%B0002.gif) icon indicates that this value is specific to each slice. Therefore, this value must be modified for each slice in the page. 
			Click the icon to directly define the values for each slice in the following window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Caract_ZR_WB_RWD%20-%20HC%20N%B0004.gif)
...
If the Looper control shows the data as a gallery in rows, you can define several options: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Caract_ZR_WB_Zoninig%20-%20HC%20N%B0003.gif)
...
If the Looper control shows the data as a gallery in columns, you can define several options: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Caract_ZR_WB_Zoninig%20-%20HC%20N%B0004.gif)
