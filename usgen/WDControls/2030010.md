...
The home page is the first page of your WEBDEV website (static or in session mode). This page is always a static page.
...
**Remark**: A home page is also proposed when testing a static project, if no home page has been defined.. For more details, see [Testing a project](../Editeurs/2019003.md).
<a name="NOTE2b_2"></a>
...
3. The corresponding HTML page is automatically generated and the home page is defined. The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_accueil.gif) icon is used to identify the home page in the "Project explorer" pane.

<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=page_Accueil_TV.gif)
...
When installing a WEBDEV website, this page will be used as the first page of the site. The address for starting the site will have to start this page.
...
[SEO of a WEBDEV website](../WDChamp/2030037.md)
