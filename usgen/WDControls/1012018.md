...
- Dynamic information coming from tables, queries, etc. This information changes according to the requests made by the Web users.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RepPageDynStat.gif)
...
- Style" tab**Style**"This allows you to define:
	...
	- the characteristics of the theme associated with the page. For more details, see [Management of themes](../Editeurs/2016020.md). 
