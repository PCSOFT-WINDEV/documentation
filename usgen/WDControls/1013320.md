...
**Note** If the field is associated with an item in a data file, the value entered is automatically retrieved using the [ScreenToFile](../WDLang4/1000021385.md) function. For more details, see [Linking a Check Box control to an item](../WDChamp/1013152.md).
<a name="NOTE3_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) 

### In WEBDEV
<a name="webdev_ELTPARAGRAPHE000275"></a>
...
<a name="modifying_the_colors_check_box_control_row_row_ELTTEXTE000305"></a>
...
<a name="modifying_the_caption_characteristics_ELTTEXTE000347"></a>
...
<a name="properties_specific_check_box_controls_ELTTEXTE000420"></a>
