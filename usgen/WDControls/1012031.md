...
1. Display the page description window: under the "Page" pane, in the "Description" group, click on "Description" (or select the "Description" option from the page context menu).

2. On the "Style" tab, in the "Style" area, select the "Page border/background" element. 
...
4. To define the background image of the page: 

	- Select the image that will be used as page background (via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button of the "Background image" control): 
...
2. On the "Style" tab, in the "Style" area, select the "Browser background" element. 

3. Specify (if necessary) the background color of the browser. 

4. Specify the characteristics of the background image: 

	- Select the image that will be used as browser background (via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button of the "Background image" control): 
