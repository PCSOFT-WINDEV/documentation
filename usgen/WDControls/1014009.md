...
For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=BulleAideChamp.gif)
...
For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=InfoChampBarreMessage2.gif)
