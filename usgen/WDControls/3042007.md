...
- Pie chart: this type of chart represents a circle divided into sectors.

- Pie chart: this type of chart represents a circle divided into sectors with a hole in the center.

- Semi-circular chart: this type of chart represents a semicircle divided into sectors.
...
<a name="characteristics_pie_donut_semicircular_chart_ELTTEXTE000209"></a><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Gencam.gif&type=thumb)
In this chart:
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png) For a Donut chart, you also have the ability to specify the size of the hole.
...
- the value corresponding to the sector: "Show values" option in the "Detail" tab of the Chart control description window.
...
**8. Gradient colors**. 
You can define the appearance of the chart in the "Details" tab of the description window.
