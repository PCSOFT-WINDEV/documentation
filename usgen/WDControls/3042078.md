...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Graphe%20Mire.jpg)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Graphe%20Mire%20multiple.jpg)
...
2. In the "Details" tab: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) in the "Zoom and crosshair" area, check "Enable chart crosshair". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Mire_Graphe_Editeur.gif)
The "Multiple crosshair (stacked lines and columns)" option allows using multiple crosshairs in Line or Column charts. 

	- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) in the "Interactivity" area, check (if necessary) "Interactive chart" then check "Enable the chart crosshair". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Mire_Graphe_EditeurWB.gif)
