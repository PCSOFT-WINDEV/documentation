...
All you have to do is right-click the search icon to open the context menu of column: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Table_menuTriColonne.gif)
...
- to remember filters ("Remember filters").
	If this option is enabled, filters set when the window is closed will be automatically executed the next time the window is opened.. A short message will be displayed to inform the user and to indicate the filters that are set. 
