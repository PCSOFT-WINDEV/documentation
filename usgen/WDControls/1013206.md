...
WINDEV allows you to easily manipulate the OLE controls via specific functions of WLanguage. For more details, see [OLE functions of WLanguage](../WDLang3/3057007.md).
