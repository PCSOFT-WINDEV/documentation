...
You can manipulate Scheduler controls using the following WLanguage properties: 
...
<a name="properties_available_window_ELTTEXTE000153"></a>
...
### Properties available in a window
<a name="properties_available_window_ELTPARAGRAPHE000035"></a>The following properties are associated with Scheduler controls:
...
| [AppointmentContinuous](../Proprietes/1000022469.md) | The **AppointmentContinuous** property is used to determine or change how multiple-day appointments are displayed in a Scheduler control. |
...
| [DayBreakHeight](../Proprietes/1000020105.md) | The **DayBreakHeight** property gets and sets the height of breaks between days in a Scheduler control where days are arranged in rows, and resources are arranged in columns. |
| [DayHeight](../Proprietes/1000020106.md) | The **DayHeight** property gets and sets the height of days in a Scheduler control where days are arranged in rows, and resources are arranged in columns. |
...
| [Resource](../Proprietes/1000019308.md) | The **Resource** property is used to: <br><br>- get the resources displayed in a Scheduler control. <br><br>- get the Scheduler control resource for the specified index. <br><br><br> |
| [ResourceHeight](../Proprietes/1000020109.md) | The **ResourceHeight** property gets and sets the height of resources in a Scheduler control where resources are arranged in rows. |
| [ResourceWidth](../Proprietes/1000020110.md) | The **ResourceWidth** property gets and sets the width of resources in a Scheduler control where resources are arranged in columns. |
...
<a name="properties_available_page_ELTTEXTE001210"></a>
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in a page (Server code)
<a name="properties_available_page_server_code_ELTPARAGRAPHE000047"></a>The following properties are associated with Scheduler controls:
...
| [FontUnderlined](../Proprietes/2510099.md) | The **FontUnderlined** property is used to:<br><br>- Determine if the text is underlined.<br><br>- Underline (or not) a text.<br><br><br> |
| [FullName](../Proprietes/2514005.md) | The **FullName** property is used to find out the full name:<br><br>- of a control.<br><br>- of a window.<br><br>- of a menu option.<br><br>- of a table column.<br><br><br><br><br> |
| [GranularityAppointment](../Proprietes/1000019100.md) | The **GranularityAppointment** gets and changes the precision of the grid used to define appointments in Organizer or Scheduler controls. <br>Property retained by compatibility. |
| [GranularityDuration](../Proprietes/1000019643.md) | The **GranularityDuration** property gets and sets the size of the grid to resize:<br><br>- appointments in an Organizer control. <br><br>- appointments in a Scheduler control.<br><br>- events in a TimeLine control.<br><br>- tasks in a Gantt Chart column.<br><br><br> |
| [GranularityMovement](../Proprietes/1000019642.md) | The **GranularityMovement** property gets and sets the size of the grid to move:  <br><br>- appointments in an Organizer control. <br><br>- appointments in a Scheduler control.<br><br>- events in a TimeLine control.<br><br>- tasks in a Gantt Chart column.<br><br><br> |
| [Grayed](../Proprietes/1000019648.md) | The **Grayed** property is used to: <br><br>- Determine if a control (or a group of controls) is grayed out. <br><br>- Gray out or ungray a control, a group of controls or a window.<br><br><br> |
| [Group](../Proprietes/2510049.md) | The **Group** property is used to: <br><br>- find out whether the control belongs to a group of controls. If the control belongs to one or more groups, the **Group** property can be used to identify these groups of controls.<br><br>- associate a control with a group of controls. <br><br><br> |
...
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000057"></a>The following properties are associated with Scheduler controls:
...
<a name="properties_available_php_ELTPARAGRAPHE000067"></a>The following properties are associated with Scheduler controls:
...
<a name="properties_available_report_ELTTEXTE002538"></a>


### Properties available in a report
<a name="properties_available_report_ELTPARAGRAPHE000079"></a>The following properties are associated with Scheduler controls:
...
[Linking a Scheduler control to a table or variable](../WDChamp/1000019543.md)
