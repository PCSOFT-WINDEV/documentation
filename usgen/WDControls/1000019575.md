...
**Remark**: WINDEV also supports the use of DotNet fields in WPF format.. For more details, see [.Net control (WPF)](../WDChamp/1017001.md). 
...
2. On the "General" tab, select the assembly used and the associated class. The "Add some .Net assemblies into the project" button allows you to integrate the necessary assemblies. You can use: 
...
Then, the control can be handled programmatically. For more details, see [Programming a ".NET 2.0 control (WinForm)"](../WDChamp/1000019579.md).
