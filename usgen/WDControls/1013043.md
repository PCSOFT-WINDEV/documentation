...
1. On the "Creation" tab, in the "Usual controls" group, expand "Text" and select "Formatted display control".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Libelle_wb%20-%20HC%20N%B0001.gif)
...
<a name="tip_display_sites_update_date_ELTPARAGRAPHE000108"></a>
...
[Manipulating formatted display controls programmatically](../WDChamp/1013042.md)

[Properties associated with formatted display controls](../WDChamp/1013030.md)

[Events associated with formatted display controls](../WDChamp/1013055.md)
