...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [linked to a table](../WDChamp/1000019543.md).

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) [bound to a variable](../WDChamp/1000019543.md).




To manipulate a Scheduler control through programming, WINDEV and WEBDEV propose the [SchedulerXXX functions](../WDLang1/1000022917.md). 
...
<a name="manipulating_scheduler_controls_programmatically_ELTTEXTE000177"></a>


### Adding a resource
<a name="adding_resource_ELTPARAGRAPHE000200"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) Note: Use [&lt;Scheduler&gt;.AddResource](../WDLang1/1000022905.md) to insert an image in the resource title.


### Adding an appointment
<a name="adding_appointment_ELTPARAGRAPHE000236"></a>
...
### Populating a Scheduler control with the data from an HFSQL table
<a name="populating_scheduler_control_with_the_data_from_hfsql_table_ELTPARAGRAPHE000281"></a>

The records are stored in an HFSQL table. The initial fill of the Scheduler control can be done by browsing the table via the FOR EACH syntax and by adding each appointment via [&lt;Scheduler&gt;.AddAppointment](../WDLang1/1000022904.md).
...
<a name="retrieving_list_appointments_ELTPARAGRAPHE000302"></a>

[&lt;Scheduler&gt;.ListAppointment](../WDLang1/1000022909.md) is used to retrieve: 
...
<a name="displaying_the_schedule_from_specific_resource_from_specific_date_ELTPARAGRAPHE000349"></a>
...
<a name="deleting_appointment_ELTPARAGRAPHE000390"></a>
...
### Deleting a resource
<a name="deleting_resource_ELTPARAGRAPHE000414"></a>

[&lt;Scheduler&gt;.DeleteResource](../WDLang1/1000022913.md) is used to delete a resource from the Scheduler control.
...
<a name="modifying_the_control_display_options_ELTPARAGRAPHE000440"></a>

The current display of a Scheduler control can be modified via the following functions: 

- [&lt;Scheduler&gt;.DisplayPreviousPeriod](../WDLang1/1000022901.md) and [&lt;Scheduler&gt;.DisplayNextPeriod](../WDLang1/1000022902.md): These two functions modify the display period (identical to the use of the spin button at the top of the Scheduler control). 

- [&lt;Scheduler&gt;.ChangeMode](../WDLang1/1000022906.md): Use this function to change the field display mode: day, week, month.  
...
<a name="handling_appointment_programmatically_ELTTEXTE000466"></a>
...
To manipulate an appointment, use the **&lt;-** operator to associate the appointment found in the Scheduler control with the [Appointment](../WDLang1/1000019244.md) variable. A modification performed on the variable will be automatically applied to the control. 
...
<a name="using_the_context_menu_aaf_ELTTEXTE000519"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) The Scheduler control is associated with a context menu (AAF). The context menu of the Scheduler control is used to: 
...
**Example**: To store an appointment added by the user via the context menu in an APT table, simply write the following in the "Enter input mode in an appointment" event:
...
<a name="advanced_use_events_associated_with_the_scheduler_control_ELTTEXTE000565"></a>


### Advanced use of events with procedures
<a name="advanced_use_events_with_procedures_ELTPARAGRAPHE000588"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) This principle can be applied to all the events called by the context menu of the Scheduler control. Example: Opening an appointment entry window.  
...
<a name="properties_specific_scheduler_controls_ELTTEXTE000647"></a>
...
For a complete list of WLanguage properties that can be used with Scheduler controls, see [Scheduler control properties](../WDChamp/1000019502.md).
