...
Cell controls can be manipulated using different WLanguage properties: 

- in a window.

- in a page in Server, Browser or PHP code.
...
<a name="static_text_control_properties_window_ELTTEXTE000126"></a>
...
<a name="properties_available_window_ELTPARAGRAPHE000024"></a>The following properties can be used with Cell controls:
...
<a name="properties_available_page_ELTTEXTE000714"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in a page (Server code)
<a name="properties_available_page_server_code_ELTPARAGRAPHE000036"></a>The following properties are associated with Cell controls:
...
<a name="properties_available_page_browser_code_ELTPARAGRAPHE000044"></a>The following WLanguage properties are associated with the Cell controls:
...
<a name="properties_available_php_page_ELTPARAGRAPHE000052"></a>The following WLanguage properties are associated with the Cell controls:
