...
- Method 1: Position the field on the desired tab pane. The control is automatically associated with the current tab.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) A control can be associated with several tabs. Simply use the second method and select all the desired tabs. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=NV_Affecter_onglet.gif)
...
<a name="not_associating_control_with_tab_ELTTEXTE000148"></a>
...
[Pane (Property)](../WDChamp/1000021098.md)

[ControlTab (Function)](../WDChamp/3025028.md)
