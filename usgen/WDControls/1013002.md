...
## Static Text control properties
<a name="static_text_control_properties_ELTTEXTE000122"></a>
Static Text controls in a window, page or report can be manipulated using the WLanguage following properties:

- [Static Text control properties in a window](#NOTE2_1).

- [Static Text control properties in a page (Server code, Browser code and PHP)](#NOTE3_1).

- [Static Text control properties in a report](#NOTE4_1).
...
## Static Text control properties in a window
<a name="static_text_control_properties_window_ELTTEXTE000146"></a>
...
### Static Text control properties in a window
<a name="static_text_control_properties_window_ELTPARAGRAPHE000030"></a>The following properties can be used with Static Text controls:
...
| [FontMinSize](../Proprietes/1000024918.md) | The **FontMinSize** property gets and sets the minimum size of the font used in a Static Text control with the "Reduce font" option. |
...
## Static Text control properties in a page
<a name="static_text_control_properties_page_ELTTEXTE001045"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Static Text control properties in a page (Server code)
<a name="static_text_control_properties_page_server_code_ELTPARAGRAPHE000043"></a>The following properties can be used with Static Text controls:
...
### Static Text control properties in a page (Browser code)
<a name="static_text_control_properties_page_browser_code_ELTPARAGRAPHE000051"></a>The following properties can be used with Static Text controls:
...
### Static Text control properties in PHP
<a name="static_text_control_properties_php_ELTPARAGRAPHE000060"></a>The following properties can be used with Static Text controls:
...
## Static Text control properties in a report
<a name="static_text_control_properties_report_ELTTEXTE002180"></a>
...
### Properties that can be used with a Static Text control in a report
<a name="properties_that_can_used_with_static_text_control_report_ELTPARAGRAPHE000072"></a>The following properties can be used with "Static Text" controls in a report:
...
| [RichEdit](../Proprietes/2510108.md) | The **RichEdit** property is used to manage the RTF (Rich Text Format) type: <br><br>- of an edit control or Static Text control found in a window.<br><br>- of a Static Text control found in a report. <br><br><br> |
| [RightToLeft](../Proprietes/1000017228.md) | The **RightToLeft** property is used to get the writing direction on a control, column, window or report. |
| [RTFWithImagesAndTables](../Proprietes/1000022170.md) | The **RTFWithImagesAndTables** property is used to manage images and tables in RTF Static Text controls in a report. |
