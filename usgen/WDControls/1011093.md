...
[**Reports & Queries**](../Presentation/3088004.md) cannot be used to create reports based on a Looper control. However, it is possible to customize states on a RepeatString Looper control created in the built-in state editor (color, font, size, etc.).
...
<a name="characteristics_report_based_looper_control_ELTTEXTE000422"></a>
...
<a name="creating_report_based_looper_control_from_the_window_editor_ELTTEXTE000446"></a>
...
**Remark**: The window editor can only be used to create an array report.. To create another type of report, use the [report editor](../Editeurs/2029004.md).
<a name="NOTE3_2"></a>
...
<a name="creating_report_based_looper_control_from_the_report_editor_ELTTEXTE000482"></a>
...
6. ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) To print:
	...
	- only user-selected lines: select "Only lines selected in the field"..
			**Remark**: This choice can be modified by programming using property [SelectionOnly](../Proprietes/2511017.md).
...
<a name="printing_report_based_looper_control_ELTTEXTE000512"></a>
...
### WEBDEV example
<a name="webdev_example_ELTPARAGRAPHE000334"></a>
