...
<a name="characteristics_line_charts_ELTTEXTE000202"></a><br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Genligne.gif&type=thumb)
In this chart:
...
- a scale of X-coordinates according to the time. This option operates with Date or DateTime data coming from a Table control or from an HFSQL item. This option cannot be used with a series populated programmatically. 
...
### Other features
<a name="other_features_ELTPARAGRAPHE000101"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The "Line" charts can be displayed with an animation. To animate this type of chart, simply check "Enable animations" in the "Details" tab of the control description.

![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The "Line" charts can be displayed in real time. For more details, see [Real-time chart](../WDChamp/1000021037.md).
