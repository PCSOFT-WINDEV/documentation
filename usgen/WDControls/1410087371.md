...
The following properties are associated with AI Chat controls:
...
| [AICaption](../Proprietes/1410086760.md) | The **AICaption** property gets and sets the label that identifies the AI model's response in the AI Chat control. |
...
| [AIImage](../Proprietes/1410086759.md) | The **AIImage** property gets and sets the image associated with a response in an AI Chat control. |
...
| [AISystemPrompt](../Proprietes/1410086763.md) | The **AISystempPrompt** property gets and sets the first text sent by the AI Chat control to the AI model to define its role and instructions. |
