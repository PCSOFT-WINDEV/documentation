...
2. Go to the "Details" tab and select a value for "Required input": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie_obligatoire_WD%20-%20HC%20N%B0001.gif)
...
This function is used to check whether all required input controls in the current window have been filled in. Depending on the options set via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Trad_param.gif) button, the controls that do not match the requirements are highlighted.
...
The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Trad_param.gif) button next to the "Required input" option allows you to define the visual changes of the control. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie_obligatoire_WD%20-%20HC%20N%B0003.gif&type=thumb)
...
- **Modify control style**: This option changes the style of the control. The style used for the indication and for the error can be set in the "Style" tab of the control. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie_obligatoire_WD%20-%20HC%20N%B0005.gif&type=thumb)


- **Display required input icon (hint)**: This option displays a specific icon in the control. The icon used and its position relative to the input area are set in the "Style" tab of the control ("Required input (indication/error): Explanation & icon", "Icon" button. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie_obligatoire_WD%20-%20HC%20N%B0006.gif&type=thumb)
...
4. In the "Details" tab, select a value for "Invalid input": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie_obligatoire_WD%20-%20HC%20N%B0002.gif)
...
The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Trad_param.gif) button next to the "Invalid input" option allows you to define the visual changes of the control. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie_obligatoire_WD%20-%20HC%20N%B0004.gif&type=thumb)


If the input is invalid, you have various options: 

- Modify control style: This option changes the style of the control. The style used for the different elements of the invalid input can be defined in the "Style" tab of the control. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie_obligatoire_WD%20-%20HC%20N%B0005.gif&type=thumb)
