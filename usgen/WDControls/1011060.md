...
2. A report group is created programmatically. This report group contains the different versions of the report. 

3. One of the reports from the report group is displayed in the report viewer. The user can select via a combo box the configuration of the report to print.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Groupe_etat%20-%20HC%20N%B0001.gif)
...
For example, you can use report groups to display: 

- statistical reports by year: the same report is displayed several times. Only the parameter specifying the year is modified. The user can directly display the reports for the different years from the report viewer. 
...
[iGroupAdd (Function)](../WDChamp/1000020580.md)

[iGroupPrint (Function)](../WDChamp/1000020582.md)

[iGroupConfigure (Function)](../WDChamp/1000020581.md)
