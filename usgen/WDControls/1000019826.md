...
WINDEV includes [Organization Chart functions](../WDLang1/1000019986.md) to programmatically manipulate Organization Chart controls. 
...
<a name="manipulating_organization_chart_controls_programmatically_ELTTEXTE000115"></a>
...
- syntax for specifying element characteristics: title, image, etc, ...
	...
	**Note** The [&lt;Organization Chart&gt;.Add](../WDLang1/1000019975.md) function inserts an image into the element (to the left of the text).
...
- syntax that handles a variable of type [OrgElement](../WDLang1/1000019713.md).
	...
	**Note** Using the [OrgElement](../WDLang1/1000019713.md) type allows you to configure many specific options: 
...
<a name="manipulating_element_organization_chart_control_ELTTEXTE000259"></a>
...
For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Orga_Horizontal.gif)
 <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Orga_Horizontal2.gif)
...
For a complete list of WLanguage properties that can be used with Organization Chart controls, see [Organization Chart control properties](../WDChamp/1000019791.md).
