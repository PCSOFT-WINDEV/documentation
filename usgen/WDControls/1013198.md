...
<a name="initializing_listview_control_ELTTEXTE000369"></a>
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) The [LoadImageProcedureList](../WDLang1/1410090789.md) function can be used to define a WLanguage procedure to be called when displaying the lines in the list. This procedure allows you to use dynamic images (not necessarily stored on disk).  
...
<a name="selecting_element_listview_control_ELTTEXTE000399"></a>


### Selecting an element at row &lt;Index&gt;
<a name="selecting_element_row_ELTPARAGRAPHE000082"></a>
...
<a name="setting_the_position_the_last_element_the_listview_control_ELTPARAGRAPHE000106"></a>

To position on the last element of a ListView control, use: 

- [Count](../WDLang1/3025009.md): 
...
<a name="retrieve_item_selected_list_box_control_ELTTEXTE000429"></a>


### Retrieving the index of the selected element
<a name="retrieving_the_index_the_selected_element_ELTPARAGRAPHE000147"></a>
...
<a name="NOTE4_1a"></a>
**Remark**: For multi-selection ListView controls, the [ListSelect](../WDLang1/3049011.md) function retrieves the selected items..
...
<a name="getting_the_value_the_selected_element_ELTPARAGRAPHE000187"></a>
...
- Syntax 3: Property [DisplayedValue](../Proprietes/2510129.md)
	
	```txt
	<Variable> = <ListView control>.DisplayedValue
	```

	**Warning** The value stored during programming may differ from the value displayed. To get the stored value corresponding to one of the rows in the ListView control, use the [StoredValue](../Proprietes/2510127.md) property.
...
<a name="properties_specific_listview_controls_ELTTEXTE000465"></a>
...
| [Memory](../Proprietes/2510076.md) | Indicates if the specified ListView control is populated programmatically or is based on a table. |
...
| [FillType](../Proprietes/1000017723.md) | Indicates how a ListView control is populated (programmatically, from a table or from a variable). |
...
| **ListView control based on a table only** |
| [BrowsedFile](../Proprietes/2510040.md) | Gets and sets the table or query used to display records in ListView controls. |
...
For a complete list of WLanguage properties that can be used with ListView controls, see [ListView control properties](../WDChamp/1013219.md). 
