...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Layout control properties**
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Properties available for the cells of Layout controls**

The following properties are associated with the cells of Layout controls:
...
<a name="properties_available_page_ELTTEXTE000977"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties that can be used in a page (Server code)
<a name="properties_that_can_used_page_server_code_ELTPARAGRAPHE000045"></a>

- The following properties can be used with Layout controls:
...
- The following properties can be used with cells of Layout controls:
...
<a name="properties_that_can_used_php_ELTPARAGRAPHE000072"></a>
