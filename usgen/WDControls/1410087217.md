...
2. The Context Menu control appears in the editor. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0001.gif)
...
<a name="characteristics_context_menu_controls_ELTTEXTE000328"></a>
...
The main characteristics are as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0002.gif)


- Menu orientation ("General" tab): The options are as follows: 

	- **Vertical Popup** (default): The sub-menu of a context menu option is displayed to the right of the parent option.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0003.gif)


	- **Vertical Déroulant**: The sub-menu of a context menu option is displayed below the parent option.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0004.gif)

- **Option selected** ("General" tab): Default context menu option selected. 
	Note: The default option can be changed by programming with property [Selected](../Proprietes/2510112.md).
...
3. The "Context menu" combo box allows you to configure the context menu:
	...
	- the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Fleche.gif) button is used to create a new context menu. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0006.gif)


	- you can select the desired context menu in the combo box. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ_menu_contextuel_WB%20-%20HC%20N%B0005.gif)
...
- To edit the selected context menu, click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Fleche.gif) button to the right of "Context menu" combo box and select "Edit this context menu".
...
- from the "UI" tab of the description of a page or control associated with this context menu:
	...
	- Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_Fleche.gif) button to the right of the "Context menu" combo box and select "Edit this context menu".
...
Notes: For details of how to change context menu options, see [Handling menu options in the editor](../WDChamp/1010042.md).
...
[Manipulating Context Menu controls programmatically](../WDChamp/1410087243.md)

[Context Menu control properties](../WDChamp/1410087223.md)

[Context Menu control events](../WDChamp/1410087219.md)

[Manipulating WEBDEV menu options](../WDChamp/1010042.md)

[Menu option: operation performed and action](../WDChamp/1010044.md)

[Programming a WEBDEV drop-down menu](../WDChamp/1010043.md)
