...
For example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GFI_WebDEv.gif)
...
<a name="NOTE2_2"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) 
...
1. Create a popup in the page that should display the dialog: under the "Creation" pane, in the "Containers" group, click on "Popup".. This popup will be used to communicate with the user. This popup must contain:
...
<a name="NOTE2_3"></a>
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png) 
...
2. The cell (as well as its controls) is invisible. It must also be superimposable.
	...
	**Remark**: To avoid displaying unnecessary scrollbars in the browser, check the "Force position at the top left of the page when loading" option ("Advanced" tab in the Cell control description window).. This option is used to automatically position the Cell control at position (0,0) when loading the page.
...
<a name="managing_dialog_via_pages_ELTPARAGRAPHE000150"></a>
...
<a name="managing_dialog_via_yesno_and_okcancel_ELTPARAGRAPHE000183"></a>
...
To manage a dialog with the [YesNo](../WDLang1/3021005.md) and [OKCancel](../WDLang1/3021004.md) functions:
...
[Dim disabled windows](../WDChamp/9000071.md)
