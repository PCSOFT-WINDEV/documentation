...
<DIV class="specObsolete">
	...
	From version <B>20</B>, this feature is kept for backward compatibility. It is only available for pages created with previous versions and that already contain a positioning table. 
</DIV><a name="NOTE1"></a>
<a name="NOTE1_1"></a>
...
This positioning table is also very useful to create "page footers".<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TablePositionnement.gif)
...
<a name="displaying_hiding_the_positioning_table_ELTPARAGRAPHE000032"></a>
...
### Anchoring a control
<a name="anchoring_control_ELTPARAGRAPHE000054"></a>
...
For example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TableP_Pixels.gif)


To anchor a control (in most cases to the bottom or to the right), specify a percentage for the control coordinates in the positioning table. To do so, perform a right click on the coordinate and select "Sizable". You can now type the requested value (in percentage): <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TableP_Pourcent.gif)
