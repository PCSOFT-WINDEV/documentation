...
The progress is performed from the lower bound to the upper bound. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=JaugeSimple.GIF)
...
The progress is performed as follows:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=JaugeSymetrique_prog.gif)
