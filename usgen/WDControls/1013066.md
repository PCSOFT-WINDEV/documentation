...
The supercontrols found in a window or in page can be handled by the WLanguage properties.
...
<a name="properties_available_window_ELTTEXTE000120"></a>
...
### Properties associated with a supercontrol found in a window
<a name="properties_associated_with_supercontrol_found_window_ELTPARAGRAPHE000020"></a>The following WLanguage properties are associated with a supercontrol:
...
| [UsefulHeight](../Proprietes/1000021504.md) | The **UsefulHeight** property gets and sets the useful height of an internal window (or supercontrol) with scrollbars. |
| [UsefulWidth](../Proprietes/1000021503.md) | The **UsefulWidth** property gets and sets the useful width of an internal window (or supercontrol) with scrollbars. |
...
<a name="properties_available_page_ELTTEXTE000843"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties associated with a supercontrol found in a page (Server code)
<a name="properties_associated_with_supercontrol_found_page_server_code_ELTPARAGRAPHE000030"></a>The following WLanguage properties are associated with a supercontrol:
...
### Properties associated with a supercontrol found in a page (Browser code)
<a name="properties_associated_with_supercontrol_found_page_browser_code_ELTPARAGRAPHE000038"></a>The following WLanguage properties are associated with a supercontrol:
...
### Properties associated with a supercontrol in PHP
<a name="properties_associated_with_supercontrol_php_ELTPARAGRAPHE000046"></a>The following WLanguage properties are associated with a supercontrol:
