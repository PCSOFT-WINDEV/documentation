...
- if the child window is minimized, the entire project is minimized using the icon for the current window (or the icon of the project if the window does not have an icon).
...
If the window is minimized, the entire project is minimized. The icon used is the one of the current window (or the icon of the project if the window has no icon).
