...
**Remark**: To obtain the source code of the Web page displayed in the HTML Display control, simply use the [DisplayedValue](../Proprietes/2510129.md) property on the HTML Display control: 
