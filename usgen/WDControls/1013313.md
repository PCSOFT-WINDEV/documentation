...
- Decoding and taking photos: 
	...
	- If the Camera field is in "Compatible 26" mode: photos and videos cannot be recorded if barcode detection is enabled (function [&lt;Camera&gt;.Capture](../WDLang1/1000022382.md) returns an error in this case). 
	...
	- ![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) If the Camera control is compatible with version 27: 
		...
		- It is not possible to record video when bar code decoding is enabled.
			...
			- If decoding is enabled when [&lt;Camera&gt;.VideoStart](../WDLang1/1410088106.md) is called, it will be stopped and restarted after the recording. 
...
- When the Camera control is configured to allow the decoding of bar codes (in the description window), the decoding automatically starts when the window is opened. 
	To prevent this behavior, you call call [CameraStopDecoding](../WDLang1/1000022449.md) (or [&lt;Camera&gt;.StopDecoding](../WDLang1/1000022474.md)) in the "Initialization" event of the Camera control. Bar code decoding can be restarted with [CameraStartDecoding](../WDLang1/1000022454.md) (or [&lt;Camera&gt;.StartDecoding](../WDLang1/1000022475.md)).
