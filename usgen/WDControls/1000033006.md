...
Note: It is possible to add choices to this menu by programming. To do so, use the [ContextMenu](../Proprietes/2510077.md) property. 
...
3. Choose the desired menu in the "Context menu" combo box. It is possible to: 
	...
	- "Display the AAF menu (System)": In this case, the context menu displayed will be the Spreadsheet control's automation menu.. For more details on how to configure this menu, see [Configuring the AAF menu](../Editeurs/2010040.md).
...
The toolbar allows the end user to perform the most common formatting operations: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Tableur_Barre_outils.gif)
...
The formula bar allows the end user to identify the selected cells and to enter the formula or the value associated with a cell. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Tableur_Barre_Formule.gif)
...
- The different worksheets are displayed at the bottom left of Spreadsheet control. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Tableur_multifeuille.gif)
The "+" button is used to add new worksheets. 

- A context menu allows end users to manage the different worksheets: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Tableur_multifeuilleMenu.gif)
It is possible to: 
