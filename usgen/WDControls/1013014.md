...
<a name="properties_available_window_ELTTEXTE000125"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) 

### Properties that can be used in a window
<a name="properties_that_can_used_window_ELTPARAGRAPHE000020"></a>The following properties can be used with Combo Box controls:
...
| [BrowsedItem](../Proprietes/2510111.md) | The **BrowsedItem** property is used to:<br><br>- Get the item used to automatically loop through table, Looper, List Box, ListView, and Combo Box controls, supercontrols, and reports based on tables.<br><br>- Change the item used to automatically loop through Table, Looper, List Box, ListView and Combo Box controls, supercontrols and reports based on tables. Then, the iteration is reinitialized.<br><br><br> |
...
| [Memory](../Proprietes/2510076.md) | The **Memory** property determines if the specified control is populated programmatically or is based on a table. |
...
<a name="properties_available_page_ELTTEXTE001357"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties that can be used in a page (Server code)
<a name="properties_that_can_used_page_server_code_ELTPARAGRAPHE000033"></a>The following properties can be used with Combo Box controls:
...
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) **Properties that can be used in a page (Browser code)**
The following properties can be used with Combo Box controls:
...
<a name="properties_that_can_used_php_ELTPARAGRAPHE000051"></a>The following properties can be used with Combo Box controls:
