...
- ![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The context menu adapts to the device used. 
	...
	- on iPhone, context menus are displayed at the bottom of the screen: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-iOS-Menu%20Contextuel-iPhone.jpg)


	- on iPad, context menus can be displayed anywhere: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-iOS-Menu%20Contextuel-iPad.jpg)
...
- [Programming a customized context menu](#NOTE6_1).
...
<a name="create_custom_context_menu_ELTPARAGRAPHE000061"></a>

To create a custom context menu:

1. On the "Window" tab, in the "Bars and menus" group, expand "Popup menus" and select "New context menu". The window for editing the new custom context menu is opened.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_contextuel_personnalis%E9%20-%20HC%20N%B0001.gif)
...
3. The "Context menu" combo box allows you to configure the context menu:
	...
	- the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button is used to create a new context menu.
...
- To edit the custom context menu, click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button to the right of "Context menu" and select "Edit this context menu".

- To associate a window or field with an existing custom context menu, use the [ContextMenu](../Proprietes/2510077.md) property.
...
### Special case: Table field context menu
<a name="special_case_table_field_context_menu_ELTPARAGRAPHE000267"></a>
...
- from the "UI" tab in the description of a window or control associated with this context menu:
	...
	- Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button to the right of the "Context menu" combo box and select "Edit this context menu".
...
Notes: For details of how to modify a customized context menu, see [Handling menu options in the editor](../WDChamp/1010008.md).
...
## Programming a customized context menu
<a name="programming_customized_context_menu_ELTTEXTE000630"></a>
...
[System popup menu](../WDChamp/1010023.md)
