...
## Overview
<a name="overview_ELTTEXTE000499"></a>
...
<a name="transforming_page_template_ELTTEXTE000523"></a>
...
<a name="transforming_the_template_page_ELTPARAGRAPHE000074"></a>

To use the "Responsive Web Design" mode on the page template: 

1. Open the project if necessary. 

2. Display the "PAGETPL_Main" template in the editor.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%201%20-%20HC%20N%B0001.gif&type=thumb)


3. Display the page description window: open the context menu (right-click) and select the "Description" option.

4. On the "General" tab, select "Slices (legacy Responsive mode)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%201%20-%20HC%20N%B0002.gif)
...
The editor is transformed: a new banner specific to the "Responsive Web Design" editing mode appears. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20Bandeau%20entete%201%20-%20HC%20N%B0001%201.gif)
...
Remember: a slice represents a browser size for a specific device.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%201%20-%20HC%20N%B0003.gif&type=thumb)
...
<a name="managing_navigation_bar_ELTPARAGRAPHE000110"></a>
...
7. Re-position the Navigation Bar control onto the black bar. You get the following interface: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0001.gif&type=thumb)
...
2. Click in the middle section of navigation bar. This section is hatched. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0002.gif)


3. Click again in the hatched area: the drop-down menu appears. It is automatically displayed in vertical mode. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0003.gif)
...
<a name="layout_tablet_and_mobile_slices_ELTPARAGRAPHE000170"></a>
...
For example, if you select the Mobile slice: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%202%20-%20HC%20N%B0004.gif)
...
<a name="transforming_page_template_inheriting_from_page_template_ELTPARAGRAPHE000210"></a>
...
2. On the "Page" tab, in the "Description" group, expand "Templates" and select "List of templates used". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%203%20-%20HC%20N%B0002.gif)
...
<a name="transforming_page_with_looper_control_ELTTEXTE000571"></a>
We are going to work on the "store" page found in the WW_Precilia_sport example. 
<a name="NOTE3_2"></a>


### Transforming the page
<a name="transforming_the_page_ELTPARAGRAPHE000243"></a>
...
<a name="checking_the_page_layout_for_each_slice_ELTPARAGRAPHE000273"></a>
...
3. On the "Details" tab, under "Display mode settings", select "Number of columns per slice". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%203%20-%20HC%20N%B0004.gif)
...
- Click the icon symbolizing the Responsive Web Design: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%203%20-%20HC%20N%B0004%201.gif)
...
In the "Desktop" (or "Tablet") slice, you get: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0001.gif)


In the "Mobile" slice, you get: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0002.gif&type=thumb)

<a name="NOTE3_4"></a>


### Test in the browser
<a name="test_the_browser_ELTPARAGRAPHE000317"></a>

The test of the final result can be run in a browser: 

- Execution in Desktop mode: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0003.gif)


- Execution in Tablet mode: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0004.gif&type=thumb)


- Execution in Mobile mode: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%204b%20-%20HC%20N%B0005.gif&type=thumb)
...
<a name="transforming_page_with_edit_controls_ELTTEXTE000613"></a>
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%205%20-%20HC%20N%B0001.gif)


**Step 1**: Upgrade the page with the template (so that the page switches to Responsive Web Design mode): under the "Page" pane, in the "Description" group, pull down "Templates" and select the "List of templates used" option.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%205%20-%20HC%20N%B0002.gif)
...
Let's go to the "Mobile" slice and move the controls in order to get the following result: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%205%20-%20HC%20N%B0003.gif&type=thumb)
...
<a name="transforming_page_with_rich_text_area_ELTTEXTE000637"></a>
...
Tip: Don't forget to change the internal margin of the Rich Text Area control so as not to truncate or overlap the fields below it..<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0001.gif&type=thumb)
...
<a name="transforming_page_with_programmed_html_control_ELTTEXTE000661"></a>
...
- Execution in "Desktop" mode: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0002.gif)


- Execution in "Tablet" mode: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0003.gif)


- Execution in "Mobile" mode: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0004.gif)
...
- modify the HTML code of the control because the map drawn has a fixed size (width set to 604, height set to 300): <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RWD%20sur%20page%20existante%206%20-%20HC%20N%B0005.gif)
