...
You can manipulate HTML Display controls in a window using the following WLanguage properties. 
...
<a name="properties_available_window_ELTTEXTE000093"></a>
**Properties available in a window**

The following properties are associated with HTML Display controls:
