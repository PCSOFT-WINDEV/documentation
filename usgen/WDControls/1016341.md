...
WINDEV allows you to manipulate a Range Slider control directly through programming.. To do so, use the variable of the Range Slider control in the code.
...
### Characteristics that can be retrieved programmatically
<a name="characteristics_that_can_retrieved_programmatically_ELTPARAGRAPHE000023"></a>
...
Example: 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=RangeSlider_Bornes.gif)
...
- the upper bound is 40. This upper bound corresponds to the value of the Range Slider control when the box of the Range Slider control is positioned at the maximum extremity. This case corresponds to position 2. This bound corresponds to the following calculation: Minimum bound + (Total range - Visible range). 
...
**Note**: You can also use the [Value](../Proprietes/2510130.md) property to modify the Range Slider control value.

<a name="NOTE4"></a>
<a name="NOTE4_1"></a>


## Properties specific to Range Slider controls
<a name="properties_specific_range_slider_controls_ELTTEXTE000329"></a>
The following properties are specific to programmed Range Slider control.
...
| [Scroll](../Proprietes/1000021574.md) | Used to find out and modify the value of the scroll value for a Range Slider control. |
| [ScrollValue](../Proprietes/2510011.md) | Used to find out and modify the value of the increment step for a Range Slider control. |
| [TotalRange](../Proprietes/1000019066.md) | Allows you to view and modify the total amount of data represented by the Range Slider control. |
...
For a complete list of WLanguage properties that can be used with Range Slider controls, see [Range Slider control properties](../WDChamp/1016342.md).
...
[Range Slider control properties](../WDChamp/1016342.md)
