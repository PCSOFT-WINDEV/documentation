...
Example of popup window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ComboFen.gif)
...
**Remark**: It's also possible to use another type of window as a popup window. In this case:

- the window's title bar will be reduced (no title will be displayed).
...
**Remark**: To switch from parameters to popup window, you need to use the [OpenPopup](../WDLang1/3038046.md) function..
![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) This feature is not available. 
<a name="NOTE5_2"></a>
...
[MyPopupControl (Reserved word)](../WDChamp/1511005.md)
