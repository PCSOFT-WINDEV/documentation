...
1. Select the overlayable control.  
	Reminder: To define an overlay field, check the "The control can be overlaid" option in the "UI" tab of the control description window. 
...
3. The following window appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB_Ancrage_superpose_nv.gif&type=thumb)
