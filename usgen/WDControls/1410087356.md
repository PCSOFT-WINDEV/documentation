...
You can manipulate Segmented Button controls in a window using various WLanguage properties. These properties can be used: 

- on the [Segmented Button control](#NOTE2_1). 

- on [Segmented Button control options](#NOTE3_1). 
...
## Segmented Button control properties
<a name="segmented_button_control_properties_ELTTEXTE000106"></a>
The following properties are associated with Segmented Button controls:
...
## Segmented Button option properties
<a name="segmented_button_option_properties_ELTTEXTE000895"></a>
The following properties are associated with Segmented Button control options:
