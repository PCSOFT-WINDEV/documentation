...
- a context menu. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Bouton_fleche_Menu.gif)


- a "Popup" window.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=bouton_fleche_popup.gif)
...
2. Open the "UI" tab in the control description window and select the type of arrow. The available options are as follows: 
	...
	- Drop-down button: The button and the arrow execute the same action. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=bouton_fleche.gif)
You can choose to: 
...
- Split button: The Button control and the arrow execute two different actions. 
	...
	- The arrow runs: 
						...
						<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=bouton_fleche_distinct.gif)
You can choose to: 
...
If there is a Button control in the group of a Ribbon control, the "UI" tab of the Button control allows you to configure how the button will behave when the ribbon is reduced. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ruban_Champ_Bouton.gif)
