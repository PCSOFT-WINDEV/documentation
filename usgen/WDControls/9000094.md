...
3. Le carré jaune a été remplacé par un carré bleu, indiquant que ce champ peut être surchargé.
	![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ModelePage_IHMNonSurchargee.gif)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ModelePage_IHMSurchargee.gif)
...
5. Deux sections de code de clic sont présents : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ModelePage_CodeNonSurcharge.gif)
...
5. Deux sections de code de clic sont présents : <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=heritage_surcharge_proc.gif)
