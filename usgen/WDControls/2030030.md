...
2. Dans l'onglet "Projet" de la fenêtre de description du projet, dans la zone "Type de site", sélectionnez "Session". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Page_session_reference%20-%20HC%20N%B0001.gif&type=thumb)
...
2. Dans l'onglet "Général" : 
	...
	- Si la page est référençable, cochez l'option "Référençable". Si nécessaire, modifiez le nom à utiliser dans l'URI. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Page_session_reference%20-%20HC%20N%B0002.gif&type=thumb)
