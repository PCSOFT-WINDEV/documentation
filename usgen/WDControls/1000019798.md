...
WINDEV includes [Organization Chart functions](../WDLang1/1000019817.md) to programmatically manipulate Organization Chart controls. 
...
## Manipulating Organization Chart controls programmatically
<a name="manipulating_organization_chart_controls_programmatically_ELTTEXTE000265"></a>
...
- syntax for specifying element characteristics: title, image, etc, ...
	...
	**Note** The [OrgAdd](../WDLang1/1000019729.md) function inserts an image into the element (to the left of the text).
...
<a name="manipulating_element_organization_chart_control_ELTTEXTE000308"></a>
