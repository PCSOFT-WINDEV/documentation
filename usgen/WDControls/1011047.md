...
|   |   |
| --- | --- |
| after the *Body* block.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=POSIMPCOMPCORPS.GIF)<br> | at the bottom of each page.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=POSIMPCOMPCORPS2.GIF)<br> |
