...
2. On the "General" tab, specify the image that will be used for the column title via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button: 
...
- The title of columns supports RTF and the graphic functions ([gXXX](../WDLang1/3029028.md) functions).
...
2. On the "Details" tab, enter the value of the option "Angle for the title of columns" (in degrees). Use the arrow button next to the field to select the precise angle required. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Angle_titre_col.gif)
...
<a name="background_image_for_the_title_area_column_ELTPARAGRAPHE000135"></a>An image can be included in each title cell.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TitreColonneTable.GIF)
...
5. Select the image of border to use by clicking the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button: 
...
### Column title-header
<a name="column_titleheader_ELTPARAGRAPHE000164"></a>You have the ability to define a title-header of columns. A column title-header is an additional title displayed above the title of one or more columns.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TableAjouteSurEntete.gif)
...
3. The different table columns are displayed in the window that opens.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TableAjouteSurEntete_Edit.gif)
...
<a name="customizing_the_magnifier_sort_context_menu_and_filter_icons_ELTPARAGRAPHE000232"></a>
...
3. Click the "Sort/Magnifier image" button and select the image that will be used for the magnifier via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu_Image_Editeur%20-%20HC%20N%B0001.gif) button ("Browse" or "Catalog" button).
...
For example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Loupe_perso.gif)
...
[TitleHeader (Property)](../WDChamp/1000022744.md)
