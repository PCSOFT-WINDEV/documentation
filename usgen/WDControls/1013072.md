...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fenetre-btn_Auto.gif)
...
**Remark**: The user can add a timer on button. This is one of the Automatic Application Features (AAF). For more details, see [Timer on button](../Editeurs/9500100.md).
...
- in the window description ("Details" tab): <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Btn_automatique.gif)


- in the Button control description ("Details" tab): <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Btn_automatique_btn.gif)
...
[DelayBeforeClosing (Function)](../WDChamp/3038040.md)

[Timer on button (AAF)](../WDChamp/9500100.md)
