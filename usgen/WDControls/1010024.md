...
- **MDI**: 
	These windows must respect certain constraints specific to MDI (Multiple Document Interface) applications. In an MDI application, the application's main window contains all the application's windows.. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_Fenetres%20MDI%20-%20HC%20N%B0001.gif&type=thumb)

	Three window types are available: MDI mother, MDI daughter or MDI sister window.. 
...
## MDI window
<a name="mdi_window_ELTTEXTE000188"></a>


### Characteristics of the MDI parent windows
<a name="characteristics_the_mdi_parent_windows_ELTPARAGRAPHE000042"></a>

An MDI (Multiple Document Interface) parent window is always the first window in a WINDEV project.. This window is used to display all the application windows.
...
<a name="characteristics_the_mdi_child_windows_ELTPARAGRAPHE000059"></a>
...
**Note**: On MDI windows, it's not possible to use a clipped skin template.

**Programming**
The MDI child windows must be opened by [MDIOpen](../WDLang1/3052005.md).

**Remark**: an MDI child window cannot be directly tested from the editor.. Indeed, it must necessarily be opened from the parent window.
...
<a name="nonmdi_window_free_window_ELTTEXTE000218"></a>
...
**Note**: Windows 11 windows can have rounded frames.. The system applies this effect to windows with double or thick frames, and without clipping. Windows with a simple border cannot have rounded corners.
...
[First project window](../WDChamp/9000177.md)
