...
**Case 1: page fields are associated with fields in a table (Binding)**
All the controls bound to an item in the table (or a related file) will be updated by [FileToPage](../WDLang4/3044148.md).

**Case 2: page fields are not associated with fields in a table**
...
**Case 1: page fields are associated with fields in a table (Binding)**
All the items in the table (or a related table) that are bound to a control in the page will be updated by [PageToFile](../WDLang4/3044022.md).
...
- Linear Slider control: 
	...
	```txt
	<Data table>.<Item> = <Slider control>
	```
