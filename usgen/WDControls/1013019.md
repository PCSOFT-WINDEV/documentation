...
You can manipulate Bar Code controls using WLanguage properties: 
...
## Bar Code control properties in a window
<a name="bar_code_control_properties_window_ELTTEXTE000147"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The following properties are associated with Bar Code controls:
...
## Bar Code control properties in a page
<a name="bar_code_control_properties_page_ELTTEXTE000807"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) The following properties are associated with Bar Code controls:
...
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) The Bar Code control properties available in Browser code are as follows:
...
## Bar Code control properties in a report
<a name="bar_code_control_properties_report_ELTTEXTE001493"></a>
![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) The following properties can be used with Bar code controls:
