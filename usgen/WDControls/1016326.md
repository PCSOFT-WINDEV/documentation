...
WINDEV and WEBDEV include the [OrganizerXXX](../WDLang1/1000019021.md) functions to manipulate Organizer controls. 
...
## Manipulating Organizer controls programmatically
<a name="manipulating_organizer_controls_programmatically_ELTTEXTE000352"></a>


### Adding an appointment
<a name="adding_appointment_ELTPARAGRAPHE000063"></a>
...
<a name="filling_organizer_control_with_the_data_found_hfsql_table_ELTPARAGRAPHE000098"></a>

The records are stored in an HFSQL table. The Organizer control can be initially filled by browsing the table via the FOR EACH syntax and by adding each appointment via [OrganizerAddAppointment](../WDLang1/1000018877.md).
...
<a name="retrieving_list_appointments_ELTPARAGRAPHE000122"></a>

[OrganizerListAppointment](../WDLang1/1000018880.md) is used to retrieve: 
...
<a name="displaying_organizer_control_from_specific_date_ELTPARAGRAPHE000156"></a>
...
<a name="delete_appointment_ELTPARAGRAPHE000167"></a>
...
<a name="modifying_the_control_display_options_ELTPARAGRAPHE000190"></a>

The current display of an Organizer control can be modified by the following functions: 

- [OrganizerDisplayPreviousPeriod](../WDLang1/1000018886.md) and [OrganizerDisplayNextPeriod](../WDLang1/1000018885.md): These two functions modify the display period (identical to the use of the spin button at the top of the Organizer control). 

- [OrganizerChangeMode](../WDLang1/1000019497.md): Use this function to change the field display mode: day, week, month.
...
<a name="using_the_context_menu_aaf_ELTTEXTE000413"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) 

### Possibilities of the context menu
<a name="possibilities_the_context_menu_ELTPARAGRAPHE000213"></a>
...
<a name="advanced_use_events_with_procedures_ELTPARAGRAPHE000239"></a>
...
<a name="management_public_holidays_ELTTEXTE000443"></a>
...
<a name="properties_specific_organizer_controls_ELTTEXTE000469"></a>
