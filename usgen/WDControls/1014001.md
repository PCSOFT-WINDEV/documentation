...
1. Go to the "Creation" tab in the window editor. This tab contains all the types of controls that can be created in a window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fen_Creation_champ.gif&type=thumb)
...
**Note** To create a new column in a Table control from within the window editor:
...
| File description, copied from the data model editor or from the ["Database schema" pane](../Editeurs/2027012.md). | Table based on a table |
| File item, copied from the ["Database schema" pane](../Editeurs/2027012.md). | Control created by RAD according to the type of control specified in the "RAD" tab of item description. |



**To create a control from the clipboard content**: 

1. Copy the item to the clipboard: under the "Home" pane, in the "Editing" group, click on "Copy" (or Ctrl + C).
...
**Note** You can explicitly choose the format in which the clipboard contents are to be pasted into the window editor: under the "Home" pane, in the "Editing" group, click on "Paste" and select "Paste Special". For more details, see [Special paste](../Editeurs/2026001.md).
<a name="NOTE2_4"></a>
...
<a name="binding_control_table_item_ELTTEXTE000717"></a>
Excluding buttons, tabs, shape controls and toolbars, all window controls can be bound to a table item.
...
<a name="selecting_grouping_and_deleting_the_window_controls_ELTTEXTE000741"></a>
...
- the control gouping to manipulate several controls in the window editor.
...
<a name="copying_the_window_controls_ELTTEXTE000777"></a>
...
<a name="moving_locking_and_aligning_the_window_controls_ELTTEXTE000819"></a>
...
- the mouse (via the sizing handles of the control) 
	Note: In this case, resizing the field and its contents is entirely WYSIWYG. 
...
In most cases, the controls belong to a window. Therefore, these controls appear in edit and at runtime. However, it is possible to position a field in the home window of a window: the field is then "out of window".. This control will be visible in edit mode and invisible at runtime. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FenFenAccueil.gif)
You can use a control outside the window to:
...
- In the editor, the "login" window is as follows: <br>![The Details button is used to enlarge the window height.](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ChpHorsFen1.gif)


- At runtime, once the "Details" button was clicked, the "login" window is as follows: <br>![The off-window controls are automatically displayed.](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ChpHorsFen2.gif)
