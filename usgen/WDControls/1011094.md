...
The mini-preview window is as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MiniFen%EAtre_apercu%20-%20HC%20N%B0001.gif)
...
- Ability to export the printout in one of the available export formats: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MiniFen%EAtre_apercu%20-%20HC%20N%B0002.gif)





Note: The [iParameterViewer](../WDLang5/1000024634.md) function is used to select the export options available from the mini-viewer.. 
...
[iPreview (Function)](../WDChamp/3046069.md)
