...
3. The yellow square was replaced with a blue square, indicating that this control can be overridden.
	![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ModeleFen_IHMNonSurchargee.gif)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ModeleFen_IHMSurchargee.gif)

4. You can now modify all the aspects of the button interface: dimensions, position, style, ... <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ModeleFen_IHMModifiee.gif)
...
5. Two sections of click code are found: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ModeleFen_CodeNonSurcharge.gif)
...
5. Two sections of click code are found: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=heritage_surcharge_proc.gif)
