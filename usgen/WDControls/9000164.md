...
Example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB%20-%20Texte%20riche%20dans%20champs.jpg&type=thumb)
...
4. You have the ability to customize the enrichment via the "Text" pane that appears in the ribbon: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Texte_Riche_2.gif&type=thumb)
You can for example: 

	- Customize the text formatting. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Texte_Riche_1.gif)
...
- A Static control containing a link: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-ZTR-Lien%20dans%20texte.jpg)


- An edit control whose caption contains a link: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-ZTR-Saisie.jpg)


- A Check Box control whose title is in bold and whose option caption contains a link: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-ZTR-Lien%20dans%20interrupteur.jpg)


- A Radio Button control whose title is in bold and whose option caption contains a link: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-ZTR-S%E9lecteur.jpg)


- A request for email, with a red star: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB%20-%20Texte%20riche%20dans%20les%20champs.jpg)
...
[CaptionHTML (Property)](../WDChamp/1000020922.md)
