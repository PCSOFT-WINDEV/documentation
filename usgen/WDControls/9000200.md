...
3. A new window is created in the editor. Only 2 field types are available in iOS 14 Widget windows: [Static Text controls](../WDChamp/1013179.md) and [Image controls](../WDChamp/1013218.md).




**Remark**: It is also possible to change the type of an existing window: 

1. Open the window description (select "Description" in the context menu). 

2. On the "UI" tab, select "Widget (Android/iOS14+)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0001.gif)
...
The size of a widget window is defined by the number of cells it occupies horizontally and vertically. This size can be configured in the "UI" tab of the description window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0003.gif)


On iOS, there are several standard sizes: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0002.gif)
...
- iOS 16 only: Square/Rectangle for lock screen. 
	These options allow you to create "Lock Screen" Widgets: these Widgets appear on the screen, even if the device is locked.
...
A widget window is displayed by the process that manages the device's home screen. The widget window is not constantly refreshed. It is updated in the following cases: 
...
**Remark**: The [WidgetDisplay](../WDLang3/1000020647.md) function causes the Widget to be redisplayed and the "Widget refresh" event to be executed.. 
...
The widget can be described in the "UI" tab of the window description. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Fen%EAtre_ios_Widget%20-%20HC%20N%B0003%202.gif)
...
Note: If an image is specified in the "UI" tab of the description window, it will not be taken into account.. 
...
[Developing an iOS 14 widget](../WDChamp/1000019929.md)

[Widget functions](../WDChamp/1410087601.md)
