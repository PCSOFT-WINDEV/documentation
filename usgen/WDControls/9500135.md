...
<br>![On the left, "standard" table content ; on the right, the same content zoomed](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Zoom-ChampTable%20-%2003.jpg)
...
**To restore the initial display**, all you have to do is select "Cancel the zoom" in the context menu of the control (or press Ctrl + 0). 
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA_Zoom_Table.gif&type=thumb)
...
If the zoom is performed through programming, the context menu of the control allows you to cancel the zoom. 
