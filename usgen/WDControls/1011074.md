...
- The edit control is not bound to a table item, query or variable. To display information coming from a table, a query or a variable, the control must be assigned programmatically.
...
**Remark**: The Check Box control is not bound to an item from a table or query, or to a variable. To display information coming from a table, a query or a variable, the control must be assigned programmatically.
<a name="NOTE4_3"></a>
...
- The Combo Box control is not bound to an item from a table or query, or to a variable. To display information coming from a table, a query or a variable, the control must be assigned programmatically.
...
- The data coming from the database can be displayed programmatically. Simply link the report to a table or query and assign the desired item to the control in the "Before printing" event.
...
- The data coming from the database can be displayed programmatically. Simply link the report to a table or query and assign the desired item to the control in the "Initialization" or "Before printing" events.
