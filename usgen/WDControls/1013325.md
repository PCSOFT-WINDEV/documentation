...
**The principle is simple**: simply use a different identifier for each duplicate.. This identifier will be retrieved by the functions for treeview management and it will be used to identify the duplicated handled.
...
**Example** To add a leaf to the "Root "+TAB+"Node "+TAB+"Leaf" element with the identifier "Id feuille", simply use the following syntax:
