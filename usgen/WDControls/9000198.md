...
2. On the "Style" tab, check "Customize title bar". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Barre_titre_personnalis%E9e%20-%20HC%20N%B0001.gif&type=thumb)
It is possible to: 
