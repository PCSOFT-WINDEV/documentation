...
2. Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=btn_multilangue.gif) icon and select "Multilingual". The multilingual image management window opens. By default, the same file is associated with all the languages supported by the page.
...
**Remark**: If a multilingual image was defined, the following message is displayed in the image description: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=image_multilangue%20-%20HC%20N%B0001.gif)
...
[Image control: Operating mode of a clickable image](../WDChamp/1013158.md)

[Binding an Image control to an item](../WDChamp/1013135.md)

[Defining clickable areas](../WDChamp/1013157.md)

[Manipulating Image controls programmatically](../WDChamp/1013136.md)

[Retrieving the coordinates of a click in a clickable image](../WDChamp/1013130.md)

[Drawing in WINDEV, WEBDEV and WINDEV Mobile](../WDChamp/3029035.md)

[Drawing charts in an Image control](../WDChamp/1013139.md)

[Events associated with Clickable Image controls](../WDChamp/1013129.md)

[Clickable Image control properties](../WDChamp/1013131.md)
