...
- select a cell, then go to the "Modification" tab, click the dialog box launcher ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ico_regroup.gif) of the "Table" group.
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Recad_Tab1.gif&type=thumb)<br>Before the resize operation | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Recad_Tab2.gif&type=thumb)<br>After the resize operation |
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Recad_Tab2.gif&type=thumb)<br>Before the resize operation | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Recad_Tab3.gif&type=thumb)<br>After the resize operation |
