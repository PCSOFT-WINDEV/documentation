...
The Rating control can be used in a window as well as in a page. This help page presents the different properties available for this type of control. 
...
<a name="properties_that_can_used_the_window_controls_ELTTEXTE000128"></a>
The following properties can be used with Rating controls:
...
<a name="properties_that_can_used_the_page_controls_ELTTEXTE000863"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties that can be used on a Rating control in a page (Server code)
<a name="properties_that_can_used_rating_control_page_server_code_ELTPARAGRAPHE000037"></a>The following properties can be used with Rating controls:
...
### Properties that can be used on a Rating control in a page (Browser code)
<a name="properties_that_can_used_rating_control_page_browser_code_ELTPARAGRAPHE000045"></a>The following properties can be used with Rating controls:
...
### Properties that can be used on a Rating control in PHP
<a name="properties_that_can_used_rating_control_php_ELTPARAGRAPHE000054"></a>The following properties can be used with Rating controls:
