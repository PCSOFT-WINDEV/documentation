...
You can manipulate a Code Editor control in a window or page using the following WLanguage properties: 

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) [Properties available in a window](#NOTE2_1). 

- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) [Properties available in a page](#NOTE3_1).
...
The following properties are associated with Code Editor controls:
...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) <a name="NOTE3"></a>
<a name="NOTE3_1"></a>


## Properties available in a page
<a name="properties_available_page_ELTTEXTE000730"></a>
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) 

### Properties available in Server code
<a name="properties_available_server_code_ELTPARAGRAPHE000043"></a>The following properties are associated with Code Editor controls:
...
<a name="properties_available_browser_code_ELTPARAGRAPHE000051"></a>The following properties are associated with Code Editor controls:
