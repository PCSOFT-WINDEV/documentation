...
[See the 927 new features (PDF)](https://us.pcsoft-windev-webdev.com/WX27-Features.pdf)
		...
		WEBDEV 27: Take advantage of 173 common new features in version 27
	

	
		WEBDEV 27 benefits from most of the 173 new features common to version 27. 
WEBDEV 27 boasts higher speeds, new controls, new Smart controls, detection of obsolete technology in the code, AI object detection, richer code editor, improved Project Management Hub, secure passwords in HFSQL, new WLanguage features, etc. 
...
- Tokenized email address input. 
		...
		New Smart control: ready-to-integrate PDF reader
	

	
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Champ-Metier-Iframe-PDF%20BIS.gif&type=thumb)
...
- ... 
		...
		New Smart control: Combo switching to input mode
...
As with any other Smart control, the source code is provided and can be fully modified and customized. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Champ-Metier-Combo-Quantite-Amazon-Passant-En-Mode-Saisie.gif&type=thumb)
*A common entry mode on sales sites*
		...
		The "Timeline" Smart control includes all the options to manage a timeline (series of events). 
You can configure each element. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Champ-Metier-Agenda-Timeline.gif&type=thumb)
*An effortless, clear Time Line*
...
Clicking the button opens the panel over the current page, according to the defined position.
		...
		New Smart control: email with Tokens
...
The user can add shapes to the diagram, link them, move and modify them, zoom in and out, edit their properties, and edit the text of shapes.... 
...
In version 27, rotation is shown directly in the page editor. <br>![Rotated controls in the page editor](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Rotation-des-champs-Edition.jpg)
...
Simply use the following properties: [ResourceWidth](../Proprietes/1000020110.md), [ResourceHeight](../Proprietes/1000020109.md), DateWidth and DateHeight. <br>![Scheduler control created with WEBDEV 27](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB%20-%20Planning%20Hauteur%20ressource%20par%20prog.gif)
...
- There are more UI customization possibilities:
	...
	5. Column sorting: click on header to sort
...
<a name="editeur_de_pages"></a>
		...
		Version 27 introduces 5 new predefined pages: product page, product catalog, dashboard, login, about.... 
These pages appear when creating a blank page. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB%20-%20Page%20pr%E9d%E9finie.gif)
...
The UI is much more intuitive and that changes everything!
		...
		Drag handle: move a field and everything below it
	

	
		Version 27 introduces a new mode for moving fields: Sliding mode.. 
For this purpose, a new handle appears on the selected field: the drag handle.. 
This manipulate allows you to move the control and all the controls below it in a single action. 
...
<a name="editeur_de_pages_plus_rapide"></a>
		...
		With version 27, page generation speed is multiplied by a factor of 3 for large projects: this gain is immediately appreciated.. 
...
Since most websites developed with WEBDEV use templates, you will also notice this improvement right away. 
		...
		In version 27, compilation uses all processor cores by default: depending on the power of your hardware, this reduces compilation times.. 
...
In version 27, the top-left manipulate of non-dissociated controls is shown as a red triangle. 
...
In version 27, the upper-left manipulate of non-dissociated controls is a red triangle. 
This lets you know that any changes made to the control will affect the next slice.
		...
		In RWD it is possible to override properties depending on the slice: visibility, font size, etc.... 
In version 27, a window lists all the overrides of all the controls in the slice and indicates the value of each override. 
You can edit the control directly from this list. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB%20-%20RWD%20fen%20toutes%20les%20surcharges.jpg)
...
This menu allows you to duplicate or delete a popup page, to access its description and its code.
		...
		In version 27, a new process appears in the code editor: the Popup Display process. . 
...
<a name="ambiance"></a>
		...
		2 new skins are available in version 27: the Museum skin and the NightCity skin.. 
...
Clusters make it possible to install as many application servers as desired, and thus to distribute the site workload across these servers. 
		...
		A cluster can be installed in 4 simple steps. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Serveur%20Application%20Cluster.gif)
**Step 1: The**distributor 
...
**Step 3: Other application servers** 
...
- Resistance to hardware failures: if one drive or machine fails, the other machines are always operational. 

- Availability in case of software failure 

- Resistant to Windows Updates: when a Windows Update runs, other machines are available. 

- Horizontal scalability: during sales periods, add 10 servers and you're done! 

- Updating the application server: this can be done in stages, without impacting site availability.
...
<a name="saas"></a>
		...
		The SaaS administrator becomes mobile friendly: administer your SaaS from a phone! <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-SaaS-Mobile.png)
...
- Request server stop.
		...
		The new AI-based object detection feature is also available for your WEBDEV websites. 
Once a shape has been detected, your site can propose the processing of your choice: edit the image, save it, crop it, search for it, etc.... <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Reconnaissance-de-forme_Avatar.png)
		...
		The [PageAddress](../WDLang2/3058010.md) function includes a new paComplèteAuto constant, which returns the URL with the protocol used to display it: http or https.. 
...
| [JSONToXML](../WDLang1/1410087330.md) | [LuhnCalculate](../WDLang1/1410087276.md) | [LuhnCheck](../WDLang1/1410087277.md) |
...
<a name="wlangage_navigateur"></a>
		...
		PageDisplay available in browser code: that makes everything so much simpler!
		...
		Edit control: Edit event available in browser mode
...
<a name="json"></a>
		...
		The new [JSONToXML](../WDLang1/1410087330.md) and [XMLToJSON](../WDLang5/1410087331.md) WLanguage functions available in Server code allow you to easily convert JSON files to XML and vice versa.
...
| [AIDetect](../WDLang6/1410087942.md) | [AIDetectModel](../WDLang6/1410087982.md) | [JSONToXML](../WDLang1/1410087330.md) |
...
<a name="php"></a>
		...
		PHP version 8 is supported by WEBDEV 27: you can generate PHP code in version 8. 
...
<a name="pages_session"></a>
		...
		PAGES IN SESSION MODE: THEY ARE SEARCHABLE
...
In version 27, a major evolution is introduced: the session mode can create searchable pages, with a different URL for each page.
...
- This page has a fixed URL, which can be copied, emailed and bookmarked,
...
Programming SEO-ready pages becomes easy. No need to change your programming habits and automations.
		...
		Search Engine Optimization session: how does it work? 
...
- to improve search Engine Optimization, you need to remember to apply the usual rules: page content, ...
...
<a name="webservices_rest"></a>
		...
		The Open API standard defines the structure of the documentation of a REST web service. 
In version 27, the documentation of a REST web service is automatically generated.
	


 
	
		Editor: Search in REST web services
	

	
		The search feature in the environment now also includes REST web services.
...
This makes it possible to ensure a high number of connections with fast response times, or to easily adjust the number of application servers according to the workload.
		...
		The Application Server home page displays a list of all sites and web services deployed on this application server. 
...
This avoids having to log in every time to complete setups on multiple accounts or platforms. 
		...
		In version 27, a new action allows you to deploy WEBDEV websites directly to PCSCloud.net.
...
Version 27 allows you to use a regular application server for these functions: there's no need to install reserved servers when you're already using an application server for your sites.. 
...
[New products brochure 27: Common new products](../Presentation/9500005.md)
