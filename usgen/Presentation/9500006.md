...
<a name="new features"></a>
		...
		WINDEV 27 benefits from the 173 new common features in version 27, especially: higher speeds, new controls, improvements of the PDF control, Windows 11 support, detection of obsolete technology in the code, AI object detection, new features of the code editor, improvements of the Project Management Hub, secure passwords in HFSQL, new features of WLanguage, etc.
...
It can be used to create input windows, or to understand the different possibilities of non-blocking required input. <br>![Required input fields that are left empty and data that does not match the input mask are highlighted in red. You can navigate between controls](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Champ-Metier-Saisie-Obligatoire-Non-Bloquante.gif)
...
A list of suggestions appears as you type the addresses of the recipients. <br>![Each selected recipient appears as a token](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Champ-Metier-Saisie-Email-Avec-Jetons.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Champ-Metier-Drag-And-Drop-Zone-R%E9p%E9t%E9e.gif)
...
These windows open more quickly in version 27. 
		...
		The Calendar control in version 27 allows you to display the week number. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20Calendrier%20-%20Affichage%20semaine.jpg)
...
For more details, see the help about [HTMLEnableDebugger](../WDLang1/1410087849.md).
...
- ... 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Masquage%20titre%20fen.jpg)
...
This makes Looper controls more elegant and readable. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Rupture%20hauteur%20variable.png)
...
In Windows 11, WINDEV application windows have rounded corners by default. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Windows11-coins-arrondis.png)

You can avoid displaying these rounded corners by using the clipping feature available in WINDEV. 
The windows are compatible with the new Snap Layouts menu and its gestures. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Windows11-snap.png)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Windows11-menu-contextuel.gif)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-WIN11-ascenseurs-fins.png)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-WIN11-ascenseurs-larges.png)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Windows-11.gif)
...
End users can now find this AAF in the context menu of Table controls. <br>![Context menu with the most common AAFs](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20FAA%20largeur%20colonne.gif)
...
<a name="java"></a>
		...
		In version 27, the [Filter](../WDLang1/1000024845.md) , [Map](../WDLang1/1000024734.md) and [Reduce](../WDLang1/1000024744.md) functions are available in Java. 
...
- EUC-KR (Korean). 
		...
		A notification is a small window that appears at the bottom right of the screen, and that can be viewed at any time in the Windows notification area. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Notif%20Windows%2011.gif)
