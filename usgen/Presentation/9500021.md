...
<br>![Code proposé par l'IA. L'IA a détecté les rubriques de la requête, a trouvé le champ Table et remplit les colonnes avec les rubriques correspondants.](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IA%201%20integre%20editeur%20testSL.gif)
...
- L'IA a analysé le code, détecté une répétition de code et propose donc la répétition pour les éléments suivants de la structure de départ (JSON). Pour valider la proposition (en jaune pâle), touche TAB. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IA%202%20-%20V2.gif)
...
- En saisie de code, je tape un commentaire...<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IA%20code%20saisie%20commentaire.gif)


- L’IA propose un code qui réalise l’action décrite dans le commentaire en tenant compte du projet en cours. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IA%20code%20saisie%20commentaire%20apres.gif)
...
Fonction **PaletteChange**<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Palettesdecouleurs-Th%E8me%20sombre.gif)
...
<br>![Thème Windows](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Windows%2011%20rose.gif)

<br>![Palette générée](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Palettesdecouleurs-Th%E8me%20windows%20rose.gif)
...
En thème sombre par exemple, les couleurs passent en blanc.<br>![A gauche icones originales, à droite passage automatique en blanc pour le mode sombre](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Icones%20th%E8me%20clair%20et%20th%E8me%20sombre%202.gif)
...
Il en est de même dans les "7 onglets". <br>![Une utilisation de couleur nommée dans les "7 onglets"](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=editeur_couleur_palette.gif)
...
Ce nouveau graphe représente un graphique qui illustre visuellement des données sous forme de pourcentages, sous une forme illustrative : bouteille, personne, thermomètre, etc.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-pictorial-percentage-chart-Launch.gif)
...
Cela permet une présentation plus visuelle.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GRAPHE-ICONE.gif)
...
<a name="environnement"></a>
		...
		Un nouveau magnifique modifieur fait son apparition en version 2025.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=nouveau-modifieur_etat_zoom-sur-modifieur.gif)
Voir nouveauté 062.
...
<a name="environnement_nouveau_modifieur"></a>
		...
		Le nouveau modifieur est un outil dont vous ne pourrez plus vous passer !<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-Nouveau-Modifieur.gif)
...
Le mode Ruban existe toujours.
		...
		La présentation des champs par volet est beaucoup plus claire.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=schema_volet_creation_champ.gif)
...
Le volet est donc disposable à votre choix : haut, bas, 2ème écran, etc.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=schema_volet_creation_champ-Rechercher.gif)
...
Le multicurseur permet d'effectuer une même manipulation simultanément à tous les endroits où les curseurs sont positionnés.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=multicurseur_avant.gif)
...
Un trait fin se charge de cette mission.<br>![Notez les traits fins qui matérialisent les blocs de code](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WX2025_Indentation.gif)
...
Le type de l'élément est indiqué en fin de ligne : champ de saisie, libellé, entier, réel, booléen, etc.<br>![Le code dans la combo utilise la coloration syntaxique](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Combo%20completion.gif)
...
En version 2025, il devient possible de paramétrer l'épaisseur de ce curseur, ainsi que sa vitesse de clignotement.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wx-taille-du-curseur-vitesse-clignotement.gif)
...
<a name="coffre_fort"></a>
		...
		Il arrive souvent que des mots de passe, des clés privées, des tokens soient utilisés en programmation.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Code%20MDP.gif)
Par exemple :
...
Tous les développeurs du projet peuvent utiliser cet identifiant.<br>![L’édition sécurisée des chaînes secrètes](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=coffre-fort%20V2%20avec%20mdp%20en%20clair.png)
...
La version 2025 permet également de décrire la relation entre le PDF et les pièces jointes (ici en XML).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Sch%E9ma%20facturation.gif)
...
<a name="yousign"></a>
		...
		La version 2025 de WINDEV propose la solution YouSign.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Yousign-Sch%E9ma.gif)
