...
Un graphique peut comporter une ou plusieurs catégories.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Graphe%20Waffle%202.png)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Graphe%20Waffle%201.png)
...
une personnalisation plus fine : arrondi sur barre, etc.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=HistoLook%20dans%20Appli.png)
...
Cela permet d'éviter des zones vides inutilisées en fonction des données réelles.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA%20-%20axe%20graphe%20menu%20seul.png)
...
Pour plus de détails, consultez [Docusign : Signature électronique](../Editeurs/9000217.md).
		...
		Pour simplifier le développement, un assistant intuitif permet de générer le code nécessaire.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=docusign_assistant.png)
...
Il est également possible de positionner des guides sur ces règles.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wd-editeur-d-image-regles-et-guides-exageration.png)
...
<a name="environnement"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Loupe%20recherche%207%20bulle.png)
...
<a name="securite_par_mot_de_passe_groupware_utilisateur"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Groupware_GPU_MotDePasse_Renforce.png)
...
Pour plus de détails, consultez [Correcteurs disponibles dans l'éditeur de code](../Editeurs/9000073.md). 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WX%20-%20Bulle%20info%20dans%20code%20-%20proc.png)
...
Pour plus de détails, consultez [Le volet "Hashtags du code"](../Editeurs/2027039.md). 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Assistant%20chaines%20multilangues.png)
...
Sécurité automatique, il est impossible de passer des paramètres incompatibles. Exemple :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Code%20type%20sur%20le%20type%20champ.png)
...
Exemple :<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Code%20cr%E9er%20ses%20fonctions%20sur%20les%20champs.png)
...
Créer un Champ Favori se réalise facilement d'un clic droit.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Passer%20un%20champ%20en%20favori.png)
...
Une fois le champ Favori positionné dans la fenêtre ou la page, vous pouvez modifier librement les paramètres de ce champ. Inutile de surcharger ses caractéristiques.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champs%20favoris%20-%20attributs.png)
...
Il suffit de spécifier la règle d'anonymisation dans les 7 onglets de la définition de la rubrique.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Anonymisation_7Onglets_brouillage.png)
