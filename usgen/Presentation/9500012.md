...
If one or more fonts have been left out, a UI error is generated.
		...
		<br>![The Search field now supports rich formatting](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20Markdown%202.png)<br>![Indication text with rich formatting](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20Markdown%20lib%20ch%20saisie.png)
...
Give users the ability to edit photos and images, with zero lines of code.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20Editeur%20d'images2.png)
...
<br>![Menu of the mobile Image Editor control](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20Editeur%20d'images.png)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20Action%20bar%201.png)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20Action%20bar%202.png)
...
![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20Action%20bar%203.png)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20Action%20bar%206.png)
...
If necessary, the Kanban control changes to the target list (column) to complete the operation.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Kanban%20Mobile.png)
In landscape mode, multiple lists (columns) are displayed.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Kanban%20Mobile%201.png)
...
The full text is then displayed.<br>![The text is truncated, but the user can tap "Show more" to see the full text](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20-%20Champ%20m%E9tier%20voir%20plus.png)
		...
		The "Badge" Smart control shows a badge containing a value over a control: image, button, etc.<br>![Standard UI behavior](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-ChampM%E9tier1%20ROND.png)
...
The layout has been adapted for easy use on mobile devices.<br>![Once selected, each destination is added as a token](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-ChampM%E9tier3.png)
		...
		The "Address autocomplete" Smart control (see new feature 202) is also available for mobile applications: The layout has been adapted to be touch-friendly.<br>![A list of address suggestions is displayed](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-ChampM%E9tier2.png)
...
```
<br>![The OPEN button on the site or email launches the app and opens the selected ad](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OUvrir%20une%20appli%20depuis%20un%20lien.png)
...
Simply pass the callback to the new [DeepLinkProcedure](../WDLang3/1410089051.md) function.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20-%20Page%20Webdev%20dans%20App%20mobile.png)
...
- plus new features specific to iOS. 
		...
		<br>![iPhone 14 and Apple Watch Series 8](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iphone14-Dynamic-Island-ferm%E9e-pizza-min.png)
...
All iPhone 14 and AppleWatch Series 8 models are supported.
		...
		<br>![Expanded dynamic island, with an available action](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iphone14-Dynamic-Island-pizza-min.png)
...
For more details, see [Using Kotlin code](../Editeurs/9000209.md).
		...
		<br>![Most payment apps use clear implementations of Activities](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Paiement-Mobile-Fenetre-Activity-SANS-Recadrage.jpg)
