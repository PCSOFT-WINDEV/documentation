...
Remember: Smart controls are delivered with their source code, so they can be fully modified and customized.
		...
		The "Multi-selection with tokens" Smart control allows you to select one or more tokens from the list.<br>![Multiple selection with tokens](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-ChampM%E9tier3.png)
...
A badge draws attention to a counter: number of pending orders, etc.. 
The chip displaying the number can be positioned on any type of field: button, label, image, etc....<br>![Here, the badge (red circle with the number) appears on a Button control](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-ChampM%E9tier1.png)
...
Please bear in mind that this control is based on a Google API. Google may require you to pay a subscription fee, depending on the number of requests.<br>![Several address suggestions appear when the end user starts typing](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD-ChampM%E9tier2.png)
...
<a name="nouveautes_sur_le_champ_table"></a>
		...
		The presentation of Image columns has been improved in version 28: by default, a margin is present around the image, making the table more harmonious..<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Table%20avec%20images%20-%20marge.jpg)
...
<a name="nouveautes_sur_les_champs"></a>
		...
		<br>![You can now format all the text in your applications](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Markdown%20Interrupteur2.png)
...
<br>![Easy formatting with Markdown](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Markdown%20Menu2.png)
...
The layout improves automatically.<br>![In edit mode, you can see the margins that have been applied around the icons](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Picto%20Libell%E9%20Onglet%20marges.png)

<br>![A clean layout at runtime:
no more icons touching the borders!](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Picto%20Libell%E9%20Onglet%20marges%20ex%E9cution.png)
		...
		A Button field can contain frames, whose appearance can vary depending on the state of the button: pressed, hovered, etc.,... 
In version 28, you can define the border settings for each state in the "Style" tab of the 7-tab window.<br>![Easily select the type of border for each state](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Cadre%20btn.jpg)
...
You can now choose how the icon's content is displayed: framed, homothetic...
		...
		A new mask for Numerical edit controls: scientific notation. 
...
In version 28, this separator can contain a text.<br>![The menu separator can now include text](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Menu%20Libell%E9%20avec%20s%E9parateur.png)
		...
		You can define "5-state" icons (e.g. buttons) in the menu options via the-7 tab window or programmatically.<br>![5-state icon](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Menu%20contextuel%20option%20dynamique.png)
...
<br>![A clean Combo Box...](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Combo%20a%E9r%E9e%20Windows%2011.png)
		...
		Static Text controls can now be rotated. This rotation is specified in the "Style" tab of the 7-tab window.<br>![Rotated text (in red)](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Champ%20libell%E9%20avec%20une%20rotation%203.png)
...
This new feature allows you to assign a different value to the Edit control than the one displayed in the Help window: for example, an acronym,...
...
<a name="installs_creees_avec_windev"></a>
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Installe%20relook%E9e.png)
...
The interface has been revised, and a modern style has been applied for a more user-friendly feel.
		...
		You can set an automatic toast message to let the user know that an update is available, if the application is in use.
...
<br>![This toast message lets the user know when an update is available. 
 It appears when the application is running, at the bottom right of the screen](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Notif%20Maj%20Appli.jpg)
...
<a name="site_webdev_dans_fenetre"></a>
		...
		A WEBDEV WEBSITE IN A WINDEV WINDOW
...
For more details, see [Integrating a WEBDEV website into a WINDEV application](../Editeurs/1410086640.md). 
...
First of all, by default, WEBDEV page navigation is limited to the URL domain provided in the application: this eliminates XSS (Cross-Site Scripting) attacks.
...
- If a window opened with [Info](../WDLang1/3021011.md), [YesNo](../WDLang1/3021005.md), or similar functions is not customized, a UI error appears. A customized window is more user-friendly because it allows the use of AIFs: timers...
...
<a name="UI_actuelles"></a>
		...
		FOR CURRENT UI: SPACE, ENLARGE, IT'S AUTOMATED
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Agrandissement%20des%20polices.png)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WD%20-%20Espacement%20des%20champ.png)
...
This skin template adapts all clickable zones: large buttons, large combo arrows, large switches/pickers, input zones, etc.... 
...
<a name="rad"></a>
		...
		The Analysis Editor lets you specify information for the ARD for each item: type of field to be generated, field content, general field properties, etc.... 
The RAD will use this information to generate windows and pages. 
Version 28 differentiates this information by platform: PC, Web, Mobile.
...
<a name="faa_les_fonctionnalites_automatiques_de_vos_applications"></a>
		...
		FAA: AUTOMATIC FUNCTIONS FOR YOUR APPLICATIONS
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=FAA%20Tous%20Aucun2.jpg)
...
<a name="linux"></a>
		...
		The code editor provides predefined actions for button clicks: open a window, send an e-mail, cut, copy, paste, etc.,... 
...
It benefits from common new features and a number of useful evolutions: AI-based edge detection, new type of undetectable chain, addition of appointments, straightening an image in perspective, evolution of introspection, automatic OCR on zone, etc., ... 
