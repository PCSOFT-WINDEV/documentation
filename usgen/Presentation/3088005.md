...
**Remark**: The following icon ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=er.png) (present in online help) indicates the differences between the User report editor and the integrated report editor.
...
**Remark**: The data files and fields that can be used in a report on a data file are defined in WINDEV's data model editor.. For more details on the requirements to use a WINDEV application with the user report editor, see [Distributing Reports & Queries](../Presentation/3088002.md).
...
For more details on report skin templates, see [Creating a report skin template](../Editeurs/2016005.md).
<a name="NOTE2_5"></a>
