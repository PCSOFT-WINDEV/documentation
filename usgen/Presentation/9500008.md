...
<a name="new_controls"></a>
		...
		![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Popup-Android.gif)![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Popup-iOS.gif)
...
A common use case is to create help messages for a given control: a custom context menu, alert, legends ... <br>![A popup displayed on a map](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Popup%20exemple%20utilisation.gif)
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Table-Hierarchique.gif)
...
Don't forget that a TreeView Table can also contain non-hierarchical columns. 
		...
		<br>![The button at the bottom of the screen is pinned](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Epingler-Un-Ou-Des-Champs.gif)
...
- Camera.
		...
		The "Token filter" control displays a series of tokens in a horizontal layout, and allows scrolling and selecting multiple elements. <br>![Standard UI behavior](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Champ-Metier-Jeton-Filtre.gif)
...
<br>![Each selected recipient appears as a token](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Champ-Metier-Saisie-Email-Avec-Jetons%20_%20Bords%209.gif)
		...
		The "Non-blocking required input" Smart control ([available in WINDEV](../Presentation/9500002.md)) is also available for mobile applications. It allows a less restrictive experience for the end user, while ensuring data validity. <br>![Each field that does not meet the requirements is highlighted in red](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Champ-Metier-Saisie-Obligatoire-Non-Bloquante.gif)
		...
		<br>![Sophisticated UIs made easy](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-Champ-Metier-Menu-Vertical-Sur-Bouton-Plus-Flottant.gif)
...
It is no longer necessary to write this code in the "Close child window" event. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=OuvreAsynchrone.jpg)
...
You can specify which users and groups of users can install an application. 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Texte%20indication.png)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20-%20marges%20chp%20de%20saisie.jpg)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ombre%20sur%20cadre.png)
...
In version 27, you can center controls via the snap feature in the window editor. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM%20magn%E9tisme%20horizontal%20au%20centre.gif)
...
In addition to the general and mobile-specific new features, version 27 includes the following new features for iOS.
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-iPhone.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=bouton_ios_partage_position.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-getPosition-iOS.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iOS-Demande-Autorisation.gif)
...
WINDEV Mobile 27 for Android benefits from the common new features of version 27, plus mobile-specific new features, plus Android-specific new features. 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WM-TelechargementFichier.jpg)
...
In version 27, you can specify the desired device without being prompted again. 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=shutterstock_1850326291.%20PPpsd%20copie.jpg)
