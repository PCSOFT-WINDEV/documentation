...
Vous pouvez également changer par programmation un fond de fenêtre d'administration en rouge (clair) pour la distinguer.<br>![Exemple de fenêtre de choix de palette en temps réel](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Choix%20palette%20dans%20les%20applis%202.gif)
...
Rappel : les Champs Métier sont livrés avec leur code source, et sont donc totalement modifiables et personnalisables.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wm-qrcode-avec-logo-au-milieu-4.gif)
...
L'usage le plus courant est la saisie de pages à imprimer.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Saisie%20de%20num%E9ros%20de%20page%20%E0%20imprimer.gif)
...
WINDEV vous apporte les aides nécessaires à la création de superbes UI.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Gabarit%20WD%20indigo.gif)
...
Leur look est adapté aux tendances actuelles.<br>![Note repositionnable new look](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wd-note-repositionnable.gif)
...
Une action par programmation sur un groupe de champs, comme par exemple le rendre invisible, permet maintenant de spécifier le volet pour ne pas impacter les autres volets.<br>![Chaque bloc est différencié](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Onglet-Ajout-Volet-Par-Prog.gif)
...
En version 2025 il devient possible de modifier l'aspect de l'onglet en le paramétrant via les "7 onglets". La visualisation reste ainsi vectorielle.<br>![Exemple d’images de volet (image agrandie)](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Volet-Onglet-Vecto.gif)
Il est également possible de définir les marges entre les différents éléments grâce aux "7 onglets".<br>![Edition des marges du contenu de l’onglet du volet](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=onglet_marges_definition.gif)
...
Pour plus de détails, consultez [Table et Zone répétée infinie](../WDChamp/1013307.md). 
		...
		<br>![Un effet de transparence](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wd-jolie-hc-avec-transparence.gif)
...
En version 2025, il n'est plus nécessaire de programmer pour utiliser cette fonctionnalité.<br>![Ici la combo repliée indique l’indicatif téléphonique, et la liste indique le drapeau et le nom du pays.](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Combo%20ValeurAffich%E9e%202.gif)
...
La fonction WLangage [ChampRectangle](../WDLang1/1410090408.md) permet de récupérer ce type de coordonnées sous forme de "rectangle" : coordonnées + largeur et hauteur.<br>![La PopUp s’affiche exactement sous l’icône](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wd-recuperer-les-coordonnees-des-elements-d-un-champ.gif)
		...
		Il est possible de changer la couleur d'une icône noir & blanc en choisissant la nouvelle option "Forcer en monochrome" disponible dans les "7 onglets", onglet Style.<br>![Changement de couleur d’icône](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=icone_noirblanc.gif)
...
Par exemple lorsque l'on définit une couleur nommée "Warning"cette couleur sera "rouge" en mode clair, et "rose" en mode sombre (parce que le rouge ne se voit pas sur un fond noir).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Th%E8me%20clair%20et%20sombre.gif)
...
```
		...
		L'aperçu d'un état contenant un recto et un verso différent visualise les pages côte à côte.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wd-apercu-avant-impression-d-un-etat-recto-verso.gif)
...
avec une programmation très simple](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wd-bouton-segmente.gif)
...
Prenons un exemple simplissime : une saisie de montant HT ou TTC.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Proc_react.gif)
...
Pour plus de détails, consultez [Procédures réactives](../Motscles/1514090.md). 
		...
		<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Proc_react2.gif)
...
Il s'agit une nouvelle option de l'Install, qui peut être désactivée.<br>![Une notification de Mise à Jour disponible dans l’application elle-même](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wd-wb-notification-de-mise-a-jour.gif)
...
<a name="faa_les_fonctionnalites_automatiques_de_vos_applications"></a>
		...
		En version 2025, une nouvelle FAA permet à l'utilisateur final de copier/coller une ligne entière dans une table de visualisation.<br>![Un copier/coller de ligne de table par FAA](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Table%20_%20copier%20coller%20de%20ligne%20possible.gif)
...
Pour plus de détails, consultez [Champ Table : Coller une ligne dans un autre champ Table (FAA)](../WDChamp/9500156.md). 
		...
		<br>![Une colonne «numéro de ligne» rajoutée par FAA](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Editeur%20HTML%20FAA%20Recherche%20internet.gif)
...
Il est maintenant possible de paramétrer la couleur des boutons ou d'associer des boutons à la zone de saisie.<br>![Une notification riche](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=wd-envoi-de-notifications-windows.gif)
