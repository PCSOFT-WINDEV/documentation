...
A report provides a custom view of a set of data. This data can come from a database, a text file, a Table control, etc. For more details, see [Reports](../WDChamp/1011023.md).
...
- ***the standard report editor***.
	This version is provided with WINDEV, WEBDEV or WINDEV Mobile. This version can only be used when developing a WINDEV or WINDEV Mobile application, or a WEBDEV site. For more details, see [The report editor](../WDChamp/1011069.md).
...
The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=er.png) icon indicates the differences between the user version of report editor and the standard report editor.
...
The reports created in WDEtat User Version can be opened in Reports & Queries. When they are opened, these reports are automatically migrated to version 2026.
...
**Note**: Reports created in WDQBE cannot be opened in Reports & Queries.. These reports must be recreated in Reports & Queries.
...
[Reports](../Presentation/1011023.md)

[Environment of the report editor ](../Presentation/2029004.md)

[Reports and Queries software: Special features](../Presentation/3088005.md)
