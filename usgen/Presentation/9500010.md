...
- Address autocomplete.
		...
		<br>![Standard UI](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-ChampsM%E9tiers-Contacts.png)
...
Model: Controls array<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-ChampsM%E9tiers-Commandes.png)
...
Template: Delivery dashboard<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-ChampsM%E9tiers-Livraisons.png)
...
Template: Sales dashboard<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-ChampsM%E9tiers-Ventes.png)
This Smart control contains:
...
Both developers and end users have the ability to create and manage Kanban controls in websites.<br>![Kanban control for managing meetings, used in a browser](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Kanban%20Web%20Navigateur.png)
...
The new **OpenContextMenu** function in WLanguage allows you to open a menu programmatically.<br>![Context menu in WEBDEV 28](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Menu-Contextuel.png)
		...
		WEBDEV 28 allows you to customize each appointment thumbnail in the Scheduler control: title, image, button, background color, frame, etc..<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Planning%20personnalisation%20des%20rdv.png)
...
This allows you to create narrower controls.<br>![Label above the drop-down list](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Combo.png)
...
This reduces the width of the control.<br>![Edit control with a label directly on the border](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Champ%20de%20saisie%20Libell%E9%20%E0%20Cheval%20version%20violette.png)
...
In version 28, the icon font provided with WEBDEV includes 5,000 new clipart images.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Police-d-icones.png)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Police-d-icones_2-de-plus.png)
...
<a name="champ_de_saisie_html"></a>
		...
		WEBDEV's HTML edit control is designed to be included on a page, allowing the user to enter HTML-formatted text: comments, CMS article description, etc.c
...
You can easily include Chart, Progress Bar and Combo Box controls within Loopers. These controls can be automatically updated.
		...
		In version 28, you can insert a Vertical RepeatString field into a Horizontal RepeatString field, and vice versa: anything goes! 
...
These modern styles provide a cleaner, easier-to-use interface.<br>![New style of the Table control in version 28](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB%20-%20Nouveau%20style%20de%20table%202.png)
...
This gives you an overview of all the styles used in the project.<br>![All the styles used in the project](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Edition-de-tous-les-styles-PP_dans-WEBDEV.jpg)
...
<br>![In the Mobile layout, the left menu and the footer have been removed to improve readability](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Agencement.png)
...
**The meaning of** elements: in rows or columns.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Flexbox_sens.png)
**Justification**: aligned left, right, justified (with or without margin), centered, ...<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Flexbox_justification.png)<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Flexbox_justification2.png)
**Whether or not to enlarge** fields in the zone<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Flexbox_agrandissement.png)
**Alignment** Alignment: top, bottom, vertically justified, centered, ...<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Flexbox_alignement.png)
**line break or not**: if no line break, either flexbox enlarges or content is truncated<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Flexbox_retourligne.png)
...
For example:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB-Flexbox_ordonner.png)
...
See new feature 022.<br>![Polar Area chart](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WB_graphe%20polaire.png)
...
<a name="json"></a>
		...
		The new WLanguage function [JSONValid](../WDLang1/1410089147.md) can be used to check that a string complies with the JSON standard: missing brace, key without value, etc.c
