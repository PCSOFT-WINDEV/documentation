...
Reminder: A semi-dynamic page is a page created in WEBDEV for displaying data. From this page, WEBDEV generates as many static pages as necessary. These static pages contain the data to display.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=PageSemiDynamiqueAffiche%20-%20HC%20N%B0001.gif)
...
**SemiDynamicPageDisplay** automatically sends the language of the current page to the WEBDEV website to be displayed. Therefore, if the current page is in French (*Nation(5)*), the WEBDEV website will be started in French.
<a name="NOTE0_3"></a>
...
[ChangeTarget (Function)](../WDLang2/3058005.md)
