...
- Tip: To find out the repetition number used (for example, when clicking on a button in the internal window), create an attribute in the RepeatString field and assign it to the result of the function **LooperAddIW**. 
...
[LooperInsertIW (Function)](../WDLang2/1000023440.md)
