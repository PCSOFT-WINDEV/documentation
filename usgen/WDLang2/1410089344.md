...
The **WBAdminConnection** type is used to get all the advanced characteristics of a connection on the server. This connection can correspond to a session, an AWP request, a schedule task, etc. You can define and change the characteristics of this connection using different WLanguage properties. 
...
| Identifier | Integer | Connection ID. To be used for a disconnection request, for example. |
