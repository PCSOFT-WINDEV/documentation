...
3. Specify the characteristics of Google Analytics account: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Google_ana_2.gif)
...
8. The web stream is created and you get a Measurement ID. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Google_ana_3.gif)
...
2. In the "General" tab: 
	...
	- Copy the Measurement ID of your site: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Google_Analytics%20-%20HC%20N%B0001.gif&type=thumb)
