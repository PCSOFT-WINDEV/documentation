...
- ![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) These transition effects are taken into account when **&lt;Image&gt;.Next** is used . 

- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) These transition effects are ignored when **&lt;Image&gt;.Next** is used. Indeed, the page is entirely refreshed. To take these effects into account, you must use a code in Ajax mode. 
...
[ImageNext (Function)](../WDLang2/1000019431.md)
