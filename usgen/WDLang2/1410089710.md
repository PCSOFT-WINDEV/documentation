...
This can be done from a WINDEV application or WEBDEV website.

These are some of the actions that can be automated:

- Manage a WEBDEV account: create, delete, list accounts, ...

- Manage connections: list connections, disconnect users, find out how many users are connected, etc.
