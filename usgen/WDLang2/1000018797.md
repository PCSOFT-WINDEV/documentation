...
***In french: UploadTailleFichierEnCours***
...
<a name="which_event_should_use_this_function_ELTPARAGRAPHE000048"></a>

**UploadCurrentFileSize** can only be used in the browser event "Progress of transfer". This event is associated: 
...
Used in another event, **UploadCurrentFileSize** will return 0.
<a name="NOTE0_2"></a>
