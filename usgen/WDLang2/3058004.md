...
Name of the page whose context must be opened. If this parameter is an empty string (""), the name of the page corresponds to the page to which the current process belongs.
