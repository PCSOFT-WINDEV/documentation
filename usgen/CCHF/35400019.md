...
2. A new tab corresponding to the new query is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_HF_Requ%EAtes%20-%20HC%20N%B0001.gif)
...
Note: You can also create a query via a wizard. 
...
<a name="query_ribbon_options_ELTTEXTE000123"></a>
The query ribbon includes the following options: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_HF_Requ%EAtes%20-%20HC%20N%B0001%201.gif)
...
- View EXPLAIN: The HFSQL Control Center can also be used to display the EXPLAIN of a query. 
...
- Start a transaction: Starts a transaction before executing the query. Once the transaction has started, you can validate it at any time by selecting "Commit transaction". 
...
- Query history: Gets a list of queries made from the HFSQL Control Center, whether or not they were successfully executed. 
