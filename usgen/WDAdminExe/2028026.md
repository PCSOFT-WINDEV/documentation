...
The "Control" tab of WDADMINEXE is used to manage the application status and the messages displayed according to this status: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDAdminExe%20-%20HC%20N%B0001.gif)
...
The control duration options are as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDAdminExe%20-%20HC%20N%B0001%201.gif)
...
The "Control" tab of WDADMINEXE allows you to manage how the application checks for updates: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WDAdminExe_2%20-%20HC%20N%B0001.gif)
...
[WDADMINEXE: User characteristics](../WDAdminExe/2028014.md)
