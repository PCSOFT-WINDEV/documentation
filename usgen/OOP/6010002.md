...
<a name="overview_object_ELTTEXTE000216"></a>
...
An object can be passed as parameter to a function or to a procedure.

**Remark**: It is possible to dynamically instantiate an object to a. The implementation of polymorphism requires the dynamic instantiation. For more details, see [Dynamic instantiation](../POO/6010003.md).

Example object: "SourceFile" is an object of class "File".. For this object, you have the ability to handle the members named "Name", "Extension", etc.
...
<a name="syntax_for_declaringinstantiating_object_ELTTEXTE000240"></a>


### Declaring/Instantiating an object
<a name="declaringinstantiating_object_ELTPARAGRAPHE000054"></a>
...
<a name="declaringinstantiating_null_object_ELTPARAGRAPHE000078"></a>
...
- the declared variable behaves as if the declaration were non-dynamic: the = operator copies the members.
...
### Note: Object in progress
<a name="note_object_progress_ELTPARAGRAPHE000092"></a>
...
### Members and methods
<a name="members_and_methods_ELTPARAGRAPHE000103"></a>
...
<a name="lifespan_object_ELTTEXTE000282"></a>


### Reference on a local object
<a name="reference_local_object_ELTPARAGRAPHE000115"></a>
...
### Returning an object
<a name="returning_object_ELTPARAGRAPHE000130"></a>

You have the ability to return an object handled by a dynamic or non-dynamic local variable.

**Remark**: In previous versions, it was only possible to return an object manipulated by a dynamic local variable.
<a name="NOTE3_3"></a>


### Objects in the loops
<a name="objects_the_loops_ELTPARAGRAPHE000139"></a>
...
### Freeing the object
<a name="freeing_the_object_ELTPARAGRAPHE000155"></a>
...
**Remark**: This is an advanced syntax to be used only in very specific cases.. In most cases, the destroy operation is automatic.

**Reminder** As a general rule, there is no need to use the keyword LIBERER. The WLanguage automatically destroys the objects that are no longer used by any variable. The most common cases are:
