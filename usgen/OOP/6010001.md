...
<a name="syntax_class_constructor_ELTTEXTE000377"></a>
...
Note: To modify the scope of the constructor, you can use the context menu on the method in the project explorer.
...
**Object declaration: constructor is automatically called**
...
<a name="note_regarding_the_constructors_ELTTEXTE000413"></a>
...
**Caution**: The assignment operator (=) does not behave in the same way with dynamic or non-dynamic objects.. Using the o2 and o3 objects in the assignments will trigger a different behavior:
...
<a name="syntax_constructors_for_the_base_classes_and_members_ELTTEXTE000437"></a>
...
<a name="syntax_the_destructor_method_ELTTEXTE000503"></a>
**Method declaration**
