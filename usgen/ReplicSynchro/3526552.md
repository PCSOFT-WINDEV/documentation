...
The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Connexion_directe.gif) /  ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Connexion_directe1.gif) icon is used to switch from online to offline.

The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Cr%E9er_cpt.gif) icon is used to add a new replication.

The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Supprimer.gif) icon is used to delete the selected replication from the list.
<a name="NOTE2_3"></a>
