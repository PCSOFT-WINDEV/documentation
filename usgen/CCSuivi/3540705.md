...
The schedule is displayed by the Project Management Hub in a "Schedule" tab. This schedule takes into account the standard tasks displayed in the "Tasks" tabs. 
...
<a name="displaying_and_printing_the_schedule_ELTPARAGRAPHE000030"></a>The schedule is displayed via a "Schedule" tab. The schedule of current contributor is displayed by default. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Gestion_Planning%20-%20HC%20N%B0001.gif&type=thumb)
The schedule of each contributor can be displayed on an hourly, daily or weekly basis, via the context menu of the schedule. 
...
- If time management is not enabled, the working hours and the working days configured in the Project Management Hub.
...
Contributors can easily indicate their current task. They can simply go to the "Tasks" tab and select "Start task". The name of the current task is displayed:

- in a tooltip found in the taskbar (above the icon of the Project Management Hub).
...
The Project Management Hub can be minimized ("Minimize" button or Esc key on the keyboard).

**To indicate that the task is completed**, you must: 

- display the Project Management Hub, 
...
The Project Management Hub allows you to quickly view the schedule overrun in the "Tasks" tabs and in the "Schedule" tabs. The relevant tasks are highlighted in a specific color or with specific hash marks.
...
3. In the window that is displayed, specify the color that will be used to: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Gestion_Planning%20-%20HC%20N%B0002.gif)
