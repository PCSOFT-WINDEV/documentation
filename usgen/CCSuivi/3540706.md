...
To configure these parameters in the Project Management Hub, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) and select "Schedules and leaves".

**Remark**: If time management support is enabled, the configuration of working days and working hours is not taken into account when calculating the time spent on a task.. This information is only taken into account when establishing the schedule, for calculating time periods. For more details, see [Using the schedule and the task management](../CCSuivi/3540713.md).
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_Suivi_Configuration%20-%20HC%20N%B0002.gif&type=thumb)
...
<a name="configuring_working_hours_ELTPARAGRAPHE000045"></a>Configuring the working hours is used to define the working hours for each half day.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_Suivi_Configuration%20-%20HC%20N%B0002_1.gif)
**Remarks**:

- During lunch, no specific action needs to be taken: the task does not need to be stopped.
...
The leave configuration window allows you to define non-working days . <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_Suivi_Configuration%20-%20HC%20N%B0003.gif&type=thumb)
This data will be taken into account by the schedule.

Two types of leaves can be viewed:

- **Personal leave**: these are the vacations entered by the contributor.

- **Suggested leave**: these are the vacations proposed by the administrator (this option is reserved for administrators).. To manage a project efficiently, leaves must be scheduled for all the contributors at the same time (or around the same time). The Project Management Hub gives the administrator the ability to suggest leave dates for all contributors.
...
- Vacation periods are taken into account by the messaging application when writing a message: when entering the name of one or more contributors, the list of recipients on vacation will be displayed.. 
...
The Project Management Hub can be used to set remote work periods. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_Suivi_Configuration%20-%20HC%20N%B0004.gif&type=thumb)
...
- Teleworking periods are taken into account by the messaging application when writing a message: when entering the name of one or more contributors, the list of teleworking recipients will be displayed.
