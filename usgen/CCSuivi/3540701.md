...
1. Start the search using one of the following methods: 
	...
	- Expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_Suivi_Configuration%20-%20HC%20N%B0001.gif) and select "Find items (Ctrl + Shift + F)".

	- Press Ctrl + Shift + F directly. 

	- Use the search box in the Project Management Hub title bar. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_Suivi_Tag%20-%20HC%20N%B0001%203.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CC_Suivi_Presentation%20-%20HC%20N%B0001.gif)
...
**Note**: Only an administrator can authorize "Guest" mode. The "Guest" mode is not available if the tables of Control Centers are in HFSQL Client/Server format.
<a name="NOTE3_6"></a>
