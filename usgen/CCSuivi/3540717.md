...
3. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeAjouterPropriete.gif) and select "New list of requirements". 

4. In the window that appears, you can specify the characteristics of the list in the "General" tab:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Exigence_Creation%20-%20HC%20N%B0002.gif)
...
3. In the tab ribbon, click "New requirement" and select the requirement creation mode: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Creation_Exigence_simple26%20-%20HC%20N%B0001.gif)
...
If you choose "Quick creation", a simplified requirement creation window is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Creation_Exigence_simple26%20-%20HC%20N%B0002.gif&type=thumb)
...
In "Contributors", you can easily associate tasks to the corresponding contributors. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Creation_Exigence_simple26%20-%20HC%20N%B0003.gif&type=thumb)
...
- directly from the requirements management window: in the "Requirements" pane, in the "Management" group, click on "Requirement lists".. In the window that is displayed, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=IconeAjouterPropriete.gif), "New requirement" option.
...
**To create an template for a**requirement, simply create a new requirement and indicate in the requirement's description window that the requirement is an template (check box "Requirement is an template").
