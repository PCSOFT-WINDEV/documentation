...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=cc_Suivi_gantt%20-%20HC%20N%B0001.gif&type=thumb)
...
On the "Gantt chart" tab, you have the ability to: 
...
On the "Gantt chart" tab, you have the ability to print the Gantt chart ("Print" in the ribbon of the "Gantt chart" tab).
