...
WINDEV and WEBDEV 2026 include a Native MariaDB Connector (also called Native MariaDB Access). This Native Connector allows you to access a MariaDB database from a WLanguage program without using any external driver.

**Attention**: This version of the MariaDB Native Connector only works with WINDEV and WEBDEV version 2026.

**Remark**: The MariaDB Native Connector is a free optional module available for download at [the PC SOFT site](https://www.windev.com).
...
<a name="required_configuration_ELTTEXTE000244"></a>
...
### Native MariaDB Connector requirements
<a name="native_mariadb_connector_requirements_ELTPARAGRAPHE000031"></a>
...
### Required files
<a name="required_files_ELTPARAGRAPHE000055"></a>
...
- The ***DLL wd310maria.dll***: Necessary for the 32-bit Native Connector to a MariaDB database. This file is provided with the Native MariaDB Connector for WINDEV and/or WEBDEV.

- The ***DLL wd310maria64.dll***: Necessary for the 64-bit Native Connector to a MariaDB database. This file is provided with the Native MariaDB Connector for WINDEV and/or WEBDEV.
...
<a name="installing_new_version_mariadb_ELTPARAGRAPHE000080"></a>
...
<a name="files_required_use_native_mariadb_connector_linux_ELTPARAGRAPHE000093"></a>
...
**2.** If you are using a WEBDEV website, copy the following DLLs into the directory of WEBDEV Application Server:

- wd310hf.so: HFSQL library

- wd310maria.so: 32-bit native connector library

- wd310maria64.so: 64-bit native connector library
...
## Use
<a name="use_ELTTEXTE000286"></a>


### Using Native MariaDB Connector in your WINDEV applications and WEBDEV websites
<a name="using_native_mariadb_connector_your_windev_applications_and_webdev_websites_ELTPARAGRAPHE000141"></a>

To use Native MariaDB Connector, you must program in the WINDEV application or in the WEBDEV website:
...
- The option "Automatically create the tables when they are opened" ("Files" tab in the project description) is taken into account by the Native MariaDB Connector. 
...
<a name="optimizing_hfsql_functions_ELTPARAGRAPHE000170"></a>
