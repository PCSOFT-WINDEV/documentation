...
**Note**: WLanguage also offers functions for handling dates and times (see date and time functions).
...
## Addition
<a name="addition_ELTTEXTE000313"></a>
...
| Added type<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif) | Date | Time | DateTime | Duration |
| --- | --- | --- | --- | --- |
...
## Subtraction
<a name="subtraction_ELTTEXTE000337"></a>
...
| Subtracted type<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif) | Date | Time | DateTime | Duration |
| --- | --- | --- | --- | --- |
...
## Comparison
<a name="comparison_ELTTEXTE000361"></a>
...
| Compared type<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=fleche2.gif) | Date | Time | DateTime | Duration |
| --- | --- | --- | --- | --- |
