...
Value to be assigned to the variable. A YAML variable can be assigned with:
...
<a name="importing_yaml_files_ELTPARAGRAPHE000064"></a>
...
Note: It is also possible to obtain compilation assistance and verification on a YAML subpart using the following syntax: 
...
<a name="assignment_and_reading_ELTPARAGRAPHE000108"></a>

**Assigning a YAML variable**
The "j = ..." syntax tries to analyze the value as a YAML string. This notation is "almost" equivalent to the notation "j.FormatYAML = ..." **except** if the YAML format string is invalid: it is then copied directly, without interpretation, as the value of the YAML element.
...
Note: YAML imported and generated
...
### Managing references
<a name="managing_references_ELTPARAGRAPHE000138"></a>
...
<a name="properties_specific_yaml_variables_ELTPARAGRAPHE000147"></a>

The following properties can be used to define the characteristics of YAML variables:
...
| Type | Integer | Type of element. <br><br>**This property is read-only**. |
...
[JSON (Variable type)](../Motscles/1000023611.md)

[JSON variable functions](../Motscles/1410091296.md)
