...
|   |   |
| --- | --- |
| **Equality** | <br><br>- Strict equality: =<br><br>- Flexible equality: ~=<br><br>- Very loose equality: ~~ <br><br>- Starts with: [=<br><br><br> |
| **Comparison** | <br><br>- Different: &lt;&gt;<br><br>- Less than or equal to: &lt;=<br><br>- Greater than or equal to: &gt;=<br><br>- Strictly less than: &lt;<br><br>- Strictly greater than: &gt;<br><br>- Starts with: [=<br><br><br><br><br>- Starts with: [~ (ignores leading spaces and case).<br>	<br><br>- Starts with: [~~ (ignores all spaces, punctuation and case).<br>	<br><br>- Comparison with a list of values: IN<br><br>- Contains: [=]<br>	<br><br>- Contains: [~] (ignores case and leading and trailing spaces).<br>	<br><br>- Contains: [~~] (ignores all spaces, punctuation and case)<br>	<br><br>- Ends with: =]<br>	<br><br>- End with: ~] (ignores trailing spaces and case)<br>	<br><br>- End with: ~~] (ignores spaces, punctuation and case)<br>	<br><br><br> |
| **Comparison interval** | <br><br>- Strictly between: &lt; .. &lt; (and the opposite)<br>	Value1 &lt; x &lt; Value2<br><br>- Between: &lt; .. &lt;= AND &lt; .. = &lt; (and vice versa)<br>	Value1 &lt;= x AND x &lt;= Value2<br><br>- Between (inclusive boundaries): &lt;= &lt;= (and vice versa)<br>	Value1 &lt;= x &lt;= Value2<br><br>- Between (including bounds): x A y <br><br><br> |
...
## Details
<a name="details_ELTTEXTE000522"></a>


### Loose equality and very loose equality
<a name="loose_equality_and_very_loose_equality_ELTPARAGRAPHE000264"></a>
...
**HFSQL** Equivalence: To find the very flexible equality equivalence when searching on a Text key in an HFSQL data file, it is necessary to configure the following options when describing the field in the analysis:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Indexation%20des%20m%E9mos%20-%20HC%20N%B0002.gif)
![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) The comparison takes into account the accented lowercase characters in Browser code.![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) The "Very loose equality" operator is not available in browser code.
```wl
...
<a name="equality_and_comparison_real_containing_more_than_6_different_decimal_places_ELTPARAGRAPHE000287"></a>
...
<a name="comparison_intervals_ELTPARAGRAPHE000300"></a>
...
- Example 2: 
	...
	- IF x=5 TO 10 THEN ...
			![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) Not supported.
...
<a name="comparison_operators_and_unicode_ELTPARAGRAPHE000324"></a>
...
<a name="NOTE2_5"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![Linux](https://doc.pcsoft.fr/ext/images/us/LX.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![User code (UMC)](https://doc.pcsoft.fr/ext/images/us/MCU.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) 

### Comparing instances of structures and instances of classes
<a name="comparing_instances_structures_and_instances_classes_ELTPARAGRAPHE000415"></a>
...
### IN operator
<a name="operator_ELTPARAGRAPHE000436"></a>
...
[StringCompare (Function)](../Motscles/3024011.md)
