...
## Use
<a name="use_ELTTEXTE000395"></a>
The operations on binary values are performed:

- with WLanguage functions: [BitwiseAND](../WDLang1/3050010.md), [BitwiseOR](../WDLang1/3050038.md), [BitwiseNOT](../WDLang1/3050011.md), [BitwiseXOR](../WDLang1/3050023.md).
...
## Bitwise operators
<a name="bitwise_operators_ELTTEXTE000419"></a>


### Binary AND, OR and exclusive OR
<a name="binary_and_and_exclusive_ELTPARAGRAPHE000055"></a>
...
- Exclusive OR binary: **&lt;Value 1&gt; ||**&lt;Value 2&gt;
...
### Binary NOT
<a name="binary_not_ELTPARAGRAPHE000111"></a>
...
## Shift operators
<a name="shift_operators_ELTTEXTE000449"></a>


### Syntaxes
<a name="syntaxes_ELTPARAGRAPHE000139"></a>
...
### Notes
<a name="notes_ELTPARAGRAPHE000151"></a>
...
| Other | 8-byte integer |
	...
	![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) The operator for left binary shift will reinject from the right the bits that exceed the operand size. The operator for right binary shift will reinject from the left the bits that exceed the operand size. For example:
...
<a name="operator_for_direct_access_the_bits_ELTTEXTE000479"></a>


### Access to a bit
<a name="access_bit_ELTPARAGRAPHE000202"></a>
...
n is int = 0
// Bit number 1 is set: n is decimal 1
n[1] = 1 
// Bit number 8 is also set: n is 129 in decimal (2 to the power of 0 + 2 to the power of 7)
n[8] = 1
```
...
<a name="access_1_2_4byte_integer_ELTPARAGRAPHE000238"></a>
...
<a name="access_the_value_several_bits_ELTPARAGRAPHE000307"></a>
...
[Bitwise operation functions](../Motscles/3050012.md)
