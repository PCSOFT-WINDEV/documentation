...
This SQL code can manipulate a variable of type SQL Request. 
...
<a name="declaration_syntax_remarks_ELTPARAGRAPHE000059"></a>

- The query must be defined as soon as it is declared. It is not possible to declare a variable of type SQL Query and then enter the corresponding SQL code after a few lines of code. 

- When declaring SQL Query variables, you can launch the query editor wizard to write the SQL code of the query. Simply select "SQL query (wizard)". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Requ%EAteSQL_WL%20-%20HC%20N%B0001.gif)
...
- The tables used in the FROM of the query must be declared in the project database schema. They cannot come from data sources initialized by an alias, external declaration or other request.
...
- When the SQL query is declared, it can be used in another variable of type SQL Query. For example: 


	```wl
	reqVols is a SQL query =
	[
		SELECT * FROM  Flights
...
### SQL code of the query
<a name="sql_code_the_query_ELTPARAGRAPHE000097"></a>
...
- Completion: Completion is available: 
	...
	- for the items and the tables,

	- for the output items of query. <br>![The assisted SQL input](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=151-sql_completion_rubriques.jpg)





- Compilation errors: In the event of an error in the query's SQL code, a compilation error is generated (as with WLanguage code). <br>![Error of SQL code detected in input](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=152-sql_code_erreur.jpg)
...
- Like for an SQL query typed in the query editor, you can: 
	...
	- type WLanguage functions. The WLanguage functions must be prefixed by "WL.". Assisted input is available. 
			![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png) You cannot run SQL queries containing WLanguage functions. 
...
<a name="using_sql_queries_ELTPARAGRAPHE000124"></a>
...
### HFSQL context
<a name="hfsql_context_ELTPARAGRAPHE000158"></a>
...
[Creating a query in SQL code](../Motscles/2032060.md)

[SQL commands available in an SQL query ](../Motscles/2034006.md)

[SQL selection conditions ](../Motscles/2034008.md)

[SQL functions that can be used in SQL queries](../Motscles/2034005.md)

[HExecuteQuery (Function)](../Motscles/3044080.md)

[HExecuteSQLQuery (Function)](../Motscles/3044084.md)

[SQL statements ](../Motscles/2034001.md)
