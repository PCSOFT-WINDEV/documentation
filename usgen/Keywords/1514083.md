...
- 128-bit and 256-bit UUID items are available in the database schema.
...
For more details, see [Database schema editor: the different types of sections](../Editeurs/2011026.md). 
<a name="NOTE0_6"></a>
