...
| *&lt;end event&gt;* | Used to specify that this procedure will be executed when the process containing the procedure call is finished. For more details, see ["At the end of the event containing the call"](#NOTE3_3).<br><br>This extension attribute is not compatible with **&lt;thread&gt;** and **&lt;main thread&gt;**.<br><br>Additionally, you can see the help about [Automatic procedures](../Editeurs/9000072.md). |
| *&lt;end process&gt;* | Used to specify that this procedure will be executed when the process containing the procedure call is finished.<br><br>This extension attribute is not compatible with **&lt;thread&gt;** and **&lt;main thread&gt;**.<br><br>Additionally, you can see the help about [Automatic procedures](../Editeurs/9000072.md). |
