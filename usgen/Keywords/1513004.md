...
- [Use a WLanguage function in an SQL query run by the HFSQL engine](#NOTE3_1).
	Note: The keyword "**WL.**"keyword also allows you to use a WLanguage constant in a SQL query containing a WLanguage function.
...
<a name="overloading_wlanguage_function_ELTTEXTE000304"></a>
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png)![Apple Watch](https://doc.pcsoft.fr/ext/images/us/APPLEWATCH.png)![Java](https://doc.pcsoft.fr/ext/images/us/JAVA.png)![User code (UMC)](https://doc.pcsoft.fr/ext/images/us/MCU.png) 
...
<a name="how_overload_wlanguage_function_ELTPARAGRAPHE000060"></a>
...
- You have the ability to overload functions that handle windows, pages or reports. Simply use the following notation to define the parameter corresponding to the desired element in the procedure that overloads the function: 
	...
	- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WINDEV Mobile](https://doc.pcsoft.fr/ext/images/us/WM.png) For the windows, the parameter must be defined by the following notation "WindowName is string &lt;window name&gt;". For example, to overload [Open](../WDLang1/3038035.md), the procedure code will be: 
	...
	- ![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) For the pages, the parameter must be defined by the following notation "PageName is string &lt;page name&gt;". For example, to overload [PageDisplay](../WDLang2/3058008.md), the procedure code will be: 
...
<a name="differentiating_between_the_wlanguage_function_and_the_custom_function_ELTPARAGRAPHE000121"></a>If a WLanguage function was overloaded and if you want to use the initial function, the name of the function must be prefixed by **WL**. The following syntax must be used:
...
<a name="using_wlanguage_functions_the_sql_queries_for_hfsql_ELTTEXTE000340"></a>


### Overview
<a name="overview_ELTPARAGRAPHE000135"></a>

A WLanguage function can be used in an SQL query. This SQL query can be executed on HFSQL tables. You can for example use the WLanguage functions to create advanced selection conditions.  
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) In Android, you can use WLanguage functions in SQL queries only: 
...
WLanguage functions cannot be used in an [SQL query](../Motscles/1514082.md).
<a name="NOTE3_2"></a>


### How to?
<a name="how_ELTPARAGRAPHE000163"></a>
...
### Remarks
<a name="remarks_ELTPARAGRAPHE000190"></a>
