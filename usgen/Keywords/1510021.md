...
This parameter is defined in the description window of the current configuration ("Unicode" tab).  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Instruction%20de%20compilation%20COMPILE%20-%20HC%20N%B0001.gif)
