...
**Note**: In this case, the &lt;Value to return&gt; must be an integer. This value can be retrieved by any application. For a WINDEV application, the value returned by another application can be retrieved by [ExeRun](../WDLang1/3035006.md).  
...
Note: These instructions can also return several values. For more details, see [Multiple return values](#NOTE0_4).
<a name="NOTE0_2"></a>
...
[Close (Function)](../Motscles/3038018.md)

[Assignment of RETURN](../Motscles/1510015.md)
