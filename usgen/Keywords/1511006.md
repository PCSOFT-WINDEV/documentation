...
| [MyBottomSlidingWindow](../Motscles/1511030.md) | handle low sliding window associated with current window. |
...
| [MyParameters](../Motscles/1511018.md) | Allows you to handle the parameters of an Procedure WLanguage (classic Procedure or Procedure with number of Variable parameters). |
...
| [MyParent](../Motscles/1511016.md) | Allows you to handle the current Supercontrol from one of its fields. |
