...
<a name="font_characteristics_ELTPARAGRAPHE000102"></a>
...
<a name="font_management_properties_ELTPARAGRAPHE000126"></a>

The following properties can be used to handle **Font** variables:
...
| [Charset](../Proprietes/2512008.md) | Returns and changes the character set used by a Font variable.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Not available. |
...
| [Orientation](../Proprietes/1410086632.md) | Returns and changes the angle (in degrees) of a Font variable.<br><br>![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png)![Android Widget ](https://doc.pcsoft.fr/ext/images/us/ANDROIDWIDGET.png) Not available. |
...
<a name="functions_that_use_font_variables_ELTPARAGRAPHE000217"></a>The following functions can be used to handle **Font** variables:
...
[Font management properties](../Motscles/2515045.md)

[Declaring and using a variable](../Motscles/1514032.md)

[LineSpacing (Property)](../Motscles/1410088366.md)

[CharacterSpacing (Property)](../Motscles/1410088367.md)
