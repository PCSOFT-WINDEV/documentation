...
A project can be opened in any IDE regardless of the one that was used to create it.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Format_compatible%20WB%20-%20HC%20N%B0001.gif)
...
For example, if you open a WINDEV project in WEBDEV, you will be able to create a project configuration named "Site", to group all the elements required by the WEBDEV website.
