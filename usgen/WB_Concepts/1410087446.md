...
<br>![A repository contains a collection of project elements. Each computer has a local copy of the elements required for development](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P34-GDS.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=GestionnaireDeSources.gif)
