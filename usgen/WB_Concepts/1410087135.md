...
<a name="which_page_display_ELTTEXTE000248"></a>
The page to display can be defined:

- in the page editor (no programming required).
...
When the target depends on a choice made by the user, this target must be defined programmatically. For example, if the user does not enter their password, an error page will appear in a new browser tab; otherwise, the next page will appear in the current browser.

[ChangeTarget](../WDLang2/3058005.md) is used to change the target of an action programmatically. This function must be used in browser code.
...
When choosing the target for a Button, Link, Image control (with clickable areas), menu option, etc., you can select:
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2-Navigateur%20en%20cours%20_top.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2-Frame%20en%20cours%20_self.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2-Frame%20parent%20_parent.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2-Nouveau%20navigateur%20_blank.gif)
