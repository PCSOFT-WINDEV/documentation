...
For your WEBDEV site to be visited, Internet users must be able to find it. To do so, your site must come up when the user enters keywords that match your site in a search engine.
<a name="NOTE1_2"></a>


### Improving the SEO of a WEBDEV website
<a name="improving_the_seo_webdev_website_ELTPARAGRAPHE000017"></a>
...
Note: In AWP, to pass parameters between your pages, we advise you to pass them via the URL rather than using AWP contexts. The URL content can be optimized whereas AWP contexts cannot. 
<a name="NOTE1_3"></a>
...
- ***SEO attributes for each static and Active WEBDEV Page***: For each page, you can define a description and a set of keywords. These keywords will allow users to access the page directly. You can also choose not to optimize a page.
...
2. On the "Details" tab, a specific area is used to manage the page SEO.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_R%E9f%E9rencement_cpt%20-%20HC%20N%B0002.gif&type=thumb)
...
## Defining the SEO keywords of a page
<a name="defining_the_seo_keywords_page_ELTTEXTE000312"></a>
To optimize a static or Active WEBDEV Page of your site:
...
4. ***In the "Keyword" tab of the SEO window***, enter the keywords associated with the page. These keywords (or expressions) will be the keywords used to reference the page: when the Web user enters one of these keywords, the search engine will propose the corresponding page. To enter keywords, simply type the desired keyword and press Enter.
	Tips:
 ...
 **Note**: These keywords can be modified dynamically, using the [Keywords](../Proprietes/1000017163.md) property.
...
Sites are optimized directly on search engines.

**Note**: SEO is sometimes a paid service.
...
- **"Directory" search engines**:
	...
	**How can I get my site optimized**?
	...
	2. Fill out a questionnaire about the site to reference: Internet address of the site, email of Webmaster, site description, ...
