...
<br>![Define the layout rules of the Flexbox control according to the size of the browser](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Flexbox-card.png)



|   |   |
| --- | --- |
| <br>![Resize images proportionally](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Flexbox-card-3.png)<br> | <br>![Reduce image width](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Flexbox-card-2-navigateur.png)<br> |
