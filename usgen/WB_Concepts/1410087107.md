...
The following operations are performed to display a WEBDEV page in Session mode:
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=mode-dynamique-WebDev.gif)
