...
| [AJAXExecute](../WDLang2/3055114.md) | Executes a server procedure without refreshing the page. |
| [AJAXExecuteAsynchronous](../WDLang2/3055115.md) | Executes a server procedure without refreshing the page. |
...
| [DynamicSiteDisplay](../WDLang2/3058024.md) | Starts a dynamic WEBDEV website from a static page or from a dynamic WEBDEV page. |
...
| [fWebDir](../WDLang1/3036052.md) | Returns the physical name of the directory containing the images, JavaScript files and Java files of the WEBDEV website. |
...
| [HTMLClassToggle](../WDLang2/1000021551.md) | Toggles a class in the HTML classes of a control: the class is added if it does not exist, the class is deleted if it already exists. |
...
| [JSONExecute](../WDLang2/1000017284.md) | Calls the URL of a page on the server that returns data in JSON format (JavaScript Object Notation). |
...
| [PageToSource](../WDLang4/1000017406.md) | Automatically updates:<br><br>- the value of the items in a table with the value of the controls in the page.<br><br>- the value of the WLanguage variables with the value of the page controls.<br><br><br> |
...
| [SiteAddress](../WDLang2/3058023.md) | Returns the Internet address for connecting to a dynamic WEBDEV website (in Session mode) found on the same server. |
| [SourceToPage](../WDLang4/1000017405.md) | Automatically updates the controls of a page with: <br><br>- the values of the bound items in the current record (loaded in memory) of the HFSL table described in the data model editor.<br><br>- the values of the bound WLanguage variables.<br><br><br> |
