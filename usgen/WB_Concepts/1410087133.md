...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
Most organizations use a standardized appearance and layout for their print jobs, for example, a date in the upper-right corner in a specific format, a page footer with print time and file name, a logo in the upper-left corner, etc.
...
|   |   |
| --- | --- |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Modeles%20d'etats%20WB%20-%20HC%20N%B0001.gif&type=thumb)<br> |
| View of a report template<br>in the report editor. |
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Modeles%20d'etats%20WB%20-%20HC%20N%B0002.gif&type=thumb)<br> | <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Modeles%20d'etats%20WB%20-%20HC%20N%B0003.gif&type=thumb)<br> |
...
- via the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P1_ICO_Cr%E9er_cpt.gif) icon in the quick access buttons. In the "New" window, click "Report", and then "Report template". 
