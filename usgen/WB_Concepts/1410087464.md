...
<a name="choosing_the_languages_supported_the_project_and_the_analysis_ELTTEXTE000381"></a>
...
2. On the "Languages" tab, you can add or delete the languages supported by the project.
...
2. Open the analysis description window. To do so, go to the "Database schema" tab, "Current element" group, and select "Description".
...
<a name="translating_the_interface_into_multiple_languages_ELTTEXTE000417"></a>
...
1. Open the WEBDEV options and define the translation settings. Go to the "Home" tab, "Environment" group, expand "Options", and select "General WEBDEV options".

2. On the "Translation" tab, choose:
...
2. Customize error handling to use HFSQL error pages ([HOnError](../WDLang4/3044017.md)).
...
To translate a site that uses the User Groupware, select the "Manual start" mode when integrating the User Groupware into the site. Reminder: To configure the User Groupware, go to the "Project" tab, "Project" group, and select "User Groupware".
...
3. Type the translation and validate. The line of code is displayed in the code editor: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=code-drapeau.gif)


	- The ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=code-drapeau%201.gif) icon indicates that this string has been translated to other languages. Click the icon to open the translation window.
...
<a name="choosing_the_language_programmatically_ELTTEXTE000465"></a>
