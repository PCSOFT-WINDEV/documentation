...
<a name="implementing_secure_transactions_via_the_tlsssl_protocol_ELTTEXTE000129"></a>
...
<a name="securing_transactions_via_tlsssl_webdev_website_ELTTEXTE000153"></a>
Generally, only the transfer of sensitive data needs to be secured. A common example is credit card information. The secure mode is slower. However, a growing number of sites are operating entirely in TLS/SSL thanks to the increase in machine power, which ensures greater confidentiality of user operations.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4-TLS-SSL%20Crypter%20les%20informations%20sur%20le%20web.gif)
