...
- Share elements between multiple projects, via the SCM (Source Code Manager).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P36-Composant%20interne.gif)
