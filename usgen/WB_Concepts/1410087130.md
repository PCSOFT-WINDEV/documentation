...
**Here's a simple example: Creating a contact in a directory**.
...
Then, the image will be displayed in the contact form.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2-upload%20envoi%20de%20fichiers%20vers%20le%20serveur.gif)
...
**Note**: WEBDEV also includes an Upload Smart control. This control supports progress bars, multiple file selection, etc.
