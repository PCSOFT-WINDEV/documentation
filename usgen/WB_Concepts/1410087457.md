...
<a name="NOTE1"></a>
<a name="NOTE1_1"></a>
WEBDEV allows you to manage business rules. A business rule is used to define a specific operating mode or particular process. For example: Calculation of a specific VAT rate, rules for changing the status of a customer, formula for calculating shipping costs, commercial commission, discount rate, depreciation rate, etc.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P3-Gestion%20des%20r%E8gles%20m%E9tier.gif)
