...
1. Run the installation package (WX2026PACKROBOT.EXE) on the computer where the monitor is to be installed. The setup wizard starts. 
	Reminder: The installation package (WX2026PACKROBOT.EXE) is available in the "Install\\Robot" subdirectory of the product used.
...
5. Go to the next step. Validate. Monitor settings are complete.
