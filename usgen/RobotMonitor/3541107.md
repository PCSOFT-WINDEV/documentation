...
1. In the menu, go to the "Categories and checks" group, click "Add" and select "Add a category" (or select "Create a category" in the context menu of the table).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Robot_Cr%E9er%20un%20controle%20-%20HC%20N%B0002%201.gif)
...
1. In the menu, go to the "Categories and checks" group, click "Add" and select "Add a check" (or select "Create a check" in the context menu of the table). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Robot_Cr%E9er%20un%20controle%20-%20HC%20N%B0002.gif)


2. The check configuration window appears. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Robot_Cr%E9er%20un%20controle%20-%20HC%20N%B0003.gif&type=thumb)
