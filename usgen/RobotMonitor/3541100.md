...
Made up of three executables launched on different workstations, the monitoring robot can be used to run various tests: Internet test, FTP server test, network test, etc.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P5-Surveillez%20vos%20applications.gif)
...
To use the monitoring robot, you must install the different programs of the monitoring robot. The installation package (WX2026PACKROBOT.EXE) is available in the "Install\\Robot" subdirectory of the IDE used.
...
2. [Installation of counter-robot if required](../RobotMonitor/3541102.md). The Robot controller is an additional security tool. It is used to check whether the monitoring robot operates properly.
...
**Note**: All three programs must be installed on the same local network or domain.
...
- Configure:
	...
	- [the Robot controller](../RobotMonitor/3541106.md)
...
[Installing the monitoring robot](../RobotMonitor/3541101.md)

[Installing the monitor](../RobotMonitor/3541103.md)

[Installing the robot controller](../RobotMonitor/3541102.md)

[Monitoring robot: Robot controller settings](../RobotMonitor/3541106.md)

[Monitoring robot: Robot settings](../RobotMonitor/3541105.md)

[Managing users](../RobotMonitor/3541104.md)

[Handling the checks](../RobotMonitor/3541123.md)
