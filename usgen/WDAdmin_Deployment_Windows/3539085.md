...
<a name="generating_proxy_configuration_example_haproxy_ELTTEXTE000126"></a>
...
To generate a configuration example, click **"Get configuration elements for HAProxy"**. The following window appears: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=WBCluster_HAProxy.gif)


Warning: you need to know how to configure HAProxy to use this example.. 
...
## Proxy and security
<a name="proxy_and_security_ELTTEXTE000150"></a>
...
[Installing a WEBDEV Cluster](../WDAdminDeploiement/1410086635.md)

[Setting up a WEBDEV Cluster](../WDAdminDeploiement/2030070.md)
