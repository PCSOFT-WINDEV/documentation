...
- Find out the properties, methods, events and constants associated with an ActiveX. Then, this information can be used to control an ActiveX programmatically.
...
- from the editor: under the "Tools" pane, in the "Utilities" group, click on "WDXView",

- run the "WDXVIEW.EXE" file located in the "Programs" subdirectory of the WINDEV or WINDEV Mobile installation directory.
...
[WDXView: How to use](../WDXView/3526001.md)
