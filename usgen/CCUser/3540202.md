...
In the setup program creation wizard, in "Network setup: Check versions", you can click the "Advanced..." button to define whether the setup program must prompt the user to reference the application in the User Control Center.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CCUser%20-%20HC%20N%B0001.gif)
...
When installing the reference version of the application, an option allows you to reference the application in the User Control Center.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CCUser%20-%20HC%20N%B0002.gif)
...
- on the development computer: 
	...
	- Open the WINDEV options. To do so, go to the "Home" tab, "Environment" group, expand "Options" and select "WINDEV general options". 
...
- on a production site, in "Reference application in the User Control Center", (shown above), when installing the reference version on the server.
...
[User Control Center: Administration of network applications](../CCUser/3540203.md)
