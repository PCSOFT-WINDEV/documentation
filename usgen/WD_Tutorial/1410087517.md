...
## Lesson 6 - Procedures
<a name="lesson_6_procedures_ELTTEXTE000612"></a>
...
## My first procedure
<a name="first_procedure_ELTTEXTE000672"></a>
...
1. On the "Code" tab, in the "Procedures" group, expand "New" and select "New global procedure". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Ma_premiere_procedure%20-%20HC%20N%B0001.jpg)


2. In the window that appears, a default name is displayed for the set of global procedures. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Ma_premiere_procedure%20-%20HC%20N%B0002.jpg)
Keep this name and click "OK" to confirm. 

3. A new window is displayed, allowing you to enter the name of the procedure and its characteristics: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Ma_premiere_procedure%20-%20HC%20N%B0003.jpg)
Let's take a closer look at this window. You can: 
	...
	- indicate whether the procedure should be an "AI TOOL". In this case, the WLanguage procedure can be used by the conversational AI in the AI Chat control of your WINDEV application. For more details, see [&lt;AI TOOL&gt; statement](../Motscles/1512012.md). 
...
5. Let's test this code. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Projet_WD_GAF.jpg) in the quick access buttons. 

6. An information window appears. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P2_Ma_premiere_procedure%20-%20HC%20N%B0005.jpg)
...
## Procedure parameters
<a name="procedure_parameters_ELTTEXTE000723"></a>


### What is a parameter?
<a name="what_parameter_ELTPARAGRAPHE000287"></a>
...
7. Let's test this code. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Projet_WD_GAF.jpg) in the quick access buttons. 
...
<a name="passing_parameters_reference_value_ELTPARAGRAPHE000367"></a>
...
4. Let's test this code. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Projet_WD_GAF.jpg) in the quick access buttons. 
...
### Return a value
<a name="return_value_ELTPARAGRAPHE000421"></a>
...
<a name="mandatory_optional_parameters_ELTPARAGRAPHE000476"></a>
...
6. Let's test this code. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Projet_WD_GAF.jpg) in the quick access buttons. 
