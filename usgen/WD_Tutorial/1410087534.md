...
In our example, this search will be done on the "Order" table. The user will be able to select:
...
The UI of the "WIN_Menu" window is as follows:<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%20Recherhe%20Aper%E7u%20-%20HC%20N%B0001.jpg&type=thumb)
This UI includes:
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Cr%E9er1_GAF.jpg) in the quick access buttons. In the window that appears, select "Query". The query creation wizard opens.
...
4. Double-click the items in the database schema, to the left of the description window. The items taken into account are displayed in the middle of the screen. 
	Note: To see the items of the different tables, simply click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg) icon to the left of the table name.
	We want to display:

	- the order information. Expand the "Order" table (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg)) and double-click the following items: OrderID, Date, Status and TotalBT.

	- information regarding the customer who placed the order. Expand the "Customer" table (click the arrow ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg)) and double-click the "FullName" item.

	- the payment method. Expand the "PaymentMethod" table (click the arrow ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg)) and double-click the "Caption" item.


 The query description window is as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001.jpg&type=thumb)
...
5. The data will be sorted by date.
	...
	- In the window that appears, indicate an ascending sort on the item. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0002.jpg&type=thumb)


	- Validate.

6. A blue arrow with the number 01 appears to the right of "Order.Date". This arrow indicates that an ascending order has been defined on the item. The number "01" indicates that this sort will be applied first. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0003.jpg)


7. In "Query name", replace "QRY_NoName1" with "QRY_FindOrders": <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0004.jpg)
...
10. The graphic query representation is displayed: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0005.jpg&type=thumb)
...
1. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Fenetre_WD_GAF.jpg).

2. The result is displayed in a window: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0006.jpg&type=thumb)
...
3. In the window that appears, we will specify that the selection condition corresponds to a parameter: 
	...
	- The "ParamStatus" name is automatically suggested.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0007.jpg)
...
4. Validate the condition description window. The number "1" appears to the right of the "Order.Status" item, indicating that a selection condition has been defined. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0008.jpg)
...
1. On the left part of the query description window, in the "Order" table, double-click "PaymentMethodID". The "PaymentMethodID" item appears in the list of query elements.

2. To avoid displaying this item in the result:

	- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0009%201.jpg) on the right of the item.
...
4. Validate the selection condition. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0009.jpg)
...
5. Validate the query description window. The query graph updates and takes the new selection conditions into account. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0010.jpg&type=thumb)


6. Save the query by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer_GAF.jpg) in the quick access buttons.
...
3. Define the following data:
	...
	- Select the ParamEndOfPeriod parameter. In the bottom section of the window, enter "03/31/2024". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0011.jpg&type=thumb)
...
6. In the "Static tab description" section, enter: "Find orders". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0001.jpg&type=thumb)


7. We will associate an image to the tab via the WINDEV image catalog. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Multilingue%20-%20HC%20N%B0014%201.jpg) on the right of "Image". Select "Catalog" in the context menu that appears. The image catalog window appears.

8. In the search area, specify "Search". Click the search icon to start the search.

9. Among the proposed images, select the icon representing the binoculars (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0002%201.jpg)) and validate.

10. Keep the default options in the image settings and confirm.

11. Validate the Tab control description window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0002.jpg)
...
4. The Table control will be based on the "QRY_FindOrders" query (created previously). Select "Display data from a table or existing query". Proceed to the next step of the wizard.

5. Select the query that will be used as data source for the Table control:

	- Expand the "Queries" group if necessary.

	- Select the "QRY_FindOrders" query. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0003.jpg&type=thumb)


	- Proceed to the next step of the wizard.

6. Select all suggested items if necessary. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0004.jpg&type=thumb)
...
10. Modify (if necessary) the position of the Table control so that it is entirely displayed in the tab pane. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0005.jpg&type=thumb)
...
2. Click the "COL_OrderID" column. The column title is displayed in the lower section of the screen. Replace "Order ID" with "ID". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%203%20Rech%20Multi%20IHM%20Table%20-%20HC%20N%B0001.jpg&type=thumb)
...
4. Click the "COL_FullName" column. Replace "Full name" by "Customer". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%203%20Rech%20Multi%20IHM%20Table%20-%20HC%20N%B0002.jpg&type=thumb)


5. Click the "COL_Caption" column. Replace "Caption" with "Payment method". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%203%20Rech%20Multi%20IHM%20Table%20-%20HC%20N%B0003.jpg&type=thumb)
...
9. Save the window by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer_GAF.jpg) in the quick access buttons. We will check the size of the columns by running the window.
...
2. Click the "Find orders" tab. Only a few orders are displayed, as when we specified the parameters in the query test window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0006.jpg&type=thumb)
...
In our database schema, the order status is saved in the "Status" item of the "Order" table. This item is a radio button.

To allow the user to select one of these three states, we will use a Radio Button control bound to the "Status" item of the "Order" table.Radio buttons allow users to choose only one option.
To create the Radio Button control:

1. Open the "Database schema" pane. Go to the "Home" tab, "Environment" group, expand "Panes", select "Panes", and then select "Database schema". The different tables defined in the "WD Full Application" database schema appear in the pane.

2. Click the ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Appli%20compl%E8te%20-%201%20Rech%20Multi%20Requete%20-%20HC%20N%B0001%201.jpg) icon to the left of the "Order" table to see its items.

3. Select the "Status" item in the Order table, then drag and drop it onto the "WIN_Menu" window.
...
By default, the Radio Button control only displays the available options. In our case, we will display the caption of the Radio Button control. To do so, simply select a style in the project theme to display the text of the control. To change this style:
...
5. Confirm. The style is immediately applied to the control in the editor. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0007.jpg&type=thumb)
...
1. Save the window by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer_GAF.jpg) in the quick access buttons.
...
4. Change the order status with the radio button and click "Find". The content of the Table control changes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0008.jpg&type=thumb)
...
An order can have several payment methods: cash, check, etc. The available payment methods are stored in the "PaymentMethod" table.

We will use an Combo Box control based on this table to allow the user to select the desired payment method.The Combo Box control displays a list of elements and allows users to select an element from the list.
...
1. On the "Creation" tab, in the "Usual controls" group, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Combo_WD_GAF.jpg).
...
4. Select "Display data from a table or existing query" and go to the next step.

5. Select the "PaymentMethod" table and go to the next step.
...
4. Click on the "Find" control. The content of the Table control changes. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%202%20Recherche%20Multi%20IHMM%20-%20HC%20N%B0011.jpg&type=thumb)
