...
In this lesson, we are going to create a window allowing the user to send an email from the "WD Full Application" application. This window is as follows: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0004.jpg&type=thumb)
...
1. On the "Creation" tab, in the "Usual controls" group, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Saisie_GAF.jpg).
...
3. Save the window (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer_GAF.jpg) or Ctrl + S).
...
The control used to type the recipient's address should list the addresses of the customers from the database, but should also allow the user to type another address. To do so, we will use an "Editable combo box" control linked to the Customer table.
...
4. Select the Customer table. Go to the next step.
...
1. On the "Creation" tab, in the "Usual controls" group, click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Saisie_GAF.jpg). The control shape appears under the cursor.
...
Align all controls in the window. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0002.jpg&type=thumb)
...
Save the window and its code (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer_GAF.jpg) or Ctrl + S).
...
3. The numbers change and appear in order. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0003.jpg&type=thumb)


4. Press F5 again to hide the numbers.

5. Save the window (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer_GAF.jpg) or Ctrl + S).
...
Test the project (click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Projet_WD_GAF.jpg) in the quick access buttons) and open the window for sending emails via "Menu .. Send an email". <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Application%20compl%E8te%20-%20Envoi%20email%20-%20HC%20N%B0004.jpg&type=thumb)
