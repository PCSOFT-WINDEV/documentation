...
The test editor displays the WLanguage code of the test that has just been recorded: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Tests%20automatiques%20-%20HC%20N%B0002.jpg&type=thumb)
The WLanguage functions used to run automated tests are the EmulateXXX functions.
The test is currently available and has not been run (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Tests%20automatiques%20-%20HC%20N%B0002%201.Jpg) next to the name of the test in the editor).
...
5. Save the test if necessary (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer_GAF.jpg) or Ctrl + S)
...
3. The test appears again in the test editor. The "Compilation errors" tab pane shows several test errors. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Tests%20automatiques%20-%20HC%20N%B0003.jpg)
...
2. Add the following code before the "EmulateMenu("_Menu","OPT_Exit")" line:
	...
	END
	```
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Tests%20automatiques%20-%20HC%20N%B0004.jpg&type=thumb)


3. Save the test (![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Enregistrer_GAF.jpg) or Ctrl + S)

4. Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Fenetre_WD_GAF.jpg). The test is completed successfully. The Table control contains at least one record. 
