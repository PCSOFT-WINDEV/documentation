...
An external component is a **building block** that can be reused in an unlimited number of projects (and therefore executable files). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Composant_PresentationGAF.gif)
...
An external component can contain code, windows, tables, a database schema, etc. 
...
- a database schema to describe the tables that store the information.
...
5. Select the elements that will be included in the project configuration. In this example, these elements will also be included in the component.
	...
	- Select the "QRY_OrdersByCity" and "SET_Component" elements. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0001.jpg&type=thumb)
...
7. The new configuration automatically becomes the current configuration.
	To identify and modify the current configuration, use the "Project explorer" pane. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0002.jpg)
...
3. The wizard asks you to select the component elements that will be accessible from the client application. In our example, we will only use the "SET_Component" set of procedures: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0003.jpg&type=thumb)


4. Go to the next step.

5. You can enable the translation of the component. This feature may be useful if the component must be used in multilingual applications. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0004.jpg&type=thumb)
...
9. Specify the main component overview. This overview will allow the user to understand the purpose of the component. Type for example: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0005.jpg&type=thumb)
...
13. Give a physical name to the component. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0006.jpg&type=thumb)
...
4. Click "Create a project" in the home page.
	...
	- Choose "Eleven" as the project theme. 
...
3. Click "Open", the description of our component is displayed. This description contains:
	...
	- On the "General" tab, the elements typed when creating the external component as well as its location. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0007.jpg&type=thumb)
...
3. We are going to call the **DataLocation** function of the component in the "End of initialization" event. This function expects as parameter the path used to access the tables handled by the component. Enter the access path to the data in the "WD Full Application" example. For example: 
...
2. In the edit control, enter "Paris" (keep uppercase and lowercase characters) and click "Search". The list of customers is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_Cr%E9er%20et%20utiliser%20un%20composant%20-%20HC%20N%B0010.jpg)
