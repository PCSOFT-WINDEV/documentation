...
<a name="details_available_options_ELTTEXTE000200"></a>


### Files
<a name="files_ELTPARAGRAPHE000025"></a>
...
### Connections
<a name="connections_ELTPARAGRAPHE000035"></a>
...
### Locks
<a name="locks_ELTPARAGRAPHE000048"></a>
...
### Backups
<a name="backups_ELTPARAGRAPHE000062"></a>
...
3. Select the type of optimization to perform: 
	...
	- **2. Optimize the speed of indexes**(recalculate the statistics): Optimizes the indexes by calculating index statistics. These statistics are used to optimize the filters, the queries and the HFSQL views.
	...
	- **3. Reindex**: Optimizes the access to the records of the data file and recalculates the statistics. All the crossed records are automatically deleted.
...
### Stored procedures
<a name="stored_procedures_ELTPARAGRAPHE000117"></a>
