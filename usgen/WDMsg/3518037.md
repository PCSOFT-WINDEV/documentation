...
The comparison file is created in the reference language. The comparison table and the extraction table have the same format (WDMSG file, HFSQL table or text table). For more details on the format of the comparison text file, see [format of the content in the text file](../WDMsg/3518030.md)
...
3. Choose the reference language. The different messages will be displayed in this reference language. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Assistant%20WDMSG%20-%20HC%20N%B0007.gif&type=thumb)
Note: Customized language names are also available. 

4. Proceed to the next step of the wizard.

5. Choose the language to compare. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Assistant%20WDMSG%20-%20HC%20N%B0008.gif&type=thumb)
Note: Customized language names are also available.
...
7. Select the elements (windows, pages, reports, etc.) with text (captions, code comments, etc.) to be compared. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Assistant%20WDMSG%20-%20HC%20N%B0009.gif&type=thumb)
...
- For a comparison in the format of tables in HFSQL format, 3 tables are included in the comparison file:
