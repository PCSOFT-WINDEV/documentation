...
|   |
| --- |
| **Note** This page describes the format of text files handled by [WDMSG](../WDMsg/3518040.md).<br>**From version 15**, you also have the ability to manage the HFSQL tables (to allow the management of a large message table for example).<br>**From version 19**, you have the ability to support WDMSG files (to allow the management of Rich Text Areas). <br><br>The extraction file in HFSQL or MDMSG format can only be handled by [WDTRAD](../WDTRAD/3518010.md) supplied with WDMSG. |
...
<a name="example_file_structure_created_wdmsg_ELTTEXTE000149"></a>
...
<a name="text_with_multiple_lines_ELTTEXTE000173"></a>
...
## RTF
<a name="rtf_ELTTEXTE000197"></a>
For the RTF edit controls and static controls, the RTF tags are kept when the messages are checked out.

**Note** Under [WDTRAD](../WDTRAD/3518010.md), to view messages in RTF format, select "View in file mode" from the message context menu.
