...
3. Select the languages in which the text will be reintegrated. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Assistant%20WDMSG%20-%20HC%20N%B0005.gif&type=thumb)
Remarks: 
...
5. Select the reintegration options of the file containing the translated text. These options are presented in the paragraph below.  <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Assistant%20WDMSG%20-%20HC%20N%B0006.gif&type=thumb)
...
- in the case of simultaneous reintegration of several languages (HFSQL or WDMSG table): the various languages contained in the translation table have been translated using the WDTRAD tool.
