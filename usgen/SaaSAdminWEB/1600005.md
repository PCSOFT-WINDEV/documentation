...
## User management
<a name="user_management_ELTTEXTE000235"></a>
...
| *Login* | Identifier for connecting to the SaaS sites.<br>**Note**: after creation, Subscription licenses must be allocated to the user to enable access to SaaS Sites. |
...
| *Password to enter* | If "Password to enter" is checked, during the next connection of the user, a message will indicate that his password has expired and that a new password must be entered.<br><br>Note: If this box is checked when the user is created, a password must still be specified for the user's first login. |
