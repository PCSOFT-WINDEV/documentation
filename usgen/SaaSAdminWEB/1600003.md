...
- Site parameters that allow you to customize the site to suit your needs.
...
- Periodicity of the price: monthly, weekly, annually or unlimited (if the price is payable only once).

- Billing method: per user or flat rate (regardless of the number of users).
...
**Remark**: The SaaS administrator displays the different tariffs associated with a site. If the site includes more than 5 pricing, an arrow is used to access the other pricing. However, more pricing can be proposed through programming with [SaaSAdminAddPricing](../WDLang3/1000019127.md).
...
**Note**: If all users of the customer account can read the value, you need to be a user with administrative rights to write.
...
[SaaSAdminFindSite (Function)](../SaaSAdminWeb/1000019105.md)

[SaaSAdminListSite (Function)](../SaaSAdminWeb/1000019106.md)

[SaaSAdminModifySite (Function)](../SaaSAdminWeb/1000019103.md)

[SaaSAdminDeleteSite (Function)](../SaaSAdminWeb/1000019104.md)
