...
- display or hide the ribbon tabs and buttons. For more details, see [Report viewer](../WDChamp/1011085.md).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Apercu_Volet_Apercu.gif&type=thumb)
...
- Two additional buttons may appear in the report viewer if the application allows running "Reports & Queries" (provided with WINDEV). <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Apercu_impression%20-%20HC%20N%B0002%201.gif)
These buttons are used to modify the current report and to create a new report with "Reports & Queries".. These buttons are displayed only:
...
| *iButtonWord* | The button used to print the report in an RTF file is visible. |
...
- print settings in a PDF file: [iParameterPDF](../WDLang5/3046007.md).

- Email settings: [iParameterExport](../WDLang5/1000017026.md).

- print settings in an XLS file: [iParameterXLS](../WDLang5/1000017224.md).

- duplicate print settings: [iParameterDuplicate](../WDLang5/1000018845.md). 

- Watermark text printing parameters: [iParameterWatermark](../WDLang5/1000019939.md).
