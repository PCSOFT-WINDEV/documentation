...
- The current vertical position when printing a character string points to the upper part of the string. The bottom position depends on the height of the fonts used in the line to print.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=iImprime.gif)
