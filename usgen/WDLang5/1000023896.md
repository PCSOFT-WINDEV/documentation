...
<a name="manipulating_xml_document_ELTTEXTE000064"></a>


To manage an XML document, see [Using an xmlDocument variable](../WDLang5/3081018.md). This method allows you to use an XSD file. 
...
Several specific functions allow you to use xmlDocument variables
...
| [&lt;Looper&gt;.ToXML](../WDLang2/1000023707.md) | Creates an XML file with data from a Looper control (Looper control based on a table or populated programmatically). |
