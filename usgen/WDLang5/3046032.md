...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003046032&name=iprintreport_function">See additional examples</a>
...
iDestination(iGenericPDF, MyUniqueFile)
...
<a name="principle_for_printing_report_ELTPARAGRAPHE000189"></a>

The function **iPrintReport** reads the report data source (tables, query, Table control, etc.). **iPrintReport** prints the *Body* block for each record. The other blocks are printed when necessary:
...
<a name="report_with_lower_and_upper_bounds_ELTPARAGRAPHE000208"></a>
...
<a name="executing_query_and_report_based_this_query_ELTPARAGRAPHE000229"></a>
...
### Print destination
<a name="print_destination_ELTPARAGRAPHE000244"></a>
...
### Passing parameters
<a name="passing_parameters_ELTPARAGRAPHE000267"></a>
...
<a name="printing_component_report_ELTPARAGRAPHE000290"></a>To print a component report, use the name of component report (the component being included in the project). For example:
...
### Nested reports
<a name="nested_reports_ELTPARAGRAPHE000321"></a>
