...
By default, this XSD file is taken into account when the document is saved: document validity is automatically checked before saving the XML document (equivalent to the [XMLValidDocument](../WDLang5/1000019272.md) function). If you don't want to perform this validation, simply use the constant *xvWithoutValidation*. 
