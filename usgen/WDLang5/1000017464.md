...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000018059&name=xlsdocument_variable_type">See additional examples</a>
...
### Declaring an XLS document without specifying the format
...
### Declaring an XLS document by specifying the format
...
|   |   |
| --- | --- |
| *xlsVersionUndefined* | Undefined version (default value). The format will be defined when the file is saved. |
| *xlsVersionXls* | XLS document. |
| *xlsVersionXlsx* | XLSX document. |
...
<a name="properties_specific_xlsdocument_variables_ELTPARAGRAPHE000084"></a>
...
| Comment | Array of [xlsComment](../WDLang5/1000024870.md) | Comments on XLS document cells. |
| File | Character string | Name and full path of XLS file associated with the document. **This property is read-only**. It is assigned when using [xlsOpen](../WDLang5/3080017.md).  <br>Note: When assigning a variable of type **xlsDocument** to another, this property is not copied (except when [xlsOpen](../WDLang5/3080017.md) is called). |
| Modified | Boolean | <br><br>- <u><u><u>True</u></u></u> if the document was modified<br><br>- <u><u><u>False</u></u></u> otherwise.<br><br><br>This property is reset to <u><u><u>False</u></u></u> after the call to [xlsSave](../WDLang5/1000018057.md). |
| NumberColumn | Integer | Number of columns in the document (same as [xlsNbColumn](../WDLang5/3080014.md), but ignoring empty columns). <br><br>**This property is read-only**. |
| NumberRow | Integer | Number of rows in the document (same as [xlsNbRow](../WDLang5/3080011.md), but ignoring empty rows).  <br><br>**This property is read-only**. |
| NumberWorksheet | Integer | Number of worksheets found in the document (identical to [xlsNbWorksheet](../WDLang5/3080023.md)). <br><br>**This property is read-only**. |
| RecalculateWhenLoading | Boolean | <br><br>- <u><u><u>True</u></u></u> if the formulas of the document must be recalculated when the document is opened in Excel or OpenOffice.<br><br>- <u><u><u>False</u></u></u> if no calculation must be performed when the document is opened in Excel or OpenOffice.<br><br><br><br><br>Note: Only formulas initially present in the document can be recalculated. |
| RightToLeft | Boolean | <br><br>- <u><u><u>True</u></u></u> if the mode for reading the current worksheet is "Right to left".<br><br>- <u><u><u>False</u></u></u> if the mode for reading the current worksheet is "Left to right".<br><br><br> |
...
<a name="accessing_column_excel_document_ELTPARAGRAPHE000260"></a>

The following syntaxes can be used to access a column of an Excel document:

- MyXLSDocument.Column[1]: Accesses column 1 of the Excel file.

- MyXLSDocument.Column["A"]: Accesses column A in the Excel file.
...
<a name="accessing_cell_excel_document_ELTPARAGRAPHE000282"></a>

The following syntaxes can be used to access a cell of an Excel document:

- MyXLSDocument[1,2]: Accesses the cell on row 1, column 2 in the Excel file.

- MyXLSDocument[5, "A"]: Accesses the cell on row 5, column A in the Excel file.
...
<a name="accessing_cell_column_excel_document_ELTPARAGRAPHE000304"></a>

The following syntaxes can be used to access a cell of a column in an Excel document:

- MyXLSDocument.Column[1].Cell: Returns the value of the cell in column 1 for the current row. 

- MyXLSDocument.Column["A"].Cell: Returns the value of the cell in column A for the current row.  
...
<a name="accessing_cell_row_excel_document_ELTPARAGRAPHE000326"></a>

The following syntax can be used to access a cell of a row in an Excel document:

- MyXLSDocument.Row[1].Cell[2]: Accesses the cell on row 1, column 2 in the Excel file.

- MyXLSDocument.Row[5].Cell["A"]: Accesses the cell on row 5, column A in the Excel file.
...
<a name="wlanguage_functions_that_use_xlsdocument_variables_ELTPARAGRAPHE000360"></a>
...
[xlsComment (Variable type)](../WDLang5/1000024870.md)
