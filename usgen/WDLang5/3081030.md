...
**If no search is in progress** moves to the element following the current one in the tree structure.
...
<a name="xml_functions_and_threads_ELTPARAGRAPHE000242"></a>
