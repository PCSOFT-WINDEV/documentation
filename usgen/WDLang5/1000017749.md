...
***In french: &lt;Variable gglConnexion&gt;.RemplitAgenda***
...
Fills a calendar that was previously retrieved: the events corresponding to the calendar are retrieved (by using criteria if necessary). This function must be used after the call to [&lt;gglConnection variable&gt;.ListCalendar](../WDLang5/1000017747.md).
<a name="Exemple1"></a>
...
<a name="managing_dates_and_times_ELTPARAGRAPHE000225"></a>
...
[GglFillCalendar (Function)](../WDLang5/1000017337.md)
