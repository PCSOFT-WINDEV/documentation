...
// Case 1: Direct use of author's name
Trace("Agenda author: " + tabAgendas[1].Author.Name)

// Case 2: Using a variable of type gglAuthor
CalendarAuthor is gglAuthor
CalendarAuthor = arrCalendars[1].Author
Trace("Agenda author: " + AgendaAuthor.Name)
```
...
<a name="properties_specific_gglauthor_variables_ELTPARAGRAPHE000043"></a>
