...
| **BC_FormatText** | Formats the text displayed for EAN 128 barcodes: brackets are added around the AIs in the printed text. | [iPrintBarCode](../WDLang5/3046020.md)<br>[BarCode](../WDLang5/1000019451.md) variable<br>[Option](../Proprietes/2510154.md) property |
...
| **BC_UNKNOWN** | For Android: Barcode decoded but type unknown. | [BarCode](../WDLang5/1000019451.md) variable |
...
| **bcDefaultHeight** | Maximum image height: The maximum height is the minimum height required to display the barcode. | [BCToImage](../WDLang5/1000024060.md) |
| **bcDefaultWidth** | Maximum image width: The maximum width is the minimum width required to display the barcode. | [BCToImage](../WDLang5/1000024060.md) |
| **bcTypeContact** | Nature of data stored in barcode: Contact description. | [BarCode](../WDLang5/1000019451.md) variable |
| **bcTypeEmail** | Type of data stored in barcode: Email address. | [BarCode](../WDLang5/1000019451.md) variable |
| **bcTypeLocation** | Type of data stored in the StrikeOut code: Geographical position. | [BarCode](../WDLang5/1000019451.md) variable |
| **bcTypeMarket** | Type of data stored in the barcode: Link to an application on Google Play (Android only). | [BarCode](../WDLang5/1000019451.md) variable |
| **bcTypePhone** | Nature of data stored in strikethrough code: Telephone number. | [BarCode](../WDLang5/1000019451.md) variable |
| **bcTypeSMS** | Type of data stored in the strikethrough: SMS number. | [BarCode](../WDLang5/1000019451.md) variable |
| **bcTypeText** | Nature of data stored in the barcode: Plain text. | [BarCode](../WDLang5/1000019451.md) variable |
| **bcTypeURL** | Type of data stored in the barcode: URL. | [BarCode](../WDLang5/1000019451.md) variable |
| **bcTypeWiFi** | Nature of data stored in barcode: Wi-Fi network connection settings (Android only). | [BarCode](../WDLang5/1000019451.md) variable |
...
| **qrcodeLevelH** | QR Code error correction level: around 30% of encoded words can be restored. | [BarCode](../WDLang5/1000019451.md) variable |
| **qrcodeLevelL** | QR Code error correction level: around 7% of encoded words can be restored. | [BarCode](../WDLang5/1000019451.md) variable |
| **qrcodeLevelM** | QR Code error correction level: around 15% of encoded words can be restored. | [BarCode](../WDLang5/1000019451.md) variable |
| **qrcodeLevelQ** | QR Code error correction level: around 25% of encoded words can be restored. | [BarCode](../WDLang5/1000019451.md) variable |
