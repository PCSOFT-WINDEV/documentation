...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Special case: QR Code barcodes: default types**
...
- a **Text QR Code** This type of QR Code associates a text with the barcode. To initialize this type of QR Code, all you have to do is assign it with a character string. For example: 
...
- a **Web Link QR Code** This type of QR Code can be used, for example, to open a site directly. To initialize this type of QR Code, all you have to do is assign it with a site address. For example: 
...
- a **Phone number QR Code** This type of QR Code can be used, for example, to call a Phone number directly. To initialize this type of QR Code, all you have to do is assign it with a phone number. For example: 
...
- a **Email Address QR Code** This type of QR Code can be used, for example, to obtain a contact's Email address. To initialize this type of QR Code, simply assign an email address to it. For example: 
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Reports and Queries](https://doc.pcsoft.fr/ext/images/us/ER.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) **Special case: QR Code barcodes: specific types**
