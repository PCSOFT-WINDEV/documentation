...
<DIV class="specObsolete">
	...
	From version <B>25</B>, the print preview has been renamed to "Report viewer". It is now recommended to use the [iParameterViewer](../WDLang5/1000024634.md) function. 
...
- display or hide the ribbon tabs and buttons. For more details, see [Print preview](../WDChamp/1011085.md).<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Apercu_Volet_Apercu.gif)
...
- Two additional buttons may appear in the print preview if the application allows "Reports & Queries" (provided with WINDEV) to be run. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=icone_Apercu_EtatRequete.gif)
These buttons are used to create and edit reports with "Reports & Queries". These buttons are displayed only:

	- If the project allows Reports and Queries to be run ("Advanced" tab of the project description).

	- If the report can be edited with "Reports & Queries" ("Details" tab of the report description).
...
| *iButtonAnnotation* | <br><br>- Up to version 19: The toolbar for annotating the report is visible.<br><br>- From version 20: The "Annotations" button is available in the "Preview" pane. The "Annotate" tab used to write annotations in the report is visible. For more details on this tab, see ["Annotate" tab](../WDChamp/1011086.md).<br><br><br><br><br>This constant is not taken into account in the mini-preview. |
...
| *iButtonDuplicate* | <br><br>- Up to version 19: The button for recording a duplicate of the current report is visible.<br><br>- From version 20: The "Export" pane is visible. The button used to save a duplicate copy of the current report is displayed in the "Export" tab. For more details on this tab, see ["Export" tab](../WDChamp/1011088.md).<br><br><br><br><br>This constant is not taken into account in the mini-preview. |
| *iButtonEmail* | <br><br>- Up to version 19: The button for printing the report in a new Email is visible.<br><br>- From version 20: The "Export" pane is visible. The button used to create an email with the content of the integrated report is displayed in the "Export" tab. For more details on this tab, see ["Export" tab](../WDChamp/1011088.md).<br><br><br> |
| *iButtonEmailPdf* | <br><br>- Up to version 19: The button for printing the status in a file linked to a new Email is visible.<br><br>- From version 20: The "Export" pane is visible. The button used to create an email with an attached PDF is displayed in the "Export" tab. For more details on this tab, see ["Export" tab](../WDChamp/1011088.md).<br><br><br> |
| *iButtonExcel* | <br><br>- Up to version 19: The button for printing the report to an Excel file is visible.<br><br>- From version 20: The "Export" pane is visible. The button used to create an Excel file from the current print is displayed in the "Export" tab. For more details on this tab, see ["Export" tab](../WDChamp/1011088.md).<br><br><br> |
| *iButtonHtml* | The button used to print the report in an HTML file is visible. |
| *iButtonNone* | <br><br>- Up to version 19: No buttons or toolbars are displayed.<br><br>- From version 20: Only the "Preview" pane of the print preview is displayed. For more details on this tab, see ["Preview" tab](../WDChamp/1011089.md). <br><br><br> |
...
| *iButtonReportCreation* | <br><br>- Up to version 19: The button for creating a report with "Reports and Queries" is visible.<br><br><br> |
...
<a name="configuring_the_print_preview_ELTPARAGRAPHE000281"></a>
...
<a name="reports_not_created_the_report_editor_ELTPARAGRAPHE000313"></a>
...
<a name="warning_message_syntax_1_ELTPARAGRAPHE000321"></a>
...
<a name="configuring_the_different_print_modes_ELTPARAGRAPHE000331"></a>
