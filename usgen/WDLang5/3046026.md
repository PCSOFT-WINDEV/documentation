...
- print-specific fonts: these fonts can only be used when printing with WLanguage functions.
...
**Caution**: You can only print with the printer's fonts.. If the font used is not available, the closest font will be used.
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png)![iPhone/iPad](https://doc.pcsoft.fr/ext/images/us/IPHONE.png) You also have the ability to create dynamic fonts. A "Font" type variable can be used to create a font that can be used in all project objects: windows, reports, printing, graphs, drawings, etc.
...
2. Define the characteristics of the font:
	...
	- either thanks to the [font properties](../Proprietes/2515045.md): [Angle](../Proprietes/1410086632.md), [StrikeOut](../Proprietes/2513005.md), [Condensed](../Proprietes/2513006.md), [Color](../Proprietes/2510071.md), [Extended](../Proprietes/2513002.md), [Bold](../Proprietes/2513001.md), [Italic](../Proprietes/2513007.md), [Large](../Proprietes/2513012.md), [Name](../Proprietes/2510082.md), [Underline](../Proprietes/2513013.md) and [Size](../Proprietes/2510125.md).
...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![Windows](https://doc.pcsoft.fr/ext/images/us/WINDOWS.png) The printer manufacturers install fonts on their printers. These fonts are called "printer" fonts.

Unlike the software fonts (such as  "TrueType"), these fonts can be directly accessed by the printer, they do not have to be downloaded.
