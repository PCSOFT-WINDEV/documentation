...
### Properties specific to gglPerson variables
<a name="properties_specific_gglperson_variables_ELTPARAGRAPHE000030"></a>

The following properties can be used to handle **gglPerson** variables:
