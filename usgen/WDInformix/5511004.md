...
## Necessary version
<a name="necessary_version_ELTTEXTE000217"></a>


### Required version of WINDEV/WEBDEV
<a name="required_version_windevwebdev_ELTPARAGRAPHE000011"></a>

**Note**: This version of the Native Informix Connector only works with WINDEV and WEBDEV 2026.
...
## Main remarks
<a name="main_remarks_ELTTEXTE000241"></a>
...
**Note**: If the Native Informix Connector detects that the client version is 7.23 or earlier, it checks in the registry that the DBDATE value is set to Y4MD at the location specified below, but only if DEFAULT_USER_SETTING is set to CU:
...
<a name="specific_features_native_informix_connector_ELTTEXTE000283"></a>


### Database schema options
<a name="database_schema_options_ELTPARAGRAPHE000082"></a>
...
### Identical records
<a name="identical_records_ELTPARAGRAPHE000090"></a>
...
<a name="forcing_the_automatic_identifier_ELTPARAGRAPHE000099"></a>
...
<a name="insert_queries_and_automatic_identifier_ELTPARAGRAPHE000112"></a>
...
### Locks
<a name="locks_ELTPARAGRAPHE000122"></a>
...
### Unsupported types
<a name="unsupported_types_ELTPARAGRAPHE000129"></a>
...
### Restoring memos
<a name="restoring_memos_ELTPARAGRAPHE000136"></a>

The memos are not restored when [HRestorePosition](../WDLang4/3044137.md) is used in the queries and in the reports.

**Result**: In a Table control based on a query, memos no longer appear:
...
### Links
<a name="links_ELTPARAGRAPHE000151"></a>
...
<a name="alias_and_accented_characters_ELTPARAGRAPHE000161"></a>
...
### Generic search
<a name="generic_search_ELTPARAGRAPHE000168"></a>
