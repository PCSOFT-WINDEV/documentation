...
- The "Automatically create the tables when they are opened" option (available in the "Tables" tab of the project description) is taken into account by the MySQL Native Connector. 
