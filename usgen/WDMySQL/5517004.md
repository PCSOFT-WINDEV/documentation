...
**Differences from HFSQL** programming: Using SQL functions to manipulate MySQL data does not imply importing the table structure into the database schema.. However, the data must be handled by queries only. The content of MySQL files cannot be read directly.
