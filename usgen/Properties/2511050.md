...
**Note**: The number of labels printed on a page width can be known and/or modified in the report editor: in the "Modification" pane, in the "Report" group, select "Format and labels"..<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=nbetiquette.gif)
...
// Is equivalent to: ETAT_EtiqClient.NbLabel += 2
```
