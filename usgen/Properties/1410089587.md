...
Note: This property can be used to change the type of Edit control to "Markdown view".. 
<a name="Exemple1"></a>
...
- <u><u><u><u>True</u></u></u></u>: Edit control becomes read-only with content displayed in Markdown format. Scrolling and selection are enabled (except if the [State](../Proprietes/2510039.md) property is set to *Grayed*). The [State](../Proprietes/2510039.md) property remains unchanged.  The Edit control switches to "Markdown (read-only)" mode. 

- <u><u><u><u>Faux</u></u></u></u>: Edit control returns to input mode. You also need to use the [State](../Proprietes/2510039.md) property to enable it. 
...
[DisplayFormat (Property)](../Proprietes/1410088879.md)
