...
The **Language** property is used to set the language used to compare and sort Unicode items (Unicode Text item or Unicode Text Memo item). It is possible to:

- Find out the language parameters used at runtime for comparing and sorting. This property can be used for an item defined in the data model editor or defined programmatically. The modifications performed by the [H.LanguageCreationUnicode](../WDLang4/3044382.md) variable are taken into account.
...
Trace("Language used in the table: ") + Client.Name.Language
```
