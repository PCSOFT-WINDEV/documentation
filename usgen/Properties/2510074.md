...
The **MDILeft** property is used to determine and change the distance between the left border of the MDI parent window and the left border of the MDI area.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MDIXX.gif)
