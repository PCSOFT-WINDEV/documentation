...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) This property is only available for Table controls in Android applications.
...
- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png)![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) TreeView Table controls,
...
![Android](https://doc.pcsoft.fr/ext/images/us/ANDROID.png) The **InputEnabled** property applies only to Table controls. For other types of controls, you can use the [State](../Proprietes/2510039.md) property set to *Active*. 

![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png) The **InputEnabled** property has no effect on the following elements: 
