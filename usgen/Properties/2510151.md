...
**Note**: By default, if a string contains the '&' character, the letter following the '&' character is interpreted as the hotkey letter.. For more details, see [Keyboard shortcut and hotkey](../WDChamp/1014018.md).
<a name="Exemple1"></a>
...
[Keyboard shortcut and hotkey](../Proprietes/1014018.md)
