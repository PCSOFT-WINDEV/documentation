...
The **Charset** property gets the character set used by an HFSQL table. This character set is selected with [ChangeCharset](../WDLang1/3054001.md) and taken into account when creating the table. This property is read-only.

**Reminder** By default, the character set used by a table is the ANSI alphabet. To change the character set of a table, you must:

- Use [ChangeCharset](../WDLang1/3054001.md) to specify the character set that must be taken into account.

- Create the table and specify the desired character set (with [HCreation](../WDLang4/3044255.md) or [HCreationIfNotFound](../WDLang4/3044254.md)). 
...
SWITCH FileLanguage
	...
	CASE alphabetOccidental: ChangeCharset(alphabetOccidental)
...
### Getting the character set used by an HFSQL table

`<Table charset> = <Table>.Charset`
---

**`<Table charset>: (Integer constant)`**

Type of character set used by the specified table: 
...
Logical name of the HFSQL table to use.  
...
<a name="changing_the_character_set_ELTPARAGRAPHE000179"></a>
...
### Font variable
<a name="font_variable_ELTPARAGRAPHE000193"></a>
