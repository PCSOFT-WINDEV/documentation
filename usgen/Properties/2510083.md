...
![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) **Reminder** To make a List Box control multicolumn (ListView control or ImageView control displayed in Classic mode):

1. Open the control description window ("Description" in the context menu).

2. On the "Details" tab, specify the number of columns in the "Number of columns" option.
...
- Number of columns in the specified multicolumn List Box control.

- Number of columns in the specified Table control.

- Number of columns in the specified Check Box or Radio Button control.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Number of columns in the specified Pivot Table control.

- ![WINDEV](https://doc.pcsoft.fr/ext/images/us/WD.png) Number of columns in the specified Combo Box Table control.
...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png)![WEBDEV - Browser code](https://doc.pcsoft.fr/ext/images/us/WBN.png)![PHP](https://doc.pcsoft.fr/ext/images/us/PHP.png) The **NumberColumn** property applies only to: 
