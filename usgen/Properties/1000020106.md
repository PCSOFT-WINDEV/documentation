...
The **DayHeight** property gets and sets the height of days in a Scheduler control where days are arranged in rows, and resources are arranged in columns. 
...
- -1 in the following cases: 
	...
	- if the resources are displayed by rows. In this case, you must use [DayWidth](../Proprietes/1000020108.md) and [ResourceHeight](../Proprietes/1000020109.md). 
