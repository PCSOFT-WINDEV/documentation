...
Note: This item may come from a table, a view or a query.
<a name="Exemple1"></a>
...
Name of new item that will be used to display the image of ListView control. This item must belong to the table the control is based on (returned or modified with the [BrowsedFile](../Proprietes/2510040.md) property).  
...
- The records displayed in a ListView control based on a table come from the table or from the query specified by the [BrowsedFile](../Proprietes/2510040.md) property.
