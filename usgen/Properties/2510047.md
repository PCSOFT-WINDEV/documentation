...
| <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=position_sel.gif)<br> | The input cursor is placed at the beginning of the selection (position 3 in this example). The **CursorEnd** property gets and sets the end of the selected area. |
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=image17.gif)
