...
The **MDIBottom** property is used to determine and change the distance between the bottom border of the MDI parent window and the bottom border of the MDI area.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=MDIXX.gif)
...
[MDITop (Property)](../Proprietes/2510075.md)
