...
Note: If the database schema and the database schemas have the same data integrity constraints, this property is not required. 
...
|   |   |
| --- | --- |
| *doAuto*<br>(Default value) | The display mode is automatic according to the cardinality of the link defined in the database schema. |
...
The Pivot Table control contains products that are not linked to a category: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TCD_Orphelin1.gif)
...
```
The same Pivot Table control can be displayed without the products that are not linked to a category: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=TCD_Orphelin2.gif)
