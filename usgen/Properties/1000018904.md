...
**Remark**: Changing an element's weight changes its size in the TreeMap control.. The weight was specified when the element was added to the TreeMap by [TreeMapAdd](../WDLang1/1000018814.md). 
<a name="Exemple1"></a>
