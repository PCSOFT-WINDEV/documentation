...
- copy of the "Translation" message for all identical "Reference" messages.
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=CopieSimple.gif)
...
**Remark**: If "Translation" messages were present in the messages found, these "Translation" messages are replaced with the new translation.
