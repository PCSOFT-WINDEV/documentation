...
## Practical example
<a name="practical_example_ELTTEXTE000236"></a>
To follow the steps in this lesson, we will use the "WLanguage" project that we created in the previous lesson (see [A project to discover WLanguage](../TutoWM/1410087570.md) in lesson 1).
...
1. Right-click the "P" button next to the open element tabs. The context menu appears. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P3_WM_WLangage%20-%20HC%20N%B0001.jpg)
...
## What is a variable?
<a name="what_variable_ELTTEXTE000314"></a>
In a programming language, a variable is used to store data. These memory sections contain strings, numbers, etc.

Variables are used to perform calculations, comparisons, or to store information that will be used later.<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Declaration27.gif)
...
<a name="declaring_variable_ELTPARAGRAPHE000035"></a>
...
### Assignment and use
<a name="assignment_and_use_ELTPARAGRAPHE000042"></a>
...
1. Test the project in the simulator: 

	- Expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Projet_WM_GAF.jpg) in the quick access buttons. 

	- Click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_simu_PRJ_WM_GAF.jpg) to test the project in simulator mode. 
...
## Types of variables
<a name="types_variables_ELTTEXTE000458"></a>
...
<a name="simple_operations_variables_ELTTEXTE000519"></a>
...
1. Test the project by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Simu_prj_WM_GAF.jpg) in the quick access buttons.
...
### Tips
<a name="tips_ELTPARAGRAPHE000063"></a>
...
<a name="string_variables_detail_ELTTEXTE000613"></a>
...
### The String type
<a name="the_string_type_ELTPARAGRAPHE000077"></a>
...
### Building a string
<a name="building_string_ELTPARAGRAPHE000084"></a>
...
<a name="operations_strings_ELTPARAGRAPHE000091"></a>
...
4. Test the project by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Simu_prj_WM_GAF.jpg) in the quick access buttons.
...
3. Test the project by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Simu_prj_WM_GAF.jpg) in the quick access buttons.
...
### Finding a string
<a name="finding_string_ELTPARAGRAPHE000098"></a>
...
<a name="comparing_two_strings_ELTPARAGRAPHE000105"></a>
...
6. Test the project by clicking ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_GO_Simu_prj_WM_GAF.jpg) in the quick access buttons.
