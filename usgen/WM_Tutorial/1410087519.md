...
2. On the "Project" tab, in the "Generation" group, click "Generate" (you can also click ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Generation_iOS_WM_GAF.jpg) in the quick access buttons).
...
This identifier will allow you to register your application so that it can be tested and deployed. By default, WINDEV Mobile automatically generates an identifier that meets Apple's development requirements. You can change this ID.
	...
	- define the email address used by default to send an error report if necessary. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_D%E9ploiement%20ios%20-%20HC%20N%B0001.jpg&type=thumb)
...
13. This step allows you to include specific tables (tables, images, etc.). 

	- Click the "Add" button.

	- Select the tables (.fic, .ndx and .mmo tables) located in the "EXE\\iOS application" directory of the project. The list of files is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_D%E9ploiement%20ios%20-%20HC%20N%B0002.jpg&type=thumb)





14. Check the "Write" box to indicate that these tables must be in write mode.
...
16. The wizard allows you to specify:
	...
	- whether files can be shared with iTunes. If this option is checked, you can copy the application files to the Mac during the synchronization. For example, if the application contains tables, iTunes will allow you to copy these tables.

	- the minimum iOS version required to run the application. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=P4_D%E9ploiement%20ios%20-%20HC%20N%B0003.jpg&type=thumb)
...
19. The application is generated in the EXE folder of the project directory. The name of the directory containing the source code that will be used on the Mac is "Project_name.xcode.gen" ("WM Product Management.xcode.gen" in our example). This directory must be copied to the Mac. Click "Browse generation directory".
	You can open the generation directory of the current project at any time. To do so, go to the "Home" tab, "General" group, expand ![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=ICO_Rep_Projet_GAF.jpg) and select "Browse generation directory".
