...
The use of SQL functions to handle Sybase data does not require importing the table structure into the database schema. However, the data must be handled by queries only. The content of Sybase files cannot be read directly.
