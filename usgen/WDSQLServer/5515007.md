...
2. In the window that opens (used to list the existing connections), click the "Add" button to create a new connection. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Parametrage_1.gif)


3. Specify the connection settings: <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=Connexion_1.gif)
...
<br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=options_1.gif)
...
4. Click "Test connection". The status report is displayed. <br>![](https://doc.pcsoft.fr/en-US/images/image.awp?langid=214&name=test_1.gif)
