...
| *mediaType_CDDA_CDROM* | Audio CD. <br>The CD will be created in "Track at Once" mode (fixed-size pause between tracks).<br>No other audio or tables can be added thereafter. |
