...
## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003061006&name=burnersave_function">See additional examples</a>
...
| *burnerFinalize* | Finalize the media: any further writing on the media will be forbidden. <br>Note: Rewritable media can still be erased and reused. |
...
**Note** In the case of an audio CD/DVD, some CD/DVD players may only play tracks from the first session.
<a name="NOTE0_3"></a>
...
[BurnerAddDirectory (Function)](../WDLang6/3061002.md)
