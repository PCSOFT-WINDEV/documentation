...
**Note** This function is not required if LDAP directory use has been configured in the user groupware settings window. To configure the User Groupware, go to the "Project" tab, "Project" group and click "User Groupware".
<a name="Exemple1"></a>
...
- <u><u><u><u>True</u></u></u></u> (default) to use the tables of groupware,
