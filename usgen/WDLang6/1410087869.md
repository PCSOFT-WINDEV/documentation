...
- start the interface of the scanner (or the corresponding system interface). This interface allows you to save the document, to modify the default parameters of the device, ... The available actions depend on the device used.




Note: WIA 2 is supported. 
