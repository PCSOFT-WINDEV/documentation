...
**Remark**: To add all the files in a directory to the compilation, use function [BurnerAddDirectory](../WDLang6/3061002.md).
<a name="Exemple1"></a>
<a name="sample_code"></a>

## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003061001&name=burneraddfile_function">See additional examples</a>
...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) The file path is relative to the Web server.
