...
**Remark**: To add a file to the compilation, use the [BurnerAddFile](../WDLang6/3061001.md) function.
<a name="Exemple1"></a>
<a name="sample_code"></a>

## Example
<a class="notetitle" target="_blank" href="$DOC$=1000003061002&name=burneradddirectory_function">See additional examples</a>
...
![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) The path of the directory is relative to the Web server.
...
|   |   |
| --- | --- |
| *burnerInterruptibleAddition* | The iteration can be interrupted by pressing ESC.<br>![WEBDEV - Server code](https://doc.pcsoft.fr/ext/images/us/WBS.png) This constant has no effect. |
| *burnerNonRecursiveAddition* | The iteration is non-recursive. Subdirectories are ignored. |
| *burnerRecursiveAddition*<br>(Default value) | The iteration is recursive. Subdirectories are automatically taken into account. |
...
[BurnerAddFile (Function)](../WDLang6/3061001.md)
