...
## SAP variable
<a name="sap_variable_ELTTEXTE000147"></a>
...
| SAP.Connection | Character string<br><br>Description of the SAP connection. For more details, see the specific documentation about SAP.<br>Example:<br><br><pre><code>SAP.Connexion = "TYPE=3 ASHOST=MINISAP.test.com SYSNR=00 <br>CLIENT=000 USER=BCUSER PASSWD=minisap"</code></pre><br>Note: if this parameter is specified, other SAP variables are ignored. |
...
## Example
<a name="example_ELTTEXTE000171"></a>


### Connection to a SAP server
<a name="connection_sap_server_ELTPARAGRAPHE000074"></a>
