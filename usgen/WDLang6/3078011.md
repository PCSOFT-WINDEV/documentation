...
***In french: TwainVersPressePapier***
...
- view the document coming from the Twain device in the [device UI](../WDLang6/3078007.md). The user can perform any of the actions proposed by this interface (e.g., record the document, change the device's default settings). The available actions depend on the device used.
	When validating the user interface, the document coming from the Twain device will be copied to the clipboard. The parameters specified in the user interface will be taken into account.
...
- <u><u><u><u>True</u></u></u></u> if the document was copied to the clipboard, 
...
<a name="document_coming_from_the_twain_device_ELTPARAGRAPHE000191"></a>

The "document coming from the Twain device" corresponds to:

- the document in the scanner when **TwainToClipboard** is called. In this case, the parameters specified in [TwainScanArea](../WDLang6/3078014.md) are taken into account.

- the image transmitted by a "Web camera" when **TwainToClipboard** is called.
...
<a name="managing_the_type_image_ELTPARAGRAPHE000214"></a>
...
<a name="multipage_scanner_with_loader_ELTPARAGRAPHE000367"></a>
...
<a name="operating_mode_the_64bit_applications_ELTPARAGRAPHE000383"></a>
