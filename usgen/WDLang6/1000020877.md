...
- view the document coming from the Twain device in the [device UI](../WDLang6/3078007.md). The user can perform any of the actions proposed by this interface (e.g. save the document, change the device's default settings). The available actions depend on the device used.
...
### Save and display the document coming from the Twain device in a PDF file
...
- <u><u><u><u>True</u></u></u></u> if the user interface of Twain device must be displayed. When saving a document, the &lt;PDF file&gt; will be proposed by default.

- <u><u><u><u>False</u></u></u></u> (default value) if the user interface of Twain device must not be displayed.
...
<u><u><u><u>True</u></u></u></u> to automatically load the pages in the device. All the pages found in the scanner loader are scanned in a single PDF file.

Note: Without a feeder, to scan multiple pages in a single PDF file, you need to scan each page in a PDF file and then use the [PDFMerge](../WDLang6/1000019712.md) function.


<a name="SYNTAXE2"></a>

### Saving the document from the Twain device in memory in PDF format
...
Then this byte string can be assigned to an Image control, saved in a file ([fSaveBuffer](../WDLang1/1000019412.md)), sent via a network (with the Socket functions), etc.
...
- <u><u><u><u>True</u></u></u></u> if the user interface of Twain device must be displayed. 
...
<a name="document_coming_from_the_twain_device_ELTPARAGRAPHE000197"></a>

The "document coming from the Twain device" corresponds to:

- the document in the scanner when **TwainToPDF** is called. In this case, the parameters specified in [TwainScanArea](../WDLang6/3078014.md) are taken into account.

- the image transmitted by a "Web camera" when **TwainToPDF** is called.

- the first photo saved in a digital camera. 
	**Note**: If [user interface](../WDLang6/3078007.md) is used, the document retrieved will correspond to the photograph selected by the user.. If several photos are selected, only the first selected photo will be retrieved.
...
<a name="managing_the_type_image_ELTPARAGRAPHE000570"></a>
...
For example: If this parameter corresponds to *TwainBlackWhite* + *TwainRVB*the image type will be:
...
### Duplex scanner
<a name="duplex_scanner_ELTPARAGRAPHE000585"></a>
...
<a name="operating_mode_the_64bit_applications_ELTPARAGRAPHE000592"></a>
...
[TwainToTIFF (Function)](../WDLang6/1000020875.md)

[TwainScanArea (Function)](../WDLang6/3078014.md)
