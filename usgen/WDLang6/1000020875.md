...
### Save and display the document coming from the Twain device in a TIFF file
...
- <u><u><u><u>False</u></u></u></u> if the document was neither saved nor viewed. The corresponding error message is returned by [ErrorInfo](../WDLang1/3013008.md).




**`<TIFF file>: (Optional character string)`**

Name and full or relative path of the file (up to 260 characters). The file extension is optional. A UNC path can be used.
If this parameter is not specified or is an empty string (""), the user will have to enter the full name of TIFF file in a file picker.

**`<User interface>: (Optional boolean)`**



- <u><u><u><u>True</u></u></u></u> if the user interface of Twain device must be displayed. When saving a document, the &lt;TIFF file&gt; will be proposed by default.
...
### Saving the document from the Twain device in memory in TIFF format
...
Byte string containing the document in TIFF format.
...
<a name="document_coming_from_the_twain_device_ELTPARAGRAPHE000547"></a>

The "document coming from the Twain device" corresponds to:

- the document in the scanner when **TwainToTIFF** is called. In this case, the parameters specified in [TwainScanArea](../WDLang6/3078014.md) are taken into account.

- the image transmitted by a "Web camera" when **TwainToTIFF** is called.
...
<a name="managing_the_type_image_ELTPARAGRAPHE000573"></a>
...
### Duplex scanner
<a name="duplex_scanner_ELTPARAGRAPHE000588"></a>
...
<a name="operating_mode_the_64bit_applications_ELTPARAGRAPHE000595"></a>
...
[TwainToPDF (Function)](../WDLang6/1000020877.md)
