...
- &lt;Image&gt; Variable of type [Image](../WDLang1/1000019650.md) containing the scanned page. This variable is only valid when the Procedure is called: it must therefore be copied or saved in a file (no reference should be made to this variable).
